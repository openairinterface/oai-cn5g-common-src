...
bool N2InformationTransferReqData::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "N2InformationTransferReqData" : pathPrefix;
    ...
    if (!m_N2Information.validate(msg, _pathPrefix + ".n2Information")) {
        msg << _pathPrefix << ": N2Information is invalid;";
        success = false;
    }     
...
bool N2InformationTransferReqData::operator==(const N2InformationTransferReqData& rhs) const
{
    return
    ...
    ((!ratSelectorIsSet() && !rhs.ratSelectorIsSet()) || (ratSelectorIsSet() && rhs.ratSelectorIsSet() && getRatSelector() == rhs.getRatSelector())) &&
...
std::vector<oai::model::Tai> N2InformationTransferReqData::getTaiList() const
{
    return m_TaiList;
}
void N2InformationTransferReqData::setTaiList(std::vector<oai::model::Tai> const& value)
{
    m_TaiList = value;
    m_TaiListIsSet = true;
}
...
oai::model::RatSelector N2InformationTransferReqData::getRatSelector() const
{
    return m_RatSelector;
}
void N2InformationTransferReqData::setRatSelector(oai::model::RatSelector const& value)
{
    m_RatSelector = value;
...
std::vector<oai::model::GlobalRanNodeId> N2InformationTransferReqData::getGlobalRanNodeList() const
{
    return m_GlobalRanNodeList;
}
void N2InformationTransferReqData::setGlobalRanNodeList(std::vector<oai::model::GlobalRanNodeId> const& value)
{
...
oai::model::N2InfoContainer N2InformationTransferReqData::getN2Information() const
{
    return m_N2Information;
}
void N2InformationTransferReqData::setN2Information(oai::model::N2InfoContainer const& value)
{
