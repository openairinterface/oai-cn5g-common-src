...
asn_TYPE_member_t asn_MBR_Ngap_LoggedMDTNr_1[] = {
    {ATF_NOFLAGS,
     0,
     offsetof(struct Ngap_LoggedMDTNr, loggingInterval),
    ...
    {ATF_NOFLAGS,
     0,
     offsetof(struct Ngap_LoggedMDTNr, loggingDuration),
    ...
    {ATF_POINTER,
     0,
     offsetof(struct Ngap_LoggedMDTNr, loggedMDTTrigger),
    ...
    {ATF_POINTER,
     5,
     offsetof(struct Ngap_LoggedMDTNr, bluetoothMeasurementConfiguration),
    ...
    {ATF_POINTER,
     4,
     offsetof(struct Ngap_LoggedMDTNr, wLANMeasurementConfiguration),
    ...
    {ATF_POINTER,
     3,
     offsetof(struct Ngap_LoggedMDTNr, sensorMeasurementConfiguration),
    ...
    {ATF_POINTER,
     2,
     offsetof(struct Ngap_LoggedMDTNr, areaScopeOfNeighCellsList),
    ...
    {ATF_POINTER,
     1,
     offsetof(struct Ngap_LoggedMDTNr, iE_Extensions),
     (ASN_TAG_CLASS_CONTEXT | (7 << 2)),
     -1, /* IMPLICIT tag at current level */
     &asn_DEF_Ngap_ProtocolExtensionContainer_12929P149,
     0,
     {
#if !defined(ASN_DISABLE_OER_SUPPORT)
         0,
