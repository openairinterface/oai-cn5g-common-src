...
asn_TYPE_member_t asn_MBR_Ngap_RANConfigurationUpdateAcknowledge_1[] = {
    {ATF_POINTER,
     0,
     offsetof(struct Ngap_RANConfigurationUpdateAcknowledge, protocolIEs),
     (ASN_TAG_CLASS_CONTEXT | (0 << 2)),
     -1, /* IMPLICIT tag at current level */
     &asn_DEF_Ngap_ProtocolIE_Container_12874P55,
     0,
     {
...
asn_SEQUENCE_specifics_t
    asn_SPC_Ngap_RANConfigurationUpdateAcknowledge_specs_1 = {
...
asn_TYPE_descriptor_t asn_DEF_Ngap_RANConfigurationUpdateAcknowledge = {
    ...
    sizeof(asn_DEF_Ngap_RANConfigurationUpdateAcknowledge_tags_1) /
        sizeof(
            asn_DEF_Ngap_RANConfigurationUpdateAcknowledge_tags_1[0]), /* 1 */
