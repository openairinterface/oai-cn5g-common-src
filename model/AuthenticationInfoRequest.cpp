...
oai::model::ResynchronizationInfo AuthenticationInfoRequest::getResynchronizationInfo() const
{
    return m_ResynchronizationInfo;
}
void AuthenticationInfoRequest::setResynchronizationInfo(oai::model::ResynchronizationInfo const& value)
{
...
void AuthenticationInfoRequest::setCellCagInfo(std::vector<std::string> const& value)
{
    m_CellCagInfo = value;
