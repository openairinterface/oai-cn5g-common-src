...
std::vector<oai::_3gpp::model::IpEndPoint> ScpDomainInfo::getScpIpEndPoints() const
{
    return m_ScpIpEndPoints;
}
void ScpDomainInfo::setScpIpEndPoints(std::vector<oai::_3gpp::model::IpEndPoint> const& value)
{
