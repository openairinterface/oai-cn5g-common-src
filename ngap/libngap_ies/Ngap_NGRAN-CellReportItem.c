...
asn_TYPE_member_t asn_MBR_Ngap_NGRAN_CellReportItem_1[] = {
	{ ATF_POINTER, 0, offsetof(struct Ngap_NGRAN_CellReportItem, nGRAN_CGI),
	...
	{ ATF_POINTER, 0, offsetof(struct Ngap_NGRAN_CellReportItem, nGRAN_CompositeAvailableCapacityGroup),
