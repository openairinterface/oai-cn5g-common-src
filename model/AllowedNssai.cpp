...
bool AllowedNssai::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "AllowedNssai" : pathPrefix;

         
    
    /* AllowedSnssaiList */ {
        const std::vector<oai::_3gpp::model::AllowedSnssai>& value = m_AllowedSnssaiList;
        ...
        { // Recursive validation of array elements
            ...
            int i = 0;
            for (const oai::_3gpp::model::AllowedSnssai& value : value)
            { 
...
std::vector<oai::_3gpp::model::AllowedSnssai> AllowedNssai::getAllowedSnssaiList() const
{
    return m_AllowedSnssaiList;
}
void AllowedNssai::setAllowedSnssaiList(std::vector<oai::_3gpp::model::AllowedSnssai> const& value)
{
    m_AllowedSnssaiList = value;
}
oai::_3gpp::model::AccessType AllowedNssai::getAccessType() const
{
    return m_AccessType;
}
void AllowedNssai::setAccessType(oai::_3gpp::model::AccessType const& value)
{
    m_AccessType = value;
}
