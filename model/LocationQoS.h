...
public:
    ...
    /// 
    /// </summary>
    oai::model::ResponseTime getResponseTime() const;
    void setResponseTime(oai::model::ResponseTime const& value);
    bool responseTimeIsSet() const;
    void unsetResponseTime();
    /// <summary>
    /// 
    /// </summary>
    std::vector<oai::model::MinorLocationQoS> getMinorLocQoses() const;
    void setMinorLocQoses(std::vector<oai::model::MinorLocationQoS> const& value);
    bool minorLocQosesIsSet() const;
    void unsetMinorLocQoses();
    /// <summary>
    /// 
    /// </summary>
    oai::model::LcsQosClass getLcsQosClass() const;
    void setLcsQosClass(oai::model::LcsQosClass const& value);
...
protected:
    ...
    oai::model::ResponseTime m_ResponseTime;
    bool m_ResponseTimeIsSet;
    std::vector<oai::model::MinorLocationQoS> m_MinorLocQoses;
    bool m_MinorLocQosesIsSet;
    oai::model::LcsQosClass m_LcsQosClass;
