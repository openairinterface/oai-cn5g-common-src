...
public:
    ...
    /// 
    /// </summary>
    std::vector<oai::_3gpp::model::AlternativeQosProfile> getAlternativeQosProfileList() const;
    void setAlternativeQosProfileList(std::vector<oai::_3gpp::model::AlternativeQosProfile> const& value);
...
protected:
    ...
    std::vector<oai::_3gpp::model::AlternativeQosProfile> m_AlternativeQosProfileList;
