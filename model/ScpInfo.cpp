...
std::map<std::string, oai::_3gpp::model::ScpDomainInfo> ScpInfo::getScpDomainInfoList() const
{
    return m_ScpDomainInfoList;
}
void ScpInfo::setScpDomainInfoList(std::map<std::string, oai::_3gpp::model::ScpDomainInfo> const& value)
{
...
std::vector<oai::_3gpp::model::Ipv6Prefix> ScpInfo::getIpv6Prefixes() const
{
    return m_Ipv6Prefixes;
}
void ScpInfo::setIpv6Prefixes(std::vector<oai::_3gpp::model::Ipv6Prefix> const& value)
{
...
std::vector<oai::_3gpp::model::Ipv4AddressRange> ScpInfo::getIpv4AddrRanges() const
{
    return m_Ipv4AddrRanges;
}
void ScpInfo::setIpv4AddrRanges(std::vector<oai::_3gpp::model::Ipv4AddressRange> const& value)
{
...
std::vector<oai::_3gpp::model::Ipv6PrefixRange> ScpInfo::getIpv6PrefixRanges() const
{
    return m_Ipv6PrefixRanges;
}
void ScpInfo::setIpv6PrefixRanges(std::vector<oai::_3gpp::model::Ipv6PrefixRange> const& value)
{
...
std::vector<oai::_3gpp::model::PlmnId> ScpInfo::getRemotePlmnList() const
{
    return m_RemotePlmnList;
}
void ScpInfo::setRemotePlmnList(std::vector<oai::_3gpp::model::PlmnId> const& value)
{
...
std::vector<oai::_3gpp::model::PlmnIdNid> ScpInfo::getRemoteSnpnList() const
{
    return m_RemoteSnpnList;
}
void ScpInfo::setRemoteSnpnList(std::vector<oai::_3gpp::model::PlmnIdNid> const& value)
{
...
oai::_3gpp::model::IpReachability ScpInfo::getIpReachability() const
{
    return m_IpReachability;
}
void ScpInfo::setIpReachability(oai::_3gpp::model::IpReachability const& value)
{
...
std::vector<oai::_3gpp::model::ScpCapability> ScpInfo::getScpCapabilities() const
{
    return m_ScpCapabilities;
}
void ScpInfo::setScpCapabilities(std::vector<oai::_3gpp::model::ScpCapability> const& value)
{
