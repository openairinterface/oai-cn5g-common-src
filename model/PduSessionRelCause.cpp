...
PduSessionRelCause_anyOf::ePduSessionRelCause_anyOf PduSessionRelCause::getEnumValue() const
{
    return m_value.getValue();
}

void PduSessionRelCause::setEnumValue(PduSessionRelCause_anyOf::ePduSessionRelCause_anyOf  value)
{
