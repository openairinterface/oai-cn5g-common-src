...
std::vector<oai::_3gpp::model::SupiRange> ChfInfo::getSupiRangeList() const
{
    return m_SupiRangeList;
}
void ChfInfo::setSupiRangeList(std::vector<oai::_3gpp::model::SupiRange> const& value)
{
...
std::vector<oai::_3gpp::model::IdentityRange> ChfInfo::getGpsiRangeList() const
{
    return m_GpsiRangeList;
}
void ChfInfo::setGpsiRangeList(std::vector<oai::_3gpp::model::IdentityRange> const& value)
{
...
std::vector<oai::_3gpp::model::PlmnRange> ChfInfo::getPlmnRangeList() const
{
    return m_PlmnRangeList;
}
void ChfInfo::setPlmnRangeList(std::vector<oai::_3gpp::model::PlmnRange> const& value)
{
