...
//------------------------------------------------------------------------------
void ServiceRequest::Set5gSTmsi(uint16_t amf_set_id, uint8_t amf_pointer,
                                const std::string &tmsi) {
  ie_5g_s_tmsi_.Set5gSTmsi(amf_set_id, amf_pointer, tmsi);
}

//------------------------------------------------------------------------------
bool ServiceRequest::Get5gSTmsi(uint16_t &amf_set_id, uint8_t &amf_pointer,
...
int ServiceRequest::Encode(uint8_t *buf, int len) {
  ...
  oai::logger::logger_common::nas().debug("Encoded ServiceRequest message (%d)",
                                          encoded_size);
  return encoded_size;
}
