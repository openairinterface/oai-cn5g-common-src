...
public:
    ...
    /// </summary>
    std::vector<oai::_3gpp::model::PolicyDecisionFailureCode> getPolDecFailureReports() const;
    void setPolDecFailureReports(std::vector<oai::_3gpp::model::PolicyDecisionFailureCode> const& value);
...
protected:
    ...
    std::vector<oai::_3gpp::model::PolicyDecisionFailureCode> m_PolDecFailureReports;
