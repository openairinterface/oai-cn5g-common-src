...
/* Implementation */
extern asn_oer_constraints_t asn_OER_type_Ngap_EventType_constr_1;
...
cbor_type_decoder_f Ngap_EventType_decode_cbor;
cbor_type_encoder_f Ngap_EventType_encode_cbor;
