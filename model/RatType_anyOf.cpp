...
void to_json(nlohmann::json& j, const RatType_anyOf& o) {
  ...
  switch (o.getValue()) {
    ...
    case RatType_anyOf::eRatType_anyOf::NR_REDCAP:
      j = "NR_REDCAP";
      break;
    case RatType_anyOf::eRatType_anyOf::WB_E_UTRAN_LEO:
      j = "WB_E_UTRAN_LEO";
      break;
    case RatType_anyOf::eRatType_anyOf::WB_E_UTRAN_MEO:
      j = "WB_E_UTRAN_MEO";
      break;
    case RatType_anyOf::eRatType_anyOf::WB_E_UTRAN_GEO:
      j = "WB_E_UTRAN_GEO";
      break;
    case RatType_anyOf::eRatType_anyOf::WB_E_UTRAN_OTHERSAT:
      j = "WB_E_UTRAN_OTHERSAT";
      break;
    case RatType_anyOf::eRatType_anyOf::NB_IOT_LEO:
      j = "NB_IOT_LEO";
      break;
    case RatType_anyOf::eRatType_anyOf::NB_IOT_MEO:
      j = "NB_IOT_MEO";
      break;
    case RatType_anyOf::eRatType_anyOf::NB_IOT_GEO:
      j = "NB_IOT_GEO";
      break;
    case RatType_anyOf::eRatType_anyOf::NB_IOT_OTHERSAT:
      j = "NB_IOT_OTHERSAT";
      break;
    case RatType_anyOf::eRatType_anyOf::LTE_M_LEO:
      j = "LTE_M_LEO";
      break;
    case RatType_anyOf::eRatType_anyOf::LTE_M_MEO:
      j = "LTE_M_MEO";
      break;
    case RatType_anyOf::eRatType_anyOf::LTE_M_GEO:
      j = "LTE_M_GEO";
      break;
    case RatType_anyOf::eRatType_anyOf::LTE_M_OTHERSAT:
      j = "LTE_M_OTHERSAT";
      break;
  }
}
...
void from_json(const nlohmann::json& j, RatType_anyOf& o) {
  ...
  } else if (s == "WB_E_UTRAN_LEO") {
    o.setValue(RatType_anyOf::eRatType_anyOf::WB_E_UTRAN_LEO);
  } else if (s == "WB_E_UTRAN_MEO") {
    o.setValue(RatType_anyOf::eRatType_anyOf::WB_E_UTRAN_MEO);
  } else if (s == "WB_E_UTRAN_GEO") {
    o.setValue(RatType_anyOf::eRatType_anyOf::WB_E_UTRAN_GEO);
  } else if (s == "WB_E_UTRAN_OTHERSAT") {
    o.setValue(RatType_anyOf::eRatType_anyOf::WB_E_UTRAN_OTHERSAT);
  } else if (s == "NB_IOT_LEO") {
    o.setValue(RatType_anyOf::eRatType_anyOf::NB_IOT_LEO);
  } else if (s == "NB_IOT_MEO") {
    o.setValue(RatType_anyOf::eRatType_anyOf::NB_IOT_MEO);
  } else if (s == "NB_IOT_GEO") {
    o.setValue(RatType_anyOf::eRatType_anyOf::NB_IOT_GEO);
  } else if (s == "NB_IOT_OTHERSAT") {
    o.setValue(RatType_anyOf::eRatType_anyOf::NB_IOT_OTHERSAT);
  } else if (s == "LTE_M_LEO") {
    o.setValue(RatType_anyOf::eRatType_anyOf::LTE_M_LEO);
  } else if (s == "LTE_M_MEO") {
    o.setValue(RatType_anyOf::eRatType_anyOf::LTE_M_MEO);
  } else if (s == "LTE_M_GEO") {
    o.setValue(RatType_anyOf::eRatType_anyOf::LTE_M_GEO);
  } else if (s == "LTE_M_OTHERSAT") {
    o.setValue(RatType_anyOf::eRatType_anyOf::LTE_M_OTHERSAT);
  } else {
    std::stringstream ss;
