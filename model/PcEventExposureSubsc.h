...
public:
    ...
    /// 
    /// </summary>
    std::vector<oai::model::PcEvent> getEventSubs() const;
    void setEventSubs(std::vector<oai::model::PcEvent> const& value);
    /// <summary>
    /// 
    /// </summary>
    oai::model::ReportingInformation getEventsRepInfo() const;
    void setEventsRepInfo(oai::model::ReportingInformation const& value);
    ...
    /// 
    /// </summary>
    std::vector<oai::model::Snssai> getFilterSnssais() const;
    void setFilterSnssais(std::vector<oai::model::Snssai> const& value);
    bool filterSnssaisIsSet() const;
    void unsetFilterSnssais();
    /// <summary>
    /// 
    /// </summary>
    std::vector<oai::model::SnssaiDnnCombination> getSnssaiDnns() const;
    void setSnssaiDnns(std::vector<oai::model::SnssaiDnnCombination> const& value);
    bool snssaiDnnsIsSet() const;
    void unsetSnssaiDnns();
    /// <summary>
    /// 
    /// </summary>
    std::vector<oai::model::ServiceIdentification> getFilterServices() const;
    void setFilterServices(std::vector<oai::model::ServiceIdentification> const& value);
    ...
    /// 
    /// </summary>
    std::vector<oai::model::PcEventNotification> getEventNotifs() const;
    void setEventNotifs(std::vector<oai::model::PcEventNotification> const& value);
...
protected:
    std::vector<oai::model::PcEvent> m_EventSubs;

    oai::model::ReportingInformation m_EventsRepInfo;
    bool m_EventsRepInfoIsSet;
    std::string m_GroupId;
    bool m_GroupIdIsSet;
    std::vector<std::string> m_FilterDnns;
    bool m_FilterDnnsIsSet;
    std::vector<oai::model::Snssai> m_FilterSnssais;
    bool m_FilterSnssaisIsSet;
    std::vector<oai::model::SnssaiDnnCombination> m_SnssaiDnns;
    bool m_SnssaiDnnsIsSet;
    std::vector<oai::model::ServiceIdentification> m_FilterServices;
    bool m_FilterServicesIsSet;
    std::string m_NotifUri;

    std::string m_NotifId;

    std::vector<oai::model::PcEventNotification> m_EventNotifs;
