...
bool LoggingIntervalMdt_anyOf::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "LoggingIntervalMdt_anyOf" : pathPrefix;

    
    if (m_value == LoggingIntervalMdt_anyOf::eLoggingIntervalMdt_anyOf::INVALID_VALUE_OPENAPI_GENERATED)
    {
        success = false;
...
bool LoggingIntervalMdt_anyOf::operator==(const LoggingIntervalMdt_anyOf& rhs) const
{
    return
...
void to_json(nlohmann::json& j, const LoggingIntervalMdt_anyOf& o)
{
    ...
    switch (o.getValue())
    {
        case LoggingIntervalMdt_anyOf::eLoggingIntervalMdt_anyOf::INVALID_VALUE_OPENAPI_GENERATED:
...
LoggingIntervalMdt_anyOf::eLoggingIntervalMdt_anyOf LoggingIntervalMdt_anyOf::getValue() const
{
    return m_value;
}
void LoggingIntervalMdt_anyOf::setValue(LoggingIntervalMdt_anyOf::eLoggingIntervalMdt_anyOf value)
{
    m_value = value;
}
