...
asn_TYPE_member_t asn_MBR_Ngap_AdditionalDLUPTNLInformationForHOItem_1[] = {
    ...
    {ATF_POINTER,
     1,
     offsetof(struct Ngap_AdditionalDLUPTNLInformationForHOItem, iE_Extensions),
     (ASN_TAG_CLASS_CONTEXT | (3 << 2)),
     -1, /* IMPLICIT tag at current level */
     &asn_DEF_Ngap_ProtocolExtensionContainer_12929P0,
     0,
     {
#if !defined(ASN_DISABLE_OER_SUPPORT)
         0,
...
static const int asn_MAP_Ngap_AdditionalDLUPTNLInformationForHOItem_oms_1[] = {
    2, 3};
...
static const asn_TYPE_tag2member_t
    asn_MAP_Ngap_AdditionalDLUPTNLInformationForHOItem_tag2el_1[] = {
        {(ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0,
         0}, /* additionalDL-NGU-UP-TNLInformation */
        {(ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0,
         0}, /* additionalQosFlowSetupResponseList */
        {(ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0,
         0}, /* additionalDLForwardingUPTNLInformation */
        {(ASN_TAG_CLASS_CONTEXT | (3 << 2)), 3, 0, 0} /* iE-Extensions */
};
asn_SEQUENCE_specifics_t
    asn_SPC_Ngap_AdditionalDLUPTNLInformationForHOItem_specs_1 = {
        ...
        asn_MAP_Ngap_AdditionalDLUPTNLInformationForHOItem_oms_1, /* Optional
                                                                     members */
        2,
        0, /* Root/Additions */
...
asn_TYPE_descriptor_t asn_DEF_Ngap_AdditionalDLUPTNLInformationForHOItem = {
    ...
    sizeof(asn_DEF_Ngap_AdditionalDLUPTNLInformationForHOItem_tags_1) /
        sizeof(
            asn_DEF_Ngap_AdditionalDLUPTNLInformationForHOItem_tags_1[0]), /* 1
                                                                            */
    ...
    4, /* Elements count */
    &asn_SPC_Ngap_AdditionalDLUPTNLInformationForHOItem_specs_1 /* Additional
                                                                   specs */
};
