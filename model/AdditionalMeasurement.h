...
public:
    ...
    void setUnexpFlowTeps(std::vector<oai::_3gpp::model::IpEthFlowDescription> const& value);
    ...
    void setCircums(std::vector<oai::_3gpp::model::CircumstanceDescription> const& value);
