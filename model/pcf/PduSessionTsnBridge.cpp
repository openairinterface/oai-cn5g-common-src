...
void PduSessionTsnBridge::setTsnBridgeInfo(oai::model::pcf::TsnBridgeInfo const& value)
{
    m_TsnBridgeInfo = value;
}
oai::model::pcf::BridgeManagementContainer PduSessionTsnBridge::getTsnBridgeManCont() const
{
    return m_TsnBridgeManCont;
}
void PduSessionTsnBridge::setTsnBridgeManCont(oai::model::pcf::BridgeManagementContainer const& value)
{
...
oai::model::pcf::PortManagementContainer PduSessionTsnBridge::getTsnPortManContDstt() const
{
    return m_TsnPortManContDstt;
}
void PduSessionTsnBridge::setTsnPortManContDstt(oai::model::pcf::PortManagementContainer const& value)
{
...
std::vector<oai::model::pcf::PortManagementContainer> PduSessionTsnBridge::getTsnPortManContNwtts() const
{
    return m_TsnPortManContNwtts;
}
void PduSessionTsnBridge::setTsnPortManContNwtts(std::vector<oai::model::pcf::PortManagementContainer> const& value)
{
...
void PduSessionTsnBridge::setUeIpv6AddrPrefix(oai::model::pcf::Ipv6Prefix const& value)
{
