...
bool QosMonitoringData::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "QosMonitoringData" : pathPrefix;
    ...
    /* RepFreqs */ {
        const std::vector<oai::_3gpp::model::ReportingFrequency>& value = m_RepFreqs;
        ...
        { // Recursive validation of array elements
            const std::string oldValuePath = currentValuePath;
            int i = 0;
            for (const oai::_3gpp::model::ReportingFrequency& value : value)
            { 
                const std::string currentValuePath = oldValuePath + "[" + std::to_string(i) + "]";
                        
        success = value.validate(msg, currentValuePath + ".repFreqs") && success;
...
bool QosMonitoringData::operator==(const QosMonitoringData& rhs) const
{
    ...
    ((!repThreshDlIsSet() && !rhs.repThreshDlIsSet()) || (repThreshDlIsSet() && rhs.repThreshDlIsSet() && getRepThreshDl() == rhs.getRepThreshDl())) &&
    
    
    ((!repThreshUlIsSet() && !rhs.repThreshUlIsSet()) || (repThreshUlIsSet() && rhs.repThreshUlIsSet() && getRepThreshUl() == rhs.getRepThreshUl())) &&
    
    
    ((!repThreshRpIsSet() && !rhs.repThreshRpIsSet()) || (repThreshRpIsSet() && rhs.repThreshRpIsSet() && getRepThreshRp() == rhs.getRepThreshRp())) &&
    ...
    ((!notifyCorreIdIsSet() && !rhs.notifyCorreIdIsSet()) || (notifyCorreIdIsSet() && rhs.notifyCorreIdIsSet() && getNotifyCorreId() == rhs.getNotifyCorreId())) &&
...
std::vector<oai::_3gpp::model::RequestedQosMonitoringParameter> QosMonitoringData::getReqQosMonParams() const
{
    return m_ReqQosMonParams;
}
void QosMonitoringData::setReqQosMonParams(std::vector<oai::_3gpp::model::RequestedQosMonitoringParameter> const& value)
{
    m_ReqQosMonParams = value;
}
std::vector<oai::_3gpp::model::ReportingFrequency> QosMonitoringData::getRepFreqs() const
{
    return m_RepFreqs;
}
void QosMonitoringData::setRepFreqs(std::vector<oai::_3gpp::model::ReportingFrequency> const& value)
{
    m_RepFreqs = value;
}
...
bool QosMonitoringData::isDirectNotifInd() const
{
...
void QosMonitoringData::unsetDirectNotifInd()
{
    m_DirectNotifIndIsSet = false;
}
