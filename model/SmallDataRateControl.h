...
public:
    ...
    /// 
    /// </summary>
    oai::model::SmallDataRateControlTimeUnit getTimeUnit() const;
    void setTimeUnit(oai::model::SmallDataRateControlTimeUnit const& value);
    /// <summary>
    /// 
    /// </summary>
...
protected:
    oai::model::SmallDataRateControlTimeUnit m_TimeUnit;
