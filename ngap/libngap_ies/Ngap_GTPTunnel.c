...
asn_TYPE_member_t asn_MBR_Ngap_GTPTunnel_1[] = {
    {ATF_NOFLAGS,
     0,
     offsetof(struct Ngap_GTPTunnel, transportLayerAddress),
    ...
    {ATF_NOFLAGS,
     0,
     offsetof(struct Ngap_GTPTunnel, gTP_TEID),
    ...
    {ATF_POINTER,
     1,
     offsetof(struct Ngap_GTPTunnel, iE_Extensions),
     (ASN_TAG_CLASS_CONTEXT | (2 << 2)),
     -1, /* IMPLICIT tag at current level */
     &asn_DEF_Ngap_ProtocolExtensionContainer_12929P106,
     0,
     {
#if !defined(ASN_DISABLE_OER_SUPPORT)
         0,
