...
asn_TYPE_member_t asn_MBR_Ngap_GUAMI_1[] = {
    {ATF_NOFLAGS,
     0,
     offsetof(struct Ngap_GUAMI, pLMNIdentity),
    ...
    {ATF_NOFLAGS,
     0,
     offsetof(struct Ngap_GUAMI, aMFRegionID),
    ...
    {ATF_NOFLAGS,
     0,
     offsetof(struct Ngap_GUAMI, aMFSetID),
    ...
    {ATF_NOFLAGS,
     0,
     offsetof(struct Ngap_GUAMI, aMFPointer),
    ...
    {ATF_POINTER,
     1,
     offsetof(struct Ngap_GUAMI, iE_Extensions),
     (ASN_TAG_CLASS_CONTEXT | (4 << 2)),
     -1, /* IMPLICIT tag at current level */
     &asn_DEF_Ngap_ProtocolExtensionContainer_12929P107,
     0,
     {
#if !defined(ASN_DISABLE_OER_SUPPORT)
         0,
