...
public:
  ...
  void Set5gsRegistrationResult(bool emergency, bool nssaa, bool sms,
                                uint8_t value);
  // TODO: Get
  ...
  void SetPduSessionReactivationResultErrorCause(uint8_t session_id,
                                                 uint8_t value);
  // TODO: Get
...
private:
  ...
  std::optional<GprsTimer2> ie_non_3gpp_deregistration_timer_value_; // Optional
  ...
  std::optional<Non3gppNwProvidedPolicies> ie_non_3gpp_nw_policies_; // Optional
