...
bool NFService::validate(
    std::stringstream& msg, const std::string& pathPrefix) const {
  bool success                  = true;
  const std::string _pathPrefix = pathPrefix.empty() ? "NFService" : pathPrefix;

  /* Versions */ {
    const std::vector<oai::_3gpp::model::NFServiceVersion>& value = m_Versions;
    ...
    {  // Recursive validation of array elements
      ...
      int i                          = 0;
      for (const oai::_3gpp::model::NFServiceVersion& value : value) {
        const std::string currentValuePath =
            oldValuePath + "[" + std::to_string(i) + "]";

        success =
            value.validate(msg, currentValuePath + ".versions") && success;
  ...
  if (ipEndPointsIsSet()) {
    const std::vector<oai::_3gpp::model::IpEndPoint>& value = m_IpEndPoints;
    ...
    {  // Recursive validation of array elements
      ...
      for (const oai::_3gpp::model::IpEndPoint& value : value) {
        ...
        success =
            value.validate(msg, currentValuePath + ".ipEndPoints") && success;
  ...
  if (allowedOperationsPerNfTypeIsSet()) {
    const std::map<std::string, std::vector<std::string>>& value =
        m_AllowedOperationsPerNfType;
    const std::string currentValuePath =
        _pathPrefix + ".allowedOperationsPerNfType";
  }
  ...
  if (allowedOperationsPerNfInstanceIsSet()) {
    ...
    const std::string currentValuePath =
        _pathPrefix + ".allowedOperationsPerNfInstance";
  }
...
bool NFService::operator==(const NFService& rhs) const {
  return
      ...
      ((!ipEndPointsIsSet() && !rhs.ipEndPointsIsSet()) ||
       (ipEndPointsIsSet() && rhs.ipEndPointsIsSet() &&
        getIpEndPoints() == rhs.getIpEndPoints())) &&

      ((!apiPrefixIsSet() && !rhs.apiPrefixIsSet()) ||
       (apiPrefixIsSet() && rhs.apiPrefixIsSet() &&
        getApiPrefix() == rhs.getApiPrefix())) &&
      ...
      ((!allowedOperationsPerNfTypeIsSet() &&
        !rhs.allowedOperationsPerNfTypeIsSet()) ||
       (allowedOperationsPerNfTypeIsSet() &&
        rhs.allowedOperationsPerNfTypeIsSet() &&
        getAllowedOperationsPerNfType() ==
            rhs.getAllowedOperationsPerNfType())) &&

      ((!allowedOperationsPerNfInstanceIsSet() &&
        !rhs.allowedOperationsPerNfInstanceIsSet()) ||
       (allowedOperationsPerNfInstanceIsSet() &&
        rhs.allowedOperationsPerNfInstanceIsSet() &&
        getAllowedOperationsPerNfInstance() ==
            rhs.getAllowedOperationsPerNfInstance())) &&
      ...
      ((!nfServiceSetIdListIsSet() && !rhs.nfServiceSetIdListIsSet()) ||
       (nfServiceSetIdListIsSet() && rhs.nfServiceSetIdListIsSet() &&
        getNfServiceSetIdList() == rhs.getNfServiceSetIdList())) &&
      ...
      ((!oauth2RequiredIsSet() && !rhs.oauth2RequiredIsSet()) ||
       (oauth2RequiredIsSet() && rhs.oauth2RequiredIsSet() &&
        isOauth2Required() == rhs.isOauth2Required())) &&

      ((!perPlmnOauth2ReqListIsSet() && !rhs.perPlmnOauth2ReqListIsSet()) ||
       (perPlmnOauth2ReqListIsSet() && rhs.perPlmnOauth2ReqListIsSet() &&
        getPerPlmnOauth2ReqList() == rhs.getPerPlmnOauth2ReqList()))
...
void to_json(nlohmann::json& j, const NFService& o) {
  ...
  if (o.oauth2RequiredIsSet()) j["oauth2Required"] = o.m_Oauth2Required;
...
oai::_3gpp::model::ServiceName NFService::getServiceName() const {
  return m_ServiceName;
}
void NFService::setServiceName(oai::_3gpp::model::ServiceName const& value) {
  m_ServiceName = value;
}
std::vector<oai::_3gpp::model::NFServiceVersion> NFService::getVersions()
    const {
  return m_Versions;
}
void NFService::setVersions(
    std::vector<oai::_3gpp::model::NFServiceVersion> const& value) {
  m_Versions = value;
}
oai::_3gpp::model::UriScheme NFService::getScheme() const {
  return m_Scheme;
}
void NFService::setScheme(oai::_3gpp::model::UriScheme const& value) {
  m_Scheme = value;
}
oai::_3gpp::model::NFServiceStatus NFService::getNfServiceStatus() const {
  return m_NfServiceStatus;
}
void NFService::setNfServiceStatus(
    oai::_3gpp::model::NFServiceStatus const& value) {
...
std::vector<oai::_3gpp::model::IpEndPoint> NFService::getIpEndPoints() const {
  return m_IpEndPoints;
}
void NFService::setIpEndPoints(
...
NFService::getDefaultNotificationSubscriptions() const {
...
std::vector<oai::_3gpp::model::PlmnId> NFService::getAllowedPlmns() const {
  return m_AllowedPlmns;
}
void NFService::setAllowedPlmns(
...
std::vector<oai::_3gpp::model::PlmnIdNid> NFService::getAllowedSnpns() const {
  return m_AllowedSnpns;
}
void NFService::setAllowedSnpns(
...
std::vector<oai::_3gpp::model::NFType> NFService::getAllowedNfTypes() const {
  return m_AllowedNfTypes;
}
void NFService::setAllowedNfTypes(
...
std::vector<oai::_3gpp::model::ExtSnssai> NFService::getAllowedNssais() const {
  return m_AllowedNssais;
}
void NFService::setAllowedNssais(
...
NFService::getAllowedOperationsPerNfType() const {
...
std::map<std::string, std::vector<std::string>>
NFService::getAllowedOperationsPerNfInstance() const {
...
std::vector<oai::_3gpp::model::ExtSnssai> NFService::getSNssais() const {
  return m_SNssais;
}
void NFService::setSNssais(
    std::vector<oai::_3gpp::model::ExtSnssai> const& value) {
  m_SNssais      = value;
  m_SNssaisIsSet = true;
}
...
std::vector<oai::_3gpp::model::PlmnSnssai> NFService::getPerPlmnSnssaiList()
    const {
  return m_PerPlmnSnssaiList;
}
void NFService::setPerPlmnSnssaiList(
...
NFService::getSupportedVendorSpecificFeatures() const {
...
oai::_3gpp::model::PlmnOauth2 NFService::getPerPlmnOauth2ReqList() const {
  return m_PerPlmnOauth2ReqList;
}
void NFService::setPerPlmnOauth2ReqList(
    oai::_3gpp::model::PlmnOauth2 const& value) {
