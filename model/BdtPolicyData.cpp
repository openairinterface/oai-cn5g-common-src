...
bool BdtPolicyData::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    ...
    /* TransfPolicies */ {
        const std::vector<oai::_3gpp::model::TransferPolicy>& value = m_TransfPolicies;
...
std::vector<oai::_3gpp::model::TransferPolicy> BdtPolicyData::getTransfPolicies() const
{
    return m_TransfPolicies;
}
void BdtPolicyData::setTransfPolicies(std::vector<oai::_3gpp::model::TransferPolicy> const& value)
{
