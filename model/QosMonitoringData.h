...
public:
    ...
    /// 
    /// </summary>
    std::vector<oai::_3gpp::model::ReportingFrequency> getRepFreqs() const;
    void setRepFreqs(std::vector<oai::_3gpp::model::ReportingFrequency> const& value);
    /// <summary>
...
protected:
    ...
    std::vector<oai::_3gpp::model::ReportingFrequency> m_RepFreqs;
