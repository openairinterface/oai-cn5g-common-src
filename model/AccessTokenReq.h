...
public:
    ...
    void setRequesterPlmnList(std::vector<oai::_3gpp::model::PlmnId> const& value);
    ...
    void setRequesterSnssaiList(std::vector<oai::_3gpp::model::Snssai> const& value);
    ...
    void setRequesterSnpnList(std::vector<oai::_3gpp::model::PlmnIdNid> const& value);
