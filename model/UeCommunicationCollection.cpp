...
bool UeCommunicationCollection::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    ...
    /* Comms */ {
        const std::vector<oai::_3gpp::model::CommunicationCollection>& value = m_Comms;
...
std::vector<oai::_3gpp::model::CommunicationCollection> UeCommunicationCollection::getComms() const
{
    return m_Comms;
}
void UeCommunicationCollection::setComms(std::vector<oai::_3gpp::model::CommunicationCollection> const& value)
{
    m_Comms = value;
}
