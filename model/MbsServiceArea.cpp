...
bool MbsServiceArea::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    ...
    if (ncgiListIsSet())
    {
        const std::vector<oai::model::NcgiTai>& value = m_NcgiList;
        ...
        { // Recursive validation of array elements
            ...
            int i = 0;
            for (const oai::model::NcgiTai& value : value)
            { 
...
std::vector<oai::model::NcgiTai> MbsServiceArea::getNcgiList() const
{
    return m_NcgiList;
}
void MbsServiceArea::setNcgiList(std::vector<oai::model::NcgiTai> const& value)
{
    m_NcgiList = value;
...
std::vector<oai::model::Tai> MbsServiceArea::getTaiList() const
{
    return m_TaiList;
}
void MbsServiceArea::setTaiList(std::vector<oai::model::Tai> const& value)
{
    m_TaiList = value;
    m_TaiListIsSet = true;
}
