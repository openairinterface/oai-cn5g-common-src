...
void V2xSubscriptionData::setNrV2xServicesAuth(oai::_3gpp::model::NrV2xAuth const& value)
{
...
oai::_3gpp::model::LteV2xAuth V2xSubscriptionData::getLteV2xServicesAuth() const
{
    return m_LteV2xServicesAuth;
}
void V2xSubscriptionData::setLteV2xServicesAuth(oai::_3gpp::model::LteV2xAuth const& value)
{
