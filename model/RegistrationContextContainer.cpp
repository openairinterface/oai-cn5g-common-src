...
oai::_3gpp::model::UeContext RegistrationContextContainer::getUeContext() const
{
    return m_UeContext;
}
void RegistrationContextContainer::setUeContext(oai::_3gpp::model::UeContext const& value)
{
    m_UeContext = value;
}
...
void RegistrationContextContainer::setAnType(oai::_3gpp::model::AccessType const& value)
{
    m_AnType = value;
}
...
oai::_3gpp::model::GlobalRanNodeId RegistrationContextContainer::getRanNodeId() const
{
    return m_RanNodeId;
}
void RegistrationContextContainer::setRanNodeId(oai::_3gpp::model::GlobalRanNodeId const& value)
{
    m_RanNodeId = value;
}
...
oai::_3gpp::model::UserLocation RegistrationContextContainer::getUserLocation() const
{
    return m_UserLocation;
}
void RegistrationContextContainer::setUserLocation(oai::_3gpp::model::UserLocation const& value)
{
...
oai::_3gpp::model::Ipv6Addr RegistrationContextContainer::getAnN2IPv6Addr() const
{
    return m_AnN2IPv6Addr;
}
void RegistrationContextContainer::setAnN2IPv6Addr(oai::_3gpp::model::Ipv6Addr const& value)
{
...
oai::_3gpp::model::AllowedNssai RegistrationContextContainer::getAllowedNssai() const
{
    return m_AllowedNssai;
}
void RegistrationContextContainer::setAllowedNssai(oai::_3gpp::model::AllowedNssai const& value)
{
...
std::vector<oai::_3gpp::model::ConfiguredSnssai> RegistrationContextContainer::getConfiguredNssai() const
{
    return m_ConfiguredNssai;
}
void RegistrationContextContainer::setConfiguredNssai(std::vector<oai::_3gpp::model::ConfiguredSnssai> const& value)
{
...
std::vector<oai::_3gpp::model::Snssai> RegistrationContextContainer::getRejectedNssaiInPlmn() const
{
    return m_RejectedNssaiInPlmn;
}
void RegistrationContextContainer::setRejectedNssaiInPlmn(std::vector<oai::_3gpp::model::Snssai> const& value)
{
...
std::vector<oai::_3gpp::model::Snssai> RegistrationContextContainer::getRejectedNssaiInTa() const
{
    return m_RejectedNssaiInTa;
}
void RegistrationContextContainer::setRejectedNssaiInTa(std::vector<oai::_3gpp::model::Snssai> const& value)
{
...
oai::_3gpp::model::PlmnId RegistrationContextContainer::getSelectedPlmnId() const
{
    return m_SelectedPlmnId;
}
void RegistrationContextContainer::setSelectedPlmnId(oai::_3gpp::model::PlmnId const& value)
{
...
oai::_3gpp::model::CeModeBInd RegistrationContextContainer::getCeModeBInd() const
{
    return m_CeModeBInd;
}
void RegistrationContextContainer::setCeModeBInd(oai::_3gpp::model::CeModeBInd const& value)
{
    m_CeModeBInd = value;
...
void RegistrationContextContainer::setLteMInd(oai::_3gpp::model::LteMInd const& value)
{
    m_LteMInd = value;
    m_LteMIndIsSet = true;
}
...
oai::_3gpp::model::NpnAccessInfo RegistrationContextContainer::getNpnAccessInfo() const
{
    return m_NpnAccessInfo;
}
void RegistrationContextContainer::setNpnAccessInfo(oai::_3gpp::model::NpnAccessInfo const& value)
{
