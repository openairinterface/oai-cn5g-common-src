...
bool TrafficInfluData::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    ...
    {
        const std::vector<oai::_3gpp::model::EthFlowDescription>& value = m_EthTrafficFilters;
    ...
    {
        const std::vector<oai::_3gpp::model::RouteToLocation>& value = m_TrafficRoutes;
    ...
    {
        const std::vector<oai::_3gpp::model::TemporalValidity>& value = m_TempValidities;
    ...
    {
        const std::vector<oai::_3gpp::model::SubscribedEvent>& value = m_SubscribedEvents;
...
std::vector<oai::_3gpp::model::EthFlowDescription> TrafficInfluData::getEthTrafficFilters() const
{
    return m_EthTrafficFilters;
}
void TrafficInfluData::setEthTrafficFilters(std::vector<oai::_3gpp::model::EthFlowDescription> const& value)
{
...
std::vector<oai::_3gpp::model::FlowInfo> TrafficInfluData::getTrafficFilters() const
{
    return m_TrafficFilters;
}
void TrafficInfluData::setTrafficFilters(std::vector<oai::_3gpp::model::FlowInfo> const& value)
{
...
std::vector<oai::_3gpp::model::RouteToLocation> TrafficInfluData::getTrafficRoutes() const
{
    return m_TrafficRoutes;
}
void TrafficInfluData::setTrafficRoutes(std::vector<oai::_3gpp::model::RouteToLocation> const& value)
{
...
std::vector<oai::_3gpp::model::TemporalValidity> TrafficInfluData::getTempValidities() const
{
    return m_TempValidities;
}
void TrafficInfluData::setTempValidities(std::vector<oai::_3gpp::model::TemporalValidity> const& value)
{
...
void TrafficInfluData::setNwAreaInfo(oai::_3gpp::model::NetworkAreaInfo_2 const& value)
{
    m_NwAreaInfo = value;
...
std::vector<oai::_3gpp::model::SubscribedEvent> TrafficInfluData::getSubscribedEvents() const
{
    return m_SubscribedEvents;
}
void TrafficInfluData::setSubscribedEvents(std::vector<oai::_3gpp::model::SubscribedEvent> const& value)
{
...
void TrafficInfluData::setDnaiChgType(oai::_3gpp::model::DnaiChangeType const& value)
{
    m_DnaiChgType = value;
