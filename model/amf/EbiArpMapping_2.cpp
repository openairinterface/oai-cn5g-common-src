...
EbiArpMapping_2::EbiArpMapping_2() { m_EpsBearerId = 0; }
...
int32_t EbiArpMapping_2::getEpsBearerId() const { return m_EpsBearerId; }
void EbiArpMapping_2::setEpsBearerId(int32_t const value) {
  m_EpsBearerId = value;
}
oai::model::common::Arp EbiArpMapping_2::getArp() const { return m_Arp; }
