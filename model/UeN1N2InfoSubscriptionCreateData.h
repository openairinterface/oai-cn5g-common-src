...
public:
    ...
    friend  void to_json(nlohmann::json& j, const UeN1N2InfoSubscriptionCreateData& o);
    friend  void from_json(const nlohmann::json& j, UeN1N2InfoSubscriptionCreateData& o);
protected:
