...
oai::_3gpp::model::RuleStatus RuleReport::getRuleStatus() const
{
    return m_RuleStatus;
}
void RuleReport::setRuleStatus(oai::_3gpp::model::RuleStatus const& value)
{
    m_RuleStatus = value;
}
...
oai::_3gpp::model::FailureCode RuleReport::getFailureCode() const
{
    return m_FailureCode;
}
void RuleReport::setFailureCode(oai::_3gpp::model::FailureCode const& value)
{
    m_FailureCode = value;
...
oai::_3gpp::model::FinalUnitAction RuleReport::getFinUnitAct() const
{
    return m_FinUnitAct;
}
void RuleReport::setFinUnitAct(oai::_3gpp::model::FinalUnitAction const& value)
{
    m_FinUnitAct = value;
...
std::vector<oai::_3gpp::model::RanNasRelCause> RuleReport::getRanNasRelCauses() const
{
    return m_RanNasRelCauses;
}
void RuleReport::setRanNasRelCauses(std::vector<oai::_3gpp::model::RanNasRelCause> const& value)
{
