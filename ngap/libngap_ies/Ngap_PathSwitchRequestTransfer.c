...
static asn_TYPE_member_t asn_MBR_Ngap_PathSwitchRequestTransfer_1[] = {
    {ATF_POINTER,
     0,
     offsetof(struct Ngap_PathSwitchRequestTransfer, dL_NGU_UP_TNLInformation),
    ...
    {ATF_POINTER,
     0,
     offsetof(struct Ngap_PathSwitchRequestTransfer, qosFlowAcceptedList),
    ...
    {ATF_POINTER,
     1,
     offsetof(struct Ngap_PathSwitchRequestTransfer, iE_Extensions),
     (ASN_TAG_CLASS_CONTEXT | (4 << 2)),
     -1, /* IMPLICIT tag at current level */
     &asn_DEF_Ngap_ProtocolExtensionContainer_12929P209,
     0,
     {
#if !defined(ASN_DISABLE_OER_SUPPORT)
         0,
...
static const asn_TYPE_tag2member_t
    asn_MAP_Ngap_PathSwitchRequestTransfer_tag2el_1[] = {
        ...
        {(ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0,
         0}, /* dL-NGU-TNLInformationReused */
        {(ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0,
         0}, /* userPlaneSecurityInformation */
