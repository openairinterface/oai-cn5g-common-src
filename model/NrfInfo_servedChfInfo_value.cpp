...
bool NrfInfo_servedChfInfo_value::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    ...
    {
        const std::vector<oai::_3gpp::model::IdentityRange>& value = m_GpsiRangeList;
...
std::vector<oai::_3gpp::model::SupiRange> NrfInfo_servedChfInfo_value::getSupiRangeList() const
{
    return m_SupiRangeList;
}
void NrfInfo_servedChfInfo_value::setSupiRangeList(std::vector<oai::_3gpp::model::SupiRange> const& value)
{
...
std::vector<oai::_3gpp::model::IdentityRange> NrfInfo_servedChfInfo_value::getGpsiRangeList() const
{
    return m_GpsiRangeList;
}
void NrfInfo_servedChfInfo_value::setGpsiRangeList(std::vector<oai::_3gpp::model::IdentityRange> const& value)
{
...
std::vector<oai::_3gpp::model::PlmnRange> NrfInfo_servedChfInfo_value::getPlmnRangeList() const
{
    return m_PlmnRangeList;
}
void NrfInfo_servedChfInfo_value::setPlmnRangeList(std::vector<oai::_3gpp::model::PlmnRange> const& value)
{
