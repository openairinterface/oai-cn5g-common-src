...
public:
    ...
    /// 
    /// </summary>
    oai::model::N1N2MessageTransferCause getCause() const;
    void setCause(oai::model::N1N2MessageTransferCause const& value);
    /// <summary>
    ...
    friend  void to_json(nlohmann::json& j, const N1N2MsgTxfrFailureNotification& o);
    friend  void from_json(const nlohmann::json& j, N1N2MsgTxfrFailureNotification& o);
protected:
    oai::model::N1N2MessageTransferCause m_Cause;
