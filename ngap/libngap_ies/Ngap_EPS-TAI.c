...
asn_TYPE_member_t asn_MBR_Ngap_EPS_TAI_1[] = {
    {ATF_NOFLAGS,
     0,
     offsetof(struct Ngap_EPS_TAI, pLMNIdentity),
    ...
    {ATF_NOFLAGS,
     0,
     offsetof(struct Ngap_EPS_TAI, ePS_TAC),
    ...
    {ATF_POINTER,
     1,
     offsetof(struct Ngap_EPS_TAI, iE_Extensions),
     (ASN_TAG_CLASS_CONTEXT | (2 << 2)),
     -1, /* IMPLICIT tag at current level */
     &asn_DEF_Ngap_ProtocolExtensionContainer_12929P75,
     0,
     {
#if !defined(ASN_DISABLE_OER_SUPPORT)
         0,
