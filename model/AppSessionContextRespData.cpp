...
bool AppSessionContextRespData::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    ...
    if (ueIdsIsSet())
    {
        const std::vector<oai::model::UeIdentityInfo>& value = m_UeIds;
        ...
        { // Recursive validation of array elements
            ...
            int i = 0;
            for (const oai::model::UeIdentityInfo& value : value)
            { 
...
oai::model::ServAuthInfo AppSessionContextRespData::getServAuthInfo() const
{
    return m_ServAuthInfo;
}
void AppSessionContextRespData::setServAuthInfo(oai::model::ServAuthInfo const& value)
{
...
std::vector<oai::model::UeIdentityInfo> AppSessionContextRespData::getUeIds() const
{
    return m_UeIds;
}
void AppSessionContextRespData::setUeIds(std::vector<oai::model::UeIdentityInfo> const& value)
{
    m_UeIds = value;
    m_UeIdsIsSet = true;
}
