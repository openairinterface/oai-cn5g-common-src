...
bool NrfInfo_servedLmfInfo_value::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "NrfInfo_servedLmfInfo_value" : pathPrefix;

         
    if (servingClientTypesIsSet())
    {
        const std::vector<oai::model::ExternalClientType>& value = m_ServingClientTypes;
        ...
        { // Recursive validation of array elements
            ...
            int i = 0;
            for (const oai::model::ExternalClientType& value : value)
            { 
    ...
    {
        const std::vector<oai::model::AccessType>& value = m_ServingAccessTypes;
    ...
    {
        const std::vector<oai::model::AnNodeType>& value = m_ServingAnNodeTypes;
        ...
        { // Recursive validation of array elements
            const std::string oldValuePath = currentValuePath;
            int i = 0;
            for (const oai::model::AnNodeType& value : value)
            { 
                const std::string currentValuePath = oldValuePath + "[" + std::to_string(i) + "]";
    ...
    {
        const std::vector<oai::model::RatType>& value = m_ServingRatTypes;
...
bool NrfInfo_servedLmfInfo_value::operator==(const NrfInfo_servedLmfInfo_value& rhs) const
{
    return
...
std::vector<oai::model::ExternalClientType> NrfInfo_servedLmfInfo_value::getServingClientTypes() const
{
    return m_ServingClientTypes;
}
void NrfInfo_servedLmfInfo_value::setServingClientTypes(std::vector<oai::model::ExternalClientType> const& value)
{
...
std::vector<oai::model::AccessType> NrfInfo_servedLmfInfo_value::getServingAccessTypes() const
{
    return m_ServingAccessTypes;
}
void NrfInfo_servedLmfInfo_value::setServingAccessTypes(std::vector<oai::model::AccessType> const& value)
{
...
std::vector<oai::model::AnNodeType> NrfInfo_servedLmfInfo_value::getServingAnNodeTypes() const
{
    return m_ServingAnNodeTypes;
}
void NrfInfo_servedLmfInfo_value::setServingAnNodeTypes(std::vector<oai::model::AnNodeType> const& value)
{
...
std::vector<oai::model::RatType> NrfInfo_servedLmfInfo_value::getServingRatTypes() const
{
    return m_ServingRatTypes;
}
void NrfInfo_servedLmfInfo_value::setServingRatTypes(std::vector<oai::model::RatType> const& value)
{
...
std::vector<oai::model::Tai> NrfInfo_servedLmfInfo_value::getTaiList() const
{
    return m_TaiList;
}
void NrfInfo_servedLmfInfo_value::setTaiList(std::vector<oai::model::Tai> const& value)
{
    m_TaiList = value;
    m_TaiListIsSet = true;
}
...
std::vector<oai::model::TaiRange> NrfInfo_servedLmfInfo_value::getTaiRangeList() const
{
    return m_TaiRangeList;
}
void NrfInfo_servedLmfInfo_value::setTaiRangeList(std::vector<oai::model::TaiRange> const& value)
{
...
std::vector<oai::model::SupportedGADShapes> NrfInfo_servedLmfInfo_value::getSupportedGADShapes() const
{
    return m_SupportedGADShapes;
}
void NrfInfo_servedLmfInfo_value::setSupportedGADShapes(std::vector<oai::model::SupportedGADShapes> const& value)
{
