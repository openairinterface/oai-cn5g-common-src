...
void NwdafInfo::setTaiRangeList(
...
void NwdafInfo::setNwdafCapability(
...
void NwdafInfo::setServingNfTypeList(
...
std::vector<oai::_3gpp::model::MlAnalyticsInfo> NwdafInfo::getMlAnalyticsList()
    const {
  return m_MlAnalyticsList;
}
void NwdafInfo::setMlAnalyticsList(
