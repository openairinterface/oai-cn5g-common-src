...
bool CagData::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
...
std::map<std::string, oai::model::CagInfo> CagData::getCagInfos() const
{
    return m_CagInfos;
}
void CagData::setCagInfos(std::map<std::string, oai::model::CagInfo> const& value)
{
    m_CagInfos = value;
}
