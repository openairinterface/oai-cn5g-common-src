...
public:
    ...
    /// </summary>
    std::map<std::string, oai::model::EpsIwkPgw> getEpsIwkPgws() const;
    void setEpsIwkPgws(std::map<std::string, oai::model::EpsIwkPgw> const& value);
...
protected:
    std::map<std::string, oai::model::EpsIwkPgw> m_EpsIwkPgws;
