...
bool PointAltitudeUncertainty::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "PointAltitudeUncertainty" : pathPrefix;
...
bool PointAltitudeUncertainty::operator==(const PointAltitudeUncertainty& rhs) const
{
    return
...
oai::model::SupportedGADShapes PointAltitudeUncertainty::getShape() const
{
    return m_Shape;
}
void PointAltitudeUncertainty::setShape(oai::model::SupportedGADShapes const& value)
{
    m_Shape = value;
}
oai::model::GeographicalCoordinates PointAltitudeUncertainty::getPoint() const
{
    return m_Point;
}
void PointAltitudeUncertainty::setPoint(oai::model::GeographicalCoordinates const& value)
{
    m_Point = value;
}
...
oai::model::UncertaintyEllipse PointAltitudeUncertainty::getUncertaintyEllipse() const
{
    return m_UncertaintyEllipse;
}
void PointAltitudeUncertainty::setUncertaintyEllipse(oai::model::UncertaintyEllipse const& value)
{
...
int32_t PointAltitudeUncertainty::getVConfidence() const
{
    return m_VConfidence;
}
void PointAltitudeUncertainty::setVConfidence(int32_t const value)
{
    m_VConfidence = value;
    m_VConfidenceIsSet = true;
}
bool PointAltitudeUncertainty::vConfidenceIsSet() const
{
    return m_VConfidenceIsSet;
}
void PointAltitudeUncertainty::unsetVConfidence()
{
    m_VConfidenceIsSet = false;
}
