...
oai::_3gpp::model::StringMatchingRule FqdnPatternMatchingRule::getStringMatchingRule() const
{
    return m_StringMatchingRule;
}
void FqdnPatternMatchingRule::setStringMatchingRule(oai::_3gpp::model::StringMatchingRule const& value)
{
