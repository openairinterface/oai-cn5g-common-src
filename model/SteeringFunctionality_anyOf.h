...
public:
    ...
    void setValue(SteeringFunctionality_anyOf::eSteeringFunctionality_anyOf value);
    
    friend void to_json(nlohmann::json& j, const SteeringFunctionality_anyOf& o);
    friend void from_json(const nlohmann::json& j, SteeringFunctionality_anyOf& o);
protected:
    SteeringFunctionality_anyOf::eSteeringFunctionality_anyOf m_value = SteeringFunctionality_anyOf::eSteeringFunctionality_anyOf::INVALID_VALUE_OPENAPI_GENERATED;
};
