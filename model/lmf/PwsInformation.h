...
public:
  ...
  ///
  /// </summary>
  oai::model::lmf::N2InfoContent getPwsContainer() const;
  void setPwsContainer(oai::model::lmf::N2InfoContent const &value);
  /// <summary>
  ///
  /// </summary>
...
protected:
  ...
  oai::model::lmf::N2InfoContent m_PwsContainer;
