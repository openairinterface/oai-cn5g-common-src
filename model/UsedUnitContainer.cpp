...
bool UsedUnitContainer::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "UsedUnitContainer" : pathPrefix;
    ...
    {
        const std::vector<oai::_3gpp::model::std::string>& value = m_EventTimeStamps;
...
bool UsedUnitContainer::operator==(const UsedUnitContainer& rhs) const
{
    ...
    ((!serviceSpecificUnitsIsSet() && !rhs.serviceSpecificUnitsIsSet()) || (serviceSpecificUnitsIsSet() && rhs.serviceSpecificUnitsIsSet() && getServiceSpecificUnits() == rhs.getServiceSpecificUnits())) &&
    
    
    ((!eventTimeStampsIsSet() && !rhs.eventTimeStampsIsSet()) || (eventTimeStampsIsSet() && rhs.eventTimeStampsIsSet() && getEventTimeStamps() == rhs.getEventTimeStamps())) &&
    
    (getLocalSequenceNumber() == rhs.getLocalSequenceNumber())
     &&
    
    
    ((!pDUContainerInformationIsSet() && !rhs.pDUContainerInformationIsSet()) || (pDUContainerInformationIsSet() && rhs.pDUContainerInformationIsSet() && getPDUContainerInformation() == rhs.getPDUContainerInformation()))
...
void UsedUnitContainer::setTriggers(std::vector<oai::_3gpp::model::Trigger> const& value)
{
    m_Triggers = value;
...
std::vector<oai::_3gpp::model::std::string> UsedUnitContainer::getEventTimeStamps() const
{
    return m_EventTimeStamps;
}
void UsedUnitContainer::setEventTimeStamps(std::vector<oai::_3gpp::model::std::string> const& value)
{
...
oai::_3gpp::model::PDUContainerInformation UsedUnitContainer::getPDUContainerInformation() const
{
    return m_PDUContainerInformation;
}
void UsedUnitContainer::setPDUContainerInformation(oai::_3gpp::model::PDUContainerInformation const& value)
{
