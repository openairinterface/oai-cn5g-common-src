...
asn_TYPE_member_t asn_MBR_Ngap_QosFlowPerTNLInformation_1[] = {
	{ ATF_POINTER, 0, offsetof(struct Ngap_QosFlowPerTNLInformation, uPTransportLayerInformation),
	...
	{ ATF_POINTER, 0, offsetof(struct Ngap_QosFlowPerTNLInformation, associatedQosFlowList),
