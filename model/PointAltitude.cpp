...
oai::_3gpp::model::SupportedGADShapes PointAltitude::getShape() const
{
    return m_Shape;
}
void PointAltitude::setShape(oai::_3gpp::model::SupportedGADShapes const& value)
{
    m_Shape = value;
}
oai::_3gpp::model::GeographicalCoordinates PointAltitude::getPoint() const
{
    return m_Point;
}
void PointAltitude::setPoint(oai::_3gpp::model::GeographicalCoordinates const& value)
{
    m_Point = value;
}
