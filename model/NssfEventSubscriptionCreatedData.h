...
public:
    ...
    /// 
    /// </summary>
    std::vector<oai::_3gpp::model::AuthorizedNssaiAvailabilityData> getAuthorizedNssaiAvailabilityData() const;
    void setAuthorizedNssaiAvailabilityData(std::vector<oai::_3gpp::model::AuthorizedNssaiAvailabilityData> const& value);
    ...
    friend void to_json(nlohmann::json& j, const NssfEventSubscriptionCreatedData& o);
    friend void from_json(const nlohmann::json& j, NssfEventSubscriptionCreatedData& o);
protected:
    std::string m_SubscriptionId;

    std::string m_Expiry;
    bool m_ExpiryIsSet;
    std::vector<oai::_3gpp::model::AuthorizedNssaiAvailabilityData> m_AuthorizedNssaiAvailabilityData;
