...
public:
    ...
    /// 
    /// </summary>
    std::vector<oai::model::AccessTech> getAccessTechList() const;
    void setAccessTechList(std::vector<oai::model::AccessTech> const& value);
...
protected:
    ...
    std::vector<oai::model::AccessTech> m_AccessTechList;
