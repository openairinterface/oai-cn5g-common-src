...
public:
    ...
    ExpectedAnalyticsType_anyOf::eExpectedAnalyticsType_anyOf getEnumValue() const;
    void setEnumValue(ExpectedAnalyticsType_anyOf::eExpectedAnalyticsType_anyOf value);
