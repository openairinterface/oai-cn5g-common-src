...
bool SubscriptionData::validate(
  ...
  if (reqNotifEventsIsSet()) {
    const std::vector<oai::_3gpp::model::NotificationEventType>& value =
        m_ReqNotifEvents;
    ...
    {  // Recursive validation of array elements
      ...
      for (const oai::_3gpp::model::NotificationEventType& value : value) {
        ...
        success = value.validate(msg, currentValuePath + ".reqNotifEvents") &&
                  success;
  ...
  if (reqSnssaisIsSet()) {
    ...
    {  // Recursive validation of array elements
      ...
      for (const oai::_3gpp::model::ExtSnssai& value : value) {
        ...
        success =
            value.validate(msg, currentValuePath + ".reqSnssais") && success;
  ...
  if (reqPerPlmnSnssaisIsSet()) {
    ...
    {  // Recursive validation of array elements
      ...
      for (const oai::_3gpp::model::PlmnSnssai& value : value) {
        ...
        success =
            value.validate(msg, currentValuePath + ".reqPerPlmnSnssais") &&
            success;
  ...
  if (reqPlmnListIsSet()) {
    ...
    {  // Recursive validation of array elements
      ...
      for (const oai::_3gpp::model::PlmnId& value : value) {
        ...
        success =
            value.validate(msg, currentValuePath + ".reqPlmnList") && success;
  ...
  if (reqSnpnListIsSet()) {
    ...
    {  // Recursive validation of array elements
      ...
      for (const oai::_3gpp::model::PlmnIdNid& value : value) {
        ...
        success =
            value.validate(msg, currentValuePath + ".reqSnpnList") && success;
...
bool SubscriptionData::operator==(const SubscriptionData& rhs) const {
  return
      ...
      ((!reqNfInstanceIdIsSet() && !rhs.reqNfInstanceIdIsSet()) ||
       (reqNfInstanceIdIsSet() && rhs.reqNfInstanceIdIsSet() &&
        getReqNfInstanceId() == rhs.getReqNfInstanceId())) &&
      ...
      ((!reqNotifEventsIsSet() && !rhs.reqNotifEventsIsSet()) ||
       (reqNotifEventsIsSet() && rhs.reqNotifEventsIsSet() &&
        getReqNotifEvents() == rhs.getReqNotifEvents())) &&
      ...
      ((!notifConditionIsSet() && !rhs.notifConditionIsSet()) ||
       (notifConditionIsSet() && rhs.notifConditionIsSet() &&
        getNotifCondition() == rhs.getNotifCondition())) &&

      ((!reqNfTypeIsSet() && !rhs.reqNfTypeIsSet()) ||
       (reqNfTypeIsSet() && rhs.reqNfTypeIsSet() &&
        getReqNfType() == rhs.getReqNfType())) &&

      ((!reqNfFqdnIsSet() && !rhs.reqNfFqdnIsSet()) ||
       (reqNfFqdnIsSet() && rhs.reqNfFqdnIsSet() &&
        getReqNfFqdn() == rhs.getReqNfFqdn())) &&

      ((!reqSnssaisIsSet() && !rhs.reqSnssaisIsSet()) ||
       (reqSnssaisIsSet() && rhs.reqSnssaisIsSet() &&
        getReqSnssais() == rhs.getReqSnssais())) &&

      ((!reqPerPlmnSnssaisIsSet() && !rhs.reqPerPlmnSnssaisIsSet()) ||
       (reqPerPlmnSnssaisIsSet() && rhs.reqPerPlmnSnssaisIsSet() &&
        getReqPerPlmnSnssais() == rhs.getReqPerPlmnSnssais())) &&

      ((!reqPlmnListIsSet() && !rhs.reqPlmnListIsSet()) ||
       (reqPlmnListIsSet() && rhs.reqPlmnListIsSet() &&
        getReqPlmnList() == rhs.getReqPlmnList())) &&

      ((!reqSnpnListIsSet() && !rhs.reqSnpnListIsSet()) ||
       (reqSnpnListIsSet() && rhs.reqSnpnListIsSet() &&
        getReqSnpnList() == rhs.getReqSnpnList())) &&

      ((!servingScopeIsSet() && !rhs.servingScopeIsSet()) ||
       (servingScopeIsSet() && rhs.servingScopeIsSet() &&
        getServingScope() == rhs.getServingScope())) &&

      ((!requesterFeaturesIsSet() && !rhs.requesterFeaturesIsSet()) ||
       (requesterFeaturesIsSet() && rhs.requesterFeaturesIsSet() &&
        getRequesterFeatures() == rhs.getRequesterFeatures())) &&

      ((!nrfSupportedFeaturesIsSet() && !rhs.nrfSupportedFeaturesIsSet()) ||
       (nrfSupportedFeaturesIsSet() && rhs.nrfSupportedFeaturesIsSet() &&
        getNrfSupportedFeatures() == rhs.getNrfSupportedFeatures())) &&

      ((!hnrfUriIsSet() && !rhs.hnrfUriIsSet()) ||
       (hnrfUriIsSet() && rhs.hnrfUriIsSet() &&
        getHnrfUri() == rhs.getHnrfUri())) &&

      ((!onboardingCapabilityIsSet() && !rhs.onboardingCapabilityIsSet()) ||
       (onboardingCapabilityIsSet() && rhs.onboardingCapabilityIsSet() &&
        isOnboardingCapability() == rhs.isOnboardingCapability())) &&

      ((!targetHniIsSet() && !rhs.targetHniIsSet()) ||
       (targetHniIsSet() && rhs.targetHniIsSet() &&
        getTargetHni() == rhs.getTargetHni())) &&

      ((!preferredLocalityIsSet() && !rhs.preferredLocalityIsSet()) ||
       (preferredLocalityIsSet() && rhs.preferredLocalityIsSet() &&
        getPreferredLocality() == rhs.getPreferredLocality()))
...
void to_json(nlohmann::json& j, const SubscriptionData& o) {
  ...
  if (o.hnrfUriIsSet()) j["hnrfUri"] = o.m_HnrfUri;
  if (o.onboardingCapabilityIsSet())
    j["onboardingCapability"] = o.m_OnboardingCapability;
  if (o.targetHniIsSet()) j["targetHni"] = o.m_TargetHni;
...
std::vector<oai::_3gpp::model::NotificationEventType>
SubscriptionData::getReqNotifEvents() const {
  return m_ReqNotifEvents;
}
void SubscriptionData::setReqNotifEvents(
    std::vector<oai::_3gpp::model::NotificationEventType> const& value) {
...
void SubscriptionData::setNotifCondition(
    oai::_3gpp::model::NotifCondition const& value) {
...
std::vector<oai::_3gpp::model::ExtSnssai> SubscriptionData::getReqSnssais()
    const {
  return m_ReqSnssais;
}
void SubscriptionData::setReqSnssais(
...
std::vector<oai::_3gpp::model::PlmnSnssai>
SubscriptionData::getReqPerPlmnSnssais() const {
  return m_ReqPerPlmnSnssais;
}
void SubscriptionData::setReqPerPlmnSnssais(
...
std::vector<oai::_3gpp::model::PlmnId> SubscriptionData::getReqPlmnList()
    const {
  return m_ReqPlmnList;
}
void SubscriptionData::setReqPlmnList(
...
std::vector<oai::_3gpp::model::PlmnIdNid> SubscriptionData::getReqSnpnList()
    const {
  return m_ReqSnpnList;
}
void SubscriptionData::setReqSnpnList(
