...
static int memb_Ngap_dayofWeek_constraint_1(
...
static int memb_Ngap_timeofDayStart_constraint_1(
    const asn_TYPE_descriptor_t* td, const void* sptr,
    asn_app_constraint_failed_f* ctfailcb, void* app_key) {
  long value;
...
static int memb_Ngap_timeofDayEnd_constraint_1(
    const asn_TYPE_descriptor_t* td, const void* sptr,
    asn_app_constraint_failed_f* ctfailcb, void* app_key) {
  long value;
...
asn_TYPE_member_t asn_MBR_Ngap_ScheduledCommunicationTime_1[] = {
    {ATF_POINTER,
     4,
     offsetof(struct Ngap_ScheduledCommunicationTime, dayofWeek),
    ...
    {ATF_POINTER,
     3,
     offsetof(struct Ngap_ScheduledCommunicationTime, timeofDayStart),
    ...
    {ATF_POINTER,
     2,
     offsetof(struct Ngap_ScheduledCommunicationTime, timeofDayEnd),
    ...
    {ATF_POINTER,
     1,
     offsetof(struct Ngap_ScheduledCommunicationTime, iE_Extensions),
     (ASN_TAG_CLASS_CONTEXT | (3 << 2)),
     -1, /* IMPLICIT tag at current level */
     &asn_DEF_Ngap_ProtocolExtensionContainer_12929P295,
     0,
     {
#if !defined(ASN_DISABLE_OER_SUPPORT)
         0,
