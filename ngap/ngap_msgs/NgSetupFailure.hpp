...
public:
  ...
  void set(const e_Ngap_CauseRadioNetwork &causeValue,
           const e_Ngap_TimeToWait &timeToWait);
  void set(const e_Ngap_CauseTransport &causeValue,
           const e_Ngap_TimeToWait &timeToWait);
  void set(const e_Ngap_CauseNas &causeValue,
           const e_Ngap_TimeToWait &timeToWait);
  void set(const e_Ngap_CauseProtocol &causeValue,
           const e_Ngap_TimeToWait &timeToWait);
  void set(const e_Ngap_CauseMisc &causeValue,
           const e_Ngap_TimeToWait &timeToWait);
