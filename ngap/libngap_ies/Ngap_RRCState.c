...
asn_oer_constraints_t asn_OER_type_Ngap_RRCState_constr_1 CC_NOTUSED = {
	{ 0, 0 },
	-1};
...
static int asn_validate_Ngap_RRCState_1(const asn_TYPE_descriptor_t *td,
                       const void *sptr,
                       asn_app_constraint_failed_f *ctfailcb,
                       void* app_key) {
    if(! sptr) { return -1; }
    e_Ngap_RRCState value = *(e_Ngap_RRCState*)sptr;
    switch(value) {
    case Ngap_RRCState_inactive:
    case Ngap_RRCState_connected:
        return 0;
    }
    return -1;
}
