...
std::vector<oai::_3gpp::model::NFServiceVersion> NFService::getVersions() const
{
    return m_Versions;
}
void NFService::setVersions(std::vector<oai::_3gpp::model::NFServiceVersion> const& value)
{
    m_Versions = value;
}
...
void NFService::setNfServiceStatus(oai::_3gpp::model::NFServiceStatus const& value)
{
...
void NFService::setIpEndPoints(std::vector<oai::_3gpp::model::IpEndPoint> const& value)
{
    m_IpEndPoints = value;
...
std::vector<oai::_3gpp::model::DefaultNotificationSubscription> NFService::getDefaultNotificationSubscriptions() const
{
    return m_DefaultNotificationSubscriptions;
}
void NFService::setDefaultNotificationSubscriptions(std::vector<oai::_3gpp::model::DefaultNotificationSubscription> const& value)
{
...
void NFService::setAllowedPlmns(std::vector<oai::_3gpp::model::PlmnId> const& value)
{
...
void NFService::setAllowedSnpns(std::vector<oai::_3gpp::model::PlmnIdNid> const& value)
{
...
void NFService::setAllowedNfTypes(std::vector<oai::_3gpp::model::NFType> const& value)
{
...
void NFService::setAllowedNssais(std::vector<oai::_3gpp::model::ExtSnssai> const& value)
{
...
void NFService::setSNssais(std::vector<oai::_3gpp::model::ExtSnssai> const& value)
{
    m_SNssais = value;
    m_SNssaisIsSet = true;
}
...
std::vector<oai::_3gpp::model::PlmnSnssai> NFService::getPerPlmnSnssaiList() const
{
    return m_PerPlmnSnssaiList;
}
void NFService::setPerPlmnSnssaiList(std::vector<oai::_3gpp::model::PlmnSnssai> const& value)
{
...
std::map<std::string, std::vector<oai::_3gpp::model::VendorSpecificFeature>> NFService::getSupportedVendorSpecificFeatures() const
{
    return m_SupportedVendorSpecificFeatures;
}
void NFService::setSupportedVendorSpecificFeatures(std::map<std::string, std::vector<oai::_3gpp::model::VendorSpecificFeature>> const& value)
{
...
void NFService::setPerPlmnOauth2ReqList(oai::_3gpp::model::PlmnOauth2 const& value)
{
