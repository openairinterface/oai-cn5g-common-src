...
bool NotifiedPosInfo::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "NotifiedPosInfo" : pathPrefix;

        
    if (!m_LocationEvent.validate(msg, _pathPrefix + ".locationEvent")) {
        msg << _pathPrefix << ": LocationEvent is invalid;";
        success = false;
    }     
    if (supiIsSet())
    {
...
bool NotifiedPosInfo::operator==(const NotifiedPosInfo& rhs) const
{
    ...
    ((!servingNodeIsSet() && !rhs.servingNodeIsSet()) || (servingNodeIsSet() && rhs.servingNodeIsSet() && getServingNode() == rhs.getServingNode())) &&
    ...
    ((!mscServerIdIsSet() && !rhs.mscServerIdIsSet()) || (mscServerIdIsSet() && rhs.mscServerIdIsSet() && getMscServerId() == rhs.getMscServerId())) &&
...
void to_json(nlohmann::json& j, const NotifiedPosInfo& o)
{
    ...
    if(o.mscServerIdIsSet())
        j["mscServerId"] = o.m_MscServerId;
...
oai::model::LocationEvent NotifiedPosInfo::getLocationEvent() const
{
    return m_LocationEvent;
}
void NotifiedPosInfo::setLocationEvent(oai::model::LocationEvent const& value)
{
...
oai::model::GeographicArea NotifiedPosInfo::getLocationEstimate() const
{
    return m_LocationEstimate;
}
void NotifiedPosInfo::setLocationEstimate(oai::model::GeographicArea const& value)
{
...
oai::model::LocalArea NotifiedPosInfo::getLocalLocationEstimate() const
{
    return m_LocalLocationEstimate;
}
void NotifiedPosInfo::setLocalLocationEstimate(oai::model::LocalArea const& value)
{
...
oai::model::VelocityEstimate NotifiedPosInfo::getVelocityEstimate() const
{
    return m_VelocityEstimate;
}
void NotifiedPosInfo::setVelocityEstimate(oai::model::VelocityEstimate const& value)
{
...
std::vector<oai::model::PositioningMethodAndUsage> NotifiedPosInfo::getPositioningDataList() const
{
    return m_PositioningDataList;
}
void NotifiedPosInfo::setPositioningDataList(std::vector<oai::model::PositioningMethodAndUsage> const& value)
{
...
std::vector<oai::model::GnssPositioningMethodAndUsage> NotifiedPosInfo::getGnssPositioningDataList() const
{
    return m_GnssPositioningDataList;
}
void NotifiedPosInfo::setGnssPositioningDataList(std::vector<oai::model::GnssPositioningMethodAndUsage> const& value)
{
...
oai::model::Ecgi NotifiedPosInfo::getEcgi() const
{
    return m_Ecgi;
}
void NotifiedPosInfo::setEcgi(oai::model::Ecgi const& value)
{
    m_Ecgi = value;
    m_EcgiIsSet = true;
}
...
oai::model::Ncgi NotifiedPosInfo::getNcgi() const
{
    return m_Ncgi;
}
void NotifiedPosInfo::setNcgi(oai::model::Ncgi const& value)
{
    m_Ncgi = value;
    m_NcgiIsSet = true;
}
...
oai::model::CivicAddress NotifiedPosInfo::getCivicAddress() const
{
    return m_CivicAddress;
}
void NotifiedPosInfo::setCivicAddress(oai::model::CivicAddress const& value)
{
...
oai::model::TerminationCause NotifiedPosInfo::getTerminationCause() const
{
    return m_TerminationCause;
}
void NotifiedPosInfo::setTerminationCause(oai::model::TerminationCause const& value)
{
...
oai::model::MinorLocationQoS NotifiedPosInfo::getAchievedQos() const
{
    return m_AchievedQos;
}
void NotifiedPosInfo::setAchievedQos(oai::model::MinorLocationQoS const& value)
{
    m_AchievedQos = value;
...
oai::model::HighAccuracyGnssMetrics NotifiedPosInfo::getHaGnssMetrics() const
{
    return m_HaGnssMetrics;
}
void NotifiedPosInfo::setHaGnssMetrics(oai::model::HighAccuracyGnssMetrics const& value)
{
