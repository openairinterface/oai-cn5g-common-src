...
static asn_TYPE_member_t asn_MBR_Ngap_HandoverRequestAcknowledgeTransfer_1[] = {
	{ ATF_POINTER, 0, offsetof(struct Ngap_HandoverRequestAcknowledgeTransfer, dL_NGU_UP_TNLInformation),
	...
	{ ATF_POINTER, 0, offsetof(struct Ngap_HandoverRequestAcknowledgeTransfer, qosFlowSetupResponseList),
