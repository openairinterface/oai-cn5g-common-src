...
bool SmPolicyNotification::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "SmPolicyNotification" : pathPrefix;
...
bool SmPolicyNotification::operator==(const SmPolicyNotification& rhs) const
{
    ...
    ((!resourceUriIsSet() && !rhs.resourceUriIsSet()) || (resourceUriIsSet() && rhs.resourceUriIsSet() && getResourceUri() == rhs.getResourceUri())) &&
    
    
    ((!smPolicyDecisionIsSet() && !rhs.smPolicyDecisionIsSet()) || (smPolicyDecisionIsSet() && rhs.smPolicyDecisionIsSet() && getSmPolicyDecision() == rhs.getSmPolicyDecision()))
...
oai::_3gpp::model::SmPolicyDecision SmPolicyNotification::getSmPolicyDecision() const
{
    return m_SmPolicyDecision;
}
void SmPolicyNotification::setSmPolicyDecision(oai::_3gpp::model::SmPolicyDecision const& value)
{
