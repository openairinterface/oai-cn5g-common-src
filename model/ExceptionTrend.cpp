...
bool ExceptionTrend::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "ExceptionTrend" : pathPrefix;
...
ExceptionTrend_anyOf::eExceptionTrend_anyOf ExceptionTrend::getEnumValue() const
{
    return m_value.getValue();
}

void ExceptionTrend::setEnumValue(ExceptionTrend_anyOf::eExceptionTrend_anyOf  value)
{
