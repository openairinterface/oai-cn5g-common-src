...
bool EasdfInfo::validate(
  ...
  if (sNssaiEasdfInfoListIsSet()) {
    ...
    {  // Recursive validation of array elements
      ...
      int i                          = 0;
      for (const oai::_3gpp::model::SnssaiEasdfInfoItem& value : value) {
        const std::string currentValuePath =
            oldValuePath + "[" + std::to_string(i) + "]";

        success =
            value.validate(msg, currentValuePath + ".sNssaiEasdfInfoList") &&
            success;
  ...
  if (easdfN6IpAddressListIsSet()) {
    const std::vector<oai::_3gpp::model::IpAddr>& value =
        m_EasdfN6IpAddressList;
    ...
    {  // Recursive validation of array elements
      ...
      for (const oai::_3gpp::model::IpAddr& value : value) {
        ...
        success =
            value.validate(msg, currentValuePath + ".easdfN6IpAddressList") &&
            success;
  ...
  if (upfN6IpAddressListIsSet()) {
    const std::vector<oai::_3gpp::model::IpAddr>& value = m_UpfN6IpAddressList;
    ...
    {  // Recursive validation of array elements
      ...
      for (const oai::_3gpp::model::IpAddr& value : value) {
        ...
        success =
            value.validate(msg, currentValuePath + ".upfN6IpAddressList") &&
            success;
...
bool EasdfInfo::operator==(const EasdfInfo& rhs) const {
  return
      ...
      ((!sNssaiEasdfInfoListIsSet() && !rhs.sNssaiEasdfInfoListIsSet()) ||
       (sNssaiEasdfInfoListIsSet() && rhs.sNssaiEasdfInfoListIsSet() &&
        getSNssaiEasdfInfoList() == rhs.getSNssaiEasdfInfoList())) &&

      ((!easdfN6IpAddressListIsSet() && !rhs.easdfN6IpAddressListIsSet()) ||
       (easdfN6IpAddressListIsSet() && rhs.easdfN6IpAddressListIsSet() &&
        getEasdfN6IpAddressList() == rhs.getEasdfN6IpAddressList())) &&

      ((!upfN6IpAddressListIsSet() && !rhs.upfN6IpAddressListIsSet()) ||
       (upfN6IpAddressListIsSet() && rhs.upfN6IpAddressListIsSet() &&
        getUpfN6IpAddressList() == rhs.getUpfN6IpAddressList()))
...
std::vector<oai::_3gpp::model::SnssaiEasdfInfoItem>
EasdfInfo::getSNssaiEasdfInfoList() const {
  return m_SNssaiEasdfInfoList;
}
void EasdfInfo::setSNssaiEasdfInfoList(
    std::vector<oai::_3gpp::model::SnssaiEasdfInfoItem> const& value) {
...
std::vector<oai::_3gpp::model::IpAddr> EasdfInfo::getEasdfN6IpAddressList()
    const {
  return m_EasdfN6IpAddressList;
}
void EasdfInfo::setEasdfN6IpAddressList(
...
std::vector<oai::_3gpp::model::IpAddr> EasdfInfo::getUpfN6IpAddressList()
    const {
  return m_UpfN6IpAddressList;
}
void EasdfInfo::setUpfN6IpAddressList(
    std::vector<oai::_3gpp::model::IpAddr> const& value) {
