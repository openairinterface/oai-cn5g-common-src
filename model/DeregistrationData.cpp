...
oai::_3gpp::model::DeregistrationReason DeregistrationData::getDeregReason() const
{
    return m_DeregReason;
}
void DeregistrationData::setDeregReason(oai::_3gpp::model::DeregistrationReason const& value)
{
    m_DeregReason = value;
}
...
void DeregistrationData::setAccessType(oai::_3gpp::model::AccessType const& value)
{
    m_AccessType = value;
