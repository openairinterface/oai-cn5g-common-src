...
ScpInfo::getScpDomainInfoList() const {
...
std::vector<oai::_3gpp::model::Ipv4AddressRange> ScpInfo::getIpv4AddrRanges()
    const {
  return m_Ipv4AddrRanges;
}
void ScpInfo::setIpv4AddrRanges(
...
std::vector<oai::_3gpp::model::Ipv6PrefixRange> ScpInfo::getIpv6PrefixRanges()
    const {
  return m_Ipv6PrefixRanges;
}
void ScpInfo::setIpv6PrefixRanges(
...
void ScpInfo::setRemotePlmnList(
...
void ScpInfo::setRemoteSnpnList(
...
void ScpInfo::setIpReachability(
...
std::vector<oai::_3gpp::model::ScpCapability> ScpInfo::getScpCapabilities()
    const {
  return m_ScpCapabilities;
}
void ScpInfo::setScpCapabilities(
