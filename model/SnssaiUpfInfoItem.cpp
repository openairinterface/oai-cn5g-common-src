...
bool SnssaiUpfInfoItem::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    ...
    /* DnnUpfInfoList */ {
        const std::vector<oai::_3gpp::model::DnnUpfInfoItem>& value = m_DnnUpfInfoList;
...
std::vector<oai::_3gpp::model::DnnUpfInfoItem> SnssaiUpfInfoItem::getDnnUpfInfoList() const
{
    return m_DnnUpfInfoList;
}
void SnssaiUpfInfoItem::setDnnUpfInfoList(std::vector<oai::_3gpp::model::DnnUpfInfoItem> const& value)
{
