...
asn_TYPE_member_t asn_MBR_Ngap_TooearlyIntersystemHO_1[] = {
    {ATF_POINTER,
     0,
     offsetof(struct Ngap_TooearlyIntersystemHO, sourcecellID),
    ...
    {ATF_POINTER,
     0,
     offsetof(struct Ngap_TooearlyIntersystemHO, failurecellID),
    ...
    {ATF_POINTER,
     2,
     offsetof(struct Ngap_TooearlyIntersystemHO, uERLFReportContainer),
    ...
    {ATF_POINTER,
     1,
     offsetof(struct Ngap_TooearlyIntersystemHO, iE_Extensions),
     (ASN_TAG_CLASS_CONTEXT | (3 << 2)),
     -1, /* IMPLICIT tag at current level */
     &asn_DEF_Ngap_ProtocolExtensionContainer_12929P338,
     0,
     {
#if !defined(ASN_DISABLE_OER_SUPPORT)
         0,
