...
void AssignEbiData::setArpList(std::vector<oai::_3gpp::model::Arp> const& value)
{
    m_ArpList = value;
    m_ArpListIsSet = true;
}
...
std::vector<oai::_3gpp::model::EbiArpMapping> AssignEbiData::getModifiedEbiList() const
{
    return m_ModifiedEbiList;
}
void AssignEbiData::setModifiedEbiList(std::vector<oai::_3gpp::model::EbiArpMapping> const& value)
{
