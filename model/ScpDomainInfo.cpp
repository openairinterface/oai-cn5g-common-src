...
bool ScpDomainInfo::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    ...
    {
        const std::vector<oai::model::IpEndPoint>& value = m_ScpIpEndPoints;
...
std::vector<oai::model::IpEndPoint> ScpDomainInfo::getScpIpEndPoints() const
{
    return m_ScpIpEndPoints;
}
void ScpDomainInfo::setScpIpEndPoints(std::vector<oai::model::IpEndPoint> const& value)
{
