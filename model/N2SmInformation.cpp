...
oai::model::N2InfoContent N2SmInformation::getN2InfoContent() const
{
    return m_N2InfoContent;
}
void N2SmInformation::setN2InfoContent(oai::model::N2InfoContent const& value)
{
...
oai::model::Snssai N2SmInformation::getSNssai() const
{
    return m_SNssai;
}
void N2SmInformation::setSNssai(oai::model::Snssai const& value)
{
    m_SNssai = value;
    m_SNssaiIsSet = true;
}
...
oai::model::Snssai N2SmInformation::getHomePlmnSnssai() const
{
    return m_HomePlmnSnssai;
}
void N2SmInformation::setHomePlmnSnssai(oai::model::Snssai const& value)
{
...
oai::model::Snssai N2SmInformation::getIwkSnssai() const
{
    return m_IwkSnssai;
}
void N2SmInformation::setIwkSnssai(oai::model::Snssai const& value)
{
    m_IwkSnssai = value;
