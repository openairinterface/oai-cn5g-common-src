...
bool LoggingDurationMdt_anyOf::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "LoggingDurationMdt_anyOf" : pathPrefix;

    
    if (m_value == LoggingDurationMdt_anyOf::eLoggingDurationMdt_anyOf::INVALID_VALUE_OPENAPI_GENERATED)
    {
        success = false;
...
bool LoggingDurationMdt_anyOf::operator==(const LoggingDurationMdt_anyOf& rhs) const
{
    return
...
void to_json(nlohmann::json& j, const LoggingDurationMdt_anyOf& o)
{
    ...
    switch (o.getValue())
    {
        case LoggingDurationMdt_anyOf::eLoggingDurationMdt_anyOf::INVALID_VALUE_OPENAPI_GENERATED:
...
LoggingDurationMdt_anyOf::eLoggingDurationMdt_anyOf LoggingDurationMdt_anyOf::getValue() const
{
    return m_value;
}
void LoggingDurationMdt_anyOf::setValue(LoggingDurationMdt_anyOf::eLoggingDurationMdt_anyOf value)
{
    m_value = value;
}
