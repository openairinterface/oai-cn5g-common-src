...
std::map<std::string, oai::_3gpp::model::MulticastAccessControl> IptvConfigDataPatch::getMultiAccCtrls() const
{
    return m_MultiAccCtrls;
}
void IptvConfigDataPatch::setMultiAccCtrls(std::map<std::string, oai::_3gpp::model::MulticastAccessControl> const& value)
{
