...
public:
    ...
    /// 
    /// </summary>
    std::vector<oai::_3gpp::model::QosFlowsUsageReport> getQosFlowsUsageReports() const;
    void setQosFlowsUsageReports(std::vector<oai::_3gpp::model::QosFlowsUsageReport> const& value);
