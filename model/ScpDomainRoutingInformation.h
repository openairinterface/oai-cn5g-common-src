...
public:
    ...
    /// </summary>
    std::map<std::string, oai::_3gpp::model::ScpDomainConnectivity> getScpDomainList() const;
    void setScpDomainList(std::map<std::string, oai::_3gpp::model::ScpDomainConnectivity> const& value);

    friend void to_json(nlohmann::json& j, const ScpDomainRoutingInformation& o);
    friend void from_json(const nlohmann::json& j, ScpDomainRoutingInformation& o);
protected:
    std::map<std::string, oai::_3gpp::model::ScpDomainConnectivity> m_ScpDomainList;
