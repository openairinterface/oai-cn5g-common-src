...
std::string SmContextUpdateData::getPei() const { return m_Pei; }
void SmContextUpdateData::setPei(std::string const &value) {
  m_Pei = value;
  m_PeiIsSet = true;
}
bool SmContextUpdateData::peiIsSet() const { return m_PeiIsSet; }
void SmContextUpdateData::unsetPei() { m_PeiIsSet = false; }
...
void SmContextUpdateData::unsetServingNfId() { m_ServingNfIdIsSet = false; }
Guami SmContextUpdateData::getGuami() const { return m_Guami; }
void SmContextUpdateData::setGuami(Guami const &value) {
  m_Guami = value;
  m_GuamiIsSet = true;
}
bool SmContextUpdateData::guamiIsSet() const { return m_GuamiIsSet; }
void SmContextUpdateData::unsetGuami() { m_GuamiIsSet = false; }
...
void SmContextUpdateData::unsetBackupAmfInfo() { m_BackupAmfInfoIsSet = false; }
std::string SmContextUpdateData::getAnType() const { return m_AnType; }
void SmContextUpdateData::setAnType(std::string const &value) {
  m_AnType = value;
  m_AnTypeIsSet = true;
}
bool SmContextUpdateData::anTypeIsSet() const { return m_AnTypeIsSet; }
void SmContextUpdateData::unsetAnType() { m_AnTypeIsSet = false; }
...
void SmContextUpdateData::unsetSecondAnType() { m_SecondAnTypeIsSet = false; }
std::string SmContextUpdateData::getRatType() const { return m_RatType; }
void SmContextUpdateData::setRatType(std::string const &value) {
  m_RatType = value;
  m_RatTypeIsSet = true;
}
bool SmContextUpdateData::ratTypeIsSet() const { return m_RatTypeIsSet; }
void SmContextUpdateData::unsetRatType() { m_RatTypeIsSet = false; }
...
UserLocation SmContextUpdateData::getUeLocation() const { return m_UeLocation; }
void SmContextUpdateData::setUeLocation(UserLocation const &value) {
  m_UeLocation = value;
  m_UeLocationIsSet = true;
}
bool SmContextUpdateData::ueLocationIsSet() const { return m_UeLocationIsSet; }
void SmContextUpdateData::unsetUeLocation() { m_UeLocationIsSet = false; }
std::string SmContextUpdateData::getUeTimeZone() const { return m_UeTimeZone; }
void SmContextUpdateData::setUeTimeZone(std::string const &value) {
  m_UeTimeZone = value;
  m_UeTimeZoneIsSet = true;
}
bool SmContextUpdateData::ueTimeZoneIsSet() const { return m_UeTimeZoneIsSet; }
void SmContextUpdateData::unsetUeTimeZone() { m_UeTimeZoneIsSet = false; }
...
void SmContextUpdateData::unsetAddUeLocation() { m_AddUeLocationIsSet = false; }
std::string SmContextUpdateData::getUpCnxState() const { return m_UpCnxState; }
void SmContextUpdateData::setUpCnxState(std::string const &value) {
  m_UpCnxState = value;
  m_UpCnxStateIsSet = true;
}
bool SmContextUpdateData::upCnxStateIsSet() const { return m_UpCnxStateIsSet; }
void SmContextUpdateData::unsetUpCnxState() { m_UpCnxStateIsSet = false; }
HoState SmContextUpdateData::getHoState() const { return m_HoState; }
void SmContextUpdateData::setHoState(HoState const &value) {
  m_HoState = value;
  m_HoStateIsSet = true;
}
bool SmContextUpdateData::hoStateIsSet() const { return m_HoStateIsSet; }
void SmContextUpdateData::unsetHoState() { m_HoStateIsSet = false; }
bool SmContextUpdateData::isToBeSwitched() const { return m_ToBeSwitched; }
...
void SmContextUpdateData::unsetToBeSwitched() { m_ToBeSwitchedIsSet = false; }
...
RefToBinaryData SmContextUpdateData::getN1SmMsg() const { return m_N1SmMsg; }
void SmContextUpdateData::setN1SmMsg(RefToBinaryData const &value) {
  m_N1SmMsg = value;
  m_N1SmMsgIsSet = true;
}
bool SmContextUpdateData::n1SmMsgIsSet() const { return m_N1SmMsgIsSet; }
void SmContextUpdateData::unsetN1SmMsg() { m_N1SmMsgIsSet = false; }
RefToBinaryData SmContextUpdateData::getN2SmInfo() const { return m_N2SmInfo; }
void SmContextUpdateData::setN2SmInfo(RefToBinaryData const &value) {
  m_N2SmInfo = value;
  m_N2SmInfoIsSet = true;
}
bool SmContextUpdateData::n2SmInfoIsSet() const { return m_N2SmInfoIsSet; }
void SmContextUpdateData::unsetN2SmInfo() { m_N2SmInfoIsSet = false; }
...
void SmContextUpdateData::unsetN2SmInfoType() { m_N2SmInfoTypeIsSet = false; }
NgRanTargetId SmContextUpdateData::getTargetId() const { return m_TargetId; }
void SmContextUpdateData::setTargetId(NgRanTargetId const &value) {
  m_TargetId = value;
  m_TargetIdIsSet = true;
}
bool SmContextUpdateData::targetIdIsSet() const { return m_TargetIdIsSet; }
void SmContextUpdateData::unsetTargetId() { m_TargetIdIsSet = false; }
...
bool SmContextUpdateData::isDataForwarding() const { return m_DataForwarding; }
...
void SmContextUpdateData::unsetRevokeEbiList() { m_RevokeEbiListIsSet = false; }
bool SmContextUpdateData::isRelease() const { return m_Release; }
void SmContextUpdateData::setRelease(bool const value) {
  m_Release = value;
  m_ReleaseIsSet = true;
}
bool SmContextUpdateData::releaseIsSet() const { return m_ReleaseIsSet; }
void SmContextUpdateData::unsetRelease() { m_ReleaseIsSet = false; }
Cause SmContextUpdateData::getCause() const { return m_Cause; }
void SmContextUpdateData::setCause(Cause const &value) {
  m_Cause = value;
  m_CauseIsSet = true;
}
bool SmContextUpdateData::causeIsSet() const { return m_CauseIsSet; }
void SmContextUpdateData::unsetCause() { m_CauseIsSet = false; }
NgApCause SmContextUpdateData::getNgApCause() const { return m_NgApCause; }
void SmContextUpdateData::setNgApCause(NgApCause const &value) {
  m_NgApCause = value;
  m_NgApCauseIsSet = true;
}
bool SmContextUpdateData::ngApCauseIsSet() const { return m_NgApCauseIsSet; }
void SmContextUpdateData::unsetNgApCause() { m_NgApCauseIsSet = false; }
...
Snssai SmContextUpdateData::getSNssai() const { return m_SNssai; }
void SmContextUpdateData::setSNssai(Snssai const &value) {
  m_SNssai = value;
  m_SNssaiIsSet = true;
}
bool SmContextUpdateData::sNssaiIsSet() const { return m_SNssaiIsSet; }
void SmContextUpdateData::unsetSNssai() { m_SNssaiIsSet = false; }
TraceData SmContextUpdateData::getTraceData() const { return m_TraceData; }
void SmContextUpdateData::setTraceData(TraceData const &value) {
  m_TraceData = value;
  m_TraceDataIsSet = true;
}
bool SmContextUpdateData::traceDataIsSet() const { return m_TraceDataIsSet; }
void SmContextUpdateData::unsetTraceData() { m_TraceDataIsSet = false; }
...
void SmContextUpdateData::unsetN2SmInfoExt1() { m_N2SmInfoExt1IsSet = false; }
...
void SmContextUpdateData::unsetMaReleaseInd() { m_MaReleaseIndIsSet = false; }
...
void SmContextUpdateData::unsetExemptionInd() { m_ExemptionIndIsSet = false; }
