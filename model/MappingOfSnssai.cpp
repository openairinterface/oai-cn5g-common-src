...
bool MappingOfSnssai::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "MappingOfSnssai" : pathPrefix;
    ...
    if (!m_HomeSnssai.validate(msg, _pathPrefix + ".homeSnssai")) {
        msg << _pathPrefix << ": HomeSnssai is invalid;";
        success = false;
    }
    return success;
}
...
oai::model::Snssai MappingOfSnssai::getServingSnssai() const
{
    return m_ServingSnssai;
}
void MappingOfSnssai::setServingSnssai(oai::model::Snssai const& value)
{
    m_ServingSnssai = value;
}
oai::model::Snssai MappingOfSnssai::getHomeSnssai() const
{
    return m_HomeSnssai;
}
void MappingOfSnssai::setHomeSnssai(oai::model::Snssai const& value)
{
    m_HomeSnssai = value;
}
