...
public:
    ...
    /// 
    /// </summary>
    std::vector<oai::model::PlmnEcInfo> getPlmnEcInfos() const;
    void setPlmnEcInfos(std::vector<oai::model::PlmnEcInfo> const& value);
...
protected:
    ...
    std::vector<oai::model::PlmnEcInfo> m_PlmnEcInfos;
