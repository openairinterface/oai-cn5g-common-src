...
bool SmallDataRateStatus::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "SmallDataRateStatus" : pathPrefix;
...
bool SmallDataRateStatus::operator==(const SmallDataRateStatus& rhs) const
{
    ...
    ((!remainPacketsUlIsSet() && !rhs.remainPacketsUlIsSet()) || (remainPacketsUlIsSet() && rhs.remainPacketsUlIsSet() && getRemainPacketsUl() == rhs.getRemainPacketsUl())) &&
    
    
    ((!remainPacketsDlIsSet() && !rhs.remainPacketsDlIsSet()) || (remainPacketsDlIsSet() && rhs.remainPacketsDlIsSet() && getRemainPacketsDl() == rhs.getRemainPacketsDl())) &&
    
    
    ((!validityTimeIsSet() && !rhs.validityTimeIsSet()) || (validityTimeIsSet() && rhs.validityTimeIsSet() && getValidityTime() == rhs.getValidityTime())) &&
    
    
    ((!remainExReportsUlIsSet() && !rhs.remainExReportsUlIsSet()) || (remainExReportsUlIsSet() && rhs.remainExReportsUlIsSet() && getRemainExReportsUl() == rhs.getRemainExReportsUl())) &&
    
    
    ((!remainExReportsDlIsSet() && !rhs.remainExReportsDlIsSet()) || (remainExReportsDlIsSet() && rhs.remainExReportsDlIsSet() && getRemainExReportsDl() == rhs.getRemainExReportsDl()))
