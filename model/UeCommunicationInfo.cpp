...
std::vector<oai::_3gpp::model::CommunicationCollection> UeCommunicationInfo::getComms() const
{
    return m_Comms;
}
void UeCommunicationInfo::setComms(std::vector<oai::_3gpp::model::CommunicationCollection> const& value)
{
    m_Comms = value;
}
