...
std::vector<oai::_3gpp::model::Guami> AmfInfo::getGuamiList() const
{
    return m_GuamiList;
}
void AmfInfo::setGuamiList(std::vector<oai::_3gpp::model::Guami> const& value)
{
    m_GuamiList = value;
}
std::vector<oai::_3gpp::model::Tai> AmfInfo::getTaiList() const
{
    return m_TaiList;
}
void AmfInfo::setTaiList(std::vector<oai::_3gpp::model::Tai> const& value)
{
    m_TaiList = value;
    m_TaiListIsSet = true;
}
...
std::vector<oai::_3gpp::model::TaiRange> AmfInfo::getTaiRangeList() const
{
    return m_TaiRangeList;
}
void AmfInfo::setTaiRangeList(std::vector<oai::_3gpp::model::TaiRange> const& value)
{
...
std::vector<oai::_3gpp::model::Guami> AmfInfo::getBackupInfoAmfFailure() const
{
    return m_BackupInfoAmfFailure;
}
void AmfInfo::setBackupInfoAmfFailure(std::vector<oai::_3gpp::model::Guami> const& value)
{
...
std::vector<oai::_3gpp::model::Guami> AmfInfo::getBackupInfoAmfRemoval() const
{
    return m_BackupInfoAmfRemoval;
}
void AmfInfo::setBackupInfoAmfRemoval(std::vector<oai::_3gpp::model::Guami> const& value)
{
...
oai::_3gpp::model::N2InterfaceAmfInfo AmfInfo::getN2InterfaceAmfInfo() const
{
    return m_N2InterfaceAmfInfo;
}
void AmfInfo::setN2InterfaceAmfInfo(oai::_3gpp::model::N2InterfaceAmfInfo const& value)
{
