...
bool MultipleUnitUsage::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    ...
    {
        const std::vector<oai::_3gpp::model::UsedUnitContainer>& value = m_UsedUnitContainer;
...
std::vector<oai::_3gpp::model::UsedUnitContainer> MultipleUnitUsage::getUsedUnitContainer() const
{
    return m_UsedUnitContainer;
}
void MultipleUnitUsage::setUsedUnitContainer(std::vector<oai::_3gpp::model::UsedUnitContainer> const& value)
{
...
oai::_3gpp::model::PDUAddress MultipleUnitUsage::getMultihomedPDUAddress() const
{
    return m_MultihomedPDUAddress;
}
void MultipleUnitUsage::setMultihomedPDUAddress(oai::_3gpp::model::PDUAddress const& value)
{
