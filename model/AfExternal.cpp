...
bool AfExternal::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "AfExternal" : pathPrefix;
...
std::vector<oai::model::GeographicArea> AfExternal::getAllowedGeographicArea() const
{
    return m_AllowedGeographicArea;
}
void AfExternal::setAllowedGeographicArea(std::vector<oai::model::GeographicArea> const& value)
{
...
oai::model::PrivacyCheckRelatedAction AfExternal::getPrivacyCheckRelatedAction() const
{
    return m_PrivacyCheckRelatedAction;
}
void AfExternal::setPrivacyCheckRelatedAction(oai::model::PrivacyCheckRelatedAction const& value)
{
...
oai::model::ValidTimePeriod AfExternal::getValidTimePeriod() const
{
    return m_ValidTimePeriod;
}
void AfExternal::setValidTimePeriod(oai::model::ValidTimePeriod const& value)
{
