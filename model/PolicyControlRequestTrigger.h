...
public:
    ...
    PolicyControlRequestTrigger_anyOf::ePolicyControlRequestTrigger_anyOf getEnumValue() const;
    void setEnumValue(PolicyControlRequestTrigger_anyOf::ePolicyControlRequestTrigger_anyOf value);
    friend void to_json(nlohmann::json& j, const PolicyControlRequestTrigger& o);
    friend void from_json(const nlohmann::json& j, PolicyControlRequestTrigger& o);
