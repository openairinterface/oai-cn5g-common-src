...
public:
    ...
    /// 
    /// </summary>
    std::vector<oai::_3gpp::model::ServingNetworkFunctionID> getServingNetworkFunctionID() const;
    void setServingNetworkFunctionID(std::vector<oai::_3gpp::model::ServingNetworkFunctionID> const& value);
...
protected:
    ...
    bool m_RATTypeIsSet;
    std::vector<oai::_3gpp::model::ServingNetworkFunctionID> m_ServingNetworkFunctionID;
