...
public:
    ...
    /// 
    /// </summary>
    oai::model::PduSessionRelCause getPduSessRelCause() const;
    void setPduSessRelCause(oai::model::PduSessionRelCause const& value);
...
protected:
    ...
    oai::model::PduSessionRelCause m_PduSessRelCause;
