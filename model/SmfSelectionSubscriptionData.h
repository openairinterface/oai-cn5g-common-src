...
public:
    ...
    /// </summary>
    std::map<std::string, oai::model::SnssaiInfo> getSubscribedSnssaiInfos() const;
    void setSubscribedSnssaiInfos(std::map<std::string, oai::model::SnssaiInfo> const& value);
...
protected:
    ...
    std::map<std::string, oai::model::SnssaiInfo> m_SubscribedSnssaiInfos;
