...
bool SmallDataRateControl::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "SmallDataRateControl" : pathPrefix;

        
    if (!m_TimeUnit.validate(msg, _pathPrefix + ".timeUnit")) {
        msg << _pathPrefix << ": TimeUnit is invalid;";
        success = false;
    }                
    return success;
}
...
bool SmallDataRateControl::operator==(const SmallDataRateControl& rhs) const
{
    ...
    ((!maxPacketRateUlIsSet() && !rhs.maxPacketRateUlIsSet()) || (maxPacketRateUlIsSet() && rhs.maxPacketRateUlIsSet() && getMaxPacketRateUl() == rhs.getMaxPacketRateUl())) &&
    
    
    ((!maxPacketRateDlIsSet() && !rhs.maxPacketRateDlIsSet()) || (maxPacketRateDlIsSet() && rhs.maxPacketRateDlIsSet() && getMaxPacketRateDl() == rhs.getMaxPacketRateDl())) &&
    
    
    ((!maxAdditionalPacketRateUlIsSet() && !rhs.maxAdditionalPacketRateUlIsSet()) || (maxAdditionalPacketRateUlIsSet() && rhs.maxAdditionalPacketRateUlIsSet() && getMaxAdditionalPacketRateUl() == rhs.getMaxAdditionalPacketRateUl())) &&
    
    
    ((!maxAdditionalPacketRateDlIsSet() && !rhs.maxAdditionalPacketRateDlIsSet()) || (maxAdditionalPacketRateDlIsSet() && rhs.maxAdditionalPacketRateDlIsSet() && getMaxAdditionalPacketRateDl() == rhs.getMaxAdditionalPacketRateDl()))
...
void to_json(nlohmann::json& j, const SmallDataRateControl& o)
{
    ...
    if(o.maxPacketRateUlIsSet())
        j["maxPacketRateUl"] = o.m_MaxPacketRateUl;
    if(o.maxPacketRateDlIsSet())
        j["maxPacketRateDl"] = o.m_MaxPacketRateDl;
...
oai::model::SmallDataRateControlTimeUnit SmallDataRateControl::getTimeUnit() const
{
    return m_TimeUnit;
}
void SmallDataRateControl::setTimeUnit(oai::model::SmallDataRateControlTimeUnit const& value)
{
    m_TimeUnit = value;
}
