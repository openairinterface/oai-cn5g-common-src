...
bool MoExpDataCounter::validate(std::stringstream &msg,
...
int32_t MoExpDataCounter::getCounter() const { return m_Counter; }
void MoExpDataCounter::setCounter(int32_t const value) { m_Counter = value; }
std::string MoExpDataCounter::getTimeStamp() const { return m_TimeStamp; }
void MoExpDataCounter::setTimeStamp(std::string const &value) {
  m_TimeStamp = value;
  m_TimeStampIsSet = true;
}
bool MoExpDataCounter::timeStampIsSet() const { return m_TimeStampIsSet; }
void MoExpDataCounter::unsetTimeStamp() { m_TimeStampIsSet = false; }
