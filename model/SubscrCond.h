...
public:
    ...
    void setServiceNameList(std::vector<oai::_3gpp::model::ServiceName> const& value);
    /// <summary>
    /// 
    /// </summary>
    ...
    void setServingNfTypeList(std::vector<oai::_3gpp::model::NFType> const& value);
    ...
    void setMlAnalyticsList(std::vector<oai::_3gpp::model::MlAnalyticsInfo> const& value);
