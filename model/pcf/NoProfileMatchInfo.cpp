...
bool NoProfileMatchInfo::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    ...
    {
        const std::vector<oai::model::pcf::QueryParamCombination>& value = m_QueryParamCombinationList;
...
void NoProfileMatchInfo::setReason(oai::model::pcf::NoProfileMatchReason const& value)
{
    m_Reason = value;
}
std::vector<oai::model::pcf::QueryParamCombination> NoProfileMatchInfo::getQueryParamCombinationList() const
{
    return m_QueryParamCombinationList;
}
void NoProfileMatchInfo::setQueryParamCombinationList(std::vector<oai::model::pcf::QueryParamCombination> const& value)
{
