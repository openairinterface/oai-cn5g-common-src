...
public:
    ...
    /// 
    /// </summary>
    std::vector<oai::_3gpp::model::RouteToLocation> getN6TrafficRoutingInfo() const;
    void setN6TrafficRoutingInfo(std::vector<oai::_3gpp::model::RouteToLocation> const& value);
