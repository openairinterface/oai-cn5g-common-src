...
asn_TYPE_member_t asn_MBR_Ngap_Dynamic5QIDescriptor_1[] = {
    {ATF_NOFLAGS,
     0,
     offsetof(struct Ngap_Dynamic5QIDescriptor, priorityLevelQos),
    ...
    {ATF_NOFLAGS,
     0,
     offsetof(struct Ngap_Dynamic5QIDescriptor, packetDelayBudget),
    ...
    {ATF_POINTER,
     0,
     offsetof(struct Ngap_Dynamic5QIDescriptor, packetErrorRate),
    ...
    {ATF_POINTER,
     5,
     offsetof(struct Ngap_Dynamic5QIDescriptor, fiveQI),
    ...
    {ATF_POINTER,
     4,
     offsetof(struct Ngap_Dynamic5QIDescriptor, delayCritical),
    ...
    {ATF_POINTER,
     3,
     offsetof(struct Ngap_Dynamic5QIDescriptor, averagingWindow),
    ...
    {ATF_POINTER,
     2,
     offsetof(struct Ngap_Dynamic5QIDescriptor, maximumDataBurstVolume),
    ...
    {ATF_POINTER,
     ...
     -1, /* IMPLICIT tag at current level */
     &asn_DEF_Ngap_ProtocolExtensionContainer_12929P65,
     0,
     {
#if !defined(ASN_DISABLE_OER_SUPPORT)
         0,
