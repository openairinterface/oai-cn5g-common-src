...
std::map<std::string, oai::_3gpp::model::LinksValueSchema> EapSession::getLinks() const
{
    return m__links;
}
void EapSession::setLinks(std::map<std::string, oai::_3gpp::model::LinksValueSchema> const& value)
{
    m__links = value;
    m__linksIsSet = true;
}
...
std::vector<oai::_3gpp::model::ServerAddressingInfo> EapSession::getPvsInfo() const
{
    return m_PvsInfo;
}
void EapSession::setPvsInfo(std::vector<oai::_3gpp::model::ServerAddressingInfo> const& value)
{
    m_PvsInfo = value;
    m_PvsInfoIsSet = true;
}
