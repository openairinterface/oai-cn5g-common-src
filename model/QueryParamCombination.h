...
public:
    ...
    /// 
    /// </summary>
    std::vector<oai::_3gpp::model::QueryParameter> getQueryParams() const;
    void setQueryParams(std::vector<oai::_3gpp::model::QueryParameter> const& value);
...
protected:
    std::vector<oai::_3gpp::model::QueryParameter> m_QueryParams;
