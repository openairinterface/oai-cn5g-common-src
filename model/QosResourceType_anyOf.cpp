...
bool QosResourceType_anyOf::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "QosResourceType_anyOf" : pathPrefix;

    
    if (m_value == QosResourceType_anyOf::eQosResourceType_anyOf::INVALID_VALUE_OPENAPI_GENERATED)
    {
        success = false;
...
void to_json(nlohmann::json& j, const QosResourceType_anyOf& o)
{
    ...
    switch (o.getValue())
    {
        case QosResourceType_anyOf::eQosResourceType_anyOf::INVALID_VALUE_OPENAPI_GENERATED:
...
QosResourceType_anyOf::eQosResourceType_anyOf QosResourceType_anyOf::getValue() const
{
    return m_value;
}
void QosResourceType_anyOf::setValue(QosResourceType_anyOf::eQosResourceType_anyOf value)
{
    m_value = value;
}
