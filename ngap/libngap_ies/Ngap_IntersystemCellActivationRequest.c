...
static asn_oer_constraints_t asn_OER_memb_Ngap_activationID_constr_2 CC_NOTUSED = {
	{ 0, 0 },
	-1};
...
asn_TYPE_member_t asn_MBR_Ngap_IntersystemCellActivationRequest_1[] = {
	...
	{ ATF_POINTER, 0, offsetof(struct Ngap_IntersystemCellActivationRequest, cellsToActivateList),
