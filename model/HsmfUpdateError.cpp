...
bool HsmfUpdateError::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "HsmfUpdateError" : pathPrefix;
...
oai::model::ProblemDetails HsmfUpdateError::getError() const
{
    return m_Error;
}
void HsmfUpdateError::setError(oai::model::ProblemDetails const& value)
{
    m_Error = value;
}
...
oai::model::RefToBinaryData HsmfUpdateError::getN1SmInfoToUe() const
{
    return m_N1SmInfoToUe;
}
void HsmfUpdateError::setN1SmInfoToUe(oai::model::RefToBinaryData const& value)
{
