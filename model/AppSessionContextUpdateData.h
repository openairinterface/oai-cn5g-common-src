...
public:
    ...
    /// </summary>
    std::map<std::string, oai::_3gpp::model::MediaComponentRm> getMedComponents() const;
    void setMedComponents(std::map<std::string, oai::_3gpp::model::MediaComponentRm> const& value);
    ...
    /// 
    /// </summary>
    oai::_3gpp::model::PreemptionControlInformationRm getPreemptControlInfo() const;
    void setPreemptControlInfo(oai::_3gpp::model::PreemptionControlInformationRm const& value);
