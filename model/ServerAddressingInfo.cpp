...
void ServerAddressingInfo::setIpv4Addresses(std::vector<std::string> const& value)
{
...
std::vector<oai::model::Ipv6Addr> ServerAddressingInfo::getIpv6Addresses() const
{
    return m_Ipv6Addresses;
}
void ServerAddressingInfo::setIpv6Addresses(std::vector<oai::model::Ipv6Addr> const& value)
{
