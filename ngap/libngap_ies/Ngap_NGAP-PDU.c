...
static asn_TYPE_member_t asn_MBR_Ngap_NGAP_PDU_1[] = {
    {ATF_POINTER,
     0,
     offsetof(struct Ngap_NGAP_PDU, choice.initiatingMessage),
    ...
    {ATF_POINTER,
     0,
     offsetof(struct Ngap_NGAP_PDU, choice.successfulOutcome),
    ...
    {ATF_POINTER,
     0,
     offsetof(struct Ngap_NGAP_PDU, choice.unsuccessfulOutcome),
...
asn_TYPE_descriptor_t asn_DEF_Ngap_NGAP_PDU = {
    ...
    {
#if !defined(ASN_DISABLE_OER_SUPPORT)
        &asn_OER_type_Ngap_NGAP_PDU_constr_1,
#endif /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
