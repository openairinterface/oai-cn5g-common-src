...
oai::_3gpp::model::Snssai SmContextCreateData::getSnssai() const
{
    return m_Snssai;
}
void SmContextCreateData::setSnssai(oai::_3gpp::model::Snssai const& value)
{
    m_Snssai = value;
}
...
oai::_3gpp::model::NiddInformation SmContextCreateData::getNiddInfo() const
{
    return m_NiddInfo;
}
void SmContextCreateData::setNiddInfo(oai::_3gpp::model::NiddInformation const& value)
{
    m_NiddInfo = value;
...
oai::_3gpp::model::SmContextConfiguration SmContextCreateData::getSmContextConfig() const
{
    return m_SmContextConfig;
}
void SmContextCreateData::setSmContextConfig(oai::_3gpp::model::SmContextConfiguration const& value)
{
