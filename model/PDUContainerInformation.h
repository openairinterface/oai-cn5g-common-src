...
public:
    ...
    void setQoSCharacteristics(oai::_3gpp::model::QosCharacteristics const& value);
    ...
    /// 
    /// </summary>
    std::vector<oai::_3gpp::model::ServingNetworkFunctionID> getServingNodeID() const;
    void setServingNodeID(std::vector<oai::_3gpp::model::ServingNetworkFunctionID> const& value);
    bool servingNodeIDIsSet() const;
    void unsetServingNodeID();
    /// <summary>
    /// 
    /// </summary>
    std::map<std::string, oai::_3gpp::model::PresenceInfo> getPresenceReportingAreaInformation() const;
    void setPresenceReportingAreaInformation(std::map<std::string, oai::_3gpp::model::PresenceInfo> const& value);
    ...
    /// 
    /// </summary>
    oai::_3gpp::model::SteeringFunctionality getMAPDUSteeringFunctionality() const;
    void setMAPDUSteeringFunctionality(oai::_3gpp::model::SteeringFunctionality const& value);
...
protected:
    ...
    std::map<std::string, oai::_3gpp::model::PresenceInfo> m_PresenceReportingAreaInformation;
