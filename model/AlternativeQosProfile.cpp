...
bool AlternativeQosProfile::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "AlternativeQosProfile" : pathPrefix;
...
bool AlternativeQosProfile::operator==(const AlternativeQosProfile& rhs) const
{
    ...
    ((!packetErrRateIsSet() && !rhs.packetErrRateIsSet()) || (packetErrRateIsSet() && rhs.packetErrRateIsSet() && getPacketErrRate() == rhs.getPacketErrRate()))
