...
std::vector<oai::_3gpp::model::SupiRange> AusfInfo::getSupiRanges() const
{
    return m_SupiRanges;
}
void AusfInfo::setSupiRanges(std::vector<oai::_3gpp::model::SupiRange> const& value)
{
    m_SupiRanges = value;
...
std::vector<oai::_3gpp::model::SuciInfo> AusfInfo::getSuciInfos() const
{
    return m_SuciInfos;
}
void AusfInfo::setSuciInfos(std::vector<oai::_3gpp::model::SuciInfo> const& value)
{
    m_SuciInfos = value;
