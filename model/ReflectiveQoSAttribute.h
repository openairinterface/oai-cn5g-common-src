...
public:
    ...
    ReflectiveQoSAttribute_anyOf::eReflectiveQoSAttribute_anyOf getEnumValue() const;
    void setEnumValue(ReflectiveQoSAttribute_anyOf::eReflectiveQoSAttribute_anyOf value);
