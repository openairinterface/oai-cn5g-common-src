...
oai::model::pcf::AppSessionContextReqData AppSessionContext::getAscReqData() const
{
    return m_AscReqData;
}
void AppSessionContext::setAscReqData(oai::model::pcf::AppSessionContextReqData const& value)
{
    m_AscReqData = value;
...
oai::model::pcf::AppSessionContextRespData AppSessionContext::getAscRespData() const
{
    return m_AscRespData;
}
void AppSessionContext::setAscRespData(oai::model::pcf::AppSessionContextRespData const& value)
{
    m_AscRespData = value;
...
void AppSessionContext::setEvsNotif(oai::model::pcf::EventsNotification const& value)
{
    m_EvsNotif = value;
