...
memb_Ngap_usageCountUL_constraint_1(const asn_TYPE_descriptor_t *td, const void *sptr,
			asn_app_constraint_failed_f *ctfailcb, void *app_key) {
	static const asn_cval_t asn_CVAL_Ngap_usageCountUL_4_lb = { ACV_UINT, { .u = UINTMAX_C(0) } };
	static const asn_cval_t asn_CVAL_Ngap_usageCountUL_4_ub = { ACV_UINT, { .u = UINTMAX_C(18446744073709551615) } };
	...
	if(asn_check_INTEGER_range(st, &asn_CVAL_Ngap_usageCountUL_4_lb, &asn_CVAL_Ngap_usageCountUL_4_ub, 0) == 0) {
		/* Constraint check succeeded */
		return 0;
	} else {
		ASN__CTFAIL(app_key, td, sptr,
...
memb_Ngap_usageCountDL_constraint_1(const asn_TYPE_descriptor_t *td, const void *sptr,
			asn_app_constraint_failed_f *ctfailcb, void *app_key) {
	static const asn_cval_t asn_CVAL_Ngap_usageCountDL_5_lb = { ACV_UINT, { .u = UINTMAX_C(0) } };
	static const asn_cval_t asn_CVAL_Ngap_usageCountDL_5_ub = { ACV_UINT, { .u = UINTMAX_C(18446744073709551615) } };
	const INTEGER_t *st = (const INTEGER_t *)sptr;
	...
	if(asn_check_INTEGER_range(st, &asn_CVAL_Ngap_usageCountDL_5_lb, &asn_CVAL_Ngap_usageCountDL_5_ub, 0) == 0) {
		/* Constraint check succeeded */
		return 0;
	} else {
		ASN__CTFAIL(app_key, td, sptr,
