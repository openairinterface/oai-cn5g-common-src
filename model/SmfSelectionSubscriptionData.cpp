...
std::map<std::string, oai::model::SnssaiInfo> SmfSelectionSubscriptionData::getSubscribedSnssaiInfos() const
{
    return m_SubscribedSnssaiInfos;
}
void SmfSelectionSubscriptionData::setSubscribedSnssaiInfos(std::map<std::string, oai::model::SnssaiInfo> const& value)
{
