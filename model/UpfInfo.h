...
class UpfInfo {
 public:
  ...
  void validate(bool check_snssai) const;
  ...
  ///
  /// </summary>
  std::vector<oai::_3gpp::model::SnssaiUpfInfoItem> getSNssaiUpfInfoList()
      const;
  ...
  ///
  /// </summary>
  std::vector<oai::_3gpp::model::InterfaceUpfInfoItem> getInterfaceUpfInfoList()
      const;
