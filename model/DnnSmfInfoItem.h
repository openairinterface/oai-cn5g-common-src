...
public:
    ...
    /// 
    /// </summary>
    std::vector<oai::_3gpp::model::DnnSmfInfoItem_dnaiList_inner> getDnaiList() const;
    void setDnaiList(std::vector<oai::_3gpp::model::DnnSmfInfoItem_dnaiList_inner> const& value);
...
protected:
    ...
    std::vector<oai::_3gpp::model::DnnSmfInfoItem_dnaiList_inner> m_DnaiList;
