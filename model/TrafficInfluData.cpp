...
bool TrafficInfluData::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "TrafficInfluData" : pathPrefix;
...
bool TrafficInfluData::operator==(const TrafficInfluData& rhs) const
{
    ...
    ((!resUriIsSet() && !rhs.resUriIsSet()) || (resUriIsSet() && rhs.resUriIsSet() && getResUri() == rhs.getResUri())) &&
...
std::vector<oai::model::EthFlowDescription> TrafficInfluData::getEthTrafficFilters() const
{
    return m_EthTrafficFilters;
}
void TrafficInfluData::setEthTrafficFilters(std::vector<oai::model::EthFlowDescription> const& value)
{
...
oai::model::Snssai TrafficInfluData::getSnssai() const
{
    return m_Snssai;
}
void TrafficInfluData::setSnssai(oai::model::Snssai const& value)
{
    m_Snssai = value;
    m_SnssaiIsSet = true;
}
...
std::vector<oai::model::FlowInfo> TrafficInfluData::getTrafficFilters() const
{
    return m_TrafficFilters;
}
void TrafficInfluData::setTrafficFilters(std::vector<oai::model::FlowInfo> const& value)
{
...
std::vector<oai::model::RouteToLocation> TrafficInfluData::getTrafficRoutes() const
{
    return m_TrafficRoutes;
}
void TrafficInfluData::setTrafficRoutes(std::vector<oai::model::RouteToLocation> const& value)
{
...
std::vector<oai::model::TemporalValidity> TrafficInfluData::getTempValidities() const
{
    return m_TempValidities;
}
void TrafficInfluData::setTempValidities(std::vector<oai::model::TemporalValidity> const& value)
{
...
oai::model::NetworkAreaInfo TrafficInfluData::getNwAreaInfo() const
{
    return m_NwAreaInfo;
}
void TrafficInfluData::setNwAreaInfo(oai::model::NetworkAreaInfo const& value)
{
    m_NwAreaInfo = value;
...
std::vector<oai::model::SubscribedEvent> TrafficInfluData::getSubscribedEvents() const
{
    return m_SubscribedEvents;
}
void TrafficInfluData::setSubscribedEvents(std::vector<oai::model::SubscribedEvent> const& value)
{
...
oai::model::DnaiChangeType TrafficInfluData::getDnaiChgType() const
{
    return m_DnaiChgType;
}
void TrafficInfluData::setDnaiChgType(oai::model::DnaiChangeType const& value)
{
    m_DnaiChgType = value;
