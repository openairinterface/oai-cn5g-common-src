...
public:
    ...
    /// </summary>
    std::map<std::string, oai::model::MediaSubComponent> getMedSubComps() const;
    void setMedSubComps(std::map<std::string, oai::model::MediaSubComponent> const& value);
    ...
    /// 
    /// </summary>
    oai::model::TsnQosContainer getTsnQos() const;
    void setTsnQos(oai::model::TsnQosContainer const& value);
...
protected:
    ...
    std::map<std::string, oai::model::MediaSubComponent> m_MedSubComps;
    ...
    oai::model::TsnQosContainer m_TsnQos;
    bool m_TsnQosIsSet;
