...
public:
    ...
    friend  void to_json(nlohmann::json& j, const ChangeOfSupiPeiAssociationReport& o);
    friend  void from_json(const nlohmann::json& j, ChangeOfSupiPeiAssociationReport& o);
protected:
    std::string m_NewPei;
