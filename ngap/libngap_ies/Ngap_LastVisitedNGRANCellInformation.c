...
asn_TYPE_member_t asn_MBR_Ngap_LastVisitedNGRANCellInformation_1[] = {
	{ ATF_POINTER, 0, offsetof(struct Ngap_LastVisitedNGRANCellInformation, globalCellID),
	...
	{ ATF_POINTER, 0, offsetof(struct Ngap_LastVisitedNGRANCellInformation, cellType),
