...
oai::model::EutraLocation UserLocation::getEutraLocation() const
{
    return m_EutraLocation;
}
void UserLocation::setEutraLocation(oai::model::EutraLocation const& value)
{
...
oai::model::NrLocation UserLocation::getNrLocation() const
{
    return m_NrLocation;
}
void UserLocation::setNrLocation(oai::model::NrLocation const& value)
{
    m_NrLocation = value;
...
oai::model::N3gaLocation UserLocation::getN3gaLocation() const
{
    return m_N3gaLocation;
}
void UserLocation::setN3gaLocation(oai::model::N3gaLocation const& value)
{
...
oai::model::UtraLocation UserLocation::getUtraLocation() const
{
    return m_UtraLocation;
}
void UserLocation::setUtraLocation(oai::model::UtraLocation const& value)
{
...
oai::model::GeraLocation UserLocation::getGeraLocation() const
{
    return m_GeraLocation;
}
void UserLocation::setGeraLocation(oai::model::GeraLocation const& value)
{
