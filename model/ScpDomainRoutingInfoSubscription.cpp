...
bool ScpDomainRoutingInfoSubscription::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "ScpDomainRoutingInfoSubscription" : pathPrefix;

                    
    return success;
}

bool ScpDomainRoutingInfoSubscription::operator==(const ScpDomainRoutingInfoSubscription& rhs) const
{
    return
    ...
    ((!reqInstanceIdIsSet() && !rhs.reqInstanceIdIsSet()) || (reqInstanceIdIsSet() && rhs.reqInstanceIdIsSet() && getReqInstanceId() == rhs.getReqInstanceId())) &&
    
    
    ((!localIndIsSet() && !rhs.localIndIsSet()) || (localIndIsSet() && rhs.localIndIsSet() && isLocalInd() == rhs.isLocalInd()))
...
void ScpDomainRoutingInfoSubscription::setCallbackUri(std::string const& value)
{
    m_CallbackUri = value;
}
...
void ScpDomainRoutingInfoSubscription::setValidityTime(std::string const& value)
{
...
void ScpDomainRoutingInfoSubscription::setReqInstanceId(std::string const& value)
{
