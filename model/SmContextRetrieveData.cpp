...
bool SmContextRetrieveData::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "SmContextRetrieveData" : pathPrefix;
...
bool SmContextRetrieveData::operator==(const SmContextRetrieveData& rhs) const
{
    ...
    ((!targetMmeCapIsSet() && !rhs.targetMmeCapIsSet()) || (targetMmeCapIsSet() && rhs.targetMmeCapIsSet() && getTargetMmeCap() == rhs.getTargetMmeCap())) &&
    
    
    ((!smContextTypeIsSet() && !rhs.smContextTypeIsSet()) || (smContextTypeIsSet() && rhs.smContextTypeIsSet() && getSmContextType() == rhs.getSmContextType())) &&
    ...
    ((!notToTransferEbiListIsSet() && !rhs.notToTransferEbiListIsSet()) || (notToTransferEbiListIsSet() && rhs.notToTransferEbiListIsSet() && getNotToTransferEbiList() == rhs.getNotToTransferEbiList())) &&
    
    
    ((!ranUnchangedIndIsSet() && !rhs.ranUnchangedIndIsSet()) || (ranUnchangedIndIsSet() && rhs.ranUnchangedIndIsSet() && isRanUnchangedInd() == rhs.isRanUnchangedInd()))
...
oai::model::MmeCapabilities SmContextRetrieveData::getTargetMmeCap() const
{
    return m_TargetMmeCap;
}
void SmContextRetrieveData::setTargetMmeCap(oai::model::MmeCapabilities const& value)
{
...
oai::model::SmContextType SmContextRetrieveData::getSmContextType() const
{
    return m_SmContextType;
}
void SmContextRetrieveData::setSmContextType(oai::model::SmContextType const& value)
{
...
oai::model::PlmnId SmContextRetrieveData::getServingNetwork() const
{
    return m_ServingNetwork;
}
void SmContextRetrieveData::setServingNetwork(oai::model::PlmnId const& value)
{
...
void SmContextRetrieveData::setNotToTransferEbiList(std::vector<int32_t> const value)
{
