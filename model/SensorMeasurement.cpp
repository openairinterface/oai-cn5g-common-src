...
bool SensorMeasurement::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "SensorMeasurement" : pathPrefix;
...
SensorMeasurement_anyOf::eSensorMeasurement_anyOf SensorMeasurement::getEnumValue() const
{
    return m_value.getValue();
}

void SensorMeasurement::setEnumValue(SensorMeasurement_anyOf::eSensorMeasurement_anyOf  value)
{
