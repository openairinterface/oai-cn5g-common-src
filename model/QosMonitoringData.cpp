...
bool QosMonitoringData::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    ...
    /* RepFreqs */ {
        const std::vector<oai::model::ReportingFrequency>& value = m_RepFreqs;
        ...
        { // Recursive validation of array elements
            const std::string oldValuePath = currentValuePath;
            int i = 0;
            for (const oai::model::ReportingFrequency& value : value)
            { 
                const std::string currentValuePath = oldValuePath + "[" + std::to_string(i) + "]";
...
std::vector<oai::model::RequestedQosMonitoringParameter> QosMonitoringData::getReqQosMonParams() const
{
    return m_ReqQosMonParams;
}
void QosMonitoringData::setReqQosMonParams(std::vector<oai::model::RequestedQosMonitoringParameter> const& value)
{
    m_ReqQosMonParams = value;
}
std::vector<oai::model::ReportingFrequency> QosMonitoringData::getRepFreqs() const
{
    return m_RepFreqs;
}
void QosMonitoringData::setRepFreqs(std::vector<oai::model::ReportingFrequency> const& value)
{
    m_RepFreqs = value;
}
