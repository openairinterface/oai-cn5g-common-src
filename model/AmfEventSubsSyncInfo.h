...
public:
    ...
    /// 
    /// </summary>
    std::vector<oai::_3gpp::model::AmfEventSubscriptionInfo> getSubscriptionList() const;
    void setSubscriptionList(std::vector<oai::_3gpp::model::AmfEventSubscriptionInfo> const& value);
