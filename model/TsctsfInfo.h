...
public:
    ...
    /// </summary>
    std::map<std::string, oai::_3gpp::model::SnssaiTsctsfInfoItem> getSNssaiInfoList() const;
    void setSNssaiInfoList(std::map<std::string, oai::_3gpp::model::SnssaiTsctsfInfoItem> const& value);
    ...
    /// 
    /// </summary>
    std::vector<oai::_3gpp::model::InternalGroupIdRange> getInternalGroupIdentifiersRanges() const;
    void setInternalGroupIdentifiersRanges(std::vector<oai::_3gpp::model::InternalGroupIdRange> const& value);
...
protected:
    std::map<std::string, oai::_3gpp::model::SnssaiTsctsfInfoItem> m_SNssaiInfoList;
    ...
    std::vector<oai::_3gpp::model::InternalGroupIdRange> m_InternalGroupIdentifiersRanges;
