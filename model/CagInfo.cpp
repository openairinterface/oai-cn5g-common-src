...
bool CagInfo::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
...
std::vector<oai::_3gpp::model::std::string> CagInfo::getAllowedCagList() const
{
    return m_AllowedCagList;
}
void CagInfo::setAllowedCagList(std::vector<oai::_3gpp::model::std::string> const& value)
{
