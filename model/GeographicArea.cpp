...
bool GeographicArea::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    ...
    /* PointList */ {
        const std::vector<oai::_3gpp::model::GeographicalCoordinates>& value = m_PointList;
        ...
        { // Recursive validation of array elements
            ...
            int i = 0;
            for (const oai::_3gpp::model::GeographicalCoordinates& value : value)
            { 
...
oai::_3gpp::model::SupportedGADShapes GeographicArea::getShape() const
{
    return m_Shape;
}
void GeographicArea::setShape(oai::_3gpp::model::SupportedGADShapes const& value)
{
    m_Shape = value;
}
oai::_3gpp::model::GeographicalCoordinates GeographicArea::getPoint() const
{
    return m_Point;
}
void GeographicArea::setPoint(oai::_3gpp::model::GeographicalCoordinates const& value)
{
    m_Point = value;
}
...
oai::_3gpp::model::UncertaintyEllipse GeographicArea::getUncertaintyEllipse() const
{
    return m_UncertaintyEllipse;
}
void GeographicArea::setUncertaintyEllipse(oai::_3gpp::model::UncertaintyEllipse const& value)
{
...
std::vector<oai::_3gpp::model::GeographicalCoordinates> GeographicArea::getPointList() const
{
    return m_PointList;
}
void GeographicArea::setPointList(std::vector<oai::_3gpp::model::GeographicalCoordinates> const& value)
{
    m_PointList = value;
}
