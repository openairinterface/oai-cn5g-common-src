...
bool AddressList::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "AddressList" : pathPrefix;

         
    if (ipv4AddrsIsSet())
    {
        const std::vector<oai::_3gpp::model::std::string>& value = m_Ipv4Addrs;
...
bool AddressList::operator==(const AddressList& rhs) const
{
    ...
    ((!ipv4AddrsIsSet() && !rhs.ipv4AddrsIsSet()) || (ipv4AddrsIsSet() && rhs.ipv4AddrsIsSet() && getIpv4Addrs() == rhs.getIpv4Addrs())) &&
...
std::vector<oai::_3gpp::model::std::string> AddressList::getIpv4Addrs() const
{
    return m_Ipv4Addrs;
}
void AddressList::setIpv4Addrs(std::vector<oai::_3gpp::model::std::string> const& value)
{
    m_Ipv4Addrs = value;
...
std::vector<oai::_3gpp::model::Ipv6Addr> AddressList::getIpv6Addrs() const
{
    return m_Ipv6Addrs;
}
void AddressList::setIpv6Addrs(std::vector<oai::_3gpp::model::Ipv6Addr> const& value)
{
    m_Ipv6Addrs = value;
