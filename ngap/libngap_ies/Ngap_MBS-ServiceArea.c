...
asn_TYPE_member_t asn_MBR_Ngap_MBS_ServiceArea_1[] = {
    {ATF_POINTER,
     0,
     offsetof(struct Ngap_MBS_ServiceArea, choice.locationindependent),
    ...
    {ATF_POINTER,
     0,
     offsetof(struct Ngap_MBS_ServiceArea, choice.locationdependent),
    ...
    {ATF_POINTER,
     0,
     offsetof(struct Ngap_MBS_ServiceArea, choice.choice_Extensions),
