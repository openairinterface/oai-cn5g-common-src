...
bool SmContextCreateData::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "SmContextCreateData" : pathPrefix;
...
bool SmContextCreateData::operator==(const SmContextCreateData& rhs) const
{
    ...
    ((!rdsSupportIsSet() && !rhs.rdsSupportIsSet()) || (rdsSupportIsSet() && rhs.rdsSupportIsSet() && isRdsSupport() == rhs.isRdsSupport())) &&
    
    
    ((!smContextConfigIsSet() && !rhs.smContextConfigIsSet()) || (smContextConfigIsSet() && rhs.smContextConfigIsSet() && getSmContextConfig() == rhs.getSmContextConfig())) &&
...
oai::model::Snssai SmContextCreateData::getSnssai() const
{
    return m_Snssai;
}
void SmContextCreateData::setSnssai(oai::model::Snssai const& value)
{
    m_Snssai = value;
}
...
oai::model::NiddInformation SmContextCreateData::getNiddInfo() const
{
    return m_NiddInfo;
}
void SmContextCreateData::setNiddInfo(oai::model::NiddInformation const& value)
{
    m_NiddInfo = value;
...
oai::model::SmContextConfiguration SmContextCreateData::getSmContextConfig() const
{
    return m_SmContextConfig;
}
void SmContextCreateData::setSmContextConfig(oai::model::SmContextConfiguration const& value)
{
