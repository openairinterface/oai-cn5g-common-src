...
bool RegistrationContextContainer::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "RegistrationContextContainer" : pathPrefix;
    ...
    if (!m_UserLocation.validate(msg, _pathPrefix + ".userLocation")) {
        msg << _pathPrefix << ": UserLocation is invalid;";
        success = false;
    }     
    if (rrcEstCauseIsSet())
    {
...
bool RegistrationContextContainer::operator==(const RegistrationContextContainer& rhs) const
{
    return
    ...
    ((!localTimeZoneIsSet() && !rhs.localTimeZoneIsSet()) || (localTimeZoneIsSet() && rhs.localTimeZoneIsSet() && getLocalTimeZone() == rhs.getLocalTimeZone())) &&
    ...
    ((!rrcEstCauseIsSet() && !rhs.rrcEstCauseIsSet()) || (rrcEstCauseIsSet() && rhs.rrcEstCauseIsSet() && getRrcEstCause() == rhs.getRrcEstCause())) &&
    
    
    ((!ueContextRequestIsSet() && !rhs.ueContextRequestIsSet()) || (ueContextRequestIsSet() && rhs.ueContextRequestIsSet() && isUeContextRequest() == rhs.isUeContextRequest())) &&
    
    
    ((!initialAmfN2ApIdIsSet() && !rhs.initialAmfN2ApIdIsSet()) || (initialAmfN2ApIdIsSet() && rhs.initialAmfN2ApIdIsSet() && getInitialAmfN2ApId() == rhs.getInitialAmfN2ApId())) &&
    
    
    ((!anN2IPv4AddrIsSet() && !rhs.anN2IPv4AddrIsSet()) || (anN2IPv4AddrIsSet() && rhs.anN2IPv4AddrIsSet() && getAnN2IPv4Addr() == rhs.getAnN2IPv4Addr())) &&
    
    
    ((!anN2IPv6AddrIsSet() && !rhs.anN2IPv6AddrIsSet()) || (anN2IPv6AddrIsSet() && rhs.anN2IPv6AddrIsSet() && getAnN2IPv6Addr() == rhs.getAnN2IPv6Addr())) &&
    ...
    ((!selectedPlmnIdIsSet() && !rhs.selectedPlmnIdIsSet()) || (selectedPlmnIdIsSet() && rhs.selectedPlmnIdIsSet() && getSelectedPlmnId() == rhs.getSelectedPlmnId())) &&
    
    
    ((!iabNodeIndIsSet() && !rhs.iabNodeIndIsSet()) || (iabNodeIndIsSet() && rhs.iabNodeIndIsSet() && isIabNodeInd() == rhs.isIabNodeInd())) &&
    
    
    ((!ceModeBIndIsSet() && !rhs.ceModeBIndIsSet()) || (ceModeBIndIsSet() && rhs.ceModeBIndIsSet() && getCeModeBInd() == rhs.getCeModeBInd())) &&
    
    
    ((!lteMIndIsSet() && !rhs.lteMIndIsSet()) || (lteMIndIsSet() && rhs.lteMIndIsSet() && getLteMInd() == rhs.getLteMInd())) &&
    
    
    ((!authenticatedIndIsSet() && !rhs.authenticatedIndIsSet()) || (authenticatedIndIsSet() && rhs.authenticatedIndIsSet() && isAuthenticatedInd() == rhs.isAuthenticatedInd())) &&
    
    
    ((!npnAccessInfoIsSet() && !rhs.npnAccessInfoIsSet()) || (npnAccessInfoIsSet() && rhs.npnAccessInfoIsSet() && getNpnAccessInfo() == rhs.getNpnAccessInfo()))
...
oai::model::UeContext RegistrationContextContainer::getUeContext() const
{
    return m_UeContext;
}
void RegistrationContextContainer::setUeContext(oai::model::UeContext const& value)
{
    m_UeContext = value;
}
...
oai::model::AccessType RegistrationContextContainer::getAnType() const
{
    return m_AnType;
}
void RegistrationContextContainer::setAnType(oai::model::AccessType const& value)
{
    m_AnType = value;
}
...
oai::model::GlobalRanNodeId RegistrationContextContainer::getRanNodeId() const
{
    return m_RanNodeId;
}
void RegistrationContextContainer::setRanNodeId(oai::model::GlobalRanNodeId const& value)
{
    m_RanNodeId = value;
}
...
oai::model::UserLocation RegistrationContextContainer::getUserLocation() const
{
    return m_UserLocation;
}
void RegistrationContextContainer::setUserLocation(oai::model::UserLocation const& value)
{
...
oai::model::Ipv6Addr RegistrationContextContainer::getAnN2IPv6Addr() const
{
    return m_AnN2IPv6Addr;
}
void RegistrationContextContainer::setAnN2IPv6Addr(oai::model::Ipv6Addr const& value)
{
...
oai::model::AllowedNssai RegistrationContextContainer::getAllowedNssai() const
{
    return m_AllowedNssai;
}
void RegistrationContextContainer::setAllowedNssai(oai::model::AllowedNssai const& value)
{
...
std::vector<oai::model::ConfiguredSnssai> RegistrationContextContainer::getConfiguredNssai() const
{
    return m_ConfiguredNssai;
}
void RegistrationContextContainer::setConfiguredNssai(std::vector<oai::model::ConfiguredSnssai> const& value)
{
...
std::vector<oai::model::Snssai> RegistrationContextContainer::getRejectedNssaiInPlmn() const
{
    return m_RejectedNssaiInPlmn;
}
void RegistrationContextContainer::setRejectedNssaiInPlmn(std::vector<oai::model::Snssai> const& value)
{
...
std::vector<oai::model::Snssai> RegistrationContextContainer::getRejectedNssaiInTa() const
{
    return m_RejectedNssaiInTa;
}
void RegistrationContextContainer::setRejectedNssaiInTa(std::vector<oai::model::Snssai> const& value)
{
...
oai::model::PlmnId RegistrationContextContainer::getSelectedPlmnId() const
{
    return m_SelectedPlmnId;
}
void RegistrationContextContainer::setSelectedPlmnId(oai::model::PlmnId const& value)
{
...
oai::model::CeModeBInd RegistrationContextContainer::getCeModeBInd() const
{
    return m_CeModeBInd;
}
void RegistrationContextContainer::setCeModeBInd(oai::model::CeModeBInd const& value)
{
    m_CeModeBInd = value;
...
oai::model::LteMInd RegistrationContextContainer::getLteMInd() const
{
    return m_LteMInd;
}
void RegistrationContextContainer::setLteMInd(oai::model::LteMInd const& value)
{
    m_LteMInd = value;
    m_LteMIndIsSet = true;
}
...
oai::model::NpnAccessInfo RegistrationContextContainer::getNpnAccessInfo() const
{
    return m_NpnAccessInfo;
}
void RegistrationContextContainer::setNpnAccessInfo(oai::model::NpnAccessInfo const& value)
{
