...
bool MlAnalyticsInfo::validate(
    std::stringstream& msg, const std::string& pathPrefix) const {
  bool success = true;
  const std::string _pathPrefix =
      pathPrefix.empty() ? "MlAnalyticsInfo" : pathPrefix;

  if (mlAnalyticsIdsIsSet()) {
    const std::vector<oai::_3gpp::model::NwdafEvent>& value = m_MlAnalyticsIds;
    ...
    {  // Recursive validation of array elements
      ...
      for (const oai::_3gpp::model::NwdafEvent& value : value) {
        ...
        success = value.validate(msg, currentValuePath + ".mlAnalyticsIds") &&
                  success;
...
bool MlAnalyticsInfo::operator==(const MlAnalyticsInfo& rhs) const {
  return
      ...
      ((!mlAnalyticsIdsIsSet() && !rhs.mlAnalyticsIdsIsSet()) ||
       (mlAnalyticsIdsIsSet() && rhs.mlAnalyticsIdsIsSet() &&
        getMlAnalyticsIds() == rhs.getMlAnalyticsIds())) &&
...
std::vector<oai::_3gpp::model::NwdafEvent> MlAnalyticsInfo::getMlAnalyticsIds()
    const {
  return m_MlAnalyticsIds;
}
void MlAnalyticsInfo::setMlAnalyticsIds(
...
std::vector<oai::_3gpp::model::Snssai> MlAnalyticsInfo::getSnssaiList() const {
  return m_SnssaiList;
}
void MlAnalyticsInfo::setSnssaiList(
...
std::vector<oai::_3gpp::model::Tai> MlAnalyticsInfo::getTrackingAreaList()
    const {
  return m_TrackingAreaList;
}
void MlAnalyticsInfo::setTrackingAreaList(
