...
bool EasdfInfo::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    ...
    {
        const std::vector<oai::model::SnssaiEasdfInfoItem>& value = m_SNssaiEasdfInfoList;
        ...
        { // Recursive validation of array elements
            ...
            int i = 0;
            for (const oai::model::SnssaiEasdfInfoItem& value : value)
            { 
    ...
    {
        const std::vector<oai::model::IpAddr>& value = m_EasdfN6IpAddressList;
    ...
    {
        const std::vector<oai::model::IpAddr>& value = m_UpfN6IpAddressList;
...
std::vector<oai::model::SnssaiEasdfInfoItem> EasdfInfo::getSNssaiEasdfInfoList() const
{
    return m_SNssaiEasdfInfoList;
}
void EasdfInfo::setSNssaiEasdfInfoList(std::vector<oai::model::SnssaiEasdfInfoItem> const& value)
{
...
std::vector<oai::model::IpAddr> EasdfInfo::getEasdfN6IpAddressList() const
{
    return m_EasdfN6IpAddressList;
}
void EasdfInfo::setEasdfN6IpAddressList(std::vector<oai::model::IpAddr> const& value)
{
...
std::vector<oai::model::IpAddr> EasdfInfo::getUpfN6IpAddressList() const
{
    return m_UpfN6IpAddressList;
}
void EasdfInfo::setUpfN6IpAddressList(std::vector<oai::model::IpAddr> const& value)
{
