...
bool AccessNetChargingIdentifier::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "AccessNetChargingIdentifier" : pathPrefix;
...
bool AccessNetChargingIdentifier::operator==(const AccessNetChargingIdentifier& rhs) const
{
    return
    
    
    
    ((!accNetChaIdValueIsSet() && !rhs.accNetChaIdValueIsSet()) || (accNetChaIdValueIsSet() && rhs.accNetChaIdValueIsSet() && getAccNetChaIdValue() == rhs.getAccNetChaIdValue())) &&
    
    
    ((!accNetChargIdStringIsSet() && !rhs.accNetChargIdStringIsSet()) || (accNetChargIdStringIsSet() && rhs.accNetChargIdStringIsSet() && getAccNetChargIdString() == rhs.getAccNetChargIdString())) &&
...
void AccessNetChargingIdentifier::setAccNetChargIdString(std::string const& value)
{
...
std::vector<oai::model::Flows> AccessNetChargingIdentifier::getFlows() const
{
    return m_Flows;
}
void AccessNetChargingIdentifier::setFlows(std::vector<oai::model::Flows> const& value)
{
    m_Flows = value;
    m_FlowsIsSet = true;
}
