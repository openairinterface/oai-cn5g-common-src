...
bool AssociationType_anyOf::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "AssociationType_anyOf" : pathPrefix;

    
    if (m_value == AssociationType_anyOf::eAssociationType_anyOf::INVALID_VALUE_OPENAPI_GENERATED)
    {
        success = false;
...
void to_json(nlohmann::json& j, const AssociationType_anyOf& o)
{
    ...
    switch (o.getValue())
    {
        case AssociationType_anyOf::eAssociationType_anyOf::INVALID_VALUE_OPENAPI_GENERATED:
...
AssociationType_anyOf::eAssociationType_anyOf AssociationType_anyOf::getValue() const
{
    return m_value;
}
void AssociationType_anyOf::setValue(AssociationType_anyOf::eAssociationType_anyOf value)
{
    m_value = value;
}
