...
std::vector<oai::_3gpp::model::AfEvent> NefCond::getAfEvents() const
{
    return m_AfEvents;
}
void NefCond::setAfEvents(std::vector<oai::_3gpp::model::AfEvent> const& value)
{
    m_AfEvents = value;
...
std::vector<oai::_3gpp::model::Snssai> NefCond::getSnssaiList() const
{
    return m_SnssaiList;
}
void NefCond::setSnssaiList(std::vector<oai::_3gpp::model::Snssai> const& value)
{
    m_SnssaiList = value;
...
oai::_3gpp::model::PfdData NefCond::getPfdData() const
{
    return m_PfdData;
}
void NefCond::setPfdData(oai::_3gpp::model::PfdData const& value)
{
    m_PfdData = value;
    m_PfdDataIsSet = true;
}
...
std::vector<oai::_3gpp::model::IdentityRange> NefCond::getGpsiRanges() const
{
    return m_GpsiRanges;
}
void NefCond::setGpsiRanges(std::vector<oai::_3gpp::model::IdentityRange> const& value)
{
    m_GpsiRanges = value;
...
std::vector<oai::_3gpp::model::IdentityRange> NefCond::getExternalGroupIdentifiersRanges() const
{
    return m_ExternalGroupIdentifiersRanges;
}
void NefCond::setExternalGroupIdentifiersRanges(std::vector<oai::_3gpp::model::IdentityRange> const& value)
{
