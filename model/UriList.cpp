...
std::map<std::string, oai::_3gpp::model::LinksValueSchema> UriList::getLinks() const
{
    return m__links;
}
void UriList::setLinks(std::map<std::string, oai::_3gpp::model::LinksValueSchema> const& value)
{
    m__links = value;
    m__linksIsSet = true;
}
