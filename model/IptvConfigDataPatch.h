...
public:
    ...
    /// </summary>
    std::map<std::string, oai::_3gpp::model::MulticastAccessControl> getMultiAccCtrls() const;
    void setMultiAccCtrls(std::map<std::string, oai::_3gpp::model::MulticastAccessControl> const& value);
...
protected:
    std::map<std::string, oai::_3gpp::model::MulticastAccessControl> m_MultiAccCtrls;
