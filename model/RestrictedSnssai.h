...
public:
    ...
    /// 
    /// </summary>
    oai::model::PlmnId getHomePlmnId() const;
    void setHomePlmnId(oai::model::PlmnId const& value);
    /// <summary>
    /// 
    /// </summary>
    std::vector<oai::model::ExtSnssai> getSNssaiList() const;
    void setSNssaiList(std::vector<oai::model::ExtSnssai> const& value);
    /// <summary>
    /// 
    /// </summary>
    std::vector<oai::model::PlmnId> getHomePlmnIdList() const;
    void setHomePlmnIdList(std::vector<oai::model::PlmnId> const& value);
...
protected:
    oai::model::PlmnId m_HomePlmnId;

    std::vector<oai::model::ExtSnssai> m_SNssaiList;

    std::vector<oai::model::PlmnId> m_HomePlmnIdList;
