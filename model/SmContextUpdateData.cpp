...
bool SmContextUpdateData::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "SmContextUpdateData" : pathPrefix;
...
bool SmContextUpdateData::operator==(const SmContextUpdateData& rhs) const
{
    ...
    ((!dlNiddEndPointIsSet() && !rhs.dlNiddEndPointIsSet()) || (dlNiddEndPointIsSet() && rhs.dlNiddEndPointIsSet() && getDlNiddEndPoint() == rhs.getDlNiddEndPoint())) &&
...
oai::_3gpp::model::SmContextConfiguration SmContextUpdateData::getSmContextConfig() const
{
    return m_SmContextConfig;
}
void SmContextUpdateData::setSmContextConfig(oai::_3gpp::model::SmContextConfiguration const& value)
{
