...
public:
    ...
    /// 
    /// </summary>
    oai::_3gpp::model::LocationPrivacyVerResult getLocationPrivacyVerResult() const;
    void setLocationPrivacyVerResult(oai::_3gpp::model::LocationPrivacyVerResult const& value);
