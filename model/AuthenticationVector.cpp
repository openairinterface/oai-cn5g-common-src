...
bool AuthenticationVector::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "AuthenticationVector" : pathPrefix;

        
    if (!m_AvType.validate(msg, _pathPrefix + ".avType")) {
        msg << _pathPrefix << ": AvType is invalid;";
        success = false;
    }     
...
oai::model::AvType AuthenticationVector::getAvType() const
{
    return m_AvType;
}
void AuthenticationVector::setAvType(oai::model::AvType const& value)
{
    m_AvType = value;
}
