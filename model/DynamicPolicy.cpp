...
bool DynamicPolicy::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "DynamicPolicy" : pathPrefix;
...
bool DynamicPolicy::operator==(const DynamicPolicy& rhs) const
{
    ...
    ((!qosSpecificationIsSet() && !rhs.qosSpecificationIsSet()) || (qosSpecificationIsSet() && rhs.qosSpecificationIsSet() && getQosSpecification() == rhs.getQosSpecification())) &&
    
    
    ((!enforcementMethodIsSet() && !rhs.enforcementMethodIsSet()) || (enforcementMethodIsSet() && rhs.enforcementMethodIsSet() && getEnforcementMethod() == rhs.getEnforcementMethod())) &&
    
    
    ((!enforcementBitRateIsSet() && !rhs.enforcementBitRateIsSet()) || (enforcementBitRateIsSet() && rhs.enforcementBitRateIsSet() && getEnforcementBitRate() == rhs.getEnforcementBitRate()))
...
std::vector<oai::model::ServiceDataFlowDescription> DynamicPolicy::getServiceDataFlowDescriptions() const
{
    return m_ServiceDataFlowDescriptions;
}
void DynamicPolicy::setServiceDataFlowDescriptions(std::vector<oai::model::ServiceDataFlowDescription> const& value)
{
    m_ServiceDataFlowDescriptions = value;
}
oai::model::MediaType DynamicPolicy::getMediaType() const
{
    return m_MediaType;
}
void DynamicPolicy::setMediaType(oai::model::MediaType const& value)
{
    m_MediaType = value;
...
oai::model::M5QoSSpecification DynamicPolicy::getQosSpecification() const
{
    return m_QosSpecification;
}
void DynamicPolicy::setQosSpecification(oai::model::M5QoSSpecification const& value)
{
