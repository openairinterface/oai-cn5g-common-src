...
oai::_3gpp::model::AerialUeIndication AerialUeSubscriptionInfo::getAerialUeInd() const
{
    return m_AerialUeInd;
}
void AerialUeSubscriptionInfo::setAerialUeInd(oai::_3gpp::model::AerialUeIndication const& value)
{
    m_AerialUeInd = value;
}
