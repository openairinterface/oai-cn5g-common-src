...
void MonitoringConfiguration::setEventType(oai::_3gpp::model::EventType const& value)
{
    m_EventType = value;
}
...
oai::_3gpp::model::LocationReportingConfiguration MonitoringConfiguration::getLocationReportingConfiguration() const
{
    return m_LocationReportingConfiguration;
}
void MonitoringConfiguration::setLocationReportingConfiguration(oai::_3gpp::model::LocationReportingConfiguration const& value)
{
...
oai::_3gpp::model::AssociationType MonitoringConfiguration::getAssociationType() const
{
    return m_AssociationType;
}
void MonitoringConfiguration::setAssociationType(oai::_3gpp::model::AssociationType const& value)
{
...
oai::_3gpp::model::DatalinkReportingConfiguration MonitoringConfiguration::getDatalinkReportCfg() const
{
    return m_DatalinkReportCfg;
}
void MonitoringConfiguration::setDatalinkReportCfg(oai::_3gpp::model::DatalinkReportingConfiguration const& value)
{
...
oai::_3gpp::model::LossConnectivityCfg MonitoringConfiguration::getLossConnectivityCfg() const
{
    return m_LossConnectivityCfg;
}
void MonitoringConfiguration::setLossConnectivityCfg(oai::_3gpp::model::LossConnectivityCfg const& value)
{
...
void MonitoringConfiguration::setSingleNssai(oai::_3gpp::model::Snssai const& value)
{
    m_SingleNssai = value;
...
oai::_3gpp::model::PduSessionStatusCfg MonitoringConfiguration::getPduSessionStatusCfg() const
{
    return m_PduSessionStatusCfg;
}
void MonitoringConfiguration::setPduSessionStatusCfg(oai::_3gpp::model::PduSessionStatusCfg const& value)
{
...
oai::_3gpp::model::ReachabilityForSmsConfiguration MonitoringConfiguration::getReachabilityForSmsCfg() const
{
    return m_ReachabilityForSmsCfg;
}
void MonitoringConfiguration::setReachabilityForSmsCfg(oai::_3gpp::model::ReachabilityForSmsConfiguration const& value)
{
...
oai::_3gpp::model::ReachabilityForDataConfiguration MonitoringConfiguration::getReachabilityForDataCfg() const
{
    return m_ReachabilityForDataCfg;
}
void MonitoringConfiguration::setReachabilityForDataCfg(oai::_3gpp::model::ReachabilityForDataConfiguration const& value)
{
