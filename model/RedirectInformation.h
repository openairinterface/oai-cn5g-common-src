...
public:
    ...
    /// 
    /// </summary>
    oai::_3gpp::model::RedirectAddressType getRedirectAddressType() const;
    void setRedirectAddressType(oai::_3gpp::model::RedirectAddressType const& value);
...
protected:
    ...
    oai::_3gpp::model::RedirectAddressType m_RedirectAddressType;
