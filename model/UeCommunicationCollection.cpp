...
bool UeCommunicationCollection::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "UeCommunicationCollection" : pathPrefix;
    ...
    /* Comms */ {
        const std::vector<oai::model::CommunicationCollection>& value = m_Comms;
        ...
        { // Recursive validation of array elements
            ...
            int i = 0;
            for (const oai::model::CommunicationCollection& value : value)
            { 
...
bool UeCommunicationCollection::operator==(const UeCommunicationCollection& rhs) const
{
    return
    ...
    ((!exterGroupIdIsSet() && !rhs.exterGroupIdIsSet()) || (exterGroupIdIsSet() && rhs.exterGroupIdIsSet() && getExterGroupId() == rhs.getExterGroupId())) &&
...
std::vector<oai::model::CommunicationCollection> UeCommunicationCollection::getComms() const
{
    return m_Comms;
}
void UeCommunicationCollection::setComms(std::vector<oai::model::CommunicationCollection> const& value)
{
    m_Comms = value;
}
