...
public:
    ...
    /// </summary>
    std::map<std::string, oai::_3gpp::model::OperatorSpecificDataContainer> getOperatorSpecificDataSet() const;
    void setOperatorSpecificDataSet(std::map<std::string, oai::_3gpp::model::OperatorSpecificDataContainer> const& value);
...
protected:
    ...
    bool m_UmDataIsSet;
    std::map<std::string, oai::_3gpp::model::OperatorSpecificDataContainer> m_OperatorSpecificDataSet;
