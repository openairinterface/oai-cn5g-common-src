...
bool SnssaiUpfInfoItem::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    ...
    /* DnnUpfInfoList */ {
        const std::vector<oai::model::DnnUpfInfoItem>& value = m_DnnUpfInfoList;
        ...
        { // Recursive validation of array elements
            ...
            int i = 0;
            for (const oai::model::DnnUpfInfoItem& value : value)
            { 
...
oai::model::ExtSnssai SnssaiUpfInfoItem::getSNssai() const
{
    return m_SNssai;
}
void SnssaiUpfInfoItem::setSNssai(oai::model::ExtSnssai const& value)
{
    m_SNssai = value;
}
std::vector<oai::model::DnnUpfInfoItem> SnssaiUpfInfoItem::getDnnUpfInfoList() const
{
    return m_DnnUpfInfoList;
}
void SnssaiUpfInfoItem::setDnnUpfInfoList(std::vector<oai::model::DnnUpfInfoItem> const& value)
{
