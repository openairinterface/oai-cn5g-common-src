...
public:
    ...
    /// 
    /// </summary>
    oai::model::ExceptionId getExcepId() const;
    void setExcepId(oai::model::ExceptionId const& value);
    /// <summary>
    /// 
    /// </summary>
    ...
    /// 
    /// </summary>
    oai::model::ExceptionTrend getExcepTrend() const;
    void setExcepTrend(oai::model::ExceptionTrend const& value);
...
protected:
    oai::model::ExceptionId m_ExcepId;

    int32_t m_ExcepLevel;
    bool m_ExcepLevelIsSet;
    oai::model::ExceptionTrend m_ExcepTrend;
