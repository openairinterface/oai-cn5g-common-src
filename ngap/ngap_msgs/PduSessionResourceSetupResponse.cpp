...
void PduSessionResourceSetupResponseMsg::initialize() {
  ...
  if (!m_PduSessionResourceSetupResponseIes->protocolIEs) {
    m_PduSessionResourceSetupResponseIes->protocolIEs =
    ...
    switch (ngap_ie->id) {
      ...
      case Ngap_ProtocolIE_ID_id_UserLocationInformation: {
        ...
        oai::logger::logger_common::ngap().debug(
            "Decoding NGAP PDUSessionResourceFailedToSetupListSURes: to be "
            "implemented");
      } break;
      default: {
