...
asn_oer_constraints_t asn_OER_type_Ngap_NewSecurityContextInd_constr_1
    CC_NOTUSED = {{0, 0}, -1};
#endif /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
asn_per_constraints_t asn_PER_type_Ngap_NewSecurityContextInd_constr_1
    CC_NOTUSED = {
...
static const asn_INTEGER_enum_map_t
    asn_MAP_Ngap_NewSecurityContextInd_value2enum_1[] = {
        {0, 4, "true"}
        /* This list is extensible */
};
static int asn_validate_Ngap_NewSecurityContextInd_1(
    const asn_TYPE_descriptor_t* td, const void* sptr,
    asn_app_constraint_failed_f* ctfailcb, void* app_key) {
  if (!sptr) {
    return -1;
  }
  e_Ngap_NewSecurityContextInd value = *(e_Ngap_NewSecurityContextInd*) sptr;
  switch (value) {
    case Ngap_NewSecurityContextInd_true:
      return 0;
  }
  return -1;
}
...
const asn_INTEGER_specifics_t asn_SPC_Ngap_NewSecurityContextInd_specs_1 = {
    asn_MAP_Ngap_NewSecurityContextInd_value2enum_1, /* "tag" => N; sorted by
                                                        tag */
...
asn_TYPE_descriptor_t asn_DEF_Ngap_NewSecurityContextInd = {
        ...
        sizeof(asn_DEF_Ngap_NewSecurityContextInd_tags_1[0]), /* 1 */
    {
        ...
        asn_validate_Ngap_NewSecurityContextInd_1},
    0,
    0,                                          /* Defined elsewhere */
