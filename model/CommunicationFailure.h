...
class CommunicationFailure {
 public:
  ...
  ///
  /// </summary>
  oai::_3gpp::model::NgApCause getRanReleaseCode() const;
  void setRanReleaseCode(oai::_3gpp::model::NgApCause const& value);
 ...
 protected:
  ...
  oai::_3gpp::model::NgApCause m_RanReleaseCode;
