...
static asn_TYPE_member_t asn_MBR_Ngap_SourceNGRANNode_ToTargetNGRANNode_TransparentContainer_1[] = {
	...
	{ ATF_POINTER, 0, offsetof(struct Ngap_SourceNGRANNode_ToTargetNGRANNode_TransparentContainer, targetCell_ID),
	...
	{ ATF_POINTER, 0, offsetof(struct Ngap_SourceNGRANNode_ToTargetNGRANNode_TransparentContainer, uEHistoryInformation),
