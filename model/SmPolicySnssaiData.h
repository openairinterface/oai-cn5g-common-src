...
public:
    ...
    /// </summary>
    std::map<std::string, oai::_3gpp::model::SmPolicyDnnData> getSmPolicyDnnData() const;
    void setSmPolicyDnnData(std::map<std::string, oai::_3gpp::model::SmPolicyDnnData> const& value);
