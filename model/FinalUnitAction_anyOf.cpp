...
bool FinalUnitAction_anyOf::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "FinalUnitAction_anyOf" : pathPrefix;

    
    if (m_value == FinalUnitAction_anyOf::eFinalUnitAction_anyOf::INVALID_VALUE_OPENAPI_GENERATED)
    {
        success = false;
...
void to_json(nlohmann::json& j, const FinalUnitAction_anyOf& o)
{
    ...
    switch (o.getValue())
    {
        case FinalUnitAction_anyOf::eFinalUnitAction_anyOf::INVALID_VALUE_OPENAPI_GENERATED:
...
FinalUnitAction_anyOf::eFinalUnitAction_anyOf FinalUnitAction_anyOf::getValue() const
{
    return m_value;
}
void FinalUnitAction_anyOf::setValue(FinalUnitAction_anyOf::eFinalUnitAction_anyOf value)
{
    m_value = value;
}
