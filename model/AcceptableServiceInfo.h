...
public:
    ...
    /// </summary>
    std::map<std::string, oai::_3gpp::model::MediaComponent> getAccBwMedComps() const;
    void setAccBwMedComps(std::map<std::string, oai::_3gpp::model::MediaComponent> const& value);
...
protected:
    std::map<std::string, oai::_3gpp::model::MediaComponent> m_AccBwMedComps;
