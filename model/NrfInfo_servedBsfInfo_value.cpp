...
bool NrfInfo_servedBsfInfo_value::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    ...
    {
        const std::vector<oai::_3gpp::model::Ipv4AddressRange>& value = m_Ipv4AddressRanges;
...
std::vector<oai::_3gpp::model::std::string> NrfInfo_servedBsfInfo_value::getDnnList() const
{
    return m_DnnList;
}
void NrfInfo_servedBsfInfo_value::setDnnList(std::vector<oai::_3gpp::model::std::string> const& value)
{
    m_DnnList = value;
    m_DnnListIsSet = true;
}
...
std::vector<oai::_3gpp::model::Ipv4AddressRange> NrfInfo_servedBsfInfo_value::getIpv4AddressRanges() const
{
    return m_Ipv4AddressRanges;
}
void NrfInfo_servedBsfInfo_value::setIpv4AddressRanges(std::vector<oai::_3gpp::model::Ipv4AddressRange> const& value)
{
...
std::vector<oai::_3gpp::model::Ipv6PrefixRange> NrfInfo_servedBsfInfo_value::getIpv6PrefixRanges() const
{
    return m_Ipv6PrefixRanges;
}
void NrfInfo_servedBsfInfo_value::setIpv6PrefixRanges(std::vector<oai::_3gpp::model::Ipv6PrefixRange> const& value)
{
...
std::vector<oai::_3gpp::model::SupiRange> NrfInfo_servedBsfInfo_value::getSupiRanges() const
{
    return m_SupiRanges;
}
void NrfInfo_servedBsfInfo_value::setSupiRanges(std::vector<oai::_3gpp::model::SupiRange> const& value)
{
    m_SupiRanges = value;
...
std::vector<oai::_3gpp::model::IdentityRange> NrfInfo_servedBsfInfo_value::getGpsiRanges() const
{
    return m_GpsiRanges;
}
void NrfInfo_servedBsfInfo_value::setGpsiRanges(std::vector<oai::_3gpp::model::IdentityRange> const& value)
{
    m_GpsiRanges = value;
