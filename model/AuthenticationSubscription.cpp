...
bool AuthenticationSubscription::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "AuthenticationSubscription" : pathPrefix;

        
    if (!m_AuthenticationMethod.validate(msg, _pathPrefix + ".authenticationMethod")) {
        msg << _pathPrefix << ": AuthenticationMethod is invalid;";
        success = false;
    }                 
    if (authenticationManagementFieldIsSet())
    {
        const std::string& value = m_AuthenticationManagementField;
        const std::string currentValuePath = _pathPrefix + ".authenticationManagementField";
...
bool AuthenticationSubscription::operator==(const AuthenticationSubscription& rhs) const
{
    return
    ...
    ((!encPermanentKeyIsSet() && !rhs.encPermanentKeyIsSet()) || (encPermanentKeyIsSet() && rhs.encPermanentKeyIsSet() && getEncPermanentKey() == rhs.getEncPermanentKey())) &&
    
    
    ((!protectionParameterIdIsSet() && !rhs.protectionParameterIdIsSet()) || (protectionParameterIdIsSet() && rhs.protectionParameterIdIsSet() && getProtectionParameterId() == rhs.getProtectionParameterId())) &&
    
    
    ((!sequenceNumberIsSet() && !rhs.sequenceNumberIsSet()) || (sequenceNumberIsSet() && rhs.sequenceNumberIsSet() && getSequenceNumber() == rhs.getSequenceNumber())) &&
    
    
    ((!authenticationManagementFieldIsSet() && !rhs.authenticationManagementFieldIsSet()) || (authenticationManagementFieldIsSet() && rhs.authenticationManagementFieldIsSet() && getAuthenticationManagementField() == rhs.getAuthenticationManagementField())) &&
    
    
    ((!algorithmIdIsSet() && !rhs.algorithmIdIsSet()) || (algorithmIdIsSet() && rhs.algorithmIdIsSet() && getAlgorithmId() == rhs.getAlgorithmId())) &&
    
    
    ((!encOpcKeyIsSet() && !rhs.encOpcKeyIsSet()) || (encOpcKeyIsSet() && rhs.encOpcKeyIsSet() && getEncOpcKey() == rhs.getEncOpcKey())) &&
    
    
    ((!encTopcKeyIsSet() && !rhs.encTopcKeyIsSet()) || (encTopcKeyIsSet() && rhs.encTopcKeyIsSet() && getEncTopcKey() == rhs.getEncTopcKey())) &&
    
    
    ((!vectorGenerationInHssIsSet() && !rhs.vectorGenerationInHssIsSet()) || (vectorGenerationInHssIsSet() && rhs.vectorGenerationInHssIsSet() && isVectorGenerationInHss() == rhs.isVectorGenerationInHss())) &&
    
    
    ((!hssGroupIdIsSet() && !rhs.hssGroupIdIsSet()) || (hssGroupIdIsSet() && rhs.hssGroupIdIsSet() && getHssGroupId() == rhs.getHssGroupId())) &&
    
    
    ((!n5gcAuthMethodIsSet() && !rhs.n5gcAuthMethodIsSet()) || (n5gcAuthMethodIsSet() && rhs.n5gcAuthMethodIsSet() && getN5gcAuthMethod() == rhs.getN5gcAuthMethod())) &&
    
    
    ((!rgAuthenticationIndIsSet() && !rhs.rgAuthenticationIndIsSet()) || (rgAuthenticationIndIsSet() && rhs.rgAuthenticationIndIsSet() && isRgAuthenticationInd() == rhs.isRgAuthenticationInd())) &&
    
    
    ((!supiIsSet() && !rhs.supiIsSet()) || (supiIsSet() && rhs.supiIsSet() && getSupi() == rhs.getSupi())) &&
    
    
    ((!akmaAllowedIsSet() && !rhs.akmaAllowedIsSet()) || (akmaAllowedIsSet() && rhs.akmaAllowedIsSet() && isAkmaAllowed() == rhs.isAkmaAllowed())) &&
    
    
    ((!routingIdIsSet() && !rhs.routingIdIsSet()) || (routingIdIsSet() && rhs.routingIdIsSet() && getRoutingId() == rhs.getRoutingId())) &&
    
    
    ((!nswoAllowedIsSet() && !rhs.nswoAllowedIsSet()) || (nswoAllowedIsSet() && rhs.nswoAllowedIsSet() && isNswoAllowed() == rhs.isNswoAllowed()))
...
void to_json(nlohmann::json& j, const AuthenticationSubscription& o)
{
    ...
    if(o.nswoAllowedIsSet())
        j["nswoAllowed"] = o.m_NswoAllowed;
...
oai::model::AuthMethod AuthenticationSubscription::getAuthenticationMethod() const
{
    return m_AuthenticationMethod;
}
void AuthenticationSubscription::setAuthenticationMethod(oai::model::AuthMethod const& value)
{
...
void AuthenticationSubscription::setProtectionParameterId(std::string const& value)
{
...
oai::model::SequenceNumber AuthenticationSubscription::getSequenceNumber() const
{
    return m_SequenceNumber;
}
void AuthenticationSubscription::setSequenceNumber(oai::model::SequenceNumber const& value)
{
...
std::string AuthenticationSubscription::getAuthenticationManagementField() const
{
    return m_AuthenticationManagementField;
}
void AuthenticationSubscription::setAuthenticationManagementField(std::string const& value)
{
...
oai::model::AuthMethod AuthenticationSubscription::getN5gcAuthMethod() const
{
    return m_N5gcAuthMethod;
}
void AuthenticationSubscription::setN5gcAuthMethod(oai::model::AuthMethod const& value)
{
