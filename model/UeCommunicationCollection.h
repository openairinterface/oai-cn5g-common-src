...
public:
    ...
    virtual ~UeCommunicationCollection() = default;
    ...
    bool operator==(const UeCommunicationCollection& rhs) const;
    bool operator!=(const UeCommunicationCollection& rhs) const;
    ...
    /// 
    /// </summary>
    std::vector<oai::model::CommunicationCollection> getComms() const;
    void setComms(std::vector<oai::model::CommunicationCollection> const& value);
...
protected:
    ...
    std::vector<oai::model::CommunicationCollection> m_Comms;
