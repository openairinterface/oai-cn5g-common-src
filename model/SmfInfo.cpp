...
std::vector<oai::model::SnssaiSmfInfoItem> SmfInfo::getSNssaiSmfInfoList() const
{
    return m_SNssaiSmfInfoList;
}
void SmfInfo::setSNssaiSmfInfoList(std::vector<oai::model::SnssaiSmfInfoItem> const& value)
{
    m_SNssaiSmfInfoList = value;
}
std::vector<oai::model::Tai> SmfInfo::getTaiList() const
{
    return m_TaiList;
}
void SmfInfo::setTaiList(std::vector<oai::model::Tai> const& value)
{
    m_TaiList = value;
    m_TaiListIsSet = true;
}
...
std::vector<oai::model::TaiRange> SmfInfo::getTaiRangeList() const
{
    return m_TaiRangeList;
}
void SmfInfo::setTaiRangeList(std::vector<oai::model::TaiRange> const& value)
{
...
std::vector<oai::model::IpAddr> SmfInfo::getPgwIpAddrList() const
{
    return m_PgwIpAddrList;
}
void SmfInfo::setPgwIpAddrList(std::vector<oai::model::IpAddr> const& value)
{
...
std::vector<oai::model::AccessType> SmfInfo::getAccessType() const
{
    return m_AccessType;
}
void SmfInfo::setAccessType(std::vector<oai::model::AccessType> const& value)
{
    m_AccessType = value;
