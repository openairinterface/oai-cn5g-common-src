...
bool DownlinkDataNotificationControlRm::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    ...
    {
        const std::vector<oai::model::NotificationControlIndication>& value = m_NotifCtrlInds;
        ...
        { // Recursive validation of array elements
            ...
            int i = 0;
            for (const oai::model::NotificationControlIndication& value : value)
            { 
...
std::vector<oai::model::NotificationControlIndication> DownlinkDataNotificationControlRm::getNotifCtrlInds() const
{
    return m_NotifCtrlInds;
}
void DownlinkDataNotificationControlRm::setNotifCtrlInds(std::vector<oai::model::NotificationControlIndication> const& value)
{
...
std::vector<oai::model::DlDataDeliveryStatus> DownlinkDataNotificationControlRm::getTypesOfNotif() const
{
    return m_TypesOfNotif;
}
void DownlinkDataNotificationControlRm::setTypesOfNotif(std::vector<oai::model::DlDataDeliveryStatus> const& value)
{
