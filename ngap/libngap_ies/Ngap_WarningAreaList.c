...
asn_oer_constraints_t asn_OER_type_Ngap_WarningAreaList_constr_1 CC_NOTUSED = {
    {0, 0},
    -1};
...
asn_TYPE_member_t asn_MBR_Ngap_WarningAreaList_1[] = {
    {ATF_POINTER,
     0,
     offsetof(struct Ngap_WarningAreaList, choice.eUTRA_CGIListForWarning),
    ...
    {ATF_POINTER,
     0,
     offsetof(struct Ngap_WarningAreaList, choice.nR_CGIListForWarning),
    ...
    {ATF_POINTER,
     0,
     offsetof(struct Ngap_WarningAreaList, choice.tAIListForWarning),
    ...
    {ATF_POINTER,
     0,
     offsetof(struct Ngap_WarningAreaList, choice.emergencyAreaIDList),
    ...
    {ATF_POINTER,
     ...
     -1, /* IMPLICIT tag at current level */
     &asn_DEF_Ngap_ProtocolIE_SingleContainer_12877P63,
     0,
     {
#if !defined(ASN_DISABLE_OER_SUPPORT)
         0,
