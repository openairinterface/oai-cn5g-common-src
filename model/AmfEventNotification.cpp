...
std::vector<oai::_3gpp::model::AmfEventReport> AmfEventNotification::getReportList() const
{
    return m_ReportList;
}
void AmfEventNotification::setReportList(std::vector<oai::_3gpp::model::AmfEventReport> const& value)
{
    m_ReportList = value;
...
oai::_3gpp::model::AmfEventSubsSyncInfo AmfEventNotification::getEventSubsSyncInfo() const
{
    return m_EventSubsSyncInfo;
}
void AmfEventNotification::setEventSubsSyncInfo(oai::_3gpp::model::AmfEventSubsSyncInfo const& value)
{
