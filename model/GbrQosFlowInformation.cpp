...
bool GbrQosFlowInformation::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "GbrQosFlowInformation" : pathPrefix;
    ...
    {
        const std::vector<oai::model::AlternativeQosProfile>& value = m_AlternativeQosProfileList;
        const std::string currentValuePath = _pathPrefix + ".alternativeQosProfileList";
                
        
        { // Recursive validation of array elements
            const std::string oldValuePath = currentValuePath;
            int i = 0;
            for (const oai::model::AlternativeQosProfile& value : value)
            { 
                const std::string currentValuePath = oldValuePath + "[" + std::to_string(i) + "]";
                        
        success = value.validate(msg, currentValuePath + ".alternativeQosProfileList") && success;
...
bool GbrQosFlowInformation::operator==(const GbrQosFlowInformation& rhs) const
{
    ...
    ((!notifControlIsSet() && !rhs.notifControlIsSet()) || (notifControlIsSet() && rhs.notifControlIsSet() && getNotifControl() == rhs.getNotifControl())) &&
    ...
    ((!alternativeQosProfileListIsSet() && !rhs.alternativeQosProfileListIsSet()) || (alternativeQosProfileListIsSet() && rhs.alternativeQosProfileListIsSet() && getAlternativeQosProfileList() == rhs.getAlternativeQosProfileList()))
...
void to_json(nlohmann::json& j, const GbrQosFlowInformation& o)
{
    ...
    if(o.alternativeQosProfileListIsSet() || !o.m_AlternativeQosProfileList.empty())
...
oai::model::NotificationControl GbrQosFlowInformation::getNotifControl() const
{
    return m_NotifControl;
}
void GbrQosFlowInformation::setNotifControl(oai::model::NotificationControl const& value)
{
...
std::vector<oai::model::AlternativeQosProfile> GbrQosFlowInformation::getAlternativeQosProfileList() const
{
    return m_AlternativeQosProfileList;
}
void GbrQosFlowInformation::setAlternativeQosProfileList(std::vector<oai::model::AlternativeQosProfile> const& value)
{
