...
oai::model::AccessType ConditionData::getAccessType() const
{
    return m_AccessType;
}
void ConditionData::setAccessType(oai::model::AccessType const& value)
{
    m_AccessType = value;
...
oai::model::RatType ConditionData::getRatType() const
{
    return m_RatType;
}
void ConditionData::setRatType(oai::model::RatType const& value)
{
    m_RatType = value;
    m_RatTypeIsSet = true;
}
