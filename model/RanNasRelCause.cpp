...
bool RanNasRelCause::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "RanNasRelCause" : pathPrefix;
...
bool RanNasRelCause::operator==(const RanNasRelCause& rhs) const
{
    ...
    ((!r5gMmCauseIsSet() && !rhs.r5gMmCauseIsSet()) || (r5gMmCauseIsSet() && rhs.r5gMmCauseIsSet() && getR5gMmCause() == rhs.getR5gMmCause())) &&
    
    
    ((!r5gSmCauseIsSet() && !rhs.r5gSmCauseIsSet()) || (r5gSmCauseIsSet() && rhs.r5gSmCauseIsSet() && getR5gSmCause() == rhs.getR5gSmCause())) &&
    
    
    ((!epsCauseIsSet() && !rhs.epsCauseIsSet()) || (epsCauseIsSet() && rhs.epsCauseIsSet() && getEpsCause() == rhs.getEpsCause()))
...
oai::_3gpp::model::NgApCause RanNasRelCause::getNgApCause() const
{
    return m_NgApCause;
}
void RanNasRelCause::setNgApCause(oai::_3gpp::model::NgApCause const& value)
{
    m_NgApCause = value;
