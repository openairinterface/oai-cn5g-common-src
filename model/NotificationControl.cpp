...
NotificationControl_anyOf::eNotificationControl_anyOf NotificationControl::getEnumValue() const
{
    return m_value.getValue();
}

void NotificationControl::setEnumValue(NotificationControl_anyOf::eNotificationControl_anyOf  value)
{
