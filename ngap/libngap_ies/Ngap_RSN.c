...
asn_oer_constraints_t asn_OER_type_Ngap_RSN_constr_1 CC_NOTUSED = {
	{ 0, 0 },
	-1};
...
static int asn_validate_Ngap_RSN_1(const asn_TYPE_descriptor_t *td,
                       const void *sptr,
                       asn_app_constraint_failed_f *ctfailcb,
                       void* app_key) {
    if(! sptr) { return -1; }
    e_Ngap_RSN value = *(e_Ngap_RSN*)sptr;
    switch(value) {
    case Ngap_RSN_v1:
    case Ngap_RSN_v2:
        return 0;
