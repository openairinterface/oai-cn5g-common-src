...
bool ExtProblemDetails::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "ExtProblemDetails" : pathPrefix;
...
std::vector<oai::_3gpp::model::InvalidParam> ExtProblemDetails::getInvalidParams() const
{
    return m_InvalidParams;
}
void ExtProblemDetails::setInvalidParams(std::vector<oai::_3gpp::model::InvalidParam> const& value)
{
...
oai::_3gpp::model::AccessTokenErr ExtProblemDetails::getAccessTokenError() const
{
    return m_AccessTokenError;
}
void ExtProblemDetails::setAccessTokenError(oai::_3gpp::model::AccessTokenErr const& value)
{
...
oai::_3gpp::model::AccessTokenReq ExtProblemDetails::getAccessTokenRequest() const
{
    return m_AccessTokenRequest;
}
void ExtProblemDetails::setAccessTokenRequest(oai::_3gpp::model::AccessTokenReq const& value)
{
