...
bool BatteryIndicationRm::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "BatteryIndicationRm" : pathPrefix;
...
bool BatteryIndicationRm::operator==(const BatteryIndicationRm& rhs) const
{
    ...
    ((!batteryIndIsSet() && !rhs.batteryIndIsSet()) || (batteryIndIsSet() && rhs.batteryIndIsSet() && isBatteryInd() == rhs.isBatteryInd())) &&
    
    
    ((!replaceableIndIsSet() && !rhs.replaceableIndIsSet()) || (replaceableIndIsSet() && rhs.replaceableIndIsSet() && isReplaceableInd() == rhs.isReplaceableInd())) &&
    
    
    ((!rechargeableIndIsSet() && !rhs.rechargeableIndIsSet()) || (rechargeableIndIsSet() && rhs.rechargeableIndIsSet() && isRechargeableInd() == rhs.isRechargeableInd()))
