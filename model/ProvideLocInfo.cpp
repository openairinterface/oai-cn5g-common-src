...
void ProvideLocInfo::setAdditionalLocation(oai::_3gpp::model::UserLocation const& value)
{
...
void ProvideLocInfo::setGeoInfo(oai::_3gpp::model::GeographicArea const& value)
{
    m_GeoInfo = value;
    m_GeoInfoIsSet = true;
}
