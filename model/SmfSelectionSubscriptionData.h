...
public:
    ...
    /// </summary>
    std::map<std::string, oai::_3gpp::model::SnssaiInfo> getSubscribedSnssaiInfos() const;
    void setSubscribedSnssaiInfos(std::map<std::string, oai::_3gpp::model::SnssaiInfo> const& value);
