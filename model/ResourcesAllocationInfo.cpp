...
bool ResourcesAllocationInfo::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "ResourcesAllocationInfo" : pathPrefix;

             
    if (flowsIsSet())
    {
        const std::vector<oai::model::Flows>& value = m_Flows;
        ...
        { // Recursive validation of array elements
            ...
            int i = 0;
            for (const oai::model::Flows& value : value)
            { 
...
bool ResourcesAllocationInfo::operator==(const ResourcesAllocationInfo& rhs) const
{
    return
    
    
    
    ((!mcResourcStatusIsSet() && !rhs.mcResourcStatusIsSet()) || (mcResourcStatusIsSet() && rhs.mcResourcStatusIsSet() && getMcResourcStatus() == rhs.getMcResourcStatus())) &&
    
    
    ((!flowsIsSet() && !rhs.flowsIsSet()) || (flowsIsSet() && rhs.flowsIsSet() && getFlows() == rhs.getFlows())) &&
    
    
    ((!altSerReqIsSet() && !rhs.altSerReqIsSet()) || (altSerReqIsSet() && rhs.altSerReqIsSet() && getAltSerReq() == rhs.getAltSerReq()))
...
oai::model::MediaComponentResourcesStatus ResourcesAllocationInfo::getMcResourcStatus() const
{
    return m_McResourcStatus;
}
void ResourcesAllocationInfo::setMcResourcStatus(oai::model::MediaComponentResourcesStatus const& value)
{
...
std::vector<oai::model::Flows> ResourcesAllocationInfo::getFlows() const
{
    return m_Flows;
}
void ResourcesAllocationInfo::setFlows(std::vector<oai::model::Flows> const& value)
{
    m_Flows = value;
    m_FlowsIsSet = true;
}
