...
bool SmPolicyUpdateContextData::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "SmPolicyUpdateContextData" : pathPrefix;

         
    if (repPolicyCtrlReqTriggersIsSet())
    {
        const std::vector<oai::_3gpp::model::PolicyControlRequestTrigger>& value = m_RepPolicyCtrlReqTriggers;
        const std::string currentValuePath = _pathPrefix + ".repPolicyCtrlReqTriggers";
        ...
        { // Recursive validation of array elements
            ...
            int i = 0;
            for (const oai::_3gpp::model::PolicyControlRequestTrigger& value : value)
            { 
                const std::string currentValuePath = oldValuePath + "[" + std::to_string(i) + "]";
                        
        success = value.validate(msg, currentValuePath + ".repPolicyCtrlReqTriggers") && success;
    ...
    if (accNetChIdsIsSet())
    {
        const std::vector<oai::_3gpp::model::AccNetChId>& value = m_AccNetChIds;
        ...
        { // Recursive validation of array elements
            const std::string oldValuePath = currentValuePath;
            int i = 0;
            for (const oai::_3gpp::model::AccNetChId& value : value)
            { 
                const std::string currentValuePath = oldValuePath + "[" + std::to_string(i) + "]";
                        
        success = value.validate(msg, currentValuePath + ".accNetChIds") && success;
    ...
    {
        const std::vector<oai::_3gpp::model::AccuUsageReport>& value = m_AccuUsageReports;
        ...
        { // Recursive validation of array elements
            const std::string oldValuePath = currentValuePath;
            int i = 0;
            for (const oai::_3gpp::model::AccuUsageReport& value : value)
            { 
                const std::string currentValuePath = oldValuePath + "[" + std::to_string(i) + "]";
                        
        success = value.validate(msg, currentValuePath + ".accuUsageReports") && success;
    ...
    {
        const std::vector<oai::_3gpp::model::AppDetectionInfo>& value = m_AppDetectionInfos;
        ...
        { // Recursive validation of array elements
            const std::string oldValuePath = currentValuePath;
            int i = 0;
            for (const oai::_3gpp::model::AppDetectionInfo& value : value)
            { 
                const std::string currentValuePath = oldValuePath + "[" + std::to_string(i) + "]";
                        
        success = value.validate(msg, currentValuePath + ".appDetectionInfos") && success;
    ...
    if (ruleReportsIsSet())
    {
        ...
        success = value.validate(msg, currentValuePath + ".ruleReports") && success;
    ...
    {
        const std::vector<oai::_3gpp::model::SessionRuleReport>& value = m_SessRuleReports;
        ...
        success = value.validate(msg, currentValuePath + ".sessRuleReports") && success;
    ...
    if (qncReportsIsSet())
    {
        const std::vector<oai::_3gpp::model::QosNotificationControlInfo>& value = m_QncReports;
        ...
        success = value.validate(msg, currentValuePath + ".qncReports") && success;
    ...
    {
        const std::vector<oai::_3gpp::model::QosMonitoringReport>& value = m_QosMonReports;
        ...
        success = value.validate(msg, currentValuePath + ".qosMonReports") && success;
    ...
    if (repPraInfosIsSet())
    {
        const std::map<std::string, oai::_3gpp::model::PresenceInfo>& value = m_RepPraInfos;
    ...
    {
        const std::vector<oai::_3gpp::model::PortManagementContainer>& value = m_TsnPortManContNwtts;
        ...
        success = value.validate(msg, currentValuePath + ".tsnPortManContNwtts") && success;
    ...
    {
        const std::vector<oai::_3gpp::model::IpMulticastAddressInfo>& value = m_MulAddrInfos;
        ...
        { // Recursive validation of array elements
            const std::string oldValuePath = currentValuePath;
            int i = 0;
            for (const oai::_3gpp::model::IpMulticastAddressInfo& value : value)
            { 
                const std::string currentValuePath = oldValuePath + "[" + std::to_string(i) + "]";
                        
        success = value.validate(msg, currentValuePath + ".mulAddrInfos") && success;
    ...
    {
        const std::vector<oai::_3gpp::model::PolicyDecisionFailureCode>& value = m_PolicyDecFailureReports;
        const std::string currentValuePath = _pathPrefix + ".policyDecFailureReports";
        ...
        success = value.validate(msg, currentValuePath + ".policyDecFailureReports") && success;
    ...
    {
        const std::vector<oai::_3gpp::model::InvalidParam>& value = m_InvalidPolicyDecs;
        ...
        success = value.validate(msg, currentValuePath + ".invalidPolicyDecs") && success;
    ...
    {
        const std::vector<oai::_3gpp::model::DddTrafficDescriptor>& value = m_TrafficDescriptors;
        ...
        success = value.validate(msg, currentValuePath + ".trafficDescriptors") && success;
    ...
    {
        const std::vector<oai::_3gpp::model::DlDataDeliveryStatus>& value = m_TypesOfNotif;
        ...
        success = value.validate(msg, currentValuePath + ".typesOfNotif") && success;
    ...
    if (interGrpIdsIsSet())
    {
        const std::vector<oai::_3gpp::model::std::string>& value = m_InterGrpIds;
    ...
    if (nwdafDatasIsSet())
    {
        ...
        success = value.validate(msg, currentValuePath + ".nwdafDatas") && success;
...
bool SmPolicyUpdateContextData::operator==(const SmPolicyUpdateContextData& rhs) const
{
    return
    
    
    
    ((!repPolicyCtrlReqTriggersIsSet() && !rhs.repPolicyCtrlReqTriggersIsSet()) || (repPolicyCtrlReqTriggersIsSet() && rhs.repPolicyCtrlReqTriggersIsSet() && getRepPolicyCtrlReqTriggers() == rhs.getRepPolicyCtrlReqTriggers())) &&
    ...
    ((!addAccessInfoIsSet() && !rhs.addAccessInfoIsSet()) || (addAccessInfoIsSet() && rhs.addAccessInfoIsSet() && getAddAccessInfo() == rhs.getAddAccessInfo())) &&
    
    
    ((!relAccessInfoIsSet() && !rhs.relAccessInfoIsSet()) || (relAccessInfoIsSet() && rhs.relAccessInfoIsSet() && getRelAccessInfo() == rhs.getRelAccessInfo())) &&
    
    
    ((!servingNetworkIsSet() && !rhs.servingNetworkIsSet()) || (servingNetworkIsSet() && rhs.servingNetworkIsSet() && getServingNetwork() == rhs.getServingNetwork())) &&
    ...
    ((!relIpv4AddressIsSet() && !rhs.relIpv4AddressIsSet()) || (relIpv4AddressIsSet() && rhs.relIpv4AddressIsSet() && getRelIpv4Address() == rhs.getRelIpv4Address())) &&
    ...
    ((!ipv6AddressPrefixIsSet() && !rhs.ipv6AddressPrefixIsSet()) || (ipv6AddressPrefixIsSet() && rhs.ipv6AddressPrefixIsSet() && getIpv6AddressPrefix() == rhs.getIpv6AddressPrefix())) &&
    
    
    ((!relIpv6AddressPrefixIsSet() && !rhs.relIpv6AddressPrefixIsSet()) || (relIpv6AddressPrefixIsSet() && rhs.relIpv6AddressPrefixIsSet() && getRelIpv6AddressPrefix() == rhs.getRelIpv6AddressPrefix())) &&
    
    
    ((!addIpv6AddrPrefixesIsSet() && !rhs.addIpv6AddrPrefixesIsSet()) || (addIpv6AddrPrefixesIsSet() && rhs.addIpv6AddrPrefixesIsSet() && getAddIpv6AddrPrefixes() == rhs.getAddIpv6AddrPrefixes())) &&
    
    
    ((!addRelIpv6AddrPrefixesIsSet() && !rhs.addRelIpv6AddrPrefixesIsSet()) || (addRelIpv6AddrPrefixesIsSet() && rhs.addRelIpv6AddrPrefixesIsSet() && getAddRelIpv6AddrPrefixes() == rhs.getAddRelIpv6AddrPrefixes())) &&
    
    
    ((!relUeMacIsSet() && !rhs.relUeMacIsSet()) || (relUeMacIsSet() && rhs.relUeMacIsSet() && getRelUeMac() == rhs.getRelUeMac())) &&
    
    
    ((!ueMacIsSet() && !rhs.ueMacIsSet()) || (ueMacIsSet() && rhs.ueMacIsSet() && getUeMac() == rhs.getUeMac())) &&
    
    
    ((!subsSessAmbrIsSet() && !rhs.subsSessAmbrIsSet()) || (subsSessAmbrIsSet() && rhs.subsSessAmbrIsSet() && getSubsSessAmbr() == rhs.getSubsSessAmbr())) &&
    
    
    ((!authProfIndexIsSet() && !rhs.authProfIndexIsSet()) || (authProfIndexIsSet() && rhs.authProfIndexIsSet() && getAuthProfIndex() == rhs.getAuthProfIndex())) &&
    
    
    ((!subsDefQosIsSet() && !rhs.subsDefQosIsSet()) || (subsDefQosIsSet() && rhs.subsDefQosIsSet() && getSubsDefQos() == rhs.getSubsDefQos())) &&
    
    
    ((!vplmnQosIsSet() && !rhs.vplmnQosIsSet()) || (vplmnQosIsSet() && rhs.vplmnQosIsSet() && getVplmnQos() == rhs.getVplmnQos())) &&
    
    
    ((!vplmnQosNotAppIsSet() && !rhs.vplmnQosNotAppIsSet()) || (vplmnQosNotAppIsSet() && rhs.vplmnQosNotAppIsSet() && isVplmnQosNotApp() == rhs.isVplmnQosNotApp())) &&
    
    
    ((!numOfPackFilterIsSet() && !rhs.numOfPackFilterIsSet()) || (numOfPackFilterIsSet() && rhs.numOfPackFilterIsSet() && getNumOfPackFilter() == rhs.getNumOfPackFilter())) &&
    
    
    ((!accuUsageReportsIsSet() && !rhs.accuUsageReportsIsSet()) || (accuUsageReportsIsSet() && rhs.accuUsageReportsIsSet() && getAccuUsageReports() == rhs.getAccuUsageReports())) &&
    
    
    ((!r3gppPsDataOffStatusIsSet() && !rhs.r3gppPsDataOffStatusIsSet()) || (r3gppPsDataOffStatusIsSet() && rhs.r3gppPsDataOffStatusIsSet() && isR3gppPsDataOffStatus() == rhs.isR3gppPsDataOffStatus())) &&
    
    
    ((!appDetectionInfosIsSet() && !rhs.appDetectionInfosIsSet()) || (appDetectionInfosIsSet() && rhs.appDetectionInfosIsSet() && getAppDetectionInfos() == rhs.getAppDetectionInfos())) &&
    
    
    ((!ruleReportsIsSet() && !rhs.ruleReportsIsSet()) || (ruleReportsIsSet() && rhs.ruleReportsIsSet() && getRuleReports() == rhs.getRuleReports())) &&
    
    
    ((!sessRuleReportsIsSet() && !rhs.sessRuleReportsIsSet()) || (sessRuleReportsIsSet() && rhs.sessRuleReportsIsSet() && getSessRuleReports() == rhs.getSessRuleReports())) &&
    
    
    ((!qncReportsIsSet() && !rhs.qncReportsIsSet()) || (qncReportsIsSet() && rhs.qncReportsIsSet() && getQncReports() == rhs.getQncReports())) &&
    
    
    ((!qosMonReportsIsSet() && !rhs.qosMonReportsIsSet()) || (qosMonReportsIsSet() && rhs.qosMonReportsIsSet() && getQosMonReports() == rhs.getQosMonReports())) &&
    
    
    ((!userLocationInfoTimeIsSet() && !rhs.userLocationInfoTimeIsSet()) || (userLocationInfoTimeIsSet() && rhs.userLocationInfoTimeIsSet() && getUserLocationInfoTime() == rhs.getUserLocationInfoTime())) &&
    
    
    ((!repPraInfosIsSet() && !rhs.repPraInfosIsSet()) || (repPraInfosIsSet() && rhs.repPraInfosIsSet() && getRepPraInfos() == rhs.getRepPraInfos())) &&
    
    
    ((!ueInitResReqIsSet() && !rhs.ueInitResReqIsSet()) || (ueInitResReqIsSet() && rhs.ueInitResReqIsSet() && getUeInitResReq() == rhs.getUeInitResReq())) &&
    
    
    ((!refQosIndicationIsSet() && !rhs.refQosIndicationIsSet()) || (refQosIndicationIsSet() && rhs.refQosIndicationIsSet() && isRefQosIndication() == rhs.isRefQosIndication())) &&
    
    
    ((!qosFlowUsageIsSet() && !rhs.qosFlowUsageIsSet()) || (qosFlowUsageIsSet() && rhs.qosFlowUsageIsSet() && getQosFlowUsage() == rhs.getQosFlowUsage())) &&
    
    
    ((!creditManageStatusIsSet() && !rhs.creditManageStatusIsSet()) || (creditManageStatusIsSet() && rhs.creditManageStatusIsSet() && getCreditManageStatus() == rhs.getCreditManageStatus())) &&
    
    
    ((!servNfIdIsSet() && !rhs.servNfIdIsSet()) || (servNfIdIsSet() && rhs.servNfIdIsSet() && getServNfId() == rhs.getServNfId())) &&
    
    
    ((!traceReqIsSet() && !rhs.traceReqIsSet()) || (traceReqIsSet() && rhs.traceReqIsSet() && getTraceReq() == rhs.getTraceReq())) &&
    
    
    ((!maPduIndIsSet() && !rhs.maPduIndIsSet()) || (maPduIndIsSet() && rhs.maPduIndIsSet() && getMaPduInd() == rhs.getMaPduInd())) &&
    
    
    ((!atsssCapabIsSet() && !rhs.atsssCapabIsSet()) || (atsssCapabIsSet() && rhs.atsssCapabIsSet() && getAtsssCapab() == rhs.getAtsssCapab())) &&
    
    
    ((!tsnBridgeInfoIsSet() && !rhs.tsnBridgeInfoIsSet()) || (tsnBridgeInfoIsSet() && rhs.tsnBridgeInfoIsSet() && getTsnBridgeInfo() == rhs.getTsnBridgeInfo())) &&
    
    
    ((!tsnBridgeManContIsSet() && !rhs.tsnBridgeManContIsSet()) || (tsnBridgeManContIsSet() && rhs.tsnBridgeManContIsSet() && getTsnBridgeManCont() == rhs.getTsnBridgeManCont())) &&
    
    
    ((!tsnPortManContDsttIsSet() && !rhs.tsnPortManContDsttIsSet()) || (tsnPortManContDsttIsSet() && rhs.tsnPortManContDsttIsSet() && getTsnPortManContDstt() == rhs.getTsnPortManContDstt())) &&
    
    
    ((!tsnPortManContNwttsIsSet() && !rhs.tsnPortManContNwttsIsSet()) || (tsnPortManContNwttsIsSet() && rhs.tsnPortManContNwttsIsSet() && getTsnPortManContNwtts() == rhs.getTsnPortManContNwtts())) &&
    
    
    ((!mulAddrInfosIsSet() && !rhs.mulAddrInfosIsSet()) || (mulAddrInfosIsSet() && rhs.mulAddrInfosIsSet() && getMulAddrInfos() == rhs.getMulAddrInfos())) &&
    
    
    ((!policyDecFailureReportsIsSet() && !rhs.policyDecFailureReportsIsSet()) || (policyDecFailureReportsIsSet() && rhs.policyDecFailureReportsIsSet() && getPolicyDecFailureReports() == rhs.getPolicyDecFailureReports())) &&
    
    
    ((!invalidPolicyDecsIsSet() && !rhs.invalidPolicyDecsIsSet()) || (invalidPolicyDecsIsSet() && rhs.invalidPolicyDecsIsSet() && getInvalidPolicyDecs() == rhs.getInvalidPolicyDecs())) &&
    
    
    ((!trafficDescriptorsIsSet() && !rhs.trafficDescriptorsIsSet()) || (trafficDescriptorsIsSet() && rhs.trafficDescriptorsIsSet() && getTrafficDescriptors() == rhs.getTrafficDescriptors())) &&
    
    
    ((!pccRuleIdIsSet() && !rhs.pccRuleIdIsSet()) || (pccRuleIdIsSet() && rhs.pccRuleIdIsSet() && getPccRuleId() == rhs.getPccRuleId())) &&
    
    
    ((!typesOfNotifIsSet() && !rhs.typesOfNotifIsSet()) || (typesOfNotifIsSet() && rhs.typesOfNotifIsSet() && getTypesOfNotif() == rhs.getTypesOfNotif())) &&
    
    
    ((!interGrpIdsIsSet() && !rhs.interGrpIdsIsSet()) || (interGrpIdsIsSet() && rhs.interGrpIdsIsSet() && getInterGrpIds() == rhs.getInterGrpIds())) &&
    
    
    ((!satBackhaulCategoryIsSet() && !rhs.satBackhaulCategoryIsSet()) || (satBackhaulCategoryIsSet() && rhs.satBackhaulCategoryIsSet() && getSatBackhaulCategory() == rhs.getSatBackhaulCategory())) &&
    
    
    ((!pcfUeInfoIsSet() && !rhs.pcfUeInfoIsSet()) || (pcfUeInfoIsSet() && rhs.pcfUeInfoIsSet() && getPcfUeInfo() == rhs.getPcfUeInfo())) &&
    
    
    ((!nwdafDatasIsSet() && !rhs.nwdafDatasIsSet()) || (nwdafDatasIsSet() && rhs.nwdafDatasIsSet() && getNwdafDatas() == rhs.getNwdafDatas())) &&
    
    
    ((!anGwStatusIsSet() && !rhs.anGwStatusIsSet()) || (anGwStatusIsSet() && rhs.anGwStatusIsSet() && isAnGwStatus() == rhs.isAnGwStatus()))
...
{
    j = nlohmann::json();
    if(o.repPolicyCtrlReqTriggersIsSet() || !o.m_RepPolicyCtrlReqTriggers.empty())
    ...
    if(o.vplmnQosNotAppIsSet())
        j["vplmnQosNotApp"] = o.m_VplmnQosNotApp;
    ...
    if(o.pcfUeInfoIsSet())
        j["pcfUeInfo"] = o.m_PcfUeInfo;
    if(o.nwdafDatasIsSet() || !o.m_NwdafDatas.empty())
        j["nwdafDatas"] = o.m_NwdafDatas;
    if(o.anGwStatusIsSet())
        j["anGwStatus"] = o.m_AnGwStatus;
...
void from_json(const nlohmann::json& j, SmPolicyUpdateContextData& o)
{
    ...
    if(j.find("anGwStatus") != j.end())
    {
        j.at("anGwStatus").get_to(o.m_AnGwStatus);
        o.m_AnGwStatusIsSet = true;
    } 
    
}

std::vector<oai::_3gpp::model::PolicyControlRequestTrigger> SmPolicyUpdateContextData::getRepPolicyCtrlReqTriggers() const
{
    return m_RepPolicyCtrlReqTriggers;
}
void SmPolicyUpdateContextData::setRepPolicyCtrlReqTriggers(std::vector<oai::_3gpp::model::PolicyControlRequestTrigger> const& value)
{
...
std::vector<oai::_3gpp::model::AccNetChId> SmPolicyUpdateContextData::getAccNetChIds() const
{
    return m_AccNetChIds;
}
void SmPolicyUpdateContextData::setAccNetChIds(std::vector<oai::_3gpp::model::AccNetChId> const& value)
{
    m_AccNetChIds = value;
...
oai::_3gpp::model::AccessType SmPolicyUpdateContextData::getAccessType() const
{
    return m_AccessType;
}
void SmPolicyUpdateContextData::setAccessType(oai::_3gpp::model::AccessType const& value)
{
    m_AccessType = value;
...
oai::_3gpp::model::RatType SmPolicyUpdateContextData::getRatType() const
{
    return m_RatType;
}
void SmPolicyUpdateContextData::setRatType(oai::_3gpp::model::RatType const& value)
{
    m_RatType = value;
    m_RatTypeIsSet = true;
}
...
oai::_3gpp::model::AdditionalAccessInfo SmPolicyUpdateContextData::getAddAccessInfo() const
{
    return m_AddAccessInfo;
}
void SmPolicyUpdateContextData::setAddAccessInfo(oai::_3gpp::model::AdditionalAccessInfo const& value)
{
...
oai::_3gpp::model::AdditionalAccessInfo SmPolicyUpdateContextData::getRelAccessInfo() const
{
    return m_RelAccessInfo;
}
void SmPolicyUpdateContextData::setRelAccessInfo(oai::_3gpp::model::AdditionalAccessInfo const& value)
{
...
oai::_3gpp::model::PlmnIdNid SmPolicyUpdateContextData::getServingNetwork() const
{
    return m_ServingNetwork;
}
void SmPolicyUpdateContextData::setServingNetwork(oai::_3gpp::model::PlmnIdNid const& value)
{
...
oai::_3gpp::model::UserLocation SmPolicyUpdateContextData::getUserLocationInfo() const
{
    return m_UserLocationInfo;
}
void SmPolicyUpdateContextData::setUserLocationInfo(oai::_3gpp::model::UserLocation const& value)
{
...
oai::_3gpp::model::Ipv6Prefix SmPolicyUpdateContextData::getIpv6AddressPrefix() const
{
    return m_Ipv6AddressPrefix;
}
void SmPolicyUpdateContextData::setIpv6AddressPrefix(oai::_3gpp::model::Ipv6Prefix const& value)
{
...
oai::_3gpp::model::Ipv6Prefix SmPolicyUpdateContextData::getRelIpv6AddressPrefix() const
{
    return m_RelIpv6AddressPrefix;
}
void SmPolicyUpdateContextData::setRelIpv6AddressPrefix(oai::_3gpp::model::Ipv6Prefix const& value)
{
...
oai::_3gpp::model::Ipv6Prefix SmPolicyUpdateContextData::getAddIpv6AddrPrefixes() const
{
    return m_AddIpv6AddrPrefixes;
}
void SmPolicyUpdateContextData::setAddIpv6AddrPrefixes(oai::_3gpp::model::Ipv6Prefix const& value)
{
...
oai::_3gpp::model::Ipv6Prefix SmPolicyUpdateContextData::getAddRelIpv6AddrPrefixes() const
{
    return m_AddRelIpv6AddrPrefixes;
}
void SmPolicyUpdateContextData::setAddRelIpv6AddrPrefixes(oai::_3gpp::model::Ipv6Prefix const& value)
{
...
oai::_3gpp::model::Ambr SmPolicyUpdateContextData::getSubsSessAmbr() const
{
    return m_SubsSessAmbr;
}
void SmPolicyUpdateContextData::setSubsSessAmbr(oai::_3gpp::model::Ambr const& value)
{
...
oai::_3gpp::model::SubscribedDefaultQos SmPolicyUpdateContextData::getSubsDefQos() const
{
    return m_SubsDefQos;
}
void SmPolicyUpdateContextData::setSubsDefQos(oai::_3gpp::model::SubscribedDefaultQos const& value)
{
    m_SubsDefQos = value;
...
oai::_3gpp::model::VplmnQos SmPolicyUpdateContextData::getVplmnQos() const
{
    return m_VplmnQos;
}
void SmPolicyUpdateContextData::setVplmnQos(oai::_3gpp::model::VplmnQos const& value)
{
    m_VplmnQos = value;
...
std::vector<oai::_3gpp::model::AccuUsageReport> SmPolicyUpdateContextData::getAccuUsageReports() const
{
    return m_AccuUsageReports;
}
void SmPolicyUpdateContextData::setAccuUsageReports(std::vector<oai::_3gpp::model::AccuUsageReport> const& value)
{
...
std::vector<oai::_3gpp::model::AppDetectionInfo> SmPolicyUpdateContextData::getAppDetectionInfos() const
{
    return m_AppDetectionInfos;
}
void SmPolicyUpdateContextData::setAppDetectionInfos(std::vector<oai::_3gpp::model::AppDetectionInfo> const& value)
{
...
std::vector<oai::_3gpp::model::RuleReport> SmPolicyUpdateContextData::getRuleReports() const
{
    return m_RuleReports;
}
void SmPolicyUpdateContextData::setRuleReports(std::vector<oai::_3gpp::model::RuleReport> const& value)
{
    m_RuleReports = value;
...
std::vector<oai::_3gpp::model::SessionRuleReport> SmPolicyUpdateContextData::getSessRuleReports() const
{
    return m_SessRuleReports;
}
void SmPolicyUpdateContextData::setSessRuleReports(std::vector<oai::_3gpp::model::SessionRuleReport> const& value)
{
...
std::vector<oai::_3gpp::model::QosNotificationControlInfo> SmPolicyUpdateContextData::getQncReports() const
{
    return m_QncReports;
}
void SmPolicyUpdateContextData::setQncReports(std::vector<oai::_3gpp::model::QosNotificationControlInfo> const& value)
{
    m_QncReports = value;
...
std::vector<oai::_3gpp::model::QosMonitoringReport> SmPolicyUpdateContextData::getQosMonReports() const
{
    return m_QosMonReports;
}
void SmPolicyUpdateContextData::setQosMonReports(std::vector<oai::_3gpp::model::QosMonitoringReport> const& value)
{
...
void SmPolicyUpdateContextData::setUserLocationInfoTime(std::string const& value)
{
...
std::map<std::string, oai::_3gpp::model::PresenceInfo> SmPolicyUpdateContextData::getRepPraInfos() const
{
    return m_RepPraInfos;
}
void SmPolicyUpdateContextData::setRepPraInfos(std::map<std::string, oai::_3gpp::model::PresenceInfo> const& value)
{
    m_RepPraInfos = value;
...
oai::_3gpp::model::UeInitiatedResourceRequest SmPolicyUpdateContextData::getUeInitResReq() const
{
    return m_UeInitResReq;
}
void SmPolicyUpdateContextData::setUeInitResReq(oai::_3gpp::model::UeInitiatedResourceRequest const& value)
{
...
oai::_3gpp::model::QosFlowUsage SmPolicyUpdateContextData::getQosFlowUsage() const
{
    return m_QosFlowUsage;
}
void SmPolicyUpdateContextData::setQosFlowUsage(oai::_3gpp::model::QosFlowUsage const& value)
{
...
oai::_3gpp::model::CreditManagementStatus SmPolicyUpdateContextData::getCreditManageStatus() const
{
    return m_CreditManageStatus;
}
void SmPolicyUpdateContextData::setCreditManageStatus(oai::_3gpp::model::CreditManagementStatus const& value)
{
...
oai::_3gpp::model::ServingNfIdentity SmPolicyUpdateContextData::getServNfId() const
{
    return m_ServNfId;
}
void SmPolicyUpdateContextData::setServNfId(oai::_3gpp::model::ServingNfIdentity const& value)
{
    m_ServNfId = value;
...
oai::_3gpp::model::TraceData SmPolicyUpdateContextData::getTraceReq() const
{
    return m_TraceReq;
}
void SmPolicyUpdateContextData::setTraceReq(oai::_3gpp::model::TraceData const& value)
{
    m_TraceReq = value;
...
oai::_3gpp::model::MaPduIndication SmPolicyUpdateContextData::getMaPduInd() const
{
    return m_MaPduInd;
}
void SmPolicyUpdateContextData::setMaPduInd(oai::_3gpp::model::MaPduIndication const& value)
{
    m_MaPduInd = value;
...
oai::_3gpp::model::AtsssCapability SmPolicyUpdateContextData::getAtsssCapab() const
{
    return m_AtsssCapab;
}
void SmPolicyUpdateContextData::setAtsssCapab(oai::_3gpp::model::AtsssCapability const& value)
{
    m_AtsssCapab = value;
...
oai::_3gpp::model::TsnBridgeInfo SmPolicyUpdateContextData::getTsnBridgeInfo() const
{
    return m_TsnBridgeInfo;
}
void SmPolicyUpdateContextData::setTsnBridgeInfo(oai::_3gpp::model::TsnBridgeInfo const& value)
{
...
oai::_3gpp::model::BridgeManagementContainer SmPolicyUpdateContextData::getTsnBridgeManCont() const
{
    return m_TsnBridgeManCont;
}
void SmPolicyUpdateContextData::setTsnBridgeManCont(oai::_3gpp::model::BridgeManagementContainer const& value)
{
...
oai::_3gpp::model::PortManagementContainer SmPolicyUpdateContextData::getTsnPortManContDstt() const
{
    return m_TsnPortManContDstt;
}
void SmPolicyUpdateContextData::setTsnPortManContDstt(oai::_3gpp::model::PortManagementContainer const& value)
{
...
std::vector<oai::_3gpp::model::PortManagementContainer> SmPolicyUpdateContextData::getTsnPortManContNwtts() const
{
    return m_TsnPortManContNwtts;
}
void SmPolicyUpdateContextData::setTsnPortManContNwtts(std::vector<oai::_3gpp::model::PortManagementContainer> const& value)
{
...
std::vector<oai::_3gpp::model::IpMulticastAddressInfo> SmPolicyUpdateContextData::getMulAddrInfos() const
{
    return m_MulAddrInfos;
}
void SmPolicyUpdateContextData::setMulAddrInfos(std::vector<oai::_3gpp::model::IpMulticastAddressInfo> const& value)
{
...
std::vector<oai::_3gpp::model::PolicyDecisionFailureCode> SmPolicyUpdateContextData::getPolicyDecFailureReports() const
{
    return m_PolicyDecFailureReports;
}
void SmPolicyUpdateContextData::setPolicyDecFailureReports(std::vector<oai::_3gpp::model::PolicyDecisionFailureCode> const& value)
{
...
std::vector<oai::_3gpp::model::InvalidParam> SmPolicyUpdateContextData::getInvalidPolicyDecs() const
{
    return m_InvalidPolicyDecs;
}
void SmPolicyUpdateContextData::setInvalidPolicyDecs(std::vector<oai::_3gpp::model::InvalidParam> const& value)
{
...
std::vector<oai::_3gpp::model::DddTrafficDescriptor> SmPolicyUpdateContextData::getTrafficDescriptors() const
{
    return m_TrafficDescriptors;
}
void SmPolicyUpdateContextData::setTrafficDescriptors(std::vector<oai::_3gpp::model::DddTrafficDescriptor> const& value)
{
...
std::vector<oai::_3gpp::model::DlDataDeliveryStatus> SmPolicyUpdateContextData::getTypesOfNotif() const
{
    return m_TypesOfNotif;
}
void SmPolicyUpdateContextData::setTypesOfNotif(std::vector<oai::_3gpp::model::DlDataDeliveryStatus> const& value)
{
...
std::vector<oai::_3gpp::model::std::string> SmPolicyUpdateContextData::getInterGrpIds() const
{
    return m_InterGrpIds;
}
void SmPolicyUpdateContextData::setInterGrpIds(std::vector<oai::_3gpp::model::std::string> const& value)
{
    m_InterGrpIds = value;
...
oai::_3gpp::model::SatelliteBackhaulCategory SmPolicyUpdateContextData::getSatBackhaulCategory() const
{
    return m_SatBackhaulCategory;
}
void SmPolicyUpdateContextData::setSatBackhaulCategory(oai::_3gpp::model::SatelliteBackhaulCategory const& value)
{
    m_SatBackhaulCategory = value;
    m_SatBackhaulCategoryIsSet = true;
}
bool SmPolicyUpdateContextData::satBackhaulCategoryIsSet() const
{
    return m_SatBackhaulCategoryIsSet;
}
void SmPolicyUpdateContextData::unsetSatBackhaulCategory()
{
    m_SatBackhaulCategoryIsSet = false;
}
oai::_3gpp::model::PcfUeCallbackInfo SmPolicyUpdateContextData::getPcfUeInfo() const
{
    return m_PcfUeInfo;
}
void SmPolicyUpdateContextData::setPcfUeInfo(oai::_3gpp::model::PcfUeCallbackInfo const& value)
{
    m_PcfUeInfo = value;
    m_PcfUeInfoIsSet = true;
}
bool SmPolicyUpdateContextData::pcfUeInfoIsSet() const
{
    return m_PcfUeInfoIsSet;
}
void SmPolicyUpdateContextData::unsetPcfUeInfo()
{
    m_PcfUeInfoIsSet = false;
}
std::vector<oai::_3gpp::model::NwdafData> SmPolicyUpdateContextData::getNwdafDatas() const
{
    return m_NwdafDatas;
}
void SmPolicyUpdateContextData::setNwdafDatas(std::vector<oai::_3gpp::model::NwdafData> const& value)
{
    m_NwdafDatas = value;
    m_NwdafDatasIsSet = true;
}
bool SmPolicyUpdateContextData::nwdafDatasIsSet() const
{
    return m_NwdafDatasIsSet;
}
void SmPolicyUpdateContextData::unsetNwdafDatas()
{
    m_NwdafDatasIsSet = false;
}
bool SmPolicyUpdateContextData::isAnGwStatus() const
{
    return m_AnGwStatus;
}
void SmPolicyUpdateContextData::setAnGwStatus(bool const value)
{
    m_AnGwStatus = value;
    m_AnGwStatusIsSet = true;
}
bool SmPolicyUpdateContextData::anGwStatusIsSet() const
{
    return m_AnGwStatusIsSet;
}
void SmPolicyUpdateContextData::unsetAnGwStatus()
{
    m_AnGwStatusIsSet = false;
}
