...
bool NotifCondition::validate(
    std::stringstream& msg, const std::string& pathPrefix) const {
  bool success = true;
  const std::string _pathPrefix =
      pathPrefix.empty() ? "NotifCondition" : pathPrefix;
...
bool NotifCondition::operator==(const NotifCondition& rhs) const {
  return
      ...
      ((!monitoredAttributesIsSet() && !rhs.monitoredAttributesIsSet()) ||
       (monitoredAttributesIsSet() && rhs.monitoredAttributesIsSet() &&
        getMonitoredAttributes() == rhs.getMonitoredAttributes())) &&

      ((!unmonitoredAttributesIsSet() && !rhs.unmonitoredAttributesIsSet()) ||
       (unmonitoredAttributesIsSet() && rhs.unmonitoredAttributesIsSet() &&
        getUnmonitoredAttributes() == rhs.getUnmonitoredAttributes()))
