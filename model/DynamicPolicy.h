...
public:
    ...
    /// 
    /// </summary>
    oai::model::M5QoSSpecification getQosSpecification() const;
    void setQosSpecification(oai::model::M5QoSSpecification const& value);
...
protected:
    ...
    oai::model::M5QoSSpecification m_QosSpecification;
