...
LoggingDurationMdt_anyOf::eLoggingDurationMdt_anyOf LoggingDurationNrMdt::getEnumValue() const
{
    return m_value.getValue();
}

void LoggingDurationNrMdt::setEnumValue(LoggingDurationMdt_anyOf::eLoggingDurationMdt_anyOf  value)
{
