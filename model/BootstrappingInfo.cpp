...
bool BootstrappingInfo::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    ...
    /* _links */ {
        const std::map<std::string, oai::model::LinksValueSchema>& value = m__links;
...
oai::model::Status BootstrappingInfo::getStatus() const
{
    return m_Status;
}
void BootstrappingInfo::setStatus(oai::model::Status const& value)
{
    m_Status = value;
    m_StatusIsSet = true;
}
...
std::map<std::string, oai::model::LinksValueSchema> BootstrappingInfo::getLinks() const
{
    return m__links;
}
void BootstrappingInfo::setLinks(std::map<std::string, oai::model::LinksValueSchema> const& value)
{
    m__links = value;
}
