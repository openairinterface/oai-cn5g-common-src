...
asn_TYPE_member_t asn_MBR_Ngap_DRBsSubjectToStatusTransferItem_1[] = {
	...
	{ ATF_POINTER, 0, offsetof(struct Ngap_DRBsSubjectToStatusTransferItem, dRBStatusUL),
	...
	{ ATF_POINTER, 0, offsetof(struct Ngap_DRBsSubjectToStatusTransferItem, dRBStatusDL),
