...
bool AppSessionContextUpdateDataPatch::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "AppSessionContextUpdateDataPatch" : pathPrefix;

        
    return success;
}

bool AppSessionContextUpdateDataPatch::operator==(const AppSessionContextUpdateDataPatch& rhs) const
{
    return
...
oai::_3gpp::model::AppSessionContextUpdateData AppSessionContextUpdateDataPatch::getAscReqData() const
{
    return m_AscReqData;
}
void AppSessionContextUpdateDataPatch::setAscReqData(oai::_3gpp::model::AppSessionContextUpdateData const& value)
{
    m_AscReqData = value;
