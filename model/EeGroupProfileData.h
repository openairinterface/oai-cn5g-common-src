...
public:
    ...
    void setRestrictedEventTypes(std::vector<oai::_3gpp::model::EventType> const& value);
    ...
    /// </summary>
    std::map<std::string, std::vector<oai::_3gpp::model::MtcProvider>> getAllowedMtcProvider() const;
    void setAllowedMtcProvider(std::map<std::string, std::vector<oai::_3gpp::model::MtcProvider>> const& value);
...
protected:
    ...
    std::map<std::string, std::vector<oai::_3gpp::model::MtcProvider>> m_AllowedMtcProvider;
