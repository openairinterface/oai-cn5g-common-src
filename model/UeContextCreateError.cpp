...
void UeContextCreateError::setError(oai::_3gpp::model::ProblemDetails const& value)
{
    m_Error = value;
}
...
void UeContextCreateError::setNgapCause(oai::_3gpp::model::NgApCause const& value)
{
    m_NgapCause = value;
...
oai::_3gpp::model::N2InfoContent UeContextCreateError::getTargetToSourceFailureData() const
{
    return m_TargetToSourceFailureData;
}
void UeContextCreateError::setTargetToSourceFailureData(oai::_3gpp::model::N2InfoContent const& value)
{
