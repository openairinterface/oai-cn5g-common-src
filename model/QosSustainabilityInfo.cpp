...
bool QosSustainabilityInfo::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "QosSustainabilityInfo" : pathPrefix;
...
bool QosSustainabilityInfo::operator==(const QosSustainabilityInfo& rhs) const
{
    ...
    ((!areaInfoIsSet() && !rhs.areaInfoIsSet()) || (areaInfoIsSet() && rhs.areaInfoIsSet() && getAreaInfo() == rhs.getAreaInfo())) &&
    ...
    ((!qosFlowRetThdIsSet() && !rhs.qosFlowRetThdIsSet()) || (qosFlowRetThdIsSet() && rhs.qosFlowRetThdIsSet() && getQosFlowRetThd() == rhs.getQosFlowRetThd())) &&
    
    
    ((!ranUeThrouThdIsSet() && !rhs.ranUeThrouThdIsSet()) || (ranUeThrouThdIsSet() && rhs.ranUeThrouThdIsSet() && getRanUeThrouThd() == rhs.getRanUeThrouThd())) &&
...
oai::model::NetworkAreaInfo QosSustainabilityInfo::getAreaInfo() const
{
    return m_AreaInfo;
}
void QosSustainabilityInfo::setAreaInfo(oai::model::NetworkAreaInfo const& value)
{
    m_AreaInfo = value;
...
oai::model::RetainabilityThreshold QosSustainabilityInfo::getQosFlowRetThd() const
{
    return m_QosFlowRetThd;
}
void QosSustainabilityInfo::setQosFlowRetThd(oai::model::RetainabilityThreshold const& value)
{
...
oai::model::Snssai QosSustainabilityInfo::getSnssai() const
{
    return m_Snssai;
}
void QosSustainabilityInfo::setSnssai(oai::model::Snssai const& value)
{
    m_Snssai = value;
    m_SnssaiIsSet = true;
}
