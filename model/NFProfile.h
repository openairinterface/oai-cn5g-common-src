...
public:
    ...
    /// 
    /// </summary>
    oai::model::NFType getNfType() const;
    void setNfType(oai::model::NFType const& value);
    /// <summary>
    /// 
    /// </summary>
    oai::model::NFStatus getNfStatus() const;
    void setNfStatus(oai::model::NFStatus const& value);
    /// <summary>
    /// 
    /// </summary>
    std::vector<oai::model::CollocatedNfInstance> getCollocatedNfInstances() const;
    void setCollocatedNfInstances(std::vector<oai::model::CollocatedNfInstance> const& value);
    ...
    /// 
    /// </summary>
    std::vector<oai::model::PlmnId> getPlmnList() const;
    void setPlmnList(std::vector<oai::model::PlmnId> const& value);
    bool plmnListIsSet() const;
    void unsetPlmnList();
    /// <summary>
    /// 
    /// </summary>
    std::vector<oai::model::PlmnIdNid> getSnpnList() const;
    void setSnpnList(std::vector<oai::model::PlmnIdNid> const& value);
    bool snpnListIsSet() const;
    void unsetSnpnList();
    /// <summary>
    /// 
    /// </summary>
    std::vector<oai::model::ExtSnssai> getSNssais() const;
    void setSNssais(std::vector<oai::model::ExtSnssai> const& value);
    bool sNssaisIsSet() const;
    void unsetSNssais();
    /// <summary>
    /// 
    /// </summary>
    std::vector<oai::model::PlmnSnssai> getPerPlmnSnssaiList() const;
    void setPerPlmnSnssaiList(std::vector<oai::model::PlmnSnssai> const& value);
    ...
    /// 
    /// </summary>
    std::vector<oai::model::Ipv6Addr> getIpv6Addresses() const;
    void setIpv6Addresses(std::vector<oai::model::Ipv6Addr> const& value);
    bool ipv6AddressesIsSet() const;
    void unsetIpv6Addresses();
    /// <summary>
    /// 
    /// </summary>
    std::vector<oai::model::PlmnId> getAllowedPlmns() const;
    void setAllowedPlmns(std::vector<oai::model::PlmnId> const& value);
    bool allowedPlmnsIsSet() const;
    void unsetAllowedPlmns();
    /// <summary>
    /// 
    /// </summary>
    std::vector<oai::model::PlmnIdNid> getAllowedSnpns() const;
    void setAllowedSnpns(std::vector<oai::model::PlmnIdNid> const& value);
    bool allowedSnpnsIsSet() const;
    void unsetAllowedSnpns();
    /// <summary>
    /// 
    /// </summary>
    std::vector<oai::model::NFType> getAllowedNfTypes() const;
    void setAllowedNfTypes(std::vector<oai::model::NFType> const& value);
    ...
    /// 
    /// </summary>
    std::vector<oai::model::ExtSnssai> getAllowedNssais() const;
    void setAllowedNssais(std::vector<oai::model::ExtSnssai> const& value);
    ...
    /// 
    /// </summary>
    oai::model::UdrInfo getUdrInfo() const;
    void setUdrInfo(oai::model::UdrInfo const& value);
    bool udrInfoIsSet() const;
    void unsetUdrInfo();
    /// <summary>
    /// A map (list of key-value pairs) where a (unique) valid JSON string serves as key of UdrInfo 
    /// </summary>
    std::map<std::string, oai::model::UdrInfo> getUdrInfoList() const;
    void setUdrInfoList(std::map<std::string, oai::model::UdrInfo> const& value);
    bool udrInfoListIsSet() const;
    void unsetUdrInfoList();
    /// <summary>
    /// 
    /// </summary>
    oai::model::UdmInfo getUdmInfo() const;
    void setUdmInfo(oai::model::UdmInfo const& value);
    bool udmInfoIsSet() const;
    void unsetUdmInfo();
    /// <summary>
    /// A map (list of key-value pairs) where a (unique) valid JSON string serves as key of UdmInfo 
    /// </summary>
    std::map<std::string, oai::model::UdmInfo> getUdmInfoList() const;
    void setUdmInfoList(std::map<std::string, oai::model::UdmInfo> const& value);
    bool udmInfoListIsSet() const;
    void unsetUdmInfoList();
    /// <summary>
    /// 
    /// </summary>
    oai::model::AusfInfo getAusfInfo() const;
    void setAusfInfo(oai::model::AusfInfo const& value);
    bool ausfInfoIsSet() const;
    void unsetAusfInfo();
    /// <summary>
    /// A map (list of key-value pairs) where a (unique) valid JSON string serves as key of AusfInfo 
    /// </summary>
    std::map<std::string, oai::model::AusfInfo> getAusfInfoList() const;
    void setAusfInfoList(std::map<std::string, oai::model::AusfInfo> const& value);
    bool ausfInfoListIsSet() const;
    void unsetAusfInfoList();
    /// <summary>
    /// 
    /// </summary>
    oai::model::AmfInfo getAmfInfo() const;
    void setAmfInfo(oai::model::AmfInfo const& value);
    bool amfInfoIsSet() const;
    void unsetAmfInfo();
    /// <summary>
    /// A map (list of key-value pairs) where a (unique) valid JSON string serves as key of AmfInfo 
    /// </summary>
    std::map<std::string, oai::model::AmfInfo> getAmfInfoList() const;
    void setAmfInfoList(std::map<std::string, oai::model::AmfInfo> const& value);
    bool amfInfoListIsSet() const;
    void unsetAmfInfoList();
    /// <summary>
    /// 
    /// </summary>
    oai::model::SmfInfo getSmfInfo() const;
    void setSmfInfo(oai::model::SmfInfo const& value);
    bool smfInfoIsSet() const;
    void unsetSmfInfo();
    /// <summary>
    /// A map (list of key-value pairs) where a (unique) valid JSON string serves as key of SmfInfo 
    /// </summary>
    std::map<std::string, oai::model::SmfInfo> getSmfInfoList() const;
    void setSmfInfoList(std::map<std::string, oai::model::SmfInfo> const& value);
    bool smfInfoListIsSet() const;
    void unsetSmfInfoList();
    /// <summary>
    /// 
    /// </summary>
    oai::model::UpfInfo getUpfInfo() const;
    void setUpfInfo(oai::model::UpfInfo const& value);
    bool upfInfoIsSet() const;
    void unsetUpfInfo();
    /// <summary>
    /// A map (list of key-value pairs) where a (unique) valid JSON string serves as key of UpfInfo 
    /// </summary>
    std::map<std::string, oai::model::UpfInfo> getUpfInfoList() const;
    void setUpfInfoList(std::map<std::string, oai::model::UpfInfo> const& value);
    bool upfInfoListIsSet() const;
    void unsetUpfInfoList();
    /// <summary>
    /// 
    /// </summary>
    oai::model::PcfInfo getPcfInfo() const;
    void setPcfInfo(oai::model::PcfInfo const& value);
    bool pcfInfoIsSet() const;
    void unsetPcfInfo();
    /// <summary>
    /// A map (list of key-value pairs) where a (unique) valid JSON string serves as key of PcfInfo 
    /// </summary>
    std::map<std::string, oai::model::PcfInfo> getPcfInfoList() const;
    void setPcfInfoList(std::map<std::string, oai::model::PcfInfo> const& value);
    bool pcfInfoListIsSet() const;
    void unsetPcfInfoList();
    /// <summary>
    /// 
    /// </summary>
    oai::model::BsfInfo getBsfInfo() const;
    void setBsfInfo(oai::model::BsfInfo const& value);
    bool bsfInfoIsSet() const;
    void unsetBsfInfo();
    /// <summary>
    /// A map (list of key-value pairs) where a (unique) valid JSON string serves as key of BsfInfo 
    /// </summary>
    std::map<std::string, oai::model::BsfInfo> getBsfInfoList() const;
    void setBsfInfoList(std::map<std::string, oai::model::BsfInfo> const& value);
    bool bsfInfoListIsSet() const;
    void unsetBsfInfoList();
    /// <summary>
    /// 
    /// </summary>
    oai::model::ChfInfo getChfInfo() const;
    void setChfInfo(oai::model::ChfInfo const& value);
    bool chfInfoIsSet() const;
    void unsetChfInfo();
    /// <summary>
    /// A map (list of key-value pairs) where a (unique) valid JSON string serves as key of ChfInfo 
    /// </summary>
    std::map<std::string, oai::model::ChfInfo> getChfInfoList() const;
    void setChfInfoList(std::map<std::string, oai::model::ChfInfo> const& value);
    bool chfInfoListIsSet() const;
    void unsetChfInfoList();
    /// <summary>
    /// 
    /// </summary>
    oai::model::NefInfo getNefInfo() const;
    void setNefInfo(oai::model::NefInfo const& value);
    bool nefInfoIsSet() const;
    void unsetNefInfo();
    /// <summary>
    /// 
    /// </summary>
    oai::model::NrfInfo getNrfInfo() const;
    void setNrfInfo(oai::model::NrfInfo const& value);
    bool nrfInfoIsSet() const;
    void unsetNrfInfo();
    /// <summary>
    /// 
    /// </summary>
    oai::model::UdsfInfo getUdsfInfo() const;
    void setUdsfInfo(oai::model::UdsfInfo const& value);
    bool udsfInfoIsSet() const;
    void unsetUdsfInfo();
    /// <summary>
    /// A map (list of key-value pairs) where a (unique) valid JSON string serves as key of UdsfInfo 
    /// </summary>
    std::map<std::string, oai::model::UdsfInfo> getUdsfInfoList() const;
    void setUdsfInfoList(std::map<std::string, oai::model::UdsfInfo> const& value);
    bool udsfInfoListIsSet() const;
    void unsetUdsfInfoList();
    /// <summary>
    /// 
    /// </summary>
    oai::model::NwdafInfo getNwdafInfo() const;
    void setNwdafInfo(oai::model::NwdafInfo const& value);
    bool nwdafInfoIsSet() const;
    void unsetNwdafInfo();
    /// <summary>
    /// A map (list of key-value pairs) where a (unique) valid JSON string serves as key of NwdafInfo 
    /// </summary>
    std::map<std::string, oai::model::NwdafInfo> getNwdafInfoList() const;
    void setNwdafInfoList(std::map<std::string, oai::model::NwdafInfo> const& value);
    ...
    /// </summary>
    std::map<std::string, oai::model::PcscfInfo> getPcscfInfoList() const;
    void setPcscfInfoList(std::map<std::string, oai::model::PcscfInfo> const& value);
    ...
    /// </summary>
    std::map<std::string, oai::model::HssInfo> getHssInfoList() const;
    void setHssInfoList(std::map<std::string, oai::model::HssInfo> const& value);
    ...
    /// 
    /// </summary>
    std::vector<oai::model::NFService> getNfServices() const;
    void setNfServices(std::vector<oai::model::NFService> const& value);
    ...
    /// </summary>
    std::map<std::string, oai::model::NFService> getNfServiceList() const;
    void setNfServiceList(std::map<std::string, oai::model::NFService> const& value);
    ...
    /// 
    /// </summary>
    std::vector<oai::model::DefaultNotificationSubscription> getDefaultNotificationSubscriptions() const;
    void setDefaultNotificationSubscriptions(std::vector<oai::model::DefaultNotificationSubscription> const& value);
    bool defaultNotificationSubscriptionsIsSet() const;
    void unsetDefaultNotificationSubscriptions();
    /// <summary>
    /// 
    /// </summary>
    oai::model::LmfInfo getLmfInfo() const;
    void setLmfInfo(oai::model::LmfInfo const& value);
    bool lmfInfoIsSet() const;
    void unsetLmfInfo();
    /// <summary>
    /// 
    /// </summary>
    oai::model::GmlcInfo getGmlcInfo() const;
    void setGmlcInfo(oai::model::GmlcInfo const& value);
    ...
    /// 
    /// </summary>
    oai::model::ScpInfo getScpInfo() const;
    void setScpInfo(oai::model::ScpInfo const& value);
    bool scpInfoIsSet() const;
    void unsetScpInfo();
    /// <summary>
    /// 
    /// </summary>
    oai::model::SeppInfo getSeppInfo() const;
    void setSeppInfo(oai::model::SeppInfo const& value);
    ...
    /// </summary>
    std::map<std::string, std::vector<oai::model::VendorSpecificFeature>> getSupportedVendorSpecificFeatures() const;
    void setSupportedVendorSpecificFeatures(std::map<std::string, std::vector<oai::model::VendorSpecificFeature>> const& value);
    ...
    /// </summary>
    std::map<std::string, oai::model::AanfInfo> getAanfInfoList() const;
    void setAanfInfoList(std::map<std::string, oai::model::AanfInfo> const& value);
    bool aanfInfoListIsSet() const;
    void unsetAanfInfoList();
    /// <summary>
    /// 
    /// </summary>
    oai::model::r_5GDdnmfInfo getR5gDdnmfInfo() const;
    void setR5gDdnmfInfo(oai::model::r_5GDdnmfInfo const& value);
    bool r5gDdnmfInfoIsSet() const;
    void unsetr_5gDdnmfInfo();
    /// <summary>
    /// 
    /// </summary>
    oai::model::MfafInfo getMfafInfo() const;
    void setMfafInfo(oai::model::MfafInfo const& value);
    bool mfafInfoIsSet() const;
    void unsetMfafInfo();
    /// <summary>
    /// A map (list of key-value pairs) where a (unique) valid JSON string serves as key of EasdfInfo 
    /// </summary>
    std::map<std::string, oai::model::EasdfInfo> getEasdfInfoList() const;
    void setEasdfInfoList(std::map<std::string, oai::model::EasdfInfo> const& value);
    bool easdfInfoListIsSet() const;
    void unsetEasdfInfoList();
    /// <summary>
    /// 
    /// </summary>
    oai::model::DccfInfo getDccfInfo() const;
    void setDccfInfo(oai::model::DccfInfo const& value);
    bool dccfInfoIsSet() const;
    void unsetDccfInfo();
    /// <summary>
    /// A map (list of key-value pairs) where a (unique) valid JSON string serves as key of NsacfInfo 
    /// </summary>
    std::map<std::string, oai::model::NsacfInfo> getNsacfInfoList() const;
    void setNsacfInfoList(std::map<std::string, oai::model::NsacfInfo> const& value);
    ...
    /// </summary>
    std::map<std::string, oai::model::MbSmfInfo> getMbSmfInfoList() const;
    void setMbSmfInfoList(std::map<std::string, oai::model::MbSmfInfo> const& value);
    ...
    /// </summary>
    std::map<std::string, oai::model::TsctsfInfo> getTsctsfInfoList() const;
    void setTsctsfInfoList(std::map<std::string, oai::model::TsctsfInfo> const& value);
    ...
    /// </summary>
    std::map<std::string, oai::model::MbUpfInfo> getMbUpfInfoList() const;
    void setMbUpfInfoList(std::map<std::string, oai::model::MbUpfInfo> const& value);
    bool mbUpfInfoListIsSet() const;
    void unsetMbUpfInfoList();
    /// <summary>
    /// 
    /// </summary>
    oai::model::TrustAfInfo getTrustAfInfo() const;
    void setTrustAfInfo(oai::model::TrustAfInfo const& value);
    bool trustAfInfoIsSet() const;
    void unsetTrustAfInfo();
    /// <summary>
    /// 
    /// </summary>
    oai::model::NssaafInfo getNssaafInfo() const;
    void setNssaafInfo(oai::model::NssaafInfo const& value);
    ...
    /// 
    /// </summary>
    oai::model::IwmscInfo getIwmscInfo() const;
    void setIwmscInfo(oai::model::IwmscInfo const& value);
    bool iwmscInfoIsSet() const;
    void unsetIwmscInfo();
    /// <summary>
    /// 
    /// </summary>
    oai::model::MnpfInfo getMnpfInfo() const;
    void setMnpfInfo(oai::model::MnpfInfo const& value);
...
protected:
    ...
    oai::model::NFType m_NfType;

    oai::model::NFStatus m_NfStatus;

    std::vector<oai::model::CollocatedNfInstance> m_CollocatedNfInstances;
    bool m_CollocatedNfInstancesIsSet;
    int32_t m_HeartBeatTimer;
    bool m_HeartBeatTimerIsSet;
    std::vector<oai::model::PlmnId> m_PlmnList;
    bool m_PlmnListIsSet;
    std::vector<oai::model::PlmnIdNid> m_SnpnList;
    bool m_SnpnListIsSet;
    std::vector<oai::model::ExtSnssai> m_SNssais;
    bool m_SNssaisIsSet;
    std::vector<oai::model::PlmnSnssai> m_PerPlmnSnssaiList;
    ...
    std::vector<oai::model::Ipv6Addr> m_Ipv6Addresses;
    bool m_Ipv6AddressesIsSet;
    std::vector<oai::model::PlmnId> m_AllowedPlmns;
    bool m_AllowedPlmnsIsSet;
    std::vector<oai::model::PlmnIdNid> m_AllowedSnpns;
    bool m_AllowedSnpnsIsSet;
    std::vector<oai::model::NFType> m_AllowedNfTypes;
    bool m_AllowedNfTypesIsSet;
    std::vector<std::string> m_AllowedNfDomains;
    bool m_AllowedNfDomainsIsSet;
    std::vector<oai::model::ExtSnssai> m_AllowedNssais;
    ...
    oai::model::UdrInfo m_UdrInfo;
    bool m_UdrInfoIsSet;
    std::map<std::string, oai::model::UdrInfo> m_UdrInfoList;
    bool m_UdrInfoListIsSet;
    oai::model::UdmInfo m_UdmInfo;
    bool m_UdmInfoIsSet;
    std::map<std::string, oai::model::UdmInfo> m_UdmInfoList;
    bool m_UdmInfoListIsSet;
    oai::model::AusfInfo m_AusfInfo;
    bool m_AusfInfoIsSet;
    std::map<std::string, oai::model::AusfInfo> m_AusfInfoList;
    bool m_AusfInfoListIsSet;
    oai::model::AmfInfo m_AmfInfo;
    bool m_AmfInfoIsSet;
    std::map<std::string, oai::model::AmfInfo> m_AmfInfoList;
    bool m_AmfInfoListIsSet;
    oai::model::SmfInfo m_SmfInfo;
    bool m_SmfInfoIsSet;
    std::map<std::string, oai::model::SmfInfo> m_SmfInfoList;
    bool m_SmfInfoListIsSet;
    oai::model::UpfInfo m_UpfInfo;
    bool m_UpfInfoIsSet;
    std::map<std::string, oai::model::UpfInfo> m_UpfInfoList;
    bool m_UpfInfoListIsSet;
    oai::model::PcfInfo m_PcfInfo;
    bool m_PcfInfoIsSet;
    std::map<std::string, oai::model::PcfInfo> m_PcfInfoList;
    bool m_PcfInfoListIsSet;
    oai::model::BsfInfo m_BsfInfo;
    bool m_BsfInfoIsSet;
    std::map<std::string, oai::model::BsfInfo> m_BsfInfoList;
    bool m_BsfInfoListIsSet;
    oai::model::ChfInfo m_ChfInfo;
    bool m_ChfInfoIsSet;
    std::map<std::string, oai::model::ChfInfo> m_ChfInfoList;
    bool m_ChfInfoListIsSet;
    oai::model::NefInfo m_NefInfo;
    bool m_NefInfoIsSet;
    oai::model::NrfInfo m_NrfInfo;
    bool m_NrfInfoIsSet;
    oai::model::UdsfInfo m_UdsfInfo;
    bool m_UdsfInfoIsSet;
    std::map<std::string, oai::model::UdsfInfo> m_UdsfInfoList;
    bool m_UdsfInfoListIsSet;
    oai::model::NwdafInfo m_NwdafInfo;
    bool m_NwdafInfoIsSet;
    std::map<std::string, oai::model::NwdafInfo> m_NwdafInfoList;
    bool m_NwdafInfoListIsSet;
    std::map<std::string, oai::model::PcscfInfo> m_PcscfInfoList;
    bool m_PcscfInfoListIsSet;
    std::map<std::string, oai::model::HssInfo> m_HssInfoList;
    ...
    std::vector<oai::model::NFService> m_NfServices;
    bool m_NfServicesIsSet;
    std::map<std::string, oai::model::NFService> m_NfServiceList;
    ...
    std::vector<oai::model::DefaultNotificationSubscription> m_DefaultNotificationSubscriptions;
    bool m_DefaultNotificationSubscriptionsIsSet;
    oai::model::LmfInfo m_LmfInfo;
    bool m_LmfInfoIsSet;
    oai::model::GmlcInfo m_GmlcInfo;
    ...
    oai::model::ScpInfo m_ScpInfo;
    bool m_ScpInfoIsSet;
    oai::model::SeppInfo m_SeppInfo;
    bool m_SeppInfoIsSet;
    std::string m_VendorId;
    bool m_VendorIdIsSet;
    std::map<std::string, std::vector<oai::model::VendorSpecificFeature>> m_SupportedVendorSpecificFeatures;
    bool m_SupportedVendorSpecificFeaturesIsSet;
    std::map<std::string, oai::model::AanfInfo> m_AanfInfoList;
    bool m_AanfInfoListIsSet;
    oai::model::r_5GDdnmfInfo m_r_5gDdnmfInfo;
    bool m_r_5gDdnmfInfoIsSet;
    oai::model::MfafInfo m_MfafInfo;
    bool m_MfafInfoIsSet;
    std::map<std::string, oai::model::EasdfInfo> m_EasdfInfoList;
    bool m_EasdfInfoListIsSet;
    oai::model::DccfInfo m_DccfInfo;
    bool m_DccfInfoIsSet;
    std::map<std::string, oai::model::NsacfInfo> m_NsacfInfoList;
    bool m_NsacfInfoListIsSet;
    std::map<std::string, oai::model::MbSmfInfo> m_MbSmfInfoList;
    bool m_MbSmfInfoListIsSet;
    std::map<std::string, oai::model::TsctsfInfo> m_TsctsfInfoList;
    bool m_TsctsfInfoListIsSet;
    std::map<std::string, oai::model::MbUpfInfo> m_MbUpfInfoList;
    bool m_MbUpfInfoListIsSet;
    oai::model::TrustAfInfo m_TrustAfInfo;
    bool m_TrustAfInfoIsSet;
    oai::model::NssaafInfo m_NssaafInfo;
    bool m_NssaafInfoIsSet;
    std::vector<std::string> m_HniList;
    bool m_HniListIsSet;
    oai::model::IwmscInfo m_IwmscInfo;
    bool m_IwmscInfoIsSet;
    oai::model::MnpfInfo m_MnpfInfo;
