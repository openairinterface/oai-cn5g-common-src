...
public:
    ...
    /// 
    /// </summary>
    oai::model::UeAuth getDirectDiscovery() const;
    void setDirectDiscovery(oai::model::UeAuth const& value);
    bool directDiscoveryIsSet() const;
    void unsetDirectDiscovery();
    /// <summary>
    /// 
    /// </summary>
    oai::model::UeAuth getDirectComm() const;
    void setDirectComm(oai::model::UeAuth const& value);
    bool directCommIsSet() const;
    void unsetDirectComm();
    /// <summary>
    /// 
    /// </summary>
    oai::model::UeAuth getL2Relay() const;
    void setL2Relay(oai::model::UeAuth const& value);
    bool l2RelayIsSet() const;
    void unsetL2Relay();
    /// <summary>
    /// 
    /// </summary>
    oai::model::UeAuth getL3Relay() const;
    void setL3Relay(oai::model::UeAuth const& value);
    bool l3RelayIsSet() const;
    void unsetL3Relay();
    /// <summary>
    /// 
    /// </summary>
    oai::model::UeAuth getL2Remote() const;
    void setL2Remote(oai::model::UeAuth const& value);
    ...
    /// 
    /// </summary>
    oai::model::Pc5QoSPara getPc5QoSPara() const;
    void setPc5QoSPara(oai::model::Pc5QoSPara const& value);
...
protected:
    oai::model::UeAuth m_DirectDiscovery;
    bool m_DirectDiscoveryIsSet;
    oai::model::UeAuth m_DirectComm;
    bool m_DirectCommIsSet;
    oai::model::UeAuth m_L2Relay;
    bool m_L2RelayIsSet;
    oai::model::UeAuth m_L3Relay;
    bool m_L3RelayIsSet;
    oai::model::UeAuth m_L2Remote;
    bool m_L2RemoteIsSet;
    std::string m_NrUePc5Ambr;
    bool m_NrUePc5AmbrIsSet;
    oai::model::Pc5QoSPara m_Pc5QoSPara;
