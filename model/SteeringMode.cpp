...
void SteeringMode::setSteerModeValue(oai::_3gpp::model::SteerModeValue const& value)
{
...
void SteeringMode::setThresValue(oai::_3gpp::model::ThresholdValue const& value)
{
    m_ThresValue = value;
...
void SteeringMode::setSteerModeInd(oai::_3gpp::model::SteerModeIndicator const& value)
{
