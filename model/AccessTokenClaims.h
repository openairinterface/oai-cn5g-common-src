...
public:
    ...
    /// 
    /// </summary>
    oai::model::AccessTokenClaims_aud getAud() const;
    void setAud(oai::model::AccessTokenClaims_aud const& value);
    /// <summary>
    /// 
    /// </summary>
    ...
    /// 
    /// </summary>
    oai::model::PlmnId getConsumerPlmnId() const;
    void setConsumerPlmnId(oai::model::PlmnId const& value);
    bool consumerPlmnIdIsSet() const;
    void unsetConsumerPlmnId();
    /// <summary>
    /// 
    /// </summary>
    oai::model::PlmnIdNid getConsumerSnpnId() const;
    void setConsumerSnpnId(oai::model::PlmnIdNid const& value);
    bool consumerSnpnIdIsSet() const;
    void unsetConsumerSnpnId();
    /// <summary>
    /// 
    /// </summary>
    oai::model::PlmnId getProducerPlmnId() const;
    void setProducerPlmnId(oai::model::PlmnId const& value);
    bool producerPlmnIdIsSet() const;
    void unsetProducerPlmnId();
    /// <summary>
    /// 
    /// </summary>
    oai::model::PlmnIdNid getProducerSnpnId() const;
    void setProducerSnpnId(oai::model::PlmnIdNid const& value);
    bool producerSnpnIdIsSet() const;
    void unsetProducerSnpnId();
    /// <summary>
    /// 
    /// </summary>
    std::vector<oai::model::Snssai> getProducerSnssaiList() const;
    void setProducerSnssaiList(std::vector<oai::model::Snssai> const& value);
...
protected:
    ...
    oai::model::AccessTokenClaims_aud m_Aud;

    std::string m_Scope;

    int32_t m_Exp;

    oai::model::PlmnId m_ConsumerPlmnId;
    bool m_ConsumerPlmnIdIsSet;
    oai::model::PlmnIdNid m_ConsumerSnpnId;
    bool m_ConsumerSnpnIdIsSet;
    oai::model::PlmnId m_ProducerPlmnId;
    bool m_ProducerPlmnIdIsSet;
    oai::model::PlmnIdNid m_ProducerSnpnId;
    bool m_ProducerSnpnIdIsSet;
    std::vector<oai::model::Snssai> m_ProducerSnssaiList;
