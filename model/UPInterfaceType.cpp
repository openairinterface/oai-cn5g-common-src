...
UPInterfaceType_anyOf::eUPInterfaceType_anyOf UPInterfaceType::getEnumValue() const
{
    return m_value.getValue();
}

void UPInterfaceType::setEnumValue(UPInterfaceType_anyOf::eUPInterfaceType_anyOf  value)
{
