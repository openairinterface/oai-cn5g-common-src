...
public:
    ...
    /// 
    /// </summary>
    oai::model::N2InfoContainer getN2InfoContainer() const;
    void setN2InfoContainer(oai::model::N2InfoContainer const& value);
    bool n2InfoContainerIsSet() const;
    void unsetN2InfoContainer();
    /// <summary>
    /// 
    /// </summary>
    oai::model::RefToBinaryData getMtData() const;
    void setMtData(oai::model::RefToBinaryData const& value);
    ...
    /// 
    /// </summary>
    oai::model::AreaOfValidity getAreaOfValidity() const;
    void setAreaOfValidity(oai::model::AreaOfValidity const& value);
    ...
    /// 
    /// </summary>
    oai::model::AccessType getTargetAccess() const;
    void setTargetAccess(oai::model::AccessType const& value);
...
protected:
    ...
    oai::model::N2InfoContainer m_N2InfoContainer;
    bool m_N2InfoContainerIsSet;
    oai::model::RefToBinaryData m_MtData;
    bool m_MtDataIsSet;
    bool m_SkipInd;
    bool m_SkipIndIsSet;
    ...
    oai::model::AreaOfValidity m_AreaOfValidity;
    ...
    oai::model::AccessType m_TargetAccess;
