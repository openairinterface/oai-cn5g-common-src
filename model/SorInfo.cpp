...
bool SorInfo::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
...
bool SorInfo::operator==(const SorInfo& rhs) const
{
    ...
    ((!sorHeaderIsSet() && !rhs.sorHeaderIsSet()) || (sorHeaderIsSet() && rhs.sorHeaderIsSet() && getSorHeader() == rhs.getSorHeader())) &&
    
    
    ((!sorTransparentInfoIsSet() && !rhs.sorTransparentInfoIsSet()) || (sorTransparentInfoIsSet() && rhs.sorTransparentInfoIsSet() && getSorTransparentInfo() == rhs.getSorTransparentInfo())) &&
...
oai::model::SteeringContainer SorInfo::getSteeringContainer() const
{
    return m_SteeringContainer;
}
void SorInfo::setSteeringContainer(oai::model::SteeringContainer const& value)
{
