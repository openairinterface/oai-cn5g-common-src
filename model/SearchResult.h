...
public:
    ...
    /// </summary>
    std::map<std::string, oai::_3gpp::model::NfInstanceInfo> getNfInstanceList() const;
    void setNfInstanceList(std::map<std::string, oai::_3gpp::model::NfInstanceInfo> const& value);
