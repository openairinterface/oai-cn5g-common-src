...
oai::model::NotificationFlag AmfUpdateEventOptionItem::getNotifFlag() const
{
    return m_NotifFlag;
}
void AmfUpdateEventOptionItem::setNotifFlag(oai::model::NotificationFlag const& value)
{
    m_NotifFlag = value;
