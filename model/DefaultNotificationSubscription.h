...
public:
    ...
    /// 
    /// </summary>
    oai::model::NotificationType getNotificationType() const;
    void setNotificationType(oai::model::NotificationType const& value);
    /// <summary>
    ...
    /// String providing an URI formatted according to RFC 3986.
    /// </summary>
    std::string getInterPlmnCallbackUri() const;
    void setInterPlmnCallbackUri(std::string const& value);
    bool interPlmnCallbackUriIsSet() const;
    void unsetInterPlmnCallbackUri();
    /// <summary>
    /// 
    /// </summary>
    oai::model::N1MessageClass getN1MessageClass() const;
    void setN1MessageClass(oai::model::N1MessageClass const& value);
    ...
    /// </summary>
    std::map<std::string, oai::model::DefSubServiceInfo> getServiceInfoList() const;
    void setServiceInfoList(std::map<std::string, oai::model::DefSubServiceInfo> const& value);
...
protected:
    oai::model::NotificationType m_NotificationType;

    std::string m_CallbackUri;

    std::string m_InterPlmnCallbackUri;
    bool m_InterPlmnCallbackUriIsSet;
    oai::model::N1MessageClass m_N1MessageClass;
    ...
    std::map<std::string, oai::model::DefSubServiceInfo> m_ServiceInfoList;
