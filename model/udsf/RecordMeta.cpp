...
bool RecordMeta::validate(std::stringstream &msg,
...
std::string RecordMeta::getTtl() const { return m_Ttl; }
void RecordMeta::setTtl(std::string const &value) {
  m_Ttl = value;
  m_TtlIsSet = true;
}
bool RecordMeta::ttlIsSet() const { return m_TtlIsSet; }
void RecordMeta::unsetTtl() { m_TtlIsSet = false; }
...
void RecordMeta::unsetCallbackReference() { m_CallbackReferenceIsSet = false; }
...
bool RecordMeta::tagsIsSet() const { return m_TagsIsSet; }
void RecordMeta::unsetTags() { m_TagsIsSet = false; }
