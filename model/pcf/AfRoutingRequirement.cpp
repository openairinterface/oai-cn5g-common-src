...
std::vector<oai::model::common::RouteToLocation> AfRoutingRequirement::getRouteToLocs() const
{
    return m_RouteToLocs;
}
void AfRoutingRequirement::setRouteToLocs(std::vector<oai::model::common::RouteToLocation> const& value)
{
    m_RouteToLocs = value;
...
void AfRoutingRequirement::setSpVal(oai::model::pcf::SpatialValidity const& value)
{
    m_SpVal = value;
    m_SpValIsSet = true;
}
...
std::vector<oai::model::pcf::TemporalValidity> AfRoutingRequirement::getTempVals() const
{
    return m_TempVals;
}
void AfRoutingRequirement::setTempVals(std::vector<oai::model::pcf::TemporalValidity> const& value)
{
    m_TempVals = value;
...
void AfRoutingRequirement::setUpPathChgSub(oai::model::pcf::UpPathChgEvent const& value)
{
...
std::vector<oai::model::pcf::EasIpReplacementInfo> AfRoutingRequirement::getEasIpReplaceInfos() const
{
    return m_EasIpReplaceInfos;
}
void AfRoutingRequirement::setEasIpReplaceInfos(std::vector<oai::model::pcf::EasIpReplacementInfo> const& value)
{
...
oai::model::pcf::TrafficCorrelationInfo AfRoutingRequirement::getTfcCorreInfo() const
{
    return m_TfcCorreInfo;
}
void AfRoutingRequirement::setTfcCorreInfo(oai::model::pcf::TrafficCorrelationInfo const& value)
{
