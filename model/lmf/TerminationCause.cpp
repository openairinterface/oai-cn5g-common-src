...
bool TerminationCause::validate(std::stringstream &msg,
...
TerminationCause_anyOf TerminationCause::getValue() const { return m_value; }
...
TerminationCause::getEnumValue() const {
