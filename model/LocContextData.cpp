...
void LocContextData::setLocationQoS(oai::_3gpp::model::LocationQoS const& value)
{
    m_LocationQoS = value;
...
std::vector<oai::_3gpp::model::SupportedGADShapes> LocContextData::getSupportedGADShapes() const
{
    return m_SupportedGADShapes;
}
void LocContextData::setSupportedGADShapes(std::vector<oai::_3gpp::model::SupportedGADShapes> const& value)
{
...
oai::_3gpp::model::PeriodicEventInfo LocContextData::getPeriodicEventInfo() const
{
    return m_PeriodicEventInfo;
}
void LocContextData::setPeriodicEventInfo(oai::_3gpp::model::PeriodicEventInfo const& value)
{
...
void LocContextData::setAreaEventInfo(oai::_3gpp::model::AreaEventInfo const& value)
{
...
void LocContextData::setMotionEventInfo(oai::_3gpp::model::MotionEventInfo const& value)
{
...
oai::_3gpp::model::EventReportMessage LocContextData::getEventReportMessage() const
{
    return m_EventReportMessage;
}
void LocContextData::setEventReportMessage(oai::_3gpp::model::EventReportMessage const& value)
{
    m_EventReportMessage = value;
}
oai::_3gpp::model::EventReportingStatus LocContextData::getEventReportingStatus() const
{
    return m_EventReportingStatus;
}
void LocContextData::setEventReportingStatus(oai::_3gpp::model::EventReportingStatus const& value)
{
...
void LocContextData::setUeLocationInfo(oai::_3gpp::model::UELocationInfo const& value)
{
