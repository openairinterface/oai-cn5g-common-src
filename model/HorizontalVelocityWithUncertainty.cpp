...
bool HorizontalVelocityWithUncertainty::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "HorizontalVelocityWithUncertainty" : pathPrefix;
...
bool HorizontalVelocityWithUncertainty::operator==(const HorizontalVelocityWithUncertainty& rhs) const
{
    return
