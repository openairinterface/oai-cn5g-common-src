...
oai::_3gpp::model::Ipv6Addr IpAddr::getIpv6Addr() const
{
    return m_Ipv6Addr;
}
void IpAddr::setIpv6Addr(oai::_3gpp::model::Ipv6Addr const& value)
{
    m_Ipv6Addr = value;
...
oai::_3gpp::model::Ipv6Prefix IpAddr::getIpv6Prefix() const
{
    return m_Ipv6Prefix;
}
void IpAddr::setIpv6Prefix(oai::_3gpp::model::Ipv6Prefix const& value)
{
    m_Ipv6Prefix = value;
