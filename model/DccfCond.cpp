...
std::vector<oai::model::Tai> DccfCond::getTaiList() const
{
    return m_TaiList;
}
void DccfCond::setTaiList(std::vector<oai::model::Tai> const& value)
{
    m_TaiList = value;
    m_TaiListIsSet = true;
}
...
std::vector<oai::model::TaiRange> DccfCond::getTaiRangeList() const
{
    return m_TaiRangeList;
}
void DccfCond::setTaiRangeList(std::vector<oai::model::TaiRange> const& value)
{
...
std::vector<oai::model::NFType> DccfCond::getServingNfTypeList() const
{
    return m_ServingNfTypeList;
}
void DccfCond::setServingNfTypeList(std::vector<oai::model::NFType> const& value)
{
