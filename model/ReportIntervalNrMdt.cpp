...
ReportIntervalNrMdt_anyOf::eReportIntervalNrMdt_anyOf ReportIntervalNrMdt::getEnumValue() const
{
    return m_value.getValue();
}

void ReportIntervalNrMdt::setEnumValue(ReportIntervalNrMdt_anyOf::eReportIntervalNrMdt_anyOf  value)
{
