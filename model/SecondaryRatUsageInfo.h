...
public:
    ...
    /// 
    /// </summary>
    std::vector<oai::_3gpp::model::QosFlowUsageReport> getQosFlowsUsageData() const;
    void setQosFlowsUsageData(std::vector<oai::_3gpp::model::QosFlowUsageReport> const& value);
    bool qosFlowsUsageDataIsSet() const;
    void unsetQosFlowsUsageData();
    /// <summary>
    /// 
    /// </summary>
    std::vector<oai::_3gpp::model::VolumeTimedReport> getPduSessionUsageData() const;
    void setPduSessionUsageData(std::vector<oai::_3gpp::model::VolumeTimedReport> const& value);
