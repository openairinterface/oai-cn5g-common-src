...
bool SubscrCond::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "SubscrCond" : pathPrefix;
    ...
    /* ServiceNameList */ {
        const std::vector<oai::model::ServiceName>& value = m_ServiceNameList;
        ...
        { // Recursive validation of array elements
            const std::string oldValuePath = currentValuePath;
            int i = 0;
            for (const oai::model::ServiceName& value : value)
            { 
                const std::string currentValuePath = oldValuePath + "[" + std::to_string(i) + "]";
    ...
    /* GuamiList */ {
        const std::vector<oai::model::Guami>& value = m_GuamiList;
        ...
        { // Recursive validation of array elements
            const std::string oldValuePath = currentValuePath;
            int i = 0;
            for (const oai::model::Guami& value : value)
            { 
                const std::string currentValuePath = oldValuePath + "[" + std::to_string(i) + "]";
    ...
    if (taiListIsSet())
    {
        const std::vector<oai::model::Tai>& value = m_TaiList;
        ...
        { // Recursive validation of array elements
            const std::string oldValuePath = currentValuePath;
            int i = 0;
            for (const oai::model::Tai& value : value)
            { 
                const std::string currentValuePath = oldValuePath + "[" + std::to_string(i) + "]";
    ...
    if (nfTypeListIsSet())
    {
        const std::vector<oai::model::NFType>& value = m_NfTypeList;
    ...
    {
        const std::vector<oai::model::TaiRange>& value = m_TaiRangeList;
        ...
        { // Recursive validation of array elements
            const std::string oldValuePath = currentValuePath;
            int i = 0;
            for (const oai::model::TaiRange& value : value)
            { 
                const std::string currentValuePath = oldValuePath + "[" + std::to_string(i) + "]";
    ...
    {
        const std::vector<oai::model::NFType>& value = m_ServingNfTypeList;
    ...
    {
        const std::vector<oai::model::MlAnalyticsInfo>& value = m_MlAnalyticsList;
        ...
        { // Recursive validation of array elements
            const std::string oldValuePath = currentValuePath;
            int i = 0;
            for (const oai::model::MlAnalyticsInfo& value : value)
            { 
                const std::string currentValuePath = oldValuePath + "[" + std::to_string(i) + "]";
    ...
    if (afEventsIsSet())
    {
        const std::vector<oai::model::AfEvent>& value = m_AfEvents;
        ...
        { // Recursive validation of array elements
            const std::string oldValuePath = currentValuePath;
            int i = 0;
            for (const oai::model::AfEvent& value : value)
            { 
                const std::string currentValuePath = oldValuePath + "[" + std::to_string(i) + "]";
    ...
    {
        const std::vector<oai::model::IdentityRange>& value = m_ExternalGroupIdentifiersRanges;
...
oai::model::ServiceName SubscrCond::getServiceName() const
{
    return m_ServiceName;
}
void SubscrCond::setServiceName(oai::model::ServiceName const& value)
{
    m_ServiceName = value;
}
...
std::vector<oai::model::ServiceName> SubscrCond::getServiceNameList() const
{
    return m_ServiceNameList;
}
void SubscrCond::setServiceNameList(std::vector<oai::model::ServiceName> const& value)
{
    m_ServiceNameList = value;
}
std::string SubscrCond::getAmfSetId() const
{
    return m_AmfSetId;
}
void SubscrCond::setAmfSetId(std::string const& value)
{
    m_AmfSetId = value;
    m_AmfSetIdIsSet = true;
}
bool SubscrCond::amfSetIdIsSet() const
{
    return m_AmfSetIdIsSet;
}
void SubscrCond::unsetAmfSetId()
{
    m_AmfSetIdIsSet = false;
}
std::string SubscrCond::getAmfRegionId() const
{
    return m_AmfRegionId;
}
void SubscrCond::setAmfRegionId(std::string const& value)
{
    m_AmfRegionId = value;
    m_AmfRegionIdIsSet = true;
}
bool SubscrCond::amfRegionIdIsSet() const
{
    return m_AmfRegionIdIsSet;
}
void SubscrCond::unsetAmfRegionId()
{
    m_AmfRegionIdIsSet = false;
}
std::vector<oai::model::Guami> SubscrCond::getGuamiList() const
{
    return m_GuamiList;
}
void SubscrCond::setGuamiList(std::vector<oai::model::Guami> const& value)
{
    m_GuamiList = value;
}
std::vector<oai::model::Snssai> SubscrCond::getSnssaiList() const
{
    return m_SnssaiList;
}
void SubscrCond::setSnssaiList(std::vector<oai::model::Snssai> const& value)
{
    m_SnssaiList = value;
}
...
std::vector<oai::model::Tai> SubscrCond::getTaiList() const
{
    return m_TaiList;
}
void SubscrCond::setTaiList(std::vector<oai::model::Tai> const& value)
{
    m_TaiList = value;
    m_TaiListIsSet = true;
}
...
std::vector<oai::model::NFType> SubscrCond::getNfTypeList() const
{
    return m_NfTypeList;
}
void SubscrCond::setNfTypeList(std::vector<oai::model::NFType> const& value)
{
    m_NfTypeList = value;
...
std::vector<oai::model::TaiRange> SubscrCond::getTaiRangeList() const
{
    return m_TaiRangeList;
}
void SubscrCond::setTaiRangeList(std::vector<oai::model::TaiRange> const& value)
{
...
std::vector<oai::model::NFType> SubscrCond::getServingNfTypeList() const
{
    return m_ServingNfTypeList;
}
void SubscrCond::setServingNfTypeList(std::vector<oai::model::NFType> const& value)
{
...
std::vector<oai::model::MlAnalyticsInfo> SubscrCond::getMlAnalyticsList() const
{
    return m_MlAnalyticsList;
}
void SubscrCond::setMlAnalyticsList(std::vector<oai::model::MlAnalyticsInfo> const& value)
{
...
std::vector<oai::model::AfEvent> SubscrCond::getAfEvents() const
{
    return m_AfEvents;
}
void SubscrCond::setAfEvents(std::vector<oai::model::AfEvent> const& value)
{
    m_AfEvents = value;
...
oai::model::PfdData SubscrCond::getPfdData() const
{
    return m_PfdData;
}
void SubscrCond::setPfdData(oai::model::PfdData const& value)
{
    m_PfdData = value;
    m_PfdDataIsSet = true;
}
...
std::vector<oai::model::IdentityRange> SubscrCond::getGpsiRanges() const
{
    return m_GpsiRanges;
}
void SubscrCond::setGpsiRanges(std::vector<oai::model::IdentityRange> const& value)
{
    m_GpsiRanges = value;
...
std::vector<oai::model::IdentityRange> SubscrCond::getExternalGroupIdentifiersRanges() const
{
    return m_ExternalGroupIdentifiersRanges;
}
void SubscrCond::setExternalGroupIdentifiersRanges(std::vector<oai::model::IdentityRange> const& value)
{
