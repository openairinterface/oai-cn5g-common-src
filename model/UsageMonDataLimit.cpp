...
std::map<std::string, oai::_3gpp::model::UsageMonDataScope> UsageMonDataLimit::getScopes() const
{
    return m_Scopes;
}
void UsageMonDataLimit::setScopes(std::map<std::string, oai::_3gpp::model::UsageMonDataScope> const& value)
{
    m_Scopes = value;
    m_ScopesIsSet = true;
}
...
void UsageMonDataLimit::setUmLevel(oai::_3gpp::model::UsageMonLevel const& value)
{
    m_UmLevel = value;
    m_UmLevelIsSet = true;
}
...
void UsageMonDataLimit::setUsageLimit(oai::_3gpp::model::UsageThreshold const& value)
{
    m_UsageLimit = value;
...
void UsageMonDataLimit::setResetPeriod(oai::_3gpp::model::TimePeriod const& value)
{
    m_ResetPeriod = value;
