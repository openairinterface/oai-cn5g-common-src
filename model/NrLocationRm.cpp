...
bool NrLocationRm::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "NrLocationRm" : pathPrefix;
...
oai::_3gpp::model::Tai NrLocationRm::getTai() const
{
    return m_Tai;
}
void NrLocationRm::setTai(oai::_3gpp::model::Tai const& value)
{
    m_Tai = value;
}
oai::_3gpp::model::Ncgi NrLocationRm::getNcgi() const
{
    return m_Ncgi;
}
void NrLocationRm::setNcgi(oai::_3gpp::model::Ncgi const& value)
{
    m_Ncgi = value;
}
...
oai::_3gpp::model::GlobalRanNodeId NrLocationRm::getGlobalGnbId() const
{
    return m_GlobalGnbId;
}
void NrLocationRm::setGlobalGnbId(oai::_3gpp::model::GlobalRanNodeId const& value)
{
    m_GlobalGnbId = value;
