...
bool NoProfileMatchInfo::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    ...
    {
        const std::vector<oai::_3gpp::model::QueryParamCombination>& value = m_QueryParamCombinationList;
...
void NoProfileMatchInfo::setReason(oai::_3gpp::model::NoProfileMatchReason const& value)
{
    m_Reason = value;
}
std::vector<oai::_3gpp::model::QueryParamCombination> NoProfileMatchInfo::getQueryParamCombinationList() const
{
    return m_QueryParamCombinationList;
}
void NoProfileMatchInfo::setQueryParamCombinationList(std::vector<oai::_3gpp::model::QueryParamCombination> const& value)
{
