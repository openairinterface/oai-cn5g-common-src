...
bool PresenceInfoRm::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    ...
    {
        const std::vector<oai::_3gpp::model::GlobalRanNodeId>& value = m_GlobalRanNodeIdList;
    ...
    {
        const std::vector<oai::_3gpp::model::GlobalRanNodeId>& value = m_GlobaleNbIdList;
...
oai::_3gpp::model::PresenceState PresenceInfoRm::getPresenceState() const
{
    return m_PresenceState;
}
void PresenceInfoRm::setPresenceState(oai::_3gpp::model::PresenceState const& value)
{
...
std::vector<oai::_3gpp::model::Tai> PresenceInfoRm::getTrackingAreaList() const
{
    return m_TrackingAreaList;
}
void PresenceInfoRm::setTrackingAreaList(std::vector<oai::_3gpp::model::Tai> const& value)
{
...
std::vector<oai::_3gpp::model::Ecgi> PresenceInfoRm::getEcgiList() const
{
    return m_EcgiList;
}
void PresenceInfoRm::setEcgiList(std::vector<oai::_3gpp::model::Ecgi> const& value)
{
    m_EcgiList = value;
...
std::vector<oai::_3gpp::model::Ncgi> PresenceInfoRm::getNcgiList() const
{
    return m_NcgiList;
}
void PresenceInfoRm::setNcgiList(std::vector<oai::_3gpp::model::Ncgi> const& value)
{
    m_NcgiList = value;
...
std::vector<oai::_3gpp::model::GlobalRanNodeId> PresenceInfoRm::getGlobalRanNodeIdList() const
{
    return m_GlobalRanNodeIdList;
}
void PresenceInfoRm::setGlobalRanNodeIdList(std::vector<oai::_3gpp::model::GlobalRanNodeId> const& value)
{
...
std::vector<oai::_3gpp::model::GlobalRanNodeId> PresenceInfoRm::getGlobaleNbIdList() const
{
    return m_GlobaleNbIdList;
}
void PresenceInfoRm::setGlobaleNbIdList(std::vector<oai::_3gpp::model::GlobalRanNodeId> const& value)
{
