...
/// <summary>
/// The response shall include a Location header field containing a different
/// URI  (pointing to a different URI of an other service instance), or the same
/// URI if a request  is redirected to the same target resource via a different
/// SCP.
/// </summary>
