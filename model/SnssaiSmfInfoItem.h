...
public:
    ...
    /// 
    /// </summary>
    std::vector<oai::model::DnnSmfInfoItem> getDnnSmfInfoList() const;
    void setDnnSmfInfoList(std::vector<oai::model::DnnSmfInfoItem> const& value);
...
protected:
    ...
    std::vector<oai::model::DnnSmfInfoItem> m_DnnSmfInfoList;
