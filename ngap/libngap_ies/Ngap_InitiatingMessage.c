...
static const asn_ioc_cell_t asn_IOS_Ngap_NGAP_ELEMENTARY_PROCEDURES_1_rows[] = {
    ...
    {"&procedureCode", aioc__value, &asn_DEF_Ngap_ProcedureCode,
     &asn_VAL_1_Ngap_id_AMFConfigurationUpdate},
    {"&criticality", aioc__value, &asn_DEF_Ngap_Criticality,
     &asn_VAL_1_Ngap_reject},
    ...
    {"&procedureCode", aioc__value, &asn_DEF_Ngap_ProcedureCode,
     &asn_VAL_2_Ngap_id_HandoverCancel},
    {"&criticality", aioc__value, &asn_DEF_Ngap_Criticality,
     &asn_VAL_2_Ngap_reject},
    ...
    {"&procedureCode", aioc__value, &asn_DEF_Ngap_ProcedureCode,
     &asn_VAL_3_Ngap_id_HandoverPreparation},
    {"&criticality", aioc__value, &asn_DEF_Ngap_Criticality,
     &asn_VAL_3_Ngap_reject},
    ...
    {"&procedureCode", aioc__value, &asn_DEF_Ngap_ProcedureCode,
     &asn_VAL_4_Ngap_id_HandoverResourceAllocation},
    {"&criticality", aioc__value, &asn_DEF_Ngap_Criticality,
     &asn_VAL_4_Ngap_reject},
    ...
    {"&procedureCode", aioc__value, &asn_DEF_Ngap_ProcedureCode,
     &asn_VAL_5_Ngap_id_InitialContextSetup},
    {"&criticality", aioc__value, &asn_DEF_Ngap_Criticality,
     &asn_VAL_5_Ngap_reject},
    ...
    {"&procedureCode", aioc__value, &asn_DEF_Ngap_ProcedureCode,
     &asn_VAL_6_Ngap_id_NGReset},
    {"&criticality", aioc__value, &asn_DEF_Ngap_Criticality,
     &asn_VAL_6_Ngap_reject},
    ...
    {"&procedureCode", aioc__value, &asn_DEF_Ngap_ProcedureCode,
     &asn_VAL_7_Ngap_id_NGSetup},
    {"&criticality", aioc__value, &asn_DEF_Ngap_Criticality,
     &asn_VAL_7_Ngap_reject},
    ...
    {"&procedureCode", aioc__value, &asn_DEF_Ngap_ProcedureCode,
     &asn_VAL_8_Ngap_id_PathSwitchRequest},
    {"&criticality", aioc__value, &asn_DEF_Ngap_Criticality,
     &asn_VAL_8_Ngap_reject},
    {"&InitiatingMessage", aioc__type,
    ...
    {"&procedureCode", aioc__value, &asn_DEF_Ngap_ProcedureCode,
     &asn_VAL_9_Ngap_id_PDUSessionResourceModify},
    {"&criticality", aioc__value, &asn_DEF_Ngap_Criticality,
     &asn_VAL_9_Ngap_reject},
    {"&InitiatingMessage", aioc__type,
    ...
    {"&procedureCode", aioc__value, &asn_DEF_Ngap_ProcedureCode,
     &asn_VAL_10_Ngap_id_PDUSessionResourceModifyIndication},
    {"&criticality", aioc__value, &asn_DEF_Ngap_Criticality,
     &asn_VAL_10_Ngap_reject},
    {"&InitiatingMessage", aioc__type,
    ...
    {"&procedureCode", aioc__value, &asn_DEF_Ngap_ProcedureCode,
     &asn_VAL_11_Ngap_id_PDUSessionResourceRelease},
    {"&criticality", aioc__value, &asn_DEF_Ngap_Criticality,
     &asn_VAL_11_Ngap_reject},
    {"&InitiatingMessage", aioc__type,
    ...
    {"&procedureCode", aioc__value, &asn_DEF_Ngap_ProcedureCode,
     &asn_VAL_12_Ngap_id_PDUSessionResourceSetup},
    {"&criticality", aioc__value, &asn_DEF_Ngap_Criticality,
    ...
    {"&procedureCode", aioc__value, &asn_DEF_Ngap_ProcedureCode,
     &asn_VAL_14_Ngap_id_RANConfigurationUpdate},
    {"&criticality", aioc__value, &asn_DEF_Ngap_Criticality,
     &asn_VAL_14_Ngap_reject},
    {"&InitiatingMessage", aioc__type,
    ...
    {"&procedureCode", aioc__value, &asn_DEF_Ngap_ProcedureCode,
     &asn_VAL_15_Ngap_id_UEContextModification},
    {"&criticality", aioc__value, &asn_DEF_Ngap_Criticality,
     &asn_VAL_15_Ngap_reject},
    ...
    {"&procedureCode", aioc__value, &asn_DEF_Ngap_ProcedureCode,
     &asn_VAL_16_Ngap_id_UEContextRelease},
    {"&criticality", aioc__value, &asn_DEF_Ngap_Criticality,
    ...
    {"&procedureCode", aioc__value, &asn_DEF_Ngap_ProcedureCode,
     &asn_VAL_17_Ngap_id_UEContextResume},
    {"&criticality", aioc__value, &asn_DEF_Ngap_Criticality,
     &asn_VAL_17_Ngap_reject},
    ...
    {"&procedureCode", aioc__value, &asn_DEF_Ngap_ProcedureCode,
     &asn_VAL_18_Ngap_id_UEContextSuspend},
    {"&criticality", aioc__value, &asn_DEF_Ngap_Criticality,
     &asn_VAL_18_Ngap_reject},
    {"&InitiatingMessage", aioc__type,
    ...
    {"&procedureCode", aioc__value, &asn_DEF_Ngap_ProcedureCode,
     &asn_VAL_19_Ngap_id_UERadioCapabilityCheck},
    {"&criticality", aioc__value, &asn_DEF_Ngap_Criticality,
     &asn_VAL_19_Ngap_reject},
    {"&InitiatingMessage", aioc__type,
    ...
    {"&procedureCode", aioc__value, &asn_DEF_Ngap_ProcedureCode,
     &asn_VAL_20_Ngap_id_UERadioCapabilityIDMapping},
    {"&criticality", aioc__value, &asn_DEF_Ngap_Criticality,
     &asn_VAL_20_Ngap_reject},
    {"&InitiatingMessage", aioc__type,
    ...
    {"&procedureCode", aioc__value, &asn_DEF_Ngap_ProcedureCode,
     &asn_VAL_21_Ngap_id_WriteReplaceWarning},
    {"&criticality", aioc__value, &asn_DEF_Ngap_Criticality,
     &asn_VAL_21_Ngap_reject},
    ...
    {"&procedureCode", aioc__value, &asn_DEF_Ngap_ProcedureCode,
     &asn_VAL_22_Ngap_id_AMFCPRelocationIndication},
    {"&criticality", aioc__value, &asn_DEF_Ngap_Criticality,
     &asn_VAL_22_Ngap_reject},
    ...
    {"&procedureCode", aioc__value, &asn_DEF_Ngap_ProcedureCode,
     &asn_VAL_23_Ngap_id_AMFStatusIndication},
    {"&criticality", aioc__value, &asn_DEF_Ngap_Criticality,
     &asn_VAL_23_Ngap_ignore},
    ...
    {"&procedureCode", aioc__value, &asn_DEF_Ngap_ProcedureCode,
     &asn_VAL_24_Ngap_id_CellTrafficTrace},
    {"&criticality", aioc__value, &asn_DEF_Ngap_Criticality,
     &asn_VAL_24_Ngap_ignore},
    {"&InitiatingMessage", aioc__type,
    ...
    {"&procedureCode", aioc__value, &asn_DEF_Ngap_ProcedureCode,
     &asn_VAL_25_Ngap_id_ConnectionEstablishmentIndication},
    {"&criticality", aioc__value, &asn_DEF_Ngap_Criticality,
     &asn_VAL_25_Ngap_reject},
    ...
    {"&procedureCode", aioc__value, &asn_DEF_Ngap_ProcedureCode,
     &asn_VAL_26_Ngap_id_DeactivateTrace},
    {"&criticality", aioc__value, &asn_DEF_Ngap_Criticality,
     &asn_VAL_26_Ngap_ignore},
    ...
    {"&procedureCode", aioc__value, &asn_DEF_Ngap_ProcedureCode,
     &asn_VAL_27_Ngap_id_DownlinkNASTransport},
    {"&criticality", aioc__value, &asn_DEF_Ngap_Criticality,
     &asn_VAL_27_Ngap_ignore},
    {"&InitiatingMessage", aioc__type,
    ...
    {"&procedureCode", aioc__value, &asn_DEF_Ngap_ProcedureCode,
     &asn_VAL_28_Ngap_id_DownlinkNonUEAssociatedNRPPaTransport},
    {"&criticality", aioc__value, &asn_DEF_Ngap_Criticality,
     &asn_VAL_28_Ngap_ignore},
    {"&InitiatingMessage", aioc__type,
    ...
    {"&procedureCode", aioc__value, &asn_DEF_Ngap_ProcedureCode,
     &asn_VAL_29_Ngap_id_DownlinkRANConfigurationTransfer},
    {"&criticality", aioc__value, &asn_DEF_Ngap_Criticality,
    ...
    {"&procedureCode", aioc__value, &asn_DEF_Ngap_ProcedureCode,
     &asn_VAL_30_Ngap_id_DownlinkRANEarlyStatusTransfer},
    {"&criticality", aioc__value, &asn_DEF_Ngap_Criticality,
     &asn_VAL_30_Ngap_ignore},
    ...
    {"&procedureCode", aioc__value, &asn_DEF_Ngap_ProcedureCode,
     &asn_VAL_31_Ngap_id_DownlinkRANStatusTransfer},
    {"&criticality", aioc__value, &asn_DEF_Ngap_Criticality,
     &asn_VAL_31_Ngap_ignore},
    {"&InitiatingMessage", aioc__type,
    ...
    {"&procedureCode", aioc__value, &asn_DEF_Ngap_ProcedureCode,
     &asn_VAL_32_Ngap_id_DownlinkRIMInformationTransfer},
    {"&criticality", aioc__value, &asn_DEF_Ngap_Criticality,
     &asn_VAL_32_Ngap_ignore},
    {"&InitiatingMessage", aioc__type,
    ...
    {"&procedureCode", aioc__value, &asn_DEF_Ngap_ProcedureCode,
     &asn_VAL_33_Ngap_id_DownlinkUEAssociatedNRPPaTransport},
    {"&criticality", aioc__value, &asn_DEF_Ngap_Criticality,
     &asn_VAL_33_Ngap_ignore},
    ...
    {"&procedureCode", aioc__value, &asn_DEF_Ngap_ProcedureCode,
     &asn_VAL_34_Ngap_id_ErrorIndication},
    {"&criticality", aioc__value, &asn_DEF_Ngap_Criticality,
     &asn_VAL_34_Ngap_ignore},
    ...
    {"&procedureCode", aioc__value, &asn_DEF_Ngap_ProcedureCode,
     &asn_VAL_35_Ngap_id_HandoverNotification},
    {"&criticality", aioc__value, &asn_DEF_Ngap_Criticality,
     &asn_VAL_35_Ngap_ignore},
    ...
    {"&procedureCode", aioc__value, &asn_DEF_Ngap_ProcedureCode,
     &asn_VAL_36_Ngap_id_HandoverSuccess},
    {"&criticality", aioc__value, &asn_DEF_Ngap_Criticality,
     &asn_VAL_36_Ngap_ignore},
    ...
    {"&procedureCode", aioc__value, &asn_DEF_Ngap_ProcedureCode,
     &asn_VAL_37_Ngap_id_InitialUEMessage},
    {"&criticality", aioc__value, &asn_DEF_Ngap_Criticality,
     &asn_VAL_37_Ngap_ignore},
    ...
    {"&procedureCode", aioc__value, &asn_DEF_Ngap_ProcedureCode,
     &asn_VAL_38_Ngap_id_LocationReport},
    {"&criticality", aioc__value, &asn_DEF_Ngap_Criticality,
    ...
    {"&procedureCode", aioc__value, &asn_DEF_Ngap_ProcedureCode,
     &asn_VAL_39_Ngap_id_LocationReportingControl},
    {"&criticality", aioc__value, &asn_DEF_Ngap_Criticality,
    ...
    {"&procedureCode", aioc__value, &asn_DEF_Ngap_ProcedureCode,
     &asn_VAL_40_Ngap_id_LocationReportingFailureIndication},
    {"&criticality", aioc__value, &asn_DEF_Ngap_Criticality,
     &asn_VAL_40_Ngap_ignore},
    ...
    {"&procedureCode", aioc__value, &asn_DEF_Ngap_ProcedureCode,
     &asn_VAL_41_Ngap_id_NASNonDeliveryIndication},
    {"&criticality", aioc__value, &asn_DEF_Ngap_Criticality,
     &asn_VAL_41_Ngap_ignore},
    ...
    {"&procedureCode", aioc__value, &asn_DEF_Ngap_ProcedureCode,
     &asn_VAL_42_Ngap_id_OverloadStart},
    {"&criticality", aioc__value, &asn_DEF_Ngap_Criticality,
    ...
    {"&procedureCode", aioc__value, &asn_DEF_Ngap_ProcedureCode,
     &asn_VAL_43_Ngap_id_OverloadStop},
    {"&criticality", aioc__value, &asn_DEF_Ngap_Criticality,
     &asn_VAL_43_Ngap_reject},
    ...
    {"&procedureCode", aioc__value, &asn_DEF_Ngap_ProcedureCode,
     &asn_VAL_44_Ngap_id_Paging},
    {"&criticality", aioc__value, &asn_DEF_Ngap_Criticality,
     &asn_VAL_44_Ngap_ignore},
    ...
    {"&procedureCode", aioc__value, &asn_DEF_Ngap_ProcedureCode,
     &asn_VAL_45_Ngap_id_PDUSessionResourceNotify},
    {"&criticality", aioc__value, &asn_DEF_Ngap_Criticality,
     &asn_VAL_45_Ngap_ignore},
    ...
    {"&procedureCode", aioc__value, &asn_DEF_Ngap_ProcedureCode,
     &asn_VAL_46_Ngap_id_PrivateMessage},
    {"&criticality", aioc__value, &asn_DEF_Ngap_Criticality,
     &asn_VAL_46_Ngap_ignore},
    ...
    {"&procedureCode", aioc__value, &asn_DEF_Ngap_ProcedureCode,
     &asn_VAL_47_Ngap_id_PWSFailureIndication},
    {"&criticality", aioc__value, &asn_DEF_Ngap_Criticality,
     &asn_VAL_47_Ngap_ignore},
    ...
    {"&procedureCode", aioc__value, &asn_DEF_Ngap_ProcedureCode,
     &asn_VAL_48_Ngap_id_PWSRestartIndication},
    {"&criticality", aioc__value, &asn_DEF_Ngap_Criticality,
    ...
    {"&procedureCode", aioc__value, &asn_DEF_Ngap_ProcedureCode,
     &asn_VAL_49_Ngap_id_RANCPRelocationIndication},
    {"&criticality", aioc__value, &asn_DEF_Ngap_Criticality,
     &asn_VAL_49_Ngap_reject},
    ...
    {"&procedureCode", aioc__value, &asn_DEF_Ngap_ProcedureCode,
     &asn_VAL_50_Ngap_id_RerouteNASRequest},
    {"&criticality", aioc__value, &asn_DEF_Ngap_Criticality,
     &asn_VAL_50_Ngap_reject},
    ...
    {"&procedureCode", aioc__value, &asn_DEF_Ngap_ProcedureCode,
     &asn_VAL_51_Ngap_id_RetrieveUEInformation},
    {"&criticality", aioc__value, &asn_DEF_Ngap_Criticality,
     &asn_VAL_51_Ngap_reject},
    {"&InitiatingMessage", aioc__type,
    ...
    {"&procedureCode", aioc__value, &asn_DEF_Ngap_ProcedureCode,
     &asn_VAL_52_Ngap_id_RRCInactiveTransitionReport},
    {"&criticality", aioc__value, &asn_DEF_Ngap_Criticality,
     &asn_VAL_52_Ngap_ignore},
    {"&InitiatingMessage", aioc__type,
    ...
    {"&procedureCode", aioc__value, &asn_DEF_Ngap_ProcedureCode,
     &asn_VAL_53_Ngap_id_SecondaryRATDataUsageReport},
    {"&criticality", aioc__value, &asn_DEF_Ngap_Criticality,
     &asn_VAL_53_Ngap_ignore},
    ...
    {"&procedureCode", aioc__value, &asn_DEF_Ngap_ProcedureCode,
     &asn_VAL_54_Ngap_id_TraceFailureIndication},
    {"&criticality", aioc__value, &asn_DEF_Ngap_Criticality,
     &asn_VAL_54_Ngap_ignore},
    ...
    {"&procedureCode", aioc__value, &asn_DEF_Ngap_ProcedureCode,
     &asn_VAL_55_Ngap_id_TraceStart},
    {"&criticality", aioc__value, &asn_DEF_Ngap_Criticality,
     &asn_VAL_55_Ngap_ignore},
    ...
    {"&procedureCode", aioc__value, &asn_DEF_Ngap_ProcedureCode,
     &asn_VAL_56_Ngap_id_UEContextReleaseRequest},
    {"&criticality", aioc__value, &asn_DEF_Ngap_Criticality,
     &asn_VAL_56_Ngap_ignore},
    ...
    {"&procedureCode", aioc__value, &asn_DEF_Ngap_ProcedureCode,
     &asn_VAL_57_Ngap_id_UEInformationTransfer},
    {"&criticality", aioc__value, &asn_DEF_Ngap_Criticality,
     &asn_VAL_57_Ngap_reject},
    {"&InitiatingMessage", aioc__type,
    ...
    {"&procedureCode", aioc__value, &asn_DEF_Ngap_ProcedureCode,
     &asn_VAL_58_Ngap_id_UERadioCapabilityInfoIndication},
    {"&criticality", aioc__value, &asn_DEF_Ngap_Criticality,
     &asn_VAL_58_Ngap_ignore},
    {"&InitiatingMessage", aioc__type,
    ...
    {"&procedureCode", aioc__value, &asn_DEF_Ngap_ProcedureCode,
     &asn_VAL_59_Ngap_id_UETNLABindingRelease},
    {"&criticality", aioc__value, &asn_DEF_Ngap_Criticality,
     &asn_VAL_59_Ngap_ignore},
    ...
    {"&procedureCode", aioc__value, &asn_DEF_Ngap_ProcedureCode,
     &asn_VAL_60_Ngap_id_UplinkNASTransport},
    {"&criticality", aioc__value, &asn_DEF_Ngap_Criticality,
     &asn_VAL_60_Ngap_ignore},
    {"&InitiatingMessage", aioc__type,
    ...
    {"&procedureCode", aioc__value, &asn_DEF_Ngap_ProcedureCode,
     &asn_VAL_61_Ngap_id_UplinkNonUEAssociatedNRPPaTransport},
    {"&criticality", aioc__value, &asn_DEF_Ngap_Criticality,
     &asn_VAL_61_Ngap_ignore},
    {"&InitiatingMessage", aioc__type,
    ...
    {"&procedureCode", aioc__value, &asn_DEF_Ngap_ProcedureCode,
     &asn_VAL_62_Ngap_id_UplinkRANConfigurationTransfer},
    {"&criticality", aioc__value, &asn_DEF_Ngap_Criticality,
     &asn_VAL_62_Ngap_ignore},
    {"&InitiatingMessage", aioc__type,
    ...
    {"&procedureCode", aioc__value, &asn_DEF_Ngap_ProcedureCode,
     &asn_VAL_63_Ngap_id_UplinkRANEarlyStatusTransfer},
    {"&criticality", aioc__value, &asn_DEF_Ngap_Criticality,
     &asn_VAL_63_Ngap_reject},
    ...
    {"&procedureCode", aioc__value, &asn_DEF_Ngap_ProcedureCode,
     &asn_VAL_64_Ngap_id_UplinkRANStatusTransfer},
    {"&criticality", aioc__value, &asn_DEF_Ngap_Criticality,
     &asn_VAL_64_Ngap_ignore},
    {"&InitiatingMessage", aioc__type,
    ...
    {"&procedureCode", aioc__value, &asn_DEF_Ngap_ProcedureCode,
     &asn_VAL_65_Ngap_id_UplinkRIMInformationTransfer},
    {"&criticality", aioc__value, &asn_DEF_Ngap_Criticality,
     &asn_VAL_65_Ngap_ignore},
    {"&InitiatingMessage", aioc__type,
    ...
    {"&procedureCode", aioc__value, &asn_DEF_Ngap_ProcedureCode,
     &asn_VAL_66_Ngap_id_UplinkUEAssociatedNRPPaTransport},
    {"&criticality", aioc__value, &asn_DEF_Ngap_Criticality,
     &asn_VAL_66_Ngap_ignore}};
...
static const asn_TYPE_tag2member_t asn_MAP_Ngap_value_tag2el_4[] = {
    {(ASN_TAG_CLASS_UNIVERSAL | (16 << 2)), 0, 0,
     65}, /* AMFConfigurationUpdate */
    {(ASN_TAG_CLASS_UNIVERSAL | (16 << 2)), 1, -1, 64}, /* HandoverCancel */
    {(ASN_TAG_CLASS_UNIVERSAL | (16 << 2)), 2, -2, 63}, /* HandoverRequired */
    {(ASN_TAG_CLASS_UNIVERSAL | (16 << 2)), 3, -3, 62}, /* HandoverRequest */
    {(ASN_TAG_CLASS_UNIVERSAL | (16 << 2)), 4, -4,
     61}, /* InitialContextSetupRequest */
    {(ASN_TAG_CLASS_UNIVERSAL | (16 << 2)), 5, -5, 60}, /* NGReset */
    {(ASN_TAG_CLASS_UNIVERSAL | (16 << 2)), 6, -6, 59}, /* NGSetupRequest */
    {(ASN_TAG_CLASS_UNIVERSAL | (16 << 2)), 7, -7, 58}, /* PathSwitchRequest */
    {(ASN_TAG_CLASS_UNIVERSAL | (16 << 2)), 8, -8,
     57}, /* PDUSessionResourceModifyRequest */
    {(ASN_TAG_CLASS_UNIVERSAL | (16 << 2)), 9, -9,
     56}, /* PDUSessionResourceModifyIndication */
    {(ASN_TAG_CLASS_UNIVERSAL | (16 << 2)), 10, -10,
     55}, /* PDUSessionResourceReleaseCommand */
    {(ASN_TAG_CLASS_UNIVERSAL | (16 << 2)), 11, -11,
     54}, /* PDUSessionResourceSetupRequest */
    {(ASN_TAG_CLASS_UNIVERSAL | (16 << 2)), 12, -12, 53}, /* PWSCancelRequest */
    {(ASN_TAG_CLASS_UNIVERSAL | (16 << 2)), 13, -13,
     52}, /* RANConfigurationUpdate */
    {(ASN_TAG_CLASS_UNIVERSAL | (16 << 2)), 14, -14,
     51}, /* UEContextModificationRequest */
    {(ASN_TAG_CLASS_UNIVERSAL | (16 << 2)), 15, -15,
     50}, /* UEContextReleaseCommand */
    {(ASN_TAG_CLASS_UNIVERSAL | (16 << 2)), 16, -16,
     49}, /* UEContextResumeRequest */
    {(ASN_TAG_CLASS_UNIVERSAL | (16 << 2)), 17, -17,
     48}, /* UEContextSuspendRequest */
    {(ASN_TAG_CLASS_UNIVERSAL | (16 << 2)), 18, -18,
     47}, /* UERadioCapabilityCheckRequest */
    {(ASN_TAG_CLASS_UNIVERSAL | (16 << 2)), 19, -19,
     46}, /* UERadioCapabilityIDMappingRequest */
    {(ASN_TAG_CLASS_UNIVERSAL | (16 << 2)), 20, -20,
     45}, /* WriteReplaceWarningRequest */
    {(ASN_TAG_CLASS_UNIVERSAL | (16 << 2)), 21, -21,
     44}, /* AMFCPRelocationIndication */
    {(ASN_TAG_CLASS_UNIVERSAL | (16 << 2)), 22, -22,
     43}, /* AMFStatusIndication */
    {(ASN_TAG_CLASS_UNIVERSAL | (16 << 2)), 23, -23, 42}, /* CellTrafficTrace */
    {(ASN_TAG_CLASS_UNIVERSAL | (16 << 2)), 24, -24,
     41}, /* ConnectionEstablishmentIndication */
    {(ASN_TAG_CLASS_UNIVERSAL | (16 << 2)), 25, -25, 40}, /* DeactivateTrace */
    {(ASN_TAG_CLASS_UNIVERSAL | (16 << 2)), 26, -26,
     39}, /* DownlinkNASTransport */
    {(ASN_TAG_CLASS_UNIVERSAL | (16 << 2)), 27, -27,
     38}, /* DownlinkNonUEAssociatedNRPPaTransport */
    {(ASN_TAG_CLASS_UNIVERSAL | (16 << 2)), 28, -28,
     37}, /* DownlinkRANConfigurationTransfer */
    {(ASN_TAG_CLASS_UNIVERSAL | (16 << 2)), 29, -29,
     36}, /* DownlinkRANEarlyStatusTransfer */
    {(ASN_TAG_CLASS_UNIVERSAL | (16 << 2)), 30, -30,
     35}, /* DownlinkRANStatusTransfer */
    {(ASN_TAG_CLASS_UNIVERSAL | (16 << 2)), 31, -31,
     34}, /* DownlinkRIMInformationTransfer */
    {(ASN_TAG_CLASS_UNIVERSAL | (16 << 2)), 32, -32,
     33}, /* DownlinkUEAssociatedNRPPaTransport */
    {(ASN_TAG_CLASS_UNIVERSAL | (16 << 2)), 33, -33, 32}, /* ErrorIndication */
    {(ASN_TAG_CLASS_UNIVERSAL | (16 << 2)), 34, -34, 31}, /* HandoverNotify */
    {(ASN_TAG_CLASS_UNIVERSAL | (16 << 2)), 35, -35, 30}, /* HandoverSuccess */
    {(ASN_TAG_CLASS_UNIVERSAL | (16 << 2)), 36, -36, 29}, /* InitialUEMessage */
    {(ASN_TAG_CLASS_UNIVERSAL | (16 << 2)), 37, -37, 28}, /* LocationReport */
    {(ASN_TAG_CLASS_UNIVERSAL | (16 << 2)), 38, -38,
     27}, /* LocationReportingControl */
    {(ASN_TAG_CLASS_UNIVERSAL | (16 << 2)), 39, -39,
     26}, /* LocationReportingFailureIndication */
    {(ASN_TAG_CLASS_UNIVERSAL | (16 << 2)), 40, -40,
     25}, /* NASNonDeliveryIndication */
    {(ASN_TAG_CLASS_UNIVERSAL | (16 << 2)), 41, -41, 24}, /* OverloadStart */
    {(ASN_TAG_CLASS_UNIVERSAL | (16 << 2)), 42, -42, 23}, /* OverloadStop */
    {(ASN_TAG_CLASS_UNIVERSAL | (16 << 2)), 43, -43, 22}, /* Paging */
    {(ASN_TAG_CLASS_UNIVERSAL | (16 << 2)), 44, -44,
     21}, /* PDUSessionResourceNotify */
    {(ASN_TAG_CLASS_UNIVERSAL | (16 << 2)), 45, -45, 20}, /* PrivateMessage */
    {(ASN_TAG_CLASS_UNIVERSAL | (16 << 2)), 46, -46,
    ...
    {(ASN_TAG_CLASS_UNIVERSAL | (16 << 2)), 51, -51,
     14}, /* RRCInactiveTransitionReport */
    {(ASN_TAG_CLASS_UNIVERSAL | (16 << 2)), 52, -52,
     13}, /* SecondaryRATDataUsageReport */
    {(ASN_TAG_CLASS_UNIVERSAL | (16 << 2)), 53, -53,
     12}, /* TraceFailureIndication */
    {(ASN_TAG_CLASS_UNIVERSAL | (16 << 2)), 54, -54, 11}, /* TraceStart */
    {(ASN_TAG_CLASS_UNIVERSAL | (16 << 2)), 55, -55,
    ...
    {(ASN_TAG_CLASS_UNIVERSAL | (16 << 2)), 64, -64,
