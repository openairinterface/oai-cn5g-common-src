...
asn_TYPE_member_t asn_MBR_Ngap_QosFlowFeedbackItem_1[] = {
    {ATF_NOFLAGS,
     0,
     offsetof(struct Ngap_QosFlowFeedbackItem, qosFlowIdentifier),
    ...
    {ATF_POINTER,
     4,
     offsetof(struct Ngap_QosFlowFeedbackItem, updateFeedback),
    ...
    {ATF_POINTER,
     3,
     offsetof(struct Ngap_QosFlowFeedbackItem, cNpacketDelayBudgetDL),
    ...
    {ATF_POINTER,
     2,
     offsetof(struct Ngap_QosFlowFeedbackItem, cNpacketDelayBudgetUL),
    ...
    {ATF_POINTER,
     1,
     offsetof(struct Ngap_QosFlowFeedbackItem, iE_Extensions),
     (ASN_TAG_CLASS_CONTEXT | (4 << 2)),
     -1, /* IMPLICIT tag at current level */
     &asn_DEF_Ngap_ProtocolExtensionContainer_12929P273,
     0,
     {
#if !defined(ASN_DISABLE_OER_SUPPORT)
         0,
...
static const asn_TYPE_tag2member_t asn_MAP_Ngap_QosFlowFeedbackItem_tag2el_1[] =
    {
        ...
        {(ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0,
         0}, /* cNpacketDelayBudgetDL */
        {(ASN_TAG_CLASS_CONTEXT | (3 << 2)), 3, 0,
         0}, /* cNpacketDelayBudgetUL */
