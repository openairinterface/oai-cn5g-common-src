...
bool NrfInfo_servedScpInfoList_value::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    ...
    {
        const std::map<std::string, oai::_3gpp::model::ScpDomainInfo>& value = m_ScpDomainInfoList;
    ...
    {
        const std::vector<oai::_3gpp::model::Ipv4AddressRange>& value = m_Ipv4AddrRanges;
    ...
    {
        const std::vector<oai::_3gpp::model::Ipv6PrefixRange>& value = m_Ipv6PrefixRanges;
    ...
    {
        const std::vector<oai::_3gpp::model::ScpCapability>& value = m_ScpCapabilities;
...
std::map<std::string, oai::_3gpp::model::ScpDomainInfo> NrfInfo_servedScpInfoList_value::getScpDomainInfoList() const
{
    return m_ScpDomainInfoList;
}
void NrfInfo_servedScpInfoList_value::setScpDomainInfoList(std::map<std::string, oai::_3gpp::model::ScpDomainInfo> const& value)
{
...
std::vector<oai::_3gpp::model::std::string> NrfInfo_servedScpInfoList_value::getIpv4Addresses() const
{
    return m_Ipv4Addresses;
}
void NrfInfo_servedScpInfoList_value::setIpv4Addresses(std::vector<oai::_3gpp::model::std::string> const& value)
{
...
std::vector<oai::_3gpp::model::Ipv6Prefix> NrfInfo_servedScpInfoList_value::getIpv6Prefixes() const
{
    return m_Ipv6Prefixes;
}
void NrfInfo_servedScpInfoList_value::setIpv6Prefixes(std::vector<oai::_3gpp::model::Ipv6Prefix> const& value)
{
...
std::vector<oai::_3gpp::model::Ipv4AddressRange> NrfInfo_servedScpInfoList_value::getIpv4AddrRanges() const
{
    return m_Ipv4AddrRanges;
}
void NrfInfo_servedScpInfoList_value::setIpv4AddrRanges(std::vector<oai::_3gpp::model::Ipv4AddressRange> const& value)
{
...
std::vector<oai::_3gpp::model::Ipv6PrefixRange> NrfInfo_servedScpInfoList_value::getIpv6PrefixRanges() const
{
    return m_Ipv6PrefixRanges;
}
void NrfInfo_servedScpInfoList_value::setIpv6PrefixRanges(std::vector<oai::_3gpp::model::Ipv6PrefixRange> const& value)
{
...
std::vector<oai::_3gpp::model::std::string> NrfInfo_servedScpInfoList_value::getServedNfSetIdList() const
{
    return m_ServedNfSetIdList;
}
void NrfInfo_servedScpInfoList_value::setServedNfSetIdList(std::vector<oai::_3gpp::model::std::string> const& value)
{
...
std::vector<oai::_3gpp::model::PlmnId> NrfInfo_servedScpInfoList_value::getRemotePlmnList() const
{
    return m_RemotePlmnList;
}
void NrfInfo_servedScpInfoList_value::setRemotePlmnList(std::vector<oai::_3gpp::model::PlmnId> const& value)
{
...
std::vector<oai::_3gpp::model::PlmnIdNid> NrfInfo_servedScpInfoList_value::getRemoteSnpnList() const
{
    return m_RemoteSnpnList;
}
void NrfInfo_servedScpInfoList_value::setRemoteSnpnList(std::vector<oai::_3gpp::model::PlmnIdNid> const& value)
{
...
oai::_3gpp::model::IpReachability NrfInfo_servedScpInfoList_value::getIpReachability() const
{
    return m_IpReachability;
}
void NrfInfo_servedScpInfoList_value::setIpReachability(oai::_3gpp::model::IpReachability const& value)
{
...
std::vector<oai::_3gpp::model::ScpCapability> NrfInfo_servedScpInfoList_value::getScpCapabilities() const
{
    return m_ScpCapabilities;
}
void NrfInfo_servedScpInfoList_value::setScpCapabilities(std::vector<oai::_3gpp::model::ScpCapability> const& value)
{
