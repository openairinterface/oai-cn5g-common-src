...
oai::model::EventReportMode ReportingOptions::getReportMode() const
{
    return m_ReportMode;
}
void ReportingOptions::setReportMode(oai::model::EventReportMode const& value)
{
    m_ReportMode = value;
...
oai::model::NotificationFlag ReportingOptions::getNotifFlag() const
{
    return m_NotifFlag;
}
void ReportingOptions::setNotifFlag(oai::model::NotificationFlag const& value)
{
    m_NotifFlag = value;
