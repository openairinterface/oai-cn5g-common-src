...
bool IptvConfigData::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    ...
    /* MultiAccCtrls */ {
        const std::map<std::string, oai::_3gpp::model::MulticastAccessControl>& value = m_MultiAccCtrls;
...
std::map<std::string, oai::_3gpp::model::MulticastAccessControl> IptvConfigData::getMultiAccCtrls() const
{
    return m_MultiAccCtrls;
}
void IptvConfigData::setMultiAccCtrls(std::map<std::string, oai::_3gpp::model::MulticastAccessControl> const& value)
{
