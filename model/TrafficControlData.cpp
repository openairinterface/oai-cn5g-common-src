...
bool TrafficControlData::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    ...
    {
        const std::vector<oai::_3gpp::model::RedirectInformation>& value = m_AddRedirectInfo;
...
void TrafficControlData::setFlowStatus(oai::_3gpp::model::FlowStatus const& value)
{
    m_FlowStatus = value;
...
oai::_3gpp::model::RedirectInformation TrafficControlData::getRedirectInfo() const
{
    return m_RedirectInfo;
}
void TrafficControlData::setRedirectInfo(oai::_3gpp::model::RedirectInformation const& value)
{
...
std::vector<oai::_3gpp::model::RedirectInformation> TrafficControlData::getAddRedirectInfo() const
{
    return m_AddRedirectInfo;
}
void TrafficControlData::setAddRedirectInfo(std::vector<oai::_3gpp::model::RedirectInformation> const& value)
{
...
std::vector<oai::_3gpp::model::RouteToLocation> TrafficControlData::getRouteToLocs() const
{
    return m_RouteToLocs;
}
void TrafficControlData::setRouteToLocs(std::vector<oai::_3gpp::model::RouteToLocation> const& value)
{
    m_RouteToLocs = value;
...
std::vector<oai::_3gpp::model::EasIpReplacementInfo> TrafficControlData::getEasIpReplaceInfos() const
{
    return m_EasIpReplaceInfos;
}
void TrafficControlData::setEasIpReplaceInfos(std::vector<oai::_3gpp::model::EasIpReplacementInfo> const& value)
{
...
oai::_3gpp::model::UpPathChgEvent TrafficControlData::getUpPathChgEvent() const
{
    return m_UpPathChgEvent;
}
void TrafficControlData::setUpPathChgEvent(oai::_3gpp::model::UpPathChgEvent const& value)
{
...
oai::_3gpp::model::SteeringFunctionality TrafficControlData::getSteerFun() const
{
    return m_SteerFun;
}
void TrafficControlData::setSteerFun(oai::_3gpp::model::SteeringFunctionality const& value)
{
    m_SteerFun = value;
...
void TrafficControlData::setSteerModeDl(oai::_3gpp::model::SteeringMode const& value)
{
    m_SteerModeDl = value;
...
void TrafficControlData::setSteerModeUl(oai::_3gpp::model::SteeringMode const& value)
{
    m_SteerModeUl = value;
...
oai::_3gpp::model::MulticastAccessControl TrafficControlData::getMulAccCtrl() const
{
    return m_MulAccCtrl;
}
void TrafficControlData::setMulAccCtrl(oai::_3gpp::model::MulticastAccessControl const& value)
{
    m_MulAccCtrl = value;
