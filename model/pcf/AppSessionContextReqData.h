...
public:
    ...
    /// </summary>
    std::map<std::string, oai::model::pcf::MediaComponent> getMedComponents() const;
    void setMedComponents(std::map<std::string, oai::model::pcf::MediaComponent> const& value);
