...
public:
    ...
    /// </summary>
    std::map<std::string, oai::_3gpp::model::MediaSubComponentRm> getMedSubComps() const;
    void setMedSubComps(std::map<std::string, oai::_3gpp::model::MediaSubComponentRm> const& value);
    ...
    void setPreemptVuln(oai::_3gpp::model::PreemptionVulnerabilityRm const& value);
