...
extern asn_TYPE_descriptor_t asn_DEF_Ngap_timeDistributionIndication
    __attribute__((weak, alias("asn_DEF_Ngap_timeDistributionIndication_2")));
#else
...
asn_DEF_Ngap_timeDistributionIndication_2_alias_init(void) {
  asn_DEF_Ngap_timeDistributionIndication =
 ...
 */
static int memb_Ngap_uUTimeSyncErrorBudget_constraint_1(
...
static asn_oer_constraints_t
    asn_OER_type_Ngap_timeDistributionIndication_constr_2 CC_NOTUSED = {
        {0, 0},
        -1};
#endif /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
static asn_per_constraints_t
    asn_PER_type_Ngap_timeDistributionIndication_constr_2 CC_NOTUSED = {
...
#if !defined(ASN_DISABLE_OER_SUPPORT)
static asn_oer_constraints_t asn_OER_memb_Ngap_uUTimeSyncErrorBudget_constr_6
    CC_NOTUSED = {{0, 0}, -1};
#endif /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
static asn_per_constraints_t asn_PER_memb_Ngap_uUTimeSyncErrorBudget_constr_6
    CC_NOTUSED = {
        {APC_CONSTRAINED | APC_EXTENSIBLE, 20, -1, 1,
         1000000} /* (1..1000000,...) */,
        {APC_UNCONSTRAINED, -1, -1, 0, 0},
        0,
        0 /* No PER value map */
...
static const asn_INTEGER_enum_map_t
    asn_MAP_Ngap_timeDistributionIndication_value2enum_2[] = {
        {0, 7, "enabled"},
        {1, 8, "disabled"}
        /* This list is extensible */
};
static int asn_validate_Ngap_timeDistributionIndication_2(
    const asn_TYPE_descriptor_t* td, const void* sptr,
    asn_app_constraint_failed_f* ctfailcb, void* app_key) {
  if (!sptr) {
    return -1;
  }
  e_Ngap_TimeSyncAssistanceInfo__timeDistributionIndication value =
      *(e_Ngap_TimeSyncAssistanceInfo__timeDistributionIndication*) sptr;
  switch (value) {
...
static const unsigned int
    asn_MAP_Ngap_timeDistributionIndication_enum2value_2[] = {
        1, /* disabled(1) */
        0  /* enabled(0) */
           /* This list is extensible */
};
static const asn_INTEGER_specifics_t
    asn_SPC_Ngap_timeDistributionIndication_specs_2 = {
        asn_MAP_Ngap_timeDistributionIndication_value2enum_2, /* "tag" => N;
                                                                 sorted by tag
                                                               */
        asn_MAP_Ngap_timeDistributionIndication_enum2value_2, /* N => "tag";
                                                                 sorted by N */
...
static /* Use -fall-defs-global to expose */
    asn_TYPE_descriptor_t asn_DEF_Ngap_timeDistributionIndication_2 = {
        ...
        sizeof(asn_DEF_Ngap_timeDistributionIndication_tags_2) /
                sizeof(asn_DEF_Ngap_timeDistributionIndication_tags_2[0]) -
            1,                                          /* 1 */
        ...
        {
#if !defined(ASN_DISABLE_OER_SUPPORT)
            &asn_OER_type_Ngap_timeDistributionIndication_constr_2,
#endif /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
...
asn_TYPE_member_t asn_MBR_Ngap_TimeSyncAssistanceInfo_1[] = {
    {ATF_NOFLAGS,
     0,
     offsetof(struct Ngap_TimeSyncAssistanceInfo, timeDistributionIndication),
    ...
    {ATF_POINTER,
     2,
     offsetof(struct Ngap_TimeSyncAssistanceInfo, uUTimeSyncErrorBudget),
     ...
     {
#if !defined(ASN_DISABLE_OER_SUPPORT)
         &asn_OER_memb_Ngap_uUTimeSyncErrorBudget_constr_6,
#endif /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
    ...
    {ATF_POINTER,
     1,
     offsetof(struct Ngap_TimeSyncAssistanceInfo, iE_Extensions),
     (ASN_TAG_CLASS_CONTEXT | (2 << 2)),
     -1, /* IMPLICIT tag at current level */
     &asn_DEF_Ngap_ProtocolExtensionContainer_12929P336,
     0,
     {
#if !defined(ASN_DISABLE_OER_SUPPORT)
         0,
...
static const asn_TYPE_tag2member_t
    asn_MAP_Ngap_TimeSyncAssistanceInfo_tag2el_1[] = {
        {(ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0,
         0}, /* timeDistributionIndication */
        {(ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0,
         0}, /* uUTimeSyncErrorBudget */
