...
ANY_t *ANY_new_fromType_aper(asn_TYPE_descriptor_t *td, void *sptr) {
  ...
  if (ANY_fromType_aper(&tmp, td, sptr))
    return 0;
...
asn_dec_rval_t ANY_decode_aper(const asn_codec_ctx_t *opt_codec_ctx,
...
asn_enc_rval_t ANY_encode_aper(const asn_TYPE_descriptor_t *td,
                               const asn_per_constraints_t *constraints,
