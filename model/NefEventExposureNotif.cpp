...
bool NefEventExposureNotif::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "NefEventExposureNotif" : pathPrefix;
...
std::vector<oai::_3gpp::model::NefEventNotification> NefEventExposureNotif::getEventNotifs() const
{
    return m_EventNotifs;
}
void NefEventExposureNotif::setEventNotifs(std::vector<oai::_3gpp::model::NefEventNotification> const& value)
{
    m_EventNotifs = value;
}
