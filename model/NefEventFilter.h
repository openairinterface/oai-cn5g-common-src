...
public:
    ...
    /// 
    /// </summary>
    oai::model::TargetUeIdentification getTgtUe() const;
    void setTgtUe(oai::model::TargetUeIdentification const& value);
    /// <summary>
    /// 
    /// </summary>
    ...
    /// 
    /// </summary>
    oai::model::NetworkAreaInfo getLocArea() const;
    void setLocArea(oai::model::NetworkAreaInfo const& value);
    bool locAreaIsSet() const;
    void unsetLocArea();
    /// <summary>
    /// 
    /// </summary>
    std::vector<oai::model::CollectiveBehaviourFilter> getCollAttrs() const;
    void setCollAttrs(std::vector<oai::model::CollectiveBehaviourFilter> const& value);
...
protected:
    oai::model::TargetUeIdentification m_TgtUe;

    std::vector<std::string> m_AppIds;
    bool m_AppIdsIsSet;
    oai::model::NetworkAreaInfo m_LocArea;
    bool m_LocAreaIsSet;
    std::vector<oai::model::CollectiveBehaviourFilter> m_CollAttrs;
