...
public:
    ...
    /// 
    /// </summary>
    oai::_3gpp::model::EthFlowDescription getEthFlowDescription() const;
    void setEthFlowDescription(oai::_3gpp::model::EthFlowDescription const& value);
    ...
    /// 
    /// </summary>
    oai::_3gpp::model::FlowDirectionRm getFlowDirection() const;
    void setFlowDirection(oai::_3gpp::model::FlowDirectionRm const& value);
...
protected:
    ...
    oai::_3gpp::model::EthFlowDescription m_EthFlowDescription;
    ...
    oai::_3gpp::model::FlowDirectionRm m_FlowDirection;
