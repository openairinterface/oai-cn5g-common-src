...
static asn_TYPE_member_t asn_MBR_Ngap_PDUSessionResourceModifyConfirmTransfer_1[] = {
	{ ATF_POINTER, 0, offsetof(struct Ngap_PDUSessionResourceModifyConfirmTransfer, qosFlowModifyConfirmList),
	...
	{ ATF_POINTER, 0, offsetof(struct Ngap_PDUSessionResourceModifyConfirmTransfer, uLNGU_UP_TNLInformation),
	...
	{ ATF_POINTER, 1, offsetof(struct Ngap_PDUSessionResourceModifyConfirmTransfer, iE_Extensions),
		...
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_Ngap_ProtocolExtensionContainer_12929P230,
		0,
		{
#if !defined(ASN_DISABLE_OER_SUPPORT)
			0,
