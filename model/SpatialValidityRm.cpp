...
std::map<std::string, oai::model::PresenceInfo> SpatialValidityRm::getPresenceInfoList() const
{
    return m_PresenceInfoList;
}
void SpatialValidityRm::setPresenceInfoList(std::map<std::string, oai::model::PresenceInfo> const& value)
{
