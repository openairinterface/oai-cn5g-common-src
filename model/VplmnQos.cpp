...
bool VplmnQos::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
...
bool VplmnQos::operator==(const VplmnQos& rhs) const
{
    ...
    ((!maxFbrDlIsSet() && !rhs.maxFbrDlIsSet()) || (maxFbrDlIsSet() && rhs.maxFbrDlIsSet() && getMaxFbrDl() == rhs.getMaxFbrDl())) &&
    
    
    ((!maxFbrUlIsSet() && !rhs.maxFbrUlIsSet()) || (maxFbrUlIsSet() && rhs.maxFbrUlIsSet() && getMaxFbrUl() == rhs.getMaxFbrUl())) &&
    
    
    ((!guaFbrDlIsSet() && !rhs.guaFbrDlIsSet()) || (guaFbrDlIsSet() && rhs.guaFbrDlIsSet() && getGuaFbrDl() == rhs.getGuaFbrDl())) &&
    
    
    ((!guaFbrUlIsSet() && !rhs.guaFbrUlIsSet()) || (guaFbrUlIsSet() && rhs.guaFbrUlIsSet() && getGuaFbrUl() == rhs.getGuaFbrUl()))
...
oai::_3gpp::model::Arp VplmnQos::getArp() const
{
    return m_Arp;
}
void VplmnQos::setArp(oai::_3gpp::model::Arp const& value)
{
    m_Arp = value;
    m_ArpIsSet = true;
}
...
oai::_3gpp::model::Ambr VplmnQos::getSessionAmbr() const
{
    return m_SessionAmbr;
}
void VplmnQos::setSessionAmbr(oai::_3gpp::model::Ambr const& value)
{
    m_SessionAmbr = value;
