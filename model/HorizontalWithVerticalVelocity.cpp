...
oai::model::VerticalDirection HorizontalWithVerticalVelocity::getVDirection() const
{
    return m_VDirection;
}
void HorizontalWithVerticalVelocity::setVDirection(oai::model::VerticalDirection const& value)
{
    m_VDirection = value;
}
