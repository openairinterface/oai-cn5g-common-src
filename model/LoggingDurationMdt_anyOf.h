...
protected:
    LoggingDurationMdt_anyOf::eLoggingDurationMdt_anyOf m_value = LoggingDurationMdt_anyOf::eLoggingDurationMdt_anyOf::INVALID_VALUE_OPENAPI_GENERATED;
};

} // namespace oai::_3gpp::model

#endif /* LoggingDurationMdt_anyOf_H_ */
