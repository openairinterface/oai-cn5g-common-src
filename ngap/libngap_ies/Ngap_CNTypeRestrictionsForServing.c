...
asn_oer_constraints_t asn_OER_type_Ngap_CNTypeRestrictionsForServing_constr_1 CC_NOTUSED = {
	{ 0, 0 },
	-1};
...
static int asn_validate_Ngap_CNTypeRestrictionsForServing_1(const asn_TYPE_descriptor_t *td,
                       const void *sptr,
                       asn_app_constraint_failed_f *ctfailcb,
                       void* app_key) {
    if(! sptr) { return -1; }
    e_Ngap_CNTypeRestrictionsForServing value = *(e_Ngap_CNTypeRestrictionsForServing*)sptr;
    switch(value) {
