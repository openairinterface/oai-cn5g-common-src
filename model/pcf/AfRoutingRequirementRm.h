...
public:
    ...
    void setRouteToLocs(std::vector<oai::model::common::RouteToLocation> const& value);
    ...
    /// </summary>
    std::vector<oai::model::pcf::EasIpReplacementInfo> getEasIpReplaceInfos() const;
    void setEasIpReplaceInfos(std::vector<oai::model::pcf::EasIpReplacementInfo> const& value);
