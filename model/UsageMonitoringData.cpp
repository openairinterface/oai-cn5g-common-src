...
bool UsageMonitoringData::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "UsageMonitoringData" : pathPrefix;
    ...
    if (volumeThresholdDownlinkIsSet())
    {
        ...
        const std::string currentValuePath = _pathPrefix + ".volumeThresholdDownlink";
    ...
    if (nextVolThresholdUplinkIsSet())
    {
        ...
        const std::string currentValuePath = _pathPrefix + ".nextVolThresholdUplink";
    ...
    if (nextVolThresholdDownlinkIsSet())
    {
        ...
        const std::string currentValuePath = _pathPrefix + ".nextVolThresholdDownlink";
...
bool UsageMonitoringData::operator==(const UsageMonitoringData& rhs) const
{
    ...
    ((!volumeThresholdIsSet() && !rhs.volumeThresholdIsSet()) || (volumeThresholdIsSet() && rhs.volumeThresholdIsSet() && getVolumeThreshold() == rhs.getVolumeThreshold())) &&
    
    
    ((!volumeThresholdUplinkIsSet() && !rhs.volumeThresholdUplinkIsSet()) || (volumeThresholdUplinkIsSet() && rhs.volumeThresholdUplinkIsSet() && getVolumeThresholdUplink() == rhs.getVolumeThresholdUplink())) &&
    
    
    ((!volumeThresholdDownlinkIsSet() && !rhs.volumeThresholdDownlinkIsSet()) || (volumeThresholdDownlinkIsSet() && rhs.volumeThresholdDownlinkIsSet() && getVolumeThresholdDownlink() == rhs.getVolumeThresholdDownlink())) &&
    
    
    ((!timeThresholdIsSet() && !rhs.timeThresholdIsSet()) || (timeThresholdIsSet() && rhs.timeThresholdIsSet() && getTimeThreshold() == rhs.getTimeThreshold())) &&
    
    
    ((!monitoringTimeIsSet() && !rhs.monitoringTimeIsSet()) || (monitoringTimeIsSet() && rhs.monitoringTimeIsSet() && getMonitoringTime() == rhs.getMonitoringTime())) &&
    
    
    ((!nextVolThresholdIsSet() && !rhs.nextVolThresholdIsSet()) || (nextVolThresholdIsSet() && rhs.nextVolThresholdIsSet() && getNextVolThreshold() == rhs.getNextVolThreshold())) &&
    
    
    ((!nextVolThresholdUplinkIsSet() && !rhs.nextVolThresholdUplinkIsSet()) || (nextVolThresholdUplinkIsSet() && rhs.nextVolThresholdUplinkIsSet() && getNextVolThresholdUplink() == rhs.getNextVolThresholdUplink())) &&
    
    
    ((!nextVolThresholdDownlinkIsSet() && !rhs.nextVolThresholdDownlinkIsSet()) || (nextVolThresholdDownlinkIsSet() && rhs.nextVolThresholdDownlinkIsSet() && getNextVolThresholdDownlink() == rhs.getNextVolThresholdDownlink())) &&
    
    
    ((!nextTimeThresholdIsSet() && !rhs.nextTimeThresholdIsSet()) || (nextTimeThresholdIsSet() && rhs.nextTimeThresholdIsSet() && getNextTimeThreshold() == rhs.getNextTimeThreshold())) &&
    
    
    ((!inactivityTimeIsSet() && !rhs.inactivityTimeIsSet()) || (inactivityTimeIsSet() && rhs.inactivityTimeIsSet() && getInactivityTime() == rhs.getInactivityTime())) &&
    
    
    ((!exUsagePccRuleIdsIsSet() && !rhs.exUsagePccRuleIdsIsSet()) || (exUsagePccRuleIdsIsSet() && rhs.exUsagePccRuleIdsIsSet() && getExUsagePccRuleIds() == rhs.getExUsagePccRuleIds()))
...
void UsageMonitoringData::setExUsagePccRuleIds(std::vector<std::string> const& value)
{
