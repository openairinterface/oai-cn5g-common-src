...
TrafficProfile_anyOf::eTrafficProfile_anyOf TrafficProfile::getEnumValue() const
{
    return m_value.getValue();
}

void TrafficProfile::setEnumValue(TrafficProfile_anyOf::eTrafficProfile_anyOf  value)
{
