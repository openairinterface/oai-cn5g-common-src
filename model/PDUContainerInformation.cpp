...
bool PDUContainerInformation::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    ...
    {
        const std::vector<oai::_3gpp::model::ServingNetworkFunctionID>& value = m_ServingNodeID;
    ...
    {
        const std::map<std::string, oai::_3gpp::model::PresenceInfo>& value = m_PresenceReportingAreaInformation;
...
void PDUContainerInformation::setQoSInformation(oai::_3gpp::model::QosData const& value)
{
...
oai::_3gpp::model::QosCharacteristics PDUContainerInformation::getQoSCharacteristics() const
{
    return m_QoSCharacteristics;
}
void PDUContainerInformation::setQoSCharacteristics(oai::_3gpp::model::QosCharacteristics const& value)
{
...
oai::_3gpp::model::UserLocation PDUContainerInformation::getUserLocationInformation() const
{
    return m_UserLocationInformation;
}
void PDUContainerInformation::setUserLocationInformation(oai::_3gpp::model::UserLocation const& value)
{
...
void PDUContainerInformation::setRATType(oai::_3gpp::model::RatType const& value)
{
    m_RATType = value;
    m_RATTypeIsSet = true;
}
...
std::vector<oai::_3gpp::model::ServingNetworkFunctionID> PDUContainerInformation::getServingNodeID() const
{
    return m_ServingNodeID;
}
void PDUContainerInformation::setServingNodeID(std::vector<oai::_3gpp::model::ServingNetworkFunctionID> const& value)
{
...
std::map<std::string, oai::_3gpp::model::PresenceInfo> PDUContainerInformation::getPresenceReportingAreaInformation() const
{
    return m_PresenceReportingAreaInformation;
}
void PDUContainerInformation::setPresenceReportingAreaInformation(std::map<std::string, oai::_3gpp::model::PresenceInfo> const& value)
{
...
oai::_3gpp::model::r_3GPPPSDataOffStatus PDUContainerInformation::getR3gppPSDataOffStatus() const
{
    return m_r_3gppPSDataOffStatus;
}
void PDUContainerInformation::setR3gppPSDataOffStatus(oai::_3gpp::model::r_3GPPPSDataOffStatus const& value)
{
...
oai::_3gpp::model::SteeringFunctionality PDUContainerInformation::getMAPDUSteeringFunctionality() const
{
    return m_MAPDUSteeringFunctionality;
}
void PDUContainerInformation::setMAPDUSteeringFunctionality(oai::_3gpp::model::SteeringFunctionality const& value)
{
...
oai::_3gpp::model::SteeringMode PDUContainerInformation::getMAPDUSteeringMode() const
{
    return m_MAPDUSteeringMode;
}
void PDUContainerInformation::setMAPDUSteeringMode(oai::_3gpp::model::SteeringMode const& value)
{
