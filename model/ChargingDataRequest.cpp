...
bool ChargingDataRequest::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "ChargingDataRequest" : pathPrefix;
    ...
    {
        const std::vector<oai::_3gpp::model::MultipleUnitUsage>& value = m_MultipleUnitUsage;
        ...
        success = value.validate(msg, currentValuePath + ".multipleUnitUsage") && success;
...
bool ChargingDataRequest::operator==(const ChargingDataRequest& rhs) const
{
    ...
    ((!subscriberIdentifierIsSet() && !rhs.subscriberIdentifierIsSet()) || (subscriberIdentifierIsSet() && rhs.subscriberIdentifierIsSet() && getSubscriberIdentifier() == rhs.getSubscriberIdentifier())) &&
    ...
    ((!retransmissionIndicatorIsSet() && !rhs.retransmissionIndicatorIsSet()) || (retransmissionIndicatorIsSet() && rhs.retransmissionIndicatorIsSet() && isRetransmissionIndicator() == rhs.isRetransmissionIndicator())) &&
    
    
    ((!serviceSpecificationInfoIsSet() && !rhs.serviceSpecificationInfoIsSet()) || (serviceSpecificationInfoIsSet() && rhs.serviceSpecificationInfoIsSet() && getServiceSpecificationInfo() == rhs.getServiceSpecificationInfo())) &&
    
    
    ((!multipleUnitUsageIsSet() && !rhs.multipleUnitUsageIsSet()) || (multipleUnitUsageIsSet() && rhs.multipleUnitUsageIsSet() && getMultipleUnitUsage() == rhs.getMultipleUnitUsage())) &&
...
oai::_3gpp::model::NFIdentification ChargingDataRequest::getNfConsumerIdentification() const
{
    return m_NfConsumerIdentification;
}
void ChargingDataRequest::setNfConsumerIdentification(oai::_3gpp::model::NFIdentification const& value)
{
...
void ChargingDataRequest::setServiceSpecificationInfo(std::string const& value)
{
...
std::vector<oai::_3gpp::model::MultipleUnitUsage> ChargingDataRequest::getMultipleUnitUsage() const
{
    return m_MultipleUnitUsage;
}
void ChargingDataRequest::setMultipleUnitUsage(std::vector<oai::_3gpp::model::MultipleUnitUsage> const& value)
{
...
std::vector<oai::_3gpp::model::Trigger> ChargingDataRequest::getTriggers() const
{
    return m_Triggers;
}
void ChargingDataRequest::setTriggers(std::vector<oai::_3gpp::model::Trigger> const& value)
{
    m_Triggers = value;
...
oai::_3gpp::model::PDUSessionChargingInformation ChargingDataRequest::getPDUSessionChargingInformation() const
{
    return m_PDUSessionChargingInformation;
}
void ChargingDataRequest::setPDUSessionChargingInformation(oai::_3gpp::model::PDUSessionChargingInformation const& value)
{
...
oai::_3gpp::model::RoamingQBCInformation ChargingDataRequest::getRoamingQBCInformation() const
{
    return m_RoamingQBCInformation;
}
void ChargingDataRequest::setRoamingQBCInformation(oai::_3gpp::model::RoamingQBCInformation const& value)
{
