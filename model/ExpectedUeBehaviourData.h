...
public:
    ...
    /// 
    /// </summary>
    oai::_3gpp::model::ScheduledCommunicationTime getScheduledCommunicationTime() const;
    void setScheduledCommunicationTime(oai::_3gpp::model::ScheduledCommunicationTime const& value);
    ...
    void setExpectedUmts(std::vector<oai::_3gpp::model::LocationArea> const& value);
