...
public:
    ...
    friend  void to_json(nlohmann::json& j, const HorizontalVelocityWithUncertainty& o);
    friend  void from_json(const nlohmann::json& j, HorizontalVelocityWithUncertainty& o);
protected:
    float m_HSpeed;
