...
public:
    ...
    /// 
    /// </summary>
    std::vector<oai::model::Snssai> getSNssaiForMapping() const;
    void setSNssaiForMapping(std::vector<oai::model::Snssai> const& value);
...
protected:
    ...
    std::vector<oai::model::Snssai> m_SNssaiForMapping;
