...
oai::_3gpp::model::DnnSmfInfoItem_dnn DnnEasdfInfoItem::getDnn() const
{
    return m_Dnn;
}
void DnnEasdfInfoItem::setDnn(oai::_3gpp::model::DnnSmfInfoItem_dnn const& value)
{
    m_Dnn = value;
}
std::vector<oai::_3gpp::model::std::string> DnnEasdfInfoItem::getDnaiList() const
{
    return m_DnaiList;
}
void DnnEasdfInfoItem::setDnaiList(std::vector<oai::_3gpp::model::std::string> const& value)
{
    m_DnaiList = value;
