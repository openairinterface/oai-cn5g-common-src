...
public:
    ...
    /// 
    /// </summary>
    oai::model::Snssai getMappedSnssai() const;
    void setMappedSnssai(oai::model::Snssai const& value);
    /// <summary>
    /// 
    /// </summary>
    oai::model::Snssai getHSnssai() const;
    void setHSnssai(oai::model::Snssai const& value);

    friend  void to_json(nlohmann::json& j, const NssaiMapping& o);
    friend  void from_json(const nlohmann::json& j, NssaiMapping& o);
protected:
    oai::model::Snssai m_MappedSnssai;

    oai::model::Snssai m_HSnssai;
