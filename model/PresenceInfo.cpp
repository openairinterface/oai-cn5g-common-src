...
bool PresenceInfo::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "PresenceInfo" : pathPrefix;
...
oai::model::PresenceState PresenceInfo::getPresenceState() const
{
    return m_PresenceState;
}
void PresenceInfo::setPresenceState(oai::model::PresenceState const& value)
{
...
std::vector<oai::model::Tai> PresenceInfo::getTrackingAreaList() const
{
    return m_TrackingAreaList;
}
void PresenceInfo::setTrackingAreaList(std::vector<oai::model::Tai> const& value)
{
...
std::vector<oai::model::Ecgi> PresenceInfo::getEcgiList() const
{
    return m_EcgiList;
}
void PresenceInfo::setEcgiList(std::vector<oai::model::Ecgi> const& value)
{
    m_EcgiList = value;
...
std::vector<oai::model::Ncgi> PresenceInfo::getNcgiList() const
{
    return m_NcgiList;
}
void PresenceInfo::setNcgiList(std::vector<oai::model::Ncgi> const& value)
{
    m_NcgiList = value;
...
std::vector<oai::model::GlobalRanNodeId> PresenceInfo::getGlobalRanNodeIdList() const
{
    return m_GlobalRanNodeIdList;
}
void PresenceInfo::setGlobalRanNodeIdList(std::vector<oai::model::GlobalRanNodeId> const& value)
{
...
std::vector<oai::model::GlobalRanNodeId> PresenceInfo::getGlobaleNbIdList() const
{
    return m_GlobaleNbIdList;
}
void PresenceInfo::setGlobaleNbIdList(std::vector<oai::model::GlobalRanNodeId> const& value)
{
