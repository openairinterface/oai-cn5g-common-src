...
public:
    ...
    /// </summary>
    std::vector<oai::_3gpp::model::GeographicalArea> getSpatialValidityAreas() const;
    void setSpatialValidityAreas(std::vector<oai::_3gpp::model::GeographicalArea> const& value);
    ...
    void setSpatialValidityTais(std::vector<oai::_3gpp::model::Tai_1> const& value);
