...
bool LcsServiceAuth::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "LcsServiceAuth" : pathPrefix;
...
LcsServiceAuth_anyOf::eLcsServiceAuth_anyOf LcsServiceAuth::getEnumValue() const
{
    return m_value.getValue();
}

void LcsServiceAuth::setEnumValue(LcsServiceAuth_anyOf::eLcsServiceAuth_anyOf  value)
{
