...
oai::_3gpp::model::NgapIeType N2InfoContent::getNgapIeType() const
{
    return m_NgapIeType;
}
void N2InfoContent::setNgapIeType(oai::_3gpp::model::NgapIeType const& value)
{
    m_NgapIeType = value;
...
oai::_3gpp::model::RefToBinaryData N2InfoContent::getNgapData() const
{
    return m_NgapData;
}
void N2InfoContent::setNgapData(oai::_3gpp::model::RefToBinaryData const& value)
{
    m_NgapData = value;
}
