...
bool JobType::validate(std::stringstream &msg,
...
bool JobType::operator!=(const JobType &rhs) const { return !(*this == rhs); }
...
void from_json(const nlohmann::json &j, JobType &o) { from_json(j, o.m_value); }

JobType_anyOf JobType::getValue() const { return m_value; }

void JobType::setValue(JobType_anyOf value) { m_value = value; }
