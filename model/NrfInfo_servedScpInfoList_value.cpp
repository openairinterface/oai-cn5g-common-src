...
bool NrfInfo_servedScpInfoList_value::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "NrfInfo_servedScpInfoList_value" : pathPrefix;

         
    if (scpDomainInfoListIsSet())
    {
        const std::map<std::string, oai::model::ScpDomainInfo>& value = m_ScpDomainInfoList;
    ...
    {
        const std::vector<oai::model::Ipv6Prefix>& value = m_Ipv6Prefixes;
    ...
    {
        const std::vector<oai::model::Ipv4AddressRange>& value = m_Ipv4AddrRanges;
    ...
    {
        const std::vector<oai::model::Ipv6PrefixRange>& value = m_Ipv6PrefixRanges;
    ...
    {
        const std::vector<oai::model::PlmnId>& value = m_RemotePlmnList;
    ...
    {
        const std::vector<oai::model::PlmnIdNid>& value = m_RemoteSnpnList;
        ...
        success = value.validate(msg, currentValuePath + ".remoteSnpnList") && success;
    ...
    {
        const std::vector<oai::model::ScpCapability>& value = m_ScpCapabilities;
        ...
        { // Recursive validation of array elements
            const std::string oldValuePath = currentValuePath;
            int i = 0;
            for (const oai::model::ScpCapability& value : value)
            { 
                const std::string currentValuePath = oldValuePath + "[" + std::to_string(i) + "]";
...
bool NrfInfo_servedScpInfoList_value::operator==(const NrfInfo_servedScpInfoList_value& rhs) const
{
    return
    ...
    ((!remoteSnpnListIsSet() && !rhs.remoteSnpnListIsSet()) || (remoteSnpnListIsSet() && rhs.remoteSnpnListIsSet() && getRemoteSnpnList() == rhs.getRemoteSnpnList())) &&
...
std::map<std::string, oai::model::ScpDomainInfo> NrfInfo_servedScpInfoList_value::getScpDomainInfoList() const
{
    return m_ScpDomainInfoList;
}
void NrfInfo_servedScpInfoList_value::setScpDomainInfoList(std::map<std::string, oai::model::ScpDomainInfo> const& value)
{
...
std::map<std::string, int32_t> NrfInfo_servedScpInfoList_value::getScpPorts() const
{
    return m_ScpPorts;
}
void NrfInfo_servedScpInfoList_value::setScpPorts(std::map<std::string, int32_t> const value)
{
    m_ScpPorts = value;
...
std::vector<std::string> NrfInfo_servedScpInfoList_value::getAddressDomains() const
{
    return m_AddressDomains;
}
void NrfInfo_servedScpInfoList_value::setAddressDomains(std::vector<std::string> const& value)
{
...
std::vector<std::string> NrfInfo_servedScpInfoList_value::getIpv4Addresses() const
{
    return m_Ipv4Addresses;
}
void NrfInfo_servedScpInfoList_value::setIpv4Addresses(std::vector<std::string> const& value)
{
...
std::vector<oai::model::Ipv6Prefix> NrfInfo_servedScpInfoList_value::getIpv6Prefixes() const
{
    return m_Ipv6Prefixes;
}
void NrfInfo_servedScpInfoList_value::setIpv6Prefixes(std::vector<oai::model::Ipv6Prefix> const& value)
{
...
std::vector<oai::model::Ipv4AddressRange> NrfInfo_servedScpInfoList_value::getIpv4AddrRanges() const
{
    return m_Ipv4AddrRanges;
}
void NrfInfo_servedScpInfoList_value::setIpv4AddrRanges(std::vector<oai::model::Ipv4AddressRange> const& value)
{
...
std::vector<oai::model::Ipv6PrefixRange> NrfInfo_servedScpInfoList_value::getIpv6PrefixRanges() const
{
    return m_Ipv6PrefixRanges;
}
void NrfInfo_servedScpInfoList_value::setIpv6PrefixRanges(std::vector<oai::model::Ipv6PrefixRange> const& value)
{
...
std::vector<std::string> NrfInfo_servedScpInfoList_value::getServedNfSetIdList() const
{
    return m_ServedNfSetIdList;
}
void NrfInfo_servedScpInfoList_value::setServedNfSetIdList(std::vector<std::string> const& value)
{
...
std::vector<oai::model::PlmnId> NrfInfo_servedScpInfoList_value::getRemotePlmnList() const
{
    return m_RemotePlmnList;
}
void NrfInfo_servedScpInfoList_value::setRemotePlmnList(std::vector<oai::model::PlmnId> const& value)
{
...
std::vector<oai::model::PlmnIdNid> NrfInfo_servedScpInfoList_value::getRemoteSnpnList() const
{
    return m_RemoteSnpnList;
}
void NrfInfo_servedScpInfoList_value::setRemoteSnpnList(std::vector<oai::model::PlmnIdNid> const& value)
{
...
oai::model::IpReachability NrfInfo_servedScpInfoList_value::getIpReachability() const
{
    return m_IpReachability;
}
void NrfInfo_servedScpInfoList_value::setIpReachability(oai::model::IpReachability const& value)
{
...
std::vector<oai::model::ScpCapability> NrfInfo_servedScpInfoList_value::getScpCapabilities() const
{
    return m_ScpCapabilities;
}
void NrfInfo_servedScpInfoList_value::setScpCapabilities(std::vector<oai::model::ScpCapability> const& value)
{
