...
bool PccRule::validate(std::stringstream &msg,
...
bool PccRule::operator!=(const PccRule &rhs) const { return !(*this == rhs); }
...
bool PccRule::flowInfosIsSet() const { return m_FlowInfosIsSet; }
void PccRule::unsetFlowInfos() { m_FlowInfosIsSet = false; }
std::string PccRule::getAppId() const { return m_AppId; }
void PccRule::setAppId(std::string const &value) {
  m_AppId = value;
  m_AppIdIsSet = true;
}
bool PccRule::appIdIsSet() const { return m_AppIdIsSet; }
void PccRule::unsetAppId() { m_AppIdIsSet = false; }
std::string PccRule::getAppDescriptor() const { return m_AppDescriptor; }
void PccRule::setAppDescriptor(std::string const &value) {
  m_AppDescriptor = value;
  m_AppDescriptorIsSet = true;
}
bool PccRule::appDescriptorIsSet() const { return m_AppDescriptorIsSet; }
void PccRule::unsetAppDescriptor() { m_AppDescriptorIsSet = false; }
int32_t PccRule::getContVer() const { return m_ContVer; }
void PccRule::setContVer(int32_t const value) {
  m_ContVer = value;
  m_ContVerIsSet = true;
}
bool PccRule::contVerIsSet() const { return m_ContVerIsSet; }
void PccRule::unsetContVer() { m_ContVerIsSet = false; }
std::string PccRule::getPccRuleId() const { return m_PccRuleId; }
void PccRule::setPccRuleId(std::string const &value) { m_PccRuleId = value; }
int32_t PccRule::getPrecedence() const { return m_Precedence; }
void PccRule::setPrecedence(int32_t const value) {
  m_Precedence = value;
  m_PrecedenceIsSet = true;
}
bool PccRule::precedenceIsSet() const { return m_PrecedenceIsSet; }
void PccRule::unsetPrecedence() { m_PrecedenceIsSet = false; }
...
bool PccRule::afSigProtocolIsSet() const { return m_AfSigProtocolIsSet; }
void PccRule::unsetAfSigProtocol() { m_AfSigProtocolIsSet = false; }
bool PccRule::isAppReloc() const { return m_AppReloc; }
void PccRule::setAppReloc(bool const value) {
  m_AppReloc = value;
  m_AppRelocIsSet = true;
}
bool PccRule::appRelocIsSet() const { return m_AppRelocIsSet; }
void PccRule::unsetAppReloc() { m_AppRelocIsSet = false; }
std::vector<std::string> PccRule::getRefQosData() const { return m_RefQosData; }
void PccRule::setRefQosData(std::vector<std::string> const &value) {
  m_RefQosData = value;
  m_RefQosDataIsSet = true;
}
bool PccRule::refQosDataIsSet() const { return m_RefQosDataIsSet; }
void PccRule::unsetRefQosData() { m_RefQosDataIsSet = false; }
...
bool PccRule::refAltQosParamsIsSet() const { return m_RefAltQosParamsIsSet; }
void PccRule::unsetRefAltQosParams() { m_RefAltQosParamsIsSet = false; }
std::vector<std::string> PccRule::getRefTcData() const { return m_RefTcData; }
void PccRule::setRefTcData(std::vector<std::string> const &value) {
  m_RefTcData = value;
  m_RefTcDataIsSet = true;
}
bool PccRule::refTcDataIsSet() const { return m_RefTcDataIsSet; }
void PccRule::unsetRefTcData() { m_RefTcDataIsSet = false; }
std::vector<std::string> PccRule::getRefChgData() const { return m_RefChgData; }
void PccRule::setRefChgData(std::vector<std::string> const &value) {
  m_RefChgData = value;
  m_RefChgDataIsSet = true;
}
bool PccRule::refChgDataIsSet() const { return m_RefChgDataIsSet; }
void PccRule::unsetRefChgData() { m_RefChgDataIsSet = false; }
...
bool PccRule::refChgN3gDataIsSet() const { return m_RefChgN3gDataIsSet; }
void PccRule::unsetRefChgN3gData() { m_RefChgN3gDataIsSet = false; }
std::vector<std::string> PccRule::getRefUmData() const { return m_RefUmData; }
void PccRule::setRefUmData(std::vector<std::string> const &value) {
  m_RefUmData = value;
  m_RefUmDataIsSet = true;
}
bool PccRule::refUmDataIsSet() const { return m_RefUmDataIsSet; }
void PccRule::unsetRefUmData() { m_RefUmDataIsSet = false; }
...
bool PccRule::refUmN3gDataIsSet() const { return m_RefUmN3gDataIsSet; }
void PccRule::unsetRefUmN3gData() { m_RefUmN3gDataIsSet = false; }
std::string PccRule::getRefCondData() const { return m_RefCondData; }
void PccRule::setRefCondData(std::string const &value) {
  m_RefCondData = value;
  m_RefCondDataIsSet = true;
}
bool PccRule::refCondDataIsSet() const { return m_RefCondDataIsSet; }
void PccRule::unsetRefCondData() { m_RefCondDataIsSet = false; }
std::vector<std::string> PccRule::getRefQosMon() const { return m_RefQosMon; }
void PccRule::setRefQosMon(std::vector<std::string> const &value) {
  m_RefQosMon = value;
  m_RefQosMonIsSet = true;
}
bool PccRule::refQosMonIsSet() const { return m_RefQosMonIsSet; }
void PccRule::unsetRefQosMon() { m_RefQosMonIsSet = false; }
bool PccRule::isAddrPreserInd() const { return m_AddrPreserInd; }
void PccRule::setAddrPreserInd(bool const value) {
  m_AddrPreserInd = value;
  m_AddrPreserIndIsSet = true;
}
bool PccRule::addrPreserIndIsSet() const { return m_AddrPreserIndIsSet; }
void PccRule::unsetAddrPreserInd() { m_AddrPreserIndIsSet = false; }
...
bool PccRule::tscaiInputDlIsSet() const { return m_TscaiInputDlIsSet; }
void PccRule::unsetTscaiInputDl() { m_TscaiInputDlIsSet = false; }
...
bool PccRule::tscaiInputUlIsSet() const { return m_TscaiInputUlIsSet; }
void PccRule::unsetTscaiInputUl() { m_TscaiInputUlIsSet = false; }
oai::model::pcf::DownlinkDataNotificationControl
PccRule::getDdNotifCtrl() const {
...
bool PccRule::ddNotifCtrlIsSet() const { return m_DdNotifCtrlIsSet; }
void PccRule::unsetDdNotifCtrl() { m_DdNotifCtrlIsSet = false; }
oai::model::pcf::DownlinkDataNotificationControlRm
PccRule::getDdNotifCtrl2() const {
...
bool PccRule::ddNotifCtrl2IsSet() const { return m_DdNotifCtrl2IsSet; }
void PccRule::unsetDdNotifCtrl2() { m_DdNotifCtrl2IsSet = false; }
bool PccRule::isDisUeNotif() const { return m_DisUeNotif; }
void PccRule::setDisUeNotif(bool const value) {
  m_DisUeNotif = value;
  m_DisUeNotifIsSet = true;
}
bool PccRule::disUeNotifIsSet() const { return m_DisUeNotifIsSet; }
void PccRule::unsetDisUeNotif() { m_DisUeNotifIsSet = false; }
