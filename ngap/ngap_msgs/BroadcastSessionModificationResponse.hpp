...
#ifndef _BROADCAST_SESSION_MODIFICATION_RESPONSE_H_
#define _BROADCAST_SESSION_MODIFICATION_RESPONSE_H_
...
class BroadcastSessionModificationResponseMsg : public NgapMessage {
 public:
  BroadcastSessionModificationResponseMsg();
  ~BroadcastSessionModificationResponseMsg() = default;
