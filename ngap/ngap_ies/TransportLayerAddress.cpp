...
//------------------------------------------------------------------------------
uint8_t TransportLayerAddress::getAddressType() const { return m_AddressType; }
//------------------------------------------------------------------------------
...
//------------------------------------------------------------------------------
void TransportLayerAddress::setIpv4v6Address(struct in_addr ipv4_address,
...
bool TransportLayerAddress::encode(
  ...
  if (m_AddressType ==
    ...
    oai::utils::ipv4v6_to_transport_layer_address(ipv4_address_.value(),
