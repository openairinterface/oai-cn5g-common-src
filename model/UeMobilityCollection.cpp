...
bool UeMobilityCollection::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    ...
    /* UeTrajs */ {
        const std::vector<oai::_3gpp::model::UeTrajectoryCollection>& value = m_UeTrajs;
...
std::vector<oai::_3gpp::model::UeTrajectoryCollection> UeMobilityCollection::getUeTrajs() const
{
    return m_UeTrajs;
}
void UeMobilityCollection::setUeTrajs(std::vector<oai::_3gpp::model::UeTrajectoryCollection> const& value)
{
    m_UeTrajs = value;
}
