...
bool NssaiAvailabilityInfo::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    ...
    /* SupportedNssaiAvailabilityData */ {
        const std::vector<oai::model::SupportedNssaiAvailabilityData>& value = m_SupportedNssaiAvailabilityData;
        ...
        { // Recursive validation of array elements
            ...
            int i = 0;
            for (const oai::model::SupportedNssaiAvailabilityData& value : value)
            { 
...
std::vector<oai::model::SupportedNssaiAvailabilityData> NssaiAvailabilityInfo::getSupportedNssaiAvailabilityData() const
{
    return m_SupportedNssaiAvailabilityData;
}
void NssaiAvailabilityInfo::setSupportedNssaiAvailabilityData(std::vector<oai::model::SupportedNssaiAvailabilityData> const& value)
{
