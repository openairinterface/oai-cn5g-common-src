...
bool UriList::operator==(const UriList& rhs) const {
  return
      ...
      ((!totalItemCountIsSet() && !rhs.totalItemCountIsSet()) ||
       (totalItemCountIsSet() && rhs.totalItemCountIsSet() &&
        getTotalItemCount() == rhs.getTotalItemCount()))
...
void to_json(nlohmann::json& j, const UriList& o) {
  ...
  if (o.totalItemCountIsSet()) j["totalItemCount"] = o.m_TotalItemCount;
}
...
std::map<std::string, oai::_3gpp::model::LinksValueSchema> UriList::getLinks()
    const {
  return m__links;
}
void UriList::setLinks(
