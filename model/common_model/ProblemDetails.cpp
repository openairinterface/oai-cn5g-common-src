...
ProblemDetails::getInvalidParams() const {
...
oai::model::common::AccessTokenErr ProblemDetails::getAccessTokenError() const {
...
ProblemDetails::getAccessTokenRequest() const {
...
std::string ProblemDetails::getNrfId() const { return m_NrfId; }
void ProblemDetails::setNrfId(std::string const &value) {
  m_NrfId = value;
  m_NrfIdIsSet = true;
}
bool ProblemDetails::nrfIdIsSet() const { return m_NrfIdIsSet; }
void ProblemDetails::unsetNrfId() { m_NrfIdIsSet = false; }
