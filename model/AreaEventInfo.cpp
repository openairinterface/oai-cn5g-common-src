...
std::vector<oai::_3gpp::model::ReportingArea> AreaEventInfo::getAreaDefinition() const
{
    return m_AreaDefinition;
}
void AreaEventInfo::setAreaDefinition(std::vector<oai::_3gpp::model::ReportingArea> const& value)
{
    m_AreaDefinition = value;
}
oai::_3gpp::model::OccurrenceInfo AreaEventInfo::getOccurrenceInfo() const
{
    return m_OccurrenceInfo;
}
void AreaEventInfo::setOccurrenceInfo(oai::_3gpp::model::OccurrenceInfo const& value)
{
