...
bool SnssaiTsctsfInfoItem::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    ...
    /* DnnInfoList */ {
        const std::vector<oai::model::DnnTsctsfInfoItem>& value = m_DnnInfoList;
        ...
        { // Recursive validation of array elements
            ...
            int i = 0;
            for (const oai::model::DnnTsctsfInfoItem& value : value)
            { 
...
oai::model::ExtSnssai SnssaiTsctsfInfoItem::getSNssai() const
{
    return m_SNssai;
}
void SnssaiTsctsfInfoItem::setSNssai(oai::model::ExtSnssai const& value)
{
    m_SNssai = value;
}
std::vector<oai::model::DnnTsctsfInfoItem> SnssaiTsctsfInfoItem::getDnnInfoList() const
{
    return m_DnnInfoList;
}
void SnssaiTsctsfInfoItem::setDnnInfoList(std::vector<oai::model::DnnTsctsfInfoItem> const& value)
{
    m_DnnInfoList = value;
}
