...
oai::model::SmallDataRateControl SmContextConfiguration::getSmalDataRateControl() const
{
    return m_SmalDataRateControl;
}
void SmContextConfiguration::setSmalDataRateControl(oai::model::SmallDataRateControl const& value)
{
...
oai::model::SmallDataRateStatus SmContextConfiguration::getSmallDataRateStatus() const
{
    return m_SmallDataRateStatus;
}
void SmContextConfiguration::setSmallDataRateStatus(oai::model::SmallDataRateStatus const& value)
{
