...
public:
    ...
    /// </summary>
    std::vector<oai::model::Accuracy> getAccPerSubset() const;
    void setAccPerSubset(std::vector<oai::model::Accuracy> const& value);
    ...
    /// 
    /// </summary>
    std::vector<oai::model::AnalyticsMetadata> getAnaMeta() const;
    void setAnaMeta(std::vector<oai::model::AnalyticsMetadata> const& value);
    bool anaMetaIsSet() const;
    void unsetAnaMeta();
    /// <summary>
    /// 
    /// </summary>
    oai::model::AnalyticsMetadataIndication getAnaMetaInd() const;
    void setAnaMetaInd(oai::model::AnalyticsMetadataIndication const& value);
    bool anaMetaIndIsSet() const;
    void unsetAnaMetaInd();
    /// <summary>
    /// 
    /// </summary>
    oai::model::TimeWindow getHistAnaTimePeriod() const;
    void setHistAnaTimePeriod(oai::model::TimeWindow const& value);
...
protected:
    ...
    std::vector<oai::model::Accuracy> m_AccPerSubset;
    ...
    std::vector<oai::model::AnalyticsMetadata> m_AnaMeta;
    bool m_AnaMetaIsSet;
    oai::model::AnalyticsMetadataIndication m_AnaMetaInd;
    bool m_AnaMetaIndIsSet;
    oai::model::TimeWindow m_HistAnaTimePeriod;
