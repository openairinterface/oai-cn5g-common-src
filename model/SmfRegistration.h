...
public:
    ...
    /// 
    /// </summary>
    oai::model::RegistrationReason getRegistrationReason() const;
    void setRegistrationReason(oai::model::RegistrationReason const& value);
...
protected:
    ...
    oai::model::RegistrationReason m_RegistrationReason;
