...
std::vector<oai::_3gpp::model::ExternalClientType> GmlcInfo::getServingClientTypes() const
{
    return m_ServingClientTypes;
}
void GmlcInfo::setServingClientTypes(std::vector<oai::_3gpp::model::ExternalClientType> const& value)
{
