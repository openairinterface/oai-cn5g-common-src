...
bool TrafficInfluDataPatch::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "TrafficInfluDataPatch" : pathPrefix;
...
std::vector<oai::model::EthFlowDescription> TrafficInfluDataPatch::getEthTrafficFilters() const
{
    return m_EthTrafficFilters;
}
void TrafficInfluDataPatch::setEthTrafficFilters(std::vector<oai::model::EthFlowDescription> const& value)
{
...
std::vector<oai::model::FlowInfo> TrafficInfluDataPatch::getTrafficFilters() const
{
    return m_TrafficFilters;
}
void TrafficInfluDataPatch::setTrafficFilters(std::vector<oai::model::FlowInfo> const& value)
{
...
std::vector<oai::model::RouteToLocation> TrafficInfluDataPatch::getTrafficRoutes() const
{
    return m_TrafficRoutes;
}
void TrafficInfluDataPatch::setTrafficRoutes(std::vector<oai::model::RouteToLocation> const& value)
{
...
std::vector<oai::model::TemporalValidity> TrafficInfluDataPatch::getTempValidities() const
{
    return m_TempValidities;
}
void TrafficInfluDataPatch::setTempValidities(std::vector<oai::model::TemporalValidity> const& value)
{
...
oai::model::NetworkAreaInfo TrafficInfluDataPatch::getNwAreaInfo() const
{
    return m_NwAreaInfo;
}
void TrafficInfluDataPatch::setNwAreaInfo(oai::model::NetworkAreaInfo const& value)
{
    m_NwAreaInfo = value;
