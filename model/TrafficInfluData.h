...
public:
    ...
    /// </summary>
    std::vector<oai::_3gpp::model::EthFlowDescription> getEthTrafficFilters() const;
    void setEthTrafficFilters(std::vector<oai::_3gpp::model::EthFlowDescription> const& value);
    ...
    void setTrafficRoutes(std::vector<oai::_3gpp::model::RouteToLocation> const& value);
    ...
    void setTempValidities(std::vector<oai::_3gpp::model::TemporalValidity> const& value);
    ...
    void setSubscribedEvents(std::vector<oai::_3gpp::model::SubscribedEvent> const& value);
