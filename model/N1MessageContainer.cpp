...
oai::_3gpp::model::N1MessageClass N1MessageContainer::getN1MessageClass() const
{
    return m_N1MessageClass;
}
void N1MessageContainer::setN1MessageClass(oai::_3gpp::model::N1MessageClass const& value)
{
    m_N1MessageClass = value;
}
oai::_3gpp::model::RefToBinaryData N1MessageContainer::getN1MessageContent() const
{
    return m_N1MessageContent;
}
void N1MessageContainer::setN1MessageContent(oai::_3gpp::model::RefToBinaryData const& value)
{
