...
oai::_3gpp::model::PresenceState PresenceInfo::getPresenceState() const
{
    return m_PresenceState;
}
void PresenceInfo::setPresenceState(oai::_3gpp::model::PresenceState const& value)
{
...
std::vector<oai::_3gpp::model::Tai> PresenceInfo::getTrackingAreaList() const
{
    return m_TrackingAreaList;
}
void PresenceInfo::setTrackingAreaList(std::vector<oai::_3gpp::model::Tai> const& value)
{
...
std::vector<oai::_3gpp::model::Ecgi> PresenceInfo::getEcgiList() const
{
    return m_EcgiList;
}
void PresenceInfo::setEcgiList(std::vector<oai::_3gpp::model::Ecgi> const& value)
{
    m_EcgiList = value;
...
std::vector<oai::_3gpp::model::Ncgi> PresenceInfo::getNcgiList() const
{
    return m_NcgiList;
}
void PresenceInfo::setNcgiList(std::vector<oai::_3gpp::model::Ncgi> const& value)
{
    m_NcgiList = value;
...
std::vector<oai::_3gpp::model::GlobalRanNodeId> PresenceInfo::getGlobalRanNodeIdList() const
{
    return m_GlobalRanNodeIdList;
}
void PresenceInfo::setGlobalRanNodeIdList(std::vector<oai::_3gpp::model::GlobalRanNodeId> const& value)
{
...
std::vector<oai::_3gpp::model::GlobalRanNodeId> PresenceInfo::getGlobaleNbIdList() const
{
    return m_GlobaleNbIdList;
}
void PresenceInfo::setGlobaleNbIdList(std::vector<oai::_3gpp::model::GlobalRanNodeId> const& value)
{
