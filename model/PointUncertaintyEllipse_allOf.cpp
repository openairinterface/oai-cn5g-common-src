...
bool PointUncertaintyEllipse_allOf::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "PointUncertaintyEllipse_allOf" : pathPrefix;
...
bool PointUncertaintyEllipse_allOf::operator==(const PointUncertaintyEllipse_allOf& rhs) const
{
    return
...
oai::_3gpp::model::GeographicalCoordinates PointUncertaintyEllipse_allOf::getPoint() const
{
    return m_Point;
}
void PointUncertaintyEllipse_allOf::setPoint(oai::_3gpp::model::GeographicalCoordinates const& value)
{
    m_Point = value;
}
oai::_3gpp::model::UncertaintyEllipse PointUncertaintyEllipse_allOf::getUncertaintyEllipse() const
{
    return m_UncertaintyEllipse;
}
void PointUncertaintyEllipse_allOf::setUncertaintyEllipse(oai::_3gpp::model::UncertaintyEllipse const& value)
{
