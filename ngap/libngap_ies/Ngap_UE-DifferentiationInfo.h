...
typedef enum Ngap_UE_DifferentiationInfo__batteryIndication {
  ...
  Ngap_UE_DifferentiationInfo__batteryIndication_battery_powered_not_rechargeable_or_replaceable =
      1,
...
struct Ngap_ProtocolExtensionContainer_12929P353;
...
/* Implementation */
/* extern asn_TYPE_descriptor_t asn_DEF_Ngap_periodicCommunicationIndicator_2;
 * // (Use -fall-defs-global to expose) */
/* extern asn_TYPE_descriptor_t asn_DEF_Ngap_stationaryIndication_8;	//
 * (Use -fall-defs-global to expose) */
/* extern asn_TYPE_descriptor_t asn_DEF_Ngap_trafficProfile_12;	// (Use
 * -fall-defs-global to expose) */
/* extern asn_TYPE_descriptor_t asn_DEF_Ngap_batteryIndication_17;	// (Use
 * -fall-defs-global to expose) */
