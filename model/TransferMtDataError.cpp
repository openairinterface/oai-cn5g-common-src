...
std::vector<oai::model::InvalidParam> TransferMtDataError::getInvalidParams() const
{
    return m_InvalidParams;
}
void TransferMtDataError::setInvalidParams(std::vector<oai::model::InvalidParam> const& value)
{
...
oai::model::AccessTokenErr TransferMtDataError::getAccessTokenError() const
{
    return m_AccessTokenError;
}
void TransferMtDataError::setAccessTokenError(oai::model::AccessTokenErr const& value)
{
...
oai::model::AccessTokenReq TransferMtDataError::getAccessTokenRequest() const
{
    return m_AccessTokenRequest;
}
void TransferMtDataError::setAccessTokenRequest(oai::model::AccessTokenReq const& value)
{
