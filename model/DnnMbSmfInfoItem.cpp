...
bool DnnMbSmfInfoItem::validate(
    std::stringstream& msg, const std::string& pathPrefix) const {
  bool success = true;
  const std::string _pathPrefix =
      pathPrefix.empty() ? "DnnMbSmfInfoItem" : pathPrefix;
...
std::string DnnMbSmfInfoItem::getDnn() const {
  return m_Dnn;
}
void DnnMbSmfInfoItem::setDnn(std::string const& value) {
  m_Dnn = value;
}
