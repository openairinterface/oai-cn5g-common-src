...
asn_TYPE_member_t asn_MBR_Ngap_LastVisitedNGRANCellInformation_1[] = {
    {ATF_POINTER,
     0,
     offsetof(struct Ngap_LastVisitedNGRANCellInformation, globalCellID),
    ...
    {ATF_POINTER,
     0,
     offsetof(struct Ngap_LastVisitedNGRANCellInformation, cellType),
    ...
    {ATF_NOFLAGS,
     0,
     offsetof(struct Ngap_LastVisitedNGRANCellInformation, timeUEStayedInCell),
    ...
    {ATF_POINTER,
     2,
     offsetof(struct Ngap_LastVisitedNGRANCellInformation, hOCauseValue),
    ...
    {ATF_POINTER,
     1,
     offsetof(struct Ngap_LastVisitedNGRANCellInformation, iE_Extensions),
     (ASN_TAG_CLASS_CONTEXT | (5 << 2)),
     -1, /* IMPLICIT tag at current level */
     &asn_DEF_Ngap_ProtocolExtensionContainer_12929P146,
     0,
     {
#if !defined(ASN_DISABLE_OER_SUPPORT)
         0,
...
static const asn_TYPE_tag2member_t
    asn_MAP_Ngap_LastVisitedNGRANCellInformation_tag2el_1[] = {
        ...
        {(ASN_TAG_CLASS_CONTEXT | (3 << 2)), 3, 0,
         0}, /* timeUEStayedInCellEnhancedGranularity */
