...
bool OutOfCreditInformation::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "OutOfCreditInformation" : pathPrefix;
...
bool OutOfCreditInformation::operator==(const OutOfCreditInformation& rhs) const
{
    return
...
oai::model::FinalUnitAction OutOfCreditInformation::getFinUnitAct() const
{
    return m_FinUnitAct;
}
void OutOfCreditInformation::setFinUnitAct(oai::model::FinalUnitAction const& value)
{
    m_FinUnitAct = value;
}
std::vector<oai::model::Flows> OutOfCreditInformation::getFlows() const
{
    return m_Flows;
}
void OutOfCreditInformation::setFlows(std::vector<oai::model::Flows> const& value)
{
    m_Flows = value;
    m_FlowsIsSet = true;
}
