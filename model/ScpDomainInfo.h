...
public:
    ...
    /// 
    /// </summary>
    std::vector<oai::model::IpEndPoint> getScpIpEndPoints() const;
    void setScpIpEndPoints(std::vector<oai::model::IpEndPoint> const& value);
...
protected:
    ...
    bool m_ScpFqdnIsSet;
    std::vector<oai::model::IpEndPoint> m_ScpIpEndPoints;
