...
oai::_3gpp::model::Tai EutraLocation::getTai() const
{
    return m_Tai;
}
void EutraLocation::setTai(oai::_3gpp::model::Tai const& value)
{
    m_Tai = value;
}
...
oai::_3gpp::model::Ecgi EutraLocation::getEcgi() const
{
    return m_Ecgi;
}
void EutraLocation::setEcgi(oai::_3gpp::model::Ecgi const& value)
{
    m_Ecgi = value;
}
...
oai::_3gpp::model::GlobalRanNodeId EutraLocation::getGlobalNgenbId() const
{
    return m_GlobalNgenbId;
}
void EutraLocation::setGlobalNgenbId(oai::_3gpp::model::GlobalRanNodeId const& value)
{
...
oai::_3gpp::model::GlobalRanNodeId EutraLocation::getGlobalENbId() const
{
    return m_GlobalENbId;
}
void EutraLocation::setGlobalENbId(oai::_3gpp::model::GlobalRanNodeId const& value)
{
    m_GlobalENbId = value;
