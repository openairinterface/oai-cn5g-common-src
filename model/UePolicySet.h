...
public:
    ...
    /// </summary>
    std::map<std::string, oai::model::PresenceInfo> getPraInfos() const;
    void setPraInfos(std::map<std::string, oai::model::PresenceInfo> const& value);
    ...
    /// </summary>
    std::map<std::string, oai::model::UePolicySection> getUePolicySections() const;
    void setUePolicySections(std::map<std::string, oai::model::UePolicySection> const& value);
    ...
    /// </summary>
    std::map<std::string, oai::model::PlmnRouteSelectionDescriptor> getAllowedRouteSelDescs() const;
    void setAllowedRouteSelDescs(std::map<std::string, oai::model::PlmnRouteSelectionDescriptor> const& value);
...
protected:
    std::map<std::string, oai::model::PresenceInfo> m_PraInfos;
    bool m_PraInfosIsSet;
    std::vector<std::string> m_SubscCats;
    bool m_SubscCatsIsSet;
    std::map<std::string, oai::model::UePolicySection> m_UePolicySections;
    bool m_UePolicySectionsIsSet;
    std::vector<std::string> m_Upsis;
    bool m_UpsisIsSet;
    std::map<std::string, oai::model::PlmnRouteSelectionDescriptor> m_AllowedRouteSelDescs;
