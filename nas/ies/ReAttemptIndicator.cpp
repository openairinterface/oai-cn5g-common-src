...
//------------------------------------------------------------------------------
void ReAttemptIndicator::SetEplmnc(bool eplmnc) { eplmnc_ = eplmnc; }

//------------------------------------------------------------------------------
bool ReAttemptIndicator::GetEplmnc() const { return eplmnc_; }

//------------------------------------------------------------------------------
void ReAttemptIndicator::SetRatc(bool ratc) { ratc_ = ratc; }

//------------------------------------------------------------------------------
bool ReAttemptIndicator::GetRatc() const { return ratc_; }
