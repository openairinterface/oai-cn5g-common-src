...
/* Implementation */
extern asn_oer_constraints_t asn_OER_type_Ngap_ProcedureCode_constr_1;
...
cbor_type_decoder_f Ngap_ProcedureCode_decode_cbor;
cbor_type_encoder_f Ngap_ProcedureCode_encode_cbor;
...
#define Ngap_ProcedureCode_id_BroadcastSessionModification                     \
  ((Ngap_ProcedureCode_t) 66)
#define Ngap_ProcedureCode_id_BroadcastSessionRelease                          \
  ((Ngap_ProcedureCode_t) 67)
#define Ngap_ProcedureCode_id_BroadcastSessionSetup ((Ngap_ProcedureCode_t) 68)
#define Ngap_ProcedureCode_id_DistributionSetup ((Ngap_ProcedureCode_t) 69)
#define Ngap_ProcedureCode_id_DistributionRelease ((Ngap_ProcedureCode_t) 70)
#define Ngap_ProcedureCode_id_MulticastSessionActivation                       \
  ((Ngap_ProcedureCode_t) 71)
#define Ngap_ProcedureCode_id_MulticastSessionDeactivation                     \
  ((Ngap_ProcedureCode_t) 72)
#define Ngap_ProcedureCode_id_MulticastSessionUpdate ((Ngap_ProcedureCode_t) 73)
#define Ngap_ProcedureCode_id_MulticastGroupPaging ((Ngap_ProcedureCode_t) 74)
#define Ngap_ProcedureCode_id_BroadcastSessionReleaseRequired                  \
  ((Ngap_ProcedureCode_t) 75)
