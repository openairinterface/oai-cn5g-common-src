...
oai::_3gpp::model::SmContextStatus SmContextStatusNotification::getStatus() const
{
    return m_Status;
}
void SmContextStatusNotification::setStatus(oai::_3gpp::model::SmContextStatus const& value)
{
    m_Status = value;
}
...
void SmContextStatusNotification::setCause(oai::_3gpp::model::ReleaseCause const& value)
{
    m_Cause = value;
    m_CauseIsSet = true;
}
...
oai::_3gpp::model::SmallDataRateStatus SmContextStatusNotification::getSmallDataRateStatus() const
{
    return m_SmallDataRateStatus;
}
void SmContextStatusNotification::setSmallDataRateStatus(oai::_3gpp::model::SmallDataRateStatus const& value)
{
...
oai::_3gpp::model::ApnRateStatus SmContextStatusNotification::getApnRateStatus() const
{
    return m_ApnRateStatus;
}
void SmContextStatusNotification::setApnRateStatus(oai::_3gpp::model::ApnRateStatus const& value)
{
