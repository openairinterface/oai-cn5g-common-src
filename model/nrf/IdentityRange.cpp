...
std::string IdentityRange::getStart() const { return m_Start; }
void IdentityRange::setStart(std::string const &value) {
  m_Start = value;
  m_StartIsSet = true;
}
bool IdentityRange::startIsSet() const { return m_StartIsSet; }
void IdentityRange::unsetStart() { m_StartIsSet = false; }
std::string IdentityRange::getEnd() const { return m_End; }
void IdentityRange::setEnd(std::string const &value) {
  m_End = value;
  m_EndIsSet = true;
}
bool IdentityRange::endIsSet() const { return m_EndIsSet; }
void IdentityRange::unsetEnd() { m_EndIsSet = false; }
std::string IdentityRange::getPattern() const { return m_Pattern; }
void IdentityRange::setPattern(std::string const &value) {
  m_Pattern = value;
  m_PatternIsSet = true;
}
bool IdentityRange::patternIsSet() const { return m_PatternIsSet; }
void IdentityRange::unsetPattern() { m_PatternIsSet = false; }
