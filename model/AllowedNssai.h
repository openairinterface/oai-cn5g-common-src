...
public:
    ...
    /// 
    /// </summary>
    std::vector<oai::model::AllowedSnssai> getAllowedSnssaiList() const;
    void setAllowedSnssaiList(std::vector<oai::model::AllowedSnssai> const& value);
    /// <summary>
    /// 
    /// </summary>
...
protected:
    std::vector<oai::model::AllowedSnssai> m_AllowedSnssaiList;
