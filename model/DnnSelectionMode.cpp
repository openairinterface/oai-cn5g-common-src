...
DnnSelectionMode_anyOf::eDnnSelectionMode_anyOf DnnSelectionMode::getEnumValue() const
{
    return m_value.getValue();
}

void DnnSelectionMode::setEnumValue(DnnSelectionMode_anyOf::eDnnSelectionMode_anyOf  value)
{
