...
std::vector<oai::_3gpp::model::InvalidParam> ProblemDetails::getInvalidParams() const
{
    return m_InvalidParams;
}
void ProblemDetails::setInvalidParams(std::vector<oai::_3gpp::model::InvalidParam> const& value)
{
...
oai::_3gpp::model::AccessTokenErr ProblemDetails::getAccessTokenError() const
{
    return m_AccessTokenError;
}
void ProblemDetails::setAccessTokenError(oai::_3gpp::model::AccessTokenErr const& value)
{
...
oai::_3gpp::model::AccessTokenReq ProblemDetails::getAccessTokenRequest() const
{
    return m_AccessTokenRequest;
}
void ProblemDetails::setAccessTokenRequest(oai::_3gpp::model::AccessTokenReq const& value)
{
