...
asn_TYPE_member_t asn_MBR_Ngap_SecurityResult_1[] = {
    {ATF_NOFLAGS,
     0,
     offsetof(struct Ngap_SecurityResult, integrityProtectionResult),
    ...
    {ATF_NOFLAGS,
     0,
     offsetof(struct Ngap_SecurityResult, confidentialityProtectionResult),
    ...
    {ATF_POINTER,
     ...
     -1, /* IMPLICIT tag at current level */
     &asn_DEF_Ngap_ProtocolExtensionContainer_12929P300,
     0,
     {
#if !defined(ASN_DISABLE_OER_SUPPORT)
         0,
...
static const asn_TYPE_tag2member_t asn_MAP_Ngap_SecurityResult_tag2el_1[] = {
    {(ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0,
     0}, /* integrityProtectionResult */
    {(ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0,
     0}, /* confidentialityProtectionResult */
