...
static int memb_Ngap_pDUSessionResourceReleaseCommandTransfer_constraint_1(
...
static asn_per_constraints_t
    asn_PER_memb_Ngap_pDUSessionResourceReleaseCommandTransfer_constr_3
        CC_NOTUSED = {
...
asn_TYPE_member_t asn_MBR_Ngap_PDUSessionResourceToReleaseItemRelCmd_1[] = {
    {ATF_NOFLAGS,
     0,
     offsetof(struct Ngap_PDUSessionResourceToReleaseItemRelCmd, pDUSessionID),
    ...
    {ATF_NOFLAGS,
     ...
     0,
     {
         ...
         0,
#endif /* !defined(ASN_DISABLE_JER_SUPPORT) */
         memb_Ngap_pDUSessionResourceReleaseCommandTransfer_constraint_1},
     0,
     0, /* No default value */
     "pDUSessionResourceReleaseCommandTransfer"},
    {ATF_POINTER,
     1,
     offsetof(struct Ngap_PDUSessionResourceToReleaseItemRelCmd, iE_Extensions),
     (ASN_TAG_CLASS_CONTEXT | (2 << 2)),
     -1, /* IMPLICIT tag at current level */
     &asn_DEF_Ngap_ProtocolExtensionContainer_12929P262,
     0,
     {
#if !defined(ASN_DISABLE_OER_SUPPORT)
         0,
...
static const int asn_MAP_Ngap_PDUSessionResourceToReleaseItemRelCmd_oms_1[] = {
    2};
...
static const asn_TYPE_tag2member_t
    asn_MAP_Ngap_PDUSessionResourceToReleaseItemRelCmd_tag2el_1[] = {
        ...
        {(ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0,
         0}, /* pDUSessionResourceReleaseCommandTransfer */
        {(ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0, 0} /* iE-Extensions */
};
asn_SEQUENCE_specifics_t
    asn_SPC_Ngap_PDUSessionResourceToReleaseItemRelCmd_specs_1 = {
        ...
        asn_MAP_Ngap_PDUSessionResourceToReleaseItemRelCmd_oms_1, /* Optional
                                                                     members */
        1,
        0, /* Root/Additions */
...
asn_TYPE_descriptor_t asn_DEF_Ngap_PDUSessionResourceToReleaseItemRelCmd = {
    ...
    sizeof(asn_DEF_Ngap_PDUSessionResourceToReleaseItemRelCmd_tags_1) /
        sizeof(
            asn_DEF_Ngap_PDUSessionResourceToReleaseItemRelCmd_tags_1[0]), /* 1
                                                                            */
    ...
    3, /* Elements count */
    &asn_SPC_Ngap_PDUSessionResourceToReleaseItemRelCmd_specs_1 /* Additional
                                                                   specs */
};
