...
public:
    ...
    /// 
    /// </summary>
    oai::_3gpp::model::CommunicationCharacteristicsAF getCommunicationCharacteristics() const;
    void setCommunicationCharacteristics(oai::_3gpp::model::CommunicationCharacteristicsAF const& value);
...
protected:
    oai::_3gpp::model::CommunicationCharacteristicsAF m_CommunicationCharacteristics;
