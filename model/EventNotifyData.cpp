...
oai::_3gpp::model::ReportedEventType EventNotifyData::getReportedEventType() const
{
    return m_ReportedEventType;
}
void EventNotifyData::setReportedEventType(oai::_3gpp::model::ReportedEventType const& value)
{
...
void EventNotifyData::setLocationEstimate(oai::_3gpp::model::GeographicArea const& value)
{
...
void EventNotifyData::setCivicAddress(oai::_3gpp::model::CivicAddress const& value)
{
...
void EventNotifyData::setLocalLocationEstimate(oai::_3gpp::model::LocalArea const& value)
{
...
std::vector<oai::_3gpp::model::PositioningMethodAndUsage> EventNotifyData::getPositioningDataList() const
{
    return m_PositioningDataList;
}
void EventNotifyData::setPositioningDataList(std::vector<oai::_3gpp::model::PositioningMethodAndUsage> const& value)
{
...
std::vector<oai::_3gpp::model::GnssPositioningMethodAndUsage> EventNotifyData::getGnssPositioningDataList() const
{
    return m_GnssPositioningDataList;
}
void EventNotifyData::setGnssPositioningDataList(std::vector<oai::_3gpp::model::GnssPositioningMethodAndUsage> const& value)
{
...
oai::_3gpp::model::TerminationCause EventNotifyData::getTerminationCause() const
{
    return m_TerminationCause;
}
void EventNotifyData::setTerminationCause(oai::_3gpp::model::TerminationCause const& value)
{
...
oai::_3gpp::model::VelocityEstimate EventNotifyData::getVelocityEstimate() const
{
    return m_VelocityEstimate;
}
void EventNotifyData::setVelocityEstimate(oai::_3gpp::model::VelocityEstimate const& value)
{
...
void EventNotifyData::setAchievedQos(oai::_3gpp::model::MinorLocationQoS const& value)
{
    m_AchievedQos = value;
...
oai::_3gpp::model::HighAccuracyGnssMetrics EventNotifyData::getHaGnssMetrics() const
{
    return m_HaGnssMetrics;
}
void EventNotifyData::setHaGnssMetrics(oai::_3gpp::model::HighAccuracyGnssMetrics const& value)
{
...
void EventNotifyData::setIntegrityResult(oai::_3gpp::model::IntegrityResult const& value)
{
