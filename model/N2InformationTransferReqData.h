...
public:
    ...
    /// 
    /// </summary>
    oai::model::RatSelector getRatSelector() const;
    void setRatSelector(oai::model::RatSelector const& value);
    ...
    /// 
    /// </summary>
    oai::model::N2InfoContainer getN2Information() const;
    void setN2Information(oai::model::N2InfoContainer const& value);
    /// <summary>
