...
oai::_3gpp::model::MmeCapabilities SmContextRetrieveData::getTargetMmeCap() const
{
    return m_TargetMmeCap;
}
void SmContextRetrieveData::setTargetMmeCap(oai::_3gpp::model::MmeCapabilities const& value)
{
...
oai::_3gpp::model::SmContextType SmContextRetrieveData::getSmContextType() const
{
    return m_SmContextType;
}
void SmContextRetrieveData::setSmContextType(oai::_3gpp::model::SmContextType const& value)
{
...
void SmContextRetrieveData::setServingNetwork(oai::_3gpp::model::PlmnId const& value)
{
