...
bool CommunicationFailure::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "CommunicationFailure" : pathPrefix;
...
bool CommunicationFailure::operator==(const CommunicationFailure& rhs) const
{
    ...
    ((!nasReleaseCodeIsSet() && !rhs.nasReleaseCodeIsSet()) || (nasReleaseCodeIsSet() && rhs.nasReleaseCodeIsSet() && getNasReleaseCode() == rhs.getNasReleaseCode())) &&
    
    
    ((!ranReleaseCodeIsSet() && !rhs.ranReleaseCodeIsSet()) || (ranReleaseCodeIsSet() && rhs.ranReleaseCodeIsSet() && getRanReleaseCode() == rhs.getRanReleaseCode()))
...
oai::_3gpp::model::NgApCause CommunicationFailure::getRanReleaseCode() const
{
    return m_RanReleaseCode;
}
void CommunicationFailure::setRanReleaseCode(oai::_3gpp::model::NgApCause const& value)
{
