...
//------------------------------------------------------------------------------
void ConfigurationUpdateCommand::Set5gGuti(const std::string &mcc,
...
int ConfigurationUpdateCommand::Encode(uint8_t *buf, int len) {
  ...
  if ((encoded_ie_size = NasHelper::Encode(ie_configuration_update_indication_,
  ...
  if ((encoded_ie_size = NasHelper::Encode(ie_full_name_for_network_, buf, len,
                                           encoded_size)) ==
      KEncodeDecodeError) {
    return KEncodeDecodeError;
  }

  if ((encoded_ie_size = NasHelper::Encode(ie_short_name_for_network_, buf, len,
                                           encoded_size)) ==
      KEncodeDecodeError) {
    return KEncodeDecodeError;
  }
...
int ConfigurationUpdateCommand::Decode(uint8_t *buf, int len) {
  ...
  while ((octet != 0x0)) {
    ...
    case kIeiConfigurationUpdateIndication: {
      ...
      if ((decoded_ie_size =
               NasHelper::Decode(ie_configuration_update_indication_, buf, len,
    ...
    case kIeiFullNameForNetwork: {
      ...
      if ((decoded_ie_size = NasHelper::Decode(ie_full_name_for_network_, buf,
    ...
    case kIeiShortNameForNetwork: {
      ...
      if ((decoded_ie_size = NasHelper::Decode(ie_short_name_for_network_, buf,
                                               len, decoded_size, true)) ==
          KEncodeDecodeError) {
        return KEncodeDecodeError;
      }
