...
public:
    ...
    /// 
    /// </summary>
    std::vector<oai::model::PlmnId_1> getDisasterCondPlmnIds() const;
    void setDisasterCondPlmnIds(std::vector<oai::model::PlmnId_1> const& value);
...
protected:
    ...
    bool m_Aol;
    bool m_AolIsSet;
    std::vector<oai::model::PlmnId_1> m_DisasterCondPlmnIds;
