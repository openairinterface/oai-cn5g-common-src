...
bool NefEventExposureSubsc::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    ...
    /* EventsSubs */ {
        const std::vector<oai::model::NefEventSubs>& value = m_EventsSubs;
        ...
        { // Recursive validation of array elements
            ...
            int i = 0;
            for (const oai::model::NefEventSubs& value : value)
            { 
    ...
    if (eventNotifsIsSet())
    {
        const std::vector<oai::model::NefEventNotification>& value = m_EventNotifs;
        ...
        { // Recursive validation of array elements
            const std::string oldValuePath = currentValuePath;
            int i = 0;
            for (const oai::model::NefEventNotification& value : value)
            { 
                const std::string currentValuePath = oldValuePath + "[" + std::to_string(i) + "]";
...
std::vector<oai::model::NefEventSubs> NefEventExposureSubsc::getEventsSubs() const
{
    return m_EventsSubs;
}
void NefEventExposureSubsc::setEventsSubs(std::vector<oai::model::NefEventSubs> const& value)
{
    m_EventsSubs = value;
}
oai::model::ReportingInformation NefEventExposureSubsc::getEventsRepInfo() const
{
    return m_EventsRepInfo;
}
void NefEventExposureSubsc::setEventsRepInfo(oai::model::ReportingInformation const& value)
{
...
std::vector<oai::model::NefEventNotification> NefEventExposureSubsc::getEventNotifs() const
{
    return m_EventNotifs;
}
void NefEventExposureSubsc::setEventNotifs(std::vector<oai::model::NefEventNotification> const& value)
{
    m_EventNotifs = value;
