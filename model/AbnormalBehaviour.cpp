...
bool AbnormalBehaviour::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "AbnormalBehaviour" : pathPrefix;
    ...
    if (!m_Excep.validate(msg, _pathPrefix + ".excep")) {
        msg << _pathPrefix << ": Excep is invalid;";
        success = false;
    }             
    if (ratioIsSet())
    {
...
bool AbnormalBehaviour::operator==(const AbnormalBehaviour& rhs) const
{
    ...
    ((!addtMeasInfoIsSet() && !rhs.addtMeasInfoIsSet()) || (addtMeasInfoIsSet() && rhs.addtMeasInfoIsSet() && getAddtMeasInfo() == rhs.getAddtMeasInfo()))
...
oai::model::Exception AbnormalBehaviour::getExcep() const
{
    return m_Excep;
}
void AbnormalBehaviour::setExcep(oai::model::Exception const& value)
{
    m_Excep = value;
}
...
oai::model::Snssai AbnormalBehaviour::getSnssai() const
{
    return m_Snssai;
}
void AbnormalBehaviour::setSnssai(oai::model::Snssai const& value)
{
    m_Snssai = value;
    m_SnssaiIsSet = true;
}
...
oai::model::AdditionalMeasurement AbnormalBehaviour::getAddtMeasInfo() const
{
    return m_AddtMeasInfo;
}
void AbnormalBehaviour::setAddtMeasInfo(oai::model::AdditionalMeasurement const& value)
{
