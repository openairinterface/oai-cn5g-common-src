...
bool QueryParamCombination::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "QueryParamCombination" : pathPrefix;

         
    
    /* QueryParams */ {
        const std::vector<oai::_3gpp::model::QueryParameter>& value = m_QueryParams;
        ...
        { // Recursive validation of array elements
            ...
            int i = 0;
            for (const oai::_3gpp::model::QueryParameter& value : value)
            { 
                const std::string currentValuePath = oldValuePath + "[" + std::to_string(i) + "]";
                        
        success = value.validate(msg, currentValuePath + ".queryParams") && success;
...
std::vector<oai::_3gpp::model::QueryParameter> QueryParamCombination::getQueryParams() const
{
    return m_QueryParams;
}
void QueryParamCombination::setQueryParams(std::vector<oai::_3gpp::model::QueryParameter> const& value)
{
    m_QueryParams = value;
}
