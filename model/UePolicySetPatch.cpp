...
std::map<std::string, oai::model::UePolicySection> UePolicySetPatch::getUePolicySections() const
{
    return m_UePolicySections;
}
void UePolicySetPatch::setUePolicySections(std::map<std::string, oai::model::UePolicySection> const& value)
{
