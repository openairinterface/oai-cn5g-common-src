...
bool EpsInterworkingInfo::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "EpsInterworkingInfo" : pathPrefix;
...
bool EpsInterworkingInfo::operator==(const EpsInterworkingInfo& rhs) const
{
    ...
    ((!epsIwkPgwsIsSet() && !rhs.epsIwkPgwsIsSet()) || (epsIwkPgwsIsSet() && rhs.epsIwkPgwsIsSet() && getEpsIwkPgws() == rhs.getEpsIwkPgws()))
...
std::map<std::string, oai::_3gpp::model::EpsIwkPgw> EpsInterworkingInfo::getEpsIwkPgws() const
{
    return m_EpsIwkPgws;
}
void EpsInterworkingInfo::setEpsIwkPgws(std::map<std::string, oai::_3gpp::model::EpsIwkPgw> const& value)
{
    m_EpsIwkPgws = value;
