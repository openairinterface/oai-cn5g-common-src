...
bool AppSessionContextReqData::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    ...
    {
        const std::map<std::string, oai::_3gpp::model::MediaComponent>& value = m_MedComponents;
...
oai::_3gpp::model::AfRequestedData AppSessionContextReqData::getAfReqData() const
{
    return m_AfReqData;
}
void AppSessionContextReqData::setAfReqData(oai::_3gpp::model::AfRequestedData const& value)
{
    m_AfReqData = value;
...
oai::_3gpp::model::AfRoutingRequirement AppSessionContextReqData::getAfRoutReq() const
{
    return m_AfRoutReq;
}
void AppSessionContextReqData::setAfRoutReq(oai::_3gpp::model::AfRoutingRequirement const& value)
{
    m_AfRoutReq = value;
...
oai::_3gpp::model::EventsSubscReqData AppSessionContextReqData::getEvSubsc() const
{
    return m_EvSubsc;
}
void AppSessionContextReqData::setEvSubsc(oai::_3gpp::model::EventsSubscReqData const& value)
{
    m_EvSubsc = value;
    m_EvSubscIsSet = true;
}
...
std::map<std::string, oai::_3gpp::model::MediaComponent> AppSessionContextReqData::getMedComponents() const
{
    return m_MedComponents;
}
void AppSessionContextReqData::setMedComponents(std::map<std::string, oai::_3gpp::model::MediaComponent> const& value)
{
...
void AppSessionContextReqData::setMpsAction(oai::_3gpp::model::MpsAction const& value)
{
    m_MpsAction = value;
...
oai::_3gpp::model::PreemptionControlInformation AppSessionContextReqData::getPreemptControlInfo() const
{
    return m_PreemptControlInfo;
}
void AppSessionContextReqData::setPreemptControlInfo(oai::_3gpp::model::PreemptionControlInformation const& value)
{
...
void AppSessionContextReqData::setResPrio(oai::_3gpp::model::ReservPriority const& value)
{
    m_ResPrio = value;
    m_ResPrioIsSet = true;
}
...
oai::_3gpp::model::ServiceInfoStatus AppSessionContextReqData::getServInfStatus() const
{
    return m_ServInfStatus;
}
void AppSessionContextReqData::setServInfStatus(oai::_3gpp::model::ServiceInfoStatus const& value)
{
...
void AppSessionContextReqData::setSliceInfo(oai::_3gpp::model::Snssai const& value)
{
    m_SliceInfo = value;
...
oai::_3gpp::model::SponsoringStatus AppSessionContextReqData::getSponStatus() const
{
    return m_SponStatus;
}
void AppSessionContextReqData::setSponStatus(oai::_3gpp::model::SponsoringStatus const& value)
{
    m_SponStatus = value;
...
void AppSessionContextReqData::setUeIpv6(oai::_3gpp::model::Ipv6Addr const& value)
{
    m_UeIpv6 = value;
    m_UeIpv6IsSet = true;
}
...
oai::_3gpp::model::BridgeManagementContainer AppSessionContextReqData::getTsnBridgeManCont() const
{
    return m_TsnBridgeManCont;
}
void AppSessionContextReqData::setTsnBridgeManCont(oai::_3gpp::model::BridgeManagementContainer const& value)
{
...
oai::_3gpp::model::PortManagementContainer AppSessionContextReqData::getTsnPortManContDstt() const
{
    return m_TsnPortManContDstt;
}
void AppSessionContextReqData::setTsnPortManContDstt(oai::_3gpp::model::PortManagementContainer const& value)
{
...
std::vector<oai::_3gpp::model::PortManagementContainer> AppSessionContextReqData::getTsnPortManContNwtts() const
{
    return m_TsnPortManContNwtts;
}
void AppSessionContextReqData::setTsnPortManContNwtts(std::vector<oai::_3gpp::model::PortManagementContainer> const& value)
{
