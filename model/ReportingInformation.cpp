...
bool ReportingInformation::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "ReportingInformation" : pathPrefix;
...
bool ReportingInformation::operator==(const ReportingInformation& rhs) const
{
    ...
    ((!monDurIsSet() && !rhs.monDurIsSet()) || (monDurIsSet() && rhs.monDurIsSet() && getMonDur() == rhs.getMonDur())) &&
...
oai::model::NotificationMethod ReportingInformation::getNotifMethod() const
{
    return m_NotifMethod;
}
void ReportingInformation::setNotifMethod(oai::model::NotificationMethod const& value)
{
    m_NotifMethod = value;
...
std::vector<oai::model::PartitioningCriteria> ReportingInformation::getPartitionCriteria() const
{
    return m_PartitionCriteria;
}
void ReportingInformation::setPartitionCriteria(std::vector<oai::model::PartitioningCriteria> const& value)
{
...
oai::model::NotificationFlag ReportingInformation::getNotifFlag() const
{
    return m_NotifFlag;
}
void ReportingInformation::setNotifFlag(oai::model::NotificationFlag const& value)
{
    m_NotifFlag = value;
