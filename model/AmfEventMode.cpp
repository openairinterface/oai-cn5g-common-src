...
bool AmfEventMode::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    ...
    {
        const std::vector<oai::_3gpp::model::PartitioningCriteria>& value = m_PartitioningCriteria;
...
std::vector<oai::_3gpp::model::PartitioningCriteria> AmfEventMode::getPartitioningCriteria() const
{
    return m_PartitioningCriteria;
}
void AmfEventMode::setPartitioningCriteria(std::vector<oai::_3gpp::model::PartitioningCriteria> const& value)
{
...
void AmfEventMode::setNotifFlag(oai::_3gpp::model::NotificationFlag const& value)
{
    m_NotifFlag = value;
