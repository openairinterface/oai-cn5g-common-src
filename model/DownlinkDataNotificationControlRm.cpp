...
bool DownlinkDataNotificationControlRm::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "DownlinkDataNotificationControlRm" : pathPrefix;

         
    if (notifCtrlIndsIsSet())
    {
        const std::vector<oai::_3gpp::model::NotificationControlIndication>& value = m_NotifCtrlInds;
        ...
        { // Recursive validation of array elements
            ...
            int i = 0;
            for (const oai::_3gpp::model::NotificationControlIndication& value : value)
            { 
                const std::string currentValuePath = oldValuePath + "[" + std::to_string(i) + "]";
                        
        success = value.validate(msg, currentValuePath + ".notifCtrlInds") && success;
...
bool DownlinkDataNotificationControlRm::operator==(const DownlinkDataNotificationControlRm& rhs) const
{
    return
    
    
    
    ((!notifCtrlIndsIsSet() && !rhs.notifCtrlIndsIsSet()) || (notifCtrlIndsIsSet() && rhs.notifCtrlIndsIsSet() && getNotifCtrlInds() == rhs.getNotifCtrlInds())) &&
...
std::vector<oai::_3gpp::model::NotificationControlIndication> DownlinkDataNotificationControlRm::getNotifCtrlInds() const
{
    return m_NotifCtrlInds;
}
void DownlinkDataNotificationControlRm::setNotifCtrlInds(std::vector<oai::_3gpp::model::NotificationControlIndication> const& value)
{
...
std::vector<oai::_3gpp::model::DlDataDeliveryStatus> DownlinkDataNotificationControlRm::getTypesOfNotif() const
{
    return m_TypesOfNotif;
}
void DownlinkDataNotificationControlRm::setTypesOfNotif(std::vector<oai::_3gpp::model::DlDataDeliveryStatus> const& value)
{
