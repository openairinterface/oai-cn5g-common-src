...
uint32_t SecurityModeCommand::GetLength() const {
  ...
  if (ie_abba_.has_value())
    msg_len += ie_abba_.value().GetIeLength();
...
//------------------------------------------------------------------------------
void SecurityModeCommand::SetNasSecurityAlgorithms(uint8_t ciphering,
                                                   uint8_t integrity) {
...
void SecurityModeCommand::SetUeSecurityCapability(
  ...
  if (ue_security_capability.GetEea(eea) &&
    ...
    ie_ue_security_capability_.Set(ue_security_capability.GetEa(),
                                   ue_security_capability.GetIa(), eea, eia);
  } else {
    ie_ue_security_capability_.Set(ue_security_capability.GetEa(),
                                   ue_security_capability.GetIa());
  }
}
...
//------------------------------------------------------------------------------
void SecurityModeCommand::SetEpsNasSecurityAlgorithms(uint8_t ciphering,
                                                      uint8_t integrity) {
...
//------------------------------------------------------------------------------
void SecurityModeCommand::SetAdditional5gSecurityInformation(bool rinmr,
                                                             bool hdp) {
...
int SecurityModeCommand::Encode(uint8_t *buf, int len) {
  ...
  if ((encoded_ie_size = NasHelper::Encode(ie_selected_nas_security_algorithms_,
  ...
  if ((encoded_ie_size = NasHelper::Encode(ie_eps_nas_security_algorithms_, buf,
                                           len, encoded_size)) ==
      KEncodeDecodeError) {
    return KEncodeDecodeError;
  }
  ...
  if ((encoded_ie_size =
           NasHelper::Encode(ie_additional_5g_security_information_, buf, len,
  ...
  if ((encoded_ie_size = NasHelper::Encode(ie_s1_ue_security_capability_, buf,
                                           len, encoded_size)) ==
      KEncodeDecodeError) {
    return KEncodeDecodeError;
  }
...
int SecurityModeCommand::Decode(uint8_t *buf, int len) {
  ...
  // NAS security algorithms
  if ((decoded_ie_size = NasHelper::Decode(ie_selected_nas_security_algorithms_,
  ...
  if ((decoded_ie_size = NasHelper::Decode(ie_ng_ksi_, buf, len, decoded_size,
                                           false, false)) ==
      KEncodeDecodeError) {
    return KEncodeDecodeError;
  }
  ...
  // UE security capability
  if ((decoded_ie_size = NasHelper::Decode(ie_ue_security_capability_, buf, len,
                                           decoded_size, false)) ==
      KEncodeDecodeError) {
    return KEncodeDecodeError;
  }
  ...
  while ((octet != 0x0)) {
    ...
    case kIeiImeisvRequest: {
      oai::logger::logger_common::nas().debug("Decoding IEI 0x%x",
                                              kIeiImeisvRequest);
      if ((decoded_ie_size = NasHelper::Decode(ie_imeisv_request_, buf, len,
                                               decoded_size, true)) ==
          KEncodeDecodeError) {
        return KEncodeDecodeError;
      }
    ...
    case kIeiEpsNasSecurityAlgorithms: {
      ...
      if ((decoded_ie_size = NasHelper::Decode(ie_eps_nas_security_algorithms_,
    ...
    case kIeiAbba: {
      ...
      if ((decoded_ie_size = NasHelper::Decode(ie_abba_, buf, len, decoded_size,
                                               true)) == KEncodeDecodeError) {
        return KEncodeDecodeError;
      }
      DECODE_U8_VALUE(buf, octet, decoded_size, len);
    ...
    case kIeiS1UeSecurityCapability: {
      ...
      if ((decoded_ie_size = NasHelper::Decode(ie_s1_ue_security_capability_,
                                               buf, len, decoded_size, true)) ==
          KEncodeDecodeError) {
        return KEncodeDecodeError;
      }
