...
//------------------------------------------------------------------------------
void InitialUeMessageMsg::setUserLocationInfoNr(const struct NrCgi_s &cig,
                                                const struct Tai_s &tai) {
  ...
  for (int i = 0; i < m_InitialUEMessageIes->protocolIEs.list.count; i++) {
    ...
    case Ngap_ProtocolIE_ID_id_RAN_UE_NGAP_ID: {
      if (m_InitialUEMessageIes->protocolIEs.list.array[i]->criticality ==
        ...
        oai::logger::logger_common::ngap().debug("Received RanUeNgapId %d ",
                                                 m_RanUeNgapId.get());
...
//------------------------------------------------------------------------------
bool InitialUeMessageMsg::getUserLocationInfoNr(struct NrCgi_s &cig,
                                                struct Tai_s &tai) const {
  UserLocationInformationNr information_nr = {};
...
//------------------------------------------------------------------------------
bool InitialUeMessageMsg::get5GSTmsi(std ::string &setid, std ::string &pointer,
