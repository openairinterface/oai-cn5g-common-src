...
bool AppDetectionInfo::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "AppDetectionInfo" : pathPrefix;

                 
    if (sdfDescriptionsIsSet())
    {
        const std::vector<oai::_3gpp::model::FlowInformation>& value = m_SdfDescriptions;
        ...
        success = value.validate(msg, currentValuePath + ".sdfDescriptions") && success;
...
bool AppDetectionInfo::operator==(const AppDetectionInfo& rhs) const
{
    ...
    ((!instanceIdIsSet() && !rhs.instanceIdIsSet()) || (instanceIdIsSet() && rhs.instanceIdIsSet() && getInstanceId() == rhs.getInstanceId())) &&
    
    
    ((!sdfDescriptionsIsSet() && !rhs.sdfDescriptionsIsSet()) || (sdfDescriptionsIsSet() && rhs.sdfDescriptionsIsSet() && getSdfDescriptions() == rhs.getSdfDescriptions()))
...
std::vector<oai::_3gpp::model::FlowInformation> AppDetectionInfo::getSdfDescriptions() const
{
    return m_SdfDescriptions;
}
void AppDetectionInfo::setSdfDescriptions(std::vector<oai::_3gpp::model::FlowInformation> const& value)
{
