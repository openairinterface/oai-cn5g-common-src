...
bool AfResultStatus::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "AfResultStatus" : pathPrefix;
...
AfResultStatus_anyOf::eAfResultStatus_anyOf AfResultStatus::getEnumValue() const
{
    return m_value.getValue();
}

void AfResultStatus::setEnumValue(AfResultStatus_anyOf::eAfResultStatus_anyOf  value)
{
