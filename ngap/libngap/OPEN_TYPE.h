...
int OPEN_TYPE_print_member(
    const asn_TYPE_descriptor_t* td, const void* sptr,
    const asn_TYPE_member_t* elm, int ilevel, asn_app_consume_bytes_f* cb,
    void* app_key);
...
asn_enc_rval_t OPEN_TYPE_ber_put(
    const asn_TYPE_descriptor_t* parent_type, const void* parent_structure,
    const asn_TYPE_member_t* element, int tag_mode, ber_tlv_tag_t tag,
...
asn_enc_rval_t OPEN_TYPE_xer_put(
    const asn_TYPE_descriptor_t* parent_type, const void* parent_structure,
    const asn_TYPE_member_t* element, int ilevel,
    enum xer_encoder_flags_e flags, asn_app_consume_bytes_f* consume_bytes_cb,
    void* app_key);
...
asn_enc_rval_t OPEN_TYPE_jer_put(
    const asn_TYPE_descriptor_t* parent_type, const void* parent_structure,
    const asn_TYPE_member_t* element, int ilevel,
    enum jer_encoder_flags_e flags, asn_app_consume_bytes_f* consume_bytes_cb,
    void* app_key);
...
asn_enc_rval_t OPEN_TYPE_oer_put(
    const asn_TYPE_descriptor_t* parent_type, const void* parent_structure,
    const asn_TYPE_member_t* element, asn_app_consume_bytes_f* consume_bytes_cb,
    void* app_key);
...
asn_enc_rval_t OPEN_TYPE_uper_put(
    const asn_TYPE_descriptor_t* parent_type, const void* parent_structure,
    const asn_TYPE_member_t* element, asn_per_outp_t* per_output);
