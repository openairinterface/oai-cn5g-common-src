...
public:
    ...
    /// 
    /// </summary>
    oai::_3gpp::model::ServAuthInfo getServAuthInfo() const;
    void setServAuthInfo(oai::_3gpp::model::ServAuthInfo const& value);
    bool servAuthInfoIsSet() const;
    void unsetServAuthInfo();
    /// <summary>
    /// 
    /// </summary>
    std::vector<oai::_3gpp::model::UeIdentityInfo> getUeIds() const;
    void setUeIds(std::vector<oai::_3gpp::model::UeIdentityInfo> const& value);
...
protected:
    oai::_3gpp::model::ServAuthInfo m_ServAuthInfo;
    bool m_ServAuthInfoIsSet;
    std::vector<oai::_3gpp::model::UeIdentityInfo> m_UeIds;
    bool m_UeIdsIsSet;
