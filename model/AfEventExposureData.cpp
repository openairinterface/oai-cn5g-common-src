...
bool AfEventExposureData::validate(
    std::stringstream& msg, const std::string& pathPrefix) const {
  bool success = true;
  const std::string _pathPrefix =
      pathPrefix.empty() ? "AfEventExposureData" : pathPrefix;
...
bool AfEventExposureData::operator==(const AfEventExposureData& rhs) const {
  return
      ...
      ((!afIdsIsSet() && !rhs.afIdsIsSet()) ||
       (afIdsIsSet() && rhs.afIdsIsSet() && getAfIds() == rhs.getAfIds())) &&
...
void to_json(nlohmann::json& j, const AfEventExposureData& o) {
  ...
  if (o.afIdsIsSet() || !o.m_AfIds.empty()) j["afIds"] = o.m_AfIds;
...
std::vector<oai::_3gpp::model::AfEvent> AfEventExposureData::getAfEvents()
    const {
  return m_AfEvents;
}
void AfEventExposureData::setAfEvents(
