...
bool SnssaiInfoItem::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    ...
    /* DnnInfoList */ {
        const std::vector<oai::model::DnnInfoItem>& value = m_DnnInfoList;
        ...
        { // Recursive validation of array elements
            ...
            int i = 0;
            for (const oai::model::DnnInfoItem& value : value)
            { 
...
oai::model::ExtSnssai SnssaiInfoItem::getSNssai() const
{
    return m_SNssai;
}
void SnssaiInfoItem::setSNssai(oai::model::ExtSnssai const& value)
{
    m_SNssai = value;
}
std::vector<oai::model::DnnInfoItem> SnssaiInfoItem::getDnnInfoList() const
{
    return m_DnnInfoList;
}
void SnssaiInfoItem::setDnnInfoList(std::vector<oai::model::DnnInfoItem> const& value)
{
    m_DnnInfoList = value;
}
