...
int Ngap_SgNB_UE_X2AP_ID_constraint(
...
asn_oer_constraints_t asn_OER_type_Ngap_SgNB_UE_X2AP_ID_constr_1 CC_NOTUSED = {
    {4, 1} /* (0..4294967295) */,
    -1};
...
asn_TYPE_descriptor_t asn_DEF_Ngap_SgNB_UE_X2AP_ID = {
    ...
    {
#if !defined(ASN_DISABLE_OER_SUPPORT)
        &asn_OER_type_Ngap_SgNB_UE_X2AP_ID_constr_1,
#endif /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
