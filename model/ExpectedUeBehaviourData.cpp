...
oai::_3gpp::model::StationaryIndication ExpectedUeBehaviourData::getStationaryIndication() const
{
    return m_StationaryIndication;
}
void ExpectedUeBehaviourData::setStationaryIndication(oai::_3gpp::model::StationaryIndication const& value)
{
...
oai::_3gpp::model::ScheduledCommunicationTime ExpectedUeBehaviourData::getScheduledCommunicationTime() const
{
    return m_ScheduledCommunicationTime;
}
void ExpectedUeBehaviourData::setScheduledCommunicationTime(oai::_3gpp::model::ScheduledCommunicationTime const& value)
{
...
oai::_3gpp::model::ScheduledCommunicationType ExpectedUeBehaviourData::getScheduledCommunicationType() const
{
    return m_ScheduledCommunicationType;
}
void ExpectedUeBehaviourData::setScheduledCommunicationType(oai::_3gpp::model::ScheduledCommunicationType const& value)
{
...
std::vector<oai::_3gpp::model::LocationArea> ExpectedUeBehaviourData::getExpectedUmts() const
{
    return m_ExpectedUmts;
}
void ExpectedUeBehaviourData::setExpectedUmts(std::vector<oai::_3gpp::model::LocationArea> const& value)
{
...
oai::_3gpp::model::TrafficProfile ExpectedUeBehaviourData::getTrafficProfile() const
{
    return m_TrafficProfile;
}
void ExpectedUeBehaviourData::setTrafficProfile(oai::_3gpp::model::TrafficProfile const& value)
{
...
oai::_3gpp::model::BatteryIndication ExpectedUeBehaviourData::getBatteryIndication() const
{
    return m_BatteryIndication;
}
void ExpectedUeBehaviourData::setBatteryIndication(oai::_3gpp::model::BatteryIndication const& value)
{
