...
std::vector<oai::model::pcf::QueryParameter> QueryParamCombination::getQueryParams() const
{
    return m_QueryParams;
}
void QueryParamCombination::setQueryParams(std::vector<oai::model::pcf::QueryParameter> const& value)
{
    m_QueryParams = value;
}
