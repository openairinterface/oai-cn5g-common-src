...
asn_oer_constraints_t asn_OER_type_Ngap_TAIListForRestart_constr_1
    CC_NOTUSED = {{0, 0}, -1 /* (SIZE(1..2048)) */};
#endif /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
asn_per_constraints_t asn_PER_type_Ngap_TAIListForRestart_constr_1
    CC_NOTUSED = {
...
asn_TYPE_descriptor_t asn_DEF_Ngap_TAIListForRestart = {
    ...
    {
#if !defined(ASN_DISABLE_OER_SUPPORT)
        &asn_OER_type_Ngap_TAIListForRestart_constr_1,
#endif /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
        &asn_PER_type_Ngap_TAIListForRestart_constr_1,
#endif /* !defined(ASN_DISABLE_UPER_SUPPORT) ||                                \
          !defined(ASN_DISABLE_APER_SUPPORT) */
#if !defined(ASN_DISABLE_JER_SUPPORT)
        0,
