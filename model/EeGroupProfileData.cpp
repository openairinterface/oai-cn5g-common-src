...
bool EeGroupProfileData::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    ...
    {
        const std::vector<oai::_3gpp::model::EventType>& value = m_RestrictedEventTypes;
    ...
    {
        const std::map<std::string, std::vector<oai::_3gpp::model::MtcProvider>>& value = m_AllowedMtcProvider;
...
std::vector<oai::_3gpp::model::EventType> EeGroupProfileData::getRestrictedEventTypes() const
{
    return m_RestrictedEventTypes;
}
void EeGroupProfileData::setRestrictedEventTypes(std::vector<oai::_3gpp::model::EventType> const& value)
{
...
std::map<std::string, std::vector<oai::_3gpp::model::MtcProvider>> EeGroupProfileData::getAllowedMtcProvider() const
{
    return m_AllowedMtcProvider;
}
void EeGroupProfileData::setAllowedMtcProvider(std::map<std::string, std::vector<oai::_3gpp::model::MtcProvider>> const& value)
{
