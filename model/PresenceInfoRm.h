...
public:
    ...
    /// </summary>
    std::vector<oai::_3gpp::model::GlobalRanNodeId> getGlobalRanNodeIdList() const;
    void setGlobalRanNodeIdList(std::vector<oai::_3gpp::model::GlobalRanNodeId> const& value);
    ...
    void setGlobaleNbIdList(std::vector<oai::_3gpp::model::GlobalRanNodeId> const& value);
