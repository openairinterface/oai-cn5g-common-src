...
asn_TYPE_member_t asn_MBR_Ngap_InfoOnRecommendedCellsAndRANNodesForPaging_1[] = {
	{ ATF_POINTER, 0, offsetof(struct Ngap_InfoOnRecommendedCellsAndRANNodesForPaging, recommendedCellsForPaging),
	...
	{ ATF_POINTER, 0, offsetof(struct Ngap_InfoOnRecommendedCellsAndRANNodesForPaging, recommendRANNodesForPaging),
	...
	{ ATF_POINTER, 1, offsetof(struct Ngap_InfoOnRecommendedCellsAndRANNodesForPaging, iE_Extensions),
		...
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_Ngap_ProtocolExtensionContainer_12929P115,
		0,
		{
#if !defined(ASN_DISABLE_OER_SUPPORT)
			0,
