...
asn_oer_constraints_t asn_OER_type_Ngap_PDUSessionResourceFailedToSetupListCxtFail_constr_1 CC_NOTUSED = {
	{ 0, 0 },
	-1	/* (SIZE(1..256)) */};
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
asn_per_constraints_t asn_PER_type_Ngap_PDUSessionResourceFailedToSetupListCxtFail_constr_1 CC_NOTUSED = {
...
static const ber_tlv_tag_t asn_DEF_Ngap_PDUSessionResourceFailedToSetupListCxtFail_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
asn_SET_OF_specifics_t asn_SPC_Ngap_PDUSessionResourceFailedToSetupListCxtFail_specs_1 = {
	...
	offsetof(struct Ngap_PDUSessionResourceFailedToSetupListCxtFail, _asn_ctx),
...
asn_TYPE_descriptor_t asn_DEF_Ngap_PDUSessionResourceFailedToSetupListCxtFail = {
	...
	asn_DEF_Ngap_PDUSessionResourceFailedToSetupListCxtFail_tags_1,	/* Same as above */
	sizeof(asn_DEF_Ngap_PDUSessionResourceFailedToSetupListCxtFail_tags_1)
		/sizeof(asn_DEF_Ngap_PDUSessionResourceFailedToSetupListCxtFail_tags_1[0]), /* 1 */
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
	...
	1,	/* Single element */
	&asn_SPC_Ngap_PDUSessionResourceFailedToSetupListCxtFail_specs_1	/* Additional specs */
};
