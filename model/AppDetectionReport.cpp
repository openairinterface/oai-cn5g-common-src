...
oai::model::AppDetectionNotifType AppDetectionReport::getAdNotifType() const
{
    return m_AdNotifType;
}
void AppDetectionReport::setAdNotifType(oai::model::AppDetectionNotifType const& value)
{
    m_AdNotifType = value;
}
