...
bool TransferMtDataError::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "TransferMtDataError" : pathPrefix;
...
bool TransferMtDataError::operator==(const TransferMtDataError& rhs) const
{
    ...
    ((!remoteErrorIsSet() && !rhs.remoteErrorIsSet()) || (remoteErrorIsSet() && rhs.remoteErrorIsSet() && isRemoteError() == rhs.isRemoteError())) &&
...
std::vector<oai::_3gpp::model::InvalidParam> TransferMtDataError::getInvalidParams() const
{
    return m_InvalidParams;
}
void TransferMtDataError::setInvalidParams(std::vector<oai::_3gpp::model::InvalidParam> const& value)
{
...
oai::_3gpp::model::AccessTokenErr TransferMtDataError::getAccessTokenError() const
{
    return m_AccessTokenError;
}
void TransferMtDataError::setAccessTokenError(oai::_3gpp::model::AccessTokenErr const& value)
{
...
oai::_3gpp::model::AccessTokenReq TransferMtDataError::getAccessTokenRequest() const
{
    return m_AccessTokenRequest;
}
void TransferMtDataError::setAccessTokenRequest(oai::_3gpp::model::AccessTokenReq const& value)
{
