...
std::vector<oai::model::pcf::Flows> AccessNetChargingIdentifier::getFlows() const
{
    return m_Flows;
}
void AccessNetChargingIdentifier::setFlows(std::vector<oai::model::pcf::Flows> const& value)
{
    m_Flows = value;
    m_FlowsIsSet = true;
}
