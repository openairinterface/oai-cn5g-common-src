...
public:
    ...
    SteeringFunctionality_anyOf::eSteeringFunctionality_anyOf getEnumValue() const;
    void setEnumValue(SteeringFunctionality_anyOf::eSteeringFunctionality_anyOf value);
