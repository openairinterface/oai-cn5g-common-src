...
bool DefaultNotificationSubscription::validate(
    std::stringstream& msg, const std::string& pathPrefix) const {
  bool success = true;
  const std::string _pathPrefix =
      pathPrefix.empty() ? "DefaultNotificationSubscription" : pathPrefix;
  ...
  if (serviceInfoListIsSet()) {
    const std::map<std::string, oai::_3gpp::model::DefSubServiceInfo>& value =
        m_ServiceInfoList;
...
bool DefaultNotificationSubscription::operator==(
    const DefaultNotificationSubscription& rhs) const {
  return
      ...
      ((!interPlmnCallbackUriIsSet() && !rhs.interPlmnCallbackUriIsSet()) ||
       (interPlmnCallbackUriIsSet() && rhs.interPlmnCallbackUriIsSet() &&
        getInterPlmnCallbackUri() == rhs.getInterPlmnCallbackUri())) &&
      ...
      ((!bindingIsSet() && !rhs.bindingIsSet()) ||
       (bindingIsSet() && rhs.bindingIsSet() &&
        getBinding() == rhs.getBinding())) &&

      ((!acceptedEncodingIsSet() && !rhs.acceptedEncodingIsSet()) ||
       (acceptedEncodingIsSet() && rhs.acceptedEncodingIsSet() &&
        getAcceptedEncoding() == rhs.getAcceptedEncoding())) &&

      ((!supportedFeaturesIsSet() && !rhs.supportedFeaturesIsSet()) ||
       (supportedFeaturesIsSet() && rhs.supportedFeaturesIsSet() &&
        getSupportedFeatures() == rhs.getSupportedFeatures())) &&

      ((!serviceInfoListIsSet() && !rhs.serviceInfoListIsSet()) ||
       (serviceInfoListIsSet() && rhs.serviceInfoListIsSet() &&
        getServiceInfoList() == rhs.getServiceInfoList()))
...
void to_json(nlohmann::json& j, const DefaultNotificationSubscription& o) {
  ...
  if (o.bindingIsSet()) j["binding"] = o.m_Binding;
  if (o.acceptedEncodingIsSet()) j["acceptedEncoding"] = o.m_AcceptedEncoding;
...
oai::_3gpp::model::NotificationType
DefaultNotificationSubscription::getNotificationType() const {
  return m_NotificationType;
}
void DefaultNotificationSubscription::setNotificationType(
    oai::_3gpp::model::NotificationType const& value) {
...
void DefaultNotificationSubscription::setInterPlmnCallbackUri(
...
DefaultNotificationSubscription::getN1MessageClass() const {
...
std::map<std::string, oai::_3gpp::model::DefSubServiceInfo>
DefaultNotificationSubscription::getServiceInfoList() const {
  return m_ServiceInfoList;
}
void DefaultNotificationSubscription::setServiceInfoList(
    std::map<std::string, oai::_3gpp::model::DefSubServiceInfo> const& value) {
