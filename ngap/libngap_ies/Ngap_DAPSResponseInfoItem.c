...
asn_TYPE_member_t asn_MBR_Ngap_DAPSResponseInfoItem_1[] = {
    {ATF_NOFLAGS,
     0,
     offsetof(struct Ngap_DAPSResponseInfoItem, dRB_ID),
    ...
    {ATF_POINTER,
     0,
     offsetof(struct Ngap_DAPSResponseInfoItem, dAPSResponseInfo),
    ...
    {ATF_POINTER,
     1,
     offsetof(struct Ngap_DAPSResponseInfoItem, iE_Extension),
     (ASN_TAG_CLASS_CONTEXT | (2 << 2)),
     -1, /* IMPLICIT tag at current level */
     &asn_DEF_Ngap_ProtocolExtensionContainer_12929P55,
     0,
     {
#if !defined(ASN_DISABLE_OER_SUPPORT)
         0,
