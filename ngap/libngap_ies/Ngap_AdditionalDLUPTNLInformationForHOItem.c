...
asn_TYPE_member_t asn_MBR_Ngap_AdditionalDLUPTNLInformationForHOItem_1[] = {
	{ ATF_POINTER, 0, offsetof(struct Ngap_AdditionalDLUPTNLInformationForHOItem, additionalDL_NGU_UP_TNLInformation),
	...
	{ ATF_POINTER, 0, offsetof(struct Ngap_AdditionalDLUPTNLInformationForHOItem, additionalQosFlowSetupResponseList),
