...
bool TraceDepth::validate(std::stringstream &msg,
...
TraceDepth_anyOf TraceDepth::getValue() const { return m_value; }

void TraceDepth::setValue(TraceDepth_anyOf value) { m_value = value; }
