...
bool AccuUsageReport::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "AccuUsageReport" : pathPrefix;
...
bool AccuUsageReport::operator==(const AccuUsageReport& rhs) const
{
    ...
    ((!volUsageIsSet() && !rhs.volUsageIsSet()) || (volUsageIsSet() && rhs.volUsageIsSet() && getVolUsage() == rhs.getVolUsage())) &&
    
    
    ((!volUsageUplinkIsSet() && !rhs.volUsageUplinkIsSet()) || (volUsageUplinkIsSet() && rhs.volUsageUplinkIsSet() && getVolUsageUplink() == rhs.getVolUsageUplink())) &&
    
    
    ((!volUsageDownlinkIsSet() && !rhs.volUsageDownlinkIsSet()) || (volUsageDownlinkIsSet() && rhs.volUsageDownlinkIsSet() && getVolUsageDownlink() == rhs.getVolUsageDownlink())) &&
    
    
    ((!timeUsageIsSet() && !rhs.timeUsageIsSet()) || (timeUsageIsSet() && rhs.timeUsageIsSet() && getTimeUsage() == rhs.getTimeUsage())) &&
    
    
    ((!nextVolUsageIsSet() && !rhs.nextVolUsageIsSet()) || (nextVolUsageIsSet() && rhs.nextVolUsageIsSet() && getNextVolUsage() == rhs.getNextVolUsage())) &&
    
    
    ((!nextVolUsageUplinkIsSet() && !rhs.nextVolUsageUplinkIsSet()) || (nextVolUsageUplinkIsSet() && rhs.nextVolUsageUplinkIsSet() && getNextVolUsageUplink() == rhs.getNextVolUsageUplink())) &&
    
    
    ((!nextVolUsageDownlinkIsSet() && !rhs.nextVolUsageDownlinkIsSet()) || (nextVolUsageDownlinkIsSet() && rhs.nextVolUsageDownlinkIsSet() && getNextVolUsageDownlink() == rhs.getNextVolUsageDownlink())) &&
    
    
    ((!nextTimeUsageIsSet() && !rhs.nextTimeUsageIsSet()) || (nextTimeUsageIsSet() && rhs.nextTimeUsageIsSet() && getNextTimeUsage() == rhs.getNextTimeUsage()))
