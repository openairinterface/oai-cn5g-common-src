...
public:
    ...
    /// 
    /// </summary>
    std::vector<oai::_3gpp::model::SnssaiRouteSelectionDescriptor> getSnssaiRouteSelDescs() const;
    void setSnssaiRouteSelDescs(std::vector<oai::_3gpp::model::SnssaiRouteSelectionDescriptor> const& value);
...
protected:
    ...
    std::vector<oai::_3gpp::model::SnssaiRouteSelectionDescriptor> m_SnssaiRouteSelDescs;
