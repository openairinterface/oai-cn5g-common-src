...
std::vector<oai::model::SupiRange> PcfInfo::getSupiRanges() const
{
    return m_SupiRanges;
}
void PcfInfo::setSupiRanges(std::vector<oai::model::SupiRange> const& value)
{
    m_SupiRanges = value;
...
std::vector<oai::model::IdentityRange> PcfInfo::getGpsiRanges() const
{
    return m_GpsiRanges;
}
void PcfInfo::setGpsiRanges(std::vector<oai::model::IdentityRange> const& value)
{
    m_GpsiRanges = value;
...
oai::model::ProSeCapability PcfInfo::getProseCapability() const
{
    return m_ProseCapability;
}
void PcfInfo::setProseCapability(oai::model::ProSeCapability const& value)
{
...
oai::model::V2xCapability PcfInfo::getV2xCapability() const
{
    return m_V2xCapability;
}
void PcfInfo::setV2xCapability(oai::model::V2xCapability const& value)
{
