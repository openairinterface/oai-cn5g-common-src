...
public:
    ...
    bool operator==(const DccfCond& rhs) const;
    bool operator!=(const DccfCond& rhs) const;
    ...
    friend  void to_json(nlohmann::json& j, const DccfCond& o);
    friend  void from_json(const nlohmann::json& j, DccfCond& o);
protected:
