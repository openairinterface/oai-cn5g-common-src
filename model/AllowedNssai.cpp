...
bool AllowedNssai::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    ...
    /* AllowedSnssaiList */ {
        const std::vector<oai::model::AllowedSnssai>& value = m_AllowedSnssaiList;
        ...
        { // Recursive validation of array elements
            ...
            int i = 0;
            for (const oai::model::AllowedSnssai& value : value)
            { 
...
std::vector<oai::model::AllowedSnssai> AllowedNssai::getAllowedSnssaiList() const
{
    return m_AllowedSnssaiList;
}
void AllowedNssai::setAllowedSnssaiList(std::vector<oai::model::AllowedSnssai> const& value)
{
    m_AllowedSnssaiList = value;
}
oai::model::AccessType AllowedNssai::getAccessType() const
{
    return m_AccessType;
}
void AllowedNssai::setAccessType(oai::model::AccessType const& value)
{
    m_AccessType = value;
}
