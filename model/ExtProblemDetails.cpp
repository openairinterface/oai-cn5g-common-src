...
std::vector<oai::model::InvalidParam> ExtProblemDetails::getInvalidParams() const
{
    return m_InvalidParams;
}
void ExtProblemDetails::setInvalidParams(std::vector<oai::model::InvalidParam> const& value)
{
...
oai::model::AccessTokenErr ExtProblemDetails::getAccessTokenError() const
{
    return m_AccessTokenError;
}
void ExtProblemDetails::setAccessTokenError(oai::model::AccessTokenErr const& value)
{
...
oai::model::AccessTokenReq ExtProblemDetails::getAccessTokenRequest() const
{
    return m_AccessTokenRequest;
}
void ExtProblemDetails::setAccessTokenRequest(oai::model::AccessTokenReq const& value)
{
