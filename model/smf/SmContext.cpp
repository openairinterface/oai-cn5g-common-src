...
std::string SmContext::getSupi() const { return m_Supi; }
void SmContext::setSupi(std::string const &value) {
  m_Supi = value;
  m_SupiIsSet = true;
}
bool SmContext::supiIsSet() const { return m_SupiIsSet; }
void SmContext::unsetSupi() { m_SupiIsSet = false; }
bool SmContext::isUnauthenticatedSupi() const { return m_UnauthenticatedSupi; }
...
std::string SmContext::getPei() const { return m_Pei; }
void SmContext::setPei(std::string const &value) {
  m_Pei = value;
  m_PeiIsSet = true;
}
bool SmContext::peiIsSet() const { return m_PeiIsSet; }
void SmContext::unsetPei() { m_PeiIsSet = false; }
...
oai::model::common::Snssai SmContext::getSNssai() const { return m_SNssai; }
...
std::string SmContext::getServingNfId() const { return m_ServingNfId; }
void SmContext::setServingNfId(std::string const &value) {
  m_ServingNfId = value;
}
Guami SmContext::getGuami() const { return m_Guami; }
void SmContext::setGuami(Guami const &value) {
  m_Guami = value;
  m_GuamiIsSet = true;
}
bool SmContext::guamiIsSet() const { return m_GuamiIsSet; }
void SmContext::unsetGuami() { m_GuamiIsSet = false; }
ServiceName SmContext::getServiceName() const { return m_ServiceName; }
void SmContext::setServiceName(ServiceName const &value) {
  m_ServiceName = value;
  m_ServiceNameIsSet = true;
}
bool SmContext::serviceNameIsSet() const { return m_ServiceNameIsSet; }
void SmContext::unsetServiceName() { m_ServiceNameIsSet = false; }
...
oai::model::common::AccessType SmContext::getAnType() const { return m_AnType; }
void SmContext::setAnType(oai::model::common::AccessType const &value) {
  m_AnType = value;
}
RatType SmContext::getRatType() const { return m_RatType; }
void SmContext::setRatType(RatType const &value) {
  m_RatType = value;
  m_RatTypeIsSet = true;
}
bool SmContext::ratTypeIsSet() const { return m_RatTypeIsSet; }
void SmContext::unsetRatType() { m_RatTypeIsSet = false; }
...
TraceData SmContext::getTraceData() const { return m_TraceData; }
void SmContext::setTraceData(TraceData const &value) {
  m_TraceData = value;
  m_TraceDataIsSet = true;
}
bool SmContext::traceDataIsSet() const { return m_TraceDataIsSet; }
void SmContext::unsetTraceData() { m_TraceDataIsSet = false; }
...
void SmContext::unsetEpsInterworkingInd() { m_EpsInterworkingIndIsSet = false; }
...
std::string SmContext::getSscMode() const { return m_SscMode; }
void SmContext::setSscMode(std::string const &value) { m_SscMode = value; }
...
std::string SmContext::getUeIpv6Prefix() const { return m_UeIpv6Prefix; }
