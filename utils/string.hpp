 ...
 * @return void
 */
void ipv4v6_to_pdu_address_information(struct in_addr ipv4_address,
                                       struct in6_addr ipv6_address,
                                       bstring str);
bool pdu_address_information_to_ipv4v6(bstring str, struct in_addr ipv4_address,
                                       struct in6_addr ipv6_address);
 ...
 * @return void
 */
void ipv4v6_to_transport_layer_address(struct in_addr ipv4_address,
                                       struct in6_addr ipv6_address,
                                       bstring str);
} // namespace oai::utils
#endif
