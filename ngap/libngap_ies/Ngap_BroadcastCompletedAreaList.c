...
asn_oer_constraints_t asn_OER_type_Ngap_BroadcastCompletedAreaList_constr_1
    CC_NOTUSED = {{0, 0}, -1};
...
asn_TYPE_member_t asn_MBR_Ngap_BroadcastCompletedAreaList_1[] = {
    ...
    {ATF_POINTER,
     0,
     offsetof(struct Ngap_BroadcastCompletedAreaList, choice.tAIBroadcastEUTRA),
    ...
    {ATF_POINTER,
     0,
     offsetof(struct Ngap_BroadcastCompletedAreaList, choice.cellIDBroadcastNR),
    ...
    {ATF_POINTER,
     0,
     offsetof(struct Ngap_BroadcastCompletedAreaList, choice.tAIBroadcastNR),
    ...
    {ATF_POINTER,
     ...
     -1, /* IMPLICIT tag at current level */
     &asn_DEF_Ngap_ProtocolIE_SingleContainer_12877P5,
     0,
     {
#if !defined(ASN_DISABLE_OER_SUPPORT)
         0,
...
static const asn_TYPE_tag2member_t
    asn_MAP_Ngap_BroadcastCompletedAreaList_tag2el_1[] = {
        ...
        {(ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0,
         0}, /* emergencyAreaIDBroadcastEUTRA */
