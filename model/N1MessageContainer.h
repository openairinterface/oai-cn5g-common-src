...
public:
    ...
    /// 
    /// </summary>
    oai::model::RefToBinaryData getN1MessageContent() const;
    void setN1MessageContent(oai::model::RefToBinaryData const& value);
    /// <summary>
...
protected:
    ...
    oai::model::RefToBinaryData m_N1MessageContent;
