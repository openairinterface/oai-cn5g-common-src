...
bool ReportingOptions::validate(std::stringstream &msg,
...
NotificationFlag ReportingOptions::getNotifFlag() const { return m_NotifFlag; }
void ReportingOptions::setNotifFlag(NotificationFlag const &value) {
  m_NotifFlag = value;
  m_NotifFlagIsSet = true;
}
bool ReportingOptions::notifFlagIsSet() const { return m_NotifFlagIsSet; }
void ReportingOptions::unsetNotifFlag() { m_NotifFlagIsSet = false; }
