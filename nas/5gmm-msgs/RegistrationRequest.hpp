...
public:
  ...
  void SetSuciSupiFormatImsi(const std::string &mcc, const std::string &mnc,
  ...
  void SetImeiImeisv();
  void Set5gSTmsi();
  void SetAdditionalGuti(const std::string &mcc, const std::string &mnc,
                         uint8_t amf_region_id, uint8_t amf_set_id,
                         uint8_t amf_pointer, const std::string &_5g_tmsi);
  ...
  void SetUeSecurityCapability(uint8_t ea, uint8_t ia, uint8_t eea,
                               uint8_t eia);
  bool GetUeSecurityCapability(uint8_t &ea, uint8_t &ia) const;
  // TODO: use std::optional for optional fields eea,eia
  bool GetUeSecurityCapability(uint8_t &ea, uint8_t &ia, uint8_t &eea,
                               uint8_t &eia) const;
  ...
  void SetLastVisitedRegisteredTai(const std::string &mcc,
                                   const std::string &mnc, uint32_t tac);
  // TODO: Getter
  ...
  void Set5gsUpdateType(uint8_t eps_pnb_ciot, uint8_t _5gs_pnb_ciot,
                        bool ng_ran, bool sms);
  bool Get5gsUpdateType(uint8_t &eps_pnb_ciot, uint8_t &_5gs_pnb_ciot,
                        bool &ng_ran_rcu, bool &sms_requested) const;
...
private:
  ...
  std::optional<NasKeySetIdentifier> ie_non_current_native_nas_ksi_; // Optional
