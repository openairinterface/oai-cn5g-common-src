...
bool TrafficCharacterization::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    ...
    if (fDescsIsSet())
    {
        const std::vector<oai::model::IpEthFlowDescription>& value = m_FDescs;
...
oai::model::Snssai TrafficCharacterization::getSnssai() const
{
    return m_Snssai;
}
void TrafficCharacterization::setSnssai(oai::model::Snssai const& value)
{
    m_Snssai = value;
    m_SnssaiIsSet = true;
}
...
std::vector<oai::model::IpEthFlowDescription> TrafficCharacterization::getFDescs() const
{
    return m_FDescs;
}
void TrafficCharacterization::setFDescs(std::vector<oai::model::IpEthFlowDescription> const& value)
{
    m_FDescs = value;
    m_FDescsIsSet = true;
}
