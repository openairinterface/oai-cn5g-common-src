...
bool AreaEventInfoExt::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "AreaEventInfoExt" : pathPrefix;

         
    
    /* AreaDefinition */ {
        const std::vector<oai::_3gpp::model::ReportingArea>& value = m_AreaDefinition;
        ...
        success = value.validate(msg, currentValuePath + ".areaDefinition") && success;
    ...
    if (geoAreaListIsSet())
    {
        ...
        success = value.validate(msg, currentValuePath + ".geoAreaList") && success;
...
bool AreaEventInfoExt::operator==(const AreaEventInfoExt& rhs) const
{
    ...
    ((!occurrenceInfoIsSet() && !rhs.occurrenceInfoIsSet()) || (occurrenceInfoIsSet() && rhs.occurrenceInfoIsSet() && getOccurrenceInfo() == rhs.getOccurrenceInfo())) &&
    
    
    ((!minimumIntervalIsSet() && !rhs.minimumIntervalIsSet()) || (minimumIntervalIsSet() && rhs.minimumIntervalIsSet() && getMinimumInterval() == rhs.getMinimumInterval())) &&
    
    
    ((!maximumIntervalIsSet() && !rhs.maximumIntervalIsSet()) || (maximumIntervalIsSet() && rhs.maximumIntervalIsSet() && getMaximumInterval() == rhs.getMaximumInterval())) &&
    
    
    ((!samplingIntervalIsSet() && !rhs.samplingIntervalIsSet()) || (samplingIntervalIsSet() && rhs.samplingIntervalIsSet() && getSamplingInterval() == rhs.getSamplingInterval())) &&
    
    
    ((!reportingDurationIsSet() && !rhs.reportingDurationIsSet()) || (reportingDurationIsSet() && rhs.reportingDurationIsSet() && getReportingDuration() == rhs.getReportingDuration())) &&
    
    
    ((!reportingLocationReqIsSet() && !rhs.reportingLocationReqIsSet()) || (reportingLocationReqIsSet() && rhs.reportingLocationReqIsSet() && isReportingLocationReq() == rhs.isReportingLocationReq())) &&
    
    
    ((!geoAreaListIsSet() && !rhs.geoAreaListIsSet()) || (geoAreaListIsSet() && rhs.geoAreaListIsSet() && getGeoAreaList() == rhs.getGeoAreaList())) &&
    
    
    ((!ignoreAreaDefIndIsSet() && !rhs.ignoreAreaDefIndIsSet()) || (ignoreAreaDefIndIsSet() && rhs.ignoreAreaDefIndIsSet() && isIgnoreAreaDefInd() == rhs.isIgnoreAreaDefInd()))
...
std::vector<oai::_3gpp::model::ReportingArea> AreaEventInfoExt::getAreaDefinition() const
{
    return m_AreaDefinition;
}
void AreaEventInfoExt::setAreaDefinition(std::vector<oai::_3gpp::model::ReportingArea> const& value)
{
...
void AreaEventInfoExt::setOccurrenceInfo(oai::_3gpp::model::OccurrenceInfo const& value)
{
...
std::vector<oai::_3gpp::model::GeographicArea> AreaEventInfoExt::getGeoAreaList() const
{
    return m_GeoAreaList;
}
void AreaEventInfoExt::setGeoAreaList(std::vector<oai::_3gpp::model::GeographicArea> const& value)
{
    m_GeoAreaList = value;
