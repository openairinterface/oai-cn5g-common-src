...
bool FlowDirection::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
...
void FlowDirection::setEnumValue(FlowDirection_anyOf::eFlowDirection_anyOf  value)
{
