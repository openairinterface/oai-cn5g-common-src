...
oai::model::N1MessageContainer N1N2MessageTransferReqData::getN1MessageContainer() const
{
    return m_N1MessageContainer;
}
void N1N2MessageTransferReqData::setN1MessageContainer(oai::model::N1MessageContainer const& value)
{
...
oai::model::N2InfoContainer N1N2MessageTransferReqData::getN2InfoContainer() const
{
    return m_N2InfoContainer;
}
void N1N2MessageTransferReqData::setN2InfoContainer(oai::model::N2InfoContainer const& value)
{
...
oai::model::RefToBinaryData N1N2MessageTransferReqData::getMtData() const
{
    return m_MtData;
}
void N1N2MessageTransferReqData::setMtData(oai::model::RefToBinaryData const& value)
{
    m_MtData = value;
    m_MtDataIsSet = true;
}
...
oai::model::Arp N1N2MessageTransferReqData::getArp() const
{
    return m_Arp;
}
void N1N2MessageTransferReqData::setArp(oai::model::Arp const& value)
{
    m_Arp = value;
    m_ArpIsSet = true;
}
...
oai::model::AreaOfValidity N1N2MessageTransferReqData::getAreaOfValidity() const
{
    return m_AreaOfValidity;
}
void N1N2MessageTransferReqData::setAreaOfValidity(oai::model::AreaOfValidity const& value)
{
...
oai::model::Guami N1N2MessageTransferReqData::getOldGuami() const
{
    return m_OldGuami;
}
void N1N2MessageTransferReqData::setOldGuami(oai::model::Guami const& value)
{
    m_OldGuami = value;
...
oai::model::AccessType N1N2MessageTransferReqData::getTargetAccess() const
{
    return m_TargetAccess;
}
void N1N2MessageTransferReqData::setTargetAccess(oai::model::AccessType const& value)
{
