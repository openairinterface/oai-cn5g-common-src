...
asn_TYPE_member_t asn_MBR_Ngap_UL_NGU_UP_TNLModifyItem_1[] = {
    {ATF_POINTER,
     0,
     offsetof(struct Ngap_UL_NGU_UP_TNLModifyItem, uL_NGU_UP_TNLInformation),
    ...
    {ATF_POINTER,
     0,
     offsetof(struct Ngap_UL_NGU_UP_TNLModifyItem, dL_NGU_UP_TNLInformation),
    ...
    {ATF_POINTER,
     1,
     offsetof(struct Ngap_UL_NGU_UP_TNLModifyItem, iE_Extensions),
     (ASN_TAG_CLASS_CONTEXT | (2 << 2)),
     -1, /* IMPLICIT tag at current level */
     &asn_DEF_Ngap_ProtocolExtensionContainer_12929P360,
     0,
     {
#if !defined(ASN_DISABLE_OER_SUPPORT)
         0,
