...
void NwdafCond::setTaiRangeList(
...
void NwdafCond::setServingNfTypeList(
...
std::vector<oai::_3gpp::model::MlAnalyticsInfo> NwdafCond::getMlAnalyticsList()
    const {
  return m_MlAnalyticsList;
}
void NwdafCond::setMlAnalyticsList(
