...
NrfInfo_servedBsfInfo_value::NrfInfo_servedBsfInfo_value()
{
...
void NrfInfo_servedBsfInfo_value::validate() const
{
...
bool NrfInfo_servedBsfInfo_value::validate(std::stringstream& msg) const
{
    return validate(msg, "");
}

bool NrfInfo_servedBsfInfo_value::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "NrfInfo_servedBsfInfo_value" : pathPrefix;
    ...
    {
        const std::vector<oai::model::Ipv4AddressRange>& value = m_Ipv4AddressRanges;
    ...
    if (supiRangesIsSet())
    {
        const std::vector<oai::model::SupiRange>& value = m_SupiRanges;
        ...
        { // Recursive validation of array elements
            const std::string oldValuePath = currentValuePath;
            int i = 0;
            for (const oai::model::SupiRange& value : value)
            { 
                const std::string currentValuePath = oldValuePath + "[" + std::to_string(i) + "]";
    ...
    if (gpsiRangesIsSet())
    {
        const std::vector<oai::model::IdentityRange>& value = m_GpsiRanges;
        ...
        { // Recursive validation of array elements
            const std::string oldValuePath = currentValuePath;
            int i = 0;
            for (const oai::model::IdentityRange& value : value)
            { 
                const std::string currentValuePath = oldValuePath + "[" + std::to_string(i) + "]";
...
bool NrfInfo_servedBsfInfo_value::operator==(const NrfInfo_servedBsfInfo_value& rhs) const
{
    return
...
void to_json(nlohmann::json& j, const NrfInfo_servedBsfInfo_value& o)
{
...
void from_json(const nlohmann::json& j, NrfInfo_servedBsfInfo_value& o)
{
...
std::vector<std::string> NrfInfo_servedBsfInfo_value::getDnnList() const
{
    return m_DnnList;
}
void NrfInfo_servedBsfInfo_value::setDnnList(std::vector<std::string> const& value)
{
    m_DnnList = value;
    m_DnnListIsSet = true;
}
bool NrfInfo_servedBsfInfo_value::dnnListIsSet() const
{
    return m_DnnListIsSet;
}
void NrfInfo_servedBsfInfo_value::unsetDnnList()
{
    m_DnnListIsSet = false;
}
std::vector<std::string> NrfInfo_servedBsfInfo_value::getIpDomainList() const
{
    return m_IpDomainList;
}
void NrfInfo_servedBsfInfo_value::setIpDomainList(std::vector<std::string> const& value)
{
    m_IpDomainList = value;
    m_IpDomainListIsSet = true;
}
bool NrfInfo_servedBsfInfo_value::ipDomainListIsSet() const
{
    return m_IpDomainListIsSet;
}
void NrfInfo_servedBsfInfo_value::unsetIpDomainList()
{
    m_IpDomainListIsSet = false;
}
std::vector<oai::model::Ipv4AddressRange> NrfInfo_servedBsfInfo_value::getIpv4AddressRanges() const
{
    return m_Ipv4AddressRanges;
}
void NrfInfo_servedBsfInfo_value::setIpv4AddressRanges(std::vector<oai::model::Ipv4AddressRange> const& value)
{
    m_Ipv4AddressRanges = value;
    m_Ipv4AddressRangesIsSet = true;
}
bool NrfInfo_servedBsfInfo_value::ipv4AddressRangesIsSet() const
{
    return m_Ipv4AddressRangesIsSet;
}
void NrfInfo_servedBsfInfo_value::unsetIpv4AddressRanges()
{
    m_Ipv4AddressRangesIsSet = false;
}
std::vector<oai::model::Ipv6PrefixRange> NrfInfo_servedBsfInfo_value::getIpv6PrefixRanges() const
{
    return m_Ipv6PrefixRanges;
}
void NrfInfo_servedBsfInfo_value::setIpv6PrefixRanges(std::vector<oai::model::Ipv6PrefixRange> const& value)
{
    m_Ipv6PrefixRanges = value;
    m_Ipv6PrefixRangesIsSet = true;
}
bool NrfInfo_servedBsfInfo_value::ipv6PrefixRangesIsSet() const
{
    return m_Ipv6PrefixRangesIsSet;
}
void NrfInfo_servedBsfInfo_value::unsetIpv6PrefixRanges()
{
    m_Ipv6PrefixRangesIsSet = false;
}
std::string NrfInfo_servedBsfInfo_value::getRxDiamHost() const
{
    return m_RxDiamHost;
}
void NrfInfo_servedBsfInfo_value::setRxDiamHost(std::string const& value)
{
    m_RxDiamHost = value;
    m_RxDiamHostIsSet = true;
}
bool NrfInfo_servedBsfInfo_value::rxDiamHostIsSet() const
{
    return m_RxDiamHostIsSet;
}
void NrfInfo_servedBsfInfo_value::unsetRxDiamHost()
{
    m_RxDiamHostIsSet = false;
}
std::string NrfInfo_servedBsfInfo_value::getRxDiamRealm() const
{
    return m_RxDiamRealm;
}
void NrfInfo_servedBsfInfo_value::setRxDiamRealm(std::string const& value)
{
    m_RxDiamRealm = value;
    m_RxDiamRealmIsSet = true;
}
bool NrfInfo_servedBsfInfo_value::rxDiamRealmIsSet() const
{
    return m_RxDiamRealmIsSet;
}
void NrfInfo_servedBsfInfo_value::unsetRxDiamRealm()
{
    m_RxDiamRealmIsSet = false;
}
std::string NrfInfo_servedBsfInfo_value::getGroupId() const
{
    return m_GroupId;
}
void NrfInfo_servedBsfInfo_value::setGroupId(std::string const& value)
{
    m_GroupId = value;
    m_GroupIdIsSet = true;
}
bool NrfInfo_servedBsfInfo_value::groupIdIsSet() const
{
    return m_GroupIdIsSet;
}
void NrfInfo_servedBsfInfo_value::unsetGroupId()
{
    m_GroupIdIsSet = false;
}
std::vector<oai::model::SupiRange> NrfInfo_servedBsfInfo_value::getSupiRanges() const
{
    return m_SupiRanges;
}
void NrfInfo_servedBsfInfo_value::setSupiRanges(std::vector<oai::model::SupiRange> const& value)
{
    m_SupiRanges = value;
    m_SupiRangesIsSet = true;
}
bool NrfInfo_servedBsfInfo_value::supiRangesIsSet() const
{
    return m_SupiRangesIsSet;
}
void NrfInfo_servedBsfInfo_value::unsetSupiRanges()
{
    m_SupiRangesIsSet = false;
}
std::vector<oai::model::IdentityRange> NrfInfo_servedBsfInfo_value::getGpsiRanges() const
{
    return m_GpsiRanges;
}
void NrfInfo_servedBsfInfo_value::setGpsiRanges(std::vector<oai::model::IdentityRange> const& value)
{
    m_GpsiRanges = value;
    m_GpsiRangesIsSet = true;
}
bool NrfInfo_servedBsfInfo_value::gpsiRangesIsSet() const
{
    return m_GpsiRangesIsSet;
}
void NrfInfo_servedBsfInfo_value::unsetGpsiRanges()
{
    m_GpsiRangesIsSet = false;
}
