...
bool N2InfoContent::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "N2InfoContent" : pathPrefix;
...
bool N2InfoContent::operator==(const N2InfoContent& rhs) const
{
    ...
    ((!ngapMessageTypeIsSet() && !rhs.ngapMessageTypeIsSet()) || (ngapMessageTypeIsSet() && rhs.ngapMessageTypeIsSet() && getNgapMessageType() == rhs.getNgapMessageType())) &&
    
    
    ((!ngapIeTypeIsSet() && !rhs.ngapIeTypeIsSet()) || (ngapIeTypeIsSet() && rhs.ngapIeTypeIsSet() && getNgapIeType() == rhs.getNgapIeType())) &&
...
oai::model::NgapIeType N2InfoContent::getNgapIeType() const
{
    return m_NgapIeType;
}
void N2InfoContent::setNgapIeType(oai::model::NgapIeType const& value)
{
    m_NgapIeType = value;
...
oai::model::RefToBinaryData N2InfoContent::getNgapData() const
{
    return m_NgapData;
}
void N2InfoContent::setNgapData(oai::model::RefToBinaryData const& value)
{
    m_NgapData = value;
}
