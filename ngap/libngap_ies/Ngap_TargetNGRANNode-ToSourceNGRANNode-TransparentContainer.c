...
static asn_TYPE_member_t
    asn_MBR_Ngap_TargetNGRANNode_ToSourceNGRANNode_TransparentContainer_1[] = {
        {ATF_NOFLAGS,
         0,
         offsetof(
             struct Ngap_TargetNGRANNode_ToSourceNGRANNode_TransparentContainer,
             rRCContainer),
        ...
        {ATF_POINTER,
         ...
         -1, /* IMPLICIT tag at current level */
         &asn_DEF_Ngap_ProtocolExtensionContainer_12929P328,
         0,
         {
#if !defined(ASN_DISABLE_OER_SUPPORT)
             0,
...
static const int
    asn_MAP_Ngap_TargetNGRANNode_ToSourceNGRANNode_TransparentContainer_oms_1
        [] = {1};
...
static asn_SEQUENCE_specifics_t
    asn_SPC_Ngap_TargetNGRANNode_ToSourceNGRANNode_TransparentContainer_specs_1 = {
        sizeof(
            struct Ngap_TargetNGRANNode_ToSourceNGRANNode_TransparentContainer),
        offsetof(
            struct Ngap_TargetNGRANNode_ToSourceNGRANNode_TransparentContainer,
