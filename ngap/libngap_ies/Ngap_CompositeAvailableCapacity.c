...
static int memb_Ngap_cellCapacityClassValue_constraint_1(
...
static int memb_Ngap_capacityValue_constraint_1(
    const asn_TYPE_descriptor_t* td, const void* sptr,
    asn_app_constraint_failed_f* ctfailcb, void* app_key) {
  long value;
...
static asn_oer_constraints_t asn_OER_memb_Ngap_cellCapacityClassValue_constr_2
    CC_NOTUSED = {{0, 0}, -1};
#endif /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
static asn_per_constraints_t asn_PER_memb_Ngap_cellCapacityClassValue_constr_2
    CC_NOTUSED = {
...
#if !defined(ASN_DISABLE_OER_SUPPORT)
static asn_oer_constraints_t asn_OER_memb_Ngap_capacityValue_constr_3
    CC_NOTUSED = {{1, 1} /* (0..100) */, -1};
#endif /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
static asn_per_constraints_t asn_PER_memb_Ngap_capacityValue_constr_3
    CC_NOTUSED = {
...
asn_TYPE_member_t asn_MBR_Ngap_CompositeAvailableCapacity_1[] = {
    {ATF_POINTER,
     1,
     offsetof(struct Ngap_CompositeAvailableCapacity, cellCapacityClassValue),
     ...
     {
#if !defined(ASN_DISABLE_OER_SUPPORT)
         &asn_OER_memb_Ngap_cellCapacityClassValue_constr_2,
#endif /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
    ...
    {ATF_NOFLAGS,
     0,
     offsetof(struct Ngap_CompositeAvailableCapacity, capacityValue),
     ...
     {
#if !defined(ASN_DISABLE_OER_SUPPORT)
         &asn_OER_memb_Ngap_capacityValue_constr_3,
#endif /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
    ...
    {ATF_POINTER,
     1,
     offsetof(struct Ngap_CompositeAvailableCapacity, iE_Extensions),
     (ASN_TAG_CLASS_CONTEXT | (2 << 2)),
     -1, /* IMPLICIT tag at current level */
     &asn_DEF_Ngap_ProtocolExtensionContainer_12929P137,
     0,
     {
#if !defined(ASN_DISABLE_OER_SUPPORT)
         0,
