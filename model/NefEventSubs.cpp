...
bool NefEventSubs::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "NefEventSubs" : pathPrefix;
...
bool NefEventSubs::operator==(const NefEventSubs& rhs) const
{
    ...
    ((!eventFilterIsSet() && !rhs.eventFilterIsSet()) || (eventFilterIsSet() && rhs.eventFilterIsSet() && getEventFilter() == rhs.getEventFilter()))
...
oai::model::NefEvent NefEventSubs::getEvent() const
{
    return m_Event;
}
void NefEventSubs::setEvent(oai::model::NefEvent const& value)
{
    m_Event = value;
}
oai::model::NefEventFilter NefEventSubs::getEventFilter() const
{
    return m_EventFilter;
}
void NefEventSubs::setEventFilter(oai::model::NefEventFilter const& value)
{
    m_EventFilter = value;
