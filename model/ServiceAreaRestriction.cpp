...
bool ServiceAreaRestriction::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    ...
    if (areasIsSet())
    {
        const std::vector<oai::_3gpp::model::Area>& value = m_Areas;
...
oai::_3gpp::model::RestrictionType ServiceAreaRestriction::getRestrictionType() const
{
    return m_RestrictionType;
}
void ServiceAreaRestriction::setRestrictionType(oai::_3gpp::model::RestrictionType const& value)
{
...
std::vector<oai::_3gpp::model::Area> ServiceAreaRestriction::getAreas() const
{
    return m_Areas;
}
void ServiceAreaRestriction::setAreas(std::vector<oai::_3gpp::model::Area> const& value)
{
    m_Areas = value;
    m_AreasIsSet = true;
}
