...
std::vector<oai::model::ServiceExperienceInfoPerFlow> ServiceExperienceInfo::getSvcExpPerFlows() const
{
    return m_SvcExpPerFlows;
}
void ServiceExperienceInfo::setSvcExpPerFlows(std::vector<oai::model::ServiceExperienceInfoPerFlow> const& value)
{
