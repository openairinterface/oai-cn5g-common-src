...
bool AccessTokenReq_1::validate(
    std::stringstream& msg, const std::string& pathPrefix) const {
  bool success = true;
  const std::string _pathPrefix =
      pathPrefix.empty() ? "AccessTokenReq_1" : pathPrefix;
  ...
  if (requesterSnpnListIsSet()) {
    const std::vector<oai::_3gpp::model::PlmnIdNid>& value =
        m_RequesterSnpnList;
...
bool AccessTokenReq_1::operator==(const AccessTokenReq_1& rhs) const {
  return
      ...
      ((!targetSnpnIsSet() && !rhs.targetSnpnIsSet()) ||
       (targetSnpnIsSet() && rhs.targetSnpnIsSet() &&
        getTargetSnpn() == rhs.getTargetSnpn())) &&
      ...
      ((!hnrfAccessTokenUriIsSet() && !rhs.hnrfAccessTokenUriIsSet()) ||
       (hnrfAccessTokenUriIsSet() && rhs.hnrfAccessTokenUriIsSet() &&
        getHnrfAccessTokenUri() == rhs.getHnrfAccessTokenUri())) &&
...
void to_json(nlohmann::json& j, const AccessTokenReq_1& o) {
  ...
  if (o.targetSnpnIsSet()) j["targetSnpn"] = o.m_TargetSnpn;
...
void AccessTokenReq_1::setRequesterPlmn(
...
std::vector<oai::_3gpp::model::PlmnId> AccessTokenReq_1::getRequesterPlmnList()
    const {
  return m_RequesterPlmnList;
}
void AccessTokenReq_1::setRequesterPlmnList(
...
AccessTokenReq_1::getRequesterSnssaiList() const {
  return m_RequesterSnssaiList;
}
void AccessTokenReq_1::setRequesterSnssaiList(
...
AccessTokenReq_1::getRequesterSnpnList() const {
  return m_RequesterSnpnList;
}
void AccessTokenReq_1::setRequesterSnpnList(
...
void AccessTokenReq_1::setTargetSnpn(
...
std::vector<oai::_3gpp::model::Snssai> AccessTokenReq_1::getTargetSnssaiList()
    const {
  return m_TargetSnssaiList;
}
void AccessTokenReq_1::setTargetSnssaiList(
    std::vector<oai::_3gpp::model::Snssai> const& value) {
