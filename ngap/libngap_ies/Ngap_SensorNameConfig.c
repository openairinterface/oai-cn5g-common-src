...
extern asn_TYPE_descriptor_t asn_DEF_Ngap_uncompensatedBarometricConfig
    __attribute__((
        weak, alias("asn_DEF_Ngap_uncompensatedBarometricConfig_2")));
#else
...
asn_DEF_Ngap_uncompensatedBarometricConfig_2_alias_init(void) {
  asn_DEF_Ngap_uncompensatedBarometricConfig =
...
#ifndef ASN1C_NO_UNSUFFIXED_PDU_ALIAS
#if defined(__ELF__) && (defined(__GNUC__) || defined(__clang__))
extern asn_TYPE_descriptor_t asn_DEF_Ngap_ueSpeedConfig
    __attribute__((weak, alias("asn_DEF_Ngap_ueSpeedConfig_5")));
#else
static asn_TYPE_descriptor_t asn_DEF_Ngap_ueSpeedConfig_5;
static asn_TYPE_descriptor_t asn_DEF_Ngap_ueSpeedConfig;
__attribute__((constructor)) static void
asn_DEF_Ngap_ueSpeedConfig_5_alias_init(void) {
...
#ifndef ASN1C_NO_UNSUFFIXED_PDU_ALIAS
#if defined(__ELF__) && (defined(__GNUC__) || defined(__clang__))
extern asn_TYPE_descriptor_t asn_DEF_Ngap_ueOrientationConfig
    __attribute__((weak, alias("asn_DEF_Ngap_ueOrientationConfig_8")));
#else
...
__attribute__((constructor)) static void
asn_DEF_Ngap_ueOrientationConfig_8_alias_init(void) {
...
static asn_per_constraints_t asn_PER_type_Ngap_ueOrientationConfig_constr_8
    CC_NOTUSED = {
        ...
        0 /* No PER value map */
          ...
          !defined(ASN_DISABLE_APER_SUPPORT) */
#if !defined(ASN_DISABLE_OER_SUPPORT)
asn_oer_constraints_t asn_OER_type_Ngap_SensorNameConfig_constr_1 CC_NOTUSED = {
    {0, 0},
    -1};
#endif /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
...
static int asn_validate_Ngap_uncompensatedBarometricConfig_2(
    const asn_TYPE_descriptor_t* td, const void* sptr,
    asn_app_constraint_failed_f* ctfailcb, void* app_key) {
  if (!sptr) {
    return -1;
  }
  e_Ngap_SensorNameConfig__uncompensatedBarometricConfig value =
      *(e_Ngap_SensorNameConfig__uncompensatedBarometricConfig*) sptr;
  switch (value) {
...
static const unsigned int
    asn_MAP_Ngap_uncompensatedBarometricConfig_enum2value_2[] = {
        0 /* true(0) */
          /* This list is extensible */
};
static const asn_INTEGER_specifics_t
    asn_SPC_Ngap_uncompensatedBarometricConfig_specs_2 = {
        asn_MAP_Ngap_uncompensatedBarometricConfig_value2enum_2, /* "tag" => N;
                                                                    sorted by
                                                                    tag */
        asn_MAP_Ngap_uncompensatedBarometricConfig_enum2value_2, /* N => "tag";
                                                                    sorted by N
                                                                  */
...
static /* Use -fall-defs-global to expose */
    asn_TYPE_descriptor_t asn_DEF_Ngap_uncompensatedBarometricConfig_2 = {
        ...
        sizeof(asn_DEF_Ngap_uncompensatedBarometricConfig_tags_2) /
                sizeof(asn_DEF_Ngap_uncompensatedBarometricConfig_tags_2[0]) -
            1,                                             /* 1 */
...
static int asn_validate_Ngap_ueSpeedConfig_5(
    const asn_TYPE_descriptor_t* td, const void* sptr,
    asn_app_constraint_failed_f* ctfailcb, void* app_key) {
  if (!sptr) {
    return -1;
  }
  e_Ngap_SensorNameConfig__ueSpeedConfig value =
      *(e_Ngap_SensorNameConfig__ueSpeedConfig*) sptr;
  switch (value) {
...
static /* Use -fall-defs-global to expose */
    asn_TYPE_descriptor_t asn_DEF_Ngap_ueSpeedConfig_5 = {
        ...
        sizeof(asn_DEF_Ngap_ueSpeedConfig_tags_5) /
                sizeof(asn_DEF_Ngap_ueSpeedConfig_tags_5[0]) -
            1,                             /* 1 */
...
static const asn_INTEGER_enum_map_t
    asn_MAP_Ngap_ueOrientationConfig_value2enum_8[] = {
        {0, 4, "true"}
        /* This list is extensible */
};
static int asn_validate_Ngap_ueOrientationConfig_8(
    const asn_TYPE_descriptor_t* td, const void* sptr,
    asn_app_constraint_failed_f* ctfailcb, void* app_key) {
  if (!sptr) {
    return -1;
  }
  e_Ngap_SensorNameConfig__ueOrientationConfig value =
      *(e_Ngap_SensorNameConfig__ueOrientationConfig*) sptr;
  switch (value) {
...
static /* Use -fall-defs-global to expose */
    asn_TYPE_descriptor_t asn_DEF_Ngap_ueOrientationConfig_8 = {
        ...
        sizeof(asn_DEF_Ngap_ueOrientationConfig_tags_8) /
                sizeof(asn_DEF_Ngap_ueOrientationConfig_tags_8[0]) -
            1,                                   /* 1 */
...
asn_TYPE_member_t asn_MBR_Ngap_SensorNameConfig_1[] = {
    {ATF_NOFLAGS,
     0,
     offsetof(
         struct Ngap_SensorNameConfig, choice.uncompensatedBarometricConfig),
    ...
    {ATF_NOFLAGS,
     0,
     offsetof(struct Ngap_SensorNameConfig, choice.ueSpeedConfig),
    ...
    {ATF_NOFLAGS,
     0,
     offsetof(struct Ngap_SensorNameConfig, choice.ueOrientationConfig),
    ...
    {ATF_POINTER,
     0,
     offsetof(struct Ngap_SensorNameConfig, choice.choice_Extensions),
     (ASN_TAG_CLASS_CONTEXT | (3 << 2)),
     -1, /* IMPLICIT tag at current level */
     &asn_DEF_Ngap_ProtocolIE_SingleContainer_12877P47,
     0,
     {
#if !defined(ASN_DISABLE_OER_SUPPORT)
         0,
