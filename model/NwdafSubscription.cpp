...
oai::_3gpp::model::NnwdafEventsSubscription NwdafSubscription::getNwdafEventsSubscription() const
{
    return m_NwdafEventsSubscription;
}
void NwdafSubscription::setNwdafEventsSubscription(oai::_3gpp::model::NnwdafEventsSubscription const& value)
{
