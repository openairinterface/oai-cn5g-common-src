...
Ngap_BitRate_constraint(const asn_TYPE_descriptor_t *td, const void *sptr,
	...
	static const asn_cval_t asn_CVAL_Ngap_BitRate_1_lb = { ACV_UINT, { .u = UINTMAX_C(0) } };
	static const asn_cval_t asn_CVAL_Ngap_BitRate_1_ub = { ACV_UINT, { .u = UINTMAX_C(4000000000000) } };
	...
	if(asn_check_INTEGER_range(st, &asn_CVAL_Ngap_BitRate_1_lb, &asn_CVAL_Ngap_BitRate_1_ub, 0) == 0) {
