...
bool AfSigProtocol_anyOf::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "AfSigProtocol_anyOf" : pathPrefix;

    
    if (m_value == AfSigProtocol_anyOf::eAfSigProtocol_anyOf::INVALID_VALUE_OPENAPI_GENERATED)
    {
        success = false;
...
void to_json(nlohmann::json& j, const AfSigProtocol_anyOf& o)
{
    ...
    switch (o.getValue())
    {
        case AfSigProtocol_anyOf::eAfSigProtocol_anyOf::INVALID_VALUE_OPENAPI_GENERATED:
...
AfSigProtocol_anyOf::eAfSigProtocol_anyOf AfSigProtocol_anyOf::getValue() const
{
    return m_value;
}
void AfSigProtocol_anyOf::setValue(AfSigProtocol_anyOf::eAfSigProtocol_anyOf value)
{
    m_value = value;
}
