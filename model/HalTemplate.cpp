...
bool HalTemplate::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "HalTemplate" : pathPrefix;
    ...
    if (propertiesIsSet())
    {
        const std::vector<oai::model::Property>& value = m_Properties;
        ...
        { // Recursive validation of array elements
            ...
            int i = 0;
            for (const oai::model::Property& value : value)
            { 
...
oai::model::HttpMethod HalTemplate::getMethod() const
{
    return m_Method;
}
void HalTemplate::setMethod(oai::model::HttpMethod const& value)
{
    m_Method = value;
}
...
std::vector<oai::model::Property> HalTemplate::getProperties() const
{
    return m_Properties;
}
void HalTemplate::setProperties(std::vector<oai::model::Property> const& value)
{
    m_Properties = value;
