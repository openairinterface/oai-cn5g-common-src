...
bool N3gaLocation::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "N3gaLocation" : pathPrefix;
...
bool N3gaLocation::operator==(const N3gaLocation& rhs) const
{
    ...
    ((!n3gppTaiIsSet() && !rhs.n3gppTaiIsSet()) || (n3gppTaiIsSet() && rhs.n3gppTaiIsSet() && getN3gppTai() == rhs.getN3gppTai())) &&
    ...
    ((!ueIpv6AddrIsSet() && !rhs.ueIpv6AddrIsSet()) || (ueIpv6AddrIsSet() && rhs.ueIpv6AddrIsSet() && getUeIpv6Addr() == rhs.getUeIpv6Addr())) &&
    ...
    ((!hfcNodeIdIsSet() && !rhs.hfcNodeIdIsSet()) || (hfcNodeIdIsSet() && rhs.hfcNodeIdIsSet() && getHfcNodeId() == rhs.getHfcNodeId())) &&
    
    
    ((!gliIsSet() && !rhs.gliIsSet()) || (gliIsSet() && rhs.gliIsSet() && getGli() == rhs.getGli())) &&
    
    
    ((!w5gbanLineTypeIsSet() && !rhs.w5gbanLineTypeIsSet()) || (w5gbanLineTypeIsSet() && rhs.w5gbanLineTypeIsSet() && getW5gbanLineType() == rhs.getW5gbanLineType())) &&
    
    
    ((!gciIsSet() && !rhs.gciIsSet()) || (gciIsSet() && rhs.gciIsSet() && getGci() == rhs.getGci()))
...
oai::model::Tai N3gaLocation::getN3gppTai() const
{
    return m_N3gppTai;
}
void N3gaLocation::setN3gppTai(oai::model::Tai const& value)
{
    m_N3gppTai = value;
...
oai::model::Ipv6Addr N3gaLocation::getUeIpv6Addr() const
{
    return m_UeIpv6Addr;
}
void N3gaLocation::setUeIpv6Addr(oai::model::Ipv6Addr const& value)
{
    m_UeIpv6Addr = value;
...
oai::model::TransportProtocol N3gaLocation::getProtocol() const
{
    return m_Protocol;
}
void N3gaLocation::setProtocol(oai::model::TransportProtocol const& value)
{
    m_Protocol = value;
...
oai::model::TnapId N3gaLocation::getTnapId() const
{
    return m_TnapId;
}
void N3gaLocation::setTnapId(oai::model::TnapId const& value)
{
    m_TnapId = value;
    m_TnapIdIsSet = true;
}
...
oai::model::TwapId N3gaLocation::getTwapId() const
{
    return m_TwapId;
}
void N3gaLocation::setTwapId(oai::model::TwapId const& value)
{
    m_TwapId = value;
    m_TwapIdIsSet = true;
}
...
oai::model::HfcNodeId N3gaLocation::getHfcNodeId() const
{
    return m_HfcNodeId;
}
void N3gaLocation::setHfcNodeId(oai::model::HfcNodeId const& value)
{
    m_HfcNodeId = value;
...
oai::model::LineType N3gaLocation::getW5gbanLineType() const
{
    return m_W5gbanLineType;
}
void N3gaLocation::setW5gbanLineType(oai::model::LineType const& value)
{
