...
public:
    ...
    /// 
    /// </summary>
    oai::model::UeContextRelocateData getJsonData() const;
    void setJsonData(oai::model::UeContextRelocateData const& value);
...
protected:
    oai::model::UeContextRelocateData m_JsonData;
