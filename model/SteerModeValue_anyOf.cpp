...
bool SteerModeValue_anyOf::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "SteerModeValue_anyOf" : pathPrefix;

    
    if (m_value == SteerModeValue_anyOf::eSteerModeValue_anyOf::INVALID_VALUE_OPENAPI_GENERATED)
    {
        success = false;
...
void to_json(nlohmann::json& j, const SteerModeValue_anyOf& o)
{
    ...
    switch (o.getValue())
    {
        case SteerModeValue_anyOf::eSteerModeValue_anyOf::INVALID_VALUE_OPENAPI_GENERATED:
...
SteerModeValue_anyOf::eSteerModeValue_anyOf SteerModeValue_anyOf::getValue() const
{
    return m_value;
}
void SteerModeValue_anyOf::setValue(SteerModeValue_anyOf::eSteerModeValue_anyOf value)
{
    m_value = value;
}
