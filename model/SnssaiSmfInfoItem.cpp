...
bool SnssaiSmfInfoItem::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    ...
    /* DnnSmfInfoList */ {
        const std::vector<oai::_3gpp::model::DnnSmfInfoItem>& value = m_DnnSmfInfoList;
...
std::vector<oai::_3gpp::model::DnnSmfInfoItem> SnssaiSmfInfoItem::getDnnSmfInfoList() const
{
    return m_DnnSmfInfoList;
}
void SnssaiSmfInfoItem::setDnnSmfInfoList(std::vector<oai::_3gpp::model::DnnSmfInfoItem> const& value)
{
