...
bool WirelineArea::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "WirelineArea" : pathPrefix;
...
std::vector<oai::_3gpp::model::std::string> WirelineArea::getGlobalLineIds() const
{
    return m_GlobalLineIds;
}
void WirelineArea::setGlobalLineIds(std::vector<oai::_3gpp::model::std::string> const& value)
{
...
std::vector<oai::_3gpp::model::std::string> WirelineArea::getHfcNIds() const
{
    return m_HfcNIds;
}
void WirelineArea::setHfcNIds(std::vector<oai::_3gpp::model::std::string> const& value)
{
    m_HfcNIds = value;
    m_HfcNIdsIsSet = true;
}
