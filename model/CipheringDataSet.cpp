...
bool CipheringDataSet::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "CipheringDataSet" : pathPrefix;
...
bool CipheringDataSet::operator==(const CipheringDataSet& rhs) const
{
    ...
    ((!ltePosSibTypesIsSet() && !rhs.ltePosSibTypesIsSet()) || (ltePosSibTypesIsSet() && rhs.ltePosSibTypesIsSet() && getLtePosSibTypes() == rhs.getLtePosSibTypes())) &&
    
    
    ((!nrPosSibTypesIsSet() && !rhs.nrPosSibTypesIsSet()) || (nrPosSibTypesIsSet() && rhs.nrPosSibTypesIsSet() && getNrPosSibTypes() == rhs.getNrPosSibTypes())) &&
