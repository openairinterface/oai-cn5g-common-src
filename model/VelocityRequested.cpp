...
VelocityRequested_anyOf::eVelocityRequested_anyOf VelocityRequested::getEnumValue() const
{
    return m_value.getValue();
}

void VelocityRequested::setEnumValue(VelocityRequested_anyOf::eVelocityRequested_anyOf  value)
{
