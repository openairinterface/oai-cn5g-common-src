...
/* Implementation */
extern asn_oer_constraints_t asn_OER_type_Ngap_AMF_UE_NGAP_ID_constr_1;
...
cbor_type_decoder_f Ngap_AMF_UE_NGAP_ID_decode_cbor;
cbor_type_encoder_f Ngap_AMF_UE_NGAP_ID_encode_cbor;
