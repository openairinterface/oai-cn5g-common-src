 ...
 */
asn_enc_rval_t oer_encode(const asn_TYPE_descriptor_t *type_descriptor,
  ...
  return type_descriptor->op->oer_encoder(
      type_descriptor, 0, struct_ptr, /* Pointer to the destination structure */
...
asn_enc_rval_t oer_encode_primitive(const asn_TYPE_descriptor_t *td,
                                    const asn_oer_constraints_t *constraints,
                                    const void *sptr,
...
static int oer__count_bytes(const void *buffer, size_t size, void *bytes_ptr) {
...
ssize_t oer_open_type_put(const asn_TYPE_descriptor_t *td,
                          const asn_oer_constraints_t *constraints,
