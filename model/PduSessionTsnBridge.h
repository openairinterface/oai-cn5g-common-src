...
public:
    ...
    /// 
    /// </summary>
    oai::_3gpp::model::Ipv6Prefix getUeIpv6AddrPrefix() const;
    void setUeIpv6AddrPrefix(oai::_3gpp::model::Ipv6Prefix const& value);
...
protected:
    ...
    oai::_3gpp::model::Ipv6Prefix m_UeIpv6AddrPrefix;
