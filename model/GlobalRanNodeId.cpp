...
oai::_3gpp::model::PlmnId GlobalRanNodeId::getPlmnId() const
{
    return m_PlmnId;
}
void GlobalRanNodeId::setPlmnId(oai::_3gpp::model::PlmnId const& value)
{
    m_PlmnId = value;
}
...
oai::_3gpp::model::GNbId GlobalRanNodeId::getGNbId() const
{
    return m_GNbId;
}
void GlobalRanNodeId::setGNbId(oai::_3gpp::model::GNbId const& value)
{
    m_GNbId = value;
    m_GNbIdIsSet = true;
}
