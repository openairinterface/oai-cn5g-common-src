...
bool V2xSubscriptionData::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "V2xSubscriptionData" : pathPrefix;
...
bool V2xSubscriptionData::operator==(const V2xSubscriptionData& rhs) const
{
    ...
    ((!ltePc5AmbrIsSet() && !rhs.ltePc5AmbrIsSet()) || (ltePc5AmbrIsSet() && rhs.ltePc5AmbrIsSet() && getLtePc5Ambr() == rhs.getLtePc5Ambr()))
...
oai::model::NrV2xAuth V2xSubscriptionData::getNrV2xServicesAuth() const
{
    return m_NrV2xServicesAuth;
}
void V2xSubscriptionData::setNrV2xServicesAuth(oai::model::NrV2xAuth const& value)
{
...
oai::model::LteV2xAuth V2xSubscriptionData::getLteV2xServicesAuth() const
{
    return m_LteV2xServicesAuth;
}
void V2xSubscriptionData::setLteV2xServicesAuth(oai::model::LteV2xAuth const& value)
{
