...
oai::model::AfEvent AfEventSubscription::getEvent() const
{
    return m_Event;
}
void AfEventSubscription::setEvent(oai::model::AfEvent const& value)
{
    m_Event = value;
}
oai::model::AfNotifMethod AfEventSubscription::getNotifMethod() const
{
    return m_NotifMethod;
}
void AfEventSubscription::setNotifMethod(oai::model::AfNotifMethod const& value)
{
    m_NotifMethod = value;
