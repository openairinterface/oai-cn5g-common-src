...
bool PartialSuccessReport::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "PartialSuccessReport" : pathPrefix;

        
    if (!m_FailureCause.validate(msg, _pathPrefix + ".failureCause")) {
        msg << _pathPrefix << ": FailureCause is invalid;";
        success = false;
    }     
    if (ruleReportsIsSet())
    {
...
bool PartialSuccessReport::operator==(const PartialSuccessReport& rhs) const
{
    ...
    ((!ueCampingRepIsSet() && !rhs.ueCampingRepIsSet()) || (ueCampingRepIsSet() && rhs.ueCampingRepIsSet() && getUeCampingRep() == rhs.getUeCampingRep())) &&
...
oai::model::FailureCause PartialSuccessReport::getFailureCause() const
{
    return m_FailureCause;
}
void PartialSuccessReport::setFailureCause(oai::model::FailureCause const& value)
{
    m_FailureCause = value;
}
std::vector<oai::model::RuleReport> PartialSuccessReport::getRuleReports() const
{
    return m_RuleReports;
}
void PartialSuccessReport::setRuleReports(std::vector<oai::model::RuleReport> const& value)
{
    m_RuleReports = value;
...
std::vector<oai::model::SessionRuleReport> PartialSuccessReport::getSessRuleReports() const
{
    return m_SessRuleReports;
}
void PartialSuccessReport::setSessRuleReports(std::vector<oai::model::SessionRuleReport> const& value)
{
...
oai::model::UeCampingRep PartialSuccessReport::getUeCampingRep() const
{
    return m_UeCampingRep;
}
void PartialSuccessReport::setUeCampingRep(oai::model::UeCampingRep const& value)
{
...
std::vector<oai::model::PolicyDecisionFailureCode> PartialSuccessReport::getPolicyDecFailureReports() const
{
    return m_PolicyDecFailureReports;
}
void PartialSuccessReport::setPolicyDecFailureReports(std::vector<oai::model::PolicyDecisionFailureCode> const& value)
{
...
std::vector<oai::model::InvalidParam> PartialSuccessReport::getInvalidPolicyDecs() const
{
    return m_InvalidPolicyDecs;
}
void PartialSuccessReport::setInvalidPolicyDecs(std::vector<oai::model::InvalidParam> const& value)
{
