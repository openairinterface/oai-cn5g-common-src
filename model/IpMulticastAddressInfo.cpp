...
bool IpMulticastAddressInfo::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "IpMulticastAddressInfo" : pathPrefix;
...
bool IpMulticastAddressInfo::operator==(const IpMulticastAddressInfo& rhs) const
{
    return
    ...
    ((!ipv4MulAddrIsSet() && !rhs.ipv4MulAddrIsSet()) || (ipv4MulAddrIsSet() && rhs.ipv4MulAddrIsSet() && getIpv4MulAddr() == rhs.getIpv4MulAddr())) &&
    
    
    ((!srcIpv6AddrIsSet() && !rhs.srcIpv6AddrIsSet()) || (srcIpv6AddrIsSet() && rhs.srcIpv6AddrIsSet() && getSrcIpv6Addr() == rhs.getSrcIpv6Addr())) &&
    
    
    ((!ipv6MulAddrIsSet() && !rhs.ipv6MulAddrIsSet()) || (ipv6MulAddrIsSet() && rhs.ipv6MulAddrIsSet() && getIpv6MulAddr() == rhs.getIpv6MulAddr()))
...
oai::_3gpp::model::Ipv6Addr IpMulticastAddressInfo::getSrcIpv6Addr() const
{
    return m_SrcIpv6Addr;
}
void IpMulticastAddressInfo::setSrcIpv6Addr(oai::_3gpp::model::Ipv6Addr const& value)
{
    m_SrcIpv6Addr = value;
...
oai::_3gpp::model::Ipv6Addr IpMulticastAddressInfo::getIpv6MulAddr() const
{
    return m_Ipv6MulAddr;
}
void IpMulticastAddressInfo::setIpv6MulAddr(oai::_3gpp::model::Ipv6Addr const& value)
{
    m_Ipv6MulAddr = value;
