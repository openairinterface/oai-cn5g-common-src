...
public:
    ...
    /// 
    /// </summary>
    oai::model::SessionRuleFailureCode getSessRuleFailureCode() const;
    void setSessRuleFailureCode(oai::model::SessionRuleFailureCode const& value);
...
protected:
    ...
    oai::model::SessionRuleFailureCode m_SessRuleFailureCode;
