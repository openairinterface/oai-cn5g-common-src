...
public:
    ...
    /// </summary>
    std::vector<oai::model::pcf::AlternativeServiceRequirementsData> getAltSerReqsData() const;
    void setAltSerReqsData(std::vector<oai::model::pcf::AlternativeServiceRequirementsData> const& value);
    ...
    /// </summary>
    std::map<std::string, oai::model::pcf::MediaSubComponent> getMedSubComps() const;
    void setMedSubComps(std::map<std::string, oai::model::pcf::MediaSubComponent> const& value);
    ...
    void setPrioSharingInd(oai::model::pcf::PrioritySharingIndicator const& value);
...
protected:
    ...
    std::vector<oai::model::pcf::AlternativeServiceRequirementsData> m_AltSerReqsData;
    ...
    std::map<std::string, oai::model::pcf::MediaSubComponent> m_MedSubComps;
    ...
    oai::model::pcf::TsnQosContainer m_TsnQos;
    bool m_TsnQosIsSet;
