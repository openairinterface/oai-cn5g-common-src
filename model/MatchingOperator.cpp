...
bool MatchingOperator::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "MatchingOperator" : pathPrefix;
...
MatchingOperator_anyOf::eMatchingOperator_anyOf MatchingOperator::getEnumValue() const
{
    return m_value.getValue();
}

void MatchingOperator::setEnumValue(MatchingOperator_anyOf::eMatchingOperator_anyOf  value)
{
