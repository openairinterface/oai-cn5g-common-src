...
bool PduSessionCreateError::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "PduSessionCreateError" : pathPrefix;
...
oai::model::ProblemDetails PduSessionCreateError::getError() const
{
    return m_Error;
}
void PduSessionCreateError::setError(oai::model::ProblemDetails const& value)
{
    m_Error = value;
}
...
oai::model::RefToBinaryData PduSessionCreateError::getN1SmInfoToUe() const
{
    return m_N1SmInfoToUe;
}
void PduSessionCreateError::setN1SmInfoToUe(oai::model::RefToBinaryData const& value)
{
