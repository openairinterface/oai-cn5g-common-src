...
bool DnnInfo::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    ...
    if (smfListIsSet())
    {
        const std::vector<oai::_3gpp::model::std::string>& value = m_SmfList;
...
bool DnnInfo::operator==(const DnnInfo& rhs) const
{
    ...
    ((!defaultDnnIndicatorIsSet() && !rhs.defaultDnnIndicatorIsSet()) || (defaultDnnIndicatorIsSet() && rhs.defaultDnnIndicatorIsSet() && isDefaultDnnIndicator() == rhs.isDefaultDnnIndicator())) &&
    
    
    ((!lboRoamingAllowedIsSet() && !rhs.lboRoamingAllowedIsSet()) || (lboRoamingAllowedIsSet() && rhs.lboRoamingAllowedIsSet() && isLboRoamingAllowed() == rhs.isLboRoamingAllowed())) &&
    
    
    ((!iwkEpsIndIsSet() && !rhs.iwkEpsIndIsSet()) || (iwkEpsIndIsSet() && rhs.iwkEpsIndIsSet() && isIwkEpsInd() == rhs.isIwkEpsInd())) &&
    
    
    ((!dnnBarredIsSet() && !rhs.dnnBarredIsSet()) || (dnnBarredIsSet() && rhs.dnnBarredIsSet() && isDnnBarred() == rhs.isDnnBarred())) &&
    
    
    ((!invokeNefIndIsSet() && !rhs.invokeNefIndIsSet()) || (invokeNefIndIsSet() && rhs.invokeNefIndIsSet() && isInvokeNefInd() == rhs.isInvokeNefInd())) &&
    
    
    ((!smfListIsSet() && !rhs.smfListIsSet()) || (smfListIsSet() && rhs.smfListIsSet() && getSmfList() == rhs.getSmfList())) &&
    
    
    ((!sameSmfIndIsSet() && !rhs.sameSmfIndIsSet()) || (sameSmfIndIsSet() && rhs.sameSmfIndIsSet() && isSameSmfInd() == rhs.isSameSmfInd()))
...
oai::_3gpp::model::AccessAndMobilitySubscriptionData_subscribedDnnList_inner DnnInfo::getDnn() const
{
    return m_Dnn;
}
void DnnInfo::setDnn(oai::_3gpp::model::AccessAndMobilitySubscriptionData_subscribedDnnList_inner const& value)
{
    m_Dnn = value;
}
...
std::vector<oai::_3gpp::model::std::string> DnnInfo::getSmfList() const
{
    return m_SmfList;
}
void DnnInfo::setSmfList(std::vector<oai::_3gpp::model::std::string> const& value)
{
    m_SmfList = value;
    m_SmfListIsSet = true;
}
