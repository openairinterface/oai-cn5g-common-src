...
public:
    ...
    /// 
    /// </summary>
    oai::model::NoProfileMatchReason getReason() const;
    void setReason(oai::model::NoProfileMatchReason const& value);
    /// <summary>
    /// 
    /// </summary>
    std::vector<oai::model::QueryParamCombination> getQueryParamCombinationList() const;
    void setQueryParamCombinationList(std::vector<oai::model::QueryParamCombination> const& value);
...
protected:
    oai::model::NoProfileMatchReason m_Reason;

    std::vector<oai::model::QueryParamCombination> m_QueryParamCombinationList;
