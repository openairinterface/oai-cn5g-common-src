...
public:
    ...
    void setPduSessionList(std::vector<oai::_3gpp::model::N2SmInformation> const& value);
    /// <summary>
    /// 
    /// </summary>
    std::vector<oai::_3gpp::model::N2SmInformation> getFailedSessionList() const;
    void setFailedSessionList(std::vector<oai::_3gpp::model::N2SmInformation> const& value);
