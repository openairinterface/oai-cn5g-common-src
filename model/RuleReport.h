...
public:
    ...
    /// 
    /// </summary>
    oai::model::RuleStatus getRuleStatus() const;
    void setRuleStatus(oai::model::RuleStatus const& value);
    /// <summary>
    ...
    /// 
    /// </summary>
    oai::model::FailureCode getFailureCode() const;
    void setFailureCode(oai::model::FailureCode const& value);
    bool failureCodeIsSet() const;
    void unsetFailureCode();
    /// <summary>
    /// 
    /// </summary>
    oai::model::FinalUnitAction getFinUnitAct() const;
    void setFinUnitAct(oai::model::FinalUnitAction const& value);
...
protected:
    ...
    oai::model::RuleStatus m_RuleStatus;

    std::vector<int32_t> m_ContVers;
    bool m_ContVersIsSet;
    oai::model::FailureCode m_FailureCode;
    bool m_FailureCodeIsSet;
    oai::model::FinalUnitAction m_FinUnitAct;
