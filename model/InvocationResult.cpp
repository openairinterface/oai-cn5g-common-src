...
void InvocationResult::setError(oai::_3gpp::model::ProblemDetails const& value)
{
    m_Error = value;
    m_ErrorIsSet = true;
}
...
oai::_3gpp::model::FailureHandling InvocationResult::getFailureHandling() const
{
    return m_FailureHandling;
}
void InvocationResult::setFailureHandling(oai::_3gpp::model::FailureHandling const& value)
{
