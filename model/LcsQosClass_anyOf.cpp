...
bool LcsQosClass_anyOf::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "LcsQosClass_anyOf" : pathPrefix;

    
    if (m_value == LcsQosClass_anyOf::eLcsQosClass_anyOf::INVALID_VALUE_OPENAPI_GENERATED)
    {
        success = false;
...
void to_json(nlohmann::json& j, const LcsQosClass_anyOf& o)
{
    ...
    switch (o.getValue())
    {
        ...
        case LcsQosClass_anyOf::eLcsQosClass_anyOf::ASSURED:
            j = "ASSURED";
            break;
        case LcsQosClass_anyOf::eLcsQosClass_anyOf::MULTIPLE_QOS:
            j = "MULTIPLE_QOS";
            break;
    }
}
...
void from_json(const nlohmann::json& j, LcsQosClass_anyOf& o)
{
    ...
    else if (s == "MULTIPLE_QOS") {
     o.setValue(LcsQosClass_anyOf::eLcsQosClass_anyOf::MULTIPLE_QOS);
    }  else {
     std::stringstream ss;
