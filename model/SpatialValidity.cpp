...
std::map<std::string, oai::_3gpp::model::PresenceInfo> SpatialValidity::getPresenceInfoList() const
{
    return m_PresenceInfoList;
}
void SpatialValidity::setPresenceInfoList(std::map<std::string, oai::_3gpp::model::PresenceInfo> const& value)
{
