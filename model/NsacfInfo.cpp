...
void NsacfInfo::setNsacfCapability(oai::_3gpp::model::NsacfCapability const& value)
{
...
void NsacfInfo::setTaiRangeList(std::vector<oai::_3gpp::model::TaiRange> const& value)
{
