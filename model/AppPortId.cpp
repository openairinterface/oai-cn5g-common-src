...
bool AppPortId::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
...
bool AppPortId::operator==(const AppPortId& rhs) const
{
    ...
    ((!destinationPortIsSet() && !rhs.destinationPortIsSet()) || (destinationPortIsSet() && rhs.destinationPortIsSet() && getDestinationPort() == rhs.getDestinationPort())) &&
    
    
    ((!originatorPortIsSet() && !rhs.originatorPortIsSet()) || (originatorPortIsSet() && rhs.originatorPortIsSet() && getOriginatorPort() == rhs.getOriginatorPort()))
