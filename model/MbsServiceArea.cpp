...
bool MbsServiceArea::validate(
    std::stringstream& msg, const std::string& pathPrefix) const {
  bool success = true;
  const std::string _pathPrefix =
      pathPrefix.empty() ? "MbsServiceArea" : pathPrefix;
...
void MbsServiceArea::setNcgiList(
    std::vector<oai::_3gpp::model::NcgiTai> const& value) {
  m_NcgiList      = value;
...
void MbsServiceArea::setTaiList(
