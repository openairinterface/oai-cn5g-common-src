...
extern asn_TYPE_descriptor_t asn_DEF_Ngap_rATType
    __attribute__((weak, alias("asn_DEF_Ngap_rATType_2")));
#else
static asn_TYPE_descriptor_t asn_DEF_Ngap_rATType_2;
static asn_TYPE_descriptor_t asn_DEF_Ngap_rATType;
__attribute__((constructor)) static void asn_DEF_Ngap_rATType_2_alias_init(
    void) {
...
static int asn_validate_Ngap_rATType_2(
    const asn_TYPE_descriptor_t* td, const void* sptr,
    asn_app_constraint_failed_f* ctfailcb, void* app_key) {
  if (!sptr) {
    return -1;
  }
  e_Ngap_PDUSessionUsageReport__rATType value =
      *(e_Ngap_PDUSessionUsageReport__rATType*) sptr;
  switch (value) {
...
static /* Use -fall-defs-global to expose */
    asn_TYPE_descriptor_t asn_DEF_Ngap_rATType_2 = {
        ...
        sizeof(asn_DEF_Ngap_rATType_tags_2) /
                sizeof(asn_DEF_Ngap_rATType_tags_2[0]) -
            1,                       /* 1 */
...
asn_TYPE_member_t asn_MBR_Ngap_PDUSessionUsageReport_1[] = {
    {ATF_NOFLAGS,
     0,
     offsetof(struct Ngap_PDUSessionUsageReport, rATType),
    ...
    {ATF_POINTER,
     0,
     offsetof(struct Ngap_PDUSessionUsageReport, pDUSessionTimedReportList),
    ...
    {ATF_POINTER,
     1,
     offsetof(struct Ngap_PDUSessionUsageReport, iE_Extensions),
     (ASN_TAG_CLASS_CONTEXT | (2 << 2)),
     -1, /* IMPLICIT tag at current level */
     &asn_DEF_Ngap_ProtocolExtensionContainer_12929P263,
     0,
     {
#if !defined(ASN_DISABLE_OER_SUPPORT)
         0,
