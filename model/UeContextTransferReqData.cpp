...
void UeContextTransferReqData::setReason(oai::_3gpp::model::TransferReason const& value)
{
    m_Reason = value;
}
...
void UeContextTransferReqData::setAccessType(oai::_3gpp::model::AccessType const& value)
{
    m_AccessType = value;
}
...
void UeContextTransferReqData::setPlmnId(oai::_3gpp::model::PlmnId const& value)
{
    m_PlmnId = value;
    m_PlmnIdIsSet = true;
}
...
oai::_3gpp::model::N1MessageContainer UeContextTransferReqData::getRegRequest() const
{
    return m_RegRequest;
}
void UeContextTransferReqData::setRegRequest(oai::_3gpp::model::N1MessageContainer const& value)
{
    m_RegRequest = value;
