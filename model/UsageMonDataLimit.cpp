...
bool UsageMonDataLimit::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "UsageMonDataLimit" : pathPrefix;
...
bool UsageMonDataLimit::operator==(const UsageMonDataLimit& rhs) const
{
    ...
    ((!usageLimitIsSet() && !rhs.usageLimitIsSet()) || (usageLimitIsSet() && rhs.usageLimitIsSet() && getUsageLimit() == rhs.getUsageLimit())) &&
    
    
    ((!resetPeriodIsSet() && !rhs.resetPeriodIsSet()) || (resetPeriodIsSet() && rhs.resetPeriodIsSet() && getResetPeriod() == rhs.getResetPeriod()))
...
std::map<std::string, oai::model::UsageMonDataScope> UsageMonDataLimit::getScopes() const
{
    return m_Scopes;
}
void UsageMonDataLimit::setScopes(std::map<std::string, oai::model::UsageMonDataScope> const& value)
{
    m_Scopes = value;
    m_ScopesIsSet = true;
}
...
oai::model::UsageMonLevel UsageMonDataLimit::getUmLevel() const
{
    return m_UmLevel;
}
void UsageMonDataLimit::setUmLevel(oai::model::UsageMonLevel const& value)
{
    m_UmLevel = value;
    m_UmLevelIsSet = true;
}
...
oai::model::UsageThreshold UsageMonDataLimit::getUsageLimit() const
{
    return m_UsageLimit;
}
void UsageMonDataLimit::setUsageLimit(oai::model::UsageThreshold const& value)
{
    m_UsageLimit = value;
...
oai::model::TimePeriod UsageMonDataLimit::getResetPeriod() const
{
    return m_ResetPeriod;
}
void UsageMonDataLimit::setResetPeriod(oai::model::TimePeriod const& value)
{
    m_ResetPeriod = value;
