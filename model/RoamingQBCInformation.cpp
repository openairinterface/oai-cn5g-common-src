...
bool RoamingQBCInformation::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    ...
    {
        const std::vector<oai::_3gpp::model::MultipleQFIcontainer>& value = m_MultipleQFIcontainer;
...
std::vector<oai::_3gpp::model::MultipleQFIcontainer> RoamingQBCInformation::getMultipleQFIcontainer() const
{
    return m_MultipleQFIcontainer;
}
void RoamingQBCInformation::setMultipleQFIcontainer(std::vector<oai::_3gpp::model::MultipleQFIcontainer> const& value)
{
...
oai::_3gpp::model::RoamingChargingProfile RoamingQBCInformation::getRoamingChargingProfile() const
{
    return m_RoamingChargingProfile;
}
void RoamingQBCInformation::setRoamingChargingProfile(oai::_3gpp::model::RoamingChargingProfile const& value)
{
