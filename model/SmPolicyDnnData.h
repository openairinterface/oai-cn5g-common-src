...
public:
    ...
    /// 
    /// </summary>
    oai::model::ChargingInformation getChfInfo() const;
    void setChfInfo(oai::model::ChargingInformation const& value);
    ...
    /// </summary>
    std::map<std::string, oai::model::LimitIdToMonitoringKey> getRefUmDataLimitIds() const;
    void setRefUmDataLimitIds(std::map<std::string, oai::model::LimitIdToMonitoringKey> const& value);
...
protected:
    ...
    bool m_Online;
    bool m_OnlineIsSet;
    oai::model::ChargingInformation m_ChfInfo;
    bool m_ChfInfoIsSet;
    std::map<std::string, oai::model::LimitIdToMonitoringKey> m_RefUmDataLimitIds;
