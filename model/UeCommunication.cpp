...
oai::_3gpp::model::ScheduledCommunicationTime_1 UeCommunication::getRecurringTime() const
{
    return m_RecurringTime;
}
void UeCommunication::setRecurringTime(oai::_3gpp::model::ScheduledCommunicationTime_1 const& value)
{
...
oai::_3gpp::model::TrafficCharacterization UeCommunication::getTrafChar() const
{
    return m_TrafChar;
}
void UeCommunication::setTrafChar(oai::_3gpp::model::TrafficCharacterization const& value)
{
    m_TrafChar = value;
...
void UeCommunication::setAnaOfAppList(oai::_3gpp::model::AppListForUeComm const& value)
{
...
oai::_3gpp::model::SessInactTimerForUeComm UeCommunication::getSessInactTimer() const
{
    return m_SessInactTimer;
}
void UeCommunication::setSessInactTimer(oai::_3gpp::model::SessInactTimerForUeComm const& value)
{
