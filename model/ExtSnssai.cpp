...
bool ExtSnssai::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
...
bool ExtSnssai::operator==(const ExtSnssai& rhs) const
{
    ...
    ((!sdIsSet() && !rhs.sdIsSet()) || (sdIsSet() && rhs.sdIsSet() && getSd() == rhs.getSd())) &&
...
std::vector<oai::_3gpp::model::SdRange> ExtSnssai::getSdRanges() const
{
    return m_SdRanges;
}
void ExtSnssai::setSdRanges(std::vector<oai::_3gpp::model::SdRange> const& value)
{
    m_SdRanges = value;
