...
public:
    ...
    /// 
    /// </summary>
    oai::model::DataInd getDataInd() const;
    void setDataInd(oai::model::DataInd const& value);
    /// <summary>
    /// 
    /// </summary>
    ...
    /// 
    /// </summary>
    std::vector<oai::model::Snssai> getSnssais() const;
    void setSnssais(std::vector<oai::model::Snssai> const& value);
    ...
    /// 
    /// </summary>
    std::vector<oai::model::Ipv6Addr> getUeIpv6s() const;
    void setUeIpv6s(std::vector<oai::model::Ipv6Addr> const& value);
...
protected:
    oai::model::DataInd m_DataInd;

    std::vector<std::string> m_Dnns;
    bool m_DnnsIsSet;
    std::vector<oai::model::Snssai> m_Snssais;
    bool m_SnssaisIsSet;
    ...
    bool m_UeIpv4sIsSet;
    std::vector<oai::model::Ipv6Addr> m_UeIpv6s;
    bool m_UeIpv6sIsSet;
