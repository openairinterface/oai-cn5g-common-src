...
1. Push your modified code to a new branch in the [GitHub repository](https://github.com/openairinterface/oai-cn5g-common-src).
   * Please use a short and descriptive branch name.

2. Create a pull request on [GitHub](https://github.com/openairinterface/oai-cn5g-common-src/pulls).
...
3. The Continuous Integration (CI) process will be triggered and will validate your changes.
   * Point the network-function repo's src/common-src submodule at your branch and run that NF's pipeline to exercise your changes.
...
6. After approval, a CI administrator will merge the pull request.
   ...
   * The corresponding pull request in the NF repository will also be merged.

## Reporting Bugs

Please report software bugs or security issues through the [GitHub Issue Tracker](https://github.com/openairinterface/oai-cn5g-common-src/issues).
