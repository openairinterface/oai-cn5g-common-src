...
CoreNetworkType_anyOf::eCoreNetworkType_anyOf CoreNetworkType::getEnumValue() const
{
    return m_value.getValue();
}

void CoreNetworkType::setEnumValue(CoreNetworkType_anyOf::eCoreNetworkType_anyOf  value)
{
