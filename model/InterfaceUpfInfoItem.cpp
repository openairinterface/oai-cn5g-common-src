...
bool InterfaceUpfInfoItem::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    ...
    if (!m_InterfaceType.validate(msg, _pathPrefix + ".interfaceType")) {
        msg << _pathPrefix << ": InterfaceType is invalid;";
        success = false;
    }     
    ...
    {
        const std::vector<oai::model::Ipv6Addr>& value = m_Ipv6EndpointAddresses;
    ...
    if (endpointFqdnIsSet())
    {
        const std::string& value = m_EndpointFqdn;
        const std::string currentValuePath = _pathPrefix + ".endpointFqdn";
...
oai::model::UPInterfaceType InterfaceUpfInfoItem::getInterfaceType() const
{
    return m_InterfaceType;
}
void InterfaceUpfInfoItem::setInterfaceType(oai::model::UPInterfaceType const& value)
{
...
std::vector<oai::model::Ipv6Addr> InterfaceUpfInfoItem::getIpv6EndpointAddresses() const
{
    return m_Ipv6EndpointAddresses;
}
void InterfaceUpfInfoItem::setIpv6EndpointAddresses(std::vector<oai::model::Ipv6Addr> const& value)
{
