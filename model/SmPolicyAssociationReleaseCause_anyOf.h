...
public:
    ...
    SmPolicyAssociationReleaseCause_anyOf::eSmPolicyAssociationReleaseCause_anyOf getValue() const;
    void setValue(SmPolicyAssociationReleaseCause_anyOf::eSmPolicyAssociationReleaseCause_anyOf value);
    
    friend void to_json(nlohmann::json& j, const SmPolicyAssociationReleaseCause_anyOf& o);
    friend void from_json(const nlohmann::json& j, SmPolicyAssociationReleaseCause_anyOf& o);
protected:
    SmPolicyAssociationReleaseCause_anyOf::eSmPolicyAssociationReleaseCause_anyOf m_value = SmPolicyAssociationReleaseCause_anyOf::eSmPolicyAssociationReleaseCause_anyOf::INVALID_VALUE_OPENAPI_GENERATED;
};
