...
/* Implementation */
extern asn_oer_constraints_t asn_OER_type_Ngap_HandoverType_constr_1;
...
cbor_type_decoder_f Ngap_HandoverType_decode_cbor;
cbor_type_encoder_f Ngap_HandoverType_encode_cbor;
