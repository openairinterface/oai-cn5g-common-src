...
bool TrafficProfile_anyOf::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "TrafficProfile_anyOf" : pathPrefix;

    
    if (m_value == TrafficProfile_anyOf::eTrafficProfile_anyOf::INVALID_VALUE_OPENAPI_GENERATED)
    {
        success = false;
...
void to_json(nlohmann::json& j, const TrafficProfile_anyOf& o)
{
    ...
    switch (o.getValue())
    {
        case TrafficProfile_anyOf::eTrafficProfile_anyOf::INVALID_VALUE_OPENAPI_GENERATED:
...
void from_json(const nlohmann::json& j, TrafficProfile_anyOf& o)
{
    ...
    if (s == "SINGLE_TRANS_UL") {
     ...
     o.setValue(TrafficProfile_anyOf::eTrafficProfile_anyOf::DUAL_TRANS_UL_FIRST);
    } 
    else if (s == "DUAL_TRANS_DL_FIRST") {
     o.setValue(TrafficProfile_anyOf::eTrafficProfile_anyOf::DUAL_TRANS_DL_FIRST);
    } 
...
TrafficProfile_anyOf::eTrafficProfile_anyOf TrafficProfile_anyOf::getValue() const
{
    return m_value;
}
void TrafficProfile_anyOf::setValue(TrafficProfile_anyOf::eTrafficProfile_anyOf value)
{
    m_value = value;
}
