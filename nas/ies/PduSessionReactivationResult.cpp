...
//------------------------------------------------------------------------------
void PduSessionReactivationResult::SetValue(uint16_t value) { value_ = value; }

//------------------------------------------------------------------------------
uint16_t PduSessionReactivationResult::GetValue() const { return value_; }
...
//------------------------------------------------------------------------------
int PduSessionReactivationResult::Decode(const uint8_t *const buf, int len,
                                         bool is_iei) {
  ...
  oai::logger::logger_common::nas().debug("Decoded %s, Value (0x%x)",
