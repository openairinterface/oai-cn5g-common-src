...
bool EllipsoidArc_allOf::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "EllipsoidArc_allOf" : pathPrefix;
...
oai::_3gpp::model::GeographicalCoordinates EllipsoidArc_allOf::getPoint() const
{
    return m_Point;
}
void EllipsoidArc_allOf::setPoint(oai::_3gpp::model::GeographicalCoordinates const& value)
{
    m_Point = value;
}
