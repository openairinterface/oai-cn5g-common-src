 ...
 */
asn_dec_rval_t SET_OF_decode_ber(const asn_codec_ctx_t *opt_codec_ctx,
  ...
  case 1:
    ...
    microphase2:
       ...
       */
      rval = elm->type->op->ber_decoder(opt_codec_ctx, elm->type, &ctx->ptr,
                                        ptr, LEFT, 0);
 ...
 */
asn_enc_rval_t SET_OF_encode_der(const asn_TYPE_descriptor_t *td,
