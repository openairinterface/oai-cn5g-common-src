...
public:
    ...
    /// 
    /// </summary>
    std::vector<oai::model::AmfStatusInfo> getAmfStatusInfoList() const;
    void setAmfStatusInfoList(std::vector<oai::model::AmfStatusInfo> const& value);
...
protected:
    std::vector<oai::model::AmfStatusInfo> m_AmfStatusInfoList;
