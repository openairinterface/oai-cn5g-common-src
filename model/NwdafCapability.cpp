...
bool NwdafCapability::validate(
    std::stringstream& msg, const std::string& pathPrefix) const {
  bool success = true;
  const std::string _pathPrefix =
      pathPrefix.empty() ? "NwdafCapability" : pathPrefix;
...
bool NwdafCapability::operator==(const NwdafCapability& rhs) const {
  return
      ...
      ((!analyticsAggregationIsSet() && !rhs.analyticsAggregationIsSet()) ||
       (analyticsAggregationIsSet() && rhs.analyticsAggregationIsSet() &&
        isAnalyticsAggregation() == rhs.isAnalyticsAggregation())) &&

      ((!analyticsMetadataProvisioningIsSet() &&
        !rhs.analyticsMetadataProvisioningIsSet()) ||
       (analyticsMetadataProvisioningIsSet() &&
        rhs.analyticsMetadataProvisioningIsSet() &&
        isAnalyticsMetadataProvisioning() ==
            rhs.isAnalyticsMetadataProvisioning()))
...
void from_json(const nlohmann::json& j, NwdafCapability& o) {
  ...
  if (j.find("analyticsMetadataProvisioning") != j.end()) {
    j.at("analyticsMetadataProvisioning")
        .get_to(o.m_AnalyticsMetadataProvisioning);
