...
bool Exception::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    ...
    if (!m_ExcepId.validate(msg, _pathPrefix + ".excepId")) {
        msg << _pathPrefix << ": ExcepId is invalid;";
        success = false;
    }        
    return success;
}
...
bool Exception::operator==(const Exception& rhs) const
{
    ...
    ((!excepLevelIsSet() && !rhs.excepLevelIsSet()) || (excepLevelIsSet() && rhs.excepLevelIsSet() && getExcepLevel() == rhs.getExcepLevel())) &&
    
    
    ((!excepTrendIsSet() && !rhs.excepTrendIsSet()) || (excepTrendIsSet() && rhs.excepTrendIsSet() && getExcepTrend() == rhs.getExcepTrend()))
...
void to_json(nlohmann::json& j, const Exception& o)
{
    ...
    if(o.excepLevelIsSet())
        j["excepLevel"] = o.m_ExcepLevel;
    if(o.excepTrendIsSet())
        j["excepTrend"] = o.m_ExcepTrend;
...
oai::model::ExceptionId Exception::getExcepId() const
{
    return m_ExcepId;
}
void Exception::setExcepId(oai::model::ExceptionId const& value)
{
    m_ExcepId = value;
}
...
oai::model::ExceptionTrend Exception::getExcepTrend() const
{
    return m_ExcepTrend;
}
void Exception::setExcepTrend(oai::model::ExceptionTrend const& value)
{
    m_ExcepTrend = value;
