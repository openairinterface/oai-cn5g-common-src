...
public:
    ...
    LossOfConnectivityReason_anyOf::eLossOfConnectivityReason_anyOf getEnumValue() const;
    void setEnumValue(LossOfConnectivityReason_anyOf::eLossOfConnectivityReason_anyOf value);
