...
asn_TYPE_member_t asn_MBR_Ngap_UserLocationInformationEUTRA_1[] = {
    {ATF_POINTER,
     0,
     offsetof(struct Ngap_UserLocationInformationEUTRA, eUTRA_CGI),
    ...
    {ATF_POINTER,
     0,
     offsetof(struct Ngap_UserLocationInformationEUTRA, tAI),
    ...
    {ATF_POINTER,
     2,
     offsetof(struct Ngap_UserLocationInformationEUTRA, timeStamp),
    ...
    {ATF_POINTER,
     1,
     offsetof(struct Ngap_UserLocationInformationEUTRA, iE_Extensions),
     (ASN_TAG_CLASS_CONTEXT | (3 << 2)),
     -1, /* IMPLICIT tag at current level */
     &asn_DEF_Ngap_ProtocolExtensionContainer_12929P364,
     0,
     {
#if !defined(ASN_DISABLE_OER_SUPPORT)
         0,
...
static const int asn_MAP_Ngap_UserLocationInformationEUTRA_oms_1[] = {2, 3};
