...
asn_oer_constraints_t asn_OER_type_Ngap_QosCharacteristics_constr_1
    CC_NOTUSED = {{0, 0}, -1};
...
asn_TYPE_member_t asn_MBR_Ngap_QosCharacteristics_1[] = {
    {ATF_POINTER,
     0,
     offsetof(struct Ngap_QosCharacteristics, choice.nonDynamic5QI),
    ...
    {ATF_POINTER,
     0,
     offsetof(struct Ngap_QosCharacteristics, choice.dynamic5QI),
