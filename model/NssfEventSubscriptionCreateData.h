...
public:
    ...
    /// 
    /// </summary>
    oai::model::NssfEventType getEvent() const;
    void setEvent(oai::model::NssfEventType const& value);
    /// <summary>
    ...
    friend  void to_json(nlohmann::json& j, const NssfEventSubscriptionCreateData& o);
    friend  void from_json(const nlohmann::json& j, NssfEventSubscriptionCreateData& o);
protected:
    std::string m_NfNssaiAvailabilityUri;

    std::vector<oai::model::Tai> m_TaiList;

    oai::model::NssfEventType m_Event;
