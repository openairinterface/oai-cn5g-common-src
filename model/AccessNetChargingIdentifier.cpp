...
std::vector<oai::_3gpp::model::Flows> AccessNetChargingIdentifier::getFlows() const
{
    return m_Flows;
}
void AccessNetChargingIdentifier::setFlows(std::vector<oai::_3gpp::model::Flows> const& value)
{
    m_Flows = value;
    m_FlowsIsSet = true;
}
