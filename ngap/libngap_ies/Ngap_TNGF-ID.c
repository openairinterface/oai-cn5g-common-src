...
static int memb_Ngap_tNGF_ID_constraint_1(
...
#if !defined(ASN_DISABLE_OER_SUPPORT)
asn_oer_constraints_t asn_OER_type_Ngap_TNGF_ID_constr_1 CC_NOTUSED = {
    {0, 0},
    -1};
#endif /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
...
asn_TYPE_member_t asn_MBR_Ngap_TNGF_ID_1[] = {
    {ATF_NOFLAGS,
     0,
     offsetof(struct Ngap_TNGF_ID, choice.tNGF_ID),
     ...
     {
#if !defined(ASN_DISABLE_OER_SUPPORT)
         &asn_OER_memb_Ngap_tNGF_ID_constr_2,
#endif /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
    ...
    {ATF_POINTER,
     0,
     offsetof(struct Ngap_TNGF_ID, choice.choice_Extensions),
     (ASN_TAG_CLASS_CONTEXT | (1 << 2)),
     -1, /* IMPLICIT tag at current level */
     &asn_DEF_Ngap_ProtocolIE_SingleContainer_12877P52,
     0,
     {
#if !defined(ASN_DISABLE_OER_SUPPORT)
         0,
...
asn_TYPE_descriptor_t asn_DEF_Ngap_TNGF_ID = {
    ...
    {
#if !defined(ASN_DISABLE_OER_SUPPORT)
        &asn_OER_type_Ngap_TNGF_ID_constr_1,
#endif /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
