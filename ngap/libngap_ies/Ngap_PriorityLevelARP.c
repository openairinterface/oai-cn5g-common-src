...
int Ngap_PriorityLevelARP_constraint(const asn_TYPE_descriptor_t *td,
                                     const void *sptr,
...
static asn_oer_constraints_t asn_OER_type_Ngap_PriorityLevelARP_constr_1
    CC_NOTUSED = {{1, 1} /* (1..15) */, -1};
