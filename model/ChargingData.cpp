...
bool ChargingData::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "ChargingData" : pathPrefix;
...
bool ChargingData::operator==(const ChargingData& rhs) const
{
    ...
    ((!meteringMethodIsSet() && !rhs.meteringMethodIsSet()) || (meteringMethodIsSet() && rhs.meteringMethodIsSet() && getMeteringMethod() == rhs.getMeteringMethod())) &&
    ...
    ((!sdfHandlIsSet() && !rhs.sdfHandlIsSet()) || (sdfHandlIsSet() && rhs.sdfHandlIsSet() && isSdfHandl() == rhs.isSdfHandl())) &&
    
    
    ((!ratingGroupIsSet() && !rhs.ratingGroupIsSet()) || (ratingGroupIsSet() && rhs.ratingGroupIsSet() && getRatingGroup() == rhs.getRatingGroup())) &&
    
    
    ((!reportingLevelIsSet() && !rhs.reportingLevelIsSet()) || (reportingLevelIsSet() && rhs.reportingLevelIsSet() && getReportingLevel() == rhs.getReportingLevel())) &&
    ...
    ((!appSvcProvIdIsSet() && !rhs.appSvcProvIdIsSet()) || (appSvcProvIdIsSet() && rhs.appSvcProvIdIsSet() && getAppSvcProvId() == rhs.getAppSvcProvId())) &&
    
    
    ((!afChargingIdentifierIsSet() && !rhs.afChargingIdentifierIsSet()) || (afChargingIdentifierIsSet() && rhs.afChargingIdentifierIsSet() && getAfChargingIdentifier() == rhs.getAfChargingIdentifier())) &&
...
oai::_3gpp::model::MeteringMethod ChargingData::getMeteringMethod() const
{
    return m_MeteringMethod;
}
void ChargingData::setMeteringMethod(oai::_3gpp::model::MeteringMethod const& value)
{
...
oai::_3gpp::model::ReportingLevel ChargingData::getReportingLevel() const
{
    return m_ReportingLevel;
}
void ChargingData::setReportingLevel(oai::_3gpp::model::ReportingLevel const& value)
{
