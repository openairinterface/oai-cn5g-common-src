...
bool BsfInfo::operator==(const BsfInfo& rhs) const {
  return
      ...
      ((!ipDomainListIsSet() && !rhs.ipDomainListIsSet()) ||
       (ipDomainListIsSet() && rhs.ipDomainListIsSet() &&
        getIpDomainList() == rhs.getIpDomainList())) &&
...
std::vector<oai::_3gpp::model::Ipv4AddressRange> BsfInfo::getIpv4AddressRanges()
    const {
  return m_Ipv4AddressRanges;
}
void BsfInfo::setIpv4AddressRanges(
...
std::vector<oai::_3gpp::model::Ipv6PrefixRange> BsfInfo::getIpv6PrefixRanges()
    const {
  return m_Ipv6PrefixRanges;
}
void BsfInfo::setIpv6PrefixRanges(
