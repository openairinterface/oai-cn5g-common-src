...
public:
    ...
    /// 
    /// </summary>
    oai::model::MeteringMethod getMeteringMethod() const;
    void setMeteringMethod(oai::model::MeteringMethod const& value);
    ...
    /// 
    /// </summary>
    oai::model::ReportingLevel getReportingLevel() const;
    void setReportingLevel(oai::model::ReportingLevel const& value);
...
protected:
    ...
    oai::model::MeteringMethod m_MeteringMethod;
    ...
    oai::model::ReportingLevel m_ReportingLevel;
