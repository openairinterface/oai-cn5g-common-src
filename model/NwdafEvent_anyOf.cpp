...
bool NwdafEvent_anyOf::validate(
    std::stringstream& msg, const std::string& pathPrefix) const {
  bool success = true;
  const std::string _pathPrefix =
      pathPrefix.empty() ? "NwdafEvent_anyOf" : pathPrefix;

  if (m_value ==
      NwdafEvent_anyOf::eNwdafEvent_anyOf::INVALID_VALUE_OPENAPI_GENERATED) {
    success = false;
...
void to_json(nlohmann::json& j, const NwdafEvent_anyOf& o) {
  ...
  switch (o.getValue()) {
    ...
    case NwdafEvent_anyOf::eNwdafEvent_anyOf::DN_PERFORMANCE:
      j = "DN_PERFORMANCE";
      break;
    case NwdafEvent_anyOf::eNwdafEvent_anyOf::DISPERSION:
      j = "DISPERSION";
      break;
    case NwdafEvent_anyOf::eNwdafEvent_anyOf::RED_TRANS_EXP:
      j = "RED_TRANS_EXP";
      break;
    case NwdafEvent_anyOf::eNwdafEvent_anyOf::WLAN_PERFORMANCE:
      j = "WLAN_PERFORMANCE";
      break;
    case NwdafEvent_anyOf::eNwdafEvent_anyOf::SM_CONGESTION:
      j = "SM_CONGESTION";
      break;
  }
}
...
void from_json(const nlohmann::json& j, NwdafEvent_anyOf& o) {
  ...
  if (s == "SLICE_LOAD_LEVEL") {
    ...
    o.setValue(NwdafEvent_anyOf::eNwdafEvent_anyOf::DISPERSION);
  } else if (s == "RED_TRANS_EXP") {
    o.setValue(NwdafEvent_anyOf::eNwdafEvent_anyOf::RED_TRANS_EXP);
  } else if (s == "WLAN_PERFORMANCE") {
    o.setValue(NwdafEvent_anyOf::eNwdafEvent_anyOf::WLAN_PERFORMANCE);
  } else if (s == "SM_CONGESTION") {
    o.setValue(NwdafEvent_anyOf::eNwdafEvent_anyOf::SM_CONGESTION);
  } else {
    std::stringstream ss;
