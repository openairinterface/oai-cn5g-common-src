...
oai::model::AppSessionContextUpdateData AppSessionContextUpdateDataPatch::getAscReqData() const
{
    return m_AscReqData;
}
void AppSessionContextUpdateDataPatch::setAscReqData(oai::model::AppSessionContextUpdateData const& value)
{
    m_AscReqData = value;
