...
public:
    ...
    /// 
    /// </summary>
    oai::model::AuthenticationVector getAuthenticationVector() const;
    void setAuthenticationVector(oai::model::AuthenticationVector const& value);
...
protected:
    ...
    oai::model::AuthenticationVector m_AuthenticationVector;
