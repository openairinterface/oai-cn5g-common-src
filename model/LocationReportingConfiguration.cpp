...
bool LocationReportingConfiguration::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "LocationReportingConfiguration" : pathPrefix;

                    
    return success;
}

bool LocationReportingConfiguration::operator==(const LocationReportingConfiguration& rhs) const
{
    return
...
oai::_3gpp::model::LocationAccuracy LocationReportingConfiguration::getAccuracy() const
{
    return m_Accuracy;
}
void LocationReportingConfiguration::setAccuracy(oai::_3gpp::model::LocationAccuracy const& value)
{
    m_Accuracy = value;
...
oai::_3gpp::model::LocationAccuracy LocationReportingConfiguration::getN3gppAccuracy() const
{
    return m_N3gppAccuracy;
}
void LocationReportingConfiguration::setN3gppAccuracy(oai::_3gpp::model::LocationAccuracy const& value)
{
