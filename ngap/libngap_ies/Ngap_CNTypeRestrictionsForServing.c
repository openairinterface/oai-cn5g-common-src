...
asn_oer_constraints_t asn_OER_type_Ngap_CNTypeRestrictionsForServing_constr_1
    CC_NOTUSED = {{0, 0}, -1};
#endif /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
asn_per_constraints_t asn_PER_type_Ngap_CNTypeRestrictionsForServing_constr_1
    CC_NOTUSED = {
...
static int asn_validate_Ngap_CNTypeRestrictionsForServing_1(
    const asn_TYPE_descriptor_t* td, const void* sptr,
    asn_app_constraint_failed_f* ctfailcb, void* app_key) {
  if (!sptr) {
    return -1;
  }
  e_Ngap_CNTypeRestrictionsForServing value =
      *(e_Ngap_CNTypeRestrictionsForServing*) sptr;
  switch (value) {
    case Ngap_CNTypeRestrictionsForServing_epc_forbidden:
      return 0;
  }
  return -1;
}
...
const asn_INTEGER_specifics_t
    asn_SPC_Ngap_CNTypeRestrictionsForServing_specs_1 = {
        asn_MAP_Ngap_CNTypeRestrictionsForServing_value2enum_1, /* "tag" => N;
                                                                   sorted by tag
                                                                 */
        asn_MAP_Ngap_CNTypeRestrictionsForServing_enum2value_1, /* N => "tag";
                                                                   sorted by N
                                                                 */
...
asn_TYPE_descriptor_t asn_DEF_Ngap_CNTypeRestrictionsForServing = {
        ...
        sizeof(asn_DEF_Ngap_CNTypeRestrictionsForServing_tags_1[0]), /* 1 */
    {
        ...
        asn_validate_Ngap_CNTypeRestrictionsForServing_1},
    0,
    0,                                                 /* Defined elsewhere */
