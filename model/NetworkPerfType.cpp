...
bool NetworkPerfType::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "NetworkPerfType" : pathPrefix;
...
NetworkPerfType_anyOf::eNetworkPerfType_anyOf NetworkPerfType::getEnumValue() const
{
    return m_value.getValue();
}

void NetworkPerfType::setEnumValue(NetworkPerfType_anyOf::eNetworkPerfType_anyOf  value)
{
