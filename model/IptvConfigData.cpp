...
bool IptvConfigData::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "IptvConfigData" : pathPrefix;
    ...
    /* MultiAccCtrls */ {
        const std::map<std::string, oai::model::MulticastAccessControl>& value = m_MultiAccCtrls;
...
oai::model::Snssai IptvConfigData::getSnssai() const
{
    return m_Snssai;
}
void IptvConfigData::setSnssai(oai::model::Snssai const& value)
{
    m_Snssai = value;
    m_SnssaiIsSet = true;
}
...
std::map<std::string, oai::model::MulticastAccessControl> IptvConfigData::getMultiAccCtrls() const
{
    return m_MultiAccCtrls;
}
void IptvConfigData::setMultiAccCtrls(std::map<std::string, oai::model::MulticastAccessControl> const& value)
{
