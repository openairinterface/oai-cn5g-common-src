...
bool PlmnEcInfo::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "PlmnEcInfo" : pathPrefix;
...
oai::model::PlmnId PlmnEcInfo::getPlmnId() const
{
    return m_PlmnId;
}
void PlmnEcInfo::setPlmnId(oai::model::PlmnId const& value)
{
    m_PlmnId = value;
}
oai::model::EcRestrictionDataWb PlmnEcInfo::getEcRestrictionDataWb() const
{
    return m_EcRestrictionDataWb;
}
void PlmnEcInfo::setEcRestrictionDataWb(oai::model::EcRestrictionDataWb const& value)
{
