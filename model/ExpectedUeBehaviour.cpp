...
oai::_3gpp::model::StationaryIndicationRm ExpectedUeBehaviour::getStationaryIndication() const
{
    return m_StationaryIndication;
}
void ExpectedUeBehaviour::setStationaryIndication(oai::_3gpp::model::StationaryIndicationRm const& value)
{
...
oai::_3gpp::model::ScheduledCommunicationTypeRm ExpectedUeBehaviour::getScheduledCommunicationType() const
{
    return m_ScheduledCommunicationType;
}
void ExpectedUeBehaviour::setScheduledCommunicationType(oai::_3gpp::model::ScheduledCommunicationTypeRm const& value)
{
...
oai::_3gpp::model::ScheduledCommunicationTimeRm ExpectedUeBehaviour::getScheduledCommunicationTime() const
{
    return m_ScheduledCommunicationTime;
}
void ExpectedUeBehaviour::setScheduledCommunicationTime(oai::_3gpp::model::ScheduledCommunicationTimeRm const& value)
{
...
std::vector<oai::_3gpp::model::LocationArea> ExpectedUeBehaviour::getExpectedUmts() const
{
    return m_ExpectedUmts;
}
void ExpectedUeBehaviour::setExpectedUmts(std::vector<oai::_3gpp::model::LocationArea> const& value)
{
...
oai::_3gpp::model::TrafficProfileRm ExpectedUeBehaviour::getTrafficProfile() const
{
    return m_TrafficProfile;
}
void ExpectedUeBehaviour::setTrafficProfile(oai::_3gpp::model::TrafficProfileRm const& value)
{
...
oai::_3gpp::model::BatteryIndicationRm ExpectedUeBehaviour::getBatteryIndication() const
{
    return m_BatteryIndication;
}
void ExpectedUeBehaviour::setBatteryIndication(oai::_3gpp::model::BatteryIndicationRm const& value)
{
