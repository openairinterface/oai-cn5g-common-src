...
bool LteV2xAuth::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "LteV2xAuth" : pathPrefix;
...
bool LteV2xAuth::operator==(const LteV2xAuth& rhs) const
{
    ...
    ((!vehicleUeAuthIsSet() && !rhs.vehicleUeAuthIsSet()) || (vehicleUeAuthIsSet() && rhs.vehicleUeAuthIsSet() && getVehicleUeAuth() == rhs.getVehicleUeAuth())) &&
    
    
    ((!pedestrianUeAuthIsSet() && !rhs.pedestrianUeAuthIsSet()) || (pedestrianUeAuthIsSet() && rhs.pedestrianUeAuthIsSet() && getPedestrianUeAuth() == rhs.getPedestrianUeAuth()))
...
oai::_3gpp::model::UeAuth LteV2xAuth::getVehicleUeAuth() const
{
    return m_VehicleUeAuth;
}
void LteV2xAuth::setVehicleUeAuth(oai::_3gpp::model::UeAuth const& value)
{
...
oai::_3gpp::model::UeAuth LteV2xAuth::getPedestrianUeAuth() const
{
    return m_PedestrianUeAuth;
}
void LteV2xAuth::setPedestrianUeAuth(oai::_3gpp::model::UeAuth const& value)
{
