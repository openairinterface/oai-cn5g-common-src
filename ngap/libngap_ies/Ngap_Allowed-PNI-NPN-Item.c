...
extern asn_TYPE_descriptor_t asn_DEF_Ngap_pNI_NPN_restricted
    __attribute__((weak, alias("asn_DEF_Ngap_pNI_NPN_restricted_3")));
#else
...
asn_DEF_Ngap_pNI_NPN_restricted_3_alias_init(void) {
...
static asn_oer_constraints_t asn_OER_type_Ngap_pNI_NPN_restricted_constr_3
    CC_NOTUSED = {{0, 0}, -1};
#endif /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
static asn_per_constraints_t asn_PER_type_Ngap_pNI_NPN_restricted_constr_3
    CC_NOTUSED = {
...
static int asn_validate_Ngap_pNI_NPN_restricted_3(
    const asn_TYPE_descriptor_t* td, const void* sptr,
    asn_app_constraint_failed_f* ctfailcb, void* app_key) {
  if (!sptr) {
    return -1;
  }
  e_Ngap_Allowed_PNI_NPN_Item__pNI_NPN_restricted value =
      *(e_Ngap_Allowed_PNI_NPN_Item__pNI_NPN_restricted*) sptr;
  switch (value) {
...
static /* Use -fall-defs-global to expose */
    asn_TYPE_descriptor_t asn_DEF_Ngap_pNI_NPN_restricted_3 = {
        ...
        sizeof(asn_DEF_Ngap_pNI_NPN_restricted_tags_3) /
                sizeof(asn_DEF_Ngap_pNI_NPN_restricted_tags_3[0]) -
            1,                                  /* 1 */
        ...
        {
#if !defined(ASN_DISABLE_OER_SUPPORT)
            &asn_OER_type_Ngap_pNI_NPN_restricted_constr_3,
#endif /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
...
asn_TYPE_member_t asn_MBR_Ngap_Allowed_PNI_NPN_Item_1[] = {
    {ATF_NOFLAGS,
     0,
     offsetof(struct Ngap_Allowed_PNI_NPN_Item, pLMNIdentity),
    ...
    {ATF_NOFLAGS,
     0,
     offsetof(struct Ngap_Allowed_PNI_NPN_Item, pNI_NPN_restricted),
    ...
    {ATF_POINTER,
     0,
     offsetof(struct Ngap_Allowed_PNI_NPN_Item, allowed_CAG_List_per_PLMN),
    ...
    {ATF_POINTER,
     1,
     offsetof(struct Ngap_Allowed_PNI_NPN_Item, iE_Extensions),
     (ASN_TAG_CLASS_CONTEXT | (3 << 2)),
     -1, /* IMPLICIT tag at current level */
     &asn_DEF_Ngap_ProtocolExtensionContainer_12929P3,
     0,
     {
#if !defined(ASN_DISABLE_OER_SUPPORT)
         0,
