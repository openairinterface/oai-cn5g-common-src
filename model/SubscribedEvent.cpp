...
SubscribedEvent_anyOf::eSubscribedEvent_anyOf SubscribedEvent::getEnumValue() const
{
    return m_value.getValue();
}

void SubscribedEvent::setEnumValue(SubscribedEvent_anyOf::eSubscribedEvent_anyOf  value)
{
