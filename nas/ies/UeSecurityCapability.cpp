...
//------------------------------------------------------------------------------
UeSecurityCapability::UeSecurityCapability(uint8_t iei, uint8_t _5g_ea,
                                           uint8_t _5g_ia)
    : Type4NasIe(iei) {
  _5g_ea_ = _5g_ea;
  _5g_ia_ = _5g_ia;
...
//------------------------------------------------------------------------------
void UeSecurityCapability::SetEa(uint8_t value) { _5g_ea_ = value; }

//------------------------------------------------------------------------------
uint8_t UeSecurityCapability::GetEa() const { return _5g_ea_; }

//------------------------------------------------------------------------------
void UeSecurityCapability::SetIa(uint8_t value) { _5g_ia_ = value; }

//------------------------------------------------------------------------------
uint8_t UeSecurityCapability::GetIa() const { return _5g_ia_; }
...
//------------------------------------------------------------------------------
void UeSecurityCapability::Set(uint8_t _5g_ea, uint8_t _5g_ia, uint8_t eea,
                               uint8_t eia) {
  _5g_ea_ = _5g_ea;
  _5g_ia_ = _5g_ia;
  eea_ = std::optional<uint8_t>(eea);
...
//------------------------------------------------------------------------------
int UeSecurityCapability::Decode(const uint8_t *const buf, int len,
                                 bool is_iei) {
  ...
  oai::logger::logger_common::nas().debug("5G EA 0x%x, 5G IA 0x%x", _5g_ea_,
                                          _5g_ia_);
  if (eea_.has_value()) {
