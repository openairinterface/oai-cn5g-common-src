...
bool CipheringKeyInfo::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    ...
    /* CipheringData */ {
        const std::vector<oai::_3gpp::model::CipheringDataSet>& value = m_CipheringData;
...
std::vector<oai::_3gpp::model::CipheringDataSet> CipheringKeyInfo::getCipheringData() const
{
    return m_CipheringData;
}
void CipheringKeyInfo::setCipheringData(std::vector<oai::_3gpp::model::CipheringDataSet> const& value)
{
