...
asn_TYPE_member_t asn_MBR_Ngap_PDUSessionResourceFailedToSetupItemCxtFail_1[] = {
    {ATF_NOFLAGS,
     0,
     offsetof(
         struct Ngap_PDUSessionResourceFailedToSetupItemCxtFail, pDUSessionID),
    ...
    {ATF_POINTER,
     1,
     offsetof(
         struct Ngap_PDUSessionResourceFailedToSetupItemCxtFail, iE_Extensions),
...
static const int
    asn_MAP_Ngap_PDUSessionResourceFailedToSetupItemCxtFail_oms_1[] = {2};
...
asn_SEQUENCE_specifics_t
    asn_SPC_Ngap_PDUSessionResourceFailedToSetupItemCxtFail_specs_1 = {
        ...
        offsetof(
            struct Ngap_PDUSessionResourceFailedToSetupItemCxtFail, _asn_ctx),
        asn_MAP_Ngap_PDUSessionResourceFailedToSetupItemCxtFail_tag2el_1,
        3, /* Count of tags in the map */
        asn_MAP_Ngap_PDUSessionResourceFailedToSetupItemCxtFail_oms_1, /* Optional
                                                                          members
                                                                        */
        1,
        0, /* Root/Additions */
...
asn_TYPE_descriptor_t asn_DEF_Ngap_PDUSessionResourceFailedToSetupItemCxtFail = {
    ...
    sizeof(asn_DEF_Ngap_PDUSessionResourceFailedToSetupItemCxtFail_tags_1) /
        sizeof(asn_DEF_Ngap_PDUSessionResourceFailedToSetupItemCxtFail_tags_1
                   [0]),                                            /* 1 */
    asn_DEF_Ngap_PDUSessionResourceFailedToSetupItemCxtFail_tags_1, /* Same
                                                                       as
                                                                       above
                                                                     */
    sizeof(asn_DEF_Ngap_PDUSessionResourceFailedToSetupItemCxtFail_tags_1) /
