...
public:
    ...
    void setN1MessageContainer(oai::_3gpp::model::N1MessageContainer const& value);
    /// <summary>
    /// LCS Correlation ID.
    /// </summary>
    ...
    /// 
    /// </summary>
    oai::_3gpp::model::RegistrationContextContainer getRegistrationCtxtContainer() const;
    void setRegistrationCtxtContainer(oai::_3gpp::model::RegistrationContextContainer const& value);
