...
oai::_3gpp::model::ChangeType ChangeItem::getOp() const
{
    return m_Op;
}
void ChangeItem::setOp(oai::_3gpp::model::ChangeType const& value)
{
    m_Op = value;
}
...
oai::_3gpp::model::nlohmann::json ChangeItem::getOrigValue() const
{
    return m_OrigValue;
}
void ChangeItem::setOrigValue(oai::_3gpp::model::nlohmann::json const& value)
{
    m_OrigValue = value;
...
oai::_3gpp::model::nlohmann::json ChangeItem::getNewValue() const
{
    return m_NewValue;
}
void ChangeItem::setNewValue(oai::_3gpp::model::nlohmann::json const& value)
{
    m_NewValue = value;
