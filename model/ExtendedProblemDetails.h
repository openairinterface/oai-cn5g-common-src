...
public:
    ...
    /// 
    /// </summary>
    oai::model::AcceptableServiceInfo getAcceptableServInfo() const;
    void setAcceptableServInfo(oai::model::AcceptableServiceInfo const& value);
...
protected:
    ...
    std::string m_NrfId;
    bool m_NrfIdIsSet;
    oai::model::AcceptableServiceInfo m_AcceptableServInfo;
