...
public:
  ...
  void
  setPduSessionResourceHandoverList(const PduSessionResourceHandoverList &list);
  bool
  getPduSessionResourceHandoverList(PduSessionResourceHandoverList &list) const;
  ...
  void
  setTargetToSourceTransparentContainer(const OCTET_STRING_t &targetTosource);
  void
  getTargetToSourceTransparentContainer(OCTET_STRING_t &targetTosource) const;
