...
ber_type_decoder_f Ngap_Range_decode_ber;
der_type_encoder_f Ngap_Range_encode_der;
...
per_type_decoder_f Ngap_Range_decode_uper;
per_type_encoder_f Ngap_Range_encode_uper;
