...
bool NotificationData::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    ...
    {
        const std::vector<oai::model::ChangeItem>& value = m_ProfileChanges;
        ...
        { // Recursive validation of array elements
            ...
            int i = 0;
            for (const oai::model::ChangeItem& value : value)
            { 
...
bool NotificationData::operator==(const NotificationData& rhs) const
{
    ...
    ((!subscriptionContextIsSet() && !rhs.subscriptionContextIsSet()) || (subscriptionContextIsSet() && rhs.subscriptionContextIsSet() && getSubscriptionContext() == rhs.getSubscriptionContext()))
...
oai::model::NotificationEventType NotificationData::getEvent() const
{
    return m_Event;
}
void NotificationData::setEvent(oai::model::NotificationEventType const& value)
{
    m_Event = value;
}
...
oai::model::NFProfile NotificationData::getNfProfile() const
{
    return m_NfProfile;
}
void NotificationData::setNfProfile(oai::model::NFProfile const& value)
{
    m_NfProfile = value;
...
std::vector<oai::model::ChangeItem> NotificationData::getProfileChanges() const
{
    return m_ProfileChanges;
}
void NotificationData::setProfileChanges(std::vector<oai::model::ChangeItem> const& value)
{
...
oai::model::ConditionEventType NotificationData::getConditionEvent() const
{
    return m_ConditionEvent;
}
void NotificationData::setConditionEvent(oai::model::ConditionEventType const& value)
{
...
oai::model::SubscriptionContext NotificationData::getSubscriptionContext() const
{
    return m_SubscriptionContext;
}
void NotificationData::setSubscriptionContext(oai::model::SubscriptionContext const& value)
{
