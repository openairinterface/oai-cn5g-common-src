...
bool PwsInformation::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    ...
    {
        const std::vector<oai::_3gpp::model::GlobalRanNodeId>& value = m_BcEmptyAreaList;
...
void PwsInformation::setPwsContainer(oai::_3gpp::model::N2InfoContent const& value)
{
    m_PwsContainer = value;
}
std::vector<oai::_3gpp::model::GlobalRanNodeId> PwsInformation::getBcEmptyAreaList() const
{
    return m_BcEmptyAreaList;
}
void PwsInformation::setBcEmptyAreaList(std::vector<oai::_3gpp::model::GlobalRanNodeId> const& value)
{
