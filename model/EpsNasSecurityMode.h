...
public:
    ...
    void setIntegrityAlgorithm(oai::_3gpp::model::EpsNasIntegrityAlgorithm const& value);
    /// <summary>
    /// 
    /// </summary>
    oai::_3gpp::model::EpsNasCipheringAlgorithm getCipheringAlgorithm() const;
    void setCipheringAlgorithm(oai::_3gpp::model::EpsNasCipheringAlgorithm const& value);
