...
asn_oer_constraints_t asn_OER_type_Ngap_M1ReportingTrigger_constr_1
    CC_NOTUSED = {{0, 0}, -1};
#endif /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
asn_per_constraints_t asn_PER_type_Ngap_M1ReportingTrigger_constr_1
    CC_NOTUSED = {
...
static const asn_INTEGER_enum_map_t
    asn_MAP_Ngap_M1ReportingTrigger_value2enum_1[] = {
        {0, 8, "periodic"},
        {1, 16, "a2eventtriggered"},
        {2, 25, "a2eventtriggered-periodic"}
        /* This list is extensible */
};
static int asn_validate_Ngap_M1ReportingTrigger_1(
...
asn_TYPE_descriptor_t asn_DEF_Ngap_M1ReportingTrigger = {
    ...
    {
#if !defined(ASN_DISABLE_OER_SUPPORT)
        &asn_OER_type_Ngap_M1ReportingTrigger_constr_1,
#endif /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
