...
bool MulticastAccessControl::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "MulticastAccessControl" : pathPrefix;
    ...
    if (!m_AccStatus.validate(msg, _pathPrefix + ".accStatus")) {
        msg << _pathPrefix << ": AccStatus is invalid;";
        success = false;
    }
    return success;
}

bool MulticastAccessControl::operator==(const MulticastAccessControl& rhs) const
{
    return
    
    
    
    ((!srcIpv4AddrIsSet() && !rhs.srcIpv4AddrIsSet()) || (srcIpv4AddrIsSet() && rhs.srcIpv4AddrIsSet() && getSrcIpv4Addr() == rhs.getSrcIpv4Addr())) &&
    
    
    ((!srcIpv6AddrIsSet() && !rhs.srcIpv6AddrIsSet()) || (srcIpv6AddrIsSet() && rhs.srcIpv6AddrIsSet() && getSrcIpv6Addr() == rhs.getSrcIpv6Addr())) &&
    
    
    ((!multicastV4AddrIsSet() && !rhs.multicastV4AddrIsSet()) || (multicastV4AddrIsSet() && rhs.multicastV4AddrIsSet() && getMulticastV4Addr() == rhs.getMulticastV4Addr())) &&
    
    
    ((!multicastV6AddrIsSet() && !rhs.multicastV6AddrIsSet()) || (multicastV6AddrIsSet() && rhs.multicastV6AddrIsSet() && getMulticastV6Addr() == rhs.getMulticastV6Addr())) &&
...
oai::model::Ipv6Addr MulticastAccessControl::getSrcIpv6Addr() const
{
    return m_SrcIpv6Addr;
}
void MulticastAccessControl::setSrcIpv6Addr(oai::model::Ipv6Addr const& value)
{
    m_SrcIpv6Addr = value;
...
oai::model::Ipv6Addr MulticastAccessControl::getMulticastV6Addr() const
{
    return m_MulticastV6Addr;
}
void MulticastAccessControl::setMulticastV6Addr(oai::model::Ipv6Addr const& value)
{
...
oai::model::AccessRightStatus MulticastAccessControl::getAccStatus() const
{
    return m_AccStatus;
}
void MulticastAccessControl::setAccStatus(oai::model::AccessRightStatus const& value)
{
    m_AccStatus = value;
}
