...
bool AllowedMtcProviderInfo::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "AllowedMtcProviderInfo" : pathPrefix;

            
    return success;
}

bool AllowedMtcProviderInfo::operator==(const AllowedMtcProviderInfo& rhs) const
{
    return
...
void AllowedMtcProviderInfo::setMtcProviderInformation(std::string const& value)
{
