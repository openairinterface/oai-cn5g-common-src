...
bool ReachabilityForSmsReport::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "ReachabilityForSmsReport" : pathPrefix;

            
    return success;
}

bool ReachabilityForSmsReport::operator==(const ReachabilityForSmsReport& rhs) const
{
    return
...
oai::_3gpp::model::AccessType ReachabilityForSmsReport::getSmsfAccessType() const
{
    return m_SmsfAccessType;
}
void ReachabilityForSmsReport::setSmsfAccessType(oai::_3gpp::model::AccessType const& value)
{
...
void ReachabilityForSmsReport::setMaxAvailabilityTime(std::string const& value)
{
