...
oai::_3gpp::model::SupportedGADShapes PointUncertaintyEllipse::getShape() const
{
    return m_Shape;
}
void PointUncertaintyEllipse::setShape(oai::_3gpp::model::SupportedGADShapes const& value)
{
    m_Shape = value;
}
oai::_3gpp::model::GeographicalCoordinates PointUncertaintyEllipse::getPoint() const
{
    return m_Point;
}
void PointUncertaintyEllipse::setPoint(oai::_3gpp::model::GeographicalCoordinates const& value)
{
    m_Point = value;
}
oai::_3gpp::model::UncertaintyEllipse PointUncertaintyEllipse::getUncertaintyEllipse() const
{
    return m_UncertaintyEllipse;
}
void PointUncertaintyEllipse::setUncertaintyEllipse(oai::_3gpp::model::UncertaintyEllipse const& value)
{
