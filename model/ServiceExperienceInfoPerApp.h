...
public:
    ...
    /// 
    /// </summary>
    oai::model::AddrFqdn getAppServerIns() const;
    void setAppServerIns(oai::model::AddrFqdn const& value);
    bool appServerInsIsSet() const;
    void unsetAppServerIns();
    /// <summary>
    /// 
    /// </summary>
    std::vector<oai::model::ServiceExperienceInfoPerFlow> getSvcExpPerFlows() const;
    void setSvcExpPerFlows(std::vector<oai::model::ServiceExperienceInfoPerFlow> const& value);
    /// <summary>
    /// 
    /// </summary>
    ...
    friend  void from_json(const nlohmann::json& j, ServiceExperienceInfoPerApp& o);
protected:
    std::string m_AppId;
    bool m_AppIdIsSet;
    oai::model::AddrFqdn m_AppServerIns;
    bool m_AppServerInsIsSet;
    std::vector<oai::model::ServiceExperienceInfoPerFlow> m_SvcExpPerFlows;
