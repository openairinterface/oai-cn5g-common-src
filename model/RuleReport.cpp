...
bool RuleReport::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "RuleReport" : pathPrefix;
    ...
    if (!m_RuleStatus.validate(msg, _pathPrefix + ".ruleStatus")) {
        msg << _pathPrefix << ": RuleStatus is invalid;";
        success = false;
    }     
    if (contVersIsSet())
    {
...
bool RuleReport::operator==(const RuleReport& rhs) const
{
    ...
    ((!contVersIsSet() && !rhs.contVersIsSet()) || (contVersIsSet() && rhs.contVersIsSet() && getContVers() == rhs.getContVers())) &&
    
    
    ((!failureCodeIsSet() && !rhs.failureCodeIsSet()) || (failureCodeIsSet() && rhs.failureCodeIsSet() && getFailureCode() == rhs.getFailureCode())) &&
    
    
    ((!finUnitActIsSet() && !rhs.finUnitActIsSet()) || (finUnitActIsSet() && rhs.finUnitActIsSet() && getFinUnitAct() == rhs.getFinUnitAct())) &&
    ...
    ((!altQosParamIdIsSet() && !rhs.altQosParamIdIsSet()) || (altQosParamIdIsSet() && rhs.altQosParamIdIsSet() && getAltQosParamId() == rhs.getAltQosParamId()))
...
oai::model::RuleStatus RuleReport::getRuleStatus() const
{
    return m_RuleStatus;
}
void RuleReport::setRuleStatus(oai::model::RuleStatus const& value)
{
    m_RuleStatus = value;
}
...
oai::model::FailureCode RuleReport::getFailureCode() const
{
    return m_FailureCode;
}
void RuleReport::setFailureCode(oai::model::FailureCode const& value)
{
    m_FailureCode = value;
...
oai::model::FinalUnitAction RuleReport::getFinUnitAct() const
{
    return m_FinUnitAct;
}
void RuleReport::setFinUnitAct(oai::model::FinalUnitAction const& value)
{
    m_FinUnitAct = value;
...
std::vector<oai::model::RanNasRelCause> RuleReport::getRanNasRelCauses() const
{
    return m_RanNasRelCauses;
}
void RuleReport::setRanNasRelCauses(std::vector<oai::model::RanNasRelCause> const& value)
{
...
std::string RuleReport::getAltQosParamId() const
{
...
bool RuleReport::altQosParamIdIsSet() const
{
    return m_AltQosParamIdIsSet;
}
void RuleReport::unsetAltQosParamId()
{
    m_AltQosParamIdIsSet = false;
}
