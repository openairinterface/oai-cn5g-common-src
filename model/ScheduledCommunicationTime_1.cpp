...
bool ScheduledCommunicationTime_1::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "ScheduledCommunicationTime_1" : pathPrefix;
...
bool ScheduledCommunicationTime_1::operator==(const ScheduledCommunicationTime_1& rhs) const
{
    return
...
void ScheduledCommunicationTime_1::setDaysOfWeek(std::vector<int32_t> const value)
{
    m_DaysOfWeek = value;
