...
bool N2RanInformation::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "N2RanInformation" : pathPrefix;

        
    if (!m_N2InfoContent.validate(msg, _pathPrefix + ".n2InfoContent")) {
        msg << _pathPrefix << ": N2InfoContent is invalid;";
        success = false;
    }
    return success;
}
...
oai::model::N2InfoContent N2RanInformation::getN2InfoContent() const
{
    return m_N2InfoContent;
}
void N2RanInformation::setN2InfoContent(oai::model::N2InfoContent const& value)
{
