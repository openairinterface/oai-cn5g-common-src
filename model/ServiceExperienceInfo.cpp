...
bool ServiceExperienceInfo::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "ServiceExperienceInfo" : pathPrefix;
...
std::vector<oai::_3gpp::model::std::string> ServiceExperienceInfo::getSupis() const
{
    return m_Supis;
}
void ServiceExperienceInfo::setSupis(std::vector<oai::_3gpp::model::std::string> const& value)
{
    m_Supis = value;
    m_SupisIsSet = true;
}
...
std::vector<oai::_3gpp::model::ServiceExperienceInfoPerFlow> ServiceExperienceInfo::getSvcExpPerFlows() const
{
    return m_SvcExpPerFlows;
}
void ServiceExperienceInfo::setSvcExpPerFlows(std::vector<oai::_3gpp::model::ServiceExperienceInfoPerFlow> const& value)
{
