...
bool N1N2MessageTransferRspData::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "N1N2MessageTransferRspData" : pathPrefix;
...
bool N1N2MessageTransferRspData::operator==(const N1N2MessageTransferRspData& rhs) const
{
    return
...
oai::model::N1N2MessageTransferCause N1N2MessageTransferRspData::getCause() const
{
    return m_Cause;
}
void N1N2MessageTransferRspData::setCause(oai::model::N1N2MessageTransferCause const& value)
{
    m_Cause = value;
}
