...
bool NfInfo::operator==(const NfInfo& rhs) const {
  return
      ...
      ((!nfTypeIsSet() && !rhs.nfTypeIsSet()) ||
       (nfTypeIsSet() && rhs.nfTypeIsSet() && getNfType() == rhs.getNfType()))
...
oai::_3gpp::model::NFType NfInfo::getNfType() const {
  return m_NfType;
}
void NfInfo::setNfType(oai::_3gpp::model::NFType const& value) {
  m_NfType      = value;
  m_NfTypeIsSet = true;
}
