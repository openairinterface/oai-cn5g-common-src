...
bool MotionEventInfo::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "MotionEventInfo" : pathPrefix;
...
oai::_3gpp::model::OccurrenceInfo MotionEventInfo::getOccurrenceInfo() const
{
    return m_OccurrenceInfo;
}
void MotionEventInfo::setOccurrenceInfo(oai::_3gpp::model::OccurrenceInfo const& value)
{
