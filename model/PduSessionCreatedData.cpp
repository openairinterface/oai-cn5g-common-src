...
bool PduSessionCreatedData::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    ...
    {
        const std::vector<oai::_3gpp::model::QosFlowSetupItem>& value = m_QosFlowsSetupList;
...
oai::_3gpp::model::PduSessionType PduSessionCreatedData::getPduSessionType() const
{
    return m_PduSessionType;
}
void PduSessionCreatedData::setPduSessionType(oai::_3gpp::model::PduSessionType const& value)
{
...
void PduSessionCreatedData::setHcnTunnelInfo(oai::_3gpp::model::TunnelInfo const& value)
{
...
void PduSessionCreatedData::setCnTunnelInfo(oai::_3gpp::model::TunnelInfo const& value)
{
...
oai::_3gpp::model::TunnelInfo PduSessionCreatedData::getAdditionalCnTunnelInfo() const
{
    return m_AdditionalCnTunnelInfo;
}
void PduSessionCreatedData::setAdditionalCnTunnelInfo(oai::_3gpp::model::TunnelInfo const& value)
{
...
void PduSessionCreatedData::setSessionAmbr(oai::_3gpp::model::Ambr const& value)
{
    m_SessionAmbr = value;
...
std::vector<oai::_3gpp::model::QosFlowSetupItem> PduSessionCreatedData::getQosFlowsSetupList() const
{
    return m_QosFlowsSetupList;
}
void PduSessionCreatedData::setQosFlowsSetupList(std::vector<oai::_3gpp::model::QosFlowSetupItem> const& value)
{
...
void PduSessionCreatedData::setAdditionalSnssai(oai::_3gpp::model::Snssai const& value)
{
...
void PduSessionCreatedData::setUeIpv6Prefix(oai::_3gpp::model::Ipv6Prefix const& value)
{
...
oai::_3gpp::model::RefToBinaryData PduSessionCreatedData::getN1SmInfoToUe() const
{
    return m_N1SmInfoToUe;
}
void PduSessionCreatedData::setN1SmInfoToUe(oai::_3gpp::model::RefToBinaryData const& value)
{
...
oai::_3gpp::model::EpsPdnCnxInfo PduSessionCreatedData::getEpsPdnCnxInfo() const
{
    return m_EpsPdnCnxInfo;
}
void PduSessionCreatedData::setEpsPdnCnxInfo(oai::_3gpp::model::EpsPdnCnxInfo const& value)
{
...
std::vector<oai::_3gpp::model::EpsBearerInfo> PduSessionCreatedData::getEpsBearerInfo() const
{
    return m_EpsBearerInfo;
}
void PduSessionCreatedData::setEpsBearerInfo(std::vector<oai::_3gpp::model::EpsBearerInfo> const& value)
{
...
oai::_3gpp::model::MaxIntegrityProtectedDataRate PduSessionCreatedData::getMaxIntegrityProtectedDataRate() const
{
    return m_MaxIntegrityProtectedDataRate;
}
void PduSessionCreatedData::setMaxIntegrityProtectedDataRate(oai::_3gpp::model::MaxIntegrityProtectedDataRate const& value)
{
...
oai::_3gpp::model::MaxIntegrityProtectedDataRate PduSessionCreatedData::getMaxIntegrityProtectedDataRateDl() const
{
    return m_MaxIntegrityProtectedDataRateDl;
}
void PduSessionCreatedData::setMaxIntegrityProtectedDataRateDl(oai::_3gpp::model::MaxIntegrityProtectedDataRate const& value)
{
...
void PduSessionCreatedData::setUpSecurity(oai::_3gpp::model::UpSecurity const& value)
{
    m_UpSecurity = value;
...
oai::_3gpp::model::RoamingChargingProfile PduSessionCreatedData::getRoamingChargingProfile() const
{
    return m_RoamingChargingProfile;
}
void PduSessionCreatedData::setRoamingChargingProfile(oai::_3gpp::model::RoamingChargingProfile const& value)
{
...
std::vector<oai::_3gpp::model::std::string> PduSessionCreatedData::getDnaiList() const
{
    return m_DnaiList;
}
void PduSessionCreatedData::setDnaiList(std::vector<oai::_3gpp::model::std::string> const& value)
{
    m_DnaiList = value;
...
void PduSessionCreatedData::setDnAaaAddress(oai::_3gpp::model::IpAddress const& value)
{
...
oai::_3gpp::model::RedundantPduSessionInformation PduSessionCreatedData::getRedundantPduSessionInfo() const
{
    return m_RedundantPduSessionInfo;
}
void PduSessionCreatedData::setRedundantPduSessionInfo(oai::_3gpp::model::RedundantPduSessionInformation const& value)
{
