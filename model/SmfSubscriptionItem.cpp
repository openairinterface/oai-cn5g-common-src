...
bool SmfSubscriptionItem::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "SmfSubscriptionItem" : pathPrefix;
...
oai::model::ContextInfo SmfSubscriptionItem::getContextInfo() const
{
    return m_ContextInfo;
}
void SmfSubscriptionItem::setContextInfo(oai::model::ContextInfo const& value)
{
    m_ContextInfo = value;
