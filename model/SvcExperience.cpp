...
bool SvcExperience::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "SvcExperience" : pathPrefix;
...
bool SvcExperience::operator==(const SvcExperience& rhs) const
{
    ...
    ((!mosIsSet() && !rhs.mosIsSet()) || (mosIsSet() && rhs.mosIsSet() && getMos() == rhs.getMos())) &&
    
    
    ((!upperRangeIsSet() && !rhs.upperRangeIsSet()) || (upperRangeIsSet() && rhs.upperRangeIsSet() && getUpperRange() == rhs.getUpperRange())) &&
    
    
    ((!lowerRangeIsSet() && !rhs.lowerRangeIsSet()) || (lowerRangeIsSet() && rhs.lowerRangeIsSet() && getLowerRange() == rhs.getLowerRange()))
