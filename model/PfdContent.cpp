...
bool PfdContent::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "PfdContent" : pathPrefix;
...
bool PfdContent::operator==(const PfdContent& rhs) const
{
    ...
    ((!pfdIdIsSet() && !rhs.pfdIdIsSet()) || (pfdIdIsSet() && rhs.pfdIdIsSet() && getPfdId() == rhs.getPfdId())) &&
    ...
    ((!domainNamesIsSet() && !rhs.domainNamesIsSet()) || (domainNamesIsSet() && rhs.domainNamesIsSet() && getDomainNames() == rhs.getDomainNames())) &&
    
    
    ((!dnProtocolIsSet() && !rhs.dnProtocolIsSet()) || (dnProtocolIsSet() && rhs.dnProtocolIsSet() && getDnProtocol() == rhs.getDnProtocol()))
...
oai::model::DomainNameProtocol PfdContent::getDnProtocol() const
{
    return m_DnProtocol;
}
void PfdContent::setDnProtocol(oai::model::DomainNameProtocol const& value)
{
    m_DnProtocol = value;
