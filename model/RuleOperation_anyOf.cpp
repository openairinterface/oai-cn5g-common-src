...
bool RuleOperation_anyOf::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "RuleOperation_anyOf" : pathPrefix;

    
    if (m_value == RuleOperation_anyOf::eRuleOperation_anyOf::INVALID_VALUE_OPENAPI_GENERATED)
    {
        success = false;
...
void to_json(nlohmann::json& j, const RuleOperation_anyOf& o)
{
    ...
    switch (o.getValue())
    {
        case RuleOperation_anyOf::eRuleOperation_anyOf::INVALID_VALUE_OPENAPI_GENERATED:
        ...
        case RuleOperation_anyOf::eRuleOperation_anyOf::DELETE_PCC_RULE:
            j = "DELETE_PCC_RULE";
            break;
        case RuleOperation_anyOf::eRuleOperation_anyOf::MODIFY_PCC_RULE_AND_ADD_PACKET_FILTERS:
            j = "MODIFY_PCC_RULE_AND_ADD_PACKET_FILTERS";
            break;
        case RuleOperation_anyOf::eRuleOperation_anyOf::MODIFY__PCC_RULE_AND_REPLACE_PACKET_FILTERS:
            j = "MODIFY_ PCC_RULE_AND_REPLACE_PACKET_FILTERS";
            break;
        case RuleOperation_anyOf::eRuleOperation_anyOf::MODIFY__PCC_RULE_AND_DELETE_PACKET_FILTERS:
            j = "MODIFY_ PCC_RULE_AND_DELETE_PACKET_FILTERS";
            break;
        case RuleOperation_anyOf::eRuleOperation_anyOf::MODIFY_PCC_RULE_WITHOUT_MODIFY_PACKET_FILTERS:
...
void from_json(const nlohmann::json& j, RuleOperation_anyOf& o)
{
    ...
    if (s == "CREATE_PCC_RULE") {
     ...
     o.setValue(RuleOperation_anyOf::eRuleOperation_anyOf::MODIFY_PCC_RULE_AND_ADD_PACKET_FILTERS);
    } 
    else if (s == "MODIFY_ PCC_RULE_AND_REPLACE_PACKET_FILTERS") {
     o.setValue(RuleOperation_anyOf::eRuleOperation_anyOf::MODIFY__PCC_RULE_AND_REPLACE_PACKET_FILTERS);
    } 
    else if (s == "MODIFY_ PCC_RULE_AND_DELETE_PACKET_FILTERS") {
     o.setValue(RuleOperation_anyOf::eRuleOperation_anyOf::MODIFY__PCC_RULE_AND_DELETE_PACKET_FILTERS);
    } 
    else if (s == "MODIFY_PCC_RULE_WITHOUT_MODIFY_PACKET_FILTERS") {
     o.setValue(RuleOperation_anyOf::eRuleOperation_anyOf::MODIFY_PCC_RULE_WITHOUT_MODIFY_PACKET_FILTERS);
    }  else {
     std::stringstream ss;
...
RuleOperation_anyOf::eRuleOperation_anyOf RuleOperation_anyOf::getValue() const
{
    return m_value;
}
void RuleOperation_anyOf::setValue(RuleOperation_anyOf::eRuleOperation_anyOf value)
{
    m_value = value;
}
