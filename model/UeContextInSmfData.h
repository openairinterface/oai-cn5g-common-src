...
public:
    ...
    /// </summary>
    std::map<std::string, oai::model::PduSession> getPduSessions() const;
    void setPduSessions(std::map<std::string, oai::model::PduSession> const& value);
    bool pduSessionsIsSet() const;
    void unsetPduSessions();
    /// <summary>
    /// 
    /// </summary>
    std::vector<oai::model::PgwInfo> getPgwInfo() const;
    void setPgwInfo(std::vector<oai::model::PgwInfo> const& value);
    bool pgwInfoIsSet() const;
    void unsetPgwInfo();
    /// <summary>
    /// 
    /// </summary>
    oai::model::EmergencyInfo getEmergencyInfo() const;
    void setEmergencyInfo(oai::model::EmergencyInfo const& value);
...
protected:
    std::map<std::string, oai::model::PduSession> m_PduSessions;
    bool m_PduSessionsIsSet;
    std::vector<oai::model::PgwInfo> m_PgwInfo;
    bool m_PgwInfoIsSet;
    oai::model::EmergencyInfo m_EmergencyInfo;
