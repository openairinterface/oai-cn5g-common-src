...
public:
    ...
    CollectionPeriodRmmNrMdt_anyOf::eCollectionPeriodRmmNrMdt_anyOf getEnumValue() const;
    void setEnumValue(CollectionPeriodRmmNrMdt_anyOf::eCollectionPeriodRmmNrMdt_anyOf value);
