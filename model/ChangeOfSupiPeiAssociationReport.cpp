...
bool ChangeOfSupiPeiAssociationReport::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "ChangeOfSupiPeiAssociationReport" : pathPrefix;
...
bool ChangeOfSupiPeiAssociationReport::operator==(const ChangeOfSupiPeiAssociationReport& rhs) const
{
    return
