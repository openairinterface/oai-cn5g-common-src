...
bool ReachabilityReport::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "ReachabilityReport" : pathPrefix;
...
std::vector<oai::model::AccessType> ReachabilityReport::getAccessTypeList() const
{
    return m_AccessTypeList;
}
void ReachabilityReport::setAccessTypeList(std::vector<oai::model::AccessType> const& value)
{
...
oai::model::UeReachability ReachabilityReport::getReachability() const
{
    return m_Reachability;
}
void ReachabilityReport::setReachability(oai::model::UeReachability const& value)
{
...
oai::model::IdleStatusIndication ReachabilityReport::getIdleStatusIndication() const
{
    return m_IdleStatusIndication;
}
void ReachabilityReport::setIdleStatusIndication(oai::model::IdleStatusIndication const& value)
{
