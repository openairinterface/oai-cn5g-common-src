...
oai::_3gpp::model::AmfEventSubscription AmfCreateEventSubscription::getSubscription() const
{
    return m_Subscription;
}
void AmfCreateEventSubscription::setSubscription(oai::_3gpp::model::AmfEventSubscription const& value)
{
...
oai::_3gpp::model::Guami AmfCreateEventSubscription::getOldGuami() const
{
    return m_OldGuami;
}
void AmfCreateEventSubscription::setOldGuami(oai::_3gpp::model::Guami const& value)
{
    m_OldGuami = value;
