...
asn_SET_OF_specifics_t
    asn_SPC_Ngap_PDUSessionResourceReleasedListPSAck_specs_1 = {
...
asn_TYPE_descriptor_t asn_DEF_Ngap_PDUSessionResourceReleasedListPSAck = {
    ...
    sizeof(asn_DEF_Ngap_PDUSessionResourceReleasedListPSAck_tags_1) /
        sizeof(
            asn_DEF_Ngap_PDUSessionResourceReleasedListPSAck_tags_1[0]), /* 1 */
    ...
    1, /* Single element */
    &asn_SPC_Ngap_PDUSessionResourceReleasedListPSAck_specs_1 /* Additional
                                                                 specs */
};
