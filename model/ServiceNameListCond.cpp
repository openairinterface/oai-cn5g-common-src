...
std::vector<oai::model::ServiceName> ServiceNameListCond::getServiceNameList() const
{
    return m_ServiceNameList;
}
void ServiceNameListCond::setServiceNameList(std::vector<oai::model::ServiceName> const& value)
{
