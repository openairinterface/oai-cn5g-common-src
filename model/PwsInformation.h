...
public:
    ...
    /// 
    /// </summary>
    oai::model::N2InfoContent getPwsContainer() const;
    void setPwsContainer(oai::model::N2InfoContent const& value);
    /// <summary>
    /// 
    /// </summary>
    std::vector<oai::model::GlobalRanNodeId> getBcEmptyAreaList() const;
    void setBcEmptyAreaList(std::vector<oai::model::GlobalRanNodeId> const& value);
...
protected:
    ...
    oai::model::N2InfoContent m_PwsContainer;

    std::vector<oai::model::GlobalRanNodeId> m_BcEmptyAreaList;
