...
public:
    ...
    /// 
    /// </summary>
    std::vector<oai::model::SnssaiUpfInfoItem> getSNssaiMbUpfInfoList() const;
    void setSNssaiMbUpfInfoList(std::vector<oai::model::SnssaiUpfInfoItem> const& value);
    /// <summary>
    /// 
    /// </summary>
    ...
    /// 
    /// </summary>
    std::vector<oai::model::InterfaceUpfInfoItem> getInterfaceMbUpfInfoList() const;
    void setInterfaceMbUpfInfoList(std::vector<oai::model::InterfaceUpfInfoItem> const& value);
...
protected:
    std::vector<oai::model::SnssaiUpfInfoItem> m_SNssaiMbUpfInfoList;

    std::vector<std::string> m_MbSmfServingArea;
    bool m_MbSmfServingAreaIsSet;
    std::vector<oai::model::InterfaceUpfInfoItem> m_InterfaceMbUpfInfoList;
