...
bool EasdfInfo::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    ...
    {
        const std::vector<oai::_3gpp::model::SnssaiEasdfInfoItem>& value = m_SNssaiEasdfInfoList;
    ...
    {
        const std::vector<oai::_3gpp::model::IpAddr>& value = m_EasdfN6IpAddressList;
...
std::vector<oai::_3gpp::model::SnssaiEasdfInfoItem> EasdfInfo::getSNssaiEasdfInfoList() const
{
    return m_SNssaiEasdfInfoList;
}
void EasdfInfo::setSNssaiEasdfInfoList(std::vector<oai::_3gpp::model::SnssaiEasdfInfoItem> const& value)
{
...
std::vector<oai::_3gpp::model::IpAddr> EasdfInfo::getEasdfN6IpAddressList() const
{
    return m_EasdfN6IpAddressList;
}
void EasdfInfo::setEasdfN6IpAddressList(std::vector<oai::_3gpp::model::IpAddr> const& value)
{
...
std::vector<oai::_3gpp::model::IpAddr> EasdfInfo::getUpfN6IpAddressList() const
{
    return m_UpfN6IpAddressList;
}
void EasdfInfo::setUpfN6IpAddressList(std::vector<oai::_3gpp::model::IpAddr> const& value)
{
