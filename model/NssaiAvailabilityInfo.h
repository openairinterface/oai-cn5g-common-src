...
public:
    ...
    /// 
    /// </summary>
    std::vector<oai::_3gpp::model::SupportedNssaiAvailabilityData> getSupportedNssaiAvailabilityData() const;
    void setSupportedNssaiAvailabilityData(std::vector<oai::_3gpp::model::SupportedNssaiAvailabilityData> const& value);
    /// <summary>
...
protected:
    std::vector<oai::_3gpp::model::SupportedNssaiAvailabilityData> m_SupportedNssaiAvailabilityData;
