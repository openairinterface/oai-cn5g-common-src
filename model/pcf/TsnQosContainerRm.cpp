...
bool TsnQosContainerRm::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "TsnQosContainerRm" : pathPrefix;
...
bool TsnQosContainerRm::operator==(const TsnQosContainerRm& rhs) const
{
    ...
    ((!maxTscBurstSizeIsSet() && !rhs.maxTscBurstSizeIsSet()) || (maxTscBurstSizeIsSet() && rhs.maxTscBurstSizeIsSet() && getMaxTscBurstSize() == rhs.getMaxTscBurstSize())) &&
    
    
    ((!tscPackDelayIsSet() && !rhs.tscPackDelayIsSet()) || (tscPackDelayIsSet() && rhs.tscPackDelayIsSet() && getTscPackDelay() == rhs.getTscPackDelay())) &&
    
    
    ((!maxPerIsSet() && !rhs.maxPerIsSet()) || (maxPerIsSet() && rhs.maxPerIsSet() && getMaxPer() == rhs.getMaxPer())) &&
    
    
    ((!tscPrioLevelIsSet() && !rhs.tscPrioLevelIsSet()) || (tscPrioLevelIsSet() && rhs.tscPrioLevelIsSet() && getTscPrioLevel() == rhs.getTscPrioLevel()))
