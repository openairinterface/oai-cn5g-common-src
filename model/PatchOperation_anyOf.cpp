...
bool PatchOperation_anyOf::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "PatchOperation_anyOf" : pathPrefix;

    
    if (m_value == PatchOperation_anyOf::ePatchOperation_anyOf::INVALID_VALUE_OPENAPI_GENERATED)
    {
        success = false;
...
void to_json(nlohmann::json& j, const PatchOperation_anyOf& o)
{
    ...
    switch (o.getValue())
    {
        case PatchOperation_anyOf::ePatchOperation_anyOf::INVALID_VALUE_OPENAPI_GENERATED:
...
PatchOperation_anyOf::ePatchOperation_anyOf PatchOperation_anyOf::getValue() const
{
    return m_value;
}
void PatchOperation_anyOf::setValue(PatchOperation_anyOf::ePatchOperation_anyOf value)
{
    m_value = value;
}
