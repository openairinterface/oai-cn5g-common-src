...
void AccessAndMobilityData::validate() const
{
...
bool AccessAndMobilityData::validate(std::stringstream& msg) const
{
    return validate(msg, "");
}

bool AccessAndMobilityData::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "AccessAndMobilityData" : pathPrefix;

                             
    if (regStatesIsSet())
    {
        const std::vector<oai::model::RmInfo>& value = m_RegStates;
        const std::string currentValuePath = _pathPrefix + ".regStates";
        ...
        success = value.validate(msg, currentValuePath + ".regStates") && success;
    ...
    if (connStatesIsSet())
    {
        const std::vector<oai::model::CmInfo>& value = m_ConnStates;
        const std::string currentValuePath = _pathPrefix + ".connStates";
        ...
        success = value.validate(msg, currentValuePath + ".connStates") && success;
    ...
    if (ratTypeIsSet())
    {
        const std::vector<oai::model::RatType>& value = m_RatType;
        ...
        success = value.validate(msg, currentValuePath + ".ratType") && success;
...
bool AccessAndMobilityData::operator==(const AccessAndMobilityData& rhs) const
{
    return
    ...
    ((!locationTsIsSet() && !rhs.locationTsIsSet()) || (locationTsIsSet() && rhs.locationTsIsSet() && getLocationTs() == rhs.getLocationTs())) &&
    
    
    ((!timeZoneIsSet() && !rhs.timeZoneIsSet()) || (timeZoneIsSet() && rhs.timeZoneIsSet() && getTimeZone() == rhs.getTimeZone())) &&
    
    
    ((!timeZoneTsIsSet() && !rhs.timeZoneTsIsSet()) || (timeZoneTsIsSet() && rhs.timeZoneTsIsSet() && getTimeZoneTs() == rhs.getTimeZoneTs())) &&
    
    
    ((!accessTypeIsSet() && !rhs.accessTypeIsSet()) || (accessTypeIsSet() && rhs.accessTypeIsSet() && getAccessType() == rhs.getAccessType())) &&
    
    
    ((!regStatesIsSet() && !rhs.regStatesIsSet()) || (regStatesIsSet() && rhs.regStatesIsSet() && getRegStates() == rhs.getRegStates())) &&
    
    
    ((!regStatesTsIsSet() && !rhs.regStatesTsIsSet()) || (regStatesTsIsSet() && rhs.regStatesTsIsSet() && getRegStatesTs() == rhs.getRegStatesTs())) &&
    
    
    ((!connStatesIsSet() && !rhs.connStatesIsSet()) || (connStatesIsSet() && rhs.connStatesIsSet() && getConnStates() == rhs.getConnStates())) &&
    
    
    ((!connStatesTsIsSet() && !rhs.connStatesTsIsSet()) || (connStatesTsIsSet() && rhs.connStatesTsIsSet() && getConnStatesTs() == rhs.getConnStatesTs())) &&
    
    
    ((!reachabilityStatusIsSet() && !rhs.reachabilityStatusIsSet()) || (reachabilityStatusIsSet() && rhs.reachabilityStatusIsSet() && getReachabilityStatus() == rhs.getReachabilityStatus())) &&
    
    
    ((!reachabilityStatusTsIsSet() && !rhs.reachabilityStatusTsIsSet()) || (reachabilityStatusTsIsSet() && rhs.reachabilityStatusTsIsSet() && getReachabilityStatusTs() == rhs.getReachabilityStatusTs())) &&
    
    
    ((!smsOverNasStatusIsSet() && !rhs.smsOverNasStatusIsSet()) || (smsOverNasStatusIsSet() && rhs.smsOverNasStatusIsSet() && getSmsOverNasStatus() == rhs.getSmsOverNasStatus())) &&
    
    
    ((!smsOverNasStatusTsIsSet() && !rhs.smsOverNasStatusTsIsSet()) || (smsOverNasStatusTsIsSet() && rhs.smsOverNasStatusTsIsSet() && getSmsOverNasStatusTs() == rhs.getSmsOverNasStatusTs())) &&
    
    
    ((!roamingStatusIsSet() && !rhs.roamingStatusIsSet()) || (roamingStatusIsSet() && rhs.roamingStatusIsSet() && isRoamingStatus() == rhs.isRoamingStatus())) &&
    
    
    ((!roamingStatusTsIsSet() && !rhs.roamingStatusTsIsSet()) || (roamingStatusTsIsSet() && rhs.roamingStatusTsIsSet() && getRoamingStatusTs() == rhs.getRoamingStatusTs())) &&
    
    
    ((!currentPlmnIsSet() && !rhs.currentPlmnIsSet()) || (currentPlmnIsSet() && rhs.currentPlmnIsSet() && getCurrentPlmn() == rhs.getCurrentPlmn())) &&
    
    
    ((!currentPlmnTsIsSet() && !rhs.currentPlmnTsIsSet()) || (currentPlmnTsIsSet() && rhs.currentPlmnTsIsSet() && getCurrentPlmnTs() == rhs.getCurrentPlmnTs())) &&
    
    
    ((!ratTypeIsSet() && !rhs.ratTypeIsSet()) || (ratTypeIsSet() && rhs.ratTypeIsSet() && getRatType() == rhs.getRatType())) &&
    
    
    ((!ratTypesTsIsSet() && !rhs.ratTypesTsIsSet()) || (ratTypesTsIsSet() && rhs.ratTypesTsIsSet() && getRatTypesTs() == rhs.getRatTypesTs())) &&
...
oai::model::UserLocation AccessAndMobilityData::getLocation() const
{
    return m_Location;
}
void AccessAndMobilityData::setLocation(oai::model::UserLocation const& value)
{
    m_Location = value;
...
oai::model::AccessType AccessAndMobilityData::getAccessType() const
{
    return m_AccessType;
}
void AccessAndMobilityData::setAccessType(oai::model::AccessType const& value)
{
    m_AccessType = value;
...
std::vector<oai::model::RmInfo> AccessAndMobilityData::getRegStates() const
{
    return m_RegStates;
}
void AccessAndMobilityData::setRegStates(std::vector<oai::model::RmInfo> const& value)
{
    m_RegStates = value;
...
std::vector<oai::model::CmInfo> AccessAndMobilityData::getConnStates() const
{
    return m_ConnStates;
}
void AccessAndMobilityData::setConnStates(std::vector<oai::model::CmInfo> const& value)
{
    m_ConnStates = value;
...
oai::model::UeReachability AccessAndMobilityData::getReachabilityStatus() const
{
    return m_ReachabilityStatus;
}
void AccessAndMobilityData::setReachabilityStatus(oai::model::UeReachability const& value)
{
...
oai::model::SmsSupport AccessAndMobilityData::getSmsOverNasStatus() const
{
    return m_SmsOverNasStatus;
}
void AccessAndMobilityData::setSmsOverNasStatus(oai::model::SmsSupport const& value)
{
...
oai::model::PlmnId AccessAndMobilityData::getCurrentPlmn() const
{
    return m_CurrentPlmn;
}
void AccessAndMobilityData::setCurrentPlmn(oai::model::PlmnId const& value)
{
    m_CurrentPlmn = value;
...
std::vector<oai::model::RatType> AccessAndMobilityData::getRatType() const
{
    return m_RatType;
}
void AccessAndMobilityData::setRatType(std::vector<oai::model::RatType> const& value)
{
    m_RatType = value;
    m_RatTypeIsSet = true;
}
...
std::vector<std::string> AccessAndMobilityData::getResetIds() const
{
    return m_ResetIds;
}
void AccessAndMobilityData::setResetIds(std::vector<std::string> const& value)
{
    m_ResetIds = value;
    m_ResetIdsIsSet = true;
}
bool AccessAndMobilityData::resetIdsIsSet() const
{
    return m_ResetIdsIsSet;
}
void AccessAndMobilityData::unsetResetIds()
{
    m_ResetIdsIsSet = false;
}
