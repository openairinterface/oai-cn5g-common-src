...
std::vector<std::string> ExposureDataSubscription::getMonitoredResourceUris() const
{
    return m_MonitoredResourceUris;
}
void ExposureDataSubscription::setMonitoredResourceUris(std::vector<std::string> const& value)
{
