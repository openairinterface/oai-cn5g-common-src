...
bool DatalinkReportingConfiguration::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    ...
    {
        const std::vector<oai::_3gpp::model::DddTrafficDescriptor>& value = m_DddTrafficDes;
...
std::vector<oai::_3gpp::model::DddTrafficDescriptor> DatalinkReportingConfiguration::getDddTrafficDes() const
{
    return m_DddTrafficDes;
}
void DatalinkReportingConfiguration::setDddTrafficDes(std::vector<oai::_3gpp::model::DddTrafficDescriptor> const& value)
{
...
void DatalinkReportingConfiguration::setSlice(oai::_3gpp::model::Snssai const& value)
{
    m_Slice = value;
    m_SliceIsSet = true;
}
...
std::vector<oai::_3gpp::model::DlDataDeliveryStatus> DatalinkReportingConfiguration::getDddStatusList() const
{
    return m_DddStatusList;
}
void DatalinkReportingConfiguration::setDddStatusList(std::vector<oai::_3gpp::model::DlDataDeliveryStatus> const& value)
{
