...
bool SmContextCreatedData::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "SmContextCreatedData" : pathPrefix;
...
bool SmContextCreatedData::operator==(const SmContextCreatedData& rhs) const
{
    ...
    ((!maxPacketSizeIsSet() && !rhs.maxPacketSizeIsSet()) || (maxPacketSizeIsSet() && rhs.maxPacketSizeIsSet() && getMaxPacketSize() == rhs.getMaxPacketSize()))
...
oai::model::Snssai SmContextCreatedData::getSnssai() const
{
    return m_Snssai;
}
void SmContextCreatedData::setSnssai(oai::model::Snssai const& value)
{
    m_Snssai = value;
}
