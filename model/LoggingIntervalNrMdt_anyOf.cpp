...
bool LoggingIntervalNrMdt_anyOf::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "LoggingIntervalNrMdt_anyOf" : pathPrefix;

    
    if (m_value == LoggingIntervalNrMdt_anyOf::eLoggingIntervalNrMdt_anyOf::INVALID_VALUE_OPENAPI_GENERATED)
    {
        success = false;
...
bool LoggingIntervalNrMdt_anyOf::operator==(const LoggingIntervalNrMdt_anyOf& rhs) const
{
    return
...
void to_json(nlohmann::json& j, const LoggingIntervalNrMdt_anyOf& o)
{
    ...
    switch (o.getValue())
    {
        case LoggingIntervalNrMdt_anyOf::eLoggingIntervalNrMdt_anyOf::INVALID_VALUE_OPENAPI_GENERATED:
...
void from_json(const nlohmann::json& j, LoggingIntervalNrMdt_anyOf& o)
{
    ...
    if (s == "128") {
     ...
     o.setValue(LoggingIntervalNrMdt_anyOf::eLoggingIntervalNrMdt_anyOf::INFINITY);
    }  else {
     std::stringstream ss;
...
LoggingIntervalNrMdt_anyOf::eLoggingIntervalNrMdt_anyOf LoggingIntervalNrMdt_anyOf::getValue() const
{
    return m_value;
}
void LoggingIntervalNrMdt_anyOf::setValue(LoggingIntervalNrMdt_anyOf::eLoggingIntervalNrMdt_anyOf value)
{
    m_value = value;
}
