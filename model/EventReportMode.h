...
public:
    ...
    void setValue(EventReportMode_anyOf value);
    EventReportMode_anyOf::eEventReportMode_anyOf getEnumValue() const;
    void setEnumValue(EventReportMode_anyOf::eEventReportMode_anyOf value);
