...
public:
    ...
    /// 
    /// </summary>
    oai::model::Exception getExcep() const;
    void setExcep(oai::model::Exception const& value);
    /// <summary>
    ...
    /// 
    /// </summary>
    oai::model::AdditionalMeasurement getAddtMeasInfo() const;
    void setAddtMeasInfo(oai::model::AdditionalMeasurement const& value);
...
protected:
    ...
    oai::model::AdditionalMeasurement m_AddtMeasInfo;
