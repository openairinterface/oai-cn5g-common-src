...
bool EpsIwkPgw::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
...
oai::model::PlmnId EpsIwkPgw::getPlmnId() const
{
    return m_PlmnId;
}
void EpsIwkPgw::setPlmnId(oai::model::PlmnId const& value)
{
    m_PlmnId = value;
    m_PlmnIdIsSet = true;
}
