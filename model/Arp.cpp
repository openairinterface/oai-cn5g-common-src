...
oai::model::PreemptionCapability Arp::getPreemptCap() const
{
    return m_PreemptCap;
}
void Arp::setPreemptCap(oai::model::PreemptionCapability const& value)
{
    m_PreemptCap = value;
}
oai::model::PreemptionVulnerability Arp::getPreemptVuln() const
{
    return m_PreemptVuln;
}
void Arp::setPreemptVuln(oai::model::PreemptionVulnerability const& value)
{
    m_PreemptVuln = value;
}
