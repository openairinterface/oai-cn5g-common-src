...
bool EpsPdnCnxInfo::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "EpsPdnCnxInfo" : pathPrefix;
...
bool EpsPdnCnxInfo::operator==(const EpsPdnCnxInfo& rhs) const
{
    ...
    ((!pgwNodeNameIsSet() && !rhs.pgwNodeNameIsSet()) || (pgwNodeNameIsSet() && rhs.pgwNodeNameIsSet() && getPgwNodeName() == rhs.getPgwNodeName())) &&
    
    
    ((!linkedBearerIdIsSet() && !rhs.linkedBearerIdIsSet()) || (linkedBearerIdIsSet() && rhs.linkedBearerIdIsSet() && getLinkedBearerId() == rhs.getLinkedBearerId()))
