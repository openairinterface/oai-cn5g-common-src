...
oai::model::Tmgi MbsSessionId::getTmgi() const
{
    return m_Tmgi;
}
void MbsSessionId::setTmgi(oai::model::Tmgi const& value)
{
    m_Tmgi = value;
    m_TmgiIsSet = true;
}
...
oai::model::Ssm MbsSessionId::getSsm() const
{
    return m_Ssm;
}
void MbsSessionId::setSsm(oai::model::Ssm const& value)
{
    m_Ssm = value;
    m_SsmIsSet = true;
}
