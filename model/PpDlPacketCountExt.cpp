...
bool PpDlPacketCountExt::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "PpDlPacketCountExt" : pathPrefix;
...
oai::model::Snssai PpDlPacketCountExt::getSingleNssai() const
{
    return m_SingleNssai;
}
void PpDlPacketCountExt::setSingleNssai(oai::model::Snssai const& value)
{
    m_SingleNssai = value;
