...
bool SmContextCreateError::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "SmContextCreateError" : pathPrefix;
...
oai::model::ExtProblemDetails SmContextCreateError::getError() const
{
    return m_Error;
}
void SmContextCreateError::setError(oai::model::ExtProblemDetails const& value)
{
    m_Error = value;
}
oai::model::RefToBinaryData SmContextCreateError::getN1SmMsg() const
{
    return m_N1SmMsg;
}
void SmContextCreateError::setN1SmMsg(oai::model::RefToBinaryData const& value)
{
    m_N1SmMsg = value;
    m_N1SmMsgIsSet = true;
}
...
oai::model::RefToBinaryData SmContextCreateError::getN2SmInfo() const
{
    return m_N2SmInfo;
}
void SmContextCreateError::setN2SmInfo(oai::model::RefToBinaryData const& value)
{
    m_N2SmInfo = value;
...
oai::model::N2SmInfoType SmContextCreateError::getN2SmInfoType() const
{
    return m_N2SmInfoType;
}
void SmContextCreateError::setN2SmInfoType(oai::model::N2SmInfoType const& value)
{
