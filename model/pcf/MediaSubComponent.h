...
public:
    ...
    void setEthfDescs(std::vector<oai::model::pcf::EthFlowDescription> const& value);
    ...
    /// </summary>
    std::vector<oai::model::pcf::AddFlowDescriptionInfo> getAddInfoFlowDescs() const;
    void setAddInfoFlowDescs(std::vector<oai::model::pcf::AddFlowDescriptionInfo> const& value);
