...
std::vector<oai::_3gpp::model::SnssaiInfoItem> TrustAfInfo::getSNssaiInfoList() const
{
    return m_SNssaiInfoList;
}
void TrustAfInfo::setSNssaiInfoList(std::vector<oai::_3gpp::model::SnssaiInfoItem> const& value)
{
...
void TrustAfInfo::setAfEvents(std::vector<oai::_3gpp::model::AfEvent> const& value)
{
    m_AfEvents = value;
