...
*/
/*
 * ReflectiveQoSAttribute_anyOf.h
 *
 * 
 */
...
public:
    ...
    void setValue(ReflectiveQoSAttribute_anyOf::eReflectiveQoSAttribute_anyOf value);
    
    friend void to_json(nlohmann::json& j, const ReflectiveQoSAttribute_anyOf& o);
    friend void from_json(const nlohmann::json& j, ReflectiveQoSAttribute_anyOf& o);
protected:
    ReflectiveQoSAttribute_anyOf::eReflectiveQoSAttribute_anyOf m_value = ReflectiveQoSAttribute_anyOf::eReflectiveQoSAttribute_anyOf::INVALID_VALUE_OPENAPI_GENERATED;
};
