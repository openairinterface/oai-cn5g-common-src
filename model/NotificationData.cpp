...
void NotificationData::setEvent(oai::_3gpp::model::NotificationEventType const& value)
{
    m_Event = value;
}
...
std::vector<oai::_3gpp::model::ChangeItem> NotificationData::getProfileChanges() const
{
    return m_ProfileChanges;
}
void NotificationData::setProfileChanges(std::vector<oai::_3gpp::model::ChangeItem> const& value)
{
...
oai::_3gpp::model::ConditionEventType NotificationData::getConditionEvent() const
{
    return m_ConditionEvent;
}
void NotificationData::setConditionEvent(oai::_3gpp::model::ConditionEventType const& value)
{
...
oai::_3gpp::model::SubscriptionContext NotificationData::getSubscriptionContext() const
{
    return m_SubscriptionContext;
}
void NotificationData::setSubscriptionContext(oai::_3gpp::model::SubscriptionContext const& value)
{
