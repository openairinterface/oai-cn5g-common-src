...
public:
    ...
    void setUrspInfluence(std::vector<oai::_3gpp::model::UrspRuleRequest> const& value);
    ...
    void setUrspGuidance(std::vector<oai::_3gpp::model::UrspRuleRequest> const& value);
