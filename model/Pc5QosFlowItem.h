...
public:
    ...
    /// 
    /// </summary>
    oai::model::Pc5FlowBitRates getPc5FlowBitRates() const;
    void setPc5FlowBitRates(oai::model::Pc5FlowBitRates const& value);
...
protected:
    ...
    oai::model::Pc5FlowBitRates m_Pc5FlowBitRates;
