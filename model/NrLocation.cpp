...
bool NrLocation::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "NrLocation" : pathPrefix;
    ...
    if (!m_Ncgi.validate(msg, _pathPrefix + ".ncgi")) {
        msg << _pathPrefix << ": Ncgi is invalid;";
        success = false;
    }         
...
bool NrLocation::operator==(const NrLocation& rhs) const
{
    ...
    ((!ignoreNcgiIsSet() && !rhs.ignoreNcgiIsSet()) || (ignoreNcgiIsSet() && rhs.ignoreNcgiIsSet() && isIgnoreNcgi() == rhs.isIgnoreNcgi())) &&
    ...
    ((!globalGnbIdIsSet() && !rhs.globalGnbIdIsSet()) || (globalGnbIdIsSet() && rhs.globalGnbIdIsSet() && getGlobalGnbId() == rhs.getGlobalGnbId()))
...
oai::model::Tai NrLocation::getTai() const
{
    return m_Tai;
}
void NrLocation::setTai(oai::model::Tai const& value)
{
    m_Tai = value;
}
oai::model::Ncgi NrLocation::getNcgi() const
{
    return m_Ncgi;
}
void NrLocation::setNcgi(oai::model::Ncgi const& value)
{
    m_Ncgi = value;
}
...
oai::model::GlobalRanNodeId NrLocation::getGlobalGnbId() const
{
    return m_GlobalGnbId;
}
void NrLocation::setGlobalGnbId(oai::model::GlobalRanNodeId const& value)
{
    m_GlobalGnbId = value;
