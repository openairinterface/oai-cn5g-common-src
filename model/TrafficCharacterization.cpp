...
bool TrafficCharacterization::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "TrafficCharacterization" : pathPrefix;

                     
    if (fDescsIsSet())
    {
        const std::vector<oai::_3gpp::model::IpEthFlowDescription>& value = m_FDescs;
...
bool TrafficCharacterization::operator==(const TrafficCharacterization& rhs) const
{
    return
    ...
    ((!ulVolIsSet() && !rhs.ulVolIsSet()) || (ulVolIsSet() && rhs.ulVolIsSet() && getUlVol() == rhs.getUlVol())) &&
    
    
    ((!ulVolVarianceIsSet() && !rhs.ulVolVarianceIsSet()) || (ulVolVarianceIsSet() && rhs.ulVolVarianceIsSet() && getUlVolVariance() == rhs.getUlVolVariance())) &&
    
    
    ((!dlVolIsSet() && !rhs.dlVolIsSet()) || (dlVolIsSet() && rhs.dlVolIsSet() && getDlVol() == rhs.getDlVol())) &&
    
    
    ((!dlVolVarianceIsSet() && !rhs.dlVolVarianceIsSet()) || (dlVolVarianceIsSet() && rhs.dlVolVarianceIsSet() && getDlVolVariance() == rhs.getDlVolVariance()))
...
oai::_3gpp::model::Snssai TrafficCharacterization::getSnssai() const
{
    return m_Snssai;
}
void TrafficCharacterization::setSnssai(oai::_3gpp::model::Snssai const& value)
{
    m_Snssai = value;
    m_SnssaiIsSet = true;
}
...
std::vector<oai::_3gpp::model::IpEthFlowDescription> TrafficCharacterization::getFDescs() const
{
    return m_FDescs;
}
void TrafficCharacterization::setFDescs(std::vector<oai::_3gpp::model::IpEthFlowDescription> const& value)
{
    m_FDescs = value;
    m_FDescsIsSet = true;
}
