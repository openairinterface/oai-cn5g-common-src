...
std::vector<oai::model::NefEventNotification> NefEventExposureNotif::getEventNotifs() const
{
    return m_EventNotifs;
}
void NefEventExposureNotif::setEventNotifs(std::vector<oai::model::NefEventNotification> const& value)
{
    m_EventNotifs = value;
}
