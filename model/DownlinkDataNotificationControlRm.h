...
public:
    ...
    /// 
    /// </summary>
    std::vector<oai::model::NotificationControlIndication> getNotifCtrlInds() const;
    void setNotifCtrlInds(std::vector<oai::model::NotificationControlIndication> const& value);
    ...
    friend  void to_json(nlohmann::json& j, const DownlinkDataNotificationControlRm& o);
    friend  void from_json(const nlohmann::json& j, DownlinkDataNotificationControlRm& o);
protected:
    std::vector<oai::model::NotificationControlIndication> m_NotifCtrlInds;
