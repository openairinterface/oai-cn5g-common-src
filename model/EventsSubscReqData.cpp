...
std::vector<oai::_3gpp::model::AfEventSubscription> EventsSubscReqData::getEvents() const
{
    return m_Events;
}
void EventsSubscReqData::setEvents(std::vector<oai::_3gpp::model::AfEventSubscription> const& value)
{
    m_Events = value;
}
...
std::vector<oai::_3gpp::model::RequestedQosMonitoringParameter> EventsSubscReqData::getReqQosMonParams() const
{
    return m_ReqQosMonParams;
}
void EventsSubscReqData::setReqQosMonParams(std::vector<oai::_3gpp::model::RequestedQosMonitoringParameter> const& value)
{
...
oai::_3gpp::model::QosMonitoringInformation EventsSubscReqData::getQosMon() const
{
    return m_QosMon;
}
void EventsSubscReqData::setQosMon(oai::_3gpp::model::QosMonitoringInformation const& value)
{
    m_QosMon = value;
    m_QosMonIsSet = true;
}
...
std::vector<oai::_3gpp::model::RequiredAccessInfo> EventsSubscReqData::getReqAnis() const
{
    return m_ReqAnis;
}
void EventsSubscReqData::setReqAnis(std::vector<oai::_3gpp::model::RequiredAccessInfo> const& value)
{
    m_ReqAnis = value;
    m_ReqAnisIsSet = true;
}
...
void EventsSubscReqData::setUsgThres(oai::_3gpp::model::UsageThreshold const& value)
{
    m_UsgThres = value;
...
std::vector<oai::_3gpp::model::std::string> EventsSubscReqData::getAfAppIds() const
{
    return m_AfAppIds;
}
void EventsSubscReqData::setAfAppIds(std::vector<oai::_3gpp::model::std::string> const& value)
{
    m_AfAppIds = value;
