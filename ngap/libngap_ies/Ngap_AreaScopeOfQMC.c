...
asn_TYPE_member_t asn_MBR_Ngap_AreaScopeOfQMC_1[] = {
    {ATF_POINTER,
     0,
     offsetof(struct Ngap_AreaScopeOfQMC, choice.cellBased),
    ...
    {ATF_POINTER,
     0,
     offsetof(struct Ngap_AreaScopeOfQMC, choice.tABased),
    ...
    {ATF_POINTER,
     0,
     offsetof(struct Ngap_AreaScopeOfQMC, choice.tAIBased),
    ...
    {ATF_POINTER,
     0,
     offsetof(struct Ngap_AreaScopeOfQMC, choice.pLMNAreaBased),
    ...
    {ATF_POINTER,
     0,
     offsetof(struct Ngap_AreaScopeOfQMC, choice.choice_Extensions),
