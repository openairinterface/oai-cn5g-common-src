...
bool BdtPolicyData::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "BdtPolicyData" : pathPrefix;

             
    
    /* TransfPolicies */ {
        const std::vector<oai::model::TransferPolicy>& value = m_TransfPolicies;
        ...
        success = value.validate(msg, currentValuePath + ".transfPolicies") && success;
...
bool BdtPolicyData::operator==(const BdtPolicyData& rhs) const
{
    ...
    ((!selTransPolicyIdIsSet() && !rhs.selTransPolicyIdIsSet()) || (selTransPolicyIdIsSet() && rhs.selTransPolicyIdIsSet() && getSelTransPolicyId() == rhs.getSelTransPolicyId())) &&
...
std::vector<oai::model::TransferPolicy> BdtPolicyData::getTransfPolicies() const
{
    return m_TransfPolicies;
}
void BdtPolicyData::setTransfPolicies(std::vector<oai::model::TransferPolicy> const& value)
{
