...
bool AssignEbiData::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "AssignEbiData" : pathPrefix;
    ...
    if (arpListIsSet())
    {
        const std::vector<oai::model::Arp>& value = m_ArpList;
...
bool AssignEbiData::operator==(const AssignEbiData& rhs) const
{
    ...
    ((!arpListIsSet() && !rhs.arpListIsSet()) || (arpListIsSet() && rhs.arpListIsSet() && getArpList() == rhs.getArpList())) &&
...
std::vector<oai::model::Arp> AssignEbiData::getArpList() const
{
    return m_ArpList;
}
void AssignEbiData::setArpList(std::vector<oai::model::Arp> const& value)
{
    m_ArpList = value;
    m_ArpListIsSet = true;
}
...
oai::model::Guami AssignEbiData::getOldGuami() const
{
    return m_OldGuami;
}
void AssignEbiData::setOldGuami(oai::model::Guami const& value)
{
    m_OldGuami = value;
...
std::vector<oai::model::EbiArpMapping> AssignEbiData::getModifiedEbiList() const
{
    return m_ModifiedEbiList;
}
void AssignEbiData::setModifiedEbiList(std::vector<oai::model::EbiArpMapping> const& value)
{
