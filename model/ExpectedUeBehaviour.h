...
public:
    ...
    void setStationaryIndication(oai::_3gpp::model::StationaryIndicationRm const& value);
    ...
    /// 
    /// </summary>
    oai::_3gpp::model::ScheduledCommunicationTypeRm getScheduledCommunicationType() const;
    void setScheduledCommunicationType(oai::_3gpp::model::ScheduledCommunicationTypeRm const& value);
    ...
    /// 
    /// </summary>
    oai::_3gpp::model::ScheduledCommunicationTimeRm getScheduledCommunicationTime() const;
    void setScheduledCommunicationTime(oai::_3gpp::model::ScheduledCommunicationTimeRm const& value);
    ...
    void setBatteryIndication(oai::_3gpp::model::BatteryIndicationRm const& value);
