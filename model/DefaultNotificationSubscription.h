...
public:
    ...
    /// 
    /// </summary>
    oai::_3gpp::model::NotificationType getNotificationType() const;
    void setNotificationType(oai::_3gpp::model::NotificationType const& value);
    /// <summary>
    ...
    void setN2InformationClass(oai::_3gpp::model::N2InformationClass const& value);
    ...
    /// </summary>
    std::map<std::string, oai::_3gpp::model::DefSubServiceInfo> getServiceInfoList() const;
    void setServiceInfoList(std::map<std::string, oai::_3gpp::model::DefSubServiceInfo> const& value);
...
protected:
    oai::_3gpp::model::NotificationType m_NotificationType;
    ...
    std::map<std::string, oai::_3gpp::model::DefSubServiceInfo> m_ServiceInfoList;
