...
bool UeContextInfo::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "UeContextInfo" : pathPrefix;
...
bool UeContextInfo::operator==(const UeContextInfo& rhs) const
{
    ...
    ((!supportVoPSIsSet() && !rhs.supportVoPSIsSet()) || (supportVoPSIsSet() && rhs.supportVoPSIsSet() && isSupportVoPS() == rhs.isSupportVoPS())) &&
    
    
    ((!supportVoPSn3gppIsSet() && !rhs.supportVoPSn3gppIsSet()) || (supportVoPSn3gppIsSet() && rhs.supportVoPSn3gppIsSet() && isSupportVoPSn3gpp() == rhs.isSupportVoPSn3gpp())) &&
    
    
    ((!lastActTimeIsSet() && !rhs.lastActTimeIsSet()) || (lastActTimeIsSet() && rhs.lastActTimeIsSet() && getLastActTime() == rhs.getLastActTime())) &&
...
oai::model::AccessType UeContextInfo::getAccessType() const
{
    return m_AccessType;
}
void UeContextInfo::setAccessType(oai::model::AccessType const& value)
{
    m_AccessType = value;
...
oai::model::RatType UeContextInfo::getRatType() const
{
    return m_RatType;
}
void UeContextInfo::setRatType(oai::model::RatType const& value)
{
    m_RatType = value;
    m_RatTypeIsSet = true;
}
