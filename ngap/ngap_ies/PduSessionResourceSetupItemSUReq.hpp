...
public:
  ...
  void set(const PduSessionId &pduSessionId, std::optional<NasPdu> &nasPdu,
           const SNssai &sNssai,
           const OCTET_STRING_t &pduSessionResourceSetupRequestTransfer);
  void get(PduSessionId &pduSessionId, std::optional<NasPdu> &nasPdu,
           SNssai &sNssai,
           OCTET_STRING_t &pduSessionResourceSetupRequestTransfer) const;

  bool
  encode(Ngap_PDUSessionResourceSetupItemSUReq_t &pduSessionResourceItem) const;
  bool
  decode(const Ngap_PDUSessionResourceSetupItemSUReq_t &pduSessionResourceItem);
