...
bool AmfUpdateEventOptionItem::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "AmfUpdateEventOptionItem" : pathPrefix;
...
bool AmfUpdateEventOptionItem::operator==(const AmfUpdateEventOptionItem& rhs) const
{
    return
...
oai::_3gpp::model::NotificationFlag AmfUpdateEventOptionItem::getNotifFlag() const
{
    return m_NotifFlag;
}
void AmfUpdateEventOptionItem::setNotifFlag(oai::_3gpp::model::NotificationFlag const& value)
{
    m_NotifFlag = value;
...
void AmfUpdateEventOptionItem::unsetNotifFlag()
{
    m_NotifFlagIsSet = false;
}
