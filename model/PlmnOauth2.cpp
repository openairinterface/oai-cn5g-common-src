...
bool PlmnOauth2::validate(
    std::stringstream& msg, const std::string& pathPrefix) const {
  bool success = true;
  const std::string _pathPrefix =
      pathPrefix.empty() ? "PlmnOauth2" : pathPrefix;

  if (oauth2RequiredPlmnIdListIsSet()) {
    const std::vector<oai::_3gpp::model::PlmnId>& value =
        m_Oauth2RequiredPlmnIdList;
    const std::string currentValuePath =
        _pathPrefix + ".oauth2RequiredPlmnIdList";
    ...
    {  // Recursive validation of array elements
      ...
      for (const oai::_3gpp::model::PlmnId& value : value) {
        ...
        success = value.validate(
                      msg, currentValuePath + ".oauth2RequiredPlmnIdList") &&
                  success;
  ...
  if (oauth2NotRequiredPlmnIdListIsSet()) {
    const std::vector<oai::_3gpp::model::PlmnId>& value =
        m_Oauth2NotRequiredPlmnIdList;
    const std::string currentValuePath =
        _pathPrefix + ".oauth2NotRequiredPlmnIdList";
    ...
    {  // Recursive validation of array elements
      ...
      for (const oai::_3gpp::model::PlmnId& value : value) {
        ...
        success = value.validate(
                      msg, currentValuePath + ".oauth2NotRequiredPlmnIdList") &&
                  success;
...
bool PlmnOauth2::operator==(const PlmnOauth2& rhs) const {
  return
      ...
      ((!oauth2RequiredPlmnIdListIsSet() &&
        !rhs.oauth2RequiredPlmnIdListIsSet()) ||
       (oauth2RequiredPlmnIdListIsSet() &&
        rhs.oauth2RequiredPlmnIdListIsSet() &&
        getOauth2RequiredPlmnIdList() == rhs.getOauth2RequiredPlmnIdList())) &&

      ((!oauth2NotRequiredPlmnIdListIsSet() &&
        !rhs.oauth2NotRequiredPlmnIdListIsSet()) ||
       (oauth2NotRequiredPlmnIdListIsSet() &&
        rhs.oauth2NotRequiredPlmnIdListIsSet() &&
        getOauth2NotRequiredPlmnIdList() ==
            rhs.getOauth2NotRequiredPlmnIdList()))
...
void to_json(nlohmann::json& j, const PlmnOauth2& o) {
  j = nlohmann::json();
  if (o.oauth2RequiredPlmnIdListIsSet() ||
      !o.m_Oauth2RequiredPlmnIdList.empty())
    j["oauth2RequiredPlmnIdList"] = o.m_Oauth2RequiredPlmnIdList;
  if (o.oauth2NotRequiredPlmnIdListIsSet() ||
      !o.m_Oauth2NotRequiredPlmnIdList.empty())
...
std::vector<oai::_3gpp::model::PlmnId> PlmnOauth2::getOauth2RequiredPlmnIdList()
    const {
  return m_Oauth2RequiredPlmnIdList;
}
void PlmnOauth2::setOauth2RequiredPlmnIdList(
...
PlmnOauth2::getOauth2NotRequiredPlmnIdList() const {
  return m_Oauth2NotRequiredPlmnIdList;
}
void PlmnOauth2::setOauth2NotRequiredPlmnIdList(
    std::vector<oai::_3gpp::model::PlmnId> const& value) {
