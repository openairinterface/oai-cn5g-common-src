...
MaPduIndication_anyOf::eMaPduIndication_anyOf MaPduIndication::getEnumValue() const
{
    return m_value.getValue();
}

void MaPduIndication::setEnumValue(MaPduIndication_anyOf::eMaPduIndication_anyOf  value)
{
