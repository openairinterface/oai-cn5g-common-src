...
bool VelocityEstimate::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "VelocityEstimate" : pathPrefix;
...
oai::_3gpp::model::VerticalDirection VelocityEstimate::getVDirection() const
{
    return m_VDirection;
}
void VelocityEstimate::setVDirection(oai::_3gpp::model::VerticalDirection const& value)
{
    m_VDirection = value;
}
