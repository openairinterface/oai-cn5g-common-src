...
bool QosRequirement::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "QosRequirement" : pathPrefix;
...
bool QosRequirement::operator==(const QosRequirement& rhs) const
{
    ...
    ((!gfbrUlIsSet() && !rhs.gfbrUlIsSet()) || (gfbrUlIsSet() && rhs.gfbrUlIsSet() && getGfbrUl() == rhs.getGfbrUl())) &&
    
    
    ((!gfbrDlIsSet() && !rhs.gfbrDlIsSet()) || (gfbrDlIsSet() && rhs.gfbrDlIsSet() && getGfbrDl() == rhs.getGfbrDl())) &&
    
    
    ((!resTypeIsSet() && !rhs.resTypeIsSet()) || (resTypeIsSet() && rhs.resTypeIsSet() && getResType() == rhs.getResType())) &&
    
    
    ((!pdbIsSet() && !rhs.pdbIsSet()) || (pdbIsSet() && rhs.pdbIsSet() && getPdb() == rhs.getPdb())) &&
    
    
    ((!perIsSet() && !rhs.perIsSet()) || (perIsSet() && rhs.perIsSet() && getPer() == rhs.getPer()))
...
oai::_3gpp::model::QosResourceType QosRequirement::getResType() const
{
    return m_ResType;
}
void QosRequirement::setResType(oai::_3gpp::model::QosResourceType const& value)
{
    m_ResType = value;
    m_ResTypeIsSet = true;
}
