...
struct Ngap_CompletedCellsInEAI_NR;
struct Ngap_ProtocolExtensionContainer_12929P70;
...
typedef struct Ngap_EmergencyAreaIDBroadcastNR_Item {
  ...
  struct Ngap_CompletedCellsInEAI_NR* completedCellsInEAI_NR;
...
extern asn_SEQUENCE_specifics_t
    asn_SPC_Ngap_EmergencyAreaIDBroadcastNR_Item_specs_1;
