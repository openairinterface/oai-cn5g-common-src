...
public:
    ...
    /// 
    /// </summary>
    std::vector<oai::_3gpp::model::UsedUnitContainer> getUsedUnitContainer() const;
    void setUsedUnitContainer(std::vector<oai::_3gpp::model::UsedUnitContainer> const& value);
