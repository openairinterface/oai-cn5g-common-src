...
bool PolicyDecisionFailureCode::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "PolicyDecisionFailureCode" : pathPrefix;
...
bool PolicyDecisionFailureCode::operator==(const PolicyDecisionFailureCode& rhs) const
{
    return
...
void PolicyDecisionFailureCode::setValue(PolicyDecisionFailureCode_anyOf value)
{
    m_value = value;
}

PolicyDecisionFailureCode_anyOf::ePolicyDecisionFailureCode_anyOf PolicyDecisionFailureCode::getEnumValue() const
{
    return m_value.getValue();
}

void PolicyDecisionFailureCode::setEnumValue(PolicyDecisionFailureCode_anyOf::ePolicyDecisionFailureCode_anyOf  value)
{
