...
std::vector<oai::_3gpp::model::NwdafEvent> MlAnalyticsInfo::getMlAnalyticsIds() const
{
    return m_MlAnalyticsIds;
}
void MlAnalyticsInfo::setMlAnalyticsIds(std::vector<oai::_3gpp::model::NwdafEvent> const& value)
{
...
void MlAnalyticsInfo::setSnssaiList(std::vector<oai::_3gpp::model::Snssai> const& value)
{
    m_SnssaiList = value;
...
std::vector<oai::_3gpp::model::Tai> MlAnalyticsInfo::getTrackingAreaList() const
{
    return m_TrackingAreaList;
}
void MlAnalyticsInfo::setTrackingAreaList(std::vector<oai::_3gpp::model::Tai> const& value)
{
