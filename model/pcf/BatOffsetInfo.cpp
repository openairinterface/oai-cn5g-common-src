...
bool BatOffsetInfo::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "BatOffsetInfo" : pathPrefix;
...
bool BatOffsetInfo::operator==(const BatOffsetInfo& rhs) const
{
    ...
    ((!adjPeriodIsSet() && !rhs.adjPeriodIsSet()) || (adjPeriodIsSet() && rhs.adjPeriodIsSet() && getAdjPeriod() == rhs.getAdjPeriod())) &&
