...
public:
    ...
    /// 
    /// </summary>
    oai::model::RoamingIndication getRoamingIndication() const;
    void setRoamingIndication(oai::model::RoamingIndication const& value);
    /// <summary>
    /// 
    /// </summary>
    oai::model::Snssai getHomeSnssai() const;
    void setHomeSnssai(oai::model::Snssai const& value);
...
protected:
    ...
    oai::model::RoamingIndication m_RoamingIndication;

    oai::model::Snssai m_HomeSnssai;
