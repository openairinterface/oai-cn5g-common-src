...
bool SmPolicyContextData::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "SmPolicyContextData" : pathPrefix;
    ...
    {
        const std::vector<oai::_3gpp::model::std::string>& value = m_Ipv4FrameRouteList;
    ...
    {
        const std::vector<oai::_3gpp::model::Ipv6Prefix>& value = m_Ipv6FrameRouteList;
    ...
    if (pvsInfoIsSet())
    {
        const std::vector<oai::_3gpp::model::ServerAddressingInfo>& value = m_PvsInfo;
...
bool SmPolicyContextData::operator==(const SmPolicyContextData& rhs) const
{
    ...
    ((!accNetChIdIsSet() && !rhs.accNetChIdIsSet()) || (accNetChIdIsSet() && rhs.accNetChIdIsSet() && getAccNetChId() == rhs.getAccNetChId())) &&
    
    
    ((!chargEntityAddrIsSet() && !rhs.chargEntityAddrIsSet()) || (chargEntityAddrIsSet() && rhs.chargEntityAddrIsSet() && getChargEntityAddr() == rhs.getChargEntityAddr())) &&
    ...
    ((!invalidSupiIsSet() && !rhs.invalidSupiIsSet()) || (invalidSupiIsSet() && rhs.invalidSupiIsSet() && isInvalidSupi() == rhs.isInvalidSupi())) &&
    ...
    ((!chargingcharacteristicsIsSet() && !rhs.chargingcharacteristicsIsSet()) || (chargingcharacteristicsIsSet() && rhs.chargingcharacteristicsIsSet() && getChargingcharacteristics() == rhs.getChargingcharacteristics())) &&
    
    (getDnn() == rhs.getDnn())
     &&
    
    
    ((!dnnSelModeIsSet() && !rhs.dnnSelModeIsSet()) || (dnnSelModeIsSet() && rhs.dnnSelModeIsSet() && getDnnSelMode() == rhs.getDnnSelMode())) &&
    ...
    ((!onlineIsSet() && !rhs.onlineIsSet()) || (onlineIsSet() && rhs.onlineIsSet() && isOnline() == rhs.isOnline())) &&
    ...
    ((!smfIdIsSet() && !rhs.smfIdIsSet()) || (smfIdIsSet() && rhs.smfIdIsSet() && getSmfId() == rhs.getSmfId())) &&
    ...
    ((!pvsInfoIsSet() && !rhs.pvsInfoIsSet()) || (pvsInfoIsSet() && rhs.pvsInfoIsSet() && getPvsInfo() == rhs.getPvsInfo())) &&
    
    
    ((!onboardIndIsSet() && !rhs.onboardIndIsSet()) || (onboardIndIsSet() && rhs.onboardIndIsSet() && isOnboardInd() == rhs.isOnboardInd())) &&
...
void to_json(nlohmann::json& j, const SmPolicyContextData& o)
{
    ...
    if(o.onboardIndIsSet())
        j["onboardInd"] = o.m_OnboardInd;
...
void from_json(const nlohmann::json& j, SmPolicyContextData& o)
{
    ...
    if(j.find("onboardInd") != j.end())
    {
        j.at("onboardInd").get_to(o.m_OnboardInd);
        o.m_OnboardIndIsSet = true;
    } 
...
oai::_3gpp::model::AccNetChId SmPolicyContextData::getAccNetChId() const
{
    return m_AccNetChId;
}
void SmPolicyContextData::setAccNetChId(oai::_3gpp::model::AccNetChId const& value)
{
    m_AccNetChId = value;
...
oai::_3gpp::model::AccNetChargingAddress SmPolicyContextData::getChargEntityAddr() const
{
    return m_ChargEntityAddr;
}
void SmPolicyContextData::setChargEntityAddr(oai::_3gpp::model::AccNetChargingAddress const& value)
{
...
std::vector<oai::_3gpp::model::std::string> SmPolicyContextData::getInterGrpIds() const
{
    return m_InterGrpIds;
}
void SmPolicyContextData::setInterGrpIds(std::vector<oai::_3gpp::model::std::string> const& value)
{
    m_InterGrpIds = value;
...
oai::_3gpp::model::PduSessionType SmPolicyContextData::getPduSessionType() const
{
    return m_PduSessionType;
}
void SmPolicyContextData::setPduSessionType(oai::_3gpp::model::PduSessionType const& value)
{
...
oai::_3gpp::model::DnnSelectionMode SmPolicyContextData::getDnnSelMode() const
{
    return m_DnnSelMode;
}
void SmPolicyContextData::setDnnSelMode(oai::_3gpp::model::DnnSelectionMode const& value)
{
    m_DnnSelMode = value;
...
oai::_3gpp::model::AccessType SmPolicyContextData::getAccessType() const
{
    return m_AccessType;
}
void SmPolicyContextData::setAccessType(oai::_3gpp::model::AccessType const& value)
{
    m_AccessType = value;
...
oai::_3gpp::model::RatType SmPolicyContextData::getRatType() const
{
    return m_RatType;
}
void SmPolicyContextData::setRatType(oai::_3gpp::model::RatType const& value)
{
    m_RatType = value;
    m_RatTypeIsSet = true;
}
...
oai::_3gpp::model::AdditionalAccessInfo SmPolicyContextData::getAddAccessInfo() const
{
    return m_AddAccessInfo;
}
void SmPolicyContextData::setAddAccessInfo(oai::_3gpp::model::AdditionalAccessInfo const& value)
{
...
oai::_3gpp::model::PlmnIdNid SmPolicyContextData::getServingNetwork() const
{
    return m_ServingNetwork;
}
void SmPolicyContextData::setServingNetwork(oai::_3gpp::model::PlmnIdNid const& value)
{
...
oai::_3gpp::model::UserLocation SmPolicyContextData::getUserLocationInfo() const
{
    return m_UserLocationInfo;
}
void SmPolicyContextData::setUserLocationInfo(oai::_3gpp::model::UserLocation const& value)
{
...
oai::_3gpp::model::Ipv6Prefix SmPolicyContextData::getIpv6AddressPrefix() const
{
    return m_Ipv6AddressPrefix;
}
void SmPolicyContextData::setIpv6AddressPrefix(oai::_3gpp::model::Ipv6Prefix const& value)
{
...
oai::_3gpp::model::Ambr SmPolicyContextData::getSubsSessAmbr() const
{
    return m_SubsSessAmbr;
}
void SmPolicyContextData::setSubsSessAmbr(oai::_3gpp::model::Ambr const& value)
{
...
oai::_3gpp::model::SubscribedDefaultQos SmPolicyContextData::getSubsDefQos() const
{
    return m_SubsDefQos;
}
void SmPolicyContextData::setSubsDefQos(oai::_3gpp::model::SubscribedDefaultQos const& value)
{
    m_SubsDefQos = value;
...
oai::_3gpp::model::VplmnQos SmPolicyContextData::getVplmnQos() const
{
    return m_VplmnQos;
}
void SmPolicyContextData::setVplmnQos(oai::_3gpp::model::VplmnQos const& value)
{
    m_VplmnQos = value;
...
oai::_3gpp::model::TraceData SmPolicyContextData::getTraceReq() const
{
    return m_TraceReq;
}
void SmPolicyContextData::setTraceReq(oai::_3gpp::model::TraceData const& value)
{
    m_TraceReq = value;
...
oai::_3gpp::model::Snssai SmPolicyContextData::getSliceInfo() const
{
    return m_SliceInfo;
}
void SmPolicyContextData::setSliceInfo(oai::_3gpp::model::Snssai const& value)
{
    m_SliceInfo = value;
}
oai::_3gpp::model::QosFlowUsage SmPolicyContextData::getQosFlowUsage() const
{
    return m_QosFlowUsage;
}
void SmPolicyContextData::setQosFlowUsage(oai::_3gpp::model::QosFlowUsage const& value)
{
...
oai::_3gpp::model::ServingNfIdentity SmPolicyContextData::getServNfId() const
{
    return m_ServNfId;
}
void SmPolicyContextData::setServNfId(oai::_3gpp::model::ServingNfIdentity const& value)
{
    m_ServNfId = value;
...
oai::_3gpp::model::MaPduIndication SmPolicyContextData::getMaPduInd() const
{
    return m_MaPduInd;
}
void SmPolicyContextData::setMaPduInd(oai::_3gpp::model::MaPduIndication const& value)
{
    m_MaPduInd = value;
...
oai::_3gpp::model::AtsssCapability SmPolicyContextData::getAtsssCapab() const
{
    return m_AtsssCapab;
}
void SmPolicyContextData::setAtsssCapab(oai::_3gpp::model::AtsssCapability const& value)
{
    m_AtsssCapab = value;
...
std::vector<oai::_3gpp::model::std::string> SmPolicyContextData::getIpv4FrameRouteList() const
{
    return m_Ipv4FrameRouteList;
}
void SmPolicyContextData::setIpv4FrameRouteList(std::vector<oai::_3gpp::model::std::string> const& value)
{
...
std::vector<oai::_3gpp::model::Ipv6Prefix> SmPolicyContextData::getIpv6FrameRouteList() const
{
    return m_Ipv6FrameRouteList;
}
void SmPolicyContextData::setIpv6FrameRouteList(std::vector<oai::_3gpp::model::Ipv6Prefix> const& value)
{
...
oai::_3gpp::model::SatelliteBackhaulCategory SmPolicyContextData::getSatBackhaulCategory() const
{
    return m_SatBackhaulCategory;
}
void SmPolicyContextData::setSatBackhaulCategory(oai::_3gpp::model::SatelliteBackhaulCategory const& value)
{
...
oai::_3gpp::model::PcfUeCallbackInfo SmPolicyContextData::getPcfUeInfo() const
{
    return m_PcfUeInfo;
}
void SmPolicyContextData::setPcfUeInfo(oai::_3gpp::model::PcfUeCallbackInfo const& value)
{
    m_PcfUeInfo = value;
    m_PcfUeInfoIsSet = true;
}
bool SmPolicyContextData::pcfUeInfoIsSet() const
{
    return m_PcfUeInfoIsSet;
}
void SmPolicyContextData::unsetPcfUeInfo()
{
    m_PcfUeInfoIsSet = false;
}
std::vector<oai::_3gpp::model::ServerAddressingInfo> SmPolicyContextData::getPvsInfo() const
{
    return m_PvsInfo;
}
void SmPolicyContextData::setPvsInfo(std::vector<oai::_3gpp::model::ServerAddressingInfo> const& value)
{
    m_PvsInfo = value;
    m_PvsInfoIsSet = true;
}
bool SmPolicyContextData::pvsInfoIsSet() const
{
    return m_PvsInfoIsSet;
}
void SmPolicyContextData::unsetPvsInfo()
{
    m_PvsInfoIsSet = false;
}
bool SmPolicyContextData::isOnboardInd() const
{
    return m_OnboardInd;
}
void SmPolicyContextData::setOnboardInd(bool const value)
{
    m_OnboardInd = value;
    m_OnboardIndIsSet = true;
}
bool SmPolicyContextData::onboardIndIsSet() const
{
    return m_OnboardIndIsSet;
}
void SmPolicyContextData::unsetOnboardInd()
{
    m_OnboardIndIsSet = false;
}
std::vector<oai::_3gpp::model::NwdafData> SmPolicyContextData::getNwdafDatas() const
{
    return m_NwdafDatas;
}
void SmPolicyContextData::setNwdafDatas(std::vector<oai::_3gpp::model::NwdafData> const& value)
{
    m_NwdafDatas = value;
    m_NwdafDatasIsSet = true;
}
bool SmPolicyContextData::nwdafDatasIsSet() const
{
    return m_NwdafDatasIsSet;
}
void SmPolicyContextData::unsetNwdafDatas()
{
    m_NwdafDatasIsSet = false;
}
