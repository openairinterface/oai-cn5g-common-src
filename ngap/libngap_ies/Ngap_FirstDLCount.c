...
asn_TYPE_member_t asn_MBR_Ngap_FirstDLCount_1[] = {
    {ATF_POINTER,
     0,
     offsetof(struct Ngap_FirstDLCount, dRBsSubjectToEarlyStatusTransfer),
    ...
    {ATF_POINTER,
     1,
     offsetof(struct Ngap_FirstDLCount, iE_Extension),
     (ASN_TAG_CLASS_CONTEXT | (1 << 2)),
     -1, /* IMPLICIT tag at current level */
     &asn_DEF_Ngap_ProtocolExtensionContainer_12929P67,
     0,
     {
#if !defined(ASN_DISABLE_OER_SUPPORT)
         0,
...
static const asn_TYPE_tag2member_t asn_MAP_Ngap_FirstDLCount_tag2el_1[] = {
    {(ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0,
     0}, /* dRBsSubjectToEarlyStatusTransfer */
