...
asn_TYPE_member_t asn_MBR_Ngap_PDUSessionAggregateMaximumBitRate_1[] = {
    ...
    {ATF_POINTER,
     1,
     offsetof(struct Ngap_PDUSessionAggregateMaximumBitRate, iE_Extensions),
     (ASN_TAG_CLASS_CONTEXT | (2 << 2)),
     -1, /* IMPLICIT tag at current level */
     &asn_DEF_Ngap_ProtocolExtensionContainer_12929P214,
     0,
     {
#if !defined(ASN_DISABLE_OER_SUPPORT)
         0,
...
static const asn_TYPE_tag2member_t
    asn_MAP_Ngap_PDUSessionAggregateMaximumBitRate_tag2el_1[] = {
        {(ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0,
         0}, /* pDUSessionAggregateMaximumBitRateDL */
        {(ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0,
         0}, /* pDUSessionAggregateMaximumBitRateUL */
...
asn_SEQUENCE_specifics_t
    asn_SPC_Ngap_PDUSessionAggregateMaximumBitRate_specs_1 = {
        ...
        asn_MAP_Ngap_PDUSessionAggregateMaximumBitRate_oms_1, /* Optional
                                                                 members */
        1,
        0, /* Root/Additions */
...
asn_TYPE_descriptor_t asn_DEF_Ngap_PDUSessionAggregateMaximumBitRate = {
    ...
    sizeof(asn_DEF_Ngap_PDUSessionAggregateMaximumBitRate_tags_1) /
        sizeof(
            asn_DEF_Ngap_PDUSessionAggregateMaximumBitRate_tags_1[0]), /* 1 */
