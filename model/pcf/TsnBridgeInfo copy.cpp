...
bool TsnBridgeInfo::operator==(const TsnBridgeInfo &rhs) const {
  return
      ...
      ((!mtuIpv4IsSet() && !rhs.mtuIpv4IsSet()) ||
       (mtuIpv4IsSet() && rhs.mtuIpv4IsSet() &&
        getMtuIpv4() == rhs.getMtuIpv4())) &&

      ((!mtuIpv6IsSet() && !rhs.mtuIpv6IsSet()) ||
       (mtuIpv6IsSet() && rhs.mtuIpv6IsSet() &&
        getMtuIpv6() == rhs.getMtuIpv6()))
...
int32_t TsnBridgeInfo::getMtuIpv4() const { return m_MtuIpv4; }
void TsnBridgeInfo::setMtuIpv4(int32_t const value) {
  m_MtuIpv4 = value;
  m_MtuIpv4IsSet = true;
}
bool TsnBridgeInfo::mtuIpv4IsSet() const { return m_MtuIpv4IsSet; }
void TsnBridgeInfo::unsetMtuIpv4() { m_MtuIpv4IsSet = false; }
int32_t TsnBridgeInfo::getMtuIpv6() const { return m_MtuIpv6; }
void TsnBridgeInfo::setMtuIpv6(int32_t const value) {
  m_MtuIpv6 = value;
  m_MtuIpv6IsSet = true;
}
bool TsnBridgeInfo::mtuIpv6IsSet() const { return m_MtuIpv6IsSet; }
void TsnBridgeInfo::unsetMtuIpv6() { m_MtuIpv6IsSet = false; }
