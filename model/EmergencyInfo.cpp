...
bool EmergencyInfo::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "EmergencyInfo" : pathPrefix;
...
bool EmergencyInfo::operator==(const EmergencyInfo& rhs) const
{
    ...
    ((!pgwIpAddressIsSet() && !rhs.pgwIpAddressIsSet()) || (pgwIpAddressIsSet() && rhs.pgwIpAddressIsSet() && getPgwIpAddress() == rhs.getPgwIpAddress())) &&
...
oai::model::IpAddress EmergencyInfo::getPgwIpAddress() const
{
    return m_PgwIpAddress;
}
void EmergencyInfo::setPgwIpAddress(oai::model::IpAddress const& value)
{
...
oai::model::PlmnId EmergencyInfo::getPlmnId() const
{
    return m_PlmnId;
}
void EmergencyInfo::setPlmnId(oai::model::PlmnId const& value)
{
    m_PlmnId = value;
    m_PlmnIdIsSet = true;
}
