...
#define Ngap_ProcedureCode_id_BroadcastSessionModification	((Ngap_ProcedureCode_t)66)
#define Ngap_ProcedureCode_id_BroadcastSessionRelease	((Ngap_ProcedureCode_t)67)
...
#define Ngap_ProcedureCode_id_MulticastSessionActivation	((Ngap_ProcedureCode_t)71)
#define Ngap_ProcedureCode_id_MulticastSessionDeactivation	((Ngap_ProcedureCode_t)72)
