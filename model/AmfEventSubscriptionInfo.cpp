...
bool AmfEventSubscriptionInfo::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "AmfEventSubscriptionInfo" : pathPrefix;
...
bool AmfEventSubscriptionInfo::operator==(const AmfEventSubscriptionInfo& rhs) const
{
    return
    ...
    ((!oldSubIdIsSet() && !rhs.oldSubIdIsSet()) || (oldSubIdIsSet() && rhs.oldSubIdIsSet() && getOldSubId() == rhs.getOldSubId()))
...
void AmfEventSubscriptionInfo::setNotifyCorrelationId(std::string const& value)
{
