...
bool UeN1N2InfoSubscriptionCreateData::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "UeN1N2InfoSubscriptionCreateData" : pathPrefix;
...
bool UeN1N2InfoSubscriptionCreateData::operator==(const UeN1N2InfoSubscriptionCreateData& rhs) const
{
    return
    ...
    ((!n2NotifyCallbackUriIsSet() && !rhs.n2NotifyCallbackUriIsSet()) || (n2NotifyCallbackUriIsSet() && rhs.n2NotifyCallbackUriIsSet() && getN2NotifyCallbackUri() == rhs.getN2NotifyCallbackUri())) &&
    ...
    ((!n1NotifyCallbackUriIsSet() && !rhs.n1NotifyCallbackUriIsSet()) || (n1NotifyCallbackUriIsSet() && rhs.n1NotifyCallbackUriIsSet() && getN1NotifyCallbackUri() == rhs.getN1NotifyCallbackUri())) &&
...
oai::model::N2InformationClass UeN1N2InfoSubscriptionCreateData::getN2InformationClass() const
{
    return m_N2InformationClass;
}
void UeN1N2InfoSubscriptionCreateData::setN2InformationClass(oai::model::N2InformationClass const& value)
{
...
oai::model::N1MessageClass UeN1N2InfoSubscriptionCreateData::getN1MessageClass() const
{
    return m_N1MessageClass;
}
void UeN1N2InfoSubscriptionCreateData::setN1MessageClass(oai::model::N1MessageClass const& value)
{
...
oai::model::Guami UeN1N2InfoSubscriptionCreateData::getOldGuami() const
{
    return m_OldGuami;
}
void UeN1N2InfoSubscriptionCreateData::setOldGuami(oai::model::Guami const& value)
{
    m_OldGuami = value;
