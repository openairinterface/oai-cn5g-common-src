...
bool AllowedSnssai::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "AllowedSnssai" : pathPrefix;

        
    if (!m_AllowedSnssai.validate(msg, _pathPrefix + ".allowedSnssai")) {
        msg << _pathPrefix << ": AllowedSnssai is invalid;";
        success = false;
    }     
    if (nsiInformationListIsSet())
    {
        const std::vector<oai::model::NsiInformation>& value = m_NsiInformationList;
        ...
        { // Recursive validation of array elements
            ...
            int i = 0;
            for (const oai::model::NsiInformation& value : value)
            { 
                const std::string currentValuePath = oldValuePath + "[" + std::to_string(i) + "]";
                        
        success = value.validate(msg, currentValuePath + ".nsiInformationList") && success;
...
bool AllowedSnssai::operator==(const AllowedSnssai& rhs) const
{
    ...
    ((!nsiInformationListIsSet() && !rhs.nsiInformationListIsSet()) || (nsiInformationListIsSet() && rhs.nsiInformationListIsSet() && getNsiInformationList() == rhs.getNsiInformationList())) &&
    
    
    ((!mappedHomeSnssaiIsSet() && !rhs.mappedHomeSnssaiIsSet()) || (mappedHomeSnssaiIsSet() && rhs.mappedHomeSnssaiIsSet() && getMappedHomeSnssai() == rhs.getMappedHomeSnssai()))
...
oai::model::Snssai AllowedSnssai::getAllowedSnssai() const
{
    return m_AllowedSnssai;
}
void AllowedSnssai::setAllowedSnssai(oai::model::Snssai const& value)
{
    m_AllowedSnssai = value;
}
std::vector<oai::model::NsiInformation> AllowedSnssai::getNsiInformationList() const
{
    return m_NsiInformationList;
}
void AllowedSnssai::setNsiInformationList(std::vector<oai::model::NsiInformation> const& value)
{
...
oai::model::Snssai AllowedSnssai::getMappedHomeSnssai() const
{
    return m_MappedHomeSnssai;
}
void AllowedSnssai::setMappedHomeSnssai(oai::model::Snssai const& value)
{
