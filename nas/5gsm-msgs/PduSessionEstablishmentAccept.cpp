...
uint32_t PduSessionEstablishmentAccept::GetLength() const {
  ...
  if (ie_s_nssai_.has_value())
    msg_len += ie_s_nssai_.value().GetIeLength();
  ...
  if (ie_dnn_.has_value())
    msg_len += ie_dnn_.value().GetIeLength();
...
int PduSessionEstablishmentAccept::Encode(uint8_t *buf, int len) {
  ...
  if ((encoded_ie_size = NasHelper::Encode(ie_selected_pdu_session_type_, buf,
                                           len, encoded_size)) ==
      KEncodeDecodeError) {
    return KEncodeDecodeError;
  }
  ...
  if ((encoded_ie_size = NasHelper::Encode(ie_authorized_qos_rules_, buf, len,
                                           encoded_size)) ==
      KEncodeDecodeError) {
    return KEncodeDecodeError;
  }
  ...
  if ((encoded_ie_size = NasHelper::Encode(ie_always_on_pdu_session_indication_,
  ...
  if ((encoded_ie_size = NasHelper::Encode(ie_authorized_qos_flow_descriptions_,
                                           buf, len, encoded_size)) ==
      KEncodeDecodeError) {
    return KEncodeDecodeError;
  }
...
int PduSessionEstablishmentAccept::Decode(uint8_t *buf, int len) {
  ...
  // Selected PDU session type
  if ((decoded_ie_size = NasHelper::Decode(ie_selected_pdu_session_type_, buf,
  ...
  // Selected SSC mode
  if ((decoded_ie_size = NasHelper::Decode(ie_selected_ssc_mode_, buf, len,
                                           decoded_size, false)) ==
      KEncodeDecodeError) {
    return KEncodeDecodeError;
  }
  ...
  // Authorized QoS rules
  if ((decoded_ie_size = NasHelper::Decode(ie_authorized_qos_rules_, buf, len,
                                           decoded_size, false)) ==
      KEncodeDecodeError) {
    return KEncodeDecodeError;
  }
  ...
  // Session AMBR
  if ((decoded_ie_size = NasHelper::Decode(ie_session_ambr_, buf, len,
                                           decoded_size, false)) ==
      KEncodeDecodeError) {
    return KEncodeDecodeError;
  }
  ...
  while ((octet != 0x0)) {
    ...
    case kIeiAlwaysOnPduSessionIndication: {
      ...
      if ((decoded_ie_size =
               NasHelper::Decode(ie_always_on_pdu_session_indication_, buf, len,
    ...
    case kIeiPduAddress: {
      oai::logger::logger_common::nas().debug("Decoding IEI 0x%x",
                                              kIeiPduAddress);
      if ((decoded_ie_size = NasHelper::Decode(ie_pdu_address_, buf, len,
                                               decoded_size, true)) ==
          KEncodeDecodeError) {
        return KEncodeDecodeError;
      }
    ...
    case kIeiRqTimerValue: {
      oai::logger::logger_common::nas().debug("Decoding IEI 0x%x",
                                              kIeiRqTimerValue);
      if ((decoded_ie_size = NasHelper::Decode(ie_gprs_timer_, kIeiRqTimerValue,
    ...
    case kIeiSNssai: {
      oai::logger::logger_common::nas().debug("Decoding IEI 0x%x", kIeiSNssai);
      if ((decoded_ie_size = NasHelper::Decode(ie_s_nssai_, kIeiSNssai, buf,
    ...
    case kIeiAuthorizedQosFlowDescriptions: {
      ...
      if ((decoded_ie_size =
               NasHelper::Decode(ie_authorized_qos_flow_descriptions_, buf, len,
                                 decoded_size, true)) == KEncodeDecodeError) {
        return KEncodeDecodeError;
      }
      DECODE_U8_VALUE(buf, octet, decoded_size, len);
    ...
    case kIeiDnn: {
      ...
      if ((decoded_ie_size = NasHelper::Decode(ie_dnn_, buf, len, decoded_size,
