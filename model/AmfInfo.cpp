...
void AmfInfo::setBackupInfoAmfFailure(
...
void AmfInfo::setBackupInfoAmfRemoval(
    std::vector<oai::_3gpp::model::Guami> const& value) {
...
void AmfInfo::setN2InterfaceAmfInfo(
