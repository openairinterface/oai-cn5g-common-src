...
bool HssAuthenticationInfoResult::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "HssAuthenticationInfoResult" : pathPrefix;
    ...
    if (!m_HssAuthenticationVectors.validate(msg, _pathPrefix + ".hssAuthenticationVectors")) {
        msg << _pathPrefix << ": HssAuthenticationVectors is invalid;";
        success = false;
    }
    return success;
}

bool HssAuthenticationInfoResult::operator==(const HssAuthenticationInfoResult& rhs) const
{
    return
...
void HssAuthenticationInfoResult::setSupportedFeatures(std::string const& value)
{
...
oai::model::HssAuthenticationVectors HssAuthenticationInfoResult::getHssAuthenticationVectors() const
{
    return m_HssAuthenticationVectors;
}
void HssAuthenticationInfoResult::setHssAuthenticationVectors(oai::model::HssAuthenticationVectors const& value)
{
