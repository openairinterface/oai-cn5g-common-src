...
std::vector<oai::_3gpp::model::Snssai> NwdafCond::getSnssaiList() const
{
    return m_SnssaiList;
}
void NwdafCond::setSnssaiList(std::vector<oai::_3gpp::model::Snssai> const& value)
{
    m_SnssaiList = value;
...
std::vector<oai::_3gpp::model::Tai> NwdafCond::getTaiList() const
{
    return m_TaiList;
}
void NwdafCond::setTaiList(std::vector<oai::_3gpp::model::Tai> const& value)
{
    m_TaiList = value;
    m_TaiListIsSet = true;
}
...
std::vector<oai::_3gpp::model::TaiRange> NwdafCond::getTaiRangeList() const
{
    return m_TaiRangeList;
}
void NwdafCond::setTaiRangeList(std::vector<oai::_3gpp::model::TaiRange> const& value)
{
...
std::vector<oai::_3gpp::model::NFType> NwdafCond::getServingNfTypeList() const
{
    return m_ServingNfTypeList;
}
void NwdafCond::setServingNfTypeList(std::vector<oai::_3gpp::model::NFType> const& value)
{
...
std::vector<oai::_3gpp::model::MlAnalyticsInfo> NwdafCond::getMlAnalyticsList() const
{
    return m_MlAnalyticsList;
}
void NwdafCond::setMlAnalyticsList(std::vector<oai::_3gpp::model::MlAnalyticsInfo> const& value)
{
