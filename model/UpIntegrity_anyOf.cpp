...
bool UpIntegrity_anyOf::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "UpIntegrity_anyOf" : pathPrefix;

    
    if (m_value == UpIntegrity_anyOf::eUpIntegrity_anyOf::INVALID_VALUE_OPENAPI_GENERATED)
    {
        success = false;
