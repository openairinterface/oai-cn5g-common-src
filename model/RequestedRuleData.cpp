...
bool RequestedRuleData::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    ...
    /* ReqData */ {
        const std::vector<oai::model::RequestedRuleDataType>& value = m_ReqData;
        ...
        { // Recursive validation of array elements
            const std::string oldValuePath = currentValuePath;
            int i = 0;
            for (const oai::model::RequestedRuleDataType& value : value)
            { 
                const std::string currentValuePath = oldValuePath + "[" + std::to_string(i) + "]";
...
std::vector<oai::model::RequestedRuleDataType> RequestedRuleData::getReqData() const
{
    return m_ReqData;
}
void RequestedRuleData::setReqData(std::vector<oai::model::RequestedRuleDataType> const& value)
{
    m_ReqData = value;
}
