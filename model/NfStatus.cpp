...
bool NfStatus::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
...
bool NfStatus::operator==(const NfStatus& rhs) const
{
    ...
    ((!statusRegisteredIsSet() && !rhs.statusRegisteredIsSet()) || (statusRegisteredIsSet() && rhs.statusRegisteredIsSet() && getStatusRegistered() == rhs.getStatusRegistered())) &&
    
    
    ((!statusUnregisteredIsSet() && !rhs.statusUnregisteredIsSet()) || (statusUnregisteredIsSet() && rhs.statusUnregisteredIsSet() && getStatusUnregistered() == rhs.getStatusUnregistered())) &&
    
    
    ((!statusUndiscoverableIsSet() && !rhs.statusUndiscoverableIsSet()) || (statusUndiscoverableIsSet() && rhs.statusUndiscoverableIsSet() && getStatusUndiscoverable() == rhs.getStatusUndiscoverable()))
