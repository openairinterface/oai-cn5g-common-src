...
void OutOfCreditInformation::setFinUnitAct(oai::model::pcf::FinalUnitAction const& value)
{
    m_FinUnitAct = value;
}
...
void OutOfCreditInformation::setFlows(std::vector<oai::model::pcf::Flows> const& value)
{
    m_Flows = value;
    m_FlowsIsSet = true;
}
