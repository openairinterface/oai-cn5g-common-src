...
bool SuciInfo::operator==(const SuciInfo& rhs) const {
  return
      ...
      ((!routingIndsIsSet() && !rhs.routingIndsIsSet()) ||
       (routingIndsIsSet() && rhs.routingIndsIsSet() &&
        getRoutingInds() == rhs.getRoutingInds())) &&

      ((!hNwPubKeyIdsIsSet() && !rhs.hNwPubKeyIdsIsSet()) ||
       (hNwPubKeyIdsIsSet() && rhs.hNwPubKeyIdsIsSet() &&
        getHNwPubKeyIds() == rhs.getHNwPubKeyIds()))
