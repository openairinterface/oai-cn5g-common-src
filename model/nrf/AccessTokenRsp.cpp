...
std::string AccessTokenRsp::getAccessToken() const { return m_Access_token; }
void AccessTokenRsp::setAccessToken(std::string const &value) {
  m_Access_token = value;
}
std::string AccessTokenRsp::getTokenType() const { return m_Token_type; }
void AccessTokenRsp::setTokenType(std::string const &value) {
  m_Token_type = value;
}
int32_t AccessTokenRsp::getExpiresIn() const { return m_Expires_in; }
void AccessTokenRsp::setExpiresIn(int32_t const value) {
  m_Expires_in = value;
  m_Expires_inIsSet = true;
}
bool AccessTokenRsp::expiresInIsSet() const { return m_Expires_inIsSet; }
void AccessTokenRsp::unsetExpires_in() { m_Expires_inIsSet = false; }
std::string AccessTokenRsp::getScope() const { return m_Scope; }
void AccessTokenRsp::setScope(std::string const &value) {
  m_Scope = value;
  m_ScopeIsSet = true;
}
bool AccessTokenRsp::scopeIsSet() const { return m_ScopeIsSet; }
void AccessTokenRsp::unsetScope() { m_ScopeIsSet = false; }
