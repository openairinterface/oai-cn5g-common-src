 ...
 * 	found in
 * "/tmp/mouse_asn1c/skeletons/standard-modules/ASN1C-UsefulInformationObjectClasses.asn1"
...
extern asn_TYPE_descriptor_t asn_DEF_Ngap_encoding
    __attribute__((weak, alias("asn_DEF_Ngap_encoding_5")));
#else
static asn_TYPE_descriptor_t asn_DEF_Ngap_encoding_5;
static asn_TYPE_descriptor_t asn_DEF_Ngap_encoding;
__attribute__((constructor)) static void asn_DEF_Ngap_encoding_5_alias_init(
    void) {
  asn_DEF_Ngap_encoding = asn_DEF_Ngap_encoding_5;
}
#endif
...
static asn_TYPE_member_t asn_MBR_Ngap_EXTERNAL__encoding_5[] = {
    {ATF_NOFLAGS,
     0,
     offsetof(struct Ngap_EXTERNAL__encoding, choice.single_ASN1_type),
    ...
    {ATF_NOFLAGS,
     0,
     offsetof(struct Ngap_EXTERNAL__encoding, choice.octet_aligned),
    ...
    {ATF_NOFLAGS,
     0,
     offsetof(struct Ngap_EXTERNAL__encoding, choice.arbitrary),
...
static /* Use -fall-defs-global to expose */
    asn_TYPE_descriptor_t asn_DEF_Ngap_encoding_5 = {
        ...
        {
#if !defined(ASN_DISABLE_OER_SUPPORT)
            &asn_OER_type_Ngap_encoding_constr_5,
#endif /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
            &asn_PER_type_Ngap_encoding_constr_5,
#endif /* !defined(ASN_DISABLE_UPER_SUPPORT) ||                                \
          !defined(ASN_DISABLE_APER_SUPPORT) */
#if !defined(ASN_DISABLE_JER_SUPPORT)
            0,
#endif /* !defined(ASN_DISABLE_JER_SUPPORT) */
            CHOICE_constraint},
        asn_MBR_Ngap_EXTERNAL__encoding_5,
        3,                             /* Elements count */
...
static asn_TYPE_member_t asn_MBR_Ngap_EXTERNAL_1[] = {
    {ATF_POINTER,
     3,
     offsetof(struct Ngap_EXTERNAL, direct_reference),
    ...
    {ATF_POINTER,
     2,
     offsetof(struct Ngap_EXTERNAL, indirect_reference),
    ...
    {ATF_POINTER,
     1,
     offsetof(struct Ngap_EXTERNAL, data_value_descriptor),
    ...
    {ATF_NOFLAGS,
     0,
     offsetof(struct Ngap_EXTERNAL, encoding),
...
asn_TYPE_descriptor_t asn_DEF_Ngap_EXTERNAL = {
    ...
    sizeof(asn_DEF_Ngap_EXTERNAL_tags_1) /
            sizeof(asn_DEF_Ngap_EXTERNAL_tags_1[0]) -
        1,                        /* 1 */
