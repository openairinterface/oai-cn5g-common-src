...
oai::model::amf::PwsInformation N2InfoContainer::getPwsInfo() const {
  return m_PwsInfo;
}
void N2InfoContainer::setPwsInfo(oai::model::amf::PwsInformation const &value) {
  m_PwsInfo = value;
  m_PwsInfoIsSet = true;
}
bool N2InfoContainer::pwsInfoIsSet() const { return m_PwsInfoIsSet; }
void N2InfoContainer::unsetPwsInfo() { m_PwsInfoIsSet = false; }
oai::model::amf::V2xInformation N2InfoContainer::getV2xInfo() const {
  return m_V2xInfo;
}
void N2InfoContainer::setV2xInfo(oai::model::amf::V2xInformation const &value) {
  m_V2xInfo = value;
  m_V2xInfoIsSet = true;
}
