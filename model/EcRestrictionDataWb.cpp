...
bool EcRestrictionDataWb::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "EcRestrictionDataWb" : pathPrefix;
...
bool EcRestrictionDataWb::operator==(const EcRestrictionDataWb& rhs) const
{
    ...
    ((!ecModeARestrictedIsSet() && !rhs.ecModeARestrictedIsSet()) || (ecModeARestrictedIsSet() && rhs.ecModeARestrictedIsSet() && isEcModeARestricted() == rhs.isEcModeARestricted())) &&
