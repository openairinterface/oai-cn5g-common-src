...
extern const asn_INTEGER_specifics_t
    asn_SPC_Ngap_Suspend_Response_Indication_specs_1;
...
cbor_type_decoder_f Ngap_Suspend_Response_Indication_decode_cbor;
cbor_type_encoder_f Ngap_Suspend_Response_Indication_encode_cbor;
