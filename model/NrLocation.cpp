...
oai::_3gpp::model::Tai NrLocation::getTai() const
{
    return m_Tai;
}
void NrLocation::setTai(oai::_3gpp::model::Tai const& value)
{
    m_Tai = value;
}
oai::_3gpp::model::Ncgi NrLocation::getNcgi() const
{
    return m_Ncgi;
}
void NrLocation::setNcgi(oai::_3gpp::model::Ncgi const& value)
{
    m_Ncgi = value;
}
...
oai::_3gpp::model::GlobalRanNodeId NrLocation::getGlobalGnbId() const
{
    return m_GlobalGnbId;
}
void NrLocation::setGlobalGnbId(oai::_3gpp::model::GlobalRanNodeId const& value)
{
    m_GlobalGnbId = value;
