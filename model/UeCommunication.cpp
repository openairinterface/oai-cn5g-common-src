...
bool UeCommunication::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "UeCommunication" : pathPrefix;
...
bool UeCommunication::operator==(const UeCommunication& rhs) const
{
    ...
    ((!commDurIsSet() && !rhs.commDurIsSet()) || (commDurIsSet() && rhs.commDurIsSet() && getCommDur() == rhs.getCommDur())) &&
    
    
    ((!commDurVarianceIsSet() && !rhs.commDurVarianceIsSet()) || (commDurVarianceIsSet() && rhs.commDurVarianceIsSet() && getCommDurVariance() == rhs.getCommDurVariance())) &&
    
    
    ((!perioTimeIsSet() && !rhs.perioTimeIsSet()) || (perioTimeIsSet() && rhs.perioTimeIsSet() && getPerioTime() == rhs.getPerioTime())) &&
    
    
    ((!perioTimeVarianceIsSet() && !rhs.perioTimeVarianceIsSet()) || (perioTimeVarianceIsSet() && rhs.perioTimeVarianceIsSet() && getPerioTimeVariance() == rhs.getPerioTimeVariance())) &&
    
    
    ((!tsIsSet() && !rhs.tsIsSet()) || (tsIsSet() && rhs.tsIsSet() && getTs() == rhs.getTs())) &&
    
    
    ((!tsVarianceIsSet() && !rhs.tsVarianceIsSet()) || (tsVarianceIsSet() && rhs.tsVarianceIsSet() && getTsVariance() == rhs.getTsVariance())) &&
    
    
    ((!recurringTimeIsSet() && !rhs.recurringTimeIsSet()) || (recurringTimeIsSet() && rhs.recurringTimeIsSet() && getRecurringTime() == rhs.getRecurringTime())) &&
    
    
    ((!trafCharIsSet() && !rhs.trafCharIsSet()) || (trafCharIsSet() && rhs.trafCharIsSet() && getTrafChar() == rhs.getTrafChar())) &&
    
    
    ((!ratioIsSet() && !rhs.ratioIsSet()) || (ratioIsSet() && rhs.ratioIsSet() && getRatio() == rhs.getRatio())) &&
    
    
    ((!perioCommIndIsSet() && !rhs.perioCommIndIsSet()) || (perioCommIndIsSet() && rhs.perioCommIndIsSet() && isPerioCommInd() == rhs.isPerioCommInd())) &&
    
    
    ((!confidenceIsSet() && !rhs.confidenceIsSet()) || (confidenceIsSet() && rhs.confidenceIsSet() && getConfidence() == rhs.getConfidence())) &&
    
    
    ((!anaOfAppListIsSet() && !rhs.anaOfAppListIsSet()) || (anaOfAppListIsSet() && rhs.anaOfAppListIsSet() && getAnaOfAppList() == rhs.getAnaOfAppList())) &&
    
    
    ((!sessInactTimerIsSet() && !rhs.sessInactTimerIsSet()) || (sessInactTimerIsSet() && rhs.sessInactTimerIsSet() && getSessInactTimer() == rhs.getSessInactTimer()))
...
void to_json(nlohmann::json& j, const UeCommunication& o)
{
    ...
    if(o.ratioIsSet())
        j["ratio"] = o.m_Ratio;
    if(o.perioCommIndIsSet())
        j["perioCommInd"] = o.m_PerioCommInd;
    if(o.confidenceIsSet())
        j["confidence"] = o.m_Confidence;
    if(o.anaOfAppListIsSet())
        j["anaOfAppList"] = o.m_AnaOfAppList;
    if(o.sessInactTimerIsSet())
        j["sessInactTimer"] = o.m_SessInactTimer;
...
oai::model::ScheduledCommunicationTime_1 UeCommunication::getRecurringTime() const
{
    return m_RecurringTime;
}
void UeCommunication::setRecurringTime(oai::model::ScheduledCommunicationTime_1 const& value)
{
...
oai::model::TrafficCharacterization UeCommunication::getTrafChar() const
{
    return m_TrafChar;
}
void UeCommunication::setTrafChar(oai::model::TrafficCharacterization const& value)
{
    m_TrafChar = value;
...
oai::model::AppListForUeComm UeCommunication::getAnaOfAppList() const
{
    return m_AnaOfAppList;
}
void UeCommunication::setAnaOfAppList(oai::model::AppListForUeComm const& value)
{
...
oai::model::SessInactTimerForUeComm UeCommunication::getSessInactTimer() const
{
    return m_SessInactTimer;
}
void UeCommunication::setSessInactTimer(oai::model::SessInactTimerForUeComm const& value)
{
