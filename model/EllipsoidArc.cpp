...
bool EllipsoidArc::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "EllipsoidArc" : pathPrefix;
...
oai::model::SupportedGADShapes EllipsoidArc::getShape() const
{
    return m_Shape;
}
void EllipsoidArc::setShape(oai::model::SupportedGADShapes const& value)
{
    m_Shape = value;
}
oai::model::GeographicalCoordinates EllipsoidArc::getPoint() const
{
    return m_Point;
}
void EllipsoidArc::setPoint(oai::model::GeographicalCoordinates const& value)
{
    m_Point = value;
}
