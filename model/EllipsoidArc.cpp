...
oai::_3gpp::model::SupportedGADShapes EllipsoidArc::getShape() const
{
    return m_Shape;
}
void EllipsoidArc::setShape(oai::_3gpp::model::SupportedGADShapes const& value)
{
    m_Shape = value;
}
oai::_3gpp::model::GeographicalCoordinates EllipsoidArc::getPoint() const
{
    return m_Point;
}
void EllipsoidArc::setPoint(oai::_3gpp::model::GeographicalCoordinates const& value)
{
    m_Point = value;
}
