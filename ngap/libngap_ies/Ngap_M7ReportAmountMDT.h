...
/* Implementation */
extern asn_oer_constraints_t asn_OER_type_Ngap_M7ReportAmountMDT_constr_1;
...
xer_type_decoder_f Ngap_M7ReportAmountMDT_decode_xer;
xer_type_encoder_f Ngap_M7ReportAmountMDT_encode_xer;
cbor_type_decoder_f Ngap_M7ReportAmountMDT_decode_cbor;
cbor_type_encoder_f Ngap_M7ReportAmountMDT_encode_cbor;
oer_type_decoder_f Ngap_M7ReportAmountMDT_decode_oer;
oer_type_encoder_f Ngap_M7ReportAmountMDT_encode_oer;
