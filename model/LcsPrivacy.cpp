...
bool LcsPrivacy::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "LcsPrivacy" : pathPrefix;
...
oai::model::Lpi LcsPrivacy::getLpi() const
{
    return m_Lpi;
}
void LcsPrivacy::setLpi(oai::model::Lpi const& value)
{
    m_Lpi = value;
    m_LpiIsSet = true;
}
