...
asn_TYPE_member_t asn_MBR_Ngap_UL_NGU_UP_TNLModifyItem_1[] = {
	{ ATF_POINTER, 0, offsetof(struct Ngap_UL_NGU_UP_TNLModifyItem, uL_NGU_UP_TNLInformation),
	...
	{ ATF_POINTER, 0, offsetof(struct Ngap_UL_NGU_UP_TNLModifyItem, dL_NGU_UP_TNLInformation),
