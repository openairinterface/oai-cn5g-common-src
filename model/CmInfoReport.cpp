...
bool CmInfoReport::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "CmInfoReport" : pathPrefix;
...
std::vector<oai::model::CmInfo> CmInfoReport::getOldCmInfoList() const
{
    return m_OldCmInfoList;
}
void CmInfoReport::setOldCmInfoList(std::vector<oai::model::CmInfo> const& value)
{
...
std::vector<oai::model::CmInfo> CmInfoReport::getNewCmInfoList() const
{
    return m_NewCmInfoList;
}
void CmInfoReport::setNewCmInfoList(std::vector<oai::model::CmInfo> const& value)
{
