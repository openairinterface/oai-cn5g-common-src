...
bool ReportingOptions::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "ReportingOptions" : pathPrefix;
...
oai::_3gpp::model::EventReportMode ReportingOptions::getReportMode() const
{
    return m_ReportMode;
}
void ReportingOptions::setReportMode(oai::_3gpp::model::EventReportMode const& value)
{
    m_ReportMode = value;
...
oai::_3gpp::model::NotificationFlag ReportingOptions::getNotifFlag() const
{
    return m_NotifFlag;
}
void ReportingOptions::setNotifFlag(oai::_3gpp::model::NotificationFlag const& value)
{
    m_NotifFlag = value;
