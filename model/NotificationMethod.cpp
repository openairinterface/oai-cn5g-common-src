...
bool NotificationMethod::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "NotificationMethod" : pathPrefix;
...
NotificationMethod_anyOf::eNotificationMethod_anyOf NotificationMethod::getEnumValue() const
{
    return m_value.getValue();
}

void NotificationMethod::setEnumValue(NotificationMethod_anyOf::eNotificationMethod_anyOf  value)
{
