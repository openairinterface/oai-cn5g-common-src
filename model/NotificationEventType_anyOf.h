...
public:
    ...
    void setValue(NotificationEventType_anyOf::eNotificationEventType_anyOf value);
...
protected:
    NotificationEventType_anyOf::eNotificationEventType_anyOf m_value = NotificationEventType_anyOf::eNotificationEventType_anyOf::INVALID_VALUE_OPENAPI_GENERATED;
};
