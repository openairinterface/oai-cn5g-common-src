...
public:
    ...
    /// 
    /// </summary>
    std::vector<oai::model::udsf::NotificationSubscription> getExpiredSubscriptions() const;
    void setExpiredSubscriptions(std::vector<oai::model::udsf::NotificationSubscription> const& value);
...
protected:
    std::vector<oai::model::udsf::NotificationSubscription> m_ExpiredSubscriptions;
