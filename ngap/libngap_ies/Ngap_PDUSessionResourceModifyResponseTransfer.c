...
static asn_TYPE_member_t
    asn_MBR_Ngap_PDUSessionResourceModifyResponseTransfer_1[] = {
        ...
        {ATF_POINTER,
         ...
         -1, /* IMPLICIT tag at current level */
         &asn_DEF_Ngap_ProtocolExtensionContainer_12929P232,
         0,
         {
#if !defined(ASN_DISABLE_OER_SUPPORT)
             0,
...
static const int asn_MAP_Ngap_PDUSessionResourceModifyResponseTransfer_oms_1[] =
    {0, 1, 2, 3, 4, 5};
...
asn_TYPE_descriptor_t asn_DEF_Ngap_PDUSessionResourceModifyResponseTransfer = {
    ...
    sizeof(asn_DEF_Ngap_PDUSessionResourceModifyResponseTransfer_tags_1) /
        sizeof(asn_DEF_Ngap_PDUSessionResourceModifyResponseTransfer_tags_1
                   [0]),                                          /* 1 */
    asn_DEF_Ngap_PDUSessionResourceModifyResponseTransfer_tags_1, /* Same as
                                                                     above */
    sizeof(asn_DEF_Ngap_PDUSessionResourceModifyResponseTransfer_tags_1) /
        sizeof(asn_DEF_Ngap_PDUSessionResourceModifyResponseTransfer_tags_1
                   [0]), /* 1 */
