...
bool UeContextTransferReqData::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "UeContextTransferReqData" : pathPrefix;
...
bool UeContextTransferReqData::operator==(const UeContextTransferReqData& rhs) const
{
    return
    ...
    ((!regRequestIsSet() && !rhs.regRequestIsSet()) || (regRequestIsSet() && rhs.regRequestIsSet() && getRegRequest() == rhs.getRegRequest())) &&
...
void to_json(nlohmann::json& j, const UeContextTransferReqData& o)
{
    ...
    if(o.plmnIdIsSet())
        j["plmnId"] = o.m_PlmnId;
    if(o.regRequestIsSet())
        j["regRequest"] = o.m_RegRequest;
...
oai::model::TransferReason UeContextTransferReqData::getReason() const
{
    return m_Reason;
}
void UeContextTransferReqData::setReason(oai::model::TransferReason const& value)
{
    m_Reason = value;
}
oai::model::AccessType UeContextTransferReqData::getAccessType() const
{
    return m_AccessType;
}
void UeContextTransferReqData::setAccessType(oai::model::AccessType const& value)
{
    m_AccessType = value;
}
oai::model::PlmnId UeContextTransferReqData::getPlmnId() const
{
    return m_PlmnId;
}
void UeContextTransferReqData::setPlmnId(oai::model::PlmnId const& value)
{
    m_PlmnId = value;
    m_PlmnIdIsSet = true;
}
...
oai::model::N1MessageContainer UeContextTransferReqData::getRegRequest() const
{
    return m_RegRequest;
}
void UeContextTransferReqData::setRegRequest(oai::model::N1MessageContainer const& value)
{
    m_RegRequest = value;
