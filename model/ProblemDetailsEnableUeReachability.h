...
public:
    ...
    virtual ~ProblemDetailsEnableUeReachability() = default;
    ...
    bool operator==(const ProblemDetailsEnableUeReachability& rhs) const;
    bool operator!=(const ProblemDetailsEnableUeReachability& rhs) const;
    ...
    friend void to_json(nlohmann::json& j, const ProblemDetailsEnableUeReachability& o);
    friend void from_json(const nlohmann::json& j, ProblemDetailsEnableUeReachability& o);
protected:
    std::string m_Type;
    bool m_TypeIsSet;
    std::string m_Title;
