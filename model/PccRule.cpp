...
bool PccRule::operator==(const PccRule& rhs) const {
  return
      ...
      ((!packFiltAllPrecIsSet() && !rhs.packFiltAllPrecIsSet()) ||
       (packFiltAllPrecIsSet() && rhs.packFiltAllPrecIsSet() &&
        getPackFiltAllPrec() == rhs.getPackFiltAllPrec()))
...
void to_json(nlohmann::json& j, const PccRule& o) {
  ...
  if (o.packFiltAllPrecIsSet()) j["packFiltAllPrec"] = o.m_PackFiltAllPrec;
}
...
oai::_3gpp::model::DownlinkDataNotificationControl PccRule::getDdNotifCtrl()
    const {
...
oai::_3gpp::model::DownlinkDataNotificationControlRm PccRule::getDdNotifCtrl2()
    const {
