...
bool SmsManagementSubscriptionData::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "SmsManagementSubscriptionData" : pathPrefix;
...
bool SmsManagementSubscriptionData::operator==(const SmsManagementSubscriptionData& rhs) const
{
    return
...
void SmsManagementSubscriptionData::setSupportedFeatures(std::string const& value)
{
...
std::vector<oai::_3gpp::model::std::string> SmsManagementSubscriptionData::getSharedSmsMngDataIds() const
{
    return m_SharedSmsMngDataIds;
}
void SmsManagementSubscriptionData::setSharedSmsMngDataIds(std::vector<oai::_3gpp::model::std::string> const& value)
{
...
oai::_3gpp::model::TraceData_1 SmsManagementSubscriptionData::getTraceData() const
{
    return m_TraceData;
}
void SmsManagementSubscriptionData::setTraceData(oai::_3gpp::model::TraceData_1 const& value)
{
    m_TraceData = value;
