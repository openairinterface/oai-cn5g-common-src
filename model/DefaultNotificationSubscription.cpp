...
{
    m_CallbackUri = "";
    m_InterPlmnCallbackUri = "";
    m_InterPlmnCallbackUriIsSet = false;
...
bool DefaultNotificationSubscription::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    ...
    if (!m_NotificationType.validate(msg, _pathPrefix + ".notificationType")) {
        msg << _pathPrefix << ": NotificationType is invalid;";
        success = false;
    }                     
    if (versionsIsSet())
    {
    ...
    if (serviceInfoListIsSet())
    {
        const std::map<std::string, oai::model::DefSubServiceInfo>& value = m_ServiceInfoList;
        const std::string currentValuePath = _pathPrefix + ".serviceInfoList";
...
bool DefaultNotificationSubscription::operator==(const DefaultNotificationSubscription& rhs) const
{
    ...
    ((!interPlmnCallbackUriIsSet() && !rhs.interPlmnCallbackUriIsSet()) || (interPlmnCallbackUriIsSet() && rhs.interPlmnCallbackUriIsSet() && getInterPlmnCallbackUri() == rhs.getInterPlmnCallbackUri())) &&
    ...
    ((!serviceInfoListIsSet() && !rhs.serviceInfoListIsSet()) || (serviceInfoListIsSet() && rhs.serviceInfoListIsSet() && getServiceInfoList() == rhs.getServiceInfoList()))
...
void to_json(nlohmann::json& j, const DefaultNotificationSubscription& o)
{
    ...
    if(o.interPlmnCallbackUriIsSet())
        j["interPlmnCallbackUri"] = o.m_InterPlmnCallbackUri;
...
void from_json(const nlohmann::json& j, DefaultNotificationSubscription& o)
{
    ...
    if(j.find("interPlmnCallbackUri") != j.end())
    {
        j.at("interPlmnCallbackUri").get_to(o.m_InterPlmnCallbackUri);
        o.m_InterPlmnCallbackUriIsSet = true;
    } 
...
oai::model::NotificationType DefaultNotificationSubscription::getNotificationType() const
{
    return m_NotificationType;
}
void DefaultNotificationSubscription::setNotificationType(oai::model::NotificationType const& value)
{
...
std::string DefaultNotificationSubscription::getInterPlmnCallbackUri() const
{
    return m_InterPlmnCallbackUri;
}
void DefaultNotificationSubscription::setInterPlmnCallbackUri(std::string const& value)
{
    m_InterPlmnCallbackUri = value;
    m_InterPlmnCallbackUriIsSet = true;
}
bool DefaultNotificationSubscription::interPlmnCallbackUriIsSet() const
{
    return m_InterPlmnCallbackUriIsSet;
}
void DefaultNotificationSubscription::unsetInterPlmnCallbackUri()
{
    m_InterPlmnCallbackUriIsSet = false;
}
oai::model::N1MessageClass DefaultNotificationSubscription::getN1MessageClass() const
{
    return m_N1MessageClass;
}
void DefaultNotificationSubscription::setN1MessageClass(oai::model::N1MessageClass const& value)
{
...
oai::model::N2InformationClass DefaultNotificationSubscription::getN2InformationClass() const
{
    return m_N2InformationClass;
}
void DefaultNotificationSubscription::setN2InformationClass(oai::model::N2InformationClass const& value)
{
...
std::map<std::string, oai::model::DefSubServiceInfo> DefaultNotificationSubscription::getServiceInfoList() const
{
    return m_ServiceInfoList;
}
void DefaultNotificationSubscription::setServiceInfoList(std::map<std::string, oai::model::DefSubServiceInfo> const& value)
{
    m_ServiceInfoList = value;
    m_ServiceInfoListIsSet = true;
}
bool DefaultNotificationSubscription::serviceInfoListIsSet() const
{
    return m_ServiceInfoListIsSet;
}
void DefaultNotificationSubscription::unsetServiceInfoList()
{
    m_ServiceInfoListIsSet = false;
}
