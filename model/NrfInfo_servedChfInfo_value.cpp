...
bool NrfInfo_servedChfInfo_value::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "NrfInfo_servedChfInfo_value" : pathPrefix;

         
    if (supiRangeListIsSet())
    {
        const std::vector<oai::model::SupiRange>& value = m_SupiRangeList;
    ...
    {
        const std::vector<oai::model::IdentityRange>& value = m_GpsiRangeList;
    ...
    {
        const std::vector<oai::model::PlmnRange>& value = m_PlmnRangeList;
        ...
        { // Recursive validation of array elements
            const std::string oldValuePath = currentValuePath;
            int i = 0;
            for (const oai::model::PlmnRange& value : value)
            { 
                const std::string currentValuePath = oldValuePath + "[" + std::to_string(i) + "]";
...
bool NrfInfo_servedChfInfo_value::operator==(const NrfInfo_servedChfInfo_value& rhs) const
{
    return
...
std::vector<oai::model::SupiRange> NrfInfo_servedChfInfo_value::getSupiRangeList() const
{
    return m_SupiRangeList;
}
void NrfInfo_servedChfInfo_value::setSupiRangeList(std::vector<oai::model::SupiRange> const& value)
{
...
std::vector<oai::model::IdentityRange> NrfInfo_servedChfInfo_value::getGpsiRangeList() const
{
    return m_GpsiRangeList;
}
void NrfInfo_servedChfInfo_value::setGpsiRangeList(std::vector<oai::model::IdentityRange> const& value)
{
...
std::vector<oai::model::PlmnRange> NrfInfo_servedChfInfo_value::getPlmnRangeList() const
{
    return m_PlmnRangeList;
}
void NrfInfo_servedChfInfo_value::setPlmnRangeList(std::vector<oai::model::PlmnRange> const& value)
{
...
void NrfInfo_servedChfInfo_value::setPrimaryChfInstance(std::string const& value)
{
...
void NrfInfo_servedChfInfo_value::setSecondaryChfInstance(std::string const& value)
{
