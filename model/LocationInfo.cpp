...
bool LocationInfo::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "LocationInfo" : pathPrefix;

        
    if (!m_Loc.validate(msg, _pathPrefix + ".loc")) {
        msg << _pathPrefix << ": Loc is invalid;";
        success = false;
    }     
    if (ratioIsSet())
    {
...
oai::model::UserLocation LocationInfo::getLoc() const
{
    return m_Loc;
}
void LocationInfo::setLoc(oai::model::UserLocation const& value)
{
    m_Loc = value;
}
int32_t LocationInfo::getRatio() const
{
    return m_Ratio;
}
void LocationInfo::setRatio(int32_t const value)
{
    m_Ratio = value;
    m_RatioIsSet = true;
}
bool LocationInfo::ratioIsSet() const
{
    return m_RatioIsSet;
}
void LocationInfo::unsetRatio()
{
    m_RatioIsSet = false;
}
int32_t LocationInfo::getConfidence() const
{
    return m_Confidence;
}
void LocationInfo::setConfidence(int32_t const value)
{
    m_Confidence = value;
    m_ConfidenceIsSet = true;
}
bool LocationInfo::confidenceIsSet() const
{
    return m_ConfidenceIsSet;
}
void LocationInfo::unsetConfidence()
{
    m_ConfidenceIsSet = false;
}
