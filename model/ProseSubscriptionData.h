...
public:
    ...
    /// 
    /// </summary>
    oai::model::ProseServiceAuth getProseServiceAuth() const;
    void setProseServiceAuth(oai::model::ProseServiceAuth const& value);
    ...
    /// 
    /// </summary>
    std::vector<oai::model::ProSeAllowedPlmn> getProseAllowedPlmn() const;
    void setProseAllowedPlmn(std::vector<oai::model::ProSeAllowedPlmn> const& value);
...
protected:
    oai::model::ProseServiceAuth m_ProseServiceAuth;
    bool m_ProseServiceAuthIsSet;
    std::string m_NrUePc5Ambr;
    bool m_NrUePc5AmbrIsSet;
    std::vector<oai::model::ProSeAllowedPlmn> m_ProseAllowedPlmn;
