...
asn_TYPE_member_t asn_MBR_Ngap_UserLocationInformationEUTRA_1[] = {
	{ ATF_POINTER, 0, offsetof(struct Ngap_UserLocationInformationEUTRA, eUTRA_CGI),
	...
	{ ATF_POINTER, 0, offsetof(struct Ngap_UserLocationInformationEUTRA, tAI),
	...
	{ ATF_POINTER, 2, offsetof(struct Ngap_UserLocationInformationEUTRA, timeStamp),
