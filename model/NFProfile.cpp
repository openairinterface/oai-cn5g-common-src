...
bool NFProfile::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    ...
    {
        const std::vector<oai::_3gpp::model::CollocatedNfInstance>& value = m_CollocatedNfInstances;
    ...
    {
        const std::vector<oai::_3gpp::model::PlmnSnssai>& value = m_PerPlmnSnssaiList;
    ...
    if (udrInfoListIsSet())
    {
        const std::map<std::string, oai::_3gpp::model::UdrInfo>& value = m_UdrInfoList;
    ...
    if (udmInfoListIsSet())
    {
        const std::map<std::string, oai::_3gpp::model::UdmInfo>& value = m_UdmInfoList;
    ...
    {
        const std::map<std::string, oai::_3gpp::model::AusfInfo>& value = m_AusfInfoList;
    ...
    if (amfInfoListIsSet())
    {
        const std::map<std::string, oai::_3gpp::model::AmfInfo>& value = m_AmfInfoList;
    ...
    if (smfInfoListIsSet())
    {
        const std::map<std::string, oai::_3gpp::model::SmfInfo>& value = m_SmfInfoList;
    ...
    if (upfInfoListIsSet())
    {
        const std::map<std::string, oai::_3gpp::model::UpfInfo>& value = m_UpfInfoList;
    ...
    if (pcfInfoListIsSet())
    {
        const std::map<std::string, oai::_3gpp::model::PcfInfo>& value = m_PcfInfoList;
    ...
    if (bsfInfoListIsSet())
    {
        const std::map<std::string, oai::_3gpp::model::BsfInfo>& value = m_BsfInfoList;
    ...
    if (chfInfoListIsSet())
    {
        const std::map<std::string, oai::_3gpp::model::ChfInfo>& value = m_ChfInfoList;
    ...
    {
        const std::map<std::string, oai::_3gpp::model::UdsfInfo>& value = m_UdsfInfoList;
    ...
    {
        const std::map<std::string, oai::_3gpp::model::NwdafInfo>& value = m_NwdafInfoList;
    ...
    {
        const std::map<std::string, oai::_3gpp::model::PcscfInfo>& value = m_PcscfInfoList;
    ...
    if (hssInfoListIsSet())
    {
        const std::map<std::string, oai::_3gpp::model::HssInfo>& value = m_HssInfoList;
    ...
    {
        const std::map<std::string, oai::_3gpp::model::NFService>& value = m_NfServiceList;
    ...
    {
        const std::vector<oai::_3gpp::model::DefaultNotificationSubscription>& value = m_DefaultNotificationSubscriptions;
        ...
        { // Recursive validation of array elements
            const std::string oldValuePath = currentValuePath;
            int i = 0;
            for (const oai::_3gpp::model::DefaultNotificationSubscription& value : value)
            { 
                const std::string currentValuePath = oldValuePath + "[" + std::to_string(i) + "]";
    ...
    {
        const std::map<std::string, std::vector<oai::_3gpp::model::VendorSpecificFeature>>& value = m_SupportedVendorSpecificFeatures;
    ...
    {
        const std::map<std::string, oai::_3gpp::model::AanfInfo>& value = m_AanfInfoList;
    ...
    {
        const std::map<std::string, oai::_3gpp::model::EasdfInfo>& value = m_EasdfInfoList;
    ...
    {
        const std::map<std::string, oai::_3gpp::model::NsacfInfo>& value = m_NsacfInfoList;
    ...
    {
        const std::map<std::string, oai::_3gpp::model::MbSmfInfo>& value = m_MbSmfInfoList;
    ...
    {
        const std::map<std::string, oai::_3gpp::model::TsctsfInfo>& value = m_TsctsfInfoList;
    ...
    {
        const std::map<std::string, oai::_3gpp::model::MbUpfInfo>& value = m_MbUpfInfoList;
...
bool NFProfile::operator==(const NFProfile& rhs) const
{
    ...
    ((!nssaafInfoIsSet() && !rhs.nssaafInfoIsSet()) || (nssaafInfoIsSet() && rhs.nssaafInfoIsSet() && getNssaafInfo() == rhs.getNssaafInfo())) &&
    
    
    ((!hniListIsSet() && !rhs.hniListIsSet()) || (hniListIsSet() && rhs.hniListIsSet() && getHniList() == rhs.getHniList())) &&
    
    
    ((!iwmscInfoIsSet() && !rhs.iwmscInfoIsSet()) || (iwmscInfoIsSet() && rhs.iwmscInfoIsSet() && getIwmscInfo() == rhs.getIwmscInfo())) &&
    
    
    ((!mnpfInfoIsSet() && !rhs.mnpfInfoIsSet()) || (mnpfInfoIsSet() && rhs.mnpfInfoIsSet() && getMnpfInfo() == rhs.getMnpfInfo()))
...
void to_json(nlohmann::json& j, const NFProfile& o)
{
    ...
    if(o.nssaafInfoIsSet())
        j["nssaafInfo"] = o.m_NssaafInfo;
    if(o.hniListIsSet() || !o.m_HniList.empty())
        j["hniList"] = o.m_HniList;
    if(o.iwmscInfoIsSet())
        j["iwmscInfo"] = o.m_IwmscInfo;
    if(o.mnpfInfoIsSet())
        j["mnpfInfo"] = o.m_MnpfInfo;
...
std::vector<oai::_3gpp::model::CollocatedNfInstance> NFProfile::getCollocatedNfInstances() const
{
    return m_CollocatedNfInstances;
}
void NFProfile::setCollocatedNfInstances(std::vector<oai::_3gpp::model::CollocatedNfInstance> const& value)
{
...
void NFProfile::setPlmnList(std::vector<oai::_3gpp::model::PlmnId> const& value)
{
    m_PlmnList = value;
...
void NFProfile::setSnpnList(std::vector<oai::_3gpp::model::PlmnIdNid> const& value)
{
    m_SnpnList = value;
...
void NFProfile::setSNssais(std::vector<oai::_3gpp::model::ExtSnssai> const& value)
{
    m_SNssais = value;
    m_SNssaisIsSet = true;
}
...
std::vector<oai::_3gpp::model::PlmnSnssai> NFProfile::getPerPlmnSnssaiList() const
{
    return m_PerPlmnSnssaiList;
}
void NFProfile::setPerPlmnSnssaiList(std::vector<oai::_3gpp::model::PlmnSnssai> const& value)
{
...
void NFProfile::setIpv6Addresses(std::vector<oai::_3gpp::model::Ipv6Addr> const& value)
{
...
void NFProfile::setAllowedPlmns(std::vector<oai::_3gpp::model::PlmnId> const& value)
{
...
void NFProfile::setAllowedSnpns(std::vector<oai::_3gpp::model::PlmnIdNid> const& value)
{
...
void NFProfile::setAllowedNfTypes(std::vector<oai::_3gpp::model::NFType> const& value)
{
...
void NFProfile::setAllowedNssais(std::vector<oai::_3gpp::model::ExtSnssai> const& value)
{
...
std::map<std::string, oai::_3gpp::model::UdrInfo> NFProfile::getUdrInfoList() const
{
    return m_UdrInfoList;
}
void NFProfile::setUdrInfoList(std::map<std::string, oai::_3gpp::model::UdrInfo> const& value)
{
    m_UdrInfoList = value;
...
std::map<std::string, oai::_3gpp::model::UdmInfo> NFProfile::getUdmInfoList() const
{
    return m_UdmInfoList;
}
void NFProfile::setUdmInfoList(std::map<std::string, oai::_3gpp::model::UdmInfo> const& value)
{
    m_UdmInfoList = value;
...
std::map<std::string, oai::_3gpp::model::AusfInfo> NFProfile::getAusfInfoList() const
{
    return m_AusfInfoList;
}
void NFProfile::setAusfInfoList(std::map<std::string, oai::_3gpp::model::AusfInfo> const& value)
{
...
std::map<std::string, oai::_3gpp::model::AmfInfo> NFProfile::getAmfInfoList() const
{
    return m_AmfInfoList;
}
void NFProfile::setAmfInfoList(std::map<std::string, oai::_3gpp::model::AmfInfo> const& value)
{
    m_AmfInfoList = value;
...
std::map<std::string, oai::_3gpp::model::SmfInfo> NFProfile::getSmfInfoList() const
{
    return m_SmfInfoList;
}
void NFProfile::setSmfInfoList(std::map<std::string, oai::_3gpp::model::SmfInfo> const& value)
{
    m_SmfInfoList = value;
...
std::map<std::string, oai::_3gpp::model::UpfInfo> NFProfile::getUpfInfoList() const
{
    return m_UpfInfoList;
}
void NFProfile::setUpfInfoList(std::map<std::string, oai::_3gpp::model::UpfInfo> const& value)
{
    m_UpfInfoList = value;
...
std::map<std::string, oai::_3gpp::model::PcfInfo> NFProfile::getPcfInfoList() const
{
    return m_PcfInfoList;
}
void NFProfile::setPcfInfoList(std::map<std::string, oai::_3gpp::model::PcfInfo> const& value)
{
    m_PcfInfoList = value;
...
std::map<std::string, oai::_3gpp::model::BsfInfo> NFProfile::getBsfInfoList() const
{
    return m_BsfInfoList;
}
void NFProfile::setBsfInfoList(std::map<std::string, oai::_3gpp::model::BsfInfo> const& value)
{
    m_BsfInfoList = value;
...
std::map<std::string, oai::_3gpp::model::ChfInfo> NFProfile::getChfInfoList() const
{
    return m_ChfInfoList;
}
void NFProfile::setChfInfoList(std::map<std::string, oai::_3gpp::model::ChfInfo> const& value)
{
    m_ChfInfoList = value;
...
std::map<std::string, oai::_3gpp::model::UdsfInfo> NFProfile::getUdsfInfoList() const
{
    return m_UdsfInfoList;
}
void NFProfile::setUdsfInfoList(std::map<std::string, oai::_3gpp::model::UdsfInfo> const& value)
{
...
std::map<std::string, oai::_3gpp::model::NwdafInfo> NFProfile::getNwdafInfoList() const
{
    return m_NwdafInfoList;
}
void NFProfile::setNwdafInfoList(std::map<std::string, oai::_3gpp::model::NwdafInfo> const& value)
{
...
std::map<std::string, oai::_3gpp::model::PcscfInfo> NFProfile::getPcscfInfoList() const
{
    return m_PcscfInfoList;
}
void NFProfile::setPcscfInfoList(std::map<std::string, oai::_3gpp::model::PcscfInfo> const& value)
{
...
std::map<std::string, oai::_3gpp::model::HssInfo> NFProfile::getHssInfoList() const
{
    return m_HssInfoList;
}
void NFProfile::setHssInfoList(std::map<std::string, oai::_3gpp::model::HssInfo> const& value)
{
    m_HssInfoList = value;
...
void NFProfile::setNfServices(std::vector<oai::_3gpp::model::NFService> const& value)
{
    m_NfServices = value;
...
std::map<std::string, oai::_3gpp::model::NFService> NFProfile::getNfServiceList() const
{
    return m_NfServiceList;
}
void NFProfile::setNfServiceList(std::map<std::string, oai::_3gpp::model::NFService> const& value)
{
...
std::vector<oai::_3gpp::model::DefaultNotificationSubscription> NFProfile::getDefaultNotificationSubscriptions() const
{
    return m_DefaultNotificationSubscriptions;
}
void NFProfile::setDefaultNotificationSubscriptions(std::vector<oai::_3gpp::model::DefaultNotificationSubscription> const& value)
{
...
std::map<std::string, std::vector<oai::_3gpp::model::VendorSpecificFeature>> NFProfile::getSupportedVendorSpecificFeatures() const
{
    return m_SupportedVendorSpecificFeatures;
}
void NFProfile::setSupportedVendorSpecificFeatures(std::map<std::string, std::vector<oai::_3gpp::model::VendorSpecificFeature>> const& value)
{
...
std::map<std::string, oai::_3gpp::model::AanfInfo> NFProfile::getAanfInfoList() const
{
    return m_AanfInfoList;
}
void NFProfile::setAanfInfoList(std::map<std::string, oai::_3gpp::model::AanfInfo> const& value)
{
...
oai::_3gpp::model::r_5GDdnmfInfo NFProfile::getR5gDdnmfInfo() const
{
    return m_r_5gDdnmfInfo;
}
void NFProfile::setR5gDdnmfInfo(oai::_3gpp::model::r_5GDdnmfInfo const& value)
{
...
std::map<std::string, oai::_3gpp::model::EasdfInfo> NFProfile::getEasdfInfoList() const
{
    return m_EasdfInfoList;
}
void NFProfile::setEasdfInfoList(std::map<std::string, oai::_3gpp::model::EasdfInfo> const& value)
{
...
std::map<std::string, oai::_3gpp::model::NsacfInfo> NFProfile::getNsacfInfoList() const
{
    return m_NsacfInfoList;
}
void NFProfile::setNsacfInfoList(std::map<std::string, oai::_3gpp::model::NsacfInfo> const& value)
{
...
std::map<std::string, oai::_3gpp::model::MbSmfInfo> NFProfile::getMbSmfInfoList() const
{
    return m_MbSmfInfoList;
}
void NFProfile::setMbSmfInfoList(std::map<std::string, oai::_3gpp::model::MbSmfInfo> const& value)
{
...
std::map<std::string, oai::_3gpp::model::TsctsfInfo> NFProfile::getTsctsfInfoList() const
{
    return m_TsctsfInfoList;
}
void NFProfile::setTsctsfInfoList(std::map<std::string, oai::_3gpp::model::TsctsfInfo> const& value)
{
...
std::map<std::string, oai::_3gpp::model::MbUpfInfo> NFProfile::getMbUpfInfoList() const
{
    return m_MbUpfInfoList;
}
void NFProfile::setMbUpfInfoList(std::map<std::string, oai::_3gpp::model::MbUpfInfo> const& value)
{
