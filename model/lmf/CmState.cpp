...
void from_json(const nlohmann::json &j, CmState &o) { from_json(j, o.m_value); }

CmState_anyOf CmState::getValue() const { return m_value; }

void CmState::setValue(CmState_anyOf value) { m_value = value; }
