...
bool Report::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    ...
    if (!m_NewServingPlmn.validate(msg, _pathPrefix + ".newServingPlmn")) {
        msg << _pathPrefix << ": NewServingPlmn is invalid;";
        success = false;
    }        
    ...
    {
        const std::vector<oai::model::CmInfo>& value = m_OldCmInfoList;
        ...
        success = value.validate(msg, currentValuePath + ".oldCmInfoList") && success;
    ...
    /* NewCmInfoList */ {
        const std::vector<oai::model::CmInfo>& value = m_NewCmInfoList;
        ...
        success = value.validate(msg, currentValuePath + ".newCmInfoList") && success;
    ...
    if (!m_PdnConnStat.validate(msg, _pathPrefix + ".pdnConnStat")) {
        msg << _pathPrefix << ": PdnConnStat is invalid;";
        success = false;
    }         
    if (pduSeIdIsSet())
    {
...
bool Report::operator==(const Report& rhs) const
{
    ...
    ((!oldCmInfoListIsSet() && !rhs.oldCmInfoListIsSet()) || (oldCmInfoListIsSet() && rhs.oldCmInfoListIsSet() && getOldCmInfoList() == rhs.getOldCmInfoList())) &&
...
oai::model::PlmnId Report::getNewServingPlmn() const
{
    return m_NewServingPlmn;
}
void Report::setNewServingPlmn(oai::model::PlmnId const& value)
{
    m_NewServingPlmn = value;
}
oai::model::AccessType Report::getAccessType() const
{
    return m_AccessType;
}
void Report::setAccessType(oai::model::AccessType const& value)
{
    m_AccessType = value;
...
oai::model::CnType Report::getNewCnType() const
{
    return m_NewCnType;
}
void Report::setNewCnType(oai::model::CnType const& value)
{
    m_NewCnType = value;
}
oai::model::CnType Report::getOldCnType() const
{
    return m_OldCnType;
}
void Report::setOldCnType(oai::model::CnType const& value)
{
    m_OldCnType = value;
...
std::vector<oai::model::CmInfo> Report::getOldCmInfoList() const
{
    return m_OldCmInfoList;
}
void Report::setOldCmInfoList(std::vector<oai::model::CmInfo> const& value)
{
...
std::vector<oai::model::CmInfo> Report::getNewCmInfoList() const
{
    return m_NewCmInfoList;
}
void Report::setNewCmInfoList(std::vector<oai::model::CmInfo> const& value)
{
    m_NewCmInfoList = value;
}
oai::model::LossOfConnectivityReason Report::getLossOfConnectReason() const
{
    return m_LossOfConnectReason;
}
void Report::setLossOfConnectReason(oai::model::LossOfConnectivityReason const& value)
{
    m_LossOfConnectReason = value;
}
oai::model::UserLocation Report::getLocation() const
{
    return m_Location;
}
void Report::setLocation(oai::model::UserLocation const& value)
{
    m_Location = value;
}
oai::model::PdnConnectivityStatus Report::getPdnConnStat() const
{
    return m_PdnConnStat;
}
void Report::setPdnConnStat(oai::model::PdnConnectivityStatus const& value)
{
    m_PdnConnStat = value;
}
...
std::vector<oai::model::Ipv6Prefix> Report::getIpv6Prefixes() const
{
    return m_Ipv6Prefixes;
}
void Report::setIpv6Prefixes(std::vector<oai::model::Ipv6Prefix> const& value)
{
...
std::vector<oai::model::Ipv6Addr> Report::getIpv6Addrs() const
{
    return m_Ipv6Addrs;
}
void Report::setIpv6Addrs(std::vector<oai::model::Ipv6Addr> const& value)
{
    m_Ipv6Addrs = value;
...
oai::model::PduSessionType Report::getPduSessType() const
{
    return m_PduSessType;
}
void Report::setPduSessType(oai::model::PduSessionType const& value)
{
    m_PduSessType = value;
