...
bool N2InterfaceAmfInfo::validate(
    std::stringstream& msg, const std::string& pathPrefix) const {
  bool success = true;
  const std::string _pathPrefix =
      pathPrefix.empty() ? "N2InterfaceAmfInfo" : pathPrefix;
  ...
  if (ipv6EndpointAddressIsSet()) {
    const std::vector<oai::_3gpp::model::Ipv6Addr>& value =
        m_Ipv6EndpointAddress;
    ...
    {  // Recursive validation of array elements
      ...
      for (const oai::_3gpp::model::Ipv6Addr& value : value) {
        ...
        success =
            value.validate(msg, currentValuePath + ".ipv6EndpointAddress") &&
            success;
  ...
  if (amfNameIsSet()) {
    const std::string& value           = m_AmfName;
    const std::string currentValuePath = _pathPrefix + ".amfName";
...
bool N2InterfaceAmfInfo::operator==(const N2InterfaceAmfInfo& rhs) const {
  return
      ...
      ((!ipv4EndpointAddressIsSet() && !rhs.ipv4EndpointAddressIsSet()) ||
       (ipv4EndpointAddressIsSet() && rhs.ipv4EndpointAddressIsSet() &&
        getIpv4EndpointAddress() == rhs.getIpv4EndpointAddress())) &&

      ((!ipv6EndpointAddressIsSet() && !rhs.ipv6EndpointAddressIsSet()) ||
       (ipv6EndpointAddressIsSet() && rhs.ipv6EndpointAddressIsSet() &&
        getIpv6EndpointAddress() == rhs.getIpv6EndpointAddress())) &&

      ((!amfNameIsSet() && !rhs.amfNameIsSet()) ||
       (amfNameIsSet() && rhs.amfNameIsSet() &&
        getAmfName() == rhs.getAmfName()))
...
N2InterfaceAmfInfo::getIpv6EndpointAddress() const {
