...
bool ServiceAreaRestriction::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "ServiceAreaRestriction" : pathPrefix;

             
    if (areasIsSet())
    {
        const std::vector<oai::model::Area>& value = m_Areas;
...
bool ServiceAreaRestriction::operator==(const ServiceAreaRestriction& rhs) const
{
    return
...
oai::model::RestrictionType ServiceAreaRestriction::getRestrictionType() const
{
    return m_RestrictionType;
}
void ServiceAreaRestriction::setRestrictionType(oai::model::RestrictionType const& value)
{
...
std::vector<oai::model::Area> ServiceAreaRestriction::getAreas() const
{
    return m_Areas;
}
void ServiceAreaRestriction::setAreas(std::vector<oai::model::Area> const& value)
{
    m_Areas = value;
    m_AreasIsSet = true;
}
...
void ServiceAreaRestriction::setMaxNumOfTAsForNotAllowedAreas(int32_t const value)
{
