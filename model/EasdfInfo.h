...
public:
    ...
    /// 
    /// </summary>
    std::vector<oai::_3gpp::model::SnssaiEasdfInfoItem> getSNssaiEasdfInfoList() const;
    void setSNssaiEasdfInfoList(std::vector<oai::_3gpp::model::SnssaiEasdfInfoItem> const& value);
    bool sNssaiEasdfInfoListIsSet() const;
    void unsetSNssaiEasdfInfoList();
    /// <summary>
    /// 
    /// </summary>
    std::vector<oai::_3gpp::model::IpAddr> getEasdfN6IpAddressList() const;
    void setEasdfN6IpAddressList(std::vector<oai::_3gpp::model::IpAddr> const& value);
    bool easdfN6IpAddressListIsSet() const;
    void unsetEasdfN6IpAddressList();
    /// <summary>
    /// 
    /// </summary>
    std::vector<oai::_3gpp::model::IpAddr> getUpfN6IpAddressList() const;
    void setUpfN6IpAddressList(std::vector<oai::_3gpp::model::IpAddr> const& value);
...
protected:
    std::vector<oai::_3gpp::model::SnssaiEasdfInfoItem> m_SNssaiEasdfInfoList;
    bool m_SNssaiEasdfInfoListIsSet;
    std::vector<oai::_3gpp::model::IpAddr> m_EasdfN6IpAddressList;
    bool m_EasdfN6IpAddressListIsSet;
    std::vector<oai::_3gpp::model::IpAddr> m_UpfN6IpAddressList;
