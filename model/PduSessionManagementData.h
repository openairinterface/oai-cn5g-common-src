...
public:
    ...
    /// 
    /// </summary>
    oai::model::PduSessionStatus getPduSessionStatus() const;
    void setPduSessionStatus(oai::model::PduSessionStatus const& value);
    ...
    /// 
    /// </summary>
    std::vector<oai::model::RouteToLocation> getN6TrafficRoutingInfo() const;
    void setN6TrafficRoutingInfo(std::vector<oai::model::RouteToLocation> const& value);
    ...
    /// UE IPv6 prefix.
    /// </summary>
    std::vector<oai::model::Ipv6Prefix> getIpv6Prefix() const;
    void setIpv6Prefix(std::vector<oai::model::Ipv6Prefix> const& value);
...
protected:
    oai::model::PduSessionStatus m_PduSessionStatus;
    ...
    std::string m_DnaiTs;
    bool m_DnaiTsIsSet;
    std::vector<oai::model::RouteToLocation> m_N6TrafficRoutingInfo;
    ...
    std::vector<oai::model::Ipv6Prefix> m_Ipv6Prefix;
