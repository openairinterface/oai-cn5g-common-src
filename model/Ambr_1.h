...
class Ambr_1 {
 public:
  ...
  bool operator==(const Ambr_1& rhs) const;
  bool operator!=(const Ambr_1& rhs) const;
  ...
  friend void to_json(nlohmann::json& j, const Ambr_1& o);
  friend void from_json(const nlohmann::json& j, Ambr_1& o);
