...
asn_TYPE_member_t asn_MBR_Ngap_FiveGProSePC5QoSFlowItem_1[] = {
    {ATF_NOFLAGS,
     0,
     offsetof(struct Ngap_FiveGProSePC5QoSFlowItem, fiveGproSepQI),
    ...
    {ATF_POINTER,
     3,
     offsetof(struct Ngap_FiveGProSePC5QoSFlowItem, fiveGproSepc5FlowBitRates),
    ...
    {ATF_POINTER,
     2,
     offsetof(struct Ngap_FiveGProSePC5QoSFlowItem, fiveGproSerange),
    ...
    {ATF_POINTER,
     1,
     offsetof(struct Ngap_FiveGProSePC5QoSFlowItem, iE_Extensions),
     (ASN_TAG_CLASS_CONTEXT | (3 << 2)),
     -1, /* IMPLICIT tag at current level */
     &asn_DEF_Ngap_ProtocolExtensionContainer_12929P90,
     0,
     {
#if !defined(ASN_DISABLE_OER_SUPPORT)
         0,
