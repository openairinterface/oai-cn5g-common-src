...
bool AmfSubscriptionInfo::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "AmfSubscriptionInfo" : pathPrefix;
...
void AmfSubscriptionInfo::setSubsChangeNotifyCorrelationId(std::string const& value)
{
...
oai::model::ContextInfo AmfSubscriptionInfo::getContextInfo() const
{
    return m_ContextInfo;
}
void AmfSubscriptionInfo::setContextInfo(oai::model::ContextInfo const& value)
{
    m_ContextInfo = value;
