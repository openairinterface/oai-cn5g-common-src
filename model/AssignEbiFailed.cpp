...
bool AssignEbiFailed::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "AssignEbiFailed" : pathPrefix;
...
std::vector<oai::model::Arp> AssignEbiFailed::getFailedArpList() const
{
    return m_FailedArpList;
}
void AssignEbiFailed::setFailedArpList(std::vector<oai::model::Arp> const& value)
{
