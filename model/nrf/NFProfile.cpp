...
std::string NFProfile::getNfType() const { return m_NfType; }
void NFProfile::setNfType(std::string const &value) { m_NfType = value; }
std::string NFProfile::getNfStatus() const { return m_NfStatus; }
void NFProfile::setNfStatus(std::string const &value) { m_NfStatus = value; }
...
std::vector<Snssai> NFProfile::getSNssais() const { return m_SNssais; }
...
std::vector<Snssai> &NFProfile::getAllowedNssais() { return m_AllowedNssais; }
...
std::vector<UdrInfo> &NFProfile::getUdrInfoExt() { return m_UdrInfoExt; }
void NFProfile::setUdrInfoExt(std::vector<UdrInfo> const &value) {
  m_UdrInfoExt = value;
  m_UdrInfoExtIsSet = true;
}
bool NFProfile::udrInfoExtIsSet() const { return m_UdrInfoExtIsSet; }
void NFProfile::unsetUdrInfoExt() { m_UdrInfoExtIsSet = false; }
...
std::vector<UdmInfo> &NFProfile::getUdmInfoExt() { return m_UdmInfoExt; }
void NFProfile::setUdmInfoExt(std::vector<UdmInfo> const &value) {
  m_UdmInfoExt = value;
  m_UdmInfoExtIsSet = true;
}
bool NFProfile::udmInfoExtIsSet() const { return m_UdmInfoExtIsSet; }
void NFProfile::unsetUdmInfoExt() { m_UdmInfoExtIsSet = false; }
...
std::vector<AusfInfo> &NFProfile::getAusfInfoExt() { return m_AusfInfoExt; }
void NFProfile::setAusfInfoExt(std::vector<AusfInfo> const &value) {
  m_AusfInfoExt = value;
  m_AusfInfoExtIsSet = true;
}
bool NFProfile::ausfInfoExtIsSet() const { return m_AusfInfoExtIsSet; }
void NFProfile::unsetAusfInfoExt() { m_AusfInfoExtIsSet = false; }
...
std::vector<AmfInfo> &NFProfile::getAmfInfoExt() { return m_AmfInfoExt; }
void NFProfile::setAmfInfoExt(std::vector<AmfInfo> const &value) {
  m_AmfInfoExt = value;
  m_AmfInfoExtIsSet = true;
}
bool NFProfile::amfInfoExtIsSet() const { return m_AmfInfoExtIsSet; }
void NFProfile::unsetAmfInfoExt() { m_AmfInfoExtIsSet = false; }
...
std::vector<SmfInfo> &NFProfile::getSmfInfoExt() { return m_SmfInfoExt; }
void NFProfile::setSmfInfoExt(std::vector<SmfInfo> const &value) {
  m_SmfInfoExt = value;
  m_SmfInfoExtIsSet = true;
}
bool NFProfile::smfInfoExtIsSet() const { return m_SmfInfoExtIsSet; }
void NFProfile::unsetSmfInfoExt() { m_SmfInfoExtIsSet = false; }
...
std::vector<UpfInfo> &NFProfile::getUpfInfoExt() { return m_UpfInfoExt; }
void NFProfile::setUpfInfoExt(std::vector<UpfInfo> const &value) {
  m_UpfInfoExt = value;
  m_UpfInfoExtIsSet = true;
}
bool NFProfile::upfInfoExtIsSet() const { return m_UpfInfoExtIsSet; }
void NFProfile::unsetUpfInfoExt() { m_UpfInfoExtIsSet = false; }
...
std::vector<PcfInfo> &NFProfile::getPcfInfoExt() { return m_PcfInfoExt; }
void NFProfile::setPcfInfoExt(std::vector<PcfInfo> const &value) {
  m_PcfInfoExt = value;
  m_PcfInfoExtIsSet = true;
}
bool NFProfile::pcfInfoExtIsSet() const { return m_PcfInfoExtIsSet; }
void NFProfile::unsetPcfInfoExt() { m_PcfInfoExtIsSet = false; }
...
std::vector<BsfInfo> &NFProfile::getBsfInfoExt() { return m_BsfInfoExt; }
void NFProfile::setBsfInfoExt(std::vector<BsfInfo> const &value) {
  m_BsfInfoExt = value;
  m_BsfInfoExtIsSet = true;
}
bool NFProfile::bsfInfoExtIsSet() const { return m_BsfInfoExtIsSet; }
void NFProfile::unsetBsfInfoExt() { m_BsfInfoExtIsSet = false; }
...
std::vector<ChfInfo> &NFProfile::getChfInfoExt() { return m_ChfInfoExt; }
void NFProfile::setChfInfoExt(std::vector<ChfInfo> const &value) {
  m_ChfInfoExt = value;
  m_ChfInfoExtIsSet = true;
}
bool NFProfile::chfInfoExtIsSet() const { return m_ChfInfoExtIsSet; }
void NFProfile::unsetChfInfoExt() { m_ChfInfoExtIsSet = false; }
...
nlohmann::json NFProfile::getCustomInfo() const { return m_CustomInfo; }
...
std::vector<NFService> NFProfile::getNfServices() const { return m_NfServices; }
