...
std::vector<oai::_3gpp::model::Tai> DccfCond::getTaiList() const
{
    return m_TaiList;
}
void DccfCond::setTaiList(std::vector<oai::_3gpp::model::Tai> const& value)
{
    m_TaiList = value;
    m_TaiListIsSet = true;
}
...
std::vector<oai::_3gpp::model::TaiRange> DccfCond::getTaiRangeList() const
{
    return m_TaiRangeList;
}
void DccfCond::setTaiRangeList(std::vector<oai::_3gpp::model::TaiRange> const& value)
{
...
std::vector<oai::_3gpp::model::NFType> DccfCond::getServingNfTypeList() const
{
    return m_ServingNfTypeList;
}
void DccfCond::setServingNfTypeList(std::vector<oai::_3gpp::model::NFType> const& value)
{
...
std::vector<oai::_3gpp::model::std::string> DccfCond::getServingNfSetIdList() const
{
    return m_ServingNfSetIdList;
}
void DccfCond::setServingNfSetIdList(std::vector<oai::_3gpp::model::std::string> const& value)
{
