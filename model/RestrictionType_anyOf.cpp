...
bool RestrictionType_anyOf::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "RestrictionType_anyOf" : pathPrefix;

    
    if (m_value == RestrictionType_anyOf::eRestrictionType_anyOf::INVALID_VALUE_OPENAPI_GENERATED)
    {
        success = false;
...
void to_json(nlohmann::json& j, const RestrictionType_anyOf& o)
{
    ...
    switch (o.getValue())
    {
        case RestrictionType_anyOf::eRestrictionType_anyOf::INVALID_VALUE_OPENAPI_GENERATED:
...
void from_json(const nlohmann::json& j, RestrictionType_anyOf& o)
{
    ...
    if (s == "ALLOWED_AREAS") {
     ...
     o.setValue(RestrictionType_anyOf::eRestrictionType_anyOf::NOT_ALLOWED_AREAS);
    }  else {
     std::stringstream ss;
...
RestrictionType_anyOf::eRestrictionType_anyOf RestrictionType_anyOf::getValue() const
{
    return m_value;
}
void RestrictionType_anyOf::setValue(RestrictionType_anyOf::eRestrictionType_anyOf value)
{
    m_value = value;
}
