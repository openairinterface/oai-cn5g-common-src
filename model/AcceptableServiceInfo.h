...
public:
    ...
    /// </summary>
    std::map<std::string, oai::model::MediaComponent> getAccBwMedComps() const;
    void setAccBwMedComps(std::map<std::string, oai::model::MediaComponent> const& value);
...
protected:
    std::map<std::string, oai::model::MediaComponent> m_AccBwMedComps;
