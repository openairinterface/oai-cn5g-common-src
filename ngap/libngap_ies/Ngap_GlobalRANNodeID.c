...
asn_oer_constraints_t asn_OER_type_Ngap_GlobalRANNodeID_constr_1 CC_NOTUSED = {
    {0, 0},
    -1};
...
asn_TYPE_member_t asn_MBR_Ngap_GlobalRANNodeID_1[] = {
    {ATF_POINTER,
     0,
     offsetof(struct Ngap_GlobalRANNodeID, choice.globalGNB_ID),
    ...
    {ATF_POINTER,
     0,
     offsetof(struct Ngap_GlobalRANNodeID, choice.globalNgENB_ID),
    ...
    {ATF_POINTER,
     0,
     offsetof(struct Ngap_GlobalRANNodeID, choice.globalN3IWF_ID),
    ...
    {ATF_POINTER,
     ...
     -1, /* IMPLICIT tag at current level */
     &asn_DEF_Ngap_ProtocolIE_SingleContainer_12877P16,
     0,
     {
#if !defined(ASN_DISABLE_OER_SUPPORT)
         0,
