...
bool ScheduledCommunicationTimeRm::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "ScheduledCommunicationTimeRm" : pathPrefix;
...
bool ScheduledCommunicationTimeRm::operator==(const ScheduledCommunicationTimeRm& rhs) const
{
    return
