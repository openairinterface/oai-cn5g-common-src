...
/* Implementation */
extern asn_oer_constraints_t asn_OER_type_Ngap_CellSize_constr_1;
...
cbor_type_decoder_f Ngap_CellSize_decode_cbor;
cbor_type_encoder_f Ngap_CellSize_encode_cbor;
