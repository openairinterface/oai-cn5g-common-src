...
bool NoProfileMatchInfo::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    ...
    {
        const std::vector<oai::model::QueryParamCombination>& value = m_QueryParamCombinationList;
        ...
        { // Recursive validation of array elements
            ...
            int i = 0;
            for (const oai::model::QueryParamCombination& value : value)
            { 
...
oai::model::NoProfileMatchReason NoProfileMatchInfo::getReason() const
{
    return m_Reason;
}
void NoProfileMatchInfo::setReason(oai::model::NoProfileMatchReason const& value)
{
    m_Reason = value;
}
std::vector<oai::model::QueryParamCombination> NoProfileMatchInfo::getQueryParamCombinationList() const
{
    return m_QueryParamCombinationList;
}
void NoProfileMatchInfo::setQueryParamCombinationList(std::vector<oai::model::QueryParamCombination> const& value)
{
