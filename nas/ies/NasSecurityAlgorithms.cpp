...
//------------------------------------------------------------------------------
NasSecurityAlgorithms::NasSecurityAlgorithms(uint8_t ciphering,
...
//------------------------------------------------------------------------------
void NasSecurityAlgorithms::Set(uint8_t ciphering,
                                uint8_t integrity_protection) {
  type_of_ciphering_algorithm_ = ciphering & 0x0f;
  type_of_integrity_protection_algorithm_ = integrity_protection & 0x0f;
}
...
//------------------------------------------------------------------------------
void NasSecurityAlgorithms::Get(uint8_t &ciphering,
...
//------------------------------------------------------------------------------
int NasSecurityAlgorithms::Decode(const uint8_t *const buf, int len,
                                  bool is_iei) {
