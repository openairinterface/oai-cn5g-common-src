...
public:
  ...
  ///
  /// </summary>
  oai::model::amf::N1MessageClass getN1MessageClass() const;
  void setN1MessageClass(oai::model::amf::N1MessageClass const &value);
  /// <summary>
  ///
  /// </summary>
...
protected:
  oai::model::amf::N1MessageClass m_N1MessageClass;
