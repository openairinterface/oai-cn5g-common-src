...
public:
    ...
    /// 
    /// </summary>
    oai::model::NotificationControl getNotifControl() const;
    void setNotifControl(oai::model::NotificationControl const& value);
    ...
    /// 
    /// </summary>
    std::vector<oai::model::AlternativeQosProfile> getAlternativeQosProfileList() const;
    void setAlternativeQosProfileList(std::vector<oai::model::AlternativeQosProfile> const& value);
...
protected:
    ...
    oai::model::NotificationControl m_NotifControl;
    ...
    std::vector<oai::model::AlternativeQosProfile> m_AlternativeQosProfileList;
