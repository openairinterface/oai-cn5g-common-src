...
std::vector<oai::_3gpp::model::SupiRange> NrfInfo_servedAusfInfo_value::getSupiRanges() const
{
    return m_SupiRanges;
}
void NrfInfo_servedAusfInfo_value::setSupiRanges(std::vector<oai::_3gpp::model::SupiRange> const& value)
{
    m_SupiRanges = value;
...
std::vector<oai::_3gpp::model::SuciInfo> NrfInfo_servedAusfInfo_value::getSuciInfos() const
{
    return m_SuciInfos;
}
void NrfInfo_servedAusfInfo_value::setSuciInfos(std::vector<oai::_3gpp::model::SuciInfo> const& value)
{
    m_SuciInfos = value;
