...
oai::model::AfSigProtocol MediaSubComponent::getAfSigProtocol() const
{
    return m_AfSigProtocol;
}
void MediaSubComponent::setAfSigProtocol(oai::model::AfSigProtocol const& value)
{
...
std::vector<oai::model::EthFlowDescription> MediaSubComponent::getEthfDescs() const
{
    return m_EthfDescs;
}
void MediaSubComponent::setEthfDescs(std::vector<oai::model::EthFlowDescription> const& value)
{
    m_EthfDescs = value;
...
oai::model::FlowStatus MediaSubComponent::getFStatus() const
{
    return m_FStatus;
}
void MediaSubComponent::setFStatus(oai::model::FlowStatus const& value)
{
    m_FStatus = value;
    m_FStatusIsSet = true;
}
...
oai::model::FlowUsage MediaSubComponent::getFlowUsage() const
{
    return m_FlowUsage;
}
void MediaSubComponent::setFlowUsage(oai::model::FlowUsage const& value)
{
    m_FlowUsage = value;
