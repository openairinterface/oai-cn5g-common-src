...
bool HorizontalWithVerticalVelocity::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "HorizontalWithVerticalVelocity" : pathPrefix;
...
bool HorizontalWithVerticalVelocity::operator==(const HorizontalWithVerticalVelocity& rhs) const
{
    return
...
oai::_3gpp::model::VerticalDirection HorizontalWithVerticalVelocity::getVDirection() const
{
    return m_VDirection;
}
void HorizontalWithVerticalVelocity::setVDirection(oai::_3gpp::model::VerticalDirection const& value)
{
    m_VDirection = value;
}
