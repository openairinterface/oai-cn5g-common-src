...
bool N1MessageContainer::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "N1MessageContainer" : pathPrefix;

        
    if (!m_N1MessageClass.validate(msg, _pathPrefix + ".n1MessageClass")) {
        msg << _pathPrefix << ": N1MessageClass is invalid;";
        success = false;
    }    
    if (!m_N1MessageContent.validate(msg, _pathPrefix + ".n1MessageContent")) {
        msg << _pathPrefix << ": N1MessageContent is invalid;";
        success = false;
    }        
    return success;
}
...
bool N1MessageContainer::operator==(const N1MessageContainer& rhs) const
{
    ...
    ((!serviceInstanceIdIsSet() && !rhs.serviceInstanceIdIsSet()) || (serviceInstanceIdIsSet() && rhs.serviceInstanceIdIsSet() && getServiceInstanceId() == rhs.getServiceInstanceId()))
...
oai::model::N1MessageClass N1MessageContainer::getN1MessageClass() const
{
    return m_N1MessageClass;
}
void N1MessageContainer::setN1MessageClass(oai::model::N1MessageClass const& value)
{
    m_N1MessageClass = value;
}
oai::model::RefToBinaryData N1MessageContainer::getN1MessageContent() const
{
    return m_N1MessageContent;
}
void N1MessageContainer::setN1MessageContent(oai::model::RefToBinaryData const& value)
{
