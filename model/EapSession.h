...
public:
    ...
    /// </summary>
    std::map<std::string, oai::model::LinksValueSchema> getLinks() const;
    void setLinks(std::map<std::string, oai::model::LinksValueSchema> const& value);
    bool linksIsSet() const;
    void unset_links();
    /// <summary>
    /// 
    /// </summary>
    oai::model::AuthResult getAuthResult() const;
    void setAuthResult(oai::model::AuthResult const& value);
...
protected:
    ...
    std::string m_KSeaf;
    bool m_KSeafIsSet;
    std::map<std::string, oai::model::LinksValueSchema> m__links;
    bool m__linksIsSet;
    oai::model::AuthResult m_AuthResult;
