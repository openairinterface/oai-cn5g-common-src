...
bool AppDetectionInfo::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    ...
    {
        const std::vector<oai::model::FlowInformation>& value = m_SdfDescriptions;
...
std::vector<oai::model::FlowInformation> AppDetectionInfo::getSdfDescriptions() const
{
    return m_SdfDescriptions;
}
void AppDetectionInfo::setSdfDescriptions(std::vector<oai::model::FlowInformation> const& value)
{
