...
public:
    ...
    /// 
    /// </summary>
    oai::model::SmContextConfiguration getSmContextConfig() const;
    void setSmContextConfig(oai::model::SmContextConfiguration const& value);
...
protected:
    ...
    oai::model::SmContextConfiguration m_SmContextConfig;
