...
bool ScheduledCommunicationTypeRm::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "ScheduledCommunicationTypeRm" : pathPrefix;

    
    return success;
}

bool ScheduledCommunicationTypeRm::operator==(const ScheduledCommunicationTypeRm& rhs) const
{
    return
