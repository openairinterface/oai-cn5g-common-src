...
bool PortManagementContainer::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "PortManagementContainer" : pathPrefix;
...
bool PortManagementContainer::operator==(const PortManagementContainer& rhs) const
{
    return
