...
public:
    ...
    void setFlowInfos(std::vector<oai::_3gpp::model::FlowInformation> const& value);
    ...
    void setDdNotifCtrl(oai::_3gpp::model::DownlinkDataNotificationControl const& value);
    ...
    void setDdNotifCtrl2(oai::_3gpp::model::DownlinkDataNotificationControlRm const& value);
