...
public:
    AssignEbiError();
    virtual ~AssignEbiError() = default;
    ...
    bool operator==(const AssignEbiError& rhs) const;
    bool operator!=(const AssignEbiError& rhs) const;
    ...
    /// 
    /// </summary>
    oai::model::AssignEbiFailed getFailureDetails() const;
    void setFailureDetails(oai::model::AssignEbiFailed const& value);
...
protected:
    ...
    oai::model::AssignEbiFailed m_FailureDetails;
