  ...
  if (ipv4IndexListIsSet()) {
    ...
    {  // Recursive validation of array elements
      ...
      for (const oai::_3gpp::model::IpIndex& value : value) {
        ...
        success =
            value.validate(msg, currentValuePath + ".ipv4IndexList") && success;
  ...
  if (ipv6IndexListIsSet()) {
    ...
    {  // Recursive validation of array elements
      ...
      for (const oai::_3gpp::model::IpIndex& value : value) {
        ...
        success =
            value.validate(msg, currentValuePath + ".ipv6IndexList") && success;
...
bool DnnUpfInfoItem::operator==(const DnnUpfInfoItem& rhs) const {
  return
      ...
      ((!ipv4IndexListIsSet() && !rhs.ipv4IndexListIsSet()) ||
       (ipv4IndexListIsSet() && rhs.ipv4IndexListIsSet() &&
        getIpv4IndexList() == rhs.getIpv4IndexList())) &&

      ((!ipv6IndexListIsSet() && !rhs.ipv6IndexListIsSet()) ||
       (ipv6IndexListIsSet() && rhs.ipv6IndexListIsSet() &&
        getIpv6IndexList() == rhs.getIpv6IndexList())) &&
...
DnnUpfInfoItem::getPduSessionTypes() const {
...
std::vector<oai::_3gpp::model::IpIndex> DnnUpfInfoItem::getIpv4IndexList()
    const {
  return m_Ipv4IndexList;
}
void DnnUpfInfoItem::setIpv4IndexList(
    std::vector<oai::_3gpp::model::IpIndex> const& value) {
...
std::vector<oai::_3gpp::model::IpIndex> DnnUpfInfoItem::getIpv6IndexList()
    const {
  return m_Ipv6IndexList;
}
void DnnUpfInfoItem::setIpv6IndexList(
    std::vector<oai::_3gpp::model::IpIndex> const& value) {
