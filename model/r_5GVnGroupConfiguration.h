...
public:
    ...
    /// 
    /// </summary>
    oai::model::r_5GVnGroupData getR5gVnGroupData() const;
    void setR5gVnGroupData(oai::model::r_5GVnGroupData const& value);
...
protected:
    oai::model::r_5GVnGroupData m_r_5gVnGroupData;
