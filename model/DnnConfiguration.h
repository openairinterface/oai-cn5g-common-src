...
public:
    ...
    void setStaticIpAddress(std::vector<oai::_3gpp::model::IpAddress> const& value);
    ...
    void setIpv4FrameRouteList(std::vector<oai::_3gpp::model::FrameRouteInfo> const& value);
    ...
    void setIpv6FrameRouteList(std::vector<oai::_3gpp::model::FrameRouteInfo> const& value);
    ...
    void setAdditionalDnAaaAddresses(std::vector<oai::_3gpp::model::IpAddress> const& value);
    ...
    /// 
    /// </summary>
    std::vector<oai::_3gpp::model::EcsAddrConfigInfo> getAdditionalEcsAddrConfigInfos() const;
    void setAdditionalEcsAddrConfigInfos(std::vector<oai::_3gpp::model::EcsAddrConfigInfo> const& value);
...
protected:
    ...
    std::vector<oai::_3gpp::model::EcsAddrConfigInfo> m_AdditionalEcsAddrConfigInfos;
