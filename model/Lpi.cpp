...
bool Lpi::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "Lpi" : pathPrefix;

        
    if (!m_LocationPrivacyInd.validate(msg, _pathPrefix + ".locationPrivacyInd")) {
        msg << _pathPrefix << ": LocationPrivacyInd is invalid;";
        success = false;
    }    
    return success;
}
...
oai::model::LocationPrivacyInd Lpi::getLocationPrivacyInd() const
{
    return m_LocationPrivacyInd;
}
void Lpi::setLocationPrivacyInd(oai::model::LocationPrivacyInd const& value)
{
    m_LocationPrivacyInd = value;
}
oai::model::ValidTimePeriod Lpi::getValidTimePeriod() const
{
    return m_ValidTimePeriod;
}
void Lpi::setValidTimePeriod(oai::model::ValidTimePeriod const& value)
{
