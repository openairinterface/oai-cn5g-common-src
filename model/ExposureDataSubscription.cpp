...
bool ExposureDataSubscription::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "ExposureDataSubscription" : pathPrefix;
...
bool ExposureDataSubscription::operator==(const ExposureDataSubscription& rhs) const
{
    return
...
std::vector<oai::_3gpp::model::std::string> ExposureDataSubscription::getMonitoredResourceUris() const
{
    return m_MonitoredResourceUris;
}
void ExposureDataSubscription::setMonitoredResourceUris(std::vector<oai::_3gpp::model::std::string> const& value)
{
...
void ExposureDataSubscription::setResetIds(std::vector<std::string> const& value)
{
    m_ResetIds = value;
