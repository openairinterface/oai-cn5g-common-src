...
public:
    ...
    /// 
    /// </summary>
    oai::model::MatchingOperator getMatchingOperator() const;
    void setMatchingOperator(oai::model::MatchingOperator const& value);
...
protected:
    ...
    oai::model::MatchingOperator m_MatchingOperator;
