...
bool QosCharacteristics::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "QosCharacteristics" : pathPrefix;
...
bool QosCharacteristics::operator==(const QosCharacteristics& rhs) const
{
    ...
    ((!averagingWindowIsSet() && !rhs.averagingWindowIsSet()) || (averagingWindowIsSet() && rhs.averagingWindowIsSet() && getAveragingWindow() == rhs.getAveragingWindow())) &&
...
oai::model::QosResourceType QosCharacteristics::getResourceType() const
{
    return m_ResourceType;
}
void QosCharacteristics::setResourceType(oai::model::QosResourceType const& value)
{
