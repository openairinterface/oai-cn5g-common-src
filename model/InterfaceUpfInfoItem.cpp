...
oai::_3gpp::model::UPInterfaceType InterfaceUpfInfoItem::getInterfaceType() const
{
    return m_InterfaceType;
}
void InterfaceUpfInfoItem::setInterfaceType(oai::_3gpp::model::UPInterfaceType const& value)
{
...
std::vector<oai::_3gpp::model::Ipv6Addr> InterfaceUpfInfoItem::getIpv6EndpointAddresses() const
{
    return m_Ipv6EndpointAddresses;
}
void InterfaceUpfInfoItem::setIpv6EndpointAddresses(std::vector<oai::_3gpp::model::Ipv6Addr> const& value)
{
