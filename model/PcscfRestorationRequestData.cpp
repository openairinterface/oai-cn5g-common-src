...
bool PcscfRestorationRequestData::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "PcscfRestorationRequestData" : pathPrefix;
...
bool PcscfRestorationRequestData::operator==(const PcscfRestorationRequestData& rhs) const
{
    return
...
oai::_3gpp::model::Snssai PcscfRestorationRequestData::getSliceInfo() const
{
    return m_SliceInfo;
}
void PcscfRestorationRequestData::setSliceInfo(oai::_3gpp::model::Snssai const& value)
{
    m_SliceInfo = value;
...
oai::_3gpp::model::Ipv6Addr PcscfRestorationRequestData::getUeIpv6() const
{
    return m_UeIpv6;
}
void PcscfRestorationRequestData::setUeIpv6(oai::_3gpp::model::Ipv6Addr const& value)
{
    m_UeIpv6 = value;
    m_UeIpv6IsSet = true;
}
