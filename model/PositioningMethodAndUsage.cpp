...
bool PositioningMethodAndUsage::operator==(const PositioningMethodAndUsage& rhs) const
{
    ...
    ((!methodCodeIsSet() && !rhs.methodCodeIsSet()) || (methodCodeIsSet() && rhs.methodCodeIsSet() && getMethodCode() == rhs.getMethodCode()))
...
oai::model::PositioningMethod PositioningMethodAndUsage::getMethod() const
{
    return m_Method;
}
void PositioningMethodAndUsage::setMethod(oai::model::PositioningMethod const& value)
{
    m_Method = value;
}
oai::model::PositioningMode PositioningMethodAndUsage::getMode() const
{
    return m_Mode;
}
void PositioningMethodAndUsage::setMode(oai::model::PositioningMode const& value)
{
    m_Mode = value;
}
oai::model::Usage PositioningMethodAndUsage::getUsage() const
{
    return m_Usage;
}
void PositioningMethodAndUsage::setUsage(oai::model::Usage const& value)
{
    m_Usage = value;
}
