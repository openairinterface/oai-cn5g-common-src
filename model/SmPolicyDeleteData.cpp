...
bool SmPolicyDeleteData::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "SmPolicyDeleteData" : pathPrefix;
...
bool SmPolicyDeleteData::operator==(const SmPolicyDeleteData& rhs) const
{
    ...
    ((!pduSessRelCauseIsSet() && !rhs.pduSessRelCauseIsSet()) || (pduSessRelCauseIsSet() && rhs.pduSessRelCauseIsSet() && getPduSessRelCause() == rhs.getPduSessRelCause()))
...
oai::_3gpp::model::UserLocation SmPolicyDeleteData::getUserLocationInfo() const
{
    return m_UserLocationInfo;
}
void SmPolicyDeleteData::setUserLocationInfo(oai::_3gpp::model::UserLocation const& value)
{
...
oai::_3gpp::model::PlmnIdNid SmPolicyDeleteData::getServingNetwork() const
{
    return m_ServingNetwork;
}
void SmPolicyDeleteData::setServingNetwork(oai::_3gpp::model::PlmnIdNid const& value)
{
...
std::vector<oai::_3gpp::model::RanNasRelCause> SmPolicyDeleteData::getRanNasRelCauses() const
{
    return m_RanNasRelCauses;
}
void SmPolicyDeleteData::setRanNasRelCauses(std::vector<oai::_3gpp::model::RanNasRelCause> const& value)
{
...
std::vector<oai::_3gpp::model::AccuUsageReport> SmPolicyDeleteData::getAccuUsageReports() const
{
    return m_AccuUsageReports;
}
void SmPolicyDeleteData::setAccuUsageReports(std::vector<oai::_3gpp::model::AccuUsageReport> const& value)
{
...
oai::_3gpp::model::PduSessionRelCause SmPolicyDeleteData::getPduSessRelCause() const
{
    return m_PduSessRelCause;
}
void SmPolicyDeleteData::setPduSessRelCause(oai::_3gpp::model::PduSessionRelCause const& value)
{
