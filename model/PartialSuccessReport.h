...
public:
    ...
    /// 
    /// </summary>
    oai::model::FailureCause getFailureCause() const;
    void setFailureCause(oai::model::FailureCause const& value);
    /// <summary>
    ...
    /// 
    /// </summary>
    oai::model::UeCampingRep getUeCampingRep() const;
    void setUeCampingRep(oai::model::UeCampingRep const& value);
...
protected:
    oai::model::FailureCause m_FailureCause;
    ...
    oai::model::UeCampingRep m_UeCampingRep;
