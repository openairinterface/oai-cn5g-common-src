...
static int memb_Ngap_pDUSessionResourceModifyUnsuccessfulTransfer_constraint_1(
...
asn_TYPE_member_t asn_MBR_Ngap_PDUSessionResourceFailedToModifyItemModRes_1[] = {
    {ATF_NOFLAGS,
     0,
     offsetof(
         struct Ngap_PDUSessionResourceFailedToModifyItemModRes, pDUSessionID),
...
static const int
    asn_MAP_Ngap_PDUSessionResourceFailedToModifyItemModRes_oms_1[] = {2};
...
static const asn_TYPE_tag2member_t
    asn_MAP_Ngap_PDUSessionResourceFailedToModifyItemModRes_tag2el_1[] = {
        ...
        {(ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0,
         0}, /* pDUSessionResourceModifyUnsuccessfulTransfer */
...
asn_SEQUENCE_specifics_t
    asn_SPC_Ngap_PDUSessionResourceFailedToModifyItemModRes_specs_1 = {
        ...
        offsetof(
            struct Ngap_PDUSessionResourceFailedToModifyItemModRes, _asn_ctx),
        asn_MAP_Ngap_PDUSessionResourceFailedToModifyItemModRes_tag2el_1,
        3, /* Count of tags in the map */
        asn_MAP_Ngap_PDUSessionResourceFailedToModifyItemModRes_oms_1, /* Optional
                                                                          members
                                                                        */
        1,
        0, /* Root/Additions */
