...
bool PolicyDataChangeNotification::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    ...
    {
        const std::map<std::string, oai::_3gpp::model::OperatorSpecificDataContainer>& value = m_OpSpecDataMap;
    ...
    {
        const std::vector<oai::_3gpp::model::std::string>& value = m_DelResources;
    ...
    {
        const std::vector<oai::_3gpp::model::NotificationItem>& value = m_ReportedFragments;
...
oai::_3gpp::model::AmPolicyData PolicyDataChangeNotification::getAmPolicyData() const
{
    return m_AmPolicyData;
}
void PolicyDataChangeNotification::setAmPolicyData(oai::_3gpp::model::AmPolicyData const& value)
{
...
oai::_3gpp::model::UePolicySet PolicyDataChangeNotification::getUePolicySet() const
{
    return m_UePolicySet;
}
void PolicyDataChangeNotification::setUePolicySet(oai::_3gpp::model::UePolicySet const& value)
{
    m_UePolicySet = value;
...
oai::_3gpp::model::UePolicySet PolicyDataChangeNotification::getPlmnUePolicySet() const
{
    return m_PlmnUePolicySet;
}
void PolicyDataChangeNotification::setPlmnUePolicySet(oai::_3gpp::model::UePolicySet const& value)
{
...
oai::_3gpp::model::SmPolicyData PolicyDataChangeNotification::getSmPolicyData() const
{
    return m_SmPolicyData;
}
void PolicyDataChangeNotification::setSmPolicyData(oai::_3gpp::model::SmPolicyData const& value)
{
...
oai::_3gpp::model::UsageMonData PolicyDataChangeNotification::getUsageMonData() const
{
    return m_UsageMonData;
}
void PolicyDataChangeNotification::setUsageMonData(oai::_3gpp::model::UsageMonData const& value)
{
...
oai::_3gpp::model::SponsorConnectivityData PolicyDataChangeNotification::getSponsorConnectivityData() const
{
    return m_SponsorConnectivityData;
}
void PolicyDataChangeNotification::setSponsorConnectivityData(oai::_3gpp::model::SponsorConnectivityData const& value)
{
...
void PolicyDataChangeNotification::setBdtData(oai::_3gpp::model::BdtData const& value)
{
    m_BdtData = value;
    m_BdtDataIsSet = true;
}
...
oai::_3gpp::model::OperatorSpecificDataContainer PolicyDataChangeNotification::getOpSpecData() const
{
    return m_OpSpecData;
}
void PolicyDataChangeNotification::setOpSpecData(oai::_3gpp::model::OperatorSpecificDataContainer const& value)
{
    m_OpSpecData = value;
...
std::map<std::string, oai::_3gpp::model::OperatorSpecificDataContainer> PolicyDataChangeNotification::getOpSpecDataMap() const
{
    return m_OpSpecDataMap;
}
void PolicyDataChangeNotification::setOpSpecDataMap(std::map<std::string, oai::_3gpp::model::OperatorSpecificDataContainer> const& value)
{
...
void PolicyDataChangeNotification::setPlmnId(oai::_3gpp::model::PlmnId_1 const& value)
{
    m_PlmnId = value;
    m_PlmnIdIsSet = true;
}
...
std::vector<oai::_3gpp::model::std::string> PolicyDataChangeNotification::getDelResources() const
{
    return m_DelResources;
}
void PolicyDataChangeNotification::setDelResources(std::vector<oai::_3gpp::model::std::string> const& value)
{
...
std::vector<oai::_3gpp::model::NotificationItem> PolicyDataChangeNotification::getReportedFragments() const
{
    return m_ReportedFragments;
}
void PolicyDataChangeNotification::setReportedFragments(std::vector<oai::_3gpp::model::NotificationItem> const& value)
{
...
oai::_3gpp::model::SlicePolicyData PolicyDataChangeNotification::getSlicePolicyData() const
{
    return m_SlicePolicyData;
}
void PolicyDataChangeNotification::setSlicePolicyData(oai::_3gpp::model::SlicePolicyData const& value)
{
...
void PolicyDataChangeNotification::setSnssai(oai::_3gpp::model::Snssai const& value)
{
    m_Snssai = value;
    m_SnssaiIsSet = true;
}
