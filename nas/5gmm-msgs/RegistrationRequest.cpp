...
uint32_t RegistrationRequest::GetLength() const {
  ...
  if (ie_ue_status_.has_value())
    msg_len += ie_ue_status_.value().GetIeLength();
...
//------------------------------------------------------------------------------
void RegistrationRequest::SetSuciSupiFormatImsi(const std::string &mcc,
  ...
  if (protection_sch_id != kNullScheme) {
    ...
    ie_5gs_mobile_identity_.SetSuciWithSupiImsi(mcc, mnc, routing_ind,
...
std::string RegistrationRequest::Get5gGuti() const {
  ...
  oai::utils::conv::get_amf_id(guti.value().amf_region_id,
                               guti.value().amf_set_id,
...
void RegistrationRequest::SetAdditionalGuti(
  ...
  ie_additional_guti_tmp.Set5gGuti(mcc, mnc, amf_region_id, amf_set_id,
                                   amf_pointer, tmsi);
  ie_additional_guti_ =
...
//------------------------------------------------------------------------------
void RegistrationRequest::SetNonCurrentNativeNasKSI(uint8_t tsc,
                                                    uint8_t key_set_id) {
...
//------------------------------------------------------------------------------
void RegistrationRequest::SetUeSecurityCapability(uint8_t ea, uint8_t ia,
                                                  uint8_t eea, uint8_t eia) {
  ie_ue_security_capability_ = std::make_optional<UeSecurityCapability>(
      kIeiUeSecurityCapability, ea, ia, eea, eia);
}

//------------------------------------------------------------------------------
bool RegistrationRequest::GetUeSecurityCapability(uint8_t &ea,
                                                  uint8_t &ia) const {
  if (ie_ue_security_capability_.has_value()) {
...
//------------------------------------------------------------------------------
void RegistrationRequest::SetLastVisitedRegisteredTai(const std::string &mcc,
                                                      const std::string &mnc,
                                                      uint32_t tac) {
...
//------------------------------------------------------------------------------
bool RegistrationRequest::GetS1UeNetworkCapability(uint8_t &eea,
                                                   uint8_t &eia) const {
  if (ie_s1_ue_network_capability_.has_value()) {
...
//------------------------------------------------------------------------------
bool RegistrationRequest::GetMicoIndication(uint8_t &sprti,
                                            uint8_t &raai) const {
  if (ie_mico_indication_.has_value()) {
...
//------------------------------------------------------------------------------
bool RegistrationRequest::GetUeStatus(uint8_t &n1_mode,
                                      uint8_t &s1_mode) const {
  if (ie_ue_status_.has_value()) {
...
//------------------------------------------------------------------------------
void RegistrationRequest::Set5gsUpdateType(uint8_t eps_pnb_ciot,
                                           uint8_t _5gs_pnb_ciot, bool ng_ran,
                                           bool sms) {
...
int RegistrationRequest::Encode(uint8_t *buf, int len) {
  ...
  // 5GS Mobile Identity
  if ((encoded_ie_size = NasHelper::Encode(ie_5gs_mobile_identity_, buf, len,
                                           encoded_size)) ==
      KEncodeDecodeError) {
    return KEncodeDecodeError;
  }
  ...
  if ((encoded_ie_size = NasHelper::Encode(ie_non_current_native_nas_ksi_, buf,
                                           len, encoded_size)) ==
      KEncodeDecodeError) {
    return KEncodeDecodeError;
  }
  ...
  if ((encoded_ie_size = NasHelper::Encode(ie_ue_security_capability_, buf, len,
                                           encoded_size)) ==
      KEncodeDecodeError) {
    return KEncodeDecodeError;
  }
  ...
  if ((encoded_ie_size = NasHelper::Encode(ie_last_visited_registered_tai_, buf,
                                           len, encoded_size)) ==
      KEncodeDecodeError) {
    return KEncodeDecodeError;
  }
  ...
  if ((encoded_ie_size = NasHelper::Encode(ie_s1_ue_network_capability_, buf,
                                           len, encoded_size)) ==
      KEncodeDecodeError) {
    return KEncodeDecodeError;
  }
  ...
  if ((encoded_ie_size = NasHelper::Encode(ie_allowed_pdu_session_status_, buf,
                                           len, encoded_size)) ==
      KEncodeDecodeError) {
    return KEncodeDecodeError;
  }
  ...
  if ((encoded_ie_size = NasHelper::Encode(ie_eps_nas_message_container_, buf,
                                           len, encoded_size)) ==
      KEncodeDecodeError) {
    return KEncodeDecodeError;
  }
  ...
  if ((encoded_ie_size = NasHelper::Encode(ie_nas_message_container_, buf, len,
                                           encoded_size)) ==
      KEncodeDecodeError) {
    return KEncodeDecodeError;
  }
...
int RegistrationRequest::Decode(uint8_t *buf, int len) {
  ...
  decoded_ie_size = NasHelper::Decode(ie_5gs_registration_type_, buf, len,
                                      decoded_size, false);
  if ((decoded_ie_size == KEncodeDecodeError) or (decoded_ie_size != 0)) {
    return KEncodeDecodeError;
  }
  decoded_ie_size = NasHelper::Decode(ie_ng_ksi_, buf, len, decoded_size, true,
  ...
  if ((decoded_ie_size = NasHelper::Decode(ie_5gs_mobile_identity_, buf, len,
                                           decoded_size, false)) ==
      KEncodeDecodeError) {
    return KEncodeDecodeError;
  }
  ...
  while ((octet != 0x0)) {
    ...
    case kIeiNasKeySetIdentifier: {
      ...
      if ((decoded_ie_size = NasHelper::Decode(ie_non_current_native_nas_ksi_,
                                               buf, len, decoded_size, false,
    ...
    case kIeiPayloadContainerType: {
      ...
      if ((decoded_ie_size = NasHelper::Decode(ie_payload_container_type_, buf,
    ...
    case kIei5gmmCapability: {
      oai::logger::logger_common::nas().debug("Decoding IEI 0x%x",
                                              kIei5gmmCapability);
      if ((decoded_ie_size = NasHelper::Decode(ie_5g_mm_capability_, buf, len,
                                               decoded_size, true)) ==
          KEncodeDecodeError) {
        return KEncodeDecodeError;
      }
    ...
    case kIeiUeSecurityCapability: {
      ...
      if ((decoded_ie_size = NasHelper::Decode(ie_ue_security_capability_, buf,
                                               len, decoded_size, true)) ==
          KEncodeDecodeError) {
        return KEncodeDecodeError;
      }
    ...
    case kIeiNSSAIRequested: {
      oai::logger::logger_common::nas().debug("Decoding IEI %d",
                                              kIeiNSSAIRequested);
      if ((decoded_ie_size = NasHelper::Decode(ie_requested_nssai_, buf, len,
                                               decoded_size, true)) ==
          KEncodeDecodeError) {
        return KEncodeDecodeError;
      }
    ...
    case kIei5gsTrackingAreaIdentity: {
      ...
      if ((decoded_ie_size = NasHelper::Decode(ie_last_visited_registered_tai_,
                                               buf, len, decoded_size, true)) ==
          KEncodeDecodeError) {
        return KEncodeDecodeError;
      }
    ...
    case kIeiUeNetworkCapability: {
      ...
      if ((decoded_ie_size = NasHelper::Decode(ie_s1_ue_network_capability_,
                                               buf, len, decoded_size, true)) ==
          KEncodeDecodeError) {
        return KEncodeDecodeError;
      }
    ...
    case kIeiUplinkDataStatus: {
      ...
      if ((decoded_ie_size = NasHelper::Decode(ie_uplink_data_status_, buf, len,
                                               decoded_size, true)) ==
          KEncodeDecodeError) {
        return KEncodeDecodeError;
      }
    ...
    case kIeiUeStatus: {
      oai::logger::logger_common::nas().debug("Decoding IEI 0x%x",
                                              kIeiUeStatus);
      if ((decoded_ie_size = NasHelper::Decode(ie_ue_status_, buf, len,
                                               decoded_size, true)) ==
          KEncodeDecodeError) {
        return KEncodeDecodeError;
      }
    ...
    case kIei5gGuti: {
      ...
      if ((decoded_ie_size = NasHelper::Decode(ie_additional_guti_, buf, len,
                                               decoded_size, true)) ==
          KEncodeDecodeError) {
        return KEncodeDecodeError;
      }
    ...
    case kIeiAllowedPduSessionStatus: {
      ...
      if ((decoded_ie_size = NasHelper::Decode(ie_allowed_pdu_session_status_,
                                               buf, len, decoded_size, true)) ==
          KEncodeDecodeError) {
        return KEncodeDecodeError;
      }
    ...
    case kIeiUeUsageSetting: {
      oai::logger::logger_common::nas().debug("Decoding IEI 0x%x",
                                              kIeiUeUsageSetting);
      if ((decoded_ie_size = NasHelper::Decode(ie_ues_usage_setting_, buf, len,
                                               decoded_size, true)) ==
          KEncodeDecodeError) {
        return KEncodeDecodeError;
      }
    ...
    case kIei5gsDrxParameters: {
      ...
      if ((decoded_ie_size = NasHelper::Decode(ie_5gs_drx_parameters_, buf, len,
                                               decoded_size, true)) ==
          KEncodeDecodeError) {
        return KEncodeDecodeError;
      }
    ...
    case kIeiEpsNasMessageContainer: {
      ...
      if ((decoded_ie_size = NasHelper::Decode(ie_eps_nas_message_container_,
                                               buf, len, decoded_size, true)) ==
          KEncodeDecodeError) {
        return KEncodeDecodeError;
      }
    ...
    case kIeiLadnIndication: {
      oai::logger::logger_common::nas().debug("Decoding IEI 0x%x",
                                              kIeiLadnIndication);
      if ((decoded_ie_size = NasHelper::Decode(ie_ladn_indication_, buf, len,
                                               decoded_size, true)) ==
          KEncodeDecodeError) {
        return KEncodeDecodeError;
      }
    ...
    case 0x53: {
      oai::logger::logger_common::nas().debug("Decoding IEI 0x%x",
                                              kIei5gsUpdateType);
      if ((decoded_ie_size = NasHelper::Decode(ie_5gs_update_type_, buf, len,
                                               decoded_size, true)) ==
          KEncodeDecodeError) {
        return KEncodeDecodeError;
      }
    ...
    case kIeiNasMessageContainer: {
      ...
      if ((decoded_ie_size = NasHelper::Decode(ie_nas_message_container_, buf,
                                               len, decoded_size, true)) ==
          KEncodeDecodeError) {
        return KEncodeDecodeError;
      }
