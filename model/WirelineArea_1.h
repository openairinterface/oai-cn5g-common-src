...
#ifndef WirelineArea_1_H_
#define WirelineArea_1_H_
...
/// included in a WirelineArea data structure
/// </summary>
class WirelineArea_1 {
 public:
  WirelineArea_1();
  virtual ~WirelineArea_1() = default;
  ...
  bool operator==(const WirelineArea_1& rhs) const;
  bool operator!=(const WirelineArea_1& rhs) const;

  /////////////////////////////////////////////
  /// WirelineArea_1 members
  ...
  friend void to_json(nlohmann::json& j, const WirelineArea_1& o);
  friend void from_json(const nlohmann::json& j, WirelineArea_1& o);
