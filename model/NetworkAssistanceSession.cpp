...
bool NetworkAssistanceSession::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    ...
    /* ServiceDataFlowDescriptions */ {
        const std::vector<oai::model::ServiceDataFlowDescription>& value = m_ServiceDataFlowDescriptions;
        ...
        { // Recursive validation of array elements
            ...
            int i = 0;
            for (const oai::model::ServiceDataFlowDescription& value : value)
            { 
...
std::vector<oai::model::ServiceDataFlowDescription> NetworkAssistanceSession::getServiceDataFlowDescriptions() const
{
    return m_ServiceDataFlowDescriptions;
}
void NetworkAssistanceSession::setServiceDataFlowDescriptions(std::vector<oai::model::ServiceDataFlowDescription> const& value)
{
    m_ServiceDataFlowDescriptions = value;
}
oai::model::MediaType NetworkAssistanceSession::getMediaType() const
{
    return m_MediaType;
}
void NetworkAssistanceSession::setMediaType(oai::model::MediaType const& value)
{
    m_MediaType = value;
...
oai::model::M5QoSSpecification NetworkAssistanceSession::getRequestedQoS() const
{
    return m_RequestedQoS;
}
void NetworkAssistanceSession::setRequestedQoS(oai::model::M5QoSSpecification const& value)
{
...
oai::model::M5QoSSpecification NetworkAssistanceSession::getRecommendedQoS() const
{
    return m_RecommendedQoS;
}
void NetworkAssistanceSession::setRecommendedQoS(oai::model::M5QoSSpecification const& value)
{
