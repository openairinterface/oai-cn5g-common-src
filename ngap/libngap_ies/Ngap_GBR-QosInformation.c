...
asn_TYPE_member_t asn_MBR_Ngap_GBR_QosInformation_1[] = {
    {ATF_NOFLAGS,
     0,
     offsetof(struct Ngap_GBR_QosInformation, maximumFlowBitRateDL),
    ...
    {ATF_NOFLAGS,
     0,
     offsetof(struct Ngap_GBR_QosInformation, maximumFlowBitRateUL),
    ...
    {ATF_NOFLAGS,
     0,
     offsetof(struct Ngap_GBR_QosInformation, guaranteedFlowBitRateDL),
    ...
    {ATF_NOFLAGS,
     0,
     offsetof(struct Ngap_GBR_QosInformation, guaranteedFlowBitRateUL),
    ...
    {ATF_POINTER,
     4,
     offsetof(struct Ngap_GBR_QosInformation, notificationControl),
    ...
    {ATF_POINTER,
     3,
     offsetof(struct Ngap_GBR_QosInformation, maximumPacketLossRateDL),
    ...
    {ATF_POINTER,
     2,
     offsetof(struct Ngap_GBR_QosInformation, maximumPacketLossRateUL),
    ...
    {ATF_POINTER,
     1,
     offsetof(struct Ngap_GBR_QosInformation, iE_Extensions),
     (ASN_TAG_CLASS_CONTEXT | (7 << 2)),
     -1, /* IMPLICIT tag at current level */
     &asn_DEF_Ngap_ProtocolExtensionContainer_12929P96,
     0,
     {
#if !defined(ASN_DISABLE_OER_SUPPORT)
         0,
