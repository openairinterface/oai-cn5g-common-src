...
public:
    ...
    /// 
    /// </summary>
    oai::_3gpp::model::SmPolicyDecision getSmPolicyDecision() const;
    void setSmPolicyDecision(oai::_3gpp::model::SmPolicyDecision const& value);
...
protected:
    ...
    oai::_3gpp::model::SmPolicyDecision m_SmPolicyDecision;
