...
/* Implementation */
extern asn_oer_constraints_t asn_OER_type_Ngap_AMFPointer_constr_1;
...
cbor_type_decoder_f Ngap_AMFPointer_decode_cbor;
cbor_type_encoder_f Ngap_AMFPointer_encode_cbor;
