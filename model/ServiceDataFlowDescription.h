...
public:
    ...
    /// 
    /// </summary>
    oai::model::IpPacketFilterSet getFlowDescription() const;
    void setFlowDescription(oai::model::IpPacketFilterSet const& value);
...
protected:
    oai::model::IpPacketFilterSet m_FlowDescription;
