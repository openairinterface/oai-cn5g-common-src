...
uint32_t RegistrationAccept::GetLength() const {
  ...
  if (ie_5g_guti_.has_value())
    msg_len += ie_5g_guti_.value().GetIeLength();
  if (ie_equivalent_plmns_.has_value())
    msg_len += ie_equivalent_plmns_.value().GetIeLength();
  if (ie_tai_list_.has_value())
    msg_len += ie_tai_list_.value().GetIeLength();
...
//------------------------------------------------------------------------------
void RegistrationAccept::Set5gsRegistrationResult(bool emergency, bool nssaa,
                                                  bool sms, uint8_t value) {
  ie_5gs_registration_result_.Set(emergency, nssaa, sms, value);
}

//------------------------------------------------------------------------------
void RegistrationAccept::SetSuciSupiFormatImsi(const std::string &mcc,
  ...
  if (protection_sch_id != kNullScheme) {
    ...
    ie_5g_guti_tmp.SetSuciWithSupiImsi(mcc, mnc, routing_ind, protection_sch_id,
                                       msin);
...
//------------------------------------------------------------------------------
void RegistrationAccept::Set5gGuti(const std::string &mcc,
                                   const std::string &mnc,
                                   uint8_t amf_region_id, uint16_t amf_set_id,
                                   uint8_t amf_pointer, uint32_t tmsi) {
  _5gsMobileIdentity ie_5g_guti_tmp = {};
  ie_5g_guti_tmp.SetIei(kIei5gGuti);
  ie_5g_guti_tmp.Set5gGuti(mcc, mnc, amf_region_id, amf_set_id, amf_pointer,
                           tmsi);
  ie_5g_guti_ = std::optional<_5gsMobileIdentity>(ie_5g_guti_tmp);
}
...
//------------------------------------------------------------------------------
void RegistrationAccept::Set5gsNetworkFeatureSupport(uint8_t value,
                                                     uint8_t value2) {
...
void RegistrationAccept::SetPduSessionReactivationResultErrorCause(
  ...
  ie_pdu_session_reactivation_result_error_cause_ =
      std::make_optional<PduSessionReactivationResultErrorCause>(session_id,
                                                                 value);
}
...
//------------------------------------------------------------------------------
void RegistrationAccept::SetExtendedDrxParameters(uint8_t paging_time,
                                                  uint8_t value) {
...
int RegistrationAccept::Encode(uint8_t *buf, int len) {
  ...
  if ((encoded_ie_size = NasHelper::Encode(ie_5gs_registration_result_, buf,
                                           len, encoded_size)) ==
      KEncodeDecodeError) {
    return KEncodeDecodeError;
  }
  ...
  if ((encoded_ie_size = NasHelper::Encode(ie_5gs_network_feature_support_, buf,
                                           len, encoded_size)) ==
      KEncodeDecodeError) {
    return KEncodeDecodeError;
  }
  ...
  if ((encoded_ie_size = NasHelper::Encode(ie_pdu_session_reactivation_result_,
  ...
  if ((encoded_ie_size =
           NasHelper::Encode(ie_pdu_session_reactivation_result_error_cause_,
  ...
  if ((encoded_ie_size = NasHelper::Encode(ie_network_slicing_indication_, buf,
                                           len, encoded_size)) ==
      KEncodeDecodeError) {
    return KEncodeDecodeError;
  }
  ...
  if ((encoded_ie_size =
           NasHelper::Encode(ie_non_3gpp_deregistration_timer_value_, buf, len,
  ...
  if ((encoded_ie_size = NasHelper::Encode(ie_sor_transparent_container_, buf,
                                           len, encoded_size)) ==
      KEncodeDecodeError) {
    return KEncodeDecodeError;
  }
  ...
  if ((encoded_ie_size = NasHelper::Encode(ie_nssai_inclusion_mode_, buf, len,
                                           encoded_size)) ==
      KEncodeDecodeError) {
    return KEncodeDecodeError;
  }

  if ((encoded_ie_size = NasHelper::Encode(ie_negotiated_drx_parameters_, buf,
                                           len, encoded_size)) ==
      KEncodeDecodeError) {
    return KEncodeDecodeError;
  }

  if ((encoded_ie_size = NasHelper::Encode(ie_non_3gpp_nw_policies_, buf, len,
                                           encoded_size)) ==
      KEncodeDecodeError) {
    return KEncodeDecodeError;
  }

  if ((encoded_ie_size = NasHelper::Encode(ie_eps_bearer_context_status_, buf,
                                           len, encoded_size)) ==
      KEncodeDecodeError) {
    return KEncodeDecodeError;
  }

  if ((encoded_ie_size = NasHelper::Encode(ie_extended_drx_parameters_, buf,
                                           len, encoded_size)) ==
      KEncodeDecodeError) {
    return KEncodeDecodeError;
  }
  ...
  if ((encoded_ie_size = NasHelper::Encode(ie_ue_radio_capability_id_, buf, len,
                                           encoded_size)) ==
      KEncodeDecodeError) {
    return KEncodeDecodeError;
  }
...
int RegistrationAccept::Decode(uint8_t *buf, int len) {
  ...
  if ((decoded_ie_size = NasHelper::Decode(ie_5gs_registration_result_, buf,
  ...
  while ((octet != 0x0)) {
    ...
    case kIeiMicoIndication: {
      oai::logger::logger_common::nas().debug("Decoding IEI 0x%x",
                                              kIeiMicoIndication);
      if ((decoded_ie_size = NasHelper::Decode(ie_mico_indication_, buf, len,
                                               decoded_size, true)) ==
          KEncodeDecodeError) {
        return KEncodeDecodeError;
      }
    ...
    case kIeiNetworkSlicingIndication: {
      ...
      if ((decoded_ie_size = NasHelper::Decode(ie_network_slicing_indication_,
    ...
    case kIeiNssaiInclusionMode: {
      ...
      if ((decoded_ie_size = NasHelper::Decode(ie_nssai_inclusion_mode_, buf,
    ...
    case kIeiNon3gppNwProvidedPolicies: {
      ...
      if ((decoded_ie_size = NasHelper::Decode(ie_non_3gpp_nw_policies_, buf,
                                               len, decoded_size, true)) ==
          KEncodeDecodeError) {
        return KEncodeDecodeError;
      }
    ...
    switch (octet) {
    case kIei5gGuti: {
      oai::logger::logger_common::nas().debug("Decoding IEI 0x%x", kIei5gGuti);
      if ((decoded_ie_size =
               NasHelper::Decode(ie_5g_guti_, buf, len, decoded_size, true)) ==
          KEncodeDecodeError) {
        return KEncodeDecodeError;
      }
      DECODE_U8_VALUE(buf, octet, decoded_size, len);
    ...
    case kIeiNSSAIAllowed: {
      oai::logger::logger_common::nas().debug("Decoding IEI 0x%x",
                                              kIeiNSSAIAllowed);
      if ((decoded_ie_size = NasHelper::Decode(ie_allowed_nssai_, buf, len,
                                               decoded_size, true)) ==
          KEncodeDecodeError) {
        return KEncodeDecodeError;
      }
    ...
    case kIeiRejectedNssaiRa: {
      ...
      if ((decoded_ie_size = NasHelper::Decode(
               ie_rejected_nssai_, kIeiRejectedNssaiRa, buf, len, decoded_size,
    ...
    case kIeiNSSAIConfigured: {
      oai::logger::logger_common::nas().debug("Decoding IEI 0x%x",
                                              kIeiNSSAIConfigured);
      if ((decoded_ie_size = NasHelper::Decode(ie_configured_nssai_, buf, len,
                                               decoded_size, true)) ==
          KEncodeDecodeError) {
        return KEncodeDecodeError;
      }
    ...
    case kIei5gsNetworkFeatureSupport: {
      ...
      if ((decoded_ie_size = NasHelper::Decode(ie_5gs_network_feature_support_,
                                               buf, len, decoded_size, true)) ==
          KEncodeDecodeError) {
        return KEncodeDecodeError;
      }
    ...
    case kIeiPduSessionStatus: {
      ...
      if ((decoded_ie_size = NasHelper::Decode(ie_pdu_session_status_, buf, len,
                                               decoded_size, true)) ==
          KEncodeDecodeError) {
        return KEncodeDecodeError;
      }
    ...
    case kIeiPduSessionReactivationResult: {
      ...
      if ((decoded_ie_size =
               NasHelper::Decode(ie_pdu_session_reactivation_result_, buf, len,
    ...
    case kIeiLadnInformation: {
      oai::logger::logger_common::nas().debug("Decoding IEI 0x%x",
                                              kIeiLadnInformation);
      if ((decoded_ie_size = NasHelper::Decode(ie_ladn_information_, buf, len,
                                               decoded_size, true)) ==
          KEncodeDecodeError) {
        return KEncodeDecodeError;
      }
    ...
    case kIeiServiceAreaList: {
      oai::logger::logger_common::nas().debug("Decoding IEI 0x%x",
                                              kIeiServiceAreaList);
      if ((decoded_ie_size = NasHelper::Decode(ie_service_area_list_, buf, len,
                                               decoded_size, true)) ==
          KEncodeDecodeError) {
        return KEncodeDecodeError;
      }
    ...
    case kIeiGprsTimer3T3512: {
      oai::logger::logger_common::nas().debug("Decoding IEI 0x%x",
                                              kIeiGprsTimer3T3512);
      if ((decoded_ie_size =
               NasHelper::Decode(ie_t3512_value_, kIeiGprsTimer3T3512, buf, len,
                                 decoded_size, true)) == KEncodeDecodeError) {
        return KEncodeDecodeError;
      }
      DECODE_U8_VALUE(buf, octet, decoded_size, len);
    ...
    case kIeiGprsTimer2Non3gppDeregistration: {
      ...
      if ((decoded_ie_size =
               NasHelper::Decode(ie_non_3gpp_deregistration_timer_value_,
                                 kIeiGprsTimer2Non3gppDeregistration, buf, len,
                                 decoded_size, true)) == KEncodeDecodeError) {
        return KEncodeDecodeError;
      }
      DECODE_U8_VALUE(buf, octet, decoded_size, len);
    ...
    case kIeiGprsTimer2T3502: {
      oai::logger::logger_common::nas().debug("Decoding IEI 0x%x",
                                              kIeiGprsTimer2T3502);
      if ((decoded_ie_size =
               NasHelper::Decode(ie_t3502_value_, kIeiGprsTimer2T3502, buf, len,
                                 decoded_size, true)) == KEncodeDecodeError) {
        return KEncodeDecodeError;
      }
      DECODE_U8_VALUE(buf, octet, decoded_size, len);
    ...
    case kIeiSorTransparentContainer: {
      ...
      if ((decoded_ie_size = NasHelper::Decode(ie_sor_transparent_container_,
                                               buf, len, decoded_size, true)) ==
          KEncodeDecodeError) {
        return KEncodeDecodeError;
      }
    ...
    case kIei5gsDrxParameters: {
      ...
      if ((decoded_ie_size = NasHelper::Decode(ie_negotiated_drx_parameters_,
                                               buf, len, decoded_size, true)) ==
          KEncodeDecodeError) {
        return KEncodeDecodeError;
      }
    ...
    case kIeiEpsBearerContextStatus: {
      ...
      if ((decoded_ie_size = NasHelper::Decode(ie_eps_bearer_context_status_,
                                               buf, len, decoded_size, true)) ==
          KEncodeDecodeError) {
        return KEncodeDecodeError;
      }
    ...
    case kIeiExtendedDrxParameters: {
      ...
      if ((decoded_ie_size = NasHelper::Decode(ie_extended_drx_parameters_, buf,
                                               len, decoded_size, true)) ==
          KEncodeDecodeError) {
        return KEncodeDecodeError;
      }
    ...
    case kIeiGprsTimer3T3447: {
      oai::logger::logger_common::nas().debug("Decoding IEI 0x%x",
                                              kIeiGprsTimer3T3447);
      if ((decoded_ie_size =
               NasHelper::Decode(ie_t3447_value_, kIeiGprsTimer3T3447, buf, len,
                                 decoded_size, true)) == KEncodeDecodeError) {
        return KEncodeDecodeError;
      }
      DECODE_U8_VALUE(buf, octet, decoded_size, len);
    ...
    case kIeiGprsTimer3T3448: {
      oai::logger::logger_common::nas().debug("Decoding IEI 0x%x",
                                              kIeiGprsTimer3T3448);
      if ((decoded_ie_size =
               NasHelper::Decode(ie_t3448_value_, kIeiGprsTimer3T3448, buf, len,
                                 decoded_size, true)) == KEncodeDecodeError) {
        return KEncodeDecodeError;
      }
      DECODE_U8_VALUE(buf, octet, decoded_size, len);
    ...
    case kIeiGprsTimer3T3324: {
      oai::logger::logger_common::nas().debug("Decoding IEI 0x%x",
                                              kIeiGprsTimer3T3324);
      if ((decoded_ie_size =
               NasHelper::Decode(ie_t3324_value_, kIeiGprsTimer3T3324, buf, len,
                                 decoded_size, true)) == KEncodeDecodeError) {
        return KEncodeDecodeError;
      }
      DECODE_U8_VALUE(buf, octet, decoded_size, len);
    ...
    case kIeiUeRadioCapabilityId: {
      ...
      if ((decoded_ie_size = NasHelper::Decode(ie_ue_radio_capability_id_, buf,
                                               len, decoded_size, true)) ==
          KEncodeDecodeError) {
        return KEncodeDecodeError;
      }
    ...
    case kIeiNSSAIPending: {
      oai::logger::logger_common::nas().debug("Decoding IEI 0x%x",
                                              kIeiNSSAIPending);
      if ((decoded_ie_size = NasHelper::Decode(ie_pending_nssai_, buf, len,
                                               decoded_size, true)) ==
          KEncodeDecodeError) {
        return KEncodeDecodeError;
      }
    ...
    case kEquivalentPlmns: {
      oai::logger::logger_common::nas().debug("Decoding IEI 0x%x",
                                              kEquivalentPlmns);
      if ((decoded_ie_size = NasHelper::Decode(ie_equivalent_plmns_, buf, len,
                                               decoded_size, true)) ==
          KEncodeDecodeError) {
        return KEncodeDecodeError;
      }
    ...
    case kIei5gsTrackingAreaIdentityList: {
      ...
      if ((decoded_ie_size =
               NasHelper::Decode(ie_tai_list_, buf, len, decoded_size, true)) ==
          KEncodeDecodeError) {
        return KEncodeDecodeError;
      }
      DECODE_U8_VALUE(buf, octet, decoded_size, len);
