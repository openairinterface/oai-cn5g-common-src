...
public:
    ...
    /// 
    /// </summary>
    oai::_3gpp::model::SessionRuleFailureCode getSessRuleFailureCode() const;
    void setSessRuleFailureCode(oai::_3gpp::model::SessionRuleFailureCode const& value);
...
protected:
    ...
    oai::_3gpp::model::SessionRuleFailureCode m_SessRuleFailureCode;
