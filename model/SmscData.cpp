...
oai::model::NetworkNodeDiameterAddress_1 SmscData::getSmscDiameterAddress() const
{
    return m_SmscDiameterAddress;
}
void SmscData::setSmscDiameterAddress(oai::model::NetworkNodeDiameterAddress_1 const& value)
{
