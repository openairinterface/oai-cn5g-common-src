...
asn_oer_constraints_t asn_OER_type_Ngap_SONInformationReport_constr_1
    CC_NOTUSED = {{0, 0}, -1};
#endif /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
asn_per_constraints_t asn_PER_type_Ngap_SONInformationReport_constr_1
    CC_NOTUSED = {
...
asn_TYPE_member_t asn_MBR_Ngap_SONInformationReport_1[] = {
    ...
    {ATF_POINTER,
     0,
     offsetof(struct Ngap_SONInformationReport, choice.hOReportInformation),
    ...
    {ATF_POINTER,
     0,
     offsetof(struct Ngap_SONInformationReport, choice.choice_Extensions),
     (ASN_TAG_CLASS_CONTEXT | (2 << 2)),
     -1, /* IMPLICIT tag at current level */
     &asn_DEF_Ngap_ProtocolIE_SingleContainer_12877P49,
     0,
     {
#if !defined(ASN_DISABLE_OER_SUPPORT)
         0,
...
asn_TYPE_descriptor_t asn_DEF_Ngap_SONInformationReport = {
    ...
    {
#if !defined(ASN_DISABLE_OER_SUPPORT)
        &asn_OER_type_Ngap_SONInformationReport_constr_1,
#endif /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
