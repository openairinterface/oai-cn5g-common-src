...
bool MmContext::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    ...
    {
        const std::vector<oai::_3gpp::model::NssaiMapping>& value = m_NssaiMappingList;
    ...
    {
        const std::vector<oai::_3gpp::model::std::string>& value = m_NsInstanceList;
    ...
    {
        const std::vector<oai::_3gpp::model::NssaaStatus>& value = m_NssaaStatusList;
    ...
    {
        const std::vector<oai::_3gpp::model::NssaiMapping>& value = m_PendingNssaiMappingList;
...
void MmContext::setNasSecurityMode(oai::_3gpp::model::NasSecurityMode const& value)
{
...
void MmContext::setEpsNasSecurityMode(oai::_3gpp::model::EpsNasSecurityMode const& value)
{
...
void MmContext::setAllowedNssai(std::vector<oai::_3gpp::model::Snssai> const& value)
{
...
std::vector<oai::_3gpp::model::NssaiMapping> MmContext::getNssaiMappingList() const
{
    return m_NssaiMappingList;
}
void MmContext::setNssaiMappingList(std::vector<oai::_3gpp::model::NssaiMapping> const& value)
{
...
void MmContext::setAllowedHomeNssai(std::vector<oai::_3gpp::model::Snssai> const& value)
{
...
std::vector<oai::_3gpp::model::std::string> MmContext::getNsInstanceList() const
{
    return m_NsInstanceList;
}
void MmContext::setNsInstanceList(std::vector<oai::_3gpp::model::std::string> const& value)
{
...
void MmContext::setExpectedUEbehavior(oai::_3gpp::model::ExpectedUeBehavior const& value)
{
...
oai::_3gpp::model::UeDifferentiationInfo MmContext::getUeDifferentiationInfo() const
{
    return m_UeDifferentiationInfo;
}
void MmContext::setUeDifferentiationInfo(oai::_3gpp::model::UeDifferentiationInfo const& value)
{
...
std::vector<oai::_3gpp::model::NssaaStatus> MmContext::getNssaaStatusList() const
{
    return m_NssaaStatusList;
}
void MmContext::setNssaaStatusList(std::vector<oai::_3gpp::model::NssaaStatus> const& value)
{
...
std::vector<oai::_3gpp::model::NssaiMapping> MmContext::getPendingNssaiMappingList() const
{
    return m_PendingNssaiMappingList;
}
void MmContext::setPendingNssaiMappingList(std::vector<oai::_3gpp::model::NssaiMapping> const& value)
{
