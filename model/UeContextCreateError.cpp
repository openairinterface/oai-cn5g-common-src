...
bool UeContextCreateError::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "UeContextCreateError" : pathPrefix;
...
bool UeContextCreateError::operator==(const UeContextCreateError& rhs) const
{
    ...
    ((!targetToSourceFailureDataIsSet() && !rhs.targetToSourceFailureDataIsSet()) || (targetToSourceFailureDataIsSet() && rhs.targetToSourceFailureDataIsSet() && getTargetToSourceFailureData() == rhs.getTargetToSourceFailureData()))
...
oai::model::ProblemDetails UeContextCreateError::getError() const
{
    return m_Error;
}
void UeContextCreateError::setError(oai::model::ProblemDetails const& value)
{
    m_Error = value;
}
oai::model::NgApCause UeContextCreateError::getNgapCause() const
{
    return m_NgapCause;
}
void UeContextCreateError::setNgapCause(oai::model::NgApCause const& value)
{
    m_NgapCause = value;
...
oai::model::N2InfoContent UeContextCreateError::getTargetToSourceFailureData() const
{
    return m_TargetToSourceFailureData;
}
void UeContextCreateError::setTargetToSourceFailureData(oai::model::N2InfoContent const& value)
{
