...
bool AreaOfValidity::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "AreaOfValidity" : pathPrefix;
...
std::vector<oai::model::Tai> AreaOfValidity::getTaiList() const
{
    return m_TaiList;
}
void AreaOfValidity::setTaiList(std::vector<oai::model::Tai> const& value)
{
    m_TaiList = value;
}
