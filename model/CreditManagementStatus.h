...
public:
    ...
    CreditManagementStatus_anyOf::eCreditManagementStatus_anyOf getEnumValue() const;
    void setEnumValue(CreditManagementStatus_anyOf::eCreditManagementStatus_anyOf value);
