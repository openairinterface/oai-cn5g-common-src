...
asn_TYPE_member_t asn_MBR_Ngap_PDUSessionResourceFailedToSetupItemSURes_1[] = {
    ...
    {ATF_POINTER,
     ...
     -1, /* IMPLICIT tag at current level */
     &asn_DEF_Ngap_ProtocolExtensionContainer_12929P224,
     0,
     {
#if !defined(ASN_DISABLE_OER_SUPPORT)
         0,
...
static const int asn_MAP_Ngap_PDUSessionResourceFailedToSetupItemSURes_oms_1[] =
    {2};
...
asn_TYPE_descriptor_t asn_DEF_Ngap_PDUSessionResourceFailedToSetupItemSURes = {
    ...
    sizeof(asn_DEF_Ngap_PDUSessionResourceFailedToSetupItemSURes_tags_1) /
        sizeof(asn_DEF_Ngap_PDUSessionResourceFailedToSetupItemSURes_tags_1
                   [0]),                                          /* 1 */
    asn_DEF_Ngap_PDUSessionResourceFailedToSetupItemSURes_tags_1, /* Same as
                                                                     above */
    sizeof(asn_DEF_Ngap_PDUSessionResourceFailedToSetupItemSURes_tags_1) /
        sizeof(asn_DEF_Ngap_PDUSessionResourceFailedToSetupItemSURes_tags_1
                   [0]), /* 1 */
