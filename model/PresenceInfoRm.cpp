...
bool PresenceInfoRm::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "PresenceInfoRm" : pathPrefix;

                     
    if (trackingAreaListIsSet())
    {
        const std::vector<oai::model::Tai>& value = m_TrackingAreaList;
    ...
    if (ecgiListIsSet())
    {
        const std::vector<oai::model::Ecgi>& value = m_EcgiList;
        ...
        { // Recursive validation of array elements
            const std::string oldValuePath = currentValuePath;
            int i = 0;
            for (const oai::model::Ecgi& value : value)
            { 
                const std::string currentValuePath = oldValuePath + "[" + std::to_string(i) + "]";
                        
        success = value.validate(msg, currentValuePath + ".ecgiList") && success;
    ...
    if (ncgiListIsSet())
    {
        const std::vector<oai::model::Ncgi>& value = m_NcgiList;
        ...
        { // Recursive validation of array elements
            const std::string oldValuePath = currentValuePath;
            int i = 0;
            for (const oai::model::Ncgi& value : value)
            { 
                const std::string currentValuePath = oldValuePath + "[" + std::to_string(i) + "]";
    ...
    {
        const std::vector<oai::model::GlobalRanNodeId>& value = m_GlobalRanNodeIdList;
        ...
        { // Recursive validation of array elements
            const std::string oldValuePath = currentValuePath;
            int i = 0;
            for (const oai::model::GlobalRanNodeId& value : value)
            { 
                const std::string currentValuePath = oldValuePath + "[" + std::to_string(i) + "]";
                        
        success = value.validate(msg, currentValuePath + ".globalRanNodeIdList") && success;
    ...
    {
        const std::vector<oai::model::GlobalRanNodeId>& value = m_GlobaleNbIdList;
        ...
        success = value.validate(msg, currentValuePath + ".globaleNbIdList") && success;
...
bool PresenceInfoRm::operator==(const PresenceInfoRm& rhs) const
{
    ...
    ((!praIdIsSet() && !rhs.praIdIsSet()) || (praIdIsSet() && rhs.praIdIsSet() && getPraId() == rhs.getPraId())) &&
    
    
    ((!additionalPraIdIsSet() && !rhs.additionalPraIdIsSet()) || (additionalPraIdIsSet() && rhs.additionalPraIdIsSet() && getAdditionalPraId() == rhs.getAdditionalPraId())) &&
    
    
    ((!presenceStateIsSet() && !rhs.presenceStateIsSet()) || (presenceStateIsSet() && rhs.presenceStateIsSet() && getPresenceState() == rhs.getPresenceState())) &&
    ...
    ((!ecgiListIsSet() && !rhs.ecgiListIsSet()) || (ecgiListIsSet() && rhs.ecgiListIsSet() && getEcgiList() == rhs.getEcgiList())) &&
    
    
    ((!ncgiListIsSet() && !rhs.ncgiListIsSet()) || (ncgiListIsSet() && rhs.ncgiListIsSet() && getNcgiList() == rhs.getNcgiList())) &&
    
    
    ((!globalRanNodeIdListIsSet() && !rhs.globalRanNodeIdListIsSet()) || (globalRanNodeIdListIsSet() && rhs.globalRanNodeIdListIsSet() && getGlobalRanNodeIdList() == rhs.getGlobalRanNodeIdList())) &&
    
    
    ((!globaleNbIdListIsSet() && !rhs.globaleNbIdListIsSet()) || (globaleNbIdListIsSet() && rhs.globaleNbIdListIsSet() && getGlobaleNbIdList() == rhs.getGlobaleNbIdList()))
...
oai::model::PresenceState PresenceInfoRm::getPresenceState() const
{
    return m_PresenceState;
}
void PresenceInfoRm::setPresenceState(oai::model::PresenceState const& value)
{
...
std::vector<oai::model::Tai> PresenceInfoRm::getTrackingAreaList() const
{
    return m_TrackingAreaList;
}
void PresenceInfoRm::setTrackingAreaList(std::vector<oai::model::Tai> const& value)
{
...
std::vector<oai::model::Ecgi> PresenceInfoRm::getEcgiList() const
{
    return m_EcgiList;
}
void PresenceInfoRm::setEcgiList(std::vector<oai::model::Ecgi> const& value)
{
    m_EcgiList = value;
...
std::vector<oai::model::Ncgi> PresenceInfoRm::getNcgiList() const
{
    return m_NcgiList;
}
void PresenceInfoRm::setNcgiList(std::vector<oai::model::Ncgi> const& value)
{
    m_NcgiList = value;
...
std::vector<oai::model::GlobalRanNodeId> PresenceInfoRm::getGlobalRanNodeIdList() const
{
    return m_GlobalRanNodeIdList;
}
void PresenceInfoRm::setGlobalRanNodeIdList(std::vector<oai::model::GlobalRanNodeId> const& value)
{
...
std::vector<oai::model::GlobalRanNodeId> PresenceInfoRm::getGlobaleNbIdList() const
{
    return m_GlobaleNbIdList;
}
void PresenceInfoRm::setGlobaleNbIdList(std::vector<oai::model::GlobalRanNodeId> const& value)
{
