...
bool ServiceExperienceInfoPerFlow::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "ServiceExperienceInfoPerFlow" : pathPrefix;

                        
    return success;
}

bool ServiceExperienceInfoPerFlow::operator==(const ServiceExperienceInfoPerFlow& rhs) const
{
    return
    
    
    
    ((!svcExprcIsSet() && !rhs.svcExprcIsSet()) || (svcExprcIsSet() && rhs.svcExprcIsSet() && getSvcExprc() == rhs.getSvcExprc())) &&
    
    
    ((!timeIntevIsSet() && !rhs.timeIntevIsSet()) || (timeIntevIsSet() && rhs.timeIntevIsSet() && getTimeIntev() == rhs.getTimeIntev())) &&
    ...
    ((!ethTrafficFilterIsSet() && !rhs.ethTrafficFilterIsSet()) || (ethTrafficFilterIsSet() && rhs.ethTrafficFilterIsSet() && getEthTrafficFilter() == rhs.getEthTrafficFilter()))
...
oai::_3gpp::model::SvcExperience ServiceExperienceInfoPerFlow::getSvcExprc() const
{
    return m_SvcExprc;
}
void ServiceExperienceInfoPerFlow::setSvcExprc(oai::_3gpp::model::SvcExperience const& value)
{
    m_SvcExprc = value;
...
oai::_3gpp::model::TimeWindow ServiceExperienceInfoPerFlow::getTimeIntev() const
{
    return m_TimeIntev;
}
void ServiceExperienceInfoPerFlow::setTimeIntev(oai::_3gpp::model::TimeWindow const& value)
{
    m_TimeIntev = value;
...
oai::_3gpp::model::FlowInfo ServiceExperienceInfoPerFlow::getIpTrafficFilter() const
{
    return m_IpTrafficFilter;
}
void ServiceExperienceInfoPerFlow::setIpTrafficFilter(oai::_3gpp::model::FlowInfo const& value)
{
...
oai::_3gpp::model::EthFlowDescription ServiceExperienceInfoPerFlow::getEthTrafficFilter() const
{
    return m_EthTrafficFilter;
}
void ServiceExperienceInfoPerFlow::setEthTrafficFilter(oai::_3gpp::model::EthFlowDescription const& value)
{
