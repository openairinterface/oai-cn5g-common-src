...
bool OdbData::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
...
bool OdbData::operator==(const OdbData& rhs) const
{
    ...
    ((!roamingOdbIsSet() && !rhs.roamingOdbIsSet()) || (roamingOdbIsSet() && rhs.roamingOdbIsSet() && getRoamingOdb() == rhs.getRoamingOdb()))
...
oai::model::RoamingOdb OdbData::getRoamingOdb() const
{
    return m_RoamingOdb;
}
void OdbData::setRoamingOdb(oai::model::RoamingOdb const& value)
{
    m_RoamingOdb = value;
