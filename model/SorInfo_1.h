...
public:
    ...
    /// 
    /// </summary>
    oai::model::SteeringContainer getSteeringContainer() const;
    void setSteeringContainer(oai::model::SteeringContainer const& value);
...
protected:
    oai::model::SteeringContainer m_SteeringContainer;
