...
public:
  ...
  bool
  encode(Ngap_PDUSessionResourceSetupListSURes_t &pduSessionResourceList) const;
  bool
  decode(const Ngap_PDUSessionResourceSetupListSURes_t &pduSessionResourceList);
