...
bool LocationAccuracy_anyOf::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "LocationAccuracy_anyOf" : pathPrefix;

    
    if (m_value == LocationAccuracy_anyOf::eLocationAccuracy_anyOf::INVALID_VALUE_OPENAPI_GENERATED)
    {
        success = false;
...
bool LocationAccuracy_anyOf::operator==(const LocationAccuracy_anyOf& rhs) const
{
    return
...
void to_json(nlohmann::json& j, const LocationAccuracy_anyOf& o)
{
    ...
    switch (o.getValue())
    {
        case LocationAccuracy_anyOf::eLocationAccuracy_anyOf::INVALID_VALUE_OPENAPI_GENERATED:
...
LocationAccuracy_anyOf::eLocationAccuracy_anyOf LocationAccuracy_anyOf::getValue() const
{
    return m_value;
}
void LocationAccuracy_anyOf::setValue(LocationAccuracy_anyOf::eLocationAccuracy_anyOf value)
{
    m_value = value;
}
