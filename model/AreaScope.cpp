...
bool AreaScope::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    ...
    {
        const std::map<std::string, oai::model::TacInfo>& value = m_TacInfoPerPlmn;
...
std::map<std::string, oai::model::TacInfo> AreaScope::getTacInfoPerPlmn() const
{
    return m_TacInfoPerPlmn;
}
void AreaScope::setTacInfoPerPlmn(std::map<std::string, oai::model::TacInfo> const& value)
{
