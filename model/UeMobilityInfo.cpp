...
bool UeMobilityInfo::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "UeMobilityInfo" : pathPrefix;
    ...
    /* UeTrajs */ {
        const std::vector<oai::model::UeTrajectoryInfo>& value = m_UeTrajs;
        ...
        { // Recursive validation of array elements
            ...
            int i = 0;
            for (const oai::model::UeTrajectoryInfo& value : value)
            { 
...
std::vector<oai::model::UeTrajectoryInfo> UeMobilityInfo::getUeTrajs() const
{
    return m_UeTrajs;
}
void UeMobilityInfo::setUeTrajs(std::vector<oai::model::UeTrajectoryInfo> const& value)
{
    m_UeTrajs = value;
}
