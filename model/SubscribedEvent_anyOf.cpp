...
bool SubscribedEvent_anyOf::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "SubscribedEvent_anyOf" : pathPrefix;

    
    if (m_value == SubscribedEvent_anyOf::eSubscribedEvent_anyOf::INVALID_VALUE_OPENAPI_GENERATED)
    {
        success = false;
...
void to_json(nlohmann::json& j, const SubscribedEvent_anyOf& o)
{
    ...
    switch (o.getValue())
    {
        case SubscribedEvent_anyOf::eSubscribedEvent_anyOf::INVALID_VALUE_OPENAPI_GENERATED:
...
SubscribedEvent_anyOf::eSubscribedEvent_anyOf SubscribedEvent_anyOf::getValue() const
{
    return m_value;
}
void SubscribedEvent_anyOf::setValue(SubscribedEvent_anyOf::eSubscribedEvent_anyOf value)
{
    m_value = value;
}
