...
public:
    ...
    friend  void to_json(nlohmann::json& j, const HorizontalWithVerticalVelocity& o);
    friend  void from_json(const nlohmann::json& j, HorizontalWithVerticalVelocity& o);
protected:
    float m_HSpeed;
