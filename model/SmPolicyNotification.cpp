...
oai::model::SmPolicyDecision SmPolicyNotification::getSmPolicyDecision() const
{
    return m_SmPolicyDecision;
}
void SmPolicyNotification::setSmPolicyDecision(oai::model::SmPolicyDecision const& value)
{
