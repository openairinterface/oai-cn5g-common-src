...
bool CivicAddress::operator==(const CivicAddress &rhs) const {
  return
      ...
      ((!a1IsSet() && !rhs.a1IsSet()) ||
       (a1IsSet() && rhs.a1IsSet() && getA1() == rhs.getA1())) &&

      ((!a2IsSet() && !rhs.a2IsSet()) ||
       (a2IsSet() && rhs.a2IsSet() && getA2() == rhs.getA2())) &&

      ((!a3IsSet() && !rhs.a3IsSet()) ||
       (a3IsSet() && rhs.a3IsSet() && getA3() == rhs.getA3())) &&

      ((!a4IsSet() && !rhs.a4IsSet()) ||
       (a4IsSet() && rhs.a4IsSet() && getA4() == rhs.getA4())) &&

      ((!a5IsSet() && !rhs.a5IsSet()) ||
       (a5IsSet() && rhs.a5IsSet() && getA5() == rhs.getA5())) &&

      ((!a6IsSet() && !rhs.a6IsSet()) ||
       (a6IsSet() && rhs.a6IsSet() && getA6() == rhs.getA6())) &&

      ((!pRDIsSet() && !rhs.pRDIsSet()) ||
       (pRDIsSet() && rhs.pRDIsSet() && getPRD() == rhs.getPRD())) &&

      ((!pODIsSet() && !rhs.pODIsSet()) ||
       (pODIsSet() && rhs.pODIsSet() && getPOD() == rhs.getPOD())) &&

      ((!sTSIsSet() && !rhs.sTSIsSet()) ||
       (sTSIsSet() && rhs.sTSIsSet() && getSTS() == rhs.getSTS())) &&

      ((!hNOIsSet() && !rhs.hNOIsSet()) ||
       (hNOIsSet() && rhs.hNOIsSet() && getHNO() == rhs.getHNO())) &&

      ((!hNSIsSet() && !rhs.hNSIsSet()) ||
       (hNSIsSet() && rhs.hNSIsSet() && getHNS() == rhs.getHNS())) &&

      ((!lMKIsSet() && !rhs.lMKIsSet()) ||
       (lMKIsSet() && rhs.lMKIsSet() && getLMK() == rhs.getLMK())) &&

      ((!lOCIsSet() && !rhs.lOCIsSet()) ||
       (lOCIsSet() && rhs.lOCIsSet() && getLOC() == rhs.getLOC())) &&

      ((!nAMIsSet() && !rhs.nAMIsSet()) ||
       (nAMIsSet() && rhs.nAMIsSet() && getNAM() == rhs.getNAM())) &&

      ((!pCIsSet() && !rhs.pCIsSet()) ||
       (pCIsSet() && rhs.pCIsSet() && getPC() == rhs.getPC())) &&

      ((!bLDIsSet() && !rhs.bLDIsSet()) ||
       (bLDIsSet() && rhs.bLDIsSet() && getBLD() == rhs.getBLD())) &&

      ((!uNITIsSet() && !rhs.uNITIsSet()) ||
       (uNITIsSet() && rhs.uNITIsSet() && getUNIT() == rhs.getUNIT())) &&

      ((!fLRIsSet() && !rhs.fLRIsSet()) ||
       (fLRIsSet() && rhs.fLRIsSet() && getFLR() == rhs.getFLR())) &&

      ((!rOOMIsSet() && !rhs.rOOMIsSet()) ||
       (rOOMIsSet() && rhs.rOOMIsSet() && getROOM() == rhs.getROOM())) &&

      ((!pLCIsSet() && !rhs.pLCIsSet()) ||
       (pLCIsSet() && rhs.pLCIsSet() && getPLC() == rhs.getPLC())) &&

      ((!pCNIsSet() && !rhs.pCNIsSet()) ||
       (pCNIsSet() && rhs.pCNIsSet() && getPCN() == rhs.getPCN())) &&

      ((!pOBOXIsSet() && !rhs.pOBOXIsSet()) ||
       (pOBOXIsSet() && rhs.pOBOXIsSet() && getPOBOX() == rhs.getPOBOX())) &&

      ((!aDDCODEIsSet() && !rhs.aDDCODEIsSet()) ||
       (aDDCODEIsSet() && rhs.aDDCODEIsSet() &&
        getADDCODE() == rhs.getADDCODE())) &&

      ((!sEATIsSet() && !rhs.sEATIsSet()) ||
       (sEATIsSet() && rhs.sEATIsSet() && getSEAT() == rhs.getSEAT())) &&

      ((!rDIsSet() && !rhs.rDIsSet()) ||
       (rDIsSet() && rhs.rDIsSet() && getRD() == rhs.getRD())) &&

      ((!rDSECIsSet() && !rhs.rDSECIsSet()) ||
       (rDSECIsSet() && rhs.rDSECIsSet() && getRDSEC() == rhs.getRDSEC())) &&

      ((!rDBRIsSet() && !rhs.rDBRIsSet()) ||
       (rDBRIsSet() && rhs.rDBRIsSet() && getRDBR() == rhs.getRDBR())) &&

      ((!rDSUBBRIsSet() && !rhs.rDSUBBRIsSet()) ||
       (rDSUBBRIsSet() && rhs.rDSUBBRIsSet() &&
        getRDSUBBR() == rhs.getRDSUBBR())) &&

      ((!pRMIsSet() && !rhs.pRMIsSet()) ||
       (pRMIsSet() && rhs.pRMIsSet() && getPRM() == rhs.getPRM())) &&

      ((!pOMIsSet() && !rhs.pOMIsSet()) ||
       (pOMIsSet() && rhs.pOMIsSet() && getPOM() == rhs.getPOM())) &&

      ((!usageRulesIsSet() && !rhs.usageRulesIsSet()) ||
       (usageRulesIsSet() && rhs.usageRulesIsSet() &&
        getUsageRules() == rhs.getUsageRules())) &&

      ((!methodIsSet() && !rhs.methodIsSet()) ||
       (methodIsSet() && rhs.methodIsSet() &&
        getMethod() == rhs.getMethod())) &&

      ((!providedByIsSet() && !rhs.providedByIsSet()) ||
       (providedByIsSet() && rhs.providedByIsSet() &&
        getProvidedBy() == rhs.getProvidedBy()))
