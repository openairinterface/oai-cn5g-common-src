...
bool GeographicalCoordinates::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "GeographicalCoordinates" : pathPrefix;
...
bool GeographicalCoordinates::operator==(const GeographicalCoordinates& rhs) const
{
    return
