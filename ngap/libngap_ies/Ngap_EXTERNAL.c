 ...
 * 	found in "/tmp/mouse_asn1c/skeletons/standard-modules/ASN1C-UsefulInformationObjectClasses.asn1"
...
extern asn_TYPE_descriptor_t asn_DEF_Ngap_encoding __attribute__((weak, alias("asn_DEF_Ngap_encoding_5")));
#else
static asn_TYPE_descriptor_t asn_DEF_Ngap_encoding_5;
static asn_TYPE_descriptor_t asn_DEF_Ngap_encoding;
__attribute__((constructor)) static void asn_DEF_Ngap_encoding_5_alias_init(void) {
