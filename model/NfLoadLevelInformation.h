...
public:
    ...
    virtual ~NfLoadLevelInformation() = default;
    ...
    bool operator==(const NfLoadLevelInformation& rhs) const;
    bool operator!=(const NfLoadLevelInformation& rhs) const;
    ...
    /// 
    /// </summary>
    int32_t getNfLoadAvgInAoi() const;
    void setNfLoadAvgInAoi(int32_t const value);
    bool nfLoadAvgInAoiIsSet() const;
    void unsetNfLoadAvgInAoi();
    /// <summary>
    /// 
    /// </summary>
...
protected:
    ...
    int32_t m_NfLoadAvgInAoi;
    bool m_NfLoadAvgInAoiIsSet;
