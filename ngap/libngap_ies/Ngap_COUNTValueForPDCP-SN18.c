...
static int memb_Ngap_pDCP_SN18_constraint_1(
...
static int memb_Ngap_hFN_PDCP_SN18_constraint_1(
    const asn_TYPE_descriptor_t* td, const void* sptr,
    asn_app_constraint_failed_f* ctfailcb, void* app_key) {
  long value;
...
#if !defined(ASN_DISABLE_OER_SUPPORT)
static asn_oer_constraints_t asn_OER_memb_Ngap_hFN_PDCP_SN18_constr_3
    CC_NOTUSED = {{2, 1} /* (0..16383) */, -1};
#endif /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
static asn_per_constraints_t asn_PER_memb_Ngap_hFN_PDCP_SN18_constr_3
    CC_NOTUSED = {
...
asn_TYPE_member_t asn_MBR_Ngap_COUNTValueForPDCP_SN18_1[] = {
    {ATF_NOFLAGS,
     0,
     offsetof(struct Ngap_COUNTValueForPDCP_SN18, pDCP_SN18),
    ...
    {ATF_NOFLAGS,
     0,
     offsetof(struct Ngap_COUNTValueForPDCP_SN18, hFN_PDCP_SN18),
    ...
    {ATF_POINTER,
     1,
     offsetof(struct Ngap_COUNTValueForPDCP_SN18, iE_Extensions),
     (ASN_TAG_CLASS_CONTEXT | (2 << 2)),
     -1, /* IMPLICIT tag at current level */
     &asn_DEF_Ngap_ProtocolExtensionContainer_12929P47,
     0,
     {
#if !defined(ASN_DISABLE_OER_SUPPORT)
         0,
