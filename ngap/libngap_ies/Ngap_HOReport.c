...
extern asn_TYPE_descriptor_t asn_DEF_Ngap_handoverReportType
    __attribute__((weak, alias("asn_DEF_Ngap_handoverReportType_2")));
#else
static asn_TYPE_descriptor_t asn_DEF_Ngap_handoverReportType_2;
static asn_TYPE_descriptor_t asn_DEF_Ngap_handoverReportType;
__attribute__((constructor)) static void
asn_DEF_Ngap_handoverReportType_2_alias_init(void) {
  asn_DEF_Ngap_handoverReportType = asn_DEF_Ngap_handoverReportType_2;
}
#endif
...
static int asn_validate_Ngap_handoverReportType_2(
    const asn_TYPE_descriptor_t* td, const void* sptr,
    asn_app_constraint_failed_f* ctfailcb, void* app_key) {
  if (!sptr) {
    return -1;
  }
  e_Ngap_HOReport__handoverReportType value =
      *(e_Ngap_HOReport__handoverReportType*) sptr;
  switch (value) {
    case Ngap_HOReport__handoverReportType_ho_too_early:
    case Ngap_HOReport__handoverReportType_ho_to_wrong_cell:
    case Ngap_HOReport__handoverReportType_intersystem_ping_pong:
      return 0;
  }
  return -1;
}
...
static /* Use -fall-defs-global to expose */
    asn_TYPE_descriptor_t asn_DEF_Ngap_handoverReportType_2 = {
        ...
        sizeof(asn_DEF_Ngap_handoverReportType_tags_2) /
                sizeof(asn_DEF_Ngap_handoverReportType_tags_2[0]) -
            1,                                  /* 1 */
            ...
            sizeof(asn_DEF_Ngap_handoverReportType_tags_2[0]), /* 2 */
        {
          ...
          !defined(ASN_DISABLE_APER_SUPPORT) */
            ...
            asn_validate_Ngap_handoverReportType_2},
        0,
        0,                                       /* Defined elsewhere */
...
asn_TYPE_member_t asn_MBR_Ngap_HOReport_1[] = {
    {ATF_NOFLAGS,
     0,
     offsetof(struct Ngap_HOReport, handoverReportType),
    ...
    {ATF_POINTER,
     0,
     offsetof(struct Ngap_HOReport, handoverCause),
    ...
    {ATF_POINTER,
     0,
     offsetof(struct Ngap_HOReport, sourcecellCGI),
    ...
    {ATF_POINTER,
     0,
     offsetof(struct Ngap_HOReport, targetcellCGI),
    ...
    {ATF_POINTER,
     6,
     offsetof(struct Ngap_HOReport, reestablishmentcellCGI),
    ...
    {ATF_POINTER,
     5,
     offsetof(struct Ngap_HOReport, sourcecellC_RNTI),
    ...
    {ATF_POINTER,
     4,
     offsetof(struct Ngap_HOReport, targetcellinE_UTRAN),
    ...
    {ATF_POINTER,
     3,
     offsetof(struct Ngap_HOReport, mobilityInformation),
    ...
    {ATF_POINTER,
     2,
     offsetof(struct Ngap_HOReport, uERLFReportContainer),
    ...
    {ATF_POINTER,
     1,
     offsetof(struct Ngap_HOReport, iE_Extensions),
     (ASN_TAG_CLASS_CONTEXT | (9 << 2)),
     -1, /* IMPLICIT tag at current level */
     &asn_DEF_Ngap_ProtocolExtensionContainer_12929P114,
     0,
     {
#if !defined(ASN_DISABLE_OER_SUPPORT)
         0,
