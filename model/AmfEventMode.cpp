...
bool AmfEventMode::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "AmfEventMode" : pathPrefix;
    ...
    {
        const std::vector<oai::model::PartitioningCriteria>& value = m_PartitioningCriteria;
...
oai::model::AmfEventTrigger AmfEventMode::getTrigger() const
{
    return m_Trigger;
}
void AmfEventMode::setTrigger(oai::model::AmfEventTrigger const& value)
{
    m_Trigger = value;
}
...
std::vector<oai::model::PartitioningCriteria> AmfEventMode::getPartitioningCriteria() const
{
    return m_PartitioningCriteria;
}
void AmfEventMode::setPartitioningCriteria(std::vector<oai::model::PartitioningCriteria> const& value)
{
...
oai::model::NotificationFlag AmfEventMode::getNotifFlag() const
{
    return m_NotifFlag;
}
void AmfEventMode::setNotifFlag(oai::model::NotificationFlag const& value)
{
    m_NotifFlag = value;
