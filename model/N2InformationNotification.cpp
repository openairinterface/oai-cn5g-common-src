...
bool N2InformationNotification::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    ...
    {
        const std::vector<oai::_3gpp::model::SmfChangeInfo>& value = m_SmfChangeInfoList;
...
oai::_3gpp::model::N2InfoContainer N2InformationNotification::getN2InfoContainer() const
{
    return m_N2InfoContainer;
}
void N2InformationNotification::setN2InfoContainer(oai::_3gpp::model::N2InfoContainer const& value)
{
...
oai::_3gpp::model::N2InfoNotifyReason N2InformationNotification::getNotifyReason() const
{
    return m_NotifyReason;
}
void N2InformationNotification::setNotifyReason(oai::_3gpp::model::N2InfoNotifyReason const& value)
{
...
std::vector<oai::_3gpp::model::SmfChangeInfo> N2InformationNotification::getSmfChangeInfoList() const
{
    return m_SmfChangeInfoList;
}
void N2InformationNotification::setSmfChangeInfoList(std::vector<oai::_3gpp::model::SmfChangeInfo> const& value)
{
...
oai::_3gpp::model::GlobalRanNodeId N2InformationNotification::getRanNodeId() const
{
    return m_RanNodeId;
}
void N2InformationNotification::setRanNodeId(oai::_3gpp::model::GlobalRanNodeId const& value)
{
    m_RanNodeId = value;
...
void N2InformationNotification::setAnN2IPv6Addr(oai::_3gpp::model::Ipv6Addr const& value)
{
...
void N2InformationNotification::setGuami(oai::_3gpp::model::Guami const& value)
{
    m_Guami = value;
    m_GuamiIsSet = true;
}
