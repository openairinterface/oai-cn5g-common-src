...
std::vector<oai::_3gpp::model::ExternalClientType> LmfInfo::getServingClientTypes() const
{
    return m_ServingClientTypes;
}
void LmfInfo::setServingClientTypes(std::vector<oai::_3gpp::model::ExternalClientType> const& value)
{
...
std::vector<oai::_3gpp::model::AccessType> LmfInfo::getServingAccessTypes() const
{
    return m_ServingAccessTypes;
}
void LmfInfo::setServingAccessTypes(std::vector<oai::_3gpp::model::AccessType> const& value)
{
...
std::vector<oai::_3gpp::model::AnNodeType> LmfInfo::getServingAnNodeTypes() const
{
    return m_ServingAnNodeTypes;
}
void LmfInfo::setServingAnNodeTypes(std::vector<oai::_3gpp::model::AnNodeType> const& value)
{
...
void LmfInfo::setServingRatTypes(std::vector<oai::_3gpp::model::RatType> const& value)
{
...
void LmfInfo::setTaiRangeList(std::vector<oai::_3gpp::model::TaiRange> const& value)
{
...
std::vector<oai::_3gpp::model::SupportedGADShapes> LmfInfo::getSupportedGADShapes() const
{
    return m_SupportedGADShapes;
}
void LmfInfo::setSupportedGADShapes(std::vector<oai::_3gpp::model::SupportedGADShapes> const& value)
{
