...
Ngap_AMF_UE_NGAP_ID_constraint(const asn_TYPE_descriptor_t *td, const void *sptr,
	...
	static const asn_cval_t asn_CVAL_Ngap_AMF_UE_NGAP_ID_1_lb = { ACV_UINT, { .u = UINTMAX_C(0) } };
	static const asn_cval_t asn_CVAL_Ngap_AMF_UE_NGAP_ID_1_ub = { ACV_UINT, { .u = UINTMAX_C(1099511627775) } };
	...
	if(asn_check_INTEGER_range(st, &asn_CVAL_Ngap_AMF_UE_NGAP_ID_1_lb, &asn_CVAL_Ngap_AMF_UE_NGAP_ID_1_ub, 0) == 0) {
