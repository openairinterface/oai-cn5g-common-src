...
bool RgAuthCtx::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
...
bool RgAuthCtx::operator==(const RgAuthCtx& rhs) const
{
    ...
    ((!authIndIsSet() && !rhs.authIndIsSet()) || (authIndIsSet() && rhs.authIndIsSet() && isAuthInd() == rhs.isAuthInd()))
...
oai::model::AuthResult RgAuthCtx::getAuthResult() const
{
    return m_AuthResult;
}
void RgAuthCtx::setAuthResult(oai::model::AuthResult const& value)
{
    m_AuthResult = value;
}
