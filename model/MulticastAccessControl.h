...
public:
    ...
    MulticastAccessControl_anyOf::eMulticastAccessControl_anyOf getEnumValue() const;
    void setEnumValue(MulticastAccessControl_anyOf::eMulticastAccessControl_anyOf value);
