...
int Ngap_PDUSessionID_constraint(
...
asn_oer_constraints_t asn_OER_type_Ngap_PDUSessionID_constr_1 CC_NOTUSED = {
    {1, 1} /* (0..255) */,
    -1};
...
asn_TYPE_descriptor_t asn_DEF_Ngap_PDUSessionID = {
    ...
    {
#if !defined(ASN_DISABLE_OER_SUPPORT)
        &asn_OER_type_Ngap_PDUSessionID_constr_1,
#endif /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
        &asn_PER_type_Ngap_PDUSessionID_constr_1,
#endif /* !defined(ASN_DISABLE_UPER_SUPPORT) ||                                \
          !defined(ASN_DISABLE_APER_SUPPORT) */
#if !defined(ASN_DISABLE_JER_SUPPORT)
        0,
#endif /* !defined(ASN_DISABLE_JER_SUPPORT) */
        Ngap_PDUSessionID_constraint},
    0,
    0, /* No members */
    0  /* No specifics */
};
