...
public:
    ...
    SmallDataRateControlTimeUnit_anyOf::eSmallDataRateControlTimeUnit_anyOf getValue() const;
    void setValue(SmallDataRateControlTimeUnit_anyOf::eSmallDataRateControlTimeUnit_anyOf value);
...
protected:
    SmallDataRateControlTimeUnit_anyOf::eSmallDataRateControlTimeUnit_anyOf m_value = SmallDataRateControlTimeUnit_anyOf::eSmallDataRateControlTimeUnit_anyOf::INVALID_VALUE_OPENAPI_GENERATED;
};
