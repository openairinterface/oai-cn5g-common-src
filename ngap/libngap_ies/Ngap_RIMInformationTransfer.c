...
asn_TYPE_member_t asn_MBR_Ngap_RIMInformationTransfer_1[] = {
    {ATF_POINTER,
     0,
     offsetof(struct Ngap_RIMInformationTransfer, targetRANNodeID_RIM),
    ...
    {ATF_POINTER,
     0,
     offsetof(struct Ngap_RIMInformationTransfer, sourceRANNodeID),
    ...
    {ATF_POINTER,
     0,
     offsetof(struct Ngap_RIMInformationTransfer, rIMInformation),
    ...
    {ATF_POINTER,
     1,
     offsetof(struct Ngap_RIMInformationTransfer, iE_Extensions),
