...
public:
    ...
    /// 
    /// </summary>
    oai::model::SmsfInfo getSmsfInfo3GppAccess() const;
    void setSmsfInfo3GppAccess(oai::model::SmsfInfo const& value);
    bool smsfInfo3GppAccessIsSet() const;
    void unsetSmsfInfo3GppAccess();
    /// <summary>
    /// 
    /// </summary>
    oai::model::SmsfInfo getSmsfInfoNon3GppAccess() const;
    void setSmsfInfoNon3GppAccess(oai::model::SmsfInfo const& value);
...
protected:
    oai::model::SmsfInfo m_SmsfInfo3GppAccess;
    bool m_SmsfInfo3GppAccessIsSet;
    oai::model::SmsfInfo m_SmsfInfoNon3GppAccess;
