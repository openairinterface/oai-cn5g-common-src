...
bool LocationQoS::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    ...
    {
        const std::vector<oai::model::MinorLocationQoS>& value = m_MinorLocQoses;
        ...
        { // Recursive validation of array elements
            ...
            int i = 0;
            for (const oai::model::MinorLocationQoS& value : value)
            { 
...
oai::model::ResponseTime LocationQoS::getResponseTime() const
{
    return m_ResponseTime;
}
void LocationQoS::setResponseTime(oai::model::ResponseTime const& value)
{
...
std::vector<oai::model::MinorLocationQoS> LocationQoS::getMinorLocQoses() const
{
    return m_MinorLocQoses;
}
void LocationQoS::setMinorLocQoses(std::vector<oai::model::MinorLocationQoS> const& value)
{
...
oai::model::LcsQosClass LocationQoS::getLcsQosClass() const
{
    return m_LcsQosClass;
}
void LocationQoS::setLcsQosClass(oai::model::LcsQosClass const& value)
{
    m_LcsQosClass = value;
