...
bool AuthenticationInfoRequest::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "AuthenticationInfoRequest" : pathPrefix;
...
bool AuthenticationInfoRequest::operator==(const AuthenticationInfoRequest& rhs) const
{
    return
...
void AuthenticationInfoRequest::setServingNetworkName(std::string const& value)
{
    m_ServingNetworkName = value;
}
oai::_3gpp::model::ResynchronizationInfo AuthenticationInfoRequest::getResynchronizationInfo() const
{
    return m_ResynchronizationInfo;
}
void AuthenticationInfoRequest::setResynchronizationInfo(oai::_3gpp::model::ResynchronizationInfo const& value)
{
...
std::vector<oai::_3gpp::model::std::string> AuthenticationInfoRequest::getCellCagInfo() const
{
    return m_CellCagInfo;
}
void AuthenticationInfoRequest::setCellCagInfo(std::vector<oai::_3gpp::model::std::string> const& value)
{
    m_CellCagInfo = value;
