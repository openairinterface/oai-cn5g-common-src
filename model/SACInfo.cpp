...
bool SACInfo::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
...
bool SACInfo::operator==(const SACInfo& rhs) const
{
    ...
    ((!numericValNumUesIsSet() && !rhs.numericValNumUesIsSet()) || (numericValNumUesIsSet() && rhs.numericValNumUesIsSet() && getNumericValNumUes() == rhs.getNumericValNumUes())) &&
    
    
    ((!numericValNumPduSessIsSet() && !rhs.numericValNumPduSessIsSet()) || (numericValNumPduSessIsSet() && rhs.numericValNumPduSessIsSet() && getNumericValNumPduSess() == rhs.getNumericValNumPduSess())) &&
    
    
    ((!percValueNumUesIsSet() && !rhs.percValueNumUesIsSet()) || (percValueNumUesIsSet() && rhs.percValueNumUesIsSet() && getPercValueNumUes() == rhs.getPercValueNumUes())) &&
    
    
    ((!percValueNumPduSessIsSet() && !rhs.percValueNumPduSessIsSet()) || (percValueNumPduSessIsSet() && rhs.percValueNumPduSessIsSet() && getPercValueNumPduSess() == rhs.getPercValueNumPduSess()))
