...
bool SmscData::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
...
bool SmscData::operator==(const SmscData& rhs) const
{
    ...
    ((!smscMapAddressIsSet() && !rhs.smscMapAddressIsSet()) || (smscMapAddressIsSet() && rhs.smscMapAddressIsSet() && getSmscMapAddress() == rhs.getSmscMapAddress())) &&
    
    
    ((!smscDiameterAddressIsSet() && !rhs.smscDiameterAddressIsSet()) || (smscDiameterAddressIsSet() && rhs.smscDiameterAddressIsSet() && getSmscDiameterAddress() == rhs.getSmscDiameterAddress()))
...
oai::_3gpp::model::NetworkNodeDiameterAddress_1 SmscData::getSmscDiameterAddress() const
{
    return m_SmscDiameterAddress;
}
void SmscData::setSmscDiameterAddress(oai::_3gpp::model::NetworkNodeDiameterAddress_1 const& value)
{
