...
public:
    ...
    void setValue(CreditManagementStatus_anyOf::eCreditManagementStatus_anyOf value);
    
    friend void to_json(nlohmann::json& j, const CreditManagementStatus_anyOf& o);
    friend void from_json(const nlohmann::json& j, CreditManagementStatus_anyOf& o);
protected:
    CreditManagementStatus_anyOf::eCreditManagementStatus_anyOf m_value = CreditManagementStatus_anyOf::eCreditManagementStatus_anyOf::INVALID_VALUE_OPENAPI_GENERATED;
};
