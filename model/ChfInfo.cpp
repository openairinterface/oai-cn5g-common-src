...
std::vector<oai::model::SupiRange> ChfInfo::getSupiRangeList() const
{
    return m_SupiRangeList;
}
void ChfInfo::setSupiRangeList(std::vector<oai::model::SupiRange> const& value)
{
...
std::vector<oai::model::IdentityRange> ChfInfo::getGpsiRangeList() const
{
    return m_GpsiRangeList;
}
void ChfInfo::setGpsiRangeList(std::vector<oai::model::IdentityRange> const& value)
{
...
std::vector<oai::model::PlmnRange> ChfInfo::getPlmnRangeList() const
{
    return m_PlmnRangeList;
}
void ChfInfo::setPlmnRangeList(std::vector<oai::model::PlmnRange> const& value)
{
