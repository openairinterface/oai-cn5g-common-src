...
oai::_3gpp::model::HssAuthType HssAuthenticationInfoRequest::getHssAuthType() const
{
    return m_HssAuthType;
}
void HssAuthenticationInfoRequest::setHssAuthType(oai::_3gpp::model::HssAuthType const& value)
{
    m_HssAuthType = value;
}
...
oai::_3gpp::model::NodeType HssAuthenticationInfoRequest::getRequestingNodeType() const
{
    return m_RequestingNodeType;
}
void HssAuthenticationInfoRequest::setRequestingNodeType(oai::_3gpp::model::NodeType const& value)
{
...
oai::_3gpp::model::PlmnId HssAuthenticationInfoRequest::getServingNetworkId() const
{
    return m_ServingNetworkId;
}
void HssAuthenticationInfoRequest::setServingNetworkId(oai::_3gpp::model::PlmnId const& value)
{
...
oai::_3gpp::model::ResynchronizationInfo HssAuthenticationInfoRequest::getResynchronizationInfo() const
{
    return m_ResynchronizationInfo;
}
void HssAuthenticationInfoRequest::setResynchronizationInfo(oai::_3gpp::model::ResynchronizationInfo const& value)
{
...
oai::_3gpp::model::AccessNetworkId HssAuthenticationInfoRequest::getAnId() const
{
    return m_AnId;
}
void HssAuthenticationInfoRequest::setAnId(oai::_3gpp::model::AccessNetworkId const& value)
{
    m_AnId = value;
    m_AnIdIsSet = true;
}
