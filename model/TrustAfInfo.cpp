...
bool TrustAfInfo::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    ...
    {
        const std::vector<oai::model::SnssaiInfoItem>& value = m_SNssaiInfoList;
        ...
        { // Recursive validation of array elements
            ...
            int i = 0;
            for (const oai::model::SnssaiInfoItem& value : value)
            { 
...
bool TrustAfInfo::operator==(const TrustAfInfo& rhs) const
{
    ...
    ((!mappingIndIsSet() && !rhs.mappingIndIsSet()) || (mappingIndIsSet() && rhs.mappingIndIsSet() && isMappingInd() == rhs.isMappingInd()))
...
void to_json(nlohmann::json& j, const TrustAfInfo& o)
{
    ...
    if(o.mappingIndIsSet())
        j["mappingInd"] = o.m_MappingInd;
...
std::vector<oai::model::SnssaiInfoItem> TrustAfInfo::getSNssaiInfoList() const
{
    return m_SNssaiInfoList;
}
void TrustAfInfo::setSNssaiInfoList(std::vector<oai::model::SnssaiInfoItem> const& value)
{
...
std::vector<oai::model::AfEvent> TrustAfInfo::getAfEvents() const
{
    return m_AfEvents;
}
void TrustAfInfo::setAfEvents(std::vector<oai::model::AfEvent> const& value)
{
    m_AfEvents = value;
