...
bool TraceDepth_anyOf::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "TraceDepth_anyOf" : pathPrefix;

    
    if (m_value == TraceDepth_anyOf::eTraceDepth_anyOf::INVALID_VALUE_OPENAPI_GENERATED)
    {
        success = false;
...
void from_json(const nlohmann::json& j, TraceDepth_anyOf& o)
{
    ...
    if (s == "MINIMUM") {
     ...
     o.setValue(TraceDepth_anyOf::eTraceDepth_anyOf::MINIMUM_WO_VENDOR_EXTENSION);
    } 
     ...
     o.setValue(TraceDepth_anyOf::eTraceDepth_anyOf::MAXIMUM_WO_VENDOR_EXTENSION);
    }  else {
     std::stringstream ss;
