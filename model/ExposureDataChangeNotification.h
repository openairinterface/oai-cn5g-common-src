...
public:
    ...
    void setAccessAndMobilityData(oai::_3gpp::model::AccessAndMobilityData const& value);
    bool accessAndMobilityDataIsSet() const;
    void unsetAccessAndMobilityData();
    /// <summary>
    /// 
    /// </summary>
    std::vector<oai::_3gpp::model::PduSessionManagementData> getPduSessionManagementData() const;
    void setPduSessionManagementData(std::vector<oai::_3gpp::model::PduSessionManagementData> const& value);
...
protected:
    ...
    std::vector<oai::_3gpp::model::PduSessionManagementData> m_PduSessionManagementData;
