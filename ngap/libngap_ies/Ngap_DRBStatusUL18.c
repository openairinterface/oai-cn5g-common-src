...
asn_TYPE_member_t asn_MBR_Ngap_DRBStatusUL18_1[] = {
    {ATF_POINTER,
     0,
     offsetof(struct Ngap_DRBStatusUL18, uL_COUNTValue),
    ...
    {ATF_POINTER,
     2,
     offsetof(struct Ngap_DRBStatusUL18, receiveStatusOfUL_PDCP_SDUs),
    ...
    {ATF_POINTER,
     1,
     offsetof(struct Ngap_DRBStatusUL18, iE_Extension),
     (ASN_TAG_CLASS_CONTEXT | (2 << 2)),
     -1, /* IMPLICIT tag at current level */
     &asn_DEF_Ngap_ProtocolExtensionContainer_12929P63,
     0,
     {
#if !defined(ASN_DISABLE_OER_SUPPORT)
         0,
