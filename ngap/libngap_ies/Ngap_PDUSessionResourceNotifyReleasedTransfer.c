...
static asn_TYPE_member_t
    asn_MBR_Ngap_PDUSessionResourceNotifyReleasedTransfer_1[] = {
        {ATF_POINTER,
         0,
         offsetof(struct Ngap_PDUSessionResourceNotifyReleasedTransfer, cause),
        ...
        {ATF_POINTER,
         ...
         &asn_DEF_Ngap_ProtocolExtensionContainer_12929P240,
         0,
         {
#if !defined(ASN_DISABLE_OER_SUPPORT)
             0,
...
static const int asn_MAP_Ngap_PDUSessionResourceNotifyReleasedTransfer_oms_1[] =
    {1};
...
asn_TYPE_descriptor_t asn_DEF_Ngap_PDUSessionResourceNotifyReleasedTransfer = {
    ...
    sizeof(asn_DEF_Ngap_PDUSessionResourceNotifyReleasedTransfer_tags_1) /
        sizeof(asn_DEF_Ngap_PDUSessionResourceNotifyReleasedTransfer_tags_1
                   [0]),                                          /* 1 */
    asn_DEF_Ngap_PDUSessionResourceNotifyReleasedTransfer_tags_1, /* Same as
                                                                     above */
    sizeof(asn_DEF_Ngap_PDUSessionResourceNotifyReleasedTransfer_tags_1) /
        sizeof(asn_DEF_Ngap_PDUSessionResourceNotifyReleasedTransfer_tags_1
                   [0]), /* 1 */
    ...
    asn_MBR_Ngap_PDUSessionResourceNotifyReleasedTransfer_1,
    2, /* Elements count */
    &asn_SPC_Ngap_PDUSessionResourceNotifyReleasedTransfer_specs_1 /* Additional
                                                                      specs */
};
