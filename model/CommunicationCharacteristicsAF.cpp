...
bool CommunicationCharacteristicsAF::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "CommunicationCharacteristicsAF" : pathPrefix;

                
    return success;
}

bool CommunicationCharacteristicsAF::operator==(const CommunicationCharacteristicsAF& rhs) const
{
    return
...
void CommunicationCharacteristicsAF::setMaximumResponseTime(int32_t const value)
{
