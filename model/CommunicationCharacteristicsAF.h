...
public:
    ...
    friend  void to_json(nlohmann::json& j, const CommunicationCharacteristicsAF& o);
    friend  void from_json(const nlohmann::json& j, CommunicationCharacteristicsAF& o);
protected:
