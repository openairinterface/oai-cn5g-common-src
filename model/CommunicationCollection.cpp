...
bool CommunicationCollection::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "CommunicationCollection" : pathPrefix;
...
bool CommunicationCollection::operator==(const CommunicationCollection& rhs) const
{
    return
