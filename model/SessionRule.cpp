...
bool SessionRule::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "SessionRule" : pathPrefix;
...
bool SessionRule::operator==(const SessionRule& rhs) const
{
    ...
    ((!authSessAmbrIsSet() && !rhs.authSessAmbrIsSet()) || (authSessAmbrIsSet() && rhs.authSessAmbrIsSet() && getAuthSessAmbr() == rhs.getAuthSessAmbr())) &&
    
    
    ((!authDefQosIsSet() && !rhs.authDefQosIsSet()) || (authDefQosIsSet() && rhs.authDefQosIsSet() && getAuthDefQos() == rhs.getAuthDefQos())) &&
...
oai::_3gpp::model::Ambr SessionRule::getAuthSessAmbr() const
{
    return m_AuthSessAmbr;
}
void SessionRule::setAuthSessAmbr(oai::_3gpp::model::Ambr const& value)
{
...
oai::_3gpp::model::AuthorizedDefaultQos SessionRule::getAuthDefQos() const
{
    return m_AuthDefQos;
}
void SessionRule::setAuthDefQos(oai::_3gpp::model::AuthorizedDefaultQos const& value)
{
    m_AuthDefQos = value;
