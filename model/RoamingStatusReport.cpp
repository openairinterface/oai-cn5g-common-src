...
bool RoamingStatusReport::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "RoamingStatusReport" : pathPrefix;
...
oai::model::PlmnId RoamingStatusReport::getNewServingPlmn() const
{
    return m_NewServingPlmn;
}
void RoamingStatusReport::setNewServingPlmn(oai::model::PlmnId const& value)
{
    m_NewServingPlmn = value;
}
oai::model::AccessType RoamingStatusReport::getAccessType() const
{
    return m_AccessType;
}
void RoamingStatusReport::setAccessType(oai::model::AccessType const& value)
{
    m_AccessType = value;
