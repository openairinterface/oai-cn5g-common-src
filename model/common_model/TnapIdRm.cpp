...
bool TnapIdRm::validate(std::stringstream &msg,
...
bool TnapIdRm::operator!=(const TnapIdRm &rhs) const { return !(*this == rhs); }
...
std::string TnapIdRm::getSsId() const { return m_SsId; }
void TnapIdRm::setSsId(std::string const &value) {
  m_SsId = value;
  m_SsIdIsSet = true;
}
bool TnapIdRm::ssIdIsSet() const { return m_SsIdIsSet; }
void TnapIdRm::unsetSsId() { m_SsIdIsSet = false; }
std::string TnapIdRm::getBssId() const { return m_BssId; }
void TnapIdRm::setBssId(std::string const &value) {
  m_BssId = value;
  m_BssIdIsSet = true;
}
bool TnapIdRm::bssIdIsSet() const { return m_BssIdIsSet; }
void TnapIdRm::unsetBssId() { m_BssIdIsSet = false; }
std::string TnapIdRm::getCivicAddress() const { return m_CivicAddress; }
void TnapIdRm::setCivicAddress(std::string const &value) {
  m_CivicAddress = value;
  m_CivicAddressIsSet = true;
}
bool TnapIdRm::civicAddressIsSet() const { return m_CivicAddressIsSet; }
void TnapIdRm::unsetCivicAddress() { m_CivicAddressIsSet = false; }
