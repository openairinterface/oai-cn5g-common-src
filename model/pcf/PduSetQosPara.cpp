...
bool PduSetQosPara::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "PduSetQosPara" : pathPrefix;
...
oai::model::pcf::PduSetHandlingInfo PduSetQosPara::getPduSetHandlingInfo() const
{
    return m_PduSetHandlingInfo;
}
void PduSetQosPara::setPduSetHandlingInfo(oai::model::pcf::PduSetHandlingInfo const& value)
{
