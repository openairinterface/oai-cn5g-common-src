...
bool NcgiTai::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    ...
    /* CellList */ {
        const std::vector<oai::model::Ncgi>& value = m_CellList;
...
oai::model::Tai NcgiTai::getTai() const
{
    return m_Tai;
}
void NcgiTai::setTai(oai::model::Tai const& value)
{
    m_Tai = value;
}
std::vector<oai::model::Ncgi> NcgiTai::getCellList() const
{
    return m_CellList;
}
void NcgiTai::setCellList(std::vector<oai::model::Ncgi> const& value)
{
    m_CellList = value;
}
