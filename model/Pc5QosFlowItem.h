...
public:
    ...
    /// 
    /// </summary>
    oai::_3gpp::model::Pc5FlowBitRates getPc5FlowBitRates() const;
    void setPc5FlowBitRates(oai::_3gpp::model::Pc5FlowBitRates const& value);
...
protected:
    ...
    oai::_3gpp::model::Pc5FlowBitRates m_Pc5FlowBitRates;
