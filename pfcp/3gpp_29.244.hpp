...
inline void mac_address_dump_to(
  ...
  os.write(
      reinterpret_cast<const char*>(mac_address),
      size);
}
...
public:
 ...
 pfcp_ie(PFCP_IE_MAC_ADDRESS){
   ...
   memset(upper_destination_mac_address, 0, sizeof(upper_destination_mac_address));
   tlv.set_length(1);
   if (u1.bf.sour) {
    tlv.add_length(6);
    memcpy(source_mac_address, b.source_mac_address, sizeof(source_mac_address));
   }
   if (u1.bf.dest) {
    tlv.add_length(6);
    memcpy(destination_mac_address, b.destination_mac_address, sizeof(destination_mac_address));
   }
   if (u1.bf.sour && u1.bf.usou) {
    tlv.add_length(6);
    memcpy(upper_source_mac_address, b.upper_source_mac_address, sizeof(upper_source_mac_address));
   }
   if (u1.bf.dest && u1.bf.udes) {
    tlv.add_length(6);
    memcpy(upper_destination_mac_address, b.upper_destination_mac_address, sizeof(upper_destination_mac_address));
   }
 }
 //--------
 ...
 void dump_to(std::ostream& os) {
   ...
   if (u1.bf.dest) {
    mac_address_dump_to(os, destination_mac_address, sizeof(destination_mac_address));
   }
   if (u1.bf.sour && u1.bf.usou) {
    mac_address_dump_to(os, upper_source_mac_address, sizeof(upper_source_mac_address));
   }
   if (u1.bf.dest && u1.bf.udes) {
    mac_address_dump_to(os, upper_destination_mac_address, sizeof(upper_destination_mac_address));
   }
 }
 //--------
 void load_from(std::istream& is) {
   ...
   if (u1.bf.dest) {
    mac_address_load_from(is, destination_mac_address, sizeof(destination_mac_address));
   }
   if (u1.bf.sour && u1.bf.usou) {
    mac_address_load_from(is, upper_source_mac_address, sizeof(upper_source_mac_address));
   }
   if (u1.bf.dest && u1.bf.udes) {
    mac_address_load_from(is, upper_destination_mac_address, sizeof(upper_destination_mac_address));
   }
 }
 //--------
 void to_core_type(pfcp_ies_container& s) {
...
public:
 ...
 //--------
 explicit pfcp_ethertype_ie(const pfcp::ethertype_t& b) : pfcp_ie(PFCP_IE_ETHERTYPE){
 ...
 //--------
 explicit pfcp_ethertype_ie(const pfcp_tlv& t) : pfcp_ie(t) {
   ethertype = 0;
 };
 //--------
 void to_core_type(pfcp::ethertype_t& b) {
   b.ethertype = ethertype;
 }
 //--------
 void dump_to(std::ostream& os) {
   tlv.dump_to(os);
   auto be_ethertype = htobe16(ethertype);
   os.write(reinterpret_cast<const char*>(&be_ethertype), sizeof(be_ethertype));
 }
 //--------
 void load_from(std::istream& is) {
   //tlv.load_from(is);
...
public:
 ...
 void dump_to(std::ostream& os) {
   ...
   os.write(reinterpret_cast<const char*>(&be_ethernet_filter_id), sizeof(be_ethernet_filter_id));
 }
 //--------
 void load_from(std::istream& is) {
   //tlv.load_from(is);
   ...
   is.read(reinterpret_cast<char*>(&ethernet_filter_id), sizeof(ethernet_filter_id));
...
public:
 ...
 //--------
 explicit pfcp_ethernet_filter_properties_ie(const pfcp::ethernet_filter_properties_t&
...
public:
 ...
 //--------
 explicit pfcp_ethernet_pdu_session_information_ie(const
 ...
 //--------
 explicit pfcp_ethernet_pdu_session_information_ie(const pfcp_tlv& t) : pfcp_ie(t) {
   u1.b = 0;
 };
 //--------
