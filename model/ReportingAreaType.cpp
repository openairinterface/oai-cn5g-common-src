...
ReportingAreaType_anyOf::eReportingAreaType_anyOf ReportingAreaType::getEnumValue() const
{
    return m_value.getValue();
}

void ReportingAreaType::setEnumValue(ReportingAreaType_anyOf::eReportingAreaType_anyOf  value)
{
