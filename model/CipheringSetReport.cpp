...
bool CipheringSetReport::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "CipheringSetReport" : pathPrefix;
...
oai::_3gpp::model::StorageOutcome CipheringSetReport::getStorageOutcome() const
{
    return m_StorageOutcome;
}
void CipheringSetReport::setStorageOutcome(oai::_3gpp::model::StorageOutcome const& value)
{
