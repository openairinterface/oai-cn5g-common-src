...
public:
    ...
    /// 
    /// </summary>
    oai::model::AuthMethod getAuthenticationMethod() const;
    void setAuthenticationMethod(oai::model::AuthMethod const& value);
    /// <summary>
    /// 
    /// </summary>
    ...
    /// 
    /// </summary>
    oai::model::SequenceNumber getSequenceNumber() const;
    void setSequenceNumber(oai::model::SequenceNumber const& value);
    ...
    /// 
    /// </summary>
    oai::model::AuthMethod getN5gcAuthMethod() const;
    void setN5gcAuthMethod(oai::model::AuthMethod const& value);
...
protected:
    oai::model::AuthMethod m_AuthenticationMethod;
    ...
    oai::model::SequenceNumber m_SequenceNumber;
    ...
    oai::model::AuthMethod m_N5gcAuthMethod;
