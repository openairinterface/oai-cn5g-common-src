...
oai::_3gpp::model::PatchOperation PatchItem::getOp() const
{
    return m_Op;
}
void PatchItem::setOp(oai::_3gpp::model::PatchOperation const& value)
{
    m_Op = value;
}
...
oai::_3gpp::model::nlohmann::json PatchItem::getValue() const
{
    return m_Value;
}
void PatchItem::setValue(oai::_3gpp::model::nlohmann::json const& value)
{
    m_Value = value;
    m_ValueIsSet = true;
}
