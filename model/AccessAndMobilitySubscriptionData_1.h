...
public:
    ...
    /// 
    /// </summary>
    oai::model::Nssai_1 getNssai() const;
    void setNssai(oai::model::Nssai_1 const& value);
    ...
    /// 
    /// </summary>
    std::vector<oai::model::Area_1> getForbiddenAreas() const;
    void setForbiddenAreas(std::vector<oai::model::Area_1> const& value);
    bool forbiddenAreasIsSet() const;
    void unsetForbiddenAreas();
    /// <summary>
    /// 
    /// </summary>
    oai::model::ServiceAreaRestriction_1 getServiceAreaRestriction() const;
    void setServiceAreaRestriction(oai::model::ServiceAreaRestriction_1 const& value);
    ...
    /// 
    /// </summary>
    oai::model::SorInfo_1 getSorInfo() const;
    void setSorInfo(oai::model::SorInfo_1 const& value);
    ...
    /// 
    /// </summary>
    oai::model::UpuInfo_1 getUpuInfo() const;
    void setUpuInfo(oai::model::UpuInfo_1 const& value);
    ...
    /// 
    /// </summary>
    oai::model::MdtConfiguration_1 getMdtConfiguration() const;
    void setMdtConfiguration(oai::model::MdtConfiguration_1 const& value);
    ...
    /// 
    /// </summary>
    oai::model::CagData_1 getCagData() const;
    void setCagData(oai::model::CagData_1 const& value);
    ...
    /// 
    /// </summary>
    oai::model::ExpectedUeBehaviourData_1 getExpectedUeBehaviourList() const;
    void setExpectedUeBehaviourList(oai::model::ExpectedUeBehaviourData_1 const& value);
    ...
    /// 
    /// </summary>
    std::vector<oai::model::EdrxParameters_1> getEdrxParametersList() const;
    void setEdrxParametersList(std::vector<oai::model::EdrxParameters_1> const& value);
    bool edrxParametersListIsSet() const;
    void unsetEdrxParametersList();
    /// <summary>
    /// 
    /// </summary>
    std::vector<oai::model::PtwParameters_1> getPtwParametersList() const;
    void setPtwParametersList(std::vector<oai::model::PtwParameters_1> const& value);
    ...
    /// </summary>
    std::map<std::string, oai::model::PlmnRestriction_1> getAdjacentPlmnRestrictions() const;
    void setAdjacentPlmnRestrictions(std::map<std::string, oai::model::PlmnRestriction_1> const& value);
    bool adjacentPlmnRestrictionsIsSet() const;
    void unsetAdjacentPlmnRestrictions();
    /// <summary>
    /// 
    /// </summary>
    std::vector<oai::model::WirelineArea_1> getWirelineForbiddenAreas() const;
    void setWirelineForbiddenAreas(std::vector<oai::model::WirelineArea_1> const& value);
    bool wirelineForbiddenAreasIsSet() const;
    void unsetWirelineForbiddenAreas();
    /// <summary>
    /// 
    /// </summary>
    oai::model::WirelineServiceAreaRestriction_1 getWirelineServiceAreaRestriction() const;
    void setWirelineServiceAreaRestriction(oai::model::WirelineServiceAreaRestriction_1 const& value);
    bool wirelineServiceAreaRestrictionIsSet() const;
    void unsetWirelineServiceAreaRestriction();
    /// <summary>
    /// 
    /// </summary>
    std::vector<oai::model::PcfSelectionAssistanceInfo_1> getPcfSelectionAssistanceInfos() const;
    void setPcfSelectionAssistanceInfos(std::vector<oai::model::PcfSelectionAssistanceInfo_1> const& value);
    bool pcfSelectionAssistanceInfosIsSet() const;
    void unsetPcfSelectionAssistanceInfos();
    /// <summary>
    /// 
    /// </summary>
    oai::model::AerialUeSubscriptionInfo_1 getAerialUeSubInfo() const;
    void setAerialUeSubInfo(oai::model::AerialUeSubscriptionInfo_1 const& value);
...
protected:
    ...
    oai::model::Nssai_1 m_Nssai;
    bool m_NssaiIsSet;
    std::set<oai::model::RatType> m_RatRestrictions;
    bool m_RatRestrictionsIsSet;
    std::vector<oai::model::Area_1> m_ForbiddenAreas;
    bool m_ForbiddenAreasIsSet;
    oai::model::ServiceAreaRestriction_1 m_ServiceAreaRestriction;
    ...
    oai::model::ExpectedUeBehaviourData_1 m_ExpectedUeBehaviourList;
    ...
    std::vector<oai::model::EdrxParameters_1> m_EdrxParametersList;
    bool m_EdrxParametersListIsSet;
    std::vector<oai::model::PtwParameters_1> m_PtwParametersList;
    bool m_PtwParametersListIsSet;
    bool m_IabOperationAllowed;
    bool m_IabOperationAllowedIsSet;
    std::map<std::string, oai::model::PlmnRestriction_1> m_AdjacentPlmnRestrictions;
    bool m_AdjacentPlmnRestrictionsIsSet;
    std::vector<oai::model::WirelineArea_1> m_WirelineForbiddenAreas;
    bool m_WirelineForbiddenAreasIsSet;
    oai::model::WirelineServiceAreaRestriction_1 m_WirelineServiceAreaRestriction;
    bool m_WirelineServiceAreaRestrictionIsSet;
    std::vector<oai::model::PcfSelectionAssistanceInfo_1> m_PcfSelectionAssistanceInfos;
    bool m_PcfSelectionAssistanceInfosIsSet;
    oai::model::AerialUeSubscriptionInfo_1 m_AerialUeSubInfo;
