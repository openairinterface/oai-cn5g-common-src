...
public:
    ...
    /// </summary>
    std::map<std::string, oai::model::common::PresenceInfo> getPresenceInfoList() const;
    void setPresenceInfoList(std::map<std::string, oai::model::common::PresenceInfo> const& value);
