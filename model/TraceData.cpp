...
bool TraceData::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
...
oai::model::TraceDepth TraceData::getTraceDepth() const
{
    return m_TraceDepth;
}
void TraceData::setTraceDepth(oai::model::TraceDepth const& value)
{
    m_TraceDepth = value;
}
...
oai::model::Ipv6Addr TraceData::getCollectionEntityIpv6Addr() const
{
    return m_CollectionEntityIpv6Addr;
}
void TraceData::setCollectionEntityIpv6Addr(oai::model::Ipv6Addr const& value)
{
...
std::string TraceData::getTraceReportingConsumerUri() const
{
    return m_TraceReportingConsumerUri;
}
void TraceData::setTraceReportingConsumerUri(std::string const& value)
{
    m_TraceReportingConsumerUri = value;
    m_TraceReportingConsumerUriIsSet = true;
}
bool TraceData::traceReportingConsumerUriIsSet() const
{
    return m_TraceReportingConsumerUriIsSet;
}
void TraceData::unsetTraceReportingConsumerUri()
{
    m_TraceReportingConsumerUriIsSet = false;
}
