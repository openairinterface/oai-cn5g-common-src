...
bool N2InformationNotification::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "N2InformationNotification" : pathPrefix;
    ...
    {
        const std::vector<oai::model::SmfChangeInfo>& value = m_SmfChangeInfoList;
        ...
        { // Recursive validation of array elements
            const std::string oldValuePath = currentValuePath;
            int i = 0;
            for (const oai::model::SmfChangeInfo& value : value)
            { 
                const std::string currentValuePath = oldValuePath + "[" + std::to_string(i) + "]";
                        
        success = value.validate(msg, currentValuePath + ".smfChangeInfoList") && success;
...
bool N2InformationNotification::operator==(const N2InformationNotification& rhs) const
{
    return
    ...
    ((!toReleaseSessionListIsSet() && !rhs.toReleaseSessionListIsSet()) || (toReleaseSessionListIsSet() && rhs.toReleaseSessionListIsSet() && getToReleaseSessionList() == rhs.getToReleaseSessionList())) &&
    ...
    ((!notifyReasonIsSet() && !rhs.notifyReasonIsSet()) || (notifyReasonIsSet() && rhs.notifyReasonIsSet() && getNotifyReason() == rhs.getNotifyReason())) &&
    
    
    ((!smfChangeInfoListIsSet() && !rhs.smfChangeInfoListIsSet()) || (smfChangeInfoListIsSet() && rhs.smfChangeInfoListIsSet() && getSmfChangeInfoList() == rhs.getSmfChangeInfoList())) &&
    
    
    ((!ranNodeIdIsSet() && !rhs.ranNodeIdIsSet()) || (ranNodeIdIsSet() && rhs.ranNodeIdIsSet() && getRanNodeId() == rhs.getRanNodeId())) &&
    
    
    ((!initialAmfNameIsSet() && !rhs.initialAmfNameIsSet()) || (initialAmfNameIsSet() && rhs.initialAmfNameIsSet() && getInitialAmfName() == rhs.getInitialAmfName())) &&
    ...
    ((!notifySourceNgRanIsSet() && !rhs.notifySourceNgRanIsSet()) || (notifySourceNgRanIsSet() && rhs.notifySourceNgRanIsSet() && isNotifySourceNgRan() == rhs.isNotifySourceNgRan()))
...
oai::model::N2InfoContainer N2InformationNotification::getN2InfoContainer() const
{
    return m_N2InfoContainer;
}
void N2InformationNotification::setN2InfoContainer(oai::model::N2InfoContainer const& value)
{
...
std::vector<int32_t> N2InformationNotification::getToReleaseSessionList() const
{
    return m_ToReleaseSessionList;
}
void N2InformationNotification::setToReleaseSessionList(std::vector<int32_t> const value)
{
...
oai::model::N2InfoNotifyReason N2InformationNotification::getNotifyReason() const
{
    return m_NotifyReason;
}
void N2InformationNotification::setNotifyReason(oai::model::N2InfoNotifyReason const& value)
{
...
std::vector<oai::model::SmfChangeInfo> N2InformationNotification::getSmfChangeInfoList() const
{
    return m_SmfChangeInfoList;
}
void N2InformationNotification::setSmfChangeInfoList(std::vector<oai::model::SmfChangeInfo> const& value)
{
...
oai::model::GlobalRanNodeId N2InformationNotification::getRanNodeId() const
{
    return m_RanNodeId;
}
void N2InformationNotification::setRanNodeId(oai::model::GlobalRanNodeId const& value)
{
    m_RanNodeId = value;
...
oai::model::Ipv6Addr N2InformationNotification::getAnN2IPv6Addr() const
{
    return m_AnN2IPv6Addr;
}
void N2InformationNotification::setAnN2IPv6Addr(oai::model::Ipv6Addr const& value)
{
...
oai::model::Guami N2InformationNotification::getGuami() const
{
    return m_Guami;
}
void N2InformationNotification::setGuami(oai::model::Guami const& value)
{
    m_Guami = value;
    m_GuamiIsSet = true;
}
