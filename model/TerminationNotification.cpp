...
oai::_3gpp::model::SmPolicyAssociationReleaseCause TerminationNotification::getCause() const
{
    return m_Cause;
}
void TerminationNotification::setCause(oai::_3gpp::model::SmPolicyAssociationReleaseCause const& value)
{
    m_Cause = value;
}
