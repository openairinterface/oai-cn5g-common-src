...
public:
    ...
    /// 
    /// </summary>
    std::vector<oai::model::AllowedNssai> getAllowedNssaiList() const;
    void setAllowedNssaiList(std::vector<oai::model::AllowedNssai> const& value);
    ...
    /// 
    /// </summary>
    oai::model::NsiInformation getNsiInformation() const;
    void setNsiInformation(oai::model::NsiInformation const& value);
    ...
    /// 
    /// </summary>
    std::vector<oai::model::Snssai> getTargetNssai() const;
    void setTargetNssai(std::vector<oai::model::Snssai> const& value);
    ...
    /// 
    /// </summary>
    std::vector<oai::model::MappingOfSnssai> getMappingOfNssai() const;
    void setMappingOfNssai(std::vector<oai::model::MappingOfSnssai> const& value);
    ...
    /// </summary>
    std::map<std::string, oai::model::SnssaiInfo> getSnssaiInfoRspData() const;
    void setSnssaiInfoRspData(std::map<std::string, oai::model::SnssaiInfo> const& value);
...
protected:
    std::vector<oai::model::AllowedNssai> m_AllowedNssaiList;
    ...
    oai::model::NsiInformation m_NsiInformation;
    ...
    std::vector<oai::model::Snssai> m_TargetNssai;
    bool m_TargetNssaiIsSet;
    std::vector<oai::model::NsagInfo> m_NsagInfos;
    bool m_NsagInfosIsSet;
    std::vector<oai::model::MappingOfSnssai> m_MappingOfNssai;
    bool m_MappingOfNssaiIsSet;
    std::map<std::string, oai::model::SnssaiInfo> m_SnssaiInfoRspData;
