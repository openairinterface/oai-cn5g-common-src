...
public:
    ...
    /// 
    /// </summary>
    std::vector<oai::_3gpp::model::ServiceExperienceInfoPerFlow> getSvcExpPerFlows() const;
    void setSvcExpPerFlows(std::vector<oai::_3gpp::model::ServiceExperienceInfoPerFlow> const& value);
    /// <summary>
    /// 
    /// </summary>
