...
//------------------------------------------------------------------------------
uint64_t HandoverRequest::getAmfUeNgapId() const { return m_AmfUeNgapId.get(); }
...
//------------------------------------------------------------------------------
void HandoverRequest::setCause(const Ngap_Cause_PR &causePresent,
                               const long &value) {
  Ngap_HandoverRequestIEs_t *ie =
      (Ngap_HandoverRequestIEs_t *)calloc(1, sizeof(Ngap_HandoverRequestIEs_t));
...
//------------------------------------------------------------------------------
void HandoverRequest::setUeAggregateMaximumBitRate(const long &bitRateDl,
...
//------------------------------------------------------------------------------
void HandoverRequest::setGuami(const PlmnId &plmnId,
                               const AmfRegionId &amfRegionId,
                               const AmfSetId &amfSetId,
                               const AmfPointer &amfPointer) {
  Ngap_HandoverRequestIEs_t *ie =
      (Ngap_HandoverRequestIEs_t *)calloc(1, sizeof(Ngap_HandoverRequestIEs_t));
...
//------------------------------------------------------------------------------
void HandoverRequest::setGuami(const std::string &mcc, const std::string &mnc,
...
//------------------------------------------------------------------------------
void HandoverRequest::setGuami(const std::string &mcc, const std::string &mnc,
                               uint8_t regionId, uint16_t setId,
                               uint8_t pointer) {
  Ngap_HandoverRequestIEs_t *ie =
      (Ngap_HandoverRequestIEs_t *)calloc(1, sizeof(Ngap_HandoverRequestIEs_t));
  ie->id = Ngap_ProtocolIE_ID_id_GUAMI;
...
void HandoverRequest::setPduSessionResourceSetupList(
  ...
  for (int i = 0; i < list.size(); i++) {
    ...
    resource_setup_item.set(pdu_session_id, s_nssai,
...
void HandoverRequest::setSourceToTargetTransparentContainer(
  ...
  ngap_utils::octet_string_copy(m_SourceToTargetTransparentContainer,
                                sourceTotarget);
  Ngap_HandoverRequestIEs_t *ie =
      (Ngap_HandoverRequestIEs_t *)calloc(1, sizeof(Ngap_HandoverRequestIEs_t));
