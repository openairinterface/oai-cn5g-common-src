...
public:
    ...
    /// 
    /// </summary>
    std::vector<oai::model::pcf::QueryParamCombination> getQueryParamCombinationList() const;
    void setQueryParamCombinationList(std::vector<oai::model::pcf::QueryParamCombination> const& value);
...
protected:
    ...
    std::vector<oai::model::pcf::QueryParamCombination> m_QueryParamCombinationList;
