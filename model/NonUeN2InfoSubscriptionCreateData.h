...
public:
    ...
    void setGlobalRanNodeList(std::vector<oai::_3gpp::model::GlobalRanNodeId> const& value);
    bool globalRanNodeListIsSet() const;
    void unsetGlobalRanNodeList();
    /// <summary>
    /// 
    /// </summary>
    std::vector<oai::_3gpp::model::AccessType> getAnTypeList() const;
    void setAnTypeList(std::vector<oai::_3gpp::model::AccessType> const& value);
...
protected:
    ...
    std::vector<oai::_3gpp::model::AccessType> m_AnTypeList;
