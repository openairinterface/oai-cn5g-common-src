...
asn_TYPE_member_t asn_MBR_Ngap_CoreNetworkAssistanceInformationForInactive_1[] = {
	{ ATF_POINTER, 0, offsetof(struct Ngap_CoreNetworkAssistanceInformationForInactive, uEIdentityIndexValue),
	...
	{ ATF_POINTER, 0, offsetof(struct Ngap_CoreNetworkAssistanceInformationForInactive, tAIListForInactive),
	...
	{ ATF_POINTER, 1, offsetof(struct Ngap_CoreNetworkAssistanceInformationForInactive, iE_Extensions),
		...
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_Ngap_ProtocolExtensionContainer_12929P45,
		0,
		{
#if !defined(ASN_DISABLE_OER_SUPPORT)
			0,
