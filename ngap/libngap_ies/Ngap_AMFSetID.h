...
/* Implementation */
extern asn_oer_constraints_t asn_OER_type_Ngap_AMFSetID_constr_1;
...
cbor_type_decoder_f Ngap_AMFSetID_decode_cbor;
cbor_type_encoder_f Ngap_AMFSetID_encode_cbor;
