...
bool PointUncertaintyCircle_allOf::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "PointUncertaintyCircle_allOf" : pathPrefix;
...
bool PointUncertaintyCircle_allOf::operator==(const PointUncertaintyCircle_allOf& rhs) const
{
    return
...
oai::_3gpp::model::GeographicalCoordinates PointUncertaintyCircle_allOf::getPoint() const
{
    return m_Point;
}
void PointUncertaintyCircle_allOf::setPoint(oai::_3gpp::model::GeographicalCoordinates const& value)
{
    m_Point = value;
}
