...
std::vector<oai::_3gpp::model::GeographicArea> AfExternal::getAllowedGeographicArea() const
{
    return m_AllowedGeographicArea;
}
void AfExternal::setAllowedGeographicArea(std::vector<oai::_3gpp::model::GeographicArea> const& value)
{
...
oai::_3gpp::model::PrivacyCheckRelatedAction AfExternal::getPrivacyCheckRelatedAction() const
{
    return m_PrivacyCheckRelatedAction;
}
void AfExternal::setPrivacyCheckRelatedAction(oai::_3gpp::model::PrivacyCheckRelatedAction const& value)
{
...
void AfExternal::setValidTimePeriod(oai::_3gpp::model::ValidTimePeriod const& value)
{
