...
public:
    ...
    /// 
    /// </summary>
    std::vector<oai::model::SnssaiEasdfInfoItem> getSNssaiEasdfInfoList() const;
    void setSNssaiEasdfInfoList(std::vector<oai::model::SnssaiEasdfInfoItem> const& value);
    bool sNssaiEasdfInfoListIsSet() const;
    void unsetSNssaiEasdfInfoList();
    /// <summary>
    /// 
    /// </summary>
    std::vector<oai::model::IpAddr> getEasdfN6IpAddressList() const;
    void setEasdfN6IpAddressList(std::vector<oai::model::IpAddr> const& value);
    bool easdfN6IpAddressListIsSet() const;
    void unsetEasdfN6IpAddressList();
    /// <summary>
    /// 
    /// </summary>
    std::vector<oai::model::IpAddr> getUpfN6IpAddressList() const;
    void setUpfN6IpAddressList(std::vector<oai::model::IpAddr> const& value);
...
protected:
    std::vector<oai::model::SnssaiEasdfInfoItem> m_SNssaiEasdfInfoList;
    bool m_SNssaiEasdfInfoListIsSet;
    std::vector<oai::model::IpAddr> m_EasdfN6IpAddressList;
    bool m_EasdfN6IpAddressListIsSet;
    std::vector<oai::model::IpAddr> m_UpfN6IpAddressList;
