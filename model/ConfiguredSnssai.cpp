...
bool ConfiguredSnssai::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "ConfiguredSnssai" : pathPrefix;

        
    if (!m_ConfiguredSnssai.validate(msg, _pathPrefix + ".configuredSnssai")) {
        msg << _pathPrefix << ": ConfiguredSnssai is invalid;";
        success = false;
    }    
    return success;
}
...
oai::model::Snssai ConfiguredSnssai::getConfiguredSnssai() const
{
    return m_ConfiguredSnssai;
}
void ConfiguredSnssai::setConfiguredSnssai(oai::model::Snssai const& value)
{
    m_ConfiguredSnssai = value;
}
oai::model::Snssai ConfiguredSnssai::getMappedHomeSnssai() const
{
    return m_MappedHomeSnssai;
}
void ConfiguredSnssai::setMappedHomeSnssai(oai::model::Snssai const& value)
{
