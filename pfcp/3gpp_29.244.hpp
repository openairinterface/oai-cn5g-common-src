...
inline void mac_address_dump_to(
    std::ostream& os, const uint8_t mac_address[], int size) {
  if (size <= 0) {
    return;
  }
...
inline void mac_address_load_from(
    std::istream& is, uint8_t mac_address[], int size) {
  if (size <= 0) {
    return;
  }
...
class pfcp_measurement_period_ie : public pfcp_ie {
 public:
  ...
  void load_from(std::istream& is) {
    ...
    is.read(
        reinterpret_cast<char*>(&measurement_period),
 ...
 public:
  ...
  void dump_to(std::ostream& os) {
    ...
    if (u1.bf.tonop) {
      ...
      os.write(
          reinterpret_cast<const char*>(&be_total_nop), sizeof(be_total_nop));
    }
    if (u1.bf.ulnop) {
      auto be_uplink_nop = htobe64(uplink_nop);
      os.write(
          reinterpret_cast<const char*>(&be_uplink_nop), sizeof(be_uplink_nop));
    }
    if (u1.bf.dlnop) {
      auto be_downlink_nop = htobe64(downlink_nop);
      os.write(
          reinterpret_cast<const char*>(&be_downlink_nop),
...
class pfcp_time_of_first_packet_ie : public pfcp_ie {
 public:
  ...
  void dump_to(std::ostream& os) {
    ...
    os.write(
        reinterpret_cast<const char*>(&be_time_of_first_packet),
  ...
  void load_from(std::istream& is) {
    ...
    is.read(
        reinterpret_cast<char*>(&time_of_first_packet),
...
class pfcp_time_of_last_packet_ie : public pfcp_ie {
 public:
  ...
  void dump_to(std::ostream& os) {
    ...
    os.write(
        reinterpret_cast<const char*>(&be_time_of_last_packet),
  ...
  void load_from(std::istream& is) {
    ...
    is.read(
        reinterpret_cast<char*>(&time_of_last_packet),
...
class pfcp_start_time_ie : public pfcp_ie {
 public:
  ...
  void dump_to(std::ostream& os) {
    ...
    os.write(
        reinterpret_cast<const char*>(&be_start_time), sizeof(be_start_time));
  }
  //--------
  void load_from(std::istream& is) {
    // tlv.load_from(is);
 ...
 public:
  ...
  void dump_to(std::ostream& os) {
    ...
    if (u1.bf.ulpr) {
      ...
      os.write(
          reinterpret_cast<const char*>(&be_maximum_uplink_packet_rate),
    ...
    if (u1.bf.dlpr) {
      ...
      os.write(
          reinterpret_cast<const char*>(&be_maximum_downlink_packet_rate),
  ...
  void load_from(std::istream& is) {
    ...
    if (u1.bf.ulpr) {
      is.read(
          reinterpret_cast<char*>(&maximum_uplink_packet_rate),
    ...
    if (u1.bf.dlpr) {
      is.read(
          reinterpret_cast<char*>(&maximum_downlink_packet_rate),
...
class pfcp_mac_address_ie : public pfcp_ie {
 public:
  ...
  explicit pfcp_mac_address_ie(const pfcp::mac_address_t& b)
    ...
    memset(
        upper_destination_mac_address, 0,
        sizeof(upper_destination_mac_address));
    tlv.set_length(1);
    if (u1.bf.sour) {
      tlv.add_length(6);
      memcpy(
          source_mac_address, b.source_mac_address, sizeof(source_mac_address));
    }
    if (u1.bf.dest) {
      tlv.add_length(6);
      memcpy(
          destination_mac_address, b.destination_mac_address,
          sizeof(destination_mac_address));
    }
    if (u1.bf.sour && u1.bf.usou) {
      tlv.add_length(6);
      memcpy(
          upper_source_mac_address, b.upper_source_mac_address,
          sizeof(upper_source_mac_address));
    }
    if (u1.bf.dest && u1.bf.udes) {
      tlv.add_length(6);
      memcpy(
          upper_destination_mac_address, b.upper_destination_mac_address,
          sizeof(upper_destination_mac_address));
    }
  }
  //--------
  ...
  void dump_to(std::ostream& os) {
    uint16_t check_length = 1;
    if (u1.bf.sour) check_length += 6;
    if (u1.bf.dest) check_length += 6;
    if (u1.bf.sour && u1.bf.usou) check_length += 6;
    if (u1.bf.dest && u1.bf.udes) check_length += 6;
    tlv.set_length(check_length);
    tlv.dump_to(os);
    os.write(reinterpret_cast<const char*>(&u1.b), sizeof(u1.b));
    ...
    if (u1.bf.dest) {
      mac_address_dump_to(
          os, destination_mac_address, sizeof(destination_mac_address));
    }
    if (u1.bf.sour && u1.bf.usou) {
      mac_address_dump_to(
          os, upper_source_mac_address, sizeof(upper_source_mac_address));
    }
    if (u1.bf.dest && u1.bf.udes) {
      mac_address_dump_to(
          os, upper_destination_mac_address,
          sizeof(upper_destination_mac_address));
    }
  }
  //--------
  void load_from(std::istream& is) {
    ...
    if (u1.bf.dest) {
      mac_address_load_from(
          is, destination_mac_address, sizeof(destination_mac_address));
    }
    if (u1.bf.sour && u1.bf.usou) {
      mac_address_load_from(
          is, upper_source_mac_address, sizeof(upper_source_mac_address));
    }
    if (u1.bf.dest && u1.bf.udes) {
      mac_address_load_from(
          is, upper_destination_mac_address,
          sizeof(upper_destination_mac_address));
    }
  }
  //--------
...
class pfcp_ethertype_ie : public pfcp_ie {
 public:
  ...
  void dump_to(std::ostream& os) {
    ...
    os.write(
        reinterpret_cast<const char*>(&be_ethertype), sizeof(be_ethertype));
  }
  //--------
  void load_from(std::istream& is) {
    // tlv.load_from(is);
...
class pfcp_ethernet_filter_id_ie : public pfcp_ie {
 public:
  ...
  void dump_to(std::ostream& os) {
    ...
    os.write(
        reinterpret_cast<const char*>(&be_ethernet_filter_id),
  ...
  void load_from(std::istream& is) {
    ...
    is.read(
        reinterpret_cast<char*>(&ethernet_filter_id),
...
class pfcp_nssai_ie : public pfcp_ie {
 public:
  ...
  void load_from(std::istream& is) {
    ...
    char e[l];
    is.read(e, l);
    if (l > sizeof(nssai)) l = sizeof(nssai);
    memcpy(&nssai, e, l);
  }
  //--------
  void to_core_type(pfcp_ies_container& s) {
