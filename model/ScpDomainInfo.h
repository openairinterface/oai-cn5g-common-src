...
public:
    ...
    /// 
    /// </summary>
    std::vector<oai::_3gpp::model::IpEndPoint> getScpIpEndPoints() const;
    void setScpIpEndPoints(std::vector<oai::_3gpp::model::IpEndPoint> const& value);
...
protected:
    ...
    bool m_ScpFqdnIsSet;
    std::vector<oai::_3gpp::model::IpEndPoint> m_ScpIpEndPoints;
