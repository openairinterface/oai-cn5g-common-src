...
public:
    ...
    /// 
    /// </summary>
    oai::model::SvcExperience getSvcExprc() const;
    void setSvcExprc(oai::model::SvcExperience const& value);
    ...
    /// 
    /// </summary>
    oai::model::EthFlowDescription getEthTrafficFilter() const;
    void setEthTrafficFilter(oai::model::EthFlowDescription const& value);
    ...
    friend  void from_json(const nlohmann::json& j, ServiceExperienceInfoPerFlow& o);
protected:
    oai::model::SvcExperience m_SvcExprc;
    ...
    oai::model::EthFlowDescription m_EthTrafficFilter;
