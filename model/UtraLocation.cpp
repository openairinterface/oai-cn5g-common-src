...
oai::_3gpp::model::CellGlobalId UtraLocation::getCgi() const
{
    return m_Cgi;
}
void UtraLocation::setCgi(oai::_3gpp::model::CellGlobalId const& value)
{
    m_Cgi = value;
    m_CgiIsSet = true;
}
...
oai::_3gpp::model::ServiceAreaId UtraLocation::getSai() const
{
    return m_Sai;
}
void UtraLocation::setSai(oai::_3gpp::model::ServiceAreaId const& value)
{
    m_Sai = value;
    m_SaiIsSet = true;
}
...
oai::_3gpp::model::LocationAreaId UtraLocation::getLai() const
{
    return m_Lai;
}
void UtraLocation::setLai(oai::_3gpp::model::LocationAreaId const& value)
{
    m_Lai = value;
    m_LaiIsSet = true;
}
...
oai::_3gpp::model::RoutingAreaId UtraLocation::getRai() const
{
    return m_Rai;
}
void UtraLocation::setRai(oai::_3gpp::model::RoutingAreaId const& value)
{
    m_Rai = value;
    m_RaiIsSet = true;
}
