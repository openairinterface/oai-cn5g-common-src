...
oai::_3gpp::model::Tai N3gaLocation::getN3gppTai() const
{
    return m_N3gppTai;
}
void N3gaLocation::setN3gppTai(oai::_3gpp::model::Tai const& value)
{
    m_N3gppTai = value;
...
oai::_3gpp::model::Ipv6Addr N3gaLocation::getUeIpv6Addr() const
{
    return m_UeIpv6Addr;
}
void N3gaLocation::setUeIpv6Addr(oai::_3gpp::model::Ipv6Addr const& value)
{
    m_UeIpv6Addr = value;
...
oai::_3gpp::model::TransportProtocol N3gaLocation::getProtocol() const
{
    return m_Protocol;
}
void N3gaLocation::setProtocol(oai::_3gpp::model::TransportProtocol const& value)
{
    m_Protocol = value;
...
oai::_3gpp::model::TnapId N3gaLocation::getTnapId() const
{
    return m_TnapId;
}
void N3gaLocation::setTnapId(oai::_3gpp::model::TnapId const& value)
{
    m_TnapId = value;
    m_TnapIdIsSet = true;
}
...
oai::_3gpp::model::TwapId N3gaLocation::getTwapId() const
{
    return m_TwapId;
}
void N3gaLocation::setTwapId(oai::_3gpp::model::TwapId const& value)
{
    m_TwapId = value;
    m_TwapIdIsSet = true;
}
...
oai::_3gpp::model::HfcNodeId N3gaLocation::getHfcNodeId() const
{
    return m_HfcNodeId;
}
void N3gaLocation::setHfcNodeId(oai::_3gpp::model::HfcNodeId const& value)
{
    m_HfcNodeId = value;
...
oai::_3gpp::model::LineType N3gaLocation::getW5gbanLineType() const
{
    return m_W5gbanLineType;
}
void N3gaLocation::setW5gbanLineType(oai::_3gpp::model::LineType const& value)
{
