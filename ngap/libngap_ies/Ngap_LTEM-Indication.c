...
asn_oer_constraints_t asn_OER_type_Ngap_LTEM_Indication_constr_1 CC_NOTUSED = {
	{ 0, 0 },
	-1};
...
static int asn_validate_Ngap_LTEM_Indication_1(const asn_TYPE_descriptor_t *td,
                       const void *sptr,
                       asn_app_constraint_failed_f *ctfailcb,
                       void* app_key) {
    if(! sptr) { return -1; }
    e_Ngap_LTEM_Indication value = *(e_Ngap_LTEM_Indication*)sptr;
    switch(value) {
    case Ngap_LTEM_Indication_lte_m:
        return 0;
    }
    return -1;
}
...
asn_TYPE_descriptor_t asn_DEF_Ngap_LTEM_Indication = {
	...
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
		&asn_OER_type_Ngap_LTEM_Indication_constr_1,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
		&asn_PER_type_Ngap_LTEM_Indication_constr_1,
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
#if !defined(ASN_DISABLE_JER_SUPPORT)
		0,
#endif  /* !defined(ASN_DISABLE_JER_SUPPORT) */
		asn_validate_Ngap_LTEM_Indication_1
	},
