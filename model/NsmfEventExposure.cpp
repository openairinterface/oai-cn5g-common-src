...
bool NsmfEventExposure::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "NsmfEventExposure" : pathPrefix;
    ...
    /* EventSubs */ {
        const std::vector<oai::model::EventSubscription>& value = m_EventSubs;
        ...
        { // Recursive validation of array elements
            const std::string oldValuePath = currentValuePath;
            int i = 0;
            for (const oai::model::EventSubscription& value : value)
            { 
                const std::string currentValuePath = oldValuePath + "[" + std::to_string(i) + "]";
                        
        success = value.validate(msg, currentValuePath + ".eventSubs") && success;
    ...
    if (eventNotifsIsSet())
    {
        const std::vector<oai::model::EventNotification>& value = m_EventNotifs;
        ...
        { // Recursive validation of array elements
            const std::string oldValuePath = currentValuePath;
            int i = 0;
            for (const oai::model::EventNotification& value : value)
            { 
                const std::string currentValuePath = oldValuePath + "[" + std::to_string(i) + "]";
                        
        success = value.validate(msg, currentValuePath + ".eventNotifs") && success;
    ...
    {
        const std::vector<oai::model::PartitioningCriteria>& value = m_PartitionCriteria;
        ...
        { // Recursive validation of array elements
            const std::string oldValuePath = currentValuePath;
            int i = 0;
            for (const oai::model::PartitioningCriteria& value : value)
            { 
                const std::string currentValuePath = oldValuePath + "[" + std::to_string(i) + "]";
                        
        success = value.validate(msg, currentValuePath + ".partitionCriteria") && success;
...
bool NsmfEventExposure::operator==(const NsmfEventExposure& rhs) const
{
    ...
    ((!subIdIsSet() && !rhs.subIdIsSet()) || (subIdIsSet() && rhs.subIdIsSet() && getSubId() == rhs.getSubId())) &&
    ...
    ((!eventNotifsIsSet() && !rhs.eventNotifsIsSet()) || (eventNotifsIsSet() && rhs.eventNotifsIsSet() && getEventNotifs() == rhs.getEventNotifs())) &&
    
    
    ((!immeRepIsSet() && !rhs.immeRepIsSet()) || (immeRepIsSet() && rhs.immeRepIsSet() && isImmeRep() == rhs.isImmeRep())) &&
    
    
    ((!notifMethodIsSet() && !rhs.notifMethodIsSet()) || (notifMethodIsSet() && rhs.notifMethodIsSet() && getNotifMethod() == rhs.getNotifMethod())) &&
    
    
    ((!maxReportNbrIsSet() && !rhs.maxReportNbrIsSet()) || (maxReportNbrIsSet() && rhs.maxReportNbrIsSet() && getMaxReportNbr() == rhs.getMaxReportNbr())) &&
    ...
    ((!partitionCriteriaIsSet() && !rhs.partitionCriteriaIsSet()) || (partitionCriteriaIsSet() && rhs.partitionCriteriaIsSet() && getPartitionCriteria() == rhs.getPartitionCriteria())) &&
    
    
    ((!grpRepTimeIsSet() && !rhs.grpRepTimeIsSet()) || (grpRepTimeIsSet() && rhs.grpRepTimeIsSet() && getGrpRepTime() == rhs.getGrpRepTime())) &&
...
oai::model::Snssai NsmfEventExposure::getSnssai() const
{
    return m_Snssai;
}
void NsmfEventExposure::setSnssai(oai::model::Snssai const& value)
{
    m_Snssai = value;
    m_SnssaiIsSet = true;
}
...
std::vector<oai::model::Ipv6Addr> NsmfEventExposure::getAltNotifIpv6Addrs() const
{
    return m_AltNotifIpv6Addrs;
}
void NsmfEventExposure::setAltNotifIpv6Addrs(std::vector<oai::model::Ipv6Addr> const& value)
{
...
void NsmfEventExposure::setAltNotifFqdns(std::vector<std::string> const& value)
{
...
std::vector<oai::model::EventSubscription> NsmfEventExposure::getEventSubs() const
{
    return m_EventSubs;
}
void NsmfEventExposure::setEventSubs(std::vector<oai::model::EventSubscription> const& value)
{
    m_EventSubs = value;
}
std::vector<oai::model::EventNotification> NsmfEventExposure::getEventNotifs() const
{
    return m_EventNotifs;
}
void NsmfEventExposure::setEventNotifs(std::vector<oai::model::EventNotification> const& value)
{
    m_EventNotifs = value;
...
oai::model::NotificationMethod NsmfEventExposure::getNotifMethod() const
{
    return m_NotifMethod;
}
void NsmfEventExposure::setNotifMethod(oai::model::NotificationMethod const& value)
{
    m_NotifMethod = value;
...
oai::model::Guami NsmfEventExposure::getGuami() const
{
    return m_Guami;
}
void NsmfEventExposure::setGuami(oai::model::Guami const& value)
{
    m_Guami = value;
    m_GuamiIsSet = true;
}
...
oai::model::ServiceName NsmfEventExposure::getServiveName() const
{
    return m_ServiveName;
}
void NsmfEventExposure::setServiveName(oai::model::ServiceName const& value)
{
    m_ServiveName = value;
...
std::vector<oai::model::PartitioningCriteria> NsmfEventExposure::getPartitionCriteria() const
{
    return m_PartitionCriteria;
}
void NsmfEventExposure::setPartitionCriteria(std::vector<oai::model::PartitioningCriteria> const& value)
{
...
oai::model::NotificationFlag NsmfEventExposure::getNotifFlag() const
{
    return m_NotifFlag;
}
void NsmfEventExposure::setNotifFlag(oai::model::NotificationFlag const& value)
{
    m_NotifFlag = value;
