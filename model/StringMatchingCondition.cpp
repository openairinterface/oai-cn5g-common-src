...
oai::_3gpp::model::MatchingOperator StringMatchingCondition::getMatchingOperator() const
{
    return m_MatchingOperator;
}
void StringMatchingCondition::setMatchingOperator(oai::_3gpp::model::MatchingOperator const& value)
{
