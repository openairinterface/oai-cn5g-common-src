...
//------------------------------------------------------------------------------
uint32_t PduSessionAuthenticationComplete::GetLength() const {
  uint32_t msg_len = 0;
...
int PduSessionAuthenticationComplete::Encode(uint8_t* buf, int len) {
  oai::logger::logger_registry::get_logger(LOGGER_COMMON)
      .debug("Encoding PduSessionAuthenticationComplete message");
  int encoded_size    = 0;
  ...
  oai::logger::logger_registry::get_logger(LOGGER_COMMON)
      .debug(
          "Encoded PduSessionAuthenticationComplete message len (%d)",
          encoded_size);
  return encoded_size;
}
...
int PduSessionAuthenticationComplete::Decode(uint8_t* buf, int len) {
  oai::logger::logger_registry::get_logger(LOGGER_COMMON)
      .debug("Decoding PduSessionAuthenticationComplete message");
  int decoded_size    = 0;
  ...
  oai::logger::logger_registry::get_logger(LOGGER_COMMON)
      .debug(
          "Decoded PduSessionAuthenticationComplete message len (%d)",
          decoded_size);
  return decoded_size;
}
