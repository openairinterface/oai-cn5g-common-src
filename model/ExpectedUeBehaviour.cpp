...
bool ExpectedUeBehaviour::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "ExpectedUeBehaviour" : pathPrefix;

                                     
    if (expectedUmtsIsSet())
    {
        const std::vector<oai::model::LocationArea>& value = m_ExpectedUmts;
        ...
        { // Recursive validation of array elements
            ...
            int i = 0;
            for (const oai::model::LocationArea& value : value)
            { 
...
oai::model::StationaryIndication ExpectedUeBehaviour::getStationaryIndication() const
{
    return m_StationaryIndication;
}
void ExpectedUeBehaviour::setStationaryIndication(oai::model::StationaryIndication const& value)
{
...
oai::model::ScheduledCommunicationType ExpectedUeBehaviour::getScheduledCommunicationType() const
{
    return m_ScheduledCommunicationType;
}
void ExpectedUeBehaviour::setScheduledCommunicationType(oai::model::ScheduledCommunicationType const& value)
{
...
oai::model::ScheduledCommunicationTime ExpectedUeBehaviour::getScheduledCommunicationTime() const
{
    return m_ScheduledCommunicationTime;
}
void ExpectedUeBehaviour::setScheduledCommunicationTime(oai::model::ScheduledCommunicationTime const& value)
{
...
std::vector<oai::model::LocationArea> ExpectedUeBehaviour::getExpectedUmts() const
{
    return m_ExpectedUmts;
}
void ExpectedUeBehaviour::setExpectedUmts(std::vector<oai::model::LocationArea> const& value)
{
...
oai::model::TrafficProfile ExpectedUeBehaviour::getTrafficProfile() const
{
    return m_TrafficProfile;
}
void ExpectedUeBehaviour::setTrafficProfile(oai::model::TrafficProfile const& value)
{
...
oai::model::BatteryIndication ExpectedUeBehaviour::getBatteryIndication() const
{
    return m_BatteryIndication;
}
void ExpectedUeBehaviour::setBatteryIndication(oai::model::BatteryIndication const& value)
{
