...
oai::_3gpp::model::Snssai SliceInfoForPDUSession::getSNssai() const
{
    return m_SNssai;
}
void SliceInfoForPDUSession::setSNssai(oai::_3gpp::model::Snssai const& value)
{
    m_SNssai = value;
}
oai::_3gpp::model::RoamingIndication SliceInfoForPDUSession::getRoamingIndication() const
{
    return m_RoamingIndication;
}
void SliceInfoForPDUSession::setRoamingIndication(oai::_3gpp::model::RoamingIndication const& value)
{
    m_RoamingIndication = value;
}
oai::_3gpp::model::Snssai SliceInfoForPDUSession::getHomeSnssai() const
{
    return m_HomeSnssai;
}
void SliceInfoForPDUSession::setHomeSnssai(oai::_3gpp::model::Snssai const& value)
{
    m_HomeSnssai = value;
