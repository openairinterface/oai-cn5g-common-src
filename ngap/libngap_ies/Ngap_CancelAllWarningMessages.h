...
extern const asn_INTEGER_specifics_t
    asn_SPC_Ngap_CancelAllWarningMessages_specs_1;
...
cbor_type_decoder_f Ngap_CancelAllWarningMessages_decode_cbor;
cbor_type_encoder_f Ngap_CancelAllWarningMessages_encode_cbor;
