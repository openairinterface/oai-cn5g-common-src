...
bool DeregistrationReason_anyOf::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "DeregistrationReason_anyOf" : pathPrefix;

    
    if (m_value == DeregistrationReason_anyOf::eDeregistrationReason_anyOf::INVALID_VALUE_OPENAPI_GENERATED)
    {
        success = false;
...
bool DeregistrationReason_anyOf::operator==(const DeregistrationReason_anyOf& rhs) const
{
    return
...
void to_json(nlohmann::json& j, const DeregistrationReason_anyOf& o)
{
    ...
    switch (o.getValue())
    {
        ...
        case DeregistrationReason_anyOf::eDeregistrationReason_anyOf::SMF_CONTEXT_TRANSFERRED:
            ...
            break;
        case DeregistrationReason_anyOf::eDeregistrationReason_anyOf::DUPLICATE_PDU_SESSION:
            j = "DUPLICATE_PDU_SESSION";
            break;
        case DeregistrationReason_anyOf::eDeregistrationReason_anyOf::DISASTER_CONDITION_TERMINATED:
...
void from_json(const nlohmann::json& j, DeregistrationReason_anyOf& o)
{
    ...
    if (s == "UE_INITIAL_REGISTRATION") {
     ...
     o.setValue(DeregistrationReason_anyOf::eDeregistrationReason_anyOf::DUPLICATE_PDU_SESSION);
    } 
    else if (s == "DISASTER_CONDITION_TERMINATED") {
     o.setValue(DeregistrationReason_anyOf::eDeregistrationReason_anyOf::DISASTER_CONDITION_TERMINATED);
    }  else {
     std::stringstream ss;
