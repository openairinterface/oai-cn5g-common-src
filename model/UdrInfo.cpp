...
std::vector<oai::model::SupiRange> UdrInfo::getSupiRanges() const
{
    return m_SupiRanges;
}
void UdrInfo::setSupiRanges(std::vector<oai::model::SupiRange> const& value)
{
    m_SupiRanges = value;
...
std::vector<oai::model::IdentityRange> UdrInfo::getGpsiRanges() const
{
    return m_GpsiRanges;
}
void UdrInfo::setGpsiRanges(std::vector<oai::model::IdentityRange> const& value)
{
    m_GpsiRanges = value;
...
std::vector<oai::model::IdentityRange> UdrInfo::getExternalGroupIdentifiersRanges() const
{
    return m_ExternalGroupIdentifiersRanges;
}
void UdrInfo::setExternalGroupIdentifiersRanges(std::vector<oai::model::IdentityRange> const& value)
{
...
std::vector<oai::model::DataSetId> UdrInfo::getSupportedDataSets() const
{
    return m_SupportedDataSets;
}
void UdrInfo::setSupportedDataSets(std::vector<oai::model::DataSetId> const& value)
{
...
std::vector<oai::model::SharedDataIdRange> UdrInfo::getSharedDataIdRanges() const
{
    return m_SharedDataIdRanges;
}
void UdrInfo::setSharedDataIdRanges(std::vector<oai::model::SharedDataIdRange> const& value)
{
