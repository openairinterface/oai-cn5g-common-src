...
bool AreaEventInfo::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "AreaEventInfo" : pathPrefix;

         
    
    /* AreaDefinition */ {
        const std::vector<oai::model::ReportingArea>& value = m_AreaDefinition;
        ...
        { // Recursive validation of array elements
            ...
            int i = 0;
            for (const oai::model::ReportingArea& value : value)
            { 
...
std::vector<oai::model::ReportingArea> AreaEventInfo::getAreaDefinition() const
{
    return m_AreaDefinition;
}
void AreaEventInfo::setAreaDefinition(std::vector<oai::model::ReportingArea> const& value)
{
    m_AreaDefinition = value;
}
oai::model::OccurrenceInfo AreaEventInfo::getOccurrenceInfo() const
{
    return m_OccurrenceInfo;
}
void AreaEventInfo::setOccurrenceInfo(oai::model::OccurrenceInfo const& value)
{
