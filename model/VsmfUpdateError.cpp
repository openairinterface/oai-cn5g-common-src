...
void VsmfUpdateError::setError(oai::_3gpp::model::ExtProblemDetails const& value)
{
    m_Error = value;
}
...
void VsmfUpdateError::setN1SmInfoFromUe(oai::_3gpp::model::RefToBinaryData const& value)
{
...
void VsmfUpdateError::setUnknownN1SmInfo(oai::_3gpp::model::RefToBinaryData const& value)
{
...
std::vector<oai::_3gpp::model::Arp> VsmfUpdateError::getFailedToAssignEbiList() const
{
    return m_FailedToAssignEbiList;
}
void VsmfUpdateError::setFailedToAssignEbiList(std::vector<oai::_3gpp::model::Arp> const& value)
{
...
void VsmfUpdateError::setN4InfoExt1(oai::_3gpp::model::N4Information const& value)
{
    m_N4InfoExt1 = value;
...
void VsmfUpdateError::setN4InfoExt2(oai::_3gpp::model::N4Information const& value)
{
    m_N4InfoExt2 = value;
...
void VsmfUpdateError::setN4InfoExt3(oai::_3gpp::model::N4Information const& value)
{
    m_N4InfoExt3 = value;
