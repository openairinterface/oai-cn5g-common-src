...
bool ReportAmountMdt_anyOf::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "ReportAmountMdt_anyOf" : pathPrefix;

    
    if (m_value == ReportAmountMdt_anyOf::eReportAmountMdt_anyOf::INVALID_VALUE_OPENAPI_GENERATED)
    {
        success = false;
...
void to_json(nlohmann::json& j, const ReportAmountMdt_anyOf& o)
{
    ...
    switch (o.getValue())
    {
        case ReportAmountMdt_anyOf::eReportAmountMdt_anyOf::INVALID_VALUE_OPENAPI_GENERATED:
        ...
        case ReportAmountMdt_anyOf::eReportAmountMdt_anyOf::_64:
            j = "64";
            break;
        case ReportAmountMdt_anyOf::eReportAmountMdt_anyOf::INFINITY:
            j = "infinity";
            break;
    }
}
...
void from_json(const nlohmann::json& j, ReportAmountMdt_anyOf& o)
{
    ...
    if (s == "1") {
     ...
     o.setValue(ReportAmountMdt_anyOf::eReportAmountMdt_anyOf::INFINITY);
    }  else {
     std::stringstream ss;
...
ReportAmountMdt_anyOf::eReportAmountMdt_anyOf ReportAmountMdt_anyOf::getValue() const
{
    return m_value;
}
void ReportAmountMdt_anyOf::setValue(ReportAmountMdt_anyOf::eReportAmountMdt_anyOf value)
{
    m_value = value;
}
