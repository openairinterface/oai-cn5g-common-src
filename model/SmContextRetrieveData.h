...
public:
    ...
    /// 
    /// </summary>
    oai::model::MmeCapabilities getTargetMmeCap() const;
    void setTargetMmeCap(oai::model::MmeCapabilities const& value);
    bool targetMmeCapIsSet() const;
    void unsetTargetMmeCap();
    /// <summary>
    /// 
    /// </summary>
    oai::model::SmContextType getSmContextType() const;
    void setSmContextType(oai::model::SmContextType const& value);
    bool smContextTypeIsSet() const;
    void unsetSmContextType();
    /// <summary>
    /// 
    /// </summary>
    oai::model::PlmnId getServingNetwork() const;
    void setServingNetwork(oai::model::PlmnId const& value);
...
protected:
    oai::model::MmeCapabilities m_TargetMmeCap;
    bool m_TargetMmeCapIsSet;
    oai::model::SmContextType m_SmContextType;
    bool m_SmContextTypeIsSet;
    oai::model::PlmnId m_ServingNetwork;
