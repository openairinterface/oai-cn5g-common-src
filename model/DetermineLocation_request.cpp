...
bool DetermineLocation_request::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "DetermineLocation_request" : pathPrefix;

            
    return success;
}

bool DetermineLocation_request::operator==(const DetermineLocation_request& rhs) const
{
    return
    ...
    ((!binaryDataLppMessageIsSet() && !rhs.binaryDataLppMessageIsSet()) || (binaryDataLppMessageIsSet() && rhs.binaryDataLppMessageIsSet() && getBinaryDataLppMessage() == rhs.getBinaryDataLppMessage()))
...
oai::_3gpp::model::InputData DetermineLocation_request::getJsonData() const
{
    return m_JsonData;
}
void DetermineLocation_request::setJsonData(oai::_3gpp::model::InputData const& value)
{
    m_JsonData = value;
...
void DetermineLocation_request::setBinaryDataLppMessage(std::string const& value)
{
