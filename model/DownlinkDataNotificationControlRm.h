...
public:
    ...
    /// 
    /// </summary>
    std::vector<oai::_3gpp::model::NotificationControlIndication> getNotifCtrlInds() const;
    void setNotifCtrlInds(std::vector<oai::_3gpp::model::NotificationControlIndication> const& value);
