...
public:
    ...
    /// 
    /// </summary>
    oai::_3gpp::model::AccessAndMobilitySubscriptionData_subscribedDnnList_inner getDnn() const;
    void setDnn(oai::_3gpp::model::AccessAndMobilitySubscriptionData_subscribedDnnList_inner const& value);
    /// <summary>
    /// 
    /// </summary>
...
protected:
    oai::_3gpp::model::AccessAndMobilitySubscriptionData_subscribedDnnList_inner m_Dnn;
