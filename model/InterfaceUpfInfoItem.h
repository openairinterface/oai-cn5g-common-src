...
public:
    ...
    /// 
    /// </summary>
    oai::_3gpp::model::UPInterfaceType getInterfaceType() const;
    void setInterfaceType(oai::_3gpp::model::UPInterfaceType const& value);
    /// <summary>
    /// 
    /// </summary>
    ...
    /// 
    /// </summary>
    std::vector<oai::_3gpp::model::Ipv6Addr> getIpv6EndpointAddresses() const;
    void setIpv6EndpointAddresses(std::vector<oai::_3gpp::model::Ipv6Addr> const& value);
