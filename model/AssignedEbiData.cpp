...
bool AssignedEbiData::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "AssignedEbiData" : pathPrefix;
    ...
    {
        const std::vector<oai::model::Arp>& value = m_FailedArpList;
        ...
        success = value.validate(msg, currentValuePath + ".failedArpList") && success;
...
bool AssignedEbiData::operator==(const AssignedEbiData& rhs) const
{
    ...
    ((!failedArpListIsSet() && !rhs.failedArpListIsSet()) || (failedArpListIsSet() && rhs.failedArpListIsSet() && getFailedArpList() == rhs.getFailedArpList())) &&
...
std::vector<oai::model::EbiArpMapping> AssignedEbiData::getAssignedEbiList() const
{
    return m_AssignedEbiList;
}
void AssignedEbiData::setAssignedEbiList(std::vector<oai::model::EbiArpMapping> const& value)
{
    m_AssignedEbiList = value;
}
std::vector<oai::model::Arp> AssignedEbiData::getFailedArpList() const
{
    return m_FailedArpList;
}
void AssignedEbiData::setFailedArpList(std::vector<oai::model::Arp> const& value)
{
