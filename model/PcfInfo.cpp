...
void PcfInfo::setSupiRanges(std::vector<oai::_3gpp::model::SupiRange> const& value)
{
    m_SupiRanges = value;
...
void PcfInfo::setGpsiRanges(std::vector<oai::_3gpp::model::IdentityRange> const& value)
{
    m_GpsiRanges = value;
...
void PcfInfo::setProseCapability(oai::_3gpp::model::ProSeCapability const& value)
{
