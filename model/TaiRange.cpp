...
bool TaiRange::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    ...
    /* TacRangeList */ {
        const std::vector<oai::model::TacRange>& value = m_TacRangeList;
        ...
        { // Recursive validation of array elements
            ...
            int i = 0;
            for (const oai::model::TacRange& value : value)
            { 
...
oai::model::PlmnId TaiRange::getPlmnId() const
{
    return m_PlmnId;
}
void TaiRange::setPlmnId(oai::model::PlmnId const& value)
{
    m_PlmnId = value;
}
std::vector<oai::model::TacRange> TaiRange::getTacRangeList() const
{
    return m_TacRangeList;
}
void TaiRange::setTacRangeList(std::vector<oai::model::TacRange> const& value)
{
