...
bool CongestionType::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "CongestionType" : pathPrefix;
...
CongestionType_anyOf::eCongestionType_anyOf CongestionType::getEnumValue() const
{
    return m_value.getValue();
}

void CongestionType::setEnumValue(CongestionType_anyOf::eCongestionType_anyOf  value)
{
