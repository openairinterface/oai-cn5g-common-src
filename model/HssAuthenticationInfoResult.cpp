...
oai::_3gpp::model::HssAuthenticationVectors HssAuthenticationInfoResult::getHssAuthenticationVectors() const
{
    return m_HssAuthenticationVectors;
}
void HssAuthenticationInfoResult::setHssAuthenticationVectors(oai::_3gpp::model::HssAuthenticationVectors const& value)
{
