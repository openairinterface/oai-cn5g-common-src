...
oai::_3gpp::model::Ipv6Prefix Ipv6PrefixRange::getStart() const
{
    return m_Start;
}
void Ipv6PrefixRange::setStart(oai::_3gpp::model::Ipv6Prefix const& value)
{
    m_Start = value;
    m_StartIsSet = true;
}
...
oai::_3gpp::model::Ipv6Prefix Ipv6PrefixRange::getEnd() const
{
    return m_End;
}
void Ipv6PrefixRange::setEnd(oai::_3gpp::model::Ipv6Prefix const& value)
{
    m_End = value;
    m_EndIsSet = true;
}
