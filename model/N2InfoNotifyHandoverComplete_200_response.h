...
public:
    ...
    /// 
    /// </summary>
    oai::model::N2InfoNotificationRspData getJsonData() const;
    void setJsonData(oai::model::N2InfoNotificationRspData const& value);
...
protected:
    oai::model::N2InfoNotificationRspData m_JsonData;
