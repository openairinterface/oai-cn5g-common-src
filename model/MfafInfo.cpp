...
std::vector<oai::_3gpp::model::NFType> MfafInfo::getServingNfTypeList() const
{
    return m_ServingNfTypeList;
}
void MfafInfo::setServingNfTypeList(std::vector<oai::_3gpp::model::NFType> const& value)
{
...
std::vector<oai::_3gpp::model::Tai> MfafInfo::getTaiList() const
{
    return m_TaiList;
}
void MfafInfo::setTaiList(std::vector<oai::_3gpp::model::Tai> const& value)
{
    m_TaiList = value;
    m_TaiListIsSet = true;
}
...
std::vector<oai::_3gpp::model::TaiRange> MfafInfo::getTaiRangeList() const
{
    return m_TaiRangeList;
}
void MfafInfo::setTaiRangeList(std::vector<oai::_3gpp::model::TaiRange> const& value)
{
