...
bool NetworkAreaInfo::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "NetworkAreaInfo" : pathPrefix;
...
std::vector<oai::model::Ecgi> NetworkAreaInfo::getEcgis() const
{
    return m_Ecgis;
}
void NetworkAreaInfo::setEcgis(std::vector<oai::model::Ecgi> const& value)
{
    m_Ecgis = value;
    m_EcgisIsSet = true;
}
...
std::vector<oai::model::Ncgi> NetworkAreaInfo::getNcgis() const
{
    return m_Ncgis;
}
void NetworkAreaInfo::setNcgis(std::vector<oai::model::Ncgi> const& value)
{
    m_Ncgis = value;
    m_NcgisIsSet = true;
}
...
std::vector<oai::model::GlobalRanNodeId> NetworkAreaInfo::getGRanNodeIds() const
{
    return m_GRanNodeIds;
}
void NetworkAreaInfo::setGRanNodeIds(std::vector<oai::model::GlobalRanNodeId> const& value)
{
    m_GRanNodeIds = value;
...
std::vector<oai::model::Tai> NetworkAreaInfo::getTais() const
{
    return m_Tais;
}
void NetworkAreaInfo::setTais(std::vector<oai::model::Tai> const& value)
{
    m_Tais = value;
    m_TaisIsSet = true;
}
