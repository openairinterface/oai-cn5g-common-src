...
public:
    ...
    /// 
    /// </summary>
    oai::_3gpp::model::AppSessionContextUpdateData getAscReqData() const;
    void setAscReqData(oai::_3gpp::model::AppSessionContextUpdateData const& value);
    bool ascReqDataIsSet() const;
    void unsetAscReqData();

    friend void to_json(nlohmann::json& j, const AppSessionContextUpdateDataPatch& o);
    friend void from_json(const nlohmann::json& j, AppSessionContextUpdateDataPatch& o);
protected:
    oai::_3gpp::model::AppSessionContextUpdateData m_AscReqData;
