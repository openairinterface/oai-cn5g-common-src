...
public:
    ...
    /// 
    /// </summary>
    oai::model::TimeWindow getTimeInterv() const;
    void setTimeInterv(oai::model::TimeWindow const& value);
    ...
    friend  void from_json(const nlohmann::json& j, UserDataCongestionCollection& o);
protected:
    std::string m_AppId;
    bool m_AppIdIsSet;
    oai::model::FlowInfo m_IpTrafficFilter;
    bool m_IpTrafficFilterIsSet;
    oai::model::TimeWindow m_TimeInterv;
