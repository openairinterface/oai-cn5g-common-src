...
bool PduSession::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "PduSession" : pathPrefix;
...
oai::model::PlmnId PduSession::getPlmnId() const
{
    return m_PlmnId;
}
void PduSession::setPlmnId(oai::model::PlmnId const& value)
{
    m_PlmnId = value;
}
oai::model::Snssai PduSession::getSingleNssai() const
{
    return m_SingleNssai;
}
void PduSession::setSingleNssai(oai::model::Snssai const& value)
{
    m_SingleNssai = value;
