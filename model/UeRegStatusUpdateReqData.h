...
public:
    ...
    /// 
    /// </summary>
    oai::model::UeContextTransferStatus getTransferStatus() const;
    void setTransferStatus(oai::model::UeContextTransferStatus const& value);
    /// <summary>
    /// 
    /// </summary>
    ...
    /// 
    /// </summary>
    std::vector<oai::model::ReleaseSessionInfo> getToReleaseSessionInfo() const;
    void setToReleaseSessionInfo(std::vector<oai::model::ReleaseSessionInfo> const& value);
...
protected:
    oai::model::UeContextTransferStatus m_TransferStatus;
    ...
    std::vector<oai::model::ReleaseSessionInfo> m_ToReleaseSessionInfo;
