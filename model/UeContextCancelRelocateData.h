...
public:
    ...
    /// 
    /// </summary>
    oai::model::RefToBinaryData getRelocationCancelRequest() const;
    void setRelocationCancelRequest(oai::model::RefToBinaryData const& value);

    friend  void to_json(nlohmann::json& j, const UeContextCancelRelocateData& o);
    friend  void from_json(const nlohmann::json& j, UeContextCancelRelocateData& o);
protected:
    std::string m_Supi;
    bool m_SupiIsSet;
    oai::model::RefToBinaryData m_RelocationCancelRequest;
