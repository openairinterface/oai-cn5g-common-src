...
bool NefEventExposureSubsc::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "NefEventExposureSubsc" : pathPrefix;

             
    
    /* EventsSubs */ {
        const std::vector<oai::_3gpp::model::NefEventSubs>& value = m_EventsSubs;
        ...
        { // Recursive validation of array elements
            ...
            int i = 0;
            for (const oai::_3gpp::model::NefEventSubs& value : value)
            { 
                const std::string currentValuePath = oldValuePath + "[" + std::to_string(i) + "]";
                        
        success = value.validate(msg, currentValuePath + ".eventsSubs") && success;
    ...
    if (eventNotifsIsSet())
    {
        const std::vector<oai::_3gpp::model::NefEventNotification>& value = m_EventNotifs;
        ...
        { // Recursive validation of array elements
            const std::string oldValuePath = currentValuePath;
            int i = 0;
            for (const oai::_3gpp::model::NefEventNotification& value : value)
            { 
                const std::string currentValuePath = oldValuePath + "[" + std::to_string(i) + "]";
...
bool NefEventExposureSubsc::operator==(const NefEventExposureSubsc& rhs) const
{
    ...
    ((!dataAccProfIdIsSet() && !rhs.dataAccProfIdIsSet()) || (dataAccProfIdIsSet() && rhs.dataAccProfIdIsSet() && getDataAccProfId() == rhs.getDataAccProfId())) &&
...
{
    j = nlohmann::json();
    if(o.dataAccProfIdIsSet())
        j["dataAccProfId"] = o.m_DataAccProfId;
...
std::string NefEventExposureSubsc::getDataAccProfId() const
{
    return m_DataAccProfId;
}
void NefEventExposureSubsc::setDataAccProfId(std::string const& value)
{
    m_DataAccProfId = value;
    m_DataAccProfIdIsSet = true;
}
bool NefEventExposureSubsc::dataAccProfIdIsSet() const
{
    return m_DataAccProfIdIsSet;
}
void NefEventExposureSubsc::unsetDataAccProfId()
{
    m_DataAccProfIdIsSet = false;
}
std::vector<oai::_3gpp::model::NefEventSubs> NefEventExposureSubsc::getEventsSubs() const
{
    return m_EventsSubs;
}
void NefEventExposureSubsc::setEventsSubs(std::vector<oai::_3gpp::model::NefEventSubs> const& value)
{
    m_EventsSubs = value;
}
oai::_3gpp::model::ReportingInformation NefEventExposureSubsc::getEventsRepInfo() const
{
    return m_EventsRepInfo;
}
void NefEventExposureSubsc::setEventsRepInfo(oai::_3gpp::model::ReportingInformation const& value)
{
...
std::vector<oai::_3gpp::model::NefEventNotification> NefEventExposureSubsc::getEventNotifs() const
{
    return m_EventNotifs;
}
void NefEventExposureSubsc::setEventNotifs(std::vector<oai::_3gpp::model::NefEventNotification> const& value)
{
    m_EventNotifs = value;
