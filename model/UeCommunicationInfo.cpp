...
bool UeCommunicationInfo::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "UeCommunicationInfo" : pathPrefix;
...
std::vector<oai::model::CommunicationCollection> UeCommunicationInfo::getComms() const
{
    return m_Comms;
}
void UeCommunicationInfo::setComms(std::vector<oai::model::CommunicationCollection> const& value)
{
    m_Comms = value;
}
