/**
 * Nsmf_PDUSession
 * SMF PDU Session Service.   © 2023, 3GPP Organizational Partners (ARIB, ATIS,
...
bool SmContext::isDisasterRoamingInd() const {
  return m_DisasterRoamingInd;
}
void SmContext::setDisasterRoamingInd(bool const value) {
  m_DisasterRoamingInd      = value;
  m_DisasterRoamingIndIsSet = true;
}
bool SmContext::disasterRoamingIndIsSet() const {
  return m_DisasterRoamingIndIsSet;
}
void SmContext::unsetDisasterRoamingInd() {
  m_DisasterRoamingIndIsSet = false;
}
