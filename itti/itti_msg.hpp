...
typedef enum {
  ...
  N3_ECHO_RESPONSE,
  N3_ERROR_INDICATION,
  N3_SUPPORTED_EXTENSION_HEADERS_NOTIFICATION,
  N3_END_MARKER,
  N3_G_PDU,  // UNUSED
  ...
  N11_SUBSCRIBE_UPF_STATUS_NOTIFY_RESPONSE,
  ...
  SBI_SMF_CONFIGURATION,
  SBI_UPDATE_SMF_CONFIGURATION,
  ...
  SBI_STORE_UE_CONTEXT_REQUEST,
  SBI_RETRIEVE_UE_CONTEXT_REQUEST,
