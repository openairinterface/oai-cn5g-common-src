...
bool UeContextInSmsfData::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "UeContextInSmsfData" : pathPrefix;
...
bool UeContextInSmsfData::operator==(const UeContextInSmsfData& rhs) const
{
    ...
    ((!smsfInfo3GppAccessIsSet() && !rhs.smsfInfo3GppAccessIsSet()) || (smsfInfo3GppAccessIsSet() && rhs.smsfInfo3GppAccessIsSet() && getSmsfInfo3GppAccess() == rhs.getSmsfInfo3GppAccess())) &&
    
    
    ((!smsfInfoNon3GppAccessIsSet() && !rhs.smsfInfoNon3GppAccessIsSet()) || (smsfInfoNon3GppAccessIsSet() && rhs.smsfInfoNon3GppAccessIsSet() && getSmsfInfoNon3GppAccess() == rhs.getSmsfInfoNon3GppAccess()))
...
oai::model::SmsfInfo UeContextInSmsfData::getSmsfInfo3GppAccess() const
{
    return m_SmsfInfo3GppAccess;
}
void UeContextInSmsfData::setSmsfInfo3GppAccess(oai::model::SmsfInfo const& value)
{
...
oai::model::SmsfInfo UeContextInSmsfData::getSmsfInfoNon3GppAccess() const
{
    return m_SmsfInfoNon3GppAccess;
}
void UeContextInSmsfData::setSmsfInfoNon3GppAccess(oai::model::SmsfInfo const& value)
{
