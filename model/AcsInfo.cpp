...
bool AcsInfo::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
...
oai::_3gpp::model::Ipv6Addr AcsInfo::getAcsIpv6Addr() const
{
    return m_AcsIpv6Addr;
}
void AcsInfo::setAcsIpv6Addr(oai::_3gpp::model::Ipv6Addr const& value)
{
    m_AcsIpv6Addr = value;
