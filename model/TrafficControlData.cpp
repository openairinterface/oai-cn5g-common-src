...
bool TrafficControlData::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "TrafficControlData" : pathPrefix;

                     
    if (addRedirectInfoIsSet())
    {
        const std::vector<oai::model::RedirectInformation>& value = m_AddRedirectInfo;
        ...
        { // Recursive validation of array elements
            ...
            int i = 0;
            for (const oai::model::RedirectInformation& value : value)
            { 
                const std::string currentValuePath = oldValuePath + "[" + std::to_string(i) + "]";
                        
        success = value.validate(msg, currentValuePath + ".addRedirectInfo") && success;
...
bool TrafficControlData::operator==(const TrafficControlData& rhs) const
{
    ...
    ((!flowStatusIsSet() && !rhs.flowStatusIsSet()) || (flowStatusIsSet() && rhs.flowStatusIsSet() && getFlowStatus() == rhs.getFlowStatus())) &&
    
    
    ((!redirectInfoIsSet() && !rhs.redirectInfoIsSet()) || (redirectInfoIsSet() && rhs.redirectInfoIsSet() && getRedirectInfo() == rhs.getRedirectInfo())) &&
    
    
    ((!addRedirectInfoIsSet() && !rhs.addRedirectInfoIsSet()) || (addRedirectInfoIsSet() && rhs.addRedirectInfoIsSet() && getAddRedirectInfo() == rhs.getAddRedirectInfo())) &&
    
    
    ((!muteNotifIsSet() && !rhs.muteNotifIsSet()) || (muteNotifIsSet() && rhs.muteNotifIsSet() && isMuteNotif() == rhs.isMuteNotif())) &&
    
    
    ((!trafficSteeringPolIdDlIsSet() && !rhs.trafficSteeringPolIdDlIsSet()) || (trafficSteeringPolIdDlIsSet() && rhs.trafficSteeringPolIdDlIsSet() && getTrafficSteeringPolIdDl() == rhs.getTrafficSteeringPolIdDl())) &&
    
    
    ((!trafficSteeringPolIdUlIsSet() && !rhs.trafficSteeringPolIdUlIsSet()) || (trafficSteeringPolIdUlIsSet() && rhs.trafficSteeringPolIdUlIsSet() && getTrafficSteeringPolIdUl() == rhs.getTrafficSteeringPolIdUl())) &&
    ...
    ((!upPathChgEventIsSet() && !rhs.upPathChgEventIsSet()) || (upPathChgEventIsSet() && rhs.upPathChgEventIsSet() && getUpPathChgEvent() == rhs.getUpPathChgEvent())) &&
    
    
    ((!steerFunIsSet() && !rhs.steerFunIsSet()) || (steerFunIsSet() && rhs.steerFunIsSet() && getSteerFun() == rhs.getSteerFun())) &&
    
    
    ((!steerModeDlIsSet() && !rhs.steerModeDlIsSet()) || (steerModeDlIsSet() && rhs.steerModeDlIsSet() && getSteerModeDl() == rhs.getSteerModeDl())) &&
    
    
    ((!steerModeUlIsSet() && !rhs.steerModeUlIsSet()) || (steerModeUlIsSet() && rhs.steerModeUlIsSet() && getSteerModeUl() == rhs.getSteerModeUl())) &&
    
    
    ((!mulAccCtrlIsSet() && !rhs.mulAccCtrlIsSet()) || (mulAccCtrlIsSet() && rhs.mulAccCtrlIsSet() && getMulAccCtrl() == rhs.getMulAccCtrl()))
...
oai::model::FlowStatus TrafficControlData::getFlowStatus() const
{
    return m_FlowStatus;
}
void TrafficControlData::setFlowStatus(oai::model::FlowStatus const& value)
{
    m_FlowStatus = value;
...
oai::model::RedirectInformation TrafficControlData::getRedirectInfo() const
{
    return m_RedirectInfo;
}
void TrafficControlData::setRedirectInfo(oai::model::RedirectInformation const& value)
{
...
std::vector<oai::model::RedirectInformation> TrafficControlData::getAddRedirectInfo() const
{
    return m_AddRedirectInfo;
}
void TrafficControlData::setAddRedirectInfo(std::vector<oai::model::RedirectInformation> const& value)
{
...
std::vector<oai::model::RouteToLocation> TrafficControlData::getRouteToLocs() const
{
    return m_RouteToLocs;
}
void TrafficControlData::setRouteToLocs(std::vector<oai::model::RouteToLocation> const& value)
{
    m_RouteToLocs = value;
...
std::vector<oai::model::EasIpReplacementInfo> TrafficControlData::getEasIpReplaceInfos() const
{
    return m_EasIpReplaceInfos;
}
void TrafficControlData::setEasIpReplaceInfos(std::vector<oai::model::EasIpReplacementInfo> const& value)
{
...
oai::model::UpPathChgEvent TrafficControlData::getUpPathChgEvent() const
{
    return m_UpPathChgEvent;
}
void TrafficControlData::setUpPathChgEvent(oai::model::UpPathChgEvent const& value)
{
...
oai::model::SteeringFunctionality TrafficControlData::getSteerFun() const
{
    return m_SteerFun;
}
void TrafficControlData::setSteerFun(oai::model::SteeringFunctionality const& value)
{
    m_SteerFun = value;
...
oai::model::SteeringMode TrafficControlData::getSteerModeDl() const
{
    return m_SteerModeDl;
}
void TrafficControlData::setSteerModeDl(oai::model::SteeringMode const& value)
{
    m_SteerModeDl = value;
...
oai::model::SteeringMode TrafficControlData::getSteerModeUl() const
{
    return m_SteerModeUl;
}
void TrafficControlData::setSteerModeUl(oai::model::SteeringMode const& value)
{
    m_SteerModeUl = value;
...
oai::model::MulticastAccessControl TrafficControlData::getMulAccCtrl() const
{
    return m_MulAccCtrl;
}
void TrafficControlData::setMulAccCtrl(oai::model::MulticastAccessControl const& value)
{
    m_MulAccCtrl = value;
