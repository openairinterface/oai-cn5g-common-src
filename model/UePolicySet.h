...
public:
    ...
    void setPraInfos(std::map<std::string, oai::_3gpp::model::PresenceInfo> const& value);
    ...
    /// </summary>
    std::map<std::string, oai::_3gpp::model::UePolicySection> getUePolicySections() const;
    void setUePolicySections(std::map<std::string, oai::_3gpp::model::UePolicySection> const& value);
    ...
    /// </summary>
    std::map<std::string, oai::_3gpp::model::PlmnRouteSelectionDescriptor> getAllowedRouteSelDescs() const;
    void setAllowedRouteSelDescs(std::map<std::string, oai::_3gpp::model::PlmnRouteSelectionDescriptor> const& value);
...
protected:
    ...
    bool m_UpsisIsSet;
    std::map<std::string, oai::_3gpp::model::PlmnRouteSelectionDescriptor> m_AllowedRouteSelDescs;
