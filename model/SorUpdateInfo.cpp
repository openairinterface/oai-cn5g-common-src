...
bool SorUpdateInfo::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "SorUpdateInfo" : pathPrefix;

        
    if (!m_VplmnId.validate(msg, _pathPrefix + ".vplmnId")) {
        msg << _pathPrefix << ": VplmnId is invalid;";
        success = false;
    }     
...
oai::model::PlmnId SorUpdateInfo::getVplmnId() const
{
    return m_VplmnId;
}
void SorUpdateInfo::setVplmnId(oai::model::PlmnId const& value)
{
    m_VplmnId = value;
}
