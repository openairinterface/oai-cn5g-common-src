...
bool N2InformationTransferReqData::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    ...
    {
        const std::vector<oai::_3gpp::model::GlobalRanNodeId>& value = m_GlobalRanNodeList;
...
std::vector<oai::_3gpp::model::Tai> N2InformationTransferReqData::getTaiList() const
{
    return m_TaiList;
}
void N2InformationTransferReqData::setTaiList(std::vector<oai::_3gpp::model::Tai> const& value)
{
    m_TaiList = value;
    m_TaiListIsSet = true;
}
...
oai::_3gpp::model::RatSelector N2InformationTransferReqData::getRatSelector() const
{
    return m_RatSelector;
}
void N2InformationTransferReqData::setRatSelector(oai::_3gpp::model::RatSelector const& value)
{
    m_RatSelector = value;
...
std::vector<oai::_3gpp::model::GlobalRanNodeId> N2InformationTransferReqData::getGlobalRanNodeList() const
{
    return m_GlobalRanNodeList;
}
void N2InformationTransferReqData::setGlobalRanNodeList(std::vector<oai::_3gpp::model::GlobalRanNodeId> const& value)
{
...
oai::_3gpp::model::N2InfoContainer N2InformationTransferReqData::getN2Information() const
{
    return m_N2Information;
}
void N2InformationTransferReqData::setN2Information(oai::_3gpp::model::N2InfoContainer const& value)
{
