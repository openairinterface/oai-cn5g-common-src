...
NotificationFlag_anyOf::eNotificationFlag_anyOf NotificationFlag::getEnumValue() const
{
    return m_value.getValue();
}

void NotificationFlag::setEnumValue(NotificationFlag_anyOf::eNotificationFlag_anyOf  value)
{
