...
int PduSessionReleaseCommand::Encode(uint8_t* buf, int len) {
  oai::logger::logger_registry::get_logger(LOGGER_COMMON)
      .debug("Encoding PduSessionReleaseCommand message");
  int encoded_size    = 0;
  ...
  oai::logger::logger_registry::get_logger(LOGGER_COMMON)
      .debug("Encoded PduSessionReleaseCommand message len (%d)", encoded_size);
  return encoded_size;
}
...
int PduSessionReleaseCommand::Decode(uint8_t* buf, int len) {
  oai::logger::logger_registry::get_logger(LOGGER_COMMON)
      .debug("Decoding PduSessionReleaseCommand message");
  int decoded_size    = 0;
  ...
  oai::logger::logger_registry::get_logger(LOGGER_COMMON)
      .debug("Decoded PduSessionReleaseCommand message len (%d)", decoded_size);
  return decoded_size;
}
