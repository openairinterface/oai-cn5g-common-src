...
public:
    ...
    /// 
    /// </summary>
    std::vector<oai::_3gpp::model::NFServiceVersion> getVersions() const;
    void setVersions(std::vector<oai::_3gpp::model::NFServiceVersion> const& value);
    /// <summary>
    /// 
    /// </summary>
    ...
    /// 
    /// </summary>
    oai::_3gpp::model::NFServiceStatus getNfServiceStatus() const;
    void setNfServiceStatus(oai::_3gpp::model::NFServiceStatus const& value);
    /// <summary>
    ...
    /// 
    /// </summary>
    std::vector<oai::_3gpp::model::IpEndPoint> getIpEndPoints() const;
    void setIpEndPoints(std::vector<oai::_3gpp::model::IpEndPoint> const& value);
    ...
    /// 
    /// </summary>
    oai::_3gpp::model::PlmnOauth2 getPerPlmnOauth2ReqList() const;
    void setPerPlmnOauth2ReqList(oai::_3gpp::model::PlmnOauth2 const& value);
...
protected:
    ...
    std::vector<oai::_3gpp::model::NFServiceVersion> m_Versions;

    oai::_3gpp::model::UriScheme m_Scheme;

    oai::_3gpp::model::NFServiceStatus m_NfServiceStatus;

    std::string m_Fqdn;
    bool m_FqdnIsSet;
    std::string m_InterPlmnFqdn;
    bool m_InterPlmnFqdnIsSet;
    std::vector<oai::_3gpp::model::IpEndPoint> m_IpEndPoints;
    ...
    oai::_3gpp::model::PlmnOauth2 m_PerPlmnOauth2ReqList;
