...
public:
    ...
    bool operator==(const ImsiRange& rhs) const;
    bool operator!=(const ImsiRange& rhs) const;
    ...
    friend void to_json(nlohmann::json& j, const ImsiRange& o);
    friend void from_json(const nlohmann::json& j, ImsiRange& o);
protected:
    std::string m_Start;
    bool m_StartIsSet;
    std::string m_End;
