...
asn_TYPE_member_t asn_MBR_Ngap_NonDynamic5QIDescriptor_1[] = {
    {ATF_NOFLAGS,
     0,
     offsetof(struct Ngap_NonDynamic5QIDescriptor, fiveQI),
    ...
    {ATF_POINTER,
     4,
     offsetof(struct Ngap_NonDynamic5QIDescriptor, priorityLevelQos),
    ...
    {ATF_POINTER,
     3,
     offsetof(struct Ngap_NonDynamic5QIDescriptor, averagingWindow),
    ...
    {ATF_POINTER,
     2,
     offsetof(struct Ngap_NonDynamic5QIDescriptor, maximumDataBurstVolume),
    ...
    {ATF_POINTER,
     1,
     offsetof(struct Ngap_NonDynamic5QIDescriptor, iE_Extensions),
     (ASN_TAG_CLASS_CONTEXT | (4 << 2)),
     -1, /* IMPLICIT tag at current level */
     &asn_DEF_Ngap_ProtocolExtensionContainer_12929P195,
     0,
     {
#if !defined(ASN_DISABLE_OER_SUPPORT)
         0,
