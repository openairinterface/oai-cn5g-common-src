...
bool AmfCreatedEventSubscription::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "AmfCreatedEventSubscription" : pathPrefix;

        
    if (!m_Subscription.validate(msg, _pathPrefix + ".subscription")) {
        msg << _pathPrefix << ": Subscription is invalid;";
        success = false;
    }         
    if (reportListIsSet())
    {
...
bool AmfCreatedEventSubscription::operator==(const AmfCreatedEventSubscription& rhs) const
{
    return
...
oai::model::AmfEventSubscription AmfCreatedEventSubscription::getSubscription() const
{
    return m_Subscription;
}
void AmfCreatedEventSubscription::setSubscription(oai::model::AmfEventSubscription const& value)
{
...
std::vector<oai::model::AmfEventReport> AmfCreatedEventSubscription::getReportList() const
{
    return m_ReportList;
}
void AmfCreatedEventSubscription::setReportList(std::vector<oai::model::AmfEventReport> const& value)
{
    m_ReportList = value;
