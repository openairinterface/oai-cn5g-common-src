...
asn_TYPE_member_t asn_MBR_Ngap_SONConfigurationTransfer_1[] = {
    {ATF_POINTER,
     0,
     offsetof(struct Ngap_SONConfigurationTransfer, targetRANNodeID_SON),
    ...
    {ATF_POINTER,
     0,
     offsetof(struct Ngap_SONConfigurationTransfer, sourceRANNodeID),
    ...
    {ATF_POINTER,
     0,
     offsetof(struct Ngap_SONConfigurationTransfer, sONInformation),
