...
static asn_TYPE_member_t asn_MBR_Ngap_HandoverRequestAcknowledgeTransfer_1[] = {
    ...
    {ATF_POINTER,
     1,
     offsetof(struct Ngap_HandoverRequestAcknowledgeTransfer, securityResult),
    ...
    {ATF_POINTER,
     ...
     -1, /* IMPLICIT tag at current level */
     &asn_DEF_Ngap_ProtocolExtensionContainer_12929P110,
     0,
     {
#if !defined(ASN_DISABLE_OER_SUPPORT)
         0,
...
static const int asn_MAP_Ngap_HandoverRequestAcknowledgeTransfer_oms_1[] = {
    1, 2, 4, 5, 6};
...
static asn_SEQUENCE_specifics_t
    asn_SPC_Ngap_HandoverRequestAcknowledgeTransfer_specs_1 = {
        ...
        asn_MAP_Ngap_HandoverRequestAcknowledgeTransfer_oms_1, /* Optional
                                                                  members */
        5,
        0, /* Root/Additions */
