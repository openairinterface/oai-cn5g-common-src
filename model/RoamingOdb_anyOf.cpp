...
bool RoamingOdb_anyOf::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "RoamingOdb_anyOf" : pathPrefix;

    
    if (m_value == RoamingOdb_anyOf::eRoamingOdb_anyOf::INVALID_VALUE_OPENAPI_GENERATED)
    {
        success = false;
