...
bool ReportIntervalNrMdt_anyOf::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "ReportIntervalNrMdt_anyOf" : pathPrefix;

    
    if (m_value == ReportIntervalNrMdt_anyOf::eReportIntervalNrMdt_anyOf::INVALID_VALUE_OPENAPI_GENERATED)
    {
        success = false;
...
bool ReportIntervalNrMdt_anyOf::operator==(const ReportIntervalNrMdt_anyOf& rhs) const
{
    return
...
void to_json(nlohmann::json& j, const ReportIntervalNrMdt_anyOf& o)
{
    ...
    switch (o.getValue())
    {
        case ReportIntervalNrMdt_anyOf::eReportIntervalNrMdt_anyOf::INVALID_VALUE_OPENAPI_GENERATED:
...
ReportIntervalNrMdt_anyOf::eReportIntervalNrMdt_anyOf ReportIntervalNrMdt_anyOf::getValue() const
{
    return m_value;
}
void ReportIntervalNrMdt_anyOf::setValue(ReportIntervalNrMdt_anyOf::eReportIntervalNrMdt_anyOf value)
{
    m_value = value;
}
