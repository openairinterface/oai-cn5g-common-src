...
public:
    ...
    friend  void to_json(nlohmann::json& j, const DownlinkDataNotificationControl& o);
    friend  void from_json(const nlohmann::json& j, DownlinkDataNotificationControl& o);
protected:
