...
bool UserDataCongestionCollection::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "UserDataCongestionCollection" : pathPrefix;
...
bool UserDataCongestionCollection::operator==(const UserDataCongestionCollection& rhs) const
{
    return
    ...
    ((!timeIntervIsSet() && !rhs.timeIntervIsSet()) || (timeIntervIsSet() && rhs.timeIntervIsSet() && getTimeInterv() == rhs.getTimeInterv())) &&
    
    
    ((!thrputUlIsSet() && !rhs.thrputUlIsSet()) || (thrputUlIsSet() && rhs.thrputUlIsSet() && getThrputUl() == rhs.getThrputUl())) &&
    
    
    ((!thrputDlIsSet() && !rhs.thrputDlIsSet()) || (thrputDlIsSet() && rhs.thrputDlIsSet() && getThrputDl() == rhs.getThrputDl())) &&
    
    
    ((!thrputPkUlIsSet() && !rhs.thrputPkUlIsSet()) || (thrputPkUlIsSet() && rhs.thrputPkUlIsSet() && getThrputPkUl() == rhs.getThrputPkUl())) &&
    
    
    ((!thrputPkDlIsSet() && !rhs.thrputPkDlIsSet()) || (thrputPkDlIsSet() && rhs.thrputPkDlIsSet() && getThrputPkDl() == rhs.getThrputPkDl()))
...
oai::_3gpp::model::FlowInfo UserDataCongestionCollection::getIpTrafficFilter() const
{
    return m_IpTrafficFilter;
}
void UserDataCongestionCollection::setIpTrafficFilter(oai::_3gpp::model::FlowInfo const& value)
{
...
oai::_3gpp::model::TimeWindow UserDataCongestionCollection::getTimeInterv() const
{
    return m_TimeInterv;
}
void UserDataCongestionCollection::setTimeInterv(oai::_3gpp::model::TimeWindow const& value)
{
    m_TimeInterv = value;
