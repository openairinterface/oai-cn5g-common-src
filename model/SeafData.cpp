...
bool SeafData::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "SeafData" : pathPrefix;

        
    if (!m_NgKsi.validate(msg, _pathPrefix + ".ngKsi")) {
        msg << _pathPrefix << ": NgKsi is invalid;";
        success = false;
    }    
    if (!m_KeyAmf.validate(msg, _pathPrefix + ".keyAmf")) {
        msg << _pathPrefix << ": KeyAmf is invalid;";
        success = false;
    }     
    if (nhIsSet())
    {
...
bool SeafData::operator==(const SeafData& rhs) const
{
    ...
    ((!nhIsSet() && !rhs.nhIsSet()) || (nhIsSet() && rhs.nhIsSet() && getNh() == rhs.getNh())) &&
    
    
    ((!nccIsSet() && !rhs.nccIsSet()) || (nccIsSet() && rhs.nccIsSet() && getNcc() == rhs.getNcc())) &&
    
    
    ((!keyAmfChangeIndIsSet() && !rhs.keyAmfChangeIndIsSet()) || (keyAmfChangeIndIsSet() && rhs.keyAmfChangeIndIsSet() && isKeyAmfChangeInd() == rhs.isKeyAmfChangeInd())) &&
    
    
    ((!keyAmfHDerivationIndIsSet() && !rhs.keyAmfHDerivationIndIsSet()) || (keyAmfHDerivationIndIsSet() && rhs.keyAmfHDerivationIndIsSet() && isKeyAmfHDerivationInd() == rhs.isKeyAmfHDerivationInd()))
...
oai::model::NgKsi SeafData::getNgKsi() const
{
    return m_NgKsi;
}
void SeafData::setNgKsi(oai::model::NgKsi const& value)
{
    m_NgKsi = value;
}
oai::model::KeyAmf SeafData::getKeyAmf() const
{
    return m_KeyAmf;
}
void SeafData::setKeyAmf(oai::model::KeyAmf const& value)
{
    m_KeyAmf = value;
}
