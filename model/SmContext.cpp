...
bool SmContext::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    ...
    /* QosFlowsList */ {
        const std::vector<oai::_3gpp::model::QosFlowSetupItem>& value = m_QosFlowsList;
    ...
    {
        const std::vector<oai::_3gpp::model::EpsBearerInfo>& value = m_EpsBearerInfo;
    ...
    {
        const std::vector<oai::_3gpp::model::QosFlowTunnel>& value = m_AddRanTunnelInfo;
    ...
    {
        const std::vector<oai::_3gpp::model::QosFlowTunnel>& value = m_AddRedRanTunnelInfo;
...
void SmContext::setPduSessionType(oai::_3gpp::model::PduSessionType const& value)
{
...
std::vector<oai::_3gpp::model::QosFlowSetupItem> SmContext::getQosFlowsList() const
{
    return m_QosFlowsList;
}
void SmContext::setQosFlowsList(std::vector<oai::_3gpp::model::QosFlowSetupItem> const& value)
{
...
void SmContext::setPduSessionSmfBinding(oai::_3gpp::model::SbiBindingLevel const& value)
{
...
void SmContext::setEpsPdnCnxInfo(oai::_3gpp::model::EpsPdnCnxInfo const& value)
{
...
std::vector<oai::_3gpp::model::EpsBearerInfo> SmContext::getEpsBearerInfo() const
{
    return m_EpsBearerInfo;
}
void SmContext::setEpsBearerInfo(std::vector<oai::_3gpp::model::EpsBearerInfo> const& value)
{
...
oai::_3gpp::model::MaxIntegrityProtectedDataRate SmContext::getMaxIntegrityProtectedDataRate() const
{
    return m_MaxIntegrityProtectedDataRate;
}
void SmContext::setMaxIntegrityProtectedDataRate(oai::_3gpp::model::MaxIntegrityProtectedDataRate const& value)
{
...
oai::_3gpp::model::MaxIntegrityProtectedDataRate SmContext::getMaxIntegrityProtectedDataRateDl() const
{
    return m_MaxIntegrityProtectedDataRateDl;
}
void SmContext::setMaxIntegrityProtectedDataRateDl(oai::_3gpp::model::MaxIntegrityProtectedDataRate const& value)
{
...
void SmContext::setChargingInfo(oai::_3gpp::model::ChargingInformation const& value)
{
...
oai::_3gpp::model::RoamingChargingProfile SmContext::getRoamingChargingProfile() const
{
    return m_RoamingChargingProfile;
}
void SmContext::setRoamingChargingProfile(oai::_3gpp::model::RoamingChargingProfile const& value)
{
...
oai::_3gpp::model::RedundantPduSessionInformation SmContext::getRedundantPduSessionInfo() const
{
    return m_RedundantPduSessionInfo;
}
void SmContext::setRedundantPduSessionInfo(oai::_3gpp::model::RedundantPduSessionInformation const& value)
{
...
void SmContext::setRanTunnelInfo(oai::_3gpp::model::QosFlowTunnel const& value)
{
...
std::vector<oai::_3gpp::model::QosFlowTunnel> SmContext::getAddRanTunnelInfo() const
{
    return m_AddRanTunnelInfo;
}
void SmContext::setAddRanTunnelInfo(std::vector<oai::_3gpp::model::QosFlowTunnel> const& value)
{
...
void SmContext::setRedRanTunnelInfo(oai::_3gpp::model::QosFlowTunnel const& value)
{
...
std::vector<oai::_3gpp::model::QosFlowTunnel> SmContext::getAddRedRanTunnelInfo() const
{
    return m_AddRedRanTunnelInfo;
}
void SmContext::setAddRedRanTunnelInfo(std::vector<oai::_3gpp::model::QosFlowTunnel> const& value)
{
...
oai::_3gpp::model::SatelliteBackhaulCategory SmContext::getSatelliteBackhaulCat() const
{
    return m_SatelliteBackhaulCat;
}
void SmContext::setSatelliteBackhaulCat(oai::_3gpp::model::SatelliteBackhaulCategory const& value)
{
