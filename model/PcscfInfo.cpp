...
void PcscfInfo::setGmIpv6Addresses(
...
void PcscfInfo::setMwIpv6Addresses(
    std::vector<oai::_3gpp::model::Ipv6Addr> const& value) {
...
PcscfInfo::getServedIpv4AddressRanges() const {
...
PcscfInfo::getServedIpv6PrefixRanges() const {
