...
oai::model::SmContextConfiguration SmContextUpdateData::getSmContextConfig() const
{
    return m_SmContextConfig;
}
void SmContextUpdateData::setSmContextConfig(oai::model::SmContextConfiguration const& value)
{
