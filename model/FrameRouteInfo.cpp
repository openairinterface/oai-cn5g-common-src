...
bool FrameRouteInfo::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "FrameRouteInfo" : pathPrefix;
...
oai::model::Ipv6Prefix FrameRouteInfo::getIpv6Prefix() const
{
    return m_Ipv6Prefix;
}
void FrameRouteInfo::setIpv6Prefix(oai::model::Ipv6Prefix const& value)
{
    m_Ipv6Prefix = value;
