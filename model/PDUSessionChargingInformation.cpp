...
oai::_3gpp::model::UserInformation PDUSessionChargingInformation::getUserInformation() const
{
    return m_UserInformation;
}
void PDUSessionChargingInformation::setUserInformation(oai::_3gpp::model::UserInformation const& value)
{
...
oai::_3gpp::model::UserLocation PDUSessionChargingInformation::getUserLocationinfo() const
{
    return m_UserLocationinfo;
}
void PDUSessionChargingInformation::setUserLocationinfo(oai::_3gpp::model::UserLocation const& value)
{
...
oai::_3gpp::model::UserLocation PDUSessionChargingInformation::getMAPDUNon3GPPUserLocationInfo() const
{
    return m_MAPDUNon3GPPUserLocationInfo;
}
void PDUSessionChargingInformation::setMAPDUNon3GPPUserLocationInfo(oai::_3gpp::model::UserLocation const& value)
{
...
std::map<std::string, oai::_3gpp::model::PresenceInfo> PDUSessionChargingInformation::getPresenceReportingAreaInformation() const
{
    return m_PresenceReportingAreaInformation;
}
void PDUSessionChargingInformation::setPresenceReportingAreaInformation(std::map<std::string, oai::_3gpp::model::PresenceInfo> const& value)
{
...
oai::_3gpp::model::PDUSessionInformation PDUSessionChargingInformation::getPduSessionInformation() const
{
    return m_PduSessionInformation;
}
void PDUSessionChargingInformation::setPduSessionInformation(oai::_3gpp::model::PDUSessionInformation const& value)
{
...
oai::_3gpp::model::RANSecondaryRATUsageReport PDUSessionChargingInformation::getRANSecondaryRATUsageReport() const
{
    return m_RANSecondaryRATUsageReport;
}
void PDUSessionChargingInformation::setRANSecondaryRATUsageReport(oai::_3gpp::model::RANSecondaryRATUsageReport const& value)
{
