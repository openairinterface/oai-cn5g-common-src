...
bool RouteToLocation::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "RouteToLocation" : pathPrefix;
...
bool RouteToLocation::operator==(const RouteToLocation& rhs) const
{
    ...
    ((!routeInfoIsSet() && !rhs.routeInfoIsSet()) || (routeInfoIsSet() && rhs.routeInfoIsSet() && getRouteInfo() == rhs.getRouteInfo())) &&
    
    
    ((!routeProfIdIsSet() && !rhs.routeProfIdIsSet()) || (routeProfIdIsSet() && rhs.routeProfIdIsSet() && getRouteProfId() == rhs.getRouteProfId()))
...
oai::_3gpp::model::RouteInformation RouteToLocation::getRouteInfo() const
{
    return m_RouteInfo;
}
void RouteToLocation::setRouteInfo(oai::_3gpp::model::RouteInformation const& value)
{
    m_RouteInfo = value;
