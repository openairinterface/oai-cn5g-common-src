...
oai::model::Snssai PcscfRestorationRequestData::getSliceInfo() const
{
    return m_SliceInfo;
}
void PcscfRestorationRequestData::setSliceInfo(oai::model::Snssai const& value)
{
    m_SliceInfo = value;
...
oai::model::Ipv6Addr PcscfRestorationRequestData::getUeIpv6() const
{
    return m_UeIpv6;
}
void PcscfRestorationRequestData::setUeIpv6(oai::model::Ipv6Addr const& value)
{
    m_UeIpv6 = value;
    m_UeIpv6IsSet = true;
}
