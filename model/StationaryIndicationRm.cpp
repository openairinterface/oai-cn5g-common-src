...
bool StationaryIndicationRm::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "StationaryIndicationRm" : pathPrefix;

    
    return success;
}

bool StationaryIndicationRm::operator==(const StationaryIndicationRm& rhs) const
{
    return
