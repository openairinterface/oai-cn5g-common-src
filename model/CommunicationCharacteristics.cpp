...
bool CommunicationCharacteristics::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "CommunicationCharacteristics" : pathPrefix;

                            
    return success;
}

bool CommunicationCharacteristics::operator==(const CommunicationCharacteristics& rhs) const
{
    return
    
    
    
    ((!ppSubsRegTimerIsSet() && !rhs.ppSubsRegTimerIsSet()) || (ppSubsRegTimerIsSet() && rhs.ppSubsRegTimerIsSet() && getPpSubsRegTimer() == rhs.getPpSubsRegTimer())) &&
    
    
    ((!ppActiveTimeIsSet() && !rhs.ppActiveTimeIsSet()) || (ppActiveTimeIsSet() && rhs.ppActiveTimeIsSet() && getPpActiveTime() == rhs.getPpActiveTime())) &&
    
    
    ((!ppDlPacketCountIsSet() && !rhs.ppDlPacketCountIsSet()) || (ppDlPacketCountIsSet() && rhs.ppDlPacketCountIsSet() && getPpDlPacketCount() == rhs.getPpDlPacketCount())) &&
    
    
    ((!ppDlPacketCountExtIsSet() && !rhs.ppDlPacketCountExtIsSet()) || (ppDlPacketCountExtIsSet() && rhs.ppDlPacketCountExtIsSet() && getPpDlPacketCountExt() == rhs.getPpDlPacketCountExt())) &&
    
    
    ((!ppMaximumResponseTimeIsSet() && !rhs.ppMaximumResponseTimeIsSet()) || (ppMaximumResponseTimeIsSet() && rhs.ppMaximumResponseTimeIsSet() && getPpMaximumResponseTime() == rhs.getPpMaximumResponseTime())) &&
    
    
    ((!ppMaximumLatencyIsSet() && !rhs.ppMaximumLatencyIsSet()) || (ppMaximumLatencyIsSet() && rhs.ppMaximumLatencyIsSet() && getPpMaximumLatency() == rhs.getPpMaximumLatency()))
...
oai::_3gpp::model::PpSubsRegTimer CommunicationCharacteristics::getPpSubsRegTimer() const
{
    return m_PpSubsRegTimer;
}
void CommunicationCharacteristics::setPpSubsRegTimer(oai::_3gpp::model::PpSubsRegTimer const& value)
{
...
oai::_3gpp::model::PpActiveTime CommunicationCharacteristics::getPpActiveTime() const
{
    return m_PpActiveTime;
}
void CommunicationCharacteristics::setPpActiveTime(oai::_3gpp::model::PpActiveTime const& value)
{
...
oai::_3gpp::model::PpDlPacketCountExt CommunicationCharacteristics::getPpDlPacketCountExt() const
{
    return m_PpDlPacketCountExt;
}
void CommunicationCharacteristics::setPpDlPacketCountExt(oai::_3gpp::model::PpDlPacketCountExt const& value)
{
...
oai::_3gpp::model::PpMaximumResponseTime CommunicationCharacteristics::getPpMaximumResponseTime() const
{
    return m_PpMaximumResponseTime;
}
void CommunicationCharacteristics::setPpMaximumResponseTime(oai::_3gpp::model::PpMaximumResponseTime const& value)
{
...
oai::_3gpp::model::PpMaximumLatency CommunicationCharacteristics::getPpMaximumLatency() const
{
    return m_PpMaximumLatency;
}
void CommunicationCharacteristics::setPpMaximumLatency(oai::_3gpp::model::PpMaximumLatency const& value)
{
