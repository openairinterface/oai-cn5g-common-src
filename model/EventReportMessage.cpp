...
void EventReportMessage::setEventClass(oai::_3gpp::model::EventClass const& value)
{
    m_EventClass = value;
}
...
void EventReportMessage::setEventContent(oai::_3gpp::model::RefToBinaryData const& value)
{
