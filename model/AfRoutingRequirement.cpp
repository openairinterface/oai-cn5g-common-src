...
std::vector<oai::_3gpp::model::RouteToLocation> AfRoutingRequirement::getRouteToLocs() const
{
    return m_RouteToLocs;
}
void AfRoutingRequirement::setRouteToLocs(std::vector<oai::_3gpp::model::RouteToLocation> const& value)
{
    m_RouteToLocs = value;
...
oai::_3gpp::model::SpatialValidity AfRoutingRequirement::getSpVal() const
{
    return m_SpVal;
}
void AfRoutingRequirement::setSpVal(oai::_3gpp::model::SpatialValidity const& value)
{
    m_SpVal = value;
    m_SpValIsSet = true;
}
...
std::vector<oai::_3gpp::model::TemporalValidity> AfRoutingRequirement::getTempVals() const
{
    return m_TempVals;
}
void AfRoutingRequirement::setTempVals(std::vector<oai::_3gpp::model::TemporalValidity> const& value)
{
    m_TempVals = value;
...
oai::_3gpp::model::UpPathChgEvent AfRoutingRequirement::getUpPathChgSub() const
{
    return m_UpPathChgSub;
}
void AfRoutingRequirement::setUpPathChgSub(oai::_3gpp::model::UpPathChgEvent const& value)
{
...
std::vector<oai::_3gpp::model::EasIpReplacementInfo> AfRoutingRequirement::getEasIpReplaceInfos() const
{
    return m_EasIpReplaceInfos;
}
void AfRoutingRequirement::setEasIpReplaceInfos(std::vector<oai::_3gpp::model::EasIpReplacementInfo> const& value)
{
