...
bool DatalinkReportingConfiguration::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "DatalinkReportingConfiguration" : pathPrefix;

         
    if (dddTrafficDesIsSet())
    {
        const std::vector<oai::model::DddTrafficDescriptor>& value = m_DddTrafficDes;
...
bool DatalinkReportingConfiguration::operator==(const DatalinkReportingConfiguration& rhs) const
{
    return
...
std::vector<oai::model::DddTrafficDescriptor> DatalinkReportingConfiguration::getDddTrafficDes() const
{
    return m_DddTrafficDes;
}
void DatalinkReportingConfiguration::setDddTrafficDes(std::vector<oai::model::DddTrafficDescriptor> const& value)
{
...
oai::model::Snssai DatalinkReportingConfiguration::getSlice() const
{
    return m_Slice;
}
void DatalinkReportingConfiguration::setSlice(oai::model::Snssai const& value)
{
    m_Slice = value;
    m_SliceIsSet = true;
}
...
std::vector<oai::model::DlDataDeliveryStatus> DatalinkReportingConfiguration::getDddStatusList() const
{
    return m_DddStatusList;
}
void DatalinkReportingConfiguration::setDddStatusList(std::vector<oai::model::DlDataDeliveryStatus> const& value)
{
