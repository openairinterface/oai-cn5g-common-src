...
bool UeInitiatedResourceRequest::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    ...
    /* PackFiltInfo */ {
        const std::vector<oai::_3gpp::model::PacketFilterInfo>& value = m_PackFiltInfo;
        ...
        { // Recursive validation of array elements
            ...
            int i = 0;
            for (const oai::_3gpp::model::PacketFilterInfo& value : value)
            { 
...
oai::_3gpp::model::RuleOperation UeInitiatedResourceRequest::getRuleOp() const
{
    return m_RuleOp;
}
void UeInitiatedResourceRequest::setRuleOp(oai::_3gpp::model::RuleOperation const& value)
{
    m_RuleOp = value;
}
...
std::vector<oai::_3gpp::model::PacketFilterInfo> UeInitiatedResourceRequest::getPackFiltInfo() const
{
    return m_PackFiltInfo;
}
void UeInitiatedResourceRequest::setPackFiltInfo(std::vector<oai::_3gpp::model::PacketFilterInfo> const& value)
{
    m_PackFiltInfo = value;
}
oai::_3gpp::model::RequestedQos UeInitiatedResourceRequest::getReqQos() const
{
    return m_ReqQos;
}
void UeInitiatedResourceRequest::setReqQos(oai::_3gpp::model::RequestedQos const& value)
{
    m_ReqQos = value;
    m_ReqQosIsSet = true;
}
