...
std::vector<oai::_3gpp::model::ServiceName> ServiceNameListCond::getServiceNameList() const
{
    return m_ServiceNameList;
}
void ServiceNameListCond::setServiceNameList(std::vector<oai::_3gpp::model::ServiceName> const& value)
{
