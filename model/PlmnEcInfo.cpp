...
oai::_3gpp::model::EcRestrictionDataWb PlmnEcInfo::getEcRestrictionDataWb() const
{
    return m_EcRestrictionDataWb;
}
void PlmnEcInfo::setEcRestrictionDataWb(oai::_3gpp::model::EcRestrictionDataWb const& value)
{
