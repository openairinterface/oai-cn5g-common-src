...
_5gsTrackingAreaIdList::_5gsTrackingAreaIdList(
  ...
  uint8_t size = (tai_list.size() > k5gsTrackingAreaIdListMaximumSupportedTAIs)
...
//------------------------------------------------------------------------------
int _5gsTrackingAreaIdList::EncodeType00(p_tai_t item, uint8_t *buf,
                                         int len) const {
  int encoded_size = 0;
...
//------------------------------------------------------------------------------
int _5gsTrackingAreaIdList::EncodeType01(p_tai_t item, uint8_t *buf,
                                         int len) const {
  // TODO:
  return KEncodeDecodeError;
}
...
//------------------------------------------------------------------------------
int _5gsTrackingAreaIdList::EncodeType10(p_tai_t item, uint8_t *buf,
                                         int len) const {
  // TODO:
  return KEncodeDecodeError;
}
