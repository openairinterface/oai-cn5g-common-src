...
PreemptionCapability_anyOf::ePreemptionCapability_anyOf PreemptionCapability::getEnumValue() const
{
    return m_value.getValue();
}

void PreemptionCapability::setEnumValue(PreemptionCapability_anyOf::ePreemptionCapability_anyOf  value)
{
