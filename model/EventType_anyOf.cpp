...
bool EventType_anyOf::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "EventType_anyOf" : pathPrefix;

    
    if (m_value == EventType_anyOf::eEventType_anyOf::INVALID_VALUE_OPENAPI_GENERATED)
    {
        success = false;
...
void to_json(nlohmann::json& j, const EventType_anyOf& o)
{
    ...
    switch (o.getValue())
    {
        ...
        case EventType_anyOf::eEventType_anyOf::TYPE_ALLOCATION_CODE_REPORT:
            ...
            break;
        case EventType_anyOf::eEventType_anyOf::FREQUENT_MOBILITY_REGISTRATION_REPORT:
...
void from_json(const nlohmann::json& j, EventType_anyOf& o)
{
    ...
    if (s == "LOSS_OF_CONNECTIVITY") {
     ...
     o.setValue(EventType_anyOf::eEventType_anyOf::CHANGE_OF_SUPI_PEI_ASSOCIATION);
    } 
     ...
     o.setValue(EventType_anyOf::eEventType_anyOf::AVAILABILITY_AFTER_DDN_FAILURE);
    } 
     ...
     o.setValue(EventType_anyOf::eEventType_anyOf::UE_CONNECTION_MANAGEMENT_STATE);
    } 
     ...
     o.setValue(EventType_anyOf::eEventType_anyOf::FREQUENT_MOBILITY_REGISTRATION_REPORT);
    } 
