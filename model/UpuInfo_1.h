...
public:
    ...
    /// 
    /// </summary>
    std::vector<oai::model::UpuData_2> getUpuDataList() const;
    void setUpuDataList(std::vector<oai::model::UpuData_2> const& value);
...
protected:
    std::vector<oai::model::UpuData_2> m_UpuDataList;
