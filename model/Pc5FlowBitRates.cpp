...
bool Pc5FlowBitRates::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "Pc5FlowBitRates" : pathPrefix;
...
bool Pc5FlowBitRates::operator==(const Pc5FlowBitRates& rhs) const
{
    ...
    ((!guaFbrIsSet() && !rhs.guaFbrIsSet()) || (guaFbrIsSet() && rhs.guaFbrIsSet() && getGuaFbr() == rhs.getGuaFbr())) &&
    
    
    ((!maxFbrIsSet() && !rhs.maxFbrIsSet()) || (maxFbrIsSet() && rhs.maxFbrIsSet() && getMaxFbr() == rhs.getMaxFbr()))
