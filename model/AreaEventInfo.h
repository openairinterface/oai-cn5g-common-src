...
public:
    ...
    /// 
    /// </summary>
    std::vector<oai::model::ReportingArea> getAreaDefinition() const;
    void setAreaDefinition(std::vector<oai::model::ReportingArea> const& value);
    /// <summary>
    /// 
    /// </summary>
    oai::model::OccurrenceInfo getOccurrenceInfo() const;
    void setOccurrenceInfo(oai::model::OccurrenceInfo const& value);
...
protected:
    std::vector<oai::model::ReportingArea> m_AreaDefinition;

    oai::model::OccurrenceInfo m_OccurrenceInfo;
