...
bool PduSessionTsnBridge::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "PduSessionTsnBridge" : pathPrefix;
...
bool PduSessionTsnBridge::operator==(const PduSessionTsnBridge& rhs) const
{
    ...
    ((!ueIpv6AddrPrefixIsSet() && !rhs.ueIpv6AddrPrefixIsSet()) || (ueIpv6AddrPrefixIsSet() && rhs.ueIpv6AddrPrefixIsSet() && getUeIpv6AddrPrefix() == rhs.getUeIpv6AddrPrefix()))
...
oai::_3gpp::model::TsnBridgeInfo PduSessionTsnBridge::getTsnBridgeInfo() const
{
    return m_TsnBridgeInfo;
}
void PduSessionTsnBridge::setTsnBridgeInfo(oai::_3gpp::model::TsnBridgeInfo const& value)
{
    m_TsnBridgeInfo = value;
}
oai::_3gpp::model::BridgeManagementContainer PduSessionTsnBridge::getTsnBridgeManCont() const
{
    return m_TsnBridgeManCont;
}
void PduSessionTsnBridge::setTsnBridgeManCont(oai::_3gpp::model::BridgeManagementContainer const& value)
{
...
oai::_3gpp::model::PortManagementContainer PduSessionTsnBridge::getTsnPortManContDstt() const
{
    return m_TsnPortManContDstt;
}
void PduSessionTsnBridge::setTsnPortManContDstt(oai::_3gpp::model::PortManagementContainer const& value)
{
...
std::vector<oai::_3gpp::model::PortManagementContainer> PduSessionTsnBridge::getTsnPortManContNwtts() const
{
    return m_TsnPortManContNwtts;
}
void PduSessionTsnBridge::setTsnPortManContNwtts(std::vector<oai::_3gpp::model::PortManagementContainer> const& value)
{
...
oai::_3gpp::model::Snssai PduSessionTsnBridge::getSnssai() const
{
    return m_Snssai;
}
void PduSessionTsnBridge::setSnssai(oai::_3gpp::model::Snssai const& value)
{
    m_Snssai = value;
    m_SnssaiIsSet = true;
}
...
oai::_3gpp::model::Ipv6Prefix PduSessionTsnBridge::getUeIpv6AddrPrefix() const
{
    return m_UeIpv6AddrPrefix;
}
void PduSessionTsnBridge::setUeIpv6AddrPrefix(oai::_3gpp::model::Ipv6Prefix const& value)
{
