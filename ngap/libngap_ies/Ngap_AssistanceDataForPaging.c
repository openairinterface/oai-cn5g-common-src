...
asn_TYPE_member_t asn_MBR_Ngap_AssistanceDataForPaging_1[] = {
    ...
    {ATF_POINTER,
     2,
     offsetof(struct Ngap_AssistanceDataForPaging, pagingAttemptInformation),
    ...
    {ATF_POINTER,
     ...
     -1, /* IMPLICIT tag at current level */
     &asn_DEF_Ngap_ProtocolExtensionContainer_12929P14,
     0,
     {
#if !defined(ASN_DISABLE_OER_SUPPORT)
         0,
...
static const asn_TYPE_tag2member_t
    asn_MAP_Ngap_AssistanceDataForPaging_tag2el_1[] = {
        {(ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0,
         0}, /* assistanceDataForRecommendedCells */
        {(ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0,
         0}, /* pagingAttemptInformation */
