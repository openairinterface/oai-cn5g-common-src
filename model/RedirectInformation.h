...
public:
    ...
    /// 
    /// </summary>
    oai::model::RedirectAddressType getRedirectAddressType() const;
    void setRedirectAddressType(oai::model::RedirectAddressType const& value);
...
protected:
    ...
    oai::model::RedirectAddressType m_RedirectAddressType;
