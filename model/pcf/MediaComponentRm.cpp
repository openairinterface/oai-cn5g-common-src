...
bool MediaComponentRm::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "MediaComponentRm" : pathPrefix;
    ...
    {
        const std::vector<oai::model::pcf::AlternativeServiceRequirementsData>& value = m_AltSerReqsData;
        ...
        { // Recursive validation of array elements
            const std::string oldValuePath = currentValuePath;
            int i = 0;
            for (const oai::model::pcf::AlternativeServiceRequirementsData& value : value)
            { 
                const std::string currentValuePath = oldValuePath + "[" + std::to_string(i) + "]";
                        
        success = value.validate(msg, currentValuePath + ".altSerReqsData") && success;
    ...
    if (medSubCompsIsSet())
    {
        const std::map<std::string, oai::model::pcf::MediaSubComponentRm>& value = m_MedSubComps;
...
bool MediaComponentRm::operator==(const MediaComponentRm& rhs) const
{
    ...
    ((!afRoutReqIsSet() && !rhs.afRoutReqIsSet()) || (afRoutReqIsSet() && rhs.afRoutReqIsSet() && getAfRoutReq() == rhs.getAfRoutReq())) &&
    
    
    ((!afSfcReqIsSet() && !rhs.afSfcReqIsSet()) || (afSfcReqIsSet() && rhs.afSfcReqIsSet() && getAfSfcReq() == rhs.getAfSfcReq())) &&
    
    
    ((!qosReferenceIsSet() && !rhs.qosReferenceIsSet()) || (qosReferenceIsSet() && rhs.qosReferenceIsSet() && getQosReference() == rhs.getQosReference())) &&
    
    
    ((!altSerReqsIsSet() && !rhs.altSerReqsIsSet()) || (altSerReqsIsSet() && rhs.altSerReqsIsSet() && getAltSerReqs() == rhs.getAltSerReqs())) &&
    
    
    ((!altSerReqsDataIsSet() && !rhs.altSerReqsDataIsSet()) || (altSerReqsDataIsSet() && rhs.altSerReqsDataIsSet() && getAltSerReqsData() == rhs.getAltSerReqsData())) &&
    
    
    ((!disUeNotifIsSet() && !rhs.disUeNotifIsSet()) || (disUeNotifIsSet() && rhs.disUeNotifIsSet() && isDisUeNotif() == rhs.isDisUeNotif())) &&
    
    
    ((!contVerIsSet() && !rhs.contVerIsSet()) || (contVerIsSet() && rhs.contVerIsSet() && getContVer() == rhs.getContVer())) &&
    
    
    ((!codecsIsSet() && !rhs.codecsIsSet()) || (codecsIsSet() && rhs.codecsIsSet() && getCodecs() == rhs.getCodecs())) &&
    
    
    ((!desMaxLatencyIsSet() && !rhs.desMaxLatencyIsSet()) || (desMaxLatencyIsSet() && rhs.desMaxLatencyIsSet() && getDesMaxLatency() == rhs.getDesMaxLatency())) &&
    
    
    ((!desMaxLossIsSet() && !rhs.desMaxLossIsSet()) || (desMaxLossIsSet() && rhs.desMaxLossIsSet() && getDesMaxLoss() == rhs.getDesMaxLoss())) &&
    
    
    ((!flusIdIsSet() && !rhs.flusIdIsSet()) || (flusIdIsSet() && rhs.flusIdIsSet() && getFlusId() == rhs.getFlusId())) &&
    
    
    ((!fStatusIsSet() && !rhs.fStatusIsSet()) || (fStatusIsSet() && rhs.fStatusIsSet() && getFStatus() == rhs.getFStatus())) &&
    
    
    ((!marBwDlIsSet() && !rhs.marBwDlIsSet()) || (marBwDlIsSet() && rhs.marBwDlIsSet() && getMarBwDl() == rhs.getMarBwDl())) &&
    
    
    ((!marBwUlIsSet() && !rhs.marBwUlIsSet()) || (marBwUlIsSet() && rhs.marBwUlIsSet() && getMarBwUl() == rhs.getMarBwUl())) &&
    
    
    ((!maxPacketLossRateDlIsSet() && !rhs.maxPacketLossRateDlIsSet()) || (maxPacketLossRateDlIsSet() && rhs.maxPacketLossRateDlIsSet() && getMaxPacketLossRateDl() == rhs.getMaxPacketLossRateDl())) &&
    
    
    ((!maxPacketLossRateUlIsSet() && !rhs.maxPacketLossRateUlIsSet()) || (maxPacketLossRateUlIsSet() && rhs.maxPacketLossRateUlIsSet() && getMaxPacketLossRateUl() == rhs.getMaxPacketLossRateUl())) &&
    
    
    ((!maxSuppBwDlIsSet() && !rhs.maxSuppBwDlIsSet()) || (maxSuppBwDlIsSet() && rhs.maxSuppBwDlIsSet() && getMaxSuppBwDl() == rhs.getMaxSuppBwDl())) &&
    
    
    ((!maxSuppBwUlIsSet() && !rhs.maxSuppBwUlIsSet()) || (maxSuppBwUlIsSet() && rhs.maxSuppBwUlIsSet() && getMaxSuppBwUl() == rhs.getMaxSuppBwUl())) &&
    
    (getMedCompN() == rhs.getMedCompN())
     &&
    
    
    ((!medSubCompsIsSet() && !rhs.medSubCompsIsSet()) || (medSubCompsIsSet() && rhs.medSubCompsIsSet() && getMedSubComps() == rhs.getMedSubComps())) &&
    
    
    ((!medTypeIsSet() && !rhs.medTypeIsSet()) || (medTypeIsSet() && rhs.medTypeIsSet() && getMedType() == rhs.getMedType())) &&
    
    
    ((!minDesBwDlIsSet() && !rhs.minDesBwDlIsSet()) || (minDesBwDlIsSet() && rhs.minDesBwDlIsSet() && getMinDesBwDl() == rhs.getMinDesBwDl())) &&
    
    
    ((!minDesBwUlIsSet() && !rhs.minDesBwUlIsSet()) || (minDesBwUlIsSet() && rhs.minDesBwUlIsSet() && getMinDesBwUl() == rhs.getMinDesBwUl())) &&
    
    
    ((!mirBwDlIsSet() && !rhs.mirBwDlIsSet()) || (mirBwDlIsSet() && rhs.mirBwDlIsSet() && getMirBwDl() == rhs.getMirBwDl())) &&
    
    
    ((!mirBwUlIsSet() && !rhs.mirBwUlIsSet()) || (mirBwUlIsSet() && rhs.mirBwUlIsSet() && getMirBwUl() == rhs.getMirBwUl())) &&
    
    
    ((!preemptCapIsSet() && !rhs.preemptCapIsSet()) || (preemptCapIsSet() && rhs.preemptCapIsSet() && getPreemptCap() == rhs.getPreemptCap())) &&
    
    
    ((!preemptVulnIsSet() && !rhs.preemptVulnIsSet()) || (preemptVulnIsSet() && rhs.preemptVulnIsSet() && getPreemptVuln() == rhs.getPreemptVuln())) &&
    
    
    ((!prioSharingIndIsSet() && !rhs.prioSharingIndIsSet()) || (prioSharingIndIsSet() && rhs.prioSharingIndIsSet() && getPrioSharingInd() == rhs.getPrioSharingInd())) &&
    
    
    ((!resPrioIsSet() && !rhs.resPrioIsSet()) || (resPrioIsSet() && rhs.resPrioIsSet() && getResPrio() == rhs.getResPrio())) &&
    
    
    ((!rrBwIsSet() && !rhs.rrBwIsSet()) || (rrBwIsSet() && rhs.rrBwIsSet() && getRrBw() == rhs.getRrBw())) &&
    
    
    ((!rsBwIsSet() && !rhs.rsBwIsSet()) || (rsBwIsSet() && rhs.rsBwIsSet() && getRsBw() == rhs.getRsBw())) &&
    
    
    ((!sharingKeyDlIsSet() && !rhs.sharingKeyDlIsSet()) || (sharingKeyDlIsSet() && rhs.sharingKeyDlIsSet() && getSharingKeyDl() == rhs.getSharingKeyDl())) &&
    
    
    ((!sharingKeyUlIsSet() && !rhs.sharingKeyUlIsSet()) || (sharingKeyUlIsSet() && rhs.sharingKeyUlIsSet() && getSharingKeyUl() == rhs.getSharingKeyUl())) &&
    
    
    ((!tsnQosIsSet() && !rhs.tsnQosIsSet()) || (tsnQosIsSet() && rhs.tsnQosIsSet() && getTsnQos() == rhs.getTsnQos())) &&
    
    
    ((!tscaiInputDlIsSet() && !rhs.tscaiInputDlIsSet()) || (tscaiInputDlIsSet() && rhs.tscaiInputDlIsSet() && getTscaiInputDl() == rhs.getTscaiInputDl())) &&
    
    
    ((!tscaiInputUlIsSet() && !rhs.tscaiInputUlIsSet()) || (tscaiInputUlIsSet() && rhs.tscaiInputUlIsSet() && getTscaiInputUl() == rhs.getTscaiInputUl())) &&
    
    
    ((!tscaiTimeDomIsSet() && !rhs.tscaiTimeDomIsSet()) || (tscaiTimeDomIsSet() && rhs.tscaiTimeDomIsSet() && getTscaiTimeDom() == rhs.getTscaiTimeDom())) &&
    
    
    ((!capBatAdaptationIsSet() && !rhs.capBatAdaptationIsSet()) || (capBatAdaptationIsSet() && rhs.capBatAdaptationIsSet() && isCapBatAdaptation() == rhs.isCapBatAdaptation())) &&
    
    
    ((!rTLatencyIndIsSet() && !rhs.rTLatencyIndIsSet()) || (rTLatencyIndIsSet() && rhs.rTLatencyIndIsSet() && isRTLatencyInd() == rhs.isRTLatencyInd())) &&
    
    
    ((!pduSetQosDlIsSet() && !rhs.pduSetQosDlIsSet()) || (pduSetQosDlIsSet() && rhs.pduSetQosDlIsSet() && getPduSetQosDl() == rhs.getPduSetQosDl())) &&
    
    
    ((!pduSetQosUlIsSet() && !rhs.pduSetQosUlIsSet()) || (pduSetQosUlIsSet() && rhs.pduSetQosUlIsSet() && getPduSetQosUl() == rhs.getPduSetQosUl())) &&
    
    
    ((!protoDescDlIsSet() && !rhs.protoDescDlIsSet()) || (protoDescDlIsSet() && rhs.protoDescDlIsSet() && getProtoDescDl() == rhs.getProtoDescDl())) &&
    
    
    ((!protoDescUlIsSet() && !rhs.protoDescUlIsSet()) || (protoDescUlIsSet() && rhs.protoDescUlIsSet() && getProtoDescUl() == rhs.getProtoDescUl())) &&
    
    
    ((!periodUlIsSet() && !rhs.periodUlIsSet()) || (periodUlIsSet() && rhs.periodUlIsSet() && getPeriodUl() == rhs.getPeriodUl())) &&
    
    
    ((!periodDlIsSet() && !rhs.periodDlIsSet()) || (periodDlIsSet() && rhs.periodDlIsSet() && getPeriodDl() == rhs.getPeriodDl())) &&
    
    
    ((!l4sIndIsSet() && !rhs.l4sIndIsSet()) || (l4sIndIsSet() && rhs.l4sIndIsSet() && getL4sInd() == rhs.getL4sInd()))
...
void MediaComponentRm::setAfRoutReq(oai::model::pcf::AfRoutingRequirementRm const& value)
{
    m_AfRoutReq = value;
...
void MediaComponentRm::setAfSfcReq(oai::model::pcf::AfSfcRequirement const& value)
{
    m_AfSfcReq = value;
...
std::vector<oai::model::pcf::AlternativeServiceRequirementsData> MediaComponentRm::getAltSerReqsData() const
{
    return m_AltSerReqsData;
}
void MediaComponentRm::setAltSerReqsData(std::vector<oai::model::pcf::AlternativeServiceRequirementsData> const& value)
{
...
std::map<std::string, oai::model::pcf::MediaSubComponentRm> MediaComponentRm::getMedSubComps() const
{
    return m_MedSubComps;
}
void MediaComponentRm::setMedSubComps(std::map<std::string, oai::model::pcf::MediaSubComponentRm> const& value)
{
    m_MedSubComps = value;
...
oai::model::common::PreemptionCapability MediaComponentRm::getPreemptCap() const
{
    return m_PreemptCap;
}
void MediaComponentRm::setPreemptCap(oai::model::common::PreemptionCapability const& value)
{
    m_PreemptCap = value;
...
oai::model::common::PreemptionVulnerability MediaComponentRm::getPreemptVuln() const
{
    return m_PreemptVuln;
}
void MediaComponentRm::setPreemptVuln(oai::model::common::PreemptionVulnerability const& value)
{
    m_PreemptVuln = value;
...
oai::model::pcf::PrioritySharingIndicator MediaComponentRm::getPrioSharingInd() const
{
    return m_PrioSharingInd;
}
void MediaComponentRm::setPrioSharingInd(oai::model::pcf::PrioritySharingIndicator const& value)
{
...
void MediaComponentRm::setResPrio(oai::model::pcf::ReservPriority const& value)
{
    m_ResPrio = value;
    m_ResPrioIsSet = true;
}
...
void MediaComponentRm::setTsnQos(oai::model::pcf::TsnQosContainerRm const& value)
{
    m_TsnQos = value;
    m_TsnQosIsSet = true;
}
...
void MediaComponentRm::setTscaiInputDl(oai::model::pcf::TscaiInputContainer const& value)
{
...
void MediaComponentRm::setTscaiInputUl(oai::model::pcf::TscaiInputContainer const& value)
{
...
void MediaComponentRm::setPduSetQosDl(oai::model::pcf::PduSetQosPara const& value)
{
    m_PduSetQosDl = value;
...
void MediaComponentRm::setPduSetQosUl(oai::model::pcf::PduSetQosPara const& value)
{
    m_PduSetQosUl = value;
...
void MediaComponentRm::setProtoDescDl(oai::model::pcf::ProtocolDescription const& value)
{
    m_ProtoDescDl = value;
...
void MediaComponentRm::setProtoDescUl(oai::model::pcf::ProtocolDescription const& value)
{
    m_ProtoDescUl = value;
...
void MediaComponentRm::setL4sInd(oai::model::pcf::UplinkDownlinkSupport const& value)
{
    m_L4sInd = value;
    m_L4sIndIsSet = true;
}
