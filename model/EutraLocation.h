...
public:
    ...
    /// 
    /// </summary>
    oai::model::GlobalRanNodeId getGlobalNgenbId() const;
    void setGlobalNgenbId(oai::model::GlobalRanNodeId const& value);
    bool globalNgenbIdIsSet() const;
    void unsetGlobalNgenbId();
    /// <summary>
    /// 
    /// </summary>
    oai::model::GlobalRanNodeId getGlobalENbId() const;
    void setGlobalENbId(oai::model::GlobalRanNodeId const& value);
...
protected:
    ...
    oai::model::GlobalRanNodeId m_GlobalNgenbId;
    bool m_GlobalNgenbIdIsSet;
    oai::model::GlobalRanNodeId m_GlobalENbId;
