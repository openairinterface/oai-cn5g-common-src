...
public:
    ...
    /// 
    /// </summary>
    oai::model::Ambr getAuthSessAmbr() const;
    void setAuthSessAmbr(oai::model::Ambr const& value);
    bool authSessAmbrIsSet() const;
    void unsetAuthSessAmbr();
    /// <summary>
    /// 
    /// </summary>
    oai::model::AuthorizedDefaultQos getAuthDefQos() const;
    void setAuthDefQos(oai::model::AuthorizedDefaultQos const& value);
...
protected:
    oai::model::Ambr m_AuthSessAmbr;
    bool m_AuthSessAmbrIsSet;
    oai::model::AuthorizedDefaultQos m_AuthDefQos;
