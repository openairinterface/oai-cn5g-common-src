...
bool BridgeManagementContainer::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "BridgeManagementContainer" : pathPrefix;

        
    return success;
}

bool BridgeManagementContainer::operator==(const BridgeManagementContainer& rhs) const
{
    return
