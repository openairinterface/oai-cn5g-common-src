...
static asn_TYPE_member_t asn_MBR_Ngap_SecondaryRATDataUsageReportTransfer_1[] =
    {
        ...
        {ATF_POINTER,
         ...
         -1, /* IMPLICIT tag at current level */
         &asn_DEF_Ngap_ProtocolExtensionContainer_12929P297,
         0,
         {
#if !defined(ASN_DISABLE_OER_SUPPORT)
             0,
...
static asn_SEQUENCE_specifics_t
    asn_SPC_Ngap_SecondaryRATDataUsageReportTransfer_specs_1 = {
        ...
        asn_MAP_Ngap_SecondaryRATDataUsageReportTransfer_oms_1, /* Optional
                                                                   members */
        2,
        0, /* Root/Additions */
...
asn_TYPE_descriptor_t asn_DEF_Ngap_SecondaryRATDataUsageReportTransfer = {
    ...
    sizeof(asn_DEF_Ngap_SecondaryRATDataUsageReportTransfer_tags_1) /
        sizeof(
            asn_DEF_Ngap_SecondaryRATDataUsageReportTransfer_tags_1[0]), /* 1 */
    ...
    2, /* Elements count */
    &asn_SPC_Ngap_SecondaryRATDataUsageReportTransfer_specs_1 /* Additional
                                                                 specs */
};
