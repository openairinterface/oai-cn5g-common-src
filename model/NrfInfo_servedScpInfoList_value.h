...
public:
    ...
    /// </summary>
    std::map<std::string, oai::_3gpp::model::ScpDomainInfo> getScpDomainInfoList() const;
    void setScpDomainInfoList(std::map<std::string, oai::_3gpp::model::ScpDomainInfo> const& value);
    ...
    /// 
    /// </summary>
    std::vector<oai::_3gpp::model::Ipv4AddressRange> getIpv4AddrRanges() const;
    void setIpv4AddrRanges(std::vector<oai::_3gpp::model::Ipv4AddressRange> const& value);
    bool ipv4AddrRangesIsSet() const;
    void unsetIpv4AddrRanges();
    /// <summary>
    /// 
    /// </summary>
    std::vector<oai::_3gpp::model::Ipv6PrefixRange> getIpv6PrefixRanges() const;
    void setIpv6PrefixRanges(std::vector<oai::_3gpp::model::Ipv6PrefixRange> const& value);
    ...
    void setRemoteSnpnList(std::vector<oai::_3gpp::model::PlmnIdNid> const& value);
    bool remoteSnpnListIsSet() const;
    void unsetRemoteSnpnList();
    /// <summary>
    /// 
    /// </summary>
    oai::_3gpp::model::IpReachability getIpReachability() const;
    void setIpReachability(oai::_3gpp::model::IpReachability const& value);
    bool ipReachabilityIsSet() const;
    void unsetIpReachability();
    /// <summary>
    /// 
    /// </summary>
    std::vector<oai::_3gpp::model::ScpCapability> getScpCapabilities() const;
    void setScpCapabilities(std::vector<oai::_3gpp::model::ScpCapability> const& value);
...
protected:
    std::map<std::string, oai::_3gpp::model::ScpDomainInfo> m_ScpDomainInfoList;
    ...
    std::vector<oai::_3gpp::model::Ipv4AddressRange> m_Ipv4AddrRanges;
    ...
    oai::_3gpp::model::IpReachability m_IpReachability;
    bool m_IpReachabilityIsSet;
    std::vector<oai::_3gpp::model::ScpCapability> m_ScpCapabilities;
