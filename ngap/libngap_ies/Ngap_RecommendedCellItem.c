...
asn_TYPE_member_t asn_MBR_Ngap_RecommendedCellItem_1[] = {
    {ATF_POINTER,
     0,
     offsetof(struct Ngap_RecommendedCellItem, nGRAN_CGI),
    ...
    {ATF_POINTER,
     2,
     offsetof(struct Ngap_RecommendedCellItem, timeStayedInCell),
    ...
    {ATF_POINTER,
     1,
     offsetof(struct Ngap_RecommendedCellItem, iE_Extensions),
     (ASN_TAG_CLASS_CONTEXT | (2 << 2)),
     -1, /* IMPLICIT tag at current level */
     &asn_DEF_Ngap_ProtocolExtensionContainer_12929P289,
     0,
     {
#if !defined(ASN_DISABLE_OER_SUPPORT)
         0,
