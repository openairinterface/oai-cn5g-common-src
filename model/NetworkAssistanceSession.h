...
public:
    ...
    /// 
    /// </summary>
    std::vector<oai::_3gpp::model::ServiceDataFlowDescription> getServiceDataFlowDescriptions() const;
    void setServiceDataFlowDescriptions(std::vector<oai::_3gpp::model::ServiceDataFlowDescription> const& value);
    /// <summary>
    /// 
    /// </summary>
...
protected:
    ...
    std::vector<oai::_3gpp::model::ServiceDataFlowDescription> m_ServiceDataFlowDescriptions;
