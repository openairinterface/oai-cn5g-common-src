...
bool QueryParamCombination::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    ...
    /* QueryParams */ {
        const std::vector<oai::model::QueryParameter>& value = m_QueryParams;
        ...
        { // Recursive validation of array elements
            ...
            int i = 0;
            for (const oai::model::QueryParameter& value : value)
            { 
...
std::vector<oai::model::QueryParameter> QueryParamCombination::getQueryParams() const
{
    return m_QueryParams;
}
void QueryParamCombination::setQueryParams(std::vector<oai::model::QueryParameter> const& value)
{
    m_QueryParams = value;
}
