...
bool SmfRegistration::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "SmfRegistration" : pathPrefix;
...
bool SmfRegistration::operator==(const SmfRegistration& rhs) const
{
    ...
    ((!smfSetIdIsSet() && !rhs.smfSetIdIsSet()) || (smfSetIdIsSet() && rhs.smfSetIdIsSet() && getSmfSetId() == rhs.getSmfSetId())) &&
    ...
    ((!emergencyServicesIsSet() && !rhs.emergencyServicesIsSet()) || (emergencyServicesIsSet() && rhs.emergencyServicesIsSet() && isEmergencyServices() == rhs.isEmergencyServices())) &&
    ...
    ((!epdgIndIsSet() && !rhs.epdgIndIsSet()) || (epdgIndIsSet() && rhs.epdgIndIsSet() && isEpdgInd() == rhs.isEpdgInd())) &&
    
    
    ((!deregCallbackUriIsSet() && !rhs.deregCallbackUriIsSet()) || (deregCallbackUriIsSet() && rhs.deregCallbackUriIsSet() && getDeregCallbackUri() == rhs.getDeregCallbackUri())) &&
    
    
    ((!registrationReasonIsSet() && !rhs.registrationReasonIsSet()) || (registrationReasonIsSet() && rhs.registrationReasonIsSet() && getRegistrationReason() == rhs.getRegistrationReason())) &&
...
oai::model::Snssai SmfRegistration::getSingleNssai() const
{
    return m_SingleNssai;
}
void SmfRegistration::setSingleNssai(oai::model::Snssai const& value)
{
    m_SingleNssai = value;
}
...
oai::model::PlmnId SmfRegistration::getPlmnId() const
{
    return m_PlmnId;
}
void SmfRegistration::setPlmnId(oai::model::PlmnId const& value)
{
    m_PlmnId = value;
}
...
oai::model::IpAddress SmfRegistration::getPgwIpAddr() const
{
    return m_PgwIpAddr;
}
void SmfRegistration::setPgwIpAddr(oai::model::IpAddress const& value)
{
    m_PgwIpAddr = value;
...
oai::model::RegistrationReason SmfRegistration::getRegistrationReason() const
{
    return m_RegistrationReason;
}
void SmfRegistration::setRegistrationReason(oai::model::RegistrationReason const& value)
{
...
oai::model::ContextInfo SmfRegistration::getContextInfo() const
{
    return m_ContextInfo;
}
void SmfRegistration::setContextInfo(oai::model::ContextInfo const& value)
{
    m_ContextInfo = value;
