...
bool RestrictionType::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "RestrictionType" : pathPrefix;
...
RestrictionType_anyOf::eRestrictionType_anyOf RestrictionType::getEnumValue() const
{
    return m_value.getValue();
}

void RestrictionType::setEnumValue(RestrictionType_anyOf::eRestrictionType_anyOf  value)
{
