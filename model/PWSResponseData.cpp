...
bool PWSResponseData::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "PWSResponseData" : pathPrefix;
    ...
    {
        const std::vector<oai::model::Tai>& value = m_UnknownTaiList;
        ...
        success = value.validate(msg, currentValuePath + ".unknownTaiList") && success;
...
bool PWSResponseData::operator==(const PWSResponseData& rhs) const
{
    ...
    ((!unknownTaiListIsSet() && !rhs.unknownTaiListIsSet()) || (unknownTaiListIsSet() && rhs.unknownTaiListIsSet() && getUnknownTaiList() == rhs.getUnknownTaiList()))
...
std::vector<oai::model::Tai> PWSResponseData::getUnknownTaiList() const
{
    return m_UnknownTaiList;
}
void PWSResponseData::setUnknownTaiList(std::vector<oai::model::Tai> const& value)
{
