...
public:
    ...
    /// </summary>
    std::vector<oai::model::RequestedRuleDataType> getReqData() const;
    void setReqData(std::vector<oai::model::RequestedRuleDataType> const& value);
...
protected:
    ...
    std::vector<oai::model::RequestedRuleDataType> m_ReqData;
