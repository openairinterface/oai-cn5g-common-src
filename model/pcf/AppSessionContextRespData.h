...
public:
    ...
    /// </summary>
    std::vector<oai::model::pcf::DirectNotificationReport> getDirectNotifReports() const;
    void setDirectNotifReports(std::vector<oai::model::pcf::DirectNotificationReport> const& value);
