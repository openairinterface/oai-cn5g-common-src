...
asn_TYPE_member_t asn_MBR_Ngap_UserPlaneSecurityInformation_1[] = {
	{ ATF_POINTER, 0, offsetof(struct Ngap_UserPlaneSecurityInformation, securityResult),
	...
	{ ATF_POINTER, 0, offsetof(struct Ngap_UserPlaneSecurityInformation, securityIndication),
