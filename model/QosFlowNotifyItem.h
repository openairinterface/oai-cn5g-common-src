...
public:
    ...
    /// 
    /// </summary>
    oai::model::NotificationCause getNotificationCause() const;
    void setNotificationCause(oai::model::NotificationCause const& value);
    /// <summary>
    /// 
    /// </summary>
...
protected:
    ...
    oai::model::NotificationCause m_NotificationCause;
