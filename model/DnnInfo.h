...
public:
    ...
    /// 
    /// </summary>
    oai::model::AccessAndMobilitySubscriptionData_subscribedDnnList_inner getDnn() const;
    void setDnn(oai::model::AccessAndMobilitySubscriptionData_subscribedDnnList_inner const& value);
    /// <summary>
    /// 
    /// </summary>
...
protected:
    oai::model::AccessAndMobilitySubscriptionData_subscribedDnnList_inner m_Dnn;
