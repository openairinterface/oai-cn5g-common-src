...
public:
    ...
    void setR5gAuthData(oai::_3gpp::model::UEAuthenticationCtx_5gAuthData const& value);
    /// <summary>
    ...
    void setLinks(std::map<std::string, oai::_3gpp::model::LinksValueSchema> const& value);
    /// <summary>
    /// 
    /// </summary>
