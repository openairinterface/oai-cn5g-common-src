...
bool N1N2MessageTransferReqData::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "N1N2MessageTransferReqData" : pathPrefix;
...
bool N1N2MessageTransferReqData::operator==(const N1N2MessageTransferReqData& rhs) const
{
    return
    
    
    
    ((!n1MessageContainerIsSet() && !rhs.n1MessageContainerIsSet()) || (n1MessageContainerIsSet() && rhs.n1MessageContainerIsSet() && getN1MessageContainer() == rhs.getN1MessageContainer())) &&
    
    
    ((!n2InfoContainerIsSet() && !rhs.n2InfoContainerIsSet()) || (n2InfoContainerIsSet() && rhs.n2InfoContainerIsSet() && getN2InfoContainer() == rhs.getN2InfoContainer())) &&
    
    
    ((!mtDataIsSet() && !rhs.mtDataIsSet()) || (mtDataIsSet() && rhs.mtDataIsSet() && getMtData() == rhs.getMtData())) &&
    
    
    ((!skipIndIsSet() && !rhs.skipIndIsSet()) || (skipIndIsSet() && rhs.skipIndIsSet() && isSkipInd() == rhs.isSkipInd())) &&
    
    
    ((!lastMsgIndicationIsSet() && !rhs.lastMsgIndicationIsSet()) || (lastMsgIndicationIsSet() && rhs.lastMsgIndicationIsSet() && isLastMsgIndication() == rhs.isLastMsgIndication())) &&
    
    
    ((!pduSessionIdIsSet() && !rhs.pduSessionIdIsSet()) || (pduSessionIdIsSet() && rhs.pduSessionIdIsSet() && getPduSessionId() == rhs.getPduSessionId())) &&
    
    
    ((!lcsCorrelationIdIsSet() && !rhs.lcsCorrelationIdIsSet()) || (lcsCorrelationIdIsSet() && rhs.lcsCorrelationIdIsSet() && getLcsCorrelationId() == rhs.getLcsCorrelationId())) &&
    
    
    ((!ppiIsSet() && !rhs.ppiIsSet()) || (ppiIsSet() && rhs.ppiIsSet() && getPpi() == rhs.getPpi())) &&
    
    
    ((!arpIsSet() && !rhs.arpIsSet()) || (arpIsSet() && rhs.arpIsSet() && getArp() == rhs.getArp())) &&
    
    
    ((!r5qiIsSet() && !rhs.r5qiIsSet()) || (r5qiIsSet() && rhs.r5qiIsSet() && getR5qi() == rhs.getR5qi())) &&
    
    
    ((!n1n2FailureTxfNotifURIIsSet() && !rhs.n1n2FailureTxfNotifURIIsSet()) || (n1n2FailureTxfNotifURIIsSet() && rhs.n1n2FailureTxfNotifURIIsSet() && getN1n2FailureTxfNotifURI() == rhs.getN1n2FailureTxfNotifURI())) &&
    
    
    ((!smfReallocationIndIsSet() && !rhs.smfReallocationIndIsSet()) || (smfReallocationIndIsSet() && rhs.smfReallocationIndIsSet() && isSmfReallocationInd() == rhs.isSmfReallocationInd())) &&
    
    
    ((!areaOfValidityIsSet() && !rhs.areaOfValidityIsSet()) || (areaOfValidityIsSet() && rhs.areaOfValidityIsSet() && getAreaOfValidity() == rhs.getAreaOfValidity())) &&
    ...
    ((!extBufSupportIsSet() && !rhs.extBufSupportIsSet()) || (extBufSupportIsSet() && rhs.extBufSupportIsSet() && isExtBufSupport() == rhs.isExtBufSupport())) &&
    
    
    ((!targetAccessIsSet() && !rhs.targetAccessIsSet()) || (targetAccessIsSet() && rhs.targetAccessIsSet() && getTargetAccess() == rhs.getTargetAccess())) &&
    
    
    ((!nfIdIsSet() && !rhs.nfIdIsSet()) || (nfIdIsSet() && rhs.nfIdIsSet() && getNfId() == rhs.getNfId()))
...
oai::_3gpp::model::N1MessageContainer N1N2MessageTransferReqData::getN1MessageContainer() const
{
    return m_N1MessageContainer;
}
void N1N2MessageTransferReqData::setN1MessageContainer(oai::_3gpp::model::N1MessageContainer const& value)
{
...
oai::_3gpp::model::N2InfoContainer N1N2MessageTransferReqData::getN2InfoContainer() const
{
    return m_N2InfoContainer;
}
void N1N2MessageTransferReqData::setN2InfoContainer(oai::_3gpp::model::N2InfoContainer const& value)
{
...
oai::_3gpp::model::RefToBinaryData N1N2MessageTransferReqData::getMtData() const
{
    return m_MtData;
}
void N1N2MessageTransferReqData::setMtData(oai::_3gpp::model::RefToBinaryData const& value)
{
    m_MtData = value;
    m_MtDataIsSet = true;
}
...
oai::_3gpp::model::Arp N1N2MessageTransferReqData::getArp() const
{
    return m_Arp;
}
void N1N2MessageTransferReqData::setArp(oai::_3gpp::model::Arp const& value)
{
    m_Arp = value;
    m_ArpIsSet = true;
}
...
void N1N2MessageTransferReqData::setN1n2FailureTxfNotifURI(std::string const& value)
{
...
oai::_3gpp::model::AreaOfValidity N1N2MessageTransferReqData::getAreaOfValidity() const
{
    return m_AreaOfValidity;
}
void N1N2MessageTransferReqData::setAreaOfValidity(oai::_3gpp::model::AreaOfValidity const& value)
{
...
void N1N2MessageTransferReqData::setSupportedFeatures(std::string const& value)
{
...
oai::_3gpp::model::Guami N1N2MessageTransferReqData::getOldGuami() const
{
    return m_OldGuami;
}
void N1N2MessageTransferReqData::setOldGuami(oai::_3gpp::model::Guami const& value)
{
    m_OldGuami = value;
...
oai::_3gpp::model::AccessType N1N2MessageTransferReqData::getTargetAccess() const
{
    return m_TargetAccess;
}
void N1N2MessageTransferReqData::setTargetAccess(oai::_3gpp::model::AccessType const& value)
{
...
std::string N1N2MessageTransferReqData::getNfId() const
{
    return m_NfId;
}
void N1N2MessageTransferReqData::setNfId(std::string const& value)
{
    m_NfId = value;
    m_NfIdIsSet = true;
}
bool N1N2MessageTransferReqData::nfIdIsSet() const
{
    return m_NfIdIsSet;
}
void N1N2MessageTransferReqData::unsetNfId()
{
    m_NfIdIsSet = false;
}
