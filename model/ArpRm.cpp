...
bool ArpRm::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
...
void ArpRm::setPreemptCap(oai::_3gpp::model::PreemptionCapability const& value)
{
    m_PreemptCap = value;
}
...
void ArpRm::setPreemptVuln(oai::_3gpp::model::PreemptionVulnerability const& value)
{
    m_PreemptVuln = value;
}
