...
public:
    ...
    SessionRuleFailureCode_anyOf::eSessionRuleFailureCode_anyOf getEnumValue() const;
    void setEnumValue(SessionRuleFailureCode_anyOf::eSessionRuleFailureCode_anyOf value);
