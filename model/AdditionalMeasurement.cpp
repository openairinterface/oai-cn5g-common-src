...
bool AdditionalMeasurement::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    ...
    {
        const std::vector<oai::model::IpEthFlowDescription>& value = m_UnexpFlowTeps;
        ...
        { // Recursive validation of array elements
            ...
            int i = 0;
            for (const oai::model::IpEthFlowDescription& value : value)
            { 
    ...
    if (circumsIsSet())
    {
        const std::vector<oai::model::CircumstanceDescription>& value = m_Circums;
        ...
        { // Recursive validation of array elements
            const std::string oldValuePath = currentValuePath;
            int i = 0;
            for (const oai::model::CircumstanceDescription& value : value)
            { 
                const std::string currentValuePath = oldValuePath + "[" + std::to_string(i) + "]";
...
oai::model::NetworkAreaInfo AdditionalMeasurement::getUnexpLoc() const
{
    return m_UnexpLoc;
}
void AdditionalMeasurement::setUnexpLoc(oai::model::NetworkAreaInfo const& value)
{
    m_UnexpLoc = value;
...
std::vector<oai::model::IpEthFlowDescription> AdditionalMeasurement::getUnexpFlowTeps() const
{
    return m_UnexpFlowTeps;
}
void AdditionalMeasurement::setUnexpFlowTeps(std::vector<oai::model::IpEthFlowDescription> const& value)
{
...
void AdditionalMeasurement::setUnexpWakes(std::vector<std::string> const& value)
{
    m_UnexpWakes = value;
...
oai::model::AddressList AdditionalMeasurement::getDdosAttack() const
{
    return m_DdosAttack;
}
void AdditionalMeasurement::setDdosAttack(oai::model::AddressList const& value)
{
    m_DdosAttack = value;
...
oai::model::AddressList AdditionalMeasurement::getWrgDest() const
{
    return m_WrgDest;
}
void AdditionalMeasurement::setWrgDest(oai::model::AddressList const& value)
{
    m_WrgDest = value;
    m_WrgDestIsSet = true;
}
...
std::vector<oai::model::CircumstanceDescription> AdditionalMeasurement::getCircums() const
{
    return m_Circums;
}
void AdditionalMeasurement::setCircums(std::vector<oai::model::CircumstanceDescription> const& value)
{
    m_Circums = value;
    m_CircumsIsSet = true;
}
