...
bool UeConnectivityState::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "UeConnectivityState" : pathPrefix;
...
bool UeConnectivityState::operator==(const UeConnectivityState& rhs) const
{
    ...
    ((!connectivitystateIsSet() && !rhs.connectivitystateIsSet()) || (connectivitystateIsSet() && rhs.connectivitystateIsSet() && getConnectivitystate() == rhs.getConnectivitystate()))
...
oai::model::AccessType UeConnectivityState::getAccessType() const
{
    return m_AccessType;
}
void UeConnectivityState::setAccessType(oai::model::AccessType const& value)
{
    m_AccessType = value;
}
oai::model::CmState UeConnectivityState::getConnectivitystate() const
{
    return m_Connectivitystate;
}
void UeConnectivityState::setConnectivitystate(oai::model::CmState const& value)
{
