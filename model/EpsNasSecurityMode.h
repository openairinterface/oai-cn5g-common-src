...
public:
    ...
    /// 
    /// </summary>
    oai::model::EpsNasIntegrityAlgorithm getIntegrityAlgorithm() const;
    void setIntegrityAlgorithm(oai::model::EpsNasIntegrityAlgorithm const& value);
    /// <summary>
    /// 
    /// </summary>
    oai::model::EpsNasCipheringAlgorithm getCipheringAlgorithm() const;
    void setCipheringAlgorithm(oai::model::EpsNasCipheringAlgorithm const& value);
...
protected:
    oai::model::EpsNasIntegrityAlgorithm m_IntegrityAlgorithm;

    oai::model::EpsNasCipheringAlgorithm m_CipheringAlgorithm;
