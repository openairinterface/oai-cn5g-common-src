...
bool MeasurementLteForMdt_anyOf::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "MeasurementLteForMdt_anyOf" : pathPrefix;

    
    if (m_value == MeasurementLteForMdt_anyOf::eMeasurementLteForMdt_anyOf::INVALID_VALUE_OPENAPI_GENERATED)
    {
        success = false;
...
bool MeasurementLteForMdt_anyOf::operator==(const MeasurementLteForMdt_anyOf& rhs) const
{
    return
...
void to_json(nlohmann::json& j, const MeasurementLteForMdt_anyOf& o)
{
    ...
    switch (o.getValue())
    {
        case MeasurementLteForMdt_anyOf::eMeasurementLteForMdt_anyOf::INVALID_VALUE_OPENAPI_GENERATED:
...
MeasurementLteForMdt_anyOf::eMeasurementLteForMdt_anyOf MeasurementLteForMdt_anyOf::getValue() const
{
    return m_value;
}
void MeasurementLteForMdt_anyOf::setValue(MeasurementLteForMdt_anyOf::eMeasurementLteForMdt_anyOf value)
{
    m_value = value;
}
