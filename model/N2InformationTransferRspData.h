...
public:
    ...
    /// 
    /// </summary>
    oai::model::N2InformationTransferResult getResult() const;
    void setResult(oai::model::N2InformationTransferResult const& value);
    /// <summary>
    /// 
    /// </summary>
    oai::model::PWSResponseData getPwsRspData() const;
    void setPwsRspData(oai::model::PWSResponseData const& value);
    ...
    friend  void from_json(const nlohmann::json& j, N2InformationTransferRspData& o);
protected:
    oai::model::N2InformationTransferResult m_Result;

    oai::model::PWSResponseData m_PwsRspData;
