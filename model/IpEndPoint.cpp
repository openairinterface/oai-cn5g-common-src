...
oai::model::Ipv6Addr IpEndPoint::getIpv6Address() const
{
    return m_Ipv6Address;
}
void IpEndPoint::setIpv6Address(oai::model::Ipv6Addr const& value)
{
    m_Ipv6Address = value;
...
oai::model::TransportProtocol_1 IpEndPoint::getTransport() const
{
    return m_Transport;
}
void IpEndPoint::setTransport(oai::model::TransportProtocol_1 const& value)
{
    m_Transport = value;
