...
extern const asn_INTEGER_specifics_t
    asn_SPC_Ngap_DataForwardingNotPossible_specs_1;
...
cbor_type_decoder_f Ngap_DataForwardingNotPossible_decode_cbor;
cbor_type_encoder_f Ngap_DataForwardingNotPossible_encode_cbor;
oer_type_decoder_f Ngap_DataForwardingNotPossible_decode_oer;
oer_type_encoder_f Ngap_DataForwardingNotPossible_encode_oer;
