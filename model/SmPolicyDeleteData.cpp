...
oai::model::UserLocation SmPolicyDeleteData::getUserLocationInfo() const
{
    return m_UserLocationInfo;
}
void SmPolicyDeleteData::setUserLocationInfo(oai::model::UserLocation const& value)
{
...
oai::model::PlmnIdNid SmPolicyDeleteData::getServingNetwork() const
{
    return m_ServingNetwork;
}
void SmPolicyDeleteData::setServingNetwork(oai::model::PlmnIdNid const& value)
{
...
std::vector<oai::model::RanNasRelCause> SmPolicyDeleteData::getRanNasRelCauses() const
{
    return m_RanNasRelCauses;
}
void SmPolicyDeleteData::setRanNasRelCauses(std::vector<oai::model::RanNasRelCause> const& value)
{
...
std::vector<oai::model::AccuUsageReport> SmPolicyDeleteData::getAccuUsageReports() const
{
    return m_AccuUsageReports;
}
void SmPolicyDeleteData::setAccuUsageReports(std::vector<oai::model::AccuUsageReport> const& value)
{
...
oai::model::PduSessionRelCause SmPolicyDeleteData::getPduSessRelCause() const
{
    return m_PduSessRelCause;
}
void SmPolicyDeleteData::setPduSessRelCause(oai::model::PduSessionRelCause const& value)
{
