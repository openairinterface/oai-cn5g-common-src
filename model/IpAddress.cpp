...
bool IpAddress::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
...
oai::model::Ipv6Addr IpAddress::getIpv6Addr() const
{
    return m_Ipv6Addr;
}
void IpAddress::setIpv6Addr(oai::model::Ipv6Addr const& value)
{
    m_Ipv6Addr = value;
...
oai::model::Ipv6Prefix IpAddress::getIpv6Prefix() const
{
    return m_Ipv6Prefix;
}
void IpAddress::setIpv6Prefix(oai::model::Ipv6Prefix const& value)
{
    m_Ipv6Prefix = value;
