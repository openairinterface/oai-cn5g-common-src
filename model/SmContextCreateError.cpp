...
void SmContextCreateError::setError(oai::_3gpp::model::ExtProblemDetails const& value)
{
    m_Error = value;
}
...
void SmContextCreateError::setN1SmMsg(oai::_3gpp::model::RefToBinaryData const& value)
{
    m_N1SmMsg = value;
    m_N1SmMsgIsSet = true;
}
...
void SmContextCreateError::setN2SmInfo(oai::_3gpp::model::RefToBinaryData const& value)
{
    m_N2SmInfo = value;
...
void SmContextCreateError::setN2SmInfoType(oai::_3gpp::model::N2SmInfoType const& value)
{
