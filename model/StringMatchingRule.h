...
public:
    ...
    /// 
    /// </summary>
    std::vector<oai::_3gpp::model::StringMatchingCondition> getStringMatchingConditions() const;
    void setStringMatchingConditions(std::vector<oai::_3gpp::model::StringMatchingCondition> const& value);
...
protected:
    std::vector<oai::_3gpp::model::StringMatchingCondition> m_StringMatchingConditions;
