...
bool MbUpfInfo::validate(
  ...
  /* SNssaiMbUpfInfoList */ {
    ...
    {  // Recursive validation of array elements
      ...
      for (const oai::_3gpp::model::SnssaiUpfInfoItem& value : value) {
        ...
        success =
            value.validate(msg, currentValuePath + ".sNssaiMbUpfInfoList") &&
            success;
  ...
  if (interfaceMbUpfInfoListIsSet()) {
    const std::vector<oai::_3gpp::model::InterfaceUpfInfoItem>& value =
        m_InterfaceMbUpfInfoList;
    const std::string currentValuePath =
        _pathPrefix + ".interfaceMbUpfInfoList";
    ...
    {  // Recursive validation of array elements
      ...
      for (const oai::_3gpp::model::InterfaceUpfInfoItem& value : value) {
        ...
        success =
            value.validate(msg, currentValuePath + ".interfaceMbUpfInfoList") &&
            success;
...
bool MbUpfInfo::operator==(const MbUpfInfo& rhs) const {
  return
      ...
      ((!mbSmfServingAreaIsSet() && !rhs.mbSmfServingAreaIsSet()) ||
       (mbSmfServingAreaIsSet() && rhs.mbSmfServingAreaIsSet() &&
        getMbSmfServingArea() == rhs.getMbSmfServingArea())) &&

      ((!interfaceMbUpfInfoListIsSet() && !rhs.interfaceMbUpfInfoListIsSet()) ||
       (interfaceMbUpfInfoListIsSet() && rhs.interfaceMbUpfInfoListIsSet() &&
        getInterfaceMbUpfInfoList() == rhs.getInterfaceMbUpfInfoList())) &&
...
MbUpfInfo::getSNssaiMbUpfInfoList() const {
  return m_SNssaiMbUpfInfoList;
}
void MbUpfInfo::setSNssaiMbUpfInfoList(
...
MbUpfInfo::getInterfaceMbUpfInfoList() const {
  return m_InterfaceMbUpfInfoList;
}
void MbUpfInfo::setInterfaceMbUpfInfoList(
...
void MbUpfInfo::setTaiRangeList(
