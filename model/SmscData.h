...
public:
    ...
    /// 
    /// </summary>
    oai::_3gpp::model::NetworkNodeDiameterAddress_1 getSmscDiameterAddress() const;
    void setSmscDiameterAddress(oai::_3gpp::model::NetworkNodeDiameterAddress_1 const& value);
