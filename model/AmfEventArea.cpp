...
bool AmfEventArea::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "AmfEventArea" : pathPrefix;
...
bool AmfEventArea::operator==(const AmfEventArea& rhs) const
{
    ...
    ((!ladnInfoIsSet() && !rhs.ladnInfoIsSet()) || (ladnInfoIsSet() && rhs.ladnInfoIsSet() && getLadnInfo() == rhs.getLadnInfo())) &&
...
oai::model::PresenceInfo AmfEventArea::getPresenceInfo() const
{
    return m_PresenceInfo;
}
void AmfEventArea::setPresenceInfo(oai::model::PresenceInfo const& value)
{
...
oai::model::LadnInfo AmfEventArea::getLadnInfo() const
{
    return m_LadnInfo;
}
void AmfEventArea::setLadnInfo(oai::model::LadnInfo const& value)
{
    m_LadnInfo = value;
...
oai::model::Snssai AmfEventArea::getSNssai() const
{
    return m_SNssai;
}
void AmfEventArea::setSNssai(oai::model::Snssai const& value)
{
    m_SNssai = value;
    m_SNssaiIsSet = true;
}
