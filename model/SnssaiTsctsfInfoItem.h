...
public:
    ...
    /// 
    /// </summary>
    std::vector<oai::model::DnnTsctsfInfoItem> getDnnInfoList() const;
    void setDnnInfoList(std::vector<oai::model::DnnTsctsfInfoItem> const& value);
...
protected:
    ...
    std::vector<oai::model::DnnTsctsfInfoItem> m_DnnInfoList;
