...
bool SubscribedDefaultQos::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "SubscribedDefaultQos" : pathPrefix;
...
oai::model::Arp SubscribedDefaultQos::getArp() const
{
    return m_Arp;
}
void SubscribedDefaultQos::setArp(oai::model::Arp const& value)
{
    m_Arp = value;
}
