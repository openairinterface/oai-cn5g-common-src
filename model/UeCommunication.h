...
public:
    ...
    /// 
    /// </summary>
    oai::model::ScheduledCommunicationTime_1 getRecurringTime() const;
    void setRecurringTime(oai::model::ScheduledCommunicationTime_1 const& value);
    bool recurringTimeIsSet() const;
    void unsetRecurringTime();
    /// <summary>
    /// 
    /// </summary>
    oai::model::TrafficCharacterization getTrafChar() const;
    void setTrafChar(oai::model::TrafficCharacterization const& value);
    ...
    /// 
    /// </summary>
    oai::model::AppListForUeComm getAnaOfAppList() const;
    void setAnaOfAppList(oai::model::AppListForUeComm const& value);
    bool anaOfAppListIsSet() const;
    void unsetAnaOfAppList();
    /// <summary>
    /// 
    /// </summary>
    oai::model::SessInactTimerForUeComm getSessInactTimer() const;
    void setSessInactTimer(oai::model::SessInactTimerForUeComm const& value);
...
protected:
    ...
    oai::model::ScheduledCommunicationTime_1 m_RecurringTime;
    bool m_RecurringTimeIsSet;
    oai::model::TrafficCharacterization m_TrafChar;
    ...
    oai::model::AppListForUeComm m_AnaOfAppList;
    bool m_AnaOfAppListIsSet;
    oai::model::SessInactTimerForUeComm m_SessInactTimer;
