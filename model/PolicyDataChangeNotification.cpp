...
bool PolicyDataChangeNotification::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "PolicyDataChangeNotification" : pathPrefix;

                                         
    if (opSpecDataMapIsSet())
    {
        const std::map<std::string, oai::model::OperatorSpecificDataContainer>& value = m_OpSpecDataMap;
    ...
    {
        const std::vector<oai::model::NotificationItem>& value = m_ReportedFragments;
        ...
        { // Recursive validation of array elements
            const std::string oldValuePath = currentValuePath;
            int i = 0;
            for (const oai::model::NotificationItem& value : value)
            { 
                const std::string currentValuePath = oldValuePath + "[" + std::to_string(i) + "]";
                        
        success = value.validate(msg, currentValuePath + ".reportedFragments") && success;
...
bool PolicyDataChangeNotification::operator==(const PolicyDataChangeNotification& rhs) const
{
    return
    
    
    
    ((!amPolicyDataIsSet() && !rhs.amPolicyDataIsSet()) || (amPolicyDataIsSet() && rhs.amPolicyDataIsSet() && getAmPolicyData() == rhs.getAmPolicyData())) &&
    
    
    ((!uePolicySetIsSet() && !rhs.uePolicySetIsSet()) || (uePolicySetIsSet() && rhs.uePolicySetIsSet() && getUePolicySet() == rhs.getUePolicySet())) &&
    
    
    ((!plmnUePolicySetIsSet() && !rhs.plmnUePolicySetIsSet()) || (plmnUePolicySetIsSet() && rhs.plmnUePolicySetIsSet() && getPlmnUePolicySet() == rhs.getPlmnUePolicySet())) &&
    
    
    ((!smPolicyDataIsSet() && !rhs.smPolicyDataIsSet()) || (smPolicyDataIsSet() && rhs.smPolicyDataIsSet() && getSmPolicyData() == rhs.getSmPolicyData())) &&
    
    
    ((!usageMonDataIsSet() && !rhs.usageMonDataIsSet()) || (usageMonDataIsSet() && rhs.usageMonDataIsSet() && getUsageMonData() == rhs.getUsageMonData())) &&
    
    
    ((!sponsorConnectivityDataIsSet() && !rhs.sponsorConnectivityDataIsSet()) || (sponsorConnectivityDataIsSet() && rhs.sponsorConnectivityDataIsSet() && getSponsorConnectivityData() == rhs.getSponsorConnectivityData())) &&
    
    
    ((!bdtDataIsSet() && !rhs.bdtDataIsSet()) || (bdtDataIsSet() && rhs.bdtDataIsSet() && getBdtData() == rhs.getBdtData())) &&
    
    
    ((!opSpecDataIsSet() && !rhs.opSpecDataIsSet()) || (opSpecDataIsSet() && rhs.opSpecDataIsSet() && getOpSpecData() == rhs.getOpSpecData())) &&
    
    
    ((!opSpecDataMapIsSet() && !rhs.opSpecDataMapIsSet()) || (opSpecDataMapIsSet() && rhs.opSpecDataMapIsSet() && getOpSpecDataMap() == rhs.getOpSpecDataMap())) &&
    
    
    ((!ueIdIsSet() && !rhs.ueIdIsSet()) || (ueIdIsSet() && rhs.ueIdIsSet() && getUeId() == rhs.getUeId())) &&
    ...
    ((!usageMonIdIsSet() && !rhs.usageMonIdIsSet()) || (usageMonIdIsSet() && rhs.usageMonIdIsSet() && getUsageMonId() == rhs.getUsageMonId())) &&
    
    
    ((!plmnIdIsSet() && !rhs.plmnIdIsSet()) || (plmnIdIsSet() && rhs.plmnIdIsSet() && getPlmnId() == rhs.getPlmnId())) &&
    
    
    ((!delResourcesIsSet() && !rhs.delResourcesIsSet()) || (delResourcesIsSet() && rhs.delResourcesIsSet() && getDelResources() == rhs.getDelResources())) &&
    
    
    ((!notifIdIsSet() && !rhs.notifIdIsSet()) || (notifIdIsSet() && rhs.notifIdIsSet() && getNotifId() == rhs.getNotifId())) &&
    
    
    ((!reportedFragmentsIsSet() && !rhs.reportedFragmentsIsSet()) || (reportedFragmentsIsSet() && rhs.reportedFragmentsIsSet() && getReportedFragments() == rhs.getReportedFragments())) &&
    
    
    ((!slicePolicyDataIsSet() && !rhs.slicePolicyDataIsSet()) || (slicePolicyDataIsSet() && rhs.slicePolicyDataIsSet() && getSlicePolicyData() == rhs.getSlicePolicyData())) &&
...
void to_json(nlohmann::json& j, const PolicyDataChangeNotification& o)
{
    ...
    if(o.slicePolicyDataIsSet())
        j["slicePolicyData"] = o.m_SlicePolicyData;
    if(o.snssaiIsSet())
        j["snssai"] = o.m_Snssai;
...
oai::model::AmPolicyData PolicyDataChangeNotification::getAmPolicyData() const
{
    return m_AmPolicyData;
}
void PolicyDataChangeNotification::setAmPolicyData(oai::model::AmPolicyData const& value)
{
...
oai::model::UePolicySet PolicyDataChangeNotification::getUePolicySet() const
{
    return m_UePolicySet;
}
void PolicyDataChangeNotification::setUePolicySet(oai::model::UePolicySet const& value)
{
    m_UePolicySet = value;
...
oai::model::UePolicySet PolicyDataChangeNotification::getPlmnUePolicySet() const
{
    return m_PlmnUePolicySet;
}
void PolicyDataChangeNotification::setPlmnUePolicySet(oai::model::UePolicySet const& value)
{
...
oai::model::SmPolicyData PolicyDataChangeNotification::getSmPolicyData() const
{
    return m_SmPolicyData;
}
void PolicyDataChangeNotification::setSmPolicyData(oai::model::SmPolicyData const& value)
{
...
oai::model::UsageMonData PolicyDataChangeNotification::getUsageMonData() const
{
    return m_UsageMonData;
}
void PolicyDataChangeNotification::setUsageMonData(oai::model::UsageMonData const& value)
{
...
oai::model::SponsorConnectivityData PolicyDataChangeNotification::getSponsorConnectivityData() const
{
    return m_SponsorConnectivityData;
}
void PolicyDataChangeNotification::setSponsorConnectivityData(oai::model::SponsorConnectivityData const& value)
{
...
oai::model::BdtData PolicyDataChangeNotification::getBdtData() const
{
    return m_BdtData;
}
void PolicyDataChangeNotification::setBdtData(oai::model::BdtData const& value)
{
    m_BdtData = value;
    m_BdtDataIsSet = true;
}
...
oai::model::OperatorSpecificDataContainer PolicyDataChangeNotification::getOpSpecData() const
{
    return m_OpSpecData;
}
void PolicyDataChangeNotification::setOpSpecData(oai::model::OperatorSpecificDataContainer const& value)
{
    m_OpSpecData = value;
...
std::map<std::string, oai::model::OperatorSpecificDataContainer> PolicyDataChangeNotification::getOpSpecDataMap() const
{
    return m_OpSpecDataMap;
}
void PolicyDataChangeNotification::setOpSpecDataMap(std::map<std::string, oai::model::OperatorSpecificDataContainer> const& value)
{
...
oai::model::PlmnId PolicyDataChangeNotification::getPlmnId() const
{
    return m_PlmnId;
}
void PolicyDataChangeNotification::setPlmnId(oai::model::PlmnId const& value)
{
    m_PlmnId = value;
    m_PlmnIdIsSet = true;
}
...
void PolicyDataChangeNotification::setDelResources(std::vector<std::string> const& value)
{
...
std::vector<oai::model::NotificationItem> PolicyDataChangeNotification::getReportedFragments() const
{
    return m_ReportedFragments;
}
void PolicyDataChangeNotification::setReportedFragments(std::vector<oai::model::NotificationItem> const& value)
{
...
oai::model::SlicePolicyData PolicyDataChangeNotification::getSlicePolicyData() const
{
    return m_SlicePolicyData;
}
void PolicyDataChangeNotification::setSlicePolicyData(oai::model::SlicePolicyData const& value)
{
...
oai::model::Snssai PolicyDataChangeNotification::getSnssai() const
{
    return m_Snssai;
}
void PolicyDataChangeNotification::setSnssai(oai::model::Snssai const& value)
{
    m_Snssai = value;
    m_SnssaiIsSet = true;
}
