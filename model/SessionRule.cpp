...
oai::model::Ambr SessionRule::getAuthSessAmbr() const
{
    return m_AuthSessAmbr;
}
void SessionRule::setAuthSessAmbr(oai::model::Ambr const& value)
{
...
oai::model::AuthorizedDefaultQos SessionRule::getAuthDefQos() const
{
    return m_AuthDefQos;
}
void SessionRule::setAuthDefQos(oai::model::AuthorizedDefaultQos const& value)
{
    m_AuthDefQos = value;
