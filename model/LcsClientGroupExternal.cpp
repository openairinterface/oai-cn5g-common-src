...
void LcsClientGroupExternal::validate() const
{
...
bool LcsClientGroupExternal::validate(std::stringstream& msg) const
{
    return validate(msg, "");
}

bool LcsClientGroupExternal::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "LcsClientGroupExternal" : pathPrefix;

         
    if (lcsClientGroupIdIsSet())
    {
        const std::string& value = m_LcsClientGroupId;
        const std::string currentValuePath = _pathPrefix + ".lcsClientGroupId";
...
bool LcsClientGroupExternal::operator==(const LcsClientGroupExternal& rhs) const
{
    return
    
    
    
    ((!lcsClientGroupIdIsSet() && !rhs.lcsClientGroupIdIsSet()) || (lcsClientGroupIdIsSet() && rhs.lcsClientGroupIdIsSet() && getLcsClientGroupId() == rhs.getLcsClientGroupId())) &&
...
std::vector<oai::_3gpp::model::GeographicArea> LcsClientGroupExternal::getAllowedGeographicArea() const
{
    return m_AllowedGeographicArea;
}
void LcsClientGroupExternal::setAllowedGeographicArea(std::vector<oai::_3gpp::model::GeographicArea> const& value)
{
...
oai::_3gpp::model::PrivacyCheckRelatedAction LcsClientGroupExternal::getPrivacyCheckRelatedAction() const
{
    return m_PrivacyCheckRelatedAction;
}
void LcsClientGroupExternal::setPrivacyCheckRelatedAction(oai::_3gpp::model::PrivacyCheckRelatedAction const& value)
{
...
oai::_3gpp::model::ValidTimePeriod LcsClientGroupExternal::getValidTimePeriod() const
{
    return m_ValidTimePeriod;
}
void LcsClientGroupExternal::setValidTimePeriod(oai::_3gpp::model::ValidTimePeriod const& value)
{
