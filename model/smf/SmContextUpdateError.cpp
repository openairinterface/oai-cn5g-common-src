...
ProblemDetails SmContextUpdateError::getError() const { return m_Error; }
void SmContextUpdateError::setError(ProblemDetails const &value) {
  m_Error = value;
}
RefToBinaryData SmContextUpdateError::getN1SmMsg() const { return m_N1SmMsg; }
void SmContextUpdateError::setN1SmMsg(RefToBinaryData const &value) {
  m_N1SmMsg = value;
  m_N1SmMsgIsSet = true;
}
bool SmContextUpdateError::n1SmMsgIsSet() const { return m_N1SmMsgIsSet; }
void SmContextUpdateError::unsetN1SmMsg() { m_N1SmMsgIsSet = false; }
RefToBinaryData SmContextUpdateError::getN2SmInfo() const { return m_N2SmInfo; }
void SmContextUpdateError::setN2SmInfo(RefToBinaryData const &value) {
  m_N2SmInfo = value;
  m_N2SmInfoIsSet = true;
}
bool SmContextUpdateError::n2SmInfoIsSet() const { return m_N2SmInfoIsSet; }
void SmContextUpdateError::unsetN2SmInfo() { m_N2SmInfoIsSet = false; }
...
void SmContextUpdateError::unsetN2SmInfoType() { m_N2SmInfoTypeIsSet = false; }
UpCnxState SmContextUpdateError::getUpCnxState() const { return m_UpCnxState; }
void SmContextUpdateError::setUpCnxState(UpCnxState const &value) {
  m_UpCnxState = value;
  m_UpCnxStateIsSet = true;
}
bool SmContextUpdateError::upCnxStateIsSet() const { return m_UpCnxStateIsSet; }
void SmContextUpdateError::unsetUpCnxState() { m_UpCnxStateIsSet = false; }
...
void SmContextUpdateError::unsetRecoveryTime() { m_RecoveryTimeIsSet = false; }
