...
asn_TYPE_member_t asn_MBR_Ngap_MDT_Configuration_EUTRA_1[] = {
    {ATF_NOFLAGS,
     0,
     offsetof(struct Ngap_MDT_Configuration_EUTRA, mdt_Activation),
    ...
    {ATF_POINTER,
     0,
     offsetof(struct Ngap_MDT_Configuration_EUTRA, areaScopeOfMDT),
    ...
    {ATF_NOFLAGS,
     0,
     offsetof(struct Ngap_MDT_Configuration_EUTRA, mDTMode),
    ...
    {ATF_POINTER,
     2,
     offsetof(struct Ngap_MDT_Configuration_EUTRA, signallingBasedMDTPLMNList),
    ...
    {ATF_POINTER,
     1,
     offsetof(struct Ngap_MDT_Configuration_EUTRA, iE_Extensions),
     (ASN_TAG_CLASS_CONTEXT | (4 << 2)),
     -1, /* IMPLICIT tag at current level */
     &asn_DEF_Ngap_ProtocolExtensionContainer_12929P177,
     0,
     {
#if !defined(ASN_DISABLE_OER_SUPPORT)
         0,
