...
bool SecondaryRatUsageInfo::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    ...
    {
        const std::vector<oai::_3gpp::model::QosFlowUsageReport>& value = m_QosFlowsUsageData;
    ...
    {
        const std::vector<oai::_3gpp::model::VolumeTimedReport>& value = m_PduSessionUsageData;
...
void SecondaryRatUsageInfo::setSecondaryRatType(oai::_3gpp::model::RatType const& value)
{
    m_SecondaryRatType = value;
}
std::vector<oai::_3gpp::model::QosFlowUsageReport> SecondaryRatUsageInfo::getQosFlowsUsageData() const
{
    return m_QosFlowsUsageData;
}
void SecondaryRatUsageInfo::setQosFlowsUsageData(std::vector<oai::_3gpp::model::QosFlowUsageReport> const& value)
{
...
std::vector<oai::_3gpp::model::VolumeTimedReport> SecondaryRatUsageInfo::getPduSessionUsageData() const
{
    return m_PduSessionUsageData;
}
void SecondaryRatUsageInfo::setPduSessionUsageData(std::vector<oai::_3gpp::model::VolumeTimedReport> const& value)
{
