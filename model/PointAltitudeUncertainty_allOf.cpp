...
bool PointAltitudeUncertainty_allOf::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "PointAltitudeUncertainty_allOf" : pathPrefix;
...
bool PointAltitudeUncertainty_allOf::operator==(const PointAltitudeUncertainty_allOf& rhs) const
{
    return
...
oai::_3gpp::model::GeographicalCoordinates PointAltitudeUncertainty_allOf::getPoint() const
{
    return m_Point;
}
void PointAltitudeUncertainty_allOf::setPoint(oai::_3gpp::model::GeographicalCoordinates const& value)
{
    m_Point = value;
}
...
oai::_3gpp::model::UncertaintyEllipse PointAltitudeUncertainty_allOf::getUncertaintyEllipse() const
{
    return m_UncertaintyEllipse;
}
void PointAltitudeUncertainty_allOf::setUncertaintyEllipse(oai::_3gpp::model::UncertaintyEllipse const& value)
{
