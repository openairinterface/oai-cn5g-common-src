...
bool FailureCode_anyOf::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "FailureCode_anyOf" : pathPrefix;

    
    if (m_value == FailureCode_anyOf::eFailureCode_anyOf::INVALID_VALUE_OPENAPI_GENERATED)
    {
        success = false;
...
void to_json(nlohmann::json& j, const FailureCode_anyOf& o)
{
    ...
    switch (o.getValue())
    {
        ...
        case FailureCode_anyOf::eFailureCode_anyOf::UE_STA_SUSP:
            j = "UE_STA_SUSP";
            break;
        case FailureCode_anyOf::eFailureCode_anyOf::UNKNOWN_REF_ID:
            j = "UNKNOWN_REF_ID";
            break;
        case FailureCode_anyOf::eFailureCode_anyOf::INCORRECT_COND_DATA:
            j = "INCORRECT_COND_DATA";
            break;
        case FailureCode_anyOf::eFailureCode_anyOf::REF_ID_COLLISION:
            j = "REF_ID_COLLISION";
            break;
        case FailureCode_anyOf::eFailureCode_anyOf::TRAFFIC_STEERING_ERROR:
            j = "TRAFFIC_STEERING_ERROR";
            break;
        ...
        case FailureCode_anyOf::eFailureCode_anyOf::MAX_NR_PACKET_FILTERS_EXCEEDED:
            ...
            break;
        case FailureCode_anyOf::eFailureCode_anyOf::PACKET_FILTER_TFT_ALLOCATION_EXCEEDED:
            j = "PACKET_FILTER_TFT_ALLOCATION_EXCEEDED";
            break;
        case FailureCode_anyOf::eFailureCode_anyOf::MUTE_CHG_NOT_ALLOWED:
            j = "MUTE_CHG_NOT_ALLOWED";
            break;
    }
}
...
void from_json(const nlohmann::json& j, FailureCode_anyOf& o)
{
    ...
    if (s == "UNK_RULE_ID") {
     ...
     o.setValue(FailureCode_anyOf::eFailureCode_anyOf::UNKNOWN_REF_ID);
    } 
    else if (s == "INCORRECT_COND_DATA") {
     o.setValue(FailureCode_anyOf::eFailureCode_anyOf::INCORRECT_COND_DATA);
    } 
    else if (s == "REF_ID_COLLISION") {
     o.setValue(FailureCode_anyOf::eFailureCode_anyOf::REF_ID_COLLISION);
    } 
    else if (s == "TRAFFIC_STEERING_ERROR") {
     ...
     o.setValue(FailureCode_anyOf::eFailureCode_anyOf::MAX_NR_PACKET_FILTERS_EXCEEDED);
    } 
    else if (s == "PACKET_FILTER_TFT_ALLOCATION_EXCEEDED") {
     o.setValue(FailureCode_anyOf::eFailureCode_anyOf::PACKET_FILTER_TFT_ALLOCATION_EXCEEDED);
    } 
    else if (s == "MUTE_CHG_NOT_ALLOWED") {
     o.setValue(FailureCode_anyOf::eFailureCode_anyOf::MUTE_CHG_NOT_ALLOWED);
    }  else {
     std::stringstream ss;
