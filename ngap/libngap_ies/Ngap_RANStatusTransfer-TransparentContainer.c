...
asn_TYPE_member_t asn_MBR_Ngap_RANStatusTransfer_TransparentContainer_1[] = {
    ...
    {ATF_POINTER,
     ...
     -1, /* IMPLICIT tag at current level */
     &asn_DEF_Ngap_ProtocolExtensionContainer_12929P286,
     0,
     {
#if !defined(ASN_DISABLE_OER_SUPPORT)
         0,
...
static const int asn_MAP_Ngap_RANStatusTransfer_TransparentContainer_oms_1[] = {
    1};
...
static const asn_TYPE_tag2member_t
    asn_MAP_Ngap_RANStatusTransfer_TransparentContainer_tag2el_1[] = {
        {(ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0,
         0}, /* dRBsSubjectToStatusTransferList */
        {(ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0} /* iE-Extensions */
};
asn_SEQUENCE_specifics_t
    asn_SPC_Ngap_RANStatusTransfer_TransparentContainer_specs_1 = {
        ...
        asn_MAP_Ngap_RANStatusTransfer_TransparentContainer_oms_1, /* Optional
                                                                      members */
        1,
        0, /* Root/Additions */
...
asn_TYPE_descriptor_t asn_DEF_Ngap_RANStatusTransfer_TransparentContainer = {
    ...
    2, /* Elements count */
    &asn_SPC_Ngap_RANStatusTransfer_TransparentContainer_specs_1 /* Additional
                                                                    specs */
};
