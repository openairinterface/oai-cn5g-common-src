...
void HssInfo::setImsiRanges(std::vector<oai::_3gpp::model::ImsiRange> const& value)
{
    m_ImsiRanges = value;
...
std::vector<oai::_3gpp::model::IdentityRange> HssInfo::getImsPrivateIdentityRanges() const
{
    return m_ImsPrivateIdentityRanges;
}
void HssInfo::setImsPrivateIdentityRanges(std::vector<oai::_3gpp::model::IdentityRange> const& value)
{
...
std::vector<oai::_3gpp::model::IdentityRange> HssInfo::getImsPublicIdentityRanges() const
{
    return m_ImsPublicIdentityRanges;
}
void HssInfo::setImsPublicIdentityRanges(std::vector<oai::_3gpp::model::IdentityRange> const& value)
{
...
void HssInfo::setMsisdnRanges(std::vector<oai::_3gpp::model::IdentityRange> const& value)
{
...
std::vector<oai::_3gpp::model::IdentityRange> HssInfo::getExternalGroupIdentifiersRanges() const
{
    return m_ExternalGroupIdentifiersRanges;
}
void HssInfo::setExternalGroupIdentifiersRanges(std::vector<oai::_3gpp::model::IdentityRange> const& value)
{
...
oai::_3gpp::model::NetworkNodeDiameterAddress HssInfo::getHssDiameterAddress() const
{
    return m_HssDiameterAddress;
}
void HssInfo::setHssDiameterAddress(oai::_3gpp::model::NetworkNodeDiameterAddress const& value)
{
