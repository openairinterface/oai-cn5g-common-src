...
asn_oer_constraints_t asn_OER_type_Ngap_ExcessPacketDelayThresholdValue_constr_1
    CC_NOTUSED = {{0, 0}, -1};
#endif /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
asn_per_constraints_t asn_PER_type_Ngap_ExcessPacketDelayThresholdValue_constr_1
    CC_NOTUSED = {
...
static const asn_INTEGER_enum_map_t
    asn_MAP_Ngap_ExcessPacketDelayThresholdValue_value2enum_1[] = {
        {0, 8, "ms0dot25"}, {1, 7, "ms0dot5"}, {2, 3, "ms1"},
        {3, 3, "ms2"},      {4, 3, "ms4"},     {5, 3, "ms5"},
        {6, 4, "ms10"},     {7, 4, "ms20"},    {8, 4, "ms30"},
        {9, 4, "ms40"},     {10, 4, "ms50"},   {11, 4, "ms60"},
        {12, 4, "ms70"},    {13, 4, "ms80"},   {14, 4, "ms90"},
        {15, 5, "ms100"},   {16, 5, "ms150"},  {17, 5, "ms300"},
        {18, 5, "ms500"}
        /* This list is extensible */
};
static int asn_validate_Ngap_ExcessPacketDelayThresholdValue_1(
    const asn_TYPE_descriptor_t* td, const void* sptr,
    asn_app_constraint_failed_f* ctfailcb, void* app_key) {
  if (!sptr) {
    return -1;
  }
  e_Ngap_ExcessPacketDelayThresholdValue value =
      *(e_Ngap_ExcessPacketDelayThresholdValue*) sptr;
  switch (value) {
...
static const unsigned int
    asn_MAP_Ngap_ExcessPacketDelayThresholdValue_enum2value_1[] = {
        0,  /* ms0dot25(0) */
        1,  /* ms0dot5(1) */
        2,  /* ms1(2) */
        6,  /* ms10(6) */
...
const asn_INTEGER_specifics_t
    asn_SPC_Ngap_ExcessPacketDelayThresholdValue_specs_1 = {
        asn_MAP_Ngap_ExcessPacketDelayThresholdValue_value2enum_1, /* "tag" =>
                                                                      N; sorted
                                                                      by tag */
        asn_MAP_Ngap_ExcessPacketDelayThresholdValue_enum2value_1, /* N =>
                                                                      "tag";
                                                                      sorted by
                                                                      N */
