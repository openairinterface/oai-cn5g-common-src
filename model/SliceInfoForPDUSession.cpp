...
bool SliceInfoForPDUSession::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "SliceInfoForPDUSession" : pathPrefix;
    ...
    if (!m_RoamingIndication.validate(msg, _pathPrefix + ".roamingIndication")) {
        msg << _pathPrefix << ": RoamingIndication is invalid;";
        success = false;
    }    
    return success;
}

bool SliceInfoForPDUSession::operator==(const SliceInfoForPDUSession& rhs) const
{
    return
    ...
    ((!homeSnssaiIsSet() && !rhs.homeSnssaiIsSet()) || (homeSnssaiIsSet() && rhs.homeSnssaiIsSet() && getHomeSnssai() == rhs.getHomeSnssai()))
...
oai::model::Snssai SliceInfoForPDUSession::getSNssai() const
{
    return m_SNssai;
}
void SliceInfoForPDUSession::setSNssai(oai::model::Snssai const& value)
{
    m_SNssai = value;
}
oai::model::RoamingIndication SliceInfoForPDUSession::getRoamingIndication() const
{
    return m_RoamingIndication;
}
void SliceInfoForPDUSession::setRoamingIndication(oai::model::RoamingIndication const& value)
{
    m_RoamingIndication = value;
}
oai::model::Snssai SliceInfoForPDUSession::getHomeSnssai() const
{
    return m_HomeSnssai;
}
void SliceInfoForPDUSession::setHomeSnssai(oai::model::Snssai const& value)
{
    m_HomeSnssai = value;
