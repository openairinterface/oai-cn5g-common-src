...
bool ConditionData::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "ConditionData" : pathPrefix;
...
bool ConditionData::operator==(const ConditionData& rhs) const
{
    ...
    ((!deactivationTimeIsSet() && !rhs.deactivationTimeIsSet()) || (deactivationTimeIsSet() && rhs.deactivationTimeIsSet() && getDeactivationTime() == rhs.getDeactivationTime())) &&
...
oai::_3gpp::model::AccessType ConditionData::getAccessType() const
{
    return m_AccessType;
}
void ConditionData::setAccessType(oai::_3gpp::model::AccessType const& value)
{
    m_AccessType = value;
...
oai::_3gpp::model::RatType ConditionData::getRatType() const
{
    return m_RatType;
}
void ConditionData::setRatType(oai::_3gpp::model::RatType const& value)
{
    m_RatType = value;
    m_RatTypeIsSet = true;
}
