...
#if !defined(ASN_DISABLE_OER_SUPPORT)
asn_oer_constraints_t asn_OER_type_Ngap_UEIdentityIndexValue_constr_1
    CC_NOTUSED = {{0, 0}, -1};
#endif /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
...
asn_TYPE_member_t asn_MBR_Ngap_UEIdentityIndexValue_1[] = {
    {ATF_NOFLAGS,
     0,
     offsetof(struct Ngap_UEIdentityIndexValue, choice.indexLength10),
    ...
    {ATF_POINTER,
     0,
     offsetof(struct Ngap_UEIdentityIndexValue, choice.choice_Extensions),
     (ASN_TAG_CLASS_CONTEXT | (1 << 2)),
     -1, /* IMPLICIT tag at current level */
     &asn_DEF_Ngap_ProtocolIE_SingleContainer_12877P55,
     0,
     {
#if !defined(ASN_DISABLE_OER_SUPPORT)
         0,
