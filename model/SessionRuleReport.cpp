...
bool SessionRuleReport::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "SessionRuleReport" : pathPrefix;
...
bool SessionRuleReport::operator==(const SessionRuleReport& rhs) const
{
    ...
    ((!sessRuleFailureCodeIsSet() && !rhs.sessRuleFailureCodeIsSet()) || (sessRuleFailureCodeIsSet() && rhs.sessRuleFailureCodeIsSet() && getSessRuleFailureCode() == rhs.getSessRuleFailureCode())) &&
...
oai::model::RuleStatus SessionRuleReport::getRuleStatus() const
{
    return m_RuleStatus;
}
void SessionRuleReport::setRuleStatus(oai::model::RuleStatus const& value)
{
    m_RuleStatus = value;
}
oai::model::SessionRuleFailureCode SessionRuleReport::getSessRuleFailureCode() const
{
    return m_SessRuleFailureCode;
}
void SessionRuleReport::setSessRuleFailureCode(oai::model::SessionRuleFailureCode const& value)
{
...
std::vector<oai::model::PolicyDecisionFailureCode> SessionRuleReport::getPolicyDecFailureReports() const
{
    return m_PolicyDecFailureReports;
}
void SessionRuleReport::setPolicyDecFailureReports(std::vector<oai::model::PolicyDecisionFailureCode> const& value)
{
