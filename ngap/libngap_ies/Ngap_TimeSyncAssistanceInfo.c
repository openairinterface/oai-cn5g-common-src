...
static asn_oer_constraints_t asn_OER_type_Ngap_timeDistributionIndication_constr_2 CC_NOTUSED = {
	{ 0, 0 },
	-1};
...
#if !defined(ASN_DISABLE_OER_SUPPORT)
static asn_oer_constraints_t asn_OER_memb_Ngap_uUTimeSyncErrorBudget_constr_6 CC_NOTUSED = {
	{ 0, 0 },
	-1};
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
