...
void PcscfRestorationRequestData::setSliceInfo(oai::model::common::Snssai const& value)
{
    m_SliceInfo = value;
...
void PcscfRestorationRequestData::setUeIpv6(oai::model::common::Ipv6Addr const& value)
{
    m_UeIpv6 = value;
    m_UeIpv6IsSet = true;
}
