...
bool QosFlowProfile::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "QosFlowProfile" : pathPrefix;
...
bool QosFlowProfile::operator==(const QosFlowProfile& rhs) const
{
    ...
    ((!nonDynamic5QiIsSet() && !rhs.nonDynamic5QiIsSet()) || (nonDynamic5QiIsSet() && rhs.nonDynamic5QiIsSet() && getNonDynamic5Qi() == rhs.getNonDynamic5Qi())) &&
    
    
    ((!dynamic5QiIsSet() && !rhs.dynamic5QiIsSet()) || (dynamic5QiIsSet() && rhs.dynamic5QiIsSet() && getDynamic5Qi() == rhs.getDynamic5Qi())) &&
    
    
    ((!arpIsSet() && !rhs.arpIsSet()) || (arpIsSet() && rhs.arpIsSet() && getArp() == rhs.getArp())) &&
    
    
    ((!gbrQosFlowInfoIsSet() && !rhs.gbrQosFlowInfoIsSet()) || (gbrQosFlowInfoIsSet() && rhs.gbrQosFlowInfoIsSet() && getGbrQosFlowInfo() == rhs.getGbrQosFlowInfo())) &&
    
    
    ((!rqaIsSet() && !rhs.rqaIsSet()) || (rqaIsSet() && rhs.rqaIsSet() && getRqa() == rhs.getRqa())) &&
    
    
    ((!additionalQosFlowInfoIsSet() && !rhs.additionalQosFlowInfoIsSet()) || (additionalQosFlowInfoIsSet() && rhs.additionalQosFlowInfoIsSet() && getAdditionalQosFlowInfo() == rhs.getAdditionalQosFlowInfo())) &&
    
    
    ((!qosMonitoringReqIsSet() && !rhs.qosMonitoringReqIsSet()) || (qosMonitoringReqIsSet() && rhs.qosMonitoringReqIsSet() && getQosMonitoringReq() == rhs.getQosMonitoringReq())) &&
    
    
    ((!qosRepPeriodIsSet() && !rhs.qosRepPeriodIsSet()) || (qosRepPeriodIsSet() && rhs.qosRepPeriodIsSet() && getQosRepPeriod() == rhs.getQosRepPeriod()))
...
oai::model::NonDynamic5Qi QosFlowProfile::getNonDynamic5Qi() const
{
    return m_NonDynamic5Qi;
}
void QosFlowProfile::setNonDynamic5Qi(oai::model::NonDynamic5Qi const& value)
{
...
oai::model::Dynamic5Qi QosFlowProfile::getDynamic5Qi() const
{
    return m_Dynamic5Qi;
}
void QosFlowProfile::setDynamic5Qi(oai::model::Dynamic5Qi const& value)
{
    m_Dynamic5Qi = value;
...
oai::model::Arp QosFlowProfile::getArp() const
{
    return m_Arp;
}
void QosFlowProfile::setArp(oai::model::Arp const& value)
{
    m_Arp = value;
    m_ArpIsSet = true;
}
...
oai::model::GbrQosFlowInformation QosFlowProfile::getGbrQosFlowInfo() const
{
    return m_GbrQosFlowInfo;
}
void QosFlowProfile::setGbrQosFlowInfo(oai::model::GbrQosFlowInformation const& value)
{
...
oai::model::ReflectiveQoSAttribute QosFlowProfile::getRqa() const
{
    return m_Rqa;
}
void QosFlowProfile::setRqa(oai::model::ReflectiveQoSAttribute const& value)
{
    m_Rqa = value;
    m_RqaIsSet = true;
}
...
oai::model::AdditionalQosFlowInfo QosFlowProfile::getAdditionalQosFlowInfo() const
{
    return m_AdditionalQosFlowInfo;
}
void QosFlowProfile::setAdditionalQosFlowInfo(oai::model::AdditionalQosFlowInfo const& value)
{
...
oai::model::QosMonitoringReq QosFlowProfile::getQosMonitoringReq() const
{
    return m_QosMonitoringReq;
}
void QosFlowProfile::setQosMonitoringReq(oai::model::QosMonitoringReq const& value)
{
