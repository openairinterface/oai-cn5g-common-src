...
public:
    ...
    /// 
    /// </summary>
    std::vector<oai::_3gpp::model::NefEventSubs> getEventsSubs() const;
    void setEventsSubs(std::vector<oai::_3gpp::model::NefEventSubs> const& value);
    /// <summary>
    /// 
    /// </summary>
    ...
    void setEventNotifs(std::vector<oai::_3gpp::model::NefEventNotification> const& value);
...
protected:
    ...
    std::vector<oai::_3gpp::model::NefEventSubs> m_EventsSubs;
