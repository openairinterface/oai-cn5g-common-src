...
//------------------------------------------------------------------------------
void QosFlowWithCauseItem::set(const QosFlowIdentifier &qosFlowIdentifier,
                               const Cause &cause) {
...
//------------------------------------------------------------------------------
bool QosFlowWithCauseItem::get(QosFlowIdentifier &qosFlowIdentifier,
                               Cause &cause) const {
...
//------------------------------------------------------------------------------
void QosFlowWithCauseItem::setCause(const Cause &cause) { m_Cause = cause; }
...
bool QosFlowWithCauseItem::encode(
  ...
  if (!m_QosFlowIdentifier.encode(QosFlowWithCauseItem.qosFlowIdentifier))
    return false;
  if (!m_Cause.encode(QosFlowWithCauseItem.cause))
    return false;
...
bool QosFlowWithCauseItem::decode(
  ...
  if (!m_QosFlowIdentifier.decode(QosFlowWithCauseItem.qosFlowIdentifier))
    return false;
  if (!m_Cause.decode(QosFlowWithCauseItem.cause))
    return false;
