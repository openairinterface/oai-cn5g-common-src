...
#ifndef CancelPosInfo_H_
#define CancelPosInfo_H_
...
public:
    ...
    bool operator==(const CancelPosInfo& rhs) const;
    bool operator!=(const CancelPosInfo& rhs) const;

    /////////////////////////////////////////////
    /// CancelPosInfo members
    ...
    friend  void to_json(nlohmann::json& j, const CancelPosInfo& o);
    friend  void from_json(const nlohmann::json& j, CancelPosInfo& o);
protected:
    std::string m_Supi;
