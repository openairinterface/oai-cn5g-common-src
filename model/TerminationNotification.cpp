...
bool TerminationNotification::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "TerminationNotification" : pathPrefix;
...
bool TerminationNotification::operator==(const TerminationNotification& rhs) const
{
    return
...
oai::model::SmPolicyAssociationReleaseCause TerminationNotification::getCause() const
{
    return m_Cause;
}
void TerminationNotification::setCause(oai::model::SmPolicyAssociationReleaseCause const& value)
{
    m_Cause = value;
}
