...
asn_TYPE_member_t asn_MBR_Ngap_SONConfigurationTransfer_1[] = {
	{ ATF_POINTER, 0, offsetof(struct Ngap_SONConfigurationTransfer, targetRANNodeID_SON),
	...
	{ ATF_POINTER, 0, offsetof(struct Ngap_SONConfigurationTransfer, sourceRANNodeID),
	...
	{ ATF_POINTER, 0, offsetof(struct Ngap_SONConfigurationTransfer, sONInformation),
	...
	{ ATF_POINTER, 1, offsetof(struct Ngap_SONConfigurationTransfer, iE_Extensions),
		...
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_Ngap_ProtocolExtensionContainer_12929P311,
		0,
		{
#if !defined(ASN_DISABLE_OER_SUPPORT)
			0,
