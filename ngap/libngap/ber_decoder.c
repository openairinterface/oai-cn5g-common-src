...
#define RETURN(_code)                                                          \
  do {                                                                         \
    ...
    rval.code = _code;                                                         \
    if (opt_ctx)                                                               \
      opt_ctx->step = step; /* Save context */                                 \
 ...
 */
asn_dec_rval_t ber_decode(const asn_codec_ctx_t *opt_codec_ctx,
   ...
   */
  return type_descriptor->op->ber_decoder(
 ...
 */
asn_dec_rval_t ber_check_tags(const asn_codec_ctx_t *opt_codec_ctx,
