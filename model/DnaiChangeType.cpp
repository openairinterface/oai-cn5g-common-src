...
bool DnaiChangeType::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "DnaiChangeType" : pathPrefix;
...
DnaiChangeType_anyOf::eDnaiChangeType_anyOf DnaiChangeType::getEnumValue() const
{
    return m_value.getValue();
}

void DnaiChangeType::setEnumValue(DnaiChangeType_anyOf::eDnaiChangeType_anyOf  value)
{
