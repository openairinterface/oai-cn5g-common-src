...
class SmContextUpdateData {
 public:
  ...
  ///
  /// </summary>
  std::vector<oai::_3gpp::model::BackupAmfInfo>& getBackupAmfInfo();
  ...
  ///
  /// </summary>
  oai::_3gpp::model::AccessType getSecondAnType() const;
  void setSecondAnType(oai::_3gpp::model::AccessType const& value);
  ...
  ///
  /// </summary>
  oai::_3gpp::model::RefToBinaryData getN2SmInfoExt1() const;
  void setN2SmInfoExt1(oai::_3gpp::model::RefToBinaryData const& value);
 ...
 protected:
  ...
  std::string m_AnType;
  bool m_AnTypeIsSet;
  oai::_3gpp::model::AccessType m_SecondAnType;
  ...
  oai::_3gpp::model::RefToBinaryData m_N2SmInfoExt1;
