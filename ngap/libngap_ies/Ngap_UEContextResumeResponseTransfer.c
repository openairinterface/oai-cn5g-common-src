...
static asn_TYPE_member_t asn_MBR_Ngap_UEContextResumeResponseTransfer_1[] = {
    ...
    {ATF_POINTER,
     1,
     offsetof(struct Ngap_UEContextResumeResponseTransfer, iE_Extensions),
     (ASN_TAG_CLASS_CONTEXT | (1 << 2)),
     -1, /* IMPLICIT tag at current level */
     &asn_DEF_Ngap_ProtocolExtensionContainer_12929P351,
     0,
     {
#if !defined(ASN_DISABLE_OER_SUPPORT)
         0,
...
static asn_SEQUENCE_specifics_t
    asn_SPC_Ngap_UEContextResumeResponseTransfer_specs_1 = {
