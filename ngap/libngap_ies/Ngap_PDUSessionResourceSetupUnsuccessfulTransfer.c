...
static asn_TYPE_member_t
    asn_MBR_Ngap_PDUSessionResourceSetupUnsuccessfulTransfer_1[] = {
        {ATF_POINTER,
         0,
         offsetof(
             struct Ngap_PDUSessionResourceSetupUnsuccessfulTransfer, cause),
        ...
        {ATF_POINTER,
         2,
         offsetof(
             struct Ngap_PDUSessionResourceSetupUnsuccessfulTransfer,
        ...
        {ATF_POINTER,
         ...
         -1, /* IMPLICIT tag at current level */
         &asn_DEF_Ngap_ProtocolExtensionContainer_12929P257,
         0,
         {
#if !defined(ASN_DISABLE_OER_SUPPORT)
             0,
...
static const int
    asn_MAP_Ngap_PDUSessionResourceSetupUnsuccessfulTransfer_oms_1[] = {1, 2};
...
static asn_SEQUENCE_specifics_t
    asn_SPC_Ngap_PDUSessionResourceSetupUnsuccessfulTransfer_specs_1 = {
        ...
        offsetof(
            struct Ngap_PDUSessionResourceSetupUnsuccessfulTransfer, _asn_ctx),
        asn_MAP_Ngap_PDUSessionResourceSetupUnsuccessfulTransfer_tag2el_1,
        3, /* Count of tags in the map */
        asn_MAP_Ngap_PDUSessionResourceSetupUnsuccessfulTransfer_oms_1, /* Optional
                                                                           members
                                                                         */
        2,
        0, /* Root/Additions */
