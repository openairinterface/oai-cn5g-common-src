...
void NFIdentification::setNFIPv6Address(oai::_3gpp::model::Ipv6Addr const& value)
{
...
oai::_3gpp::model::NodeFunctionality NFIdentification::getNodeFunctionality() const
{
    return m_NodeFunctionality;
}
void NFIdentification::setNodeFunctionality(oai::_3gpp::model::NodeFunctionality const& value)
{
