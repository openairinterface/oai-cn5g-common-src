...
public:
    ...
    friend  void to_json(nlohmann::json& j, const NonUeN2InfoSubscriptionCreatedData& o);
    friend  void from_json(const nlohmann::json& j, NonUeN2InfoSubscriptionCreatedData& o);
protected:
