...
bool DnnSmfInfoItem::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    ...
    if (dnaiListIsSet())
    {
        const std::vector<oai::model::DnnSmfInfoItem_dnaiList_inner>& value = m_DnaiList;
        ...
        { // Recursive validation of array elements
            ...
            int i = 0;
            for (const oai::model::DnnSmfInfoItem_dnaiList_inner& value : value)
            { 
...
oai::model::DnnSmfInfoItem_dnn DnnSmfInfoItem::getDnn() const
{
    return m_Dnn;
}
void DnnSmfInfoItem::setDnn(oai::model::DnnSmfInfoItem_dnn const& value)
{
    m_Dnn = value;
}
std::vector<oai::model::DnnSmfInfoItem_dnaiList_inner> DnnSmfInfoItem::getDnaiList() const
{
    return m_DnaiList;
}
void DnnSmfInfoItem::setDnaiList(std::vector<oai::model::DnnSmfInfoItem_dnaiList_inner> const& value)
{
    m_DnaiList = value;
