...
ReportAmountMdt_anyOf::eReportAmountMdt_anyOf ReportAmountMdt::getEnumValue() const
{
    return m_value.getValue();
}

void ReportAmountMdt::setEnumValue(ReportAmountMdt_anyOf::eReportAmountMdt_anyOf  value)
{
