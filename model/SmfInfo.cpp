...
std::vector<oai::_3gpp::model::SnssaiSmfInfoItem> SmfInfo::getSNssaiSmfInfoList() const
{
    return m_SNssaiSmfInfoList;
}
void SmfInfo::setSNssaiSmfInfoList(std::vector<oai::_3gpp::model::SnssaiSmfInfoItem> const& value)
{
...
void SmfInfo::setTaiRangeList(std::vector<oai::_3gpp::model::TaiRange> const& value)
{
...
void SmfInfo::setPgwIpAddrList(std::vector<oai::_3gpp::model::IpAddr> const& value)
{
...
void SmfInfo::setAccessType(std::vector<oai::_3gpp::model::AccessType> const& value)
{
    m_AccessType = value;
