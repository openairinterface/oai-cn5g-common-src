...
public:
    ...
    /// 
    /// </summary>
    oai::model::LocationReportingConfiguration getLocationReportingConfiguration() const;
    void setLocationReportingConfiguration(oai::model::LocationReportingConfiguration const& value);
    ...
    /// 
    /// </summary>
    oai::model::DatalinkReportingConfiguration getDatalinkReportCfg() const;
    void setDatalinkReportCfg(oai::model::DatalinkReportingConfiguration const& value);
    bool datalinkReportCfgIsSet() const;
    void unsetDatalinkReportCfg();
    /// <summary>
    /// 
    /// </summary>
    oai::model::LossConnectivityCfg getLossConnectivityCfg() const;
    void setLossConnectivityCfg(oai::model::LossConnectivityCfg const& value);
    ...
    /// 
    /// </summary>
    oai::model::PduSessionStatusCfg getPduSessionStatusCfg() const;
    void setPduSessionStatusCfg(oai::model::PduSessionStatusCfg const& value);
    ...
    /// 
    /// </summary>
    oai::model::ReachabilityForDataConfiguration getReachabilityForDataCfg() const;
    void setReachabilityForDataCfg(oai::model::ReachabilityForDataConfiguration const& value);
...
protected:
    ...
    oai::model::LocationReportingConfiguration m_LocationReportingConfiguration;
    bool m_LocationReportingConfigurationIsSet;
    oai::model::AssociationType m_AssociationType;
    bool m_AssociationTypeIsSet;
    oai::model::DatalinkReportingConfiguration m_DatalinkReportCfg;
    bool m_DatalinkReportCfgIsSet;
    oai::model::LossConnectivityCfg m_LossConnectivityCfg;
    ...
    oai::model::PduSessionStatusCfg m_PduSessionStatusCfg;
    ...
    std::string m_AfId;
    bool m_AfIdIsSet;
    oai::model::ReachabilityForDataConfiguration m_ReachabilityForDataCfg;
