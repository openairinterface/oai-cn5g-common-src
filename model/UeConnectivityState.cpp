...
void UeConnectivityState::setAccessType(oai::_3gpp::model::AccessType const& value)
{
    m_AccessType = value;
}
...
void UeConnectivityState::setConnectivitystate(oai::_3gpp::model::CmState const& value)
{
