...
public:
    ...
    /// 
    /// </summary>
    std::vector<oai::model::IpIndex> getIpv4IndexList() const;
    void setIpv4IndexList(std::vector<oai::model::IpIndex> const& value);
    bool ipv4IndexListIsSet() const;
    void unsetIpv4IndexList();
    /// <summary>
    /// 
    /// </summary>
    std::vector<oai::model::IpIndex> getIpv6IndexList() const;
    void setIpv6IndexList(std::vector<oai::model::IpIndex> const& value);
    bool ipv6IndexListIsSet() const;
    void unsetIpv6IndexList();
    /// <summary>
...
protected:
    ...
    std::vector<oai::model::IpIndex> m_Ipv4IndexList;
    bool m_Ipv4IndexListIsSet;
    std::vector<oai::model::IpIndex> m_Ipv6IndexList;
    bool m_Ipv6IndexListIsSet;
