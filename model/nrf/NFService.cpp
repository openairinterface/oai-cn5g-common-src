...
std::string NFService::getServiceName() const { return m_ServiceName; }
...
std::string NFService::getScheme() const { return m_Scheme; }
void NFService::setScheme(std::string const &value) { m_Scheme = value; }
std::string NFService::getNfServiceStatus() const { return m_NfServiceStatus; }
...
std::vector<Snssai> &NFService::getAllowedNssais() { return m_AllowedNssais; }
...
ChfServiceInfo NFService::getChfServiceInfo() const { return m_ChfServiceInfo; }
void NFService::setChfServiceInfo(ChfServiceInfo const &value) {
  m_ChfServiceInfo = value;
  m_ChfServiceInfoIsSet = true;
}
bool NFService::chfServiceInfoIsSet() const { return m_ChfServiceInfoIsSet; }
void NFService::unsetChfServiceInfo() { m_ChfServiceInfoIsSet = false; }
