...
//---------------------------------------------------------------------------------------------
void sbi_helper::get_nrf_nfm_api_root(const nf_addr_t &nrf_addr,
                                      std::string &api_root) {
  api_root = nrf_addr.uri_root + sbi_helper::NrfNfmBase + nrf_addr.api_version;
}

//---------------------------------------------------------------------------------------------
void sbi_helper::get_nrf_nf_instance_uri(const nf_addr_t &nrf_addr,
  ...
  get_fmt_format_form(sbi_helper::NrfNfmPathNfInstancesNfInstanceId,
                      path_nf_instance_id);
  uri = nrf_api_root + fmt::format(path_nf_instance_id, nf_instance);
}

//---------------------------------------------------------------------------------------------
void sbi_helper::get_nrf_disc_api_root(const nf_addr_t &nrf_addr,
                                       std::string &api_root) {
  api_root = nrf_addr.uri_root + sbi_helper::NrfDiscBase + nrf_addr.api_version;
}

//---------------------------------------------------------------------------------------------
void sbi_helper::get_nrf_disc_search_nf_instances_uri(const nf_addr_t &nrf_addr,
                                                      std::string &uri) {
  std::string api_root = {};
