...
LoggingDurationMdt_anyOf::eLoggingDurationMdt_anyOf LoggingDurationMdt::getEnumValue() const
{
    return m_value.getValue();
}

void LoggingDurationMdt::setEnumValue(LoggingDurationMdt_anyOf::eLoggingDurationMdt_anyOf  value)
{
