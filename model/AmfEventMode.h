...
public:
    ...
    /// 
    /// </summary>
    oai::model::AmfEventTrigger getTrigger() const;
    void setTrigger(oai::model::AmfEventTrigger const& value);
    /// <summary>
    /// 
    /// </summary>
    ...
    /// 
    /// </summary>
    std::vector<oai::model::PartitioningCriteria> getPartitioningCriteria() const;
    void setPartitioningCriteria(std::vector<oai::model::PartitioningCriteria> const& value);
...
protected:
    oai::model::AmfEventTrigger m_Trigger;
    ...
    std::vector<oai::model::PartitioningCriteria> m_PartitioningCriteria;
