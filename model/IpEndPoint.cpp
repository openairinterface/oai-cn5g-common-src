...
bool IpEndPoint::validate(
  ...
  const std::string _pathPrefix =
      pathPrefix.empty() ? "IpEndPoint" : pathPrefix;
...
bool IpEndPoint::operator==(const IpEndPoint& rhs) const {
  return
      ...
      ((!ipv6AddressIsSet() && !rhs.ipv6AddressIsSet()) ||
       (ipv6AddressIsSet() && rhs.ipv6AddressIsSet() &&
        getIpv6Address() == rhs.getIpv6Address())) &&

      ((!transportIsSet() && !rhs.transportIsSet()) ||
       (transportIsSet() && rhs.transportIsSet() &&
        getTransport() == rhs.getTransport())) &&
...
oai::_3gpp::model::Ipv6Addr IpEndPoint::getIpv6Address() const {
  return m_Ipv6Address;
}
void IpEndPoint::setIpv6Address(oai::_3gpp::model::Ipv6Addr const& value) {
  m_Ipv6Address      = value;
