...
public:
    ...
    /// 
    /// </summary>
    oai::_3gpp::model::AccessAndMobilitySubscriptionData_1 getSharedAmData() const;
    void setSharedAmData(oai::_3gpp::model::AccessAndMobilitySubscriptionData_1 const& value);
    ...
    void setSharedSmsSubsData(oai::_3gpp::model::SmsSubscriptionData_1 const& value);
    bool sharedSmsSubsDataIsSet() const;
    void unsetSharedSmsSubsData();
    /// <summary>
    /// 
    /// </summary>
    oai::_3gpp::model::SmsManagementSubscriptionData_1 getSharedSmsMngSubsData() const;
    void setSharedSmsMngSubsData(oai::_3gpp::model::SmsManagementSubscriptionData_1 const& value);
    ...
    /// </summary>
    std::map<std::string, oai::_3gpp::model::DnnConfiguration_1> getSharedDnnConfigurations() const;
    void setSharedDnnConfigurations(std::map<std::string, oai::_3gpp::model::DnnConfiguration_1> const& value);
    ...
    /// </summary>
    std::map<std::string, oai::_3gpp::model::SnssaiInfo> getSharedSnssaiInfos() const;
    void setSharedSnssaiInfos(std::map<std::string, oai::_3gpp::model::SnssaiInfo> const& value);
    ...
    /// </summary>
    std::map<std::string, oai::_3gpp::model::VnGroupData> getSharedVnGroupDatas() const;
    void setSharedVnGroupDatas(std::map<std::string, oai::_3gpp::model::VnGroupData> const& value);
    ...
    /// </summary>
    std::map<std::string, oai::_3gpp::model::SharedDataTreatmentInstruction> getTreatmentInstructions() const;
    void setTreatmentInstructions(std::map<std::string, oai::_3gpp::model::SharedDataTreatmentInstruction> const& value);
    bool treatmentInstructionsIsSet() const;
    void unsetTreatmentInstructions();
    /// <summary>
    /// 
    /// </summary>
    oai::_3gpp::model::SessionManagementSubscriptionData_1 getSharedSmSubsData() const;
    void setSharedSmSubsData(oai::_3gpp::model::SessionManagementSubscriptionData_1 const& value);
    ...
    void setSharedEcsAddrConfigInfo(oai::_3gpp::model::EcsAddrConfigInfo_1 const& value);
...
protected:
    ...
    std::map<std::string, oai::_3gpp::model::DnnConfiguration_1> m_SharedDnnConfigurations;
    ...
    std::map<std::string, oai::_3gpp::model::SharedDataTreatmentInstruction> m_TreatmentInstructions;
