...
bool LcsServiceAuth::validate(std::stringstream &msg,
...
LcsServiceAuth_anyOf LcsServiceAuth::getValue() const { return m_value; }

void LcsServiceAuth::setValue(LcsServiceAuth_anyOf value) { m_value = value; }

LcsServiceAuth_anyOf::eLcsServiceAuth_anyOf
LcsServiceAuth::getEnumValue() const {
