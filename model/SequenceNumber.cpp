...
bool SequenceNumber::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "SequenceNumber" : pathPrefix;
...
bool SequenceNumber::operator==(const SequenceNumber& rhs) const
{
    ...
    ((!sqnSchemeIsSet() && !rhs.sqnSchemeIsSet()) || (sqnSchemeIsSet() && rhs.sqnSchemeIsSet() && getSqnScheme() == rhs.getSqnScheme())) &&
    
    
    ((!sqnIsSet() && !rhs.sqnIsSet()) || (sqnIsSet() && rhs.sqnIsSet() && getSqn() == rhs.getSqn())) &&
    
    
    ((!lastIndexesIsSet() && !rhs.lastIndexesIsSet()) || (lastIndexesIsSet() && rhs.lastIndexesIsSet() && getLastIndexes() == rhs.getLastIndexes())) &&
    
    
    ((!indLengthIsSet() && !rhs.indLengthIsSet()) || (indLengthIsSet() && rhs.indLengthIsSet() && getIndLength() == rhs.getIndLength())) &&
    
    
    ((!difSignIsSet() && !rhs.difSignIsSet()) || (difSignIsSet() && rhs.difSignIsSet() && getDifSign() == rhs.getDifSign()))
...
oai::model::SqnScheme SequenceNumber::getSqnScheme() const
{
    return m_SqnScheme;
}
void SequenceNumber::setSqnScheme(oai::model::SqnScheme const& value)
{
    m_SqnScheme = value;
...
void SequenceNumber::setLastIndexes(std::map<std::string, int32_t> const value)
{
    m_LastIndexes = value;
...
oai::model::Sign SequenceNumber::getDifSign() const
{
    return m_DifSign;
}
void SequenceNumber::setDifSign(oai::model::Sign const& value)
{
    m_DifSign = value;
    m_DifSignIsSet = true;
}
