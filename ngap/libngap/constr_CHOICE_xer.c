 ...
 */
asn_dec_rval_t CHOICE_decode_xer(const asn_codec_ctx_t *opt_codec_ctx,
  ...
  for (edx = ctx->step; ctx->phase <= 4;) {
    ...
    if (ctx->phase == 2) {
      ...
      tmprval = elm->type->op->xer_decoder(opt_codec_ctx, elm->type, memb_ptr2,
...
asn_enc_rval_t CHOICE_encode_xer(const asn_TYPE_descriptor_t *td,
