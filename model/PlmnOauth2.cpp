...
bool PlmnOauth2::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    ...
    {
        const std::vector<oai::_3gpp::model::PlmnId>& value = m_Oauth2RequiredPlmnIdList;
    ...
    {
        const std::vector<oai::_3gpp::model::PlmnId>& value = m_Oauth2NotRequiredPlmnIdList;
...
std::vector<oai::_3gpp::model::PlmnId> PlmnOauth2::getOauth2RequiredPlmnIdList() const
{
    return m_Oauth2RequiredPlmnIdList;
}
void PlmnOauth2::setOauth2RequiredPlmnIdList(std::vector<oai::_3gpp::model::PlmnId> const& value)
{
...
std::vector<oai::_3gpp::model::PlmnId> PlmnOauth2::getOauth2NotRequiredPlmnIdList() const
{
    return m_Oauth2NotRequiredPlmnIdList;
}
void PlmnOauth2::setOauth2NotRequiredPlmnIdList(std::vector<oai::_3gpp::model::PlmnId> const& value)
{
