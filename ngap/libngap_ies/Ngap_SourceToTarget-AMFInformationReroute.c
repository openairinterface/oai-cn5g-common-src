...
asn_TYPE_member_t asn_MBR_Ngap_SourceToTarget_AMFInformationReroute_1[] = {
    ...
    {ATF_POINTER,
     1,
     offsetof(struct Ngap_SourceToTarget_AMFInformationReroute, iE_Extensions),
     (ASN_TAG_CLASS_CONTEXT | (3 << 2)),
     -1, /* IMPLICIT tag at current level */
     &asn_DEF_Ngap_ProtocolExtensionContainer_12929P316,
     0,
     {
#if !defined(ASN_DISABLE_OER_SUPPORT)
         0,
...
static const int asn_MAP_Ngap_SourceToTarget_AMFInformationReroute_oms_1[] = {
    0, 1, 2, 3};
...
asn_SEQUENCE_specifics_t
    asn_SPC_Ngap_SourceToTarget_AMFInformationReroute_specs_1 = {
        ...
        asn_MAP_Ngap_SourceToTarget_AMFInformationReroute_oms_1, /* Optional
                                                                    members */
        4,
        0, /* Root/Additions */
...
asn_TYPE_descriptor_t asn_DEF_Ngap_SourceToTarget_AMFInformationReroute = {
    ...
    sizeof(asn_DEF_Ngap_SourceToTarget_AMFInformationReroute_tags_1) /
        sizeof(
            asn_DEF_Ngap_SourceToTarget_AMFInformationReroute_tags_1[0]), /* 1
                                                                           */
    ...
    4, /* Elements count */
    &asn_SPC_Ngap_SourceToTarget_AMFInformationReroute_specs_1 /* Additional
                                                                  specs */
};
