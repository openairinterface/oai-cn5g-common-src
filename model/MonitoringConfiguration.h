...
public:
    ...
    /// 
    /// </summary>
    oai::_3gpp::model::LocationReportingConfiguration getLocationReportingConfiguration() const;
    void setLocationReportingConfiguration(oai::_3gpp::model::LocationReportingConfiguration const& value);
    ...
    /// 
    /// </summary>
    oai::_3gpp::model::DatalinkReportingConfiguration getDatalinkReportCfg() const;
    void setDatalinkReportCfg(oai::_3gpp::model::DatalinkReportingConfiguration const& value);
    ...
    void setLossConnectivityCfg(oai::_3gpp::model::LossConnectivityCfg const& value);
    ...
    void setPduSessionStatusCfg(oai::_3gpp::model::PduSessionStatusCfg const& value);
    ...
    /// 
    /// </summary>
    oai::_3gpp::model::ReachabilityForDataConfiguration getReachabilityForDataCfg() const;
    void setReachabilityForDataCfg(oai::_3gpp::model::ReachabilityForDataConfiguration const& value);
...
protected:
    ...
    oai::_3gpp::model::LocationReportingConfiguration m_LocationReportingConfiguration;
