...
asn_TYPE_member_t asn_MBR_Ngap_MBS_DataForwardingResponseMRBItem_1[] = {
    {ATF_NOFLAGS,
     0,
     offsetof(struct Ngap_MBS_DataForwardingResponseMRBItem, mRB_ID),
    ...
    {ATF_POINTER,
     ...
     offsetof(
         ...
         dL_Forwarding_UPTNLInformation),
    ...
    {ATF_POINTER,
     1,
     offsetof(struct Ngap_MBS_DataForwardingResponseMRBItem, iE_Extensions),
     (ASN_TAG_CLASS_CONTEXT | (3 << 2)),
     -1, /* IMPLICIT tag at current level */
     &asn_DEF_Ngap_ProtocolExtensionContainer_12929P152,
     0,
     {
#if !defined(ASN_DISABLE_OER_SUPPORT)
         0,
...
static const int asn_MAP_Ngap_MBS_DataForwardingResponseMRBItem_oms_1[] = {
    2, 3};
...
static const asn_TYPE_tag2member_t
    asn_MAP_Ngap_MBS_DataForwardingResponseMRBItem_tag2el_1[] = {
        ...
        {(ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0,
         0}, /* dL-Forwarding-UPTNLInformation */
...
asn_SEQUENCE_specifics_t
    asn_SPC_Ngap_MBS_DataForwardingResponseMRBItem_specs_1 = {
        ...
        asn_MAP_Ngap_MBS_DataForwardingResponseMRBItem_oms_1, /* Optional
                                                                 members */
        2,
        0, /* Root/Additions */
...
asn_TYPE_descriptor_t asn_DEF_Ngap_MBS_DataForwardingResponseMRBItem = {
    ...
    sizeof(asn_DEF_Ngap_MBS_DataForwardingResponseMRBItem_tags_1) /
        sizeof(
            asn_DEF_Ngap_MBS_DataForwardingResponseMRBItem_tags_1[0]), /* 1 */
