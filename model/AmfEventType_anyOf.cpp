...
bool AmfEventType_anyOf::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "AmfEventType_anyOf" : pathPrefix;

    
    if (m_value == AmfEventType_anyOf::eAmfEventType_anyOf::INVALID_VALUE_OPENAPI_GENERATED)
    {
        success = false;
...
void to_json(nlohmann::json& j, const AmfEventType_anyOf& o)
{
    ...
    switch (o.getValue())
    {
        case AmfEventType_anyOf::eAmfEventType_anyOf::INVALID_VALUE_OPENAPI_GENERATED:
        ...
        case AmfEventType_anyOf::eAmfEventType_anyOf::_5GS_USER_STATE_REPORT:
            ...
            break;
        case AmfEventType_anyOf::eAmfEventType_anyOf::AVAILABILITY_AFTER_DDN_FAILURE:
        ...
        case AmfEventType_anyOf::eAmfEventType_anyOf::TYPE_ALLOCATION_CODE_REPORT:
            ...
            break;
        case AmfEventType_anyOf::eAmfEventType_anyOf::FREQUENT_MOBILITY_REGISTRATION_REPORT:
...
void from_json(const nlohmann::json& j, AmfEventType_anyOf& o)
{
    ...
    if (s == "LOCATION_REPORT") {
     ...
     o.setValue(AmfEventType_anyOf::eAmfEventType_anyOf::REGISTRATION_STATE_REPORT);
    } 
    else if (s == "CONNECTIVITY_STATE_REPORT") {
     o.setValue(AmfEventType_anyOf::eAmfEventType_anyOf::CONNECTIVITY_STATE_REPORT);
    } 
     ...
     o.setValue(AmfEventType_anyOf::eAmfEventType_anyOf::COMMUNICATION_FAILURE_REPORT);
    } 
     ...
     o.setValue(AmfEventType_anyOf::eAmfEventType_anyOf::SUBSCRIPTION_ID_ADDITION);
    } 
     ...
     o.setValue(AmfEventType_anyOf::eAmfEventType_anyOf::AVAILABILITY_AFTER_DDN_FAILURE);
    } 
    else if (s == "TYPE_ALLOCATION_CODE_REPORT") {
     o.setValue(AmfEventType_anyOf::eAmfEventType_anyOf::TYPE_ALLOCATION_CODE_REPORT);
    } 
    else if (s == "FREQUENT_MOBILITY_REGISTRATION_REPORT") {
     o.setValue(AmfEventType_anyOf::eAmfEventType_anyOf::FREQUENT_MOBILITY_REGISTRATION_REPORT);
    } 
    else if (s == "SNSSAI_TA_MAPPING_REPORT") {
     o.setValue(AmfEventType_anyOf::eAmfEventType_anyOf::SNSSAI_TA_MAPPING_REPORT);
    } 
     ...
     o.setValue(AmfEventType_anyOf::eAmfEventType_anyOf::UE_ACCESS_BEHAVIOR_TRENDS);
    } 
    else if (s == "UE_MM_TRANSACTION_REPORT") {
     o.setValue(AmfEventType_anyOf::eAmfEventType_anyOf::UE_MM_TRANSACTION_REPORT);
    }  else {
     std::stringstream ss;
...
void AmfEventType_anyOf::setValue(AmfEventType_anyOf::eAmfEventType_anyOf value)
{
    m_value = value;
}
