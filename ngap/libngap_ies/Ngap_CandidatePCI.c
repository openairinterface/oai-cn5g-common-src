...
static asn_oer_constraints_t asn_OER_memb_Ngap_candidatePCI_constr_2 CC_NOTUSED = {
	{ 0, 0 },
	-1};
...
#if !defined(ASN_DISABLE_OER_SUPPORT)
static asn_oer_constraints_t asn_OER_memb_Ngap_candidateNRARFCN_constr_3 CC_NOTUSED = {
	{ 4, 1 }	/* (0..3279165) */,
	-1};
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
...
asn_TYPE_member_t asn_MBR_Ngap_CandidatePCI_1[] = {
	...
	{ ATF_POINTER, 1, offsetof(struct Ngap_CandidatePCI, iE_Extensions),
		...
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_Ngap_ProtocolExtensionContainer_12929P32,
		0,
		{
#if !defined(ASN_DISABLE_OER_SUPPORT)
			0,
