...
bool DnnUpfInfoItem::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    ...
    {
        const std::vector<oai::model::IpIndex>& value = m_Ipv4IndexList;
        ...
        { // Recursive validation of array elements
            const std::string oldValuePath = currentValuePath;
            int i = 0;
            for (const oai::model::IpIndex& value : value)
            { 
                const std::string currentValuePath = oldValuePath + "[" + std::to_string(i) + "]";
    ...
    {
        const std::vector<oai::model::IpIndex>& value = m_Ipv6IndexList;
...
std::vector<oai::model::PduSessionType> DnnUpfInfoItem::getPduSessionTypes() const
{
    return m_PduSessionTypes;
}
void DnnUpfInfoItem::setPduSessionTypes(std::vector<oai::model::PduSessionType> const& value)
{
...
std::vector<oai::model::Ipv4AddressRange> DnnUpfInfoItem::getIpv4AddressRanges() const
{
    return m_Ipv4AddressRanges;
}
void DnnUpfInfoItem::setIpv4AddressRanges(std::vector<oai::model::Ipv4AddressRange> const& value)
{
...
std::vector<oai::model::Ipv6PrefixRange> DnnUpfInfoItem::getIpv6PrefixRanges() const
{
    return m_Ipv6PrefixRanges;
}
void DnnUpfInfoItem::setIpv6PrefixRanges(std::vector<oai::model::Ipv6PrefixRange> const& value)
{
...
std::vector<oai::model::IpIndex> DnnUpfInfoItem::getIpv4IndexList() const
{
    return m_Ipv4IndexList;
}
void DnnUpfInfoItem::setIpv4IndexList(std::vector<oai::model::IpIndex> const& value)
{
...
std::vector<oai::model::IpIndex> DnnUpfInfoItem::getIpv6IndexList() const
{
    return m_Ipv6IndexList;
}
void DnnUpfInfoItem::setIpv6IndexList(std::vector<oai::model::IpIndex> const& value)
{
