...
void RoamingStatusReport::setNewServingPlmn(oai::_3gpp::model::PlmnId const& value)
{
...
void RoamingStatusReport::setAccessType(oai::_3gpp::model::AccessType const& value)
{
    m_AccessType = value;
