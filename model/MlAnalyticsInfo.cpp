...
bool MlAnalyticsInfo::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    ...
    {
        const std::vector<oai::model::NwdafEvent>& value = m_MlAnalyticsIds;
...
std::vector<oai::model::NwdafEvent> MlAnalyticsInfo::getMlAnalyticsIds() const
{
    return m_MlAnalyticsIds;
}
void MlAnalyticsInfo::setMlAnalyticsIds(std::vector<oai::model::NwdafEvent> const& value)
{
...
std::vector<oai::model::Snssai> MlAnalyticsInfo::getSnssaiList() const
{
    return m_SnssaiList;
}
void MlAnalyticsInfo::setSnssaiList(std::vector<oai::model::Snssai> const& value)
{
    m_SnssaiList = value;
...
std::vector<oai::model::Tai> MlAnalyticsInfo::getTrackingAreaList() const
{
    return m_TrackingAreaList;
}
void MlAnalyticsInfo::setTrackingAreaList(std::vector<oai::model::Tai> const& value)
{
