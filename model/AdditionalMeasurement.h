...
public:
    ...
    /// 
    /// </summary>
    oai::model::NetworkAreaInfo getUnexpLoc() const;
    void setUnexpLoc(oai::model::NetworkAreaInfo const& value);
    bool unexpLocIsSet() const;
    void unsetUnexpLoc();
    /// <summary>
    /// 
    /// </summary>
    std::vector<oai::model::IpEthFlowDescription> getUnexpFlowTeps() const;
    void setUnexpFlowTeps(std::vector<oai::model::IpEthFlowDescription> const& value);
    ...
    /// 
    /// </summary>
    oai::model::AddressList getDdosAttack() const;
    void setDdosAttack(oai::model::AddressList const& value);
    bool ddosAttackIsSet() const;
    void unsetDdosAttack();
    /// <summary>
    /// 
    /// </summary>
    oai::model::AddressList getWrgDest() const;
    void setWrgDest(oai::model::AddressList const& value);
    bool wrgDestIsSet() const;
    void unsetWrgDest();
    /// <summary>
    /// 
    /// </summary>
    std::vector<oai::model::CircumstanceDescription> getCircums() const;
    void setCircums(std::vector<oai::model::CircumstanceDescription> const& value);
...
protected:
    oai::model::NetworkAreaInfo m_UnexpLoc;
    bool m_UnexpLocIsSet;
    std::vector<oai::model::IpEthFlowDescription> m_UnexpFlowTeps;
    bool m_UnexpFlowTepsIsSet;
    std::vector<std::string> m_UnexpWakes;
    bool m_UnexpWakesIsSet;
    oai::model::AddressList m_DdosAttack;
    bool m_DdosAttackIsSet;
    oai::model::AddressList m_WrgDest;
    bool m_WrgDestIsSet;
    std::vector<oai::model::CircumstanceDescription> m_Circums;
    bool m_CircumsIsSet;
