...
std::vector<oai::model::AfEventSubscription> EventsSubscReqData::getEvents() const
{
    return m_Events;
}
void EventsSubscReqData::setEvents(std::vector<oai::model::AfEventSubscription> const& value)
{
    m_Events = value;
}
...
std::vector<oai::model::RequestedQosMonitoringParameter> EventsSubscReqData::getReqQosMonParams() const
{
    return m_ReqQosMonParams;
}
void EventsSubscReqData::setReqQosMonParams(std::vector<oai::model::RequestedQosMonitoringParameter> const& value)
{
...
oai::model::QosMonitoringInformation EventsSubscReqData::getQosMon() const
{
    return m_QosMon;
}
void EventsSubscReqData::setQosMon(oai::model::QosMonitoringInformation const& value)
{
    m_QosMon = value;
    m_QosMonIsSet = true;
}
...
std::vector<oai::model::RequiredAccessInfo> EventsSubscReqData::getReqAnis() const
{
    return m_ReqAnis;
}
void EventsSubscReqData::setReqAnis(std::vector<oai::model::RequiredAccessInfo> const& value)
{
    m_ReqAnis = value;
    m_ReqAnisIsSet = true;
}
...
oai::model::UsageThreshold EventsSubscReqData::getUsgThres() const
{
    return m_UsgThres;
}
void EventsSubscReqData::setUsgThres(oai::model::UsageThreshold const& value)
{
    m_UsgThres = value;
