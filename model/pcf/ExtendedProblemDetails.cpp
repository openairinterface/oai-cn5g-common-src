...
bool ExtendedProblemDetails::validate(std::stringstream &msg,
...
oai::model::common::AccessTokenErr
ExtendedProblemDetails::getAccessTokenError() const {
...
ExtendedProblemDetails::getSupportedApiVersions() const {
