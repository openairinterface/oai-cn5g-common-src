...
asn_TYPE_member_t asn_MBR_Ngap_QosFlowAcceptedItem_1[] = {
    {ATF_NOFLAGS,
     0,
     offsetof(struct Ngap_QosFlowAcceptedItem, qosFlowIdentifier),
    ...
    {ATF_POINTER,
     1,
     offsetof(struct Ngap_QosFlowAcceptedItem, iE_Extensions),
     (ASN_TAG_CLASS_CONTEXT | (1 << 2)),
     -1, /* IMPLICIT tag at current level */
     &asn_DEF_Ngap_ProtocolExtensionContainer_12929P270,
     0,
     {
#if !defined(ASN_DISABLE_OER_SUPPORT)
         0,
