...
MeasurementLteForMdt_anyOf::eMeasurementLteForMdt_anyOf MeasurementLteForMdt::getEnumValue() const
{
    return m_value.getValue();
}

void MeasurementLteForMdt::setEnumValue(MeasurementLteForMdt_anyOf::eMeasurementLteForMdt_anyOf  value)
{
