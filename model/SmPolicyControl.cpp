...
oai::_3gpp::model::SmPolicyContextData SmPolicyControl::getContext() const
{
    return m_Context;
}
void SmPolicyControl::setContext(oai::_3gpp::model::SmPolicyContextData const& value)
{
    m_Context = value;
}
oai::_3gpp::model::SmPolicyDecision SmPolicyControl::getPolicy() const
{
    return m_Policy;
}
void SmPolicyControl::setPolicy(oai::_3gpp::model::SmPolicyDecision const& value)
{
    m_Policy = value;
}
