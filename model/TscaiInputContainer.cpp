...
bool TscaiInputContainer::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "TscaiInputContainer" : pathPrefix;
...
bool TscaiInputContainer::operator==(const TscaiInputContainer& rhs) const
{
    ...
    ((!periodicityIsSet() && !rhs.periodicityIsSet()) || (periodicityIsSet() && rhs.periodicityIsSet() && getPeriodicity() == rhs.getPeriodicity())) &&
    
    
    ((!burstArrivalTimeIsSet() && !rhs.burstArrivalTimeIsSet()) || (burstArrivalTimeIsSet() && rhs.burstArrivalTimeIsSet() && getBurstArrivalTime() == rhs.getBurstArrivalTime())) &&
    
    
    ((!surTimeInNumMsgIsSet() && !rhs.surTimeInNumMsgIsSet()) || (surTimeInNumMsgIsSet() && rhs.surTimeInNumMsgIsSet() && getSurTimeInNumMsg() == rhs.getSurTimeInNumMsg())) &&
    
    
    ((!surTimeInTimeIsSet() && !rhs.surTimeInTimeIsSet()) || (surTimeInTimeIsSet() && rhs.surTimeInTimeIsSet() && getSurTimeInTime() == rhs.getSurTimeInTime()))
