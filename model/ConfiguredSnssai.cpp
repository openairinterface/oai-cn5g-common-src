...
oai::_3gpp::model::Snssai ConfiguredSnssai::getConfiguredSnssai() const
{
    return m_ConfiguredSnssai;
}
void ConfiguredSnssai::setConfiguredSnssai(oai::_3gpp::model::Snssai const& value)
{
    m_ConfiguredSnssai = value;
}
oai::_3gpp::model::Snssai ConfiguredSnssai::getMappedHomeSnssai() const
{
    return m_MappedHomeSnssai;
}
void ConfiguredSnssai::setMappedHomeSnssai(oai::_3gpp::model::Snssai const& value)
{
