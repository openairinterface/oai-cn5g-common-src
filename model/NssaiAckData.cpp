...
bool NssaiAckData::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "NssaiAckData" : pathPrefix;
...
oai::model::UeUpdateStatus NssaiAckData::getUeUpdateStatus() const
{
    return m_UeUpdateStatus;
}
void NssaiAckData::setUeUpdateStatus(oai::model::UeUpdateStatus const& value)
{
