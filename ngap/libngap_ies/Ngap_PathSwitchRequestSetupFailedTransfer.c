...
static asn_TYPE_member_t asn_MBR_Ngap_PathSwitchRequestSetupFailedTransfer_1[] =
    {
        {ATF_POINTER,
         0,
         offsetof(struct Ngap_PathSwitchRequestSetupFailedTransfer, cause),
        ...
        {ATF_POINTER,
         ...
         &asn_DEF_Ngap_ProtocolExtensionContainer_12929P208,
         0,
         {
#if !defined(ASN_DISABLE_OER_SUPPORT)
             0,
...
static const int asn_MAP_Ngap_PathSwitchRequestSetupFailedTransfer_oms_1[] = {
    1};
...
static asn_SEQUENCE_specifics_t
    asn_SPC_Ngap_PathSwitchRequestSetupFailedTransfer_specs_1 = {
        ...
        asn_MAP_Ngap_PathSwitchRequestSetupFailedTransfer_oms_1, /* Optional
                                                                    members */
        1,
        0, /* Root/Additions */
...
asn_TYPE_descriptor_t asn_DEF_Ngap_PathSwitchRequestSetupFailedTransfer = {
    ...
    sizeof(asn_DEF_Ngap_PathSwitchRequestSetupFailedTransfer_tags_1) /
        sizeof(
            asn_DEF_Ngap_PathSwitchRequestSetupFailedTransfer_tags_1[0]), /* 1
                                                                           */
    ...
    2, /* Elements count */
    &asn_SPC_Ngap_PathSwitchRequestSetupFailedTransfer_specs_1 /* Additional
                                                                  specs */
};
