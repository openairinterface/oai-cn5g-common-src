...
static int memb_Ngap_pDUSessionResourceModifyConfirmTransfer_constraint_1(
...
asn_TYPE_member_t asn_MBR_Ngap_PDUSessionResourceModifyItemModCfm_1[] = {
    {ATF_NOFLAGS,
     0,
     offsetof(struct Ngap_PDUSessionResourceModifyItemModCfm, pDUSessionID),
    ...
    {ATF_POINTER,
     1,
     offsetof(struct Ngap_PDUSessionResourceModifyItemModCfm, iE_Extensions),
     (ASN_TAG_CLASS_CONTEXT | (2 << 2)),
     -1, /* IMPLICIT tag at current level */
     &asn_DEF_Ngap_ProtocolExtensionContainer_12929P234,
     0,
     {
#if !defined(ASN_DISABLE_OER_SUPPORT)
         0,
...
static const asn_TYPE_tag2member_t
    asn_MAP_Ngap_PDUSessionResourceModifyItemModCfm_tag2el_1[] = {
        ...
        {(ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0,
         0}, /* pDUSessionResourceModifyConfirmTransfer */
        {(ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0, 0} /* iE-Extensions */
};
asn_SEQUENCE_specifics_t
    asn_SPC_Ngap_PDUSessionResourceModifyItemModCfm_specs_1 = {
        ...
        asn_MAP_Ngap_PDUSessionResourceModifyItemModCfm_oms_1, /* Optional
                                                                  members */
        1,
        0, /* Root/Additions */
...
asn_TYPE_descriptor_t asn_DEF_Ngap_PDUSessionResourceModifyItemModCfm = {
    ...
    sizeof(asn_DEF_Ngap_PDUSessionResourceModifyItemModCfm_tags_1) /
        sizeof(
            asn_DEF_Ngap_PDUSessionResourceModifyItemModCfm_tags_1[0]), /* 1 */
