...
static asn_TYPE_member_t asn_MBR_Ngap_MBS_DistributionReleaseRequestTransfer_1[] = {
	{ ATF_POINTER, 0, offsetof(struct Ngap_MBS_DistributionReleaseRequestTransfer, mBS_SessionID),
	...
	{ ATF_POINTER, 0, offsetof(struct Ngap_MBS_DistributionReleaseRequestTransfer, cause),
