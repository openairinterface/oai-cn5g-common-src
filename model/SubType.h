...
class SubType {
 public:
  ...
  bool operator==(const SubType& rhs) const { return m_value == rhs.m_value; }
  bool operator!=(const SubType& rhs) const { return !(*this == rhs); }
  std::string getValue() const { return m_value; }
  void setValue(const std::string& v) { m_value = v; }
  friend void to_json(nlohmann::json& j, const SubType& o) { j = o.m_value; }
