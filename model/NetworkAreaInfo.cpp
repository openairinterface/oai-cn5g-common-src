...
std::vector<oai::_3gpp::model::Ecgi> NetworkAreaInfo::getEcgis() const
{
    return m_Ecgis;
}
void NetworkAreaInfo::setEcgis(std::vector<oai::_3gpp::model::Ecgi> const& value)
{
    m_Ecgis = value;
    m_EcgisIsSet = true;
}
...
std::vector<oai::_3gpp::model::Ncgi> NetworkAreaInfo::getNcgis() const
{
    return m_Ncgis;
}
void NetworkAreaInfo::setNcgis(std::vector<oai::_3gpp::model::Ncgi> const& value)
{
    m_Ncgis = value;
    m_NcgisIsSet = true;
}
...
std::vector<oai::_3gpp::model::GlobalRanNodeId> NetworkAreaInfo::getGRanNodeIds() const
{
    return m_GRanNodeIds;
}
void NetworkAreaInfo::setGRanNodeIds(std::vector<oai::_3gpp::model::GlobalRanNodeId> const& value)
{
    m_GRanNodeIds = value;
...
std::vector<oai::_3gpp::model::Tai> NetworkAreaInfo::getTais() const
{
    return m_Tais;
}
void NetworkAreaInfo::setTais(std::vector<oai::_3gpp::model::Tai> const& value)
{
    m_Tais = value;
    m_TaisIsSet = true;
}
