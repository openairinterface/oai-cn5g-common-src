...
bool MbUpfInfo::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    ...
    /* SNssaiMbUpfInfoList */ {
        const std::vector<oai::model::SnssaiUpfInfoItem>& value = m_SNssaiMbUpfInfoList;
    ...
    {
        const std::vector<oai::model::InterfaceUpfInfoItem>& value = m_InterfaceMbUpfInfoList;
...
std::vector<oai::model::SnssaiUpfInfoItem> MbUpfInfo::getSNssaiMbUpfInfoList() const
{
    return m_SNssaiMbUpfInfoList;
}
void MbUpfInfo::setSNssaiMbUpfInfoList(std::vector<oai::model::SnssaiUpfInfoItem> const& value)
{
...
std::vector<oai::model::InterfaceUpfInfoItem> MbUpfInfo::getInterfaceMbUpfInfoList() const
{
    return m_InterfaceMbUpfInfoList;
}
void MbUpfInfo::setInterfaceMbUpfInfoList(std::vector<oai::model::InterfaceUpfInfoItem> const& value)
{
...
std::vector<oai::model::Tai> MbUpfInfo::getTaiList() const
{
    return m_TaiList;
}
void MbUpfInfo::setTaiList(std::vector<oai::model::Tai> const& value)
{
    m_TaiList = value;
    m_TaiListIsSet = true;
}
...
std::vector<oai::model::TaiRange> MbUpfInfo::getTaiRangeList() const
{
    return m_TaiRangeList;
}
void MbUpfInfo::setTaiRangeList(std::vector<oai::model::TaiRange> const& value)
{
