...
std::vector<std::string> SmsManagementSubscriptionData::getSharedSmsMngDataIds() const
{
    return m_SharedSmsMngDataIds;
}
void SmsManagementSubscriptionData::setSharedSmsMngDataIds(std::vector<std::string> const& value)
{
...
oai::model::TraceData_1 SmsManagementSubscriptionData::getTraceData() const
{
    return m_TraceData;
}
void SmsManagementSubscriptionData::setTraceData(oai::model::TraceData_1 const& value)
{
    m_TraceData = value;
