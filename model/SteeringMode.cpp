...
bool SteeringMode::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    ...
    if (!m_SteerModeValue.validate(msg, _pathPrefix + ".steerModeValue")) {
...
oai::model::SteerModeValue SteeringMode::getSteerModeValue() const
{
    return m_SteerModeValue;
}
void SteeringMode::setSteerModeValue(oai::model::SteerModeValue const& value)
{
    m_SteerModeValue = value;
}
oai::model::AccessType SteeringMode::getActive() const
{
    return m_Active;
}
void SteeringMode::setActive(oai::model::AccessType const& value)
{
    m_Active = value;
    m_ActiveIsSet = true;
}
...
oai::model::AccessType SteeringMode::getStandby() const
{
    return m_Standby;
}
void SteeringMode::setStandby(oai::model::AccessType const& value)
{
    m_Standby = value;
    m_StandbyIsSet = true;
}
...
oai::model::AccessType SteeringMode::getPrioAcc() const
{
    return m_PrioAcc;
}
void SteeringMode::setPrioAcc(oai::model::AccessType const& value)
{
    m_PrioAcc = value;
    m_PrioAccIsSet = true;
}
...
oai::model::ThresholdValue SteeringMode::getThresValue() const
{
    return m_ThresValue;
}
void SteeringMode::setThresValue(oai::model::ThresholdValue const& value)
{
    m_ThresValue = value;
...
oai::model::SteerModeIndicator SteeringMode::getSteerModeInd() const
{
    return m_SteerModeInd;
}
void SteeringMode::setSteerModeInd(oai::model::SteerModeIndicator const& value)
{
