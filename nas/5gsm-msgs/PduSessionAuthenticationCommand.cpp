...
PduSessionAuthenticationCommand::PduSessionAuthenticationCommand()
    : Nas5gsmMessage(
          k5gsSessionManagementMessages, kPduSessionAuthenticationCommand) {
...
//------------------------------------------------------------------------------
uint32_t PduSessionAuthenticationCommand::GetLength() const {
  uint32_t msg_len = 0;
...
//------------------------------------------------------------------------------
void PduSessionAuthenticationCommand::SetEapMessage(
    const EapMessage& eap_message) {
  ie_eap_message_ = eap_message;
}

//------------------------------------------------------------------------------
void PduSessionAuthenticationCommand::GetEapMessage(
    EapMessage& eap_message) const {
  eap_message = ie_eap_message_;
}

//------------------------------------------------------------------------------
void PduSessionAuthenticationCommand::SetExtendedProtocolConfigurationOptions(
...
//------------------------------------------------------------------------------
void PduSessionAuthenticationCommand::GetExtendedProtocolConfigurationOptions(
    std::optional<ExtendedProtocolConfigurationOptions>& options) const {
  options = ie_extended_protocol_configuration_options_;
}

//------------------------------------------------------------------------------
int PduSessionAuthenticationCommand::Encode(uint8_t* buf, int len) {
  oai::logger::logger_common::nas().debug(
      "Encoding PduSessionAuthenticationCommand message");
  int encoded_size    = 0;
  ...
  oai::logger::logger_common::nas().debug(
      "Encoded PduSessionAuthenticationCommand message len (%d)", encoded_size);
  return encoded_size;
}

//------------------------------------------------------------------------------
int PduSessionAuthenticationCommand::Decode(uint8_t* buf, int len) {
  oai::logger::logger_common::nas().debug(
      "Decoding PduSessionAuthenticationCommand message");
  int decoded_size    = 0;
  ...
  oai::logger::logger_common::nas().debug(
      "Decoded PduSessionAuthenticationCommand message len (%d)", decoded_size);
  return decoded_size;
}
