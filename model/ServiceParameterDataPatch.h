...
public:
    ...
    /// </summary>
    std::vector<oai::model::UrspRuleRequest> getUrspInfluence() const;
    void setUrspInfluence(std::vector<oai::model::UrspRuleRequest> const& value);
    bool urspInfluenceIsSet() const;
    void unsetUrspInfluence();
    /// <summary>
    /// Contains the service parameter used to influence the URSP. 
    /// </summary>
    std::vector<oai::model::UrspRuleRequest> getUrspGuidance() const;
    void setUrspGuidance(std::vector<oai::model::UrspRuleRequest> const& value);
    bool urspGuidanceIsSet() const;
    void unsetUrspGuidance();
    /// <summary>
    /// Contains the outcome of the UE Policy Delivery.
    /// </summary>
    std::vector<oai::model::Event> getDeliveryEvents() const;
    void setDeliveryEvents(std::vector<oai::model::Event> const& value);
...
protected:
    ...
    std::vector<oai::model::UrspRuleRequest> m_UrspInfluence;
    bool m_UrspInfluenceIsSet;
    std::vector<oai::model::UrspRuleRequest> m_UrspGuidance;
    bool m_UrspGuidanceIsSet;
    std::vector<oai::model::Event> m_DeliveryEvents;
