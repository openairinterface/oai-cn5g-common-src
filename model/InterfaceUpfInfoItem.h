...
public:
    ...
    /// 
    /// </summary>
    oai::model::UPInterfaceType getInterfaceType() const;
    void setInterfaceType(oai::model::UPInterfaceType const& value);
    /// <summary>
    /// 
    /// </summary>
    ...
    /// 
    /// </summary>
    std::vector<oai::model::Ipv6Addr> getIpv6EndpointAddresses() const;
    void setIpv6EndpointAddresses(std::vector<oai::model::Ipv6Addr> const& value);
...
protected:
    oai::model::UPInterfaceType m_InterfaceType;

    std::vector<std::string> m_Ipv4EndpointAddresses;
    bool m_Ipv4EndpointAddressesIsSet;
    std::vector<oai::model::Ipv6Addr> m_Ipv6EndpointAddresses;
