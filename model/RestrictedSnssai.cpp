...
std::vector<oai::_3gpp::model::ExtSnssai> RestrictedSnssai::getSNssaiList() const
{
    return m_SNssaiList;
}
void RestrictedSnssai::setSNssaiList(std::vector<oai::_3gpp::model::ExtSnssai> const& value)
{
    m_SNssaiList = value;
}
std::vector<oai::_3gpp::model::PlmnId> RestrictedSnssai::getHomePlmnIdList() const
{
    return m_HomePlmnIdList;
}
void RestrictedSnssai::setHomePlmnIdList(std::vector<oai::_3gpp::model::PlmnId> const& value)
{
