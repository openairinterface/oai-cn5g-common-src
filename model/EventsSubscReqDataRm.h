...
public:
    ...
    /// 
    /// </summary>
    oai::model::QosMonitoringInformationRm getQosMon() const;
    void setQosMon(oai::model::QosMonitoringInformationRm const& value);
    ...
    /// 
    /// </summary>
    oai::model::UsageThresholdRm getUsgThres() const;
    void setUsgThres(oai::model::UsageThresholdRm const& value);
...
protected:
    ...
    oai::model::QosMonitoringInformationRm m_QosMon;
    bool m_QosMonIsSet;
    std::vector<oai::model::RequiredAccessInfo> m_ReqAnis;
    bool m_ReqAnisIsSet;
    oai::model::UsageThresholdRm m_UsgThres;
