...
bool AppDetectionReport::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "AppDetectionReport" : pathPrefix;
...
oai::_3gpp::model::AppDetectionNotifType AppDetectionReport::getAdNotifType() const
{
    return m_AdNotifType;
}
void AppDetectionReport::setAdNotifType(oai::_3gpp::model::AppDetectionNotifType const& value)
{
    m_AdNotifType = value;
}
