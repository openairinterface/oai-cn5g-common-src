...
bool RestrictedSnssai::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "RestrictedSnssai" : pathPrefix;

        
    if (!m_HomePlmnId.validate(msg, _pathPrefix + ".homePlmnId")) {
        msg << _pathPrefix << ": HomePlmnId is invalid;";
        success = false;
    }     
    
    /* SNssaiList */ {
        const std::vector<oai::model::ExtSnssai>& value = m_SNssaiList;
    ...
    {
        const std::vector<oai::model::PlmnId>& value = m_HomePlmnIdList;
        ...
        success = value.validate(msg, currentValuePath + ".homePlmnIdList") && success;
...
bool RestrictedSnssai::operator==(const RestrictedSnssai& rhs) const
{
    ...
    ((!homePlmnIdListIsSet() && !rhs.homePlmnIdListIsSet()) || (homePlmnIdListIsSet() && rhs.homePlmnIdListIsSet() && getHomePlmnIdList() == rhs.getHomePlmnIdList())) &&
    
    
    ((!roamingRestrictionIsSet() && !rhs.roamingRestrictionIsSet()) || (roamingRestrictionIsSet() && rhs.roamingRestrictionIsSet() && isRoamingRestriction() == rhs.isRoamingRestriction()))
...
oai::model::PlmnId RestrictedSnssai::getHomePlmnId() const
{
    return m_HomePlmnId;
}
void RestrictedSnssai::setHomePlmnId(oai::model::PlmnId const& value)
{
    m_HomePlmnId = value;
}
std::vector<oai::model::ExtSnssai> RestrictedSnssai::getSNssaiList() const
{
    return m_SNssaiList;
}
void RestrictedSnssai::setSNssaiList(std::vector<oai::model::ExtSnssai> const& value)
{
    m_SNssaiList = value;
}
std::vector<oai::model::PlmnId> RestrictedSnssai::getHomePlmnIdList() const
{
    return m_HomePlmnIdList;
}
void RestrictedSnssai::setHomePlmnIdList(std::vector<oai::model::PlmnId> const& value)
{
