...
extern asn_TYPE_descriptor_t asn_DEF_Ngap_cn_Type
    __attribute__((weak, alias("asn_DEF_Ngap_cn_Type_3")));
#else
static asn_TYPE_descriptor_t asn_DEF_Ngap_cn_Type_3;
static asn_TYPE_descriptor_t asn_DEF_Ngap_cn_Type;
__attribute__((constructor)) static void asn_DEF_Ngap_cn_Type_3_alias_init(
    void) {
  asn_DEF_Ngap_cn_Type = asn_DEF_Ngap_cn_Type_3;
}
#endif
...
static int asn_validate_Ngap_cn_Type_3(
    const asn_TYPE_descriptor_t* td, const void* sptr,
    asn_app_constraint_failed_f* ctfailcb, void* app_key) {
  if (!sptr) {
    return -1;
  }
  e_Ngap_CNTypeRestrictionsForEquivalentItem__cn_Type value =
      *(e_Ngap_CNTypeRestrictionsForEquivalentItem__cn_Type*) sptr;
  switch (value) {
    case Ngap_CNTypeRestrictionsForEquivalentItem__cn_Type_epc_forbidden:
    case Ngap_CNTypeRestrictionsForEquivalentItem__cn_Type_fiveGC_forbidden:
      return 0;
  }
  return -1;
}
...
static /* Use -fall-defs-global to expose */
    asn_TYPE_descriptor_t asn_DEF_Ngap_cn_Type_3 = {
        ...
        sizeof(asn_DEF_Ngap_cn_Type_tags_3) /
                sizeof(asn_DEF_Ngap_cn_Type_tags_3[0]) -
            1,                       /* 1 */
...
asn_TYPE_member_t asn_MBR_Ngap_CNTypeRestrictionsForEquivalentItem_1[] = {
    {ATF_NOFLAGS,
     0,
     offsetof(struct Ngap_CNTypeRestrictionsForEquivalentItem, plmnIdentity),
    ...
    {ATF_NOFLAGS,
     0,
     offsetof(struct Ngap_CNTypeRestrictionsForEquivalentItem, cn_Type),
    ...
    {ATF_POINTER,
     1,
     offsetof(struct Ngap_CNTypeRestrictionsForEquivalentItem, iE_Extensions),
     (ASN_TAG_CLASS_CONTEXT | (2 << 2)),
     -1, /* IMPLICIT tag at current level */
     &asn_DEF_Ngap_ProtocolExtensionContainer_12929P40,
     0,
     {
#if !defined(ASN_DISABLE_OER_SUPPORT)
         0,
...
asn_SEQUENCE_specifics_t
    asn_SPC_Ngap_CNTypeRestrictionsForEquivalentItem_specs_1 = {
        ...
        asn_MAP_Ngap_CNTypeRestrictionsForEquivalentItem_oms_1, /* Optional
                                                                   members */
        1,
        0, /* Root/Additions */
...
asn_TYPE_descriptor_t asn_DEF_Ngap_CNTypeRestrictionsForEquivalentItem = {
    ...
    sizeof(asn_DEF_Ngap_CNTypeRestrictionsForEquivalentItem_tags_1) /
        sizeof(
            asn_DEF_Ngap_CNTypeRestrictionsForEquivalentItem_tags_1[0]), /* 1 */
    ...
    3, /* Elements count */
    &asn_SPC_Ngap_CNTypeRestrictionsForEquivalentItem_specs_1 /* Additional
                                                                 specs */
};
