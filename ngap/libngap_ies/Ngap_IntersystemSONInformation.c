...
asn_oer_constraints_t asn_OER_type_Ngap_IntersystemSONInformation_constr_1
    CC_NOTUSED = {{0, 0}, -1};
...
asn_TYPE_member_t asn_MBR_Ngap_IntersystemSONInformation_1[] = {
    ...
    {ATF_POINTER,
     0,
     offsetof(struct Ngap_IntersystemSONInformation, choice.choice_Extensions),
     (ASN_TAG_CLASS_CONTEXT | (1 << 2)),
     -1, /* IMPLICIT tag at current level */
     &asn_DEF_Ngap_ProtocolIE_SingleContainer_12877P19,
     0,
     {
#if !defined(ASN_DISABLE_OER_SUPPORT)
         0,
