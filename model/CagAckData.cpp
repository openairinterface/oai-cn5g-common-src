...
bool CagAckData::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "CagAckData" : pathPrefix;
...
oai::model::UeUpdateStatus CagAckData::getUeUpdateStatus() const
{
    return m_UeUpdateStatus;
}
void CagAckData::setUeUpdateStatus(oai::model::UeUpdateStatus const& value)
{
