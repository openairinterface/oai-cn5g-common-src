...
*/
/*
 * _application_data_influenceData_subs_to_notify_post_request_inner.h
 *
 * 
 */

#ifndef _application_data_influenceData_subs_to_notify_post_request_inner_H_
#define _application_data_influenceData_subs_to_notify_post_request_inner_H_
...
/// 
/// </summary>
class  _application_data_influenceData_subs_to_notify_post_request_inner
{
public:
    _application_data_influenceData_subs_to_notify_post_request_inner();
    virtual ~_application_data_influenceData_subs_to_notify_post_request_inner() = default;
    ...
    bool operator==(const _application_data_influenceData_subs_to_notify_post_request_inner& rhs) const;
    bool operator!=(const _application_data_influenceData_subs_to_notify_post_request_inner& rhs) const;

    /////////////////////////////////////////////
    /// _application_data_influenceData_subs_to_notify_post_request_inner members
    ...
    /// </summary>
    std::vector<oai::model::EthFlowDescription> getEthTrafficFilters() const;
    void setEthTrafficFilters(std::vector<oai::model::EthFlowDescription> const& value);
    ...
    /// </summary>
    std::vector<oai::model::FlowInfo> getTrafficFilters() const;
    void setTrafficFilters(std::vector<oai::model::FlowInfo> const& value);
    bool trafficFiltersIsSet() const;
    void unsetTrafficFilters();
    /// <summary>
    /// Identifies the N6 traffic routing requirement.
    /// </summary>
    std::vector<oai::model::RouteToLocation> getTrafficRoutes() const;
    void setTrafficRoutes(std::vector<oai::model::RouteToLocation> const& value);
    ...
    /// </summary>
    std::vector<oai::model::TemporalValidity> getTempValidities() const;
    void setTempValidities(std::vector<oai::model::TemporalValidity> const& value);
    bool tempValiditiesIsSet() const;
    void unsetTempValidities();
    /// <summary>
    /// 
    /// </summary>
    oai::model::NetworkAreaInfo getNwAreaInfo() const;
    void setNwAreaInfo(oai::model::NetworkAreaInfo const& value);
    ...
    /// 
    /// </summary>
    std::vector<oai::model::SubscribedEvent> getSubscribedEvents() const;
    void setSubscribedEvents(std::vector<oai::model::SubscribedEvent> const& value);
    bool subscribedEventsIsSet() const;
    void unsetSubscribedEvents();
    /// <summary>
    /// 
    /// </summary>
    oai::model::DnaiChangeType getDnaiChgType() const;
    void setDnaiChgType(oai::model::DnaiChangeType const& value);
    ...
    friend  void to_json(nlohmann::json& j, const _application_data_influenceData_subs_to_notify_post_request_inner& o);
    friend  void from_json(const nlohmann::json& j, _application_data_influenceData_subs_to_notify_post_request_inner& o);
protected:
    ...
    std::string m_Dnn;
    bool m_DnnIsSet;
    std::vector<oai::model::EthFlowDescription> m_EthTrafficFilters;
    ...
    std::string m_Supi;
    bool m_SupiIsSet;
    std::vector<oai::model::FlowInfo> m_TrafficFilters;
    bool m_TrafficFiltersIsSet;
    std::vector<oai::model::RouteToLocation> m_TrafficRoutes;
    ...
    std::vector<oai::model::TemporalValidity> m_TempValidities;
    bool m_TempValiditiesIsSet;
    oai::model::NetworkAreaInfo m_NwAreaInfo;
    bool m_NwAreaInfoIsSet;
    std::string m_UpPathChgNotifUri;
    bool m_UpPathChgNotifUriIsSet;
    std::vector<std::string> m_Headers;
    bool m_HeadersIsSet;
    std::vector<oai::model::SubscribedEvent> m_SubscribedEvents;
    bool m_SubscribedEventsIsSet;
    oai::model::DnaiChangeType m_DnaiChgType;
...
#endif /* _application_data_influenceData_subs_to_notify_post_request_inner_H_ */
