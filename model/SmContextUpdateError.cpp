...
void SmContextUpdateError::setError(oai::_3gpp::model::ExtProblemDetails const& value)
{
    m_Error = value;
}
...
void SmContextUpdateError::setN1SmMsg(oai::_3gpp::model::RefToBinaryData const& value)
{
    m_N1SmMsg = value;
    m_N1SmMsgIsSet = true;
}
...
void SmContextUpdateError::setN2SmInfo(oai::_3gpp::model::RefToBinaryData const& value)
{
    m_N2SmInfo = value;
...
void SmContextUpdateError::setN2SmInfoType(oai::_3gpp::model::N2SmInfoType const& value)
{
...
void SmContextUpdateError::setUpCnxState(oai::_3gpp::model::UpCnxState const& value)
{
    m_UpCnxState = value;
