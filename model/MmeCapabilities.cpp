...
bool MmeCapabilities::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "MmeCapabilities" : pathPrefix;
...
bool MmeCapabilities::operator==(const MmeCapabilities& rhs) const
{
    ...
    ((!nonIpSupportedIsSet() && !rhs.nonIpSupportedIsSet()) || (nonIpSupportedIsSet() && rhs.nonIpSupportedIsSet() && isNonIpSupported() == rhs.isNonIpSupported())) &&
    
    
    ((!ethernetSupportedIsSet() && !rhs.ethernetSupportedIsSet()) || (ethernetSupportedIsSet() && rhs.ethernetSupportedIsSet() && isEthernetSupported() == rhs.isEthernetSupported())) &&
