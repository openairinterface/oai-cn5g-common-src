...
//------------------------------------------------------------------------------
void UeContextReleaseCommandMsg::setUeNgapIdPair(const unsigned long &amfId,
                                                 const uint32_t &ranId) {
...
//------------------------------------------------------------------------------
bool UeContextReleaseCommandMsg::getUeNgapIdPair(uint64_t &amfId,
                                                 uint32_t &ranId) const {
  if (m_RanUeNgapId.has_value()) {
