...
bool NssfEventSubscriptionCreateData::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "NssfEventSubscriptionCreateData" : pathPrefix;
...
bool NssfEventSubscriptionCreateData::operator==(const NssfEventSubscriptionCreateData& rhs) const
{
    return
...
void NssfEventSubscriptionCreateData::setNfNssaiAvailabilityUri(std::string const& value)
{
    m_NfNssaiAvailabilityUri = value;
}
std::vector<oai::model::Tai> NssfEventSubscriptionCreateData::getTaiList() const
{
    return m_TaiList;
}
void NssfEventSubscriptionCreateData::setTaiList(std::vector<oai::model::Tai> const& value)
{
    m_TaiList = value;
}
oai::model::NssfEventType NssfEventSubscriptionCreateData::getEvent() const
{
    return m_Event;
}
void NssfEventSubscriptionCreateData::setEvent(oai::model::NssfEventType const& value)
{
    m_Event = value;
}
...
std::vector<oai::model::TaiRange> NssfEventSubscriptionCreateData::getTaiRangeList() const
{
    return m_TaiRangeList;
}
void NssfEventSubscriptionCreateData::setTaiRangeList(std::vector<oai::model::TaiRange> const& value)
{
...
std::string NssfEventSubscriptionCreateData::getAmfId() const
{
    return m_AmfId;
}
void NssfEventSubscriptionCreateData::setAmfId(std::string const& value)
{
    m_AmfId = value;
    m_AmfIdIsSet = true;
}
bool NssfEventSubscriptionCreateData::amfIdIsSet() const
{
    return m_AmfIdIsSet;
}
void NssfEventSubscriptionCreateData::unsetAmfId()
{
    m_AmfIdIsSet = false;
}
...
void NssfEventSubscriptionCreateData::setSupportedFeatures(std::string const& value)
{
