...
bool ErrorReport::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "ErrorReport" : pathPrefix;
    ...
    {
        const std::vector<oai::model::PolicyDecisionFailureCode>& value = m_PolDecFailureReports;
        ...
        success = value.validate(msg, currentValuePath + ".polDecFailureReports") && success;
...
bool ErrorReport::operator==(const ErrorReport& rhs) const
{
    ...
    ((!polDecFailureReportsIsSet() && !rhs.polDecFailureReportsIsSet()) || (polDecFailureReportsIsSet() && rhs.polDecFailureReportsIsSet() && getPolDecFailureReports() == rhs.getPolDecFailureReports())) &&
...
oai::model::ProblemDetails ErrorReport::getError() const
{
    return m_Error;
}
void ErrorReport::setError(oai::model::ProblemDetails const& value)
{
    m_Error = value;
    m_ErrorIsSet = true;
}
...
std::vector<oai::model::RuleReport> ErrorReport::getRuleReports() const
{
    return m_RuleReports;
}
void ErrorReport::setRuleReports(std::vector<oai::model::RuleReport> const& value)
{
    m_RuleReports = value;
...
std::vector<oai::model::SessionRuleReport> ErrorReport::getSessRuleReports() const
{
    return m_SessRuleReports;
}
void ErrorReport::setSessRuleReports(std::vector<oai::model::SessionRuleReport> const& value)
{
...
std::vector<oai::model::PolicyDecisionFailureCode> ErrorReport::getPolDecFailureReports() const
{
    return m_PolDecFailureReports;
}
void ErrorReport::setPolDecFailureReports(std::vector<oai::model::PolicyDecisionFailureCode> const& value)
{
...
std::vector<oai::model::InvalidParam> ErrorReport::getInvalidPolicyDecs() const
{
    return m_InvalidPolicyDecs;
}
void ErrorReport::setInvalidPolicyDecs(std::vector<oai::model::InvalidParam> const& value)
{
