...
bool PccRule::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    ...
    if (flowInfosIsSet())
    {
        const std::vector<oai::model::FlowInformation>& value = m_FlowInfos;
        ...
        { // Recursive validation of array elements
            ...
            int i = 0;
            for (const oai::model::FlowInformation& value : value)
            { 
...
std::vector<oai::model::FlowInformation> PccRule::getFlowInfos() const
{
    return m_FlowInfos;
}
void PccRule::setFlowInfos(std::vector<oai::model::FlowInformation> const& value)
{
    m_FlowInfos = value;
...
oai::model::AfSigProtocol PccRule::getAfSigProtocol() const
{
    return m_AfSigProtocol;
}
void PccRule::setAfSigProtocol(oai::model::AfSigProtocol const& value)
{
...
oai::model::TscaiInputContainer PccRule::getTscaiInputDl() const
{
    return m_TscaiInputDl;
}
void PccRule::setTscaiInputDl(oai::model::TscaiInputContainer const& value)
{
...
oai::model::TscaiInputContainer PccRule::getTscaiInputUl() const
{
    return m_TscaiInputUl;
}
void PccRule::setTscaiInputUl(oai::model::TscaiInputContainer const& value)
{
...
oai::model::DownlinkDataNotificationControl PccRule::getDdNotifCtrl() const
{
    return m_DdNotifCtrl;
}
void PccRule::setDdNotifCtrl(oai::model::DownlinkDataNotificationControl const& value)
{
    m_DdNotifCtrl = value;
...
oai::model::DownlinkDataNotificationControlRm PccRule::getDdNotifCtrl2() const
{
    return m_DdNotifCtrl2;
}
void PccRule::setDdNotifCtrl2(oai::model::DownlinkDataNotificationControlRm const& value)
{
