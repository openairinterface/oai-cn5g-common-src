...
void PduSessionCreateError::setError(oai::_3gpp::model::ProblemDetails const& value)
{
    m_Error = value;
}
...
oai::_3gpp::model::RefToBinaryData PduSessionCreateError::getN1SmInfoToUe() const
{
    return m_N1SmInfoToUe;
}
void PduSessionCreateError::setN1SmInfoToUe(oai::_3gpp::model::RefToBinaryData const& value)
{
