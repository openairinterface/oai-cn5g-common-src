...
oai::model::Arp VplmnQos::getArp() const
{
    return m_Arp;
}
void VplmnQos::setArp(oai::model::Arp const& value)
{
    m_Arp = value;
    m_ArpIsSet = true;
}
...
oai::model::Ambr VplmnQos::getSessionAmbr() const
{
    return m_SessionAmbr;
}
void VplmnQos::setSessionAmbr(oai::model::Ambr const& value)
{
    m_SessionAmbr = value;
