...
ChargingInformation::ChargingInformation()
{
    ...
    m_SecondaryChfAddressIsSet = false;
    m_PrimaryChfSetId = "";
...
bool ChargingInformation::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "ChargingInformation" : pathPrefix;
...
bool ChargingInformation::operator==(const ChargingInformation& rhs) const
{
    ...
    ((!secondaryChfAddressIsSet() && !rhs.secondaryChfAddressIsSet()) || (secondaryChfAddressIsSet() && rhs.secondaryChfAddressIsSet() && getSecondaryChfAddress() == rhs.getSecondaryChfAddress())) &&
    
    
    ((!primaryChfSetIdIsSet() && !rhs.primaryChfSetIdIsSet()) || (primaryChfSetIdIsSet() && rhs.primaryChfSetIdIsSet() && getPrimaryChfSetId() == rhs.getPrimaryChfSetId())) &&
    
    
    ((!primaryChfInstanceIdIsSet() && !rhs.primaryChfInstanceIdIsSet()) || (primaryChfInstanceIdIsSet() && rhs.primaryChfInstanceIdIsSet() && getPrimaryChfInstanceId() == rhs.getPrimaryChfInstanceId())) &&
    
    
    ((!secondaryChfSetIdIsSet() && !rhs.secondaryChfSetIdIsSet()) || (secondaryChfSetIdIsSet() && rhs.secondaryChfSetIdIsSet() && getSecondaryChfSetId() == rhs.getSecondaryChfSetId())) &&
    
    
    ((!secondaryChfInstanceIdIsSet() && !rhs.secondaryChfInstanceIdIsSet()) || (secondaryChfInstanceIdIsSet() && rhs.secondaryChfInstanceIdIsSet() && getSecondaryChfInstanceId() == rhs.getSecondaryChfInstanceId()))
...
void from_json(const nlohmann::json& j, ChargingInformation& o)
{
    ...
    if(j.find("secondaryChfAddress") != j.end())
    {
        j.at("secondaryChfAddress").get_to(o.m_SecondaryChfAddress);
        o.m_SecondaryChfAddressIsSet = true;
    } 
...
void ChargingInformation::setSecondaryChfAddress(std::string const& value)
{
    ...
    m_SecondaryChfAddressIsSet = true;
}
bool ChargingInformation::secondaryChfAddressIsSet() const
{
    return m_SecondaryChfAddressIsSet;
}
void ChargingInformation::unsetSecondaryChfAddress()
{
    m_SecondaryChfAddressIsSet = false;
}
