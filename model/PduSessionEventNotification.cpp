...
bool PduSessionEventNotification::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "PduSessionEventNotification" : pathPrefix;
...
bool PduSessionEventNotification::operator==(const PduSessionEventNotification& rhs) const
{
    return
...
oai::_3gpp::model::AfEventNotification PduSessionEventNotification::getEvNotif() const
{
    return m_EvNotif;
}
void PduSessionEventNotification::setEvNotif(oai::_3gpp::model::AfEventNotification const& value)
{
    m_EvNotif = value;
}
...
oai::_3gpp::model::Ipv6Addr PduSessionEventNotification::getUeIpv6() const
{
    return m_UeIpv6;
}
void PduSessionEventNotification::setUeIpv6(oai::_3gpp::model::Ipv6Addr const& value)
{
    m_UeIpv6 = value;
    m_UeIpv6IsSet = true;
}
...
oai::_3gpp::model::PduSessionStatus PduSessionEventNotification::getStatus() const
{
    return m_Status;
}
void PduSessionEventNotification::setStatus(oai::_3gpp::model::PduSessionStatus const& value)
{
    m_Status = value;
    m_StatusIsSet = true;
}
...
oai::_3gpp::model::PcfAddressingInfo PduSessionEventNotification::getPcfInfo() const
{
    return m_PcfInfo;
}
void PduSessionEventNotification::setPcfInfo(oai::_3gpp::model::PcfAddressingInfo const& value)
{
    m_PcfInfo = value;
    m_PcfInfoIsSet = true;
}
...
oai::_3gpp::model::Snssai PduSessionEventNotification::getSnssai() const
{
    return m_Snssai;
}
void PduSessionEventNotification::setSnssai(oai::_3gpp::model::Snssai const& value)
{
    m_Snssai = value;
    m_SnssaiIsSet = true;
}
