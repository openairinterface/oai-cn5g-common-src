...
RequestedRuleDataType_anyOf::eRequestedRuleDataType_anyOf RequestedRuleDataType::getEnumValue() const
{
    return m_value.getValue();
}

void RequestedRuleDataType::setEnumValue(RequestedRuleDataType_anyOf::eRequestedRuleDataType_anyOf  value)
{
