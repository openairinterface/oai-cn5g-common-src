...
public:
    ...
    /// 
    /// </summary>
    oai::model::ScheduledCommunicationTime getScheduledCommunicationTime() const;
    void setScheduledCommunicationTime(oai::model::ScheduledCommunicationTime const& value);
    ...
    /// </summary>
    std::vector<oai::model::LocationArea> getExpectedUmts() const;
    void setExpectedUmts(std::vector<oai::model::LocationArea> const& value);
...
protected:
    ...
    oai::model::ScheduledCommunicationTime m_ScheduledCommunicationTime;
    bool m_ScheduledCommunicationTimeIsSet;
    std::vector<oai::model::LocationArea> m_ExpectedUmts;
