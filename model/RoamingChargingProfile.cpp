...
std::vector<oai::_3gpp::model::Trigger> RoamingChargingProfile::getTriggers() const
{
    return m_Triggers;
}
void RoamingChargingProfile::setTriggers(std::vector<oai::_3gpp::model::Trigger> const& value)
{
    m_Triggers = value;
...
oai::_3gpp::model::PartialRecordMethod RoamingChargingProfile::getPartialRecordMethod() const
{
    return m_PartialRecordMethod;
}
void RoamingChargingProfile::setPartialRecordMethod(oai::_3gpp::model::PartialRecordMethod const& value)
{
