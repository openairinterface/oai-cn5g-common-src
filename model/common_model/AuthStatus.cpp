...
bool AuthStatus::validate(std::stringstream &msg,
...
AuthStatus_anyOf AuthStatus::getValue() const { return m_value; }

void AuthStatus::setValue(AuthStatus_anyOf value) { m_value = value; }
