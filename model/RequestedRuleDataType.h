...
public:
    ...
    RequestedRuleDataType_anyOf::eRequestedRuleDataType_anyOf getEnumValue() const;
    void setEnumValue(RequestedRuleDataType_anyOf::eRequestedRuleDataType_anyOf value);
