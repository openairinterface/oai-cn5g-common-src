...
public:
    ...
    /// </summary>
    std::map<std::string, oai::_3gpp::model::LimitIdToMonitoringKey> getRefUmDataLimitIds() const;
    void setRefUmDataLimitIds(std::map<std::string, oai::_3gpp::model::LimitIdToMonitoringKey> const& value);
...
protected:
    ...
    bool m_ChfInfoIsSet;
    std::map<std::string, oai::_3gpp::model::LimitIdToMonitoringKey> m_RefUmDataLimitIds;
