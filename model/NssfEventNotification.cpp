...
std::vector<oai::model::AuthorizedNssaiAvailabilityData> NssfEventNotification::getAuthorizedNssaiAvailabilityData() const
{
    return m_AuthorizedNssaiAvailabilityData;
}
void NssfEventNotification::setAuthorizedNssaiAvailabilityData(std::vector<oai::model::AuthorizedNssaiAvailabilityData> const& value)
{
