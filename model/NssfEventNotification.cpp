...
bool NssfEventNotification::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "NssfEventNotification" : pathPrefix;
...
std::vector<oai::_3gpp::model::AuthorizedNssaiAvailabilityData> NssfEventNotification::getAuthorizedNssaiAvailabilityData() const
{
    return m_AuthorizedNssaiAvailabilityData;
}
void NssfEventNotification::setAuthorizedNssaiAvailabilityData(std::vector<oai::_3gpp::model::AuthorizedNssaiAvailabilityData> const& value)
{
