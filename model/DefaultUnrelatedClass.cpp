...
bool DefaultUnrelatedClass::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "DefaultUnrelatedClass" : pathPrefix;
...
std::vector<oai::_3gpp::model::GeographicArea> DefaultUnrelatedClass::getAllowedGeographicArea() const
{
    return m_AllowedGeographicArea;
}
void DefaultUnrelatedClass::setAllowedGeographicArea(std::vector<oai::_3gpp::model::GeographicArea> const& value)
{
...
oai::_3gpp::model::PrivacyCheckRelatedAction DefaultUnrelatedClass::getPrivacyCheckRelatedAction() const
{
    return m_PrivacyCheckRelatedAction;
}
void DefaultUnrelatedClass::setPrivacyCheckRelatedAction(oai::_3gpp::model::PrivacyCheckRelatedAction const& value)
{
...
void DefaultUnrelatedClass::setCodeWordInd(oai::_3gpp::model::CodeWordInd const& value)
{
    m_CodeWordInd = value;
...
oai::_3gpp::model::ValidTimePeriod DefaultUnrelatedClass::getValidTimePeriod() const
{
    return m_ValidTimePeriod;
}
void DefaultUnrelatedClass::setValidTimePeriod(oai::_3gpp::model::ValidTimePeriod const& value)
{
...
std::vector<oai::_3gpp::model::std::string> DefaultUnrelatedClass::getCodeWordList() const
{
    return m_CodeWordList;
}
void DefaultUnrelatedClass::setCodeWordList(std::vector<oai::_3gpp::model::std::string> const& value)
{
