...
bool AccessRightStatus_anyOf::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "AccessRightStatus_anyOf" : pathPrefix;

    
    if (m_value == AccessRightStatus_anyOf::eAccessRightStatus_anyOf::INVALID_VALUE_OPENAPI_GENERATED)
    {
        success = false;
...
bool AccessRightStatus_anyOf::operator==(const AccessRightStatus_anyOf& rhs) const
{
    return
...
void to_json(nlohmann::json& j, const AccessRightStatus_anyOf& o)
{
    ...
    switch (o.getValue())
    {
        case AccessRightStatus_anyOf::eAccessRightStatus_anyOf::INVALID_VALUE_OPENAPI_GENERATED:
...
void from_json(const nlohmann::json& j, AccessRightStatus_anyOf& o)
{
    ...
    if (s == "FULLY_ALLOWED") {
     o.setValue(AccessRightStatus_anyOf::eAccessRightStatus_anyOf::FULLY_ALLOWED);
    } 
    else if (s == "PREVIEW_ALLOWED") {
     o.setValue(AccessRightStatus_anyOf::eAccessRightStatus_anyOf::PREVIEW_ALLOWED);
    } 
...
AccessRightStatus_anyOf::eAccessRightStatus_anyOf AccessRightStatus_anyOf::getValue() const
{
    return m_value;
}
void AccessRightStatus_anyOf::setValue(AccessRightStatus_anyOf::eAccessRightStatus_anyOf value)
{
    m_value = value;
}
