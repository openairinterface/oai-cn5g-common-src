...
public:
    ...
    /// 
    /// </summary>
    oai::model::AmfEventSubscription getSubscription() const;
    void setSubscription(oai::model::AmfEventSubscription const& value);
    /// <summary>
    /// 
    /// </summary>
    std::vector<oai::model::AmfEventReport> getReportList() const;
    void setReportList(std::vector<oai::model::AmfEventReport> const& value);
    bool reportListIsSet() const;
    void unsetReportList();

    friend  void to_json(nlohmann::json& j, const AmfUpdatedEventSubscription& o);
    friend  void from_json(const nlohmann::json& j, AmfUpdatedEventSubscription& o);
protected:
    oai::model::AmfEventSubscription m_Subscription;

    std::vector<oai::model::AmfEventReport> m_ReportList;
