...
asn_TYPE_member_t asn_MBR_Ngap_CriticalityDiagnostics_IE_Item_1[] = {
    {ATF_NOFLAGS,
     0,
     offsetof(struct Ngap_CriticalityDiagnostics_IE_Item, iECriticality),
    ...
    {ATF_NOFLAGS,
     0,
     offsetof(struct Ngap_CriticalityDiagnostics_IE_Item, iE_ID),
    ...
    {ATF_NOFLAGS,
     0,
     offsetof(struct Ngap_CriticalityDiagnostics_IE_Item, typeOfError),
    ...
    {ATF_POINTER,
     ...
     -1, /* IMPLICIT tag at current level */
     &asn_DEF_Ngap_ProtocolExtensionContainer_12929P49,
     0,
     {
#if !defined(ASN_DISABLE_OER_SUPPORT)
         0,
