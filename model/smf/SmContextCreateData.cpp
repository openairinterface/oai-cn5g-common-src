...
void to_json(nlohmann::json &j, const SmContextCreateData &o) {
  ...
  if (o.maPduIndicationIsSet())
    j["maPduIndication"] = o.m_MaPduIndication;
  if (o.n2SmInfoIsSet())
    j["n2SmInfo"] = o.m_N2SmInfo;
  if (o.smContextRefIsSet())
...
bool SmContextCreateData::supiIsSet() const { return m_SupiIsSet; }
void SmContextCreateData::unsetSupi() { m_SupiIsSet = false; }
...
std::string SmContextCreateData::getPei() const { return m_Pei; }
void SmContextCreateData::setPei(std::string const &value) {
  m_Pei = value;
  m_PeiIsSet = true;
}
bool SmContextCreateData::peiIsSet() const { return m_PeiIsSet; }
void SmContextCreateData::unsetPei() { m_PeiIsSet = false; }
std::string SmContextCreateData::getGpsi() const { return m_Gpsi; }
void SmContextCreateData::setGpsi(std::string const &value) {
  m_Gpsi = value;
  m_GpsiIsSet = true;
}
bool SmContextCreateData::gpsiIsSet() const { return m_GpsiIsSet; }
void SmContextCreateData::unsetGpsi() { m_GpsiIsSet = false; }
uint8_t SmContextCreateData::getPduSessionId() const { return m_PduSessionId; }
...
void SmContextCreateData::unsetPduSessionId() { m_PduSessionIdIsSet = false; }
std::string SmContextCreateData::getDnn() const { return m_Dnn; }
void SmContextCreateData::setDnn(std::string const &value) {
  m_Dnn = value;
  m_DnnIsSet = true;
}
bool SmContextCreateData::dnnIsSet() const { return m_DnnIsSet; }
void SmContextCreateData::unsetDnn() { m_DnnIsSet = false; }
...
bool SmContextCreateData::sNssaiIsSet() const { return m_SNssaiIsSet; }
void SmContextCreateData::unsetSNssai() { m_SNssaiIsSet = false; }
...
void SmContextCreateData::unsetHplmnSnssai() { m_HplmnSnssaiIsSet = false; }
...
Guami SmContextCreateData::getGuami() const { return m_Guami; }
void SmContextCreateData::setGuami(Guami const &value) {
  m_Guami = value;
  m_GuamiIsSet = true;
}
bool SmContextCreateData::guamiIsSet() const { return m_GuamiIsSet; }
void SmContextCreateData::unsetGuami() { m_GuamiIsSet = false; }
...
void SmContextCreateData::unsetServiceName() { m_ServiceNameIsSet = false; }
...
void SmContextCreateData::unsetRequestType() { m_RequestTypeIsSet = false; }
RefToBinaryData SmContextCreateData::getN1SmMsg() const { return m_N1SmMsg; }
void SmContextCreateData::setN1SmMsg(RefToBinaryData const &value) {
  m_N1SmMsg = value;
  m_N1SmMsgIsSet = true;
}
bool SmContextCreateData::n1SmMsgIsSet() const { return m_N1SmMsgIsSet; }
void SmContextCreateData::unsetN1SmMsg() { m_N1SmMsgIsSet = false; }
std::string SmContextCreateData::getAnType() const { return m_AnType; }
...
void SmContextCreateData::unsetSecondAnType() { m_SecondAnTypeIsSet = false; }
std::string SmContextCreateData::getRatType() const { return m_RatType; }
void SmContextCreateData::setRatType(std::string const &value) {
  m_RatType = value;
  m_RatTypeIsSet = true;
}
bool SmContextCreateData::ratTypeIsSet() const { return m_RatTypeIsSet; }
void SmContextCreateData::unsetRatType() { m_RatTypeIsSet = false; }
...
UserLocation SmContextCreateData::getUeLocation() const { return m_UeLocation; }
void SmContextCreateData::setUeLocation(UserLocation const &value) {
  m_UeLocation = value;
  m_UeLocationIsSet = true;
}
bool SmContextCreateData::ueLocationIsSet() const { return m_UeLocationIsSet; }
void SmContextCreateData::unsetUeLocation() { m_UeLocationIsSet = false; }
std::string SmContextCreateData::getUeTimeZone() const { return m_UeTimeZone; }
void SmContextCreateData::setUeTimeZone(std::string const &value) {
  m_UeTimeZone = value;
  m_UeTimeZoneIsSet = true;
}
bool SmContextCreateData::ueTimeZoneIsSet() const { return m_UeTimeZoneIsSet; }
void SmContextCreateData::unsetUeTimeZone() { m_UeTimeZoneIsSet = false; }
...
void SmContextCreateData::unsetAddUeLocation() { m_AddUeLocationIsSet = false; }
...
std::string SmContextCreateData::getHSmfUri() const { return m_HSmfUri; }
void SmContextCreateData::setHSmfUri(std::string const &value) {
  m_HSmfUri = value;
  m_HSmfUriIsSet = true;
}
bool SmContextCreateData::hSmfUriIsSet() const { return m_HSmfUriIsSet; }
void SmContextCreateData::unsetHSmfUri() { m_HSmfUriIsSet = false; }
...
std::string SmContextCreateData::getHoState() const { return m_HoState; }
void SmContextCreateData::setHoState(std::string const &value) {
  m_HoState = value;
  m_HoStateIsSet = true;
}
bool SmContextCreateData::hoStateIsSet() const { return m_HoStateIsSet; }
void SmContextCreateData::unsetHoState() { m_HoStateIsSet = false; }
std::string SmContextCreateData::getPcfId() const { return m_PcfId; }
void SmContextCreateData::setPcfId(std::string const &value) {
  m_PcfId = value;
  m_PcfIdIsSet = true;
}
bool SmContextCreateData::pcfIdIsSet() const { return m_PcfIdIsSet; }
void SmContextCreateData::unsetPcfId() { m_PcfIdIsSet = false; }
std::string SmContextCreateData::getNrfUri() const { return m_NrfUri; }
void SmContextCreateData::setNrfUri(std::string const &value) {
  m_NrfUri = value;
  m_NrfUriIsSet = true;
}
bool SmContextCreateData::nrfUriIsSet() const { return m_NrfUriIsSet; }
void SmContextCreateData::unsetNrfUri() { m_NrfUriIsSet = false; }
...
std::string SmContextCreateData::getSelMode() const { return m_SelMode; }
void SmContextCreateData::setSelMode(std::string const &value) {
  m_SelMode = value;
  m_SelModeIsSet = true;
}
bool SmContextCreateData::selModeIsSet() const { return m_SelModeIsSet; }
void SmContextCreateData::unsetSelMode() { m_SelModeIsSet = false; }
...
void SmContextCreateData::unsetBackupAmfInfo() { m_BackupAmfInfoIsSet = false; }
TraceData SmContextCreateData::getTraceData() const { return m_TraceData; }
void SmContextCreateData::setTraceData(TraceData const &value) {
  m_TraceData = value;
  m_TraceDataIsSet = true;
}
bool SmContextCreateData::traceDataIsSet() const { return m_TraceDataIsSet; }
void SmContextCreateData::unsetTraceData() { m_TraceDataIsSet = false; }
std::string SmContextCreateData::getUdmGroupId() const { return m_UdmGroupId; }
void SmContextCreateData::setUdmGroupId(std::string const &value) {
  m_UdmGroupId = value;
  m_UdmGroupIdIsSet = true;
}
bool SmContextCreateData::udmGroupIdIsSet() const { return m_UdmGroupIdIsSet; }
void SmContextCreateData::unsetUdmGroupId() { m_UdmGroupIdIsSet = false; }
...
NgRanTargetId SmContextCreateData::getTargetId() const { return m_TargetId; }
void SmContextCreateData::setTargetId(NgRanTargetId const &value) {
  m_TargetId = value;
  m_TargetIdIsSet = true;
}
bool SmContextCreateData::targetIdIsSet() const { return m_TargetIdIsSet; }
void SmContextCreateData::unsetTargetId() { m_TargetIdIsSet = false; }
...
bool SmContextCreateData::isCpCiotEnabled() const { return m_CpCiotEnabled; }
...
void SmContextCreateData::unsetCpCiotEnabled() { m_CpCiotEnabledIsSet = false; }
bool SmContextCreateData::isInvokeNef() const { return m_InvokeNef; }
void SmContextCreateData::setInvokeNef(bool const value) {
  m_InvokeNef = value;
  m_InvokeNefIsSet = true;
}
bool SmContextCreateData::invokeNefIsSet() const { return m_InvokeNefIsSet; }
void SmContextCreateData::unsetInvokeNef() { m_InvokeNefIsSet = false; }
...
RefToBinaryData SmContextCreateData::getN2SmInfo() const { return m_N2SmInfo; }
void SmContextCreateData::setN2SmInfo(RefToBinaryData const &value) {
  m_N2SmInfo = value;
  m_N2SmInfoIsSet = true;
}
bool SmContextCreateData::n2SmInfoIsSet() const { return m_N2SmInfoIsSet; }
void SmContextCreateData::unsetN2SmInfo() { m_N2SmInfoIsSet = false; }
...
void SmContextCreateData::unsetSmContextRef() { m_SmContextRefIsSet = false; }
