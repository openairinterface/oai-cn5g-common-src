...
bool EutraLocationRm::validate(std::stringstream &msg,
...
oai::model::common::Tai EutraLocationRm::getTai() const { return m_Tai; }
...
oai::model::common::Ecgi EutraLocationRm::getEcgi() const { return m_Ecgi; }
