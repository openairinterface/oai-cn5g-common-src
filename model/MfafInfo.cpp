...
std::vector<oai::model::NFType> MfafInfo::getServingNfTypeList() const
{
    return m_ServingNfTypeList;
}
void MfafInfo::setServingNfTypeList(std::vector<oai::model::NFType> const& value)
{
...
std::vector<oai::model::Tai> MfafInfo::getTaiList() const
{
    return m_TaiList;
}
void MfafInfo::setTaiList(std::vector<oai::model::Tai> const& value)
{
    m_TaiList = value;
    m_TaiListIsSet = true;
}
...
std::vector<oai::model::TaiRange> MfafInfo::getTaiRangeList() const
{
    return m_TaiRangeList;
}
void MfafInfo::setTaiRangeList(std::vector<oai::model::TaiRange> const& value)
{
