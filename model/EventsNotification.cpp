...
std::vector<oai::_3gpp::model::AppDetectionReport> EventsNotification::getAdReports() const
{
    return m_AdReports;
}
void EventsNotification::setAdReports(std::vector<oai::_3gpp::model::AppDetectionReport> const& value)
{
    m_AdReports = value;
...
void EventsNotification::setAccessType(oai::_3gpp::model::AccessType const& value)
{
    m_AccessType = value;
...
oai::_3gpp::model::AdditionalAccessInfo EventsNotification::getAddAccessInfo() const
{
    return m_AddAccessInfo;
}
void EventsNotification::setAddAccessInfo(oai::_3gpp::model::AdditionalAccessInfo const& value)
{
...
oai::_3gpp::model::AdditionalAccessInfo EventsNotification::getRelAccessInfo() const
{
    return m_RelAccessInfo;
}
void EventsNotification::setRelAccessInfo(oai::_3gpp::model::AdditionalAccessInfo const& value)
{
...
oai::_3gpp::model::AccNetChargingAddress EventsNotification::getAnChargAddr() const
{
    return m_AnChargAddr;
}
void EventsNotification::setAnChargAddr(oai::_3gpp::model::AccNetChargingAddress const& value)
{
    m_AnChargAddr = value;
...
std::vector<oai::_3gpp::model::AccessNetChargingIdentifier> EventsNotification::getAnChargIds() const
{
    return m_AnChargIds;
}
void EventsNotification::setAnChargIds(std::vector<oai::_3gpp::model::AccessNetChargingIdentifier> const& value)
{
    m_AnChargIds = value;
...
void EventsNotification::setAnGwAddr(oai::_3gpp::model::AnGwAddress const& value)
{
    m_AnGwAddr = value;
...
std::vector<oai::_3gpp::model::AfEventNotification> EventsNotification::getEvNotifs() const
{
    return m_EvNotifs;
}
void EventsNotification::setEvNotifs(std::vector<oai::_3gpp::model::AfEventNotification> const& value)
{
    m_EvNotifs = value;
}
std::vector<oai::_3gpp::model::ResourcesAllocationInfo> EventsNotification::getFailedResourcAllocReports() const
{
    return m_FailedResourcAllocReports;
}
void EventsNotification::setFailedResourcAllocReports(std::vector<oai::_3gpp::model::ResourcesAllocationInfo> const& value)
{
...
std::vector<oai::_3gpp::model::ResourcesAllocationInfo> EventsNotification::getSuccResourcAllocReports() const
{
    return m_SuccResourcAllocReports;
}
void EventsNotification::setSuccResourcAllocReports(std::vector<oai::_3gpp::model::ResourcesAllocationInfo> const& value)
{
...
oai::_3gpp::model::NetLocAccessSupport EventsNotification::getNoNetLocSupp() const
{
    return m_NoNetLocSupp;
}
void EventsNotification::setNoNetLocSupp(oai::_3gpp::model::NetLocAccessSupport const& value)
{
...
std::vector<oai::_3gpp::model::OutOfCreditInformation> EventsNotification::getOutOfCredReports() const
{
    return m_OutOfCredReports;
}
void EventsNotification::setOutOfCredReports(std::vector<oai::_3gpp::model::OutOfCreditInformation> const& value)
{
...
std::vector<oai::_3gpp::model::QosNotificationControlInfo> EventsNotification::getQncReports() const
{
    return m_QncReports;
}
void EventsNotification::setQncReports(std::vector<oai::_3gpp::model::QosNotificationControlInfo> const& value)
{
    m_QncReports = value;
...
std::vector<oai::_3gpp::model::QosMonitoringReport> EventsNotification::getQosMonReports() const
{
    return m_QosMonReports;
}
void EventsNotification::setQosMonReports(std::vector<oai::_3gpp::model::QosMonitoringReport> const& value)
{
...
std::vector<oai::_3gpp::model::RanNasRelCause> EventsNotification::getRanNasRelCauses() const
{
    return m_RanNasRelCauses;
}
void EventsNotification::setRanNasRelCauses(std::vector<oai::_3gpp::model::RanNasRelCause> const& value)
{
...
oai::_3gpp::model::SatelliteBackhaulCategory EventsNotification::getSatBackhaulCategory() const
{
    return m_SatBackhaulCategory;
}
void EventsNotification::setSatBackhaulCategory(oai::_3gpp::model::SatelliteBackhaulCategory const& value)
{
...
void EventsNotification::setUeLoc(oai::_3gpp::model::UserLocation const& value)
{
    m_UeLoc = value;
    m_UeLocIsSet = true;
}
...
void EventsNotification::setUsgRep(oai::_3gpp::model::AccumulatedUsage const& value)
{
    m_UsgRep = value;
    m_UsgRepIsSet = true;
}
...
oai::_3gpp::model::BridgeManagementContainer EventsNotification::getTsnBridgeManCont() const
{
    return m_TsnBridgeManCont;
}
void EventsNotification::setTsnBridgeManCont(oai::_3gpp::model::BridgeManagementContainer const& value)
{
...
oai::_3gpp::model::PortManagementContainer EventsNotification::getTsnPortManContDstt() const
{
    return m_TsnPortManContDstt;
}
void EventsNotification::setTsnPortManContDstt(oai::_3gpp::model::PortManagementContainer const& value)
{
...
std::vector<oai::_3gpp::model::PortManagementContainer> EventsNotification::getTsnPortManContNwtts() const
{
    return m_TsnPortManContNwtts;
}
void EventsNotification::setTsnPortManContNwtts(std::vector<oai::_3gpp::model::PortManagementContainer> const& value)
{
