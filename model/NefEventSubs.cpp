...
oai::_3gpp::model::NefEvent NefEventSubs::getEvent() const
{
    return m_Event;
}
void NefEventSubs::setEvent(oai::_3gpp::model::NefEvent const& value)
{
    m_Event = value;
}
oai::_3gpp::model::NefEventFilter NefEventSubs::getEventFilter() const
{
    return m_EventFilter;
}
void NefEventSubs::setEventFilter(oai::_3gpp::model::NefEventFilter const& value)
{
    m_EventFilter = value;
