...
bool SmPolicyDnnData::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "SmPolicyDnnData" : pathPrefix;
    ...
    {
        const std::map<std::string, oai::_3gpp::model::LimitIdToMonitoringKey>& value = m_RefUmDataLimitIds;
    ...
    if (praInfosIsSet())
    {
        const std::map<std::string, oai::_3gpp::model::PresenceInfo>& value = m_PraInfos;
    ...
    if (bdtRefIdsIsSet())
    {
        const std::map<std::string, oai::_3gpp::model::std::string>& value = m_BdtRefIds;
...
bool SmPolicyDnnData::operator==(const SmPolicyDnnData& rhs) const
{
    ...
    ((!allowedServicesIsSet() && !rhs.allowedServicesIsSet()) || (allowedServicesIsSet() && rhs.allowedServicesIsSet() && getAllowedServices() == rhs.getAllowedServices())) &&
    
    
    ((!subscCatsIsSet() && !rhs.subscCatsIsSet()) || (subscCatsIsSet() && rhs.subscCatsIsSet() && getSubscCats() == rhs.getSubscCats())) &&
    
    
    ((!gbrUlIsSet() && !rhs.gbrUlIsSet()) || (gbrUlIsSet() && rhs.gbrUlIsSet() && getGbrUl() == rhs.getGbrUl())) &&
    
    
    ((!gbrDlIsSet() && !rhs.gbrDlIsSet()) || (gbrDlIsSet() && rhs.gbrDlIsSet() && getGbrDl() == rhs.getGbrDl())) &&
    
    
    ((!adcSupportIsSet() && !rhs.adcSupportIsSet()) || (adcSupportIsSet() && rhs.adcSupportIsSet() && isAdcSupport() == rhs.isAdcSupport())) &&
    
    
    ((!subscSpendingLimitsIsSet() && !rhs.subscSpendingLimitsIsSet()) || (subscSpendingLimitsIsSet() && rhs.subscSpendingLimitsIsSet() && isSubscSpendingLimits() == rhs.isSubscSpendingLimits())) &&
    ...
    ((!refUmDataLimitIdsIsSet() && !rhs.refUmDataLimitIdsIsSet()) || (refUmDataLimitIdsIsSet() && rhs.refUmDataLimitIdsIsSet() && getRefUmDataLimitIds() == rhs.getRefUmDataLimitIds())) &&
    ...
    ((!imsSignallingPrioIsSet() && !rhs.imsSignallingPrioIsSet()) || (imsSignallingPrioIsSet() && rhs.imsSignallingPrioIsSet() && isImsSignallingPrio() == rhs.isImsSignallingPrio())) &&
    
    
    ((!mpsPriorityLevelIsSet() && !rhs.mpsPriorityLevelIsSet()) || (mpsPriorityLevelIsSet() && rhs.mpsPriorityLevelIsSet() && getMpsPriorityLevel() == rhs.getMpsPriorityLevel())) &&
    
    
    ((!mcsPriorityLevelIsSet() && !rhs.mcsPriorityLevelIsSet()) || (mcsPriorityLevelIsSet() && rhs.mcsPriorityLevelIsSet() && getMcsPriorityLevel() == rhs.getMcsPriorityLevel())) &&
    
    
    ((!praInfosIsSet() && !rhs.praInfosIsSet()) || (praInfosIsSet() && rhs.praInfosIsSet() && getPraInfos() == rhs.getPraInfos())) &&
    
    
    ((!bdtRefIdsIsSet() && !rhs.bdtRefIdsIsSet()) || (bdtRefIdsIsSet() && rhs.bdtRefIdsIsSet() && getBdtRefIds() == rhs.getBdtRefIds())) &&
    
    
    ((!locRoutNotAllowedIsSet() && !rhs.locRoutNotAllowedIsSet()) || (locRoutNotAllowedIsSet() && rhs.locRoutNotAllowedIsSet() && isLocRoutNotAllowed() == rhs.isLocRoutNotAllowed()))
...
void SmPolicyDnnData::setAllowedServices(std::vector<std::string> const& value)
{
...
void SmPolicyDnnData::setChfInfo(oai::_3gpp::model::ChargingInformation const& value)
{
    m_ChfInfo = value;
    m_ChfInfoIsSet = true;
}
...
std::map<std::string, oai::_3gpp::model::LimitIdToMonitoringKey> SmPolicyDnnData::getRefUmDataLimitIds() const
{
    return m_RefUmDataLimitIds;
}
void SmPolicyDnnData::setRefUmDataLimitIds(std::map<std::string, oai::_3gpp::model::LimitIdToMonitoringKey> const& value)
{
...
std::map<std::string, oai::_3gpp::model::PresenceInfo> SmPolicyDnnData::getPraInfos() const
{
    return m_PraInfos;
}
void SmPolicyDnnData::setPraInfos(std::map<std::string, oai::_3gpp::model::PresenceInfo> const& value)
{
    m_PraInfos = value;
...
std::map<std::string, oai::_3gpp::model::std::string> SmPolicyDnnData::getBdtRefIds() const
{
    return m_BdtRefIds;
}
void SmPolicyDnnData::setBdtRefIds(std::map<std::string, oai::_3gpp::model::std::string> const& value)
{
    m_BdtRefIds = value;
