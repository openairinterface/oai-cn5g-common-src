...
public:
    ...
    /// 
    /// </summary>
    std::vector<oai::model::SupportedNssaiAvailabilityData> getSupportedNssaiAvailabilityData() const;
    void setSupportedNssaiAvailabilityData(std::vector<oai::model::SupportedNssaiAvailabilityData> const& value);
    /// <summary>
...
protected:
    std::vector<oai::model::SupportedNssaiAvailabilityData> m_SupportedNssaiAvailabilityData;
