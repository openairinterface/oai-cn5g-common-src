...
public:
    ...
    /// 
    /// </summary>
    oai::model::ScpDomainRoutingInformation getRoutingInfo() const;
    void setRoutingInfo(oai::model::ScpDomainRoutingInformation const& value);
    /// <summary>
    /// 
    /// </summary>
    ...
    friend  void to_json(nlohmann::json& j, const ScpDomainRoutingInfoNotification& o);
    friend  void from_json(const nlohmann::json& j, ScpDomainRoutingInfoNotification& o);
protected:
    oai::model::ScpDomainRoutingInformation m_RoutingInfo;
