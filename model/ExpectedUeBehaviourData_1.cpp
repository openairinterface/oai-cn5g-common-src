...
bool ExpectedUeBehaviourData_1::validate(
    std::stringstream& msg, const std::string& pathPrefix) const {
  bool success = true;
  const std::string _pathPrefix =
      pathPrefix.empty() ? "ExpectedUeBehaviourData_1" : pathPrefix;

  if (expectedUmtsIsSet()) {
    const std::vector<oai::_3gpp::model::LocationArea_1>& value =
        m_ExpectedUmts;
...
bool ExpectedUeBehaviourData_1::operator==(
    const ExpectedUeBehaviourData_1& rhs) const {
  return
...
ExpectedUeBehaviourData_1::getStationaryIndication() const {
  return m_StationaryIndication;
}
void ExpectedUeBehaviourData_1::setStationaryIndication(
...
void ExpectedUeBehaviourData_1::setCommunicationDurationTime(
    int32_t const value) {
...
ExpectedUeBehaviourData_1::getScheduledCommunicationTime() const {
  return m_ScheduledCommunicationTime;
}
void ExpectedUeBehaviourData_1::setScheduledCommunicationTime(
...
ExpectedUeBehaviourData_1::getScheduledCommunicationType() const {
  return m_ScheduledCommunicationType;
}
void ExpectedUeBehaviourData_1::setScheduledCommunicationType(
...
std::vector<oai::_3gpp::model::LocationArea_1>
ExpectedUeBehaviourData_1::getExpectedUmts() const {
  return m_ExpectedUmts;
}
void ExpectedUeBehaviourData_1::setExpectedUmts(
...
oai::_3gpp::model::TrafficProfile ExpectedUeBehaviourData_1::getTrafficProfile()
    const {
  return m_TrafficProfile;
}
void ExpectedUeBehaviourData_1::setTrafficProfile(
...
oai::_3gpp::model::BatteryIndication
ExpectedUeBehaviourData_1::getBatteryIndication() const {
  return m_BatteryIndication;
}
void ExpectedUeBehaviourData_1::setBatteryIndication(
