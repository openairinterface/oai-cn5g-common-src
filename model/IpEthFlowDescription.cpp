...
oai::model::EthFlowDescription IpEthFlowDescription::getEthTrafficFilter() const
{
    return m_EthTrafficFilter;
}
void IpEthFlowDescription::setEthTrafficFilter(oai::model::EthFlowDescription const& value)
{
