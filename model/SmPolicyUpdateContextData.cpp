...
bool SmPolicyUpdateContextData::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    ...
    {
        const std::vector<oai::model::PolicyControlRequestTrigger>& value = m_RepPolicyCtrlReqTriggers;
        ...
        { // Recursive validation of array elements
            ...
            int i = 0;
            for (const oai::model::PolicyControlRequestTrigger& value : value)
            { 
    ...
    if (accNetChIdsIsSet())
    {
        const std::vector<oai::model::AccNetChId>& value = m_AccNetChIds;
        ...
        { // Recursive validation of array elements
            const std::string oldValuePath = currentValuePath;
            int i = 0;
            for (const oai::model::AccNetChId& value : value)
            { 
                const std::string currentValuePath = oldValuePath + "[" + std::to_string(i) + "]";
    ...
    {
        const std::vector<oai::model::AccuUsageReport>& value = m_AccuUsageReports;
        ...
        { // Recursive validation of array elements
            const std::string oldValuePath = currentValuePath;
            int i = 0;
            for (const oai::model::AccuUsageReport& value : value)
            { 
                const std::string currentValuePath = oldValuePath + "[" + std::to_string(i) + "]";
    ...
    {
        const std::vector<oai::model::AppDetectionInfo>& value = m_AppDetectionInfos;
        ...
        { // Recursive validation of array elements
            const std::string oldValuePath = currentValuePath;
            int i = 0;
            for (const oai::model::AppDetectionInfo& value : value)
            { 
                const std::string currentValuePath = oldValuePath + "[" + std::to_string(i) + "]";
    ...
    if (ruleReportsIsSet())
    {
        const std::vector<oai::model::RuleReport>& value = m_RuleReports;
        ...
        { // Recursive validation of array elements
            const std::string oldValuePath = currentValuePath;
            int i = 0;
            for (const oai::model::RuleReport& value : value)
            { 
                const std::string currentValuePath = oldValuePath + "[" + std::to_string(i) + "]";
    ...
    {
        const std::vector<oai::model::SessionRuleReport>& value = m_SessRuleReports;
        ...
        { // Recursive validation of array elements
            const std::string oldValuePath = currentValuePath;
            int i = 0;
            for (const oai::model::SessionRuleReport& value : value)
            { 
                const std::string currentValuePath = oldValuePath + "[" + std::to_string(i) + "]";
    ...
    if (qncReportsIsSet())
    {
        const std::vector<oai::model::QosNotificationControlInfo>& value = m_QncReports;
        ...
        { // Recursive validation of array elements
            const std::string oldValuePath = currentValuePath;
            int i = 0;
            for (const oai::model::QosNotificationControlInfo& value : value)
            { 
                const std::string currentValuePath = oldValuePath + "[" + std::to_string(i) + "]";
    ...
    {
        const std::vector<oai::model::QosMonitoringReport>& value = m_QosMonReports;
        ...
        { // Recursive validation of array elements
            const std::string oldValuePath = currentValuePath;
            int i = 0;
            for (const oai::model::QosMonitoringReport& value : value)
            { 
                const std::string currentValuePath = oldValuePath + "[" + std::to_string(i) + "]";
    ...
    if (repPraInfosIsSet())
    {
        const std::map<std::string, oai::model::PresenceInfo>& value = m_RepPraInfos;
    ...
    {
        const std::vector<oai::model::PortManagementContainer>& value = m_TsnPortManContNwtts;
        ...
        { // Recursive validation of array elements
            const std::string oldValuePath = currentValuePath;
            int i = 0;
            for (const oai::model::PortManagementContainer& value : value)
            { 
                const std::string currentValuePath = oldValuePath + "[" + std::to_string(i) + "]";
    ...
    {
        const std::vector<oai::model::IpMulticastAddressInfo>& value = m_MulAddrInfos;
        ...
        { // Recursive validation of array elements
            const std::string oldValuePath = currentValuePath;
            int i = 0;
            for (const oai::model::IpMulticastAddressInfo& value : value)
            { 
                const std::string currentValuePath = oldValuePath + "[" + std::to_string(i) + "]";
    ...
    {
        const std::vector<oai::model::PolicyDecisionFailureCode>& value = m_PolicyDecFailureReports;
        ...
        { // Recursive validation of array elements
            const std::string oldValuePath = currentValuePath;
            int i = 0;
            for (const oai::model::PolicyDecisionFailureCode& value : value)
            { 
                const std::string currentValuePath = oldValuePath + "[" + std::to_string(i) + "]";
    ...
    {
        const std::vector<oai::model::InvalidParam>& value = m_InvalidPolicyDecs;
        ...
        { // Recursive validation of array elements
            const std::string oldValuePath = currentValuePath;
            int i = 0;
            for (const oai::model::InvalidParam& value : value)
            { 
                const std::string currentValuePath = oldValuePath + "[" + std::to_string(i) + "]";
    ...
    {
        const std::vector<oai::model::DddTrafficDescriptor>& value = m_TrafficDescriptors;
        ...
        { // Recursive validation of array elements
            const std::string oldValuePath = currentValuePath;
            int i = 0;
            for (const oai::model::DddTrafficDescriptor& value : value)
            { 
                const std::string currentValuePath = oldValuePath + "[" + std::to_string(i) + "]";
    ...
    {
        const std::vector<oai::model::DlDataDeliveryStatus>& value = m_TypesOfNotif;
        ...
        { // Recursive validation of array elements
            const std::string oldValuePath = currentValuePath;
            int i = 0;
            for (const oai::model::DlDataDeliveryStatus& value : value)
            { 
                const std::string currentValuePath = oldValuePath + "[" + std::to_string(i) + "]";
    ...
    if (nwdafDatasIsSet())
    {
        const std::vector<oai::model::NwdafData>& value = m_NwdafDatas;
        ...
        { // Recursive validation of array elements
            const std::string oldValuePath = currentValuePath;
            int i = 0;
            for (const oai::model::NwdafData& value : value)
            { 
                const std::string currentValuePath = oldValuePath + "[" + std::to_string(i) + "]";
...
std::vector<oai::model::PolicyControlRequestTrigger> SmPolicyUpdateContextData::getRepPolicyCtrlReqTriggers() const
{
    return m_RepPolicyCtrlReqTriggers;
}
void SmPolicyUpdateContextData::setRepPolicyCtrlReqTriggers(std::vector<oai::model::PolicyControlRequestTrigger> const& value)
{
...
std::vector<oai::model::AccNetChId> SmPolicyUpdateContextData::getAccNetChIds() const
{
    return m_AccNetChIds;
}
void SmPolicyUpdateContextData::setAccNetChIds(std::vector<oai::model::AccNetChId> const& value)
{
    m_AccNetChIds = value;
...
oai::model::AccessType SmPolicyUpdateContextData::getAccessType() const
{
    return m_AccessType;
}
void SmPolicyUpdateContextData::setAccessType(oai::model::AccessType const& value)
{
    m_AccessType = value;
...
oai::model::RatType SmPolicyUpdateContextData::getRatType() const
{
    return m_RatType;
}
void SmPolicyUpdateContextData::setRatType(oai::model::RatType const& value)
{
    m_RatType = value;
    m_RatTypeIsSet = true;
}
...
oai::model::AdditionalAccessInfo SmPolicyUpdateContextData::getAddAccessInfo() const
{
    return m_AddAccessInfo;
}
void SmPolicyUpdateContextData::setAddAccessInfo(oai::model::AdditionalAccessInfo const& value)
{
...
oai::model::AdditionalAccessInfo SmPolicyUpdateContextData::getRelAccessInfo() const
{
    return m_RelAccessInfo;
}
void SmPolicyUpdateContextData::setRelAccessInfo(oai::model::AdditionalAccessInfo const& value)
{
...
oai::model::PlmnIdNid SmPolicyUpdateContextData::getServingNetwork() const
{
    return m_ServingNetwork;
}
void SmPolicyUpdateContextData::setServingNetwork(oai::model::PlmnIdNid const& value)
{
...
oai::model::UserLocation SmPolicyUpdateContextData::getUserLocationInfo() const
{
    return m_UserLocationInfo;
}
void SmPolicyUpdateContextData::setUserLocationInfo(oai::model::UserLocation const& value)
{
...
oai::model::Ipv6Prefix SmPolicyUpdateContextData::getIpv6AddressPrefix() const
{
    return m_Ipv6AddressPrefix;
}
void SmPolicyUpdateContextData::setIpv6AddressPrefix(oai::model::Ipv6Prefix const& value)
{
...
oai::model::Ipv6Prefix SmPolicyUpdateContextData::getRelIpv6AddressPrefix() const
{
    return m_RelIpv6AddressPrefix;
}
void SmPolicyUpdateContextData::setRelIpv6AddressPrefix(oai::model::Ipv6Prefix const& value)
{
...
oai::model::Ipv6Prefix SmPolicyUpdateContextData::getAddIpv6AddrPrefixes() const
{
    return m_AddIpv6AddrPrefixes;
}
void SmPolicyUpdateContextData::setAddIpv6AddrPrefixes(oai::model::Ipv6Prefix const& value)
{
...
oai::model::Ipv6Prefix SmPolicyUpdateContextData::getAddRelIpv6AddrPrefixes() const
{
    return m_AddRelIpv6AddrPrefixes;
}
void SmPolicyUpdateContextData::setAddRelIpv6AddrPrefixes(oai::model::Ipv6Prefix const& value)
{
...
oai::model::Ambr SmPolicyUpdateContextData::getSubsSessAmbr() const
{
    return m_SubsSessAmbr;
}
void SmPolicyUpdateContextData::setSubsSessAmbr(oai::model::Ambr const& value)
{
...
oai::model::SubscribedDefaultQos SmPolicyUpdateContextData::getSubsDefQos() const
{
    return m_SubsDefQos;
}
void SmPolicyUpdateContextData::setSubsDefQos(oai::model::SubscribedDefaultQos const& value)
{
    m_SubsDefQos = value;
...
oai::model::VplmnQos SmPolicyUpdateContextData::getVplmnQos() const
{
    return m_VplmnQos;
}
void SmPolicyUpdateContextData::setVplmnQos(oai::model::VplmnQos const& value)
{
    m_VplmnQos = value;
...
std::vector<oai::model::AccuUsageReport> SmPolicyUpdateContextData::getAccuUsageReports() const
{
    return m_AccuUsageReports;
}
void SmPolicyUpdateContextData::setAccuUsageReports(std::vector<oai::model::AccuUsageReport> const& value)
{
...
std::vector<oai::model::AppDetectionInfo> SmPolicyUpdateContextData::getAppDetectionInfos() const
{
    return m_AppDetectionInfos;
}
void SmPolicyUpdateContextData::setAppDetectionInfos(std::vector<oai::model::AppDetectionInfo> const& value)
{
...
std::vector<oai::model::RuleReport> SmPolicyUpdateContextData::getRuleReports() const
{
    return m_RuleReports;
}
void SmPolicyUpdateContextData::setRuleReports(std::vector<oai::model::RuleReport> const& value)
{
    m_RuleReports = value;
...
std::vector<oai::model::SessionRuleReport> SmPolicyUpdateContextData::getSessRuleReports() const
{
    return m_SessRuleReports;
}
void SmPolicyUpdateContextData::setSessRuleReports(std::vector<oai::model::SessionRuleReport> const& value)
{
...
std::vector<oai::model::QosNotificationControlInfo> SmPolicyUpdateContextData::getQncReports() const
{
    return m_QncReports;
}
void SmPolicyUpdateContextData::setQncReports(std::vector<oai::model::QosNotificationControlInfo> const& value)
{
    m_QncReports = value;
...
std::vector<oai::model::QosMonitoringReport> SmPolicyUpdateContextData::getQosMonReports() const
{
    return m_QosMonReports;
}
void SmPolicyUpdateContextData::setQosMonReports(std::vector<oai::model::QosMonitoringReport> const& value)
{
...
std::map<std::string, oai::model::PresenceInfo> SmPolicyUpdateContextData::getRepPraInfos() const
{
    return m_RepPraInfos;
}
void SmPolicyUpdateContextData::setRepPraInfos(std::map<std::string, oai::model::PresenceInfo> const& value)
{
    m_RepPraInfos = value;
...
oai::model::UeInitiatedResourceRequest SmPolicyUpdateContextData::getUeInitResReq() const
{
    return m_UeInitResReq;
}
void SmPolicyUpdateContextData::setUeInitResReq(oai::model::UeInitiatedResourceRequest const& value)
{
...
oai::model::QosFlowUsage SmPolicyUpdateContextData::getQosFlowUsage() const
{
    return m_QosFlowUsage;
}
void SmPolicyUpdateContextData::setQosFlowUsage(oai::model::QosFlowUsage const& value)
{
...
oai::model::CreditManagementStatus SmPolicyUpdateContextData::getCreditManageStatus() const
{
    return m_CreditManageStatus;
}
void SmPolicyUpdateContextData::setCreditManageStatus(oai::model::CreditManagementStatus const& value)
{
...
oai::model::ServingNfIdentity SmPolicyUpdateContextData::getServNfId() const
{
    return m_ServNfId;
}
void SmPolicyUpdateContextData::setServNfId(oai::model::ServingNfIdentity const& value)
{
    m_ServNfId = value;
...
oai::model::TraceData SmPolicyUpdateContextData::getTraceReq() const
{
    return m_TraceReq;
}
void SmPolicyUpdateContextData::setTraceReq(oai::model::TraceData const& value)
{
    m_TraceReq = value;
...
oai::model::MaPduIndication SmPolicyUpdateContextData::getMaPduInd() const
{
    return m_MaPduInd;
}
void SmPolicyUpdateContextData::setMaPduInd(oai::model::MaPduIndication const& value)
{
    m_MaPduInd = value;
...
oai::model::AtsssCapability SmPolicyUpdateContextData::getAtsssCapab() const
{
    return m_AtsssCapab;
}
void SmPolicyUpdateContextData::setAtsssCapab(oai::model::AtsssCapability const& value)
{
    m_AtsssCapab = value;
...
oai::model::TsnBridgeInfo SmPolicyUpdateContextData::getTsnBridgeInfo() const
{
    return m_TsnBridgeInfo;
}
void SmPolicyUpdateContextData::setTsnBridgeInfo(oai::model::TsnBridgeInfo const& value)
{
...
oai::model::BridgeManagementContainer SmPolicyUpdateContextData::getTsnBridgeManCont() const
{
    return m_TsnBridgeManCont;
}
void SmPolicyUpdateContextData::setTsnBridgeManCont(oai::model::BridgeManagementContainer const& value)
{
...
oai::model::PortManagementContainer SmPolicyUpdateContextData::getTsnPortManContDstt() const
{
    return m_TsnPortManContDstt;
}
void SmPolicyUpdateContextData::setTsnPortManContDstt(oai::model::PortManagementContainer const& value)
{
...
std::vector<oai::model::PortManagementContainer> SmPolicyUpdateContextData::getTsnPortManContNwtts() const
{
    return m_TsnPortManContNwtts;
}
void SmPolicyUpdateContextData::setTsnPortManContNwtts(std::vector<oai::model::PortManagementContainer> const& value)
{
...
std::vector<oai::model::IpMulticastAddressInfo> SmPolicyUpdateContextData::getMulAddrInfos() const
{
    return m_MulAddrInfos;
}
void SmPolicyUpdateContextData::setMulAddrInfos(std::vector<oai::model::IpMulticastAddressInfo> const& value)
{
...
std::vector<oai::model::PolicyDecisionFailureCode> SmPolicyUpdateContextData::getPolicyDecFailureReports() const
{
    return m_PolicyDecFailureReports;
}
void SmPolicyUpdateContextData::setPolicyDecFailureReports(std::vector<oai::model::PolicyDecisionFailureCode> const& value)
{
...
std::vector<oai::model::InvalidParam> SmPolicyUpdateContextData::getInvalidPolicyDecs() const
{
    return m_InvalidPolicyDecs;
}
void SmPolicyUpdateContextData::setInvalidPolicyDecs(std::vector<oai::model::InvalidParam> const& value)
{
...
std::vector<oai::model::DddTrafficDescriptor> SmPolicyUpdateContextData::getTrafficDescriptors() const
{
    return m_TrafficDescriptors;
}
void SmPolicyUpdateContextData::setTrafficDescriptors(std::vector<oai::model::DddTrafficDescriptor> const& value)
{
...
std::vector<oai::model::DlDataDeliveryStatus> SmPolicyUpdateContextData::getTypesOfNotif() const
{
    return m_TypesOfNotif;
}
void SmPolicyUpdateContextData::setTypesOfNotif(std::vector<oai::model::DlDataDeliveryStatus> const& value)
{
...
void SmPolicyUpdateContextData::setInterGrpIds(std::vector<std::string> const& value)
{
    m_InterGrpIds = value;
...
oai::model::SatelliteBackhaulCategory SmPolicyUpdateContextData::getSatBackhaulCategory() const
{
    return m_SatBackhaulCategory;
}
void SmPolicyUpdateContextData::setSatBackhaulCategory(oai::model::SatelliteBackhaulCategory const& value)
{
...
oai::model::PcfUeCallbackInfo SmPolicyUpdateContextData::getPcfUeInfo() const
{
    return m_PcfUeInfo;
}
void SmPolicyUpdateContextData::setPcfUeInfo(oai::model::PcfUeCallbackInfo const& value)
{
    m_PcfUeInfo = value;
...
std::vector<oai::model::NwdafData> SmPolicyUpdateContextData::getNwdafDatas() const
{
    return m_NwdafDatas;
}
void SmPolicyUpdateContextData::setNwdafDatas(std::vector<oai::model::NwdafData> const& value)
{
    m_NwdafDatas = value;
