...
public:
  static void register_logger(const std::string &nf_name,
                              const std::string &logger_name, bool log_stdout,
                              bool log_rot_file);
...
class logger_common {
public:
  logger_common(const std::string &name, const bool log_stdout,
                const bool log_rot_file) {
    oai::logger::logger_registry::register_logger(name, ASYNC_CMD, log_stdout,
                                                  log_rot_file);
    oai::logger::logger_registry::register_logger(name, LOGGER_COMMON,
                                                  log_stdout, log_rot_file);
    oai::logger::logger_registry::register_logger(name, LOGGER_COMMON_NAS,
                                                  log_stdout, log_rot_file);
    oai::logger::logger_registry::register_logger(name, LOGGER_COMMON_NGAP,
                                                  log_stdout, log_rot_file);
    oai::logger::logger_registry::register_logger(name, LOGGER_COMMON_PFCP,
                                                  log_stdout, log_rot_file);
    oai::logger::logger_registry::register_logger(name, SYSTEM, log_stdout,
                                                  log_rot_file);
    oai::logger::logger_registry::register_logger(name, LOGGER_COMMON_UTILS,
                                                  log_stdout, log_rot_file);
  }
  static bool should_log(spdlog::level::level_enum level) {
