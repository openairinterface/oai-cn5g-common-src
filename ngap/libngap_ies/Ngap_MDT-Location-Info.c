...
asn_TYPE_member_t asn_MBR_Ngap_MDT_Location_Info_1[] = {
    {ATF_NOFLAGS,
     0,
     offsetof(struct Ngap_MDT_Location_Info, mDT_Location_Information),
    ...
    {ATF_POINTER,
     1,
     offsetof(struct Ngap_MDT_Location_Info, iE_Extensions),
     (ASN_TAG_CLASS_CONTEXT | (1 << 2)),
     -1, /* IMPLICIT tag at current level */
     &asn_DEF_Ngap_ProtocolExtensionContainer_12929P190,
     0,
     {
#if !defined(ASN_DISABLE_OER_SUPPORT)
         0,
