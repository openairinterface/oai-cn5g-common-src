...
std::vector<oai::_3gpp::model::EbiArpMapping> AssignedEbiData::getAssignedEbiList() const
{
    return m_AssignedEbiList;
}
void AssignedEbiData::setAssignedEbiList(std::vector<oai::_3gpp::model::EbiArpMapping> const& value)
{
...
void AssignedEbiData::setFailedArpList(std::vector<oai::_3gpp::model::Arp> const& value)
{
