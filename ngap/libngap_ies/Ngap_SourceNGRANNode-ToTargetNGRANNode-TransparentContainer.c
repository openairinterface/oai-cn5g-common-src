...
static asn_TYPE_member_t
    asn_MBR_Ngap_SourceNGRANNode_ToTargetNGRANNode_TransparentContainer_1[] = {
        {ATF_NOFLAGS,
         0,
         offsetof(
             struct Ngap_SourceNGRANNode_ToTargetNGRANNode_TransparentContainer,
             rRCContainer),
        ...
        {ATF_POINTER,
         ...
         -1, /* IMPLICIT tag at current level */
         &asn_DEF_Ngap_ProtocolExtensionContainer_12929P314,
         0,
         {
#if !defined(ASN_DISABLE_OER_SUPPORT)
             0,
...
static const int
    asn_MAP_Ngap_SourceNGRANNode_ToTargetNGRANNode_TransparentContainer_oms_1
        [] = {1, 2, 4, 6};
