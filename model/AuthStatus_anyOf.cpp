...
bool AuthStatus_anyOf::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "AuthStatus_anyOf" : pathPrefix;

    
    if (m_value == AuthStatus_anyOf::eAuthStatus_anyOf::INVALID_VALUE_OPENAPI_GENERATED)
    {
        success = false;
