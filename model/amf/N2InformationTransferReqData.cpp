...
N2InformationTransferReqData::getTaiList() {
  return m_TaiList;
}
...
std::vector<oai::model::common::Ecgi> &
N2InformationTransferReqData::getEcgiList() {
  return m_EcgiList;
}
...
std::vector<oai::model::common::Ncgi> &
N2InformationTransferReqData::getNcgiList() {
  return m_NcgiList;
}
