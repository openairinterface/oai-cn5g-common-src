...
bool PfdSubscription::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "PfdSubscription" : pathPrefix;

         
    if (applicationIdsIsSet())
    {
        const std::vector<oai::_3gpp::model::std::string>& value = m_ApplicationIds;
...
bool PfdSubscription::operator==(const PfdSubscription& rhs) const
{
    ...
    ((!applicationIdsIsSet() && !rhs.applicationIdsIsSet()) || (applicationIdsIsSet() && rhs.applicationIdsIsSet() && getApplicationIds() == rhs.getApplicationIds())) &&
...
std::vector<oai::_3gpp::model::std::string> PfdSubscription::getApplicationIds() const
{
    return m_ApplicationIds;
}
void PfdSubscription::setApplicationIds(std::vector<oai::_3gpp::model::std::string> const& value)
{
