...
public:
    ...
    /// </summary>
    std::vector<oai::model::TransferPolicy> getTransfPolicies() const;
    void setTransfPolicies(std::vector<oai::model::TransferPolicy> const& value);
    /// <summary>
...
protected:
    ...
    std::vector<oai::model::TransferPolicy> m_TransfPolicies;
