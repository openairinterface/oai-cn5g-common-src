...
public:
    ...
    /// </summary>
    std::vector<oai::_3gpp::model::SdRange> getSdRanges() const;
    void setSdRanges(std::vector<oai::_3gpp::model::SdRange> const& value);
...
protected:
    ...
    std::string m_Sd;
    bool m_SdIsSet;
    std::vector<oai::_3gpp::model::SdRange> m_SdRanges;
