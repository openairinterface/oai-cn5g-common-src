...
oai::model::N2InformationClass NonUeN2InfoSubscriptionCreatedData::getN2InformationClass() const
{
    return m_N2InformationClass;
}
void NonUeN2InfoSubscriptionCreatedData::setN2InformationClass(oai::model::N2InformationClass const& value)
{
