...
bool ServiceNameListCond::validate(
    std::stringstream& msg, const std::string& pathPrefix) const {
  bool success = true;
  const std::string _pathPrefix =
      pathPrefix.empty() ? "ServiceNameListCond" : pathPrefix;
...
std::vector<oai::_3gpp::model::ServiceName>
ServiceNameListCond::getServiceNameList() const {
  return m_ServiceNameList;
}
void ServiceNameListCond::setServiceNameList(
