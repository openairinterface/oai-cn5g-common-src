...
public:
    ...
    /// 
    /// </summary>
    oai::model::UeContextTransferRspData getJsonData() const;
    void setJsonData(oai::model::UeContextTransferRspData const& value);
    ...
    friend  void to_json(nlohmann::json& j, const UEContextTransfer_200_response& o);
    friend  void from_json(const nlohmann::json& j, UEContextTransfer_200_response& o);
protected:
    oai::model::UeContextTransferRspData m_JsonData;
