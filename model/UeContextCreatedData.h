...
public:
    ...
    /// 
    /// </summary>
    oai::model::N2InfoContent getTargetToSourceData() const;
    void setTargetToSourceData(oai::model::N2InfoContent const& value);
    /// <summary>
    /// 
    /// </summary>
    ...
    /// 
    /// </summary>
    std::vector<oai::model::N2SmInformation> getFailedSessionList() const;
    void setFailedSessionList(std::vector<oai::model::N2SmInformation> const& value);
...
protected:
    ...
    oai::model::N2InfoContent m_TargetToSourceData;

    std::vector<oai::model::N2SmInformation> m_PduSessionList;

    std::vector<oai::model::N2SmInformation> m_FailedSessionList;
