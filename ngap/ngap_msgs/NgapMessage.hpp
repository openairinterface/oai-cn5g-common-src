...
enum class NgapMessageType {
  ...
  BROADCAST_SESSION_SETUP_REQUEST            = 97,
  BROADCAST_SESSION_SETUP_RESPONSE           = 98,
  BROADCAST_SESSION_SETUP_FAILURE            = 99,
  BROADCAST_SESSION_MODIFICATION_REQUEST     = 100,
  BROADCAST_SESSION_MODIFICATION_RESPONSE    = 101,
  BROADCAST_SESSION_MODIFICATION_FAILURE     = 102,
  BROADCAST_SESSION_RELEASE_REQUEST          = 103,
  BROADCAST_SESSION_RELEASE_RESPONSE         = 104,
  BROADCAST_SESSION_RELEASE_REQUIRED         = 105,
  DISTRIBUTION_SETUP_REQUEST                 = 106,
  DISTRIBUTION_SETUP_RESPONSE                = 107,
  DISTRIBUTION_SETUP_FAILURE                 = 108,
  DISTRIBUTION_RELEASE_REQUEST               = 109,
  DISTRIBUTION_RELEASE_RESPONSE              = 110,
  MULTICAST_SESSION_ACTIVATION_REQUEST       = 111,
  MULTICAST_SESSION_ACTIVATION_RESPONSE      = 112,
  MULTICAST_SESSION_ACTIVATION_FAILURE       = 113,
  MULTICAST_SESSION_DEACTIVATION_REQUEST     = 114,
  MULTICAST_SESSION_DEACTIVATION_RESPONSE    = 115,
  MULTICAST_SESSION_UPDATE_REQUEST           = 116,
  MULTICAST_SESSION_UPDATE_RESPONSE          = 117,
  MULTICAST_SESSION_UPDATE_FAILURE           = 118,
  MULTICAST_GROUP_PAGING                     = 119
};
