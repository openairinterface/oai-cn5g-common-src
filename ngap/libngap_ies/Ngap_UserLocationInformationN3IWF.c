...
asn_TYPE_member_t asn_MBR_Ngap_UserLocationInformationN3IWF_1[] = {
    {ATF_NOFLAGS,
     0,
     offsetof(struct Ngap_UserLocationInformationN3IWF, iPAddress),
    ...
    {ATF_NOFLAGS,
     0,
     offsetof(struct Ngap_UserLocationInformationN3IWF, portNumber),
    ...
    {ATF_POINTER,
     1,
     offsetof(struct Ngap_UserLocationInformationN3IWF, iE_Extensions),
     (ASN_TAG_CLASS_CONTEXT | (2 << 2)),
     -1, /* IMPLICIT tag at current level */
     &asn_DEF_Ngap_ProtocolExtensionContainer_12929P365,
     0,
     {
#if !defined(ASN_DISABLE_OER_SUPPORT)
         0,
