...
asn_TYPE_member_t asn_MBR_Ngap_CriticalityDiagnostics_1[] = {
    {ATF_POINTER,
     5,
     offsetof(struct Ngap_CriticalityDiagnostics, procedureCode),
    ...
    {ATF_POINTER,
     4,
     offsetof(struct Ngap_CriticalityDiagnostics, triggeringMessage),
    ...
    {ATF_POINTER,
     3,
     offsetof(struct Ngap_CriticalityDiagnostics, procedureCriticality),
    ...
    {ATF_POINTER,
     2,
     offsetof(struct Ngap_CriticalityDiagnostics, iEsCriticalityDiagnostics),
    ...
    {ATF_POINTER,
     1,
     offsetof(struct Ngap_CriticalityDiagnostics, iE_Extensions),
     (ASN_TAG_CLASS_CONTEXT | (4 << 2)),
     -1, /* IMPLICIT tag at current level */
     &asn_DEF_Ngap_ProtocolExtensionContainer_12929P48,
     0,
     {
#if !defined(ASN_DISABLE_OER_SUPPORT)
         0,
