...
bool TrafficInfluSub::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "TrafficInfluSub" : pathPrefix;
...
std::vector<oai::_3gpp::model::std::string> TrafficInfluSub::getDnns() const
{
    return m_Dnns;
}
void TrafficInfluSub::setDnns(std::vector<oai::_3gpp::model::std::string> const& value)
{
    m_Dnns = value;
    m_DnnsIsSet = true;
}
...
void TrafficInfluSub::setSnssais(std::vector<oai::_3gpp::model::Snssai> const& value)
{
    m_Snssais = value;
    m_SnssaisIsSet = true;
}
...
std::vector<oai::_3gpp::model::std::string> TrafficInfluSub::getInternalGroupIds() const
{
    return m_InternalGroupIds;
}
void TrafficInfluSub::setInternalGroupIds(std::vector<oai::_3gpp::model::std::string> const& value)
{
...
std::vector<oai::_3gpp::model::std::string> TrafficInfluSub::getSupis() const
{
    return m_Supis;
}
void TrafficInfluSub::setSupis(std::vector<oai::_3gpp::model::std::string> const& value)
{
    m_Supis = value;
    m_SupisIsSet = true;
}
