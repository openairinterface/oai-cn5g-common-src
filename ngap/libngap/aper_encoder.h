 ...
 */
asn_enc_rval_t
aper_encode(const struct asn_TYPE_descriptor_s *type_descriptor,
 ...
 */
asn_enc_rval_t
aper_encode_to_buffer(const struct asn_TYPE_descriptor_s *type_descriptor,
                      const asn_per_constraints_t *constraints,
                      const void *struct_ptr, /* Structure to be encoded */
 ...
 */
ssize_t aper_encode_to_new_buffer(const struct asn_TYPE_descriptor_s *td,
                                  const asn_per_constraints_t *constraints,
