...
public:
    ...
    /// </summary>
    std::vector<oai::_3gpp::model::PolicyControlRequestTrigger> getRepPolicyCtrlReqTriggers() const;
    void setRepPolicyCtrlReqTriggers(std::vector<oai::_3gpp::model::PolicyControlRequestTrigger> const& value);
    ...
    void setAccuUsageReports(std::vector<oai::_3gpp::model::AccuUsageReport> const& value);
    ...
    void setAppDetectionInfos(std::vector<oai::_3gpp::model::AppDetectionInfo> const& value);
    ...
    void setSessRuleReports(std::vector<oai::_3gpp::model::SessionRuleReport> const& value);
    bool sessRuleReportsIsSet() const;
    void unsetSessRuleReports();
    /// <summary>
    /// QoS Notification Control information.
    /// </summary>
    std::vector<oai::_3gpp::model::QosNotificationControlInfo> getQncReports() const;
    void setQncReports(std::vector<oai::_3gpp::model::QosNotificationControlInfo> const& value);
    ...
    void setQosMonReports(std::vector<oai::_3gpp::model::QosMonitoringReport> const& value);
    ...
    void setRepPraInfos(std::map<std::string, oai::_3gpp::model::PresenceInfo> const& value);
    ...
    void setUeInitResReq(oai::_3gpp::model::UeInitiatedResourceRequest const& value);
    ...
    void setCreditManageStatus(oai::_3gpp::model::CreditManagementStatus const& value);
    ...
    void setTsnBridgeManCont(oai::_3gpp::model::BridgeManagementContainer const& value);
    ...
    void setTsnPortManContDstt(oai::_3gpp::model::PortManagementContainer const& value);
    bool tsnPortManContDsttIsSet() const;
    void unsetTsnPortManContDstt();
    /// <summary>
    /// 
    /// </summary>
    std::vector<oai::_3gpp::model::PortManagementContainer> getTsnPortManContNwtts() const;
    void setTsnPortManContNwtts(std::vector<oai::_3gpp::model::PortManagementContainer> const& value);
    bool tsnPortManContNwttsIsSet() const;
    void unsetTsnPortManContNwtts();
    /// <summary>
    /// 
    /// </summary>
    std::vector<oai::_3gpp::model::IpMulticastAddressInfo> getMulAddrInfos() const;
    void setMulAddrInfos(std::vector<oai::_3gpp::model::IpMulticastAddressInfo> const& value);
    bool mulAddrInfosIsSet() const;
    void unsetMulAddrInfos();
    /// <summary>
    /// Contains the type(s) of failed policy decision and/or condition data.
    /// </summary>
    std::vector<oai::_3gpp::model::PolicyDecisionFailureCode> getPolicyDecFailureReports() const;
    void setPolicyDecFailureReports(std::vector<oai::_3gpp::model::PolicyDecisionFailureCode> const& value);
    ...
    void setInvalidPolicyDecs(std::vector<oai::_3gpp::model::InvalidParam> const& value);
    bool invalidPolicyDecsIsSet() const;
    void unsetInvalidPolicyDecs();
    /// <summary>
    /// 
    /// </summary>
    std::vector<oai::_3gpp::model::DddTrafficDescriptor> getTrafficDescriptors() const;
    void setTrafficDescriptors(std::vector<oai::_3gpp::model::DddTrafficDescriptor> const& value);
    ...
    void setTypesOfNotif(std::vector<oai::_3gpp::model::DlDataDeliveryStatus> const& value);
    ...
    void setSatBackhaulCategory(oai::_3gpp::model::SatelliteBackhaulCategory const& value);
...
protected:
    std::vector<oai::_3gpp::model::PolicyControlRequestTrigger> m_RepPolicyCtrlReqTriggers;
    ...
    std::vector<oai::_3gpp::model::PolicyDecisionFailureCode> m_PolicyDecFailureReports;
