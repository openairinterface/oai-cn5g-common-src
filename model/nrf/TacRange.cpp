...
bool TacRange::validate(std::stringstream &msg,
...
bool TacRange::operator!=(const TacRange &rhs) const { return !(*this == rhs); }
...
std::string TacRange::getStart() const { return m_Start; }
void TacRange::setStart(std::string const &value) {
  m_Start = value;
  m_StartIsSet = true;
}
bool TacRange::startIsSet() const { return m_StartIsSet; }
void TacRange::unsetStart() { m_StartIsSet = false; }
std::string TacRange::getEnd() const { return m_End; }
void TacRange::setEnd(std::string const &value) {
  m_End = value;
  m_EndIsSet = true;
}
bool TacRange::endIsSet() const { return m_EndIsSet; }
void TacRange::unsetEnd() { m_EndIsSet = false; }
std::string TacRange::getPattern() const { return m_Pattern; }
void TacRange::setPattern(std::string const &value) {
  m_Pattern = value;
  m_PatternIsSet = true;
}
bool TacRange::patternIsSet() const { return m_PatternIsSet; }
void TacRange::unsetPattern() { m_PatternIsSet = false; }
