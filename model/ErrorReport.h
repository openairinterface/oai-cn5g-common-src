...
public:
    ...
    /// </summary>
    std::vector<oai::model::PolicyDecisionFailureCode> getPolDecFailureReports() const;
    void setPolDecFailureReports(std::vector<oai::model::PolicyDecisionFailureCode> const& value);
...
protected:
    ...
    std::vector<oai::model::PolicyDecisionFailureCode> m_PolDecFailureReports;
