...
public:
    ...
    void setChargEntityAddr(oai::_3gpp::model::AccNetChargingAddress const& value);
    ...
    void setIpv6FrameRouteList(std::vector<oai::_3gpp::model::Ipv6Prefix> const& value);
    ...
    void setPvsInfo(std::vector<oai::_3gpp::model::ServerAddressingInfo> const& value);
