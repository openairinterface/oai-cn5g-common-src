...
protected:
    MaPduIndication_anyOf::eMaPduIndication_anyOf m_value = MaPduIndication_anyOf::eMaPduIndication_anyOf::INVALID_VALUE_OPENAPI_GENERATED;
};
