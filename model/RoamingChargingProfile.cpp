...
bool RoamingChargingProfile::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    ...
    if (triggersIsSet())
    {
        const std::vector<oai::model::Trigger>& value = m_Triggers;
        ...
        { // Recursive validation of array elements
            ...
            int i = 0;
            for (const oai::model::Trigger& value : value)
            { 
...
std::vector<oai::model::Trigger> RoamingChargingProfile::getTriggers() const
{
    return m_Triggers;
}
void RoamingChargingProfile::setTriggers(std::vector<oai::model::Trigger> const& value)
{
    m_Triggers = value;
...
oai::model::PartialRecordMethod RoamingChargingProfile::getPartialRecordMethod() const
{
    return m_PartialRecordMethod;
}
void RoamingChargingProfile::setPartialRecordMethod(oai::model::PartialRecordMethod const& value)
{
