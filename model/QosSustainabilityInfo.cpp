...
void QosSustainabilityInfo::setAreaInfo(oai::_3gpp::model::NetworkAreaInfo const& value)
{
    m_AreaInfo = value;
...
oai::_3gpp::model::RetainabilityThreshold QosSustainabilityInfo::getQosFlowRetThd() const
{
    return m_QosFlowRetThd;
}
void QosSustainabilityInfo::setQosFlowRetThd(oai::_3gpp::model::RetainabilityThreshold const& value)
{
