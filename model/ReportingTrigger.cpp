...
bool ReportingTrigger::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "ReportingTrigger" : pathPrefix;
...
ReportingTrigger_anyOf::eReportingTrigger_anyOf ReportingTrigger::getEnumValue() const
{
    return m_value.getValue();
}

void ReportingTrigger::setEnumValue(ReportingTrigger_anyOf::eReportingTrigger_anyOf  value)
{
