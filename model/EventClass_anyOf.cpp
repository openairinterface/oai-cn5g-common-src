...
bool EventClass_anyOf::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "EventClass_anyOf" : pathPrefix;

    
    if (m_value == EventClass_anyOf::eEventClass_anyOf::INVALID_VALUE_OPENAPI_GENERATED)
    {
        success = false;
