...
bool ReportIntervalMdt_anyOf::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "ReportIntervalMdt_anyOf" : pathPrefix;

    
    if (m_value == ReportIntervalMdt_anyOf::eReportIntervalMdt_anyOf::INVALID_VALUE_OPENAPI_GENERATED)
    {
        success = false;
...
bool ReportIntervalMdt_anyOf::operator==(const ReportIntervalMdt_anyOf& rhs) const
{
    return
...
void to_json(nlohmann::json& j, const ReportIntervalMdt_anyOf& o)
{
    ...
    switch (o.getValue())
    {
        case ReportIntervalMdt_anyOf::eReportIntervalMdt_anyOf::INVALID_VALUE_OPENAPI_GENERATED:
...
ReportIntervalMdt_anyOf::eReportIntervalMdt_anyOf ReportIntervalMdt_anyOf::getValue() const
{
    return m_value;
}
void ReportIntervalMdt_anyOf::setValue(ReportIntervalMdt_anyOf::eReportIntervalMdt_anyOf value)
{
    m_value = value;
}
