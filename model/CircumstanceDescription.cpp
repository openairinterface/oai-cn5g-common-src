...
bool CircumstanceDescription::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "CircumstanceDescription" : pathPrefix;
...
bool CircumstanceDescription::operator==(const CircumstanceDescription& rhs) const
{
    return
    ...
    ((!tmIsSet() && !rhs.tmIsSet()) || (tmIsSet() && rhs.tmIsSet() && getTm() == rhs.getTm())) &&
    
    
    ((!locAreaIsSet() && !rhs.locAreaIsSet()) || (locAreaIsSet() && rhs.locAreaIsSet() && getLocArea() == rhs.getLocArea())) &&
    
    
    ((!volIsSet() && !rhs.volIsSet()) || (volIsSet() && rhs.volIsSet() && getVol() == rhs.getVol()))
...
oai::_3gpp::model::NetworkAreaInfo CircumstanceDescription::getLocArea() const
{
    return m_LocArea;
}
void CircumstanceDescription::setLocArea(oai::_3gpp::model::NetworkAreaInfo const& value)
{
    m_LocArea = value;
    m_LocAreaIsSet = true;
}
