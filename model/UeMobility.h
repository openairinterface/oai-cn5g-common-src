...
public:
    ...
    /// 
    /// </summary>
    std::vector<oai::model::LocationInfo> getLocInfos() const;
    void setLocInfos(std::vector<oai::model::LocationInfo> const& value);
...
protected:
    ...
    std::vector<oai::model::LocationInfo> m_LocInfos;
