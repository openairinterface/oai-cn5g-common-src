...
std::vector<oai::_3gpp::model::GlobalRanNodeId> NonUeN2InfoSubscriptionCreateData::getGlobalRanNodeList() const
{
    return m_GlobalRanNodeList;
}
void NonUeN2InfoSubscriptionCreateData::setGlobalRanNodeList(std::vector<oai::_3gpp::model::GlobalRanNodeId> const& value)
{
...
std::vector<oai::_3gpp::model::AccessType> NonUeN2InfoSubscriptionCreateData::getAnTypeList() const
{
    return m_AnTypeList;
}
void NonUeN2InfoSubscriptionCreateData::setAnTypeList(std::vector<oai::_3gpp::model::AccessType> const& value)
{
    m_AnTypeList = value;
...
oai::_3gpp::model::N2InformationClass NonUeN2InfoSubscriptionCreateData::getN2InformationClass() const
{
    return m_N2InformationClass;
}
void NonUeN2InfoSubscriptionCreateData::setN2InformationClass(oai::_3gpp::model::N2InformationClass const& value)
{
