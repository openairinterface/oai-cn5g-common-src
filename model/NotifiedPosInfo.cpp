...
void NotifiedPosInfo::setLocationEvent(oai::_3gpp::model::LocationEvent const& value)
{
...
void NotifiedPosInfo::setLocationEstimate(oai::_3gpp::model::GeographicArea const& value)
{
...
void NotifiedPosInfo::setLocalLocationEstimate(oai::_3gpp::model::LocalArea const& value)
{
...
oai::_3gpp::model::VelocityEstimate NotifiedPosInfo::getVelocityEstimate() const
{
    return m_VelocityEstimate;
}
void NotifiedPosInfo::setVelocityEstimate(oai::_3gpp::model::VelocityEstimate const& value)
{
...
std::vector<oai::_3gpp::model::PositioningMethodAndUsage> NotifiedPosInfo::getPositioningDataList() const
{
    return m_PositioningDataList;
}
void NotifiedPosInfo::setPositioningDataList(std::vector<oai::_3gpp::model::PositioningMethodAndUsage> const& value)
{
...
std::vector<oai::_3gpp::model::GnssPositioningMethodAndUsage> NotifiedPosInfo::getGnssPositioningDataList() const
{
    return m_GnssPositioningDataList;
}
void NotifiedPosInfo::setGnssPositioningDataList(std::vector<oai::_3gpp::model::GnssPositioningMethodAndUsage> const& value)
{
...
void NotifiedPosInfo::setCivicAddress(oai::_3gpp::model::CivicAddress const& value)
{
...
oai::_3gpp::model::TerminationCause NotifiedPosInfo::getTerminationCause() const
{
    return m_TerminationCause;
}
void NotifiedPosInfo::setTerminationCause(oai::_3gpp::model::TerminationCause const& value)
{
...
void NotifiedPosInfo::setAchievedQos(oai::_3gpp::model::MinorLocationQoS const& value)
{
    m_AchievedQos = value;
...
oai::_3gpp::model::HighAccuracyGnssMetrics NotifiedPosInfo::getHaGnssMetrics() const
{
    return m_HaGnssMetrics;
}
void NotifiedPosInfo::setHaGnssMetrics(oai::_3gpp::model::HighAccuracyGnssMetrics const& value)
{
