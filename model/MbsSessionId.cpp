...
bool MbsSessionId::validate(
    std::stringstream& msg, const std::string& pathPrefix) const {
  bool success = true;
  const std::string _pathPrefix =
      pathPrefix.empty() ? "MbsSessionId" : pathPrefix;
...
oai::_3gpp::model::Tmgi MbsSessionId::getTmgi() const {
  return m_Tmgi;
}
void MbsSessionId::setTmgi(oai::_3gpp::model::Tmgi const& value) {
  m_Tmgi      = value;
  m_TmgiIsSet = true;
}
...
oai::_3gpp::model::Ssm MbsSessionId::getSsm() const {
  return m_Ssm;
}
void MbsSessionId::setSsm(oai::_3gpp::model::Ssm const& value) {
  m_Ssm      = value;
  m_SsmIsSet = true;
}
