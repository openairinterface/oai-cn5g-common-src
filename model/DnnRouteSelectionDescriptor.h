...
public:
    ...
    /// 
    /// </summary>
    std::vector<oai::model::SscMode> getSscModes() const;
    void setSscModes(std::vector<oai::model::SscMode> const& value);
    bool sscModesIsSet() const;
    void unsetSscModes();
    /// <summary>
    /// 
    /// </summary>
    std::vector<oai::model::PduSessionType> getPduSessTypes() const;
    void setPduSessTypes(std::vector<oai::model::PduSessionType> const& value);
...
protected:
    ...
    std::vector<oai::model::SscMode> m_SscModes;
    bool m_SscModesIsSet;
    std::vector<oai::model::PduSessionType> m_PduSessTypes;
