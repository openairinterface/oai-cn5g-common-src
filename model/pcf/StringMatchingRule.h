...
public:
    ...
    /// 
    /// </summary>
    std::vector<oai::model::pcf::StringMatchingCondition> getStringMatchingConditions() const;
    void setStringMatchingConditions(std::vector<oai::model::pcf::StringMatchingCondition> const& value);
...
protected:
    std::vector<oai::model::pcf::StringMatchingCondition> m_StringMatchingConditions;
