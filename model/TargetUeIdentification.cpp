...
bool TargetUeIdentification::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "TargetUeIdentification" : pathPrefix;
...
bool TargetUeIdentification::operator==(const TargetUeIdentification& rhs) const
{
    return
    ...
    ((!anyUeIdIsSet() && !rhs.anyUeIdIsSet()) || (anyUeIdIsSet() && rhs.anyUeIdIsSet() && isAnyUeId() == rhs.isAnyUeId()))
...
std::vector<oai::_3gpp::model::std::string> TargetUeIdentification::getSupis() const
{
    return m_Supis;
}
void TargetUeIdentification::setSupis(std::vector<oai::_3gpp::model::std::string> const& value)
{
    m_Supis = value;
    m_SupisIsSet = true;
}
...
std::vector<oai::_3gpp::model::std::string> TargetUeIdentification::getInterGroupIds() const
{
    return m_InterGroupIds;
}
void TargetUeIdentification::setInterGroupIds(std::vector<oai::_3gpp::model::std::string> const& value)
{
