...
bool VnGroupData::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "VnGroupData" : pathPrefix;
...
oai::model::PduSessionTypes_1 VnGroupData::getPduSessionTypes() const
{
    return m_PduSessionTypes;
}
void VnGroupData::setPduSessionTypes(oai::model::PduSessionTypes_1 const& value)
{
...
oai::model::Snssai VnGroupData::getSingleNssai() const
{
    return m_SingleNssai;
}
void VnGroupData::setSingleNssai(oai::model::Snssai const& value)
{
    m_SingleNssai = value;
...
std::vector<oai::model::AppDescriptor> VnGroupData::getAppDescriptors() const
{
    return m_AppDescriptors;
}
void VnGroupData::setAppDescriptors(std::vector<oai::model::AppDescriptor> const& value)
{
