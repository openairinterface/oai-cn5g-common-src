...
bool RANSecondaryRATUsageReport::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    ...
    {
        const std::vector<oai::_3gpp::model::QosFlowsUsageReport>& value = m_QosFlowsUsageReports;
...
oai::_3gpp::model::RatType RANSecondaryRATUsageReport::getRANSecondaryRATType() const
{
    return m_RANSecondaryRATType;
}
void RANSecondaryRATUsageReport::setRANSecondaryRATType(oai::_3gpp::model::RatType const& value)
{
...
std::vector<oai::_3gpp::model::QosFlowsUsageReport> RANSecondaryRATUsageReport::getQosFlowsUsageReports() const
{
    return m_QosFlowsUsageReports;
}
void RANSecondaryRATUsageReport::setQosFlowsUsageReports(std::vector<oai::_3gpp::model::QosFlowsUsageReport> const& value)
{
