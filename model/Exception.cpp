...
oai::_3gpp::model::ExceptionId Exception::getExcepId() const
{
    return m_ExcepId;
}
void Exception::setExcepId(oai::_3gpp::model::ExceptionId const& value)
{
    m_ExcepId = value;
}
...
oai::_3gpp::model::ExceptionTrend Exception::getExcepTrend() const
{
    return m_ExcepTrend;
}
void Exception::setExcepTrend(oai::_3gpp::model::ExceptionTrend const& value)
{
    m_ExcepTrend = value;
