...
public:
    ...
    /// 
    /// </summary>
    oai::model::SqnScheme getSqnScheme() const;
    void setSqnScheme(oai::model::SqnScheme const& value);
    ...
    /// 
    /// </summary>
    oai::model::Sign getDifSign() const;
    void setDifSign(oai::model::Sign const& value);
...
protected:
    oai::model::SqnScheme m_SqnScheme;
