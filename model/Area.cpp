...
bool Area::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
...
std::vector<oai::_3gpp::model::std::string> Area::getTacs() const
{
    return m_Tacs;
}
void Area::setTacs(std::vector<oai::_3gpp::model::std::string> const& value)
{
    m_Tacs = value;
    m_TacsIsSet = true;
}
