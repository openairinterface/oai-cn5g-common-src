...
public:
  ...
  void get(PduSessionId &pduSessionId,
           OCTET_STRING_t &handoverRequiredTransfer) const;

  bool
  encode(Ngap_PDUSessionResourceItemHORqd_t &pduSessionResourceItemHORqd) const;
  bool
  decode(const Ngap_PDUSessionResourceItemHORqd_t &pduSessionResourceItemHORqd);
