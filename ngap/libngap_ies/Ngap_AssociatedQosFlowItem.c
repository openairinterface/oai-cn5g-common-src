...
extern asn_TYPE_descriptor_t asn_DEF_Ngap_qosFlowMappingIndication
    __attribute__((weak, alias("asn_DEF_Ngap_qosFlowMappingIndication_3")));
#else
...
asn_DEF_Ngap_qosFlowMappingIndication_3_alias_init(void) {
  asn_DEF_Ngap_qosFlowMappingIndication =
...
static asn_oer_constraints_t asn_OER_type_Ngap_qosFlowMappingIndication_constr_3
    CC_NOTUSED = {{0, 0}, -1};
#endif /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
static asn_per_constraints_t asn_PER_type_Ngap_qosFlowMappingIndication_constr_3
    CC_NOTUSED = {
...
static int asn_validate_Ngap_qosFlowMappingIndication_3(
    const asn_TYPE_descriptor_t* td, const void* sptr,
    asn_app_constraint_failed_f* ctfailcb, void* app_key) {
  if (!sptr) {
    return -1;
  }
  e_Ngap_AssociatedQosFlowItem__qosFlowMappingIndication value =
      *(e_Ngap_AssociatedQosFlowItem__qosFlowMappingIndication*) sptr;
  switch (value) {
...
static const asn_INTEGER_specifics_t
    asn_SPC_Ngap_qosFlowMappingIndication_specs_3 = {
        asn_MAP_Ngap_qosFlowMappingIndication_value2enum_3, /* "tag" => N;
                                                               sorted by tag */
        asn_MAP_Ngap_qosFlowMappingIndication_enum2value_3, /* N => "tag";
                                                               sorted by N */
...
static /* Use -fall-defs-global to expose */
    asn_TYPE_descriptor_t asn_DEF_Ngap_qosFlowMappingIndication_3 = {
        ...
        sizeof(asn_DEF_Ngap_qosFlowMappingIndication_tags_3) /
                sizeof(asn_DEF_Ngap_qosFlowMappingIndication_tags_3[0]) -
            1,                                        /* 1 */
        ...
        {
#if !defined(ASN_DISABLE_OER_SUPPORT)
            &asn_OER_type_Ngap_qosFlowMappingIndication_constr_3,
#endif /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
...
asn_TYPE_member_t asn_MBR_Ngap_AssociatedQosFlowItem_1[] = {
    {ATF_NOFLAGS,
     0,
     offsetof(struct Ngap_AssociatedQosFlowItem, qosFlowIdentifier),
    ...
    {ATF_POINTER,
     2,
     offsetof(struct Ngap_AssociatedQosFlowItem, qosFlowMappingIndication),
    ...
    {ATF_POINTER,
     1,
     offsetof(struct Ngap_AssociatedQosFlowItem, iE_Extensions),
     (ASN_TAG_CLASS_CONTEXT | (2 << 2)),
     -1, /* IMPLICIT tag at current level */
     &asn_DEF_Ngap_ProtocolExtensionContainer_12929P18,
     0,
     {
#if !defined(ASN_DISABLE_OER_SUPPORT)
         0,
