...
bool DnaiChangeType_anyOf::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "DnaiChangeType_anyOf" : pathPrefix;

    
    if (m_value == DnaiChangeType_anyOf::eDnaiChangeType_anyOf::INVALID_VALUE_OPENAPI_GENERATED)
    {
        success = false;
...
void to_json(nlohmann::json& j, const DnaiChangeType_anyOf& o)
{
    ...
    switch (o.getValue())
    {
        case DnaiChangeType_anyOf::eDnaiChangeType_anyOf::INVALID_VALUE_OPENAPI_GENERATED:
...
DnaiChangeType_anyOf::eDnaiChangeType_anyOf DnaiChangeType_anyOf::getValue() const
{
    return m_value;
}
void DnaiChangeType_anyOf::setValue(DnaiChangeType_anyOf::eDnaiChangeType_anyOf value)
{
    m_value = value;
}
