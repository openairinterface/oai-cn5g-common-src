...
oai::model::UeAuth LteV2xAuth::getVehicleUeAuth() const
{
    return m_VehicleUeAuth;
}
void LteV2xAuth::setVehicleUeAuth(oai::model::UeAuth const& value)
{
...
oai::model::UeAuth LteV2xAuth::getPedestrianUeAuth() const
{
    return m_PedestrianUeAuth;
}
void LteV2xAuth::setPedestrianUeAuth(oai::model::UeAuth const& value)
{
