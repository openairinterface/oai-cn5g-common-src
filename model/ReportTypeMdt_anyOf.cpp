...
bool ReportTypeMdt_anyOf::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "ReportTypeMdt_anyOf" : pathPrefix;

    
    if (m_value == ReportTypeMdt_anyOf::eReportTypeMdt_anyOf::INVALID_VALUE_OPENAPI_GENERATED)
    {
        success = false;
...
void to_json(nlohmann::json& j, const ReportTypeMdt_anyOf& o)
{
    ...
    switch (o.getValue())
    {
        case ReportTypeMdt_anyOf::eReportTypeMdt_anyOf::INVALID_VALUE_OPENAPI_GENERATED:
...
ReportTypeMdt_anyOf::eReportTypeMdt_anyOf ReportTypeMdt_anyOf::getValue() const
{
    return m_value;
}
void ReportTypeMdt_anyOf::setValue(ReportTypeMdt_anyOf::eReportTypeMdt_anyOf value)
{
    m_value = value;
}
