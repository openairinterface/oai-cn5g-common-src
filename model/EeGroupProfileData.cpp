...
bool EeGroupProfileData::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "EeGroupProfileData" : pathPrefix;

         
    if (restrictedEventTypesIsSet())
    {
        const std::vector<oai::model::EventType>& value = m_RestrictedEventTypes;
        ...
        { // Recursive validation of array elements
            ...
            int i = 0;
            for (const oai::model::EventType& value : value)
            { 
                const std::string currentValuePath = oldValuePath + "[" + std::to_string(i) + "]";
                        
        success = value.validate(msg, currentValuePath + ".restrictedEventTypes") && success;
    ...
    {
        const std::map<std::string, std::vector<oai::model::MtcProvider>>& value = m_AllowedMtcProvider;
...
bool EeGroupProfileData::operator==(const EeGroupProfileData& rhs) const
{
    ...
    ((!restrictedEventTypesIsSet() && !rhs.restrictedEventTypesIsSet()) || (restrictedEventTypesIsSet() && rhs.restrictedEventTypesIsSet() && getRestrictedEventTypes() == rhs.getRestrictedEventTypes())) &&
    
    
    ((!allowedMtcProviderIsSet() && !rhs.allowedMtcProviderIsSet()) || (allowedMtcProviderIsSet() && rhs.allowedMtcProviderIsSet() && getAllowedMtcProvider() == rhs.getAllowedMtcProvider())) &&
    ...
    ((!iwkEpcRestrictedIsSet() && !rhs.iwkEpcRestrictedIsSet()) || (iwkEpcRestrictedIsSet() && rhs.iwkEpcRestrictedIsSet() && isIwkEpcRestricted() == rhs.isIwkEpcRestricted())) &&
...
std::vector<oai::model::EventType> EeGroupProfileData::getRestrictedEventTypes() const
{
    return m_RestrictedEventTypes;
}
void EeGroupProfileData::setRestrictedEventTypes(std::vector<oai::model::EventType> const& value)
{
...
std::map<std::string, std::vector<oai::model::MtcProvider>> EeGroupProfileData::getAllowedMtcProvider() const
{
    return m_AllowedMtcProvider;
}
void EeGroupProfileData::setAllowedMtcProvider(std::map<std::string, std::vector<oai::model::MtcProvider>> const& value)
{
