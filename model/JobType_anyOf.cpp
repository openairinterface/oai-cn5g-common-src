...
bool JobType_anyOf::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "JobType_anyOf" : pathPrefix;

    
    if (m_value == JobType_anyOf::eJobType_anyOf::INVALID_VALUE_OPENAPI_GENERATED)
    {
        success = false;
