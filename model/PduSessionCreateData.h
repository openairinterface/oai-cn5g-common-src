...
public:
    ...
    void setSmallDataRateStatus(oai::_3gpp::model::SmallDataRateStatus const& value);
    ...
    /// 
    /// </summary>
    oai::_3gpp::model::RedundantPduSessionInformation getRedundantPduSessionInfo() const;
    void setRedundantPduSessionInfo(oai::_3gpp::model::RedundantPduSessionInformation const& value);
