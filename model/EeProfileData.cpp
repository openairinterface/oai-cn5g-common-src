...
bool EeProfileData::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "EeProfileData" : pathPrefix;
...
std::vector<oai::model::EventType> EeProfileData::getRestrictedEventTypes() const
{
    return m_RestrictedEventTypes;
}
void EeProfileData::setRestrictedEventTypes(std::vector<oai::model::EventType> const& value)
{
...
std::map<std::string, std::vector<oai::model::MtcProvider>> EeProfileData::getAllowedMtcProvider() const
{
    return m_AllowedMtcProvider;
}
void EeProfileData::setAllowedMtcProvider(std::map<std::string, std::vector<oai::model::MtcProvider>> const& value)
{
