...
oai::_3gpp::model::CommunicationCharacteristicsAF PpDataEntry::getCommunicationCharacteristics() const
{
    return m_CommunicationCharacteristics;
}
void PpDataEntry::setCommunicationCharacteristics(oai::_3gpp::model::CommunicationCharacteristicsAF const& value)
{
...
oai::_3gpp::model::EcsAddrConfigInfo_1 PpDataEntry::getEcsAddrConfigInfo() const
{
    return m_EcsAddrConfigInfo;
}
void PpDataEntry::setEcsAddrConfigInfo(oai::_3gpp::model::EcsAddrConfigInfo_1 const& value)
{
...
std::vector<oai::_3gpp::model::EcsAddrConfigInfo_1> PpDataEntry::getAdditionalEcsAddrConfigInfos() const
{
    return m_AdditionalEcsAddrConfigInfos;
}
void PpDataEntry::setAdditionalEcsAddrConfigInfos(std::vector<oai::_3gpp::model::EcsAddrConfigInfo_1> const& value)
{
...
void PpDataEntry::setEcRestriction(oai::_3gpp::model::EcRestriction_1 const& value)
{
