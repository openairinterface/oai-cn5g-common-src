...
bool MbsfnArea::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
...
bool MbsfnArea::operator==(const MbsfnArea& rhs) const
{
    ...
    ((!mbsfnAreaIdIsSet() && !rhs.mbsfnAreaIdIsSet()) || (mbsfnAreaIdIsSet() && rhs.mbsfnAreaIdIsSet() && getMbsfnAreaId() == rhs.getMbsfnAreaId())) &&
    
    
    ((!carrierFrequencyIsSet() && !rhs.carrierFrequencyIsSet()) || (carrierFrequencyIsSet() && rhs.carrierFrequencyIsSet() && getCarrierFrequency() == rhs.getCarrierFrequency()))
