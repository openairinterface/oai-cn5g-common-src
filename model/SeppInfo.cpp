...
std::vector<oai::model::PlmnId> SeppInfo::getRemotePlmnList() const
{
    return m_RemotePlmnList;
}
void SeppInfo::setRemotePlmnList(std::vector<oai::model::PlmnId> const& value)
{
...
std::vector<oai::model::PlmnIdNid> SeppInfo::getRemoteSnpnList() const
{
    return m_RemoteSnpnList;
}
void SeppInfo::setRemoteSnpnList(std::vector<oai::model::PlmnIdNid> const& value)
{
