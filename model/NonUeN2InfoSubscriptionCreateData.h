...
public:
    ...
    virtual ~NonUeN2InfoSubscriptionCreateData() = default;
    ...
    bool operator==(const NonUeN2InfoSubscriptionCreateData& rhs) const;
    bool operator!=(const NonUeN2InfoSubscriptionCreateData& rhs) const;
    ...
    /// 
    /// </summary>
    std::vector<oai::model::GlobalRanNodeId> getGlobalRanNodeList() const;
    void setGlobalRanNodeList(std::vector<oai::model::GlobalRanNodeId> const& value);
    bool globalRanNodeListIsSet() const;
    void unsetGlobalRanNodeList();
    /// <summary>
    /// 
    /// </summary>
    std::vector<oai::model::AccessType> getAnTypeList() const;
    void setAnTypeList(std::vector<oai::model::AccessType> const& value);
    ...
    friend  void to_json(nlohmann::json& j, const NonUeN2InfoSubscriptionCreateData& o);
    friend  void from_json(const nlohmann::json& j, NonUeN2InfoSubscriptionCreateData& o);
protected:
    std::vector<oai::model::GlobalRanNodeId> m_GlobalRanNodeList;
    bool m_GlobalRanNodeListIsSet;
    std::vector<oai::model::AccessType> m_AnTypeList;
