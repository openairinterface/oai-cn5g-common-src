...
bool RequestedUsageData::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "RequestedUsageData" : pathPrefix;
...
bool RequestedUsageData::operator==(const RequestedUsageData& rhs) const
{
    ...
    ((!refUmIdsIsSet() && !rhs.refUmIdsIsSet()) || (refUmIdsIsSet() && rhs.refUmIdsIsSet() && getRefUmIds() == rhs.getRefUmIds())) &&
    
    
    ((!allUmIdsIsSet() && !rhs.allUmIdsIsSet()) || (allUmIdsIsSet() && rhs.allUmIdsIsSet() && isAllUmIds() == rhs.isAllUmIds()))
