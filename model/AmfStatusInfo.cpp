...
void AmfStatusInfo::setGuamiList(std::vector<oai::_3gpp::model::Guami> const& value)
{
    m_GuamiList = value;
}
...
void AmfStatusInfo::setStatusChange(oai::_3gpp::model::StatusChange const& value)
{
