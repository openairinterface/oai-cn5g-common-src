...
bool HsmfUpdateData::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    ...
    {
        const std::vector<oai::_3gpp::model::QosFlowItem>& value = m_QosFlowsRelNotifyList;
    ...
    {
        const std::vector<oai::_3gpp::model::QosFlowNotifyItem>& value = m_QosFlowsNotifyList;
    ...
    if (notifyListIsSet())
    {
        const std::vector<oai::_3gpp::model::PduSessionNotifyItem>& value = m_NotifyList;
    ...
    {
        const std::vector<oai::_3gpp::model::SecondaryRatUsageReport>& value = m_SecondaryRatUsageReport;
    ...
    {
        const std::vector<oai::_3gpp::model::SecondaryRatUsageInfo>& value = m_SecondaryRatUsageInfo;
    ...
    {
        const std::vector<oai::_3gpp::model::std::string>& value = m_SecondaryRatUsageDataReportContainer;
...
oai::_3gpp::model::RequestIndication HsmfUpdateData::getRequestIndication() const
{
    return m_RequestIndication;
}
void HsmfUpdateData::setRequestIndication(oai::_3gpp::model::RequestIndication const& value)
{
...
void HsmfUpdateData::setVcnTunnelInfo(oai::_3gpp::model::TunnelInfo const& value)
{
...
void HsmfUpdateData::setIcnTunnelInfo(oai::_3gpp::model::TunnelInfo const& value)
{
...
oai::_3gpp::model::TunnelInfo HsmfUpdateData::getAdditionalCnTunnelInfo() const
{
    return m_AdditionalCnTunnelInfo;
}
void HsmfUpdateData::setAdditionalCnTunnelInfo(oai::_3gpp::model::TunnelInfo const& value)
{
...
void HsmfUpdateData::setServingNetwork(oai::_3gpp::model::PlmnIdNid const& value)
{
...
void HsmfUpdateData::setAdditionalAnType(oai::_3gpp::model::AccessType const& value)
{
...
void HsmfUpdateData::setUeLocation(oai::_3gpp::model::UserLocation const& value)
{
    m_UeLocation = value;
...
void HsmfUpdateData::setAddUeLocation(oai::_3gpp::model::UserLocation const& value)
{
...
void HsmfUpdateData::setN1SmInfoFromUe(oai::_3gpp::model::RefToBinaryData const& value)
{
...
void HsmfUpdateData::setUnknownN1SmInfo(oai::_3gpp::model::RefToBinaryData const& value)
{
...
std::vector<oai::_3gpp::model::QosFlowItem> HsmfUpdateData::getQosFlowsRelNotifyList() const
{
    return m_QosFlowsRelNotifyList;
}
void HsmfUpdateData::setQosFlowsRelNotifyList(std::vector<oai::_3gpp::model::QosFlowItem> const& value)
{
...
std::vector<oai::_3gpp::model::QosFlowNotifyItem> HsmfUpdateData::getQosFlowsNotifyList() const
{
    return m_QosFlowsNotifyList;
}
void HsmfUpdateData::setQosFlowsNotifyList(std::vector<oai::_3gpp::model::QosFlowNotifyItem> const& value)
{
...
std::vector<oai::_3gpp::model::PduSessionNotifyItem> HsmfUpdateData::getNotifyList() const
{
    return m_NotifyList;
}
void HsmfUpdateData::setNotifyList(std::vector<oai::_3gpp::model::PduSessionNotifyItem> const& value)
{
    m_NotifyList = value;
...
oai::_3gpp::model::EpsInterworkingIndication HsmfUpdateData::getEpsInterworkingInd() const
{
    return m_EpsInterworkingInd;
}
void HsmfUpdateData::setEpsInterworkingInd(oai::_3gpp::model::EpsInterworkingIndication const& value)
{
...
std::vector<oai::_3gpp::model::SecondaryRatUsageReport> HsmfUpdateData::getSecondaryRatUsageReport() const
{
    return m_SecondaryRatUsageReport;
}
void HsmfUpdateData::setSecondaryRatUsageReport(std::vector<oai::_3gpp::model::SecondaryRatUsageReport> const& value)
{
...
std::vector<oai::_3gpp::model::SecondaryRatUsageInfo> HsmfUpdateData::getSecondaryRatUsageInfo() const
{
    return m_SecondaryRatUsageInfo;
}
void HsmfUpdateData::setSecondaryRatUsageInfo(std::vector<oai::_3gpp::model::SecondaryRatUsageInfo> const& value)
{
...
void HsmfUpdateData::setMaReleaseInd(oai::_3gpp::model::MaReleaseIndication const& value)
{
...
oai::_3gpp::model::UnavailableAccessIndication HsmfUpdateData::getUnavailableAccessInd() const
{
    return m_UnavailableAccessInd;
}
void HsmfUpdateData::setUnavailableAccessInd(oai::_3gpp::model::UnavailableAccessIndication const& value)
{
...
std::vector<oai::_3gpp::model::PsaInformation> HsmfUpdateData::getPsaInfo() const
{
    return m_PsaInfo;
}
void HsmfUpdateData::setPsaInfo(std::vector<oai::_3gpp::model::PsaInformation> const& value)
{
    m_PsaInfo = value;
    m_PsaInfoIsSet = true;
}
...
void HsmfUpdateData::setUlclBpInfo(oai::_3gpp::model::UlclBpInformation const& value)
{
    m_UlclBpInfo = value;
...
void HsmfUpdateData::setN4InfoExt1(oai::_3gpp::model::N4Information const& value)
{
    m_N4InfoExt1 = value;
...
void HsmfUpdateData::setN4InfoExt2(oai::_3gpp::model::N4Information const& value)
{
    m_N4InfoExt2 = value;
...
void HsmfUpdateData::setPresenceInLadn(oai::_3gpp::model::PresenceState const& value)
{
...
std::vector<oai::_3gpp::model::std::string> HsmfUpdateData::getDnaiList() const
{
    return m_DnaiList;
}
void HsmfUpdateData::setDnaiList(std::vector<oai::_3gpp::model::std::string> const& value)
{
    m_DnaiList = value;
...
oai::_3gpp::model::RoamingChargingProfile HsmfUpdateData::getRoamingChargingProfile() const
{
    return m_RoamingChargingProfile;
}
void HsmfUpdateData::setRoamingChargingProfile(oai::_3gpp::model::RoamingChargingProfile const& value)
{
...
oai::_3gpp::model::MoExpDataCounter HsmfUpdateData::getMoExpDataCounter() const
{
    return m_MoExpDataCounter;
}
void HsmfUpdateData::setMoExpDataCounter(oai::_3gpp::model::MoExpDataCounter const& value)
{
...
void HsmfUpdateData::setSecurityResult(oai::_3gpp::model::SecurityResult const& value)
{
...
void HsmfUpdateData::setUpSecurityInfo(oai::_3gpp::model::UpSecurityInfo const& value)
{
...
std::vector<oai::_3gpp::model::std::string> HsmfUpdateData::getSecondaryRatUsageDataReportContainer() const
{
    return m_SecondaryRatUsageDataReportContainer;
}
void HsmfUpdateData::setSecondaryRatUsageDataReportContainer(std::vector<oai::_3gpp::model::std::string> const& value)
{
...
oai::_3gpp::model::PcfUeCallbackInfo HsmfUpdateData::getPcfUeCallbackInfo() const
{
    return m_PcfUeCallbackInfo;
}
void HsmfUpdateData::setPcfUeCallbackInfo(oai::_3gpp::model::PcfUeCallbackInfo const& value)
{
...
oai::_3gpp::model::SatelliteBackhaulCategory HsmfUpdateData::getSatelliteBackhaulCat() const
{
    return m_SatelliteBackhaulCat;
}
void HsmfUpdateData::setSatelliteBackhaulCat(oai::_3gpp::model::SatelliteBackhaulCategory const& value)
{
...
oai::_3gpp::model::MaxIntegrityProtectedDataRate HsmfUpdateData::getMaxIntegrityProtectedDataRateUl() const
{
    return m_MaxIntegrityProtectedDataRateUl;
}
void HsmfUpdateData::setMaxIntegrityProtectedDataRateUl(oai::_3gpp::model::MaxIntegrityProtectedDataRate const& value)
{
...
oai::_3gpp::model::MaxIntegrityProtectedDataRate HsmfUpdateData::getMaxIntegrityProtectedDataRateDl() const
{
    return m_MaxIntegrityProtectedDataRateDl;
}
void HsmfUpdateData::setMaxIntegrityProtectedDataRateDl(oai::_3gpp::model::MaxIntegrityProtectedDataRate const& value)
{
