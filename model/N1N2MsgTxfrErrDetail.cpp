...
bool N1N2MsgTxfrErrDetail::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "N1N2MsgTxfrErrDetail" : pathPrefix;
...
bool N1N2MsgTxfrErrDetail::operator==(const N1N2MsgTxfrErrDetail& rhs) const
{
    ...
    ((!retryAfterIsSet() && !rhs.retryAfterIsSet()) || (retryAfterIsSet() && rhs.retryAfterIsSet() && getRetryAfter() == rhs.getRetryAfter())) &&
    
    
    ((!highestPrioArpIsSet() && !rhs.highestPrioArpIsSet()) || (highestPrioArpIsSet() && rhs.highestPrioArpIsSet() && getHighestPrioArp() == rhs.getHighestPrioArp())) &&
...
oai::model::Arp N1N2MsgTxfrErrDetail::getHighestPrioArp() const
{
    return m_HighestPrioArp;
}
void N1N2MsgTxfrErrDetail::setHighestPrioArp(oai::model::Arp const& value)
{
