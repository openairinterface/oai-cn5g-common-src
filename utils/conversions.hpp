...
public:
  ...
  static std::string mccToString(uint8_t digit1, uint8_t digit2,
                                 uint8_t digit3);
  static std::string mncToString(uint8_t digit1, uint8_t digit2,
                                 uint8_t digit3);
  ...
  static bool string_to_int(const std::string &str, uint32_t &value,
                            uint8_t base);
  ...
  static void int_to_string_hex(uint64_t value, std::string &value_str,
                                uint8_t length = 0);
  ...
  static void get_amf_id(uint8_t amf_region_id, uint16_t amf_set_id,
                         uint8_t amf_pointer, uint32_t &amf_id);
  static void get_amf_id(uint8_t amf_region_id, uint16_t amf_set_id,
                         uint8_t amf_pointer, std::string &amf_id);
  static void get_amf_id(const std::string &amf_region_id,
                         const std::string &amf_set_id,
                         const std::string &amf_pointer, uint32_t &amf_id);
  static void get_amf_id(const std::string &amf_region_id,
                         const std::string &amf_set_id,
                         const std::string &amf_pointer, std::string &amf_id);
  static void convert_string_2_hex(const std::string &input_str,
                                   std::string &output_str);
  static void string_to_uint_mac_address(const std::string &macStr,
   ...
   * @param j
   */
  static void fix_primitive_json_values(nlohmann::json &j,
                                        bool parse_hex_values = false);
