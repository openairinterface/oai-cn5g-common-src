...
bool DddTrafficDescriptor::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "DddTrafficDescriptor" : pathPrefix;
...
oai::_3gpp::model::Ipv6Addr DddTrafficDescriptor::getIpv6Addr() const
{
    return m_Ipv6Addr;
}
void DddTrafficDescriptor::setIpv6Addr(oai::_3gpp::model::Ipv6Addr const& value)
{
    m_Ipv6Addr = value;
