...
public:
    ...
    void setRouteToLocs(std::vector<oai::_3gpp::model::RouteToLocation> const& value);
    bool routeToLocsIsSet() const;
    void unsetRouteToLocs();
    /// <summary>
    /// 
    /// </summary>
    oai::_3gpp::model::SpatialValidityRm getSpVal() const;
    void setSpVal(oai::_3gpp::model::SpatialValidityRm const& value);
    bool spValIsSet() const;
    void unsetSpVal();
    /// <summary>
    /// 
    /// </summary>
    std::vector<oai::_3gpp::model::TemporalValidity> getTempVals() const;
    void setTempVals(std::vector<oai::_3gpp::model::TemporalValidity> const& value);
    bool tempValsIsSet() const;
    void unsetTempVals();
    /// <summary>
    /// 
    /// </summary>
    oai::_3gpp::model::UpPathChgEvent getUpPathChgSub() const;
    void setUpPathChgSub(oai::_3gpp::model::UpPathChgEvent const& value);
    ...
    /// </summary>
    std::vector<oai::_3gpp::model::EasIpReplacementInfo> getEasIpReplaceInfos() const;
    void setEasIpReplaceInfos(std::vector<oai::_3gpp::model::EasIpReplacementInfo> const& value);
...
protected:
    ...
    oai::_3gpp::model::SpatialValidityRm m_SpVal;
    bool m_SpValIsSet;
    std::vector<oai::_3gpp::model::TemporalValidity> m_TempVals;
    bool m_TempValsIsSet;
    oai::_3gpp::model::UpPathChgEvent m_UpPathChgSub;
