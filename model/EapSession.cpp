...
bool EapSession::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "EapSession" : pathPrefix;
...
bool EapSession::operator==(const EapSession& rhs) const
{
    ...
    ((!kSeafIsSet() && !rhs.kSeafIsSet()) || (kSeafIsSet() && rhs.kSeafIsSet() && getKSeaf() == rhs.getKSeaf())) &&
    
    
    ((!linksIsSet() && !rhs.linksIsSet()) || (linksIsSet() && rhs.linksIsSet() && getLinks() == rhs.getLinks())) &&
    
    
    ((!authResultIsSet() && !rhs.authResultIsSet()) || (authResultIsSet() && rhs.authResultIsSet() && getAuthResult() == rhs.getAuthResult())) &&
    ...
    ((!mskIsSet() && !rhs.mskIsSet()) || (mskIsSet() && rhs.mskIsSet() && getMsk() == rhs.getMsk()))
...
std::map<std::string, oai::model::LinksValueSchema> EapSession::getLinks() const
{
    return m__links;
}
void EapSession::setLinks(std::map<std::string, oai::model::LinksValueSchema> const& value)
{
    m__links = value;
    m__linksIsSet = true;
}
...
oai::model::AuthResult EapSession::getAuthResult() const
{
    return m_AuthResult;
}
void EapSession::setAuthResult(oai::model::AuthResult const& value)
{
    m_AuthResult = value;
...
std::vector<oai::model::ServerAddressingInfo> EapSession::getPvsInfo() const
{
    return m_PvsInfo;
}
void EapSession::setPvsInfo(std::vector<oai::model::ServerAddressingInfo> const& value)
{
    m_PvsInfo = value;
    m_PvsInfoIsSet = true;
}
