...
public:
    ...
    /// 
    /// </summary>
    oai::_3gpp::model::HssAuthenticationVectors getHssAuthenticationVectors() const;
    void setHssAuthenticationVectors(oai::_3gpp::model::HssAuthenticationVectors const& value);
