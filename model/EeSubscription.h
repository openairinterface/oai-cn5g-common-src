...
public:
    ...
    /// </summary>
    std::map<std::string, oai::_3gpp::model::MonitoringConfiguration> getMonitoringConfigurations() const;
    void setMonitoringConfigurations(std::map<std::string, oai::_3gpp::model::MonitoringConfiguration> const& value);
    /// <summary>
    /// 
    /// </summary>
...
protected:
    ...
    std::map<std::string, oai::_3gpp::model::MonitoringConfiguration> m_MonitoringConfigurations;
