...
extern asn_TYPE_descriptor_t asn_DEF_Ngap_outOfCoverage
    __attribute__((weak, alias("asn_DEF_Ngap_outOfCoverage_2")));
#else
static asn_TYPE_descriptor_t asn_DEF_Ngap_outOfCoverage_2;
static asn_TYPE_descriptor_t asn_DEF_Ngap_outOfCoverage;
__attribute__((constructor)) static void
asn_DEF_Ngap_outOfCoverage_2_alias_init(void) {
...
#if !defined(ASN_DISABLE_OER_SUPPORT)
asn_oer_constraints_t asn_OER_type_Ngap_EventTrigger_constr_1 CC_NOTUSED = {
    {0, 0},
    -1};
#endif /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
...
static int asn_validate_Ngap_outOfCoverage_2(
    const asn_TYPE_descriptor_t* td, const void* sptr,
    asn_app_constraint_failed_f* ctfailcb, void* app_key) {
  if (!sptr) {
    return -1;
  }
  e_Ngap_EventTrigger__outOfCoverage value =
      *(e_Ngap_EventTrigger__outOfCoverage*) sptr;
  switch (value) {
...
static /* Use -fall-defs-global to expose */
    asn_TYPE_descriptor_t asn_DEF_Ngap_outOfCoverage_2 = {
        ...
        sizeof(asn_DEF_Ngap_outOfCoverage_tags_2) /
                sizeof(asn_DEF_Ngap_outOfCoverage_tags_2[0]) -
            1,                             /* 1 */
...
asn_TYPE_member_t asn_MBR_Ngap_EventTrigger_1[] = {
    {ATF_NOFLAGS,
     0,
     offsetof(struct Ngap_EventTrigger, choice.outOfCoverage),
    ...
    {ATF_POINTER,
     0,
     offsetof(struct Ngap_EventTrigger, choice.eventL1LoggedMDTConfig),
    ...
    {ATF_POINTER,
     ...
     -1, /* IMPLICIT tag at current level */
     &asn_DEF_Ngap_ProtocolIE_SingleContainer_12877P14,
     0,
     {
#if !defined(ASN_DISABLE_OER_SUPPORT)
         0,
