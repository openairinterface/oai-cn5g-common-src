...
oai::model::Ipv6Addr IpMulticastAddressInfo::getSrcIpv6Addr() const
{
    return m_SrcIpv6Addr;
}
void IpMulticastAddressInfo::setSrcIpv6Addr(oai::model::Ipv6Addr const& value)
{
    m_SrcIpv6Addr = value;
...
oai::model::Ipv6Addr IpMulticastAddressInfo::getIpv6MulAddr() const
{
    return m_Ipv6MulAddr;
}
void IpMulticastAddressInfo::setIpv6MulAddr(oai::model::Ipv6Addr const& value)
{
    m_Ipv6MulAddr = value;
