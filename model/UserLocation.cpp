...
oai::_3gpp::model::EutraLocation UserLocation::getEutraLocation() const
{
    return m_EutraLocation;
}
void UserLocation::setEutraLocation(oai::_3gpp::model::EutraLocation const& value)
{
...
oai::_3gpp::model::NrLocation UserLocation::getNrLocation() const
{
    return m_NrLocation;
}
void UserLocation::setNrLocation(oai::_3gpp::model::NrLocation const& value)
{
    m_NrLocation = value;
...
oai::_3gpp::model::N3gaLocation UserLocation::getN3gaLocation() const
{
    return m_N3gaLocation;
}
void UserLocation::setN3gaLocation(oai::_3gpp::model::N3gaLocation const& value)
{
...
oai::_3gpp::model::UtraLocation UserLocation::getUtraLocation() const
{
    return m_UtraLocation;
}
void UserLocation::setUtraLocation(oai::_3gpp::model::UtraLocation const& value)
{
...
oai::_3gpp::model::GeraLocation UserLocation::getGeraLocation() const
{
    return m_GeraLocation;
}
void UserLocation::setGeraLocation(oai::_3gpp::model::GeraLocation const& value)
{
