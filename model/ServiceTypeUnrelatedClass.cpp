...
bool ServiceTypeUnrelatedClass::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "ServiceTypeUnrelatedClass" : pathPrefix;
    ...
    {
        const std::vector<oai::_3gpp::model::GeographicArea>& value = m_AllowedGeographicArea;
        ...
        success = value.validate(msg, currentValuePath + ".allowedGeographicArea") && success;
    ...
    {
        const std::vector<oai::_3gpp::model::std::string>& value = m_CodeWordList;
...
bool ServiceTypeUnrelatedClass::operator==(const ServiceTypeUnrelatedClass& rhs) const
{
    return
    ...
    ((!allowedGeographicAreaIsSet() && !rhs.allowedGeographicAreaIsSet()) || (allowedGeographicAreaIsSet() && rhs.allowedGeographicAreaIsSet() && getAllowedGeographicArea() == rhs.getAllowedGeographicArea())) &&
    
    
    ((!privacyCheckRelatedActionIsSet() && !rhs.privacyCheckRelatedActionIsSet()) || (privacyCheckRelatedActionIsSet() && rhs.privacyCheckRelatedActionIsSet() && getPrivacyCheckRelatedAction() == rhs.getPrivacyCheckRelatedAction())) &&
    
    
    ((!codeWordIndIsSet() && !rhs.codeWordIndIsSet()) || (codeWordIndIsSet() && rhs.codeWordIndIsSet() && getCodeWordInd() == rhs.getCodeWordInd())) &&
    
    
    ((!validTimePeriodIsSet() && !rhs.validTimePeriodIsSet()) || (validTimePeriodIsSet() && rhs.validTimePeriodIsSet() && getValidTimePeriod() == rhs.getValidTimePeriod())) &&
    
    
    ((!codeWordListIsSet() && !rhs.codeWordListIsSet()) || (codeWordListIsSet() && rhs.codeWordListIsSet() && getCodeWordList() == rhs.getCodeWordList()))
...
std::vector<oai::_3gpp::model::GeographicArea> ServiceTypeUnrelatedClass::getAllowedGeographicArea() const
{
    return m_AllowedGeographicArea;
}
void ServiceTypeUnrelatedClass::setAllowedGeographicArea(std::vector<oai::_3gpp::model::GeographicArea> const& value)
{
...
oai::_3gpp::model::PrivacyCheckRelatedAction ServiceTypeUnrelatedClass::getPrivacyCheckRelatedAction() const
{
    return m_PrivacyCheckRelatedAction;
}
void ServiceTypeUnrelatedClass::setPrivacyCheckRelatedAction(oai::_3gpp::model::PrivacyCheckRelatedAction const& value)
{
...
oai::_3gpp::model::CodeWordInd ServiceTypeUnrelatedClass::getCodeWordInd() const
{
    return m_CodeWordInd;
}
void ServiceTypeUnrelatedClass::setCodeWordInd(oai::_3gpp::model::CodeWordInd const& value)
{
    m_CodeWordInd = value;
...
oai::_3gpp::model::ValidTimePeriod ServiceTypeUnrelatedClass::getValidTimePeriod() const
{
    return m_ValidTimePeriod;
}
void ServiceTypeUnrelatedClass::setValidTimePeriod(oai::_3gpp::model::ValidTimePeriod const& value)
{
...
std::vector<oai::_3gpp::model::std::string> ServiceTypeUnrelatedClass::getCodeWordList() const
{
    return m_CodeWordList;
}
void ServiceTypeUnrelatedClass::setCodeWordList(std::vector<oai::_3gpp::model::std::string> const& value)
{
