...
bool BackupAmfInfo::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "BackupAmfInfo" : pathPrefix;
...
bool BackupAmfInfo::operator==(const BackupAmfInfo& rhs) const
{
    ...
    ((!guamiListIsSet() && !rhs.guamiListIsSet()) || (guamiListIsSet() && rhs.guamiListIsSet() && getGuamiList() == rhs.getGuamiList()))
...
std::vector<oai::model::Guami> BackupAmfInfo::getGuamiList() const
{
    return m_GuamiList;
}
void BackupAmfInfo::setGuamiList(std::vector<oai::model::Guami> const& value)
{
    m_GuamiList = value;
