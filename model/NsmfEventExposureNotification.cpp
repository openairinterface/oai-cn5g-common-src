...
std::vector<oai::_3gpp::model::EventNotification> NsmfEventExposureNotification::getEventNotifs() const
{
    return m_EventNotifs;
}
void NsmfEventExposureNotification::setEventNotifs(std::vector<oai::_3gpp::model::EventNotification> const& value)
{
    m_EventNotifs = value;
}
