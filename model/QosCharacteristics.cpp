...
oai::_3gpp::model::QosResourceType QosCharacteristics::getResourceType() const
{
    return m_ResourceType;
}
void QosCharacteristics::setResourceType(oai::_3gpp::model::QosResourceType const& value)
{
