...
public:
    ...
    /// 
    /// </summary>
    oai::model::RatType getSecondaryRatType() const;
    void setSecondaryRatType(oai::model::RatType const& value);
    /// <summary>
    /// 
    /// </summary>
    std::vector<oai::model::QosFlowUsageReport> getQosFlowsUsageData() const;
    void setQosFlowsUsageData(std::vector<oai::model::QosFlowUsageReport> const& value);
    bool qosFlowsUsageDataIsSet() const;
    void unsetQosFlowsUsageData();
    /// <summary>
    /// 
    /// </summary>
    std::vector<oai::model::VolumeTimedReport> getPduSessionUsageData() const;
    void setPduSessionUsageData(std::vector<oai::model::VolumeTimedReport> const& value);
...
protected:
    oai::model::RatType m_SecondaryRatType;

    std::vector<oai::model::QosFlowUsageReport> m_QosFlowsUsageData;
    bool m_QosFlowsUsageDataIsSet;
    std::vector<oai::model::VolumeTimedReport> m_PduSessionUsageData;
