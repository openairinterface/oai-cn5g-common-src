...
void to_json(nlohmann::json& j, const ServiceName_anyOf& o)
{
    ...
    switch (o.getValue())
    {
        ...
        case ServiceName_anyOf::eServiceName_anyOf::_3GPP_ANALYTICSEXPOSURE:
            ...
            break;
        case ServiceName_anyOf::eServiceName_anyOf::_3GPP_RACS_PARAMETER_PROVISIONING:
...
void from_json(const nlohmann::json& j, ServiceName_anyOf& o)
{
    ...
    if (s == "nnrf-nfm") {
     ...
     o.setValue(ServiceName_anyOf::eServiceName_anyOf::_3GPP_RACS_PARAMETER_PROVISIONING);
    } 
     ...
     o.setValue(ServiceName_anyOf::eServiceName_anyOf::NPCF_AM_POLICYAUTHORIZATION);
    } 
