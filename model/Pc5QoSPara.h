...
public:
    ...
    /// 
    /// </summary>
    std::vector<oai::model::Pc5QosFlowItem> getPc5QosFlowList() const;
    void setPc5QosFlowList(std::vector<oai::model::Pc5QosFlowItem> const& value);
    /// <summary>
...
protected:
    std::vector<oai::model::Pc5QosFlowItem> m_Pc5QosFlowList;
