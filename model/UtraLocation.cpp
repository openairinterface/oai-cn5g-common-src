...
bool UtraLocation::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "UtraLocation" : pathPrefix;
...
oai::model::CellGlobalId UtraLocation::getCgi() const
{
    return m_Cgi;
}
void UtraLocation::setCgi(oai::model::CellGlobalId const& value)
{
    m_Cgi = value;
    m_CgiIsSet = true;
}
...
oai::model::ServiceAreaId UtraLocation::getSai() const
{
    return m_Sai;
}
void UtraLocation::setSai(oai::model::ServiceAreaId const& value)
{
    m_Sai = value;
    m_SaiIsSet = true;
}
...
oai::model::LocationAreaId UtraLocation::getLai() const
{
    return m_Lai;
}
void UtraLocation::setLai(oai::model::LocationAreaId const& value)
{
    m_Lai = value;
    m_LaiIsSet = true;
}
...
oai::model::RoutingAreaId UtraLocation::getRai() const
{
    return m_Rai;
}
void UtraLocation::setRai(oai::model::RoutingAreaId const& value)
{
    m_Rai = value;
    m_RaiIsSet = true;
}
