...
bool AreaScope::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    ...
    {
        const std::vector<oai::_3gpp::model::std::string>& value = m_EutraCellIdList;
    ...
    {
        const std::vector<oai::_3gpp::model::std::string>& value = m_NrCellIdList;
    ...
    if (tacListIsSet())
    {
        const std::vector<oai::_3gpp::model::std::string>& value = m_TacList;
    ...
    if (tacInfoPerPlmnIsSet())
    {
        const std::map<std::string, oai::_3gpp::model::TacInfo>& value = m_TacInfoPerPlmn;
        const std::string currentValuePath = _pathPrefix + ".tacInfoPerPlmn";
...
bool AreaScope::operator==(const AreaScope& rhs) const
{
    ...
    ((!eutraCellIdListIsSet() && !rhs.eutraCellIdListIsSet()) || (eutraCellIdListIsSet() && rhs.eutraCellIdListIsSet() && getEutraCellIdList() == rhs.getEutraCellIdList())) &&
    
    
    ((!nrCellIdListIsSet() && !rhs.nrCellIdListIsSet()) || (nrCellIdListIsSet() && rhs.nrCellIdListIsSet() && getNrCellIdList() == rhs.getNrCellIdList())) &&
    
    
    ((!tacListIsSet() && !rhs.tacListIsSet()) || (tacListIsSet() && rhs.tacListIsSet() && getTacList() == rhs.getTacList())) &&
    
    
    ((!tacInfoPerPlmnIsSet() && !rhs.tacInfoPerPlmnIsSet()) || (tacInfoPerPlmnIsSet() && rhs.tacInfoPerPlmnIsSet() && getTacInfoPerPlmn() == rhs.getTacInfoPerPlmn()))
...
std::vector<oai::_3gpp::model::std::string> AreaScope::getEutraCellIdList() const
{
    return m_EutraCellIdList;
}
void AreaScope::setEutraCellIdList(std::vector<oai::_3gpp::model::std::string> const& value)
{
...
std::vector<oai::_3gpp::model::std::string> AreaScope::getNrCellIdList() const
{
    return m_NrCellIdList;
}
void AreaScope::setNrCellIdList(std::vector<oai::_3gpp::model::std::string> const& value)
{
...
std::vector<oai::_3gpp::model::std::string> AreaScope::getTacList() const
{
    return m_TacList;
}
void AreaScope::setTacList(std::vector<oai::_3gpp::model::std::string> const& value)
{
    m_TacList = value;
    m_TacListIsSet = true;
}
...
std::map<std::string, oai::_3gpp::model::TacInfo> AreaScope::getTacInfoPerPlmn() const
{
    return m_TacInfoPerPlmn;
}
void AreaScope::setTacInfoPerPlmn(std::map<std::string, oai::_3gpp::model::TacInfo> const& value)
{
