...
oai::model::LocationAccuracy LocationReportingConfiguration::getAccuracy() const
{
    return m_Accuracy;
}
void LocationReportingConfiguration::setAccuracy(oai::model::LocationAccuracy const& value)
{
    m_Accuracy = value;
...
oai::model::LocationAccuracy LocationReportingConfiguration::getN3gppAccuracy() const
{
    return m_N3gppAccuracy;
}
void LocationReportingConfiguration::setN3gppAccuracy(oai::model::LocationAccuracy const& value)
{
