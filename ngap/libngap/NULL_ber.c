 ...
 * Decode NULL type.
 */
asn_dec_rval_t NULL_decode_ber(const asn_codec_ctx_t *opt_codec_ctx,
                               const asn_TYPE_descriptor_t *td,
                               void **bool_value, const void *buf_ptr,
...
asn_enc_rval_t NULL_encode_der(const asn_TYPE_descriptor_t *td, const void *ptr,
