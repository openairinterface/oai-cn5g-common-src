...
*/
/*
 * RelocateUEContext_request.h
 *
 * 
 */

#ifndef RelocateUEContext_request_H_
#define RelocateUEContext_request_H_
...
/// 
/// </summary>
class  RelocateUEContext_request
{
public:
    RelocateUEContext_request();
    virtual ~RelocateUEContext_request() = default;
    ...
    bool operator==(const RelocateUEContext_request& rhs) const;
    bool operator!=(const RelocateUEContext_request& rhs) const;

    /////////////////////////////////////////////
    /// RelocateUEContext_request members

    /// <summary>
    /// 
    /// </summary>
    oai::_3gpp::model::UeContextRelocateData getJsonData() const;
    void setJsonData(oai::_3gpp::model::UeContextRelocateData const& value);
    bool jsonDataIsSet() const;
    void unsetJsonData();
    /// <summary>
    /// 
    /// </summary>
    std::string getBinaryDataForwardRelocationRequest() const;
    void setBinaryDataForwardRelocationRequest(std::string const& value);
    bool binaryDataForwardRelocationRequestIsSet() const;
    void unsetBinaryDataForwardRelocationRequest();
    /// <summary>
    /// 
    /// </summary>
    ...
    friend void to_json(nlohmann::json& j, const RelocateUEContext_request& o);
    friend void from_json(const nlohmann::json& j, RelocateUEContext_request& o);
protected:
    oai::_3gpp::model::UeContextRelocateData m_JsonData;
    bool m_JsonDataIsSet;
    std::string m_BinaryDataForwardRelocationRequest;
    bool m_BinaryDataForwardRelocationRequestIsSet;
...
#endif /* RelocateUEContext_request_H_ */
