...
void AuthenticationInfoResult::setAuthType(oai::_3gpp::model::AuthType const& value)
{
    m_AuthType = value;
}
...
oai::_3gpp::model::AuthenticationVector AuthenticationInfoResult::getAuthenticationVector() const
{
    return m_AuthenticationVector;
}
void AuthenticationInfoResult::setAuthenticationVector(oai::_3gpp::model::AuthenticationVector const& value)
{
...
std::vector<oai::_3gpp::model::ServerAddressingInfo> AuthenticationInfoResult::getPvsInfo() const
{
    return m_PvsInfo;
}
void AuthenticationInfoResult::setPvsInfo(std::vector<oai::_3gpp::model::ServerAddressingInfo> const& value)
{
    m_PvsInfo = value;
    m_PvsInfoIsSet = true;
}
