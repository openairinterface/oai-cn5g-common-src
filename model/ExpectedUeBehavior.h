...
public:
    ...
    /// 
    /// </summary>
    std::vector<oai::model::UserLocation> getExpMoveTrajectory() const;
    void setExpMoveTrajectory(std::vector<oai::model::UserLocation> const& value);
    /// <summary>
...
protected:
    std::vector<oai::model::UserLocation> m_ExpMoveTrajectory;
