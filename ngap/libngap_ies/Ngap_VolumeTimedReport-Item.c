...
static int memb_Ngap_startTimeStamp_constraint_1(
...
static int memb_Ngap_endTimeStamp_constraint_1(
    const asn_TYPE_descriptor_t* td, const void* sptr,
    asn_app_constraint_failed_f* ctfailcb, void* app_key) {
  const OCTET_STRING_t* st = (const OCTET_STRING_t*) sptr;
  size_t size;
...
static int memb_Ngap_usageCountUL_constraint_1(
    const asn_TYPE_descriptor_t* td, const void* sptr,
    asn_app_constraint_failed_f* ctfailcb, void* app_key) {
  static const asn_cval_t asn_CVAL_Ngap_usageCountUL_4_lb = {
      ACV_UINT, {.u = UINTMAX_C(0)}};
  static const asn_cval_t asn_CVAL_Ngap_usageCountUL_4_ub = {
      ACV_UINT, {.u = UINTMAX_C(18446744073709551615)}};
  ...
  if (asn_check_INTEGER_range(
          st, &asn_CVAL_Ngap_usageCountUL_4_lb,
          &asn_CVAL_Ngap_usageCountUL_4_ub, 0) == 0) {
    /* Constraint check succeeded */
    return 0;
  } else {
    ASN__CTFAIL(
...
static int memb_Ngap_usageCountDL_constraint_1(
    const asn_TYPE_descriptor_t* td, const void* sptr,
    asn_app_constraint_failed_f* ctfailcb, void* app_key) {
  static const asn_cval_t asn_CVAL_Ngap_usageCountDL_5_lb = {
      ACV_UINT, {.u = UINTMAX_C(0)}};
  static const asn_cval_t asn_CVAL_Ngap_usageCountDL_5_ub = {
      ACV_UINT, {.u = UINTMAX_C(18446744073709551615)}};
  const INTEGER_t* st = (const INTEGER_t*) sptr;
  ...
  if (asn_check_INTEGER_range(
          st, &asn_CVAL_Ngap_usageCountDL_5_lb,
          &asn_CVAL_Ngap_usageCountDL_5_ub, 0) == 0) {
    /* Constraint check succeeded */
    return 0;
  } else {
    ASN__CTFAIL(
...
asn_TYPE_member_t asn_MBR_Ngap_VolumeTimedReport_Item_1[] = {
    {ATF_NOFLAGS,
     0,
     offsetof(struct Ngap_VolumeTimedReport_Item, startTimeStamp),
    ...
    {ATF_NOFLAGS,
     0,
     offsetof(struct Ngap_VolumeTimedReport_Item, endTimeStamp),
    ...
    {ATF_NOFLAGS,
     0,
     offsetof(struct Ngap_VolumeTimedReport_Item, usageCountUL),
    ...
    {ATF_NOFLAGS,
     0,
     offsetof(struct Ngap_VolumeTimedReport_Item, usageCountDL),
    ...
    {ATF_POINTER,
     1,
     offsetof(struct Ngap_VolumeTimedReport_Item, iE_Extensions),
     (ASN_TAG_CLASS_CONTEXT | (4 << 2)),
     -1, /* IMPLICIT tag at current level */
     &asn_DEF_Ngap_ProtocolExtensionContainer_11980P370,
     0,
     {
#if !defined(ASN_DISABLE_OER_SUPPORT)
         0,
