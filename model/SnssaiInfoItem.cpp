...
std::vector<oai::_3gpp::model::DnnInfoItem> SnssaiInfoItem::getDnnInfoList() const
{
    return m_DnnInfoList;
}
void SnssaiInfoItem::setDnnInfoList(std::vector<oai::_3gpp::model::DnnInfoItem> const& value)
{
    m_DnnInfoList = value;
}
