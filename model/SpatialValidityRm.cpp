...
std::map<std::string, oai::_3gpp::model::PresenceInfo> SpatialValidityRm::getPresenceInfoList() const
{
    return m_PresenceInfoList;
}
void SpatialValidityRm::setPresenceInfoList(std::map<std::string, oai::_3gpp::model::PresenceInfo> const& value)
{
