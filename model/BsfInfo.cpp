...
std::vector<oai::_3gpp::model::Ipv4AddressRange> BsfInfo::getIpv4AddressRanges() const
{
    return m_Ipv4AddressRanges;
}
void BsfInfo::setIpv4AddressRanges(std::vector<oai::_3gpp::model::Ipv4AddressRange> const& value)
{
...
std::vector<oai::_3gpp::model::Ipv6PrefixRange> BsfInfo::getIpv6PrefixRanges() const
{
    return m_Ipv6PrefixRanges;
}
void BsfInfo::setIpv6PrefixRanges(std::vector<oai::_3gpp::model::Ipv6PrefixRange> const& value)
{
...
std::vector<oai::_3gpp::model::SupiRange> BsfInfo::getSupiRanges() const
{
    return m_SupiRanges;
}
void BsfInfo::setSupiRanges(std::vector<oai::_3gpp::model::SupiRange> const& value)
{
    m_SupiRanges = value;
...
std::vector<oai::_3gpp::model::IdentityRange> BsfInfo::getGpsiRanges() const
{
    return m_GpsiRanges;
}
void BsfInfo::setGpsiRanges(std::vector<oai::_3gpp::model::IdentityRange> const& value)
{
    m_GpsiRanges = value;
