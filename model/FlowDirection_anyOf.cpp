...
bool FlowDirection_anyOf::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "FlowDirection_anyOf" : pathPrefix;

    
    if (m_value == FlowDirection_anyOf::eFlowDirection_anyOf::INVALID_VALUE_OPENAPI_GENERATED)
    {
        success = false;
...
void to_json(nlohmann::json& j, const FlowDirection_anyOf& o)
{
    ...
    switch (o.getValue())
    {
        case FlowDirection_anyOf::eFlowDirection_anyOf::INVALID_VALUE_OPENAPI_GENERATED:
...
FlowDirection_anyOf::eFlowDirection_anyOf FlowDirection_anyOf::getValue() const
{
    return m_value;
}
void FlowDirection_anyOf::setValue(FlowDirection_anyOf::eFlowDirection_anyOf value)
{
    m_value = value;
}
