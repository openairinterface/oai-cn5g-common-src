...
void PduSessionCreateData::setHplmnSnssai(oai::_3gpp::model::Snssai const& value)
{
    m_HplmnSnssai = value;
...
void PduSessionCreateData::setServingNetwork(oai::_3gpp::model::PlmnIdNid const& value)
{
...
void PduSessionCreateData::setRequestType(oai::_3gpp::model::RequestType const& value)
{
    m_RequestType = value;
...
void PduSessionCreateData::setVcnTunnelInfo(oai::_3gpp::model::TunnelInfo const& value)
{
...
void PduSessionCreateData::setIcnTunnelInfo(oai::_3gpp::model::TunnelInfo const& value)
{
...
oai::_3gpp::model::TunnelInfo PduSessionCreateData::getN9ForwardingTunnelInfo() const
{
    return m_N9ForwardingTunnelInfo;
}
void PduSessionCreateData::setN9ForwardingTunnelInfo(oai::_3gpp::model::TunnelInfo const& value)
{
...
oai::_3gpp::model::TunnelInfo PduSessionCreateData::getAdditionalCnTunnelInfo() const
{
    return m_AdditionalCnTunnelInfo;
}
void PduSessionCreateData::setAdditionalCnTunnelInfo(oai::_3gpp::model::TunnelInfo const& value)
{
...
void PduSessionCreateData::setAnType(oai::_3gpp::model::AccessType const& value)
{
    m_AnType = value;
}
oai::_3gpp::model::AccessType PduSessionCreateData::getAdditionalAnType() const
{
    return m_AdditionalAnType;
}
void PduSessionCreateData::setAdditionalAnType(oai::_3gpp::model::AccessType const& value)
{
...
void PduSessionCreateData::setUeLocation(oai::_3gpp::model::UserLocation const& value)
{
    m_UeLocation = value;
...
void PduSessionCreateData::setAddUeLocation(oai::_3gpp::model::UserLocation const& value)
{
...
oai::_3gpp::model::RefToBinaryData PduSessionCreateData::getN1SmInfoFromUe() const
{
    return m_N1SmInfoFromUe;
}
void PduSessionCreateData::setN1SmInfoFromUe(oai::_3gpp::model::RefToBinaryData const& value)
{
...
oai::_3gpp::model::RefToBinaryData PduSessionCreateData::getUnknownN1SmInfo() const
{
    return m_UnknownN1SmInfo;
}
void PduSessionCreateData::setUnknownN1SmInfo(oai::_3gpp::model::RefToBinaryData const& value)
{
...
void PduSessionCreateData::setSelMode(oai::_3gpp::model::DnnSelectionMode const& value)
{
    m_SelMode = value;
    m_SelModeIsSet = true;
}
...
oai::_3gpp::model::EpsInterworkingIndication PduSessionCreateData::getEpsInterworkingInd() const
{
    return m_EpsInterworkingInd;
}
void PduSessionCreateData::setEpsInterworkingInd(oai::_3gpp::model::EpsInterworkingIndication const& value)
{
...
oai::_3gpp::model::RoamingChargingProfile PduSessionCreateData::getRoamingChargingProfile() const
{
    return m_RoamingChargingProfile;
}
void PduSessionCreateData::setRoamingChargingProfile(oai::_3gpp::model::RoamingChargingProfile const& value)
{
...
oai::_3gpp::model::MaxIntegrityProtectedDataRate PduSessionCreateData::getMaxIntegrityProtectedDataRateUl() const
{
    return m_MaxIntegrityProtectedDataRateUl;
}
void PduSessionCreateData::setMaxIntegrityProtectedDataRateUl(oai::_3gpp::model::MaxIntegrityProtectedDataRate const& value)
{
...
oai::_3gpp::model::MaxIntegrityProtectedDataRate PduSessionCreateData::getMaxIntegrityProtectedDataRateDl() const
{
    return m_MaxIntegrityProtectedDataRateDl;
}
void PduSessionCreateData::setMaxIntegrityProtectedDataRateDl(oai::_3gpp::model::MaxIntegrityProtectedDataRate const& value)
{
...
std::vector<oai::_3gpp::model::std::string> PduSessionCreateData::getDnaiList() const
{
    return m_DnaiList;
}
void PduSessionCreateData::setDnaiList(std::vector<oai::_3gpp::model::std::string> const& value)
{
    m_DnaiList = value;
...
oai::_3gpp::model::PresenceState PduSessionCreateData::getPresenceInLadn() const
{
    return m_PresenceInLadn;
}
void PduSessionCreateData::setPresenceInLadn(oai::_3gpp::model::PresenceState const& value)
{
...
std::vector<oai::_3gpp::model::SecondaryRatUsageInfo> PduSessionCreateData::getSecondaryRatUsageInfo() const
{
    return m_SecondaryRatUsageInfo;
}
void PduSessionCreateData::setSecondaryRatUsageInfo(std::vector<oai::_3gpp::model::SecondaryRatUsageInfo> const& value)
{
...
oai::_3gpp::model::SmallDataRateStatus PduSessionCreateData::getSmallDataRateStatus() const
{
    return m_SmallDataRateStatus;
}
void PduSessionCreateData::setSmallDataRateStatus(oai::_3gpp::model::SmallDataRateStatus const& value)
{
...
oai::_3gpp::model::ApnRateStatus PduSessionCreateData::getApnRateStatus() const
{
    return m_ApnRateStatus;
}
void PduSessionCreateData::setApnRateStatus(oai::_3gpp::model::ApnRateStatus const& value)
{
...
oai::_3gpp::model::UpSecurityInfo PduSessionCreateData::getUpSecurityInfo() const
{
    return m_UpSecurityInfo;
}
void PduSessionCreateData::setUpSecurityInfo(oai::_3gpp::model::UpSecurityInfo const& value)
{
...
void PduSessionCreateData::setVplmnQos(oai::_3gpp::model::VplmnQos const& value)
{
    m_VplmnQos = value;
...
oai::_3gpp::model::RedundantPduSessionInformation PduSessionCreateData::getRedundantPduSessionInfo() const
{
    return m_RedundantPduSessionInfo;
}
void PduSessionCreateData::setRedundantPduSessionInfo(oai::_3gpp::model::RedundantPduSessionInformation const& value)
{
...
oai::_3gpp::model::PcfUeCallbackInfo PduSessionCreateData::getPcfUeCallbackInfo() const
{
    return m_PcfUeCallbackInfo;
}
void PduSessionCreateData::setPcfUeCallbackInfo(oai::_3gpp::model::PcfUeCallbackInfo const& value)
{
...
oai::_3gpp::model::SatelliteBackhaulCategory PduSessionCreateData::getSatelliteBackhaulCat() const
{
    return m_SatelliteBackhaulCat;
}
void PduSessionCreateData::setSatelliteBackhaulCat(oai::_3gpp::model::SatelliteBackhaulCategory const& value)
{
...
void PduSessionCreateData::setUpCnxState(oai::_3gpp::model::UpCnxState const& value)
{
    m_UpCnxState = value;
