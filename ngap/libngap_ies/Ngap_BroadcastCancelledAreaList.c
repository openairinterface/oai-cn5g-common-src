...
asn_oer_constraints_t asn_OER_type_Ngap_BroadcastCancelledAreaList_constr_1
    CC_NOTUSED = {{0, 0}, -1};
...
asn_TYPE_member_t asn_MBR_Ngap_BroadcastCancelledAreaList_1[] = {
    ...
    {ATF_POINTER,
     0,
     offsetof(struct Ngap_BroadcastCancelledAreaList, choice.tAICancelledEUTRA),
    ...
    {ATF_POINTER,
     0,
     offsetof(struct Ngap_BroadcastCancelledAreaList, choice.cellIDCancelledNR),
    ...
    {ATF_POINTER,
     0,
     offsetof(struct Ngap_BroadcastCancelledAreaList, choice.tAICancelledNR),
    ...
    {ATF_POINTER,
     ...
     -1, /* IMPLICIT tag at current level */
     &asn_DEF_Ngap_ProtocolIE_SingleContainer_12877P4,
     0,
     {
#if !defined(ASN_DISABLE_OER_SUPPORT)
         0,
...
static const asn_TYPE_tag2member_t
    asn_MAP_Ngap_BroadcastCancelledAreaList_tag2el_1[] = {
        ...
        {(ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0,
         0}, /* emergencyAreaIDCancelledEUTRA */
