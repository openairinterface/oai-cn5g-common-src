...
static asn_TYPE_member_t asn_MBR_Ngap_MBS_DistributionSetupResponseTransfer_1[] = {
	{ ATF_POINTER, 0, offsetof(struct Ngap_MBS_DistributionSetupResponseTransfer, mBS_SessionID),
	...
	{ ATF_POINTER, 0, offsetof(struct Ngap_MBS_DistributionSetupResponseTransfer, mBS_QoSFlowsToBeSetupList),
