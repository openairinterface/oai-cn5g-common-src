...
void PartialSuccessReport::setFailureCause(oai::_3gpp::model::FailureCause const& value)
{
    m_FailureCause = value;
}
std::vector<oai::_3gpp::model::RuleReport> PartialSuccessReport::getRuleReports() const
{
    return m_RuleReports;
}
void PartialSuccessReport::setRuleReports(std::vector<oai::_3gpp::model::RuleReport> const& value)
{
    m_RuleReports = value;
...
std::vector<oai::_3gpp::model::SessionRuleReport> PartialSuccessReport::getSessRuleReports() const
{
    return m_SessRuleReports;
}
void PartialSuccessReport::setSessRuleReports(std::vector<oai::_3gpp::model::SessionRuleReport> const& value)
{
...
void PartialSuccessReport::setUeCampingRep(oai::_3gpp::model::UeCampingRep const& value)
{
...
std::vector<oai::_3gpp::model::PolicyDecisionFailureCode> PartialSuccessReport::getPolicyDecFailureReports() const
{
    return m_PolicyDecFailureReports;
}
void PartialSuccessReport::setPolicyDecFailureReports(std::vector<oai::_3gpp::model::PolicyDecisionFailureCode> const& value)
{
...
std::vector<oai::_3gpp::model::InvalidParam> PartialSuccessReport::getInvalidPolicyDecs() const
{
    return m_InvalidPolicyDecs;
}
void PartialSuccessReport::setInvalidPolicyDecs(std::vector<oai::_3gpp::model::InvalidParam> const& value)
{
