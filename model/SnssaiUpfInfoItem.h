...
public:
    ...
    /// 
    /// </summary>
    std::vector<oai::model::DnnUpfInfoItem> getDnnUpfInfoList() const;
    void setDnnUpfInfoList(std::vector<oai::model::DnnUpfInfoItem> const& value);
    /// <summary>
    /// 
    /// </summary>
...
protected:
    ...
    std::vector<oai::model::DnnUpfInfoItem> m_DnnUpfInfoList;
