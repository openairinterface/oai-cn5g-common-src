...
bool RoamingIndication_anyOf::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "RoamingIndication_anyOf" : pathPrefix;

    
    if (m_value == RoamingIndication_anyOf::eRoamingIndication_anyOf::INVALID_VALUE_OPENAPI_GENERATED)
    {
        success = false;
...
bool RoamingIndication_anyOf::operator==(const RoamingIndication_anyOf& rhs) const
{
    return
...
void to_json(nlohmann::json& j, const RoamingIndication_anyOf& o)
{
    ...
    switch (o.getValue())
    {
        case RoamingIndication_anyOf::eRoamingIndication_anyOf::INVALID_VALUE_OPENAPI_GENERATED:
...
void from_json(const nlohmann::json& j, RoamingIndication_anyOf& o)
{
    ...
    if (s == "NON_ROAMING") {
     ...
     o.setValue(RoamingIndication_anyOf::eRoamingIndication_anyOf::LOCAL_BREAKOUT);
    } 
    else if (s == "HOME_ROUTED_ROAMING") {
     o.setValue(RoamingIndication_anyOf::eRoamingIndication_anyOf::HOME_ROUTED_ROAMING);
    }  else {
     std::stringstream ss;
...
RoamingIndication_anyOf::eRoamingIndication_anyOf RoamingIndication_anyOf::getValue() const
{
    return m_value;
}
void RoamingIndication_anyOf::setValue(RoamingIndication_anyOf::eRoamingIndication_anyOf value)
{
    m_value = value;
}
