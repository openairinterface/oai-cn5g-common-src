...
bool AccessTokenReq::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    ...
    {
        const std::vector<oai::model::PlmnId_1>& value = m_RequesterPlmnList;
    ...
    {
        const std::vector<oai::model::PlmnIdNid_1>& value = m_RequesterSnpnList;
        ...
        { // Recursive validation of array elements
            const std::string oldValuePath = currentValuePath;
            int i = 0;
            for (const oai::model::PlmnIdNid_1& value : value)
            { 
                const std::string currentValuePath = oldValuePath + "[" + std::to_string(i) + "]";
...
oai::model::NFType AccessTokenReq::getNfType() const
{
    return m_NfType;
}
void AccessTokenReq::setNfType(oai::model::NFType const& value)
{
    m_NfType = value;
    m_NfTypeIsSet = true;
}
...
oai::model::NFType AccessTokenReq::getTargetNfType() const
{
    return m_TargetNfType;
}
void AccessTokenReq::setTargetNfType(oai::model::NFType const& value)
{
...
oai::model::PlmnId_1 AccessTokenReq::getRequesterPlmn() const
{
    return m_RequesterPlmn;
}
void AccessTokenReq::setRequesterPlmn(oai::model::PlmnId_1 const& value)
{
...
std::vector<oai::model::PlmnId_1> AccessTokenReq::getRequesterPlmnList() const
{
    return m_RequesterPlmnList;
}
void AccessTokenReq::setRequesterPlmnList(std::vector<oai::model::PlmnId_1> const& value)
{
...
std::vector<oai::model::Snssai> AccessTokenReq::getRequesterSnssaiList() const
{
    return m_RequesterSnssaiList;
}
void AccessTokenReq::setRequesterSnssaiList(std::vector<oai::model::Snssai> const& value)
{
...
std::vector<oai::model::PlmnIdNid_1> AccessTokenReq::getRequesterSnpnList() const
{
    return m_RequesterSnpnList;
}
void AccessTokenReq::setRequesterSnpnList(std::vector<oai::model::PlmnIdNid_1> const& value)
{
...
oai::model::PlmnId_1 AccessTokenReq::getTargetPlmn() const
{
    return m_TargetPlmn;
}
void AccessTokenReq::setTargetPlmn(oai::model::PlmnId_1 const& value)
{
    m_TargetPlmn = value;
...
oai::model::PlmnIdNid_1 AccessTokenReq::getTargetSnpn() const
{
    return m_TargetSnpn;
}
void AccessTokenReq::setTargetSnpn(oai::model::PlmnIdNid_1 const& value)
{
    m_TargetSnpn = value;
...
std::vector<oai::model::Snssai> AccessTokenReq::getTargetSnssaiList() const
{
    return m_TargetSnssaiList;
}
void AccessTokenReq::setTargetSnssaiList(std::vector<oai::model::Snssai> const& value)
{
...
void AccessTokenReq::setSourceNfInstanceId(std::string const& value)
{
