...
#define Ngap_ProtocolIE_ID_id_HashedUEIdentityIndexValue	((Ngap_ProtocolIE_ID_t)365)
#define Ngap_ProtocolIE_ID_id_ExtendedMobilityInformation	((Ngap_ProtocolIE_ID_t)366)
