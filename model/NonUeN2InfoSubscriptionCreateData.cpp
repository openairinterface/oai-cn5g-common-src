...
bool NonUeN2InfoSubscriptionCreateData::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "NonUeN2InfoSubscriptionCreateData" : pathPrefix;

         
    if (globalRanNodeListIsSet())
    {
        const std::vector<oai::model::GlobalRanNodeId>& value = m_GlobalRanNodeList;
        ...
        success = value.validate(msg, currentValuePath + ".globalRanNodeList") && success;
    ...
    if (anTypeListIsSet())
    {
        const std::vector<oai::model::AccessType>& value = m_AnTypeList;
...
bool NonUeN2InfoSubscriptionCreateData::operator==(const NonUeN2InfoSubscriptionCreateData& rhs) const
{
    return
    
    
    
    ((!globalRanNodeListIsSet() && !rhs.globalRanNodeListIsSet()) || (globalRanNodeListIsSet() && rhs.globalRanNodeListIsSet() && getGlobalRanNodeList() == rhs.getGlobalRanNodeList())) &&
    
    
    ((!anTypeListIsSet() && !rhs.anTypeListIsSet()) || (anTypeListIsSet() && rhs.anTypeListIsSet() && getAnTypeList() == rhs.getAnTypeList())) &&
...
std::vector<oai::model::GlobalRanNodeId> NonUeN2InfoSubscriptionCreateData::getGlobalRanNodeList() const
{
    return m_GlobalRanNodeList;
}
void NonUeN2InfoSubscriptionCreateData::setGlobalRanNodeList(std::vector<oai::model::GlobalRanNodeId> const& value)
{
...
std::vector<oai::model::AccessType> NonUeN2InfoSubscriptionCreateData::getAnTypeList() const
{
    return m_AnTypeList;
}
void NonUeN2InfoSubscriptionCreateData::setAnTypeList(std::vector<oai::model::AccessType> const& value)
{
    m_AnTypeList = value;
...
oai::model::N2InformationClass NonUeN2InfoSubscriptionCreateData::getN2InformationClass() const
{
    return m_N2InformationClass;
}
void NonUeN2InfoSubscriptionCreateData::setN2InformationClass(oai::model::N2InformationClass const& value)
{
