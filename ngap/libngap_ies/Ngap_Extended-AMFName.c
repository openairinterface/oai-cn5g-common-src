...
asn_TYPE_member_t asn_MBR_Ngap_Extended_AMFName_1[] = {
    {ATF_POINTER,
     3,
     offsetof(struct Ngap_Extended_AMFName, aMFNameVisibleString),
    ...
    {ATF_POINTER,
     2,
     offsetof(struct Ngap_Extended_AMFName, aMFNameUTF8String),
    ...
    {ATF_POINTER,
     1,
     offsetof(struct Ngap_Extended_AMFName, iE_Extensions),
     (ASN_TAG_CLASS_CONTEXT | (2 << 2)),
     -1, /* IMPLICIT tag at current level */
     &asn_DEF_Ngap_ProtocolExtensionContainer_12929P83,
     0,
     {
#if !defined(ASN_DISABLE_OER_SUPPORT)
         0,
