...
bool IpEthFlowDescription::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "IpEthFlowDescription" : pathPrefix;
...
oai::_3gpp::model::EthFlowDescription IpEthFlowDescription::getEthTrafficFilter() const
{
    return m_EthTrafficFilter;
}
void IpEthFlowDescription::setEthTrafficFilter(oai::_3gpp::model::EthFlowDescription const& value)
{
