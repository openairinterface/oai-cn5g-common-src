...
std::vector<oai::_3gpp::model::NFType> DccfInfo::getServingNfTypeList() const
{
    return m_ServingNfTypeList;
}
void DccfInfo::setServingNfTypeList(std::vector<oai::_3gpp::model::NFType> const& value)
{
...
std::vector<oai::_3gpp::model::Tai> DccfInfo::getTaiList() const
{
    return m_TaiList;
}
void DccfInfo::setTaiList(std::vector<oai::_3gpp::model::Tai> const& value)
{
    m_TaiList = value;
    m_TaiListIsSet = true;
}
...
std::vector<oai::_3gpp::model::TaiRange> DccfInfo::getTaiRangeList() const
{
    return m_TaiRangeList;
}
void DccfInfo::setTaiRangeList(std::vector<oai::_3gpp::model::TaiRange> const& value)
{
