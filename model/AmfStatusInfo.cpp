...
bool AmfStatusInfo::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "AmfStatusInfo" : pathPrefix;
    ...
    if (!m_StatusChange.validate(msg, _pathPrefix + ".statusChange")) {
        msg << _pathPrefix << ": StatusChange is invalid;";
        success = false;
    }     
...
bool AmfStatusInfo::operator==(const AmfStatusInfo& rhs) const
{
    ...
    ((!targetAmfRemovalIsSet() && !rhs.targetAmfRemovalIsSet()) || (targetAmfRemovalIsSet() && rhs.targetAmfRemovalIsSet() && getTargetAmfRemoval() == rhs.getTargetAmfRemoval())) &&
    
    
    ((!targetAmfFailureIsSet() && !rhs.targetAmfFailureIsSet()) || (targetAmfFailureIsSet() && rhs.targetAmfFailureIsSet() && getTargetAmfFailure() == rhs.getTargetAmfFailure()))
...
std::vector<oai::model::Guami> AmfStatusInfo::getGuamiList() const
{
    return m_GuamiList;
}
void AmfStatusInfo::setGuamiList(std::vector<oai::model::Guami> const& value)
{
    m_GuamiList = value;
}
oai::model::StatusChange AmfStatusInfo::getStatusChange() const
{
    return m_StatusChange;
}
void AmfStatusInfo::setStatusChange(oai::model::StatusChange const& value)
{
