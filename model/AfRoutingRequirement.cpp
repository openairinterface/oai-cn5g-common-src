...
bool AfRoutingRequirement::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "AfRoutingRequirement" : pathPrefix;
...
std::vector<oai::model::RouteToLocation> AfRoutingRequirement::getRouteToLocs() const
{
    return m_RouteToLocs;
}
void AfRoutingRequirement::setRouteToLocs(std::vector<oai::model::RouteToLocation> const& value)
{
    m_RouteToLocs = value;
...
oai::model::SpatialValidity AfRoutingRequirement::getSpVal() const
{
    return m_SpVal;
}
void AfRoutingRequirement::setSpVal(oai::model::SpatialValidity const& value)
{
    m_SpVal = value;
    m_SpValIsSet = true;
}
...
std::vector<oai::model::TemporalValidity> AfRoutingRequirement::getTempVals() const
{
    return m_TempVals;
}
void AfRoutingRequirement::setTempVals(std::vector<oai::model::TemporalValidity> const& value)
{
    m_TempVals = value;
...
oai::model::UpPathChgEvent AfRoutingRequirement::getUpPathChgSub() const
{
    return m_UpPathChgSub;
}
void AfRoutingRequirement::setUpPathChgSub(oai::model::UpPathChgEvent const& value)
{
...
std::vector<oai::model::EasIpReplacementInfo> AfRoutingRequirement::getEasIpReplaceInfos() const
{
    return m_EasIpReplaceInfos;
}
void AfRoutingRequirement::setEasIpReplaceInfos(std::vector<oai::model::EasIpReplacementInfo> const& value)
{
