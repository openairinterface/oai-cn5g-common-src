...
asn_dec_rval_t ENUMERATED_decode_oer(
  ...
  rval = NativeEnumerated_decode_oer(
      opt_codec_ctx, td, constraints, (void**) &vptr, ptr, size);
  if (rval.code == RC_OK) {
...
asn_enc_rval_t ENUMERATED_encode_oer(
