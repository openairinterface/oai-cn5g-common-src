...
public:
  ...
  void SetSNSSAI(uint8_t sst, uint32_t sd, uint8_t mapped_hplmn_sst = 0,
                 uint32_t mapped_hplmn_sd = SD_NO_VALUE);
  void SetSNSSAI(std::optional<int8_t> iei, uint8_t sst, uint32_t sd,
                 uint8_t mapped_hplmn_sst = 0,
                 uint32_t mapped_hplmn_sd = SD_NO_VALUE);
