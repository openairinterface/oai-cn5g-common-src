...
public:
    ...
    void setEpsNasSecurityMode(oai::_3gpp::model::EpsNasSecurityMode const& value);
    ...
    void setNssaiMappingList(std::vector<oai::_3gpp::model::NssaiMapping> const& value);
    ...
    void setExpectedUEbehavior(oai::_3gpp::model::ExpectedUeBehavior const& value);
    ...
    void setUeDifferentiationInfo(oai::_3gpp::model::UeDifferentiationInfo const& value);
    ...
    void setNssaaStatusList(std::vector<oai::_3gpp::model::NssaaStatus> const& value);
    bool nssaaStatusListIsSet() const;
    void unsetNssaaStatusList();
    /// <summary>
    /// 
    /// </summary>
    std::vector<oai::_3gpp::model::NssaiMapping> getPendingNssaiMappingList() const;
    void setPendingNssaiMappingList(std::vector<oai::_3gpp::model::NssaiMapping> const& value);
