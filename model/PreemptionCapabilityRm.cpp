...
bool PreemptionCapabilityRm::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "PreemptionCapabilityRm" : pathPrefix;

    
    return success;
}

bool PreemptionCapabilityRm::operator==(const PreemptionCapabilityRm& rhs) const
{
    return
