...
bool N2InterfaceAmfInfo::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    ...
    {
        const std::vector<oai::model::Ipv6Addr>& value = m_Ipv6EndpointAddress;
...
std::vector<oai::model::Ipv6Addr> N2InterfaceAmfInfo::getIpv6EndpointAddress() const
{
    return m_Ipv6EndpointAddress;
}
void N2InterfaceAmfInfo::setIpv6EndpointAddress(std::vector<oai::model::Ipv6Addr> const& value)
{
