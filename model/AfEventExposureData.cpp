...
std::vector<oai::_3gpp::model::AfEvent> AfEventExposureData::getAfEvents() const
{
    return m_AfEvents;
}
void AfEventExposureData::setAfEvents(std::vector<oai::_3gpp::model::AfEvent> const& value)
{
    m_AfEvents = value;
}
