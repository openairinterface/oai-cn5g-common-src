...
public:
    ...
    /// 
    /// </summary>
    oai::model::NetworkAreaInfo getAreaInfo() const;
    void setAreaInfo(oai::model::NetworkAreaInfo const& value);
    ...
    /// 
    /// </summary>
    oai::model::RetainabilityThreshold getQosFlowRetThd() const;
    void setQosFlowRetThd(oai::model::RetainabilityThreshold const& value);
...
protected:
    oai::model::NetworkAreaInfo m_AreaInfo;
    bool m_AreaInfoIsSet;
    std::string m_StartTs;
    bool m_StartTsIsSet;
    std::string m_EndTs;
    bool m_EndTsIsSet;
    oai::model::RetainabilityThreshold m_QosFlowRetThd;
