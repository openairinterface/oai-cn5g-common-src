...
public:
    ...
    /// 
    /// </summary>
    oai::_3gpp::model::Ipv6Addr getAnChargIpv6Addr() const;
    void setAnChargIpv6Addr(oai::_3gpp::model::Ipv6Addr const& value);
...
protected:
    ...
    oai::_3gpp::model::Ipv6Addr m_AnChargIpv6Addr;
