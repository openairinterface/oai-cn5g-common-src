...
/* Implementation */
extern asn_oer_constraints_t asn_OER_type_Ngap_PacketLossRate_constr_1;
...
cbor_type_decoder_f Ngap_PacketLossRate_decode_cbor;
cbor_type_encoder_f Ngap_PacketLossRate_encode_cbor;
