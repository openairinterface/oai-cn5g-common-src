...
std::vector<oai::_3gpp::model::Tai> NssfEventSubscriptionCreateData::getTaiList() const
{
    return m_TaiList;
}
void NssfEventSubscriptionCreateData::setTaiList(std::vector<oai::_3gpp::model::Tai> const& value)
{
    m_TaiList = value;
}
oai::_3gpp::model::NssfEventType NssfEventSubscriptionCreateData::getEvent() const
{
    return m_Event;
}
void NssfEventSubscriptionCreateData::setEvent(oai::_3gpp::model::NssfEventType const& value)
{
    m_Event = value;
}
...
std::vector<oai::_3gpp::model::TaiRange> NssfEventSubscriptionCreateData::getTaiRangeList() const
{
    return m_TaiRangeList;
}
void NssfEventSubscriptionCreateData::setTaiRangeList(std::vector<oai::_3gpp::model::TaiRange> const& value)
{
