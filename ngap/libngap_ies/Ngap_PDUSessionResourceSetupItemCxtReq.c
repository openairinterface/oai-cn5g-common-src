...
asn_TYPE_member_t asn_MBR_Ngap_PDUSessionResourceSetupItemCxtReq_1[] = {
    {ATF_NOFLAGS,
     0,
     offsetof(struct Ngap_PDUSessionResourceSetupItemCxtReq, pDUSessionID),
    ...
    {ATF_POINTER,
     1,
     offsetof(struct Ngap_PDUSessionResourceSetupItemCxtReq, nAS_PDU),
    ...
    {ATF_POINTER,
     0,
     offsetof(struct Ngap_PDUSessionResourceSetupItemCxtReq, s_NSSAI),
    ...
    {ATF_POINTER,
     1,
     offsetof(struct Ngap_PDUSessionResourceSetupItemCxtReq, iE_Extensions),
     (ASN_TAG_CLASS_CONTEXT | (4 << 2)),
     -1, /* IMPLICIT tag at current level */
     &asn_DEF_Ngap_ProtocolExtensionContainer_12929P251,
     0,
     {
#if !defined(ASN_DISABLE_OER_SUPPORT)
         0,
...
asn_SEQUENCE_specifics_t
    asn_SPC_Ngap_PDUSessionResourceSetupItemCxtReq_specs_1 = {
        ...
        asn_MAP_Ngap_PDUSessionResourceSetupItemCxtReq_oms_1, /* Optional
                                                                 members */
        2,
        0, /* Root/Additions */
...
asn_TYPE_descriptor_t asn_DEF_Ngap_PDUSessionResourceSetupItemCxtReq = {
    ...
    sizeof(asn_DEF_Ngap_PDUSessionResourceSetupItemCxtReq_tags_1) /
        sizeof(
            asn_DEF_Ngap_PDUSessionResourceSetupItemCxtReq_tags_1[0]), /* 1 */
