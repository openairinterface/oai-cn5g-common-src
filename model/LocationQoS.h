...
public:
    ...
    /// 
    /// </summary>
    oai::_3gpp::model::ResponseTime getResponseTime() const;
    void setResponseTime(oai::_3gpp::model::ResponseTime const& value);
    bool responseTimeIsSet() const;
    void unsetResponseTime();
    /// <summary>
    /// 
    /// </summary>
    std::vector<oai::_3gpp::model::MinorLocationQoS> getMinorLocQoses() const;
    void setMinorLocQoses(std::vector<oai::_3gpp::model::MinorLocationQoS> const& value);
...
protected:
    ...
    oai::_3gpp::model::ResponseTime m_ResponseTime;
    bool m_ResponseTimeIsSet;
    std::vector<oai::_3gpp::model::MinorLocationQoS> m_MinorLocQoses;
