 ...
 *
 * Possible values are - MINUTE: Indicates the rate control is applied per minute. - HOUR: Indicates the rate control is applied per hour. - DAY: Indicates the rate control is applied per day. - WEEK: Indicates the rate control is applied per week. - 6MINUTES: Indicates the rate control is applied per 6 minutes. 
 */
...
public:
    ...
    SmallDataRateControlTimeUnit_anyOf::eSmallDataRateControlTimeUnit_anyOf getEnumValue() const;
    void setEnumValue(SmallDataRateControlTimeUnit_anyOf::eSmallDataRateControlTimeUnit_anyOf value);
    friend void to_json(nlohmann::json& j, const SmallDataRateControlTimeUnit& o);
    friend void from_json(const nlohmann::json& j, SmallDataRateControlTimeUnit& o);
    friend void to_json(nlohmann::json& j, const SmallDataRateControlTimeUnit_anyOf& o);
    friend void from_json(const nlohmann::json& j, SmallDataRateControlTimeUnit_anyOf& o);
protected:
