...
bool GbrQosFlowInformation::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    ...
    {
        const std::vector<oai::_3gpp::model::AlternativeQosProfile>& value = m_AlternativeQosProfileList;
...
oai::_3gpp::model::NotificationControl GbrQosFlowInformation::getNotifControl() const
{
    return m_NotifControl;
}
void GbrQosFlowInformation::setNotifControl(oai::_3gpp::model::NotificationControl const& value)
{
...
std::vector<oai::_3gpp::model::AlternativeQosProfile> GbrQosFlowInformation::getAlternativeQosProfileList() const
{
    return m_AlternativeQosProfileList;
}
void GbrQosFlowInformation::setAlternativeQosProfileList(std::vector<oai::_3gpp::model::AlternativeQosProfile> const& value)
{
