...
static asn_TYPE_member_t
    asn_MBR_Ngap_PDUSessionResourceModifyRequestTransfer_1[] = {
        {ATF_POINTER,
         ...
         &asn_DEF_Ngap_ProtocolIE_Container_12874P121,
         0,
         {
...
static asn_SEQUENCE_specifics_t
    asn_SPC_Ngap_PDUSessionResourceModifyRequestTransfer_specs_1 = {
...
asn_TYPE_descriptor_t asn_DEF_Ngap_PDUSessionResourceModifyRequestTransfer = {
    ...
    sizeof(asn_DEF_Ngap_PDUSessionResourceModifyRequestTransfer_tags_1) /
        sizeof(asn_DEF_Ngap_PDUSessionResourceModifyRequestTransfer_tags_1
                   [0]),                                         /* 1 */
    asn_DEF_Ngap_PDUSessionResourceModifyRequestTransfer_tags_1, /* Same as
                                                                    above */
    sizeof(asn_DEF_Ngap_PDUSessionResourceModifyRequestTransfer_tags_1) /
        sizeof(asn_DEF_Ngap_PDUSessionResourceModifyRequestTransfer_tags_1
                   [0]), /* 1 */
    ...
    asn_MBR_Ngap_PDUSessionResourceModifyRequestTransfer_1,
    1, /* Elements count */
    &asn_SPC_Ngap_PDUSessionResourceModifyRequestTransfer_specs_1 /* Additional
                                                                     specs */
};
