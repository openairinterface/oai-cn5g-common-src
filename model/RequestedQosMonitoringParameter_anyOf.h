...
public:
    ...
    RequestedQosMonitoringParameter_anyOf::eRequestedQosMonitoringParameter_anyOf getValue() const;
    void setValue(RequestedQosMonitoringParameter_anyOf::eRequestedQosMonitoringParameter_anyOf value);
    
    friend void to_json(nlohmann::json& j, const RequestedQosMonitoringParameter_anyOf& o);
    friend void from_json(const nlohmann::json& j, RequestedQosMonitoringParameter_anyOf& o);
protected:
    RequestedQosMonitoringParameter_anyOf::eRequestedQosMonitoringParameter_anyOf m_value = RequestedQosMonitoringParameter_anyOf::eRequestedQosMonitoringParameter_anyOf::INVALID_VALUE_OPENAPI_GENERATED;
};
