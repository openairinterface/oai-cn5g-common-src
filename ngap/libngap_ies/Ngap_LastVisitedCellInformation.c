...
asn_oer_constraints_t asn_OER_type_Ngap_LastVisitedCellInformation_constr_1
    CC_NOTUSED = {{0, 0}, -1};
...
asn_TYPE_member_t asn_MBR_Ngap_LastVisitedCellInformation_1[] = {
    {ATF_POINTER,
     0,
     offsetof(struct Ngap_LastVisitedCellInformation, choice.nGRANCell),
    ...
    {ATF_NOFLAGS,
     0,
     offsetof(struct Ngap_LastVisitedCellInformation, choice.eUTRANCell),
    ...
    {ATF_NOFLAGS,
     0,
     offsetof(struct Ngap_LastVisitedCellInformation, choice.uTRANCell),
    ...
    {ATF_NOFLAGS,
     0,
     offsetof(struct Ngap_LastVisitedCellInformation, choice.gERANCell),
    ...
    {ATF_POINTER,
     ...
     -1, /* IMPLICIT tag at current level */
     &asn_DEF_Ngap_ProtocolIE_SingleContainer_12877P27,
     0,
     {
#if !defined(ASN_DISABLE_OER_SUPPORT)
         0,
