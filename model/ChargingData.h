...
public:
    ...
    /// 
    /// </summary>
    oai::_3gpp::model::MeteringMethod getMeteringMethod() const;
    void setMeteringMethod(oai::_3gpp::model::MeteringMethod const& value);
    ...
    /// 
    /// </summary>
    oai::_3gpp::model::ReportingLevel getReportingLevel() const;
    void setReportingLevel(oai::_3gpp::model::ReportingLevel const& value);
...
protected:
    ...
    oai::_3gpp::model::MeteringMethod m_MeteringMethod;
    ...
    oai::_3gpp::model::ReportingLevel m_ReportingLevel;
