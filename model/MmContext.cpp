...
bool MmContext::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    ...
    {
        const std::vector<oai::model::Snssai>& value = m_AllowedNssai;
        ...
        success = value.validate(msg, currentValuePath + ".allowedNssai") && success;
    ...
    {
        const std::vector<oai::model::NssaiMapping>& value = m_NssaiMappingList;
        ...
        { // Recursive validation of array elements
            const std::string oldValuePath = currentValuePath;
            int i = 0;
            for (const oai::model::NssaiMapping& value : value)
            { 
                const std::string currentValuePath = oldValuePath + "[" + std::to_string(i) + "]";
                        
        success = value.validate(msg, currentValuePath + ".nssaiMappingList") && success;
    ...
    {
        const std::vector<oai::model::Snssai>& value = m_AllowedHomeNssai;
        ...
        success = value.validate(msg, currentValuePath + ".allowedHomeNssai") && success;
    ...
    {
        const std::vector<oai::model::NssaaStatus>& value = m_NssaaStatusList;
        ...
        { // Recursive validation of array elements
            const std::string oldValuePath = currentValuePath;
            int i = 0;
            for (const oai::model::NssaaStatus& value : value)
            { 
                const std::string currentValuePath = oldValuePath + "[" + std::to_string(i) + "]";
                        
        success = value.validate(msg, currentValuePath + ".nssaaStatusList") && success;
    ...
    {
        const std::vector<oai::model::NssaiMapping>& value = m_PendingNssaiMappingList;
        const std::string currentValuePath = _pathPrefix + ".pendingNssaiMappingList";
        ...
        success = value.validate(msg, currentValuePath + ".pendingNssaiMappingList") && success;
...
bool MmContext::operator==(const MmContext& rhs) const
{
    ...
    ((!nasSecurityModeIsSet() && !rhs.nasSecurityModeIsSet()) || (nasSecurityModeIsSet() && rhs.nasSecurityModeIsSet() && getNasSecurityMode() == rhs.getNasSecurityMode())) &&
    
    
    ((!epsNasSecurityModeIsSet() && !rhs.epsNasSecurityModeIsSet()) || (epsNasSecurityModeIsSet() && rhs.epsNasSecurityModeIsSet() && getEpsNasSecurityMode() == rhs.getEpsNasSecurityMode())) &&
    
    
    ((!nasDownlinkCountIsSet() && !rhs.nasDownlinkCountIsSet()) || (nasDownlinkCountIsSet() && rhs.nasDownlinkCountIsSet() && getNasDownlinkCount() == rhs.getNasDownlinkCount())) &&
    
    
    ((!nasUplinkCountIsSet() && !rhs.nasUplinkCountIsSet()) || (nasUplinkCountIsSet() && rhs.nasUplinkCountIsSet() && getNasUplinkCount() == rhs.getNasUplinkCount())) &&
    
    
    ((!ueSecurityCapabilityIsSet() && !rhs.ueSecurityCapabilityIsSet()) || (ueSecurityCapabilityIsSet() && rhs.ueSecurityCapabilityIsSet() && getUeSecurityCapability() == rhs.getUeSecurityCapability())) &&
    
    
    ((!s1UeNetworkCapabilityIsSet() && !rhs.s1UeNetworkCapabilityIsSet()) || (s1UeNetworkCapabilityIsSet() && rhs.s1UeNetworkCapabilityIsSet() && getS1UeNetworkCapability() == rhs.getS1UeNetworkCapability())) &&
    
    
    ((!allowedNssaiIsSet() && !rhs.allowedNssaiIsSet()) || (allowedNssaiIsSet() && rhs.allowedNssaiIsSet() && getAllowedNssai() == rhs.getAllowedNssai())) &&
    
    
    ((!nssaiMappingListIsSet() && !rhs.nssaiMappingListIsSet()) || (nssaiMappingListIsSet() && rhs.nssaiMappingListIsSet() && getNssaiMappingList() == rhs.getNssaiMappingList())) &&
    
    
    ((!allowedHomeNssaiIsSet() && !rhs.allowedHomeNssaiIsSet()) || (allowedHomeNssaiIsSet() && rhs.allowedHomeNssaiIsSet() && getAllowedHomeNssai() == rhs.getAllowedHomeNssai())) &&
    
    
    ((!nsInstanceListIsSet() && !rhs.nsInstanceListIsSet()) || (nsInstanceListIsSet() && rhs.nsInstanceListIsSet() && getNsInstanceList() == rhs.getNsInstanceList())) &&
    
    
    ((!expectedUEbehaviorIsSet() && !rhs.expectedUEbehaviorIsSet()) || (expectedUEbehaviorIsSet() && rhs.expectedUEbehaviorIsSet() && getExpectedUEbehavior() == rhs.getExpectedUEbehavior())) &&
    
    
    ((!ueDifferentiationInfoIsSet() && !rhs.ueDifferentiationInfoIsSet()) || (ueDifferentiationInfoIsSet() && rhs.ueDifferentiationInfoIsSet() && getUeDifferentiationInfo() == rhs.getUeDifferentiationInfo())) &&
    
    
    ((!plmnAssiUeRadioCapIdIsSet() && !rhs.plmnAssiUeRadioCapIdIsSet()) || (plmnAssiUeRadioCapIdIsSet() && rhs.plmnAssiUeRadioCapIdIsSet() && getPlmnAssiUeRadioCapId() == rhs.getPlmnAssiUeRadioCapId())) &&
    
    
    ((!manAssiUeRadioCapIdIsSet() && !rhs.manAssiUeRadioCapIdIsSet()) || (manAssiUeRadioCapIdIsSet() && rhs.manAssiUeRadioCapIdIsSet() && getManAssiUeRadioCapId() == rhs.getManAssiUeRadioCapId())) &&
    
    
    ((!ucmfDicEntryIdIsSet() && !rhs.ucmfDicEntryIdIsSet()) || (ucmfDicEntryIdIsSet() && rhs.ucmfDicEntryIdIsSet() && getUcmfDicEntryId() == rhs.getUcmfDicEntryId())) &&
    
    
    ((!n3IwfIdIsSet() && !rhs.n3IwfIdIsSet()) || (n3IwfIdIsSet() && rhs.n3IwfIdIsSet() && getN3IwfId() == rhs.getN3IwfId())) &&
    
    
    ((!wagfIdIsSet() && !rhs.wagfIdIsSet()) || (wagfIdIsSet() && rhs.wagfIdIsSet() && getWagfId() == rhs.getWagfId())) &&
    
    
    ((!tngfIdIsSet() && !rhs.tngfIdIsSet()) || (tngfIdIsSet() && rhs.tngfIdIsSet() && getTngfId() == rhs.getTngfId())) &&
    
    
    ((!anN2ApIdIsSet() && !rhs.anN2ApIdIsSet()) || (anN2ApIdIsSet() && rhs.anN2ApIdIsSet() && getAnN2ApId() == rhs.getAnN2ApId())) &&
    
    
    ((!nssaaStatusListIsSet() && !rhs.nssaaStatusListIsSet()) || (nssaaStatusListIsSet() && rhs.nssaaStatusListIsSet() && getNssaaStatusList() == rhs.getNssaaStatusList())) &&
    
    
    ((!pendingNssaiMappingListIsSet() && !rhs.pendingNssaiMappingListIsSet()) || (pendingNssaiMappingListIsSet() && rhs.pendingNssaiMappingListIsSet() && getPendingNssaiMappingList() == rhs.getPendingNssaiMappingList())) &&
    
    
    ((!uuaaMmStatusIsSet() && !rhs.uuaaMmStatusIsSet()) || (uuaaMmStatusIsSet() && rhs.uuaaMmStatusIsSet() && getUuaaMmStatus() == rhs.getUuaaMmStatus()))
...
void to_json(nlohmann::json& j, const MmContext& o)
{
    ...
    if(o.uuaaMmStatusIsSet())
        j["uuaaMmStatus"] = o.m_UuaaMmStatus;
...
oai::model::AccessType MmContext::getAccessType() const
{
    return m_AccessType;
}
void MmContext::setAccessType(oai::model::AccessType const& value)
{
    m_AccessType = value;
}
oai::model::NasSecurityMode MmContext::getNasSecurityMode() const
{
    return m_NasSecurityMode;
}
void MmContext::setNasSecurityMode(oai::model::NasSecurityMode const& value)
{
...
oai::model::EpsNasSecurityMode MmContext::getEpsNasSecurityMode() const
{
    return m_EpsNasSecurityMode;
}
void MmContext::setEpsNasSecurityMode(oai::model::EpsNasSecurityMode const& value)
{
...
std::vector<oai::model::Snssai> MmContext::getAllowedNssai() const
{
    return m_AllowedNssai;
}
void MmContext::setAllowedNssai(std::vector<oai::model::Snssai> const& value)
{
...
std::vector<oai::model::NssaiMapping> MmContext::getNssaiMappingList() const
{
    return m_NssaiMappingList;
}
void MmContext::setNssaiMappingList(std::vector<oai::model::NssaiMapping> const& value)
{
...
std::vector<oai::model::Snssai> MmContext::getAllowedHomeNssai() const
{
    return m_AllowedHomeNssai;
}
void MmContext::setAllowedHomeNssai(std::vector<oai::model::Snssai> const& value)
{
...
oai::model::ExpectedUeBehavior MmContext::getExpectedUEbehavior() const
{
    return m_ExpectedUEbehavior;
}
void MmContext::setExpectedUEbehavior(oai::model::ExpectedUeBehavior const& value)
{
...
oai::model::UeDifferentiationInfo MmContext::getUeDifferentiationInfo() const
{
    return m_UeDifferentiationInfo;
}
void MmContext::setUeDifferentiationInfo(oai::model::UeDifferentiationInfo const& value)
{
...
oai::model::GlobalRanNodeId MmContext::getN3IwfId() const
{
    return m_N3IwfId;
}
void MmContext::setN3IwfId(oai::model::GlobalRanNodeId const& value)
{
    m_N3IwfId = value;
    m_N3IwfIdIsSet = true;
}
...
oai::model::GlobalRanNodeId MmContext::getWagfId() const
{
    return m_WagfId;
}
void MmContext::setWagfId(oai::model::GlobalRanNodeId const& value)
{
    m_WagfId = value;
    m_WagfIdIsSet = true;
}
...
oai::model::GlobalRanNodeId MmContext::getTngfId() const
{
    return m_TngfId;
}
void MmContext::setTngfId(oai::model::GlobalRanNodeId const& value)
{
    m_TngfId = value;
    m_TngfIdIsSet = true;
}
...
std::vector<oai::model::NssaaStatus> MmContext::getNssaaStatusList() const
{
    return m_NssaaStatusList;
}
void MmContext::setNssaaStatusList(std::vector<oai::model::NssaaStatus> const& value)
{
...
std::vector<oai::model::NssaiMapping> MmContext::getPendingNssaiMappingList() const
{
    return m_PendingNssaiMappingList;
}
void MmContext::setPendingNssaiMappingList(std::vector<oai::model::NssaiMapping> const& value)
{
...
oai::model::UuaaMmStatus MmContext::getUuaaMmStatus() const
{
    return m_UuaaMmStatus;
}
void MmContext::setUuaaMmStatus(oai::model::UuaaMmStatus const& value)
{
