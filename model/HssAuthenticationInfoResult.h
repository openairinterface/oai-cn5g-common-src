...
public:
    ...
    /// 
    /// </summary>
    oai::model::HssAuthenticationVectors getHssAuthenticationVectors() const;
    void setHssAuthenticationVectors(oai::model::HssAuthenticationVectors const& value);

    friend  void to_json(nlohmann::json& j, const HssAuthenticationInfoResult& o);
    friend  void from_json(const nlohmann::json& j, HssAuthenticationInfoResult& o);
protected:
    std::string m_SupportedFeatures;
    bool m_SupportedFeaturesIsSet;
    oai::model::HssAuthenticationVectors m_HssAuthenticationVectors;
