...
void to_json(nlohmann::json &j, const EventNotification &o) {
  ...
  if (o.usageReportIsSet())
    j["Usage Report"] = o.m_usageReport;
}
...
SmfEvent EventNotification::getEvent() const { return m_Event; }
void EventNotification::setEvent(SmfEvent const &value) { m_Event = value; }
std::string EventNotification::getTimeStamp() const { return m_TimeStamp; }
void EventNotification::setTimeStamp(std::string const &value) {
  m_TimeStamp = value;
}
std::string EventNotification::getSupi() const { return m_Supi; }
void EventNotification::setSupi(std::string const &value) {
  m_Supi = value;
  m_SupiIsSet = true;
}
bool EventNotification::supiIsSet() const { return m_SupiIsSet; }
void EventNotification::unsetSupi() { m_SupiIsSet = false; }
...
bool EventNotification::dnaiChgTypeIsSet() const { return m_DnaiChgTypeIsSet; }
void EventNotification::unsetDnaiChgType() { m_DnaiChgTypeIsSet = false; }
...
std::string EventNotification::getAdIpv4Addr() const { return m_AdIpv4Addr; }
void EventNotification::setAdIpv4Addr(std::string const &value) {
  m_AdIpv4Addr = value;
  m_AdIpv4AddrIsSet = true;
}
bool EventNotification::adIpv4AddrIsSet() const { return m_AdIpv4AddrIsSet; }
void EventNotification::unsetAdIpv4Addr() { m_AdIpv4AddrIsSet = false; }
Ipv6Prefix EventNotification::getAdIpv6Prefix() const { return m_AdIpv6Prefix; }
...
void EventNotification::unsetAdIpv6Prefix() { m_AdIpv6PrefixIsSet = false; }
std::string EventNotification::getReIpv4Addr() const { return m_ReIpv4Addr; }
void EventNotification::setReIpv4Addr(std::string const &value) {
  m_ReIpv4Addr = value;
  m_ReIpv4AddrIsSet = true;
}
bool EventNotification::reIpv4AddrIsSet() const { return m_ReIpv4AddrIsSet; }
void EventNotification::unsetReIpv4Addr() { m_ReIpv4AddrIsSet = false; }
Ipv6Prefix EventNotification::getReIpv6Prefix() const { return m_ReIpv6Prefix; }
...
void EventNotification::unsetReIpv6Prefix() { m_ReIpv6PrefixIsSet = false; }
...
bool EventNotification::plmnIdIsSet() const { return m_PlmnIdIsSet; }
void EventNotification::unsetPlmnId() { m_PlmnIdIsSet = false; }
...
bool EventNotification::accTypeIsSet() const { return m_AccTypeIsSet; }
void EventNotification::unsetAccType() { m_AccTypeIsSet = false; }
int32_t EventNotification::getPduSeId() const { return m_PduSeId; }
void EventNotification::setPduSeId(int32_t const value) {
  m_PduSeId = value;
  m_PduSeIdIsSet = true;
}
bool EventNotification::pduSeIdIsSet() const { return m_PduSeIdIsSet; }
void EventNotification::unsetPduSeId() { m_PduSeIdIsSet = false; }
DddStatus EventNotification::getDddStatus() const { return m_DddStatus; }
void EventNotification::setDddStatus(DddStatus const &value) {
  m_DddStatus = value;
  m_DddStatusIsSet = true;
}
bool EventNotification::dddStatusIsSet() const { return m_DddStatusIsSet; }
void EventNotification::unsetDddStatus() { m_DddStatusIsSet = false; }
std::string EventNotification::getMaxWaitTime() const { return m_MaxWaitTime; }
void EventNotification::setMaxWaitTime(std::string const &value) {
  m_MaxWaitTime = value;
  m_MaxWaitTimeIsSet = true;
}
bool EventNotification::maxWaitTimeIsSet() const { return m_MaxWaitTimeIsSet; }
void EventNotification::unsetMaxWaitTime() { m_MaxWaitTimeIsSet = false; }
UsageReport EventNotification::getUsageReport() const { return m_usageReport; }
void EventNotification::setUsageReport(UsageReport const &value) {
  m_usageReport = value;
  m_usageReportIsSet = true;
}
bool EventNotification::usageReportIsSet() const { return m_usageReportIsSet; }
void EventNotification::unsetUsageReport() { m_usageReportIsSet = false; }
