...
bool ExceptionInfo::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    ...
    /* Exceps */ {
        const std::vector<oai::model::Exception>& value = m_Exceps;
...
oai::model::FlowInfo ExceptionInfo::getIpTrafficFilter() const
{
    return m_IpTrafficFilter;
}
void ExceptionInfo::setIpTrafficFilter(oai::model::FlowInfo const& value)
{
...
oai::model::EthFlowDescription ExceptionInfo::getEthTrafficFilter() const
{
    return m_EthTrafficFilter;
}
void ExceptionInfo::setEthTrafficFilter(oai::model::EthFlowDescription const& value)
{
...
std::vector<oai::model::Exception> ExceptionInfo::getExceps() const
{
    return m_Exceps;
}
void ExceptionInfo::setExceps(std::vector<oai::model::Exception> const& value)
{
    m_Exceps = value;
}
