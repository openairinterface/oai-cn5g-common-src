  ...
  /*
    Plain NAS 5GS Message
        ...
        5GS mobile identity
            ...
            Scheme output: 25b6b6df89af58b0e70787fe5277a6317c2cc47d764a81aa3eccbea37bd05740aee0d554…
                ECC ephemeral public key: 25b6b6df89af58b0e70787fe5277a6317c2cc47d764a81aa3eccbea37bd05740
                Ciphertext: aee0d55470bff47c08
                MAC tag: 0xe31df9b855991248
        UE security capability
            Element ID: 0x2e
            Length: 2
            1... .... = 5G-EA0: Supported
...
TEST(TestSuiteNasMsg, positiveTestingRegistrationRequestGuti)
{
  ...
  Plain NAS 5GS Message
    ...
    5GMM capability
        ...
        .0.. .... = IP header compression for control plane CIoT 5GS optimization (5G-IPHC-CP CIoT): Not supported
        ..0. .... = N3 data transfer (N3 data): Not supported
        ...0 .... = Control plane CIoT 5GS optimization (5G-CP CIoT): Not supported
        .... 0... = Restriction on use of enhanced coverage support (RestrictEC): Not supported
        .... .0.. = LTE Positioning Protocol (LPP) capability: Not supported
        .... ..1. = ATTACH REQUEST message containing PDN CONNECTIVITY REQUEST message for handover support (HO attach): Supported
    ...
    5GS update type
        ...
        0... .... = Spare: 0
        .0.. .... = Spare: 0
        ..00 .... = EPS Preferred CIoT network behaviour (EPS-PNB-CIoT): no additional information (0)
        .... 00.. = 5GS Preferred CIoT network behaviour (5GS PNB-CIoT): no additional information (0)
...
Plain NAS 5GS Message
    ...
    5GMM capability
        ...
        .... 0... = Restriction on use of enhanced coverage support (RestrictEC): Not supported
        .... .0.. = LTE Positioning Protocol (LPP) capability: Not supported
        .... ..0. = ATTACH REQUEST message containing PDN CONNECTIVITY REQUEST message for handover support (HO attach): Not supported
    ...
    MICO indication
        ...
        .... 0... = Spare: 0
        .... .0.. = Spare: 0
        .... ..0. = Strictly Periodic Registration Timer Indication (SPRTI): Not supported
        .... ...0 = Registration Area Allocation Indication (RAAI): all PLMN registration area not allocated
    UE status
        Element ID: 0x2b
        Length: 1
        0... .... = Spare: 0
...
Plain NAS 5GS Message
    ...
    5GS mobile identity
        ...
        Scheme output: a1ae7e561b544b7c74030989a92155d78bbf28535fb59423b4cb640e6c1ed43715e83c72…
            ECC ephemeral public key: a1ae7e561b544b7c74030989a92155d78bbf28535fb59423b4cb640e6c1ed437
            Ciphertext: 15e83c7239
            MAC tag: 0x1f158a9d7acc094b
  */
  uint8_t packet_bytes[] = {
      ...
      0x72, 0x39, 0x1f, 0x15, 0x8a, 0x9d, 0x7a, 0xcc, 0x09, 0x4b}; // TODO check may add 0x00 ?};
...
Plain NAS 5GS Message
    ...
    Authentication response parameter
        Element ID: 0x2d
        Length: 16
        RES: 25706f9a5b90b6c957506c883d76cc63
  */
    uint8_t packet_bytes[] = {
...
Plain NAS 5GS Message
    ...
    0000 .... = Spare Half Octet: 0
    .... 0000 = Security header type: Plain NAS message, not security protected (0)
    Message type: Authentication failure (0x59)
    5GMM cause
        5GMM cause: UE security capabilities mismatch (23)
  */
    uint8_t packet_bytes[] = {
      0x7e, 0x0, 0x59, 0x17}; 
...
Non-Access-Stratum 5GS (NAS)PDU
    Plain NAS 5GS Message
        ...
        Message type: Authentication failure (0x59)
        5GMM cause
            5GMM cause: Security mode rejected, unspecified (24)
  */
    uint8_t packet_bytes[] = {
      0x7e, 0x0, 0x59, 0x18}; 
...
Security protected NAS 5GS message
    ...
    Message authentication code: 0x54f6e12a
    Sequence number: 0
Plain NAS 5GS Message
    Extended protocol discriminator: 5G mobility management messages (126)
    0000 .... = Spare Half Octet: 0
  ...
  */
  uint8_t packet_bytes[] = {
      ...
      0x7e, 0x00, 0x5e, 0x77, 0x00, 0x09, 0x45, 0x73,
      0x80, 0x61, 0x21, 0x85, 0x61, 0x51, 0xf1, 0x71,
      0x00, 0x23, 0x7e, 0x00, 0x41, 0x79, 0x00, 0x0d,
      0x01, 0x22, 0x62, 0x54, 0x00, 0x00, 0x00, 0x00,
      0x00, 0x00, 0x00, 0x00, 0xf1, 0x10, 0x01, 0x00,
      0x2e, 0x08, 0x80, 0x20, 0x00, 0x00, 0x00, 0x00,
      0x00, 0x00, 0x2f, 0x02, 0x01};
  //, 0x01, 0x53, 0x01,
  //    0x00};
...
NAS-PDU: 7e025d5f4918017e0043
    Non-Access-Stratum 5GS (NAS)PDU
        Security protected NAS 5GS message
            ...
            Message authentication code: 0x5d5f4918
            Sequence number: 1
        Plain NAS 5GS Message
            Extended protocol discriminator: 5G mobility management messages (126)
            0000 .... = Spare Half Octet: 0
...
TEST(TestSuiteNasMsg, positiveTestingServiceRequestWithPdu)
{
  ...
  Plain NAS 5GS Message
      ...
      0000 .... = Spare Half Octet: 0
      .... 0000 = Security header type: Plain NAS message, not security protected (0)
      Message type: Service request (0x4c)
      NAS key set identifier
          .... 0... = Type of security context flag (TSC): Native security context (for KSIAMF)
          .... .000 = NAS key set identifier: 0
      Service type
