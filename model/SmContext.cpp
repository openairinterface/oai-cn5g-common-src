...
bool SmContext::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    ...
    if (!m_PduSessionType.validate(msg, _pathPrefix + ".pduSessionType")) {
        msg << _pathPrefix << ": PduSessionType is invalid;";
        success = false;
    }     
    if (gpsiIsSet())
    {
    ...
    if (!m_SessionAmbr.validate(msg, _pathPrefix + ".sessionAmbr")) {
        msg << _pathPrefix << ": SessionAmbr is invalid;";
        success = false;
    }     
    
    /* QosFlowsList */ {
        const std::vector<oai::model::QosFlowSetupItem>& value = m_QosFlowsList;
        ...
        { // Recursive validation of array elements
            ...
            int i = 0;
            for (const oai::model::QosFlowSetupItem& value : value)
            { 
                const std::string currentValuePath = oldValuePath + "[" + std::to_string(i) + "]";
                        
        success = value.validate(msg, currentValuePath + ".qosFlowsList") && success;
    ...
    {
        const std::vector<oai::model::EpsBearerInfo>& value = m_EpsBearerInfo;
        ...
        { // Recursive validation of array elements
            const std::string oldValuePath = currentValuePath;
            int i = 0;
            for (const oai::model::EpsBearerInfo& value : value)
            { 
                const std::string currentValuePath = oldValuePath + "[" + std::to_string(i) + "]";
                        
        success = value.validate(msg, currentValuePath + ".epsBearerInfo") && success;
    ...
    {
        const std::vector<oai::model::QosFlowTunnel>& value = m_AddRanTunnelInfo;
        ...
        { // Recursive validation of array elements
            const std::string oldValuePath = currentValuePath;
            int i = 0;
            for (const oai::model::QosFlowTunnel& value : value)
            { 
                const std::string currentValuePath = oldValuePath + "[" + std::to_string(i) + "]";
                        
        success = value.validate(msg, currentValuePath + ".addRanTunnelInfo") && success;
    ...
    {
        const std::vector<oai::model::QosFlowTunnel>& value = m_AddRedRanTunnelInfo;
        ...
        success = value.validate(msg, currentValuePath + ".addRedRanTunnelInfo") && success;
...
bool SmContext::operator==(const SmContext& rhs) const
{
    ...
    ((!hSmfUriIsSet() && !rhs.hSmfUriIsSet()) || (hSmfUriIsSet() && rhs.hSmfUriIsSet() && getHSmfUri() == rhs.getHSmfUri())) &&
    
    
    ((!smfUriIsSet() && !rhs.smfUriIsSet()) || (smfUriIsSet() && rhs.smfUriIsSet() && getSmfUri() == rhs.getSmfUri())) &&
    
    
    ((!pduSessionRefIsSet() && !rhs.pduSessionRefIsSet()) || (pduSessionRefIsSet() && rhs.pduSessionRefIsSet() && getPduSessionRef() == rhs.getPduSessionRef())) &&
    ...
    ((!hSmfInstanceIdIsSet() && !rhs.hSmfInstanceIdIsSet()) || (hSmfInstanceIdIsSet() && rhs.hSmfInstanceIdIsSet() && getHSmfInstanceId() == rhs.getHSmfInstanceId())) &&
    
    
    ((!smfInstanceIdIsSet() && !rhs.smfInstanceIdIsSet()) || (smfInstanceIdIsSet() && rhs.smfInstanceIdIsSet() && getSmfInstanceId() == rhs.getSmfInstanceId())) &&
    
    
    ((!pduSessionSmfSetIdIsSet() && !rhs.pduSessionSmfSetIdIsSet()) || (pduSessionSmfSetIdIsSet() && rhs.pduSessionSmfSetIdIsSet() && getPduSessionSmfSetId() == rhs.getPduSessionSmfSetId())) &&
    
    
    ((!pduSessionSmfServiceSetIdIsSet() && !rhs.pduSessionSmfServiceSetIdIsSet()) || (pduSessionSmfServiceSetIdIsSet() && rhs.pduSessionSmfServiceSetIdIsSet() && getPduSessionSmfServiceSetId() == rhs.getPduSessionSmfServiceSetId())) &&
    
    
    ((!pduSessionSmfBindingIsSet() && !rhs.pduSessionSmfBindingIsSet()) || (pduSessionSmfBindingIsSet() && rhs.pduSessionSmfBindingIsSet() && getPduSessionSmfBinding() == rhs.getPduSessionSmfBinding())) &&
    
    
    ((!enablePauseChargingIsSet() && !rhs.enablePauseChargingIsSet()) || (enablePauseChargingIsSet() && rhs.enablePauseChargingIsSet() && isEnablePauseCharging() == rhs.isEnablePauseCharging())) &&
    
    
    ((!ueIpv4AddressIsSet() && !rhs.ueIpv4AddressIsSet()) || (ueIpv4AddressIsSet() && rhs.ueIpv4AddressIsSet() && getUeIpv4Address() == rhs.getUeIpv4Address())) &&
    ...
    ((!epsBearerInfoIsSet() && !rhs.epsBearerInfoIsSet()) || (epsBearerInfoIsSet() && rhs.epsBearerInfoIsSet() && getEpsBearerInfo() == rhs.getEpsBearerInfo())) &&
    
    
    ((!maxIntegrityProtectedDataRateIsSet() && !rhs.maxIntegrityProtectedDataRateIsSet()) || (maxIntegrityProtectedDataRateIsSet() && rhs.maxIntegrityProtectedDataRateIsSet() && getMaxIntegrityProtectedDataRate() == rhs.getMaxIntegrityProtectedDataRate())) &&
    ...
    ((!alwaysOnGrantedIsSet() && !rhs.alwaysOnGrantedIsSet()) || (alwaysOnGrantedIsSet() && rhs.alwaysOnGrantedIsSet() && isAlwaysOnGranted() == rhs.isAlwaysOnGranted())) &&
    
    
    ((!upSecurityIsSet() && !rhs.upSecurityIsSet()) || (upSecurityIsSet() && rhs.upSecurityIsSet() && getUpSecurity() == rhs.getUpSecurity())) &&
    
    
    ((!hSmfServiceInstanceIdIsSet() && !rhs.hSmfServiceInstanceIdIsSet()) || (hSmfServiceInstanceIdIsSet() && rhs.hSmfServiceInstanceIdIsSet() && getHSmfServiceInstanceId() == rhs.getHSmfServiceInstanceId())) &&
    
    
    ((!smfServiceInstanceIdIsSet() && !rhs.smfServiceInstanceIdIsSet()) || (smfServiceInstanceIdIsSet() && rhs.smfServiceInstanceIdIsSet() && getSmfServiceInstanceId() == rhs.getSmfServiceInstanceId())) &&
    
    
    ((!recoveryTimeIsSet() && !rhs.recoveryTimeIsSet()) || (recoveryTimeIsSet() && rhs.recoveryTimeIsSet() && getRecoveryTime() == rhs.getRecoveryTime())) &&
    
    
    ((!forwardingIndIsSet() && !rhs.forwardingIndIsSet()) || (forwardingIndIsSet() && rhs.forwardingIndIsSet() && isForwardingInd() == rhs.isForwardingInd())) &&
    
    
    ((!psaTunnelInfoIsSet() && !rhs.psaTunnelInfoIsSet()) || (psaTunnelInfoIsSet() && rhs.psaTunnelInfoIsSet() && getPsaTunnelInfo() == rhs.getPsaTunnelInfo())) &&
    
    
    ((!chargingIdIsSet() && !rhs.chargingIdIsSet()) || (chargingIdIsSet() && rhs.chargingIdIsSet() && getChargingId() == rhs.getChargingId())) &&
    
    
    ((!chargingInfoIsSet() && !rhs.chargingInfoIsSet()) || (chargingInfoIsSet() && rhs.chargingInfoIsSet() && getChargingInfo() == rhs.getChargingInfo())) &&
    ...
    ((!nefExtBufSupportIndIsSet() && !rhs.nefExtBufSupportIndIsSet()) || (nefExtBufSupportIndIsSet() && rhs.nefExtBufSupportIndIsSet() && isNefExtBufSupportInd() == rhs.isNefExtBufSupportInd())) &&
    ...
    ((!ranTunnelInfoIsSet() && !rhs.ranTunnelInfoIsSet()) || (ranTunnelInfoIsSet() && rhs.ranTunnelInfoIsSet() && getRanTunnelInfo() == rhs.getRanTunnelInfo())) &&
    
    
    ((!addRanTunnelInfoIsSet() && !rhs.addRanTunnelInfoIsSet()) || (addRanTunnelInfoIsSet() && rhs.addRanTunnelInfoIsSet() && getAddRanTunnelInfo() == rhs.getAddRanTunnelInfo())) &&
    
    
    ((!redRanTunnelInfoIsSet() && !rhs.redRanTunnelInfoIsSet()) || (redRanTunnelInfoIsSet() && rhs.redRanTunnelInfoIsSet() && getRedRanTunnelInfo() == rhs.getRedRanTunnelInfo())) &&
    
    
    ((!addRedRanTunnelInfoIsSet() && !rhs.addRedRanTunnelInfoIsSet()) || (addRedRanTunnelInfoIsSet() && rhs.addRedRanTunnelInfoIsSet() && getAddRedRanTunnelInfo() == rhs.getAddRedRanTunnelInfo())) &&
    
    
    ((!nspuSupportIndIsSet() && !rhs.nspuSupportIndIsSet()) || (nspuSupportIndIsSet() && rhs.nspuSupportIndIsSet() && isNspuSupportInd() == rhs.isNspuSupportInd())) &&
    
    
    ((!smfBindingInfoIsSet() && !rhs.smfBindingInfoIsSet()) || (smfBindingInfoIsSet() && rhs.smfBindingInfoIsSet() && getSmfBindingInfo() == rhs.getSmfBindingInfo())) &&
    ...
    ((!dlsetSupportIndIsSet() && !rhs.dlsetSupportIndIsSet()) || (dlsetSupportIndIsSet() && rhs.dlsetSupportIndIsSet() && isDlsetSupportInd() == rhs.isDlsetSupportInd())) &&
    
    
    ((!n9fscSupportIndIsSet() && !rhs.n9fscSupportIndIsSet()) || (n9fscSupportIndIsSet() && rhs.n9fscSupportIndIsSet() && isN9fscSupportInd() == rhs.isN9fscSupportInd())) &&
    
    
    ((!anchorSmfOauth2RequiredIsSet() && !rhs.anchorSmfOauth2RequiredIsSet()) || (anchorSmfOauth2RequiredIsSet() && rhs.anchorSmfOauth2RequiredIsSet() && isAnchorSmfOauth2Required() == rhs.isAnchorSmfOauth2Required()))
...
void to_json(nlohmann::json& j, const SmContext& o)
{
    ...
    if(o.smfBindingInfoIsSet())
        j["smfBindingInfo"] = o.m_SmfBindingInfo;
    if(o.satelliteBackhaulCatIsSet())
        j["satelliteBackhaulCat"] = o.m_SatelliteBackhaulCat;
    if(o.sscModeIsSet())
        j["sscMode"] = o.m_SscMode;
    if(o.dlsetSupportIndIsSet())
        j["dlsetSupportInd"] = o.m_DlsetSupportInd;
    if(o.n9fscSupportIndIsSet())
        j["n9fscSupportInd"] = o.m_N9fscSupportInd;
...
void from_json(const nlohmann::json& j, SmContext& o)
{
    ...
    {
        j.at("maxIntegrityProtectedDataRate").get_to(o.m_MaxIntegrityProtectedDataRate);
...
oai::model::Snssai SmContext::getSNssai() const
{
    return m_SNssai;
}
void SmContext::setSNssai(oai::model::Snssai const& value)
{
    m_SNssai = value;
}
oai::model::Snssai SmContext::getHplmnSnssai() const
{
    return m_HplmnSnssai;
}
void SmContext::setHplmnSnssai(oai::model::Snssai const& value)
{
    m_HplmnSnssai = value;
...
oai::model::PduSessionType SmContext::getPduSessionType() const
{
    return m_PduSessionType;
}
void SmContext::setPduSessionType(oai::model::PduSessionType const& value)
{
...
oai::model::DnnSelectionMode SmContext::getSelMode() const
{
    return m_SelMode;
}
void SmContext::setSelMode(oai::model::DnnSelectionMode const& value)
{
    m_SelMode = value;
    m_SelModeIsSet = true;
}
...
oai::model::Ambr SmContext::getSessionAmbr() const
{
    return m_SessionAmbr;
}
void SmContext::setSessionAmbr(oai::model::Ambr const& value)
{
    m_SessionAmbr = value;
}
std::vector<oai::model::QosFlowSetupItem> SmContext::getQosFlowsList() const
{
    return m_QosFlowsList;
}
void SmContext::setQosFlowsList(std::vector<oai::model::QosFlowSetupItem> const& value)
{
...
oai::model::SbiBindingLevel SmContext::getPduSessionSmfBinding() const
{
    return m_PduSessionSmfBinding;
}
void SmContext::setPduSessionSmfBinding(oai::model::SbiBindingLevel const& value)
{
...
oai::model::Ipv6Prefix SmContext::getUeIpv6Prefix() const
{
    return m_UeIpv6Prefix;
}
void SmContext::setUeIpv6Prefix(oai::model::Ipv6Prefix const& value)
{
...
oai::model::EpsPdnCnxInfo SmContext::getEpsPdnCnxInfo() const
{
    return m_EpsPdnCnxInfo;
}
void SmContext::setEpsPdnCnxInfo(oai::model::EpsPdnCnxInfo const& value)
{
...
std::vector<oai::model::EpsBearerInfo> SmContext::getEpsBearerInfo() const
{
    return m_EpsBearerInfo;
}
void SmContext::setEpsBearerInfo(std::vector<oai::model::EpsBearerInfo> const& value)
{
...
oai::model::MaxIntegrityProtectedDataRate SmContext::getMaxIntegrityProtectedDataRate() const
{
    return m_MaxIntegrityProtectedDataRate;
}
void SmContext::setMaxIntegrityProtectedDataRate(oai::model::MaxIntegrityProtectedDataRate const& value)
{
...
oai::model::MaxIntegrityProtectedDataRate SmContext::getMaxIntegrityProtectedDataRateDl() const
{
    return m_MaxIntegrityProtectedDataRateDl;
}
void SmContext::setMaxIntegrityProtectedDataRateDl(oai::model::MaxIntegrityProtectedDataRate const& value)
{
...
oai::model::UpSecurity SmContext::getUpSecurity() const
{
    return m_UpSecurity;
}
void SmContext::setUpSecurity(oai::model::UpSecurity const& value)
{
    m_UpSecurity = value;
...
oai::model::TunnelInfo SmContext::getPsaTunnelInfo() const
{
    return m_PsaTunnelInfo;
}
void SmContext::setPsaTunnelInfo(oai::model::TunnelInfo const& value)
{
...
oai::model::ChargingInformation SmContext::getChargingInfo() const
{
    return m_ChargingInfo;
}
void SmContext::setChargingInfo(oai::model::ChargingInformation const& value)
{
...
oai::model::RoamingChargingProfile SmContext::getRoamingChargingProfile() const
{
    return m_RoamingChargingProfile;
}
void SmContext::setRoamingChargingProfile(oai::model::RoamingChargingProfile const& value)
{
...
oai::model::IpAddress SmContext::getDnAaaAddress() const
{
    return m_DnAaaAddress;
}
void SmContext::setDnAaaAddress(oai::model::IpAddress const& value)
{
...
oai::model::RedundantPduSessionInformation SmContext::getRedundantPduSessionInfo() const
{
    return m_RedundantPduSessionInfo;
}
void SmContext::setRedundantPduSessionInfo(oai::model::RedundantPduSessionInformation const& value)
{
...
oai::model::QosFlowTunnel SmContext::getRanTunnelInfo() const
{
    return m_RanTunnelInfo;
}
void SmContext::setRanTunnelInfo(oai::model::QosFlowTunnel const& value)
{
...
std::vector<oai::model::QosFlowTunnel> SmContext::getAddRanTunnelInfo() const
{
    return m_AddRanTunnelInfo;
}
void SmContext::setAddRanTunnelInfo(std::vector<oai::model::QosFlowTunnel> const& value)
{
...
oai::model::QosFlowTunnel SmContext::getRedRanTunnelInfo() const
{
    return m_RedRanTunnelInfo;
}
void SmContext::setRedRanTunnelInfo(oai::model::QosFlowTunnel const& value)
{
...
std::vector<oai::model::QosFlowTunnel> SmContext::getAddRedRanTunnelInfo() const
{
    return m_AddRedRanTunnelInfo;
}
void SmContext::setAddRedRanTunnelInfo(std::vector<oai::model::QosFlowTunnel> const& value)
{
...
oai::model::SatelliteBackhaulCategory SmContext::getSatelliteBackhaulCat() const
{
    return m_SatelliteBackhaulCat;
}
void SmContext::setSatelliteBackhaulCat(oai::model::SatelliteBackhaulCategory const& value)
{
