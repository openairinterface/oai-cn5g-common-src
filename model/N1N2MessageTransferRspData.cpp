...
oai::_3gpp::model::N1N2MessageTransferCause N1N2MessageTransferRspData::getCause() const
{
    return m_Cause;
}
void N1N2MessageTransferRspData::setCause(oai::_3gpp::model::N1N2MessageTransferCause const& value)
{
    m_Cause = value;
}
