...
bool RegistrationDataSetName_anyOf::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "RegistrationDataSetName_anyOf" : pathPrefix;

    
    if (m_value == RegistrationDataSetName_anyOf::eRegistrationDataSetName_anyOf::INVALID_VALUE_OPENAPI_GENERATED)
    {
        success = false;
...
bool RegistrationDataSetName_anyOf::operator==(const RegistrationDataSetName_anyOf& rhs) const
{
    return
...
void to_json(nlohmann::json& j, const RegistrationDataSetName_anyOf& o)
{
    ...
    switch (o.getValue())
    {
        ...
        case RegistrationDataSetName_anyOf::eRegistrationDataSetName_anyOf::SMSF_NON_3GPP:
            j = "SMSF_NON_3GPP";
            break;
        case RegistrationDataSetName_anyOf::eRegistrationDataSetName_anyOf::IP_SM_GW:
            j = "IP_SM_GW";
            break;
...
void from_json(const nlohmann::json& j, RegistrationDataSetName_anyOf& o)
{
    ...
    if (s == "AMF_3GPP") {
     ...
     o.setValue(RegistrationDataSetName_anyOf::eRegistrationDataSetName_anyOf::IP_SM_GW);
    } 
    else if (s == "NWDAF") {
     o.setValue(RegistrationDataSetName_anyOf::eRegistrationDataSetName_anyOf::NWDAF);
    }  else {
     std::stringstream ss;
