...
bool TngfInfo::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    ...
    {
        const std::vector<oai::_3gpp::model::Ipv6Addr>& value = m_Ipv6EndpointAddresses;
...
std::vector<oai::_3gpp::model::std::string> TngfInfo::getIpv4EndpointAddresses() const
{
    return m_Ipv4EndpointAddresses;
}
void TngfInfo::setIpv4EndpointAddresses(std::vector<oai::_3gpp::model::std::string> const& value)
{
...
std::vector<oai::_3gpp::model::Ipv6Addr> TngfInfo::getIpv6EndpointAddresses() const
{
    return m_Ipv6EndpointAddresses;
}
void TngfInfo::setIpv6EndpointAddresses(std::vector<oai::_3gpp::model::Ipv6Addr> const& value)
{
