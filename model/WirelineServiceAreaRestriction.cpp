...
bool WirelineServiceAreaRestriction::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    ...
    if (areasIsSet())
    {
        const std::vector<oai::_3gpp::model::WirelineArea>& value = m_Areas;
...
oai::_3gpp::model::RestrictionType WirelineServiceAreaRestriction::getRestrictionType() const
{
    return m_RestrictionType;
}
void WirelineServiceAreaRestriction::setRestrictionType(oai::_3gpp::model::RestrictionType const& value)
{
...
std::vector<oai::_3gpp::model::WirelineArea> WirelineServiceAreaRestriction::getAreas() const
{
    return m_Areas;
}
void WirelineServiceAreaRestriction::setAreas(std::vector<oai::_3gpp::model::WirelineArea> const& value)
{
    m_Areas = value;
    m_AreasIsSet = true;
}
