...
asn_TYPE_member_t asn_MBR_Ngap_IntersystemSONConfigurationTransfer_1[] = {
	{ ATF_POINTER, 0, offsetof(struct Ngap_IntersystemSONConfigurationTransfer, transferType),
	...
	{ ATF_POINTER, 0, offsetof(struct Ngap_IntersystemSONConfigurationTransfer, intersystemSONInformation),
