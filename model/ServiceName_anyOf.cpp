...
bool ServiceName_anyOf::validate(
    std::stringstream& msg, const std::string& pathPrefix) const {
  bool success = true;
  const std::string _pathPrefix =
      pathPrefix.empty() ? "ServiceName_anyOf" : pathPrefix;

  if (m_value ==
      ServiceName_anyOf::eServiceName_anyOf::INVALID_VALUE_OPENAPI_GENERATED) {
    success = false;
...
void to_json(nlohmann::json& j, const ServiceName_anyOf& o) {
  ...
  switch (o.getValue()) {
    ...
    case ServiceName_anyOf::eServiceName_anyOf::NUDM_SSAU:
      j = "nudm-ssau";
      break;
    case ServiceName_anyOf::eServiceName_anyOf::NUDM_RSDS:
      j = "nudm-rsds";
      break;
    case ServiceName_anyOf::eServiceName_anyOf::NUDM_UEID:
      j = "nudm-ueid";
      break;
    ...
    case ServiceName_anyOf::eServiceName_anyOf::NNEF_EVENTEXPOSURE:
      ...
      break;
    case ServiceName_anyOf::eServiceName_anyOf::NNEF_EAS_DEPLOYMENT:
      j = "nnef-eas-deployment";
      break;
    ...
    case ServiceName_anyOf::eServiceName_anyOf::_3GPP_DEVICE_TRIGGERING:
      ...
      break;
    case ServiceName_anyOf::eServiceName_anyOf::_3GPP_BDT:
      j = "3gpp-bdt";
      break;
    ...
    case ServiceName_anyOf::eServiceName_anyOf::_3GPP_SERVICE_PARAMETER:
      ...
      break;
    case ServiceName_anyOf::eServiceName_anyOf::_3GPP_MONITORING_EVENT:
      j = "3gpp-monitoring-event";
      break;
    case ServiceName_anyOf::eServiceName_anyOf::
    ...
    case ServiceName_anyOf::eServiceName_anyOf::_3GPP_ANALYTICSEXPOSURE:
      ...
      break;
    case ServiceName_anyOf::eServiceName_anyOf::
        _3GPP_RACS_PARAMETER_PROVISIONING:
      j = "3gpp-racs-parameter-provisioning";
      break;
    ...
    case ServiceName_anyOf::eServiceName_anyOf::_3GPP_AKMA:
      j = "3gpp-akma";
      break;
    case ServiceName_anyOf::eServiceName_anyOf::_3GPP_EAS_DEPLOYMENT:
      j = "3gpp-eas-deployment";
      break;
    ...
    case ServiceName_anyOf::eServiceName_anyOf::_3GPP_MBS_SESSION:
      j = "3gpp-mbs-session";
      break;
    case ServiceName_anyOf::eServiceName_anyOf::_3GPP_AUTHENTICATION:
      j = "3gpp-authentication";
      break;
    case ServiceName_anyOf::eServiceName_anyOf::_3GPP_ASTI:
      j = "3gpp-asti";
      break;
    ...
    case ServiceName_anyOf::eServiceName_anyOf::NPCF_UE_POLICY_CONTROL:
      ...
      break;
    case ServiceName_anyOf::eServiceName_anyOf::NPCF_AM_POLICYAUTHORIZATION:
      j = "npcf-am-policyauthorization";
      break;
    case ServiceName_anyOf::eServiceName_anyOf::NPCF_MBSPOLICYCONTROL:
      j = "npcf-mbspolicycontrol";
      break;
    case ServiceName_anyOf::eServiceName_anyOf::NPCF_MBSPOLICYAUTH:
      j = "npcf-mbspolicyauth";
      break;
    ...
    case ServiceName_anyOf::eServiceName_anyOf::NNSSAAF_NSSAA:
      j = "nnssaaf-nssaa";
      break;
    case ServiceName_anyOf::eServiceName_anyOf::NNSSAAF_AIW:
      j = "nnssaaf-aiw";
      break;
    ...
    case ServiceName_anyOf::eServiceName_anyOf::N5GDDNMF_DISCOVERY:
      ...
      break;
    case ServiceName_anyOf::eServiceName_anyOf::NMFAF_3DADATAMANAGEMENT:
      j = "nmfaf-3dadatamanagement";
      break;
    case ServiceName_anyOf::eServiceName_anyOf::NMFAF_3CADATAMANAGEMENT:
      j = "nmfaf-3cadatamanagement";
      break;
    ...
    case ServiceName_anyOf::eServiceName_anyOf::NEASDF_BASELINEDNSPATTERN:
      ...
      break;
    case ServiceName_anyOf::eServiceName_anyOf::NDCCF_DATAMANAGEMENT:
      j = "ndccf-datamanagement";
      break;
    case ServiceName_anyOf::eServiceName_anyOf::NDCCF_CONTEXTMANAGEMENT:
      j = "ndccf-contextmanagement";
      break;
    ...
    case ServiceName_anyOf::eServiceName_anyOf::NMBSMF_MBSSESSION:
      j = "nmbsmf-mbssession";
      break;
    case ServiceName_anyOf::eServiceName_anyOf::NADRF_DATAMANAGEMENT:
      j = "nadrf-datamanagement";
      break;
    ...
    case ServiceName_anyOf::eServiceName_anyOf::NTSCTSF_QOS_TSCAI:
      j = "ntsctsf-qos-tscai";
      break;
    case ServiceName_anyOf::eServiceName_anyOf::NTSCTSF_ASTI:
      j = "ntsctsf-asti";
      break;
    case ServiceName_anyOf::eServiceName_anyOf::NPKMF_KEYREQ:
      j = "npkmf-keyreq";
      break;
    case ServiceName_anyOf::eServiceName_anyOf::NPKMF_USERID:
      j = "npkmf-userid";
      break;
    case ServiceName_anyOf::eServiceName_anyOf::NPKMF_DISCOVERY:
      j = "npkmf-discovery";
      break;
    case ServiceName_anyOf::eServiceName_anyOf::NMNPF_NPSTATUS:
      j = "nmnpf-npstatus";
      break;
    case ServiceName_anyOf::eServiceName_anyOf::NIWMSC_SMSERVICE:
      j = "niwmsc-smservice";
      break;
    case ServiceName_anyOf::eServiceName_anyOf::NMBSF_MBS_US:
      j = "nmbsf-mbs-us";
      break;
    case ServiceName_anyOf::eServiceName_anyOf::NMBSF_MBS_UD_INGEST:
      j = "nmbsf-mbs-ud-ingest";
      break;
    case ServiceName_anyOf::eServiceName_anyOf::NMBSTF_DISTSESSION:
      j = "nmbstf-distsession";
      break;
    case ServiceName_anyOf::eServiceName_anyOf::NPANF_PROSEKEY:
      j = "npanf-prosekey";
      break;
    case ServiceName_anyOf::eServiceName_anyOf::NPANF_USERID:
      j = "npanf-userid";
      break;
  }
}
...
void from_json(const nlohmann::json& j, ServiceName_anyOf& o) {
  ...
  if (s == "nnrf-nfm") {
    ...
    o.setValue(ServiceName_anyOf::eServiceName_anyOf::NUDM_RSDS);
  } else if (s == "nudm-ueid") {
  ...
  } else if (s == "nnef-eas-deployment") {
    o.setValue(ServiceName_anyOf::eServiceName_anyOf::NNEF_EAS_DEPLOYMENT);
  } else if (s == "3gpp-cp-parameter-provisioning") {
    o.setValue(
        ServiceName_anyOf::eServiceName_anyOf::_3GPP_CP_PARAMETER_PROVISIONING);
  } else if (s == "3gpp-device-triggering") {
    o.setValue(ServiceName_anyOf::eServiceName_anyOf::_3GPP_DEVICE_TRIGGERING);
  } else if (s == "3gpp-bdt") {
    o.setValue(ServiceName_anyOf::eServiceName_anyOf::_3GPP_BDT);
    ...
    o.setValue(
        ServiceName_anyOf::eServiceName_anyOf::_3GPP_AS_SESSION_WITH_QOS);
  ...
  } else if (s == "3gpp-monitoring-event") {
    o.setValue(ServiceName_anyOf::eServiceName_anyOf::_3GPP_MONITORING_EVENT);
  } else if (s == "3gpp-nidd-configuration-trigger") {
    o.setValue(ServiceName_anyOf::eServiceName_anyOf::
                   _3GPP_NIDD_CONFIGURATION_TRIGGER);
  } else if (s == "3gpp-nidd") {
  ...
  } else if (s == "3gpp-racs-parameter-provisioning") {
    o.setValue(ServiceName_anyOf::eServiceName_anyOf::
                   _3GPP_RACS_PARAMETER_PROVISIONING);
    ...
    o.setValue(
        ServiceName_anyOf::eServiceName_anyOf::_3GPP_APPLYING_BDT_POLICY);
    ...
    o.setValue(
        ServiceName_anyOf::eServiceName_anyOf::_3GPP_AM_POLICYAUTHORIZATION);
  } else if (s == "3gpp-akma") {
    o.setValue(ServiceName_anyOf::eServiceName_anyOf::_3GPP_AKMA);
  } else if (s == "3gpp-eas-deployment") {
    o.setValue(ServiceName_anyOf::eServiceName_anyOf::_3GPP_EAS_DEPLOYMENT);
  ...
  } else if (s == "3gpp-authentication") {
    o.setValue(ServiceName_anyOf::eServiceName_anyOf::_3GPP_AUTHENTICATION);
  } else if (s == "3gpp-asti") {
    o.setValue(ServiceName_anyOf::eServiceName_anyOf::_3GPP_ASTI);
  ...
  } else if (s == "npcf-am-policyauthorization") {
    o.setValue(
        ServiceName_anyOf::eServiceName_anyOf::NPCF_AM_POLICYAUTHORIZATION);
  } else if (s == "npcf-mbspolicycontrol") {
    o.setValue(ServiceName_anyOf::eServiceName_anyOf::NPCF_MBSPOLICYCONTROL);
  } else if (s == "npcf-mbspolicyauth") {
    o.setValue(ServiceName_anyOf::eServiceName_anyOf::NPCF_MBSPOLICYAUTH);
  } else if (s == "nsmsf-sms") {
    ...
    o.setValue(
        ServiceName_anyOf::eServiceName_anyOf::NCHF_SPENDINGLIMITCONTROL);
    ...
    o.setValue(
        ServiceName_anyOf::eServiceName_anyOf::NNWDAF_EVENTSSUBSCRIPTION);
    ...
    o.setValue(
        ServiceName_anyOf::eServiceName_anyOf::NUCMF_UECAPABILITYMANAGEMENT);
  } else if (s == "nhss-sdm") {
  ...
  } else if (s == "nnssaaf-aiw") {
    o.setValue(ServiceName_anyOf::eServiceName_anyOf::NNSSAAF_AIW);
  ...
  } else if (s == "nmfaf-3dadatamanagement") {
    o.setValue(ServiceName_anyOf::eServiceName_anyOf::NMFAF_3DADATAMANAGEMENT);
  } else if (s == "nmfaf-3cadatamanagement") {
    o.setValue(ServiceName_anyOf::eServiceName_anyOf::NMFAF_3CADATAMANAGEMENT);
    ...
    o.setValue(
        ServiceName_anyOf::eServiceName_anyOf::NEASDF_BASELINEDNSPATTERN);
  } else if (s == "ndccf-datamanagement") {
    o.setValue(ServiceName_anyOf::eServiceName_anyOf::NDCCF_DATAMANAGEMENT);
  } else if (s == "ndccf-contextmanagement") {
    o.setValue(ServiceName_anyOf::eServiceName_anyOf::NDCCF_CONTEXTMANAGEMENT);
  ...
  } else if (s == "nadrf-datamanagement") {
    o.setValue(ServiceName_anyOf::eServiceName_anyOf::NADRF_DATAMANAGEMENT);
  } else if (s == "nbsp-gba") {
  ...
  } else if (s == "ntsctsf-asti") {
    o.setValue(ServiceName_anyOf::eServiceName_anyOf::NTSCTSF_ASTI);
  } else if (s == "npkmf-keyreq") {
    o.setValue(ServiceName_anyOf::eServiceName_anyOf::NPKMF_KEYREQ);
  } else if (s == "npkmf-userid") {
    o.setValue(ServiceName_anyOf::eServiceName_anyOf::NPKMF_USERID);
  } else if (s == "npkmf-discovery") {
    o.setValue(ServiceName_anyOf::eServiceName_anyOf::NPKMF_DISCOVERY);
  } else if (s == "nmnpf-npstatus") {
    o.setValue(ServiceName_anyOf::eServiceName_anyOf::NMNPF_NPSTATUS);
  } else if (s == "niwmsc-smservice") {
    o.setValue(ServiceName_anyOf::eServiceName_anyOf::NIWMSC_SMSERVICE);
  } else if (s == "nmbsf-mbs-us") {
    o.setValue(ServiceName_anyOf::eServiceName_anyOf::NMBSF_MBS_US);
  } else if (s == "nmbsf-mbs-ud-ingest") {
    o.setValue(ServiceName_anyOf::eServiceName_anyOf::NMBSF_MBS_UD_INGEST);
  } else if (s == "nmbstf-distsession") {
    o.setValue(ServiceName_anyOf::eServiceName_anyOf::NMBSTF_DISTSESSION);
  } else if (s == "npanf-prosekey") {
    o.setValue(ServiceName_anyOf::eServiceName_anyOf::NPANF_PROSEKEY);
  } else if (s == "npanf-userid") {
    o.setValue(ServiceName_anyOf::eServiceName_anyOf::NPANF_USERID);
  } else {
    std::stringstream ss;
