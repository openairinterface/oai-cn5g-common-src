...
NFProfile::NFProfile() {
  ...
  m_HniListIsSet                          = false;
  m_IwmscInfoIsSet                        = false;
  m_MnpfInfoIsSet                         = false;
}
...
bool NFProfile::validate(
    std::stringstream& msg, const std::string& pathPrefix) const {
  bool success                  = true;
  const std::string _pathPrefix = pathPrefix.empty() ? "NFProfile" : pathPrefix;

  if (collocatedNfInstancesIsSet()) {
    const std::vector<oai::_3gpp::model::CollocatedNfInstance>& value =
        m_CollocatedNfInstances;
    ...
    {  // Recursive validation of array elements
      ...
      int i                          = 0;
      for (const oai::_3gpp::model::CollocatedNfInstance& value : value) {
        const std::string currentValuePath =
            oldValuePath + "[" + std::to_string(i) + "]";

        success =
            value.validate(msg, currentValuePath + ".collocatedNfInstances") &&
            success;
  ...
  if (plmnListIsSet()) {
    const std::vector<oai::_3gpp::model::PlmnId>& value = m_PlmnList;
    ...
    {  // Recursive validation of array elements
      ...
      for (const oai::_3gpp::model::PlmnId& value : value) {
        ...
        success =
            value.validate(msg, currentValuePath + ".plmnList") && success;
  ...
  if (snpnListIsSet()) {
    const std::vector<oai::_3gpp::model::PlmnIdNid>& value = m_SnpnList;
    ...
    {  // Recursive validation of array elements
      ...
      for (const oai::_3gpp::model::PlmnIdNid& value : value) {
        ...
        success =
            value.validate(msg, currentValuePath + ".snpnList") && success;
  ...
  if (sNssaisIsSet()) {
    const std::vector<oai::_3gpp::model::ExtSnssai>& value = m_SNssais;
  ...
  if (perPlmnSnssaiListIsSet()) {
    const std::vector<oai::_3gpp::model::PlmnSnssai>& value =
        m_PerPlmnSnssaiList;
    ...
    {  // Recursive validation of array elements
      ...
      for (const oai::_3gpp::model::PlmnSnssai& value : value) {
        ...
        success =
            value.validate(msg, currentValuePath + ".perPlmnSnssaiList") &&
            success;
  ...
  if (interPlmnFqdnIsSet()) {
    const std::string& value           = m_InterPlmnFqdn;
    const std::string currentValuePath = _pathPrefix + ".interPlmnFqdn";
  ...
  if (ipv6AddressesIsSet()) {
    const std::vector<oai::_3gpp::model::Ipv6Addr>& value = m_Ipv6Addresses;
  ...
  if (allowedPlmnsIsSet()) {
    const std::vector<oai::_3gpp::model::PlmnId>& value = m_AllowedPlmns;
    ...
    {  // Recursive validation of array elements
      ...
      for (const oai::_3gpp::model::PlmnId& value : value) {
        ...
        success =
            value.validate(msg, currentValuePath + ".allowedPlmns") && success;
  ...
  if (allowedSnpnsIsSet()) {
    const std::vector<oai::_3gpp::model::PlmnIdNid>& value = m_AllowedSnpns;
    ...
    {  // Recursive validation of array elements
      ...
      for (const oai::_3gpp::model::PlmnIdNid& value : value) {
        ...
        success =
            value.validate(msg, currentValuePath + ".allowedSnpns") && success;
  ...
  if (allowedNfTypesIsSet()) {
    const std::vector<oai::_3gpp::model::NFType>& value = m_AllowedNfTypes;
    ...
    {  // Recursive validation of array elements
      ...
      for (const oai::_3gpp::model::NFType& value : value) {
        ...
        success = value.validate(msg, currentValuePath + ".allowedNfTypes") &&
                  success;
  ...
  if (allowedNssaisIsSet()) {
    const std::vector<oai::_3gpp::model::ExtSnssai>& value = m_AllowedNssais;
    ...
    {  // Recursive validation of array elements
      ...
      for (const oai::_3gpp::model::ExtSnssai& value : value) {
        ...
        success =
            value.validate(msg, currentValuePath + ".allowedNssais") && success;
  ...
  if (nfServicesIsSet()) {
    ...
    {  // Recursive validation of array elements
      const std::string oldValuePath = currentValuePath;
      int i                          = 0;
      for (const oai::_3gpp::model::NFService& value : value) {
        const std::string currentValuePath =
            oldValuePath + "[" + std::to_string(i) + "]";

        success =
            value.validate(msg, currentValuePath + ".nfServices") && success;
  ...
  if (nfServiceListIsSet()) {
    const std::map<std::string, oai::_3gpp::model::NFService>& value =
        m_NfServiceList;
    const std::string currentValuePath = _pathPrefix + ".nfServiceList";
  }

  if (defaultNotificationSubscriptionsIsSet()) {
    const std::vector<oai::_3gpp::model::DefaultNotificationSubscription>&
        value = m_DefaultNotificationSubscriptions;
    const std::string currentValuePath =
        _pathPrefix + ".defaultNotificationSubscriptions";

    {  // Recursive validation of array elements
      const std::string oldValuePath = currentValuePath;
      int i                          = 0;
      for (const oai::_3gpp::model::DefaultNotificationSubscription& value :
           value) {
        const std::string currentValuePath =
            oldValuePath + "[" + std::to_string(i) + "]";
        ...
        success =
            value.validate(
                msg, currentValuePath + ".defaultNotificationSubscriptions") &&
            success;
  ...
  if (serviceSetRecoveryTimeListIsSet()) {
    const std::map<std::string, std::string>& value =
        m_ServiceSetRecoveryTimeList;
    const std::string currentValuePath =
        _pathPrefix + ".serviceSetRecoveryTimeList";
  }
  ...
  if (supportedVendorSpecificFeaturesIsSet()) {
    const std::map<
        std::string, std::vector<oai::_3gpp::model::VendorSpecificFeature>>&
        value = m_SupportedVendorSpecificFeatures;
    const std::string currentValuePath =
        _pathPrefix + ".supportedVendorSpecificFeatures";
  }

  if (aanfInfoListIsSet()) {
    const std::map<std::string, oai::_3gpp::model::AanfInfo>& value =
        m_AanfInfoList;
    const std::string currentValuePath = _pathPrefix + ".aanfInfoList";
  }

  if (easdfInfoListIsSet()) {
    const std::map<std::string, oai::_3gpp::model::EasdfInfo>& value =
        m_EasdfInfoList;
    const std::string currentValuePath = _pathPrefix + ".easdfInfoList";
  }

  if (nsacfInfoListIsSet()) {
    const std::map<std::string, oai::_3gpp::model::NsacfInfo>& value =
        m_NsacfInfoList;
    const std::string currentValuePath = _pathPrefix + ".nsacfInfoList";
  }

  if (mbSmfInfoListIsSet()) {
    const std::map<std::string, oai::_3gpp::model::MbSmfInfo>& value =
        m_MbSmfInfoList;
    const std::string currentValuePath = _pathPrefix + ".mbSmfInfoList";
  }

  if (tsctsfInfoListIsSet()) {
    const std::map<std::string, oai::_3gpp::model::TsctsfInfo>& value =
        m_TsctsfInfoList;
    const std::string currentValuePath = _pathPrefix + ".tsctsfInfoList";
  }

  if (mbUpfInfoListIsSet()) {
    const std::map<std::string, oai::_3gpp::model::MbUpfInfo>& value =
        m_MbUpfInfoList;
...
bool NFProfile::operator==(const NFProfile& rhs) const {
  return
      ...
      ((!collocatedNfInstancesIsSet() && !rhs.collocatedNfInstancesIsSet()) ||
       (collocatedNfInstancesIsSet() && rhs.collocatedNfInstancesIsSet() &&
        getCollocatedNfInstances() == rhs.getCollocatedNfInstances())) &&
      ...
      ((!nwdafInfoListIsSet() && !rhs.nwdafInfoListIsSet()) ||
       (nwdafInfoListIsSet() && rhs.nwdafInfoListIsSet() &&
        getNwdafInfoList() == rhs.getNwdafInfoList())) &&
      ...
      ((!seppInfoIsSet() && !rhs.seppInfoIsSet()) ||
       (seppInfoIsSet() && rhs.seppInfoIsSet() &&
        getSeppInfo() == rhs.getSeppInfo())) &&

      ((!vendorIdIsSet() && !rhs.vendorIdIsSet()) ||
       (vendorIdIsSet() && rhs.vendorIdIsSet() &&
        getVendorId() == rhs.getVendorId())) &&

      ((!supportedVendorSpecificFeaturesIsSet() &&
        !rhs.supportedVendorSpecificFeaturesIsSet()) ||
       (supportedVendorSpecificFeaturesIsSet() &&
        rhs.supportedVendorSpecificFeaturesIsSet() &&
        getSupportedVendorSpecificFeatures() ==
            rhs.getSupportedVendorSpecificFeatures())) &&

      ((!aanfInfoListIsSet() && !rhs.aanfInfoListIsSet()) ||
       (aanfInfoListIsSet() && rhs.aanfInfoListIsSet() &&
        getAanfInfoList() == rhs.getAanfInfoList())) &&

      ((!r5gDdnmfInfoIsSet() && !rhs.r5gDdnmfInfoIsSet()) ||
       (r5gDdnmfInfoIsSet() && rhs.r5gDdnmfInfoIsSet() &&
        getR5gDdnmfInfo() == rhs.getR5gDdnmfInfo())) &&

      ((!mfafInfoIsSet() && !rhs.mfafInfoIsSet()) ||
       (mfafInfoIsSet() && rhs.mfafInfoIsSet() &&
        getMfafInfo() == rhs.getMfafInfo())) &&

      ((!easdfInfoListIsSet() && !rhs.easdfInfoListIsSet()) ||
       (easdfInfoListIsSet() && rhs.easdfInfoListIsSet() &&
        getEasdfInfoList() == rhs.getEasdfInfoList())) &&

      ((!dccfInfoIsSet() && !rhs.dccfInfoIsSet()) ||
       (dccfInfoIsSet() && rhs.dccfInfoIsSet() &&
        getDccfInfo() == rhs.getDccfInfo())) &&

      ((!nsacfInfoListIsSet() && !rhs.nsacfInfoListIsSet()) ||
       (nsacfInfoListIsSet() && rhs.nsacfInfoListIsSet() &&
        getNsacfInfoList() == rhs.getNsacfInfoList())) &&

      ((!mbSmfInfoListIsSet() && !rhs.mbSmfInfoListIsSet()) ||
       (mbSmfInfoListIsSet() && rhs.mbSmfInfoListIsSet() &&
        getMbSmfInfoList() == rhs.getMbSmfInfoList())) &&

      ((!tsctsfInfoListIsSet() && !rhs.tsctsfInfoListIsSet()) ||
       (tsctsfInfoListIsSet() && rhs.tsctsfInfoListIsSet() &&
        getTsctsfInfoList() == rhs.getTsctsfInfoList())) &&

      ((!mbUpfInfoListIsSet() && !rhs.mbUpfInfoListIsSet()) ||
       (mbUpfInfoListIsSet() && rhs.mbUpfInfoListIsSet() &&
        getMbUpfInfoList() == rhs.getMbUpfInfoList())) &&

      ((!trustAfInfoIsSet() && !rhs.trustAfInfoIsSet()) ||
       (trustAfInfoIsSet() && rhs.trustAfInfoIsSet() &&
        getTrustAfInfo() == rhs.getTrustAfInfo())) &&

      ((!nssaafInfoIsSet() && !rhs.nssaafInfoIsSet()) ||
       (nssaafInfoIsSet() && rhs.nssaafInfoIsSet() &&
        getNssaafInfo() == rhs.getNssaafInfo())) &&

      ((!hniListIsSet() && !rhs.hniListIsSet()) ||
       (hniListIsSet() && rhs.hniListIsSet() &&
        getHniList() == rhs.getHniList())) &&

      ((!iwmscInfoIsSet() && !rhs.iwmscInfoIsSet()) ||
       (iwmscInfoIsSet() && rhs.iwmscInfoIsSet() &&
        getIwmscInfo() == rhs.getIwmscInfo())) &&

      ((!mnpfInfoIsSet() && !rhs.mnpfInfoIsSet()) ||
       (mnpfInfoIsSet() && rhs.mnpfInfoIsSet() &&
        getMnpfInfo() == rhs.getMnpfInfo()))
...
void to_json(nlohmann::json& j, const NFProfile& o) {
  ...
  if (o.snpnListIsSet() || !o.m_SnpnList.empty()) j["snpnList"] = o.m_SnpnList;
  ...
  if (o.loadTimeStampIsSet()) j["loadTimeStamp"] = o.m_LoadTimeStamp;
  ...
  if (o.nefInfoIsSet()) j["nefInfo"] = o.m_NefInfo;
  if (o.nrfInfoIsSet()) j["nrfInfo"] = o.m_NrfInfo;
  if (o.udsfInfoIsSet()) j["udsfInfo"] = o.m_UdsfInfo;
  ...
  if (o.lmfInfoIsSet()) j["lmfInfo"] = o.m_LmfInfo;
  if (o.gmlcInfoIsSet()) j["gmlcInfo"] = o.m_GmlcInfo;
  ...
  if (o.lcHSupportIndIsSet()) j["lcHSupportInd"] = o.m_LcHSupportInd;
  if (o.olcHSupportIndIsSet()) j["olcHSupportInd"] = o.m_OlcHSupportInd;
  ...
  if (o.scpInfoIsSet()) j["scpInfo"] = o.m_ScpInfo;
  if (o.seppInfoIsSet()) j["seppInfo"] = o.m_SeppInfo;
  if (o.vendorIdIsSet()) j["vendorId"] = o.m_VendorId;
  ...
  if (o.r5gDdnmfInfoIsSet()) j["5gDdnmfInfo"] = o.m_r_5gDdnmfInfo;
  if (o.mfafInfoIsSet()) j["mfafInfo"] = o.m_MfafInfo;
  if (o.easdfInfoListIsSet() || !o.m_EasdfInfoList.empty())
    j["easdfInfoList"] = o.m_EasdfInfoList;
  if (o.dccfInfoIsSet()) j["dccfInfo"] = o.m_DccfInfo;
  ...
  if (o.trustAfInfoIsSet()) j["trustAfInfo"] = o.m_TrustAfInfo;
  if (o.nssaafInfoIsSet()) j["nssaafInfo"] = o.m_NssaafInfo;
  if (o.hniListIsSet() || !o.m_HniList.empty()) j["hniList"] = o.m_HniList;
  if (o.iwmscInfoIsSet()) j["iwmscInfo"] = o.m_IwmscInfo;
  if (o.mnpfInfoIsSet()) j["mnpfInfo"] = o.m_MnpfInfo;
}
...
void from_json(const nlohmann::json& j, NFProfile& o) {
  ...
  if (j.find("nssaafInfo") != j.end()) {
    j.at("nssaafInfo").get_to(o.m_NssaafInfo);
    o.m_NssaafInfoIsSet = true;
  }
  if (j.find("hniList") != j.end()) {
    j.at("hniList").get_to(o.m_HniList);
    o.m_HniListIsSet = true;
  }
  if (j.find("iwmscInfo") != j.end()) {
    j.at("iwmscInfo").get_to(o.m_IwmscInfo);
    o.m_IwmscInfoIsSet = true;
  }
  if (j.find("mnpfInfo") != j.end()) {
    j.at("mnpfInfo").get_to(o.m_MnpfInfo);
    o.m_MnpfInfoIsSet = true;
  }
}
...
oai::_3gpp::model::NFType NFProfile::getNfType() const {
  return m_NfType;
}
void NFProfile::setNfType(oai::_3gpp::model::NFType const& value) {
  m_NfType = value;
}
oai::_3gpp::model::NFStatus NFProfile::getNfStatus() const {
  return m_NfStatus;
}
void NFProfile::setNfStatus(oai::_3gpp::model::NFStatus const& value) {
  m_NfStatus = value;
}
std::vector<oai::_3gpp::model::CollocatedNfInstance>
NFProfile::getCollocatedNfInstances() const {
  return m_CollocatedNfInstances;
}
void NFProfile::setCollocatedNfInstances(
...
std::vector<oai::_3gpp::model::PlmnId> NFProfile::getPlmnList() const {
  return m_PlmnList;
}
...
std::vector<oai::_3gpp::model::PlmnIdNid> NFProfile::getSnpnList() const {
  return m_SnpnList;
}
void NFProfile::setSnpnList(
...
std::vector<oai::_3gpp::model::ExtSnssai> NFProfile::getSNssais() const {
  return m_SNssais;
}
...
std::vector<oai::_3gpp::model::PlmnSnssai> NFProfile::getPerPlmnSnssaiList()
    const {
  return m_PerPlmnSnssaiList;
}
void NFProfile::setPerPlmnSnssaiList(
...
std::vector<oai::_3gpp::model::Ipv6Addr> NFProfile::getIpv6Addresses() const {
  return m_Ipv6Addresses;
}
void NFProfile::setIpv6Addresses(
...
std::vector<oai::_3gpp::model::PlmnId> NFProfile::getAllowedPlmns() const {
...
std::vector<oai::_3gpp::model::PlmnIdNid> NFProfile::getAllowedSnpns() const {
  return m_AllowedSnpns;
}
void NFProfile::setAllowedSnpns(
    std::vector<oai::_3gpp::model::PlmnIdNid> const& value) {
...
std::vector<oai::_3gpp::model::NFType> NFProfile::getAllowedNfTypes() const {
  return m_AllowedNfTypes;
}
void NFProfile::setAllowedNfTypes(
...
std::vector<oai::_3gpp::model::ExtSnssai> NFProfile::getAllowedNssais() const {
...
oai::_3gpp::model::UdrInfo NFProfile::getUdrInfo() const {
  return m_UdrInfo;
}
void NFProfile::setUdrInfo(oai::_3gpp::model::UdrInfo const& value) {
  m_UdrInfo      = value;
  m_UdrInfoIsSet = true;
}
...
std::map<std::string, oai::_3gpp::model::UdrInfo> NFProfile::getUdrInfoList()
    const {
  return m_UdrInfoList;
}
void NFProfile::setUdrInfoList(
...
oai::_3gpp::model::UdmInfo NFProfile::getUdmInfo() const {
  return m_UdmInfo;
}
void NFProfile::setUdmInfo(oai::_3gpp::model::UdmInfo const& value) {
  m_UdmInfo      = value;
  m_UdmInfoIsSet = true;
}
...
std::map<std::string, oai::_3gpp::model::UdmInfo> NFProfile::getUdmInfoList()
    const {
  return m_UdmInfoList;
}
void NFProfile::setUdmInfoList(
...
oai::_3gpp::model::AusfInfo NFProfile::getAusfInfo() const {
  return m_AusfInfo;
}
void NFProfile::setAusfInfo(oai::_3gpp::model::AusfInfo const& value) {
  m_AusfInfo      = value;
...
std::map<std::string, oai::_3gpp::model::AusfInfo> NFProfile::getAusfInfoList()
    const {
  return m_AusfInfoList;
}
void NFProfile::setAusfInfoList(
...
oai::_3gpp::model::AmfInfo NFProfile::getAmfInfo() const {
  return m_AmfInfo;
}
void NFProfile::setAmfInfo(oai::_3gpp::model::AmfInfo const& value) {
  m_AmfInfo      = value;
  m_AmfInfoIsSet = true;
}
...
std::map<std::string, oai::_3gpp::model::AmfInfo> NFProfile::getAmfInfoList()
    const {
  return m_AmfInfoList;
}
void NFProfile::setAmfInfoList(
...
oai::_3gpp::model::SmfInfo NFProfile::getSmfInfo() const {
  return m_SmfInfo;
}
void NFProfile::setSmfInfo(oai::_3gpp::model::SmfInfo const& value) {
  m_SmfInfo      = value;
  m_SmfInfoIsSet = true;
}
...
std::map<std::string, oai::_3gpp::model::SmfInfo> NFProfile::getSmfInfoList()
    const {
  return m_SmfInfoList;
}
void NFProfile::setSmfInfoList(
...
oai::_3gpp::model::UpfInfo NFProfile::getUpfInfo() const {
  return m_UpfInfo;
}
void NFProfile::setUpfInfo(oai::_3gpp::model::UpfInfo const& value) {
  m_UpfInfo      = value;
  m_UpfInfoIsSet = true;
}
...
std::map<std::string, oai::_3gpp::model::UpfInfo> NFProfile::getUpfInfoList()
    const {
  return m_UpfInfoList;
}
void NFProfile::setUpfInfoList(
...
oai::_3gpp::model::PcfInfo NFProfile::getPcfInfo() const {
  return m_PcfInfo;
}
void NFProfile::setPcfInfo(oai::_3gpp::model::PcfInfo const& value) {
  m_PcfInfo      = value;
  m_PcfInfoIsSet = true;
}
...
std::map<std::string, oai::_3gpp::model::PcfInfo> NFProfile::getPcfInfoList()
    const {
  return m_PcfInfoList;
}
void NFProfile::setPcfInfoList(
...
oai::_3gpp::model::BsfInfo NFProfile::getBsfInfo() const {
  return m_BsfInfo;
}
void NFProfile::setBsfInfo(oai::_3gpp::model::BsfInfo const& value) {
  m_BsfInfo      = value;
  m_BsfInfoIsSet = true;
}
...
std::map<std::string, oai::_3gpp::model::BsfInfo> NFProfile::getBsfInfoList()
    const {
  return m_BsfInfoList;
}
void NFProfile::setBsfInfoList(
...
oai::_3gpp::model::ChfInfo NFProfile::getChfInfo() const {
  return m_ChfInfo;
}
void NFProfile::setChfInfo(oai::_3gpp::model::ChfInfo const& value) {
  m_ChfInfo      = value;
  m_ChfInfoIsSet = true;
}
...
std::map<std::string, oai::_3gpp::model::ChfInfo> NFProfile::getChfInfoList()
    const {
  return m_ChfInfoList;
}
void NFProfile::setChfInfoList(
...
oai::_3gpp::model::NefInfo NFProfile::getNefInfo() const {
  return m_NefInfo;
}
void NFProfile::setNefInfo(oai::_3gpp::model::NefInfo const& value) {
  m_NefInfo      = value;
  m_NefInfoIsSet = true;
}
...
oai::_3gpp::model::NrfInfo NFProfile::getNrfInfo() const {
  return m_NrfInfo;
}
void NFProfile::setNrfInfo(oai::_3gpp::model::NrfInfo const& value) {
  m_NrfInfo      = value;
  m_NrfInfoIsSet = true;
}
...
oai::_3gpp::model::UdsfInfo NFProfile::getUdsfInfo() const {
  return m_UdsfInfo;
}
void NFProfile::setUdsfInfo(oai::_3gpp::model::UdsfInfo const& value) {
  m_UdsfInfo      = value;
...
std::map<std::string, oai::_3gpp::model::UdsfInfo> NFProfile::getUdsfInfoList()
    const {
  return m_UdsfInfoList;
}
void NFProfile::setUdsfInfoList(
...
oai::_3gpp::model::NwdafInfo NFProfile::getNwdafInfo() const {
  return m_NwdafInfo;
}
void NFProfile::setNwdafInfo(oai::_3gpp::model::NwdafInfo const& value) {
  m_NwdafInfo      = value;
...
std::map<std::string, oai::_3gpp::model::NwdafInfo>
NFProfile::getNwdafInfoList() const {
...
std::map<std::string, oai::_3gpp::model::PcscfInfo>
NFProfile::getPcscfInfoList() const {
...
std::map<std::string, oai::_3gpp::model::HssInfo> NFProfile::getHssInfoList()
    const {
  return m_HssInfoList;
}
void NFProfile::setHssInfoList(
...
std::vector<oai::_3gpp::model::NFService> NFProfile::getNfServices() const {
  return m_NfServices;
}
void NFProfile::setNfServices(
    std::vector<oai::_3gpp::model::NFService> const& value) {
  m_NfServices      = value;
...
std::map<std::string, oai::_3gpp::model::NFService>
NFProfile::getNfServiceList() const {
...
NFProfile::getDefaultNotificationSubscriptions() const {
...
oai::_3gpp::model::LmfInfo NFProfile::getLmfInfo() const {
  return m_LmfInfo;
}
void NFProfile::setLmfInfo(oai::_3gpp::model::LmfInfo const& value) {
  m_LmfInfo      = value;
  m_LmfInfoIsSet = true;
}
...
oai::_3gpp::model::GmlcInfo NFProfile::getGmlcInfo() const {
  return m_GmlcInfo;
}
void NFProfile::setGmlcInfo(oai::_3gpp::model::GmlcInfo const& value) {
  m_GmlcInfo      = value;
...
oai::_3gpp::model::ScpInfo NFProfile::getScpInfo() const {
  return m_ScpInfo;
}
void NFProfile::setScpInfo(oai::_3gpp::model::ScpInfo const& value) {
  m_ScpInfo      = value;
  m_ScpInfoIsSet = true;
}
...
oai::_3gpp::model::SeppInfo NFProfile::getSeppInfo() const {
  return m_SeppInfo;
}
void NFProfile::setSeppInfo(oai::_3gpp::model::SeppInfo const& value) {
  m_SeppInfo      = value;
...
NFProfile::getSupportedVendorSpecificFeatures() const {
...
std::map<std::string, oai::_3gpp::model::AanfInfo> NFProfile::getAanfInfoList()
    const {
  return m_AanfInfoList;
}
void NFProfile::setAanfInfoList(
...
oai::_3gpp::model::_5GDdnmfInfo NFProfile::getR5gDdnmfInfo() const {
  return m_r_5gDdnmfInfo;
}
void NFProfile::setR5gDdnmfInfo(oai::_3gpp::model::_5GDdnmfInfo const& value) {
...
oai::_3gpp::model::MfafInfo NFProfile::getMfafInfo() const {
  return m_MfafInfo;
}
void NFProfile::setMfafInfo(oai::_3gpp::model::MfafInfo const& value) {
  m_MfafInfo      = value;
...
std::map<std::string, oai::_3gpp::model::EasdfInfo>
NFProfile::getEasdfInfoList() const {
...
oai::_3gpp::model::DccfInfo NFProfile::getDccfInfo() const {
  return m_DccfInfo;
}
void NFProfile::setDccfInfo(oai::_3gpp::model::DccfInfo const& value) {
  m_DccfInfo      = value;
...
std::map<std::string, oai::_3gpp::model::NsacfInfo>
NFProfile::getNsacfInfoList() const {
  return m_NsacfInfoList;
}
void NFProfile::setNsacfInfoList(
...
std::map<std::string, oai::_3gpp::model::MbSmfInfo>
NFProfile::getMbSmfInfoList() const {
  return m_MbSmfInfoList;
}
void NFProfile::setMbSmfInfoList(
...
std::map<std::string, oai::_3gpp::model::TsctsfInfo>
NFProfile::getTsctsfInfoList() const {
  return m_TsctsfInfoList;
}
void NFProfile::setTsctsfInfoList(
...
std::map<std::string, oai::_3gpp::model::MbUpfInfo>
NFProfile::getMbUpfInfoList() const {
  return m_MbUpfInfoList;
}
void NFProfile::setMbUpfInfoList(
...
oai::_3gpp::model::TrustAfInfo NFProfile::getTrustAfInfo() const {
  return m_TrustAfInfo;
}
void NFProfile::setTrustAfInfo(oai::_3gpp::model::TrustAfInfo const& value) {
  m_TrustAfInfo      = value;
...
oai::_3gpp::model::NssaafInfo NFProfile::getNssaafInfo() const {
  return m_NssaafInfo;
}
void NFProfile::setNssaafInfo(oai::_3gpp::model::NssaafInfo const& value) {
  m_NssaafInfo      = value;
  m_NssaafInfoIsSet = true;
}
bool NFProfile::nssaafInfoIsSet() const {
  return m_NssaafInfoIsSet;
}
void NFProfile::unsetNssaafInfo() {
  m_NssaafInfoIsSet = false;
}
...
bool NFProfile::hniListIsSet() const {
  return m_HniListIsSet;
}
void NFProfile::unsetHniList() {
  m_HniListIsSet = false;
}
oai::_3gpp::model::IwmscInfo NFProfile::getIwmscInfo() const {
  return m_IwmscInfo;
}
void NFProfile::setIwmscInfo(oai::_3gpp::model::IwmscInfo const& value) {
  m_IwmscInfo      = value;
  m_IwmscInfoIsSet = true;
}
bool NFProfile::iwmscInfoIsSet() const {
  return m_IwmscInfoIsSet;
}
void NFProfile::unsetIwmscInfo() {
  m_IwmscInfoIsSet = false;
}
oai::_3gpp::model::MnpfInfo NFProfile::getMnpfInfo() const {
  return m_MnpfInfo;
}
void NFProfile::setMnpfInfo(oai::_3gpp::model::MnpfInfo const& value) {
  m_MnpfInfo      = value;
  m_MnpfInfoIsSet = true;
}
bool NFProfile::mnpfInfoIsSet() const {
  return m_MnpfInfoIsSet;
}
void NFProfile::unsetMnpfInfo() {
  m_MnpfInfoIsSet = false;
}
