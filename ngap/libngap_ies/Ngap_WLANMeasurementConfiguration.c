...
extern asn_TYPE_descriptor_t asn_DEF_Ngap_wlan_rssi __attribute__((weak, alias("asn_DEF_Ngap_wlan_rssi_4")));
#else
static asn_TYPE_descriptor_t asn_DEF_Ngap_wlan_rssi_4;
static asn_TYPE_descriptor_t asn_DEF_Ngap_wlan_rssi;
__attribute__((constructor)) static void asn_DEF_Ngap_wlan_rssi_4_alias_init(void) {
...
#ifndef ASN1C_NO_UNSUFFIXED_PDU_ALIAS
#if defined(__ELF__) && (defined(__GNUC__) || defined(__clang__))
extern asn_TYPE_descriptor_t asn_DEF_Ngap_wlan_rtt __attribute__((weak, alias("asn_DEF_Ngap_wlan_rtt_7")));
#else
static asn_TYPE_descriptor_t asn_DEF_Ngap_wlan_rtt_7;
static asn_TYPE_descriptor_t asn_DEF_Ngap_wlan_rtt;
__attribute__((constructor)) static void asn_DEF_Ngap_wlan_rtt_7_alias_init(void) {
...
static int asn_validate_Ngap_wlan_rssi_4(const asn_TYPE_descriptor_t *td,
                       const void *sptr,
                       asn_app_constraint_failed_f *ctfailcb,
                       void* app_key) {
    if(! sptr) { return -1; }
    e_Ngap_WLANMeasurementConfiguration__wlan_rssi value = *(e_Ngap_WLANMeasurementConfiguration__wlan_rssi*)sptr;
    switch(value) {
...
static int asn_validate_Ngap_wlan_rtt_7(const asn_TYPE_descriptor_t *td,
                       const void *sptr,
                       asn_app_constraint_failed_f *ctfailcb,
                       void* app_key) {
    if(! sptr) { return -1; }
    e_Ngap_WLANMeasurementConfiguration__wlan_rtt value = *(e_Ngap_WLANMeasurementConfiguration__wlan_rtt*)sptr;
    switch(value) {
