...
oai::_3gpp::model::NFType AccessTokenReq::getNfType() const
{
    return m_NfType;
}
void AccessTokenReq::setNfType(oai::_3gpp::model::NFType const& value)
{
    m_NfType = value;
    m_NfTypeIsSet = true;
}
...
oai::_3gpp::model::NFType AccessTokenReq::getTargetNfType() const
{
    return m_TargetNfType;
}
void AccessTokenReq::setTargetNfType(oai::_3gpp::model::NFType const& value)
{
...
oai::_3gpp::model::PlmnId AccessTokenReq::getRequesterPlmn() const
{
    return m_RequesterPlmn;
}
void AccessTokenReq::setRequesterPlmn(oai::_3gpp::model::PlmnId const& value)
{
...
std::vector<oai::_3gpp::model::PlmnId> AccessTokenReq::getRequesterPlmnList() const
{
    return m_RequesterPlmnList;
}
void AccessTokenReq::setRequesterPlmnList(std::vector<oai::_3gpp::model::PlmnId> const& value)
{
...
std::vector<oai::_3gpp::model::Snssai> AccessTokenReq::getRequesterSnssaiList() const
{
    return m_RequesterSnssaiList;
}
void AccessTokenReq::setRequesterSnssaiList(std::vector<oai::_3gpp::model::Snssai> const& value)
{
...
std::vector<oai::_3gpp::model::PlmnIdNid> AccessTokenReq::getRequesterSnpnList() const
{
    return m_RequesterSnpnList;
}
void AccessTokenReq::setRequesterSnpnList(std::vector<oai::_3gpp::model::PlmnIdNid> const& value)
{
...
oai::_3gpp::model::PlmnId AccessTokenReq::getTargetPlmn() const
{
    return m_TargetPlmn;
}
void AccessTokenReq::setTargetPlmn(oai::_3gpp::model::PlmnId const& value)
{
    m_TargetPlmn = value;
...
oai::_3gpp::model::PlmnIdNid AccessTokenReq::getTargetSnpn() const
{
    return m_TargetSnpn;
}
void AccessTokenReq::setTargetSnpn(oai::_3gpp::model::PlmnIdNid const& value)
{
    m_TargetSnpn = value;
...
std::vector<oai::_3gpp::model::Snssai> AccessTokenReq::getTargetSnssaiList() const
{
    return m_TargetSnssaiList;
}
void AccessTokenReq::setTargetSnssaiList(std::vector<oai::_3gpp::model::Snssai> const& value)
{
