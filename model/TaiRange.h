...
public:
    ...
    /// 
    /// </summary>
    std::vector<oai::_3gpp::model::TacRange> getTacRangeList() const;
    void setTacRangeList(std::vector<oai::_3gpp::model::TacRange> const& value);
    /// <summary>
...
protected:
    ...
    std::vector<oai::_3gpp::model::TacRange> m_TacRangeList;
