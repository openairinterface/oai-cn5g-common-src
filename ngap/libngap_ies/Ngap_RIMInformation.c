...
extern asn_TYPE_descriptor_t asn_DEF_Ngap_rIM_RSDetection __attribute__((weak, alias("asn_DEF_Ngap_rIM_RSDetection_3")));
#else
static asn_TYPE_descriptor_t asn_DEF_Ngap_rIM_RSDetection_3;
static asn_TYPE_descriptor_t asn_DEF_Ngap_rIM_RSDetection;
__attribute__((constructor)) static void asn_DEF_Ngap_rIM_RSDetection_3_alias_init(void) {
...
static int asn_validate_Ngap_rIM_RSDetection_3(const asn_TYPE_descriptor_t *td,
                       const void *sptr,
                       asn_app_constraint_failed_f *ctfailcb,
                       void* app_key) {
    if(! sptr) { return -1; }
    e_Ngap_RIMInformation__rIM_RSDetection value = *(e_Ngap_RIMInformation__rIM_RSDetection*)sptr;
    switch(value) {
