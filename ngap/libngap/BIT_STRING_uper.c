...
asn_dec_rval_t BIT_STRING_decode_uper(const asn_codec_ctx_t *opt_codec_ctx,
...
asn_enc_rval_t BIT_STRING_encode_uper(const asn_TYPE_descriptor_t *td,
                                      const asn_per_constraints_t *constraints,
  ...
  ASN_DEBUG("Encoding %s into %" ASN_PRI_SIZE " bits"
            " (%ld..%ld, effective %d)%s",
