...
public:
  ...
  //  PFCP_IE_UPDATE_BAR_
  virtual bool
  get(pfcp::update_bar_within_pfcp_session_modification_request &v) const {
    throw pfcp_msg_illegal_ie_exception(
        0, PFCP_IE_UPDATE_BAR_WITHIN_PFCP_SESSION_MODIFICATION_REQUEST,
        __FILE__, __LINE__);
  }
  virtual void
  set(const pfcp::update_bar_within_pfcp_session_modification_request &v) {
    throw pfcp_msg_illegal_ie_exception(
        0, PFCP_IE_UPDATE_BAR_WITHIN_PFCP_SESSION_MODIFICATION_REQUEST,
        __FILE__, __LINE__);
  }
  virtual bool
  get(pfcp::update_bar_within_pfcp_session_report_response &v) const {
    throw pfcp_msg_illegal_ie_exception(
        0, PFCP_IE_UPDATE_BAR_WITHIN_PFCP_SESSION_REPORT_RESPONSE, __FILE__,
        __LINE__);
  }
  virtual void
  set(const pfcp::update_bar_within_pfcp_session_report_response &v) {
    throw pfcp_msg_illegal_ie_exception(
        0, PFCP_IE_UPDATE_BAR_WITHIN_PFCP_SESSION_REPORT_RESPONSE, __FILE__,
        __LINE__);
  }
  ...
  virtual bool
  get(pfcp::usage_report_within_pfcp_session_modification_response &v) const {
    throw pfcp_msg_illegal_ie_exception(
        0, PFCP_IE_USAGE_REPORT_WITHIN_SESSION_MODIFICATION_RESPONSE, __FILE__,
        __LINE__);
  }
  virtual void
  set(const pfcp::usage_report_within_pfcp_session_modification_response &v) {
    throw pfcp_msg_illegal_ie_exception(
        0, PFCP_IE_USAGE_REPORT_WITHIN_SESSION_MODIFICATION_RESPONSE, __FILE__,
        __LINE__);
  }
  ...
  virtual bool
  get(pfcp::usage_report_within_pfcp_session_deletion_response &v) const {
    throw pfcp_msg_illegal_ie_exception(
        0, PFCP_IE_USAGE_REPORT_WITHIN_SESSION_DELETION_RESPONSE, __FILE__,
        __LINE__);
  }
  virtual void
  set(const pfcp::usage_report_within_pfcp_session_deletion_response &v) {
    throw pfcp_msg_illegal_ie_exception(
        0, PFCP_IE_USAGE_REPORT_WITHIN_SESSION_DELETION_RESPONSE, __FILE__,
        __LINE__);
  }
  ...
  virtual bool
  get(pfcp::usage_report_within_pfcp_session_report_request &v) const {
    throw pfcp_msg_illegal_ie_exception(
        0, PFCP_IE_USAGE_REPORT_WITHIN_SESSION_REPORT_REQUEST, __FILE__,
        __LINE__);
  }
  virtual void
  set(const pfcp::usage_report_within_pfcp_session_report_request &v) {
    throw pfcp_msg_illegal_ie_exception(
        0, PFCP_IE_USAGE_REPORT_WITHIN_SESSION_REPORT_REQUEST, __FILE__,
        __LINE__);
  }
  ...
  //  PFCP_IE_SUBSEQUENT_EVENT_THRESHOLD
  virtual bool get(pfcp::event_threshold_t &v) const {
    throw pfcp_msg_illegal_ie_exception(0, PFCP_IE_SUBSEQUENT_EVENT_THRESHOLD,
                                        __FILE__, __LINE__);
  }
  ...
  virtual bool get(pfcp::_3gpp_interface_type_t &v) const {
    throw pfcp_msg_illegal_ie_exception(0, PFCP_IE_3GPP_INTERFACE_TYPE,
                                        __FILE__, __LINE__);
  }
  virtual void set(const pfcp::_3gpp_interface_type_t &v) {
    throw pfcp_msg_illegal_ie_exception(0, PFCP_IE_3GPP_INTERFACE_TYPE,
                                        __FILE__, __LINE__);
  }
...
public:
  ...
  ethernet_packet_filter()
      : ethernet_filter_id(), ethernet_filter_properties(), mac_address(),
        ethertype(), c_tag(), s_tag(), sdf_filter() {}
  ...
  ethernet_packet_filter(const ethernet_packet_filter &e)
      : ethernet_filter_id(e.ethernet_filter_id),
        ...
        mac_address(e.mac_address), ethertype(e.ethertype), c_tag(e.c_tag),
        s_tag(e.s_tag), sdf_filter(e.sdf_filter) {}
...
public:
  ...
  pdi()
      : source_interface(), local_fteid(), network_instance(), ue_ip_address(),
        traffic_endpoint_id(), sdf_filter(), application_id(),
        ethernet_pdu_session_information(), ethernet_packet_filter(), qfi(),
        framed_route(), framed_routing(), framed_ipv6_route() {}

  pdi(const pdi &p)
      : source_interface(p.source_interface), local_fteid(p.local_fteid),
        network_instance(p.network_instance), ue_ip_address(p.ue_ip_address),
        traffic_endpoint_id(p.traffic_endpoint_id), sdf_filter(p.sdf_filter),
        application_id(p.application_id),
        ethernet_pdu_session_information(p.ethernet_pdu_session_information),
        ethernet_packet_filter(p.ethernet_packet_filter), qfi(p.qfi),
        framed_route(p.framed_route), framed_routing(p.framed_routing),
...
public:
  ...
  create_pdr()
      : pdr_id(), precedence(), pdi(), outer_header_removal(), far_id(),
        urr_id(), qer_id(), activate_predefined_rules() {}

  create_pdr(const create_pdr &c)
      : pdr_id(c.pdr_id), precedence(c.precedence), pdi(c.pdi),
        outer_header_removal(c.outer_header_removal), far_id(c.far_id),
        urr_id(c.urr_id), qer_id(c.qer_id),
...
public:
  ...
  update_forwarding_parameters()
      : destination_interface(), network_instance(), outer_header_creation(),
        transport_level_marking(), forwarding_policy(), header_enrichment(),
        pfcpsmreq_flags(), linked_traffic_endpoint_id() {}
...
public:
  ...
  forwarding_parameters()
      : destination_interface(), network_instance(), redirect_information(),
        outer_header_creation(), transport_level_marking(), forwarding_policy(),
        header_enrichment(), linked_traffic_endpoint_id(), proxying() {}
  ...
  bool update(const update_forwarding_parameters &u) {
    if (u.destination_interface.first)
      set(u.destination_interface.second);
    if (u.network_instance.first)
      set(u.network_instance.second);
    if (u.outer_header_creation.first)
      set(u.outer_header_creation.second);
    if (u.transport_level_marking.first)
      set(u.transport_level_marking.second);
    if (u.forwarding_policy.first)
      set(u.forwarding_policy.second);
    if (u.header_enrichment.first)
      set(u.header_enrichment.second);
...
public:
  ...
  update_duplicating_parameters()
      : destination_interface(), outer_header_creation(),
        transport_level_marking(), forwarding_policy() {}
...
public:
  ...
  create_far()
      : far_id(), apply_action(), forwarding_parameters(),
        duplicating_parameters(), bar_id() {}

  create_far(const create_far &c)
      : far_id(c.far_id), apply_action(c.apply_action),
        forwarding_parameters(c.forwarding_parameters),
        duplicating_parameters(c.duplicating_parameters), bar_id(c.bar_id) {}
...
public:
  ...
  additional_monitoring_time()
      : monitoring_time(), subsequent_volume_threshold(),
        subsequent_time_threshold(), subsequent_volume_quota(),
...
public:
  ...
  create_urr()
      : urr_id(), measurement_method(), reporting_triggers(),
        measurement_period(), volume_threshold(), volume_quota(),
        time_threshold(), time_quota(), quota_holding_time(),
        dropped_dl_traffic_threshold(), monitoring_time(), event_information(),
        subsequent_volume_threshold(), subsequent_time_threshold(),
        subsequent_volume_quota(), subsequent_time_quota(),
        inactivity_detection_time(), linked_urr_id(), measurement_information(),
        time_quota_mechanism(), aggregated_urrs(), far_id_for_quota_action(),
        ethernet_inactivity_timer(), additional_monitoring_time() {}

  create_urr(const create_urr &c)
      : urr_id(c.urr_id), measurement_method(c.measurement_method),
        reporting_triggers(c.reporting_triggers),
        measurement_period(c.measurement_period),
        volume_threshold(c.volume_threshold), volume_quota(c.volume_quota),
        time_threshold(c.time_threshold), time_quota(c.time_quota),
...
public:
  ...
  create_qer()
      : qer_id(), qer_correlation_id(), gate_status(), maximum_bitrate(),
        guaranteed_bitrate(), packet_rate(), dl_flow_level_marking(),
        qos_flow_identifier(), reflective_qos() {}

  create_qer(const create_qer &c)
      : qer_id(c.qer_id), qer_correlation_id(c.qer_correlation_id),
        gate_status(c.gate_status), maximum_bitrate(c.maximum_bitrate),
        guaranteed_bitrate(c.guaranteed_bitrate), packet_rate(c.packet_rate),
...
public:
  ...
  create_bar()
      : bar_id(), downlink_data_notification_delay(),
        suggested_buffering_packets_count() {}
...
public:
  ...
  create_traffic_endpoint()
      : traffic_endpoint_id(), local_fteid(), network_instance(),
        ue_ip_address(), ethernet_pdu_session_information(), framed_route(),
        framed_routing(), framed_ipv6_route() {}

  create_traffic_endpoint(const create_traffic_endpoint &c)
      : traffic_endpoint_id(c.traffic_endpoint_id), local_fteid(c.local_fteid),
        network_instance(c.network_instance), ue_ip_address(c.ue_ip_address),
        ethernet_pdu_session_information(c.ethernet_pdu_session_information),
        framed_route(c.framed_route), framed_routing(c.framed_routing),
...
public:
  ...
  overload_control_information()
      : overload_control_sequence_number(), overload_reduction_metric(),
        period_of_validity(), overload_control_information_flags() {}
...
public:
  ...
  update_pdr()
      : pdr_id(), outer_header_removal(), precedence(), pdi(), far_id(),
        urr_id(), qer_id(), activate_predefined_rules(),
        deactivate_predefined_rules() {}

  update_pdr(const update_pdr &u)
      : pdr_id(u.pdr_id), outer_header_removal(u.outer_header_removal),
        precedence(u.precedence), pdi(u.pdi), far_id(u.far_id),
        urr_id(u.urr_id), qer_id(u.qer_id),
...
public:
  ...
  update_far()
      : far_id(), apply_action(), update_forwarding_parameters(),
        update_duplicating_parameters(), bar_id() {}

  update_far(const update_far &u)
      : far_id(u.far_id), apply_action(u.apply_action),
...
public:
  ...
  update_urr(const update_urr &u)
      : urr_id(u.urr_id), measurement_method(u.measurement_method),
        reporting_triggers(u.reporting_triggers),
        measurement_period(u.measurement_period),
        volume_threshold(u.volume_threshold), volume_quota(u.volume_quota),
        time_threshold(u.time_threshold), time_quota(u.time_quota),
...
public:
  ...
  update_traffic_endpoint()
      : traffic_endpoint_id(), local_fteid(), network_instance(),
        ue_ip_address(), framed_route(), framed_routing(), framed_ipv6_route() {
  }

  update_traffic_endpoint(const update_traffic_endpoint &u)
      : traffic_endpoint_id(u.traffic_endpoint_id), local_fteid(u.local_fteid),
        network_instance(u.network_instance), ue_ip_address(u.ue_ip_address),
        framed_route(u.framed_route), framed_routing(u.framed_routing),
...
public:
  ...
  usage_report_within_pfcp_session_modification_response()
      : urr_id(), ur_seqn(), usage_report_trigger(), start_time(), end_time(),
        volume_measurement(), duration_measurement(), time_of_first_packet(),
        time_of_last_packet(), usage_information(), query_urr_reference(),
        ethernet_traffic_information() {}

  usage_report_within_pfcp_session_modification_response(
      const usage_report_within_pfcp_session_modification_response &u)
      : urr_id(u.urr_id), ur_seqn(u.ur_seqn),
        usage_report_trigger(u.usage_report_trigger), start_time(u.start_time),
        end_time(u.end_time), volume_measurement(u.volume_measurement),
...
public:
  ...
  usage_report_within_pfcp_session_deletion_response()
      : urr_id(), ur_seqn(), usage_report_trigger(), start_time(), end_time(),
        volume_measurement(), duration_measurement(), time_of_first_packet(),
        time_of_last_packet(), usage_information(),
        ethernet_traffic_information(), enterprise_specific() {}
...
/*
  ...
  public:
      ...
      event_reporting(const event_reporting& e) :
        event_id(e.event_id) {}

      //virtual ~event_reporting() {};
      void set(const pfcp::event_id_t& v) {event_id.first = true;
  event_id.second = v;}

      bool get(pfcp::event_id_t& v) const {if (event_id.first) {v =
  event_id.second;return true;}return false;}
  };
  */
...
public:
  ...
  usage_report_within_pfcp_session_report_request()
      : urr_id(), ur_seqn(), usage_report_trigger(), start_time(), end_time(),
        volume_measurement(), duration_measurement(),
        application_detection_information(), ue_ip_address(),
        network_instance(), time_of_first_packet(), time_of_last_packet(),
        usage_information(), query_urr_reference(),
        // event_reporting(),
        ethernet_traffic_information(), enterprise_specific() {}
  ...
  usage_report_within_pfcp_session_report_request(
      ...
      : urr_id(u.urr_id), ur_seqn(u.ur_seqn),
        ...
        ue_ip_address(u.ue_ip_address), network_instance(u.network_instance),
        time_of_first_packet(u.time_of_first_packet),
        time_of_last_packet(u.time_of_last_packet),
        usage_information(u.usage_information),
        query_urr_reference(u.query_urr_reference),
  ...
  // void set(const pfcp::event_reporting& v) {event_reporting.first = true;
...
public:
  ...
  update_bar_within_pfcp_session_report_response()
      : bar_id(), downlink_data_notification_delay(), dl_buffering_duration(),
        dl_buffering_buffering_suggested_packet_count(),
        suggested_buffering_packets_count() {}
...
public:
  ...
  pfcp_association_setup_request()
      : node_id(), recovery_time_stamp(), up_function_features(),
        cp_function_features(), user_plane_ip_resource_information(),
        enterprise_specific() {}
...
public:
  ...
  pfcp_association_setup_response()
      : node_id(), cause(), recovery_time_stamp(), up_function_features(),
        cp_function_features(), user_plane_ip_resource_information(),
        enterprise_specific() {}
...
public:
  ...
  pfcp_association_update_request()
      : node_id(), up_function_features(), cp_function_features(),
        pfcp_association_release_request(), graceful_release_period(),
        user_plane_ip_resource_information() {}
...
public:
  ...
  bool get(pfcp::pfcpaureq_flags_t &v) const {
    if (pfcpaureq_flags.first) {
      v = pfcpaureq_flags.second;
      return true;
    }
    return false;
  }
  bool get(pfcp::alternative_smf_ip_address_t &v) const {
    if (alternative_smf_ip_address.first) {
      v = alternative_smf_ip_address.second;
      return true;
    }
    return false;
  }
  ...
  void set(const pfcp::pfcpaureq_flags_t &v) {
    pfcpaureq_flags.first = true;
    pfcpaureq_flags.second = v;
  }
  void set(const pfcp::alternative_smf_ip_address_t &v) {
    alternative_smf_ip_address.first = true;
    alternative_smf_ip_address.second = v;
  }
};
...
public:
  ...
  pfcp_session_set_deletion_request()
      : node_id(), sgw_c_fq_csid(), pgw_c_fq_csid(), sgw_u_fq_csid(),
        pgw_u_fq_csid(), twan_fq_csid(), epdg_fq_csid(), mme_fq_csid() {}
...
public:
  ...
  pfcp_session_establishment_request()
      : node_id(), cp_fseid(), create_pdrs(), create_fars(), create_urrs(),
        create_qers(), create_bar(), create_traffic_endpoint(), pdn_type(),
        apn_dnn(), sgw_c_fq_csid(), mme_fq_csid(), pgw_c_fq_csid(),
        epdg_fq_csid(), twan_fq_csid(), user_plane_inactivity_timer(),
        user_id(), trace_information() {}
...
public:
  ...
  pfcp_session_establishment_response()
      : node_id(), cause(), offending_ie(), up_fseid(), created_pdrs(),
        load_control_information(), overload_control_information(),
        sgw_u_fq_csid(), pgw_u_fq_csid(), failed_rule_id(),
...
public:
  ...
  pfcp_session_modification_request()
      : cp_fseid(), remove_pdrs(), remove_fars(), remove_urrs(), remove_qers(),
        remove_bar(), remove_traffic_endpoint(), create_pdrs(), create_fars(),
        create_urrs(), create_qers(), query_urrs(), create_bar(),
        create_traffic_endpoint(), update_pdrs(), update_fars(), update_urrs(),
        update_qers(), update_bar(), update_traffic_endpoint(),
        pfcpsmreq_flags(), pgw_c_fq_csid(), sgw_c_fq_csid(), mme_fq_csid(),
        epdg_fq_csid(), twan_fq_csid(), user_plane_inactivity_timer(),
        query_urr_reference(), trace_information() {}

  pfcp_session_modification_request(const pfcp_session_modification_request &i)
      : cp_fseid(i.cp_fseid), remove_pdrs(i.remove_pdrs),
        remove_fars(i.remove_fars), remove_urrs(i.remove_urrs),
        remove_qers(i.remove_qers), remove_bar(i.remove_bar),
        remove_traffic_endpoint(i.remove_traffic_endpoint),
        create_pdrs(i.create_pdrs), create_fars(i.create_fars),
        create_urrs(i.create_urrs), create_qers(i.create_qers),
        query_urrs(i.query_urrs), create_bar(i.create_bar),
        create_traffic_endpoint(i.create_traffic_endpoint),
        update_pdrs(i.update_pdrs), update_fars(i.update_fars),
        update_urrs(i.update_urrs), update_qers(i.update_qers),
        update_bar(i.update_bar),
        update_traffic_endpoint(i.update_traffic_endpoint),
        pfcpsmreq_flags(i.pfcpsmreq_flags), pgw_c_fq_csid(i.pgw_c_fq_csid),
        sgw_c_fq_csid(i.sgw_c_fq_csid), mme_fq_csid(i.mme_fq_csid),
        epdg_fq_csid(i.epdg_fq_csid), twan_fq_csid(i.twan_fq_csid),
        user_plane_inactivity_timer(i.user_plane_inactivity_timer),
...
public:
  ...
  pfcp_session_modification_response()
      : cause(), offending_ie(), created_pdrs(), load_control_information(),
        overload_control_information(), usage_report(), failed_rule_id(),
        additional_usage_reports_information(), created_traffic_endpoint() {}
  ...
  pfcp_session_modification_response(
      ...
      : cause(i.cause), offending_ie(i.offending_ie),
        ...
        load_control_information(i.load_control_information),
        overload_control_information(i.overload_control_information),
        usage_report(i.usage_report), failed_rule_id(i.failed_rule_id),
        additional_usage_reports_information(
...
public:
  ...
  pfcp_session_report_request()
      : report_type(), downlink_data_report(), usage_report(),
        error_indication_report(), load_control_information(),
        overload_control_information(), additional_usage_reports_information() {
  }
