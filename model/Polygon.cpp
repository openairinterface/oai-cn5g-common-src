...
oai::_3gpp::model::SupportedGADShapes Polygon::getShape() const
{
    return m_Shape;
}
void Polygon::setShape(oai::_3gpp::model::SupportedGADShapes const& value)
{
    m_Shape = value;
}
std::vector<oai::_3gpp::model::GeographicalCoordinates> Polygon::getPointList() const
{
    return m_PointList;
}
void Polygon::setPointList(std::vector<oai::_3gpp::model::GeographicalCoordinates> const& value)
{
    m_PointList = value;
}
