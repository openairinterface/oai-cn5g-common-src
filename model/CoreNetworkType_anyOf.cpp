...
bool CoreNetworkType_anyOf::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "CoreNetworkType_anyOf" : pathPrefix;

    
    if (m_value == CoreNetworkType_anyOf::eCoreNetworkType_anyOf::INVALID_VALUE_OPENAPI_GENERATED)
    {
        success = false;
...
void to_json(nlohmann::json& j, const CoreNetworkType_anyOf& o)
{
    ...
    switch (o.getValue())
    {
        case CoreNetworkType_anyOf::eCoreNetworkType_anyOf::INVALID_VALUE_OPENAPI_GENERATED:
...
CoreNetworkType_anyOf::eCoreNetworkType_anyOf CoreNetworkType_anyOf::getValue() const
{
    return m_value;
}
void CoreNetworkType_anyOf::setValue(CoreNetworkType_anyOf::eCoreNetworkType_anyOf value)
{
    m_value = value;
}
