...
public:
    ...
    /// 
    /// </summary>
    oai::model::Report getReport() const;
    void setReport(oai::model::Report const& value);
    bool reportIsSet() const;
    void unsetReport();
    /// <summary>
    /// 
    /// </summary>
    oai::model::ReachabilityForSmsReport getReachabilityForSmsReport() const;
    void setReachabilityForSmsReport(oai::model::ReachabilityForSmsReport const& value);
    ...
    /// 
    /// </summary>
    oai::model::ReachabilityReport getReachabilityReport() const;
    void setReachabilityReport(oai::model::ReachabilityReport const& value);
...
protected:
    ...
    oai::model::Report m_Report;
    bool m_ReportIsSet;
    oai::model::ReachabilityForSmsReport m_ReachabilityForSmsReport;
    bool m_ReachabilityForSmsReportIsSet;
    std::string m_Gpsi;
    bool m_GpsiIsSet;
    std::string m_TimeStamp;

    oai::model::ReachabilityReport m_ReachabilityReport;
