...
bool PdvMonitoringReport::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "PdvMonitoringReport" : pathPrefix;
...
bool PdvMonitoringReport::operator==(const PdvMonitoringReport& rhs) const
{
    ...
    ((!ulPdvIsSet() && !rhs.ulPdvIsSet()) || (ulPdvIsSet() && rhs.ulPdvIsSet() && getUlPdv() == rhs.getUlPdv())) &&
    
    
    ((!dlPdvIsSet() && !rhs.dlPdvIsSet()) || (dlPdvIsSet() && rhs.dlPdvIsSet() && getDlPdv() == rhs.getDlPdv())) &&
    
    
    ((!rtPdvIsSet() && !rhs.rtPdvIsSet()) || (rtPdvIsSet() && rhs.rtPdvIsSet() && getRtPdv() == rhs.getRtPdv()))
...
void PdvMonitoringReport::setFlows(std::vector<oai::model::pcf::Flows> const& value)
{
    m_Flows = value;
    m_FlowsIsSet = true;
}
