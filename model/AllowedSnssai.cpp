...
bool AllowedSnssai::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    ...
    {
        const std::vector<oai::_3gpp::model::NsiInformation>& value = m_NsiInformationList;
        ...
        { // Recursive validation of array elements
            ...
            int i = 0;
            for (const oai::_3gpp::model::NsiInformation& value : value)
            { 
...
oai::_3gpp::model::Snssai AllowedSnssai::getAllowedSnssai() const
{
    return m_AllowedSnssai;
}
void AllowedSnssai::setAllowedSnssai(oai::_3gpp::model::Snssai const& value)
{
    m_AllowedSnssai = value;
}
std::vector<oai::_3gpp::model::NsiInformation> AllowedSnssai::getNsiInformationList() const
{
    return m_NsiInformationList;
}
void AllowedSnssai::setNsiInformationList(std::vector<oai::_3gpp::model::NsiInformation> const& value)
{
...
oai::_3gpp::model::Snssai AllowedSnssai::getMappedHomeSnssai() const
{
    return m_MappedHomeSnssai;
}
void AllowedSnssai::setMappedHomeSnssai(oai::_3gpp::model::Snssai const& value)
{
