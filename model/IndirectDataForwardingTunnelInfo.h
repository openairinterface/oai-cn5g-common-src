...
public:
    ...
    friend  void to_json(nlohmann::json& j, const IndirectDataForwardingTunnelInfo& o);
    friend  void from_json(const nlohmann::json& j, IndirectDataForwardingTunnelInfo& o);
protected:
