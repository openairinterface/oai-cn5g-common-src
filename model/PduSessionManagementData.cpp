...
bool PduSessionManagementData::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "PduSessionManagementData" : pathPrefix;

                         
    if (n6TrafficRoutingInfoIsSet())
    {
        const std::vector<oai::model::RouteToLocation>& value = m_N6TrafficRoutingInfo;
        ...
        success = value.validate(msg, currentValuePath + ".n6TrafficRoutingInfo") && success;
    ...
    if (ipv6PrefixIsSet())
    {
        const std::vector<oai::model::Ipv6Prefix>& value = m_Ipv6Prefix;
        ...
        success = value.validate(msg, currentValuePath + ".ipv6Prefix") && success;
    ...
    if (ipv6AddrsIsSet())
    {
        const std::vector<oai::model::Ipv6Addr>& value = m_Ipv6Addrs;
        ...
        success = value.validate(msg, currentValuePath + ".ipv6Addrs") && success;
...
bool PduSessionManagementData::operator==(const PduSessionManagementData& rhs) const
{
    return
    
    
    
    ((!pduSessionStatusIsSet() && !rhs.pduSessionStatusIsSet()) || (pduSessionStatusIsSet() && rhs.pduSessionStatusIsSet() && getPduSessionStatus() == rhs.getPduSessionStatus())) &&
    
    
    ((!pduSessionStatusTsIsSet() && !rhs.pduSessionStatusTsIsSet()) || (pduSessionStatusTsIsSet() && rhs.pduSessionStatusTsIsSet() && getPduSessionStatusTs() == rhs.getPduSessionStatusTs())) &&
    
    
    ((!dnaiIsSet() && !rhs.dnaiIsSet()) || (dnaiIsSet() && rhs.dnaiIsSet() && getDnai() == rhs.getDnai())) &&
    
    
    ((!dnaiTsIsSet() && !rhs.dnaiTsIsSet()) || (dnaiTsIsSet() && rhs.dnaiTsIsSet() && getDnaiTs() == rhs.getDnaiTs())) &&
    
    
    ((!n6TrafficRoutingInfoIsSet() && !rhs.n6TrafficRoutingInfoIsSet()) || (n6TrafficRoutingInfoIsSet() && rhs.n6TrafficRoutingInfoIsSet() && getN6TrafficRoutingInfo() == rhs.getN6TrafficRoutingInfo())) &&
    
    
    ((!n6TrafficRoutingInfoTsIsSet() && !rhs.n6TrafficRoutingInfoTsIsSet()) || (n6TrafficRoutingInfoTsIsSet() && rhs.n6TrafficRoutingInfoTsIsSet() && getN6TrafficRoutingInfoTs() == rhs.getN6TrafficRoutingInfoTs())) &&
    ...
    ((!ipv6AddrsIsSet() && !rhs.ipv6AddrsIsSet()) || (ipv6AddrsIsSet() && rhs.ipv6AddrsIsSet() && getIpv6Addrs() == rhs.getIpv6Addrs())) &&
    
    
    ((!pduSessTypeIsSet() && !rhs.pduSessTypeIsSet()) || (pduSessTypeIsSet() && rhs.pduSessTypeIsSet() && getPduSessType() == rhs.getPduSessType())) &&
    
    
    ((!ipAddrTsIsSet() && !rhs.ipAddrTsIsSet()) || (ipAddrTsIsSet() && rhs.ipAddrTsIsSet() && getIpAddrTs() == rhs.getIpAddrTs())) &&
...
oai::model::PduSessionStatus PduSessionManagementData::getPduSessionStatus() const
{
    return m_PduSessionStatus;
}
void PduSessionManagementData::setPduSessionStatus(oai::model::PduSessionStatus const& value)
{
...
std::vector<oai::model::RouteToLocation> PduSessionManagementData::getN6TrafficRoutingInfo() const
{
    return m_N6TrafficRoutingInfo;
}
void PduSessionManagementData::setN6TrafficRoutingInfo(std::vector<oai::model::RouteToLocation> const& value)
{
...
void PduSessionManagementData::setN6TrafficRoutingInfoTs(std::string const& value)
{
...
std::vector<oai::model::Ipv6Prefix> PduSessionManagementData::getIpv6Prefix() const
{
    return m_Ipv6Prefix;
}
void PduSessionManagementData::setIpv6Prefix(std::vector<oai::model::Ipv6Prefix> const& value)
{
    m_Ipv6Prefix = value;
...
std::vector<oai::model::Ipv6Addr> PduSessionManagementData::getIpv6Addrs() const
{
    return m_Ipv6Addrs;
}
void PduSessionManagementData::setIpv6Addrs(std::vector<oai::model::Ipv6Addr> const& value)
{
    m_Ipv6Addrs = value;
...
oai::model::PduSessionType PduSessionManagementData::getPduSessType() const
{
    return m_PduSessType;
}
void PduSessionManagementData::setPduSessType(oai::model::PduSessionType const& value)
{
    m_PduSessType = value;
...
void PduSessionManagementData::setResetIds(std::vector<std::string> const& value)
{
    m_ResetIds = value;
