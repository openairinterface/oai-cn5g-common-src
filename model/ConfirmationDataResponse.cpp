...
oai::_3gpp::model::AuthResult ConfirmationDataResponse::getAuthResult() const
{
    return m_AuthResult;
}
void ConfirmationDataResponse::setAuthResult(oai::_3gpp::model::AuthResult const& value)
{
    m_AuthResult = value;
}
...
std::vector<oai::_3gpp::model::ServerAddressingInfo> ConfirmationDataResponse::getPvsInfo() const
{
    return m_PvsInfo;
}
void ConfirmationDataResponse::setPvsInfo(std::vector<oai::_3gpp::model::ServerAddressingInfo> const& value)
{
    m_PvsInfo = value;
    m_PvsInfoIsSet = true;
}
