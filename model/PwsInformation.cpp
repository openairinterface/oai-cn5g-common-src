...
bool PwsInformation::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "PwsInformation" : pathPrefix;
    ...
    if (!m_PwsContainer.validate(msg, _pathPrefix + ".pwsContainer")) {
        msg << _pathPrefix << ": PwsContainer is invalid;";
        success = false;
    }     
    if (bcEmptyAreaListIsSet())
    {
        const std::vector<oai::model::GlobalRanNodeId>& value = m_BcEmptyAreaList;
        ...
        success = value.validate(msg, currentValuePath + ".bcEmptyAreaList") && success;
...
bool PwsInformation::operator==(const PwsInformation& rhs) const
{
    ...
    ((!bcEmptyAreaListIsSet() && !rhs.bcEmptyAreaListIsSet()) || (bcEmptyAreaListIsSet() && rhs.bcEmptyAreaListIsSet() && getBcEmptyAreaList() == rhs.getBcEmptyAreaList())) &&
    
    
    ((!sendRanResponseIsSet() && !rhs.sendRanResponseIsSet()) || (sendRanResponseIsSet() && rhs.sendRanResponseIsSet() && isSendRanResponse() == rhs.isSendRanResponse())) &&
    
    
    ((!omcIdIsSet() && !rhs.omcIdIsSet()) || (omcIdIsSet() && rhs.omcIdIsSet() && getOmcId() == rhs.getOmcId())) &&
...
oai::model::N2InfoContent PwsInformation::getPwsContainer() const
{
    return m_PwsContainer;
}
void PwsInformation::setPwsContainer(oai::model::N2InfoContent const& value)
{
    m_PwsContainer = value;
}
std::vector<oai::model::GlobalRanNodeId> PwsInformation::getBcEmptyAreaList() const
{
    return m_BcEmptyAreaList;
}
void PwsInformation::setBcEmptyAreaList(std::vector<oai::model::GlobalRanNodeId> const& value)
{
