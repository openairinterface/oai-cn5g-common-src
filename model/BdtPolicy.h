...
public:
    ...
    /// 
    /// </summary>
    oai::model::BdtPolicyData getBdtPolData() const;
    void setBdtPolData(oai::model::BdtPolicyData const& value);
    bool bdtPolDataIsSet() const;
    void unsetBdtPolData();
    /// <summary>
    /// 
    /// </summary>
    oai::model::BdtReqData getBdtReqData() const;
    void setBdtReqData(oai::model::BdtReqData const& value);
...
protected:
    oai::model::BdtPolicyData m_BdtPolData;
    bool m_BdtPolDataIsSet;
    oai::model::BdtReqData m_BdtReqData;
