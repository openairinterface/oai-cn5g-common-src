...
std::vector<oai::_3gpp::model::Ipv6Addr> TwifInfo::getIpv6EndpointAddresses() const
{
    return m_Ipv6EndpointAddresses;
}
void TwifInfo::setIpv6EndpointAddresses(std::vector<oai::_3gpp::model::Ipv6Addr> const& value)
{
