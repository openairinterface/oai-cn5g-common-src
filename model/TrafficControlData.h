...
public:
    ...
    /// 
    /// </summary>
    oai::model::FlowStatus getFlowStatus() const;
    void setFlowStatus(oai::model::FlowStatus const& value);
    bool flowStatusIsSet() const;
    void unsetFlowStatus();
    /// <summary>
    /// 
    /// </summary>
    oai::model::RedirectInformation getRedirectInfo() const;
    void setRedirectInfo(oai::model::RedirectInformation const& value);
    bool redirectInfoIsSet() const;
    void unsetRedirectInfo();
    /// <summary>
    /// 
    /// </summary>
    std::vector<oai::model::RedirectInformation> getAddRedirectInfo() const;
    void setAddRedirectInfo(std::vector<oai::model::RedirectInformation> const& value);
    ...
    /// 
    /// </summary>
    oai::model::UpPathChgEvent getUpPathChgEvent() const;
    void setUpPathChgEvent(oai::model::UpPathChgEvent const& value);
    bool upPathChgEventIsSet() const;
    void unsetUpPathChgEvent();
    /// <summary>
    /// 
    /// </summary>
    oai::model::SteeringFunctionality getSteerFun() const;
    void setSteerFun(oai::model::SteeringFunctionality const& value);
    bool steerFunIsSet() const;
    void unsetSteerFun();
    /// <summary>
    /// 
    /// </summary>
    oai::model::SteeringMode getSteerModeDl() const;
    void setSteerModeDl(oai::model::SteeringMode const& value);
    bool steerModeDlIsSet() const;
    void unsetSteerModeDl();
    /// <summary>
    /// 
    /// </summary>
    oai::model::SteeringMode getSteerModeUl() const;
    void setSteerModeUl(oai::model::SteeringMode const& value);
    bool steerModeUlIsSet() const;
    void unsetSteerModeUl();
    /// <summary>
    /// 
    /// </summary>
    oai::model::MulticastAccessControl getMulAccCtrl() const;
    void setMulAccCtrl(oai::model::MulticastAccessControl const& value);
...
protected:
    ...
    oai::model::FlowStatus m_FlowStatus;
    bool m_FlowStatusIsSet;
    oai::model::RedirectInformation m_RedirectInfo;
    bool m_RedirectInfoIsSet;
    std::vector<oai::model::RedirectInformation> m_AddRedirectInfo;
    ...
    oai::model::UpPathChgEvent m_UpPathChgEvent;
    bool m_UpPathChgEventIsSet;
    oai::model::SteeringFunctionality m_SteerFun;
    bool m_SteerFunIsSet;
    oai::model::SteeringMode m_SteerModeDl;
    bool m_SteerModeDlIsSet;
    oai::model::SteeringMode m_SteerModeUl;
    bool m_SteerModeUlIsSet;
    oai::model::MulticastAccessControl m_MulAccCtrl;
