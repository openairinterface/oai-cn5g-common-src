...
oai::_3gpp::model::InvocationResult ChargingDataResponse::getInvocationResult() const
{
    return m_InvocationResult;
}
void ChargingDataResponse::setInvocationResult(oai::_3gpp::model::InvocationResult const& value)
{
...
oai::_3gpp::model::SessionFailover ChargingDataResponse::getSessionFailover() const
{
    return m_SessionFailover;
}
void ChargingDataResponse::setSessionFailover(oai::_3gpp::model::SessionFailover const& value)
{
...
std::vector<oai::_3gpp::model::Trigger> ChargingDataResponse::getTriggers() const
{
    return m_Triggers;
}
void ChargingDataResponse::setTriggers(std::vector<oai::_3gpp::model::Trigger> const& value)
{
    m_Triggers = value;
...
oai::_3gpp::model::PDUSessionChargingInformation ChargingDataResponse::getPDUSessionChargingInformation() const
{
    return m_PDUSessionChargingInformation;
}
void ChargingDataResponse::setPDUSessionChargingInformation(oai::_3gpp::model::PDUSessionChargingInformation const& value)
{
...
oai::_3gpp::model::RoamingQBCInformation ChargingDataResponse::getRoamingQBCInformation() const
{
    return m_RoamingQBCInformation;
}
void ChargingDataResponse::setRoamingQBCInformation(oai::_3gpp::model::RoamingQBCInformation const& value)
{
