...
bool RtpHeaderExtInfo::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "RtpHeaderExtInfo" : pathPrefix;
...
bool RtpHeaderExtInfo::operator==(const RtpHeaderExtInfo& rhs) const
{
    ...
    ((!rtpHeaderExtTypeIsSet() && !rhs.rtpHeaderExtTypeIsSet()) || (rtpHeaderExtTypeIsSet() && rhs.rtpHeaderExtTypeIsSet() && getRtpHeaderExtType() == rhs.getRtpHeaderExtType())) &&
    
    
    ((!rtpHeaderExtIdIsSet() && !rhs.rtpHeaderExtIdIsSet()) || (rtpHeaderExtIdIsSet() && rhs.rtpHeaderExtIdIsSet() && getRtpHeaderExtId() == rhs.getRtpHeaderExtId())) &&
    
    
    ((!longFormatIsSet() && !rhs.longFormatIsSet()) || (longFormatIsSet() && rhs.longFormatIsSet() && isLongFormat() == rhs.isLongFormat())) &&
    
    
    ((!pduSetSizeActiveIsSet() && !rhs.pduSetSizeActiveIsSet()) || (pduSetSizeActiveIsSet() && rhs.pduSetSizeActiveIsSet() && isPduSetSizeActive() == rhs.isPduSetSizeActive()))
...
oai::model::pcf::RtpHeaderExtType RtpHeaderExtInfo::getRtpHeaderExtType() const
{
    return m_RtpHeaderExtType;
}
void RtpHeaderExtInfo::setRtpHeaderExtType(oai::model::pcf::RtpHeaderExtType const& value)
{
