...
bool SnssaiExtension::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    ...
    if (sdRangesIsSet())
    {
        const std::vector<oai::model::SdRange>& value = m_SdRanges;
        ...
        { // Recursive validation of array elements
            ...
            int i = 0;
            for (const oai::model::SdRange& value : value)
            { 
...
std::vector<oai::model::SdRange> SnssaiExtension::getSdRanges() const
{
    return m_SdRanges;
}
void SnssaiExtension::setSdRanges(std::vector<oai::model::SdRange> const& value)
{
    m_SdRanges = value;
