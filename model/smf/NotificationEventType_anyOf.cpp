...
bool NotificationEventType_anyOf::validate(
  ...
  if (m_value == NotificationEventType_anyOf::eNotificationEventType_anyOf::
...
void from_json(const nlohmann::json &j, NotificationEventType_anyOf &o) {
  ...
  if (s == "NF_REGISTERED") {
    o.setValue(
        NotificationEventType_anyOf::eNotificationEventType_anyOf::REGISTERED);
  } else if (s == "NF_DEREGISTERED") {
    o.setValue(NotificationEventType_anyOf::eNotificationEventType_anyOf::
                   DEREGISTERED);
...
void NotificationEventType_anyOf::setValue(
