...
bool PDUSessionInformation::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    ...
    {
        const std::vector<oai::_3gpp::model::RanNasRelCause>& value = m_EnhancedDiagnostics;
        ...
        success = value.validate(msg, currentValuePath + ".enhancedDiagnostics") && success;
...
bool PDUSessionInformation::operator==(const PDUSessionInformation& rhs) const
{
    ...
    ((!networkSlicingInfoIsSet() && !rhs.networkSlicingInfoIsSet()) || (networkSlicingInfoIsSet() && rhs.networkSlicingInfoIsSet() && getNetworkSlicingInfo() == rhs.getNetworkSlicingInfo())) &&
    
    (getPduSessionID() == rhs.getPduSessionID())
     &&
    
    
    ((!pduTypeIsSet() && !rhs.pduTypeIsSet()) || (pduTypeIsSet() && rhs.pduTypeIsSet() && getPduType() == rhs.getPduType())) &&
    
    
    ((!sscModeIsSet() && !rhs.sscModeIsSet()) || (sscModeIsSet() && rhs.sscModeIsSet() && getSscMode() == rhs.getSscMode())) &&
    
    
    ((!hPlmnIdIsSet() && !rhs.hPlmnIdIsSet()) || (hPlmnIdIsSet() && rhs.hPlmnIdIsSet() && getHPlmnId() == rhs.getHPlmnId())) &&
    ...
    ((!mAPDUNon3GPPRATTypeIsSet() && !rhs.mAPDUNon3GPPRATTypeIsSet()) || (mAPDUNon3GPPRATTypeIsSet() && rhs.mAPDUNon3GPPRATTypeIsSet() && getMAPDUNon3GPPRATType() == rhs.getMAPDUNon3GPPRATType())) &&
    ...
    ((!chargingCharacteristicsSelectionModeIsSet() && !rhs.chargingCharacteristicsSelectionModeIsSet()) || (chargingCharacteristicsSelectionModeIsSet() && rhs.chargingCharacteristicsSelectionModeIsSet() && getChargingCharacteristicsSelectionMode() == rhs.getChargingCharacteristicsSelectionMode())) &&
    
    
    ((!startTimeIsSet() && !rhs.startTimeIsSet()) || (startTimeIsSet() && rhs.startTimeIsSet() && getStartTime() == rhs.getStartTime())) &&
    
    
    ((!stopTimeIsSet() && !rhs.stopTimeIsSet()) || (stopTimeIsSet() && rhs.stopTimeIsSet() && getStopTime() == rhs.getStopTime())) &&
    ...
    ((!sessionStopIndicatorIsSet() && !rhs.sessionStopIndicatorIsSet()) || (sessionStopIndicatorIsSet() && rhs.sessionStopIndicatorIsSet() && isSessionStopIndicator() == rhs.isSessionStopIndicator())) &&
    
    
    ((!pduAddressIsSet() && !rhs.pduAddressIsSet()) || (pduAddressIsSet() && rhs.pduAddressIsSet() && getPduAddress() == rhs.getPduAddress())) &&
    
    
    ((!diagnosticsIsSet() && !rhs.diagnosticsIsSet()) || (diagnosticsIsSet() && rhs.diagnosticsIsSet() && getDiagnostics() == rhs.getDiagnostics())) &&
    
    
    ((!authorizedQoSInformationIsSet() && !rhs.authorizedQoSInformationIsSet()) || (authorizedQoSInformationIsSet() && rhs.authorizedQoSInformationIsSet() && getAuthorizedQoSInformation() == rhs.getAuthorizedQoSInformation())) &&
    
    
    ((!subscribedQoSInformationIsSet() && !rhs.subscribedQoSInformationIsSet()) || (subscribedQoSInformationIsSet() && rhs.subscribedQoSInformationIsSet() && getSubscribedQoSInformation() == rhs.getSubscribedQoSInformation())) &&
    
    
    ((!authorizedSessionAMBRIsSet() && !rhs.authorizedSessionAMBRIsSet()) || (authorizedSessionAMBRIsSet() && rhs.authorizedSessionAMBRIsSet() && getAuthorizedSessionAMBR() == rhs.getAuthorizedSessionAMBR())) &&
    
    
    ((!subscribedSessionAMBRIsSet() && !rhs.subscribedSessionAMBRIsSet()) || (subscribedSessionAMBRIsSet() && rhs.subscribedSessionAMBRIsSet() && getSubscribedSessionAMBR() == rhs.getSubscribedSessionAMBR())) &&
    
    
    ((!servingCNPlmnIdIsSet() && !rhs.servingCNPlmnIdIsSet()) || (servingCNPlmnIdIsSet() && rhs.servingCNPlmnIdIsSet() && getServingCNPlmnId() == rhs.getServingCNPlmnId())) &&
    
    
    ((!mAPDUSessionInformationIsSet() && !rhs.mAPDUSessionInformationIsSet()) || (mAPDUSessionInformationIsSet() && rhs.mAPDUSessionInformationIsSet() && getMAPDUSessionInformation() == rhs.getMAPDUSessionInformation())) &&
    
    
    ((!enhancedDiagnosticsIsSet() && !rhs.enhancedDiagnosticsIsSet()) || (enhancedDiagnosticsIsSet() && rhs.enhancedDiagnosticsIsSet() && getEnhancedDiagnostics() == rhs.getEnhancedDiagnostics()))
...
void to_json(nlohmann::json& j, const PDUSessionInformation& o)
{
    ...
    if(o.chargingCharacteristicsSelectionModeIsSet())
        j["chargingCharacteristicsSelectionMode"] = o.m_ChargingCharacteristicsSelectionMode;
    if(o.startTimeIsSet())
...
void from_json(const nlohmann::json& j, PDUSessionInformation& o)
{
    ...
    {
        j.at("chargingCharacteristicsSelectionMode").get_to(o.m_ChargingCharacteristicsSelectionMode);
...
oai::_3gpp::model::NetworkSlicingInfo PDUSessionInformation::getNetworkSlicingInfo() const
{
    return m_NetworkSlicingInfo;
}
void PDUSessionInformation::setNetworkSlicingInfo(oai::_3gpp::model::NetworkSlicingInfo const& value)
{
...
void PDUSessionInformation::setPduType(oai::_3gpp::model::PduSessionType const& value)
{
    m_PduType = value;
    m_PduTypeIsSet = true;
}
...
void PDUSessionInformation::setSscMode(oai::_3gpp::model::SscMode const& value)
{
    m_SscMode = value;
    m_SscModeIsSet = true;
}
...
oai::_3gpp::model::ServingNetworkFunctionID PDUSessionInformation::getServingNetworkFunctionID() const
{
    return m_ServingNetworkFunctionID;
}
void PDUSessionInformation::setServingNetworkFunctionID(oai::_3gpp::model::ServingNetworkFunctionID const& value)
{
...
void PDUSessionInformation::setRatType(oai::_3gpp::model::RatType const& value)
{
    m_RatType = value;
    m_RatTypeIsSet = true;
}
...
oai::_3gpp::model::RatType PDUSessionInformation::getMAPDUNon3GPPRATType() const
{
    return m_MAPDUNon3GPPRATType;
}
void PDUSessionInformation::setMAPDUNon3GPPRATType(oai::_3gpp::model::RatType const& value)
{
...
void PDUSessionInformation::setChargingCharacteristics(std::string const& value)
{
...
oai::_3gpp::model::ChargingCharacteristicsSelectionMode PDUSessionInformation::getChargingCharacteristicsSelectionMode() const
{
    return m_ChargingCharacteristicsSelectionMode;
}
void PDUSessionInformation::setChargingCharacteristicsSelectionMode(oai::_3gpp::model::ChargingCharacteristicsSelectionMode const& value)
{
...
oai::_3gpp::model::r_3GPPPSDataOffStatus PDUSessionInformation::getR3gppPSDataOffStatus() const
{
    return m_r_3gppPSDataOffStatus;
}
void PDUSessionInformation::setR3gppPSDataOffStatus(oai::_3gpp::model::r_3GPPPSDataOffStatus const& value)
{
...
void PDUSessionInformation::setPduAddress(oai::_3gpp::model::PDUAddress const& value)
{
    m_PduAddress = value;
...
oai::_3gpp::model::AuthorizedDefaultQos PDUSessionInformation::getAuthorizedQoSInformation() const
{
    return m_AuthorizedQoSInformation;
}
void PDUSessionInformation::setAuthorizedQoSInformation(oai::_3gpp::model::AuthorizedDefaultQos const& value)
{
...
oai::_3gpp::model::SubscribedDefaultQos PDUSessionInformation::getSubscribedQoSInformation() const
{
    return m_SubscribedQoSInformation;
}
void PDUSessionInformation::setSubscribedQoSInformation(oai::_3gpp::model::SubscribedDefaultQos const& value)
{
...
oai::_3gpp::model::Ambr PDUSessionInformation::getAuthorizedSessionAMBR() const
{
    return m_AuthorizedSessionAMBR;
}
void PDUSessionInformation::setAuthorizedSessionAMBR(oai::_3gpp::model::Ambr const& value)
{
...
oai::_3gpp::model::Ambr PDUSessionInformation::getSubscribedSessionAMBR() const
{
    return m_SubscribedSessionAMBR;
}
void PDUSessionInformation::setSubscribedSessionAMBR(oai::_3gpp::model::Ambr const& value)
{
...
void PDUSessionInformation::setServingCNPlmnId(oai::_3gpp::model::PlmnId const& value)
{
...
oai::_3gpp::model::MAPDUSessionInformation PDUSessionInformation::getMAPDUSessionInformation() const
{
    return m_MAPDUSessionInformation;
}
void PDUSessionInformation::setMAPDUSessionInformation(oai::_3gpp::model::MAPDUSessionInformation const& value)
{
...
std::vector<oai::_3gpp::model::RanNasRelCause> PDUSessionInformation::getEnhancedDiagnostics() const
{
    return m_EnhancedDiagnostics;
}
void PDUSessionInformation::setEnhancedDiagnostics(std::vector<oai::_3gpp::model::RanNasRelCause> const& value)
{
