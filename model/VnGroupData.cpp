...
void VnGroupData::setPduSessionTypes(oai::_3gpp::model::PduSessionTypes_1 const& value)
{
...
std::vector<oai::_3gpp::model::AppDescriptor> VnGroupData::getAppDescriptors() const
{
    return m_AppDescriptors;
}
void VnGroupData::setAppDescriptors(std::vector<oai::_3gpp::model::AppDescriptor> const& value)
{
