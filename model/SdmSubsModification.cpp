...
bool SdmSubsModification::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "SdmSubsModification" : pathPrefix;
...
bool SdmSubsModification::operator==(const SdmSubsModification& rhs) const
{
    ...
    ((!monitoredResourceUrisIsSet() && !rhs.monitoredResourceUrisIsSet()) || (monitoredResourceUrisIsSet() && rhs.monitoredResourceUrisIsSet() && getMonitoredResourceUris() == rhs.getMonitoredResourceUris()))
...
std::vector<oai::_3gpp::model::std::string> SdmSubsModification::getMonitoredResourceUris() const
{
    return m_MonitoredResourceUris;
}
void SdmSubsModification::setMonitoredResourceUris(std::vector<oai::_3gpp::model::std::string> const& value)
{
