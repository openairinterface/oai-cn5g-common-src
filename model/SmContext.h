...
public:
    ...
    void setQosFlowsList(std::vector<oai::_3gpp::model::QosFlowSetupItem> const& value);
    /// <summary>
    /// String uniquely identifying a NF instance. The format of the NF Instance ID shall be a  Universally Unique Identifier (UUID) version 4, as described in IETF RFC 4122.  
    /// </summary>
    ...
    /// 
    /// </summary>
    oai::_3gpp::model::MaxIntegrityProtectedDataRate getMaxIntegrityProtectedDataRate() const;
    void setMaxIntegrityProtectedDataRate(oai::_3gpp::model::MaxIntegrityProtectedDataRate const& value);
    ...
    void setAddRanTunnelInfo(std::vector<oai::_3gpp::model::QosFlowTunnel> const& value);
    ...
    void setAddRedRanTunnelInfo(std::vector<oai::_3gpp::model::QosFlowTunnel> const& value);
...
protected:
    ...
    oai::_3gpp::model::MaxIntegrityProtectedDataRate m_MaxIntegrityProtectedDataRate;
