...
bool NetworkSliceCond::validate(
    std::stringstream& msg, const std::string& pathPrefix) const {
  bool success = true;
  const std::string _pathPrefix =
      pathPrefix.empty() ? "NetworkSliceCond" : pathPrefix;
...
std::vector<oai::_3gpp::model::Snssai> NetworkSliceCond::getSnssaiList() const {
  return m_SnssaiList;
}
void NetworkSliceCond::setSnssaiList(
