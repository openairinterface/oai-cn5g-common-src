...
bool ExemptionInd::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "ExemptionInd" : pathPrefix;
...
bool ExemptionInd::operator==(const ExemptionInd& rhs) const
{
    ...
    ((!dnnCongestionIsSet() && !rhs.dnnCongestionIsSet()) || (dnnCongestionIsSet() && rhs.dnnCongestionIsSet() && isDnnCongestion() == rhs.isDnnCongestion())) &&
    
    
    ((!snssaiOnlyCongestionIsSet() && !rhs.snssaiOnlyCongestionIsSet()) || (snssaiOnlyCongestionIsSet() && rhs.snssaiOnlyCongestionIsSet() && isSnssaiOnlyCongestion() == rhs.isSnssaiOnlyCongestion())) &&
    
    
    ((!snssaiDnnCongestionIsSet() && !rhs.snssaiDnnCongestionIsSet()) || (snssaiDnnCongestionIsSet() && rhs.snssaiDnnCongestionIsSet() && isSnssaiDnnCongestion() == rhs.isSnssaiDnnCongestion()))
