...
bool UePolicySetPatch::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "UePolicySetPatch" : pathPrefix;
...
std::map<std::string, oai::_3gpp::model::UePolicySection> UePolicySetPatch::getUePolicySections() const
{
    return m_UePolicySections;
}
void UePolicySetPatch::setUePolicySections(std::map<std::string, oai::_3gpp::model::UePolicySection> const& value)
{
...
std::vector<oai::_3gpp::model::std::string> UePolicySetPatch::getOsIds() const
{
    return m_OsIds;
}
void UePolicySetPatch::setOsIds(std::vector<oai::_3gpp::model::std::string> const& value)
{
    m_OsIds = value;
    m_OsIdsIsSet = true;
}
