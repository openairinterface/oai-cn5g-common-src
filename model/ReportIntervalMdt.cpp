...
ReportIntervalMdt_anyOf::eReportIntervalMdt_anyOf ReportIntervalMdt::getEnumValue() const
{
    return m_value.getValue();
}

void ReportIntervalMdt::setEnumValue(ReportIntervalMdt_anyOf::eReportIntervalMdt_anyOf  value)
{
