...
bool NFService::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    ...
    if (!m_ServiceName.validate(msg, _pathPrefix + ".serviceName")) {
        msg << _pathPrefix << ": ServiceName is invalid;";
        success = false;
    }     
    
    /* Versions */ {
        const std::vector<oai::model::NFServiceVersion>& value = m_Versions;
        ...
        { // Recursive validation of array elements
            ...
            int i = 0;
            for (const oai::model::NFServiceVersion& value : value)
            { 
    ...
    if (!m_NfServiceStatus.validate(msg, _pathPrefix + ".nfServiceStatus")) {
        msg << _pathPrefix << ": NfServiceStatus is invalid;";
        success = false;
    }     
    if (fqdnIsSet())
    {
    ...
    if (ipEndPointsIsSet())
    {
        const std::vector<oai::model::IpEndPoint>& value = m_IpEndPoints;
        ...
        { // Recursive validation of array elements
            const std::string oldValuePath = currentValuePath;
            int i = 0;
            for (const oai::model::IpEndPoint& value : value)
            { 
                const std::string currentValuePath = oldValuePath + "[" + std::to_string(i) + "]";
...
oai::model::ServiceName NFService::getServiceName() const
{
    return m_ServiceName;
}
void NFService::setServiceName(oai::model::ServiceName const& value)
{
    m_ServiceName = value;
}
std::vector<oai::model::NFServiceVersion> NFService::getVersions() const
{
    return m_Versions;
}
void NFService::setVersions(std::vector<oai::model::NFServiceVersion> const& value)
{
    m_Versions = value;
}
oai::model::UriScheme NFService::getScheme() const
{
    return m_Scheme;
}
void NFService::setScheme(oai::model::UriScheme const& value)
{
    m_Scheme = value;
}
oai::model::NFServiceStatus NFService::getNfServiceStatus() const
{
    return m_NfServiceStatus;
}
void NFService::setNfServiceStatus(oai::model::NFServiceStatus const& value)
{
...
std::vector<oai::model::IpEndPoint> NFService::getIpEndPoints() const
{
    return m_IpEndPoints;
}
void NFService::setIpEndPoints(std::vector<oai::model::IpEndPoint> const& value)
{
    m_IpEndPoints = value;
...
std::vector<oai::model::DefaultNotificationSubscription> NFService::getDefaultNotificationSubscriptions() const
{
    return m_DefaultNotificationSubscriptions;
}
void NFService::setDefaultNotificationSubscriptions(std::vector<oai::model::DefaultNotificationSubscription> const& value)
{
...
std::vector<oai::model::PlmnId> NFService::getAllowedPlmns() const
{
    return m_AllowedPlmns;
}
void NFService::setAllowedPlmns(std::vector<oai::model::PlmnId> const& value)
{
...
std::vector<oai::model::PlmnIdNid> NFService::getAllowedSnpns() const
{
    return m_AllowedSnpns;
}
void NFService::setAllowedSnpns(std::vector<oai::model::PlmnIdNid> const& value)
{
...
std::vector<oai::model::NFType> NFService::getAllowedNfTypes() const
{
    return m_AllowedNfTypes;
}
void NFService::setAllowedNfTypes(std::vector<oai::model::NFType> const& value)
{
...
std::vector<oai::model::ExtSnssai> NFService::getAllowedNssais() const
{
    return m_AllowedNssais;
}
void NFService::setAllowedNssais(std::vector<oai::model::ExtSnssai> const& value)
{
...
std::vector<oai::model::ExtSnssai> NFService::getSNssais() const
{
    return m_SNssais;
}
void NFService::setSNssais(std::vector<oai::model::ExtSnssai> const& value)
{
    m_SNssais = value;
    m_SNssaisIsSet = true;
}
...
std::vector<oai::model::PlmnSnssai> NFService::getPerPlmnSnssaiList() const
{
    return m_PerPlmnSnssaiList;
}
void NFService::setPerPlmnSnssaiList(std::vector<oai::model::PlmnSnssai> const& value)
{
...
std::map<std::string, std::vector<oai::model::VendorSpecificFeature>> NFService::getSupportedVendorSpecificFeatures() const
{
    return m_SupportedVendorSpecificFeatures;
}
void NFService::setSupportedVendorSpecificFeatures(std::map<std::string, std::vector<oai::model::VendorSpecificFeature>> const& value)
{
...
oai::model::PlmnOauth2 NFService::getPerPlmnOauth2ReqList() const
{
    return m_PerPlmnOauth2ReqList;
}
void NFService::setPerPlmnOauth2ReqList(oai::model::PlmnOauth2 const& value)
{
