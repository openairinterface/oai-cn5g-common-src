...
oai::model::QosFlowProfile QosFlowAddModifyRequestItem::getQosFlowProfile() const
{
    return m_QosFlowProfile;
}
void QosFlowAddModifyRequestItem::setQosFlowProfile(oai::model::QosFlowProfile const& value)
{
...
oai::model::QosFlowAccessType QosFlowAddModifyRequestItem::getAssociatedAnType() const
{
    return m_AssociatedAnType;
}
void QosFlowAddModifyRequestItem::setAssociatedAnType(oai::model::QosFlowAccessType const& value)
{
