...
extern asn_TYPE_descriptor_t asn_DEF_Ngap_dAPSIndicator __attribute__((weak, alias("asn_DEF_Ngap_dAPSIndicator_2")));
#else
static asn_TYPE_descriptor_t asn_DEF_Ngap_dAPSIndicator_2;
static asn_TYPE_descriptor_t asn_DEF_Ngap_dAPSIndicator;
__attribute__((constructor)) static void asn_DEF_Ngap_dAPSIndicator_2_alias_init(void) {
...
static int asn_validate_Ngap_dAPSIndicator_2(const asn_TYPE_descriptor_t *td,
                       const void *sptr,
                       asn_app_constraint_failed_f *ctfailcb,
                       void* app_key) {
    if(! sptr) { return -1; }
    e_Ngap_DAPSRequestInfo__dAPSIndicator value = *(e_Ngap_DAPSRequestInfo__dAPSIndicator*)sptr;
    switch(value) {
