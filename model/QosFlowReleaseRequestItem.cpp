...
bool QosFlowReleaseRequestItem::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "QosFlowReleaseRequestItem" : pathPrefix;
...
bool QosFlowReleaseRequestItem::operator==(const QosFlowReleaseRequestItem& rhs) const
{
    return
...
void QosFlowReleaseRequestItem::setQosFlowDescription(std::string const& value)
{
