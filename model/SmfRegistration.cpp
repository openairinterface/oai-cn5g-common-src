...
oai::_3gpp::model::RegistrationReason SmfRegistration::getRegistrationReason() const
{
    return m_RegistrationReason;
}
void SmfRegistration::setRegistrationReason(oai::_3gpp::model::RegistrationReason const& value)
{
...
void SmfRegistration::setContextInfo(oai::_3gpp::model::ContextInfo const& value)
{
    m_ContextInfo = value;
