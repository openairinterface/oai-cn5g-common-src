...
bool PatchItem::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    ...
    if (!m_Op.validate(msg, _pathPrefix + ".op")) {
        msg << _pathPrefix << ": Op is invalid;";
        success = false;
    }            
    return success;
}
...
oai::model::PatchOperation PatchItem::getOp() const
{
    return m_Op;
}
void PatchItem::setOp(oai::model::PatchOperation const& value)
{
    m_Op = value;
}
