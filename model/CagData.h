...
public:
    ...
    /// </summary>
    std::map<std::string, oai::model::CagInfo> getCagInfos() const;
    void setCagInfos(std::map<std::string, oai::model::CagInfo> const& value);
    /// <summary>
...
protected:
    std::map<std::string, oai::model::CagInfo> m_CagInfos;
