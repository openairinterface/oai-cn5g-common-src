...
static int memb_Ngap_macroNgENB_ID_constraint_1(
...
static int memb_Ngap_shortMacroNgENB_ID_constraint_1(
    const asn_TYPE_descriptor_t* td, const void* sptr,
    asn_app_constraint_failed_f* ctfailcb, void* app_key) {
  const BIT_STRING_t* st = (const BIT_STRING_t*) sptr;
  size_t size;
...
static int memb_Ngap_longMacroNgENB_ID_constraint_1(
    const asn_TYPE_descriptor_t* td, const void* sptr,
    asn_app_constraint_failed_f* ctfailcb, void* app_key) {
  const BIT_STRING_t* st = (const BIT_STRING_t*) sptr;
  size_t size;
...
static asn_per_constraints_t asn_PER_memb_Ngap_longMacroNgENB_ID_constr_4
    CC_NOTUSED = {
        ...
        0 /* No PER value map */
          ...
          !defined(ASN_DISABLE_APER_SUPPORT) */
#if !defined(ASN_DISABLE_OER_SUPPORT)
asn_oer_constraints_t asn_OER_type_Ngap_NgENB_ID_constr_1 CC_NOTUSED = {
    {0, 0},
    -1};
#endif /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
...
asn_TYPE_member_t asn_MBR_Ngap_NgENB_ID_1[] = {
    {ATF_NOFLAGS,
     0,
     offsetof(struct Ngap_NgENB_ID, choice.macroNgENB_ID),
    ...
    {ATF_NOFLAGS,
     0,
     offsetof(struct Ngap_NgENB_ID, choice.shortMacroNgENB_ID),
    ...
    {ATF_NOFLAGS,
     0,
     offsetof(struct Ngap_NgENB_ID, choice.longMacroNgENB_ID),
    ...
    {ATF_POINTER,
     ...
     -1, /* IMPLICIT tag at current level */
     &asn_DEF_Ngap_ProtocolIE_SingleContainer_12877P37,
     0,
     {
#if !defined(ASN_DISABLE_OER_SUPPORT)
         0,
