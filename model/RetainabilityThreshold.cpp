...
bool RetainabilityThreshold::operator==(const RetainabilityThreshold& rhs) const
{
    ...
    ((!relFlowNumIsSet() && !rhs.relFlowNumIsSet()) || (relFlowNumIsSet() && rhs.relFlowNumIsSet() && getRelFlowNum() == rhs.getRelFlowNum())) &&
    
    
    ((!relTimeUnitIsSet() && !rhs.relTimeUnitIsSet()) || (relTimeUnitIsSet() && rhs.relTimeUnitIsSet() && getRelTimeUnit() == rhs.getRelTimeUnit())) &&
    
    
    ((!relFlowRatioIsSet() && !rhs.relFlowRatioIsSet()) || (relFlowRatioIsSet() && rhs.relFlowRatioIsSet() && getRelFlowRatio() == rhs.getRelFlowRatio()))
...
oai::_3gpp::model::TimeUnit RetainabilityThreshold::getRelTimeUnit() const
{
    return m_RelTimeUnit;
}
void RetainabilityThreshold::setRelTimeUnit(oai::_3gpp::model::TimeUnit const& value)
{
    m_RelTimeUnit = value;
