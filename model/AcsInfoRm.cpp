...
bool AcsInfoRm::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
...
oai::_3gpp::model::Ipv6Addr AcsInfoRm::getAcsIpv6Addr() const
{
    return m_AcsIpv6Addr;
}
void AcsInfoRm::setAcsIpv6Addr(oai::_3gpp::model::Ipv6Addr const& value)
{
    m_AcsIpv6Addr = value;
