...
typedef enum Ngap_TriggeringMessage {
	...
	Ngap_TriggeringMessage_unsuccessful_outcome	= 2
...
/* Implementation */
extern asn_oer_constraints_t asn_OER_type_Ngap_TriggeringMessage_constr_1;
...
cbor_type_decoder_f Ngap_TriggeringMessage_decode_cbor;
cbor_type_encoder_f Ngap_TriggeringMessage_encode_cbor;
oer_type_decoder_f Ngap_TriggeringMessage_decode_oer;
oer_type_encoder_f Ngap_TriggeringMessage_encode_oer;
