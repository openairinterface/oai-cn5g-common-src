...
bool SmPolicyDecision::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    ...
    if (sessRulesIsSet())
    {
        const std::map<std::string, oai::model::SessionRule>& value = m_SessRules;
    ...
    if (pccRulesIsSet())
    {
        const std::map<std::string, oai::model::PccRule>& value = m_PccRules;
    ...
    if (qosDecsIsSet())
    {
        const std::map<std::string, oai::model::QosData>& value = m_QosDecs;
    ...
    if (chgDecsIsSet())
    {
        const std::map<std::string, oai::model::ChargingData>& value = m_ChgDecs;
    ...
    {
        const std::map<std::string, oai::model::TrafficControlData>& value = m_TraffContDecs;
    ...
    if (umDecsIsSet())
    {
        const std::map<std::string, oai::model::UsageMonitoringData>& value = m_UmDecs;
    ...
    if (qosCharsIsSet())
    {
        const std::map<std::string, oai::model::QosCharacteristics>& value = m_QosChars;
    ...
    if (qosMonDecsIsSet())
    {
        const std::map<std::string, oai::model::QosMonitoringData>& value = m_QosMonDecs;
    ...
    if (condsIsSet())
    {
        const std::map<std::string, oai::model::ConditionData>& value = m_Conds;
    ...
    {
        const std::vector<oai::model::PolicyControlRequestTrigger>& value = m_PolicyCtrlReqTriggers;
    ...
    {
        const std::vector<oai::model::RequestedRuleData>& value = m_LastReqRuleData;
        ...
        { // Recursive validation of array elements
            const std::string oldValuePath = currentValuePath;
            int i = 0;
            for (const oai::model::RequestedRuleData& value : value)
            { 
                const std::string currentValuePath = oldValuePath + "[" + std::to_string(i) + "]";
    ...
    if (praInfosIsSet())
    {
        const std::map<std::string, oai::model::PresenceInfoRm>& value = m_PraInfos;
...
std::map<std::string, oai::model::SessionRule> SmPolicyDecision::getSessRules() const
{
    return m_SessRules;
}
void SmPolicyDecision::setSessRules(std::map<std::string, oai::model::SessionRule> const& value)
{
    m_SessRules = value;
...
std::map<std::string, oai::model::PccRule> SmPolicyDecision::getPccRules() const
{
    return m_PccRules;
}
void SmPolicyDecision::setPccRules(std::map<std::string, oai::model::PccRule> const& value)
{
    m_PccRules = value;
...
std::map<std::string, oai::model::QosData> SmPolicyDecision::getQosDecs() const
{
    return m_QosDecs;
}
void SmPolicyDecision::setQosDecs(std::map<std::string, oai::model::QosData> const& value)
{
    m_QosDecs = value;
    m_QosDecsIsSet = true;
}
...
std::map<std::string, oai::model::ChargingData> SmPolicyDecision::getChgDecs() const
{
    return m_ChgDecs;
}
void SmPolicyDecision::setChgDecs(std::map<std::string, oai::model::ChargingData> const& value)
{
    m_ChgDecs = value;
    m_ChgDecsIsSet = true;
}
...
oai::model::ChargingInformation SmPolicyDecision::getChargingInfo() const
{
    return m_ChargingInfo;
}
void SmPolicyDecision::setChargingInfo(oai::model::ChargingInformation const& value)
{
...
std::map<std::string, oai::model::TrafficControlData> SmPolicyDecision::getTraffContDecs() const
{
    return m_TraffContDecs;
}
void SmPolicyDecision::setTraffContDecs(std::map<std::string, oai::model::TrafficControlData> const& value)
{
...
std::map<std::string, oai::model::UsageMonitoringData> SmPolicyDecision::getUmDecs() const
{
    return m_UmDecs;
}
void SmPolicyDecision::setUmDecs(std::map<std::string, oai::model::UsageMonitoringData> const& value)
{
    m_UmDecs = value;
    m_UmDecsIsSet = true;
}
...
std::map<std::string, oai::model::QosCharacteristics> SmPolicyDecision::getQosChars() const
{
    return m_QosChars;
}
void SmPolicyDecision::setQosChars(std::map<std::string, oai::model::QosCharacteristics> const& value)
{
    m_QosChars = value;
...
std::map<std::string, oai::model::QosMonitoringData> SmPolicyDecision::getQosMonDecs() const
{
    return m_QosMonDecs;
}
void SmPolicyDecision::setQosMonDecs(std::map<std::string, oai::model::QosMonitoringData> const& value)
{
    m_QosMonDecs = value;
...
std::map<std::string, oai::model::ConditionData> SmPolicyDecision::getConds() const
{
    return m_Conds;
}
void SmPolicyDecision::setConds(std::map<std::string, oai::model::ConditionData> const& value)
{
    m_Conds = value;
    m_CondsIsSet = true;
}
...
std::vector<oai::model::PolicyControlRequestTrigger> SmPolicyDecision::getPolicyCtrlReqTriggers() const
{
    return m_PolicyCtrlReqTriggers;
}
void SmPolicyDecision::setPolicyCtrlReqTriggers(std::vector<oai::model::PolicyControlRequestTrigger> const& value)
{
...
std::vector<oai::model::RequestedRuleData> SmPolicyDecision::getLastReqRuleData() const
{
    return m_LastReqRuleData;
}
void SmPolicyDecision::setLastReqRuleData(std::vector<oai::model::RequestedRuleData> const& value)
{
...
oai::model::RequestedUsageData SmPolicyDecision::getLastReqUsageData() const
{
    return m_LastReqUsageData;
}
void SmPolicyDecision::setLastReqUsageData(oai::model::RequestedUsageData const& value)
{
...
std::map<std::string, oai::model::PresenceInfoRm> SmPolicyDecision::getPraInfos() const
{
    return m_PraInfos;
}
void SmPolicyDecision::setPraInfos(std::map<std::string, oai::model::PresenceInfoRm> const& value)
{
    m_PraInfos = value;
...
oai::model::QosFlowUsage SmPolicyDecision::getQosFlowUsage() const
{
    return m_QosFlowUsage;
}
void SmPolicyDecision::setQosFlowUsage(oai::model::QosFlowUsage const& value)
{
...
oai::model::SmPolicyAssociationReleaseCause SmPolicyDecision::getRelCause() const
{
    return m_RelCause;
}
void SmPolicyDecision::setRelCause(oai::model::SmPolicyAssociationReleaseCause const& value)
{
    m_RelCause = value;
...
oai::model::BridgeManagementContainer SmPolicyDecision::getTsnBridgeManCont() const
{
    return m_TsnBridgeManCont;
}
void SmPolicyDecision::setTsnBridgeManCont(oai::model::BridgeManagementContainer const& value)
{
...
oai::model::PortManagementContainer SmPolicyDecision::getTsnPortManContDstt() const
{
    return m_TsnPortManContDstt;
}
void SmPolicyDecision::setTsnPortManContDstt(oai::model::PortManagementContainer const& value)
{
...
std::vector<oai::model::PortManagementContainer> SmPolicyDecision::getTsnPortManContNwtts() const
{
    return m_TsnPortManContNwtts;
}
void SmPolicyDecision::setTsnPortManContNwtts(std::vector<oai::model::PortManagementContainer> const& value)
{
