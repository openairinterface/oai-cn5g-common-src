...
public:
    ...
    /// 
    /// </summary>
    std::vector<oai::model::AuthorizedNssaiAvailabilityData> getAuthorizedNssaiAvailabilityData() const;
    void setAuthorizedNssaiAvailabilityData(std::vector<oai::model::AuthorizedNssaiAvailabilityData> const& value);
...
protected:
    ...
    std::string m_Expiry;
    bool m_ExpiryIsSet;
    std::vector<oai::model::AuthorizedNssaiAvailabilityData> m_AuthorizedNssaiAvailabilityData;
