...
public:
    ...
    void setTransferStatus(oai::_3gpp::model::UeContextTransferStatus const& value);
    /// <summary>
    /// 
    /// </summary>
    ...
    void setSmfChangeInfoList(std::vector<oai::_3gpp::model::SmfChangeInfo> const& value);
    ...
    /// 
    /// </summary>
    std::vector<oai::_3gpp::model::ReleaseSessionInfo> getToReleaseSessionInfo() const;
    void setToReleaseSessionInfo(std::vector<oai::_3gpp::model::ReleaseSessionInfo> const& value);
