...
void Report::setOldCmInfoList(std::vector<oai::_3gpp::model::CmInfo> const& value)
{
...
void Report::setNewCmInfoList(std::vector<oai::_3gpp::model::CmInfo> const& value)
{
    m_NewCmInfoList = value;
}
oai::_3gpp::model::LossOfConnectivityReason Report::getLossOfConnectReason() const
{
    return m_LossOfConnectReason;
}
void Report::setLossOfConnectReason(oai::_3gpp::model::LossOfConnectivityReason const& value)
{
...
void Report::setPdnConnStat(oai::_3gpp::model::PdnConnectivityStatus const& value)
{
    m_PdnConnStat = value;
}
...
void Report::setIpv6Prefixes(std::vector<oai::_3gpp::model::Ipv6Prefix> const& value)
{
...
void Report::setIpv6Addrs(std::vector<oai::_3gpp::model::Ipv6Addr> const& value)
{
    m_Ipv6Addrs = value;
