...
bool EutraLocationRm::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "EutraLocationRm" : pathPrefix;
...
oai::_3gpp::model::Tai EutraLocationRm::getTai() const
{
    return m_Tai;
}
void EutraLocationRm::setTai(oai::_3gpp::model::Tai const& value)
{
    m_Tai = value;
}
...
oai::_3gpp::model::Ecgi EutraLocationRm::getEcgi() const
{
    return m_Ecgi;
}
void EutraLocationRm::setEcgi(oai::_3gpp::model::Ecgi const& value)
{
    m_Ecgi = value;
}
...
oai::_3gpp::model::GlobalRanNodeId EutraLocationRm::getGlobalNgenbId() const
{
    return m_GlobalNgenbId;
}
void EutraLocationRm::setGlobalNgenbId(oai::_3gpp::model::GlobalRanNodeId const& value)
{
...
oai::_3gpp::model::GlobalRanNodeId EutraLocationRm::getGlobalENbId() const
{
    return m_GlobalENbId;
}
void EutraLocationRm::setGlobalENbId(oai::_3gpp::model::GlobalRanNodeId const& value)
{
    m_GlobalENbId = value;
