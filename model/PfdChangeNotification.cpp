...
std::vector<oai::_3gpp::model::PfdContent> PfdChangeNotification::getPfds() const
{
    return m_Pfds;
}
void PfdChangeNotification::setPfds(std::vector<oai::_3gpp::model::PfdContent> const& value)
{
    m_Pfds = value;
    m_PfdsIsSet = true;
}
