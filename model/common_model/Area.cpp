...
bool Area::validate(std::stringstream &msg) const { return validate(msg, ""); }

bool Area::validate(std::stringstream &msg,
...
bool Area::operator!=(const Area &rhs) const { return !(*this == rhs); }
...
std::vector<std::string> Area::getTacs() const { return m_Tacs; }
