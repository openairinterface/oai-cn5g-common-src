...
bool AcknowledgeInfo::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "AcknowledgeInfo" : pathPrefix;
...
bool AcknowledgeInfo::operator==(const AcknowledgeInfo& rhs) const
{
    ...
    ((!sorMacIueIsSet() && !rhs.sorMacIueIsSet()) || (sorMacIueIsSet() && rhs.sorMacIueIsSet() && getSorMacIue() == rhs.getSorMacIue())) &&
    
    
    ((!upuMacIueIsSet() && !rhs.upuMacIueIsSet()) || (upuMacIueIsSet() && rhs.upuMacIueIsSet() && getUpuMacIue() == rhs.getUpuMacIue())) &&
    ...
    ((!ueNotReachableIsSet() && !rhs.ueNotReachableIsSet()) || (ueNotReachableIsSet() && rhs.ueNotReachableIsSet() && isUeNotReachable() == rhs.isUeNotReachable())) &&
