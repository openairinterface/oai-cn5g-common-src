...
oai::model::FlowInfo UserDataCongestionCollection::getIpTrafficFilter() const
{
    return m_IpTrafficFilter;
}
void UserDataCongestionCollection::setIpTrafficFilter(oai::model::FlowInfo const& value)
{
...
oai::model::TimeWindow UserDataCongestionCollection::getTimeInterv() const
{
    return m_TimeInterv;
}
void UserDataCongestionCollection::setTimeInterv(oai::model::TimeWindow const& value)
{
    m_TimeInterv = value;
