...
asn_oer_constraints_t asn_OER_type_Ngap_ExpectedHOInterval_constr_1 CC_NOTUSED = {
	{ 0, 0 },
	-1};
...
static int asn_validate_Ngap_ExpectedHOInterval_1(const asn_TYPE_descriptor_t *td,
                       const void *sptr,
