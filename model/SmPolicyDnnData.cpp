...
bool SmPolicyDnnData::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    ...
    {
        const std::map<std::string, oai::model::LimitIdToMonitoringKey>& value = m_RefUmDataLimitIds;
...
oai::model::ChargingInformation SmPolicyDnnData::getChfInfo() const
{
    return m_ChfInfo;
}
void SmPolicyDnnData::setChfInfo(oai::model::ChargingInformation const& value)
{
    m_ChfInfo = value;
    m_ChfInfoIsSet = true;
}
...
std::map<std::string, oai::model::LimitIdToMonitoringKey> SmPolicyDnnData::getRefUmDataLimitIds() const
{
    return m_RefUmDataLimitIds;
}
void SmPolicyDnnData::setRefUmDataLimitIds(std::map<std::string, oai::model::LimitIdToMonitoringKey> const& value)
{
...
std::map<std::string, oai::model::PresenceInfo> SmPolicyDnnData::getPraInfos() const
{
    return m_PraInfos;
}
void SmPolicyDnnData::setPraInfos(std::map<std::string, oai::model::PresenceInfo> const& value)
{
    m_PraInfos = value;
...
void SmPolicyDnnData::setBdtRefIds(std::map<std::string, std::string> const& value)
{
    m_BdtRefIds = value;
