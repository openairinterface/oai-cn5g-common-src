...
extern asn_TYPE_descriptor_t asn_DEF_Ngap_cn_Type __attribute__((weak, alias("asn_DEF_Ngap_cn_Type_3")));
#else
static asn_TYPE_descriptor_t asn_DEF_Ngap_cn_Type_3;
static asn_TYPE_descriptor_t asn_DEF_Ngap_cn_Type;
__attribute__((constructor)) static void asn_DEF_Ngap_cn_Type_3_alias_init(void) {
...
static int asn_validate_Ngap_cn_Type_3(const asn_TYPE_descriptor_t *td,
                       const void *sptr,
                       asn_app_constraint_failed_f *ctfailcb,
                       void* app_key) {
    if(! sptr) { return -1; }
    e_Ngap_CNTypeRestrictionsForEquivalentItem__cn_Type value = *(e_Ngap_CNTypeRestrictionsForEquivalentItem__cn_Type*)sptr;
    switch(value) {
