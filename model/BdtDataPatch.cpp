...
void BdtDataPatch::setTransPolicy(oai::_3gpp::model::TransferPolicy const& value)
{
    m_TransPolicy = value;
...
void BdtDataPatch::setBdtpStatus(oai::_3gpp::model::BdtPolicyStatus const& value)
{
    m_BdtpStatus = value;
