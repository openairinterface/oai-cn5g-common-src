...
oai::_3gpp::model::EventType MonitoringReport::getEventType() const
{
    return m_EventType;
}
void MonitoringReport::setEventType(oai::_3gpp::model::EventType const& value)
{
    m_EventType = value;
}
oai::_3gpp::model::Report MonitoringReport::getReport() const
{
    return m_Report;
}
void MonitoringReport::setReport(oai::_3gpp::model::Report const& value)
{
    m_Report = value;
    m_ReportIsSet = true;
}
...
oai::_3gpp::model::ReachabilityForSmsReport MonitoringReport::getReachabilityForSmsReport() const
{
    return m_ReachabilityForSmsReport;
}
void MonitoringReport::setReachabilityForSmsReport(oai::_3gpp::model::ReachabilityForSmsReport const& value)
{
...
oai::_3gpp::model::ReachabilityReport MonitoringReport::getReachabilityReport() const
{
    return m_ReachabilityReport;
}
void MonitoringReport::setReachabilityReport(oai::_3gpp::model::ReachabilityReport const& value)
{
