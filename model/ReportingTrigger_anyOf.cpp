...
bool ReportingTrigger_anyOf::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "ReportingTrigger_anyOf" : pathPrefix;

    
    if (m_value == ReportingTrigger_anyOf::eReportingTrigger_anyOf::INVALID_VALUE_OPENAPI_GENERATED)
    {
        success = false;
...
bool ReportingTrigger_anyOf::operator==(const ReportingTrigger_anyOf& rhs) const
{
    return
...
void to_json(nlohmann::json& j, const ReportingTrigger_anyOf& o)
{
    ...
    switch (o.getValue())
    {
        case ReportingTrigger_anyOf::eReportingTrigger_anyOf::INVALID_VALUE_OPENAPI_GENERATED:
...
void from_json(const nlohmann::json& j, ReportingTrigger_anyOf& o)
{
    ...
    if (s == "PERIODICAL") {
     ...
     o.setValue(ReportingTrigger_anyOf::eReportingTrigger_anyOf::EVENT_A2_PERIODIC);
    } 
    else if (s == "ALL_RRM_EVENT_TRIGGERS") {
     o.setValue(ReportingTrigger_anyOf::eReportingTrigger_anyOf::ALL_RRM_EVENT_TRIGGERS);
    }  else {
     std::stringstream ss;
...
ReportingTrigger_anyOf::eReportingTrigger_anyOf ReportingTrigger_anyOf::getValue() const
{
    return m_value;
}
void ReportingTrigger_anyOf::setValue(ReportingTrigger_anyOf::eReportingTrigger_anyOf value)
{
    m_value = value;
}
