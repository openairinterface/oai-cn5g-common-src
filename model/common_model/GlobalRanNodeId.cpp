...
bool GlobalRanNodeId::validate(std::stringstream & /* msg */,
...
oai::model::common::GNbId GlobalRanNodeId::getGNbId() const { return m_GNbId; }
void GlobalRanNodeId::setGNbId(oai::model::common::GNbId const &value) {
  m_GNbId = value;
  m_GNbIdIsSet = true;
}
