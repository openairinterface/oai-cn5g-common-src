...
std::vector<oai::model::Snssai> NwdafCond::getSnssaiList() const
{
    return m_SnssaiList;
}
void NwdafCond::setSnssaiList(std::vector<oai::model::Snssai> const& value)
{
    m_SnssaiList = value;
...
std::vector<oai::model::Tai> NwdafCond::getTaiList() const
{
    return m_TaiList;
}
void NwdafCond::setTaiList(std::vector<oai::model::Tai> const& value)
{
    m_TaiList = value;
    m_TaiListIsSet = true;
}
...
std::vector<oai::model::TaiRange> NwdafCond::getTaiRangeList() const
{
    return m_TaiRangeList;
}
void NwdafCond::setTaiRangeList(std::vector<oai::model::TaiRange> const& value)
{
...
std::vector<oai::model::NFType> NwdafCond::getServingNfTypeList() const
{
    return m_ServingNfTypeList;
}
void NwdafCond::setServingNfTypeList(std::vector<oai::model::NFType> const& value)
{
...
std::vector<oai::model::MlAnalyticsInfo> NwdafCond::getMlAnalyticsList() const
{
    return m_MlAnalyticsList;
}
void NwdafCond::setMlAnalyticsList(std::vector<oai::model::MlAnalyticsInfo> const& value)
{
