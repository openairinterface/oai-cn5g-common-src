...
bool AcceptableServiceInfo::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "AcceptableServiceInfo" : pathPrefix;

         
    if (accBwMedCompsIsSet())
    {
        const std::map<std::string, oai::_3gpp::model::MediaComponent>& value = m_AccBwMedComps;
...
bool AcceptableServiceInfo::operator==(const AcceptableServiceInfo& rhs) const
{
    ...
    ((!accBwMedCompsIsSet() && !rhs.accBwMedCompsIsSet()) || (accBwMedCompsIsSet() && rhs.accBwMedCompsIsSet() && getAccBwMedComps() == rhs.getAccBwMedComps())) &&
...
std::map<std::string, oai::_3gpp::model::MediaComponent> AcceptableServiceInfo::getAccBwMedComps() const
{
    return m_AccBwMedComps;
}
void AcceptableServiceInfo::setAccBwMedComps(std::map<std::string, oai::_3gpp::model::MediaComponent> const& value)
{
