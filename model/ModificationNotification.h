...
public:
    ...
    /// 
    /// </summary>
    std::vector<oai::model::NotifyItem> getNotifyItems() const;
    void setNotifyItems(std::vector<oai::model::NotifyItem> const& value);
...
protected:
    std::vector<oai::model::NotifyItem> m_NotifyItems;
