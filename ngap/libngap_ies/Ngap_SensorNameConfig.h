...
/* Implementation */
/* extern asn_TYPE_descriptor_t asn_DEF_Ngap_uncompensatedBarometricConfig_2;
 * // (Use -fall-defs-global to expose) */
/* extern asn_TYPE_descriptor_t asn_DEF_Ngap_ueSpeedConfig_5;	// (Use
 * -fall-defs-global to expose) */
/* extern asn_TYPE_descriptor_t asn_DEF_Ngap_ueOrientationConfig_8;	// (Use
 * -fall-defs-global to expose) */
