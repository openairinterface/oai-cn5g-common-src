...
bool N2SmInformation::operator==(const N2SmInformation& rhs) const
{
    ...
    ((!homePlmnSnssaiIsSet() && !rhs.homePlmnSnssaiIsSet()) || (homePlmnSnssaiIsSet() && rhs.homePlmnSnssaiIsSet() && getHomePlmnSnssai() == rhs.getHomePlmnSnssai())) &&
    
    
    ((!iwkSnssaiIsSet() && !rhs.iwkSnssaiIsSet()) || (iwkSnssaiIsSet() && rhs.iwkSnssaiIsSet() && getIwkSnssai() == rhs.getIwkSnssai())) &&
...
void to_json(nlohmann::json& j, const N2SmInformation& o)
{
    ...
    if(o.sNssaiIsSet())
        j["sNssai"] = o.m_SNssai;
    if(o.homePlmnSnssaiIsSet())
        j["homePlmnSnssai"] = o.m_HomePlmnSnssai;
    if(o.iwkSnssaiIsSet())
        j["iwkSnssai"] = o.m_IwkSnssai;
...
oai::_3gpp::model::N2InfoContent N2SmInformation::getN2InfoContent() const
{
    return m_N2InfoContent;
}
void N2SmInformation::setN2InfoContent(oai::_3gpp::model::N2InfoContent const& value)
{
...
oai::_3gpp::model::Snssai N2SmInformation::getSNssai() const
{
    return m_SNssai;
}
void N2SmInformation::setSNssai(oai::_3gpp::model::Snssai const& value)
{
    m_SNssai = value;
    m_SNssaiIsSet = true;
}
...
oai::_3gpp::model::Snssai N2SmInformation::getHomePlmnSnssai() const
{
    return m_HomePlmnSnssai;
}
void N2SmInformation::setHomePlmnSnssai(oai::_3gpp::model::Snssai const& value)
{
...
oai::_3gpp::model::Snssai N2SmInformation::getIwkSnssai() const
{
    return m_IwkSnssai;
}
void N2SmInformation::setIwkSnssai(oai::_3gpp::model::Snssai const& value)
{
    m_IwkSnssai = value;
