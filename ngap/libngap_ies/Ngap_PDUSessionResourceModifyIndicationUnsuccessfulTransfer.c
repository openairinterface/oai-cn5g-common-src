...
static asn_TYPE_member_t
    asn_MBR_Ngap_PDUSessionResourceModifyIndicationUnsuccessfulTransfer_1[] = {
        {ATF_POINTER,
         0,
         offsetof(
             struct Ngap_PDUSessionResourceModifyIndicationUnsuccessfulTransfer,
             cause),
        ...
        {ATF_POINTER,
         ...
         &asn_DEF_Ngap_ProtocolExtensionContainer_12929P231,
         0,
         {
#if !defined(ASN_DISABLE_OER_SUPPORT)
             0,
...
static const int
    asn_MAP_Ngap_PDUSessionResourceModifyIndicationUnsuccessfulTransfer_oms_1
        [] = {1};
...
static asn_SEQUENCE_specifics_t
    asn_SPC_Ngap_PDUSessionResourceModifyIndicationUnsuccessfulTransfer_specs_1 = {
        sizeof(
            struct Ngap_PDUSessionResourceModifyIndicationUnsuccessfulTransfer),
        offsetof(
            struct Ngap_PDUSessionResourceModifyIndicationUnsuccessfulTransfer,
