...
public:
    ...
    /// 
    /// </summary>
    oai::model::SmContextStatus getStatus() const;
    void setStatus(oai::model::SmContextStatus const& value);
    /// <summary>
    ...
    /// 
    /// </summary>
    oai::model::ReleaseCause getCause() const;
    void setCause(oai::model::ReleaseCause const& value);
    ...
    friend  void from_json(const nlohmann::json& j, SmContextStatusNotification& o);
protected:
    oai::model::SmContextStatus m_Status;

    std::string m_SmContextId;

    oai::model::ReleaseCause m_Cause;
    bool m_CauseIsSet;
