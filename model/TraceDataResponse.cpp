...
bool TraceDataResponse::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "TraceDataResponse" : pathPrefix;
...
oai::model::TraceData TraceDataResponse::getTraceData() const
{
    return m_TraceData;
}
void TraceDataResponse::setTraceData(oai::model::TraceData const& value)
{
    m_TraceData = value;
