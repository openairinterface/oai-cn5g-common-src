...
std::vector<oai::model::EventId> NwdafInfo::getEventIds() const
{
    return m_EventIds;
}
void NwdafInfo::setEventIds(std::vector<oai::model::EventId> const& value)
{
    m_EventIds = value;
...
std::vector<oai::model::NwdafEvent> NwdafInfo::getNwdafEvents() const
{
    return m_NwdafEvents;
}
void NwdafInfo::setNwdafEvents(std::vector<oai::model::NwdafEvent> const& value)
{
    m_NwdafEvents = value;
...
std::vector<oai::model::Tai> NwdafInfo::getTaiList() const
{
    return m_TaiList;
}
void NwdafInfo::setTaiList(std::vector<oai::model::Tai> const& value)
{
    m_TaiList = value;
    m_TaiListIsSet = true;
}
...
std::vector<oai::model::TaiRange> NwdafInfo::getTaiRangeList() const
{
    return m_TaiRangeList;
}
void NwdafInfo::setTaiRangeList(std::vector<oai::model::TaiRange> const& value)
{
...
oai::model::NwdafCapability NwdafInfo::getNwdafCapability() const
{
    return m_NwdafCapability;
}
void NwdafInfo::setNwdafCapability(oai::model::NwdafCapability const& value)
{
...
std::vector<oai::model::NFType> NwdafInfo::getServingNfTypeList() const
{
    return m_ServingNfTypeList;
}
void NwdafInfo::setServingNfTypeList(std::vector<oai::model::NFType> const& value)
{
...
std::vector<oai::model::MlAnalyticsInfo> NwdafInfo::getMlAnalyticsList() const
{
    return m_MlAnalyticsList;
}
void NwdafInfo::setMlAnalyticsList(std::vector<oai::model::MlAnalyticsInfo> const& value)
{
