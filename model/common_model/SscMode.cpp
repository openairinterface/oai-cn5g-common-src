...
bool SscMode::validate(std::stringstream &msg,
...
bool SscMode::operator!=(const SscMode &rhs) const { return !(*this == rhs); }
...
void from_json(const nlohmann::json &j, SscMode &o) { from_json(j, o.m_value); }

SscMode_anyOf SscMode::getValue() const { return m_value; }

void SscMode::setValue(SscMode_anyOf value) { m_value = value; }
