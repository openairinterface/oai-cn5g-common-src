...
*/
/*
 * CreateUEContext_201_response.h
 *
 * 
 */

#ifndef CreateUEContext_201_response_H_
#define CreateUEContext_201_response_H_
...
/// 
/// </summary>
class  CreateUEContext_201_response
{
public:
    CreateUEContext_201_response();
    virtual ~CreateUEContext_201_response() = default;
    ...
    bool operator==(const CreateUEContext_201_response& rhs) const;
    bool operator!=(const CreateUEContext_201_response& rhs) const;

    /////////////////////////////////////////////
    /// CreateUEContext_201_response members

    /// <summary>
    /// 
    /// </summary>
    oai::_3gpp::model::UeContextCreatedData getJsonData() const;
    void setJsonData(oai::_3gpp::model::UeContextCreatedData const& value);
    ...
    friend void to_json(nlohmann::json& j, const CreateUEContext_201_response& o);
    friend void from_json(const nlohmann::json& j, CreateUEContext_201_response& o);
protected:
    oai::_3gpp::model::UeContextCreatedData m_JsonData;
...
#endif /* CreateUEContext_201_response_H_ */
