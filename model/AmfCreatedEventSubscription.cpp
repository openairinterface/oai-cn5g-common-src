...
oai::_3gpp::model::AmfEventSubscription AmfCreatedEventSubscription::getSubscription() const
{
    return m_Subscription;
}
void AmfCreatedEventSubscription::setSubscription(oai::_3gpp::model::AmfEventSubscription const& value)
{
...
std::vector<oai::_3gpp::model::AmfEventReport> AmfCreatedEventSubscription::getReportList() const
{
    return m_ReportList;
}
void AmfCreatedEventSubscription::setReportList(std::vector<oai::_3gpp::model::AmfEventReport> const& value)
{
    m_ReportList = value;
