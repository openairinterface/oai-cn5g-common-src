...
std::vector<oai::_3gpp::model::Trigger> MultipleQFIcontainer::getTriggers() const
{
    return m_Triggers;
}
void MultipleQFIcontainer::setTriggers(std::vector<oai::_3gpp::model::Trigger> const& value)
{
    m_Triggers = value;
...
oai::_3gpp::model::QFIContainerInformation MultipleQFIcontainer::getQFIContainerInformation() const
{
    return m_QFIContainerInformation;
}
void MultipleQFIcontainer::setQFIContainerInformation(oai::_3gpp::model::QFIContainerInformation const& value)
{
