...
public:
    ...
    void setRecurringTime(oai::_3gpp::model::ScheduledCommunicationTime_1 const& value);
    ...
    void setSessInactTimer(oai::_3gpp::model::SessInactTimerForUeComm const& value);
