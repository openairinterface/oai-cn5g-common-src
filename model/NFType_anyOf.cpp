...
bool NFType_anyOf::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "NFType_anyOf" : pathPrefix;
...
void to_json(nlohmann::json& j, const NFType_anyOf& o)
{
    ...
    switch (o.getValue())
    {
        ...
        case NFType_anyOf::eNFType_anyOf::IMS_AS:
            j = "IMS_AS";
            break;
        case NFType_anyOf::eNFType_anyOf::AANF:
            j = "AANF";
            break;
        case NFType_anyOf::eNFType_anyOf::_5G_DDNMF:
            j = "5G_DDNMF";
            break;
        case NFType_anyOf::eNFType_anyOf::NSACF:
            j = "NSACF";
            break;
        case NFType_anyOf::eNFType_anyOf::MFAF:
            j = "MFAF";
            break;
        case NFType_anyOf::eNFType_anyOf::EASDF:
            j = "EASDF";
            break;
        case NFType_anyOf::eNFType_anyOf::DCCF:
            j = "DCCF";
            break;
        case NFType_anyOf::eNFType_anyOf::MB_SMF:
            j = "MB_SMF";
            break;
        case NFType_anyOf::eNFType_anyOf::TSCTSF:
            j = "TSCTSF";
            break;
        case NFType_anyOf::eNFType_anyOf::ADRF:
            j = "ADRF";
            break;
        case NFType_anyOf::eNFType_anyOf::GBA_BSF:
            j = "GBA_BSF";
            break;
        case NFType_anyOf::eNFType_anyOf::CEF:
            j = "CEF";
            break;
        case NFType_anyOf::eNFType_anyOf::MB_UPF:
            j = "MB_UPF";
            break;
        case NFType_anyOf::eNFType_anyOf::NSWOF:
            j = "NSWOF";
            break;
        case NFType_anyOf::eNFType_anyOf::PKMF:
            j = "PKMF";
            break;
        case NFType_anyOf::eNFType_anyOf::MNPF:
            j = "MNPF";
            break;
        case NFType_anyOf::eNFType_anyOf::SMS_GMSC:
            j = "SMS_GMSC";
            break;
        case NFType_anyOf::eNFType_anyOf::SMS_IWMSC:
            j = "SMS_IWMSC";
            break;
        case NFType_anyOf::eNFType_anyOf::MBSF:
            j = "MBSF";
            break;
        case NFType_anyOf::eNFType_anyOf::MBSTF:
            j = "MBSTF";
            break;
        case NFType_anyOf::eNFType_anyOf::PANF:
            j = "PANF";
            break;
        case NFType_anyOf::eNFType_anyOf::IP_SM_GW:
            j = "IP_SM_GW";
            break;
        case NFType_anyOf::eNFType_anyOf::SMS_ROUTER:
            j = "SMS_ROUTER";
            break;
    }
}
...
void from_json(const nlohmann::json& j, NFType_anyOf& o)
{
    ...
    if (s == "NRF") {
     ...
     o.setValue(NFType_anyOf::eNFType_anyOf::AANF);
    } 
    else if (s == "5G_DDNMF") {
     o.setValue(NFType_anyOf::eNFType_anyOf::_5G_DDNMF);
    } 
    else if (s == "NSACF") {
     o.setValue(NFType_anyOf::eNFType_anyOf::NSACF);
    } 
    else if (s == "MFAF") {
     o.setValue(NFType_anyOf::eNFType_anyOf::MFAF);
    } 
    else if (s == "EASDF") {
     o.setValue(NFType_anyOf::eNFType_anyOf::EASDF);
    } 
    else if (s == "DCCF") {
     o.setValue(NFType_anyOf::eNFType_anyOf::DCCF);
    } 
    else if (s == "MB_SMF") {
     o.setValue(NFType_anyOf::eNFType_anyOf::MB_SMF);
    } 
    else if (s == "TSCTSF") {
     o.setValue(NFType_anyOf::eNFType_anyOf::TSCTSF);
    } 
    else if (s == "ADRF") {
     o.setValue(NFType_anyOf::eNFType_anyOf::ADRF);
    } 
    else if (s == "GBA_BSF") {
     o.setValue(NFType_anyOf::eNFType_anyOf::GBA_BSF);
    } 
    else if (s == "CEF") {
     o.setValue(NFType_anyOf::eNFType_anyOf::CEF);
    } 
    else if (s == "MB_UPF") {
     o.setValue(NFType_anyOf::eNFType_anyOf::MB_UPF);
    } 
    else if (s == "NSWOF") {
     o.setValue(NFType_anyOf::eNFType_anyOf::NSWOF);
    } 
    else if (s == "PKMF") {
     o.setValue(NFType_anyOf::eNFType_anyOf::PKMF);
    } 
    else if (s == "MNPF") {
     o.setValue(NFType_anyOf::eNFType_anyOf::MNPF);
    } 
    else if (s == "SMS_GMSC") {
     o.setValue(NFType_anyOf::eNFType_anyOf::SMS_GMSC);
    } 
    else if (s == "SMS_IWMSC") {
     o.setValue(NFType_anyOf::eNFType_anyOf::SMS_IWMSC);
    } 
    else if (s == "MBSF") {
     o.setValue(NFType_anyOf::eNFType_anyOf::MBSF);
    } 
    else if (s == "MBSTF") {
     o.setValue(NFType_anyOf::eNFType_anyOf::MBSTF);
    } 
    else if (s == "PANF") {
     o.setValue(NFType_anyOf::eNFType_anyOf::PANF);
    } 
    else if (s == "IP_SM_GW") {
     o.setValue(NFType_anyOf::eNFType_anyOf::IP_SM_GW);
    } 
    else if (s == "SMS_ROUTER") {
     o.setValue(NFType_anyOf::eNFType_anyOf::SMS_ROUTER);
    }  else {
     std::stringstream ss;
