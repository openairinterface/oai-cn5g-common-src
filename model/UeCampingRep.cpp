...
bool UeCampingRep::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "UeCampingRep" : pathPrefix;
...
oai::_3gpp::model::AccessType UeCampingRep::getAccessType() const
{
    return m_AccessType;
}
void UeCampingRep::setAccessType(oai::_3gpp::model::AccessType const& value)
{
    m_AccessType = value;
...
oai::_3gpp::model::RatType UeCampingRep::getRatType() const
{
    return m_RatType;
}
void UeCampingRep::setRatType(oai::_3gpp::model::RatType const& value)
{
    m_RatType = value;
    m_RatTypeIsSet = true;
}
...
oai::_3gpp::model::ServingNfIdentity UeCampingRep::getServNfId() const
{
    return m_ServNfId;
}
void UeCampingRep::setServNfId(oai::_3gpp::model::ServingNfIdentity const& value)
{
    m_ServNfId = value;
...
oai::_3gpp::model::PlmnIdNid UeCampingRep::getServingNetwork() const
{
    return m_ServingNetwork;
}
void UeCampingRep::setServingNetwork(oai::_3gpp::model::PlmnIdNid const& value)
{
...
oai::_3gpp::model::UserLocation UeCampingRep::getUserLocationInfo() const
{
    return m_UserLocationInfo;
}
void UeCampingRep::setUserLocationInfo(oai::_3gpp::model::UserLocation const& value)
{
...
oai::_3gpp::model::NetLocAccessSupport UeCampingRep::getNetLocAccSupp() const
{
    return m_NetLocAccSupp;
}
void UeCampingRep::setNetLocAccSupp(oai::_3gpp::model::NetLocAccessSupport const& value)
{
...
oai::_3gpp::model::SatelliteBackhaulCategory UeCampingRep::getSatBackhaulCategory() const
{
    return m_SatBackhaulCategory;
}
void UeCampingRep::setSatBackhaulCategory(oai::_3gpp::model::SatelliteBackhaulCategory const& value)
{
    m_SatBackhaulCategory = value;
    m_SatBackhaulCategoryIsSet = true;
}
bool UeCampingRep::satBackhaulCategoryIsSet() const
{
    return m_SatBackhaulCategoryIsSet;
}
void UeCampingRep::unsetSatBackhaulCategory()
{
    m_SatBackhaulCategoryIsSet = false;
}
