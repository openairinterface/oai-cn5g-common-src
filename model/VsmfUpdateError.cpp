...
bool VsmfUpdateError::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "VsmfUpdateError" : pathPrefix;
...
oai::model::ExtProblemDetails VsmfUpdateError::getError() const
{
    return m_Error;
}
void VsmfUpdateError::setError(oai::model::ExtProblemDetails const& value)
{
    m_Error = value;
}
...
oai::model::RefToBinaryData VsmfUpdateError::getN1SmInfoFromUe() const
{
    return m_N1SmInfoFromUe;
}
void VsmfUpdateError::setN1SmInfoFromUe(oai::model::RefToBinaryData const& value)
{
...
oai::model::RefToBinaryData VsmfUpdateError::getUnknownN1SmInfo() const
{
    return m_UnknownN1SmInfo;
}
void VsmfUpdateError::setUnknownN1SmInfo(oai::model::RefToBinaryData const& value)
{
...
std::vector<oai::model::Arp> VsmfUpdateError::getFailedToAssignEbiList() const
{
    return m_FailedToAssignEbiList;
}
void VsmfUpdateError::setFailedToAssignEbiList(std::vector<oai::model::Arp> const& value)
{
...
oai::model::NgApCause VsmfUpdateError::getNgApCause() const
{
    return m_NgApCause;
}
void VsmfUpdateError::setNgApCause(oai::model::NgApCause const& value)
{
    m_NgApCause = value;
...
oai::model::N4Information VsmfUpdateError::getN4Info() const
{
    return m_N4Info;
}
void VsmfUpdateError::setN4Info(oai::model::N4Information const& value)
{
    m_N4Info = value;
    m_N4InfoIsSet = true;
}
...
oai::model::N4Information VsmfUpdateError::getN4InfoExt1() const
{
    return m_N4InfoExt1;
}
void VsmfUpdateError::setN4InfoExt1(oai::model::N4Information const& value)
{
    m_N4InfoExt1 = value;
...
oai::model::N4Information VsmfUpdateError::getN4InfoExt2() const
{
    return m_N4InfoExt2;
}
void VsmfUpdateError::setN4InfoExt2(oai::model::N4Information const& value)
{
    m_N4InfoExt2 = value;
...
oai::model::N4Information VsmfUpdateError::getN4InfoExt3() const
{
    return m_N4InfoExt3;
}
void VsmfUpdateError::setN4InfoExt3(oai::model::N4Information const& value)
{
    m_N4InfoExt3 = value;
