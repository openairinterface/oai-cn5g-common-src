...
bool TaiRange::validate(std::stringstream &msg,
...
bool TaiRange::operator!=(const TaiRange &rhs) const { return !(*this == rhs); }
...
oai::model::common::PlmnId TaiRange::getPlmnId() const { return m_PlmnId; }
