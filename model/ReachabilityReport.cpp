...
std::vector<oai::_3gpp::model::AccessType> ReachabilityReport::getAccessTypeList() const
{
    return m_AccessTypeList;
}
void ReachabilityReport::setAccessTypeList(std::vector<oai::_3gpp::model::AccessType> const& value)
{
...
void ReachabilityReport::setReachability(oai::_3gpp::model::UeReachability const& value)
{
...
oai::_3gpp::model::IdleStatusIndication ReachabilityReport::getIdleStatusIndication() const
{
    return m_IdleStatusIndication;
}
void ReachabilityReport::setIdleStatusIndication(oai::_3gpp::model::IdleStatusIndication const& value)
{
