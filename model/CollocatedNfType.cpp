...
bool CollocatedNfType::validate(
    std::stringstream& msg, const std::string& pathPrefix) const {
  bool success = true;
  const std::string _pathPrefix =
      pathPrefix.empty() ? "CollocatedNfType" : pathPrefix;
...
CollocatedNfType_anyOf::eCollocatedNfType_anyOf CollocatedNfType::getEnumValue()
    const {
  return m_value.getValue();
}

void CollocatedNfType::setEnumValue(
