...
bool LocationArea::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "LocationArea" : pathPrefix;
...
std::vector<oai::model::GeographicArea> LocationArea::getGeographicAreas() const
{
    return m_GeographicAreas;
}
void LocationArea::setGeographicAreas(std::vector<oai::model::GeographicArea> const& value)
{
...
std::vector<oai::model::CivicAddress> LocationArea::getCivicAddresses() const
{
    return m_CivicAddresses;
}
void LocationArea::setCivicAddresses(std::vector<oai::model::CivicAddress> const& value)
{
...
oai::model::NetworkAreaInfo_1 LocationArea::getNwAreaInfo() const
{
    return m_NwAreaInfo;
}
void LocationArea::setNwAreaInfo(oai::model::NetworkAreaInfo_1 const& value)
{
    m_NwAreaInfo = value;
...
oai::model::UmtTime LocationArea::getUmtTime() const
{
    return m_UmtTime;
}
void LocationArea::setUmtTime(oai::model::UmtTime const& value)
{
    m_UmtTime = value;
    m_UmtTimeIsSet = true;
}
