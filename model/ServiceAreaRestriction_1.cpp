...
bool ServiceAreaRestriction_1::validate(
    std::stringstream& msg, const std::string& pathPrefix) const {
  bool success = true;
  const std::string _pathPrefix =
      pathPrefix.empty() ? "ServiceAreaRestriction_1" : pathPrefix;
...
bool ServiceAreaRestriction_1::operator==(
    const ServiceAreaRestriction_1& rhs) const {
  return
...
oai::_3gpp::model::RestrictionType
ServiceAreaRestriction_1::getRestrictionType() const {
  return m_RestrictionType;
}
void ServiceAreaRestriction_1::setRestrictionType(
    oai::_3gpp::model::RestrictionType const& value) {
...
std::vector<oai::_3gpp::model::Area_1> ServiceAreaRestriction_1::getAreas()
    const {
  return m_Areas;
}
void ServiceAreaRestriction_1::setAreas(
...
void ServiceAreaRestriction_1::setMaxNumOfTAsForNotAllowedAreas(
    int32_t const value) {
