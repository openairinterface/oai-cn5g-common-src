...
int asn_generic_no_constraint(const asn_TYPE_descriptor_t *type_descriptor,
...
int asn_generic_unknown_constraint(const asn_TYPE_descriptor_t *type_descriptor,
                                   const void *struct_ptr,
                                   asn_app_constraint_failed_f *cb, void *key) {
  (void)type_descriptor; /* Unused argument */
  (void)struct_ptr;      /* Unused argument */
...
static void CC_PRINTFLIKE(4, 5)
    _asn_i_ctfailcb(void *key, const asn_TYPE_descriptor_t *td,
...
int asn_check_constraints(const asn_TYPE_descriptor_t *type_descriptor,
