...
oai::_3gpp::model::N1MessageContainer N1MessageNotification::getN1MessageContainer() const
{
    return m_N1MessageContainer;
}
void N1MessageNotification::setN1MessageContainer(oai::_3gpp::model::N1MessageContainer const& value)
{
...
oai::_3gpp::model::RegistrationContextContainer N1MessageNotification::getRegistrationCtxtContainer() const
{
    return m_RegistrationCtxtContainer;
}
void N1MessageNotification::setRegistrationCtxtContainer(oai::_3gpp::model::RegistrationContextContainer const& value)
{
