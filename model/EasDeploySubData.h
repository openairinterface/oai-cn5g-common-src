...
public:
    ...
    /// </summary>
    std::vector<oai::model::EasDeployInfoData> getEventsNotifs() const;
    void setEventsNotifs(std::vector<oai::model::EasDeployInfoData> const& value);
...
protected:
    ...
    std::vector<oai::model::EasDeployInfoData> m_EventsNotifs;
