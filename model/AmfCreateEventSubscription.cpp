...
bool AmfCreateEventSubscription::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "AmfCreateEventSubscription" : pathPrefix;
...
bool AmfCreateEventSubscription::operator==(const AmfCreateEventSubscription& rhs) const
{
    return
...
oai::model::AmfEventSubscription AmfCreateEventSubscription::getSubscription() const
{
    return m_Subscription;
}
void AmfCreateEventSubscription::setSubscription(oai::model::AmfEventSubscription const& value)
{
...
oai::model::Guami AmfCreateEventSubscription::getOldGuami() const
{
    return m_OldGuami;
}
void AmfCreateEventSubscription::setOldGuami(oai::model::Guami const& value)
{
    m_OldGuami = value;
