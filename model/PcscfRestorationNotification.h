...
public:
    ...
    virtual ~PcscfRestorationNotification() = default;
    ...
    bool operator==(const PcscfRestorationNotification& rhs) const;
    bool operator!=(const PcscfRestorationNotification& rhs) const;
    ...
    /// 
    /// </summary>
    oai::_3gpp::model::PcscfAddress getFailedPcscf() const;
    void setFailedPcscf(oai::_3gpp::model::PcscfAddress const& value);
    bool failedPcscfIsSet() const;
    void unsetFailedPcscf();
...
protected:
    ...
    oai::_3gpp::model::PcscfAddress m_FailedPcscf;
    bool m_FailedPcscfIsSet;
