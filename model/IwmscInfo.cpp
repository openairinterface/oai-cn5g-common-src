...
std::vector<oai::_3gpp::model::IdentityRange> IwmscInfo::getMsisdnRanges() const
{
    return m_MsisdnRanges;
}
void IwmscInfo::setMsisdnRanges(std::vector<oai::_3gpp::model::IdentityRange> const& value)
{
...
void IwmscInfo::setSupiRanges(std::vector<oai::_3gpp::model::SupiRange> const& value)
{
    m_SupiRanges = value;
...
void IwmscInfo::setTaiRangeList(std::vector<oai::_3gpp::model::TaiRange> const& value)
{
