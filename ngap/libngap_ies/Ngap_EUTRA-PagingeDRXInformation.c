...
asn_TYPE_member_t asn_MBR_Ngap_EUTRA_PagingeDRXInformation_1[] = {
    {ATF_NOFLAGS,
     0,
     offsetof(struct Ngap_EUTRA_PagingeDRXInformation, eUTRA_paging_eDRX_Cycle),
    ...
    {ATF_POINTER,
     2,
     offsetof(
         struct Ngap_EUTRA_PagingeDRXInformation, eUTRA_paging_Time_Window),
    ...
    {ATF_POINTER,
     1,
     offsetof(struct Ngap_EUTRA_PagingeDRXInformation, iE_Extensions),
     (ASN_TAG_CLASS_CONTEXT | (2 << 2)),
     -1, /* IMPLICIT tag at current level */
     &asn_DEF_Ngap_ProtocolExtensionContainer_12929P78,
     0,
     {
#if !defined(ASN_DISABLE_OER_SUPPORT)
         0,
...
static const asn_TYPE_tag2member_t
    asn_MAP_Ngap_EUTRA_PagingeDRXInformation_tag2el_1[] = {
        {(ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0,
         0}, /* eUTRA-paging-eDRX-Cycle */
        {(ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0,
         0}, /* eUTRA-paging-Time-Window */
