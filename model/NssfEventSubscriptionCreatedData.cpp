...
bool NssfEventSubscriptionCreatedData::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    ...
    {
        const std::vector<oai::model::AuthorizedNssaiAvailabilityData>& value = m_AuthorizedNssaiAvailabilityData;
        ...
        { // Recursive validation of array elements
            ...
            int i = 0;
            for (const oai::model::AuthorizedNssaiAvailabilityData& value : value)
            { 
...
std::vector<oai::model::AuthorizedNssaiAvailabilityData> NssfEventSubscriptionCreatedData::getAuthorizedNssaiAvailabilityData() const
{
    return m_AuthorizedNssaiAvailabilityData;
}
void NssfEventSubscriptionCreatedData::setAuthorizedNssaiAvailabilityData(std::vector<oai::model::AuthorizedNssaiAvailabilityData> const& value)
{
