...
bool MbUpfInfo::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    ...
    /* SNssaiMbUpfInfoList */ {
        const std::vector<oai::_3gpp::model::SnssaiUpfInfoItem>& value = m_SNssaiMbUpfInfoList;
    ...
    {
        const std::vector<oai::_3gpp::model::InterfaceUpfInfoItem>& value = m_InterfaceMbUpfInfoList;
...
std::vector<oai::_3gpp::model::SnssaiUpfInfoItem> MbUpfInfo::getSNssaiMbUpfInfoList() const
{
    return m_SNssaiMbUpfInfoList;
}
void MbUpfInfo::setSNssaiMbUpfInfoList(std::vector<oai::_3gpp::model::SnssaiUpfInfoItem> const& value)
{
...
std::vector<oai::_3gpp::model::InterfaceUpfInfoItem> MbUpfInfo::getInterfaceMbUpfInfoList() const
{
    return m_InterfaceMbUpfInfoList;
}
void MbUpfInfo::setInterfaceMbUpfInfoList(std::vector<oai::_3gpp::model::InterfaceUpfInfoItem> const& value)
{
...
std::vector<oai::_3gpp::model::Tai> MbUpfInfo::getTaiList() const
{
    return m_TaiList;
}
void MbUpfInfo::setTaiList(std::vector<oai::_3gpp::model::Tai> const& value)
{
    m_TaiList = value;
    m_TaiListIsSet = true;
}
...
std::vector<oai::_3gpp::model::TaiRange> MbUpfInfo::getTaiRangeList() const
{
    return m_TaiRangeList;
}
void MbUpfInfo::setTaiRangeList(std::vector<oai::_3gpp::model::TaiRange> const& value)
{
