...
asn_TYPE_member_t asn_MBR_Ngap_CompletedCellsInTAI_EUTRA_Item_1[] = {
    {ATF_POINTER,
     0,
     offsetof(struct Ngap_CompletedCellsInTAI_EUTRA_Item, eUTRA_CGI),
    ...
    {ATF_POINTER,
     1,
     offsetof(struct Ngap_CompletedCellsInTAI_EUTRA_Item, iE_Extensions),
     (ASN_TAG_CLASS_CONTEXT | (1 << 2)),
     -1, /* IMPLICIT tag at current level */
     &asn_DEF_Ngap_ProtocolExtensionContainer_12929P43,
     0,
     {
#if !defined(ASN_DISABLE_OER_SUPPORT)
         0,
