...
asn_TYPE_member_t asn_MBR_Ngap_UserLocationInformationTNGF_1[] = {
    {ATF_NOFLAGS,
     0,
     offsetof(struct Ngap_UserLocationInformationTNGF, tNAP_ID),
    ...
    {ATF_NOFLAGS,
     0,
     offsetof(struct Ngap_UserLocationInformationTNGF, iPAddress),
    ...
    {ATF_POINTER,
     2,
     offsetof(struct Ngap_UserLocationInformationTNGF, portNumber),
    ...
    {ATF_POINTER,
     1,
     offsetof(struct Ngap_UserLocationInformationTNGF, iE_Extensions),
     (ASN_TAG_CLASS_CONTEXT | (3 << 2)),
     -1, /* IMPLICIT tag at current level */
     &asn_DEF_Ngap_ProtocolExtensionContainer_12929P366,
     0,
     {
#if !defined(ASN_DISABLE_OER_SUPPORT)
         0,
