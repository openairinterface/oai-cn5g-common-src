...
public:
    ...
    /// </summary>
    std::map<std::string, oai::model::TacInfo> getTacInfoPerPlmn() const;
    void setTacInfoPerPlmn(std::map<std::string, oai::model::TacInfo> const& value);
...
protected:
    ...
    bool m_TacListIsSet;
    std::map<std::string, oai::model::TacInfo> m_TacInfoPerPlmn;
