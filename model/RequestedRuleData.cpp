...
bool RequestedRuleData::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "RequestedRuleData" : pathPrefix;
    ...
    /* ReqData */ {
        const std::vector<oai::_3gpp::model::RequestedRuleDataType>& value = m_ReqData;
        ...
        { // Recursive validation of array elements
            const std::string oldValuePath = currentValuePath;
            int i = 0;
            for (const oai::_3gpp::model::RequestedRuleDataType& value : value)
            { 
                const std::string currentValuePath = oldValuePath + "[" + std::to_string(i) + "]";
...
void RequestedRuleData::setRefPccRuleIds(std::vector<std::string> const& value)
{
    m_RefPccRuleIds = value;
}
std::vector<oai::_3gpp::model::RequestedRuleDataType> RequestedRuleData::getReqData() const
{
    return m_ReqData;
}
void RequestedRuleData::setReqData(std::vector<oai::_3gpp::model::RequestedRuleDataType> const& value)
{
    m_ReqData = value;
}
