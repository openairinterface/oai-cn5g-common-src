...
asn_TYPE_member_t asn_MBR_Ngap_AMF_TNLAssociationToUpdateItem_1[] = {
    ...
    {ATF_POINTER,
     3,
     offsetof(struct Ngap_AMF_TNLAssociationToUpdateItem, tNLAssociationUsage),
    ...
    {ATF_POINTER,
     1,
     offsetof(struct Ngap_AMF_TNLAssociationToUpdateItem, iE_Extensions),
     (ASN_TAG_CLASS_CONTEXT | (3 << 2)),
     -1, /* IMPLICIT tag at current level */
     &asn_DEF_Ngap_ProtocolExtensionContainer_12929P8,
     0,
     {
#if !defined(ASN_DISABLE_OER_SUPPORT)
         0,
