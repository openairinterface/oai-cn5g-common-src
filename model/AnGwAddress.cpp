...
bool AnGwAddress::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "AnGwAddress" : pathPrefix;
...
bool AnGwAddress::operator==(const AnGwAddress& rhs) const
{
    ...
    ((!anGwIpv4AddrIsSet() && !rhs.anGwIpv4AddrIsSet()) || (anGwIpv4AddrIsSet() && rhs.anGwIpv4AddrIsSet() && getAnGwIpv4Addr() == rhs.getAnGwIpv4Addr())) &&
    
    
    ((!anGwIpv6AddrIsSet() && !rhs.anGwIpv6AddrIsSet()) || (anGwIpv6AddrIsSet() && rhs.anGwIpv6AddrIsSet() && getAnGwIpv6Addr() == rhs.getAnGwIpv6Addr()))
...
oai::_3gpp::model::Ipv6Addr AnGwAddress::getAnGwIpv6Addr() const
{
    return m_AnGwIpv6Addr;
}
void AnGwAddress::setAnGwIpv6Addr(oai::_3gpp::model::Ipv6Addr const& value)
{
