...
asn_TYPE_member_t asn_MBR_Ngap_QosFlowAddOrModifyRequestItem_1[] = {
    {ATF_NOFLAGS,
     0,
     offsetof(struct Ngap_QosFlowAddOrModifyRequestItem, qosFlowIdentifier),
    ...
    {ATF_POINTER,
     2,
     offsetof(struct Ngap_QosFlowAddOrModifyRequestItem, e_RAB_ID),
    ...
    {ATF_POINTER,
     ...
     -1, /* IMPLICIT tag at current level */
     &asn_DEF_Ngap_ProtocolExtensionContainer_12929P271,
     0,
     {
#if !defined(ASN_DISABLE_OER_SUPPORT)
         0,
