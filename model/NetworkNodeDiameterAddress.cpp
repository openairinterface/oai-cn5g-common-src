...
bool NetworkNodeDiameterAddress::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "NetworkNodeDiameterAddress" : pathPrefix;
...
bool NetworkNodeDiameterAddress::operator==(const NetworkNodeDiameterAddress& rhs) const
{
    return
