...
public:
    ...
    /// </summary>
    std::map<std::string, oai::_3gpp::model::DnnConfiguration_1> getDnnConfigurations() const;
    void setDnnConfigurations(std::map<std::string, oai::_3gpp::model::DnnConfiguration_1> const& value);
    ...
    /// </summary>
    std::map<std::string, oai::_3gpp::model::ExpectedUeBehaviourData_1> getExpectedUeBehavioursList() const;
    void setExpectedUeBehavioursList(std::map<std::string, oai::_3gpp::model::ExpectedUeBehaviourData_1> const& value);
    ...
    /// </summary>
    std::map<std::string, oai::_3gpp::model::SuggestedPacketNumDl_1> getSuggestedPacketNumDlList() const;
    void setSuggestedPacketNumDlList(std::map<std::string, oai::_3gpp::model::SuggestedPacketNumDl_1> const& value);
...
protected:
    ...
    std::map<std::string, oai::_3gpp::model::DnnConfiguration_1> m_DnnConfigurations;
    ...
    std::map<std::string, oai::_3gpp::model::ExpectedUeBehaviourData_1> m_ExpectedUeBehavioursList;
    bool m_ExpectedUeBehavioursListIsSet;
    std::map<std::string, oai::_3gpp::model::SuggestedPacketNumDl_1> m_SuggestedPacketNumDlList;
