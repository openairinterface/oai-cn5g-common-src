...
public:
    ...
    /// 
    /// </summary>
    std::vector<oai::_3gpp::model::MultipleQFIcontainer> getMultipleQFIcontainer() const;
    void setMultipleQFIcontainer(std::vector<oai::_3gpp::model::MultipleQFIcontainer> const& value);
