...
public:
    ...
    N1N2MessageTransferCause_anyOf::eN1N2MessageTransferCause_anyOf getEnumValue() const;
    void setEnumValue(N1N2MessageTransferCause_anyOf::eN1N2MessageTransferCause_anyOf value);
