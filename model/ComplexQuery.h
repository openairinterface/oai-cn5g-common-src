...
public:
    ...
    /// 
    /// </summary>
    std::vector<oai::model::CnfUnit> getCnfUnits() const;
    void setCnfUnits(std::vector<oai::model::CnfUnit> const& value);
    /// <summary>
    /// 
    /// </summary>
    std::vector<oai::model::DnfUnit> getDnfUnits() const;
    void setDnfUnits(std::vector<oai::model::DnfUnit> const& value);

    friend  void to_json(nlohmann::json& j, const ComplexQuery& o);
    friend  void from_json(const nlohmann::json& j, ComplexQuery& o);
protected:
    std::vector<oai::model::CnfUnit> m_CnfUnits;

    std::vector<oai::model::DnfUnit> m_DnfUnits;
