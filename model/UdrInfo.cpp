...
void UdrInfo::setSupiRanges(std::vector<oai::_3gpp::model::SupiRange> const& value)
{
    m_SupiRanges = value;
...
void UdrInfo::setGpsiRanges(std::vector<oai::_3gpp::model::IdentityRange> const& value)
{
    m_GpsiRanges = value;
...
std::vector<oai::_3gpp::model::IdentityRange> UdrInfo::getExternalGroupIdentifiersRanges() const
{
    return m_ExternalGroupIdentifiersRanges;
}
void UdrInfo::setExternalGroupIdentifiersRanges(std::vector<oai::_3gpp::model::IdentityRange> const& value)
{
...
std::vector<oai::_3gpp::model::DataSetId> UdrInfo::getSupportedDataSets() const
{
    return m_SupportedDataSets;
}
void UdrInfo::setSupportedDataSets(std::vector<oai::_3gpp::model::DataSetId> const& value)
{
...
std::vector<oai::_3gpp::model::SharedDataIdRange> UdrInfo::getSharedDataIdRanges() const
{
    return m_SharedDataIdRanges;
}
void UdrInfo::setSharedDataIdRanges(std::vector<oai::_3gpp::model::SharedDataIdRange> const& value)
{
