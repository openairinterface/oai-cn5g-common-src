...
oai::_3gpp::model::NotificationMethod ReportingInformation::getNotifMethod() const
{
    return m_NotifMethod;
}
void ReportingInformation::setNotifMethod(oai::_3gpp::model::NotificationMethod const& value)
{
    m_NotifMethod = value;
...
std::vector<oai::_3gpp::model::PartitioningCriteria> ReportingInformation::getPartitionCriteria() const
{
    return m_PartitionCriteria;
}
void ReportingInformation::setPartitionCriteria(std::vector<oai::_3gpp::model::PartitioningCriteria> const& value)
{
...
void ReportingInformation::setNotifFlag(oai::_3gpp::model::NotificationFlag const& value)
{
    m_NotifFlag = value;
