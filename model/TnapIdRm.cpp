...
bool TnapIdRm::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
...
bool TnapIdRm::operator==(const TnapIdRm& rhs) const
{
    ...
    ((!ssIdIsSet() && !rhs.ssIdIsSet()) || (ssIdIsSet() && rhs.ssIdIsSet() && getSsId() == rhs.getSsId())) &&
    
    
    ((!bssIdIsSet() && !rhs.bssIdIsSet()) || (bssIdIsSet() && rhs.bssIdIsSet() && getBssId() == rhs.getBssId())) &&
