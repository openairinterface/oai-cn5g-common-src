...
bool LocationQoS::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "LocationQoS" : pathPrefix;
    ...
    if (minorLocQosesIsSet())
    {
        const std::vector<oai::_3gpp::model::MinorLocationQoS>& value = m_MinorLocQoses;
        const std::string currentValuePath = _pathPrefix + ".minorLocQoses";
        ...
        { // Recursive validation of array elements
            ...
            int i = 0;
            for (const oai::_3gpp::model::MinorLocationQoS& value : value)
            { 
                const std::string currentValuePath = oldValuePath + "[" + std::to_string(i) + "]";
                        
        success = value.validate(msg, currentValuePath + ".minorLocQoses") && success;
...
bool LocationQoS::operator==(const LocationQoS& rhs) const
{
    ...
    ((!hAccuracyIsSet() && !rhs.hAccuracyIsSet()) || (hAccuracyIsSet() && rhs.hAccuracyIsSet() && getHAccuracy() == rhs.getHAccuracy())) &&
    
    
    ((!vAccuracyIsSet() && !rhs.vAccuracyIsSet()) || (vAccuracyIsSet() && rhs.vAccuracyIsSet() && getVAccuracy() == rhs.getVAccuracy())) &&
    
    
    ((!verticalRequestedIsSet() && !rhs.verticalRequestedIsSet()) || (verticalRequestedIsSet() && rhs.verticalRequestedIsSet() && isVerticalRequested() == rhs.isVerticalRequested())) &&
    
    
    ((!responseTimeIsSet() && !rhs.responseTimeIsSet()) || (responseTimeIsSet() && rhs.responseTimeIsSet() && getResponseTime() == rhs.getResponseTime())) &&
    
    
    ((!minorLocQosesIsSet() && !rhs.minorLocQosesIsSet()) || (minorLocQosesIsSet() && rhs.minorLocQosesIsSet() && getMinorLocQoses() == rhs.getMinorLocQoses())) &&
    
    
    ((!lcsQosClassIsSet() && !rhs.lcsQosClassIsSet()) || (lcsQosClassIsSet() && rhs.lcsQosClassIsSet() && getLcsQosClass() == rhs.getLcsQosClass()))
...
void to_json(nlohmann::json& j, const LocationQoS& o)
{
    ...
    if(o.minorLocQosesIsSet() || !o.m_MinorLocQoses.empty())
        j["minorLocQoses"] = o.m_MinorLocQoses;
...
void from_json(const nlohmann::json& j, LocationQoS& o)
{
    ...
    if(j.find("minorLocQoses") != j.end())
    {
        j.at("minorLocQoses").get_to(o.m_MinorLocQoses);
        o.m_MinorLocQosesIsSet = true;
    } 
...
oai::_3gpp::model::ResponseTime LocationQoS::getResponseTime() const
{
    return m_ResponseTime;
}
void LocationQoS::setResponseTime(oai::_3gpp::model::ResponseTime const& value)
{
...
std::vector<oai::_3gpp::model::MinorLocationQoS> LocationQoS::getMinorLocQoses() const
{
    return m_MinorLocQoses;
}
void LocationQoS::setMinorLocQoses(std::vector<oai::_3gpp::model::MinorLocationQoS> const& value)
{
    m_MinorLocQoses = value;
    m_MinorLocQosesIsSet = true;
}
bool LocationQoS::minorLocQosesIsSet() const
{
    return m_MinorLocQosesIsSet;
}
void LocationQoS::unsetMinorLocQoses()
{
    m_MinorLocQosesIsSet = false;
}
oai::_3gpp::model::LcsQosClass LocationQoS::getLcsQosClass() const
{
    return m_LcsQosClass;
}
void LocationQoS::setLcsQosClass(oai::_3gpp::model::LcsQosClass const& value)
{
    m_LcsQosClass = value;
