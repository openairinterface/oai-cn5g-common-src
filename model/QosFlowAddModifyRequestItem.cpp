...
bool QosFlowAddModifyRequestItem::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "QosFlowAddModifyRequestItem" : pathPrefix;
...
bool QosFlowAddModifyRequestItem::operator==(const QosFlowAddModifyRequestItem& rhs) const
{
    return
    ...
    ((!ebiIsSet() && !rhs.ebiIsSet()) || (ebiIsSet() && rhs.ebiIsSet() && getEbi() == rhs.getEbi())) &&
    
    
    ((!qosRulesIsSet() && !rhs.qosRulesIsSet()) || (qosRulesIsSet() && rhs.qosRulesIsSet() && getQosRules() == rhs.getQosRules())) &&
    
    
    ((!qosFlowDescriptionIsSet() && !rhs.qosFlowDescriptionIsSet()) || (qosFlowDescriptionIsSet() && rhs.qosFlowDescriptionIsSet() && getQosFlowDescription() == rhs.getQosFlowDescription())) &&
    
    
    ((!qosFlowProfileIsSet() && !rhs.qosFlowProfileIsSet()) || (qosFlowProfileIsSet() && rhs.qosFlowProfileIsSet() && getQosFlowProfile() == rhs.getQosFlowProfile())) &&
    
    
    ((!associatedAnTypeIsSet() && !rhs.associatedAnTypeIsSet()) || (associatedAnTypeIsSet() && rhs.associatedAnTypeIsSet() && getAssociatedAnType() == rhs.getAssociatedAnType()))
...
void QosFlowAddModifyRequestItem::setQosFlowDescription(std::string const& value)
{
...
oai::_3gpp::model::QosFlowProfile QosFlowAddModifyRequestItem::getQosFlowProfile() const
{
    return m_QosFlowProfile;
}
void QosFlowAddModifyRequestItem::setQosFlowProfile(oai::_3gpp::model::QosFlowProfile const& value)
{
...
oai::_3gpp::model::QosFlowAccessType QosFlowAddModifyRequestItem::getAssociatedAnType() const
{
    return m_AssociatedAnType;
}
void QosFlowAddModifyRequestItem::setAssociatedAnType(oai::_3gpp::model::QosFlowAccessType const& value)
{
