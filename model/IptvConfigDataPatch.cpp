...
bool IptvConfigDataPatch::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "IptvConfigDataPatch" : pathPrefix;
...
bool IptvConfigDataPatch::operator==(const IptvConfigDataPatch& rhs) const
{
    ...
    ((!multiAccCtrlsIsSet() && !rhs.multiAccCtrlsIsSet()) || (multiAccCtrlsIsSet() && rhs.multiAccCtrlsIsSet() && getMultiAccCtrls() == rhs.getMultiAccCtrls()))
...
std::map<std::string, oai::model::MulticastAccessControl> IptvConfigDataPatch::getMultiAccCtrls() const
{
    return m_MultiAccCtrls;
}
void IptvConfigDataPatch::setMultiAccCtrls(std::map<std::string, oai::model::MulticastAccessControl> const& value)
{
