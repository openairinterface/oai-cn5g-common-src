...
public:
    ...
    void setNfConsumerIdentification(oai::_3gpp::model::NFIdentification const& value);
    /// <summary>
    ...
    /// 
    /// </summary>
    std::vector<oai::_3gpp::model::MultipleUnitUsage> getMultipleUnitUsage() const;
    void setMultipleUnitUsage(std::vector<oai::_3gpp::model::MultipleUnitUsage> const& value);
    ...
    /// 
    /// </summary>
    oai::_3gpp::model::PDUSessionChargingInformation getPDUSessionChargingInformation() const;
    void setPDUSessionChargingInformation(oai::_3gpp::model::PDUSessionChargingInformation const& value);
    ...
    void setRoamingQBCInformation(oai::_3gpp::model::RoamingQBCInformation const& value);
...
protected:
    ...
    oai::_3gpp::model::PDUSessionChargingInformation m_PDUSessionChargingInformation;
