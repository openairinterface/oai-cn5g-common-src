...
bool AccNetChargingAddress::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "AccNetChargingAddress" : pathPrefix;
...
bool AccNetChargingAddress::operator==(const AccNetChargingAddress& rhs) const
{
    ...
    ((!anChargIpv4AddrIsSet() && !rhs.anChargIpv4AddrIsSet()) || (anChargIpv4AddrIsSet() && rhs.anChargIpv4AddrIsSet() && getAnChargIpv4Addr() == rhs.getAnChargIpv4Addr())) &&
    
    
    ((!anChargIpv6AddrIsSet() && !rhs.anChargIpv6AddrIsSet()) || (anChargIpv6AddrIsSet() && rhs.anChargIpv6AddrIsSet() && getAnChargIpv6Addr() == rhs.getAnChargIpv6Addr()))
...
oai::_3gpp::model::Ipv6Addr AccNetChargingAddress::getAnChargIpv6Addr() const
{
    return m_AnChargIpv6Addr;
}
void AccNetChargingAddress::setAnChargIpv6Addr(oai::_3gpp::model::Ipv6Addr const& value)
{
