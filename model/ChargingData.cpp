...
oai::model::MeteringMethod ChargingData::getMeteringMethod() const
{
    return m_MeteringMethod;
}
void ChargingData::setMeteringMethod(oai::model::MeteringMethod const& value)
{
...
oai::model::ReportingLevel ChargingData::getReportingLevel() const
{
    return m_ReportingLevel;
}
void ChargingData::setReportingLevel(oai::model::ReportingLevel const& value)
{
