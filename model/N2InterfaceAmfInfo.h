...
public:
    ...
    /// 
    /// </summary>
    std::vector<oai::model::Ipv6Addr> getIpv6EndpointAddress() const;
    void setIpv6EndpointAddress(std::vector<oai::model::Ipv6Addr> const& value);
...
protected:
    ...
    std::vector<oai::model::Ipv6Addr> m_Ipv6EndpointAddress;
