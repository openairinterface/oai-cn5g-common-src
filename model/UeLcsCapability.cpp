...
bool UeLcsCapability::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "UeLcsCapability" : pathPrefix;
...
bool UeLcsCapability::operator==(const UeLcsCapability& rhs) const
{
    ...
    ((!lppSupportIsSet() && !rhs.lppSupportIsSet()) || (lppSupportIsSet() && rhs.lppSupportIsSet() && isLppSupport() == rhs.isLppSupport())) &&
    
    
    ((!ciotOptimisationIsSet() && !rhs.ciotOptimisationIsSet()) || (ciotOptimisationIsSet() && rhs.ciotOptimisationIsSet() && isCiotOptimisation() == rhs.isCiotOptimisation()))
