...
public:
    ...
    /// 
    /// </summary>
    oai::_3gpp::model::ReachabilityForSmsReport getReachabilityForSmsReport() const;
    void setReachabilityForSmsReport(oai::_3gpp::model::ReachabilityForSmsReport const& value);
    ...
    void setReachabilityReport(oai::_3gpp::model::ReachabilityReport const& value);
