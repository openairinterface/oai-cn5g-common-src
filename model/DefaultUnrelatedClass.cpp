...
std::vector<oai::model::GeographicArea> DefaultUnrelatedClass::getAllowedGeographicArea() const
{
    return m_AllowedGeographicArea;
}
void DefaultUnrelatedClass::setAllowedGeographicArea(std::vector<oai::model::GeographicArea> const& value)
{
...
oai::model::PrivacyCheckRelatedAction DefaultUnrelatedClass::getPrivacyCheckRelatedAction() const
{
    return m_PrivacyCheckRelatedAction;
}
void DefaultUnrelatedClass::setPrivacyCheckRelatedAction(oai::model::PrivacyCheckRelatedAction const& value)
{
...
oai::model::CodeWordInd DefaultUnrelatedClass::getCodeWordInd() const
{
    return m_CodeWordInd;
}
void DefaultUnrelatedClass::setCodeWordInd(oai::model::CodeWordInd const& value)
{
    m_CodeWordInd = value;
...
oai::model::ValidTimePeriod DefaultUnrelatedClass::getValidTimePeriod() const
{
    return m_ValidTimePeriod;
}
void DefaultUnrelatedClass::setValidTimePeriod(oai::model::ValidTimePeriod const& value)
{
...
void DefaultUnrelatedClass::setCodeWordList(std::vector<std::string> const& value)
{
