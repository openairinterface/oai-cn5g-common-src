...
bool NsacfInfo::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    ...
    if (!m_NsacfCapability.validate(msg, _pathPrefix + ".nsacfCapability")) {
        msg << _pathPrefix << ": NsacfCapability is invalid;";
        success = false;
    }     
    if (taiListIsSet())
    {
...
bool NsacfInfo::operator==(const NsacfInfo& rhs) const
{
    ...
    ((!nsacSaiListIsSet() && !rhs.nsacSaiListIsSet()) || (nsacSaiListIsSet() && rhs.nsacSaiListIsSet() && getNsacSaiList() == rhs.getNsacSaiList()))
...
oai::model::NsacfCapability NsacfInfo::getNsacfCapability() const
{
    return m_NsacfCapability;
}
void NsacfInfo::setNsacfCapability(oai::model::NsacfCapability const& value)
{
    m_NsacfCapability = value;
}
std::vector<oai::model::Tai> NsacfInfo::getTaiList() const
{
    return m_TaiList;
}
void NsacfInfo::setTaiList(std::vector<oai::model::Tai> const& value)
{
    m_TaiList = value;
    m_TaiListIsSet = true;
}
...
std::vector<oai::model::TaiRange> NsacfInfo::getTaiRangeList() const
{
    return m_TaiRangeList;
}
void NsacfInfo::setTaiRangeList(std::vector<oai::model::TaiRange> const& value)
{
