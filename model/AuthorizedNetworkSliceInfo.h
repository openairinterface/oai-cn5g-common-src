...
public:
    ...
    void setAllowedNssaiList(std::vector<oai::_3gpp::model::AllowedNssai> const& value);
    ...
    void setConfiguredNssai(std::vector<oai::_3gpp::model::ConfiguredSnssai> const& value);
    ...
    void setRejectedNssaiInPlmn(std::vector<oai::_3gpp::model::Snssai> const& value);
    ...
    void setRejectedNssaiInTa(std::vector<oai::_3gpp::model::Snssai> const& value);
    ...
    void setMappingOfNssai(std::vector<oai::_3gpp::model::MappingOfSnssai> const& value);
    ...
    /// </summary>
    std::map<std::string, oai::_3gpp::model::SnssaiInfo> getSnssaiInfoRspData() const;
    void setSnssaiInfoRspData(std::map<std::string, oai::_3gpp::model::SnssaiInfo> const& value);
