...
bool QosNotifType_anyOf::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "QosNotifType_anyOf" : pathPrefix;

    
    if (m_value == QosNotifType_anyOf::eQosNotifType_anyOf::INVALID_VALUE_OPENAPI_GENERATED)
    {
        success = false;
...
void QosNotifType_anyOf::setValue(QosNotifType_anyOf::eQosNotifType_anyOf value)
{
    m_value = value;
}
