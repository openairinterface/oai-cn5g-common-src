...
public:
    ...
    /// </summary>
    std::map<std::string, oai::model::SessionRule> getSessRules() const;
    void setSessRules(std::map<std::string, oai::model::SessionRule> const& value);
    ...
    /// </summary>
    std::map<std::string, oai::model::PccRule> getPccRules() const;
    void setPccRules(std::map<std::string, oai::model::PccRule> const& value);
    ...
    /// </summary>
    std::map<std::string, oai::model::QosData> getQosDecs() const;
    void setQosDecs(std::map<std::string, oai::model::QosData> const& value);
    ...
    /// </summary>
    std::map<std::string, oai::model::ChargingData> getChgDecs() const;
    void setChgDecs(std::map<std::string, oai::model::ChargingData> const& value);
    ...
    /// </summary>
    std::map<std::string, oai::model::TrafficControlData> getTraffContDecs() const;
    void setTraffContDecs(std::map<std::string, oai::model::TrafficControlData> const& value);
    ...
    /// </summary>
    std::map<std::string, oai::model::UsageMonitoringData> getUmDecs() const;
    void setUmDecs(std::map<std::string, oai::model::UsageMonitoringData> const& value);
    bool umDecsIsSet() const;
    void unsetUmDecs();
    /// <summary>
    /// Map of QoS characteristics for non standard 5QIs. This map uses the 5QI values as keys.
    /// </summary>
    std::map<std::string, oai::model::QosCharacteristics> getQosChars() const;
    void setQosChars(std::map<std::string, oai::model::QosCharacteristics> const& value);
    ...
    /// </summary>
    std::map<std::string, oai::model::QosMonitoringData> getQosMonDecs() const;
    void setQosMonDecs(std::map<std::string, oai::model::QosMonitoringData> const& value);
    ...
    /// </summary>
    std::map<std::string, oai::model::ConditionData> getConds() const;
    void setConds(std::map<std::string, oai::model::ConditionData> const& value);
    ...
    /// </summary>
    std::vector<oai::model::PolicyControlRequestTrigger> getPolicyCtrlReqTriggers() const;
    void setPolicyCtrlReqTriggers(std::vector<oai::model::PolicyControlRequestTrigger> const& value);
    ...
    /// </summary>
    std::vector<oai::model::RequestedRuleData> getLastReqRuleData() const;
    void setLastReqRuleData(std::vector<oai::model::RequestedRuleData> const& value);
    bool lastReqRuleDataIsSet() const;
    void unsetLastReqRuleData();
    /// <summary>
    /// 
    /// </summary>
    oai::model::RequestedUsageData getLastReqUsageData() const;
    void setLastReqUsageData(oai::model::RequestedUsageData const& value);
    ...
    /// </summary>
    std::map<std::string, oai::model::PresenceInfoRm> getPraInfos() const;
    void setPraInfos(std::map<std::string, oai::model::PresenceInfoRm> const& value);
    ...
    /// 
    /// </summary>
    oai::model::SmPolicyAssociationReleaseCause getRelCause() const;
    void setRelCause(oai::model::SmPolicyAssociationReleaseCause const& value);
...
protected:
    std::map<std::string, oai::model::SessionRule> m_SessRules;
    bool m_SessRulesIsSet;
    std::map<std::string, oai::model::PccRule> m_PccRules;
    bool m_PccRulesIsSet;
    bool m_PcscfRestIndication;
    bool m_PcscfRestIndicationIsSet;
    std::map<std::string, oai::model::QosData> m_QosDecs;
    bool m_QosDecsIsSet;
    std::map<std::string, oai::model::ChargingData> m_ChgDecs;
    bool m_ChgDecsIsSet;
    oai::model::ChargingInformation m_ChargingInfo;
    bool m_ChargingInfoIsSet;
    std::map<std::string, oai::model::TrafficControlData> m_TraffContDecs;
    bool m_TraffContDecsIsSet;
    std::map<std::string, oai::model::UsageMonitoringData> m_UmDecs;
    bool m_UmDecsIsSet;
    std::map<std::string, oai::model::QosCharacteristics> m_QosChars;
    bool m_QosCharsIsSet;
    std::map<std::string, oai::model::QosMonitoringData> m_QosMonDecs;
    bool m_QosMonDecsIsSet;
    int32_t m_ReflectiveQoSTimer;
    bool m_ReflectiveQoSTimerIsSet;
    std::map<std::string, oai::model::ConditionData> m_Conds;
    bool m_CondsIsSet;
    ...
    std::vector<oai::model::PolicyControlRequestTrigger> m_PolicyCtrlReqTriggers;
    bool m_PolicyCtrlReqTriggersIsSet;
    std::vector<oai::model::RequestedRuleData> m_LastReqRuleData;
    bool m_LastReqRuleDataIsSet;
    oai::model::RequestedUsageData m_LastReqUsageData;
    bool m_LastReqUsageDataIsSet;
    std::map<std::string, oai::model::PresenceInfoRm> m_PraInfos;
    ...
    oai::model::SmPolicyAssociationReleaseCause m_RelCause;
