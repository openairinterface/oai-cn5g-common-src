...
bool LossOfConnectivityReason_anyOf::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "LossOfConnectivityReason_anyOf" : pathPrefix;

    
    if (m_value == LossOfConnectivityReason_anyOf::eLossOfConnectivityReason_anyOf::INVALID_VALUE_OPENAPI_GENERATED)
    {
        success = false;
...
void to_json(nlohmann::json& j, const LossOfConnectivityReason_anyOf& o)
{
    ...
    switch (o.getValue())
    {
        case LossOfConnectivityReason_anyOf::eLossOfConnectivityReason_anyOf::INVALID_VALUE_OPENAPI_GENERATED:
...
LossOfConnectivityReason_anyOf::eLossOfConnectivityReason_anyOf LossOfConnectivityReason_anyOf::getValue() const
{
    return m_value;
}
void LossOfConnectivityReason_anyOf::setValue(LossOfConnectivityReason_anyOf::eLossOfConnectivityReason_anyOf value)
{
    m_value = value;
}
