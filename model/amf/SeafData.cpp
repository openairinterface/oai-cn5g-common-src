...
NgKsi SeafData::getNgKsi() const { return m_NgKsi; }
void SeafData::setNgKsi(NgKsi const &value) { m_NgKsi = value; }
KeyAmf SeafData::getKeyAmf() const { return m_KeyAmf; }
void SeafData::setKeyAmf(KeyAmf const &value) { m_KeyAmf = value; }
std::string SeafData::getNh() const { return m_Nh; }
void SeafData::setNh(std::string const &value) {
  m_Nh = value;
  m_NhIsSet = true;
}
bool SeafData::nhIsSet() const { return m_NhIsSet; }
void SeafData::unsetNh() { m_NhIsSet = false; }
int32_t SeafData::getNcc() const { return m_Ncc; }
void SeafData::setNcc(int32_t const value) {
  m_Ncc = value;
  m_NccIsSet = true;
}
bool SeafData::nccIsSet() const { return m_NccIsSet; }
void SeafData::unsetNcc() { m_NccIsSet = false; }
bool SeafData::isKeyAmfChangeInd() const { return m_KeyAmfChangeInd; }
void SeafData::setKeyAmfChangeInd(bool const value) {
  m_KeyAmfChangeInd = value;
  m_KeyAmfChangeIndIsSet = true;
}
bool SeafData::keyAmfChangeIndIsSet() const { return m_KeyAmfChangeIndIsSet; }
void SeafData::unsetKeyAmfChangeInd() { m_KeyAmfChangeIndIsSet = false; }
bool SeafData::isKeyAmfHDerivationInd() const { return m_KeyAmfHDerivationInd; }
