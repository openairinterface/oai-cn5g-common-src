...
bool GlobalRanNodeId::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "GlobalRanNodeId" : pathPrefix;
...
oai::model::PlmnId GlobalRanNodeId::getPlmnId() const
{
    return m_PlmnId;
}
void GlobalRanNodeId::setPlmnId(oai::model::PlmnId const& value)
{
    m_PlmnId = value;
}
...
oai::model::GNbId GlobalRanNodeId::getGNbId() const
{
    return m_GNbId;
}
void GlobalRanNodeId::setGNbId(oai::model::GNbId const& value)
{
    m_GNbId = value;
    m_GNbIdIsSet = true;
}
