...
LoggingIntervalNrMdt_anyOf::eLoggingIntervalNrMdt_anyOf LoggingIntervalNrMdt::getEnumValue() const
{
    return m_value.getValue();
}

void LoggingIntervalNrMdt::setEnumValue(LoggingIntervalNrMdt_anyOf::eLoggingIntervalNrMdt_anyOf  value)
{
