...
public:
    ...
    /// </summary>
    std::map<std::string, oai::_3gpp::model::SmPolicySnssaiDataPatch> getSmPolicySnssaiData() const;
    void setSmPolicySnssaiData(std::map<std::string, oai::_3gpp::model::SmPolicySnssaiDataPatch> const& value);
...
protected:
    ...
    bool m_UmDataIsSet;
    std::map<std::string, oai::_3gpp::model::SmPolicySnssaiDataPatch> m_SmPolicySnssaiData;
