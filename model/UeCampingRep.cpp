...
oai::model::AccessType UeCampingRep::getAccessType() const
{
    return m_AccessType;
}
void UeCampingRep::setAccessType(oai::model::AccessType const& value)
{
    m_AccessType = value;
...
oai::model::RatType UeCampingRep::getRatType() const
{
    return m_RatType;
}
void UeCampingRep::setRatType(oai::model::RatType const& value)
{
    m_RatType = value;
    m_RatTypeIsSet = true;
}
...
oai::model::ServingNfIdentity UeCampingRep::getServNfId() const
{
    return m_ServNfId;
}
void UeCampingRep::setServNfId(oai::model::ServingNfIdentity const& value)
{
    m_ServNfId = value;
...
oai::model::PlmnIdNid UeCampingRep::getServingNetwork() const
{
    return m_ServingNetwork;
}
void UeCampingRep::setServingNetwork(oai::model::PlmnIdNid const& value)
{
...
oai::model::UserLocation UeCampingRep::getUserLocationInfo() const
{
    return m_UserLocationInfo;
}
void UeCampingRep::setUserLocationInfo(oai::model::UserLocation const& value)
{
...
oai::model::NetLocAccessSupport UeCampingRep::getNetLocAccSupp() const
{
    return m_NetLocAccSupp;
}
void UeCampingRep::setNetLocAccSupp(oai::model::NetLocAccessSupport const& value)
{
...
oai::model::SatelliteBackhaulCategory UeCampingRep::getSatBackhaulCategory() const
{
    return m_SatBackhaulCategory;
}
void UeCampingRep::setSatBackhaulCategory(oai::model::SatelliteBackhaulCategory const& value)
{
