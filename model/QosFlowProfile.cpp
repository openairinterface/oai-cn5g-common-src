...
void QosFlowProfile::setNonDynamic5Qi(oai::_3gpp::model::NonDynamic5Qi const& value)
{
...
oai::_3gpp::model::GbrQosFlowInformation QosFlowProfile::getGbrQosFlowInfo() const
{
    return m_GbrQosFlowInfo;
}
void QosFlowProfile::setGbrQosFlowInfo(oai::_3gpp::model::GbrQosFlowInformation const& value)
{
...
void QosFlowProfile::setRqa(oai::_3gpp::model::ReflectiveQoSAttribute const& value)
{
    m_Rqa = value;
    m_RqaIsSet = true;
}
...
oai::_3gpp::model::AdditionalQosFlowInfo QosFlowProfile::getAdditionalQosFlowInfo() const
{
    return m_AdditionalQosFlowInfo;
}
void QosFlowProfile::setAdditionalQosFlowInfo(oai::_3gpp::model::AdditionalQosFlowInfo const& value)
{
...
oai::_3gpp::model::QosMonitoringReq QosFlowProfile::getQosMonitoringReq() const
{
    return m_QosMonitoringReq;
}
void QosFlowProfile::setQosMonitoringReq(oai::_3gpp::model::QosMonitoringReq const& value)
{
