...
public:
    ...
    /// 
    /// </summary>
    oai::_3gpp::model::NFIdentification getServingNetworkFunctionInformation() const;
    void setServingNetworkFunctionInformation(oai::_3gpp::model::NFIdentification const& value);
    /// <summary>
