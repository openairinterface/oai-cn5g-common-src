...
bool DnnSmfInfoItem::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    ...
    if (dnaiListIsSet())
    {
        const std::vector<oai::_3gpp::model::DnnSmfInfoItem_dnaiList_inner>& value = m_DnaiList;
        ...
        { // Recursive validation of array elements
            ...
            int i = 0;
            for (const oai::_3gpp::model::DnnSmfInfoItem_dnaiList_inner& value : value)
            { 
...
void DnnSmfInfoItem::setDnn(oai::_3gpp::model::DnnSmfInfoItem_dnn const& value)
{
    m_Dnn = value;
}
std::vector<oai::_3gpp::model::DnnSmfInfoItem_dnaiList_inner> DnnSmfInfoItem::getDnaiList() const
{
    return m_DnaiList;
}
void DnnSmfInfoItem::setDnaiList(std::vector<oai::_3gpp::model::DnnSmfInfoItem_dnaiList_inner> const& value)
{
    m_DnaiList = value;
