...
bool AuthorizationInfo::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "AuthorizationInfo" : pathPrefix;
...
oai::model::Snssai AuthorizationInfo::getSnssai() const
{
    return m_Snssai;
}
void AuthorizationInfo::setSnssai(oai::model::Snssai const& value)
{
    m_Snssai = value;
}
...
oai::model::ContextInfo AuthorizationInfo::getContextInfo() const
{
    return m_ContextInfo;
}
void AuthorizationInfo::setContextInfo(oai::model::ContextInfo const& value)
{
    m_ContextInfo = value;
