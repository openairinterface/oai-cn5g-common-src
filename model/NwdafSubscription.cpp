...
bool NwdafSubscription::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "NwdafSubscription" : pathPrefix;

            
    if (!m_NwdafEventsSubscription.validate(msg, _pathPrefix + ".nwdafEventsSubscription")) {
        msg << _pathPrefix << ": NwdafEventsSubscription is invalid;";
        success = false;
    }
    return success;
}
...
oai::model::NnwdafEventsSubscription NwdafSubscription::getNwdafEventsSubscription() const
{
    return m_NwdafEventsSubscription;
}
void NwdafSubscription::setNwdafEventsSubscription(oai::model::NnwdafEventsSubscription const& value)
{
