...
bool NotificationFlag_anyOf::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "NotificationFlag_anyOf" : pathPrefix;

    
    if (m_value == NotificationFlag_anyOf::eNotificationFlag_anyOf::INVALID_VALUE_OPENAPI_GENERATED)
    {
        success = false;
...
bool NotificationFlag_anyOf::operator==(const NotificationFlag_anyOf& rhs) const
{
    return
...
void to_json(nlohmann::json& j, const NotificationFlag_anyOf& o)
{
    ...
    switch (o.getValue())
    {
        case NotificationFlag_anyOf::eNotificationFlag_anyOf::INVALID_VALUE_OPENAPI_GENERATED:
...
NotificationFlag_anyOf::eNotificationFlag_anyOf NotificationFlag_anyOf::getValue() const
{
    return m_value;
}
void NotificationFlag_anyOf::setValue(NotificationFlag_anyOf::eNotificationFlag_anyOf value)
{
    m_value = value;
}
