...
bool Pc5QoSPara::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "Pc5QoSPara" : pathPrefix;

         
    
    /* Pc5QosFlowList */ {
        const std::vector<oai::_3gpp::model::Pc5QosFlowItem>& value = m_Pc5QosFlowList;
        ...
        { // Recursive validation of array elements
            ...
            int i = 0;
            for (const oai::_3gpp::model::Pc5QosFlowItem& value : value)
            { 
                const std::string currentValuePath = oldValuePath + "[" + std::to_string(i) + "]";
                        
        success = value.validate(msg, currentValuePath + ".pc5QosFlowList") && success;
...
bool Pc5QoSPara::operator==(const Pc5QoSPara& rhs) const
{
    ...
    ((!pc5LinkAmbrIsSet() && !rhs.pc5LinkAmbrIsSet()) || (pc5LinkAmbrIsSet() && rhs.pc5LinkAmbrIsSet() && getPc5LinkAmbr() == rhs.getPc5LinkAmbr()))
...
std::vector<oai::_3gpp::model::Pc5QosFlowItem> Pc5QoSPara::getPc5QosFlowList() const
{
    return m_Pc5QosFlowList;
}
void Pc5QoSPara::setPc5QosFlowList(std::vector<oai::_3gpp::model::Pc5QosFlowItem> const& value)
{
