...
oai::_3gpp::model::MaPduIndication MAPDUSessionInformation::getMAPDUSessionIndicator() const
{
    return m_MAPDUSessionIndicator;
}
void MAPDUSessionInformation::setMAPDUSessionIndicator(oai::_3gpp::model::MaPduIndication const& value)
{
...
oai::_3gpp::model::AtsssCapability MAPDUSessionInformation::getATSSSCapability() const
{
    return m_ATSSSCapability;
}
void MAPDUSessionInformation::setATSSSCapability(oai::_3gpp::model::AtsssCapability const& value)
{
