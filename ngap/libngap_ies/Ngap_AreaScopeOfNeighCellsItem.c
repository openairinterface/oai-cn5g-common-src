...
asn_TYPE_member_t asn_MBR_Ngap_AreaScopeOfNeighCellsItem_1[] = {
	{ ATF_POINTER, 0, offsetof(struct Ngap_AreaScopeOfNeighCellsItem, nrFrequencyInfo),
	...
	{ ATF_POINTER, 2, offsetof(struct Ngap_AreaScopeOfNeighCellsItem, pciListForMDT),
	...
	{ ATF_POINTER, 1, offsetof(struct Ngap_AreaScopeOfNeighCellsItem, iE_Extensions),
...
static const asn_TYPE_tag2member_t asn_MAP_Ngap_AreaScopeOfNeighCellsItem_tag2el_1[] = {
