...
public:
    ...
    /// </summary>
    std::map<std::string, oai::_3gpp::model::CandidateForReplacement> getCandidates() const;
    void setCandidates(std::map<std::string, oai::_3gpp::model::CandidateForReplacement> const& value);
...
protected:
    ...
    std::map<std::string, oai::_3gpp::model::CandidateForReplacement> m_Candidates;
