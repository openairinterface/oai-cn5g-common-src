...
bool HssAuthenticationVectors::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "HssAuthenticationVectors" : pathPrefix;

    
    return success;
}

bool HssAuthenticationVectors::operator==(const HssAuthenticationVectors& rhs) const
{
    return
