...
bool QosMonitoringInformationRm::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "QosMonitoringInformationRm" : pathPrefix;
...
bool QosMonitoringInformationRm::operator==(const QosMonitoringInformationRm& rhs) const
{
    return
    ...
    ((!repThreshDatRateUlIsSet() && !rhs.repThreshDatRateUlIsSet()) || (repThreshDatRateUlIsSet() && rhs.repThreshDatRateUlIsSet() && getRepThreshDatRateUl() == rhs.getRepThreshDatRateUl())) &&
    
    
    ((!repThreshDatRateDlIsSet() && !rhs.repThreshDatRateDlIsSet()) || (repThreshDatRateDlIsSet() && rhs.repThreshDatRateDlIsSet() && getRepThreshDatRateDl() == rhs.getRepThreshDatRateDl())) &&
    
    
    ((!conThreshDlIsSet() && !rhs.conThreshDlIsSet()) || (conThreshDlIsSet() && rhs.conThreshDlIsSet() && getConThreshDl() == rhs.getConThreshDl())) &&
    
    
    ((!conThreshUlIsSet() && !rhs.conThreshUlIsSet()) || (conThreshUlIsSet() && rhs.conThreshUlIsSet() && getConThreshUl() == rhs.getConThreshUl()))
...
void QosMonitoringInformationRm::setRepThreshDatRateUl(std::string const& value)
{
...
void QosMonitoringInformationRm::setRepThreshDatRateDl(std::string const& value)
{
