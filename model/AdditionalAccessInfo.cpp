...
bool AdditionalAccessInfo::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "AdditionalAccessInfo" : pathPrefix;
...
oai::model::AccessType AdditionalAccessInfo::getAccessType() const
{
    return m_AccessType;
}
void AdditionalAccessInfo::setAccessType(oai::model::AccessType const& value)
{
    m_AccessType = value;
}
oai::model::RatType AdditionalAccessInfo::getRatType() const
{
    return m_RatType;
}
void AdditionalAccessInfo::setRatType(oai::model::RatType const& value)
{
    m_RatType = value;
    m_RatTypeIsSet = true;
}
