...
extern asn_TYPE_descriptor_t asn_DEF_Ngap_rIM_RSDetection
    __attribute__((weak, alias("asn_DEF_Ngap_rIM_RSDetection_3")));
#else
static asn_TYPE_descriptor_t asn_DEF_Ngap_rIM_RSDetection_3;
static asn_TYPE_descriptor_t asn_DEF_Ngap_rIM_RSDetection;
__attribute__((constructor)) static void
asn_DEF_Ngap_rIM_RSDetection_3_alias_init(void) {
  asn_DEF_Ngap_rIM_RSDetection = asn_DEF_Ngap_rIM_RSDetection_3;
}
#endif
...
static asn_oer_constraints_t asn_OER_type_Ngap_rIM_RSDetection_constr_3
    CC_NOTUSED = {{0, 0}, -1};
#endif /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
static asn_per_constraints_t asn_PER_type_Ngap_rIM_RSDetection_constr_3
    CC_NOTUSED = {
...
static const asn_INTEGER_enum_map_t
    asn_MAP_Ngap_rIM_RSDetection_value2enum_3[] = {
        {0, 11, "rs-detected"},
        {1, 14, "rs-disappeared"}
        /* This list is extensible */
};
static int asn_validate_Ngap_rIM_RSDetection_3(
    const asn_TYPE_descriptor_t* td, const void* sptr,
    asn_app_constraint_failed_f* ctfailcb, void* app_key) {
  if (!sptr) {
    return -1;
  }
  e_Ngap_RIMInformation__rIM_RSDetection value =
      *(e_Ngap_RIMInformation__rIM_RSDetection*) sptr;
  switch (value) {
    case Ngap_RIMInformation__rIM_RSDetection_rs_detected:
    case Ngap_RIMInformation__rIM_RSDetection_rs_disappeared:
      return 0;
  }
  return -1;
}
...
static /* Use -fall-defs-global to expose */
    asn_TYPE_descriptor_t asn_DEF_Ngap_rIM_RSDetection_3 = {
        ...
        sizeof(asn_DEF_Ngap_rIM_RSDetection_tags_3) /
                sizeof(asn_DEF_Ngap_rIM_RSDetection_tags_3[0]) -
            1,                               /* 1 */
        ...
        {
#if !defined(ASN_DISABLE_OER_SUPPORT)
            &asn_OER_type_Ngap_rIM_RSDetection_constr_3,
#endif /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
          ...
          !defined(ASN_DISABLE_APER_SUPPORT) */
            ...
            asn_validate_Ngap_rIM_RSDetection_3},
        0,
        0,                                    /* Defined elsewhere */
...
asn_TYPE_member_t asn_MBR_Ngap_RIMInformation_1[] = {
    {ATF_NOFLAGS,
     0,
     offsetof(struct Ngap_RIMInformation, targetgNBSetID),
    ...
    {ATF_NOFLAGS,
     0,
     offsetof(struct Ngap_RIMInformation, rIM_RSDetection),
    ...
    {ATF_POINTER,
     1,
     offsetof(struct Ngap_RIMInformation, iE_Extensions),
     (ASN_TAG_CLASS_CONTEXT | (2 << 2)),
     -1, /* IMPLICIT tag at current level */
     &asn_DEF_Ngap_ProtocolExtensionContainer_12929P294,
     0,
     {
#if !defined(ASN_DISABLE_OER_SUPPORT)
         0,
