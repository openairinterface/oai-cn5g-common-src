...
public:
    ...
    /// 
    /// </summary>
    std::vector<oai::model::UeTrajectoryInfo> getUeTrajs() const;
    void setUeTrajs(std::vector<oai::model::UeTrajectoryInfo> const& value);
...
protected:
    ...
    std::string m_AppId;
    bool m_AppIdIsSet;
    std::vector<oai::model::UeTrajectoryInfo> m_UeTrajs;
