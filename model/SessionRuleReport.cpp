...
oai::_3gpp::model::RuleStatus SessionRuleReport::getRuleStatus() const
{
    return m_RuleStatus;
}
void SessionRuleReport::setRuleStatus(oai::_3gpp::model::RuleStatus const& value)
{
    m_RuleStatus = value;
}
oai::_3gpp::model::SessionRuleFailureCode SessionRuleReport::getSessRuleFailureCode() const
{
    return m_SessRuleFailureCode;
}
void SessionRuleReport::setSessRuleFailureCode(oai::_3gpp::model::SessionRuleFailureCode const& value)
{
...
std::vector<oai::_3gpp::model::PolicyDecisionFailureCode> SessionRuleReport::getPolicyDecFailureReports() const
{
    return m_PolicyDecFailureReports;
}
void SessionRuleReport::setPolicyDecFailureReports(std::vector<oai::_3gpp::model::PolicyDecisionFailureCode> const& value)
{
