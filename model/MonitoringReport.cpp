...
bool MonitoringReport::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "MonitoringReport" : pathPrefix;
...
bool MonitoringReport::operator==(const MonitoringReport& rhs) const
{
    ...
    ((!reachabilityForSmsReportIsSet() && !rhs.reachabilityForSmsReportIsSet()) || (reachabilityForSmsReportIsSet() && rhs.reachabilityForSmsReportIsSet() && getReachabilityForSmsReport() == rhs.getReachabilityForSmsReport())) &&
    ...
    ((!reachabilityReportIsSet() && !rhs.reachabilityReportIsSet()) || (reachabilityReportIsSet() && rhs.reachabilityReportIsSet() && getReachabilityReport() == rhs.getReachabilityReport()))
...
oai::model::EventType MonitoringReport::getEventType() const
{
    return m_EventType;
}
void MonitoringReport::setEventType(oai::model::EventType const& value)
{
    m_EventType = value;
}
oai::model::Report MonitoringReport::getReport() const
{
    return m_Report;
}
void MonitoringReport::setReport(oai::model::Report const& value)
{
    m_Report = value;
    m_ReportIsSet = true;
}
...
oai::model::ReachabilityForSmsReport MonitoringReport::getReachabilityForSmsReport() const
{
    return m_ReachabilityForSmsReport;
}
void MonitoringReport::setReachabilityForSmsReport(oai::model::ReachabilityForSmsReport const& value)
{
...
oai::model::ReachabilityReport MonitoringReport::getReachabilityReport() const
{
    return m_ReachabilityReport;
}
void MonitoringReport::setReachabilityReport(oai::model::ReachabilityReport const& value)
{
