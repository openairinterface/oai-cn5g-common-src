...
bool SmfSelectionSubscriptionData::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "SmfSelectionSubscriptionData" : pathPrefix;
...
bool SmfSelectionSubscriptionData::operator==(const SmfSelectionSubscriptionData& rhs) const
{
    return
    ...
    ((!subscribedSnssaiInfosIsSet() && !rhs.subscribedSnssaiInfosIsSet()) || (subscribedSnssaiInfosIsSet() && rhs.subscribedSnssaiInfosIsSet() && getSubscribedSnssaiInfos() == rhs.getSubscribedSnssaiInfos())) &&
    
    
    ((!sharedSnssaiInfosIdIsSet() && !rhs.sharedSnssaiInfosIdIsSet()) || (sharedSnssaiInfosIdIsSet() && rhs.sharedSnssaiInfosIdIsSet() && getSharedSnssaiInfosId() == rhs.getSharedSnssaiInfosId())) &&
...
std::map<std::string, oai::_3gpp::model::SnssaiInfo> SmfSelectionSubscriptionData::getSubscribedSnssaiInfos() const
{
    return m_SubscribedSnssaiInfos;
}
void SmfSelectionSubscriptionData::setSubscribedSnssaiInfos(std::map<std::string, oai::_3gpp::model::SnssaiInfo> const& value)
{
