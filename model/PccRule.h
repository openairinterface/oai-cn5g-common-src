...
public:
    ...
    /// </summary>
    std::vector<oai::model::FlowInformation> getFlowInfos() const;
    void setFlowInfos(std::vector<oai::model::FlowInformation> const& value);
    ...
    /// 
    /// </summary>
    oai::model::AfSigProtocol getAfSigProtocol() const;
    void setAfSigProtocol(oai::model::AfSigProtocol const& value);
    ...
    /// 
    /// </summary>
    oai::model::DownlinkDataNotificationControl getDdNotifCtrl() const;
    void setDdNotifCtrl(oai::model::DownlinkDataNotificationControl const& value);
    bool ddNotifCtrlIsSet() const;
    void unsetDdNotifCtrl();
    /// <summary>
    /// 
    /// </summary>
    oai::model::DownlinkDataNotificationControlRm getDdNotifCtrl2() const;
    void setDdNotifCtrl2(oai::model::DownlinkDataNotificationControlRm const& value);
...
protected:
    std::vector<oai::model::FlowInformation> m_FlowInfos;
    ...
    oai::model::AfSigProtocol m_AfSigProtocol;
    ...
    oai::model::DownlinkDataNotificationControl m_DdNotifCtrl;
    bool m_DdNotifCtrlIsSet;
    oai::model::DownlinkDataNotificationControlRm m_DdNotifCtrl2;
