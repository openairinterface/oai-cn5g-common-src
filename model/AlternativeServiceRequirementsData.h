...
public:
    ...
    friend void to_json(nlohmann::json& j, const AlternativeServiceRequirementsData& o);
    friend void from_json(const nlohmann::json& j, AlternativeServiceRequirementsData& o);
protected:
