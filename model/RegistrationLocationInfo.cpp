...
void RegistrationLocationInfo::setPlmnId(oai::_3gpp::model::PlmnId const& value)
{
    m_PlmnId = value;
    m_PlmnIdIsSet = true;
}
...
oai::_3gpp::model::VgmlcAddress RegistrationLocationInfo::getVgmlcAddress() const
{
    return m_VgmlcAddress;
}
void RegistrationLocationInfo::setVgmlcAddress(oai::_3gpp::model::VgmlcAddress const& value)
{
...
std::vector<oai::_3gpp::model::AccessType> RegistrationLocationInfo::getAccessTypeList() const
{
    return m_AccessTypeList;
}
void RegistrationLocationInfo::setAccessTypeList(std::vector<oai::_3gpp::model::AccessType> const& value)
{
