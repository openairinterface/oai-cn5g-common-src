...
bool ProvideLocInfo::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "ProvideLocInfo" : pathPrefix;
...
oai::model::UserLocation ProvideLocInfo::getLocation() const
{
    return m_Location;
}
void ProvideLocInfo::setLocation(oai::model::UserLocation const& value)
{
    m_Location = value;
...
oai::model::UserLocation ProvideLocInfo::getAdditionalLocation() const
{
    return m_AdditionalLocation;
}
void ProvideLocInfo::setAdditionalLocation(oai::model::UserLocation const& value)
{
...
oai::model::GeographicArea ProvideLocInfo::getGeoInfo() const
{
    return m_GeoInfo;
}
void ProvideLocInfo::setGeoInfo(oai::model::GeographicArea const& value)
{
    m_GeoInfo = value;
    m_GeoInfoIsSet = true;
}
...
oai::model::RatType ProvideLocInfo::getRatType() const
{
    return m_RatType;
}
void ProvideLocInfo::setRatType(oai::model::RatType const& value)
{
    m_RatType = value;
    m_RatTypeIsSet = true;
}
...
oai::model::Guami ProvideLocInfo::getOldGuami() const
{
    return m_OldGuami;
}
void ProvideLocInfo::setOldGuami(oai::model::Guami const& value)
{
    m_OldGuami = value;
