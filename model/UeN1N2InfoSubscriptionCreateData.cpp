...
oai::_3gpp::model::N2InformationClass UeN1N2InfoSubscriptionCreateData::getN2InformationClass() const
{
    return m_N2InformationClass;
}
void UeN1N2InfoSubscriptionCreateData::setN2InformationClass(oai::_3gpp::model::N2InformationClass const& value)
{
...
oai::_3gpp::model::N1MessageClass UeN1N2InfoSubscriptionCreateData::getN1MessageClass() const
{
    return m_N1MessageClass;
}
void UeN1N2InfoSubscriptionCreateData::setN1MessageClass(oai::_3gpp::model::N1MessageClass const& value)
{
...
void UeN1N2InfoSubscriptionCreateData::setOldGuami(oai::_3gpp::model::Guami const& value)
{
    m_OldGuami = value;
