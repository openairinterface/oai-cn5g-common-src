...
bool PositioningMethod_anyOf::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "PositioningMethod_anyOf" : pathPrefix;

    
    if (m_value == PositioningMethod_anyOf::ePositioningMethod_anyOf::INVALID_VALUE_OPENAPI_GENERATED)
    {
        success = false;
...
bool PositioningMethod_anyOf::operator==(const PositioningMethod_anyOf& rhs) const
{
    return
...
void to_json(nlohmann::json& j, const PositioningMethod_anyOf& o)
{
    ...
    switch (o.getValue())
    {
        case PositioningMethod_anyOf::ePositioningMethod_anyOf::INVALID_VALUE_OPENAPI_GENERATED:
...
void from_json(const nlohmann::json& j, PositioningMethod_anyOf& o)
{
    ...
    if (s == "CELLID") {
     ...
     o.setValue(PositioningMethod_anyOf::ePositioningMethod_anyOf::BAROMETRIC_PRESSURE);
    } 
    else if (s == "WLAN") {
     ...
     o.setValue(PositioningMethod_anyOf::ePositioningMethod_anyOf::MOTION_SENSOR);
    } 
    else if (s == "DL_TDOA") {
     ...
     o.setValue(PositioningMethod_anyOf::ePositioningMethod_anyOf::NETWORK_SPECIFIC);
    }  else {
     std::stringstream ss;
...
PositioningMethod_anyOf::ePositioningMethod_anyOf PositioningMethod_anyOf::getValue() const
{
    return m_value;
}
void PositioningMethod_anyOf::setValue(PositioningMethod_anyOf::ePositioningMethod_anyOf value)
{
    m_value = value;
}
