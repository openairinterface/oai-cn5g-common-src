...
oai::_3gpp::model::CnType CnTypeChangeReport::getNewCnType() const
{
    return m_NewCnType;
}
void CnTypeChangeReport::setNewCnType(oai::_3gpp::model::CnType const& value)
{
    m_NewCnType = value;
}
oai::_3gpp::model::CnType CnTypeChangeReport::getOldCnType() const
{
    return m_OldCnType;
}
void CnTypeChangeReport::setOldCnType(oai::_3gpp::model::CnType const& value)
{
    m_OldCnType = value;
