...
std::vector<oai::_3gpp::model::InvalidParam> ExtendedProblemDetails::getInvalidParams() const
{
    return m_InvalidParams;
}
void ExtendedProblemDetails::setInvalidParams(std::vector<oai::_3gpp::model::InvalidParam> const& value)
{
...
oai::_3gpp::model::AccessTokenErr ExtendedProblemDetails::getAccessTokenError() const
{
    return m_AccessTokenError;
}
void ExtendedProblemDetails::setAccessTokenError(oai::_3gpp::model::AccessTokenErr const& value)
{
...
oai::_3gpp::model::AccessTokenReq ExtendedProblemDetails::getAccessTokenRequest() const
{
    return m_AccessTokenRequest;
}
void ExtendedProblemDetails::setAccessTokenRequest(oai::_3gpp::model::AccessTokenReq const& value)
{
...
oai::_3gpp::model::AcceptableServiceInfo ExtendedProblemDetails::getAcceptableServInfo() const
{
    return m_AcceptableServInfo;
}
void ExtendedProblemDetails::setAcceptableServInfo(oai::_3gpp::model::AcceptableServiceInfo const& value)
{
