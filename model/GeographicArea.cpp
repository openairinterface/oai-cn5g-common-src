...
bool GeographicArea::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "GeographicArea" : pathPrefix;
...
oai::model::SupportedGADShapes GeographicArea::getShape() const
{
    return m_Shape;
}
void GeographicArea::setShape(oai::model::SupportedGADShapes const& value)
{
    m_Shape = value;
}
oai::model::GeographicalCoordinates GeographicArea::getPoint() const
{
    return m_Point;
}
void GeographicArea::setPoint(oai::model::GeographicalCoordinates const& value)
{
    m_Point = value;
}
...
oai::model::UncertaintyEllipse GeographicArea::getUncertaintyEllipse() const
{
    return m_UncertaintyEllipse;
}
void GeographicArea::setUncertaintyEllipse(oai::model::UncertaintyEllipse const& value)
{
...
std::vector<oai::model::GeographicalCoordinates> GeographicArea::getPointList() const
{
    return m_PointList;
}
void GeographicArea::setPointList(std::vector<oai::model::GeographicalCoordinates> const& value)
{
    m_PointList = value;
}
...
int32_t GeographicArea::getVConfidence() const
{
    return m_VConfidence;
}
void GeographicArea::setVConfidence(int32_t const value)
{
    m_VConfidence = value;
    m_VConfidenceIsSet = true;
}
bool GeographicArea::vConfidenceIsSet() const
{
    return m_VConfidenceIsSet;
}
void GeographicArea::unsetVConfidence()
{
    m_VConfidenceIsSet = false;
}
