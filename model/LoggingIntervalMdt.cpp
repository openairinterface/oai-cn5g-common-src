...
LoggingIntervalMdt_anyOf::eLoggingIntervalMdt_anyOf LoggingIntervalMdt::getEnumValue() const
{
    return m_value.getValue();
}

void LoggingIntervalMdt::setEnumValue(LoggingIntervalMdt_anyOf::eLoggingIntervalMdt_anyOf  value)
{
