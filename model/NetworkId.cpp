...
bool NetworkId::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
...
bool NetworkId::operator==(const NetworkId& rhs) const
{
    ...
    ((!mncIsSet() && !rhs.mncIsSet()) || (mncIsSet() && rhs.mncIsSet() && getMnc() == rhs.getMnc())) &&
    
    
    ((!mccIsSet() && !rhs.mccIsSet()) || (mccIsSet() && rhs.mccIsSet() && getMcc() == rhs.getMcc()))
