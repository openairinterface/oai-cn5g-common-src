...
bool SnssaiExtension::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "SnssaiExtension" : pathPrefix;

         
    if (sdRangesIsSet())
    {
        const std::vector<oai::_3gpp::model::SdRange>& value = m_SdRanges;
        ...
        { // Recursive validation of array elements
            ...
            int i = 0;
            for (const oai::_3gpp::model::SdRange& value : value)
            { 
                const std::string currentValuePath = oldValuePath + "[" + std::to_string(i) + "]";
                        
        success = value.validate(msg, currentValuePath + ".sdRanges") && success;
...
bool SnssaiExtension::operator==(const SnssaiExtension& rhs) const
{
    ...
    ((!sdRangesIsSet() && !rhs.sdRangesIsSet()) || (sdRangesIsSet() && rhs.sdRangesIsSet() && getSdRanges() == rhs.getSdRanges())) &&
    
    
    ((!wildcardSdIsSet() && !rhs.wildcardSdIsSet()) || (wildcardSdIsSet() && rhs.wildcardSdIsSet() && isWildcardSd() == rhs.isWildcardSd()))
...
std::vector<oai::_3gpp::model::SdRange> SnssaiExtension::getSdRanges() const
{
    return m_SdRanges;
}
void SnssaiExtension::setSdRanges(std::vector<oai::_3gpp::model::SdRange> const& value)
{
    m_SdRanges = value;
