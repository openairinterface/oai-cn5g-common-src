...
bool HandoverCommandMsg::getNasSecurityParametersFromNgRan(
  ...
  if (!m_NasSecurityParametersFromNgRan.has_value())
    return false;
...
bool HandoverCommandMsg::getPduSessionResourceToReleaseListHOCmd(
  ...
  if (!m_PduSessionResourceToReleaseListHOCmd.has_value())
    return false;
...
void HandoverCommandMsg::setTargetToSourceTransparentContainer(
  ...
  ngap_utils::octet_string_copy(m_TargetToSourceTransparentContainer,
                                targetTosource);
