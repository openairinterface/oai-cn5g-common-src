...
bool SpatialValidity::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "SpatialValidity" : pathPrefix;
...
std::map<std::string, oai::model::common::PresenceInfo> SpatialValidity::getPresenceInfoList() const
{
    return m_PresenceInfoList;
}
void SpatialValidity::setPresenceInfoList(std::map<std::string, oai::model::common::PresenceInfo> const& value)
{
