...
public:
    ...
    /// 
    /// </summary>
    oai::model::CellGlobalId getCgi() const;
    void setCgi(oai::model::CellGlobalId const& value);
    bool cgiIsSet() const;
    void unsetCgi();
    /// <summary>
    /// 
    /// </summary>
    oai::model::ServiceAreaId getSai() const;
    void setSai(oai::model::ServiceAreaId const& value);
    bool saiIsSet() const;
    void unsetSai();
    /// <summary>
    /// 
    /// </summary>
    oai::model::LocationAreaId getLai() const;
    void setLai(oai::model::LocationAreaId const& value);
    bool laiIsSet() const;
    void unsetLai();
    /// <summary>
    /// 
    /// </summary>
    oai::model::RoutingAreaId getRai() const;
    void setRai(oai::model::RoutingAreaId const& value);
    bool raiIsSet() const;
    void unsetRai();
    /// <summary>
...
protected:
    oai::model::CellGlobalId m_Cgi;
    bool m_CgiIsSet;
    oai::model::ServiceAreaId m_Sai;
    bool m_SaiIsSet;
    oai::model::LocationAreaId m_Lai;
    bool m_LaiIsSet;
    oai::model::RoutingAreaId m_Rai;
    bool m_RaiIsSet;
