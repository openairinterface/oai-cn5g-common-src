...
bool IpReachability_anyOf::validate(
    std::stringstream& msg, const std::string& pathPrefix) const {
  bool success = true;
  const std::string _pathPrefix =
      pathPrefix.empty() ? "IpReachability_anyOf" : pathPrefix;

  if (m_value == IpReachability_anyOf::eIpReachability_anyOf::
...
void to_json(nlohmann::json& j, const IpReachability_anyOf& o) {
  ...
  switch (o.getValue()) {
    case IpReachability_anyOf::eIpReachability_anyOf::
        INVALID_VALUE_OPENAPI_GENERATED:
...
IpReachability_anyOf::eIpReachability_anyOf IpReachability_anyOf::getValue()
    const {
  return m_value;
}
void IpReachability_anyOf::setValue(
