...
public:
    ...
    /// 
    /// </summary>
    std::vector<oai::model::IpEthFlowDescription> getFDescs() const;
    void setFDescs(std::vector<oai::model::IpEthFlowDescription> const& value);
...
protected:
    ...
    std::string m_AppId;
    bool m_AppIdIsSet;
    std::vector<oai::model::IpEthFlowDescription> m_FDescs;
    bool m_FDescsIsSet;
    int64_t m_UlVol;
    bool m_UlVolIsSet;
