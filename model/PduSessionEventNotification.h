...
public:
    ...
    /// 
    /// </summary>
    oai::_3gpp::model::AfEventNotification getEvNotif() const;
    void setEvNotif(oai::_3gpp::model::AfEventNotification const& value);
    /// <summary>
    ...
    /// 
    /// </summary>
    oai::_3gpp::model::PduSessionStatus getStatus() const;
    void setStatus(oai::_3gpp::model::PduSessionStatus const& value);
    bool statusIsSet() const;
    void unsetStatus();
    /// <summary>
    /// 
    /// </summary>
    oai::_3gpp::model::PcfAddressingInfo getPcfInfo() const;
    void setPcfInfo(oai::_3gpp::model::PcfAddressingInfo const& value);
...
protected:
    oai::_3gpp::model::AfEventNotification m_EvNotif;
    ...
    std::string m_UeMac;
    bool m_UeMacIsSet;
    oai::_3gpp::model::PduSessionStatus m_Status;
    bool m_StatusIsSet;
    oai::_3gpp::model::PcfAddressingInfo m_PcfInfo;
    bool m_PcfInfoIsSet;
    std::string m_Dnn;
    bool m_DnnIsSet;
