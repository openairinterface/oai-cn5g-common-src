...
SteeringFunctionality_anyOf::eSteeringFunctionality_anyOf SteeringFunctionality::getEnumValue() const
{
    return m_value.getValue();
}

void SteeringFunctionality::setEnumValue(SteeringFunctionality_anyOf::eSteeringFunctionality_anyOf  value)
{
