...
public:
    ...
    /// 
    /// </summary>
    std::vector<oai::_3gpp::model::CollectiveBehaviourFilter> getCollAttrs() const;
    void setCollAttrs(std::vector<oai::_3gpp::model::CollectiveBehaviourFilter> const& value);
