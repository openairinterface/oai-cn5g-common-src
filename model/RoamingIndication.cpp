...
RoamingIndication_anyOf::eRoamingIndication_anyOf RoamingIndication::getEnumValue() const
{
    return m_value.getValue();
}

void RoamingIndication::setEnumValue(RoamingIndication_anyOf::eRoamingIndication_anyOf  value)
{
