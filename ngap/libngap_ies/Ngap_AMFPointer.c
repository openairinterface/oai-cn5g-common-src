...
int Ngap_AMFPointer_constraint(const asn_TYPE_descriptor_t *td,
                               const void *sptr,
...
static asn_oer_constraints_t asn_OER_type_Ngap_AMFPointer_constr_1
    CC_NOTUSED = {{0, 0}, 6 /* (SIZE(6..6)) */};
