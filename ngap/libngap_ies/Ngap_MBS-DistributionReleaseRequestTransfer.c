...
static asn_TYPE_member_t
    asn_MBR_Ngap_MBS_DistributionReleaseRequestTransfer_1[] = {
        {ATF_POINTER,
         0,
         offsetof(
             struct Ngap_MBS_DistributionReleaseRequestTransfer, mBS_SessionID),
        ...
        {ATF_POINTER,
         2,
         offsetof(
             struct Ngap_MBS_DistributionReleaseRequestTransfer,
             mBS_AreaSessionID),
        ...
        {ATF_POINTER,
         0,
         offsetof(struct Ngap_MBS_DistributionReleaseRequestTransfer, cause),
        ...
        {ATF_POINTER,
         1,
         offsetof(
             struct Ngap_MBS_DistributionReleaseRequestTransfer, iE_Extensions),
         (ASN_TAG_CLASS_CONTEXT | (4 << 2)),
         -1, /* IMPLICIT tag at current level */
         &asn_DEF_Ngap_ProtocolExtensionContainer_12929P167,
         0,
         {
#if !defined(ASN_DISABLE_OER_SUPPORT)
             0,
...
static const int asn_MAP_Ngap_MBS_DistributionReleaseRequestTransfer_oms_1[] = {
    1, 2, 4};
...
static asn_SEQUENCE_specifics_t
    asn_SPC_Ngap_MBS_DistributionReleaseRequestTransfer_specs_1 = {
        ...
        asn_MAP_Ngap_MBS_DistributionReleaseRequestTransfer_oms_1, /* Optional
                                                                      members */
        3,
        0, /* Root/Additions */
...
asn_TYPE_descriptor_t asn_DEF_Ngap_MBS_DistributionReleaseRequestTransfer = {
    ...
    asn_MBR_Ngap_MBS_DistributionReleaseRequestTransfer_1,
    5, /* Elements count */
    &asn_SPC_Ngap_MBS_DistributionReleaseRequestTransfer_specs_1 /* Additional
                                                                    specs */
};
