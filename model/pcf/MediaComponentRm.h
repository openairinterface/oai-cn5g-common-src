...
public:
    ...
    /// </summary>
    std::map<std::string, oai::model::pcf::MediaSubComponentRm> getMedSubComps() const;
    void setMedSubComps(std::map<std::string, oai::model::pcf::MediaSubComponentRm> const& value);
