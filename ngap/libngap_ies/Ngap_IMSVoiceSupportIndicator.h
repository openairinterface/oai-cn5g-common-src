...
extern const asn_INTEGER_specifics_t
    asn_SPC_Ngap_IMSVoiceSupportIndicator_specs_1;
...
cbor_type_decoder_f Ngap_IMSVoiceSupportIndicator_decode_cbor;
cbor_type_encoder_f Ngap_IMSVoiceSupportIndicator_encode_cbor;
