...
bool IndirectDataForwardingTunnelInfo::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "IndirectDataForwardingTunnelInfo" : pathPrefix;
...
bool IndirectDataForwardingTunnelInfo::operator==(const IndirectDataForwardingTunnelInfo& rhs) const
{
    return
    ...
    ((!drbIdIsSet() && !rhs.drbIdIsSet()) || (drbIdIsSet() && rhs.drbIdIsSet() && getDrbId() == rhs.getDrbId())) &&
    
    
    ((!additionalTnlNbIsSet() && !rhs.additionalTnlNbIsSet()) || (additionalTnlNbIsSet() && rhs.additionalTnlNbIsSet() && getAdditionalTnlNb() == rhs.getAdditionalTnlNb()))
...
oai::_3gpp::model::Ipv6Addr IndirectDataForwardingTunnelInfo::getIpv6Addr() const
{
    return m_Ipv6Addr;
}
void IndirectDataForwardingTunnelInfo::setIpv6Addr(oai::_3gpp::model::Ipv6Addr const& value)
{
    m_Ipv6Addr = value;
