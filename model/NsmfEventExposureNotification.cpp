...
bool NsmfEventExposureNotification::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "NsmfEventExposureNotification" : pathPrefix;
...
bool NsmfEventExposureNotification::operator==(const NsmfEventExposureNotification& rhs) const
{
    return
    ...
    ((!ackUriIsSet() && !rhs.ackUriIsSet()) || (ackUriIsSet() && rhs.ackUriIsSet() && getAckUri() == rhs.getAckUri()))
...
std::vector<oai::model::EventNotification> NsmfEventExposureNotification::getEventNotifs() const
{
    return m_EventNotifs;
}
void NsmfEventExposureNotification::setEventNotifs(std::vector<oai::model::EventNotification> const& value)
{
    m_EventNotifs = value;
}
