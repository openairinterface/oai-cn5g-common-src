...
bool ExceptionInfo::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "ExceptionInfo" : pathPrefix;

                 
    
    /* Exceps */ {
        const std::vector<oai::_3gpp::model::Exception>& value = m_Exceps;
...
oai::_3gpp::model::FlowInfo ExceptionInfo::getIpTrafficFilter() const
{
    return m_IpTrafficFilter;
}
void ExceptionInfo::setIpTrafficFilter(oai::_3gpp::model::FlowInfo const& value)
{
...
oai::_3gpp::model::EthFlowDescription ExceptionInfo::getEthTrafficFilter() const
{
    return m_EthTrafficFilter;
}
void ExceptionInfo::setEthTrafficFilter(oai::_3gpp::model::EthFlowDescription const& value)
{
...
std::vector<oai::_3gpp::model::Exception> ExceptionInfo::getExceps() const
{
    return m_Exceps;
}
void ExceptionInfo::setExceps(std::vector<oai::_3gpp::model::Exception> const& value)
{
    m_Exceps = value;
}
