...
public:
    ...
    /// </summary>
    std::map<std::string, oai::model::CandidateForReplacement> getCandidates() const;
    void setCandidates(std::map<std::string, oai::model::CandidateForReplacement> const& value);
    ...
    /// 
    /// </summary>
    oai::model::Snssai getMappingSnssai() const;
    void setMappingSnssai(oai::model::Snssai const& value);
...
protected:
    ...
    std::map<std::string, oai::model::CandidateForReplacement> m_Candidates;
    bool m_CandidatesIsSet;
    oai::model::Snssai m_Snssai;
    bool m_SnssaiIsSet;
    oai::model::Snssai m_MappingSnssai;
