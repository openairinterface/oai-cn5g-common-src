...
public:
    ...
    /// </summary>
    std::vector<oai::model::FlowInformation> getSdfDescriptions() const;
    void setSdfDescriptions(std::vector<oai::model::FlowInformation> const& value);
...
protected:
    ...
    std::vector<oai::model::FlowInformation> m_SdfDescriptions;
