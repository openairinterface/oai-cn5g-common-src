...
public:
    ...
    /// 
    /// </summary>
    std::vector<oai::_3gpp::model::QueryParamCombination> getQueryParamCombinationList() const;
    void setQueryParamCombinationList(std::vector<oai::_3gpp::model::QueryParamCombination> const& value);
...
protected:
    ...
    std::vector<oai::_3gpp::model::QueryParamCombination> m_QueryParamCombinationList;
