...
bool UeN1N2InfoSubscriptionCreatedData::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "UeN1N2InfoSubscriptionCreatedData" : pathPrefix;
...
bool UeN1N2InfoSubscriptionCreatedData::operator==(const UeN1N2InfoSubscriptionCreatedData& rhs) const
{
    return
