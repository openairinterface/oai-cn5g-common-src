...
bool UpConfidentiality::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "UpConfidentiality" : pathPrefix;
...
void UpConfidentiality::setEnumValue(UpIntegrity_anyOf::eUpIntegrity_anyOf  value)
{
