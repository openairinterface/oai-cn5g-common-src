...
bool TerminationCause::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "TerminationCause" : pathPrefix;
...
TerminationCause_anyOf::eTerminationCause_anyOf TerminationCause::getEnumValue() const
{
    return m_value.getValue();
}

void TerminationCause::setEnumValue(TerminationCause_anyOf::eTerminationCause_anyOf  value)
{
