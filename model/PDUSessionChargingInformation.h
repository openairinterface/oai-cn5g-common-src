...
public:
    ...
    void setMAPDUNon3GPPUserLocationInfo(oai::_3gpp::model::UserLocation const& value);
    ...
    void setPduSessionInformation(oai::_3gpp::model::PDUSessionInformation const& value);
    /// <summary>
    ...
    /// 
    /// </summary>
    oai::_3gpp::model::RANSecondaryRATUsageReport getRANSecondaryRATUsageReport() const;
    void setRANSecondaryRATUsageReport(oai::_3gpp::model::RANSecondaryRATUsageReport const& value);
