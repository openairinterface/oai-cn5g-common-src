...
bool MediaSubComponent::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "MediaSubComponent" : pathPrefix;

             
    if (ethfDescsIsSet())
    {
        const std::vector<oai::_3gpp::model::EthFlowDescription>& value = m_EthfDescs;
    ...
    if (fDescsIsSet())
    {
        const std::vector<oai::_3gpp::model::std::string>& value = m_FDescs;
...
oai::_3gpp::model::AfSigProtocol MediaSubComponent::getAfSigProtocol() const
{
    return m_AfSigProtocol;
}
void MediaSubComponent::setAfSigProtocol(oai::_3gpp::model::AfSigProtocol const& value)
{
...
std::vector<oai::_3gpp::model::EthFlowDescription> MediaSubComponent::getEthfDescs() const
{
    return m_EthfDescs;
}
void MediaSubComponent::setEthfDescs(std::vector<oai::_3gpp::model::EthFlowDescription> const& value)
{
    m_EthfDescs = value;
...
std::vector<oai::_3gpp::model::std::string> MediaSubComponent::getFDescs() const
{
    return m_FDescs;
}
void MediaSubComponent::setFDescs(std::vector<oai::_3gpp::model::std::string> const& value)
{
    m_FDescs = value;
    m_FDescsIsSet = true;
}
...
oai::_3gpp::model::FlowStatus MediaSubComponent::getFStatus() const
{
    return m_FStatus;
}
void MediaSubComponent::setFStatus(oai::_3gpp::model::FlowStatus const& value)
{
    m_FStatus = value;
    m_FStatusIsSet = true;
}
...
oai::_3gpp::model::FlowUsage MediaSubComponent::getFlowUsage() const
{
    return m_FlowUsage;
}
void MediaSubComponent::setFlowUsage(oai::_3gpp::model::FlowUsage const& value)
{
    m_FlowUsage = value;
