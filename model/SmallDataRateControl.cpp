...
oai::_3gpp::model::SmallDataRateControlTimeUnit SmallDataRateControl::getTimeUnit() const
{
    return m_TimeUnit;
}
void SmallDataRateControl::setTimeUnit(oai::_3gpp::model::SmallDataRateControlTimeUnit const& value)
{
    m_TimeUnit = value;
}
