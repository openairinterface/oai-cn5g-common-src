...
//------------------------------------------------------------------------------
void SNssai::SetSNSSAI(uint8_t sst, uint32_t sd, uint8_t mapped_hplmn_sst,
...
//------------------------------------------------------------------------------
void SNssai::SetSNSSAI(std::optional<int8_t> iei, uint8_t sst, uint32_t sd,
...
int SNssai::Encode(uint8_t *buf, int len) const {
  ...
  oai::logger::logger_common::nas().debug("Encoded header %s, len (%d)",
...
int SNssai::Decode(uint8_t *buf, int len, const bool is_iei) {
  ...
  oai::logger::logger_common::nas().debug("Decoded S-NSSAI %s",
                                          ToString().c_str());
