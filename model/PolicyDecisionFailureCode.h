...
public:
    ...
    PolicyDecisionFailureCode_anyOf::ePolicyDecisionFailureCode_anyOf getEnumValue() const;
    void setEnumValue(PolicyDecisionFailureCode_anyOf::ePolicyDecisionFailureCode_anyOf value);
