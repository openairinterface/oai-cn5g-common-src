...
bool PacketFilterInfo::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "PacketFilterInfo" : pathPrefix;
...
bool PacketFilterInfo::operator==(const PacketFilterInfo& rhs) const
{
    ...
    ((!packFiltContIsSet() && !rhs.packFiltContIsSet()) || (packFiltContIsSet() && rhs.packFiltContIsSet() && getPackFiltCont() == rhs.getPackFiltCont())) &&
...
oai::_3gpp::model::FlowDirection PacketFilterInfo::getFlowDirection() const
{
    return m_FlowDirection;
}
void PacketFilterInfo::setFlowDirection(oai::_3gpp::model::FlowDirection const& value)
{
