...
std::vector<oai::_3gpp::model::EthFlowDescription> TrafficInfluDataPatch::getEthTrafficFilters() const
{
    return m_EthTrafficFilters;
}
void TrafficInfluDataPatch::setEthTrafficFilters(std::vector<oai::_3gpp::model::EthFlowDescription> const& value)
{
...
std::vector<oai::_3gpp::model::FlowInfo> TrafficInfluDataPatch::getTrafficFilters() const
{
    return m_TrafficFilters;
}
void TrafficInfluDataPatch::setTrafficFilters(std::vector<oai::_3gpp::model::FlowInfo> const& value)
{
...
std::vector<oai::_3gpp::model::RouteToLocation> TrafficInfluDataPatch::getTrafficRoutes() const
{
    return m_TrafficRoutes;
}
void TrafficInfluDataPatch::setTrafficRoutes(std::vector<oai::_3gpp::model::RouteToLocation> const& value)
{
...
std::vector<oai::_3gpp::model::TemporalValidity> TrafficInfluDataPatch::getTempValidities() const
{
    return m_TempValidities;
}
void TrafficInfluDataPatch::setTempValidities(std::vector<oai::_3gpp::model::TemporalValidity> const& value)
{
...
oai::_3gpp::model::NetworkAreaInfo_2 TrafficInfluDataPatch::getNwAreaInfo() const
{
    return m_NwAreaInfo;
}
void TrafficInfluDataPatch::setNwAreaInfo(oai::_3gpp::model::NetworkAreaInfo_2 const& value)
{
    m_NwAreaInfo = value;
