...
public:
    ...
    /// 
    /// </summary>
    oai::model::Ipv6Addr getIpv6Address() const;
    void setIpv6Address(oai::model::Ipv6Addr const& value);
    bool ipv6AddressIsSet() const;
    void unsetIpv6Address();
    /// <summary>
    /// 
    /// </summary>
    oai::model::TransportProtocol_1 getTransport() const;
    void setTransport(oai::model::TransportProtocol_1 const& value);
...
protected:
    ...
    oai::model::Ipv6Addr m_Ipv6Address;
    bool m_Ipv6AddressIsSet;
    oai::model::TransportProtocol_1 m_Transport;
