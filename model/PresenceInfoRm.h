...
public:
    ...
    /// 
    /// </summary>
    oai::model::PresenceState getPresenceState() const;
    void setPresenceState(oai::model::PresenceState const& value);
    ...
    /// </summary>
    std::vector<oai::model::Tai> getTrackingAreaList() const;
    void setTrackingAreaList(std::vector<oai::model::Tai> const& value);
    ...
    /// </summary>
    std::vector<oai::model::Ecgi> getEcgiList() const;
    void setEcgiList(std::vector<oai::model::Ecgi> const& value);
    ...
    /// </summary>
    std::vector<oai::model::Ncgi> getNcgiList() const;
    void setNcgiList(std::vector<oai::model::Ncgi> const& value);
    ...
    /// </summary>
    std::vector<oai::model::GlobalRanNodeId> getGlobalRanNodeIdList() const;
    void setGlobalRanNodeIdList(std::vector<oai::model::GlobalRanNodeId> const& value);
    ...
    /// </summary>
    std::vector<oai::model::GlobalRanNodeId> getGlobaleNbIdList() const;
    void setGlobaleNbIdList(std::vector<oai::model::GlobalRanNodeId> const& value);
...
protected:
    ...
    oai::model::PresenceState m_PresenceState;
    bool m_PresenceStateIsSet;
    std::vector<oai::model::Tai> m_TrackingAreaList;
    bool m_TrackingAreaListIsSet;
    std::vector<oai::model::Ecgi> m_EcgiList;
    bool m_EcgiListIsSet;
    std::vector<oai::model::Ncgi> m_NcgiList;
    bool m_NcgiListIsSet;
    std::vector<oai::model::GlobalRanNodeId> m_GlobalRanNodeIdList;
    bool m_GlobalRanNodeIdListIsSet;
    std::vector<oai::model::GlobalRanNodeId> m_GlobaleNbIdList;
