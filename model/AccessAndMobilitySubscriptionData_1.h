...
class AccessAndMobilitySubscriptionData_1 {
 public:
  ...
  ///
  /// </summary>
  oai::_3gpp::model::ExpectedUeBehaviourData_1 getExpectedUeBehaviourList()
      const;
  ...
  ///
  /// </summary>
  std::vector<oai::_3gpp::model::EdrxParameters_1> getEdrxParametersList()
      const;
  ...
  ///
  /// </summary>
  std::vector<oai::_3gpp::model::WirelineArea_1> getWirelineForbiddenAreas()
      const;
  ...
  void setPcfSelectionAssistanceInfos(
      std::vector<oai::_3gpp::model::PcfSelectionAssistanceInfo_1> const&
          value);
  ...
  friend void to_json(
      nlohmann::json& j, const AccessAndMobilitySubscriptionData_1& o);
