...
oai::_3gpp::model::ServAuthInfo AppSessionContextRespData::getServAuthInfo() const
{
    return m_ServAuthInfo;
}
void AppSessionContextRespData::setServAuthInfo(oai::_3gpp::model::ServAuthInfo const& value)
{
...
std::vector<oai::_3gpp::model::UeIdentityInfo> AppSessionContextRespData::getUeIds() const
{
    return m_UeIds;
}
void AppSessionContextRespData::setUeIds(std::vector<oai::_3gpp::model::UeIdentityInfo> const& value)
{
    m_UeIds = value;
    m_UeIdsIsSet = true;
}
