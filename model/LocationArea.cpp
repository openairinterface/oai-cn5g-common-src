...
std::vector<oai::_3gpp::model::GeographicArea> LocationArea::getGeographicAreas() const
{
    return m_GeographicAreas;
}
void LocationArea::setGeographicAreas(std::vector<oai::_3gpp::model::GeographicArea> const& value)
{
...
std::vector<oai::_3gpp::model::CivicAddress> LocationArea::getCivicAddresses() const
{
    return m_CivicAddresses;
}
void LocationArea::setCivicAddresses(std::vector<oai::_3gpp::model::CivicAddress> const& value)
{
...
void LocationArea::setNwAreaInfo(oai::_3gpp::model::NetworkAreaInfo_1 const& value)
{
    m_NwAreaInfo = value;
