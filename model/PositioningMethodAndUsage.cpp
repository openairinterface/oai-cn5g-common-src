...
oai::_3gpp::model::PositioningMethod PositioningMethodAndUsage::getMethod() const
{
    return m_Method;
}
void PositioningMethodAndUsage::setMethod(oai::_3gpp::model::PositioningMethod const& value)
{
    m_Method = value;
}
...
void PositioningMethodAndUsage::setMode(oai::_3gpp::model::PositioningMode const& value)
{
    m_Mode = value;
}
...
void PositioningMethodAndUsage::setUsage(oai::_3gpp::model::Usage const& value)
{
    m_Usage = value;
}
