...
std::vector<oai::_3gpp::model::UeTrajectoryInfo> UeMobilityInfo::getUeTrajs() const
{
    return m_UeTrajs;
}
void UeMobilityInfo::setUeTrajs(std::vector<oai::_3gpp::model::UeTrajectoryInfo> const& value)
{
    m_UeTrajs = value;
}
