...
public:
    ...
    void setSessRules(std::map<std::string, oai::_3gpp::model::SessionRule> const& value);
    ...
    void setPccRules(std::map<std::string, oai::_3gpp::model::PccRule> const& value);
    ...
    void setQosDecs(std::map<std::string, oai::_3gpp::model::QosData> const& value);
    ...
    void setChgDecs(std::map<std::string, oai::_3gpp::model::ChargingData> const& value);
    ...
    /// </summary>
    std::map<std::string, oai::_3gpp::model::TrafficControlData> getTraffContDecs() const;
    void setTraffContDecs(std::map<std::string, oai::_3gpp::model::TrafficControlData> const& value);
    ...
    /// </summary>
    std::map<std::string, oai::_3gpp::model::UsageMonitoringData> getUmDecs() const;
    void setUmDecs(std::map<std::string, oai::_3gpp::model::UsageMonitoringData> const& value);
    bool umDecsIsSet() const;
    void unsetUmDecs();
    /// <summary>
    /// Map of QoS characteristics for non standard 5QIs. This map uses the 5QI values as keys.
    /// </summary>
    std::map<std::string, oai::_3gpp::model::QosCharacteristics> getQosChars() const;
    void setQosChars(std::map<std::string, oai::_3gpp::model::QosCharacteristics> const& value);
    ...
    /// </summary>
    std::map<std::string, oai::_3gpp::model::QosMonitoringData> getQosMonDecs() const;
    void setQosMonDecs(std::map<std::string, oai::_3gpp::model::QosMonitoringData> const& value);
    ...
    void setConds(std::map<std::string, oai::_3gpp::model::ConditionData> const& value);
    ...
    /// </summary>
    std::vector<oai::_3gpp::model::PolicyControlRequestTrigger> getPolicyCtrlReqTriggers() const;
    void setPolicyCtrlReqTriggers(std::vector<oai::_3gpp::model::PolicyControlRequestTrigger> const& value);
    ...
    void setLastReqRuleData(std::vector<oai::_3gpp::model::RequestedRuleData> const& value);
    ...
    void setPraInfos(std::map<std::string, oai::_3gpp::model::PresenceInfoRm> const& value);
    ...
    void setRelCause(oai::_3gpp::model::SmPolicyAssociationReleaseCause const& value);
...
protected:
    ...
    std::vector<oai::_3gpp::model::PolicyControlRequestTrigger> m_PolicyCtrlReqTriggers;
