...
bool GeraLocation::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "GeraLocation" : pathPrefix;
...
bool GeraLocation::operator==(const GeraLocation& rhs) const
{
    ...
    ((!locationNumberIsSet() && !rhs.locationNumberIsSet()) || (locationNumberIsSet() && rhs.locationNumberIsSet() && getLocationNumber() == rhs.getLocationNumber())) &&
    
    
    ((!cgiIsSet() && !rhs.cgiIsSet()) || (cgiIsSet() && rhs.cgiIsSet() && getCgi() == rhs.getCgi())) &&
    
    
    ((!saiIsSet() && !rhs.saiIsSet()) || (saiIsSet() && rhs.saiIsSet() && getSai() == rhs.getSai())) &&
    
    
    ((!laiIsSet() && !rhs.laiIsSet()) || (laiIsSet() && rhs.laiIsSet() && getLai() == rhs.getLai())) &&
    
    
    ((!raiIsSet() && !rhs.raiIsSet()) || (raiIsSet() && rhs.raiIsSet() && getRai() == rhs.getRai())) &&
    
    
    ((!vlrNumberIsSet() && !rhs.vlrNumberIsSet()) || (vlrNumberIsSet() && rhs.vlrNumberIsSet() && getVlrNumber() == rhs.getVlrNumber())) &&
    
    
    ((!mscNumberIsSet() && !rhs.mscNumberIsSet()) || (mscNumberIsSet() && rhs.mscNumberIsSet() && getMscNumber() == rhs.getMscNumber())) &&
...
oai::model::CellGlobalId GeraLocation::getCgi() const
{
    return m_Cgi;
}
void GeraLocation::setCgi(oai::model::CellGlobalId const& value)
{
    m_Cgi = value;
    m_CgiIsSet = true;
}
...
oai::model::ServiceAreaId GeraLocation::getSai() const
{
    return m_Sai;
}
void GeraLocation::setSai(oai::model::ServiceAreaId const& value)
{
    m_Sai = value;
    m_SaiIsSet = true;
}
...
oai::model::LocationAreaId GeraLocation::getLai() const
{
    return m_Lai;
}
void GeraLocation::setLai(oai::model::LocationAreaId const& value)
{
    m_Lai = value;
    m_LaiIsSet = true;
}
...
oai::model::RoutingAreaId GeraLocation::getRai() const
{
    return m_Rai;
}
void GeraLocation::setRai(oai::model::RoutingAreaId const& value)
{
    m_Rai = value;
    m_RaiIsSet = true;
}
