...
bool NetworkPerfType_anyOf::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "NetworkPerfType_anyOf" : pathPrefix;

    
    if (m_value == NetworkPerfType_anyOf::eNetworkPerfType_anyOf::INVALID_VALUE_OPENAPI_GENERATED)
    {
        success = false;
...
void to_json(nlohmann::json& j, const NetworkPerfType_anyOf& o)
{
    ...
    switch (o.getValue())
    {
        case NetworkPerfType_anyOf::eNetworkPerfType_anyOf::INVALID_VALUE_OPENAPI_GENERATED:
...
void from_json(const nlohmann::json& j, NetworkPerfType_anyOf& o)
{
    ...
    if (s == "GNB_ACTIVE_RATIO") {
     ...
     o.setValue(NetworkPerfType_anyOf::eNetworkPerfType_anyOf::GNB_COMPUTING_USAGE);
    } 
...
NetworkPerfType_anyOf::eNetworkPerfType_anyOf NetworkPerfType_anyOf::getValue() const
{
    return m_value;
}
void NetworkPerfType_anyOf::setValue(NetworkPerfType_anyOf::eNetworkPerfType_anyOf value)
{
    m_value = value;
}
