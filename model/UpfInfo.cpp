...
std::vector<oai::_3gpp::model::SnssaiUpfInfoItem> UpfInfo::getSNssaiUpfInfoList() const
{
    return m_SNssaiUpfInfoList;
}
void UpfInfo::setSNssaiUpfInfoList(std::vector<oai::_3gpp::model::SnssaiUpfInfoItem> const& value)
{
...
std::vector<oai::_3gpp::model::InterfaceUpfInfoItem> UpfInfo::getInterfaceUpfInfoList() const
{
    return m_InterfaceUpfInfoList;
}
void UpfInfo::setInterfaceUpfInfoList(std::vector<oai::_3gpp::model::InterfaceUpfInfoItem> const& value)
{
...
std::vector<oai::_3gpp::model::PduSessionType> UpfInfo::getPduSessionTypes() const
{
    return m_PduSessionTypes;
}
void UpfInfo::setPduSessionTypes(std::vector<oai::_3gpp::model::PduSessionType> const& value)
{
...
oai::_3gpp::model::AtsssCapability UpfInfo::getAtsssCapability() const
{
    return m_AtsssCapability;
}
void UpfInfo::setAtsssCapability(oai::_3gpp::model::AtsssCapability const& value)
{
...
std::vector<oai::_3gpp::model::Tai> UpfInfo::getTaiList() const
{
    return m_TaiList;
}
void UpfInfo::setTaiList(std::vector<oai::_3gpp::model::Tai> const& value)
{
    m_TaiList = value;
    m_TaiListIsSet = true;
}
...
std::vector<oai::_3gpp::model::TaiRange> UpfInfo::getTaiRangeList() const
{
    return m_TaiRangeList;
}
void UpfInfo::setTaiRangeList(std::vector<oai::_3gpp::model::TaiRange> const& value)
{
...
oai::_3gpp::model::WAgfInfo UpfInfo::getWAgfInfo() const
{
    return m_WAgfInfo;
}
void UpfInfo::setWAgfInfo(oai::_3gpp::model::WAgfInfo const& value)
{
    m_WAgfInfo = value;
...
oai::_3gpp::model::TngfInfo UpfInfo::getTngfInfo() const
{
    return m_TngfInfo;
}
void UpfInfo::setTngfInfo(oai::_3gpp::model::TngfInfo const& value)
{
    m_TngfInfo = value;
...
oai::_3gpp::model::TwifInfo UpfInfo::getTwifInfo() const
{
    return m_TwifInfo;
}
void UpfInfo::setTwifInfo(oai::_3gpp::model::TwifInfo const& value)
{
    m_TwifInfo = value;
