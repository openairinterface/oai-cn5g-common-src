...
public:
    ...
    void setServiceAreaRestriction(oai::_3gpp::model::ServiceAreaRestriction const& value);
    ...
    void setExpectedUeBehaviourList(oai::_3gpp::model::ExpectedUeBehaviourData const& value);
    ...
    void setEdrxParametersList(std::vector<oai::_3gpp::model::EdrxParameters> const& value);
    ...
    void setPtwParametersList(std::vector<oai::_3gpp::model::PtwParameters> const& value);
    ...
    /// </summary>
    std::map<std::string, oai::_3gpp::model::PlmnRestriction> getAdjacentPlmnRestrictions() const;
    void setAdjacentPlmnRestrictions(std::map<std::string, oai::_3gpp::model::PlmnRestriction> const& value);
    bool adjacentPlmnRestrictionsIsSet() const;
    void unsetAdjacentPlmnRestrictions();
    /// <summary>
    /// 
    /// </summary>
    std::vector<oai::_3gpp::model::WirelineArea> getWirelineForbiddenAreas() const;
    void setWirelineForbiddenAreas(std::vector<oai::_3gpp::model::WirelineArea> const& value);
    bool wirelineForbiddenAreasIsSet() const;
    void unsetWirelineForbiddenAreas();
    /// <summary>
    /// 
    /// </summary>
    oai::_3gpp::model::WirelineServiceAreaRestriction getWirelineServiceAreaRestriction() const;
    void setWirelineServiceAreaRestriction(oai::_3gpp::model::WirelineServiceAreaRestriction const& value);
    bool wirelineServiceAreaRestrictionIsSet() const;
    void unsetWirelineServiceAreaRestriction();
    /// <summary>
    /// 
    /// </summary>
    std::vector<oai::_3gpp::model::PcfSelectionAssistanceInfo> getPcfSelectionAssistanceInfos() const;
    void setPcfSelectionAssistanceInfos(std::vector<oai::_3gpp::model::PcfSelectionAssistanceInfo> const& value);
    ...
    void setAerialUeSubInfo(oai::_3gpp::model::AerialUeSubscriptionInfo const& value);
...
protected:
    ...
    std::map<std::string, oai::_3gpp::model::PlmnRestriction> m_AdjacentPlmnRestrictions;
    ...
    oai::_3gpp::model::WirelineServiceAreaRestriction m_WirelineServiceAreaRestriction;
    bool m_WirelineServiceAreaRestrictionIsSet;
    std::vector<oai::_3gpp::model::PcfSelectionAssistanceInfo> m_PcfSelectionAssistanceInfos;
