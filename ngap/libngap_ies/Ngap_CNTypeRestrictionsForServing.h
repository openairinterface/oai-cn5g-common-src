...
/* Implementation */
extern asn_oer_constraints_t asn_OER_type_Ngap_CNTypeRestrictionsForServing_constr_1;
...
cbor_type_decoder_f Ngap_CNTypeRestrictionsForServing_decode_cbor;
cbor_type_encoder_f Ngap_CNTypeRestrictionsForServing_encode_cbor;
