...
public:
    ...
    /// 
    /// </summary>
    oai::model::EutraLocation getEutraLocation() const;
    void setEutraLocation(oai::model::EutraLocation const& value);
    bool eutraLocationIsSet() const;
    void unsetEutraLocation();
    /// <summary>
    /// 
    /// </summary>
    oai::model::NrLocation getNrLocation() const;
    void setNrLocation(oai::model::NrLocation const& value);
    ...
    /// 
    /// </summary>
    oai::model::UtraLocation getUtraLocation() const;
    void setUtraLocation(oai::model::UtraLocation const& value);
    bool utraLocationIsSet() const;
    void unsetUtraLocation();
    /// <summary>
    /// 
    /// </summary>
    oai::model::GeraLocation getGeraLocation() const;
    void setGeraLocation(oai::model::GeraLocation const& value);
...
protected:
    oai::model::EutraLocation m_EutraLocation;
    bool m_EutraLocationIsSet;
    oai::model::NrLocation m_NrLocation;
    bool m_NrLocationIsSet;
    oai::model::N3gaLocation m_N3gaLocation;
    bool m_N3gaLocationIsSet;
    oai::model::UtraLocation m_UtraLocation;
    bool m_UtraLocationIsSet;
    oai::model::GeraLocation m_GeraLocation;
