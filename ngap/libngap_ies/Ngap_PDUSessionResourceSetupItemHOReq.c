...
static asn_oer_constraints_t asn_OER_memb_Ngap_handoverRequestTransfer_constr_4 CC_NOTUSED = {
	{ 0, 0 },
	-1	/* (SIZE(0..MAX)) */};
...
asn_TYPE_member_t asn_MBR_Ngap_PDUSessionResourceSetupItemHOReq_1[] = {
	...
	{ ATF_POINTER, 0, offsetof(struct Ngap_PDUSessionResourceSetupItemHOReq, s_NSSAI),
