...
bool LocationInfoResult::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "LocationInfoResult" : pathPrefix;
...
bool LocationInfoResult::operator==(const LocationInfoResult& rhs) const
{
    ...
    ((!vPlmnIdIsSet() && !rhs.vPlmnIdIsSet()) || (vPlmnIdIsSet() && rhs.vPlmnIdIsSet() && getVPlmnId() == rhs.getVPlmnId())) &&
    
    
    ((!amfInstanceIdIsSet() && !rhs.amfInstanceIdIsSet()) || (amfInstanceIdIsSet() && rhs.amfInstanceIdIsSet() && getAmfInstanceId() == rhs.getAmfInstanceId())) &&
    
    
    ((!smsfInstanceIdIsSet() && !rhs.smsfInstanceIdIsSet()) || (smsfInstanceIdIsSet() && rhs.smsfInstanceIdIsSet() && getSmsfInstanceId() == rhs.getSmsfInstanceId())) &&
    ...
    ((!taiIsSet() && !rhs.taiIsSet()) || (taiIsSet() && rhs.taiIsSet() && getTai() == rhs.getTai())) &&
    
    
    ((!currentLocIsSet() && !rhs.currentLocIsSet()) || (currentLocIsSet() && rhs.currentLocIsSet() && isCurrentLoc() == rhs.isCurrentLoc())) &&
    
    
    ((!geoInfoIsSet() && !rhs.geoInfoIsSet()) || (geoInfoIsSet() && rhs.geoInfoIsSet() && getGeoInfo() == rhs.getGeoInfo())) &&
    
    
    ((!locationAgeIsSet() && !rhs.locationAgeIsSet()) || (locationAgeIsSet() && rhs.locationAgeIsSet() && getLocationAge() == rhs.getLocationAge())) &&
...
oai::model::PlmnId LocationInfoResult::getVPlmnId() const
{
    return m_VPlmnId;
}
void LocationInfoResult::setVPlmnId(oai::model::PlmnId const& value)
{
    m_VPlmnId = value;
    m_VPlmnIdIsSet = true;
}
...
oai::model::Ncgi LocationInfoResult::getNcgi() const
{
    return m_Ncgi;
}
void LocationInfoResult::setNcgi(oai::model::Ncgi const& value)
{
    m_Ncgi = value;
    m_NcgiIsSet = true;
}
...
oai::model::Ecgi LocationInfoResult::getEcgi() const
{
    return m_Ecgi;
}
void LocationInfoResult::setEcgi(oai::model::Ecgi const& value)
{
    m_Ecgi = value;
    m_EcgiIsSet = true;
}
...
oai::model::Tai LocationInfoResult::getTai() const
{
    return m_Tai;
}
void LocationInfoResult::setTai(oai::model::Tai const& value)
{
    m_Tai = value;
    m_TaiIsSet = true;
}
...
oai::model::GeographicArea LocationInfoResult::getGeoInfo() const
{
    return m_GeoInfo;
}
void LocationInfoResult::setGeoInfo(oai::model::GeographicArea const& value)
{
    m_GeoInfo = value;
    m_GeoInfoIsSet = true;
}
...
oai::model::RatType LocationInfoResult::getRatType() const
{
    return m_RatType;
}
void LocationInfoResult::setRatType(oai::model::RatType const& value)
{
    m_RatType = value;
    m_RatTypeIsSet = true;
}
