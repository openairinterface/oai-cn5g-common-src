...
public:
    ...
    /// </summary>
    std::map<std::string, oai::model::MonitoringConfiguration> getMonitoringConfigurations() const;
    void setMonitoringConfigurations(std::map<std::string, oai::model::MonitoringConfiguration> const& value);
    /// <summary>
    /// 
    /// </summary>
    oai::model::ReportingOptions getReportingOptions() const;
    void setReportingOptions(oai::model::ReportingOptions const& value);
...
protected:
    ...
    std::map<std::string, oai::model::MonitoringConfiguration> m_MonitoringConfigurations;

    oai::model::ReportingOptions m_ReportingOptions;
