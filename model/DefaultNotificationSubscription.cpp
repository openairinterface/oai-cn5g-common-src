...
bool DefaultNotificationSubscription::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    ...
    {
        const std::map<std::string, oai::_3gpp::model::DefSubServiceInfo>& value = m_ServiceInfoList;
...
oai::_3gpp::model::NotificationType DefaultNotificationSubscription::getNotificationType() const
{
    return m_NotificationType;
}
void DefaultNotificationSubscription::setNotificationType(oai::_3gpp::model::NotificationType const& value)
{
...
oai::_3gpp::model::N1MessageClass DefaultNotificationSubscription::getN1MessageClass() const
{
    return m_N1MessageClass;
}
void DefaultNotificationSubscription::setN1MessageClass(oai::_3gpp::model::N1MessageClass const& value)
{
...
oai::_3gpp::model::N2InformationClass DefaultNotificationSubscription::getN2InformationClass() const
{
    return m_N2InformationClass;
}
void DefaultNotificationSubscription::setN2InformationClass(oai::_3gpp::model::N2InformationClass const& value)
{
...
std::map<std::string, oai::_3gpp::model::DefSubServiceInfo> DefaultNotificationSubscription::getServiceInfoList() const
{
    return m_ServiceInfoList;
}
void DefaultNotificationSubscription::setServiceInfoList(std::map<std::string, oai::_3gpp::model::DefSubServiceInfo> const& value)
{
