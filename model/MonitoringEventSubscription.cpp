...
MonitoringEventSubscription::MonitoringEventSubscription() {
  ...
  m_Msisdn                          = "";
  m_MsisdnIsSet                     = false;
  m_AddedExternalIdsIsSet           = false;
  m_AddedMsisdnsIsSet               = false;
  ...
  m_RevocationNotifUri              = "";
  m_RevocationNotifUriIsSet         = false;
}
...
bool MonitoringEventSubscription::validate(
  ...
  if (addedExternalIdsIsSet()) {
    const std::vector<std::string>& value = m_AddedExternalIds;
    const std::string currentValuePath    = _pathPrefix + ".addedExternalIds";
  ...
  if (addedMsisdnsIsSet()) {
    const std::vector<std::string>& value = m_AddedMsisdns;
    const std::string currentValuePath    = _pathPrefix + ".addedMsisdns";
  ...
  if (!m_MonitoringType.validate(msg, _pathPrefix + ".monitoringType")) {
    msg << _pathPrefix << ": MonitoringType is invalid;";
    success = false;
  }
  ...
  if (supportedGADShapesIsSet()) {
    const std::vector<oai::model::SupportedGADShapes>& value =
    ...
    {  // Recursive validation of array elements
      const std::string oldValuePath = currentValuePath;
      int i                          = 0;
      for (const oai::model::SupportedGADShapes& value : value) {
        const std::string currentValuePath =
            oldValuePath + "[" + std::to_string(i) + "]";
  ...
  if (dddTraDescriptorsIsSet()) {
    const std::vector<oai::model::DddTrafficDescriptor>& value =
        m_DddTraDescriptors;
  ...
  if (dddStatiIsSet()) {
    const std::vector<oai::model::DlDataDeliveryStatus>& value = m_DddStati;
  ...
  if (addnMonTypesIsSet()) {
    const std::vector<oai::model::MonitoringType>& value = m_AddnMonTypes;
    const std::string currentValuePath = _pathPrefix + ".addnMonTypes";

    {  // Recursive validation of array elements
      const std::string oldValuePath = currentValuePath;
      int i                          = 0;
      for (const oai::model::MonitoringType& value : value) {
        const std::string currentValuePath =
            oldValuePath + "[" + std::to_string(i) + "]";
  ...
  if (addnMonEventReportsIsSet()) {
    const std::vector<oai::model::MonitoringEventReport>& value =
        m_AddnMonEventReports;
    const std::string currentValuePath = _pathPrefix + ".addnMonEventReports";

    {  // Recursive validation of array elements
      const std::string oldValuePath = currentValuePath;
      int i                          = 0;
      for (const oai::model::MonitoringEventReport& value : value) {
        const std::string currentValuePath =
            oldValuePath + "[" + std::to_string(i) + "]";
...
bool MonitoringEventSubscription::operator==(
  ...
  return
      ...
      ((!addedExternalIdsIsSet() && !rhs.addedExternalIdsIsSet()) ||
       (addedExternalIdsIsSet() && rhs.addedExternalIdsIsSet() &&
        getAddedExternalIds() == rhs.getAddedExternalIds())) &&

      ((!addedMsisdnsIsSet() && !rhs.addedMsisdnsIsSet()) ||
       (addedMsisdnsIsSet() && rhs.addedMsisdnsIsSet() &&
        getAddedMsisdns() == rhs.getAddedMsisdns())) &&
      ...
      ((!nsRepFormatIsSet() && !rhs.nsRepFormatIsSet()) ||
       (nsRepFormatIsSet() && rhs.nsRepFormatIsSet() &&
        getNsRepFormat() == rhs.getNsRepFormat())) &&
      ...
      ((!ueMacAddrIsSet() && !rhs.ueMacAddrIsSet()) ||
       (ueMacAddrIsSet() && rhs.ueMacAddrIsSet() &&
        getUeMacAddr() == rhs.getUeMacAddr())) &&

      ((!revocationNotifUriIsSet() && !rhs.revocationNotifUriIsSet()) ||
       (revocationNotifUriIsSet() && rhs.revocationNotifUriIsSet() &&
        getRevocationNotifUri() == rhs.getRevocationNotifUri()))
...
void to_json(nlohmann::json& j, const MonitoringEventSubscription& o) {
  ...
  if (o.addedExternalIdsIsSet() || !o.m_AddedExternalIds.empty())
    j["addedExternalIds"] = o.m_AddedExternalIds;
  if (o.addedMsisdnsIsSet() || !o.m_AddedMsisdns.empty())
    j["addedMsisdns"] = o.m_AddedMsisdns;
  ...
  if (o.nsRepFormatIsSet()) j["nsRepFormat"] = o.m_NsRepFormat;
  ...
  if (o.ueMacAddrIsSet()) j["ueMacAddr"] = o.m_UeMacAddr;
  if (o.revocationNotifUriIsSet())
    j["revocationNotifUri"] = o.m_RevocationNotifUri;
}
...
void from_json(const nlohmann::json& j, MonitoringEventSubscription& o) {
  ...
  if (j.find("addedExternalIds") != j.end()) {
    j.at("addedExternalIds").get_to(o.m_AddedExternalIds);
    o.m_AddedExternalIdsIsSet = true;
  }
  if (j.find("addedMsisdns") != j.end()) {
    j.at("addedMsisdns").get_to(o.m_AddedMsisdns);
    o.m_AddedMsisdnsIsSet = true;
  }
  ...
  if (j.find("nsRepFormat") != j.end()) {
    j.at("nsRepFormat").get_to(o.m_NsRepFormat);
    o.m_NsRepFormatIsSet = true;
  }
  ...
  if (j.find("revocationNotifUri") != j.end()) {
    j.at("revocationNotifUri").get_to(o.m_RevocationNotifUri);
    o.m_RevocationNotifUriIsSet = true;
  }
}
...
std::vector<std::string> MonitoringEventSubscription::getAddedExternalIds()
    const {
  return m_AddedExternalIds;
}
void MonitoringEventSubscription::setAddedExternalIds(
    std::vector<std::string> const& value) {
  m_AddedExternalIds      = value;
  m_AddedExternalIdsIsSet = true;
}
bool MonitoringEventSubscription::addedExternalIdsIsSet() const {
  return m_AddedExternalIdsIsSet;
}
void MonitoringEventSubscription::unsetAddedExternalIds() {
  m_AddedExternalIdsIsSet = false;
}
std::vector<std::string> MonitoringEventSubscription::getAddedMsisdns() const {
  return m_AddedMsisdns;
}
void MonitoringEventSubscription::setAddedMsisdns(
    std::vector<std::string> const& value) {
  m_AddedMsisdns      = value;
  m_AddedMsisdnsIsSet = true;
}
bool MonitoringEventSubscription::addedMsisdnsIsSet() const {
  return m_AddedMsisdnsIsSet;
}
void MonitoringEventSubscription::unsetAddedMsisdns() {
  m_AddedMsisdnsIsSet = false;
}
...
oai::model::WebsockNotifConfig
MonitoringEventSubscription::getWebsockNotifConfig() const {
  return m_WebsockNotifConfig;
}
void MonitoringEventSubscription::setWebsockNotifConfig(
    oai::model::WebsockNotifConfig const& value) {
...
oai::model::MonitoringType MonitoringEventSubscription::getMonitoringType()
    const {
  return m_MonitoringType;
}
void MonitoringEventSubscription::setMonitoringType(
    oai::model::MonitoringType const& value) {
...
oai::model::ReachabilityType MonitoringEventSubscription::getReachabilityType()
    const {
  return m_ReachabilityType;
}
void MonitoringEventSubscription::setReachabilityType(
    oai::model::ReachabilityType const& value) {
...
oai::model::LocationType MonitoringEventSubscription::getLocationType() const {
  return m_LocationType;
}
void MonitoringEventSubscription::setLocationType(
    oai::model::LocationType const& value) {
...
oai::model::Accuracy MonitoringEventSubscription::getAccuracy() const {
  return m_Accuracy;
}
void MonitoringEventSubscription::setAccuracy(
    oai::model::Accuracy const& value) {
  m_Accuracy      = value;
...
oai::model::LocationQoS MonitoringEventSubscription::getLocQoS() const {
  return m_LocQoS;
}
void MonitoringEventSubscription::setLocQoS(
    oai::model::LocationQoS const& value) {
  m_LocQoS      = value;
  m_LocQoSIsSet = true;
}
...
oai::model::LdrType MonitoringEventSubscription::getLdrType() const {
  return m_LdrType;
}
void MonitoringEventSubscription::setLdrType(oai::model::LdrType const& value) {
  m_LdrType      = value;
  m_LdrTypeIsSet = true;
}
...
oai::model::VelocityRequested
MonitoringEventSubscription::getVelocityRequested() const {
  return m_VelocityRequested;
}
void MonitoringEventSubscription::setVelocityRequested(
    oai::model::VelocityRequested const& value) {
...
oai::model::TimeWindow MonitoringEventSubscription::getLocTimeWindow() const {
  return m_LocTimeWindow;
}
void MonitoringEventSubscription::setLocTimeWindow(
    oai::model::TimeWindow const& value) {
...
std::vector<oai::model::SupportedGADShapes>
...
oai::model::AssociationType MonitoringEventSubscription::getAssociationType()
    const {
  return m_AssociationType;
}
void MonitoringEventSubscription::setAssociationType(
    oai::model::AssociationType const& value) {
...
oai::model::LocationArea MonitoringEventSubscription::getLocationArea() const {
  return m_LocationArea;
}
void MonitoringEventSubscription::setLocationArea(
    oai::model::LocationArea const& value) {
...
oai::model::LocationArea5G MonitoringEventSubscription::getLocationArea5G()
    const {
  return m_LocationArea5G;
}
void MonitoringEventSubscription::setLocationArea5G(
    oai::model::LocationArea5G const& value) {
...
std::vector<oai::model::DddTrafficDescriptor>
...
std::vector<oai::model::DlDataDeliveryStatus>
MonitoringEventSubscription::getDddStati() const {
  return m_DddStati;
}
void MonitoringEventSubscription::setDddStati(
    std::vector<oai::model::DlDataDeliveryStatus> const& value) {
  m_DddStati      = value;
...
oai::model::MonitoringEventReport
...
void MonitoringEventSubscription::setMonitoringEventReport(
    oai::model::MonitoringEventReport const& value) {
...
oai::model::Snssai MonitoringEventSubscription::getSnssai() const {
  return m_Snssai;
}
void MonitoringEventSubscription::setSnssai(oai::model::Snssai const& value) {
  m_Snssai      = value;
  m_SnssaiIsSet = true;
}
...
oai::model::SACInfo MonitoringEventSubscription::getTgtNsThreshold() const {
  return m_TgtNsThreshold;
}
void MonitoringEventSubscription::setTgtNsThreshold(
    oai::model::SACInfo const& value) {
...
oai::model::SACRepFormat MonitoringEventSubscription::getNsRepFormat() const {
  return m_NsRepFormat;
}
void MonitoringEventSubscription::setNsRepFormat(
    oai::model::SACRepFormat const& value) {
  m_NsRepFormat      = value;
  m_NsRepFormatIsSet = true;
}
bool MonitoringEventSubscription::nsRepFormatIsSet() const {
  return m_NsRepFormatIsSet;
}
void MonitoringEventSubscription::unsetNsRepFormat() {
  m_NsRepFormatIsSet = false;
}
std::string MonitoringEventSubscription::getAfServiceId() const {
  return m_AfServiceId;
}
void MonitoringEventSubscription::setAfServiceId(std::string const& value) {
  m_AfServiceId      = value;
  m_AfServiceIdIsSet = true;
}
bool MonitoringEventSubscription::afServiceIdIsSet() const {
  return m_AfServiceIdIsSet;
}
void MonitoringEventSubscription::unsetAfServiceId() {
  m_AfServiceIdIsSet = false;
}
...
oai::model::UavPolicy MonitoringEventSubscription::getUavPolicy() const {
  return m_UavPolicy;
}
void MonitoringEventSubscription::setUavPolicy(
    oai::model::UavPolicy const& value) {
  m_UavPolicy      = value;
...
oai::model::SubType MonitoringEventSubscription::getSubType() const {
  return m_SubType;
}
void MonitoringEventSubscription::setSubType(oai::model::SubType const& value) {
  m_SubType      = value;
  m_SubTypeIsSet = true;
}
...
std::vector<oai::model::MonitoringType>
MonitoringEventSubscription::getAddnMonTypes() const {
  return m_AddnMonTypes;
}
void MonitoringEventSubscription::setAddnMonTypes(
    std::vector<oai::model::MonitoringType> const& value) {
...
std::vector<oai::model::MonitoringEventReport>
...
oai::model::IpAddr MonitoringEventSubscription::getUeIpAddr() const {
  return m_UeIpAddr;
}
void MonitoringEventSubscription::setUeIpAddr(oai::model::IpAddr const& value) {
  m_UeIpAddr      = value;
  m_UeIpAddrIsSet = true;
}
bool MonitoringEventSubscription::ueIpAddrIsSet() const {
  return m_UeIpAddrIsSet;
}
void MonitoringEventSubscription::unsetUeIpAddr() {
  m_UeIpAddrIsSet = false;
}
std::string MonitoringEventSubscription::getUeMacAddr() const {
  return m_UeMacAddr;
}
void MonitoringEventSubscription::setUeMacAddr(std::string const& value) {
  m_UeMacAddr      = value;
  m_UeMacAddrIsSet = true;
}
bool MonitoringEventSubscription::ueMacAddrIsSet() const {
  return m_UeMacAddrIsSet;
}
void MonitoringEventSubscription::unsetUeMacAddr() {
  m_UeMacAddrIsSet = false;
}
std::string MonitoringEventSubscription::getRevocationNotifUri() const {
  return m_RevocationNotifUri;
}
void MonitoringEventSubscription::setRevocationNotifUri(
    std::string const& value) {
  m_RevocationNotifUri      = value;
  m_RevocationNotifUriIsSet = true;
}
bool MonitoringEventSubscription::revocationNotifUriIsSet() const {
  return m_RevocationNotifUriIsSet;
}
void MonitoringEventSubscription::unsetRevocationNotifUri() {
  m_RevocationNotifUriIsSet = false;
}
