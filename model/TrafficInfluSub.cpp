...
std::vector<oai::model::Snssai> TrafficInfluSub::getSnssais() const
{
    return m_Snssais;
}
void TrafficInfluSub::setSnssais(std::vector<oai::model::Snssai> const& value)
{
    m_Snssais = value;
    m_SnssaisIsSet = true;
}
...
void TrafficInfluSub::setInternalGroupIds(std::vector<std::string> const& value)
{
