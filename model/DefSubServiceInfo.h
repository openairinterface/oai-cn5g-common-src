...
#ifndef DefSubServiceInfo_H_
#define DefSubServiceInfo_H_
...
/// Service Specific information for Default Notification Subscription.
/// </summary>
class  DefSubServiceInfo
{
public:
    DefSubServiceInfo();
    virtual ~DefSubServiceInfo() = default;
    ...
    bool operator==(const DefSubServiceInfo& rhs) const;
    bool operator!=(const DefSubServiceInfo& rhs) const;

    /////////////////////////////////////////////
    /// DefSubServiceInfo members
    ...
    friend void to_json(nlohmann::json& j, const DefSubServiceInfo& o);
    friend void from_json(const nlohmann::json& j, DefSubServiceInfo& o);
protected:
