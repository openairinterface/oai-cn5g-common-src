...
asn_oer_constraints_t asn_OER_type_Ngap_XnExtTLAs_constr_1 CC_NOTUSED = {
    {0, 0},
    -1 /* (SIZE(1..16)) */};
...
asn_SET_OF_specifics_t asn_SPC_Ngap_XnExtTLAs_specs_1 = {
    sizeof(struct Ngap_XnExtTLAs), offsetof(struct Ngap_XnExtTLAs, _asn_ctx),
...
asn_TYPE_descriptor_t asn_DEF_Ngap_XnExtTLAs = {
    ...
    {
#if !defined(ASN_DISABLE_OER_SUPPORT)
        &asn_OER_type_Ngap_XnExtTLAs_constr_1,
#endif /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
        &asn_PER_type_Ngap_XnExtTLAs_constr_1,
#endif /* !defined(ASN_DISABLE_UPER_SUPPORT) ||                                \
          !defined(ASN_DISABLE_APER_SUPPORT) */
#if !defined(ASN_DISABLE_JER_SUPPORT)
        0,
