...
bool LadnInfo::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
...
bool LadnInfo::operator==(const LadnInfo& rhs) const
{
    ...
    ((!presenceIsSet() && !rhs.presenceIsSet()) || (presenceIsSet() && rhs.presenceIsSet() && getPresence() == rhs.getPresence()))
...
oai::_3gpp::model::PresenceState LadnInfo::getPresence() const
{
    return m_Presence;
}
void LadnInfo::setPresence(oai::_3gpp::model::PresenceState const& value)
{
    m_Presence = value;
