...
bool NcgiTai::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    ...
    /* CellList */ {
        const std::vector<oai::_3gpp::model::Ncgi>& value = m_CellList;
...
oai::_3gpp::model::Tai NcgiTai::getTai() const
{
    return m_Tai;
}
void NcgiTai::setTai(oai::_3gpp::model::Tai const& value)
{
    m_Tai = value;
}
std::vector<oai::_3gpp::model::Ncgi> NcgiTai::getCellList() const
{
    return m_CellList;
}
void NcgiTai::setCellList(std::vector<oai::_3gpp::model::Ncgi> const& value)
{
    m_CellList = value;
}
