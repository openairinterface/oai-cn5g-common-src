...
int Ngap_ConfiguredNSSAI_constraint(const asn_TYPE_descriptor_t *td,
                                    const void *sptr,
...
static asn_oer_constraints_t asn_OER_type_Ngap_ConfiguredNSSAI_constr_1
    CC_NOTUSED = {{0, 0}, 128 /* (SIZE(128..128)) */};
