...
bool NssaiAvailabilityInfo::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "NssaiAvailabilityInfo" : pathPrefix;

         
    
    /* SupportedNssaiAvailabilityData */ {
        const std::vector<oai::_3gpp::model::SupportedNssaiAvailabilityData>& value = m_SupportedNssaiAvailabilityData;
        const std::string currentValuePath = _pathPrefix + ".supportedNssaiAvailabilityData";
        ...
        { // Recursive validation of array elements
            ...
            int i = 0;
            for (const oai::_3gpp::model::SupportedNssaiAvailabilityData& value : value)
            { 
                const std::string currentValuePath = oldValuePath + "[" + std::to_string(i) + "]";
                        
        success = value.validate(msg, currentValuePath + ".supportedNssaiAvailabilityData") && success;
...
bool NssaiAvailabilityInfo::operator==(const NssaiAvailabilityInfo& rhs) const
{
    ...
    (getSupportedNssaiAvailabilityData() == rhs.getSupportedNssaiAvailabilityData())
     &&
...
{
    j.at("supportedNssaiAvailabilityData").get_to(o.m_SupportedNssaiAvailabilityData);
...
std::vector<oai::_3gpp::model::SupportedNssaiAvailabilityData> NssaiAvailabilityInfo::getSupportedNssaiAvailabilityData() const
{
    return m_SupportedNssaiAvailabilityData;
}
void NssaiAvailabilityInfo::setSupportedNssaiAvailabilityData(std::vector<oai::_3gpp::model::SupportedNssaiAvailabilityData> const& value)
{
