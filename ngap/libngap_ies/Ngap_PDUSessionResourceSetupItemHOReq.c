...
static int memb_Ngap_handoverRequestTransfer_constraint_1(
...
static asn_oer_constraints_t asn_OER_memb_Ngap_handoverRequestTransfer_constr_4
    CC_NOTUSED = {{0, 0}, -1 /* (SIZE(0..MAX)) */};
#endif /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
static asn_per_constraints_t asn_PER_memb_Ngap_handoverRequestTransfer_constr_4
    CC_NOTUSED = {
...
asn_TYPE_member_t asn_MBR_Ngap_PDUSessionResourceSetupItemHOReq_1[] = {
    {ATF_NOFLAGS,
     0,
     offsetof(struct Ngap_PDUSessionResourceSetupItemHOReq, pDUSessionID),
    ...
    {ATF_POINTER,
     0,
     offsetof(struct Ngap_PDUSessionResourceSetupItemHOReq, s_NSSAI),
    ...
    {ATF_NOFLAGS,
     0,
     offsetof(
         struct Ngap_PDUSessionResourceSetupItemHOReq, handoverRequestTransfer),
     ...
     {
#if !defined(ASN_DISABLE_OER_SUPPORT)
         &asn_OER_memb_Ngap_handoverRequestTransfer_constr_4,
#endif /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
    ...
    {ATF_POINTER,
     1,
     offsetof(struct Ngap_PDUSessionResourceSetupItemHOReq, iE_Extensions),
     (ASN_TAG_CLASS_CONTEXT | (3 << 2)),
     -1, /* IMPLICIT tag at current level */
     &asn_DEF_Ngap_ProtocolExtensionContainer_12929P253,
     0,
     {
#if !defined(ASN_DISABLE_OER_SUPPORT)
         0,
