...
bool AmfEventNotification::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "AmfEventNotification" : pathPrefix;

                 
    if (reportListIsSet())
    {
        const std::vector<oai::model::AmfEventReport>& value = m_ReportList;
        ...
        { // Recursive validation of array elements
            ...
            int i = 0;
            for (const oai::model::AmfEventReport& value : value)
            { 
...
bool AmfEventNotification::operator==(const AmfEventNotification& rhs) const
{
    ...
    ((!eventSubsSyncInfoIsSet() && !rhs.eventSubsSyncInfoIsSet()) || (eventSubsSyncInfoIsSet() && rhs.eventSubsSyncInfoIsSet() && getEventSubsSyncInfo() == rhs.getEventSubsSyncInfo()))
...
void AmfEventNotification::setSubsChangeNotifyCorrelationId(std::string const& value)
{
...
std::vector<oai::model::AmfEventReport> AmfEventNotification::getReportList() const
{
    return m_ReportList;
}
void AmfEventNotification::setReportList(std::vector<oai::model::AmfEventReport> const& value)
{
    m_ReportList = value;
...
oai::model::AmfEventSubsSyncInfo AmfEventNotification::getEventSubsSyncInfo() const
{
    return m_EventSubsSyncInfo;
}
void AmfEventNotification::setEventSubsSyncInfo(oai::model::AmfEventSubsSyncInfo const& value)
{
