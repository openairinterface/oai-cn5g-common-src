...
void NefInfo::setGpsiRanges(std::vector<oai::_3gpp::model::IdentityRange> const& value)
{
    m_GpsiRanges = value;
...
std::vector<oai::_3gpp::model::IdentityRange> NefInfo::getExternalGroupIdentifiersRanges() const
{
    return m_ExternalGroupIdentifiersRanges;
}
void NefInfo::setExternalGroupIdentifiersRanges(std::vector<oai::_3gpp::model::IdentityRange> const& value)
{
...
void NefInfo::setTaiRangeList(std::vector<oai::_3gpp::model::TaiRange> const& value)
{
...
std::vector<oai::_3gpp::model::UnTrustAfInfo> NefInfo::getUnTrustAfInfoList() const
{
    return m_UnTrustAfInfoList;
}
void NefInfo::setUnTrustAfInfoList(std::vector<oai::_3gpp::model::UnTrustAfInfo> const& value)
{
