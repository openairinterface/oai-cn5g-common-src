...
oai::_3gpp::model::CellGlobalId GeraLocation::getCgi() const
{
    return m_Cgi;
}
void GeraLocation::setCgi(oai::_3gpp::model::CellGlobalId const& value)
{
    m_Cgi = value;
    m_CgiIsSet = true;
}
...
oai::_3gpp::model::ServiceAreaId GeraLocation::getSai() const
{
    return m_Sai;
}
void GeraLocation::setSai(oai::_3gpp::model::ServiceAreaId const& value)
{
    m_Sai = value;
    m_SaiIsSet = true;
}
...
oai::_3gpp::model::LocationAreaId GeraLocation::getLai() const
{
    return m_Lai;
}
void GeraLocation::setLai(oai::_3gpp::model::LocationAreaId const& value)
{
    m_Lai = value;
    m_LaiIsSet = true;
}
...
oai::_3gpp::model::RoutingAreaId GeraLocation::getRai() const
{
    return m_Rai;
}
void GeraLocation::setRai(oai::_3gpp::model::RoutingAreaId const& value)
{
    m_Rai = value;
    m_RaiIsSet = true;
}
