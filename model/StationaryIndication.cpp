...
bool StationaryIndication::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "StationaryIndication" : pathPrefix;
...
StationaryIndication_anyOf::eStationaryIndication_anyOf StationaryIndication::getEnumValue() const
{
    return m_value.getValue();
}

void StationaryIndication::setEnumValue(StationaryIndication_anyOf::eStationaryIndication_anyOf  value)
{
