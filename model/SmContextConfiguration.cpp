...
bool SmContextConfiguration::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "SmContextConfiguration" : pathPrefix;
...
bool SmContextConfiguration::operator==(const SmContextConfiguration& rhs) const
{
    return
    
    
    
    ((!smalDataRateControlIsSet() && !rhs.smalDataRateControlIsSet()) || (smalDataRateControlIsSet() && rhs.smalDataRateControlIsSet() && getSmalDataRateControl() == rhs.getSmalDataRateControl())) &&
    ...
    ((!servPlmnDataRateCtlIsSet() && !rhs.servPlmnDataRateCtlIsSet()) || (servPlmnDataRateCtlIsSet() && rhs.servPlmnDataRateCtlIsSet() && getServPlmnDataRateCtl() == rhs.getServPlmnDataRateCtl()))
...
oai::_3gpp::model::SmallDataRateControl SmContextConfiguration::getSmalDataRateControl() const
{
    return m_SmalDataRateControl;
}
void SmContextConfiguration::setSmalDataRateControl(oai::_3gpp::model::SmallDataRateControl const& value)
{
...
oai::_3gpp::model::SmallDataRateStatus SmContextConfiguration::getSmallDataRateStatus() const
{
    return m_SmallDataRateStatus;
}
void SmContextConfiguration::setSmallDataRateStatus(oai::_3gpp::model::SmallDataRateStatus const& value)
{
