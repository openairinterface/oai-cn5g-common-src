...
asn_TYPE_member_t asn_MBR_Ngap_OverloadStartNSSAIItem_1[] = {
    {ATF_POINTER,
     0,
     offsetof(struct Ngap_OverloadStartNSSAIItem, sliceOverloadList),
    ...
    {ATF_POINTER,
     3,
     offsetof(struct Ngap_OverloadStartNSSAIItem, sliceOverloadResponse),
    ...
    {ATF_POINTER,
     1,
     offsetof(struct Ngap_OverloadStartNSSAIItem, iE_Extensions),
     (ASN_TAG_CLASS_CONTEXT | (3 << 2)),
     -1, /* IMPLICIT tag at current level */
     &asn_DEF_Ngap_ProtocolExtensionContainer_12929P203,
     0,
     {
#if !defined(ASN_DISABLE_OER_SUPPORT)
         0,
...
static const asn_TYPE_tag2member_t
    asn_MAP_Ngap_OverloadStartNSSAIItem_tag2el_1[] = {
        ...
        {(ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0,
         0}, /* sliceOverloadResponse */
        {(ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0,
         0}, /* sliceTrafficLoadReductionIndication */
