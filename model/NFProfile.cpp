...
bool NFProfile::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    ...
    if (!m_NfType.validate(msg, _pathPrefix + ".nfType")) {
        msg << _pathPrefix << ": NfType is invalid;";
        success = false;
    }    
    if (!m_NfStatus.validate(msg, _pathPrefix + ".nfStatus")) {
        msg << _pathPrefix << ": NfStatus is invalid;";
        success = false;
    }     
    if (collocatedNfInstancesIsSet())
    {
        const std::vector<oai::model::CollocatedNfInstance>& value = m_CollocatedNfInstances;
        ...
        { // Recursive validation of array elements
            ...
            int i = 0;
            for (const oai::model::CollocatedNfInstance& value : value)
            { 
    ...
    if (plmnListIsSet())
    {
        const std::vector<oai::model::PlmnId>& value = m_PlmnList;
    ...
    if (snpnListIsSet())
    {
        const std::vector<oai::model::PlmnIdNid>& value = m_SnpnList;
        ...
        { // Recursive validation of array elements
            const std::string oldValuePath = currentValuePath;
            int i = 0;
            for (const oai::model::PlmnIdNid& value : value)
            { 
                const std::string currentValuePath = oldValuePath + "[" + std::to_string(i) + "]";
    ...
    if (sNssaisIsSet())
    {
        const std::vector<oai::model::ExtSnssai>& value = m_SNssais;
        ...
        { // Recursive validation of array elements
            const std::string oldValuePath = currentValuePath;
            int i = 0;
            for (const oai::model::ExtSnssai& value : value)
            { 
                const std::string currentValuePath = oldValuePath + "[" + std::to_string(i) + "]";
    ...
    {
        const std::vector<oai::model::PlmnSnssai>& value = m_PerPlmnSnssaiList;
        ...
        { // Recursive validation of array elements
            const std::string oldValuePath = currentValuePath;
            int i = 0;
            for (const oai::model::PlmnSnssai& value : value)
            { 
                const std::string currentValuePath = oldValuePath + "[" + std::to_string(i) + "]";
    ...
    {
        const std::vector<oai::model::Ipv6Addr>& value = m_Ipv6Addresses;
        ...
        { // Recursive validation of array elements
            const std::string oldValuePath = currentValuePath;
            int i = 0;
            for (const oai::model::Ipv6Addr& value : value)
            { 
                const std::string currentValuePath = oldValuePath + "[" + std::to_string(i) + "]";
    ...
    {
        const std::vector<oai::model::PlmnId>& value = m_AllowedPlmns;
    ...
    {
        const std::vector<oai::model::PlmnIdNid>& value = m_AllowedSnpns;
    ...
    {
        const std::vector<oai::model::NFType>& value = m_AllowedNfTypes;
    ...
    {
        const std::vector<oai::model::ExtSnssai>& value = m_AllowedNssais;
    ...
    if (udrInfoListIsSet())
    {
        const std::map<std::string, oai::model::UdrInfo>& value = m_UdrInfoList;
    ...
    if (udmInfoListIsSet())
    {
        const std::map<std::string, oai::model::UdmInfo>& value = m_UdmInfoList;
    ...
    {
        const std::map<std::string, oai::model::AusfInfo>& value = m_AusfInfoList;
    ...
    if (amfInfoListIsSet())
    {
        const std::map<std::string, oai::model::AmfInfo>& value = m_AmfInfoList;
    ...
    if (smfInfoListIsSet())
    {
        const std::map<std::string, oai::model::SmfInfo>& value = m_SmfInfoList;
    ...
    if (upfInfoListIsSet())
    {
        const std::map<std::string, oai::model::UpfInfo>& value = m_UpfInfoList;
    ...
    if (pcfInfoListIsSet())
    {
        const std::map<std::string, oai::model::PcfInfo>& value = m_PcfInfoList;
    ...
    if (bsfInfoListIsSet())
    {
        const std::map<std::string, oai::model::BsfInfo>& value = m_BsfInfoList;
    ...
    if (chfInfoListIsSet())
    {
        const std::map<std::string, oai::model::ChfInfo>& value = m_ChfInfoList;
    ...
    {
        const std::map<std::string, oai::model::UdsfInfo>& value = m_UdsfInfoList;
    ...
    {
        const std::map<std::string, oai::model::NwdafInfo>& value = m_NwdafInfoList;
    ...
    {
        const std::map<std::string, oai::model::PcscfInfo>& value = m_PcscfInfoList;
    ...
    if (hssInfoListIsSet())
    {
        const std::map<std::string, oai::model::HssInfo>& value = m_HssInfoList;
    ...
    if (nfServicesIsSet())
    {
        const std::vector<oai::model::NFService>& value = m_NfServices;
        ...
        { // Recursive validation of array elements
            const std::string oldValuePath = currentValuePath;
            int i = 0;
            for (const oai::model::NFService& value : value)
            { 
                const std::string currentValuePath = oldValuePath + "[" + std::to_string(i) + "]";
    ...
    {
        const std::map<std::string, oai::model::NFService>& value = m_NfServiceList;
    ...
    {
        const std::vector<oai::model::DefaultNotificationSubscription>& value = m_DefaultNotificationSubscriptions;
        ...
        { // Recursive validation of array elements
            const std::string oldValuePath = currentValuePath;
            int i = 0;
            for (const oai::model::DefaultNotificationSubscription& value : value)
            { 
                const std::string currentValuePath = oldValuePath + "[" + std::to_string(i) + "]";
    ...
    {
        const std::map<std::string, std::vector<oai::model::VendorSpecificFeature>>& value = m_SupportedVendorSpecificFeatures;
    ...
    {
        const std::map<std::string, oai::model::AanfInfo>& value = m_AanfInfoList;
    ...
    {
        const std::map<std::string, oai::model::EasdfInfo>& value = m_EasdfInfoList;
    ...
    {
        const std::map<std::string, oai::model::NsacfInfo>& value = m_NsacfInfoList;
    ...
    {
        const std::map<std::string, oai::model::MbSmfInfo>& value = m_MbSmfInfoList;
    ...
    {
        const std::map<std::string, oai::model::TsctsfInfo>& value = m_TsctsfInfoList;
    ...
    {
        const std::map<std::string, oai::model::MbUpfInfo>& value = m_MbUpfInfoList;
...
oai::model::NFType NFProfile::getNfType() const
{
    return m_NfType;
}
void NFProfile::setNfType(oai::model::NFType const& value)
{
    m_NfType = value;
}
oai::model::NFStatus NFProfile::getNfStatus() const
{
    return m_NfStatus;
}
void NFProfile::setNfStatus(oai::model::NFStatus const& value)
{
    m_NfStatus = value;
}
std::vector<oai::model::CollocatedNfInstance> NFProfile::getCollocatedNfInstances() const
{
    return m_CollocatedNfInstances;
}
void NFProfile::setCollocatedNfInstances(std::vector<oai::model::CollocatedNfInstance> const& value)
{
...
std::vector<oai::model::PlmnId> NFProfile::getPlmnList() const
{
    return m_PlmnList;
}
void NFProfile::setPlmnList(std::vector<oai::model::PlmnId> const& value)
{
    m_PlmnList = value;
...
std::vector<oai::model::PlmnIdNid> NFProfile::getSnpnList() const
{
    return m_SnpnList;
}
void NFProfile::setSnpnList(std::vector<oai::model::PlmnIdNid> const& value)
{
    m_SnpnList = value;
...
std::vector<oai::model::ExtSnssai> NFProfile::getSNssais() const
{
    return m_SNssais;
}
void NFProfile::setSNssais(std::vector<oai::model::ExtSnssai> const& value)
{
    m_SNssais = value;
    m_SNssaisIsSet = true;
}
...
std::vector<oai::model::PlmnSnssai> NFProfile::getPerPlmnSnssaiList() const
{
    return m_PerPlmnSnssaiList;
}
void NFProfile::setPerPlmnSnssaiList(std::vector<oai::model::PlmnSnssai> const& value)
{
...
std::vector<oai::model::Ipv6Addr> NFProfile::getIpv6Addresses() const
{
    return m_Ipv6Addresses;
}
void NFProfile::setIpv6Addresses(std::vector<oai::model::Ipv6Addr> const& value)
{
...
std::vector<oai::model::PlmnId> NFProfile::getAllowedPlmns() const
{
    return m_AllowedPlmns;
}
void NFProfile::setAllowedPlmns(std::vector<oai::model::PlmnId> const& value)
{
...
std::vector<oai::model::PlmnIdNid> NFProfile::getAllowedSnpns() const
{
    return m_AllowedSnpns;
}
void NFProfile::setAllowedSnpns(std::vector<oai::model::PlmnIdNid> const& value)
{
...
std::vector<oai::model::NFType> NFProfile::getAllowedNfTypes() const
{
    return m_AllowedNfTypes;
}
void NFProfile::setAllowedNfTypes(std::vector<oai::model::NFType> const& value)
{
...
std::vector<oai::model::ExtSnssai> NFProfile::getAllowedNssais() const
{
    return m_AllowedNssais;
}
void NFProfile::setAllowedNssais(std::vector<oai::model::ExtSnssai> const& value)
{
...
oai::model::UdrInfo NFProfile::getUdrInfo() const
{
    return m_UdrInfo;
}
void NFProfile::setUdrInfo(oai::model::UdrInfo const& value)
{
    m_UdrInfo = value;
    m_UdrInfoIsSet = true;
}
...
std::map<std::string, oai::model::UdrInfo> NFProfile::getUdrInfoList() const
{
    return m_UdrInfoList;
}
void NFProfile::setUdrInfoList(std::map<std::string, oai::model::UdrInfo> const& value)
{
    m_UdrInfoList = value;
...
oai::model::UdmInfo NFProfile::getUdmInfo() const
{
    return m_UdmInfo;
}
void NFProfile::setUdmInfo(oai::model::UdmInfo const& value)
{
    m_UdmInfo = value;
    m_UdmInfoIsSet = true;
}
...
std::map<std::string, oai::model::UdmInfo> NFProfile::getUdmInfoList() const
{
    return m_UdmInfoList;
}
void NFProfile::setUdmInfoList(std::map<std::string, oai::model::UdmInfo> const& value)
{
    m_UdmInfoList = value;
...
oai::model::AusfInfo NFProfile::getAusfInfo() const
{
    return m_AusfInfo;
}
void NFProfile::setAusfInfo(oai::model::AusfInfo const& value)
{
    m_AusfInfo = value;
...
std::map<std::string, oai::model::AusfInfo> NFProfile::getAusfInfoList() const
{
    return m_AusfInfoList;
}
void NFProfile::setAusfInfoList(std::map<std::string, oai::model::AusfInfo> const& value)
{
...
oai::model::AmfInfo NFProfile::getAmfInfo() const
{
    return m_AmfInfo;
}
void NFProfile::setAmfInfo(oai::model::AmfInfo const& value)
{
    m_AmfInfo = value;
    m_AmfInfoIsSet = true;
}
...
std::map<std::string, oai::model::AmfInfo> NFProfile::getAmfInfoList() const
{
    return m_AmfInfoList;
}
void NFProfile::setAmfInfoList(std::map<std::string, oai::model::AmfInfo> const& value)
{
    m_AmfInfoList = value;
...
oai::model::SmfInfo NFProfile::getSmfInfo() const
{
    return m_SmfInfo;
}
void NFProfile::setSmfInfo(oai::model::SmfInfo const& value)
{
    m_SmfInfo = value;
    m_SmfInfoIsSet = true;
}
...
std::map<std::string, oai::model::SmfInfo> NFProfile::getSmfInfoList() const
{
    return m_SmfInfoList;
}
void NFProfile::setSmfInfoList(std::map<std::string, oai::model::SmfInfo> const& value)
{
    m_SmfInfoList = value;
...
oai::model::UpfInfo NFProfile::getUpfInfo() const
{
    return m_UpfInfo;
}
void NFProfile::setUpfInfo(oai::model::UpfInfo const& value)
{
    m_UpfInfo = value;
    m_UpfInfoIsSet = true;
}
...
std::map<std::string, oai::model::UpfInfo> NFProfile::getUpfInfoList() const
{
    return m_UpfInfoList;
}
void NFProfile::setUpfInfoList(std::map<std::string, oai::model::UpfInfo> const& value)
{
    m_UpfInfoList = value;
...
oai::model::PcfInfo NFProfile::getPcfInfo() const
{
    return m_PcfInfo;
}
void NFProfile::setPcfInfo(oai::model::PcfInfo const& value)
{
    m_PcfInfo = value;
    m_PcfInfoIsSet = true;
}
...
std::map<std::string, oai::model::PcfInfo> NFProfile::getPcfInfoList() const
{
    return m_PcfInfoList;
}
void NFProfile::setPcfInfoList(std::map<std::string, oai::model::PcfInfo> const& value)
{
    m_PcfInfoList = value;
...
oai::model::BsfInfo NFProfile::getBsfInfo() const
{
    return m_BsfInfo;
}
void NFProfile::setBsfInfo(oai::model::BsfInfo const& value)
{
    m_BsfInfo = value;
    m_BsfInfoIsSet = true;
}
...
std::map<std::string, oai::model::BsfInfo> NFProfile::getBsfInfoList() const
{
    return m_BsfInfoList;
}
void NFProfile::setBsfInfoList(std::map<std::string, oai::model::BsfInfo> const& value)
{
    m_BsfInfoList = value;
...
oai::model::ChfInfo NFProfile::getChfInfo() const
{
    return m_ChfInfo;
}
void NFProfile::setChfInfo(oai::model::ChfInfo const& value)
{
    m_ChfInfo = value;
    m_ChfInfoIsSet = true;
}
...
std::map<std::string, oai::model::ChfInfo> NFProfile::getChfInfoList() const
{
    return m_ChfInfoList;
}
void NFProfile::setChfInfoList(std::map<std::string, oai::model::ChfInfo> const& value)
{
    m_ChfInfoList = value;
...
oai::model::NefInfo NFProfile::getNefInfo() const
{
    return m_NefInfo;
}
void NFProfile::setNefInfo(oai::model::NefInfo const& value)
{
    m_NefInfo = value;
    m_NefInfoIsSet = true;
}
...
oai::model::NrfInfo NFProfile::getNrfInfo() const
{
    return m_NrfInfo;
}
void NFProfile::setNrfInfo(oai::model::NrfInfo const& value)
{
    m_NrfInfo = value;
    m_NrfInfoIsSet = true;
}
...
oai::model::UdsfInfo NFProfile::getUdsfInfo() const
{
    return m_UdsfInfo;
}
void NFProfile::setUdsfInfo(oai::model::UdsfInfo const& value)
{
    m_UdsfInfo = value;
...
std::map<std::string, oai::model::UdsfInfo> NFProfile::getUdsfInfoList() const
{
    return m_UdsfInfoList;
}
void NFProfile::setUdsfInfoList(std::map<std::string, oai::model::UdsfInfo> const& value)
{
...
oai::model::NwdafInfo NFProfile::getNwdafInfo() const
{
    return m_NwdafInfo;
}
void NFProfile::setNwdafInfo(oai::model::NwdafInfo const& value)
{
    m_NwdafInfo = value;
...
std::map<std::string, oai::model::NwdafInfo> NFProfile::getNwdafInfoList() const
{
    return m_NwdafInfoList;
}
void NFProfile::setNwdafInfoList(std::map<std::string, oai::model::NwdafInfo> const& value)
{
...
std::map<std::string, oai::model::PcscfInfo> NFProfile::getPcscfInfoList() const
{
    return m_PcscfInfoList;
}
void NFProfile::setPcscfInfoList(std::map<std::string, oai::model::PcscfInfo> const& value)
{
...
std::map<std::string, oai::model::HssInfo> NFProfile::getHssInfoList() const
{
    return m_HssInfoList;
}
void NFProfile::setHssInfoList(std::map<std::string, oai::model::HssInfo> const& value)
{
    m_HssInfoList = value;
...
std::vector<oai::model::NFService> NFProfile::getNfServices() const
{
    return m_NfServices;
}
void NFProfile::setNfServices(std::vector<oai::model::NFService> const& value)
{
    m_NfServices = value;
...
std::map<std::string, oai::model::NFService> NFProfile::getNfServiceList() const
{
    return m_NfServiceList;
}
void NFProfile::setNfServiceList(std::map<std::string, oai::model::NFService> const& value)
{
...
std::vector<oai::model::DefaultNotificationSubscription> NFProfile::getDefaultNotificationSubscriptions() const
{
    return m_DefaultNotificationSubscriptions;
}
void NFProfile::setDefaultNotificationSubscriptions(std::vector<oai::model::DefaultNotificationSubscription> const& value)
{
...
oai::model::LmfInfo NFProfile::getLmfInfo() const
{
    return m_LmfInfo;
}
void NFProfile::setLmfInfo(oai::model::LmfInfo const& value)
{
    m_LmfInfo = value;
    m_LmfInfoIsSet = true;
}
...
oai::model::GmlcInfo NFProfile::getGmlcInfo() const
{
    return m_GmlcInfo;
}
void NFProfile::setGmlcInfo(oai::model::GmlcInfo const& value)
{
    m_GmlcInfo = value;
...
oai::model::ScpInfo NFProfile::getScpInfo() const
{
    return m_ScpInfo;
}
void NFProfile::setScpInfo(oai::model::ScpInfo const& value)
{
    m_ScpInfo = value;
    m_ScpInfoIsSet = true;
}
...
oai::model::SeppInfo NFProfile::getSeppInfo() const
{
    return m_SeppInfo;
}
void NFProfile::setSeppInfo(oai::model::SeppInfo const& value)
{
    m_SeppInfo = value;
...
std::map<std::string, std::vector<oai::model::VendorSpecificFeature>> NFProfile::getSupportedVendorSpecificFeatures() const
{
    return m_SupportedVendorSpecificFeatures;
}
void NFProfile::setSupportedVendorSpecificFeatures(std::map<std::string, std::vector<oai::model::VendorSpecificFeature>> const& value)
{
...
std::map<std::string, oai::model::AanfInfo> NFProfile::getAanfInfoList() const
{
    return m_AanfInfoList;
}
void NFProfile::setAanfInfoList(std::map<std::string, oai::model::AanfInfo> const& value)
{
...
oai::model::r_5GDdnmfInfo NFProfile::getR5gDdnmfInfo() const
{
    return m_r_5gDdnmfInfo;
}
void NFProfile::setR5gDdnmfInfo(oai::model::r_5GDdnmfInfo const& value)
{
...
oai::model::MfafInfo NFProfile::getMfafInfo() const
{
    return m_MfafInfo;
}
void NFProfile::setMfafInfo(oai::model::MfafInfo const& value)
{
    m_MfafInfo = value;
...
std::map<std::string, oai::model::EasdfInfo> NFProfile::getEasdfInfoList() const
{
    return m_EasdfInfoList;
}
void NFProfile::setEasdfInfoList(std::map<std::string, oai::model::EasdfInfo> const& value)
{
...
oai::model::DccfInfo NFProfile::getDccfInfo() const
{
    return m_DccfInfo;
}
void NFProfile::setDccfInfo(oai::model::DccfInfo const& value)
{
    m_DccfInfo = value;
...
std::map<std::string, oai::model::NsacfInfo> NFProfile::getNsacfInfoList() const
{
    return m_NsacfInfoList;
}
void NFProfile::setNsacfInfoList(std::map<std::string, oai::model::NsacfInfo> const& value)
{
...
std::map<std::string, oai::model::MbSmfInfo> NFProfile::getMbSmfInfoList() const
{
    return m_MbSmfInfoList;
}
void NFProfile::setMbSmfInfoList(std::map<std::string, oai::model::MbSmfInfo> const& value)
{
...
std::map<std::string, oai::model::TsctsfInfo> NFProfile::getTsctsfInfoList() const
{
    return m_TsctsfInfoList;
}
void NFProfile::setTsctsfInfoList(std::map<std::string, oai::model::TsctsfInfo> const& value)
{
...
std::map<std::string, oai::model::MbUpfInfo> NFProfile::getMbUpfInfoList() const
{
    return m_MbUpfInfoList;
}
void NFProfile::setMbUpfInfoList(std::map<std::string, oai::model::MbUpfInfo> const& value)
{
...
oai::model::TrustAfInfo NFProfile::getTrustAfInfo() const
{
    return m_TrustAfInfo;
}
void NFProfile::setTrustAfInfo(oai::model::TrustAfInfo const& value)
{
    m_TrustAfInfo = value;
...
oai::model::NssaafInfo NFProfile::getNssaafInfo() const
{
    return m_NssaafInfo;
}
void NFProfile::setNssaafInfo(oai::model::NssaafInfo const& value)
{
    m_NssaafInfo = value;
...
oai::model::IwmscInfo NFProfile::getIwmscInfo() const
{
    return m_IwmscInfo;
}
void NFProfile::setIwmscInfo(oai::model::IwmscInfo const& value)
{
    m_IwmscInfo = value;
...
oai::model::MnpfInfo NFProfile::getMnpfInfo() const
{
    return m_MnpfInfo;
}
void NFProfile::setMnpfInfo(oai::model::MnpfInfo const& value)
{
    m_MnpfInfo = value;
