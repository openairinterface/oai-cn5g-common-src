...
/* Implementation */
extern asn_oer_constraints_t asn_OER_type_Ngap_UL_NAS_Count_constr_1;
...
cbor_type_decoder_f Ngap_UL_NAS_Count_decode_cbor;
cbor_type_encoder_f Ngap_UL_NAS_Count_encode_cbor;
oer_type_decoder_f Ngap_UL_NAS_Count_decode_oer;
oer_type_encoder_f Ngap_UL_NAS_Count_encode_oer;
