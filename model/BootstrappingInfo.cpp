...
bool BootstrappingInfo::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    ...
    /* _links */ {
        const std::map<std::string, oai::_3gpp::model::LinksValueSchema>& value = m__links;
    ...
    if (nrfFeaturesIsSet())
    {
        const std::map<std::string, oai::_3gpp::model::std::string>& value = m_NrfFeatures;
...
bool BootstrappingInfo::operator==(const BootstrappingInfo& rhs) const
{
    ...
    ((!nrfSetIdIsSet() && !rhs.nrfSetIdIsSet()) || (nrfSetIdIsSet() && rhs.nrfSetIdIsSet() && getNrfSetId() == rhs.getNrfSetId())) &&
    
    
    ((!nrfInstanceIdIsSet() && !rhs.nrfInstanceIdIsSet()) || (nrfInstanceIdIsSet() && rhs.nrfInstanceIdIsSet() && getNrfInstanceId() == rhs.getNrfInstanceId()))
...
void to_json(nlohmann::json& j, const BootstrappingInfo& o)
{
    ...
    if(o.nrfSetIdIsSet())
        j["nrfSetId"] = o.m_NrfSetId;
    if(o.nrfInstanceIdIsSet())
        j["nrfInstanceId"] = o.m_NrfInstanceId;
...
std::map<std::string, oai::_3gpp::model::LinksValueSchema> BootstrappingInfo::getLinks() const
{
    return m__links;
}
void BootstrappingInfo::setLinks(std::map<std::string, oai::_3gpp::model::LinksValueSchema> const& value)
{
    m__links = value;
}
std::map<std::string, oai::_3gpp::model::std::string> BootstrappingInfo::getNrfFeatures() const
{
    return m_NrfFeatures;
}
void BootstrappingInfo::setNrfFeatures(std::map<std::string, oai::_3gpp::model::std::string> const& value)
{
    m_NrfFeatures = value;
