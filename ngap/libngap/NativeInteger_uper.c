...
asn_dec_rval_t NativeInteger_decode_uper(
...
asn_enc_rval_t NativeInteger_encode_uper(
  ...
  ASN_DEBUG("Encoding NativeInteger %s (UPER)", td->name);

  if (NativeInteger_to_INTEGER(sptr, specs, &tmpint)) ASN__ENCODE_FAILED;
