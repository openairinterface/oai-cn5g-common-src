...
public:
    ...
    /// 
    /// </summary>
    oai::model::TransferReason getReason() const;
    void setReason(oai::model::TransferReason const& value);
    /// <summary>
    /// 
    /// </summary>
    ...
    /// 
    /// </summary>
    oai::model::N1MessageContainer getRegRequest() const;
    void setRegRequest(oai::model::N1MessageContainer const& value);
...
protected:
    oai::model::TransferReason m_Reason;

    oai::model::AccessType m_AccessType;

    oai::model::PlmnId m_PlmnId;
    bool m_PlmnIdIsSet;
    oai::model::N1MessageContainer m_RegRequest;
