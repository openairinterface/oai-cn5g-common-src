...
std::vector<oai::_3gpp::model::PlmnId> AccessTokenReq::getRequesterPlmnList()
    const {
...
std::vector<oai::_3gpp::model::Snssai> AccessTokenReq::getRequesterSnssaiList()
    const {
...
std::vector<oai::_3gpp::model::PlmnIdNid> AccessTokenReq::getRequesterSnpnList()
    const {
...
std::vector<oai::_3gpp::model::Snssai> AccessTokenReq::getTargetSnssaiList()
    const {
