...
#ifndef DispersionType_H_
#define DispersionType_H_
...
public:
    DispersionType();
    virtual ~DispersionType() = default;
    ...
    bool operator==(const DispersionType& rhs) const;
    bool operator!=(const DispersionType& rhs) const;

    /////////////////////////////////////////////
    /// DispersionType members


    friend  void to_json(nlohmann::json& j, const DispersionType& o);
    friend  void from_json(const nlohmann::json& j, DispersionType& o);
protected:
