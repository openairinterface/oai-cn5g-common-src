...
std::vector<oai::model::ExternalClientType> GmlcInfo::getServingClientTypes() const
{
    return m_ServingClientTypes;
}
void GmlcInfo::setServingClientTypes(std::vector<oai::model::ExternalClientType> const& value)
{
