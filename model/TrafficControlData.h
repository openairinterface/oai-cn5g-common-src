...
public:
    ...
    /// 
    /// </summary>
    std::vector<oai::_3gpp::model::RedirectInformation> getAddRedirectInfo() const;
    void setAddRedirectInfo(std::vector<oai::_3gpp::model::RedirectInformation> const& value);
