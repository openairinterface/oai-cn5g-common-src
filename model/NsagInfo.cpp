...
void NsagInfo::setSnssaiList(std::vector<oai::_3gpp::model::Snssai> const& value)
{
    m_SnssaiList = value;
}
...
void NsagInfo::setTaiRangeList(std::vector<oai::_3gpp::model::TaiRange> const& value)
{
