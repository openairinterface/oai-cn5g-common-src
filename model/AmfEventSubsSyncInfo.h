...
public:
    ...
    /// 
    /// </summary>
    std::vector<oai::model::AmfEventSubscriptionInfo> getSubscriptionList() const;
    void setSubscriptionList(std::vector<oai::model::AmfEventSubscriptionInfo> const& value);
...
protected:
    std::vector<oai::model::AmfEventSubscriptionInfo> m_SubscriptionList;
