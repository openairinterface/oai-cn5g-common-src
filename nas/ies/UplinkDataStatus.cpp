...
//------------------------------------------------------------------------------
void UplinkDataStatus::SetValue(uint16_t value) { value_ = value; }

//------------------------------------------------------------------------------
uint16_t UplinkDataStatus::GetValue() const { return value_; }
...
int UplinkDataStatus::Decode(const uint8_t *const buf, int len, bool is_iei) {
  ...
  oai::logger::logger_common::nas().debug("Decoded %s, value 0x%x len %d",
