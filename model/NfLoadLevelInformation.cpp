...
bool NfLoadLevelInformation::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "NfLoadLevelInformation" : pathPrefix;
...
bool NfLoadLevelInformation::operator==(const NfLoadLevelInformation& rhs) const
{
    return
    ...
    ((!nfStatusIsSet() && !rhs.nfStatusIsSet()) || (nfStatusIsSet() && rhs.nfStatusIsSet() && getNfStatus() == rhs.getNfStatus())) &&
    ...
    ((!nfLoadLevelAverageIsSet() && !rhs.nfLoadLevelAverageIsSet()) || (nfLoadLevelAverageIsSet() && rhs.nfLoadLevelAverageIsSet() && getNfLoadLevelAverage() == rhs.getNfLoadLevelAverage())) &&
    
    
    ((!nfLoadLevelpeakIsSet() && !rhs.nfLoadLevelpeakIsSet()) || (nfLoadLevelpeakIsSet() && rhs.nfLoadLevelpeakIsSet() && getNfLoadLevelpeak() == rhs.getNfLoadLevelpeak())) &&
    
    
    ((!nfLoadAvgInAoiIsSet() && !rhs.nfLoadAvgInAoiIsSet()) || (nfLoadAvgInAoiIsSet() && rhs.nfLoadAvgInAoiIsSet() && getNfLoadAvgInAoi() == rhs.getNfLoadAvgInAoi())) &&
...
void to_json(nlohmann::json& j, const NfLoadLevelInformation& o)
{
    ...
    if(o.nfLoadAvgInAoiIsSet())
        j["nfLoadAvgInAoi"] = o.m_NfLoadAvgInAoi;
    if(o.snssaiIsSet())
        j["snssai"] = o.m_Snssai;
...
oai::model::NFType NfLoadLevelInformation::getNfType() const
{
    return m_NfType;
}
void NfLoadLevelInformation::setNfType(oai::model::NFType const& value)
{
    m_NfType = value;
    m_NfTypeIsSet = true;
}
...
oai::model::NfStatus NfLoadLevelInformation::getNfStatus() const
{
    return m_NfStatus;
}
void NfLoadLevelInformation::setNfStatus(oai::model::NfStatus const& value)
{
    m_NfStatus = value;
...
oai::model::Snssai NfLoadLevelInformation::getSnssai() const
{
    return m_Snssai;
}
void NfLoadLevelInformation::setSnssai(oai::model::Snssai const& value)
{
    m_Snssai = value;
    m_SnssaiIsSet = true;
}
