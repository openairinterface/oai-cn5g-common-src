...
protected:
    DnaiChangeType_anyOf::eDnaiChangeType_anyOf m_value = DnaiChangeType_anyOf::eDnaiChangeType_anyOf::INVALID_VALUE_OPENAPI_GENERATED;
};

} // namespace oai::_3gpp::model

#endif /* DnaiChangeType_anyOf_H_ */
