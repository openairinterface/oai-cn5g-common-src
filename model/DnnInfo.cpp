...
bool DnnInfo::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    ...
    if (!m_Dnn.validate(msg, _pathPrefix + ".dnn")) {
        msg << _pathPrefix << ": Dnn is invalid;";
        success = false;
    }                         
    if (smfListIsSet())
    {
...
oai::model::AccessAndMobilitySubscriptionData_subscribedDnnList_inner DnnInfo::getDnn() const
{
    return m_Dnn;
}
void DnnInfo::setDnn(oai::model::AccessAndMobilitySubscriptionData_subscribedDnnList_inner const& value)
{
    m_Dnn = value;
}
