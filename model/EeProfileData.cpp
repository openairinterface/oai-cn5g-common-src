...
std::vector<oai::_3gpp::model::EventType> EeProfileData::getRestrictedEventTypes() const
{
    return m_RestrictedEventTypes;
}
void EeProfileData::setRestrictedEventTypes(std::vector<oai::_3gpp::model::EventType> const& value)
{
...
std::map<std::string, std::vector<oai::_3gpp::model::MtcProvider>> EeProfileData::getAllowedMtcProvider() const
{
    return m_AllowedMtcProvider;
}
void EeProfileData::setAllowedMtcProvider(std::map<std::string, std::vector<oai::_3gpp::model::MtcProvider>> const& value)
{
