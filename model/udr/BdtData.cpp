...
TransferPolicy BdtData::getTransPolicy() const {
...
NetworkAreaInfo_2 BdtData::getNwAreaInfo() const {
  return m_NwAreaInfo;
}
...
UsageThreshold BdtData::getVolPerUe() const {
  return m_VolPerUe;
}
...
BdtPolicyStatus BdtData::getBdtpStatus() const {
  return m_BdtpStatus;
}
