...
oai::model::UeAuth NrV2xAuth::getVehicleUeAuth() const
{
    return m_VehicleUeAuth;
}
void NrV2xAuth::setVehicleUeAuth(oai::model::UeAuth const& value)
{
...
oai::model::UeAuth NrV2xAuth::getPedestrianUeAuth() const
{
    return m_PedestrianUeAuth;
}
void NrV2xAuth::setPedestrianUeAuth(oai::model::UeAuth const& value)
{
