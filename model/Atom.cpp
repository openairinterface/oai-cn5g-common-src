...
bool Atom::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
...
bool Atom::operator==(const Atom& rhs) const
{
    ...
    ((!negativeIsSet() && !rhs.negativeIsSet()) || (negativeIsSet() && rhs.negativeIsSet() && isNegative() == rhs.isNegative()))
...
oai::_3gpp::model::nlohmann::json Atom::getValue() const
{
    return m_Value;
}
void Atom::setValue(oai::_3gpp::model::nlohmann::json const& value)
{
    m_Value = value;
}
