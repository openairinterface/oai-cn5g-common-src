...
bool PduSessionType::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "PduSessionType" : pathPrefix;
...
PduSessionType_anyOf::ePduSessionType_anyOf PduSessionType::getEnumValue() const
{
    return m_value.getValue();
}

void PduSessionType::setEnumValue(PduSessionType_anyOf::ePduSessionType_anyOf  value)
{
