...
bool ExternalClientType_anyOf::validate(
  ...
  if (m_value == ExternalClientType_anyOf::eExternalClientType_anyOf::
...
void from_json(const nlohmann::json& j, ExternalClientType_anyOf& o) {
  ...
  if (s == "EMERGENCY_SERVICES") {
    ...
    o.setValue(
        ExternalClientType_anyOf::eExternalClientType_anyOf::PLMN_OPERATOR_OM);
...
void ExternalClientType_anyOf::setValue(
    ExternalClientType_anyOf::eExternalClientType_anyOf value) {
  m_value = value;
}
