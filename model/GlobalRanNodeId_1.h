...
#ifndef GlobalRanNodeId_1_H_
#define GlobalRanNodeId_1_H_
...
/// One of the six attributes n3IwfId, gNbIdm, ngeNbId, wagfId, tngfId, eNbId shall be present. 
/// </summary>
class  GlobalRanNodeId_1
{
public:
    GlobalRanNodeId_1();
    virtual ~GlobalRanNodeId_1() = default;
    ...
    bool operator==(const GlobalRanNodeId_1& rhs) const;
    bool operator!=(const GlobalRanNodeId_1& rhs) const;

    /////////////////////////////////////////////
    /// GlobalRanNodeId_1 members
    ...
    /// 
    /// </summary>
    oai::model::GNbId getGNbId() const;
    void setGNbId(oai::model::GNbId const& value);
    ...
    friend  void to_json(nlohmann::json& j, const GlobalRanNodeId_1& o);
    friend  void from_json(const nlohmann::json& j, GlobalRanNodeId_1& o);
protected:
    oai::model::PlmnId_1 m_PlmnId;

    std::string m_N3IwfId;
    bool m_N3IwfIdIsSet;
    oai::model::GNbId m_GNbId;
    bool m_GNbIdIsSet;
