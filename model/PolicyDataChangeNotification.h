...
public:
    ...
    void setSponsorConnectivityData(oai::_3gpp::model::SponsorConnectivityData const& value);
    ...
    void setOpSpecData(oai::_3gpp::model::OperatorSpecificDataContainer const& value);
    ...
    /// </summary>
    std::map<std::string, oai::_3gpp::model::OperatorSpecificDataContainer> getOpSpecDataMap() const;
    void setOpSpecDataMap(std::map<std::string, oai::_3gpp::model::OperatorSpecificDataContainer> const& value);
    ...
    void setReportedFragments(std::vector<oai::_3gpp::model::NotificationItem> const& value);
...
protected:
    ...
    std::map<std::string, oai::_3gpp::model::OperatorSpecificDataContainer> m_OpSpecDataMap;
