...
std::vector<oai::model::SupiRange> UdsfInfo::getSupiRanges() const
{
    return m_SupiRanges;
}
void UdsfInfo::setSupiRanges(std::vector<oai::model::SupiRange> const& value)
{
    m_SupiRanges = value;
...
std::map<std::string, std::vector<oai::model::IdentityRange>> UdsfInfo::getStorageIdRanges() const
{
    return m_StorageIdRanges;
}
void UdsfInfo::setStorageIdRanges(std::map<std::string, std::vector<oai::model::IdentityRange>> const& value)
{
