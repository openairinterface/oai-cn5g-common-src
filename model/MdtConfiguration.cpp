...
bool MdtConfiguration::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "MdtConfiguration" : pathPrefix;
    ...
    {
        const std::vector<oai::_3gpp::model::PlmnId>& value = m_MdtAllowedPlmnIdList;
    ...
    {
        const std::vector<oai::_3gpp::model::InterFreqTargetInfo>& value = m_InterFreqTargetList;
        ...
        { // Recursive validation of array elements
            const std::string oldValuePath = currentValuePath;
            int i = 0;
            for (const oai::_3gpp::model::InterFreqTargetInfo& value : value)
            { 
                const std::string currentValuePath = oldValuePath + "[" + std::to_string(i) + "]";
...
oai::_3gpp::model::JobType MdtConfiguration::getJobType() const
{
    return m_JobType;
}
void MdtConfiguration::setJobType(oai::_3gpp::model::JobType const& value)
{
    m_JobType = value;
}
oai::_3gpp::model::ReportTypeMdt MdtConfiguration::getReportType() const
{
    return m_ReportType;
}
void MdtConfiguration::setReportType(oai::_3gpp::model::ReportTypeMdt const& value)
{
    m_ReportType = value;
...
oai::_3gpp::model::AreaScope MdtConfiguration::getAreaScope() const
{
    return m_AreaScope;
}
void MdtConfiguration::setAreaScope(oai::_3gpp::model::AreaScope const& value)
{
    m_AreaScope = value;
...
std::vector<oai::_3gpp::model::MeasurementLteForMdt> MdtConfiguration::getMeasurementLteList() const
{
    return m_MeasurementLteList;
}
void MdtConfiguration::setMeasurementLteList(std::vector<oai::_3gpp::model::MeasurementLteForMdt> const& value)
{
...
std::vector<oai::_3gpp::model::MeasurementNrForMdt> MdtConfiguration::getMeasurementNrList() const
{
    return m_MeasurementNrList;
}
void MdtConfiguration::setMeasurementNrList(std::vector<oai::_3gpp::model::MeasurementNrForMdt> const& value)
{
...
std::vector<oai::_3gpp::model::SensorMeasurement> MdtConfiguration::getSensorMeasurementList() const
{
    return m_SensorMeasurementList;
}
void MdtConfiguration::setSensorMeasurementList(std::vector<oai::_3gpp::model::SensorMeasurement> const& value)
{
...
std::vector<oai::_3gpp::model::ReportingTrigger> MdtConfiguration::getReportingTriggerList() const
{
    return m_ReportingTriggerList;
}
void MdtConfiguration::setReportingTriggerList(std::vector<oai::_3gpp::model::ReportingTrigger> const& value)
{
...
oai::_3gpp::model::ReportIntervalMdt MdtConfiguration::getReportInterval() const
{
    return m_ReportInterval;
}
void MdtConfiguration::setReportInterval(oai::_3gpp::model::ReportIntervalMdt const& value)
{
...
oai::_3gpp::model::ReportIntervalNrMdt MdtConfiguration::getReportIntervalNr() const
{
    return m_ReportIntervalNr;
}
void MdtConfiguration::setReportIntervalNr(oai::_3gpp::model::ReportIntervalNrMdt const& value)
{
...
oai::_3gpp::model::ReportAmountMdt MdtConfiguration::getReportAmount() const
{
    return m_ReportAmount;
}
void MdtConfiguration::setReportAmount(oai::_3gpp::model::ReportAmountMdt const& value)
{
...
std::vector<oai::_3gpp::model::EventForMdt> MdtConfiguration::getEventList() const
{
    return m_EventList;
}
void MdtConfiguration::setEventList(std::vector<oai::_3gpp::model::EventForMdt> const& value)
{
    m_EventList = value;
...
oai::_3gpp::model::LoggingIntervalMdt MdtConfiguration::getLoggingInterval() const
{
    return m_LoggingInterval;
}
void MdtConfiguration::setLoggingInterval(oai::_3gpp::model::LoggingIntervalMdt const& value)
{
...
oai::_3gpp::model::LoggingIntervalNrMdt MdtConfiguration::getLoggingIntervalNr() const
{
    return m_LoggingIntervalNr;
}
void MdtConfiguration::setLoggingIntervalNr(oai::_3gpp::model::LoggingIntervalNrMdt const& value)
{
...
oai::_3gpp::model::LoggingDurationMdt MdtConfiguration::getLoggingDuration() const
{
    return m_LoggingDuration;
}
void MdtConfiguration::setLoggingDuration(oai::_3gpp::model::LoggingDurationMdt const& value)
{
...
oai::_3gpp::model::LoggingDurationNrMdt MdtConfiguration::getLoggingDurationNr() const
{
    return m_LoggingDurationNr;
}
void MdtConfiguration::setLoggingDurationNr(oai::_3gpp::model::LoggingDurationNrMdt const& value)
{
...
oai::_3gpp::model::PositioningMethodMdt MdtConfiguration::getPositioningMethod() const
{
    return m_PositioningMethod;
}
void MdtConfiguration::setPositioningMethod(oai::_3gpp::model::PositioningMethodMdt const& value)
{
...
std::vector<oai::_3gpp::model::PositioningMethodMdt> MdtConfiguration::getAddPositioningMethodList() const
{
    return m_AddPositioningMethodList;
}
void MdtConfiguration::setAddPositioningMethodList(std::vector<oai::_3gpp::model::PositioningMethodMdt> const& value)
{
...
oai::_3gpp::model::CollectionPeriodRmmLteMdt MdtConfiguration::getCollectionPeriodRmmLte() const
{
    return m_CollectionPeriodRmmLte;
}
void MdtConfiguration::setCollectionPeriodRmmLte(oai::_3gpp::model::CollectionPeriodRmmLteMdt const& value)
{
...
oai::_3gpp::model::CollectionPeriodRmmNrMdt MdtConfiguration::getCollectionPeriodRmmNr() const
{
    return m_CollectionPeriodRmmNr;
}
void MdtConfiguration::setCollectionPeriodRmmNr(oai::_3gpp::model::CollectionPeriodRmmNrMdt const& value)
{
...
oai::_3gpp::model::MeasurementPeriodLteMdt MdtConfiguration::getMeasurementPeriodLte() const
{
    return m_MeasurementPeriodLte;
}
void MdtConfiguration::setMeasurementPeriodLte(oai::_3gpp::model::MeasurementPeriodLteMdt const& value)
{
...
std::vector<oai::_3gpp::model::PlmnId> MdtConfiguration::getMdtAllowedPlmnIdList() const
{
    return m_MdtAllowedPlmnIdList;
}
void MdtConfiguration::setMdtAllowedPlmnIdList(std::vector<oai::_3gpp::model::PlmnId> const& value)
{
...
std::vector<oai::_3gpp::model::MbsfnArea> MdtConfiguration::getMbsfnAreaList() const
{
    return m_MbsfnAreaList;
}
void MdtConfiguration::setMbsfnAreaList(std::vector<oai::_3gpp::model::MbsfnArea> const& value)
{
...
std::vector<oai::_3gpp::model::InterFreqTargetInfo> MdtConfiguration::getInterFreqTargetList() const
{
    return m_InterFreqTargetList;
}
void MdtConfiguration::setInterFreqTargetList(std::vector<oai::_3gpp::model::InterFreqTargetInfo> const& value)
{
