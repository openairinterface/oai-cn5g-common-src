...
protected:
    ReportTypeMdt_anyOf::eReportTypeMdt_anyOf m_value = ReportTypeMdt_anyOf::eReportTypeMdt_anyOf::INVALID_VALUE_OPENAPI_GENERATED;
};

} // namespace oai::_3gpp::model

#endif /* ReportTypeMdt_anyOf_H_ */
