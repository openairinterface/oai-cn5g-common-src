...
bool EutraLocation::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "EutraLocation" : pathPrefix;
    ...
    if (!m_Ecgi.validate(msg, _pathPrefix + ".ecgi")) {
        msg << _pathPrefix << ": Ecgi is invalid;";
        success = false;
    }         
    if (ageOfLocationInformationIsSet())
    {
        const int32_t& value = m_AgeOfLocationInformation;
        const std::string currentValuePath = _pathPrefix + ".ageOfLocationInformation";
    ...
    if (geographicalInformationIsSet())
    {
        ...
        const std::string currentValuePath = _pathPrefix + ".geographicalInformation";
...
bool EutraLocation::operator==(const EutraLocation& rhs) const
{
    ...
    ((!ignoreTaiIsSet() && !rhs.ignoreTaiIsSet()) || (ignoreTaiIsSet() && rhs.ignoreTaiIsSet() && isIgnoreTai() == rhs.isIgnoreTai())) &&
    
    (getEcgi() == rhs.getEcgi())
     &&
    
    
    ((!ignoreEcgiIsSet() && !rhs.ignoreEcgiIsSet()) || (ignoreEcgiIsSet() && rhs.ignoreEcgiIsSet() && isIgnoreEcgi() == rhs.isIgnoreEcgi())) &&
    
    
    ((!ageOfLocationInformationIsSet() && !rhs.ageOfLocationInformationIsSet()) || (ageOfLocationInformationIsSet() && rhs.ageOfLocationInformationIsSet() && getAgeOfLocationInformation() == rhs.getAgeOfLocationInformation())) &&
    
    
    ((!ueLocationTimestampIsSet() && !rhs.ueLocationTimestampIsSet()) || (ueLocationTimestampIsSet() && rhs.ueLocationTimestampIsSet() && getUeLocationTimestamp() == rhs.getUeLocationTimestamp())) &&
    
    
    ((!geographicalInformationIsSet() && !rhs.geographicalInformationIsSet()) || (geographicalInformationIsSet() && rhs.geographicalInformationIsSet() && getGeographicalInformation() == rhs.getGeographicalInformation())) &&
    
    
    ((!geodeticInformationIsSet() && !rhs.geodeticInformationIsSet()) || (geodeticInformationIsSet() && rhs.geodeticInformationIsSet() && getGeodeticInformation() == rhs.getGeodeticInformation())) &&
    
    
    ((!globalNgenbIdIsSet() && !rhs.globalNgenbIdIsSet()) || (globalNgenbIdIsSet() && rhs.globalNgenbIdIsSet() && getGlobalNgenbId() == rhs.getGlobalNgenbId())) &&
    
    
    ((!globalENbIdIsSet() && !rhs.globalENbIdIsSet()) || (globalENbIdIsSet() && rhs.globalENbIdIsSet() && getGlobalENbId() == rhs.getGlobalENbId()))
...
oai::model::Tai EutraLocation::getTai() const
{
    return m_Tai;
}
void EutraLocation::setTai(oai::model::Tai const& value)
{
    m_Tai = value;
}
...
void EutraLocation::setIgnoreTai(bool const value)
{
    m_IgnoreTai = value;
...
oai::model::Ecgi EutraLocation::getEcgi() const
{
    return m_Ecgi;
}
void EutraLocation::setEcgi(oai::model::Ecgi const& value)
{
    m_Ecgi = value;
}
...
oai::model::GlobalRanNodeId EutraLocation::getGlobalNgenbId() const
{
    return m_GlobalNgenbId;
}
void EutraLocation::setGlobalNgenbId(oai::model::GlobalRanNodeId const& value)
{
...
oai::model::GlobalRanNodeId EutraLocation::getGlobalENbId() const
{
    return m_GlobalENbId;
}
void EutraLocation::setGlobalENbId(oai::model::GlobalRanNodeId const& value)
{
    m_GlobalENbId = value;
