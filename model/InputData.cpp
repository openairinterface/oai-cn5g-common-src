...
bool InputData::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    ...
    {
        const std::vector<oai::_3gpp::model::SupportedGADShapes>& value = m_SupportedGADShapes;
    ...
    {
        const std::vector<oai::_3gpp::model::ReportingAccessType>& value = m_ReportingAccessTypes;
    ...
    {
        const std::vector<oai::_3gpp::model::RefToBinaryData>& value = m_LppMessageExt;
...
void InputData::setExternalClientType(oai::_3gpp::model::ExternalClientType const& value)
{
...
std::vector<oai::_3gpp::model::SupportedGADShapes> InputData::getSupportedGADShapes() const
{
    return m_SupportedGADShapes;
}
void InputData::setSupportedGADShapes(std::vector<oai::_3gpp::model::SupportedGADShapes> const& value)
{
...
void InputData::setVelocityRequested(oai::_3gpp::model::VelocityRequested const& value)
{
...
void InputData::setPeriodicEventInfo(oai::_3gpp::model::PeriodicEventInfo const& value)
{
...
void InputData::setAreaEventInfo(oai::_3gpp::model::AreaEventInfo const& value)
{
...
void InputData::setMotionEventInfo(oai::_3gpp::model::MotionEventInfo const& value)
{
...
std::vector<oai::_3gpp::model::ReportingAccessType> InputData::getReportingAccessTypes() const
{
    return m_ReportingAccessTypes;
}
void InputData::setReportingAccessTypes(std::vector<oai::_3gpp::model::ReportingAccessType> const& value)
{
...
oai::_3gpp::model::UeConnectivityState InputData::getUeConnectivityStates() const
{
    return m_UeConnectivityStates;
}
void InputData::setUeConnectivityStates(oai::_3gpp::model::UeConnectivityState const& value)
{
...
oai::_3gpp::model::UeLocationServiceInd InputData::getUeLocationServiceInd() const
{
    return m_UeLocationServiceInd;
}
void InputData::setUeLocationServiceInd(oai::_3gpp::model::UeLocationServiceInd const& value)
{
...
oai::_3gpp::model::LcsBroadcastAssistanceTypesData InputData::getMoAssistanceDataTypes() const
{
    return m_MoAssistanceDataTypes;
}
void InputData::setMoAssistanceDataTypes(oai::_3gpp::model::LcsBroadcastAssistanceTypesData const& value)
{
...
std::vector<oai::_3gpp::model::RefToBinaryData> InputData::getLppMessageExt() const
{
    return m_LppMessageExt;
}
void InputData::setLppMessageExt(std::vector<oai::_3gpp::model::RefToBinaryData> const& value)
{
...
oai::_3gpp::model::IntegrityRequirements InputData::getIntegrityRequirements() const
{
    return m_IntegrityRequirements;
}
void InputData::setIntegrityRequirements(oai::_3gpp::model::IntegrityRequirements const& value)
{
