...
public:
    ...
    /// 
    /// </summary>
    oai::model::AmfEventSubsSyncInfo getEventSubsSyncInfo() const;
    void setEventSubsSyncInfo(oai::model::AmfEventSubsSyncInfo const& value);
...
protected:
    ...
    oai::model::AmfEventSubsSyncInfo m_EventSubsSyncInfo;
