...
oai::_3gpp::model::MediaComponentResourcesStatus ResourcesAllocationInfo::getMcResourcStatus() const
{
    return m_McResourcStatus;
}
void ResourcesAllocationInfo::setMcResourcStatus(oai::_3gpp::model::MediaComponentResourcesStatus const& value)
{
...
std::vector<oai::_3gpp::model::Flows> ResourcesAllocationInfo::getFlows() const
{
    return m_Flows;
}
void ResourcesAllocationInfo::setFlows(std::vector<oai::_3gpp::model::Flows> const& value)
{
    m_Flows = value;
    m_FlowsIsSet = true;
}
