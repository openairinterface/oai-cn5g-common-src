...
bool AuthorizedDefaultQos::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "AuthorizedDefaultQos" : pathPrefix;
...
oai::_3gpp::model::Arp AuthorizedDefaultQos::getArp() const
{
    return m_Arp;
}
void AuthorizedDefaultQos::setArp(oai::_3gpp::model::Arp const& value)
{
    m_Arp = value;
    m_ArpIsSet = true;
}
