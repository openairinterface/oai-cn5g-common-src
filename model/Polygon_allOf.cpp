...
bool Polygon_allOf::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "Polygon_allOf" : pathPrefix;
...
std::vector<oai::_3gpp::model::GeographicalCoordinates> Polygon_allOf::getPointList() const
{
    return m_PointList;
}
void Polygon_allOf::setPointList(std::vector<oai::_3gpp::model::GeographicalCoordinates> const& value)
{
    m_PointList = value;
}
