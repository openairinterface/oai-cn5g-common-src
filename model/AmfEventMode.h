...
public:
    ...
    /// 
    /// </summary>
    std::vector<oai::_3gpp::model::PartitioningCriteria> getPartitioningCriteria() const;
    void setPartitioningCriteria(std::vector<oai::_3gpp::model::PartitioningCriteria> const& value);
