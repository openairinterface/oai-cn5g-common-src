...
public:
    ...
    /// 
    /// </summary>
    oai::model::N2InfoNotifyReason getNotifyReason() const;
    void setNotifyReason(oai::model::N2InfoNotifyReason const& value);
    bool notifyReasonIsSet() const;
    void unsetNotifyReason();
    /// <summary>
    /// 
    /// </summary>
    std::vector<oai::model::SmfChangeInfo> getSmfChangeInfoList() const;
    void setSmfChangeInfoList(std::vector<oai::model::SmfChangeInfo> const& value);
...
protected:
    ...
    oai::model::N2InfoNotifyReason m_NotifyReason;
    bool m_NotifyReasonIsSet;
    std::vector<oai::model::SmfChangeInfo> m_SmfChangeInfoList;
