...
SteerModeValue_anyOf::eSteerModeValue_anyOf SteerModeValue::getEnumValue() const
{
    return m_value.getValue();
}

void SteerModeValue::setEnumValue(SteerModeValue_anyOf::eSteerModeValue_anyOf  value)
{
