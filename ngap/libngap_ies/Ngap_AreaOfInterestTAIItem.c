...
asn_TYPE_member_t asn_MBR_Ngap_AreaOfInterestTAIItem_1[] = {
    {ATF_POINTER,
     0,
     offsetof(struct Ngap_AreaOfInterestTAIItem, tAI),
    ...
    {ATF_POINTER,
     1,
     offsetof(struct Ngap_AreaOfInterestTAIItem, iE_Extensions),
     (ASN_TAG_CLASS_CONTEXT | (1 << 2)),
     -1, /* IMPLICIT tag at current level */
     &asn_DEF_Ngap_ProtocolExtensionContainer_12929P13,
     0,
     {
#if !defined(ASN_DISABLE_OER_SUPPORT)
         0,
