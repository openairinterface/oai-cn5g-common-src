...
bool Dynamic5Qi::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "Dynamic5Qi" : pathPrefix;

        
    if (!m_ResourceType.validate(msg, _pathPrefix + ".resourceType")) {
        msg << _pathPrefix << ": ResourceType is invalid;";
        success = false;
    }     
...
bool Dynamic5Qi::operator==(const Dynamic5Qi& rhs) const
{
    ...
    ((!extPacketDelBudgetIsSet() && !rhs.extPacketDelBudgetIsSet()) || (extPacketDelBudgetIsSet() && rhs.extPacketDelBudgetIsSet() && getExtPacketDelBudget() == rhs.getExtPacketDelBudget())) &&
    
    
    ((!cnPacketDelayBudgetDlIsSet() && !rhs.cnPacketDelayBudgetDlIsSet()) || (cnPacketDelayBudgetDlIsSet() && rhs.cnPacketDelayBudgetDlIsSet() && getCnPacketDelayBudgetDl() == rhs.getCnPacketDelayBudgetDl())) &&
    
    
    ((!cnPacketDelayBudgetUlIsSet() && !rhs.cnPacketDelayBudgetUlIsSet()) || (cnPacketDelayBudgetUlIsSet() && rhs.cnPacketDelayBudgetUlIsSet() && getCnPacketDelayBudgetUl() == rhs.getCnPacketDelayBudgetUl()))
...
oai::model::QosResourceType Dynamic5Qi::getResourceType() const
{
    return m_ResourceType;
}
void Dynamic5Qi::setResourceType(oai::model::QosResourceType const& value)
{
