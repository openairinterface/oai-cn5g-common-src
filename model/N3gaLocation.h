...
public:
    ...
    /// 
    /// </summary>
    oai::model::Tai getN3gppTai() const;
    void setN3gppTai(oai::model::Tai const& value);
    ...
    /// 
    /// </summary>
    oai::model::Ipv6Addr getUeIpv6Addr() const;
    void setUeIpv6Addr(oai::model::Ipv6Addr const& value);
    ...
    /// 
    /// </summary>
    oai::model::TransportProtocol getProtocol() const;
    void setProtocol(oai::model::TransportProtocol const& value);
    ...
    /// 
    /// </summary>
    oai::model::HfcNodeId getHfcNodeId() const;
    void setHfcNodeId(oai::model::HfcNodeId const& value);
    ...
    /// 
    /// </summary>
    oai::model::LineType getW5gbanLineType() const;
    void setW5gbanLineType(oai::model::LineType const& value);
