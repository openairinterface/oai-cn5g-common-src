...
asn_TYPE_member_t asn_MBR_Ngap_DRBsSubjectToStatusTransferItem_1[] = {
    {ATF_NOFLAGS,
     0,
     offsetof(struct Ngap_DRBsSubjectToStatusTransferItem, dRB_ID),
    ...
    {ATF_POINTER,
     0,
     offsetof(struct Ngap_DRBsSubjectToStatusTransferItem, dRBStatusUL),
    ...
    {ATF_POINTER,
     0,
     offsetof(struct Ngap_DRBsSubjectToStatusTransferItem, dRBStatusDL),
    ...
    {ATF_POINTER,
     1,
     offsetof(struct Ngap_DRBsSubjectToStatusTransferItem, iE_Extension),
     (ASN_TAG_CLASS_CONTEXT | (3 << 2)),
     -1, /* IMPLICIT tag at current level */
     &asn_DEF_Ngap_ProtocolExtensionContainer_12929P59,
     0,
     {
#if !defined(ASN_DISABLE_OER_SUPPORT)
         0,
