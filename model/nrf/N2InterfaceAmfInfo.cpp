...
std::string N2InterfaceAmfInfo::getAmfName() const { return m_AmfName; }
void N2InterfaceAmfInfo::setAmfName(std::string const &value) {
  m_AmfName = value;
  m_AmfNameIsSet = true;
}
bool N2InterfaceAmfInfo::amfNameIsSet() const { return m_AmfNameIsSet; }
void N2InterfaceAmfInfo::unsetAmfName() { m_AmfNameIsSet = false; }
