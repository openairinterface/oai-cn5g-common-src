...
public:
  ...
  bool
  encode(Ngap_PDUSessionResourceSetupItemSURes_t &pduSessionResourceItem) const;
  bool
  decode(const Ngap_PDUSessionResourceSetupItemSURes_t &pduSessionResourceItem);
