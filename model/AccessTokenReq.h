...
public:
    ...
    /// 
    /// </summary>
    oai::model::NFType getTargetNfType() const;
    void setTargetNfType(oai::model::NFType const& value);
    ...
    /// 
    /// </summary>
    oai::model::PlmnId_1 getRequesterPlmn() const;
    void setRequesterPlmn(oai::model::PlmnId_1 const& value);
    bool requesterPlmnIsSet() const;
    void unsetRequesterPlmn();
    /// <summary>
    /// 
    /// </summary>
    std::vector<oai::model::PlmnId_1> getRequesterPlmnList() const;
    void setRequesterPlmnList(std::vector<oai::model::PlmnId_1> const& value);
    bool requesterPlmnListIsSet() const;
    void unsetRequesterPlmnList();
    /// <summary>
    /// 
    /// </summary>
    std::vector<oai::model::Snssai> getRequesterSnssaiList() const;
    void setRequesterSnssaiList(std::vector<oai::model::Snssai> const& value);
    ...
    /// 
    /// </summary>
    std::vector<oai::model::PlmnIdNid_1> getRequesterSnpnList() const;
    void setRequesterSnpnList(std::vector<oai::model::PlmnIdNid_1> const& value);
    bool requesterSnpnListIsSet() const;
    void unsetRequesterSnpnList();
    /// <summary>
    /// 
    /// </summary>
    oai::model::PlmnId_1 getTargetPlmn() const;
    void setTargetPlmn(oai::model::PlmnId_1 const& value);
    bool targetPlmnIsSet() const;
    void unsetTargetPlmn();
    /// <summary>
    /// 
    /// </summary>
    oai::model::PlmnIdNid_1 getTargetSnpn() const;
    void setTargetSnpn(oai::model::PlmnIdNid_1 const& value);
    bool targetSnpnIsSet() const;
    void unsetTargetSnpn();
    /// <summary>
    /// 
    /// </summary>
    std::vector<oai::model::Snssai> getTargetSnssaiList() const;
    void setTargetSnssaiList(std::vector<oai::model::Snssai> const& value);
...
protected:
    ...
    bool m_NfTypeIsSet;
    oai::model::NFType m_TargetNfType;
    bool m_TargetNfTypeIsSet;
    std::string m_Scope;

    std::string m_TargetNfInstanceId;
    bool m_TargetNfInstanceIdIsSet;
    oai::model::PlmnId_1 m_RequesterPlmn;
    bool m_RequesterPlmnIsSet;
    std::vector<oai::model::PlmnId_1> m_RequesterPlmnList;
    bool m_RequesterPlmnListIsSet;
    std::vector<oai::model::Snssai> m_RequesterSnssaiList;
    bool m_RequesterSnssaiListIsSet;
    std::string m_RequesterFqdn;
    bool m_RequesterFqdnIsSet;
    std::vector<oai::model::PlmnIdNid_1> m_RequesterSnpnList;
    bool m_RequesterSnpnListIsSet;
    oai::model::PlmnId_1 m_TargetPlmn;
    bool m_TargetPlmnIsSet;
    oai::model::PlmnIdNid_1 m_TargetSnpn;
    bool m_TargetSnpnIsSet;
    std::vector<oai::model::Snssai> m_TargetSnssaiList;
