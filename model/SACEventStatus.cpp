...
bool SACEventStatus::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "SACEventStatus" : pathPrefix;
...
bool SACEventStatus::operator==(const SACEventStatus& rhs) const
{
    ...
    ((!reachedNumUesIsSet() && !rhs.reachedNumUesIsSet()) || (reachedNumUesIsSet() && rhs.reachedNumUesIsSet() && getReachedNumUes() == rhs.getReachedNumUes())) &&
    
    
    ((!reachedNumPduSessIsSet() && !rhs.reachedNumPduSessIsSet()) || (reachedNumPduSessIsSet() && rhs.reachedNumPduSessIsSet() && getReachedNumPduSess() == rhs.getReachedNumPduSess()))
...
oai::model::SACInfo SACEventStatus::getReachedNumUes() const
{
    return m_ReachedNumUes;
}
void SACEventStatus::setReachedNumUes(oai::model::SACInfo const& value)
{
...
oai::model::SACInfo SACEventStatus::getReachedNumPduSess() const
{
    return m_ReachedNumPduSess;
}
void SACEventStatus::setReachedNumPduSess(oai::model::SACInfo const& value)
{
