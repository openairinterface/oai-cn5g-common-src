...
bool RedirectInformation::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "RedirectInformation" : pathPrefix;
...
bool RedirectInformation::operator==(const RedirectInformation& rhs) const
{
    ...
    ((!redirectEnabledIsSet() && !rhs.redirectEnabledIsSet()) || (redirectEnabledIsSet() && rhs.redirectEnabledIsSet() && isRedirectEnabled() == rhs.isRedirectEnabled())) &&
    
    
    ((!redirectAddressTypeIsSet() && !rhs.redirectAddressTypeIsSet()) || (redirectAddressTypeIsSet() && rhs.redirectAddressTypeIsSet() && getRedirectAddressType() == rhs.getRedirectAddressType())) &&
    
    
    ((!redirectServerAddressIsSet() && !rhs.redirectServerAddressIsSet()) || (redirectServerAddressIsSet() && rhs.redirectServerAddressIsSet() && getRedirectServerAddress() == rhs.getRedirectServerAddress()))
...
oai::_3gpp::model::RedirectAddressType RedirectInformation::getRedirectAddressType() const
{
    return m_RedirectAddressType;
}
void RedirectInformation::setRedirectAddressType(oai::_3gpp::model::RedirectAddressType const& value)
{
