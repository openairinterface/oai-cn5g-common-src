...
bool AppSessionContext::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "AppSessionContext" : pathPrefix;
...
bool AppSessionContext::operator==(const AppSessionContext& rhs) const
{
    ...
    ((!ascReqDataIsSet() && !rhs.ascReqDataIsSet()) || (ascReqDataIsSet() && rhs.ascReqDataIsSet() && getAscReqData() == rhs.getAscReqData())) &&
    
    
    ((!ascRespDataIsSet() && !rhs.ascRespDataIsSet()) || (ascRespDataIsSet() && rhs.ascRespDataIsSet() && getAscRespData() == rhs.getAscRespData())) &&
    
    
    ((!evsNotifIsSet() && !rhs.evsNotifIsSet()) || (evsNotifIsSet() && rhs.evsNotifIsSet() && getEvsNotif() == rhs.getEvsNotif()))
...
oai::model::AppSessionContextReqData AppSessionContext::getAscReqData() const
{
    return m_AscReqData;
}
void AppSessionContext::setAscReqData(oai::model::AppSessionContextReqData const& value)
{
    m_AscReqData = value;
...
oai::model::AppSessionContextRespData AppSessionContext::getAscRespData() const
{
    return m_AscRespData;
}
void AppSessionContext::setAscRespData(oai::model::AppSessionContextRespData const& value)
{
    m_AscRespData = value;
...
oai::model::EventsNotification AppSessionContext::getEvsNotif() const
{
    return m_EvsNotif;
}
void AppSessionContext::setEvsNotif(oai::model::EventsNotification const& value)
{
    m_EvsNotif = value;
