...
void UEAuthenticationCtx::setAuthType(oai::_3gpp::model::AuthType const& value)
{
    m_AuthType = value;
}
oai::_3gpp::model::UEAuthenticationCtx_5gAuthData UEAuthenticationCtx::getR5gAuthData() const
{
    return m_r_5gAuthData;
}
void UEAuthenticationCtx::setR5gAuthData(oai::_3gpp::model::UEAuthenticationCtx_5gAuthData const& value)
{
    m_r_5gAuthData = value;
}
std::map<std::string, oai::_3gpp::model::LinksValueSchema> UEAuthenticationCtx::getLinks() const
{
    return m__links;
}
void UEAuthenticationCtx::setLinks(std::map<std::string, oai::_3gpp::model::LinksValueSchema> const& value)
{
    m__links = value;
}
