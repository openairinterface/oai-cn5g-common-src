...
bool UpConfidentiality::validate(std::stringstream &msg,
...
UpIntegrity_anyOf UpConfidentiality::getValue() const { return m_value; }

void UpConfidentiality::setValue(UpIntegrity_anyOf value) { m_value = value; }
