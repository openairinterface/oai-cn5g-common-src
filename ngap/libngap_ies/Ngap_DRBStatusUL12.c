...
asn_TYPE_member_t asn_MBR_Ngap_DRBStatusUL12_1[] = {
    {ATF_POINTER,
     0,
     offsetof(struct Ngap_DRBStatusUL12, uL_COUNTValue),
    ...
    {ATF_POINTER,
     2,
     offsetof(struct Ngap_DRBStatusUL12, receiveStatusOfUL_PDCP_SDUs),
    ...
    {ATF_POINTER,
     1,
     offsetof(struct Ngap_DRBStatusUL12, iE_Extension),
     (ASN_TAG_CLASS_CONTEXT | (2 << 2)),
     -1, /* IMPLICIT tag at current level */
     &asn_DEF_Ngap_ProtocolExtensionContainer_12929P62,
     0,
     {
#if !defined(ASN_DISABLE_OER_SUPPORT)
         0,
