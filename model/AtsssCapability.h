...
class AtsssCapability {
 public:
  ...
  /// Traffic Steering, Switching, Splitting (see clauses 4.2.10, 5.32 of 3GPP
  /// TS 23.501). true: Supported false (default): Not Supported
  /// </summary>
  ...
  /// measurement without PMF (see clauses 5.32.2, 6.3.3.3 of 3GPP TS 23.501
