...
public:
    ...
    /// 
    /// </summary>
    oai::model::AppDetectionNotifType getAdNotifType() const;
    void setAdNotifType(oai::model::AppDetectionNotifType const& value);
    /// <summary>
...
protected:
    oai::model::AppDetectionNotifType m_AdNotifType;
