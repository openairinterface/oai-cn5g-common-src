...
asn_TYPE_member_t asn_MBR_Ngap_UE_NGAP_ID_pair_1[] = {
    {ATF_NOFLAGS,
     0,
     offsetof(struct Ngap_UE_NGAP_ID_pair, aMF_UE_NGAP_ID),
    ...
    {ATF_NOFLAGS,
     0,
     offsetof(struct Ngap_UE_NGAP_ID_pair, rAN_UE_NGAP_ID),
    ...
    {ATF_POINTER,
     1,
     offsetof(struct Ngap_UE_NGAP_ID_pair, iE_Extensions),
     (ASN_TAG_CLASS_CONTEXT | (2 << 2)),
     -1, /* IMPLICIT tag at current level */
     &asn_DEF_Ngap_ProtocolExtensionContainer_12929P354,
     0,
     {
#if !defined(ASN_DISABLE_OER_SUPPORT)
         0,
