...
bool ScheduledCommunicationTime::validate(std::stringstream& msg) const
{
    return validate(msg, "");
}

bool ScheduledCommunicationTime::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "ScheduledCommunicationTime" : pathPrefix;
...
bool ScheduledCommunicationTime::operator==(const ScheduledCommunicationTime& rhs) const
{
    return
    ...
    ((!timeOfDayStartIsSet() && !rhs.timeOfDayStartIsSet()) || (timeOfDayStartIsSet() && rhs.timeOfDayStartIsSet() && getTimeOfDayStart() == rhs.getTimeOfDayStart())) &&
    
    
    ((!timeOfDayEndIsSet() && !rhs.timeOfDayEndIsSet()) || (timeOfDayEndIsSet() && rhs.timeOfDayEndIsSet() && getTimeOfDayEnd() == rhs.getTimeOfDayEnd()))
...
std::vector<int32_t> ScheduledCommunicationTime::getDaysOfWeek() const
{
    return m_DaysOfWeek;
}
void ScheduledCommunicationTime::setDaysOfWeek(std::vector<int32_t> const value)
{
    m_DaysOfWeek = value;
