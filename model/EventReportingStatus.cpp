...
bool EventReportingStatus::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "EventReportingStatus" : pathPrefix;
...
bool EventReportingStatus::operator==(const EventReportingStatus& rhs) const
{
    ...
    ((!eventReportCounterIsSet() && !rhs.eventReportCounterIsSet()) || (eventReportCounterIsSet() && rhs.eventReportCounterIsSet() && getEventReportCounter() == rhs.getEventReportCounter())) &&
    
    
    ((!eventReportDurationIsSet() && !rhs.eventReportDurationIsSet()) || (eventReportDurationIsSet() && rhs.eventReportDurationIsSet() && getEventReportDuration() == rhs.getEventReportDuration()))
