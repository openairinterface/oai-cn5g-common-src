...
std::map<std::string, oai::_3gpp::model::PresenceInfo> AmPolicyData::getPraInfos() const
{
    return m_PraInfos;
}
void AmPolicyData::setPraInfos(std::map<std::string, oai::_3gpp::model::PresenceInfo> const& value)
{
    m_PraInfos = value;
