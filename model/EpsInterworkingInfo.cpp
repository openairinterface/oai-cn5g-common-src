...
std::map<std::string, oai::model::EpsIwkPgw> EpsInterworkingInfo::getEpsIwkPgws() const
{
    return m_EpsIwkPgws;
}
void EpsInterworkingInfo::setEpsIwkPgws(std::map<std::string, oai::model::EpsIwkPgw> const& value)
{
    m_EpsIwkPgws = value;
