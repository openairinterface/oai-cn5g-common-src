...
void SeppInfo::setRemotePlmnList(std::vector<oai::_3gpp::model::PlmnId> const& value)
{
...
void SeppInfo::setRemoteSnpnList(std::vector<oai::_3gpp::model::PlmnIdNid> const& value)
{
