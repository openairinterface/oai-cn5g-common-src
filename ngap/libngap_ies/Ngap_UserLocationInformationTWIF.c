...
asn_TYPE_member_t asn_MBR_Ngap_UserLocationInformationTWIF_1[] = {
    {ATF_NOFLAGS,
     0,
     offsetof(struct Ngap_UserLocationInformationTWIF, tWAP_ID),
    ...
    {ATF_NOFLAGS,
     0,
     offsetof(struct Ngap_UserLocationInformationTWIF, iPAddress),
    ...
    {ATF_POINTER,
     2,
     offsetof(struct Ngap_UserLocationInformationTWIF, portNumber),
    ...
    {ATF_POINTER,
     1,
     offsetof(struct Ngap_UserLocationInformationTWIF, iE_Extensions),
     (ASN_TAG_CLASS_CONTEXT | (3 << 2)),
     -1, /* IMPLICIT tag at current level */
     &asn_DEF_Ngap_ProtocolExtensionContainer_12929P367,
     0,
     {
#if !defined(ASN_DISABLE_OER_SUPPORT)
         0,
...
asn_SEQUENCE_specifics_t asn_SPC_Ngap_UserLocationInformationTWIF_specs_1 = {
