...
bool Guami::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
...
oai::model::PlmnIdNid Guami::getPlmnId() const
{
    return m_PlmnId;
}
void Guami::setPlmnId(oai::model::PlmnIdNid const& value)
{
    m_PlmnId = value;
}
