...
public:
    ...
    /// </summary>
    std::map<std::string, oai::model::DnnConfiguration> getDnnConfigurations() const;
    void setDnnConfigurations(std::map<std::string, oai::model::DnnConfiguration> const& value);
    ...
    /// </summary>
    std::map<std::string, oai::model::ExpectedUeBehaviourData> getExpectedUeBehavioursList() const;
    void setExpectedUeBehavioursList(std::map<std::string, oai::model::ExpectedUeBehaviourData> const& value);
    ...
    /// </summary>
    std::map<std::string, oai::model::SuggestedPacketNumDl> getSuggestedPacketNumDlList() const;
    void setSuggestedPacketNumDlList(std::map<std::string, oai::model::SuggestedPacketNumDl> const& value);
...
protected:
    ...
    std::map<std::string, oai::model::DnnConfiguration> m_DnnConfigurations;
    ...
    std::map<std::string, oai::model::ExpectedUeBehaviourData> m_ExpectedUeBehavioursList;
    bool m_ExpectedUeBehavioursListIsSet;
    std::map<std::string, oai::model::SuggestedPacketNumDl> m_SuggestedPacketNumDlList;
