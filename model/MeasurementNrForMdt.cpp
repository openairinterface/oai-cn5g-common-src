...
bool MeasurementNrForMdt::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "MeasurementNrForMdt" : pathPrefix;
...
MeasurementLteForMdt_anyOf::eMeasurementLteForMdt_anyOf MeasurementNrForMdt::getEnumValue() const
{
    return m_value.getValue();
}

void MeasurementNrForMdt::setEnumValue(MeasurementLteForMdt_anyOf::eMeasurementLteForMdt_anyOf  value)
{
