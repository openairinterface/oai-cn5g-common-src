...
bool PointAltitude::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "PointAltitude" : pathPrefix;
...
oai::model::SupportedGADShapes PointAltitude::getShape() const
{
    return m_Shape;
}
void PointAltitude::setShape(oai::model::SupportedGADShapes const& value)
{
    m_Shape = value;
}
oai::model::GeographicalCoordinates PointAltitude::getPoint() const
{
    return m_Point;
}
void PointAltitude::setPoint(oai::model::GeographicalCoordinates const& value)
{
    m_Point = value;
}
