...
public:
    ...
    /// 
    /// </summary>
    std::vector<oai::model::ReportingFrequency> getRepFreqs() const;
    void setRepFreqs(std::vector<oai::model::ReportingFrequency> const& value);
    /// <summary>
...
protected:
    ...
    std::vector<oai::model::ReportingFrequency> m_RepFreqs;
