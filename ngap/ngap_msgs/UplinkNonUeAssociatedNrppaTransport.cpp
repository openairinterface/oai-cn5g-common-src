...
void UplinkNonUeAssociatedNrppaTransportMsg::initialize() {
  ...
  if (!m_UplinkNonUeAssociatedNrppaTransportIes->protocolIEs) {
    m_UplinkNonUeAssociatedNrppaTransportIes->protocolIEs =
...
bool UplinkNonUeAssociatedNrppaTransportMsg::decode(
  ...
  for (int i = 0;
       ...
       i++) {
    Ngap_UplinkNonUEAssociatedNRPPaTransportIEs_t* ngap_ie =
