...
bool PduSessionManagementData::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    ...
    {
        const std::vector<oai::_3gpp::model::RouteToLocation>& value = m_N6TrafficRoutingInfo;
...
oai::_3gpp::model::PduSessionStatus PduSessionManagementData::getPduSessionStatus() const
{
    return m_PduSessionStatus;
}
void PduSessionManagementData::setPduSessionStatus(oai::_3gpp::model::PduSessionStatus const& value)
{
...
std::vector<oai::_3gpp::model::RouteToLocation> PduSessionManagementData::getN6TrafficRoutingInfo() const
{
    return m_N6TrafficRoutingInfo;
}
void PduSessionManagementData::setN6TrafficRoutingInfo(std::vector<oai::_3gpp::model::RouteToLocation> const& value)
{
...
std::vector<oai::_3gpp::model::Ipv6Prefix> PduSessionManagementData::getIpv6Prefix() const
{
    return m_Ipv6Prefix;
}
void PduSessionManagementData::setIpv6Prefix(std::vector<oai::_3gpp::model::Ipv6Prefix> const& value)
{
    m_Ipv6Prefix = value;
...
std::vector<oai::_3gpp::model::Ipv6Addr> PduSessionManagementData::getIpv6Addrs() const
{
    return m_Ipv6Addrs;
}
void PduSessionManagementData::setIpv6Addrs(std::vector<oai::_3gpp::model::Ipv6Addr> const& value)
{
    m_Ipv6Addrs = value;
...
oai::_3gpp::model::PduSessionType PduSessionManagementData::getPduSessType() const
{
    return m_PduSessType;
}
void PduSessionManagementData::setPduSessType(oai::_3gpp::model::PduSessionType const& value)
{
    m_PduSessType = value;
