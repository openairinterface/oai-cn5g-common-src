...
public:
    ...
    /// </summary>
    std::map<std::string, oai::model::pcf::MediaComponent> getAccBwMedComps() const;
    void setAccBwMedComps(std::map<std::string, oai::model::pcf::MediaComponent> const& value);
