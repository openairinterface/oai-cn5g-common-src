...
std::vector<oai::model::InvalidParam> ProblemDetails::getInvalidParams() const
{
    return m_InvalidParams;
}
void ProblemDetails::setInvalidParams(std::vector<oai::model::InvalidParam> const& value)
{
...
oai::model::AccessTokenErr ProblemDetails::getAccessTokenError() const
{
    return m_AccessTokenError;
}
void ProblemDetails::setAccessTokenError(oai::model::AccessTokenErr const& value)
{
...
oai::model::AccessTokenReq ProblemDetails::getAccessTokenRequest() const
{
    return m_AccessTokenRequest;
}
void ProblemDetails::setAccessTokenRequest(oai::model::AccessTokenReq const& value)
{
