...
asn_oer_constraints_t asn_OER_type_Ngap_UE_NGAP_IDs_constr_1 CC_NOTUSED = {
    {0, 0},
    -1};
...
asn_TYPE_member_t asn_MBR_Ngap_UE_NGAP_IDs_1[] = {
    {ATF_POINTER,
     0,
     offsetof(struct Ngap_UE_NGAP_IDs, choice.uE_NGAP_ID_pair),
    ...
    {ATF_NOFLAGS,
     0,
     offsetof(struct Ngap_UE_NGAP_IDs, choice.aMF_UE_NGAP_ID),
    ...
    {ATF_POINTER,
     ...
     -1, /* IMPLICIT tag at current level */
     &asn_DEF_Ngap_ProtocolIE_SingleContainer_12877P56,
     0,
     {
#if !defined(ASN_DISABLE_OER_SUPPORT)
         0,
