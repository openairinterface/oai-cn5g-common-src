...
bool NssfEventSubscriptionCreatedData::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "NssfEventSubscriptionCreatedData" : pathPrefix;

                 
    if (authorizedNssaiAvailabilityDataIsSet())
    {
        const std::vector<oai::_3gpp::model::AuthorizedNssaiAvailabilityData>& value = m_AuthorizedNssaiAvailabilityData;
        const std::string currentValuePath = _pathPrefix + ".authorizedNssaiAvailabilityData";
        ...
        { // Recursive validation of array elements
            ...
            int i = 0;
            for (const oai::_3gpp::model::AuthorizedNssaiAvailabilityData& value : value)
            { 
                const std::string currentValuePath = oldValuePath + "[" + std::to_string(i) + "]";
                        
        success = value.validate(msg, currentValuePath + ".authorizedNssaiAvailabilityData") && success;
...
bool NssfEventSubscriptionCreatedData::operator==(const NssfEventSubscriptionCreatedData& rhs) const
{
    return
    ...
    ((!authorizedNssaiAvailabilityDataIsSet() && !rhs.authorizedNssaiAvailabilityDataIsSet()) || (authorizedNssaiAvailabilityDataIsSet() && rhs.authorizedNssaiAvailabilityDataIsSet() && getAuthorizedNssaiAvailabilityData() == rhs.getAuthorizedNssaiAvailabilityData())) &&
...
void to_json(nlohmann::json& j, const NssfEventSubscriptionCreatedData& o)
{
    ...
    if(o.expiryIsSet())
        j["expiry"] = o.m_Expiry;
    if(o.authorizedNssaiAvailabilityDataIsSet() || !o.m_AuthorizedNssaiAvailabilityData.empty())
...
void from_json(const nlohmann::json& j, NssfEventSubscriptionCreatedData& o)
{
    ...
    {
        j.at("authorizedNssaiAvailabilityData").get_to(o.m_AuthorizedNssaiAvailabilityData);
...
void NssfEventSubscriptionCreatedData::setSubscriptionId(std::string const& value)
{
...
std::vector<oai::_3gpp::model::AuthorizedNssaiAvailabilityData> NssfEventSubscriptionCreatedData::getAuthorizedNssaiAvailabilityData() const
{
    return m_AuthorizedNssaiAvailabilityData;
}
void NssfEventSubscriptionCreatedData::setAuthorizedNssaiAvailabilityData(std::vector<oai::_3gpp::model::AuthorizedNssaiAvailabilityData> const& value)
{
    m_AuthorizedNssaiAvailabilityData = value;
    m_AuthorizedNssaiAvailabilityDataIsSet = true;
}
bool NssfEventSubscriptionCreatedData::authorizedNssaiAvailabilityDataIsSet() const
{
...
void NssfEventSubscriptionCreatedData::setSupportedFeatures(std::string const& value)
{
