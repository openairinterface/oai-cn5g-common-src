...
asn_TYPE_member_t asn_MBR_Ngap_AlternativeQoSParaSetItem_1[] = {
    {ATF_NOFLAGS,
     0,
     offsetof(
         struct Ngap_AlternativeQoSParaSetItem, alternativeQoSParaSetIndex),
    ...
    {ATF_POINTER,
     5,
     offsetof(struct Ngap_AlternativeQoSParaSetItem, guaranteedFlowBitRateDL),
    ...
    {ATF_POINTER,
     4,
     offsetof(struct Ngap_AlternativeQoSParaSetItem, guaranteedFlowBitRateUL),
    ...
    {ATF_POINTER,
     3,
     offsetof(struct Ngap_AlternativeQoSParaSetItem, packetDelayBudget),
    ...
    {ATF_POINTER,
     2,
     offsetof(struct Ngap_AlternativeQoSParaSetItem, packetErrorRate),
    ...
    {ATF_POINTER,
     1,
     offsetof(struct Ngap_AlternativeQoSParaSetItem, iE_Extensions),
     (ASN_TAG_CLASS_CONTEXT | (5 << 2)),
     -1, /* IMPLICIT tag at current level */
     &asn_DEF_Ngap_ProtocolExtensionContainer_12929P4,
     0,
     {
#if !defined(ASN_DISABLE_OER_SUPPORT)
         0,
...
static const int asn_MAP_Ngap_AlternativeQoSParaSetItem_oms_1[] = {
    1, 2, 3, 4, 5};
