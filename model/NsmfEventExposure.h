...
public:
    ...
    void setEventSubs(std::vector<oai::_3gpp::model::EventSubscription> const& value);
    /// <summary>
    /// 
    /// </summary>
    std::vector<oai::_3gpp::model::EventNotification> getEventNotifs() const;
    void setEventNotifs(std::vector<oai::_3gpp::model::EventNotification> const& value);
    ...
    /// </summary>
    std::vector<oai::_3gpp::model::PartitioningCriteria> getPartitionCriteria() const;
    void setPartitionCriteria(std::vector<oai::_3gpp::model::PartitioningCriteria> const& value);
