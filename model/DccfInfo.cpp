...
std::vector<oai::model::NFType> DccfInfo::getServingNfTypeList() const
{
    return m_ServingNfTypeList;
}
void DccfInfo::setServingNfTypeList(std::vector<oai::model::NFType> const& value)
{
...
std::vector<oai::model::Tai> DccfInfo::getTaiList() const
{
    return m_TaiList;
}
void DccfInfo::setTaiList(std::vector<oai::model::Tai> const& value)
{
    m_TaiList = value;
    m_TaiListIsSet = true;
}
...
std::vector<oai::model::TaiRange> DccfInfo::getTaiRangeList() const
{
    return m_TaiRangeList;
}
void DccfInfo::setTaiRangeList(std::vector<oai::model::TaiRange> const& value)
{
