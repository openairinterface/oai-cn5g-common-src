...
bool ReportTypeMdt::validate(std::stringstream &msg,
...
ReportTypeMdt_anyOf ReportTypeMdt::getValue() const { return m_value; }

void ReportTypeMdt::setValue(ReportTypeMdt_anyOf value) { m_value = value; }
