...
bool Pc5QoSPara::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    ...
    /* Pc5QosFlowList */ {
        const std::vector<oai::model::Pc5QosFlowItem>& value = m_Pc5QosFlowList;
        ...
        { // Recursive validation of array elements
            ...
            int i = 0;
            for (const oai::model::Pc5QosFlowItem& value : value)
            { 
...
std::vector<oai::model::Pc5QosFlowItem> Pc5QoSPara::getPc5QosFlowList() const
{
    return m_Pc5QosFlowList;
}
void Pc5QoSPara::setPc5QosFlowList(std::vector<oai::model::Pc5QosFlowItem> const& value)
{
