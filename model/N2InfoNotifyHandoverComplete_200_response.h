...
*/
/*
 * N2InfoNotifyHandoverComplete_200_response.h
 *
 * 
 */

#ifndef N2InfoNotifyHandoverComplete_200_response_H_
#define N2InfoNotifyHandoverComplete_200_response_H_
...
/// 
/// </summary>
class  N2InfoNotifyHandoverComplete_200_response
{
public:
    N2InfoNotifyHandoverComplete_200_response();
    virtual ~N2InfoNotifyHandoverComplete_200_response() = default;
    ...
    bool operator==(const N2InfoNotifyHandoverComplete_200_response& rhs) const;
    bool operator!=(const N2InfoNotifyHandoverComplete_200_response& rhs) const;

    /////////////////////////////////////////////
    /// N2InfoNotifyHandoverComplete_200_response members

    /// <summary>
    /// 
    /// </summary>
    oai::_3gpp::model::N2InfoNotificationRspData getJsonData() const;
    void setJsonData(oai::_3gpp::model::N2InfoNotificationRspData const& value);
    ...
    friend void to_json(nlohmann::json& j, const N2InfoNotifyHandoverComplete_200_response& o);
    friend void from_json(const nlohmann::json& j, N2InfoNotifyHandoverComplete_200_response& o);
protected:
    oai::_3gpp::model::N2InfoNotificationRspData m_JsonData;
...
#endif /* N2InfoNotifyHandoverComplete_200_response_H_ */
