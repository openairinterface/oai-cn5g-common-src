...
bool QFIContainerInformation::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    ...
    {
        const std::vector<oai::_3gpp::model::ServingNetworkFunctionID>& value = m_ServingNetworkFunctionID;
...
void QFIContainerInformation::setQoSInformation(oai::_3gpp::model::QosData const& value)
{
...
oai::_3gpp::model::QosCharacteristics QFIContainerInformation::getQoSCharacteristics() const
{
    return m_QoSCharacteristics;
}
void QFIContainerInformation::setQoSCharacteristics(oai::_3gpp::model::QosCharacteristics const& value)
{
...
oai::_3gpp::model::UserLocation QFIContainerInformation::getUserLocationInformation() const
{
    return m_UserLocationInformation;
}
void QFIContainerInformation::setUserLocationInformation(oai::_3gpp::model::UserLocation const& value)
{
...
std::map<std::string, oai::_3gpp::model::PresenceInfo> QFIContainerInformation::getPresenceReportingAreaInformation() const
{
    return m_PresenceReportingAreaInformation;
}
void QFIContainerInformation::setPresenceReportingAreaInformation(std::map<std::string, oai::_3gpp::model::PresenceInfo> const& value)
{
...
void QFIContainerInformation::setRATType(oai::_3gpp::model::RatType const& value)
{
    m_RATType = value;
    m_RATTypeIsSet = true;
}
...
std::vector<oai::_3gpp::model::ServingNetworkFunctionID> QFIContainerInformation::getServingNetworkFunctionID() const
{
    return m_ServingNetworkFunctionID;
}
void QFIContainerInformation::setServingNetworkFunctionID(std::vector<oai::_3gpp::model::ServingNetworkFunctionID> const& value)
{
...
oai::_3gpp::model::r_3GPPPSDataOffStatus QFIContainerInformation::getR3gppPSDataOffStatus() const
{
    return m_r_3gppPSDataOffStatus;
}
void QFIContainerInformation::setR3gppPSDataOffStatus(oai::_3gpp::model::r_3GPPPSDataOffStatus const& value)
{
