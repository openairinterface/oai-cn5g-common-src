...
public:
    ...
    friend  void to_json(nlohmann::json& j, const ScpDomainRoutingInfoSubscription& o);
    friend  void from_json(const nlohmann::json& j, ScpDomainRoutingInfoSubscription& o);
protected:
