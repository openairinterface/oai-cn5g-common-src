...
bool AccessAndMobilityData::validate(
    std::stringstream& msg, const std::string& pathPrefix) const {
  bool success = true;
  const std::string _pathPrefix =
      pathPrefix.empty() ? "AccessAndMobilityData" : pathPrefix;
  ...
  if (regStatesIsSet()) {
    ...
    {  // Recursive validation of array elements
      ...
      for (const oai::_3gpp::model::RmInfo& value : value) {
        ...
        success =
            value.validate(msg, currentValuePath + ".regStates") && success;
  ...
  if (connStatesIsSet()) {
    ...
    {  // Recursive validation of array elements
      ...
      for (const oai::_3gpp::model::CmInfo& value : value) {
        ...
        success =
            value.validate(msg, currentValuePath + ".connStates") && success;
...
bool AccessAndMobilityData::operator==(const AccessAndMobilityData& rhs) const {
  return
      ...
      ((!locationTsIsSet() && !rhs.locationTsIsSet()) ||
       (locationTsIsSet() && rhs.locationTsIsSet() &&
        getLocationTs() == rhs.getLocationTs())) &&

      ((!timeZoneIsSet() && !rhs.timeZoneIsSet()) ||
       (timeZoneIsSet() && rhs.timeZoneIsSet() &&
        getTimeZone() == rhs.getTimeZone())) &&

      ((!timeZoneTsIsSet() && !rhs.timeZoneTsIsSet()) ||
       (timeZoneTsIsSet() && rhs.timeZoneTsIsSet() &&
        getTimeZoneTs() == rhs.getTimeZoneTs())) &&

      ((!accessTypeIsSet() && !rhs.accessTypeIsSet()) ||
       (accessTypeIsSet() && rhs.accessTypeIsSet() &&
        getAccessType() == rhs.getAccessType())) &&

      ((!regStatesIsSet() && !rhs.regStatesIsSet()) ||
       (regStatesIsSet() && rhs.regStatesIsSet() &&
        getRegStates() == rhs.getRegStates())) &&

      ((!regStatesTsIsSet() && !rhs.regStatesTsIsSet()) ||
       (regStatesTsIsSet() && rhs.regStatesTsIsSet() &&
        getRegStatesTs() == rhs.getRegStatesTs())) &&

      ((!connStatesIsSet() && !rhs.connStatesIsSet()) ||
       (connStatesIsSet() && rhs.connStatesIsSet() &&
        getConnStates() == rhs.getConnStates())) &&

      ((!connStatesTsIsSet() && !rhs.connStatesTsIsSet()) ||
       (connStatesTsIsSet() && rhs.connStatesTsIsSet() &&
        getConnStatesTs() == rhs.getConnStatesTs())) &&

      ((!reachabilityStatusIsSet() && !rhs.reachabilityStatusIsSet()) ||
       (reachabilityStatusIsSet() && rhs.reachabilityStatusIsSet() &&
        getReachabilityStatus() == rhs.getReachabilityStatus())) &&

      ((!reachabilityStatusTsIsSet() && !rhs.reachabilityStatusTsIsSet()) ||
       (reachabilityStatusTsIsSet() && rhs.reachabilityStatusTsIsSet() &&
        getReachabilityStatusTs() == rhs.getReachabilityStatusTs())) &&

      ((!smsOverNasStatusIsSet() && !rhs.smsOverNasStatusIsSet()) ||
       (smsOverNasStatusIsSet() && rhs.smsOverNasStatusIsSet() &&
        getSmsOverNasStatus() == rhs.getSmsOverNasStatus())) &&

      ((!smsOverNasStatusTsIsSet() && !rhs.smsOverNasStatusTsIsSet()) ||
       (smsOverNasStatusTsIsSet() && rhs.smsOverNasStatusTsIsSet() &&
        getSmsOverNasStatusTs() == rhs.getSmsOverNasStatusTs())) &&

      ((!roamingStatusIsSet() && !rhs.roamingStatusIsSet()) ||
       (roamingStatusIsSet() && rhs.roamingStatusIsSet() &&
        isRoamingStatus() == rhs.isRoamingStatus())) &&

      ((!roamingStatusTsIsSet() && !rhs.roamingStatusTsIsSet()) ||
       (roamingStatusTsIsSet() && rhs.roamingStatusTsIsSet() &&
        getRoamingStatusTs() == rhs.getRoamingStatusTs())) &&

      ((!currentPlmnIsSet() && !rhs.currentPlmnIsSet()) ||
       (currentPlmnIsSet() && rhs.currentPlmnIsSet() &&
        getCurrentPlmn() == rhs.getCurrentPlmn())) &&

      ((!currentPlmnTsIsSet() && !rhs.currentPlmnTsIsSet()) ||
       (currentPlmnTsIsSet() && rhs.currentPlmnTsIsSet() &&
        getCurrentPlmnTs() == rhs.getCurrentPlmnTs())) &&

      ((!ratTypeIsSet() && !rhs.ratTypeIsSet()) ||
       (ratTypeIsSet() && rhs.ratTypeIsSet() &&
        getRatType() == rhs.getRatType())) &&

      ((!ratTypesTsIsSet() && !rhs.ratTypesTsIsSet()) ||
       (ratTypesTsIsSet() && rhs.ratTypesTsIsSet() &&
        getRatTypesTs() == rhs.getRatTypesTs())) &&
...
std::vector<oai::_3gpp::model::RmInfo> AccessAndMobilityData::getRegStates()
    const {
  return m_RegStates;
}
void AccessAndMobilityData::setRegStates(
...
std::vector<oai::_3gpp::model::CmInfo> AccessAndMobilityData::getConnStates()
    const {
  return m_ConnStates;
}
void AccessAndMobilityData::setConnStates(
...
oai::_3gpp::model::UeReachability AccessAndMobilityData::getReachabilityStatus()
    const {
  return m_ReachabilityStatus;
}
void AccessAndMobilityData::setReachabilityStatus(
...
oai::_3gpp::model::SmsSupport AccessAndMobilityData::getSmsOverNasStatus()
    const {
  return m_SmsOverNasStatus;
}
void AccessAndMobilityData::setSmsOverNasStatus(
    oai::_3gpp::model::SmsSupport const& value) {
...
std::vector<oai::_3gpp::model::RatType> AccessAndMobilityData::getRatType()
    const {
  return m_RatType;
}
