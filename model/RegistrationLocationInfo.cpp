...
bool RegistrationLocationInfo::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "RegistrationLocationInfo" : pathPrefix;
...
bool RegistrationLocationInfo::operator==(const RegistrationLocationInfo& rhs) const
{
    return
...
oai::model::Guami RegistrationLocationInfo::getGuami() const
{
    return m_Guami;
}
void RegistrationLocationInfo::setGuami(oai::model::Guami const& value)
{
    m_Guami = value;
    m_GuamiIsSet = true;
}
...
oai::model::PlmnId RegistrationLocationInfo::getPlmnId() const
{
    return m_PlmnId;
}
void RegistrationLocationInfo::setPlmnId(oai::model::PlmnId const& value)
{
    m_PlmnId = value;
    m_PlmnIdIsSet = true;
}
...
oai::model::VgmlcAddress RegistrationLocationInfo::getVgmlcAddress() const
{
    return m_VgmlcAddress;
}
void RegistrationLocationInfo::setVgmlcAddress(oai::model::VgmlcAddress const& value)
{
...
std::vector<oai::model::AccessType> RegistrationLocationInfo::getAccessTypeList() const
{
    return m_AccessTypeList;
}
void RegistrationLocationInfo::setAccessTypeList(std::vector<oai::model::AccessType> const& value)
{
