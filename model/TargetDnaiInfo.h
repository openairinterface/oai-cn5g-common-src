...
public:
    ...
    /// 
    /// </summary>
    oai::model::SmfSelectionType getSmfSelectionType() const;
    void setSmfSelectionType(oai::model::SmfSelectionType const& value);
...
protected:
    ...
    oai::model::SmfSelectionType m_SmfSelectionType;
