...
bool UeDifferentiationInfo::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "UeDifferentiationInfo" : pathPrefix;
...
bool UeDifferentiationInfo::operator==(const UeDifferentiationInfo& rhs) const
{
    ...
    ((!periodicComIndIsSet() && !rhs.periodicComIndIsSet()) || (periodicComIndIsSet() && rhs.periodicComIndIsSet() && getPeriodicComInd() == rhs.getPeriodicComInd())) &&
    
    
    ((!periodicTimeIsSet() && !rhs.periodicTimeIsSet()) || (periodicTimeIsSet() && rhs.periodicTimeIsSet() && getPeriodicTime() == rhs.getPeriodicTime())) &&
    
    
    ((!scheduledComTimeIsSet() && !rhs.scheduledComTimeIsSet()) || (scheduledComTimeIsSet() && rhs.scheduledComTimeIsSet() && getScheduledComTime() == rhs.getScheduledComTime())) &&
    
    
    ((!stationaryIndIsSet() && !rhs.stationaryIndIsSet()) || (stationaryIndIsSet() && rhs.stationaryIndIsSet() && getStationaryInd() == rhs.getStationaryInd())) &&
    ...
    ((!batteryIndIsSet() && !rhs.batteryIndIsSet()) || (batteryIndIsSet() && rhs.batteryIndIsSet() && getBatteryInd() == rhs.getBatteryInd())) &&
...
oai::_3gpp::model::PeriodicCommunicationIndicator UeDifferentiationInfo::getPeriodicComInd() const
{
    return m_PeriodicComInd;
}
void UeDifferentiationInfo::setPeriodicComInd(oai::_3gpp::model::PeriodicCommunicationIndicator const& value)
{
...
oai::_3gpp::model::ScheduledCommunicationTime UeDifferentiationInfo::getScheduledComTime() const
{
    return m_ScheduledComTime;
}
void UeDifferentiationInfo::setScheduledComTime(oai::_3gpp::model::ScheduledCommunicationTime const& value)
{
...
oai::_3gpp::model::StationaryIndication UeDifferentiationInfo::getStationaryInd() const
{
    return m_StationaryInd;
}
void UeDifferentiationInfo::setStationaryInd(oai::_3gpp::model::StationaryIndication const& value)
{
...
oai::_3gpp::model::TrafficProfile UeDifferentiationInfo::getTrafficProfile() const
{
    return m_TrafficProfile;
}
void UeDifferentiationInfo::setTrafficProfile(oai::_3gpp::model::TrafficProfile const& value)
{
...
oai::_3gpp::model::BatteryIndication UeDifferentiationInfo::getBatteryInd() const
{
    return m_BatteryInd;
}
void UeDifferentiationInfo::setBatteryInd(oai::_3gpp::model::BatteryIndication const& value)
{
    m_BatteryInd = value;
