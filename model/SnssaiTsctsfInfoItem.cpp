...
bool SnssaiTsctsfInfoItem::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    ...
    /* DnnInfoList */ {
        const std::vector<oai::_3gpp::model::DnnTsctsfInfoItem>& value = m_DnnInfoList;
...
void SnssaiTsctsfInfoItem::setSNssai(oai::_3gpp::model::ExtSnssai const& value)
{
    m_SNssai = value;
}
std::vector<oai::_3gpp::model::DnnTsctsfInfoItem> SnssaiTsctsfInfoItem::getDnnInfoList() const
{
    return m_DnnInfoList;
}
void SnssaiTsctsfInfoItem::setDnnInfoList(std::vector<oai::_3gpp::model::DnnTsctsfInfoItem> const& value)
{
    m_DnnInfoList = value;
}
