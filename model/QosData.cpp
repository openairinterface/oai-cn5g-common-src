...
bool QosData::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
...
bool QosData::operator==(const QosData& rhs) const
{
    ...
    ((!maxbrUlIsSet() && !rhs.maxbrUlIsSet()) || (maxbrUlIsSet() && rhs.maxbrUlIsSet() && getMaxbrUl() == rhs.getMaxbrUl())) &&
    
    
    ((!maxbrDlIsSet() && !rhs.maxbrDlIsSet()) || (maxbrDlIsSet() && rhs.maxbrDlIsSet() && getMaxbrDl() == rhs.getMaxbrDl())) &&
    ...
    ((!qncIsSet() && !rhs.qncIsSet()) || (qncIsSet() && rhs.qncIsSet() && isQnc() == rhs.isQnc())) &&
    
    
    ((!priorityLevelIsSet() && !rhs.priorityLevelIsSet()) || (priorityLevelIsSet() && rhs.priorityLevelIsSet() && getPriorityLevel() == rhs.getPriorityLevel())) &&
    
    
    ((!averWindowIsSet() && !rhs.averWindowIsSet()) || (averWindowIsSet() && rhs.averWindowIsSet() && getAverWindow() == rhs.getAverWindow())) &&
    
    
    ((!maxDataBurstVolIsSet() && !rhs.maxDataBurstVolIsSet()) || (maxDataBurstVolIsSet() && rhs.maxDataBurstVolIsSet() && getMaxDataBurstVol() == rhs.getMaxDataBurstVol())) &&
    
    
    ((!reflectiveQosIsSet() && !rhs.reflectiveQosIsSet()) || (reflectiveQosIsSet() && rhs.reflectiveQosIsSet() && isReflectiveQos() == rhs.isReflectiveQos())) &&
    ...
    ((!defQosFlowIndicationIsSet() && !rhs.defQosFlowIndicationIsSet()) || (defQosFlowIndicationIsSet() && rhs.defQosFlowIndicationIsSet() && isDefQosFlowIndication() == rhs.isDefQosFlowIndication())) &&
    
    
    ((!extMaxDataBurstVolIsSet() && !rhs.extMaxDataBurstVolIsSet()) || (extMaxDataBurstVolIsSet() && rhs.extMaxDataBurstVolIsSet() && getExtMaxDataBurstVol() == rhs.getExtMaxDataBurstVol())) &&
    
    
    ((!packetDelayBudgetIsSet() && !rhs.packetDelayBudgetIsSet()) || (packetDelayBudgetIsSet() && rhs.packetDelayBudgetIsSet() && getPacketDelayBudget() == rhs.getPacketDelayBudget())) &&
    
    
    ((!packetErrorRateIsSet() && !rhs.packetErrorRateIsSet()) || (packetErrorRateIsSet() && rhs.packetErrorRateIsSet() && getPacketErrorRate() == rhs.getPacketErrorRate()))
...
oai::_3gpp::model::Arp QosData::getArp() const
{
    return m_Arp;
}
void QosData::setArp(oai::_3gpp::model::Arp const& value)
{
    m_Arp = value;
    m_ArpIsSet = true;
}
