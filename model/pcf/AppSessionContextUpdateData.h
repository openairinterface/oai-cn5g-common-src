...
public:
    ...
    /// </summary>
    std::map<std::string, oai::model::pcf::MediaComponentRm> getMedComponents() const;
    void setMedComponents(std::map<std::string, oai::model::pcf::MediaComponentRm> const& value);
    ...
    void setPreemptControlInfo(oai::model::pcf::PreemptionControlInformation const& value);
