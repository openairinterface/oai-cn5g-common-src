...
bool AdditionalMeasurement::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "AdditionalMeasurement" : pathPrefix;

             
    if (unexpFlowTepsIsSet())
    {
        const std::vector<oai::_3gpp::model::IpEthFlowDescription>& value = m_UnexpFlowTeps;
        ...
        { // Recursive validation of array elements
            ...
            int i = 0;
            for (const oai::_3gpp::model::IpEthFlowDescription& value : value)
            { 
                const std::string currentValuePath = oldValuePath + "[" + std::to_string(i) + "]";
                        
        success = value.validate(msg, currentValuePath + ".unexpFlowTeps") && success;
    ...
    if (unexpWakesIsSet())
    {
        const std::vector<oai::_3gpp::model::std::string>& value = m_UnexpWakes;
    ...
    if (circumsIsSet())
    {
        const std::vector<oai::_3gpp::model::CircumstanceDescription>& value = m_Circums;
        ...
        { // Recursive validation of array elements
            const std::string oldValuePath = currentValuePath;
            int i = 0;
            for (const oai::_3gpp::model::CircumstanceDescription& value : value)
            { 
                const std::string currentValuePath = oldValuePath + "[" + std::to_string(i) + "]";
...
bool AdditionalMeasurement::operator==(const AdditionalMeasurement& rhs) const
{
    ...
    ((!unexpLocIsSet() && !rhs.unexpLocIsSet()) || (unexpLocIsSet() && rhs.unexpLocIsSet() && getUnexpLoc() == rhs.getUnexpLoc())) &&
    
    
    ((!unexpFlowTepsIsSet() && !rhs.unexpFlowTepsIsSet()) || (unexpFlowTepsIsSet() && rhs.unexpFlowTepsIsSet() && getUnexpFlowTeps() == rhs.getUnexpFlowTeps())) &&
    
    
    ((!unexpWakesIsSet() && !rhs.unexpWakesIsSet()) || (unexpWakesIsSet() && rhs.unexpWakesIsSet() && getUnexpWakes() == rhs.getUnexpWakes())) &&
    
    
    ((!ddosAttackIsSet() && !rhs.ddosAttackIsSet()) || (ddosAttackIsSet() && rhs.ddosAttackIsSet() && getDdosAttack() == rhs.getDdosAttack())) &&
    
    
    ((!wrgDestIsSet() && !rhs.wrgDestIsSet()) || (wrgDestIsSet() && rhs.wrgDestIsSet() && getWrgDest() == rhs.getWrgDest())) &&
    
    
    ((!circumsIsSet() && !rhs.circumsIsSet()) || (circumsIsSet() && rhs.circumsIsSet() && getCircums() == rhs.getCircums()))
...
oai::_3gpp::model::NetworkAreaInfo AdditionalMeasurement::getUnexpLoc() const
{
    return m_UnexpLoc;
}
void AdditionalMeasurement::setUnexpLoc(oai::_3gpp::model::NetworkAreaInfo const& value)
{
    m_UnexpLoc = value;
...
std::vector<oai::_3gpp::model::IpEthFlowDescription> AdditionalMeasurement::getUnexpFlowTeps() const
{
    return m_UnexpFlowTeps;
}
void AdditionalMeasurement::setUnexpFlowTeps(std::vector<oai::_3gpp::model::IpEthFlowDescription> const& value)
{
...
std::vector<oai::_3gpp::model::std::string> AdditionalMeasurement::getUnexpWakes() const
{
    return m_UnexpWakes;
}
void AdditionalMeasurement::setUnexpWakes(std::vector<oai::_3gpp::model::std::string> const& value)
{
    m_UnexpWakes = value;
...
oai::_3gpp::model::AddressList AdditionalMeasurement::getDdosAttack() const
{
    return m_DdosAttack;
}
void AdditionalMeasurement::setDdosAttack(oai::_3gpp::model::AddressList const& value)
{
    m_DdosAttack = value;
...
oai::_3gpp::model::AddressList AdditionalMeasurement::getWrgDest() const
{
    return m_WrgDest;
}
void AdditionalMeasurement::setWrgDest(oai::_3gpp::model::AddressList const& value)
{
    m_WrgDest = value;
    m_WrgDestIsSet = true;
}
...
std::vector<oai::_3gpp::model::CircumstanceDescription> AdditionalMeasurement::getCircums() const
{
    return m_Circums;
}
void AdditionalMeasurement::setCircums(std::vector<oai::_3gpp::model::CircumstanceDescription> const& value)
{
    m_Circums = value;
    m_CircumsIsSet = true;
}
