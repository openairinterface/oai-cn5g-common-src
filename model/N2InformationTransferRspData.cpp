...
oai::_3gpp::model::N2InformationTransferResult N2InformationTransferRspData::getResult() const
{
    return m_Result;
}
void N2InformationTransferRspData::setResult(oai::_3gpp::model::N2InformationTransferResult const& value)
{
    m_Result = value;
}
oai::_3gpp::model::PWSResponseData N2InformationTransferRspData::getPwsRspData() const
{
    return m_PwsRspData;
}
void N2InformationTransferRspData::setPwsRspData(oai::_3gpp::model::PWSResponseData const& value)
{
    m_PwsRspData = value;
