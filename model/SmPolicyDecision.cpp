...
SmPolicyDecision::SmPolicyDecision()
{
    ...
    m_Online = false;
    m_OnlineIsSet = false;
    m_OfflineChOnly = false;
    m_OfflineChOnlyIsSet = false;
...
bool SmPolicyDecision::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "SmPolicyDecision" : pathPrefix;

         
    if (sessRulesIsSet())
    {
        const std::map<std::string, oai::_3gpp::model::SessionRule>& value = m_SessRules;
    ...
    if (pccRulesIsSet())
    {
        const std::map<std::string, oai::_3gpp::model::PccRule>& value = m_PccRules;
    ...
    if (qosDecsIsSet())
    {
        const std::map<std::string, oai::_3gpp::model::QosData>& value = m_QosDecs;
    ...
    if (chgDecsIsSet())
    {
        const std::map<std::string, oai::_3gpp::model::ChargingData>& value = m_ChgDecs;
    ...
    {
        const std::map<std::string, oai::_3gpp::model::TrafficControlData>& value = m_TraffContDecs;
    ...
    if (umDecsIsSet())
    {
        const std::map<std::string, oai::_3gpp::model::UsageMonitoringData>& value = m_UmDecs;
    ...
    if (qosCharsIsSet())
    {
        const std::map<std::string, oai::_3gpp::model::QosCharacteristics>& value = m_QosChars;
    ...
    if (qosMonDecsIsSet())
    {
        const std::map<std::string, oai::_3gpp::model::QosMonitoringData>& value = m_QosMonDecs;
    ...
    if (condsIsSet())
    {
        const std::map<std::string, oai::_3gpp::model::ConditionData>& value = m_Conds;
    ...
    {
        const std::vector<oai::_3gpp::model::PolicyControlRequestTrigger>& value = m_PolicyCtrlReqTriggers;
        ...
        success = value.validate(msg, currentValuePath + ".policyCtrlReqTriggers") && success;
    ...
    {
        const std::vector<oai::_3gpp::model::RequestedRuleData>& value = m_LastReqRuleData;
        ...
        { // Recursive validation of array elements
            const std::string oldValuePath = currentValuePath;
            int i = 0;
            for (const oai::_3gpp::model::RequestedRuleData& value : value)
            { 
                const std::string currentValuePath = oldValuePath + "[" + std::to_string(i) + "]";
                        
        success = value.validate(msg, currentValuePath + ".lastReqRuleData") && success;
    ...
    if (praInfosIsSet())
    {
        const std::map<std::string, oai::_3gpp::model::PresenceInfoRm>& value = m_PraInfos;
...
bool SmPolicyDecision::operator==(const SmPolicyDecision& rhs) const
{
    ...
    ((!sessRulesIsSet() && !rhs.sessRulesIsSet()) || (sessRulesIsSet() && rhs.sessRulesIsSet() && getSessRules() == rhs.getSessRules())) &&
    
    
    ((!pccRulesIsSet() && !rhs.pccRulesIsSet()) || (pccRulesIsSet() && rhs.pccRulesIsSet() && getPccRules() == rhs.getPccRules())) &&
    
    
    ((!pcscfRestIndicationIsSet() && !rhs.pcscfRestIndicationIsSet()) || (pcscfRestIndicationIsSet() && rhs.pcscfRestIndicationIsSet() && isPcscfRestIndication() == rhs.isPcscfRestIndication())) &&
    
    
    ((!qosDecsIsSet() && !rhs.qosDecsIsSet()) || (qosDecsIsSet() && rhs.qosDecsIsSet() && getQosDecs() == rhs.getQosDecs())) &&
    
    
    ((!chgDecsIsSet() && !rhs.chgDecsIsSet()) || (chgDecsIsSet() && rhs.chgDecsIsSet() && getChgDecs() == rhs.getChgDecs())) &&
    
    
    ((!chargingInfoIsSet() && !rhs.chargingInfoIsSet()) || (chargingInfoIsSet() && rhs.chargingInfoIsSet() && getChargingInfo() == rhs.getChargingInfo())) &&
    
    
    ((!traffContDecsIsSet() && !rhs.traffContDecsIsSet()) || (traffContDecsIsSet() && rhs.traffContDecsIsSet() && getTraffContDecs() == rhs.getTraffContDecs())) &&
    
    
    ((!umDecsIsSet() && !rhs.umDecsIsSet()) || (umDecsIsSet() && rhs.umDecsIsSet() && getUmDecs() == rhs.getUmDecs())) &&
    
    
    ((!qosCharsIsSet() && !rhs.qosCharsIsSet()) || (qosCharsIsSet() && rhs.qosCharsIsSet() && getQosChars() == rhs.getQosChars())) &&
    
    
    ((!qosMonDecsIsSet() && !rhs.qosMonDecsIsSet()) || (qosMonDecsIsSet() && rhs.qosMonDecsIsSet() && getQosMonDecs() == rhs.getQosMonDecs())) &&
    
    
    ((!reflectiveQoSTimerIsSet() && !rhs.reflectiveQoSTimerIsSet()) || (reflectiveQoSTimerIsSet() && rhs.reflectiveQoSTimerIsSet() && getReflectiveQoSTimer() == rhs.getReflectiveQoSTimer())) &&
    
    
    ((!condsIsSet() && !rhs.condsIsSet()) || (condsIsSet() && rhs.condsIsSet() && getConds() == rhs.getConds())) &&
    
    
    ((!revalidationTimeIsSet() && !rhs.revalidationTimeIsSet()) || (revalidationTimeIsSet() && rhs.revalidationTimeIsSet() && getRevalidationTime() == rhs.getRevalidationTime())) &&
    ...
    ((!offlineChOnlyIsSet() && !rhs.offlineChOnlyIsSet()) || (offlineChOnlyIsSet() && rhs.offlineChOnlyIsSet() && isOfflineChOnly() == rhs.isOfflineChOnly())) &&
    
    
    ((!policyCtrlReqTriggersIsSet() && !rhs.policyCtrlReqTriggersIsSet()) || (policyCtrlReqTriggersIsSet() && rhs.policyCtrlReqTriggersIsSet() && getPolicyCtrlReqTriggers() == rhs.getPolicyCtrlReqTriggers())) &&
    
    
    ((!lastReqRuleDataIsSet() && !rhs.lastReqRuleDataIsSet()) || (lastReqRuleDataIsSet() && rhs.lastReqRuleDataIsSet() && getLastReqRuleData() == rhs.getLastReqRuleData())) &&
    
    
    ((!lastReqUsageDataIsSet() && !rhs.lastReqUsageDataIsSet()) || (lastReqUsageDataIsSet() && rhs.lastReqUsageDataIsSet() && getLastReqUsageData() == rhs.getLastReqUsageData())) &&
    ...
    ((!relCauseIsSet() && !rhs.relCauseIsSet()) || (relCauseIsSet() && rhs.relCauseIsSet() && getRelCause() == rhs.getRelCause())) &&
    ...
    ((!redSessIndicationIsSet() && !rhs.redSessIndicationIsSet()) || (redSessIndicationIsSet() && rhs.redSessIndicationIsSet() && isRedSessIndication() == rhs.isRedSessIndication()))
...
void to_json(nlohmann::json& j, const SmPolicyDecision& o)
{
    ...
    if(o.onlineIsSet())
        j["online"] = o.m_Online;
    if(o.offlineChOnlyIsSet())
        j["offlineChOnly"] = o.m_OfflineChOnly;
...
void from_json(const nlohmann::json& j, SmPolicyDecision& o)
{
    ...
    if(j.find("offlineChOnly") != j.end())
    {
        j.at("offlineChOnly").get_to(o.m_OfflineChOnly);
        o.m_OfflineChOnlyIsSet = true;
    } 
...
std::map<std::string, oai::_3gpp::model::SessionRule> SmPolicyDecision::getSessRules() const
{
    return m_SessRules;
}
void SmPolicyDecision::setSessRules(std::map<std::string, oai::_3gpp::model::SessionRule> const& value)
{
    m_SessRules = value;
...
std::map<std::string, oai::_3gpp::model::PccRule> SmPolicyDecision::getPccRules() const
{
    return m_PccRules;
}
void SmPolicyDecision::setPccRules(std::map<std::string, oai::_3gpp::model::PccRule> const& value)
{
    m_PccRules = value;
...
std::map<std::string, oai::_3gpp::model::QosData> SmPolicyDecision::getQosDecs() const
{
    return m_QosDecs;
}
void SmPolicyDecision::setQosDecs(std::map<std::string, oai::_3gpp::model::QosData> const& value)
{
    m_QosDecs = value;
    m_QosDecsIsSet = true;
}
...
std::map<std::string, oai::_3gpp::model::ChargingData> SmPolicyDecision::getChgDecs() const
{
    return m_ChgDecs;
}
void SmPolicyDecision::setChgDecs(std::map<std::string, oai::_3gpp::model::ChargingData> const& value)
{
    m_ChgDecs = value;
    m_ChgDecsIsSet = true;
}
...
oai::_3gpp::model::ChargingInformation SmPolicyDecision::getChargingInfo() const
{
    return m_ChargingInfo;
}
void SmPolicyDecision::setChargingInfo(oai::_3gpp::model::ChargingInformation const& value)
{
...
std::map<std::string, oai::_3gpp::model::TrafficControlData> SmPolicyDecision::getTraffContDecs() const
{
    return m_TraffContDecs;
}
void SmPolicyDecision::setTraffContDecs(std::map<std::string, oai::_3gpp::model::TrafficControlData> const& value)
{
...
std::map<std::string, oai::_3gpp::model::UsageMonitoringData> SmPolicyDecision::getUmDecs() const
{
    return m_UmDecs;
}
void SmPolicyDecision::setUmDecs(std::map<std::string, oai::_3gpp::model::UsageMonitoringData> const& value)
{
    m_UmDecs = value;
    m_UmDecsIsSet = true;
}
...
std::map<std::string, oai::_3gpp::model::QosCharacteristics> SmPolicyDecision::getQosChars() const
{
    return m_QosChars;
}
void SmPolicyDecision::setQosChars(std::map<std::string, oai::_3gpp::model::QosCharacteristics> const& value)
{
    m_QosChars = value;
...
std::map<std::string, oai::_3gpp::model::QosMonitoringData> SmPolicyDecision::getQosMonDecs() const
{
    return m_QosMonDecs;
}
void SmPolicyDecision::setQosMonDecs(std::map<std::string, oai::_3gpp::model::QosMonitoringData> const& value)
{
    m_QosMonDecs = value;
...
std::map<std::string, oai::_3gpp::model::ConditionData> SmPolicyDecision::getConds() const
{
    return m_Conds;
}
void SmPolicyDecision::setConds(std::map<std::string, oai::_3gpp::model::ConditionData> const& value)
{
    m_Conds = value;
    m_CondsIsSet = true;
}
...
bool SmPolicyDecision::isOfflineChOnly() const
{
    return m_OfflineChOnly;
}
void SmPolicyDecision::setOfflineChOnly(bool const value)
{
    m_OfflineChOnly = value;
    m_OfflineChOnlyIsSet = true;
}
bool SmPolicyDecision::offlineChOnlyIsSet() const
{
    return m_OfflineChOnlyIsSet;
}
void SmPolicyDecision::unsetOfflineChOnly()
{
    m_OfflineChOnlyIsSet = false;
}
std::vector<oai::_3gpp::model::PolicyControlRequestTrigger> SmPolicyDecision::getPolicyCtrlReqTriggers() const
{
    return m_PolicyCtrlReqTriggers;
}
void SmPolicyDecision::setPolicyCtrlReqTriggers(std::vector<oai::_3gpp::model::PolicyControlRequestTrigger> const& value)
{
...
std::vector<oai::_3gpp::model::RequestedRuleData> SmPolicyDecision::getLastReqRuleData() const
{
    return m_LastReqRuleData;
}
void SmPolicyDecision::setLastReqRuleData(std::vector<oai::_3gpp::model::RequestedRuleData> const& value)
{
...
oai::_3gpp::model::RequestedUsageData SmPolicyDecision::getLastReqUsageData() const
{
    return m_LastReqUsageData;
}
void SmPolicyDecision::setLastReqUsageData(oai::_3gpp::model::RequestedUsageData const& value)
{
...
std::map<std::string, oai::_3gpp::model::PresenceInfoRm> SmPolicyDecision::getPraInfos() const
{
    return m_PraInfos;
}
void SmPolicyDecision::setPraInfos(std::map<std::string, oai::_3gpp::model::PresenceInfoRm> const& value)
{
    m_PraInfos = value;
...
oai::_3gpp::model::QosFlowUsage SmPolicyDecision::getQosFlowUsage() const
{
    return m_QosFlowUsage;
}
void SmPolicyDecision::setQosFlowUsage(oai::_3gpp::model::QosFlowUsage const& value)
{
...
oai::_3gpp::model::SmPolicyAssociationReleaseCause SmPolicyDecision::getRelCause() const
{
    return m_RelCause;
}
void SmPolicyDecision::setRelCause(oai::_3gpp::model::SmPolicyAssociationReleaseCause const& value)
{
    m_RelCause = value;
...
oai::_3gpp::model::BridgeManagementContainer SmPolicyDecision::getTsnBridgeManCont() const
{
    return m_TsnBridgeManCont;
}
void SmPolicyDecision::setTsnBridgeManCont(oai::_3gpp::model::BridgeManagementContainer const& value)
{
...
oai::_3gpp::model::PortManagementContainer SmPolicyDecision::getTsnPortManContDstt() const
{
    return m_TsnPortManContDstt;
}
void SmPolicyDecision::setTsnPortManContDstt(oai::_3gpp::model::PortManagementContainer const& value)
{
...
std::vector<oai::_3gpp::model::PortManagementContainer> SmPolicyDecision::getTsnPortManContNwtts() const
{
    return m_TsnPortManContNwtts;
}
void SmPolicyDecision::setTsnPortManContNwtts(std::vector<oai::_3gpp::model::PortManagementContainer> const& value)
{
