...
asn_TYPE_member_t asn_MBR_Ngap_E_RABInformationItem_1[] = {
    {ATF_NOFLAGS,
     0,
     offsetof(struct Ngap_E_RABInformationItem, e_RAB_ID),
    ...
    {ATF_POINTER,
     2,
     offsetof(struct Ngap_E_RABInformationItem, dLForwarding),
    ...
    {ATF_POINTER,
     1,
     offsetof(struct Ngap_E_RABInformationItem, iE_Extensions),
     (ASN_TAG_CLASS_CONTEXT | (2 << 2)),
     -1, /* IMPLICIT tag at current level */
     &asn_DEF_Ngap_ProtocolExtensionContainer_12929P76,
     0,
     {
#if !defined(ASN_DISABLE_OER_SUPPORT)
         0,
