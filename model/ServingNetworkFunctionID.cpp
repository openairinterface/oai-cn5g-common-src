...
oai::_3gpp::model::NFIdentification ServingNetworkFunctionID::getServingNetworkFunctionInformation() const
{
    return m_ServingNetworkFunctionInformation;
}
void ServingNetworkFunctionID::setServingNetworkFunctionInformation(oai::_3gpp::model::NFIdentification const& value)
{
