...
bool ArpRm::validate(std::stringstream &msg) const { return validate(msg, ""); }

bool ArpRm::validate(std::stringstream &msg,
...
bool ArpRm::operator!=(const ArpRm &rhs) const { return !(*this == rhs); }
