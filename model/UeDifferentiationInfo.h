...
public:
    ...
    void setPeriodicComInd(oai::_3gpp::model::PeriodicCommunicationIndicator const& value);
    ...
    void setScheduledComTime(oai::_3gpp::model::ScheduledCommunicationTime const& value);
