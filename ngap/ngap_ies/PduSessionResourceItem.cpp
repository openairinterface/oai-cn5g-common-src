...
//------------------------------------------------------------------------------
void PduSessionResourceItem::set(const PduSessionId &pduSessionId,
...
//------------------------------------------------------------------------------
void PduSessionResourceItem::get(PduSessionId &pduSessionId,
...
//------------------------------------------------------------------------------
bool PduSessionResourceItem::encode(Ngap_PDUSessionID_t &pduSessionId,
                                    OCTET_STRING_t &resource) const {
  if (!m_PduSessionId.encode(pduSessionId))
    return false;
  return ngap_utils::octet_string_copy(resource, m_Resource);
}

//------------------------------------------------------------------------------
bool PduSessionResourceItem::decode(const Ngap_PDUSessionID_t &pduSessionId,
                                    const OCTET_STRING_t &resource) {
  if (!m_PduSessionId.decode(pduSessionId))
    return false;
...
bool PduSessionResourceItem::encode(
  ...
  return encode(item.pDUSessionID,
...
bool PduSessionResourceItem::decode(
  ...
  return decode(item.pDUSessionID,
                item.pDUSessionResourceSetupResponseTransfer);
}
...
bool PduSessionResourceItem::encode(
  ...
  return encode(item.pDUSessionID,
                item.handoverPreparationUnsuccessfulTransfer);
}
...
bool PduSessionResourceItem::encode(
  ...
  return encode(item.pDUSessionID,
                item.handoverResourceAllocationUnsuccessfulTransfer);
}
