...
bool ScpDomainCond::validate(
    std::stringstream& msg, const std::string& pathPrefix) const {
  bool success = true;
  const std::string _pathPrefix =
      pathPrefix.empty() ? "ScpDomainCond" : pathPrefix;
...
std::vector<oai::_3gpp::model::NFType> ScpDomainCond::getNfTypeList() const {
  return m_NfTypeList;
}
void ScpDomainCond::setNfTypeList(
