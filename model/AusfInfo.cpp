...
std::vector<oai::model::SupiRange> AusfInfo::getSupiRanges() const
{
    return m_SupiRanges;
}
void AusfInfo::setSupiRanges(std::vector<oai::model::SupiRange> const& value)
{
    m_SupiRanges = value;
...
std::vector<oai::model::SuciInfo> AusfInfo::getSuciInfos() const
{
    return m_SuciInfos;
}
void AusfInfo::setSuciInfos(std::vector<oai::model::SuciInfo> const& value)
{
    m_SuciInfos = value;
