...
public:
    ...
    void setSnssaiDnns(std::vector<oai::_3gpp::model::SnssaiDnnCombination> const& value);
    bool snssaiDnnsIsSet() const;
    void unsetSnssaiDnns();
    /// <summary>
    /// 
    /// </summary>
    std::vector<oai::_3gpp::model::ServiceIdentification> getFilterServices() const;
    void setFilterServices(std::vector<oai::_3gpp::model::ServiceIdentification> const& value);
    ...
    void setEventNotifs(std::vector<oai::_3gpp::model::PcEventNotification> const& value);
