...
public:
    ...
    /// 
    /// </summary>
    oai::model::EthFlowDescription getEthFlowDescription() const;
    void setEthFlowDescription(oai::model::EthFlowDescription const& value);
    ...
    /// 
    /// </summary>
    oai::model::FlowDirection getFlowDirection() const;
    void setFlowDirection(oai::model::FlowDirection const& value);
...
protected:
    ...
    oai::model::EthFlowDescription m_EthFlowDescription;
    ...
    oai::model::FlowDirection m_FlowDirection;
