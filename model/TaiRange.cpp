...
bool TaiRange::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    ...
    /* TacRangeList */ {
        const std::vector<oai::_3gpp::model::TacRange>& value = m_TacRangeList;
        ...
        { // Recursive validation of array elements
            ...
            int i = 0;
            for (const oai::_3gpp::model::TacRange& value : value)
            { 
...
oai::_3gpp::model::PlmnId TaiRange::getPlmnId() const
{
    return m_PlmnId;
}
void TaiRange::setPlmnId(oai::_3gpp::model::PlmnId const& value)
{
    m_PlmnId = value;
}
std::vector<oai::_3gpp::model::TacRange> TaiRange::getTacRangeList() const
{
    return m_TacRangeList;
}
void TaiRange::setTacRangeList(std::vector<oai::_3gpp::model::TacRange> const& value)
{
