...
oai::_3gpp::model::NetworkPerfType NetworkPerfRequirement::getNwPerfType() const
{
    return m_NwPerfType;
}
void NetworkPerfRequirement::setNwPerfType(oai::_3gpp::model::NetworkPerfType const& value)
{
    m_NwPerfType = value;
}
