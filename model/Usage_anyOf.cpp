...
bool Usage_anyOf::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "Usage_anyOf" : pathPrefix;
...
void from_json(const nlohmann::json& j, Usage_anyOf& o)
{
    ...
    if (s == "UNSUCCESS") {
     ...
     o.setValue(Usage_anyOf::eUsage_anyOf::SUCCESS_RESULTS_USED_TO_VERIFY_LOCATION);
    } 
    else if (s == "SUCCESS_RESULTS_USED_TO_GENERATE_LOCATION") {
     o.setValue(Usage_anyOf::eUsage_anyOf::SUCCESS_RESULTS_USED_TO_GENERATE_LOCATION);
    } 
