...
oai::_3gpp::model::N1N2MessageTransferCause N1N2MsgTxfrFailureNotification::getCause() const
{
    return m_Cause;
}
void N1N2MsgTxfrFailureNotification::setCause(oai::_3gpp::model::N1N2MessageTransferCause const& value)
{
    m_Cause = value;
}
