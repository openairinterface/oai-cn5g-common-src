...
bool ReflectiveQoSAttributeRm::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "ReflectiveQoSAttributeRm" : pathPrefix;

    
    return success;
}

bool ReflectiveQoSAttributeRm::operator==(const ReflectiveQoSAttributeRm& rhs) const
{
    return
