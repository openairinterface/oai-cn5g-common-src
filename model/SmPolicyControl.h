...
public:
    ...
    /// 
    /// </summary>
    oai::model::SmPolicyContextData getContext() const;
    void setContext(oai::model::SmPolicyContextData const& value);
    /// <summary>
    /// 
    /// </summary>
    oai::model::SmPolicyDecision getPolicy() const;
    void setPolicy(oai::model::SmPolicyDecision const& value);

    friend  void to_json(nlohmann::json& j, const SmPolicyControl& o);
    friend  void from_json(const nlohmann::json& j, SmPolicyControl& o);
protected:
    oai::model::SmPolicyContextData m_Context;

    oai::model::SmPolicyDecision m_Policy;
