...
bool AcceptableServiceInfo::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    ...
    {
        const std::map<std::string, oai::model::MediaComponent>& value = m_AccBwMedComps;
...
std::map<std::string, oai::model::MediaComponent> AcceptableServiceInfo::getAccBwMedComps() const
{
    return m_AccBwMedComps;
}
void AcceptableServiceInfo::setAccBwMedComps(std::map<std::string, oai::model::MediaComponent> const& value)
{
