...
oai::_3gpp::model::TraceDepth TraceData::getTraceDepth() const
{
    return m_TraceDepth;
}
void TraceData::setTraceDepth(oai::_3gpp::model::TraceDepth const& value)
{
    m_TraceDepth = value;
}
...
oai::_3gpp::model::Ipv6Addr TraceData::getCollectionEntityIpv6Addr() const
{
    return m_CollectionEntityIpv6Addr;
}
void TraceData::setCollectionEntityIpv6Addr(oai::_3gpp::model::Ipv6Addr const& value)
{
