...
bool RoutingAreaId::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "RoutingAreaId" : pathPrefix;
...
oai::model::PlmnId RoutingAreaId::getPlmnId() const
{
    return m_PlmnId;
}
void RoutingAreaId::setPlmnId(oai::model::PlmnId const& value)
{
    m_PlmnId = value;
}
