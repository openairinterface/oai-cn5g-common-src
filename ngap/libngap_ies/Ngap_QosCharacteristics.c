...
asn_oer_constraints_t asn_OER_type_Ngap_QosCharacteristics_constr_1 CC_NOTUSED = {
	{ 0, 0 },
	-1};
...
asn_TYPE_member_t asn_MBR_Ngap_QosCharacteristics_1[] = {
	{ ATF_POINTER, 0, offsetof(struct Ngap_QosCharacteristics, choice.nonDynamic5QI),
	...
	{ ATF_POINTER, 0, offsetof(struct Ngap_QosCharacteristics, choice.dynamic5QI),
	...
	{ ATF_POINTER, 0, offsetof(struct Ngap_QosCharacteristics, choice.choice_Extensions),
		(ASN_TAG_CLASS_CONTEXT | (2 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_Ngap_ProtocolIE_SingleContainer_12877P45,
		0,
		{
#if !defined(ASN_DISABLE_OER_SUPPORT)
			0,
...
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
		&asn_PER_type_Ngap_QosCharacteristics_constr_1,
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
#if !defined(ASN_DISABLE_JER_SUPPORT)
		0,
#endif  /* !defined(ASN_DISABLE_JER_SUPPORT) */
