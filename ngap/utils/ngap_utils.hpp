...
class ngap_utils {
public:
  static void print_asn_msg(const asn_TYPE_descriptor_t *td,
                            const void *struct_ptr);
  static bool octet_string_2_bstring(const OCTET_STRING_t &octet_str,
                                     bstring &b_str);
  static bool bstring_2_octet_string(const bstring &b_str,
  ...
  static void octet_string_2_string(const OCTET_STRING_t &octet_str,
                                    std::string &str);
  static void string_2_octet_string(const std::string &str,
  ...
  static bool octet_string_copy(OCTET_STRING_t &destination,
                                const OCTET_STRING_t &source);
  static bool check_octet_string(const OCTET_STRING_t &octet_str);
  static bool string_2_masked_imeisv(const std::string &str,
                                     BIT_STRING_t &imeisv);
};
} // namespace oai::ngap
