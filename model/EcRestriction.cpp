...
std::vector<oai::_3gpp::model::PlmnEcInfo> EcRestriction::getPlmnEcInfos() const
{
    return m_PlmnEcInfos;
}
void EcRestriction::setPlmnEcInfos(std::vector<oai::_3gpp::model::PlmnEcInfo> const& value)
{
    m_PlmnEcInfos = value;
