...
public:
    ...
    /// 
    /// </summary>
    oai::model::SmPolicyDecision getSmPolicyDecision() const;
    void setSmPolicyDecision(oai::model::SmPolicyDecision const& value);
...
protected:
    ...
    oai::model::SmPolicyDecision m_SmPolicyDecision;
