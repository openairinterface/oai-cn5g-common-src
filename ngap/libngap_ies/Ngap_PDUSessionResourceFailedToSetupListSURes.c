...
asn_SET_OF_specifics_t
    asn_SPC_Ngap_PDUSessionResourceFailedToSetupListSURes_specs_1 = {
        ...
        offsetof(
            struct Ngap_PDUSessionResourceFailedToSetupListSURes, _asn_ctx),
...
asn_TYPE_descriptor_t asn_DEF_Ngap_PDUSessionResourceFailedToSetupListSURes = {
    ...
    sizeof(asn_DEF_Ngap_PDUSessionResourceFailedToSetupListSURes_tags_1) /
        sizeof(asn_DEF_Ngap_PDUSessionResourceFailedToSetupListSURes_tags_1
                   [0]),                                          /* 1 */
    asn_DEF_Ngap_PDUSessionResourceFailedToSetupListSURes_tags_1, /* Same as
                                                                     above */
    sizeof(asn_DEF_Ngap_PDUSessionResourceFailedToSetupListSURes_tags_1) /
        sizeof(asn_DEF_Ngap_PDUSessionResourceFailedToSetupListSURes_tags_1
                   [0]), /* 1 */
    ...
    1, /* Single element */
    &asn_SPC_Ngap_PDUSessionResourceFailedToSetupListSURes_specs_1 /* Additional
                                                                      specs */
};
