...
asn_TYPE_member_t asn_MBR_Ngap_CellIDCancelledEUTRA_Item_1[] = {
    {ATF_POINTER,
     0,
     offsetof(struct Ngap_CellIDCancelledEUTRA_Item, eUTRA_CGI),
    ...
    {ATF_NOFLAGS,
     0,
     offsetof(struct Ngap_CellIDCancelledEUTRA_Item, numberOfBroadcasts),
    ...
    {ATF_POINTER,
     1,
     offsetof(struct Ngap_CellIDCancelledEUTRA_Item, iE_Extensions),
     (ASN_TAG_CLASS_CONTEXT | (2 << 2)),
     -1, /* IMPLICIT tag at current level */
     &asn_DEF_Ngap_ProtocolExtensionContainer_12929P36,
     0,
     {
#if !defined(ASN_DISABLE_OER_SUPPORT)
         0,
