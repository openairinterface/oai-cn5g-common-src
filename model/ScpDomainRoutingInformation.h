...
public:
    ...
    /// </summary>
    std::map<std::string, oai::model::ScpDomainConnectivity> getScpDomainList() const;
    void setScpDomainList(std::map<std::string, oai::model::ScpDomainConnectivity> const& value);
...
protected:
    std::map<std::string, oai::model::ScpDomainConnectivity> m_ScpDomainList;
